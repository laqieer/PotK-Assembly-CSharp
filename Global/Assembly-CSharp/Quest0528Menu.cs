...
public class Quest0528Menu : BackButtonMenuBase
{
  ...
  private IEnumerator WaitScrollSe(NGHorizontalScrollParts obj)
  {
    ...
    return (IEnumerator) new Quest0528Menu.\u003CWaitScrollSe\u003Ec__Iterator600()
    {
      obj = obj,
      \u003C\u0024\u003Eobj = obj
    };
  ...
  public void onBtnOrganization()
  {
    if (this.IsPushAndSet())
      return;
    Quest0529Scene.ChangeScene(true);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528Menu.\u003CInit\u003Ec__Iterator601()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528Menu.\u003CsetupMapChipsWithInfoIndicator\u003Ec__Iterator602()
    {
      stage = stage,
      \u003C\u0024\u003Estage = stage,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528Menu.\u003CcreateBattleUnitInfo\u003Ec__Iterator603()
    {
