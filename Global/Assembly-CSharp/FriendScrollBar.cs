...
public class FriendScrollBar : MonoBehaviour
{
  ...
  public void Set(PlayerFriend friend, DateTime now)
  {
    ...
    this.lastPlay.SetTextLocalize(Consts.Lookup("LAST_PLAY", (IDictionary) new Hashtable()
    {
      {
        (object) "time",
        (object) (this.nowTime - friend.target_player_last_signed_in_at).DisplayStringForFriends()
      }
    }));
    this.friend = friend;
  }
  ...
  public IEnumerator SetUnitIcon()
  {
    ...
    return (IEnumerator) new FriendScrollBar.\u003CSetUnitIcon\u003Ec__Iterator422()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  protected void SetApplication(UILabel label)
  {
    ...
    label.SetTextLocalize(Consts.Lookup("FRIEND_0085SCROLLPARTS_DESCRIPTION01", (IDictionary) new Hashtable()
    {
      {
        (object) "dsfapplied",
