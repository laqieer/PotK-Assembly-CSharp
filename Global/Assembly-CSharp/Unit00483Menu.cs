...
public class Unit00483Menu : BackButtonMenuBase
{
    ...
    Dictionary<int, int> playerSkillDict)
  {
    ...
    Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyCC1 ratioCAnonStoreyCc1_1 = new Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyCC1();
    // ISSUE: reference to a compiler-generated field
    ratioCAnonStoreyCc1_1.baseUnit = baseUnit;
    // ISSUE: reference to a compiler-generated field
    ratioCAnonStoreyCc1_1.data = new Dictionary<int, float>();
    // ISSUE: reference to a compiler-generated field
    foreach (BattleskillSkill battleSkill in ratioCAnonStoreyCc1_1.baseUnit.GetBattleSkills())
    {
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ratioCAnonStoreyCc1_1.data[ratioCAnonStoreyCc1_1.baseUnit.evolutionSkill(battleSkill).ID] = 0.0f;
    }
    if (materialUnits.Length < 1)
    {
      // ISSUE: reference to a compiler-generated field
      return ratioCAnonStoreyCc1_1.data;
    }
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated method
    List<PlayerUnitSkills> list = ((IEnumerable<PlayerUnitSkills>) ratioCAnonStoreyCc1_1.baseUnit.skills).Where<PlayerUnitSkills>(new Func<PlayerUnitSkills, bool>(ratioCAnonStoreyCc1_1.\u003C\u003Em__C94)).ToList<PlayerUnitSkills>();
    foreach (PlayerUnit materialUnit in materialUnits)
    {
      PlayerUnit material = materialUnit;
      // ISSUE: reference to a compiler-generated field
      if (material.unit.same_character_id == ratioCAnonStoreyCc1_1.baseUnit.unit.same_character_id)
      {
        ...
        {
          // ISSUE: variable of a compiler-generated type
          Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyCC1 ratioCAnonStoreyCc1 = ratioCAnonStoreyCc1_1;
          // ISSUE: variable of a compiler-generated type
          Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyCC3 ratioCAnonStoreyCc3 = this;
          PlayerUnitSkills x1 = x;
          BattleskillSkill battleskillSkill = baseUnit.evolutionSkill(x1.skill);
          if (UnitDetailIcon.IsSkillUpMaterial(material, baseUnit))
          {
            if (battleskillSkill.skill_type != (BattleskillSkillType) material.unit.skillup_type && material.unit.skillup_type != UnitDetailIcon.SKILL_ID_ALL || 20.0 <= (double) data[battleskillSkill.ID])
              return;
            data[battleskillSkill.ID] = 20f;
          }
          else
          {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CCreateSkillDetailDialog\u003Ec__Iterator2CE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CInit\u003Ec__Iterator2CF()
    {
  ...
  {
    UIButton component = this.composeBtn.GetComponent<UIButton>();
  ...
  private void setLimitBreak(PlayerUnit basePlayerUnit, int limitBreakCount)
  {
    ...
    for (int breakthroughCount = basePlayerUnit.breakthrough_count; breakthroughCount < basePlayerUnit.breakthrough_count + limitBreakCount; ++breakthroughCount)
      ((Component) this.limitBreakGreen[breakthroughCount]).gameObject.SetActive(true);
    if (basePlayerUnit.unit.breakthrough_limit == 0)
      this.slc_Limitbreak.SetActive(false);
    NGTween.playTweens(NGTween.findTweenersAll(this.limitBreak, false), 0);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CCreateSkillIcon\u003Ec__Iterator2D0()
    {
      idx = idx,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CsetSkillIcon\u003Ec__Iterator2D1()
    {
      basePlayerUnit = basePlayerUnit,
      \u003C\u0024\u003EbasePlayerUnit = basePlayerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003Ccombine\u003Ec__Iterator2D2()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public virtual void IbtnCombine()
  {
    ...
    if (rarityList.Count<PlayerUnit>() != 0)
      this.changeSceneForPopup(Singleton<PopupManager>.GetInstance().open(this.RarityAlertPopupPrefab).GetComponent<Unit004832Menu>(), this, rarityList, this.baseUnit, this.selectUnit);
    else
  ...
  {
    this.StartCoroutine(popupMenu.SetSelectedUnitIcons(menu, rarityList.ToArray(), baseUnit, selectUnit));
  }
}
