...
public class BattleEffects : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    return (IEnumerator) new BattleEffects.\u003CStart_Battle\u003Ec__Iterator838()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleEffects.\u003CdoFieldEffect\u003Ec__Iterator839()
    {
      delay = delay,
      prefab = prefab,
      t = t,
  ...
  private class StartEffect : ScheduleEnumerator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleEffects.StartEffect.\u003CdoBody\u003Ec__Iterator83A()
      {
        \u003C\u003Ef__this = this
      };
    }
