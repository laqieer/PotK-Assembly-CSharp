...
public class DuelCutin : MonoBehaviour
{
  ...
  public IEnumerator Initialize<T>(T unit)
  {
    ...
    return (IEnumerator) new DuelCutin.\u003CInitialize\u003Ec__Iterator698<T>()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DuelCutin.\u003CLoadAndSetTexture\u003Ec__Iterator699()
    {
      unitId = unitId,
      pos = pos,
      \u003C\u0024\u003EunitId = unitId,
  ...
  private void GetUnitUnit<T>(T unit)
  {
    ...
    else
    {
      ...
      Debug.LogError((object) "GetUnitUnit trying to access a non-unit");
    }
  }
