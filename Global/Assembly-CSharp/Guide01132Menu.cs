...
public class Guide01132Menu : BackButtonMenuBase
{
  ...
  public IEnumerator onStartSceneAsync(UnitUnit unit, bool voiceFlag)
  {
    ...
    return (IEnumerator) new Guide01132Menu.\u003ConStartSceneAsync\u003Ec__Iterator4BC()
    {
      unit = unit,
      voiceFlag = voiceFlag,
      \u003C\u0024\u003Eunit = unit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guide01132Menu.\u003CSetUnitImg\u003Ec__Iterator4BD()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guide01132Menu.\u003CSetModel\u003Ec__Iterator4BE()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
