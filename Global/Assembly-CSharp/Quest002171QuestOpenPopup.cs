...
public class Quest002171QuestOpenPopup : BackButtonMenuBase
{
    ...
    Quest002171Scroll scrollcomp)
  {
    ...
    return (IEnumerator) new Quest002171QuestOpenPopup.\u003CInit\u003Ec__Iterator1B9()
    {
      menu = menu,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171QuestOpenPopup.\u003CInitOfEachCount\u003Ec__Iterator1BA()
    {
      gates = gates,
      \u003C\u0024\u003Egates = gates,
      \u003C\u003Ef__this = this
  ...
  private string GetReleaseTime(int totalSec)
  {
    ...
    if (timeSpan.Days > 0)
      empty += Consts.Lookup("QUEST_002171_RELEASEPOPUP_DESCRIPTION_DAY", (IDictionary) new Hashtable()
      {
        {
          (object) "day",
    ...
    if (timeSpan.Hours > 0)
      empty += Consts.Lookup("QUEST_002171_RELEASEPOPUP_DESCRIPTION_HOUR", (IDictionary) new Hashtable()
      {
        {
          (object) "hour",
    ...
    if (timeSpan.Minutes > 0)
      empty += Consts.Lookup("QUEST_002171_RELEASEPOPUP_DESCRIPTION_MIN", (IDictionary) new Hashtable()
      {
        {
          (object) "min",
  ...
  public void IbtnYes()
  {
    ...
    this.menu.StartAPI_QuestRelease(this.passGate);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171QuestOpenPopup.\u003CCreateKeySprite\u003Ec__Iterator1BB()
    {
      keyID = keyID,
      \u003C\u0024\u003EkeyID = keyID,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171QuestOpenPopup.\u003CCreateBanner\u003Ec__Iterator1BC()
    {
      num = num,
      \u003C\u0024\u003Enum = num,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171QuestOpenPopup.\u003CCreateBannerSprite\u003Ec__Iterator1BD()
    {
      gates = gates,
      isScroll = isScroll,
      isAtlas = isAtlas,
