...
public class Gacha00611Menu : EquipmentDetailMenuBase
{
    ...
    PlayerItem baseInfo = null)
  {
    ...
    return (IEnumerator) new Gacha00611Menu.\u003CInitialize\u003Ec__Iterator35B()
    {
  ...
  public void StartAnime() => this.StartCoroutine(this.Play());

  [DebuggerHidden]
  private IEnumerator Play()
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha00611Menu.\u003CPlay\u003Ec__Iterator35C()
    {
      \u003C\u003Ef__this = this
    };
  }
