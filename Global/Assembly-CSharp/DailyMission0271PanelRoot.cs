...
public class DailyMission0271PanelRoot : MonoBehaviour
{
  ...
  public IEnumerator Init(PlayerBingoPanel pbp, BackButtonMenuBase baseMenu)
  {
    ...
    return (IEnumerator) new DailyMission0271PanelRoot.\u003CInit\u003Ec__Iterator5C7()
    {
      pbp = pbp,
      baseMenu = baseMenu,
      \u003C\u0024\u003Epbp = pbp,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271PanelRoot.\u003CopenDetailPopup\u003Ec__Iterator5C8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271PanelRoot.\u003CclearMission\u003Ec__Iterator5C9()
    {
      \u003C\u003Ef__this = this
    };
  }
