...
public class DetailMenuScrollView01 : DetailMenuScrollViewBase
{
  ...
  public override bool Init(PlayerUnit playerUnit)
  {
    ...
    this.txt_Lvmax.SetTextLocalize(Consts.Lookup("UNIT_DETAIL_MAX", (IDictionary) new Hashtable()
    {
      {
        (object) "max",
    ...
    this.txt_Hpmax.SetTextLocalize(Consts.Lookup("UNIT_DETAIL_MAX", (IDictionary) new Hashtable()
    {
      {
        (object) "max",
    ...
    System.Action action = null)
  {
    ...
    return (IEnumerator) new DetailMenuScrollView01.\u003CsetModel\u003Ec__Iterator8B7()
    {
