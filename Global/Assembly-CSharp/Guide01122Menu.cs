...
public class Guide01122Menu : BackButtonMenuBase
{
  ...
  public IEnumerator onStartSceneAsync(UnitUnit unit, bool voiceFlag)
  {
    ...
    return (IEnumerator) new Guide01122Menu.\u003ConStartSceneAsync\u003Ec__Iterator4AD()
    {
      unit = unit,
      voiceFlag = voiceFlag,
      \u003C\u0024\u003Eunit = unit,
  ...
  public IEnumerator onEndSceneAsync()
  {
    ...
    Guide01122Menu.\u003ConEndSceneAsync\u003Ec__Iterator4AE asyncCIterator4Ae = new Guide01122Menu.\u003ConEndSceneAsync\u003Ec__Iterator4AE();
    return (IEnumerator) asyncCIterator4Ae;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guide01122Menu.\u003CSetUnitImg\u003Ec__Iterator4AF()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
