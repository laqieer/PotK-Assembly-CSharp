...
public class GaugeRunner
{
  ...
  public static IEnumerator Run(GaugeRunner[] runners)
  {
    ...
    return (IEnumerator) new GaugeRunner.\u003CRun\u003Ec__Iterator964()
    {
      runners = runners,
      \u003C\u0024\u003Erunners = runners
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GaugeRunner.\u003CRun\u003Ec__Iterator965()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GaugeRunner.\u003CRun\u003Ec__Iterator966()
    {
      from = from,
      to = to,
      duration = duration,
