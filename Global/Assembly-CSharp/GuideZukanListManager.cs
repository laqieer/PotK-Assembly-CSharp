...
public class GuideZukanListManager : BackButtonMenuBase
{
  ...
  protected virtual IEnumerator CreateZukanList(Future<GameObject> popupSortAndFilter)
  {
    ...
    return (IEnumerator) new GuideZukanListManager.\u003CCreateZukanList\u003Ec__Iterator4A4()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideZukanListManager.\u003CCreateSpriteCashList\u003Ec__Iterator4A5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideZukanListManager.\u003CCreateIconWithNumber\u003Ec__Iterator4A6()
    {
      fPrefab = fPrefab,
      \u003C\u0024\u003EfPrefab = fPrefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideZukanListManager.\u003CCreateSortAndFilter\u003Ec__Iterator4A7()
    {
      fPrefab = fPrefab,
      \u003C\u0024\u003EfPrefab = fPrefab,
      \u003C\u003Ef__this = this
  ...
  protected string Order(GuideUnitUnit unit, bool reverse)
  {
    ...
    return (reverse != flag ? "0" : "1") + unit.History.ToString();
  }
