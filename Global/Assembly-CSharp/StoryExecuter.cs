...
public class StoryExecuter : MonoBehaviour
{
  ...
  {
    this.waitNextAutoPlay_ = 0.5f;
    this.lstFunctionWait_ = new List<Func<bool>>();
  ...
  private void initAutoPlay() => this.setStatusAutoPlay(this.isAutoPlay_);
  ...
  public void onClickedAutoPlayON() => this.setStatusAutoPlay(true);

  public void onClickedAutoPlayOFF() => this.setStatusAutoPlay(false);
  ...
  private void Update()
  {
    ...
    else if (!this.backlog_manager.IsEnable() && (this.isWaitAndNext && this.typewriterText == null || this.isAutoPlay_ && !flag && this.typewriterText == null && this.isNextAutoPlay()))
    {
  ...
  public IEnumerator initialize(string text)
  {
    ...
    return (IEnumerator) new StoryExecuter.\u003Cinitialize\u003Ec__Iterator478()
    {
      text = text,
      \u003C\u0024\u003Etext = text,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CDeleteObject\u003Ec__Iterator479()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CtypewriterEffect\u003Ec__Iterator47A()
    {
      text = text,
  ...
  public void setNameMsgBright()
  {
    ...
    if (this.environment.current.text.pos == TextBlock.Position.BOTTOM)
    {
      ...
      {
        this.textTopBox[index].color = instance.UI_SPRITE_DISABLED_COLOR;
        this.textBottomBox[index].color = instance.UI_SPRITE_NORMAL_COLOR;
        this.myselfSprite[index].color = new Color(1f, 1f, 1f);
      }
      this.nameTopBox.color = instance.UI_SPRITE_DISABLED_COLOR;
      this.nameBottomLabel.color = new Color(1f, 1f, 1f);
      this.nameTopLabel.color = new Color(0.5f, 0.5f, 0.5f);
      this.nameBottomBox.color = instance.UI_SPRITE_NORMAL_COLOR;
      this.nextTopSprite.color = instance.UI_SPRITE_DISABLED_COLOR;
      this.nextBottomSprite.color = instance.UI_SPRITE_NORMAL_COLOR;
    }
    else
    {
      for (int index = 0; index < this.textTopBox.Length; ++index)
      {
        this.textTopBox[index].color = instance.UI_SPRITE_NORMAL_COLOR;
        this.textBottomBox[index].color = instance.UI_SPRITE_DISABLED_COLOR;
        this.myselfSprite[index].color = new Color(0.5f, 0.5f, 0.5f);
      }
      this.nameTopBox.color = instance.UI_SPRITE_NORMAL_COLOR;
      this.nameTopLabel.color = new Color(1f, 1f, 1f);
      this.nameBottomLabel.color = new Color(0.5f, 0.5f, 0.5f);
      this.nameBottomBox.color = instance.UI_SPRITE_NORMAL_COLOR;
      this.nextTopSprite.color = instance.UI_SPRITE_NORMAL_COLOR;
      this.nextBottomSprite.color = instance.UI_SPRITE_DISABLED_COLOR;
    }
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CInitBackGround\u003Ec__Iterator47B()
    {
      s = s,
      \u003C\u0024\u003Es = s,
      \u003C\u003Ef__this = this
...
label_11:
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CdelayStopSe\u003Ec__Iterator47C()
    {
      delay = delay,
      ch = ch,
      \u003C\u0024\u003Edelay = delay,
  ...
  public void StartSelect(SelectBlock sb)
  {
    ...
    for (int index = 0; index < 3; ++index)
    {
      if (index < sb.data.Count)
      {
        ...
        int id = 0;
        if (int.TryParse(sb.data[index].msg, out id))
        {
          this.SelectLabel[index].SetText(((IEnumerable<ScriptText>) MasterData.ScriptTextList).First<ScriptText>((Func<ScriptText, bool>) (x => x.ID == id)).Text);
        }
        else
        {
          Debug.LogError((object) ("ID以外が入ってました" + sb.data[index].msg));
          this.SelectLabel[index].SetText("ID以外が入ってました" + sb.data[index].msg);
        }
      }
    }
    if (sb.data.Count > 0)
  ...
  private void InitStartSelect()
  {
    foreach (GameObject gameObject in this.select)
    {
      ...
      {
        componentInChildren.color = Consts.GetInstance().UI_SPRITE_NORMAL_COLOR;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CShowStoryEffect\u003Ec__Iterator47D()
    {
      label = label,
      \u003C\u0024\u003Elabel = label
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CexecCoroutine\u003Ec__Iterator47E()
    {
      e = e,
      \u003C\u0024\u003Ee = e,
      \u003C\u003Ef__this = this
  ...
  public void setImageName(int id, string name)
  {
    ...
    else
    {
      ...
      ResourceManager.Load<Sprite>("AssetBundle/Resources/EventImages/" + name).RunOn<Sprite>((MonoBehaviour) this, (Action<Sprite>) (s =>
      {
