...
public class Story00910Menu : BackButtonMenuBase
{
  ...
  private IEnumerator API()
  {
    ...
    return (IEnumerator) new Story00910Menu.\u003CAPI\u003Ec__Iterator45B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story00910Menu.\u003CUsePrefab\u003Ec__Iterator45C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story00910Menu.\u003CCreateList\u003Ec__Iterator45D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story00910Menu.\u003CInitScene\u003Ec__Iterator45E()
    {
      \u003C\u003Ef__this = this
    };
  }
