...
public class NGDuelDataManager : Singleton<NGDuelDataManager>
{
  ...
  public IEnumerator createMapCache(BL.Stage stage, bool isColosseum)
  {
    ...
    return (IEnumerator) new NGDuelDataManager.\u003CcreateMapCache\u003Ec__Iterator69C()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelDataManager.\u003CcreateMap\u003Ec__Iterator69D()
    {
      stage = stage,
      isColosseum = isColosseum,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelDataManager.\u003CpreloadDuelUnitObject\u003Ec__Iterator69E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelDataManager.\u003CloadDefaultAnimatorController\u003Ec__Iterator69F()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit
    };
  ...
  {
    return this.cameraAnimator.ContainsKey(name) ? Future.Single<RuntimeAnimatorController>(this.cameraAnimator[name]) : ResourceManager.Load<RuntimeAnimatorController>(string.Format("Animators/Camera/{0}", (object) name)).Then<RuntimeAnimatorController>((Func<RuntimeAnimatorController, RuntimeAnimatorController>) (x =>
    {
