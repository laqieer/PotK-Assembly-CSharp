...
// Type: Facebook.Unity.Mobile.IOS.IOSWrapper
...
namespace Facebook.Unity.Mobile.IOS
{
  internal class IOSWrapper : IIOSWrapper
  {
    ...
    public void LogOut() => IOSWrapper.IOSLogOut();

    public void SetShareDialogMode(int mode) => IOSWrapper.IOSSetShareDialogMode(mode);
    ...
    public void FBSettingsActivateApp(string appId) => IOSWrapper.IOSFBSettingsActivateApp(appId);
    ...
    public void GetAppLink(int requestId) => IOSWrapper.IOSGetAppLink(requestId);

    public string FBSdkVersion() => IOSWrapper.IOSFBSdkVersion();
