...
namespace Facebook.Unity.Mobile.Android
{
  internal sealed class AndroidFacebook : MobileFacebook
  {
    ...
    public override string SDKName => "FBAndroidSDK";

    public override string SDKVersion => this.facebookJava.CallStatic<string>("GetSdkVersion");
    ...
    {
      this.CallFB("SetUserAgentSuffix", string.Format("Unity.{0}", (object) Constants.UnitySDKUserAgentSuffixLegacy));
      ...
      Dictionary<string, object> parameters)
    {
      ...
      new AndroidFacebook.JavaMethodCall<IResult>(this, "LogAppEvent").Call(args);
    }
    ...
    {
      AndroidFacebook.JavaMethodCall<IAccessTokenRefreshResult> javaMethodCall = new AndroidFacebook.JavaMethodCall<IAccessTokenRefreshResult>(this, nameof (RefreshCurrentAccessToken));
      javaMethodCall.Callback = callback;
      javaMethodCall.Call((MethodArguments) null);
    }
