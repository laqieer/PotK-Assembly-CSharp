...
public class Mypage0017Menu : BackButtonMenuBase
{
  ...
  public virtual void IbtnReceive()
  {
  }
  ...
  public IEnumerator Init(PlayerPresent[] presents)
  {
    ...
    return (IEnumerator) new Mypage0017Menu.\u003CInit\u003Ec__Iterator15D()
    {
      presents = presents,
      \u003C\u0024\u003Epresents = presents,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CUpdateList\u003Ec__Iterator15E()
    {
      presents = presents,
      \u003C\u0024\u003Epresents = presents,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CUnitOverPopup\u003Ec__Iterator15F()
    {
      haveUnit = haveUnit,
      player = player,
      \u003C\u0024\u003EhaveUnit = haveUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CItemOverPopup\u003Ec__Iterator160()
    {
      haveItem = haveItem,
      player = player,
      \u003C\u0024\u003EhaveItem = haveItem,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CLimitOverPopup\u003Ec__Iterator161()
    {
      str = str,
      \u003C\u0024\u003Estr = str
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CReceiveConnection\u003Ec__Iterator162()
    {
      present = present,
      \u003C\u0024\u003Epresent = present,
      \u003C\u003Ef__this = this
  ...
  private void IbtnReceive(PlayerPresent present)
  {
    ...
    if (present.reward_type_id.Value == 1)
    {
    ...
    else if (present.reward_type_id.Value == 19)
    {
      ...
      if (playerQuestKey != null)
      {
        ...
        if ((!nullable.HasValue ? 0 : (nullable.Value <= playerQuestKey.max_quantity ? 1 : 0)) == 0)
        {
          ...
          this.StartCoroutine(this.LimitOverPopup(Consts.Lookup("UNIQUE_ICON_KEY")));
          return;
        }
      }
      this.StartCoroutine(this.ReceiveConnection(present));
    ...
    else if (present.reward_type_id.Value == 4)
    {
      if (player.money + present.reward_quantity.Value <= Consts.GetInstance().MONEY_MAX)
        ...
        this.StartCoroutine(this.LimitOverPopup(Consts.Lookup("UNIQUE_ICON_ZENY")));
    }
    else if (present.reward_type_id.Value == 15)
    {
      if (player.friend_point + present.reward_quantity.Value <= Consts.GetInstance().FRIEND_POINT_MAX)
        ...
        this.StartCoroutine(this.LimitOverPopup(Consts.Lookup("UNIQUE_ICON_POINT")));
    }
    else if (present.reward_type_id.Value == 14)
    {
      if (player.medal + present.reward_quantity.Value <= Consts.GetInstance().MEDAL_MAX)
        ...
        this.StartCoroutine(this.LimitOverPopup(Consts.Lookup("UNIQUE_ICON_MEDAL")));
    }
    else
      this.StartCoroutine(this.ReceiveConnection(present));
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CHavePresentShow\u003Ec__Iterator163()
    {
      present = present,
      \u003C\u0024\u003Epresent = present,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CReceiveAll\u003Ec__Iterator164()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CDeleteAll\u003Ec__Iterator165()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CCreateScrollBase\u003Ec__Iterator166()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Mypage0017Menu.\u003CCreateScroll\u003Ec__Iterator167()
    {
