...
public class TutorialAdvice : MonoBehaviour
{
  ...
  private void setBackgroundPrefabs()
  {
    ...
    foreach (string background in this.getBackgrounds())
    {
      ...
      if (flag)
        ResourceManager.LoadOrNull<GameObject>(path).RunOn<GameObject>((MonoBehaviour) this, (Action<GameObject>) (prefab =>
        {
  ...
  private void setAnchor(GameObject root, string path)
  {
    ...
    for (int index = 0; index < transform.childCount; ++index)
    {
      ...
      if (Object.op_Inequality((Object) component, (Object) null))
      {
        ...
        Debug.LogError((object) ("SetAnchor widget was not found for path=" + path));
    }
  }
