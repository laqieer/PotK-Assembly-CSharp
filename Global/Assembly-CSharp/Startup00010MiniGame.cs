...
public class Startup00010MiniGame : MonoBehaviour
{
  ...
  private void OnPress(bool isDown)
  {
    if (isDown)
    {
      ...
      if (Object.op_Inequality((Object) Singleton<NGSoundManager>.GetInstance(), (Object) null))
        Singleton<NGSoundManager>.GetInstance().PlaySe("SE_0512", channel: 2, delayReinitialize: true);
      this.killEnemy();
      this.player.Attack();
    }
    else
  ...
  public IEnumerator BonusScoreCutin(int score)
  {
    ...
    return (IEnumerator) new Startup00010MiniGame.\u003CBonusScoreCutin\u003Ec__Iterator121()
    {
      score = score,
      \u003C\u0024\u003Escore = score,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Startup00010MiniGame.\u003CScoreCutin\u003Ec__Iterator122()
    {
      score = score,
      \u003C\u0024\u003Escore = score,
      \u003C\u003Ef__this = this
  ...
  private void Update()
  {
    ...
    if (StartupDownLoad.progress != null)
    {
      ...
      n = (float) StartupDownLoad.progress.Numerator;
    }
    this.dlc_gauge.SetTextLocalize(((int) (float) ((double) n / (double) max * 100.0)).ToString() + "％");
