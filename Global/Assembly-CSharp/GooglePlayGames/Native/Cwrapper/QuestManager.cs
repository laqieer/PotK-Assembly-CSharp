...
namespace GooglePlayGames.Native.Cwrapper
{
  internal static class QuestManager
  {
    ...
    internal static extern void QuestManager_FetchList(
      ...
      int fetch_flags,
      QuestManager.FetchListCallback callback,
      IntPtr callback_arg);
    ...
    internal static extern void QuestManager_Accept(
      HandleRef self,
      IntPtr quest,
      QuestManager.AcceptCallback callback,
      IntPtr callback_arg);

    [DllImport("gpg")]
    internal static extern void QuestManager_ShowAllUI(
      HandleRef self,
      QuestManager.QuestUICallback callback,
      IntPtr callback_arg);
    ...
    internal static extern void QuestManager_ClaimMilestone(
      HandleRef self,
      IntPtr milestone,
      QuestManager.ClaimMilestoneCallback callback,
      IntPtr callback_arg);
    ...
    internal static extern void QuestManager_Fetch(
      ...
      Types.DataSource data_source,
      string quest_id,
      QuestManager.FetchCallback callback,
      IntPtr callback_arg);
    ...
    [DllImport("gpg")]
    internal static extern CommonErrorStatus.ResponseStatus QuestManager_FetchResponse_GetStatus(
      HandleRef self);
    ...
    [DllImport("gpg")]
    internal static extern CommonErrorStatus.ResponseStatus QuestManager_FetchListResponse_GetStatus(
      HandleRef self);
    ...
    [DllImport("gpg")]
    internal static extern IntPtr QuestManager_FetchListResponse_GetData_GetElement(
      HandleRef self,
      UIntPtr index);
    ...
    [DllImport("gpg")]
    internal static extern CommonErrorStatus.QuestAcceptStatus QuestManager_AcceptResponse_GetStatus(
      HandleRef self);
    ...
    [DllImport("gpg")]
    internal static extern CommonErrorStatus.QuestClaimMilestoneStatus QuestManager_ClaimMilestoneResponse_GetStatus(
      HandleRef self);

    [DllImport("gpg")]
    internal static extern IntPtr QuestManager_ClaimMilestoneResponse_GetClaimedMilestone(
      HandleRef self);
    ...
    [DllImport("gpg")]
    internal static extern CommonErrorStatus.UIStatus QuestManager_QuestUIResponse_GetStatus(
      HandleRef self);
