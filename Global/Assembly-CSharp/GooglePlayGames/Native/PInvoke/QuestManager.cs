...
namespace GooglePlayGames.Native.PInvoke
{
  internal class QuestManager
  {
    ...
    internal void Fetch(
      ...
      string questId,
      Action<QuestManager.FetchResponse> callback)
    {
    ...
    internal void FetchList(
      Types.DataSource source,
      int fetchFlags,
      Action<QuestManager.FetchListResponse> callback)
    {
    ...
    internal void ClaimMilestone(
      NativeQuestMilestone milestone,
      Action<QuestManager.ClaimMilestoneResponse> callback)
    {
    ...
    internal class FetchResponse : BaseReferenceHolder
    {
      ...
      {
        return !this.RequestSucceeded() ? (NativeQuest) null : new NativeQuest(GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_FetchResponse_GetData(this.SelfPtr()));
      }
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (QuestManager.FetchResponse) null : new QuestManager.FetchResponse(pointer);
      }
    }
    ...
    internal class FetchListResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (QuestManager.FetchListResponse) null : new QuestManager.FetchListResponse(pointer);
      }
    }
    ...
    internal class ClaimMilestoneResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (QuestManager.ClaimMilestoneResponse) null : new QuestManager.ClaimMilestoneResponse(pointer);
      }
    }
    ...
    internal class AcceptResponse : BaseReferenceHolder
    {
      ...
      {
        return !this.RequestSucceeded() ? (NativeQuest) null : new NativeQuest(GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_AcceptResponse_GetAcceptedQuest(this.SelfPtr()));
      }
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (QuestManager.AcceptResponse) null : new QuestManager.AcceptResponse(pointer);
      }
    }
    ...
    internal class QuestUIResponse : BaseReferenceHolder
    {
      ...
      internal NativeQuestMilestone MilestoneToClaim()
      {
        if (!this.RequestSucceeded())
          return (NativeQuestMilestone) null;
        NativeQuestMilestone claim = new NativeQuestMilestone(GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_QuestUIResponse_GetMilestoneToClaim(this.SelfPtr()));
        if (claim.Valid())
          return claim;
        claim.Dispose();
        return (NativeQuestMilestone) null;
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (QuestManager.QuestUIResponse) null : new QuestManager.QuestUIResponse(pointer);
      }
    }
  }
}
