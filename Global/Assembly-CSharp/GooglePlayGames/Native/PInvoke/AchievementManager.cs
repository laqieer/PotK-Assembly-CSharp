...
namespace GooglePlayGames.Native.PInvoke
{
  internal class AchievementManager
  {
    ...
    internal void FetchAll(
      Action<AchievementManager.FetchAllResponse> callback)
    {
    ...
    internal class FetchResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (AchievementManager.FetchResponse) null : new AchievementManager.FetchResponse(pointer);
      }
    }
      ...
      IEnumerable<NativeAchievement>
    {
      ...
      {
        return index.ToUInt64() < this.Length().ToUInt64() ? new NativeAchievement(GooglePlayGames.Native.Cwrapper.AchievementManager.AchievementManager_FetchAllResponse_GetData_GetElement(this.SelfPtr(), index)) : throw new ArgumentOutOfRangeException();
      }
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (AchievementManager.FetchAllResponse) null : new AchievementManager.FetchAllResponse(pointer);
      }
    }
  }
}
