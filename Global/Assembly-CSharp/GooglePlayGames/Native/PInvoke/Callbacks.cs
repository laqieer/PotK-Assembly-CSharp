...
namespace GooglePlayGames.Native.PInvoke
{
  internal static class Callbacks
  {
    ...
    {
      return (object) callback == null ? IntPtr.Zero : GCHandle.ToIntPtr(GCHandle.Alloc((object) callback));
    }
    ...
    internal static void PerformInternalCallback(
      string callbackName,
    ...
    internal static void PerformInternalCallback<T>(
      string callbackName,
      Callbacks.Type callbackType,
      T param1,
      IntPtr param2,
