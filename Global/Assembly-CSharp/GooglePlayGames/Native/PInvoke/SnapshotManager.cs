...
namespace GooglePlayGames.Native.PInvoke
{
  internal class SnapshotManager
  {
    ...
    internal void FetchAll(
      ...
      Action<SnapshotManager.FetchAllResponse> callback)
    {
    ...
    internal void SnapshotSelectUI(
      ...
      uint maxSnapshots,
      string uiTitle,
      Action<SnapshotManager.SnapshotSelectUIResponse> callback)
    {
    ...
    internal void Open(
      ...
      Action<SnapshotManager.OpenResponse> callback)
    {
    ...
    internal void Commit(
      NativeSnapshotMetadata metadata,
      NativeSnapshotMetadataChange metadataChange,
      byte[] updatedData,
      Action<SnapshotManager.CommitResponse> callback)
    {
    ...
    internal void Read(
      NativeSnapshotMetadata metadata,
      Action<SnapshotManager.ReadResponse> callback)
    {
      Misc.CheckNotNull<NativeSnapshotMetadata>(metadata);
    ...
    internal class OpenResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (SnapshotManager.OpenResponse) null : new SnapshotManager.OpenResponse(pointer);
      }
    }
    ...
    internal class FetchAllResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (SnapshotManager.FetchAllResponse) null : new SnapshotManager.FetchAllResponse(pointer);
      }
    }
    ...
    internal class CommitResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (SnapshotManager.CommitResponse) null : new SnapshotManager.CommitResponse(pointer);
      }
    }
    ...
    internal class ReadResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (SnapshotManager.ReadResponse) null : new SnapshotManager.ReadResponse(pointer);
      }
    }
    ...
    internal class SnapshotSelectUIResponse : BaseReferenceHolder
    {
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (SnapshotManager.SnapshotSelectUIResponse) null : new SnapshotManager.SnapshotSelectUIResponse(pointer);
      }
    }
  }
}
