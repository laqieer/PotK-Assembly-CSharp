...
namespace GooglePlayGames.Native.PInvoke
{
  internal class NearbyConnectionsManager : BaseReferenceHolder
  {
    ...
    internal void StartAdvertising(
      string name,
    ...
    internal void SendConnectionRequest(
      ...
      byte[] payload,
      Action<long, NativeConnectionResponse> callback,
    ...
    private static void InternalConnectResponseCallback(
      long localClientId,
      IntPtr response,
      IntPtr userData)
    {
    ...
    internal void AcceptConnectionRequest(
      string remoteEndpointId,
      byte[] payload,
      NativeMessageListenerHelper listener)
    {
    ...
    internal void StopAllConnections() => NearbyConnections.NearbyConnections_Stop(this.SelfPtr());
    ...
    internal void Shutdown() => NearbyConnections.NearbyConnections_Stop(this.SelfPtr());
    ...
    public string AppBundleId
    {
      get
      {
        using (AndroidJavaClass androidJavaClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
          return ((AndroidJavaObject) androidJavaClass).GetStatic<AndroidJavaObject>("currentActivity").Call<string>("getPackageName", new object[0]);
      }
    }
    ...
    internal static string ReadServiceId()
    {
      ...
      using (AndroidJavaClass androidJavaClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
      {
        ...
        {
          string str1 = androidJavaObject.Call<string>("getPackageName", new object[0]);
          string str2 = androidJavaObject.Call<AndroidJavaObject>("getPackageManager", new object[0]).Call<AndroidJavaObject>("getApplicationInfo", new object[2]
          {
            (object) str1,
            (object) 128
          }).Get<AndroidJavaObject>("metaData").Call<string>("getString", new object[1]
          {
    ...
    public static string ServiceId => NearbyConnectionsManager.sServiceId;
  }
}
