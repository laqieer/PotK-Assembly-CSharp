...
namespace GooglePlayGames.Native.PInvoke
{
  internal class TurnBasedManager
  {
    ...
    internal TurnBasedManager(GameServices services) => this.mGameServices = services;

    internal void GetMatch(
      string matchId,
      Action<TurnBasedManager.TurnBasedMatchResponse> callback)
    {
    ...
    internal void GetAllTurnbasedMatches(
      Action<TurnBasedManager.TurnBasedMatchesResponse> callback)
    {
    ...
    internal void TakeTurn(
      ...
      byte[] data,
      MultiplayerParticipant nextParticipant,
      Action<TurnBasedManager.TurnBasedMatchResponse> callback)
    {
    ...
    internal void ShowInboxUI(
      Action<TurnBasedManager.MatchInboxUIResponse> callback)
    {
    ...
    internal static void InternalMultiplayerStatusCallback(
      CommonErrorStatus.MultiplayerStatus status,
      IntPtr data)
    {
    ...
    internal void LeaveDuringMyTurn(
      NativeTurnBasedMatch match,
      MultiplayerParticipant nextParticipant,
    ...
    internal void FinishMatchDuringMyTurn(
      NativeTurnBasedMatch match,
      byte[] data,
    ...
    internal void ConfirmPendingCompletion(
      NativeTurnBasedMatch match,
      Action<TurnBasedManager.TurnBasedMatchResponse> callback)
    {
    ...
    internal void LeaveMatchDuringTheirTurn(
      NativeTurnBasedMatch match,
      Action<CommonErrorStatus.MultiplayerStatus> callback)
    {
    ...
    internal class MatchInboxUIResponse : BaseReferenceHolder
    {
      ...
      {
        return this.UiStatus() != CommonErrorStatus.UIStatus.VALID ? (NativeTurnBasedMatch) null : new NativeTurnBasedMatch(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_MatchInboxUIResponse_GetMatch(this.SelfPtr()));
      }
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (TurnBasedManager.MatchInboxUIResponse) null : new TurnBasedManager.MatchInboxUIResponse(pointer);
      }
    }
    ...
    internal class TurnBasedMatchResponse : BaseReferenceHolder
    {
      ...
      internal NativeTurnBasedMatch Match()
      {
        return !this.RequestSucceeded() ? (NativeTurnBasedMatch) null : new NativeTurnBasedMatch(TurnBasedMultiplayerManager.TurnBasedMultiplayerManager_TurnBasedMatchResponse_GetMatch(this.SelfPtr()));
      }
      ...
      {
        return pointer.Equals((object) IntPtr.Zero) ? (TurnBasedManager.TurnBasedMatchResponse) null : new TurnBasedManager.TurnBasedMatchResponse(pointer);
      }
    }
    ...
    internal class TurnBasedMatchesResponse : BaseReferenceHolder
    {
      ...
      {
        return PInvokeUtilities.IsNull(pointer) ? (TurnBasedManager.TurnBasedMatchesResponse) null : new TurnBasedManager.TurnBasedMatchesResponse(pointer);
      }
    }
