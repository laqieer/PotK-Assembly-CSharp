...
namespace GooglePlayGames.Native
{
  public class NativeTurnBasedMultiplayerClient : ITurnBasedMultiplayerClient
  {
    ...
    public void CreateQuickMatch(
      ...
      uint maxOpponents,
      uint variant,
      Action<bool, GooglePlayGames.BasicApi.Multiplayer.TurnBasedMatch> callback)
    {
    ...
    public void CreateWithInvitationScreen(
      ...
      uint maxOpponents,
      uint variant,
      Action<GooglePlayGames.BasicApi.UIStatus, GooglePlayGames.BasicApi.Multiplayer.TurnBasedMatch> callback)
    {
    ...
    private Action<TurnBasedManager.TurnBasedMatchResponse> BridgeMatchToUserCallback(
      Action<GooglePlayGames.BasicApi.UIStatus, GooglePlayGames.BasicApi.Multiplayer.TurnBasedMatch> userCallback)
    {
    ...
    internal void HandleMatchEvent(
      ...
      NativeTurnBasedMatch match)
    {
      ...
      else
      {
        ...
        match.ReferToMe();
        Callbacks.AsCoroutine(this.WaitForLogin((Action) (() =>
        {
    ...
    private IEnumerator WaitForLogin(Action method)
    {
      ...
      return (IEnumerator) new NativeTurnBasedMultiplayerClient.\u003CWaitForLogin\u003Ec__Iterator10E()
      {
        method = method,
        \u003C\u0024\u003Emethod = method,
        \u003C\u003Ef__this = this
    ...
    private void FindEqualVersionMatch(
      GooglePlayGames.BasicApi.Multiplayer.TurnBasedMatch match,
    ...
    private void FindEqualVersionMatchWithParticipant(
      GooglePlayGames.BasicApi.Multiplayer.TurnBasedMatch match,
      string participantId,
      Action<bool> onFailure,
      Action<GooglePlayGames.Native.PInvoke.MultiplayerParticipant, NativeTurnBasedMatch> onFoundParticipantAndMatch)
    {
    ...
    public int GetMaxMatchDataSize() => throw new NotImplementedException();
