...
namespace GooglePlayGames.Android
{
  internal class AndroidTokenClient : TokenClient
  {
    ...
    public AndroidTokenClient(string playerId) => this.playerId = playerId;
      ...
      Action<int, string, string, string> callback)
    {
      ...
      try
      {
        using (AndroidJavaClass androidJavaClass = new AndroidJavaClass("com.google.games.bridge.TokenFragment"))
        {
          ...
          {
            IntPtr staticMethodId = AndroidJNI.GetStaticMethodID(((AndroidJavaObject) androidJavaClass).GetRawClass(), "fetchToken", "(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;ZZZLjava/lang/String;)Lcom/google/android/gms/common/api/PendingResult;");
    ...
    public string GetEmail() => this.GetAccountName((Action<CommonStatusCodes, string>) null);
