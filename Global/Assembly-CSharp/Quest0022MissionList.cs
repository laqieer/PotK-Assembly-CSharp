...
public class Quest0022MissionList : MonoBehaviour
{
  ...
  public IEnumerator SetValue(QuestStoryMission story, bool clearFlag)
  {
    ...
    return (IEnumerator) new Quest0022MissionList.\u003CSetValue\u003Ec__Iterator1EA()
    {
      story = story,
      clearFlag = clearFlag,
      \u003C\u0024\u003Estory = story,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0022MissionList.\u003CSetValue\u003Ec__Iterator1EB()
    {
      extra = extra,
      clearFlag = clearFlag,
      \u003C\u0024\u003Eextra = extra,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0022MissionList.\u003CSetValue\u003Ec__Iterator1EC()
    {
  ...
  public void InitEffects()
  {
    if (!this.IsClear)
      return;
    this.LinkPrefab.GetComponent<UIWidget>().color = Consts.GetInstance().UI_SPRITE_NORMAL_COLOR;
