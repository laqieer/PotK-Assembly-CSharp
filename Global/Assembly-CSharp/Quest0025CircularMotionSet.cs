...
public class Quest0025CircularMotionSet : MonoBehaviour
{
  ...
  public virtual void SetValue()
  {
    ...
    this.MotionTargets.Where<Transform>((Func<Transform, bool>) (x => !((Component) x).GetComponent<Quest0025SlidePanelDragged>().Release)).ForEach<Transform>((Action<Transform>) (x =>
    {
      ((IEnumerable<UISprite>) ((Component) x).GetComponentsInChildren<UISprite>()).ForEach<UISprite>((Action<UISprite>) (y => y.color = PunkColor.button_off));
      ((IEnumerable<UILabel>) ((Component) x).GetComponentsInChildren<UILabel>()).ForEach<UILabel>((Action<UILabel>) (y => y.color = Color.gray));
    }));
  ...
  private IEnumerator setBackGroundPrefab()
  {
    ...
    Quest0025CircularMotionSet.\u003CsetBackGroundPrefab\u003Ec__Iterator227 prefabCIterator227 = new Quest0025CircularMotionSet.\u003CsetBackGroundPrefab\u003Ec__Iterator227();
    return (IEnumerator) prefabCIterator227;
  }
