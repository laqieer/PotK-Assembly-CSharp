...
public class Battle0171111Event : BattleMonoBehaviour
{
  ...
  private IEnumerator setIcons()
  {
    ...
    return (IEnumerator) new Battle0171111Event.\u003CsetIcons\u003Ec__Iterator674()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void setRemainTurn(int turn)
  {
    ...
    this.label_RemainTurn.SetTextLocalize(Consts.Lookup("AILMENT_REMAINTURN", (IDictionary) new Hashtable()
    {
      {
        (object) nameof (turn),
        (object) turn
