...
public class Quest00227Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Initialize(QuestScoreCampaignProgress qscp)
  {
    ...
    return (IEnumerator) new Quest00227Menu.\u003CInitialize\u003Ec__Iterator209()
    {
      qscp = qscp,
      \u003C\u0024\u003Eqscp = qscp,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00227Menu.\u003CLoadResources\u003Ec__Iterator20A()
    {
      \u003C\u003Ef__this = this
    };
  }
    ...
    int index = 0)
  {
    ...
    switch (type)
    {
      ...
      case Quest00227Menu.BarType.Ranking:
        ...
        EventDelegate.Add(componentInChildren1.onClick, (EventDelegate.Callback) (() => Quest002271Scene.ChangeScene(true, progress, Consts.Lookup("QUEST_00227_RANKING_BARNAME"), rank)));
        componentInChildren2.SetTextLocalize(Consts.Lookup("QUEST_00227_RANKING_BARNAME"));
        break;
    }
  }
