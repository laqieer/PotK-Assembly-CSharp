...
public class ResourceInfo : IEnumerable, IEnumerable<ResourceInfo.Resource>
{
  ...
  public IEnumerator<ResourceInfo.Resource> GetEnumerator()
  {
    ...
    return (IEnumerator<ResourceInfo.Resource>) new ResourceInfo.\u003CGetEnumerator\u003Ec__Iterator946()
    {
      \u003C\u003Ef__this = this
    };
  }
    ...
    public void Set(KeyValuePair<string, object> info)
    {
      ...
      foreach (KeyValuePair<string, object> keyValuePair1 in (Dictionary<string, object>) info.Value)
      {
        ...
        if (key1 != null)
        {
          ...
          if (ResourceInfo.Resource.\u003C\u003Ef__switch\u0024map28 == null)
          {
            // ISSUE: reference to a compiler-generated field
            ResourceInfo.Resource.\u003C\u003Ef__switch\u0024map28 = new Dictionary<string, int>(16)
            {
              {
                "store_size",
                0
          ...
          int num1;
          // ISSUE: reference to a compiler-generated field
          if (ResourceInfo.Resource.\u003C\u003Ef__switch\u0024map28.TryGetValue(key1, out num1))
          {
            switch (num1)
            {
              case 0:
                    ...
                    while (enumerator1.MoveNext())
                    {
                      foreach (KeyValuePair<string, object> keyValuePair2 in (Dictionary<string, object>) enumerator1.Current)
                      {
                        ...
                        if (key2 != null)
                        {
                          ...
                          {
                            // ISSUE: reference to a compiler-generated field
                            ResourceInfo.Resource.\u003C\u003Ef__switch\u0024map27 = new Dictionary<string, int>(6)
                            {
                              {
                                "type",
                                0
                          ...
                          int num2;
                          // ISSUE: reference to a compiler-generated field
                          if (ResourceInfo.Resource.\u003C\u003Ef__switch\u0024map27.TryGetValue(key2, out num2))
                          {
                            switch (num2)
                            {
                              case 0:
  ...
  private sealed class Parser : IDisposable
  {
    ...
    public IEnumerable<KeyValuePair<string, object>> ParseObjectEnum()
    {
      ...
      ResourceInfo.Parser.\u003CParseObjectEnum\u003Ec__Iterator947 objectEnum = new ResourceInfo.Parser.\u003CParseObjectEnum\u003Ec__Iterator947()
      {
        \u003C\u003Ef__this = this
      };
      // ISSUE: reference to a compiler-generated field
              ...
              default:
                switch (peekChar)
                {
                  ...
                  default:
                    ...
                    if (nextWord != null)
                    {
                      if (ResourceInfo.Parser.\u003C\u003Ef__switch\u0024map29 == null)
                        ResourceInfo.Parser.\u003C\u003Ef__switch\u0024map29 = new Dictionary<string, int>(3)
                        {
                          {
                            "false",
                            0
                      ...
                      int num;
                      if (ResourceInfo.Parser.\u003C\u003Ef__switch\u0024map29.TryGetValue(nextWord, out num))
                      {
                        switch (num)
                        {
                          case 0:
