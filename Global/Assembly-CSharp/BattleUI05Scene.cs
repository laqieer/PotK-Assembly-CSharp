...
public class BattleUI05Scene : NGSceneBase
{
  ...
  public static void ReturnQuestScene(BattleInfo info, bool isWin, BattleEnd result)
  {
    switch (info.quest_type)
    {
      ...
      case CommonQuestType.Harmony:
        Quest00214Scene.ChangeScene(false, true);
        break;
      default:
  ...
  public IEnumerator onStartSceneAsync(BattleInfo info, bool isWin, BattleEnd result)
  {
    ...
    return (IEnumerator) new BattleUI05Scene.\u003ConStartSceneAsync\u003Ec__Iterator772()
    {
      info = info,
      result = result,
      isWin = isWin,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05Scene.\u003CsetBackGround\u003Ec__Iterator773()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05Scene.\u003CInitMenus\u003Ec__Iterator774()
    {
      info = info,
      result = result,
      \u003C\u0024\u003Einfo = info,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05Scene.\u003CRunMenus\u003Ec__Iterator775()
    {
      info = info,
      isWin = isWin,
      result = result,
