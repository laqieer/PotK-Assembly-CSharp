...
public class Shop0574Scroll : MonoBehaviour
{
  ...
  private IEnumerator SetThumbnail(EarthShopContent content)
  {
    ...
    return (IEnumerator) new Shop0574Scroll.\u003CSetThumbnail\u003Ec__Iterator649()
    {
      content = content,
      \u003C\u0024\u003Econtent = content,
      \u003C\u003Ef__this = this
  ...
  private void SetLimit(EarthShopArticle article)
  {
    ...
    if (article.limit.HasValue)
    {
      ...
      this.txtQuantity20.SetTextLocalize(string.Format(Consts.Lookup("SHOP_0074_SCROLL_ARTICLE_LIMIT_VALUE"), (object) (article.limit.Value - num2)));
    }
    else
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0574Scroll.\u003CInit\u003Ec__Iterator64A()
    {
      action = action,
