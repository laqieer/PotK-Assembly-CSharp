...
public class BattleStateController : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Original()
  {
    ...
    return (IEnumerator) new BattleStateController.\u003CStart_Original\u003Ec__Iterator835()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleStateController.\u003CStart_Battle\u003Ec__Iterator836()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void doExecuteSkillEffects(BL.UnitPosition up, BL.ExecuteSkillEffectResult es)
  {
    ...
    this.battleManager.battleEffects.skillFieldEffectStartCore(passiveEffect, up.unit, targets, effectPrefab, targetEffectPrefab, (System.Action) (() =>
    {
  ...
  private void doExecuteCompletedSkillEffects(BL.UnitPosition up, BL.ExecuteSkillEffectResult es)
  {
    ...
    else
    {
      ...
      this.battleManager.battleEffects.skillFieldEffectStartCore(passiveEffect, (BL.Unit) null, targets, effectPrefab, targetEffectPrefab, targetAction: (System.Action) (() =>
      {
        for (int index = 0; index < es.targets.Count; ++index)
          this.dispHpNumberAnime(es.targets[index].unit, es.target_prev_hps[index], es.target_hps[index]);
      }));
  ...
  private bool deadCheck()
  {
    ...
    {
      this.btm.setPhaseState(BL.Phase.stageclear, true);
      return true;
    }
  ...
  public void spawnUnit(BL.Panel panel, BL.UnitPosition up)
  {
    ...
    BattleLandformEffectPhase phase)
  {
    this.btm.setScheduleAction((System.Action) (() =>
    {
      ...
      this.btm.setScheduleAction((System.Action) (() => this.uiNode.hpCheckWithDeadEffects(up.unit)), isInsertMode: true);
    }), isInsertMode: true);
    return false;
  }
  ...
  protected override void LateUpdate_Battle()
  {
    ...
    switch (state)
    {
      ...
      case BL.Phase.player_start_post:
        List<BL.Story> sl1 = this.env.core.getStoryOffense(this.env.core.phaseState.turnCount);
      ...
      case BL.Phase.enemy_start_post:
        List<BL.Story> sl2 = this.env.core.getStoryDefense(this.env.core.phaseState.turnCount);
      ...
      default:
        switch (state - 41)
        {
          ...
          case BL.Phase.neutral_start | BL.Phase.enemy_end:
            ...
            ModalWindow.ShowYesNo(Consts.Lookup("VERSUS_02694POPUP_TITLE"), this.pvpManager.getErrorMessage(this.pvpManager.exception), (System.Action) (() => this.pvpManager.errorRecovery()), (System.Action) (() => this.btm.setPhaseState(BL.Phase.finalize)));
            this.btm.setPhaseState(BL.Phase.none);
            return;
          default:
  ...
  private class EffectAIWait : ScheduleEnumerator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleStateController.EffectAIWait.\u003CdoBody\u003Ec__Iterator837()
      {
        \u003C\u003Ef__this = this
      };
    }
  ...
  private class PvpMatchEffect : BattleEffects.CloneEnumlator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleStateController.PvpMatchEffect.\u003CdoBody\u003Ec__Iterator83B()
      {
        o = o,
        \u003C\u0024\u003Eo = o,
        \u003C\u003Ef__this = this
