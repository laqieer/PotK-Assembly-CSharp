...
public class Friend00810Menu : BackButtonMenuBase
{
  ...
  private IEnumerator BackSceneAsync()
  {
    ...
    return (IEnumerator) new Friend00810Menu.\u003CBackSceneAsync\u003Ec__Iterator423()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    DeviceManager.OpenUrl(Consts.Lookup("INVITE_CAMPAIGN_BANNER_URL") + SMManager.Get<Player>().short_id);
  }
  ...
  private IEnumerator openPopup008161()
  {
    ...
    Friend00810Menu.\u003CopenPopup008161\u003Ec__Iterator424 popup008161CIterator424 = new Friend00810Menu.\u003CopenPopup008161\u003Ec__Iterator424();
    return (IEnumerator) popup008161CIterator424;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend00810Menu.\u003CSearchUser\u003Ec__Iterator425()
    {
      short_id = short_id,
      \u003C\u0024\u003Eshort_id = short_id,
      \u003C\u003Ef__this = this
  ...
  private IEnumerator openPopup00812()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    Friend00810Menu.\u003CopenPopup00812\u003Ec__Iterator426 popup00812CIterator426 = new Friend00810Menu.\u003CopenPopup00812\u003Ec__Iterator426();
    return (IEnumerator) popup00812CIterator426;
  }
