...
namespace GameCore
{
    ...
    IEnumerable<KeyValuePair<TKey, TValue>>
  {
    ...
    public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator()
    {
      ...
      return (IEnumerator<KeyValuePair<TKey, TValue>>) new AssocList<TKey, TValue>.\u003CGetEnumerator\u003Ec__Iterator25()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    private void EnsureCapacity(int min)
    {
      if (min <= this.keys.Length)
        return;
      int num = this.keys.Length != 0 ? this.keys.Length * 2 : 4;
      while (num < min)
        num *= 2;
      this.Capacity = num;
    }
    ...
    private class DictEnum : IEnumerator, IDictionaryEnumerator
    {
      ...
      {
        get => new DictionaryEntry((object) this.e.Current.Key, (object) this.e.Current.Value);
      }
    }
  }
}
