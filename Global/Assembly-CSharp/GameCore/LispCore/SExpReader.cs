  ...
  public class SExpReader
  {
    ...
    private int readObj(int p)
    {
      ...
      if (key != null)
      {
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (SExpReader.\u003C\u003Ef__switch\u0024mapF.TryGetValue(key, out num))
        {
          if (num == 0)
...
label_5:
    ...
    private bool numberp(string c, bool is_first)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          SExpReader.\u003C\u003Ef__switch\u0024map10 = new Dictionary<string, int>(12)
          {
            {
              "0",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (SExpReader.\u003C\u003Ef__switch\u0024map10.TryGetValue(key, out num))
        {
          if (num == 0)
            return true;
          if (num == 1)
    ...
    private bool punctp(string c)
    {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (SExpReader.\u003C\u003Ef__switch\u0024map11 == null)
        {
          // ISSUE: reference to a compiler-generated field
          SExpReader.\u003C\u003Ef__switch\u0024map11 = new Dictionary<string, int>(2)
          {
            {
              "(",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (SExpReader.\u003C\u003Ef__switch\u0024map11.TryGetValue(key, out num) && num == 0)
          return true;
      }
      return false;
    }
    ...
    private bool whiteSpacep(string c)
    {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (SExpReader.\u003C\u003Ef__switch\u0024map12 == null)
        {
          // ISSUE: reference to a compiler-generated field
          SExpReader.\u003C\u003Ef__switch\u0024map12 = new Dictionary<string, int>(6)
          {
            {
              " ",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (SExpReader.\u003C\u003Ef__switch\u0024map12.TryGetValue(key, out num) && num == 0)
          return true;
      }
      return false;
    }
