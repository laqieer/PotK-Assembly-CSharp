...
namespace GameCore
{
  public class BattleLogicInitializer
  {
      ...
      BL env)
    {
      ...
      return (IEnumerator) new BattleLogicInitializer.\u003CcreateEnemyUnits\u003Ec__Iterator1C()
      {
        info = info,
        env = env,
        enemies = enemies,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleLogicInitializer.\u003CinitializeWave\u003Ec__Iterator1D()
      {
        info = info,
        wave = wave,
        env = env,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleLogicInitializer.\u003CcreateUnitPositions\u003Ec__Iterator1E()
      {
        info = info,
        players = players,
        env = env,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleLogicInitializer.\u003CinitializeData\u003Ec__Iterator1F()
      {
        env = env,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleLogicInitializer.\u003CdoStart\u003Ec__Iterator20()
      {
        battleInfo = battleInfo,
        env = env,
        \u003C\u0024\u003EbattleInfo = battleInfo,
