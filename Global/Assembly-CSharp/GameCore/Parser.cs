...
namespace GameCore
{
  public class Parser
  {
    ...
    private string[] battle_var = new string[4]
    {
      "sum_own",
      "sum_enemy",
      "own_team_can_attacked",
      "turn"
    };
    ...
    private INode cond()
    {
      ...
      this.lex.Skip(",");
      INode left2 = this.exp();
      this.lex.Skip(",");
      INode right2 = this.exp();
      return (INode) new If(new Cond(operand, left1, right1), left2, right2);
    }
