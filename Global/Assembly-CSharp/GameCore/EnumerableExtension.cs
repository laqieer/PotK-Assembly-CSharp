...
namespace GameCore
{
  public static class EnumerableExtension
  {
      ...
      Func<T1, T2, TResult> func)
    {
      ...
      EnumerableExtension.\u003CSelect\u003Ec__Iterator27<T1, T2, TResult> selectCIterator27 = new EnumerableExtension.\u003CSelect\u003Ec__Iterator27<T1, T2, TResult>()
      {
        source1 = source1,
        source2 = source2,
        func = func,
      ...
      selectCIterator27.\u0024PC = -2;
      return (IEnumerable<TResult>) selectCIterator27;
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EnumerableExtension.\u003CWaitAll\u003Ec__Iterator28()
      {
        self = self,
        \u003C\u0024\u003Eself = self
      };
    ...
    public static IEnumerable<T> Shuffle<T>(this IEnumerable<T> self, Random random)
    {
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      EnumerableExtension.\u003CShuffle\u003Ec__Iterator29<T> shuffleCIterator29 = new EnumerableExtension.\u003CShuffle\u003Ec__Iterator29<T>()
      {
        self = self,
        random = random,
        \u003C\u0024\u003Eself = self,
      ...
      // ISSUE: reference to a compiler-generated field
      shuffleCIterator29.\u0024PC = -2;
      return (IEnumerable<T>) shuffleCIterator29;
    }
  }
}
