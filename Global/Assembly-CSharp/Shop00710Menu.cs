...
public class Shop00710Menu : BackButtonMenuBase
{
    ...
    string kisekiNum)
  {
    ...
    return (IEnumerator) new Shop00710Menu.\u003CInit\u003Ec__Iterator3C6()
    {
      spr = spr,
      title = title,
      kisekiNum = kisekiNum,
  ...
  public void SetText(string title, string kisekiNum)
  {
    ...
    this.TxtDescription01.SetTextLocalize(this.itemTitle + kisekiNum + Consts.Lookup("SHOP_00710_MENU"));
    this.TxtDescription02.SetText(Consts.Lookup("SHOP_00710_TXT_DESCRIPTION02"));
