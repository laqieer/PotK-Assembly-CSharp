...
public class Invite0131Menu : BackButtonMenuBase
{
  ...
  private IEnumerator openPopup00132()
  {
    ...
    Invite0131Menu.\u003CopenPopup00132\u003Ec__Iterator4CB popup00132CIterator4Cb = new Invite0131Menu.\u003CopenPopup00132\u003Ec__Iterator4CB();
    return (IEnumerator) popup00132CIterator4Cb;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Invite0131Menu.\u003CopenPopup00135\u003Ec__Iterator4CC()
    {
      str = str,
      \u003C\u0024\u003Estr = str
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Invite0131Menu.\u003CInvitationAcceptAscync\u003Ec__Iterator4CD()
    {
      \u003C\u003Ef__this = this
    };
  }
