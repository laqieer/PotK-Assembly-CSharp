...
public class Quest00240723Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(PlayerStoryQuestS[] StoryData, int ChoiceLnum, bool reStart = false)
  {
    ...
    return (IEnumerator) new Quest00240723Menu.\u003CInit\u003Ec__Iterator219()
    {
      StoryData = StoryData,
      reStart = reStart,
  ...
  public static bool IsBeginnerSupport()
  {
    Player player = SMManager.Get<Player>();
    return player.level <= 20 && player.GetNewbie();
  }
  ...
  private Future<GameObject> GetPassStoryBtnObj(int id)
  {
    ...
    return Singleton<ResourceManager>.GetInstance().Contains(path) ? ResourceManager.Load<GameObject>(path) : ResourceManager.Load<GameObject>("Prefabs/quest002_4/story_btns/_1/Story_btn");
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00240723Menu.\u003CStoryChoiceButtonSetting\u003Ec__Iterator21A()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00240723Menu.\u003CSwitchModeInitialze\u003Ec__Iterator21B()
    {
      StoryData = StoryData,
      passdata = passdata,
      reStart = reStart,
