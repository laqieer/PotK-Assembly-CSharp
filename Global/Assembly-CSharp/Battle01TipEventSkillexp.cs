...
public class Battle01TipEventSkillexp : Battle01TipEventBase
{
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    return (IEnumerator) new Battle01TipEventSkillexp.\u003ConInitAsync\u003Ec__Iterator725()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01TipEventSkillexp.\u003CdoSetIcon\u003Ec__Iterator726()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  public override void setData(BL.DropData e, BL.Unit unit)
  {
    if (e.reward.Type != MasterDataTable.CommonRewardType.gear_experience_point)
      return;
    this.setText(Consts.Lookup("TipEvent_text_skillexp", (IDictionary) new Dictionary<string, string>()
    {
