...
public class CRISoundManager : Singleton<CRISoundManager>
{
  ...
  private IEnumerator Fade(CriAtomSource audio, float v0, float v1, float duration, float delay = 0.0f)
  {
    ...
    return (IEnumerator) new CRISoundManager.\u003CFade\u003Ec__Iterator8D8()
    {
      delay = delay,
      audio = audio,
      duration = duration,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new CRISoundManager.\u003CBgmCrossFade\u003Ec__Iterator8D9()
    {
      delay = delay,
      duration = duration,
      audio = audio,
...
label_5:
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new CRISoundManager.\u003CdelayPlay\u003Ec__Iterator8DA()
    {
      delay = delay,
      audio = audio,
      \u003C\u0024\u003Edelay = delay,
