...
public class Popup0063SheetMenu : BackButtonMenuBase
{
    ...
    GachaG007PlayerSheet sheetData)
  {
    ...
    return (IEnumerator) new Popup0063SheetMenu.\u003CInit\u003Ec__Iterator7BE()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CInit\u003Ec__Iterator7BF()
    {
      sheetData = sheetData,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CStartSelEffect\u003Ec__Iterator7C0()
    {
      panels = panels,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CShowSheetResetPopup\u003Ec__Iterator7C1()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CShowDetaiPopup\u003Ec__Iterator7C2()
    {
      type = type,
      id = id,
      \u003C\u0024\u003Etype = type,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CGetItemEffect\u003Ec__Iterator7C3()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CSheetCompleteEffect\u003Ec__Iterator7C4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CSheetResetPopup\u003Ec__Iterator7C5()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CSheetReset\u003Ec__Iterator7C6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup0063SheetMenu.\u003CUpdateSheetPanel\u003Ec__Iterator7C7()
    {
      \u003C\u003Ef__this = this
    };
  }
