...
public class ItemIcon : IconPrefabBase
{
  ...
  {
    get => this.supply.quantity.activeSelf;
    set => this.supply.quantity.SetActive(value);
  }
  ...
  {
    get => this.supply.selectQuantity.activeSelf;
    set => this.supply.selectQuantity.SetActive(value);
  }
  ...
  public IEnumerator InitByPlayerItem(PlayerItem playerItem)
  {
    ...
    return (IEnumerator) new ItemIcon.\u003CInitByPlayerItem\u003Ec__Iterator90C()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ItemIcon.\u003CInitBySupplyItem\u003Ec__Iterator90D()
    {
  ...
  private void initManaseedsInfo(PlayerItem playerItem)
  {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ItemIcon.\u003CInitByGear\u003Ec__Iterator90E()
    {
      gear = gear,
      element = element,
      \u003C\u0024\u003Egear = gear,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ItemIcon.\u003CInitForEquipGear\u003Ec__Iterator90F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ItemIcon.\u003CInitBySupply\u003Ec__Iterator910()
    {
      supply = supply,
      \u003C\u0024\u003Esupply = supply,
      \u003C\u003Ef__this = this
  ...
  public void InitBySupplyCache(SupplySupply supply)
  {
    ...
    this.supply.selectQuantity.SetActive(false);
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ItemIcon.\u003CLoadSprite\u003Ec__Iterator911()
    {
      playerItem = playerItem,
      \u003C\u0024\u003EplayerItem = playerItem
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ItemIcon.\u003CLoadSprite\u003Ec__Iterator912()
    {
      supply = supply,
      \u003C\u0024\u003Esupply = supply
    };
  ...
  public void EnableQuantity(int quantity)
  {
    ...
    {
      this.supply.rightNum[index3].SetActive(false);
      this.supply.leftNum[index3].SetActive(false);
    }
    this.supply.rightNum[index1].SetActive(true);
    if (index2 != 0)
    {
      this.supply.leftNum[index2].SetActive(true);
      this.supply.equals.transform.localPosition = this.supply.equalsPos.localPosition;
    }
    else
    {
      this.supply.leftNum[index2].SetActive(false);
      this.supply.equals.transform.localPosition = ((Component) this.supply.leftNum[0].transform.parent).transform.localPosition;
    }
  ...
  public void SelectedQuantity(int quantity)
  {
    ...
    for (int index3 = 0; index3 <= 9; ++index3)
    {
      this.supply.selectedRightNum[index3].SetActive(false);
      this.supply.selectedLeftNum[index3].SetActive(false);
    }
    this.supply.selectedRightNum[index1].SetActive(true);
    if (index2 != 0)
      this.supply.selectedLeftNum[index2].SetActive(true);
    else
      this.supply.selectedLeftNum[index2].SetActive(true);
    this.supply.checkmark.SetActive(true);
  }
  ...
  public void SetEmpty(bool empty)
  {
    if (empty)
    {
      ...
      else
      {
        ...
        this.supply.quantity.SetActive(false);
    ...
    else
    {
      ...
      this.supply.quantity.SetActive(true);
