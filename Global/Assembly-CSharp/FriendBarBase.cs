...
public class FriendBarBase : BackButtonMenuBase
{
  ...
  {
    for (int index = 0; index < this.sortLabels.Length; ++index)
      ((Component) this.sortLabels[index]).gameObject.SetActive(index == Persist.sortOrder.Data.Friend);
  }
  ...
  protected IEnumerator CreateFriendBarRange(int value)
  {
    ...
    return (IEnumerator) new FriendBarBase.\u003CCreateFriendBarRange\u003Ec__Iterator41A()
    {
      value = value,
      \u003C\u0024\u003Evalue = value,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendBarBase.\u003CCreateScrollBase\u003Ec__Iterator41B()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendBarBase.\u003CCreateScroll\u003Ec__Iterator41C()
    {
      bar_index = bar_index,
