...
namespace SM
{
  ...
  public class Player : KeyCompare
  {
    ...
    {
      this._hasKey = false;
      this.has_new_bingo2 = (bool) json[nameof (has_new_bingo2)];
      ...
      this.is_open_bingo2 = (bool) json[nameof (is_open_bingo2)];
    ...
    public int coin => this.free_coin + this.paid_coin;
    ...
    public bool CheckMaxItem() => this.CheckMaxItem(SMManager.Get<PlayerItem[]>().Length);
    ...
    public bool GetNewbie() => this.ContainsExtension("newbie_1");
