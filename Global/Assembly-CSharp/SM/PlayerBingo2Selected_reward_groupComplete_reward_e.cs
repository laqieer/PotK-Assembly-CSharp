...
// Type: SM.PlayerBingo2Selected_reward_groupComplete_reward_entities
...
{
  [Serializable]
  public class PlayerBingo2Selected_reward_groupComplete_reward_entities : KeyCompare
  {
    public string url;
    public int _complete_reward_entity;

    public PlayerBingo2Selected_reward_groupComplete_reward_entities()
    {
    }

    public PlayerBingo2Selected_reward_groupComplete_reward_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
