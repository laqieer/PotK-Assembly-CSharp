...
// Type: SM.BattleFinishDrop_supply_entities
...
{
  [Serializable]
  public class BattleFinishDrop_supply_entities : KeyCompare
  {
    ...
    public BattleFinishDrop_supply_entities()
    {
    }

    public BattleFinishDrop_supply_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
