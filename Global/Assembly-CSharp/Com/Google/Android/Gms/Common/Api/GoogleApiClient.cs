...
namespace Com.Google.Android.Gms.Common.Api
{
  public class GoogleApiClient : JavaObjWrapper
  {
    ...
    public void connect() => this.InvokeCallVoid(nameof (connect), "()V");

    public void disconnect() => this.InvokeCallVoid(nameof (disconnect), "()V");
    ...
    public int getSessionId() => this.InvokeCall<int>(nameof (getSessionId), "()I");

    public bool isConnecting() => this.InvokeCall<bool>(nameof (isConnecting), "()Z");
    ...
    public void reconnect() => this.InvokeCallVoid(nameof (reconnect), "()V");
    ...
    public bool isConnected() => this.InvokeCall<bool>(nameof (isConnected), "()Z");
  }
}
