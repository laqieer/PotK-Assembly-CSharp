  ...
  public class QuestStoryM
  {
    ...
    public string name
    {
      get
      {
        ...
        return LocalizationManager.TryGetTermTranslation("quest_story_QuestStoryM_name_" + (object) this.ID, out Translation) ? Translation : this._name;
      }
    ...
    public string short_name
    {
      get
      {
        ...
        string Translation = string.Empty;
        return LocalizationManager.TryGetTermTranslation("quest_story_QuestStoryM_short_name_" + (object) this.ID, out Translation) ? Translation : this._short_name;
      }
