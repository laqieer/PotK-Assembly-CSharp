  ...
  public class GearGear
  {
    ...
    public string name
    {
      get
      {
        ...
        return LocalizationManager.TryGetTermTranslation("gear_GearGear_name_" + (object) this.ID, out Translation) ? Translation : this._name;
      }
    ...
    {
      return ResourceManager.Load<Sprite>(string.Format("AssetBundle/Resources/Gears/{0}/2D/weapon_thum", (object) this.resource_reference_gear_id.ID));
    }

    public Future<Sprite> LoadSpriteBasic()
    {
      return ResourceManager.Load<Sprite>(string.Format("AssetBundle/Resources/Gears/{0}/2D/weapon_basic", (object) this.resource_reference_gear_id.ID));
    }

    public Future<GameObject> LoadModel()
    {
      return ResourceManager.Load<GameObject>(string.Format("Gears/{0}/3D/prefab", (object) this.resource_reference_gear_id.ID));
    }
  }
}
