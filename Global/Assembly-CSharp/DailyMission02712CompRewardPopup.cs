...
// Type: DailyMission02712CompRewardPopup
...
#nullable disable
public class DailyMission02712CompRewardPopup : BackButtonMenuBase
{
  [SerializeField]
  ...
  public IEnumerator Init(Hashtable reward, System.Action yes = null, System.Action no = null)
  {
    ...
    return (IEnumerator) new DailyMission02712CompRewardPopup.\u003CInit\u003Ec__Iterator5CB()
    {
      reward = reward,
      yes = yes,
      no = no,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission02712CompRewardPopup.\u003CloadThumb\u003Ec__Iterator5CC()
    {
