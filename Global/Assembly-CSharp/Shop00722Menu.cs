...
public class Shop00722Menu : BackButtonMenuBase
{
  ...
  public IEnumerator UpdateArticleInfo()
  {
    ...
    return (IEnumerator) new Shop00722Menu.\u003CUpdateArticleInfo\u003Ec__Iterator3E3()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void SetBtnActive(PlayerShopArticle article, DateTime serverTime)
  {
    ...
    this.txt_Buy.SetActive(true);
    this.slcItemFull.SetActive(false);
    if (article.article.UpperLimitCheck())
    {
      this.ibtnPopupBuy.isEnabled = false;
      this.txt_Buy.SetActive(false);
      this.slcItemFull.SetActive(true);
    }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00722Menu.\u003CInit\u003Ec__Iterator3E4()
    {
      shopID = shopID,
      article = article,
      product = product,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00722Menu.\u003CShowDetailPopup\u003Ec__Iterator3E5()
    {
      content = content,
      \u003C\u0024\u003Econtent = content,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00722Menu.\u003CpopupAlert007222\u003Ec__Iterator3E6()
    {
      \u003C\u003Ef__this = this
    };
  }
