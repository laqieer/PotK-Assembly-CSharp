...
public class Unit0042Menu : BackButtonMenuBase
{
  ...
  private IEnumerator UpdateActive(GameObject go)
  {
    ...
    return (IEnumerator) new Unit0042Menu.\u003CUpdateActive\u003Ec__Iterator24C()
    {
      go = go,
      \u003C\u0024\u003Ego = go
    };
  ...
  private void PadScale()
  {
    if (Object.op_Equality((Object) this.grid, (Object) null))
      return;
    this.grid.cellWidth = this.width;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0042Menu.\u003CLoadPrefabs\u003Ec__Iterator24D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0042Menu.\u003CInit\u003Ec__Iterator24E()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0042Menu.\u003CCreatePage\u003Ec__Iterator24F()
    {
      unitIdx = unitIdx,
      isUpdate = isUpdate,
      \u003C\u0024\u003EunitIdx = unitIdx,
  ...
  [DebuggerHidden]
  public IEnumerator UpdateAllPages(PlayerUnit[] playerUnits)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0042Menu.\u003CUpdateAllPages\u003Ec__Iterator250()
    {
      playerUnits = playerUnits,
      \u003C\u0024\u003EplayerUnits = playerUnits,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0042Menu.\u003CUpdatePage\u003Ec__Iterator251()
    {
      unitIdx = unitIdx,
      \u003C\u0024\u003EunitIdx = unitIdx,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0042Menu.\u003CUnitFavoriteAscync\u003Ec__Iterator252()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0042Menu.\u003ConEndSceneAsync\u003Ec__Iterator253()
    {
      \u003C\u003Ef__this = this
    };
  }
