...
public class Quest00214Menu : BackButtonMenuBase
{
  ...
  public void InitCombiQuestButton() => this.ibtnCombi.SetActive(Player.Current.IsCombiQuest());

  [DebuggerHidden]
  public IEnumerator InitCharacterQuestButton(PlayerUnit[] pUnits, int? unitId = null)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214Menu.\u003CInitCharacterQuestButton\u003Ec__Iterator187()
    {
      unitId = unitId,
      \u003C\u0024\u003EunitId = unitId,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214Menu.\u003CinstanciateUnitIcon\u003Ec__Iterator188()
    {
      prefab = prefab,
      unit = unit,
      isOpen = isOpen,
  ...
  public void IbtnCombi()
  {
    ...
    this.SetTxtTitle = Consts.Lookup("QUEST_00214_COMBI_TITLE");
  ...
  public void IbtnChara()
  {
    ...
    this.SetTxtTitle = Consts.Lookup("QUEST_00214_CHARACTER_TITLE");
