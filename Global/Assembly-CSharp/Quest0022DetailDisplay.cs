...
public class Quest0022DetailDisplay : MonoBehaviour
{
    ...
    QuestScoreCampaignProgress qscp)
  {
    ...
    if (Object.op_Inequality((Object) this.TxtRest, (Object) null))
    {
      ...
      if (stageData.remain_battle_count.HasValue)
      {
        ...
        this.TxtRest.SetTextLocalize(Consts.Lookup("QUEST_0022_LIMIT", (IDictionary) new Hashtable()
        {
          {
            (object) "remains",
            (object) num2
        ...
        this.TxtRest.SetTextLocalize(Consts.Lookup("QUEST_0022_LIMIT_NONE"));
    }
  ...
  protected void SetRankingEventHiScore(int score)
  {
    ...
    this.TxtHiScroe.SetTextLocalize(Consts.Lookup("QUEST_00220_HISCORE_TEXT", (IDictionary) new Hashtable()
    {
      {
        (object) nameof (score),
        (object) score
  ...
  private IEnumerator SpriteCreate(string path)
  {
    ...
    return (IEnumerator) new Quest0022DetailDisplay.\u003CSpriteCreate\u003Ec__Iterator1CB()
    {
      path = path,
      \u003C\u0024\u003Epath = path,
      \u003C\u003Ef__this = this
