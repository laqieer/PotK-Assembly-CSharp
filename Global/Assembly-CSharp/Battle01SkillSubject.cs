...
public class Battle01SkillSubject : NGBattleMenuBase
{
  ...
  protected override IEnumerator Start_Original()
  {
    ...
    Battle01SkillSubject.\u003CStart_Original\u003Ec__Iterator717 originalCIterator717 = new Battle01SkillSubject.\u003CStart_Original\u003Ec__Iterator717();
    return (IEnumerator) originalCIterator717;
  }
  ...
  protected override void Update_Battle()
  {
    ...
    if (Object.op_Inequality((Object) this.txt_consume_hp, (Object) null))
    {
      if (hpCost > 0)
      {
        ...
        string v = Consts.Lookup("BATTLE_UI_CONSUME_HP", (IDictionary) new Hashtable()
        {
          {
            (object) "hp",
            (object) hpCost
