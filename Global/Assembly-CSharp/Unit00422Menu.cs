...
public class Unit00422Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(PlayerUnit playerUnit)
  {
    ...
    return (IEnumerator) new Unit00422Menu.\u003CInit\u003Ec__Iterator258()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00422Menu.\u003CInitPlayer\u003Ec__Iterator259()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00422Menu.\u003CSetMainCharacter\u003Ec__Iterator25A()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  private void UpdateSelectCharacter(UnitIconBase unitIcon)
  {
    ...
    if (characterIntimate.level == characterIntimate.max_level)
      this.TxtLv.SetTextLocalize(Consts.Lookup("UNIT_00422_MAX").ToConverter());
    else
