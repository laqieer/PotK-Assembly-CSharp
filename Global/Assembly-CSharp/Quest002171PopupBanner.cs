...
public class Quest002171PopupBanner : MonoBehaviour
{
    ...
    Quest002171Scroll scrollcomp)
  {
    ...
    return (IEnumerator) new Quest002171PopupBanner.\u003CInitScroll\u003Ec__Iterator1B5()
    {
      menu = menu,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171PopupBanner.\u003CSetSprite\u003Ec__Iterator1B6()
    {
      id = id,
      idle = idle,
      press = press,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171PopupBanner.\u003CSetSprite\u003Ec__Iterator1B7()
    {
      gate = gate,
      \u003C\u0024\u003Egate = gate,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171PopupBanner.\u003CCreateSprite\u003Ec__Iterator1B8()
    {
      path = path,
      obj = obj,
      \u003C\u0024\u003Epath = path,
