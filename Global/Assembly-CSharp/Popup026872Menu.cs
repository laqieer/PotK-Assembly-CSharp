...
public class Popup026872Menu : Popup02610Base
{
  ...
  public override void Init(WebAPI.Response.PvpBoot pvpInfo, Versus02610Menu menu)
  {
    ...
    this.txtTitle.SetText(Consts.Lookup("VERSUS_0026872POPUP_TITLE"));
    this.txtDescriptionYellow.SetText(Consts.Lookup("VERSUS_0026872POPUP_DESCRIPTION1"));
    this.txtDescriptionNormal.SetText(Consts.Lookup("VERSUS_0026872POPUP_DESCRIPTION2"));
  ...
  private IEnumerator ExchangeTicketPopup()
  {
    ...
    return (IEnumerator) new Popup026872Menu.\u003CExchangeTicketPopup\u003Ec__Iterator7F6()
    {
      \u003C\u003Ef__this = this
    };
  }
