...
public class BattlePrepareCharacterInfoBase : NGBattleMenuBase
{
  ...
  [SerializeField]
  protected UILabel hpNumberLabel;
  [SerializeField]
  ...
  public virtual IEnumerator Init(BL.UnitPosition up, AttackStatus[] attacks_)
  {
    ...
    return (IEnumerator) new BattlePrepareCharacterInfoBase.\u003CInit\u003Ec__Iterator744()
    {
      up = up,
      attacks_ = attacks_,
      \u003C\u0024\u003Eup = up,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattlePrepareCharacterInfoBase.\u003CSetElementalIcon\u003Ec__Iterator745()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
