...
public class CommonRewardType
{
  ...
  public IEnumerator CreateIcon(Transform parent)
  {
    ...
    return (IEnumerator) new CommonRewardType.\u003CCreateIcon\u003Ec__Iterator968()
    {
      parent = parent,
      \u003C\u0024\u003Eparent = parent,
      \u003C\u003Ef__this = this
  ...
  public static string GetRewardName(MasterDataTable.CommonRewardType type, int id, int quantity)
  {
    ...
    switch (type)
    {
      ...
      case MasterDataTable.CommonRewardType.recover:
        rewardName = Consts.Lookup("MYPAGE_0017_AP_RECOVER", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.max_unit:
        rewardName = Consts.Lookup("MYPAGE_0017_MAX_UNIT", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.max_item:
        rewardName = Consts.Lookup("MYPAGE_0017_MAX_ITEM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.emblem:
        rewardName = Consts.Lookup("MYPAGE_0017_EMBLEM", (IDictionary) new Hashtable()
        {
          {
            (object) "Name",
      ...
      case MasterDataTable.CommonRewardType.cp_recover:
        rewardName = Consts.Lookup("MYPAGE_0017_CP_RECOVER", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.quest_key:
        ...
        {
          rewardName = Consts.Lookup("MYPAGE_0017_KEY_DEFAULT", (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) quantity
      ...
      case MasterDataTable.CommonRewardType.gacha_ticket:
        ...
        rewardName = Consts.Lookup("MYPAGE_0017_GACHATICKET_NAME", (IDictionary) new Hashtable()
        {
          {
            (object) "Name",
            (object) (!MasterData.GachaTicket.ContainsKey(id) ? Consts.Lookup("MYPAGE_0017_GACHATICKET_COMMONNAME") : MasterData.GachaTicket[id].short_name)
          },
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.season_ticket:
        rewardName = Consts.Lookup("MYPAGE_0017_SEASONTICKET", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.mp_recover:
        rewardName = Consts.Lookup("MYPAGE_0017_MP_RECOVER", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
        ...
        break;
      default:
        rewardName = Consts.Lookup("MYPAGE_0017_OTHER", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
  ...
  public static string GetRewardName(MasterDataTable.CommonRewardType type, int id)
  {
    ...
    switch (type)
    {
      ...
      case MasterDataTable.CommonRewardType.player_exp:
        return Consts.Lookup("UNIQUE_ICON_EXP");
      case MasterDataTable.CommonRewardType.coin:
      ...
      case MasterDataTable.CommonRewardType.gacha_ticket:
        string empty2 = string.Empty;
        return !MasterData.GachaTicket.ContainsKey(id) ? Consts.Lookup("MYPAGE_0017_GACHATICKET_COMMONNAME") : MasterData.GachaTicket[id].short_name;
      case MasterDataTable.CommonRewardType.season_ticket:
        return Consts.Lookup("UNIQUE_ICON_SEASONTICKET");
      case MasterDataTable.CommonRewardType.mp_recover:
        return Consts.Lookup("UNIQUE_ICON_MPRECOVER");
      default:
        return Consts.Lookup("UNIQUE_ICON_OTHER");
    }
  }
  ...
  public static string GetRewardQuantity(MasterDataTable.CommonRewardType type, int id, int quantity)
  {
    ...
    {
      case MasterDataTable.CommonRewardType.unit:
        return Consts.Lookup("SPECIAL_SHOP_UNIT_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.supply:
        return Consts.Lookup("SPECIAL_SHOP_SUPPLY_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.gear:
        return Consts.Lookup("SPECIAL_SHOP_GEAR_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.money:
        return Consts.Lookup("SPECIAL_SHOP_ZENY_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.player_exp:
        return Consts.Lookup("SPECIAL_SHOP_EXP_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.coin:
        return Consts.Lookup("SPECIAL_SHOP_STONE_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.recover:
        return Consts.Lookup("SPECIAL_SHOP_AP_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.max_unit:
        return Consts.Lookup("SPECIAL_SHOP_OTHER_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.medal:
        return Consts.Lookup("SPECIAL_SHOP_MEDAL_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.friend_point:
        return Consts.Lookup("SPECIAL_SHOP_POINT_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.emblem:
        return Consts.Lookup("SPECIAL_SHOP_EMBLEM_NUM");
      case MasterDataTable.CommonRewardType.battle_medal:
        return Consts.Lookup("SPECIAL_SHOP_BATTLE_MEDAL_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.cp_recover:
        return Consts.Lookup("SPECIAL_SHOP_CP_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.quest_key:
        return Consts.Lookup("SPECIAL_SHOP_KEY_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.gacha_ticket:
        return Consts.Lookup("SPECIAL_SHOP_GACHATICKET_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.season_ticket:
        return Consts.Lookup("SPECIAL_SHOP_SEASONTICKETNUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
      ...
      case MasterDataTable.CommonRewardType.mp_recover:
        return Consts.Lookup("SPECIAL_SHOP_MP_NUM", (IDictionary) new Hashtable()
        {
          {
            (object) "Count",
            (object) quantity
