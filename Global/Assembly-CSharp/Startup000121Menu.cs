...
public class Startup000121Menu : NGMenuBase
{
  ...
  public IEnumerator InitNoticeList(OfficialInformationArticle[] infos, int num)
  {
    ...
    return (IEnumerator) new Startup000121Menu.\u003CInitNoticeList\u003Ec__Iterator133()
    {
      num = num,
      infos = infos,
      \u003C\u0024\u003Enum = num,
  ...
  public void CheckNew()
  {
    ...
    this.ScrollNewsPartList.ForEach((Action<Startup000121NewsScrollParts>) (obj =>
    {
      if (!obj.SetNewSprite())
        return;
      this.isNews = true;
    }));
    this.ScrollEventPartList.ForEach((Action<Startup000121EventsScrollParts>) (obj =>
    {
      if (!obj.SetNewSprite())
        return;
      this.isEvent = true;
    }));
    this.ScrollFunctionPartList.ForEach((Action<Startup000121FunctionsScrollParts>) (obj =>
    {
      if (!obj.SetNewSprite())
        return;
