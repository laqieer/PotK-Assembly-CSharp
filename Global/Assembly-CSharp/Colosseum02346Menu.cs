...
public class Colosseum02346Menu : ResultMenuBase
{
    ...
    Gladiator gladiator)
  {
    ...
    return (IEnumerator) new Colosseum02346Menu.\u003CInit\u003Ec__Iterator519()
    {
      info = info,
      param = param,
      gladiator = gladiator,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02346Menu.\u003CRun\u003Ec__Iterator51A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public override IEnumerator OnFinish()
  {
    ...
    Colosseum02346Menu.\u003COnFinish\u003Ec__Iterator51B finishCIterator51B = new Colosseum02346Menu.\u003COnFinish\u003Ec__Iterator51B();
    return (IEnumerator) finishCIterator51B;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02346Menu.\u003CInitObjects\u003Ec__Iterator51C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02346Menu.\u003CShowRankUp\u003Ec__Iterator51D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02346Menu.\u003CShowRankInfo\u003Ec__Iterator51E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02346Menu.\u003CShowRankPoint\u003Ec__Iterator51F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02346Menu.\u003CShowTitleEXP\u003Ec__Iterator520()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02346Menu.\u003CShowBottomMessage\u003Ec__Iterator521()
    {
      \u003C\u003Ef__this = this
    };
  }
