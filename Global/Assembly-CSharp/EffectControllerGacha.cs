...
public class EffectControllerGacha : EffectController
{
  ...
  public IEnumerator SetNeedData(GachaResultData.ResultData result_data, GameObject back_button)
  {
    ...
    return (IEnumerator) new EffectControllerGacha.\u003CSetNeedData\u003Ec__Iterator78D()
    {
  ...
  public int OnSE_0500() => Singleton<NGSoundManager>.GetInstance().playSE("SE_0500");

  public int OnSE_0508() => Singleton<NGSoundManager>.GetInstance().playSE("SE_0508");
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CLoadFlashImage\u003Ec__Iterator78E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CInitResultImage\u003Ec__Iterator78F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CbugFix\u003Ec__Iterator790()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CTanpatu\u003Ec__Iterator791()
    {
      result_data = result_data,
      \u003C\u0024\u003Eresult_data = result_data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CRenpatu\u003Ec__Iterator792()
    {
      result_data = result_data,
      \u003C\u0024\u003Eresult_data = result_data,
      \u003C\u003Ef__this = this
