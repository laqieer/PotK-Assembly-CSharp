...
public class Popup02646Menu : MonoBehaviour
{
    ...
    WebAPI.Response.PvpFriend fData)
  {
    ...
    return (IEnumerator) new Popup02646Menu.\u003CInit\u003Ec__Iterator7ED()
    {
      fData = fData,
      actionOk = actionOk,
      actionNo = actionNo,
  ...
  private void TimeOutProc()
  {
    ...
    ModalWindow.Show(Consts.Lookup("VERSUS_002645POPUP_TITLE"), Consts.Lookup("VERSUS_002645POPUP_DESCRIPTION"), (System.Action) (() => { }));
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02646Menu.\u003CCreatePopupWait\u003Ec__Iterator7EE()
    {
      \u003C\u003Ef__this = this
    };
  }
