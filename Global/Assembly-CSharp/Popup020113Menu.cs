...
public class Popup020113Menu : NGMenuBase
{
  ...
  public virtual IEnumerator Init(QuestHarmonyS quest)
  {
    ...
    return (IEnumerator) new Popup020113Menu.\u003CInit\u003Ec__Iterator7CF()
    {
      quest = quest,
      \u003C\u0024\u003Equest = quest,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup020113Menu.\u003CLoadUnitPrefab\u003Ec__Iterator7D0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup020113Menu.\u003CSetUnitPrefab\u003Ec__Iterator7D1()
    {
      setObject = setObject,
      unit = unit,
      \u003C\u0024\u003EsetObject = setObject,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup020113Menu.\u003CSetCharaIcon\u003Ec__Iterator7D2()
    {
      unit_1 = unit_1,
      unit_2 = unit_2,
      \u003C\u0024\u003Eunit_1 = unit_1,
