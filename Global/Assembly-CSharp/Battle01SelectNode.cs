...
public class Battle01SelectNode : BattleMonoBehaviour
{
  ...
  private bool isTutorial
  {
    get
    {
      if (!this.tutorialFlag.HasValue)
        this.tutorialFlag = new bool?(!Singleton<TutorialRoot>.GetInstance().IsTutorialFinish());
      return this.tutorialFlag.Value;
    }
  }
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    return (IEnumerator) new Battle01SelectNode.\u003ConInitAsync\u003Ec__Iterator710()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CStart_Battle\u003Ec__Iterator711()
    {
      \u003C\u003Ef__this = this
    };
  }
...
label_16:
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CWaitScrollSe\u003Ec__Iterator712()
    {
      obj = obj,
      \u003C\u0024\u003Eobj = obj
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CAutoBattleStartPop\u003Ec__Iterator713()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CTurnEndPop\u003Ec__Iterator714()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    if (Object.op_Equality((Object) this.spdButton1x, (Object) null) || Object.op_Equality((Object) this.spdButton2x, (Object) null) || Object.op_Equality((Object) this.spdButton4x, (Object) null))
      return;
    int num = Mathf.Clamp(speed, 1, 3);
    if (this.settingSpeed != num)
    {
      this.settingSpeed = num;
      Persist.battleTimeSetting.Data.speed = this.settingSpeed;
      Persist.battleTimeSetting.Flush();
    }
    Time.timeScale = (float) this.settingSpeed;
    this.spdButton1x.SetActive(!this.isTutorial && this.settingSpeed == 1);
    this.spdButton2x.SetActive(!this.isTutorial && this.settingSpeed == 2);
    this.spdButton4x.SetActive(!this.isTutorial && this.settingSpeed == 3);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CpushCancel\u003Ec__Iterator715()
    {
      \u003C\u003Ef__this = this
    };
  }
