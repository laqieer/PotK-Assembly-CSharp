...
public class Battle0181Menu : NGMenuBase
{
  ...
  public IEnumerator onStartSceneAsync(bool isColosseum)
  {
    ...
    return (IEnumerator) new Battle0181Menu.\u003ConStartSceneAsync\u003Ec__Iterator691()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181Menu.\u003CcreateColosseumDuelInvokeSkillDisp\u003Ec__Iterator692()
    {
