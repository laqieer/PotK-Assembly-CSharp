...
public static class MasterDataCache
{
  ...
  private static IEnumerable<string> CleanTargets()
  {
    ...
    MasterDataCache.\u003CCleanTargets\u003Ec__Iterator40 targetsCIterator40_1 = new MasterDataCache.\u003CCleanTargets\u003Ec__Iterator40();
    // ISSUE: variable of a compiler-generated type
    MasterDataCache.\u003CCleanTargets\u003Ec__Iterator40 targetsCIterator40_2 = targetsCIterator40_1;
    // ISSUE: reference to a compiler-generated field
    targetsCIterator40_2.\u0024PC = -2;
    return (IEnumerable<string>) targetsCIterator40_2;
  }
  ...
  private static IEnumerable<KeyValuePair<K, T>> AssocListSelect<K, T>(T[] list, Func<T, K> getID)
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    MasterDataCache.\u003CAssocListSelect\u003Ec__Iterator41<K, T> selectCIterator41 = new MasterDataCache.\u003CAssocListSelect\u003Ec__Iterator41<K, T>()
    {
      list = list,
      getID = getID,
      \u003C\u0024\u003Elist = list,
    ...
    // ISSUE: reference to a compiler-generated field
    selectCIterator41.\u0024PC = -2;
    return (IEnumerable<KeyValuePair<K, T>>) selectCIterator41;
  }
  ...
  private static IEnumerable<KeyValuePair<M, T[]>> Select<M, T>(Dictionary<M, List<T>> d)
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    MasterDataCache.\u003CSelect\u003Ec__Iterator42<M, T> selectCIterator42 = new MasterDataCache.\u003CSelect\u003Ec__Iterator42<M, T>()
    {
      d = d,
      \u003C\u0024\u003Ed = d
    };
    // ISSUE: reference to a compiler-generated field
    selectCIterator42.\u0024PC = -2;
    return (IEnumerable<KeyValuePair<M, T[]>>) selectCIterator42;
  }
