...
public static class AlgorithmUtil
{
  ...
  private static IEnumerable<IEnumerable<T>> _permutation<T>(IEnumerable<T> xs, IEnumerable<T> ys) where T : IComparable
  {
    ...
    AlgorithmUtil.\u003C_permutation\u003Ec__Iterator967<T> permutationCIterator967 = new AlgorithmUtil.\u003C_permutation\u003Ec__Iterator967<T>()
    {
      ys = ys,
      xs = xs,
      \u003C\u0024\u003Eys = ys,
    ...
    permutationCIterator967.\u0024PC = -2;
    return (IEnumerable<IEnumerable<T>>) permutationCIterator967;
  }
}
