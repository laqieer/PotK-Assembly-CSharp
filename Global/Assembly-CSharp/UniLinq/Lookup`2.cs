...
namespace UniLinq
{
    ...
    ILookup<TKey, TElement>
  {
      ...
      Func<TKey, IEnumerable<TElement>, TResult> resultSelector)
    {
      ...
      Lookup<TKey, TElement>.\u003CApplyResultSelector\u003Ec__Iterator10A<TResult> selectorCIterator10A = new Lookup<TKey, TElement>.\u003CApplyResultSelector\u003Ec__Iterator10A<TResult>()
      {
      ...
      selectorCIterator10A.\u0024PC = -2;
      return (IEnumerable<TResult>) selectorCIterator10A;
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator<IGrouping<TKey, TElement>>) new Lookup<TKey, TElement>.\u003CGetEnumerator\u003Ec__Iterator10B()
      {
        \u003C\u003Ef__this = this
      };
    }
