...
public class Unit00484Menu : Unit00483Menu
{
    ...
    Unit00468Scene.Mode mode)
  {
    ...
    return (IEnumerator) new Unit00484Menu.\u003CInit\u003Ec__Iterator2D7()
    {
      mode = mode,
  ...
  protected override void setEnterBtnStatus(PlayerUnit[] _selectUnit)
  {
    ...
    switch (this._mode)
    {
      case Unit00468Scene.Mode.Unit0048:
        ...
        this.TxtTitle.SetText(Consts.Lookup("unit_004_8_4_combine_title"));
        break;
      case Unit00468Scene.Mode.Unit00481:
        ...
        this.TxtTitle.SetText(Consts.Lookup("unit_004_8_4_reinforce_title"));
        break;
    }
  ...
  protected override void ChangeSozaiSelect(PlayerUnit _baseUnit, PlayerUnit[] _selectUnit)
  {
    ...
    switch (this._mode)
    {
      case Unit00468Scene.Mode.Unit0048:
        ...
        break;
      case Unit00468Scene.Mode.Unit00481:
        Unit00487Scene.changeScene(false, _baseUnit, _selectUnit);
        break;
    }
  }
