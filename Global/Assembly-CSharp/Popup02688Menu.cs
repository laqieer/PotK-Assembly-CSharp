...
public class Popup02688Menu : Popup02610Base
{
  ...
  public override IEnumerator InitCoroutine(WebAPI.Response.PvpBoot pvpInfo, Versus02610Menu menu)
  {
    ...
    return (IEnumerator) new Popup02688Menu.\u003CInitCoroutine\u003Ec__Iterator7FD()
    {
      pvpInfo = pvpInfo,
      menu = menu,
      \u003C\u0024\u003EpvpInfo = pvpInfo,
  ...
  private void isActiveLeftButton(PvpClassKind c)
  {
    ...
    if (remainingMatches > 0)
    {
      ...
      this.txtConfirmCheck2.SetText(!this.ContinueButton.isEnabled ? Consts.Lookup("VERSUS_002688POPUP_CONFIRMCHECK3") : Consts.Lookup("VERSUS_002688POPUP_CONFIRMCHECK2"));
    }
    else
    {
      ...
      this.txtConfirmCheck2.SetText(Consts.Lookup("VERSUS_002688POPUP_CONFIRMCHECK1"));
    }
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02688Menu.\u003CExtendPopup\u003Ec__Iterator7FE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02688Menu.\u003CSeasonClose\u003Ec__Iterator7FF()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02688Menu.\u003CCreateClassChange\u003Ec__Iterator800()
    {
      \u003C\u003Ef__this = this
    };
  }
