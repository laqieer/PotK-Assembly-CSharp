...
public class CalcUnitCompose
{
    ...
    CalcUnitCompose.ComposeType type)
  {
    ...
    switch (type)
    {
      case CalcUnitCompose.ComposeType.HP:
        ...
        num2 = (int) ((double) unit.unit.hp_max * (10000.0 + (double) unit.UnitTypeParameter.hp_levelup_max_correction * 10000.0) / 10000.0) - (unit.hp.level + unit.hp.buildup);
        break;
      case CalcUnitCompose.ComposeType.STRENGTH:
        num1 = ((IEnumerable<PlayerUnit>) material).Sum<PlayerUnit>((Func<PlayerUnit, int>) (x => x != (PlayerUnit) null ? x.unit.strength_buildup : 0));
        num2 = (int) ((double) unit.unit.strength_max * (10000.0 + (double) unit.UnitTypeParameter.strength_levelup_max_correction * 10000.0) / 10000.0) - (unit.strength.level + unit.strength.buildup);
        break;
      case CalcUnitCompose.ComposeType.INTELLIGENCE:
        ...
        num2 = (int) ((double) unit.unit.intelligence_max * (10000.0 + (double) unit.UnitTypeParameter.intelligence_levelup_max_correction * 10000.0) / 10000.0) - (unit.intelligence.level + unit.intelligence.buildup);
        break;
      case CalcUnitCompose.ComposeType.VITALITY:
        num1 = ((IEnumerable<PlayerUnit>) material).Sum<PlayerUnit>((Func<PlayerUnit, int>) (x => x != (PlayerUnit) null ? x.unit.vitality_buildup : 0));
        num2 = (int) ((double) unit.unit.vitality_max * (10000.0 + (double) unit.UnitTypeParameter.vitality_levelup_max_correction * 10000.0) / 10000.0) - (unit.vitality.level + unit.vitality.buildup);
        break;
      case CalcUnitCompose.ComposeType.MIND:
        num1 = ((IEnumerable<PlayerUnit>) material).Sum<PlayerUnit>((Func<PlayerUnit, int>) (x => x != (PlayerUnit) null ? x.unit.mind_buildup : 0));
        num2 = (int) ((double) unit.unit.mind_max * (10000.0 + (double) unit.UnitTypeParameter.mind_levelup_max_correction * 10000.0) / 10000.0) - (unit.mind.level + unit.mind.buildup);
        break;
      case CalcUnitCompose.ComposeType.AGILITY:
        num1 = ((IEnumerable<PlayerUnit>) material).Sum<PlayerUnit>((Func<PlayerUnit, int>) (x => x != (PlayerUnit) null ? x.unit.agility_buildup : 0));
        num2 = (int) ((double) unit.unit.agility_max * (10000.0 + (double) unit.UnitTypeParameter.agility_levelup_max_correction * 10000.0) / 10000.0) - (unit.agility.level + unit.agility.buildup);
        break;
      case CalcUnitCompose.ComposeType.DEXTERITY:
        num1 = ((IEnumerable<PlayerUnit>) material).Sum<PlayerUnit>((Func<PlayerUnit, int>) (x => x != (PlayerUnit) null ? x.unit.dexterity_buildup : 0));
        num2 = (int) ((double) unit.unit.dexterity_max * (10000.0 + (double) unit.UnitTypeParameter.dexterity_levelup_max_correction * 10000.0) / 10000.0) - (unit.dexterity.level + unit.dexterity.buildup);
        break;
      case CalcUnitCompose.ComposeType.LUCKY:
        num1 = ((IEnumerable<PlayerUnit>) material).Sum<PlayerUnit>((Func<PlayerUnit, int>) (x => x != (PlayerUnit) null ? x.unit.lucky_buildup : 0));
        num2 = (int) ((double) unit.unit.lucky_max * (10000.0 + (double) unit.UnitTypeParameter.lucky_levelup_max_correction * 10000.0) / 10000.0) - (unit.lucky.level + unit.lucky.buildup);
        break;
    }
    if (num2 < 0)
      num2 = 0;
  ...
  {
    return CalcUnitCompose.price(base_unit, material_units, CalcUnitCompose.PriceMode.Compose);
  }

  public static int priceStringth(PlayerUnit base_unit, PlayerUnit[] material_units)
  {
    return CalcUnitCompose.price(base_unit, material_units, CalcUnitCompose.PriceMode.Stringth);
  }
