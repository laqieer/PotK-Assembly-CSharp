  ...
  public class JsonMapper
  {
    ...
    private static object ReadValue(Type inst_type, JsonReader reader)
    {
      ...
      if (reader.Token == JsonToken.Double || reader.Token == JsonToken.Int || reader.Token == JsonToken.Long || reader.Token == JsonToken.String || reader.Token == JsonToken.Boolean)
      {
        ...
        return (JsonMapper.GetConvOp(inst_type, type) ?? throw new JsonException(string.Format("Can't assign value '{0}' (type {1}) to type {2}", reader.Value, (object) type, (object) inst_type))).Invoke((object) null, new object[1]
        {
          reader.Value
        });
      }
...
label_43:
    ...
    private static void RegisterBaseImporters()
    {
      ...
      ImporterFunc importer2 = (ImporterFunc) (input => (object) Convert.ToInt64((int) input));
      JsonMapper.RegisterImporter(JsonMapper.base_importers_table, typeof (int), typeof (long), importer2);
      ImporterFunc importer3 = (ImporterFunc) (input => (object) Convert.ToUInt64((int) input));
      JsonMapper.RegisterImporter(JsonMapper.base_importers_table, typeof (int), typeof (ulong), importer3);
