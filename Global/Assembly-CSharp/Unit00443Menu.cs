...
public class Unit00443Menu : EquipmentDetailMenuBase
{
  ...
  public IEnumerator Init(PlayerItem targetGear, bool limited = false)
  {
    ...
    return (IEnumerator) new Unit00443Menu.\u003CInit\u003Ec__Iterator26F()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00443Menu.\u003CFavoriteAPI\u003Ec__Iterator270()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00443Menu.\u003CWaitScrollSe\u003Ec__Iterator271()
    {
      \u003C\u003Ef__this = this
    };
  }
