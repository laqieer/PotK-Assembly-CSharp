...
public class SocialListener : MonoBehaviour, SocialKit.Share.IShareListener
{
  ...
  {
    SocialKit.Share.Send(SocialKit.Platform.Twitter, string.Format("{0}【招待コード：{1}】{2}", (object) "ファンキルはプレーした？本格的なシミュレーションRPGが手軽に楽しめてゲーム好きなら絶対オススメだから遊んでみて！招待コード入れてくれたら特典も貰えるよ！", (object) SMManager.Get<Player>().short_id, (object) "https://pk.fg-games.co.jp"));
  }
}
