...
public class BGChange : MonoBehaviour
{
  ...
  public IEnumerator asyncBgAnim(QuestBG.AnimApply set, float duration = 0)
  {
    ...
    return (IEnumerator) new BGChange.\u003CasyncBgAnim\u003Ec__Iterator221()
    {
      set = set,
      duration = duration,
      \u003C\u0024\u003Eset = set,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BGChange.\u003CQuestBGprefabCreate\u003Ec__Iterator222()
    {
      L = L,
      M = M,
      XL = XL,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BGChange.\u003CExtraBGprefabCreate\u003Ec__Iterator223()
    {
      name = name,
      \u003C\u0024\u003Ename = name
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BGChange.\u003CBGprefabCreate\u003Ec__Iterator224()
    {
      L = L,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BGChange.\u003CEarthBGprefabCreate\u003Ec__Iterator225()
    {
      name = name,
      \u003C\u0024\u003Ename = name
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BGChange.\u003CCheckStageBG\u003Ec__Iterator226()
    {
      \u003C\u003Ef__this = this
    };
  }
