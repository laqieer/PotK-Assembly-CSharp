...
public class Unit0046Menu : BackButtonMenuBase
{
  ...
  private IEnumerator WaitScrollSe()
  {
    ...
    return (IEnumerator) new Unit0046Menu.\u003CWaitScrollSe\u003Ec__Iterator27D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CShouldStop\u003Ec__Iterator27E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    this.TxtCostValue.SetTextLocalize(Consts.Lookup("UNIT_0046_COST", (IDictionary) new Hashtable()
    {
      {
        (object) "now",
        (object) deck.cost
    ...
    this.TxtTeamNum.SetTextLocalize(Consts.Lookup("UNIT_0046_MENU", (IDictionary) new Hashtable()
    {
      {
        (object) "num",
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CInit3DModelPrefab\u003Ec__Iterator27F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CModelChange\u003Ec__Iterator280()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003COneProcessDestroy\u003Ec__Iterator281()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CStartDestroyPoolableObject\u003Ec__Iterator282()
    {
      go = go,
      \u003C\u0024\u003Ego = go
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CInitPlayerDecks\u003Ec__Iterator283()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CAddDeck\u003Ec__Iterator284()
    {
      prefab = prefab,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CUpdateDeck\u003Ec__Iterator285()
    {
      index = index,
      \u003C\u0024\u003Eindex = index,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CInitPlayerItems\u003Ec__Iterator286()
    {
      items = items,
      \u003C\u0024\u003Eitems = items,
      \u003C\u003Ef__this = this
  ...
  public void charaActive(PlayerDeck pDeck)
  {
    ...
    foreach (PlayerUnit playerUnit in pDeck.player_units)
    {
      if (playerUnit == (PlayerUnit) null)
        ((Component) this.buttons[index]).GetComponent<Unit0046Character>().CharaSetActive(false);
      else
        ((Component) this.buttons[index]).GetComponent<Unit0046Character>().CharaSetActive(true);
      ++index;
    }
  }
