...
public class Shop0574Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitSceneAsync()
  {
    ...
    return (IEnumerator) new Shop0574Menu.\u003CInitSceneAsync\u003Ec__Iterator643()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0574Menu.\u003CStartSceneAsync\u003Ec__Iterator644()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0574Menu.\u003CopenDetailPopupAsync\u003Ec__Iterator645()
    {
      article = article,
      \u003C\u0024\u003Earticle = article,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0574Menu.\u003CopenCompletePopup\u003Ec__Iterator646()
    {
      thum = thum,
      article = article,
      buyNum = buyNum,
