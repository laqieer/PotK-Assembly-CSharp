...
namespace Net
{
  public class Peer
  {
      ...
      Promise<Tuple<Peer.CommonHeader, byte[]>> promise)
    {
      ...
      return (IEnumerator) new Peer.\u003CReceiveE\u003Ec__Iterator8FA()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new Peer.\u003CSendResponseE\u003Ec__Iterator8FB()
      {
        type = type,
        requestId = requestId,
        data = data,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new Peer.\u003CSendE\u003Ec__Iterator8FC()
      {
        type = type,
        data = data,
        timeout = timeout,
    ...
    public class CommonHeader
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new Peer.CommonHeader.\u003CReadE\u003Ec__Iterator8FD()
        {
          client = client,
          promise = promise,
          \u003C\u0024\u003Eclient = client,
