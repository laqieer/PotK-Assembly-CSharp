...
namespace Net
{
  public class AppPeer : Peer
  {
      ...
      Promise<AppPeer.ReceivedMessage> promise)
    {
      ...
      return (IEnumerator) new AppPeer.\u003CReceiveUntilF\u003Ec__Iterator8FE()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new AppPeer.\u003CReceiveTypeE\u003Ec__Iterator8FF()
      {
        timeoutMilliseconds = timeoutMilliseconds,
        promise = promise,
        \u003C\u0024\u003EtimeoutMilliseconds = timeoutMilliseconds,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new AppPeer.\u003CSendNothrowE\u003Ec__Iterator900()
      {
        send = send,
        promise = promise,
        \u003C\u0024\u003Esend = send,
