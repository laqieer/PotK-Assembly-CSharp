...
public class Shop00741Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(Player player, bool isUpdate = true)
  {
    ...
    return (IEnumerator) new Shop00741Menu.\u003CInit\u003Ec__Iterator3F1()
    {
      player = player,
      isUpdate = isUpdate,
      \u003C\u0024\u003Eplayer = player,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00741Menu.\u003CupdateScroll\u003Ec__Iterator3F2()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00741Menu.\u003CDetailPopup\u003Ec__Iterator3F3()
    {
      \u003C\u003Ef__this = this
    };
  }
