...
public class Gacha99931Menu : BackButtonMenuBase
{
  ...
  public void SetText(string text1 = "", string text2 = "")
  {
    ...
    this.TxtDescription02.SetText(Consts.Lookup("GACHA_99931MENU_DESCRIPTION03").ToConverter());
    ...
    if (text1 == string.Empty)
      this.TxtDescription01.SetText(Consts.Lookup("GACHA_99931MENU_DESCRIPTION01"));
    else
      this.TxtDescription01.SetText(text1);
    if (text2 == string.Empty)
      this.TxtPopupTitle.SetText(Consts.Lookup("GACHA_99931MENU_DESCRIPTION02"));
    else
