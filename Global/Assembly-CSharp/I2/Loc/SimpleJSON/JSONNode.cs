...
namespace I2.Loc.SimpleJSON
{
  public class JSONNode
  {
    ...
    public virtual IEnumerable<JSONNode> Childs
    {
      get
      {
        JSONNode.\u003C\u003Ec__Iterator114 cIterator114 = new JSONNode.\u003C\u003Ec__Iterator114();
        JSONNode.\u003C\u003Ec__Iterator114 childs = cIterator114;
        childs.\u0024PC = -2;
    ...
    public IEnumerable<JSONNode> DeepChilds
    {
      get
      {
        JSONNode.\u003C\u003Ec__Iterator115 deepChilds = new JSONNode.\u003C\u003Ec__Iterator115()
        {
          \u003C\u003Ef__this = this
        };
        deepChilds.\u0024PC = -2;
