...
public class StoryEnvironment
{
  ...
  private static void colorFromName(string name, out float r, out float g, out float b)
  {
    ...
    if (key != null)
    {
      ...
      if (StoryEnvironment.\u003C\u003Ef__switch\u0024map1B == null)
      {
        // ISSUE: reference to a compiler-generated field
        StoryEnvironment.\u003C\u003Ef__switch\u0024map1B = new Dictionary<string, int>(6)
        {
          {
            "black",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (StoryEnvironment.\u003C\u003Ef__switch\u0024map1B.TryGetValue(key, out num))
      {
        switch (num)
        {
          case 0:
