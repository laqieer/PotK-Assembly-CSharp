...
public class PopupPvpMatchResult : NGBattleMenuBase
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    return (IEnumerator) new PopupPvpMatchResult.\u003CStart_Battle\u003Ec__Iterator811()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PopupPvpMatchResult.\u003CStart_Battle_Debug\u003Ec__Iterator812()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void setResultBase()
  {
    ...
    this.linkObj.color = n != 0 ? Consts.GetInstance().UI_SPRITE_DISABLED_COLOR : Consts.GetInstance().UI_SPRITE_NORMAL_COLOR;
