...
public class Shop0074Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(Player player, bool isUpdate = true)
  {
    ...
    return (IEnumerator) new Shop0074Menu.\u003CInit\u003Ec__Iterator3E9()
    {
      player = player,
      isUpdate = isUpdate,
      \u003C\u0024\u003Eplayer = player,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0074Menu.\u003CupdateScroll\u003Ec__Iterator3EA()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0074Menu.\u003CDetailPopup\u003Ec__Iterator3EB()
    {
      \u003C\u003Ef__this = this
    };
  }
