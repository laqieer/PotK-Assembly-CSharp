...
public class Bugu05561Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(PlayerItem item)
  {
    ...
    return (IEnumerator) new Bugu05561Scene.\u003ConStartSceneAsync\u003Ec__Iterator640()
    {
      item = item,
      \u003C\u0024\u003Eitem = item,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu05561Scene.\u003ConStartSceneAsync\u003Ec__Iterator641()
    {
      item = item,
      isNew = isNew,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu05561Scene.\u003CstartSceneAsync\u003Ec__Iterator642()
    {
      isGacha = isGacha,
      supply = supply,
      isNew = isNew,
