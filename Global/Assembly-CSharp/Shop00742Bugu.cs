...
public class Shop00742Bugu : MonoBehaviour
{
  ...
  public IEnumerator Init(GearGear target)
  {
    ...
    return (IEnumerator) new Shop00742Bugu.\u003CInit\u003Ec__Iterator3F5()
    {
      target = target,
      \u003C\u0024\u003Etarget = target,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00742Bugu.\u003CBuguSpriteCreate\u003Ec__Iterator3F6()
    {
      spriteF = spriteF,
      \u003C\u0024\u003EspriteF = spriteF,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00742Bugu.\u003CRarityCreate\u003Ec__Iterator3F7()
    {
      target = target,
      \u003C\u0024\u003Etarget = target,
      \u003C\u003Ef__this = this
