...
public class Popup0156Menu : BackButtonMenuBase
{
  ...
  [SerializeField]
  private UILabel ibtn_Popup_Ok_Label;

  public virtual void IbtnPopupOk()
  {
    if (this.detail.movePage.moveScene == "colosseum023_4" && !SMManager.Get<Player>().GetReleaseColosseum())
    {
      ModalWindow.Show(Consts.Lookup("POPUP_0156_TITLE"), Consts.Lookup("POPUP_0156_DESCRIPT_TEXT"), (System.Action) (() => { }));
    }
    else
    {
      switch (this.detail.movePage.ID)
      {
        case 1:
          ...
          break;
        case 2:
          Quest00240723Scene.ChangeScene0024(true, this.GetRecentStoryID());
          goto case 1;
        case 6:
        ...
        case 9:
          ...
          goto case 1;
        default:
          Singleton<NGSceneManager>.GetInstance().changeScene(this.detail.movePage.moveScene);
          goto case 1;
      }
    }
  }
  ...
  private void SetButtonFrame()
  {
    ...
    if (this.detail.movePage.moveScene == string.Empty)
    {
    ...
    else
    {
      ...
      this.ibtn_Popup_Ok_Label.SetTextLocalize(Consts.Lookup("UI_HELP_NAVIGATION_" + this.detail.movePage.buttonImage));
    }
  }
