...
public class Quest00214aMenu : BackButtonMenuBase
{
  ...
  private IEnumerator LoadCharacterSprite(int id, GameObject locationObject)
  {
    ...
    return (IEnumerator) new Quest00214aMenu.\u003CLoadCharacterSprite\u003Ec__Iterator18F()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214aMenu.\u003CLoadCharacterStorySprite\u003Ec__Iterator190()
    {
      locationObject = locationObject,
      id = id,
      \u003C\u0024\u003ElocationObject = locationObject,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214aMenu.\u003CLoadMask\u003Ec__Iterator191()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214aMenu.\u003CSetBg\u003Ec__Iterator192()
    {
      questData = questData,
      index = index,
      \u003C\u0024\u003EquestData = questData,
  ...
  private void SetGrayQuestIcon(int questLength, GameObject character)
  {
    ...
    if (questLength != 0)
      return;
    ((Component) character.transform.GetChild(0)).GetComponent<UI2DSprite>().color = Consts.GetInstance().UI_SPRITE_DISABLED_COLOR;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214aMenu.\u003CInit\u003Ec__Iterator193()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214aMenu.\u003CInit\u003Ec__Iterator194()
    {
      iconPrefab = iconPrefab,
      conditionPrefab = conditionPrefab,
      unitId = unitId,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214aMenu.\u003CInitReleases\u003Ec__Iterator195()
    {
      list = list,
      iconPrefab = iconPrefab,
      conditionPrefab = conditionPrefab,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214aMenu.\u003CInitHscroll\u003Ec__Iterator196()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void Disable()
  {
    ...
    if (this.mode == Quest00214aMenu.Mode.Character)
    {
      ...
      this.menu.SetTxtTitle = Consts.Lookup("QUEST_00214_CHARACTER_TITLE");
    }
    if (this.mode != Quest00214aMenu.Mode.Harmony)
      return;
    this.menu.CellEnable = !this.menu.isSelect;
    this.menu.SetTxtTitle = Consts.Lookup("QUEST_00214_COMBI_TITLE");
  }
