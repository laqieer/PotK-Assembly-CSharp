...
public class Popup02687Menu : Popup02610Base
{
  ...
  public override IEnumerator InitCoroutine(WebAPI.Response.PvpBoot pvpInfo, Versus02610Menu menu)
  {
    ...
    return (IEnumerator) new Popup02687Menu.\u003CInitCoroutine\u003Ec__Iterator7F9()
    {
      pvpInfo = pvpInfo,
      menu = menu,
      \u003C\u0024\u003EpvpInfo = pvpInfo,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02687Menu.\u003CUpSeasonAPI\u003Ec__Iterator7FA()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02687Menu.\u003CCompPopup\u003Ec__Iterator7FB()
    {
      cnt = cnt,
      \u003C\u0024\u003Ecnt = cnt
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02687Menu.\u003CShortagePopup\u003Ec__Iterator7FC()
    {
      \u003C\u003Ef__this = this
    };
  }
