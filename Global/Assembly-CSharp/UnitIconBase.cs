...
public class UnitIconBase : IconPrefabBase
{
  ...
  public virtual IEnumerator SetUnit(UnitUnit unit, CommonElement element, bool isGray = false)
  {
    ...
    return (IEnumerator) new UnitIconBase.\u003CSetUnit\u003Ec__Iterator928()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetUnitWithLongPressAction\u003Ec__Iterator929()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetMaterialUnit\u003Ec__Iterator92A()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetMaterialUnit\u003Ec__Iterator92B()
    {
      playerUnit = playerUnit,
      isNew = isNew,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetPlayerUnit\u003Ec__Iterator92C()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    this.bottomLevel.SetActive(type == UnitSortAndFilter.SORT_TYPES.BranchOfAnArmy || type == UnitSortAndFilter.SORT_TYPES.Level || type == UnitSortAndFilter.SORT_TYPES.Rarity || type == UnitSortAndFilter.SORT_TYPES.GetOrder);
    this.bottomRarity.SetActive(type == UnitSortAndFilter.SORT_TYPES.BranchOfAnArmy || type == UnitSortAndFilter.SORT_TYPES.Level || type == UnitSortAndFilter.SORT_TYPES.Rarity || type == UnitSortAndFilter.SORT_TYPES.GetOrder);
    this.bottomCost.SetActive(type == UnitSortAndFilter.SORT_TYPES.Cost);
    this.bottomNum.SetActive(type != UnitSortAndFilter.SORT_TYPES.BranchOfAnArmy && type != UnitSortAndFilter.SORT_TYPES.Level && type != UnitSortAndFilter.SORT_TYPES.Rarity && type != UnitSortAndFilter.SORT_TYPES.Cost && type != UnitSortAndFilter.SORT_TYPES.GetOrder);
  }
  ...
  public void ShowBottomInfo(UnitSortAndFilter.SORT_TYPES sort)
  {
    ...
    switch (sort)
    {
      case UnitSortAndFilter.SORT_TYPES.Attribute:
        this.setText(this.playerUnit.GetElementName());
        this.SetElementTextColor(this.playerUnit.GetElement());
        break;
