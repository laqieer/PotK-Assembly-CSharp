...
public class Shop0074Scroll : MonoBehaviour
{
    ...
    Func<IEnumerator> onPurchased)
  {
    ...
    return (IEnumerator) new Shop0074Scroll.\u003CInit\u003Ec__Iterator3ED()
    {
      menu = menu,
      playerShopArticle = playerShopArticle,
      shopArticle = shopArticle,
    ...
    int holding)
  {
    ...
    if (this._shopArticle.limit.HasValue || this._shopArticle.daily_limit.HasValue)
    {
      ...
      this.quantityLabel.SetTextLocalize(string.Format(Consts.Lookup("SHOP_0074_SCROLL_ARTICLE_LIMIT_VALUE"), (object) this._playerShopArticle.limit.Value));
    }
    else
  ...
  public void Init00771(WebAPI.Response.ShopBuy result)
  {
    ...
    // ISSUE: object of a compiler-generated type is created
    foreach (\u003C\u003E__AnonType4<Shop, int> anonType4 in ((IEnumerable<Shop>) SMManager.Get<Shop[]>()).Select<Shop, \u003C\u003E__AnonType4<Shop, int>>((Func<Shop, int, \u003C\u003E__AnonType4<Shop, int>>) ((value, index) => new \u003C\u003E__AnonType4<Shop, int>(value, index))))
    {
      foreach (PlayerShopArticle playerShopArticle in (IEnumerable<PlayerShopArticle>) ((IEnumerable<PlayerShopArticle>) anonType4.value.articles).OrderBy<PlayerShopArticle, int>((Func<PlayerShopArticle, int>) (x => x.article.view_order)))
      {
    ...
    if (this._shopArticle.ShopContents[0].entity_type == MasterDataTable.CommonRewardType.unit)
      this.ownLabel.SetTextLocalize(this._allUnits.AmountHavingTargetUnit(this._shopArticle.ShopContents[0].entity_id, this._shopArticle.ShopContents[0].entity_type).ToString());
    ...
    else if (this._shopArticle.ShopContents[0].entity_type == MasterDataTable.CommonRewardType.season_ticket)
    {
      ...
      Debug.LogWarning((object) ("予期せぬCommonRewardTypeを取得しました " + (object) this._shopArticle.ShopContents[0].entity_type));
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0074Scroll.\u003CopenPopup0076\u003Ec__Iterator3EE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0074Scroll.\u003CsetDetailPopup\u003Ec__Iterator3EF()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0074Scroll.\u003CUpdateServerTime\u003Ec__Iterator3F0()
    {
      \u003C\u003Ef__this = this
    };
  }
