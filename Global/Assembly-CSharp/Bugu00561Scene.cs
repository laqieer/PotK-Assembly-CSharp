...
public class Bugu00561Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(PlayerItem item)
  {
    ...
    return (IEnumerator) new Bugu00561Scene.\u003ConStartSceneAsync\u003Ec__Iterator33B()
    {
      item = item,
      \u003C\u0024\u003Eitem = item,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu00561Scene.\u003ConStartSceneAsync\u003Ec__Iterator33C()
    {
      item = item,
      isNew = isNew,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu00561Scene.\u003ConStartSceneAsync\u003Ec__Iterator33D()
    {
      item = item,
      isNew = isNew,
      isScreenTouch = isScreenTouch,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu00561Scene.\u003CstartSceneAsync\u003Ec__Iterator33E()
    {
      isGacha = isGacha,
      supply = supply,
      isNew = isNew,
