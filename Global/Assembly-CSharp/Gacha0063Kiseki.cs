...
public class Gacha0063Kiseki : Gacha0063hindicator
{
  ...
  public override IEnumerator Set(GameObject detailPopup)
  {
    ...
    return (IEnumerator) new Gacha0063Kiseki.\u003CSet\u003Ec__Iterator379()
    {
  ...
  private void CreatePickupUnitIdList()
  {
    ...
    {
      if (gachaModuleNewentity.reward_type_id == 1)
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateCharacterImage\u003Ec__Iterator37A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateSkillImage\u003Ec__Iterator37B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateSimpleCharacter3DImage\u003Ec__Iterator37C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateCharacterModel\u003Ec__Iterator37D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator CashClean()
  {
    ...
    Gacha0063Kiseki.\u003CCashClean\u003Ec__Iterator37E cleanCIterator37E = new Gacha0063Kiseki.\u003CCashClean\u003Ec__Iterator37E();
    return (IEnumerator) cleanCIterator37E;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateModel\u003Ec__Iterator37F()
    {
      id = id,
      \u003C\u0024\u003Eid = id,
      \u003C\u003Ef__this = this
  ...
  private void ChangeSkillIcon(int id)
  {
    ...
    if (!Object.op_Inequality((Object) this.dyn_Unit_Skill.iconSprite.mainTexture, (Object) null))
      return;
