...
public class Versus02610Menu : Versus026MatchBase
{
  ...
  public override IEnumerator Init(PvpMatchingTypeEnum type, WebAPI.Response.PvpBoot pvpInfo)
  {
    ...
    return (IEnumerator) new Versus02610Menu.\u003CInit\u003Ec__Iterator56B()
    {
      type = type,
      pvpInfo = pvpInfo,
      \u003C\u0024\u003Etype = type,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02610Menu.\u003CSetRankingOrSeasonPopup\u003Ec__Iterator56C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02610Menu.\u003CRankingEndPopup\u003Ec__Iterator56D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02610Menu.\u003CInitSeasonEndPopup\u003Ec__Iterator56E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    this.txtTitle.SetText(Consts.Lookup("VERSUS_002610TITLE"));
    ...
    string text1 = !flag || this.pvpInfo.ranking <= 0 ? Consts.Lookup("VERSUS_002610RANKING_DEFAULT") : this.pvpInfo.ranking.ToLocalizeNumberText();
    string text2 = !flag ? Consts.Lookup("VERSUS_002610RANKING_DEFAULT") : this.pvpInfo.ranking_pt.ToLocalizeNumberText();
  ...
  private string GetMatchRemainText()
  {
    ...
    return Consts.Lookup("VERSUS_00261REMAIN_LONG", (IDictionary) new Hashtable()
    {
      {
        (object) "nowCnt",
  ...
  {
    return Consts.Lookup(minute >= 10 ? "VERSUS_00261REMAIN_TIME" : "VERSUS_00261REMAIN_TIME_SUB", (IDictionary) new Hashtable()
    {
      {
        (object) nameof (hour),
  ...
  private void SetTxtCondition(UILabel l)
  {
    ...
    PvpClassKind.Condition condition = pvpClassKind.ClassCondition(currentSeasonWinCount);
    switch (pvpClassKind.NextCondition(condition))
    {
      ...
      case PvpClassKind.Condition.STAY_TOPCLASS:
        ...
        l.color = color1;
        l.SetText(Consts.Lookup("VERSUS_002610CONDITION_DOWN", (IDictionary) new Hashtable()
        {
          {
            (object) "win",
      ...
      case PvpClassKind.Condition.UP:
        ...
        l.color = color2;
        l.SetText(Consts.Lookup("VERSUS_002610CONDITION_STAY", (IDictionary) new Hashtable()
        {
          {
            (object) "win",
      ...
      case PvpClassKind.Condition.TITLE_TOPCLASS:
        if (condition == PvpClassKind.Condition.TITLE || condition == PvpClassKind.Condition.TITLE_TOPCLASS)
        {
          Color color3 = Color32.op_Implicit(new Color32(byte.MaxValue, (byte) 105, (byte) 0, byte.MaxValue));
          l.color = color3;
          l.SetText(Consts.Lookup("VERSUS_002610CONDITION_TITLE"));
          break;
        }
        Color color4 = Color32.op_Implicit(new Color32(byte.MaxValue, (byte) 105, (byte) 0, byte.MaxValue));
        l.color = color4;
        l.SetText(Consts.Lookup("VERSUS_002610CONDITION_UP", (IDictionary) new Hashtable()
        {
          {
            (object) "win",
  ...
  private IEnumerator ShowMPAlertPopup()
  {
    ...
    Versus02610Menu.\u003CShowMPAlertPopup\u003Ec__Iterator56F popupCIterator56F = new Versus02610Menu.\u003CShowMPAlertPopup\u003Ec__Iterator56F();
    return (IEnumerator) popupCIterator56F;
  }
  ...
  private IEnumerator ShowAggregatePopup()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    Versus02610Menu.\u003CShowAggregatePopup\u003Ec__Iterator570 popupCIterator570 = new Versus02610Menu.\u003CShowAggregatePopup\u003Ec__Iterator570();
    return (IEnumerator) popupCIterator570;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02610Menu.\u003CErrorMathcingBegin\u003Ec__Iterator571()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02610Menu.\u003CSeasonEndPopup\u003Ec__Iterator572()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02610Menu.\u003CChangeSceneRanking\u003Ec__Iterator573()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02610Menu.\u003CSceneUpdate\u003Ec__Iterator574()
    {
      \u003C\u003Ef__this = this
    };
  }
