...
public class Shop0076Menu : BackButtonMenuBase
{
    ...
    Func<IEnumerator> onPurchased)
  {
    ...
    return (IEnumerator) new Shop0076Menu.\u003CInit\u003Ec__Iterator40A()
    {
      player = player,
      playerShopArticle = playerShopArticle,
      shopArticle = shopArticle,
  ...
  public void SetTxtDescription05(ShopArticle sa)
  {
    if (sa.pay_type == CommonPayType.money)
    {
      ...
      if (this.holding < this.quantity * this.price)
        text = Consts.Lookup("SHOP_0076_TXT_DESCRIPTION05_MONEY_OVER", (IDictionary) new Hashtable()
        {
          {
            (object) "money",
        ...
        text = Consts.Lookup("SHOP_007X_TXT_DESCRIPTION05_MONEY", (IDictionary) new Hashtable()
        {
          {
            (object) "money",
            (object) (this.quantity * this.price).ToLocalizeNumberText()
    ...
    else if (sa.pay_type == CommonPayType.medal)
    {
      string text;
      if (this.holding < this.quantity * this.price)
        text = Consts.Lookup("SHOP_0076_TXT_DESCRIPTION05_MEDAL_OVER", (IDictionary) new Hashtable()
        {
          {
            (object) "medal",
            (object) (this.quantity * this.price).ToLocalizeNumberText()
        ...
        text = Consts.Lookup("SHOP_007X_TXT_DESCRIPTION05_MEDAL", (IDictionary) new Hashtable()
        {
          {
            (object) "medal",
            (object) (this.quantity * this.price).ToLocalizeNumberText()
  ...
  public void SetTxtDescription06(ShopArticle sa)
  {
    if (sa.pay_type == CommonPayType.money)
      ...
      this.TxtDescription06.SetTextLocalize(Consts.Lookup("SHOP_0076_TXT_DESCRIPTION06_MEDAL", (IDictionary) new Hashtable()
      {
        {
          (object) "medal",
          (object) this.holding
      ...
      Debug.LogWarning((object) ("selected pay_type is other than money, medal " + (object) sa.pay_type));
  }
  ...
  public void onChangeInputQuantity(bool isInit = true)
  {
    ...
    if (this._playerShopArticle.limit.HasValue && this.quantity >= this._playerShopArticle.limit.Value)
    {
      this.quantity = this._playerShopArticle.limit.Value;
      this.btnPlus.isEnabled = false;
    }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0076Menu.\u003COpenPopup00771\u003Ec__Iterator40B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0076Menu.\u003CLongPressedCountPlus\u003Ec__Iterator40C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0076Menu.\u003CLongPressedCountMinus\u003Ec__Iterator40D()
    {
      \u003C\u003Ef__this = this
    };
  }
