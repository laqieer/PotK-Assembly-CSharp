...
public class NGBattle3DObjectManager : BattleManagerBase
{
  ...
  public IEnumerator loadStage(BE env, bool setOthers = true)
  {
    ...
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadStage\u003Ec__Iterator848()
    {
      env = env,
      setOthers = setOthers,
      \u003C\u0024\u003Eenv = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadUnitResources\u003Ec__Iterator849()
    {
      env = env,
      \u003C\u0024\u003Eenv = env,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003Cinitialize\u003Ec__Iterator84A()
    {
      env_ = env_,
      \u003C\u0024\u003Eenv_ = env_,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003Ccleanup\u003Ec__Iterator84B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CinitializePanels\u003Ec__Iterator84C()
    {
      env = env,
      root = root,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CcreatePanels\u003Ec__Iterator84D()
    {
      env = env,
      setOthers = setOthers,
      root = root,
  ...
  [DebuggerHidden]
  private IEnumerator spawns(List<BL.UnitPosition> units, BE env, bool wait = true)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003Cspawns\u003Ec__Iterator84E()
    {
      units = units,
      wait = wait,
      \u003C\u0024\u003Eunits = units,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadSkillResource\u003Ec__Iterator84F()
    {
      env = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadSkillResource\u003Ec__Iterator850()
    {
      skill = skill,
      env = env,
      \u003C\u0024\u003Eskill = skill,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadAilmentSkillResource\u003Ec__Iterator851()
    {
      env = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadItemResource\u003Ec__Iterator852()
    {
      env = env,
      item = item,
      \u003C\u0024\u003Eenv = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadMagicBulletResource\u003Ec__Iterator853()
    {
      mb = mb,
      env = env,
      \u003C\u0024\u003Emb = mb,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadUnitResource\u003Ec__Iterator854()
    {
      env = env,
      unit = unit,
      \u003C\u0024\u003Eenv = env,
