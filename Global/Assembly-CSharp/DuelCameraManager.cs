...
public class DuelCameraManager : MonoBehaviour
{
  ...
  public IEnumerator changeCamera(string cameraName, Transform parent = null)
  {
    ...
    return (IEnumerator) new DuelCameraManager.\u003CchangeCamera\u003Ec__Iterator695()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DuelCameraManager.\u003CcoShakeCamera\u003Ec__Iterator696()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DuelCameraManager.\u003CWarpCamera1stAttackPosRemoteEnemy\u003Ec__Iterator697()
    {
      delay = delay,
      defender = defender,
      bullet = bullet,
