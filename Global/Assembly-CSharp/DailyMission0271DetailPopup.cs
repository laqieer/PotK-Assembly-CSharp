...
#nullable disable
public class DailyMission0271DetailPopup : BackButtonMenuBase
{
  [SerializeField]
  ...
  private DailyMission0271Panel panelObject;
  ...
  public IEnumerator Init(DailyMission0271PanelRoot.DailyMissionView v, DailyMission0271Panel panel)
  {
    ...
    return (IEnumerator) new DailyMission0271DetailPopup.\u003CInit\u003Ec__Iterator5BB()
    {
      v = v,
      panel = panel,
      \u003C\u0024\u003Ev = v,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271DetailPopup.\u003CcallReviewApi\u003Ec__Iterator5BC()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  [DebuggerHidden]
  private IEnumerator loadThumb(BingoRewardGroup reward)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271DetailPopup.\u003CloadThumb\u003Ec__Iterator5BD()
    {
      reward = reward,
      \u003C\u0024\u003Ereward = reward,
      \u003C\u003Ef__this = this
