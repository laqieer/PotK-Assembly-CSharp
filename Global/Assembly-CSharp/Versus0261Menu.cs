...
public class Versus0261Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Initialize(WebAPI.Response.PvpBoot pvpInfo)
  {
    ...
    return (IEnumerator) new Versus0261Menu.\u003CInitialize\u003Ec__Iterator55C()
    {
      pvpInfo = pvpInfo,
      \u003C\u0024\u003EpvpInfo = pvpInfo,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0261Menu.\u003CSetCampaignImage\u003Ec__Iterator55D()
    {
      campaigns = campaigns,
      \u003C\u0024\u003Ecampaigns = campaigns,
      \u003C\u003Ef__this = this
  ...
  {
    this.txtTitle.SetText(Consts.Lookup("VERSUS_00261TITLE"));
    ((Component) this.TxtRemain).gameObject.SetActive(true);
    this.TxtRemain.SetTextLocalize(Consts.Lookup("VERSUS_00262BONUS", (IDictionary) new Hashtable()
    {
      {
        (object) "cnt",
        (object) remainNum
    ...
    this.txtAttention.SetTextLocalize(Consts.Lookup("VERSUS_00261ATTENTION", (IDictionary) new Hashtable()
    {
      {
        (object) "cnt",
        (object) limitNum
  ...
  private void SetMatchRemainText()
  {
    ...
    if (this.pvpInfo.rank_aggregate)
    {
      ...
      text = Consts.Lookup("VERSUS_00261REMAIN_RANK_AGREGATE", (IDictionary) new Hashtable()
      {
        {
          (object) "remainTime",
    ...
    else if (player.mp <= 0 && this.pvpInfo.aggregate_finish_time.HasValue && this.pvpInfo.aggregate_finish_time.Value <= player.mp_full_recovery_at)
    {
      ...
      text = Consts.Lookup("VERSUS_00261REMAIN_BEFORE_RANK_AGREGATE", (IDictionary) new Hashtable()
      {
        {
          (object) "remainTime",
          (object) this.SetRemainTime(dateTime.Hour, dateTime.Minute)
    ...
    else
    {
      ...
      text = Consts.Lookup("VERSUS_00261REMAIN_LONG", (IDictionary) new Hashtable()
      {
        {
          (object) "nowCnt",
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0261Menu.\u003CCreateMapPrefab\u003Ec__Iterator55E()
    {
      \u003C\u003Ef__this = this
    };
  }
