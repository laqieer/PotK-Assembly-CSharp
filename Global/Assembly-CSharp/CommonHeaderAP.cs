...
public class CommonHeaderAP : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    if (!Object.op_Inequality((Object) this.gaugeRemainder, (Object) null))
      return;
  ...
  {
    if (Object.op_Equality((Object) this.gaugeRemainder, (Object) null) || Object.op_Equality((Object) this.gaugeTweenerRemainder, (Object) null))
      return;
    ...
    float num4 = !Object.op_Inequality((Object) this.gaugeRemainder, (Object) null) ? 0.0f : this.gaugeRemainder.transform.localScale.x;
    float num5 = num2;
    this.gaugeTweenerRemainder.from = new Vector3(num4, this.gaugeRemainder.transform.localScale.y, this.gaugeRemainder.transform.localScale.z);
    this.gaugeTweenerRemainder.to = new Vector3(num5, this.gaugeRemainder.transform.localScale.y, this.gaugeRemainder.transform.localScale.z);
