...
public class Battle0181CharacterStatus : NGBattleMenuBase
{
  ...
  public virtual void Init(BL.UnitPosition up, AttackStatus attackStatus)
  {
    ...
    this.hpNumberLabel.SetText(unit.hp.ToString());
    ...
    if (attackStatus != null)
    {
      this.txt_attack.SetTextLocalize(attackStatus.attack);
  ...
  private IEnumerator LoadCharaIcon()
  {
    ...
    return (IEnumerator) new Battle0181CharacterStatus.\u003CLoadCharaIcon\u003Ec__Iterator68C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void Damaged(int damage, int? heal = null)
  {
    ...
    this.hpNumberLabel.SetText(this.currentHp.ToString());
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill\u003Ec__Iterator68D()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill2\u003Ec__Iterator68E()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill3\u003Ec__Iterator68F()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill4\u003Ec__Iterator690()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
    ...
    GameObject downEffect)
  {
    ...
    {
      this.txt_attack.SetTextLocalize(newAttackStatus.attack);
      if (attackStatus.attack < newAttackStatus.attack)
      {
