...
public class Ryusei_100111_ef : MonoBehaviour
{
  ...
  private IEnumerator loadPrefab(string pname, Vector3 pos, Vector3 rot)
  {
    ...
    return (IEnumerator) new Ryusei_100111_ef.\u003CloadPrefab\u003Ec__Iterator6DE()
    {
      pname = pname,
      pos = pos,
      rot = rot,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Ryusei_100111_ef.\u003CloadPrefab\u003Ec__Iterator6DF()
    {
      data_name = data_name,
      \u003C\u0024\u003Edata_name = data_name,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Ryusei_100111_ef.\u003CloadPrefab\u003Ec__Iterator6E0()
    {
  ...
  public void play_CombineCutin(string unitIds)
  {
    ...
    {
      Debug.LogError((object) "[play_CombineCutin] Parse Error");
      this.myUnit.playSkillCutin();
    }
  }
  ...
  private List<int> PerseCutinId(string unitIds)
  {
    ...
    foreach (string s in str.Split(chArray))
    {
      ...
      if (int.TryParse(s, out result))
        ...
        Debug.LogError((object) "[ParseCutinId] unitId Parse Error");
    }
    return intList;
  }
