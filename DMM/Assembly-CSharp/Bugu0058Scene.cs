...
public class Bugu0058Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, GameCore.ItemInfo baseItem) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_8", (stack ? 1 : 0) != 0, (object) baseItem);

  public static void changeScene(bool stack, List<GameCore.ItemInfo> selectItemList) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_8", (stack ? 1 : 0) != 0, (object) selectItemList);
