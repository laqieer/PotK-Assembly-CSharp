...
public class Unit004StorageSellMenu : UnitStorageMenuBase
{
  ...
  public IEnumerator Init(PlayerUnit[] storageUnits)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) unit004StorageSellMenu.prefab0041014 == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004StorageSellMenu.prefab0041013 == (UnityEngine.Object) null)
    {
  ...
  public void AllUpdateUnitIcons()
  {
    ...
    {
      if ((UnityEngine.Object) allUnitInfo.icon != (UnityEngine.Object) null && allUnitInfo.icon.Button.enabled)
      {
  ...
  private IEnumerator IbtnYesAsync()
  {
    ...
    if (menu.selectedUnitIcons.Any<UnitIconInfo>((Func<UnitIconInfo, bool>) (ui => ui.playerUnit.unit.rarity.index > 1)))
    {
      ...
      menu.selectedUnitIcons.ForEach((System.Action<UnitIconInfo>) (v => ls.AddRange((IEnumerable<PlayerUnit>) unit004StorageSellMenu.ExpandPlayerUnits(v, v.SelectedCount))));
  ...
  public void OnBtnUnitSellList() => Unit00468Scene.changeScene00410WithInitialize(false, this.isFromAlertUnitOver ? Unit00410Menu.FromType.AlertUnitOver : Unit00410Menu.FromType.UnitList);
  ...
  {
    Unit004StorageSellMenu unit004StorageSellMenu = this;
    if ((UnityEngine.Object) unit004StorageSellMenu.prefabDialog == (UnityEngine.Object) null)
    {
    ...
    callbackList.Add(new System.Action(((UnitSelectMenuBase) unit004StorageSellMenu).CreateSelectUnitList));
    callbackList.Add(new System.Action(unit004StorageSellMenu.AllUpdateUnitIcons));
    callbackList.Add(new System.Action(((UnitSelectMenuBase) unit004StorageSellMenu).UpdateInfomation));
