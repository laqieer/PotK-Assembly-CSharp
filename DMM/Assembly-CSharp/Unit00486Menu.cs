...
public class Unit00486Menu : UnitSelectMenuBase
{
  ...
  private IEnumerator doReturnScene()
  {
    ...
    if (flag1)
    {
      ...
      PopupCommonNoYes.Show(instance.POPUP_ALERT_TITLE_COMBINE_OVERKILLERS_SLOTS, instance.POPUP_ALERT_MESSAGE_COMINE_OVERKILLERS_SLOTS, (System.Action) (() => nCommand = 1), (System.Action) (() => nCommand = -1));
      while (nCommand == 0)
    ...
    if (flag2)
    {
      int nCommand = 0;
      Consts instance = Consts.GetInstance();
      PopupCommonNoYes.Show(instance.POPUP_ALERT_TITLE_COMBINE_JOBCHANGE_UNITS, instance.POPUP_ALERT_MESSAGE_COMBINE_JOBCHANGE_UNITS, (System.Action) (() => nCommand = 1), (System.Action) (() => nCommand = -1), NGUIText.Alignment.Left);
      while (nCommand == 0)
        yield return (object) null;
      if (nCommand < 0)
        yield break;
    ...
    if (flag3)
    {
      int nCommand = 0;
      Consts instance = Consts.GetInstance();
      PopupCommonNoYes.Show(instance.POPUP_ALERT_TITLE_COMBINE_BUGU3OPENED_SLOTS, instance.POPUP_ALERT_MESSAGE_COMINE_BUGU3OPENED_SLOTS, (System.Action) (() => nCommand = 1), (System.Action) (() => nCommand = -1));
      while (nCommand == 0)
        yield return (object) null;
      if (nCommand < 0)
        yield break;
    ...
    for (int index = 0; index < valueTupleArray.Length; ++index)
    {
      ...
      {
        int nCommand = 0;
        PopupCommonNoYes.Show(valueTuple.Item2.Item1, valueTuple.Item2.Item2, (System.Action) (() => nCommand = 1), (System.Action) (() => nCommand = -1));
        while (nCommand == 0)
          yield return (object) null;
        if (nCommand < 0)
          yield break;
