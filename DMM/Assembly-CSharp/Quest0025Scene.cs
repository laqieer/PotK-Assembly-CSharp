...
public class Quest0025Scene : NGSceneBase
{
  ...
  public static void changeScene0025(bool stack, Quest0025Scene.Quest0025Param param) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_5", (stack ? 1 : 0) != 0, (object) param);
