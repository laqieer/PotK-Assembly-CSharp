...
public class ColosseumResultUnit : MonoBehaviour
{
  ...
  private const float scale = 0.8823529f;
  [SerializeField]
  ...
  public IEnumerator OnUnitLevelup(GameObject obj, int count)
  {
    ...
    UnitIcon component = colosseumResultUnit.LinkChar.transform.GetChild(0).GetComponent<UnitIcon>();
    component.setLevelText((component.PlayerUnit.level + count + 1).ToLocalizeNumberText());
    ((IEnumerable<UITweener>) colosseumResultUnit.DirUnitLevelUP.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
    {
      x.ResetToBeginning();
      x.PlayForward();
    }));
  ...
  public IEnumerator OnSkipUnitLevelup(GameObject obj, int count)
  {
    ...
    colosseumResultUnit.DirUnitLevelUP.SetActive(true);
    colosseumResultUnit.Invoke("OutUnitLevelup", 1f);
    colosseumResultUnit.LinkChar.transform.GetChild(0).GetComponent<UnitIcon>().setLevelText(colosseumResultUnit.AfterUnit.level.ToLocalizeNumberText());
    ((IEnumerable<UITweener>) colosseumResultUnit.DirUnitLevelUP.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
    {
      x.ResetToBeginning();
      x.PlayForward();
  ...
  {
    if (!((UnityEngine.Object) this.DeathIcon != (UnityEngine.Object) null))
      return;
  ...
  public IEnumerator Init(PlayerUnit beforeUnit, PlayerUnit afterUnit, BattleInfo info = null)
  {
    ...
    if ((UnityEngine.Object) this.secondGearInfo.RootObj != (UnityEngine.Object) null)
    ...
    {
      if (!((UnityEngine.Object) gearInfoArray[index].RootObj == (UnityEngine.Object) null) && gearInfoArray[index].RootObj.activeSelf)
      {
    ...
    this.TxtUnitEXP.gameObject.SetActive(false);
    this.SetMVP(false);
    ...
    if ((UnityEngine.Object) this.secondGearInfo.RootObj != (UnityEngine.Object) null && this.secondGearInfo.RootObj.activeSelf && beforeUnit.equippedGear2 != (PlayerItem) null)
  ...
  {
    if (!((UnityEngine.Object) this.slc_DearDegree_Base != (UnityEngine.Object) null))
      return;
    if (!this.afterUnit.is_trust)
    {
      this.TxtDearDegreeNone.gameObject.SetActive(true);
    ...
    else
    {
      ...
      if ((UnityEngine.Object) this.TxtDearDegree != (UnityEngine.Object) null)
        this.TxtDearDegree.SetTextLocalize(string.Format("{0}%", (object) (Math.Round((double) this.afterUnit.trust_rate * 100.0) / 100.0)));
      if (!((UnityEngine.Object) this.TxtDearDegreeUpAmount != (UnityEngine.Object) null))
        return;
      ...
      if ((double) num > 0.0)
      {
        ...
        if (!((UnityEngine.Object) this.dir_DearDegree != (UnityEngine.Object) null))
          return;
        this.dir_DearDegree.SetChildren(this.dir_DearDegree.gameObject.transform.GetChildren().Select<Transform, GameObject>((Func<Transform, GameObject>) (x => x.gameObject)).ToArray<GameObject>());
        this.dir_DearDegree.enabled = true;
      }
      else
        this.TxtDearDegreeUpAmount.gameObject.SetActive(false);
    }
  }

  private void InitUnityDegree()
  {
    if (!((UnityEngine.Object) this.dir_UnityDegree != (UnityEngine.Object) null))
      return;
    ...
    if (num > 0)
    {
      ...
      this.dir_UnityDegree.SetChildren(this.dir_UnityDegree.transform.GetChildren().Select<Transform, GameObject>((Func<Transform, GameObject>) (x => x.gameObject)).ToArray<GameObject>());
      this.dir_UnityDegree.enabled = true;
    }
    else
      this.TxtUnityDegreeUpAmount.transform.parent.gameObject.SetActive(false);
  }

  private void SetDearDegreeSprite(UnitUnit unit)
  {
    if ((UnityEngine.Object) this.slcDearDegree == (UnityEngine.Object) null || (UnityEngine.Object) this.slcDearDegree.atlas == (UnityEngine.Object) null)
      return;
    if (this.slcDearDegree.atlas.name == "023-4-6_sozai_prefab")
    {
      if (unit.IsSea)
      {
    ...
    else
    {
      ...
      this.slcDearDegree.width = atlasSprite.width;
      this.slcDearDegree.height = atlasSprite.height;
    }
  }
  ...
  public IEnumerator LoadUnitPrefab(PlayerUnit unit, BattleInfo info)
  {
    ...
    gameObject.transform.localScale = new Vector3(0.8823529f, 0.8823529f);
    UnitIcon unitScript = gameObject.GetComponent<UnitIcon>();
    e = unitScript.setSimpleUnit(unit);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    unitScript.Button.enabled = false;
    unitScript.buttonBoxCollider.enabled = false;
    List<SwitchUnitComponentBase> list = ((IEnumerable<SwitchUnitComponentBase>) colosseumResultUnit.GetComponentsInChildren<SwitchUnitComponentBase>(true)).ToList<SwitchUnitComponentBase>();
  ...
  public IEnumerator LoadGearPrefab(PlayerUnit unit, BattleInfo info)
  {
    ...
    this.gearIcon.ItemIcon.gear.button.enabled = false;
    this.gearIcon.ItemIcon.gear.button.GetComponent<BoxCollider>().enabled = false;
    this.gearIcon.numberLabel.gameObject.SetActive(false);
    if ((UnityEngine.Object) this.secondGearInfo.RootObj != (UnityEngine.Object) null && this.secondGearInfo.RootObj.activeSelf)
    {
      ...
      if (gear2 != (PlayerItem) null)
      {
        ...
        this.secondGearIcon.ItemIcon.gear.button.enabled = false;
        this.secondGearIcon.ItemIcon.gear.button.GetComponent<BoxCollider>().enabled = false;
        this.secondGearIcon.numberLabel.gameObject.SetActive(false);
      }
      else
      {
    ...
    PlayerUnit after)
  {
    if (after.unit.IsAllEquipUnit)
    {
      ...
      gearInfo.ProficiencyBefore.transform.Find(this.toProficiencyObjectName(true, 0)).gameObject.SetActive(true);
    }
    else
    {
      ...
      gearInfo.ProficiencyBefore.transform.Find(this.toProficiencyObjectName(gearInfo.IsHideProficiency, unitGearProficiency1.level)).gameObject.SetActive(true);
      gearInfo.DirProficiency.SetActive(true);
      gearInfo.ProficiencyBefore.SetActive(true);
      ((IEnumerable<UITweener>) gearInfo.ProficiencyBefore.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
      {
        if (x.tweenGroup != 1)
          return;
        x.ResetToBeginning();
  ...
  public bool IsNotLastPlayGaugeRunner()
  {
    if (this.LinkChar.transform.childCount == 0 || this.AfterUnit == (PlayerUnit) null)
      return false;
    UnitIcon component = this.LinkChar.transform.GetChild(0).GetComponent<UnitIcon>();
    int level = component.PlayerUnit.level;
    return (UnityEngine.Object) component != (UnityEngine.Object) null && level + this.levelUpCount < this.AfterUnit.level - 1;
  }

  public GaugeRunner GetUnitExpLastGaugeRunner() => new GaugeRunner(this.UnitExpGauge, (float) this.afterUnit.exp / (float) (this.afterUnit.exp + this.afterUnit.exp_next), 1, new Func<GameObject, int, IEnumerator>(this.OnSkipUnitLevelup));

  public GaugeRunner GetUnitExpGaugeRunner(
    ...
    Func<GameObject, int, IEnumerator> levelupCallback)
  {
    ...
    int?[] nullableArray = new int?[2];
    PlayerItem equippedGear = this.afterUnit.equippedGear;
    nullableArray[0] = (object) equippedGear != null ? new int?(equippedGear.id) : new int?();
    PlayerItem equippedGear2 = this.afterUnit.equippedGear2;
    nullableArray[1] = (object) equippedGear2 != null ? new int?(equippedGear2.id) : new int?();
    int?[] equippedGearIds = nullableArray;
    PlayerItem[] playerItemArray = SMManager.Get<PlayerItem[]>();
    for (int i = 0; i < equippedGearIds.Length; i++)
    {
      if (!equippedGearIds[i].HasValue || (UnityEngine.Object) gearInfoArray[i].RootObj == (UnityEngine.Object) null)
      {
        gaugeRunnerList.Add((GaugeRunner) null);
      }
      else
      {
        PlayerItem playerItem = after = (PlayerItem) null;
        if (!((IEnumerable<PlayerItem>) playerItemArray).Any<PlayerItem>((Func<PlayerItem, bool>) (x =>
        {
          int id = x.id;
        ...
        else
        {
          ...
          gaugeRunnerList.Add(new GaugeRunner(gearInfoArray[i].WeaponExpGauge, (float) playerItem.gear_exp / (float) (playerItem.gear_exp + playerItem.gear_exp_next), (float) after.gear_exp / (float) (after.gear_exp + after.gear_exp_next), after.gear_level - playerItem.gear_level, levelupCallback));
        }
      }
    }
    return gaugeRunnerList;
  }
  ...
  public void OpenAfterProficiency()
  {
    ...
    for (int index = 0; index < gearInfoArray.Length; ++index)
    {
      if (!((UnityEngine.Object) gearInfoArray[index].RootObj == (UnityEngine.Object) null) && gearInfoArray[index].RootObj.activeSelf && gearInfoArray[index].GearBeforeLv != gearInfoArray[index].GearAfterLv)
      {
        gearInfoArray[index].ProficiencyAfter.transform.Find(this.toProficiencyObjectName(gearInfoArray[index].IsHideProficiency, gearInfoArray[index].GearAfterLv)).gameObject.SetActive(true);
        ...
        ((IEnumerable<UITweener>) gearInfoArray[index].DirBuguRankUP.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
        {
          x.ResetToBeginning();
          x.PlayForward();
        }));
        ((IEnumerable<UITweener>) gearInfoArray[index].ProficiencyAfter.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
        {
          x.ResetToBeginning();
          x.PlayForward();
        }));
        ((IEnumerable<UITweener>) gearInfoArray[index].ProficiencyBefore.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
        {
          if (x.tweenGroup != 0)
            return;
          x.ResetToBeginning();
  ...
  public void SetMVP(bool active)
  {
    ...
    if (!((UnityEngine.Object) this.MVPIconWhite != (UnityEngine.Object) null))
      return;
  ...
  public void ShowUnitExp()
  {
    ...
    if (this.GetUnitEXP <= 0)
      return;
    this.TxtUnitEXP.gameObject.SetActive(true);
    this.TxtUnitEXP.SetTextLocalize("ＥＸＰ＋" + this.GetUnitEXP.ToString());
    ((IEnumerable<UITweener>) this.TxtUnitEXP.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
    {
      x.ResetToBeginning();
      x.PlayForward();
    }));
  ...
  public void ShowWeaponRankUp()
  {
    ...
    if ((UnityEngine.Object) this.secondGearInfo.RootObj == (UnityEngine.Object) null || !this.secondGearInfo.RootObj.activeSelf || !this.secondGearInfo.IsGearRankUp)
      return;
  ...
  public bool IsWeaponBreakStopAnim() => (UnityEngine.Object) this.secondGearInfo.RootObj == (UnityEngine.Object) null || !this.secondGearInfo.RootObj.activeSelf ? this.firstGearInfo.IsGearBreakStopAnim : this.firstGearInfo.IsGearBreakStopAnim | this.secondGearInfo.IsGearBreakStopAnim;

  private void WeaponBreakStopAnimation(ColosseumResultUnit.GearInfo gearInfo) => ((IEnumerable<UITweener>) gearInfo.DirWeaponBroken.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
  {
    x.delay = 0.0f;
    x.duration = 0.0f;
  }));

  public bool ShowGearUpgradeSkill() => this.gearUpgradeSkills != null && this.gearUpgradeSkills.Count > 0;
