...
public class Unit004ExtraskillEquipListScene : NGSceneBase
{
  ...
  public static void changeScene(bool bStack, EditAwakeSkillParam param) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_extraskill_equip_list", (bStack ? 1 : 0) != 0, (object) param);

  public static void changeScene(bool stack, PlayerUnit unit) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_extraskill_equip_list", (stack ? 1 : 0) != 0, (object) unit);
