...
public class GuildMemberListBase : BackButtonMenuBase
{
  ...
  public bool IsOpenSortPopup => !((UnityEngine.Object) this.sortInfo == (UnityEngine.Object) null) && this.sortInfo.gameObject.GetComponent<NGTweenParts>().isActive;
  ...
  {
    this.sortInfo.gameObject.SetActive(true);
    this.sortInfo.gameObject.GetComponent<NGTweenParts>().isActive = true;
  }
  ...
  protected IEnumerator CreateSortPopup()
  {
    ...
    list.sortInfo.gameObject.GetComponent<NGTweenParts>().isActive = false;
    list.sortInfo.GetComponent<GuildMemberSort>().Initialize(list);
    ...
    SortAndFilter.SORT_TYPE_ORDER_BUY order)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allMemberBar.Count); ++index)
      this.scroll.AddColumn1(this.allMemberBar[index].gameObject, this.barWidth, this.barHeight);
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.allMemberInfo.FirstIndexOrNull<MemberBarInfo>((Func<MemberBarInfo, bool>) (v => (UnityEngine.Object) v.scroll != (UnityEngine.Object) null && (UnityEngine.Object) v.scroll.gameObject == (UnityEngine.Object) unit));
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allMemberInfo.Count); ++index)
      this.allMemberBar.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<Guild0282MemberScroll>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allMemberBar.Count); ++index)
      this.scroll.AddColumn1(this.allMemberBar[index].gameObject, this.barWidth, this.barHeight);
    this.scroll.CreateScrollPointHeight(this.barHeight, this.allMemberInfo.Count);
  ...
  protected void ResetScroll(int index)
  {
    ...
    this.allMemberInfo.Where<MemberBarInfo>((Func<MemberBarInfo, bool>) (a => (UnityEngine.Object) a.scroll == (UnityEngine.Object) scroll)).ForEach<MemberBarInfo>((System.Action<MemberBarInfo>) (b => b.scroll = (Guild0282MemberScroll) null));
  }
  ...
  {
    if ((UnityEngine.Object) this.sortInfo != (UnityEngine.Object) null)
      return;
    int num = this.sortInfo.gameObject.GetComponent<NGTweenParts>().isActive ? 1 : 0;
  }
}
