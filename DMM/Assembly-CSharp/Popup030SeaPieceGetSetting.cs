...
public class Popup030SeaPieceGetSetting : MonoBehaviour
{
  ...
  public IEnumerator Init(List<PieceGetResult> getPiece, System.Action callback)
  {
    ...
    if (unitUnitList != null)
    {
      ...
      {
        GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.unitIconPrefab);
        gameObject.gameObject.SetParent(this.grid.transform.gameObject);
