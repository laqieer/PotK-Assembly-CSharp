...
namespace GameCore
{
  ...
  public class XorShift
  {
    ...
    public int RangeInt(int min, int max) => (int) (this.NextDouble() * (double) ((long) max - (long) min) + (double) min);

    public float RangeFloat(float min, float max) => (float) (this.NextDouble() * ((double) max - (double) min)) + min;
