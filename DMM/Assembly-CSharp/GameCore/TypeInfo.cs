...
namespace GameCore
{
  public class TypeInfo
  {
    ...
    public override bool Equals(object obj) => obj != null && obj is TypeInfo typeInfo && this.AssemblyQualifiedName == typeInfo.AssemblyQualifiedName;

    public override string ToString() => string.Format("[TypeInfo: {0}]", (object) this.AssemblyQualifiedName);
  }
}
