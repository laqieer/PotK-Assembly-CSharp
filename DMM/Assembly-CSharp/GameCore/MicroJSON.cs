...
namespace GameCore
{
  public class MicroJSON
  {
    ...
    public static MicroJSON.IValue FromMiniJSON(object obj, bool toIntern = false) => (MicroJSON.IValue) new MicroJSON.Value(MicroJSON.ParseMiniJSONValue(obj, toIntern));
    ...
    public class Value : MicroJSON.IValue
    {
      ...
      public bool ContainsKey(string key) => this.value is IDictionary<string, object> dictionary ? dictionary.ContainsKey(key) : throw new Exception("value must be object");

      public MicroJSON.IValue this[string key] => this.value is IDictionary<string, object> dictionary ? (MicroJSON.IValue) new MicroJSON.Value(dictionary[key]) : throw new Exception("value must be object");
      ...
      public MicroJSON.IValue this[int index] => this.value is Array array ? (MicroJSON.IValue) new MicroJSON.Value(array.GetValue(index)) : throw new Exception("value must be array");
