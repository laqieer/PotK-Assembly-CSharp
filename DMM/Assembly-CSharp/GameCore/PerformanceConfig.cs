...
namespace GameCore
{
  public class PerformanceConfig
  {
    ...
    public bool IsNotAutoSaveBeforeDuel => !MasterData.AppSetupTuning.ContainsKey(2) || MasterData.AppSetupTuning[2].IsEnable;

    public bool IsTuningEventTopSetting => !MasterData.AppSetupTuning.ContainsKey(3) || MasterData.AppSetupTuning[3].IsEnable;

    public bool IsTuningTitleToHome => !MasterData.AppSetupTuning.ContainsKey(4) || MasterData.AppSetupTuning[4].IsEnable;
    ...
    public bool IsTuningGachaInitialize => !MasterData.AppSetupTuning.ContainsKey(7) || MasterData.AppSetupTuning[7].IsEnable;

    public bool IsTuningMissionInitialize => !MasterData.AppSetupTuning.ContainsKey(8) || MasterData.AppSetupTuning[8].IsEnable;
    ...
    public bool IsOnedariDate => !MasterData.AppSetupTuning.ContainsKey(13) || MasterData.AppSetupTuning[13].IsEnable;

    public bool IsQuestResult => !MasterData.AppSetupTuning.ContainsKey(14) || MasterData.AppSetupTuning[14].IsEnable;

    public bool IsGear3 => !MasterData.AppSetupTuning.ContainsKey(15) || MasterData.AppSetupTuning[15].IsEnable;

    public bool IsSendErrorTracker => !MasterData.AppSetupTuning.ContainsKey(16) || MasterData.AppSetupTuning[16].IsEnable;
  }
}
