...
namespace GameCore
{
  public class Parser
  {
    ...
    private INode factor() => this.lex.Try("IF", ")", (Func<INode>) (() => this.cond())) ?? this.lex.Try("USESKILL", ")", (Func<INode>) (() => this.useskill())) ?? this.lex.Try("USEITEM", ")", (Func<INode>) (() => this.useitem())) ?? this.lex.Try("(", ")", (Func<INode>) (() => this.exp())) ?? (INode) new Node(this.lex.TokenAndNext());
