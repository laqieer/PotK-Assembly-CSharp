...
namespace GameCore
{
  ...
  public class BattleInfo
  {
    ...
    public BattleStageGuest[] Guests => this.guest_ids != null ? ((IEnumerable<int>) this.guest_ids).Select<int, BattleStageGuest>((Func<int, BattleStageGuest>) (x => MasterData.BattleStageGuest[x])).ToArray<BattleStageGuest>() : (BattleStageGuest[]) null;

    public BattleEarthStageGuest[] EarthGuests => this.guest_ids != null ? ((IEnumerable<int>) this.guest_ids).Select<int, BattleEarthStageGuest>((Func<int, BattleEarthStageGuest>) (x => MasterData.BattleEarthStageGuest[x])).ToArray<BattleEarthStageGuest>() : (BattleEarthStageGuest[]) null;
    ...
    public BattleStageEnemy[] Enemies => this.enemy_ids != null ? ((IEnumerable<int>) this.enemy_ids).Select<int, BattleStageEnemy>((Func<int, BattleStageEnemy>) (x => MasterData.BattleStageEnemy[x])).ToArray<BattleStageEnemy>() : (BattleStageEnemy[]) null;
    ...
    public BattleStageUserUnit[] UserEnemies => this.user_enemy_ids != null ? ((IEnumerable<int>) this.user_enemy_ids).Select<int, BattleStageUserUnit>((Func<int, BattleStageUserUnit>) (x => MasterData.BattleStageUserUnit[x])).ToArray<BattleStageUserUnit>() : (BattleStageUserUnit[]) null;
    ...
    public BattleStagePanelEvent[] Panels => this.panel_ids != null ? ((IEnumerable<int>) this.panel_ids).Select<int, BattleStagePanelEvent>((Func<int, BattleStagePanelEvent>) (x => MasterData.BattleStagePanelEvent[x])).ToArray<BattleStagePanelEvent>() : (BattleStagePanelEvent[]) null;
    ...
    public static BattleInfo MakePvNpcBattleInfo(
      WebAPI.Response.PvpPlayerNpcStart response)
    {
      BattleInfo battleInfo = new BattleInfo();
      battleInfo.quest_type = CommonQuestType.PvP;
      battleInfo.isStoryEnable = false;
    ...
    public static BattleInfo MakeRaidBattleInfo(
      WebAPI.Response.GuildraidBattleStart webResponse)
    {
      BattleInfo battleInfo = new BattleInfo()
      {
    ...
    public static BattleInfo MakeRaidBattleInfo(
      WebAPI.Response.GuildraidBattleResume webResponse)
    {
      BattleInfo battleInfo = new BattleInfo()
      {
        isSimulation = webResponse.is_simulation,
