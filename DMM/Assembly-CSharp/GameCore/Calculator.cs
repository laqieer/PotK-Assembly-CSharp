...
namespace GameCore
{
  public class Calculator
  {
    ...
    public T getParam<T>(Dictionary<string, float> vars_) => this.getEdgeNode(vars_) is IParam<T> edgeNode ? edgeNode.getParam(new Func<string, float>(this.dictConvert)) : default (T);
  }
}
