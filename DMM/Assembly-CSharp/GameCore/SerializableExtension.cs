...
namespace GameCore
{
  ...
  {
    public static void Serialize(this bool self, Stream writer) => new BinaryWriter(writer).Write(self);

    public static bool Deserialize(this bool self, Stream reader) => new BinaryReader(reader).ReadBoolean();
    ...
    public static void Serialize(this int self, Stream writer) => new BinaryWriter(writer).Write(self);

    public static int Deserialize(this int self, Stream reader) => new BinaryReader(reader).ReadInt32();
    ...
    public static void Serialize(this float self, Stream writer) => new BinaryWriter(writer).Write(self);

    public static float Deserialize(this float self, Stream reader) => new BinaryReader(reader).ReadSingle();
    ...
    public static void Serialize(this string self, Stream writer) => new BinaryWriter(writer).Write(self);

    public static string Deserialize(this string self, Stream reader) => new BinaryReader(reader).ReadString();
