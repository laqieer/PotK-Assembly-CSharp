...
namespace GameCore
{
  public class Future
  {
    ...
    public static Future<T> Single<T>(T value) => new Future<T>((Func<Promise<T>, IEnumerator>) (promise => Future.SingleFunc<T>(value, promise)));

    private static IEnumerator WhenAllFunc<T1>(
      Future<T1> arg1,
      Promise<Tuple<T1>> result)
    {
    ...
    public static Future<Tuple<T1>> WhenAll<T1>(Future<T1> arg1) => new Future<Tuple<T1>>((Func<Promise<Tuple<T1>>, IEnumerator>) (promise => Future.WhenAllFunc<T1>(arg1, promise)));

    public static Future<TResult> WhenAllThen<T1, TResult>(
      Future<T1> arg1,
      Func<T1, TResult> f)
    {
    ...
    public static Future<Tuple<T1, T2>> WhenAll<T1, T2>(Future<T1> arg1, Future<T2> arg2) => new Future<Tuple<T1, T2>>((Func<Promise<Tuple<T1, T2>>, IEnumerator>) (promise => Future.WhenAllFunc<T1, T2>(arg1, arg2, promise)));
