...
namespace GameCore
{
  ...
  {
    private BL.DropData createFieldEvent(Reward reward) => new BL.DropData()
    {
      reward = reward
    };

    private Future<BL.Skill> createSkill(PlayerUnitSkills playerSkill) => Future.Single<BL.Skill>(this.createSkillCommon(playerSkill.skill_id, playerSkill.level));

    private Future<BL.Skill> createSkill(GearGearSkill gearSkill) => Future.Single<BL.Skill>(this.createSkillCommon(gearSkill.skill_BattleskillSkill, gearSkill.skill_level));

    private Future<BL.Skill> createSkill(GearReisouSkill reisouSkill) => Future.Single<BL.Skill>(this.createSkillCommon(reisouSkill.skill_BattleskillSkill, reisouSkill.skill_level));

    private Future<BL.Skill> createSkill(PlayerAwakeSkill awakeSkill) => Future.Single<BL.Skill>(this.createSkillCommon(awakeSkill.skill_id, awakeSkill.level));
    ...
    private Future<BL.MagicBullet> createMagicBullet(PlayerUnitSkills playerSkill) => Future.Single<BL.MagicBullet>(new BL.MagicBullet()
    {
      skillId = playerSkill.skill.ID
    });

    private Future<BL.MagicBullet> createMagicBullet(GearGearSkill gearSkill) => Future.Single<BL.MagicBullet>(new BL.MagicBullet()
    {
      skillId = gearSkill.skill.ID
    });

    private Future<BL.MagicBullet> createMagicBullet(GearReisouSkill reisouSkill) => Future.Single<BL.MagicBullet>(new BL.MagicBullet()
    {
      skillId = reisouSkill.skill.ID
    });

    private Future<BL.MagicBullet> createMagicBullet(PlayerAwakeSkill awakeSkill) => Future.Single<BL.MagicBullet>(new BL.MagicBullet()
    {
      skillId = awakeSkill.masterData.ID
    });

    private Future<BL.MagicBullet> createMagicBullet(IAttackMethod attackMethod) => Future.Single<BL.MagicBullet>(new BL.MagicBullet()
    {
      ...
      Checker checkRules)
    {
      ...
      List<PlayerUnitSkills> source = !disableSkills ? ((IEnumerable<PlayerUnitSkills>) pu.skills).Concat<PlayerUnitSkills>((IEnumerable<PlayerUnitSkills>) pu.retrofitSkills).ToList<PlayerUnitSkills>() : ((IEnumerable<PlayerUnitSkills>) pu.skills).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (x =>
      {
      ...
      PlayerUnitSkills[] array1 = source.Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (v => v.skill.skill_type == BattleskillSkillType.command)).ToArray<PlayerUnitSkills>();
      PlayerUnitSkills[] array2 = source.Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (v => v.skill.skill_type == BattleskillSkillType.release)).ToArray<PlayerUnitSkills>();
      PlayerUnitSkills[] array3 = source.Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (v => v.skill.skill_type == BattleskillSkillType.SEA)).ToArray<PlayerUnitSkills>();
      PlayerUnitSkills[] array4 = source.Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (v => v.skill.skill_type == BattleskillSkillType.magic)).ToArray<PlayerUnitSkills>();
      PlayerUnitSkills[] array5 = source.Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (v => v.skill.skill_type == BattleskillSkillType.duel)).ToArray<PlayerUnitSkills>();
      GearGearSkill[] gearGearSkillArray = !(pu.equippedGear != (PlayerItem) null) || disableSkills ? new GearGearSkill[0] : pu.equippedGear.skills;
      List<GearGearSkill> list1 = ((IEnumerable<GearGearSkill>) gearGearSkillArray).Where<GearGearSkill>((Func<GearGearSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.command)).ToList<GearGearSkill>();
      List<GearGearSkill> list2 = ((IEnumerable<GearGearSkill>) gearGearSkillArray).Where<GearGearSkill>((Func<GearGearSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.duel)).ToList<GearGearSkill>();
      List<GearGearSkill> list3 = ((IEnumerable<GearGearSkill>) gearGearSkillArray).Where<GearGearSkill>((Func<GearGearSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.magic)).ToList<GearGearSkill>();
      ...
      GearReisouSkill[] gearReisouSkillArray = !(pu.equippedGear != (PlayerItem) null) || !(pu.equippedReisou != (PlayerItem) null) || disableSkills ? new GearReisouSkill[0] : pu.equippedReisou.getReisouSkills(pu.equippedGear.entity_id);
      List<GearReisouSkill> list4 = ((IEnumerable<GearReisouSkill>) gearReisouSkillArray).Where<GearReisouSkill>((Func<GearReisouSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.command)).ToList<GearReisouSkill>();
      List<GearReisouSkill> list5 = ((IEnumerable<GearReisouSkill>) gearReisouSkillArray).Where<GearReisouSkill>((Func<GearReisouSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.duel)).ToList<GearReisouSkill>();
      List<GearReisouSkill> list6 = ((IEnumerable<GearReisouSkill>) gearReisouSkillArray).Where<GearReisouSkill>((Func<GearReisouSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.magic)).ToList<GearReisouSkill>();
    ...
    private float CalcIndicatorLevel(IEnumerable<PlayerUnit> playerUnits) => !playerUnits.Any<PlayerUnit>() ? 0.0f : playerUnits.Where<PlayerUnit>((Func<PlayerUnit, bool>) (x => x != (PlayerUnit) null)).Select<PlayerUnit, float>((Func<PlayerUnit, float>) (x => (float) x.level * x.unit.rarity.indicator_level_rate)).OrderByDescending<float, float>((Func<float, float>) (x => x)).Max();
      ...
      int playerUnitId)
    {
      ...
      {
        BL.Unit pu = unit;
        IEnumerable<BL.Skill> first = (IEnumerable<BL.Skill>) pu.skills;
        if (pu.hasOugi)
        ...
        foreach (BL.Skill skill1 in first)
        {
          ...
          foreach (BattleskillEffect battleskillEffect in ((IEnumerable<BattleskillEffect>) skill.skill.Effects).Where<BattleskillEffect>((Func<BattleskillEffect, bool>) (x => x.EffectLogic.Enum == BattleskillEffectLogicEnum.facility_creation && x.checkLevel(skill.level))))
          {
            BattleskillEffect effect = battleskillEffect;
            int maxCount = effect.GetInt(BattleskillEffectLogicArgumentEnum.creation_max);
            for (int i = 0; i < maxCount; ++i)
            {
              PlayerUnit pu1 = PlayerUnit.FromFacility(MasterData.UnitUnit[effect.GetInt(BattleskillEffectLogicArgumentEnum.facility_unit_id)], playerUnitId);
              pu1.is_enemy = isEnemy;
              pu1.spawn_turn = int.MaxValue;
              Future<BL.Unit> future = this.createUnitByPlayerUnit(pu1, unitIndex, false, 0, (Checker) null);
              IEnumerator e = future.Wait();
              while (e.MoveNext())
                yield return e.Current;
              e = (IEnumerator) null;
              ...
              facility1.isPutOn = facility2.is_puton;
              facility1.isView = facility2.is_view;
              facility1.skillUnitIndex = new int?(pu.index);
              result.facility = facility1;
              result.AIMoveGroupOrder = 100;
              facilities.Add(result);
              if (info.quest_type == CommonQuestType.Tower)
      ...
      int mapFacilityCount)
    {
      ...
      List<BL.UnitPosition> list6 = list1.Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) unitPositionList3).Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) unitPositionList2).Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) list2).Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) list3).Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) list4).Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) list5).ToList<BL.UnitPosition>();
    ...
    private void setGearSkills(
      ...
      bool targetOnly = false)
    {
      System.Action<BL.Unit, PlayerItem, int> action1 = (System.Action<BL.Unit, PlayerItem, int>) ((unit, gear, gearIndex) =>
      {
      ...
      System.Action<BL.Unit, int, PlayerItem, int> action2 = (System.Action<BL.Unit, int, PlayerItem, int>) ((unit, gear_id, reisou, gearIndex) =>
      {
    ...
    private IEnumerator initializeData(BattleInfo battleInfo, BL env)
    {
      ...
      else
      {
        ...
        List<BL.UnitPosition> list3 = first.Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) unitPositionList).Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) list1).Concat<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) list2).ToList<BL.UnitPosition>();
