  ...
  public class Judgement
  {
      ...
      bool isAI)
    {
      ...
      if (packedSkillEffect.HasKey(BattleskillEffectLogicArgumentEnum.level_up_status_type))
      {
        ...
        if (statusType2 != 0)
        {
          ...
          Decimal num1 = (Decimal) packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.target_level_up_status_min);
          Decimal num2 = (Decimal) packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.target_level_up_status_max);
          if (num1 != 0M && levelUpStatusRatio < num1 || num2 != 0M && levelUpStatusRatio >= num2)
            return false;
        }
      }
      ...
      bool isAI)
    {
      ...
      if (packedSkillEffect.HasKey(BattleskillEffectLogicArgumentEnum.level_up_status_type))
      {
        ...
        {
          Decimal levelUpStatusRatio = BattleFuncs.GetLevelUpStatusRatio(unit, statusType2);
          Decimal num2 = (Decimal) packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.target_level_up_status_min);
          Decimal num3 = (Decimal) packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.target_level_up_status_max);
          if (num2 != 0M && levelUpStatusRatio < num2 || num3 != 0M && levelUpStatusRatio >= num3)
            return false;
        }
      }
      ...
      int? unitHp)
    {
      ...
      int num1 = BattleFuncs.getForceID(unit.originalUnit) == BattleFuncs.getForceID(iskillEffectListUnit.originalUnit) ? 0 : 1;
      BL.UnitPosition unitPosition = BattleFuncs.iSkillEffectListUnitToUnitPosition(iskillEffectListUnit);
      BL.Panel unitPanel = unitPosition != null ? BattleFuncs.getPanel(unitPosition.row, unitPosition.column) : (BL.Panel) null;
      int num2 = effect.effect.GetInt(BattleskillEffectLogicArgumentEnum.effect_target);
      return num1 == num2 && (effect.GetCheckInvokeGeneric().DoCheck(iskillEffectListUnit, unit, colosseumTurn, targetHp: unitHp, attackType: attackType, unitPanel: unitPanel, targetPanel: panel, effect: effect) && (iskillEffectListUnit != target || !BattleFuncs.isSkillsAndEffectsInvalid(target, unit)) && (!BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target)));
    }
...
label_6:
    ...
    {
      IEnumerable<Tuple<BL.SkillEffect, int>> fixEffectParams = unit.skillEffects.GetFixEffectParams(logic);
      List<BattleFuncs.SkillParam> skillParamList = (List<BattleFuncs.SkillParam>) null;
      foreach (Tuple<BL.SkillEffect, int> tuple in fixEffectParams)
      {
        if (!BattleFuncs.isSealedSkillEffect(unit, tuple.Item1))
        {
          if (skillParamList == null)
            skillParamList = new List<BattleFuncs.SkillParam>();
          skillParamList.Add(BattleFuncs.SkillParam.CreateAdd(unit.originalUnit, tuple.Item1, (float) tuple.Item2));
        }
      }
      ...
      BattleskillEffectLogicEnum logic)
    {
      ...
      foreach (Tuple<BL.SkillEffect, float> tuple in ratioEffectParams)
      {
        if (!BattleFuncs.isSealedSkillEffect(unit, tuple.Item1))
        {
          if (skillParamList == null)
            skillParamList = new List<BattleFuncs.SkillParam>();
          skillParamList.Add(BattleFuncs.SkillParam.CreateMul(unit.originalUnit, tuple.Item1, tuple.Item2));
        }
      }
      return skillParamList;
    }
    ...
    public class GearParameter
    {
      ...
      public static Judgement.GearParameter FromPlayerGear(ItemInfo item) => Judgement.GearParameter.FromPlayerGear(Array.Find<PlayerItem>(SMManager.Get<PlayerItem[]>(), (Predicate<PlayerItem>) (x => x.id == item.itemID)));

      public static Judgement.GearParameter FromPlayerGear(PlayerItem pi) => new Judgement.GearParameter()
      {
        Power = pi.power,
      ...
      public static Judgement.GearParameter FromGearGear(GearGear gear) => new Judgement.GearParameter()
      {
        Power = gear.power,
    ...
    public class NonBattleParameter
    {
      ...
      public static Judgement.NonBattleParameter FromPlayerUnitWithoutGear(
        PlayerUnit playerUnit)
      {
          ...
          switch (skillEffect.effect.EffectLogic.opt_test3)
          {
            ...
            case 41:
              if (Judgement.CheckEnabledBuffDebuffClamp(skillEffect, this.beUnit, this.panel, this.isAI))
              {
                if (skillEffect.effect.EffectLogic.effect_tag2 == BattleskillEffectTag.fix_value)
                {
                  int num2 = skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.max_value);
                  int num3 = skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.min_value);
                  ...
                  skillParamClamp.fixMax = new int?(num2);
label_69:
                  ...
                  skillParamClamp.fixMin = new int?(num3);
                }
                else
                {
                  Decimal num2 = (Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.max_percentage);
                  Decimal num3 = (Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.min_percentage);
                  Decimal? nullable2;
                  ...
                  skillParamClamp.ratioMax = new Decimal?(num2);
label_75:
                  ...
                  skillParamClamp.ratioMin = new Decimal?(num3);
                }
label_78:
                num1 = -1;
                break;
            ...
            case 43:
              ...
              int num5 = isHp ? 1 : 0;
              if (!Judgement.CheckEnabledGenericBuffDebuff(effect, beUnit2, colosseumTurn, nbpCache, hp, panel, num5 != 0))
                continue;
              break;
            default:
              continue;
          ...
          if (num1 >= 0)
          {
            if (skillEffect.effect.EffectLogic.effect_tag2 == BattleskillEffectTag.fix_value)
            {
              int num2 = flag ? skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.value) + skillEffect.baseSkillLevel * skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_ratio) : skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.value);
              skillParam.Add(BattleFuncs.SkillParam.CreateAdd(beUnit1.originalUnit, skillEffect, (float) num2, (object) num1));
            }
            else
            {
    ...
    public class BeforeDuelUnitParameter
    {
        ...
        Judgement.BeforeDuelUnitParameter.FromBeUnitData data = null)
      {
        ...
        {
          Judgement.GearParameter rhs2 = Judgement.GearParameter.FromPlayerGear(playerUnit.equippedReisou3);
          if (lhs != null)
            lhs = Judgement.GearParameter.AddReisou(lhs, rhs2);
        }
        ...
        float hpRatio = 0.0f;
        int turnCount = BattleFuncs.getPhaseState() != null ? BattleFuncs.getPhaseState().absoluteTurnCount : 0;
          ...
          foreach (object processEffect in effectUnit2.skillEffects.GetProcessEffects(process))
          {
            ...
            switch (skillEffect.effect.EffectLogic.opt_test3)
            {
              ...
              case 17:
                if (unitDeckUnits != null)
                {
                  skillEffect = Judgement.GetEnabledDeadCountBuffDebuff(effects, beUnit, beTarget, turnCount, unitDeckUnits, (IEnumerable<BL.Unit>) null, BattleskillInvokeGameModeEnum.quest, isAI);
                  if (skillEffect != null)
                    break;
                  continue;
                }
              ...
              case 18:
                if (targetDeckUnits != null)
                {
                  skillEffect = Judgement.GetEnabledDeadCountBuffDebuff(effects, beUnit, beTarget, turnCount, (IEnumerable<BL.Unit>) null, targetDeckUnits, BattleskillInvokeGameModeEnum.quest, isAI);
                  if (skillEffect != null)
                    break;
                  continue;
                }
              ...
              case 19:
                ...
                {
                  skillEffect = Judgement.GetEnabledDeadCountBuffDebuff(effects, beUnit, beTarget, turnCount, unitDeckUnits, targetDeckUnits, BattleskillInvokeGameModeEnum.quest, isAI);
                  if (skillEffect != null)
                    break;
                  continue;
                }
              ...
              case 27:
                if (Judgement.CheckEnabledParamDiffBuffDebuff(skillEffect, beUnit, beTarget, work, num1, num2))
                {
                  ...
                  int num5 = Math.Abs(BattleFuncs.GetParamDiffValue(skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.target_param_type), work.target.nbpCache, num2) - paramDiffValue);
                  int num6 = (double) num4 < 0.0 ? Mathf.FloorToInt((float) ((Decimal) num5 * (Decimal) num4)) : Mathf.CeilToInt((float) ((Decimal) num5 * (Decimal) num4));
                  skillParamList.Add(BattleFuncs.SkillParam.CreateAdd(effectUnit2.originalUnit, skillEffect, (float) num6));
                  num3 = -1;
                  break;
                }
                continue;
              case 28:
                if (Judgement.CheckEnabledParamDiffEnemyBuffDebuff(skillEffect, beUnit, beTarget, work, num1, num2))
                {
                  ...
                  int num5 = Math.Abs(BattleFuncs.GetParamDiffValue(skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.target_param_type), work.self.nbpCache, num1) - paramDiffValue);
                  int num6 = (double) num4 < 0.0 ? Mathf.FloorToInt((float) ((Decimal) num5 * (Decimal) num4)) : Mathf.CeilToInt((float) ((Decimal) num5 * (Decimal) num4));
                  skillParamList.Add(BattleFuncs.SkillParam.CreateAdd(effectUnit2.originalUnit, skillEffect, (float) num6));
                  num3 = -1;
                  break;
              ...
              case 42:
                ...
                if (skillEffect.effect.EffectLogic.effect_tag2 == BattleskillEffectTag.fix_value)
                {
                  ...
                  if (skillParamClamp.fixMax.HasValue)
                  {
                    ...
                    if (!(num6 < valueOrDefault & fixMax.HasValue))
                      goto label_103;
                  }
...
label_103:
                  if (skillParamClamp.fixMin.HasValue)
                  {
                    ...
                    if (!(num6 > valueOrDefault & fixMin.HasValue))
                      goto label_112;
                  }
                ...
                {
                  Decimal num4 = (Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.max_percentage);
                  Decimal num5 = (Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.min_percentage);
                  if (skillParamClamp.ratioMax.HasValue)
                  {
                    Decimal num6 = num4;
                    Decimal? ratioMax = skillParamClamp.ratioMax;
                    Decimal valueOrDefault = ratioMax.GetValueOrDefault();
                    if (!(num6 < valueOrDefault & ratioMax.HasValue))
                      goto label_109;
                  }
                  skillParamClamp.ratioMax = new Decimal?(num4);
label_109:
                  if (skillParamClamp.ratioMin.HasValue)
                  {
                    Decimal num6 = num5;
                    ...
                    if (!(num6 > valueOrDefault & ratioMin.HasValue))
                      goto label_112;
                  }
                  skillParamClamp.ratioMin = new Decimal?(num5);
                }
label_112:
                num3 = -1;
                break;
            ...
            if (num3 >= 0)
            {
              if (skillEffect.effect.EffectLogic.effect_tag2 == BattleskillEffectTag.fix_value)
              {
                int num4 = flag3 ? skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.value) + skillEffect.baseSkillLevel * skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_ratio) : skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.value);
                skillParamList.Add(BattleFuncs.SkillParam.CreateAdd(effectUnit2.originalUnit, skillEffect, (float) num4, (object) num3));
              }
              else
              {
        ...
        int num7 = beMagicBullet == null ? 0 : beMagicBullet.power;
        List<BattleFuncs.SkillParam> skillParams3 = new List<BattleFuncs.SkillParam>();
        List<BattleFuncs.SkillParam> skillParams4 = new List<BattleFuncs.SkillParam>();
        ...
        int num8 = BattleFuncs.calcSkillParamAdd(skillParams3);
        int num9 = BattleFuncs.calcSkillParamAdd(skillParams4);
        int num10 = BattleFuncs.calcSkillParamAdd(skillParams5);
        int num11 = BattleFuncs.calcSkillParamAdd(skillParams6);
        float num12 = BattleFuncs.calcSkillParamMul(skillParams3);
        float num13 = BattleFuncs.calcSkillParamMul(skillParams4);
        float num14 = BattleFuncs.calcSkillParamMul(skillParams5);
        float num15 = BattleFuncs.calcSkillParamMul(skillParams6);
        float num16 = incr.physical_defense_ratio_incr.HasValue ? (float) num8 : Mathf.Ceil((float) incr.physical_defense_incr * num12) + (float) num8;
        float num17 = incr.magic_defense_ratio_incr.HasValue ? (float) num9 : Mathf.Ceil((float) incr.magic_defense_incr * num13) + (float) num9;
        float num18 = incr.hit_ratio_incr.HasValue ? (float) num10 : Mathf.Ceil((float) incr.hit_incr * num14) + (float) num10;
        float num19 = incr.evasion_ratio_incr.HasValue ? (float) num11 : Mathf.Ceil((float) incr.evasion_incr * num15) + (float) num11;
        float num20 = incr.physical_defense_ratio_incr.HasValue ? incr.physical_defense_ratio_incr.Value * num12 : 1f;
        float num21 = incr.magic_defense_ratio_incr.HasValue ? incr.magic_defense_ratio_incr.Value * num13 : 1f;
        float num22 = incr.hit_ratio_incr.HasValue ? incr.hit_ratio_incr.Value * num14 : 1f;
        float num23 = incr.evasion_ratio_incr.HasValue ? incr.evasion_ratio_incr.Value * num15 : 1f;
        ...
        r.Hit = (int) BattleFuncs.calcSkillParam((IEnumerable<BattleFuncs.SkillParam>) skillParams1[13], skillParamClampArray[13], (double) ((r.Dexterity * 3 + r.Luck) / 2 + lhs.Hit + proficiencyIncr.hit), duelSkillIncr.skillMulHit * num22, (float) ((double) (duelSkillIncr.skillAddHit + gearKindIncr.Item2 + beforeDuelDuelSupport.hit) + (double) num18 + (numArray != null ? (double) numArray[13] : 0.0)), swapState);
        ...
        r.Evasion = (int) BattleFuncs.calcSkillParam((IEnumerable<BattleFuncs.SkillParam>) skillParams1[15], skillParamClampArray[15], (double) ((r.Agility * 3 + r.Luck) / 2 + lhs.Evasion + proficiencyIncr.evasion), duelSkillIncr.skillMulEvasion * num23, (float) ((double) (duelSkillIncr.skillAddEvasion + beforeDuelDuelSupport.evasion) + (double) num19 + (numArray != null ? (double) numArray[15] : 0.0)), swapState);
        ...
        Tuple<float, float> tuple2 = BattleFuncs.calcSkillParam2(skillParams1[2], skillParamClampArray[2], (float) playerUnit.total_intelligence, duelSkillIncr.skillMulIntelligence, (float) (lhs.Intelligence + duelSkillIncr.skillAddIntelligence + (numArray != null ? numArray[2] : 0)), skillParams1[11], skillParamClampArray[11], (float) num7 + (float) magicalPower * elementOrKindRatio + (float) proficiencyIncr.magic_attack, duelSkillIncr.skillMulMagicAttack, (float) (duelSkillIncr.skillAddMagicAttack + gearKindIncr.Item1 + (numArray != null ? numArray[11] : 0)), swapState);
        Tuple<float, float> tuple3 = BattleFuncs.calcSkillParam2(skillParams1[3], skillParamClampArray[3], (float) playerUnit.total_vitality, duelSkillIncr.skillMulVitality, (float) (lhs.Vitality + duelSkillIncr.skillAddVitality + (numArray != null ? numArray[3] : 0)), skillParams1[10], skillParamClampArray[10], (float) lhs.PhysicalDefense, duelSkillIncr.skillMulPhysicalDefense * num20, (float) ((double) duelSkillIncr.skillAddPhysicalDefense + (double) num16 + (numArray != null ? (double) numArray[10] : 0.0)), swapState);
        Tuple<float, float> tuple4 = BattleFuncs.calcSkillParam2(skillParams1[4], skillParamClampArray[4], (float) playerUnit.total_mind, duelSkillIncr.skillMulMind, (float) (lhs.Mind + duelSkillIncr.skillAddMind + (numArray != null ? numArray[4] : 0)), skillParams1[12], skillParamClampArray[12], (float) lhs.MagicDefense, duelSkillIncr.skillMulMagicDefense * num21, (float) ((double) duelSkillIncr.skillAddMagicDefense + (double) num17 + (numArray != null ? (double) numArray[12] : 0.0)), swapState);
        ...
        int num24 = BattleFuncs.calcEquippedGearWeight(playerUnit.initial_gear, playerUnit.equippedGear, playerUnit.equippedGear2, playerUnit.equippedGear3);
        r.AttackSpeed = (int) BattleFuncs.calcSkillParam((IEnumerable<BattleFuncs.SkillParam>) skillParams1[17], skillParamClampArray[17], (double) (r.Agility - num24 - (beMagicBullet == null ? 0 : beMagicBullet.weight)), extraAdd: (numArray != null ? (float) numArray[17] : 0.0f), swapState: swapState);
        ...
        int colosseumTurn)
      {
        ...
        {
          Judgement.GearParameter rhs2 = Judgement.GearParameter.FromPlayerGear(equipped_reisou3);
          if (lhs != null)
            lhs = Judgement.GearParameter.AddReisou(lhs, rhs2);
        }
        Judgement.BeforeDuelUnitParameter r = new Judgement.BeforeDuelUnitParameter();
        ...
        for (int process = 0; process < 4; ++process)
        {
          BL.Unit unit = process != 3 ? beUnit : beTarget;
          bool isHp = process == 0;
          Dictionary<int, List<BL.SkillEffect>> useRemainSkillEffects = new Dictionary<int, List<BL.SkillEffect>>();
          foreach (object processEffect in unit.skillEffects.GetProcessEffects(process))
          {
            ...
            switch (skillEffect.effect.EffectLogic.opt_test3)
            {
              ...
              case 27:
                if (Judgement.CheckEnabledParamDiffBuffDebuff(skillEffect, (BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, work, attackHp, defenseHp))
                {
                  ...
                  int num4 = (double) num2 < 0.0 ? Mathf.FloorToInt((float) ((Decimal) num3 * (Decimal) num2)) : Mathf.CeilToInt((float) ((Decimal) num3 * (Decimal) num2));
                  skillParamList.Add(BattleFuncs.SkillParam.CreateAdd(unit.originalUnit, skillEffect, (float) num4));
                  num1 = -1;
                  break;
                }
                continue;
              case 28:
                if (Judgement.CheckEnabledParamDiffEnemyBuffDebuff(skillEffect, (BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, work, attackHp, defenseHp))
                {
                  ...
                  int num3 = Math.Abs(BattleFuncs.GetParamDiffValue(skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.target_param_type), work.self.nbpCache, attackHp) - paramDiffValue);
                  int num4 = (double) num2 < 0.0 ? Mathf.FloorToInt((float) ((Decimal) num3 * (Decimal) num2)) : Mathf.CeilToInt((float) ((Decimal) num3 * (Decimal) num2));
                  skillParamList.Add(BattleFuncs.SkillParam.CreateAdd(unit.originalUnit, skillEffect, (float) num4));
                  num1 = -1;
                  break;
              ...
              case 42:
                ...
                if (skillEffect.effect.EffectLogic.effect_tag2 == BattleskillEffectTag.fix_value)
                {
                  ...
                  if (skillParamClamp.fixMax.HasValue)
                  {
                    ...
                    int? fixMax = skillParamClamp.fixMax;
                    int valueOrDefault = fixMax.GetValueOrDefault();
                    if (!(num4 < valueOrDefault & fixMax.HasValue))
                      goto label_67;
                  }
                  skillParamClamp.fixMax = new int?(num2);
label_67:
                  if (skillParamClamp.fixMin.HasValue)
                  {
                    ...
                    int? fixMin = skillParamClamp.fixMin;
                    int valueOrDefault = fixMin.GetValueOrDefault();
                    if (!(num4 > valueOrDefault & fixMin.HasValue))
                      goto label_76;
                  }
                  skillParamClamp.fixMin = new int?(num3);
                }
                else
                {
                  ...
                  if (skillParamClamp.ratioMax.HasValue)
                  {
                    ...
                    Decimal? ratioMax = skillParamClamp.ratioMax;
                    Decimal valueOrDefault = ratioMax.GetValueOrDefault();
                    if (!(num4 < valueOrDefault & ratioMax.HasValue))
                      goto label_73;
                  }
                  skillParamClamp.ratioMax = new Decimal?(num2);
label_73:
                  if (skillParamClamp.ratioMin.HasValue)
                  {
                    ...
                    Decimal? ratioMin = skillParamClamp.ratioMin;
                    Decimal valueOrDefault = ratioMin.GetValueOrDefault();
                    if (!(num4 > valueOrDefault & ratioMin.HasValue))
                      goto label_76;
                  }
                  skillParamClamp.ratioMin = new Decimal?(num3);
                }
label_76:
            ...
            if (num1 >= 0)
            {
              ...
              {
                int num2 = flag ? skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.value) + skillEffect.baseSkillLevel * skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_ratio) : skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.value);
                skillParamList.Add(BattleFuncs.SkillParam.CreateAdd(unit.originalUnit, skillEffect, (float) num2, (object) num1));
              }
              else
              {
                float mulParam = flag ? (float) ((Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage) + (Decimal) skillEffect.baseSkillLevel * (Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.skill_ratio)) : skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage);
                skillParamList.Add(BattleFuncs.SkillParam.CreateMul(unit.originalUnit, skillEffect, mulParam, (object) num1));
              }
            }
          }
          Judgement.ApplyUseRemainSkillEffect(useRemainSkillEffects, skillParams1, (BL.ISkillEffectListUnit) unit, r);
          if (process == 0)
          {
        ...
        int num5 = beMagicBullet == null ? 0 : beMagicBullet.power;
        ...
        Tuple<float, float> tuple2 = BattleFuncs.calcSkillParam2(skillParams1[2], skillParamClampArray[2], (float) playerUnit.total_intelligence, 1f, (float) lhs.Intelligence, skillParams1[11], skillParamClampArray[11], (float) num5 + (float) magicalPower * elementOrKindRatio + (float) proficiencyIncr.magic_attack, 1f, (float) gearKindIncr.Item1, swapState);
        ...
        r.Mind = (int) tuple4.Item1;
        r.MagicDefense = (int) tuple4.Item2;
        int num6 = BattleFuncs.calcEquippedGearWeight(playerUnit.initial_gear, equipped_gear, equipped_gear2, equipped_gear3);
        r.AttackSpeed = (int) BattleFuncs.calcSkillParam((IEnumerable<BattleFuncs.SkillParam>) skillParams1[17], skillParamClampArray[17], (double) (r.Agility - num6 - (beMagicBullet == null ? 0 : beMagicBullet.weight)), swapState: swapState);
    ...
    public class BeforeDuelParameter
    {
      ...
      public float CalcPhysicalAttack(float rate, bool excludeBaseDamage = false) => this.CalcAttack(this.attackerUnitParameter.PhysicalAttack, this.defenderUnitParameter.PhysicalDefense, rate, excludeBaseDamage);

      public float CalcMagicAttack(float rate, bool excludeBaseDamage = false) => this.CalcAttack(this.attackerUnitParameter.MagicAttack, this.defenderUnitParameter.MagicDefense, rate, excludeBaseDamage);
      ...
      public int DisplayHit
      {
        get
        {
          if (this.defenderUnitParameter.IsDontEvasion)
            return 100;
          int num = !this.FixHit.HasValue ? this.attackerUnitParameter.Hit - this.defenderUnitParameter.Evasion : this.FixHit.Value;
          if (this.HitMax.HasValue && num > this.HitMax.Value)
            num = this.HitMax.Value;
          if (this.HitMin.HasValue && num < this.HitMin.Value)
            num = this.HitMin.Value;
          return num;
        }
      }
      ...
      public int DisplayCritical
      {
        get
        {
          int num1 = this.defenderUnitParameter.CriticalEvasion;
          if (num1 < 0)
            num1 = 0;
          int num2 = this.attackerUnitParameter.Critical - num1;
          if (this.CriticalMax.HasValue && num2 > this.CriticalMax.Value)
            num2 = this.CriticalMax.Value;
          if (this.CriticalMin.HasValue && num2 < this.CriticalMin.Value)
            num2 = this.CriticalMin.Value;
          return num2;
        }
      }
        ...
        BL.Weapon weapon = null)
      {
        ...
        Judgement.BeforeDuelParameter beforeDuelParameter = new Judgement.BeforeDuelParameter()
        {
          attackerUnitParameter = attack,
          defenderUnitParameter = defense
        };
        beforeDuelParameter.AttackCount = BattleFuncs.attackCount(beAttackUnit, beDefenseUnit);
        beforeDuelParameter.AttackCount *= beAttackUnit.originalUnit.playerUnit.normalAttackCount;
        if (BattleFuncs.canOneMore(attack, defense, beAttackUnit, beDefenseUnit, isAttack, attackPanel: blAttackPanel, defensePanel: blDefencePanel))
          beforeDuelParameter.AttackCount *= 2;
        beforeDuelParameter.FixDamage = Judgement.BeforeDuelParameter.MakeFixDamage(beAttackUnit, beAttackMagicBullet, defenseHp <= 0 ? beDefenseUnit.hp : defenseHp);
        ...
        beforeDuelParameter.HitMin = tuple1.Item1;
        beforeDuelParameter.HitMax = tuple1.Item2;
        beforeDuelParameter.FixHit = tuple1.Item3;
        ...
        beforeDuelParameter.CriticalMin = tuple2.Item1;
        beforeDuelParameter.CriticalMax = tuple2.Item2;
        beforeDuelParameter.DamageRate = Judgement.BeforeDuelParameter.MakeDamageRate(beAttackUnit, beDefenseUnit, true, new int?(), blAttackPanel, distance, isAI, isMagic, blDefencePanel, weapon, new bool?(isAttack), new int?(attackHp), new int?(defenseHp));
        beforeDuelParameter.BaseDamage = Judgement.BeforeDuelParameter.MakeBaseDamage(beAttackUnit, beDefenseUnit, blAttackPanel, isAI);
        return beforeDuelParameter;
      }
        ...
        bool disableUseCountSkillEffect = true)
      {
        ...
        BL.ForceID[] forceIdArray1;
        BL.ForceID[] forceIdArray2;
        ...
        if (env != null)
        {
          ...
          forceIdArray1 = env.getTargetForce(beAttackUnit.originalUnit, beAttackUnit.IsCharm);
          forceIdArray2 = env.getTargetForce(beDefenseUnit.originalUnit, beDefenseUnit.IsCharm);
          units1 = (IEnumerable<BL.Unit>) env.forceUnits(forceId1).value;
          units2 = ((IEnumerable<BL.ForceID>) forceIdArray1).SelectMany<BL.ForceID, BL.Unit>((Func<BL.ForceID, IEnumerable<BL.Unit>>) (x => (IEnumerable<BL.Unit>) env.forceUnits(x).value));
          ...
          else
          {
            ...
            units4 = ((IEnumerable<BL.ForceID>) forceIdArray2).SelectMany<BL.ForceID, BL.Unit>((Func<BL.ForceID, IEnumerable<BL.Unit>>) (x => (IEnumerable<BL.Unit>) env.forceUnits(x).value));
          }
        }
        else
        {
          forceIdArray1 = (BL.ForceID[]) null;
          forceIdArray2 = (BL.ForceID[]) null;
        ...
        data.attackHp = 0;
        data.defenseHp = 0;
        data.targetForceId = forceIdArray2;
        ...
        Judgement.BeforeDuelParameter beforeDuelParameter = new Judgement.BeforeDuelParameter();
        beforeDuelParameter.attackerUnitParameter = duelUnitParameter1;
        beforeDuelParameter.defenderUnitParameter = duelUnitParameter2;
        beforeDuelParameter.FixDamage = Judgement.BeforeDuelParameter.MakeFixDamage(beAttackUnit, beAttackMagicBullet, defenseHp);
        ...
        beforeDuelParameter.CriticalMin = tuple2.Item1;
        beforeDuelParameter.CriticalMax = tuple2.Item2;
        beforeDuelParameter.DamageRate = Judgement.BeforeDuelParameter.MakeDamageRate(beAttackUnit, beDefenseUnit, false, new int?(), defenseHp: new int?(defenseHp));
        beforeDuelParameter.BaseDamage = Judgement.BeforeDuelParameter.MakeBaseDamage(beAttackUnit, beDefenseUnit);
        return beforeDuelParameter;
      }
        ...
        int colosseumTurn)
      {
        ...
        beforeDuelParameter.AttackCount = BattleFuncs.attackCount((BL.ISkillEffectListUnit) beAttackUnit, (BL.ISkillEffectListUnit) beDefenseUnit);
        beforeDuelParameter.AttackCount *= beAttackUnit.originalUnit.playerUnit.normalAttackCount;
        if (BattleFuncs.canOneMore(attack, defense, (BL.ISkillEffectListUnit) beAttackUnit, (BL.ISkillEffectListUnit) beDefenseUnit, isAttack, colosseumIsSample: isSample))
          beforeDuelParameter.AttackCount *= 2;
        beforeDuelParameter.FixDamage = Judgement.BeforeDuelParameter.MakeFixDamage((BL.ISkillEffectListUnit) beAttackUnit, beAttackMagicBullet, defenseHp);
        ...
        BL.Panel defensePanel = null)
      {
        ...
        System.Action<BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, int> action = (System.Action<BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, int>) ((effectUnit, targetUnit, effect_target) =>
        {
...
label_31:
        ...
        else
        {
          ...
          float num = 100f;
          nullable8 = nullable4.HasValue ? new int?((int) ((double) nullable4.GetValueOrDefault() * (double) num)) : new int?();
        }
        int? nullable9 = nullable8;
        int? nullable10 = nullable7;
        int? nullable11 = nullable9;
        return new Tuple<int?, int?, int?>(nullable5, nullable10, nullable11);
      }
...
label_5:
      ...
      {
        int baseDamage = 0;
        ((System.Action<BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, int>) ((effectUnit, targetUnit, effect_target) =>
        {
      ...
      private static float CalcDamageRateEffect(BL.SkillEffect effect) => (float) ((Decimal) effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.damage_percentage) + (Decimal) effect.baseSkillLevel * (Decimal) effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.skill_ratio));
        ...
        ref TurnHp hp)
      {
        ...
        int num1 = magicBullet != null ? magicBullet.cost : 0;
        if (num1 > 0 && (isAttacker ? hp.attackerHp : hp.defenderHp) <= num1)
        ...
        {
          Decimal num3 = 1M - Math.Min(Math.Max((Decimal) lotteryInfo.Final * 0.01M, 0M), 1M);
          num2 *= num3;
          flag1 = ((flag1 ? 1 : 0) | (!lotteryInfo.Max.HasValue ? 0 : ((double) lotteryInfo.Max.Value <= 0.0 ? 1 : 0))) != 0;
        }
        Decimal num4 = (1M - num2) * 100M;
        bool flag2 = num4 <= 0M & flag1;
        return new Tuple<BL.Skill, float, bool>(battleDuelSkill.attackerSkills[0], (float) num4, flag2);
      }
    }
  }
}
