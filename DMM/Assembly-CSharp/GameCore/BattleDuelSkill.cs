...
namespace GameCore
{
  public class BattleDuelSkill
  {
    ...
    private BL.Skill[] InvokeAilmentSkills(bool isAI)
    {
      ...
      {
        IEnumerable<BattleskillEffect> source = this.attackStatus.magicBullet != null ? this.attackStatus.magicBullet.investSkillEffect : (IEnumerable<BattleskillEffect>) null;
        if (source != null && source.Any<BattleskillEffect>())
        {
          foreach (BattleskillEffect battleskillEffect in source)
          {
    ...
    private void InvokeElementSkill()
    {
      ...
      foreach (CommonElement commonElement in element)
        d *= (Decimal) BattleFuncs.calcSpecResistDamageRate(this.attacker, this.defender, (int) commonElement, BattleskillEffectLogicEnum.attack_element_spec_ratio, BattleskillEffectLogicEnum.attack_element_resist_ratio, BattleskillEffectLogicArgumentEnum.attack_element_id, BattleskillEffectLogicArgumentEnum.target_attack_element_id);
    ...
    public void InvokeDamageSkill(int finalAttack)
    {
      ...
      this.invokeRate = new float?();
      BL.Skill[] skillArray1 = this.InvokeAttackerDamageSkill();
      if (skillArray1 != BattleDuelSkill.noneSkills)
        this.attackerSkills = ((IEnumerable<BL.Skill>) this.attackerSkills).Concat<BL.Skill>((IEnumerable<BL.Skill>) skillArray1).ToArray<BL.Skill>();
      BL.Skill[] skillArray2 = this.InvokeDefenderDamageSkill();
      if (skillArray2 == BattleDuelSkill.noneSkills)
        return;
      this.defenderSkills = ((IEnumerable<BL.Skill>) this.defenderSkills).Concat<BL.Skill>((IEnumerable<BL.Skill>) skillArray2).ToArray<BL.Skill>();
    }
    ...
    private bool funcIntelligenceToPhysicalAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToPhysicalAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Intelligence);

    private bool funcAgilityToPhysicalAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToPhysicalAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Agility);

    private bool funcDexterityToPhysicalAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToPhysicalAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Dexterity);

    private bool funcLuckToPhysicalAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToPhysicalAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Luck);
    ...
    private bool funcStrengthToMagicAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToMagicAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Strength);

    private bool funcAgilityToMagicAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToMagicAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Agility);

    private bool funcDexterityToMagicAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToMagicAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Dexterity);

    private bool funcLuckToMagicAttackUp(BL.Skill skill, BattleskillEffect effect) => this.funcParameterToMagicAttackUp(skill, effect, this.attackStatus.duelParameter.attackerUnitParameter.Luck);
    ...
    private bool funcMdmgCombi(BL.Skill skill, BattleskillEffect effect)
    {
      ...
      if (list1.Count > 0)
      {
        ...
        if (list2.Count > 0)
        {
          ...
          if (beAttackUnit != null)
          {
            ...
            int num2 = BL.fieldDistance(pos.Item1, pos.Item2, unitCell2.Item1, unitCell2.Item2);
            int num3 = Mathf.Max(0, effect.GetInt(BattleskillEffectLogicArgumentEnum.max_range) - (num2 - 1));
            percentage_invocation += (float) num3 * effect.GetFloat(BattleskillEffectLogicArgumentEnum.range_add_precentage_invocation);
            num1 += (float) num3 * effect.GetFloat(BattleskillEffectLogicArgumentEnum.range_add_precentage_damage);
          }
        }
      }
      ...
      int num7 = effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_id);
      List<BL.SkillEffect> useResistEffects;
      bool flag2 = BattleFuncs.isAilmentInvest(1f, num7, this.defender, this.attacker, this.random, this.colosseumTurn, out useResistEffects, this.turnHp, new int?(this.getUnitCurrentHp(this.defender)), new int?(this.getUnitCurrentHp(this.attacker)));
      this.addInvestSkills(this.defender, BattleFuncs.ailmentInvest(num7, this.defender), new int[1]
      {
        num7
    ...
    private bool funcAnohanaTrio(BL.Skill skill, BattleskillEffect effect)
    {
      ...
      if (list1.Count > 1)
      {
        ...
        if (beAttackUnit1 != null && beAttackUnit2 != null)
        {
          ...
          int num2 = BL.fieldDistance(unitCell1.Item1, unitCell1.Item2, attacker_pos.Item1, attacker_pos.Item2);
          int num3 = BL.fieldDistance(unitCell2.Item1, unitCell2.Item2, attacker_pos.Item1, attacker_pos.Item2);
          int num4 = num2 > num3 ? num2 : num3;
          int num5 = Mathf.Max(0, effect.GetInt(BattleskillEffectLogicArgumentEnum.max_range) - (num4 - 1));
          percentage_invocation += (float) num5 * effect.GetFloat(BattleskillEffectLogicArgumentEnum.range_add_precentage_invocation);
          num1 += (float) num5 * effect.GetFloat(BattleskillEffectLogicArgumentEnum.range_add_precentage_damage);
        }
      }
      if (!this.isInvoke(this.attacker, this.defender, this.attackStatus.duelParameter.attackerUnitParameter, this.attackStatus.duelParameter.defenderUnitParameter, this.attackStatus, this.defenseStatus, skill.level, percentage_invocation, this.currentAttakerHp, this.currentDefenderHp))
        return false;
      ...
      {
        long num2 = !flag1 ? (long) beforeDuelParameter1.DisplayPhysicalAttack : (long) beforeDuelParameter1.DisplayMagicAttack;
        this.additionalDamage = (float) Judgement.CalcMaximumLongToInt(!flag2 ? num2 + (long) beforeDuelParameter2.DisplayPhysicalAttack : num2 + (long) beforeDuelParameter2.DisplayMagicAttack);
      }
      else
        num1 *= 2f;
      this.damageRate *= num1;
    ...
    private bool funcCombiAttack(BL.Skill skill, BattleskillEffect effect)
    {
      ...
      if (list1.Count > 0)
      {
        ...
        if (list2.Count > 0)
        {
          ...
          if (beAttackUnit != null)
          {
            ...
            beforeDuelParameter = Judgement.BeforeDuelParameter.CreateDuelSkill(beAttackUnit, beAttackMagicBullet, BattleFuncs.getPanel(pos.Item1, pos.Item2), this.defender, BattleFuncs.getPanel(unitCell1.Item1, unitCell1.Item2), this.distance, this.currentDefenderHp);
            Tuple<int, int> unitCell2 = BattleFuncs.getUnitCell(beAttackUnit.originalUnit, this.isAI);
            int num3 = BL.fieldDistance(pos.Item1, pos.Item2, unitCell2.Item1, unitCell2.Item2);
            int num4 = Mathf.Max(0, effect.GetInt(BattleskillEffectLogicArgumentEnum.max_range) - (num3 - 1));
            percentage_invocation += (float) num4 * effect.GetFloat(BattleskillEffectLogicArgumentEnum.range_add_precentage_invocation);
            num2 += (float) num4 * effect.GetFloat(BattleskillEffectLogicArgumentEnum.range_add_precentage_damage);
          }
        }
      }
      if (!this.isInvoke(this.attacker, this.defender, this.attackStatus.duelParameter.attackerUnitParameter, this.attackStatus.duelParameter.defenderUnitParameter, this.attackStatus, this.defenseStatus, skill.level, percentage_invocation, this.currentAttakerHp, this.currentDefenderHp))
      ...
      float num8 = effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage_drain);
      if ((double) this.drainRate < (double) num8)
        this.drainRate = num8;
      float num9 = effect.GetFloat(BattleskillEffectLogicArgumentEnum.hit_value);
      if ((double) num9 > 0.0)
        this.FixHit = new float?(num9);
      int num10 = effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_id);
      if (num10 != 0 && MasterData.BattleskillSkill.ContainsKey(num10))
      {
        if (MasterData.BattleskillSkill[num10].skill_type == BattleskillSkillType.ailment)
        {
          List<BL.SkillEffect> useResistEffects;
          bool flag2 = BattleFuncs.isAilmentInvest(1f, num10, this.defender, this.attacker, this.random, this.colosseumTurn, out useResistEffects, this.turnHp, new int?(this.getUnitCurrentHp(this.defender)), new int?(this.getUnitCurrentHp(this.attacker)));
          this.addInvestSkills(this.defender, BattleFuncs.ailmentInvest(num10, this.defender), new int[1]
          {
            num10
          }, this.attacker, skill.id, true, false, 0, isSuccess: ((flag2 ? 1 : 0) != 0), useResistEffects: useResistEffects);
        }
        else
        {
          BL.Skill[] skills = new BL.Skill[1]
          {
            new BL.Skill() { id = num10 }
          };
          foreach (BL.ISkillEffectListUnit unit in this.getInvestUnit(this.attacker, this.defender, num10, 0))
            this.addInvestSkills(unit, skills, new int[1]
            {
              num10
            }, this.attacker, skill.id, false, false, 0);
    ...
    private bool funcInvestSkillEffect(BL.Skill skill, BattleskillEffect effect, bool isAI)
    {
      if (this.isHit)
      {
        double num = (double) effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage_invest) + (double) effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage_invest_levelup) * (double) skill.level;
        ...
        bool flag = BattleFuncs.isAilmentInvest((float) num, skillID, defender, attacker, random, colosseumTurn, out local, turnHp, targetHp, unitHp);
      ...
      List<Tuple<int, int>> suppressSkill)
    {
      ...
      {
        int num = work.GetInt(BattleskillEffectLogicArgumentEnum.attacker_family_id);
        if (num != 0 && !this.attacker.originalUnit.playerUnit.HasFamily((UnitFamily) num))
          return false;
      }
      if (work.HasKey(BattleskillEffectLogicArgumentEnum.defender_family_id))
      {
        int num = work.GetInt(BattleskillEffectLogicArgumentEnum.defender_family_id);
        if (num != 0 && !this.defender.originalUnit.playerUnit.HasFamily((UnitFamily) num))
          return false;
      }
      if (this.distance != 0)
      {
      ...
      {
        int num3 = work.GetInt(BattleskillEffectLogicArgumentEnum.turn_cycle);
        if (num3 != 0 && (num1 - num2) % num3 != 0)
          return false;
      }
      ...
      {
        int num3 = work.GetInt(BattleskillEffectLogicArgumentEnum.attacker_attack_type);
        if (num3 == 1 && (this.attackStatus == null || this.attackStatus.isMagic) || num3 == 2 && (this.attackStatus == null || !this.attackStatus.isMagic))
          return false;
      }
    ...
    {
      List<List<BattleskillEffect>> battleskillEffectListList = new List<List<BattleskillEffect>>();
      ...
      for (int index = 0; index < skill.skill.Effects.Length; ++index)
      {
        ...
        if (effect.HasKey(borderKey))
        {
          if (effect.checkLevel(skill.level))
          {
            ...
            battleskillEffectListList.Add(battleskillEffectList);
          }
          else
      ...
      return battleskillEffectListList;
    }
        ...
        if (num1 != 0)
        {
          for (int index = 0; index < combiUnits.Length; ++index)
          {
            if (combiUnits[index] != null)
              skillEffectListUnitList.Add(combiUnits[index]);
          }
        }
      }
      int num2 = 1;
      while (true)
      {
        ...
        if (logicArgumentEnum1 != BattleskillEffectLogicArgumentEnum.none && work.HasKey(logicArgumentEnum1))
        {
          ...
          if (num3 != 0 && MasterData.BattleskillSkill.ContainsKey(num3))
          {
            ...
            {
              case 1:
                skillEffectListUnits = this.getInvestUnit(myself, enemy, num3, rangeType).Union<BL.ISkillEffectListUnit>((IEnumerable<BL.ISkillEffectListUnit>) skillEffectListUnitList);
                break;
              case 2:
                skillEffectListUnits = (IEnumerable<BL.ISkillEffectListUnit>) skillEffectListUnitList;
                break;
              default:
            ...
            else
            {
              ...
              {
                bool flag5 = !flag3 ? flag4 : (double) lottery >= (double) this.random.NextFloat();
                flag1 |= flag5;
                if (flag5)
      ...
      foreach (BL.Skill duelSkill1 in this.attacker.originalUnit.duelSkills)
      {
        if (((IEnumerable<BattleskillEffect>) duelSkill1.skill.Effects).Any<BattleskillEffect>((Func<BattleskillEffect, bool>) (x => x.HasKey(BattleskillEffectLogicArgumentEnum.gda_percentage_invocation))))
        {
          ...
          if (!this.attacker.IsDontUseSkill(duelSkill1.id) && this.attacker.checkEnableSkill(duelSkill1.skill))
          {
            ...
            foreach (List<BattleskillEffect> battleskillEffectList in this.CreateEffectPack(duelSkill1, BattleskillEffectLogicArgumentEnum.gda_percentage_invocation))
            {
              BattleDuelSkill.InvokeAttackerGenericWork attackerGenericWork1 = new BattleDuelSkill.InvokeAttackerGenericWork();
              attackerGenericWork1.skill = duelSkill1;
              attackerGenericWork1.effects = battleskillEffectList;
              BattleDuelSkill.InvokeAttackerGenericWork attackerGenericWork2 = attackerGenericWork1;
              int num1 = attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.duel_skill_effect_group) ? attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.duel_skill_effect_group) : 0;
              if (num1 == 0 || !intSet.Contains(num1))
              {
                int num2 = 1;
                if (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.attack_count))
                  num2 = attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.attack_count);
                if (suppressSkill == null)
                  suppressSkill = this.GetSuppressSkill(this.defender, this.attacker, this.defensePanel);
                if (this.CheckInvokeGeneric((BattleDuelSkill.InvokeGenericWork) attackerGenericWork2, this.attacker, suppressSkill))
                {
                  if (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.is_attack))
                  {
                    bool flag = this.isInvokedAmbush ? !this.isAttacker : this.isAttacker;
                    int num3 = attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.is_attack);
                    if (num3 == 1 && !flag || num3 == 2 & flag)
                      continue;
                  }
                  float percentage_invocation = attackerGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.gda_percentage_invocation);
                  attackerGenericWork2.combiUnits = (BL.ISkillEffectListUnit[]) null;
                  if (!this.isColossume)
                  {
                    int length = 0;
                    ...
                    while (true)
                    {
                      ...
                      if (attackerGenericWork2.HasKey(logicArgumentEnum) && attackerGenericWork2.GetInt(logicArgumentEnum) != 0)
                      {
                        targetSkillIds.Add(attackerGenericWork2.GetInt(logicArgumentEnum));
                        ++length;
                      }
                      else
                        break;
                    ...
                    if (length >= 1)
                    {
                      ...
                      if ((attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_not_must_partake) ? attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_not_must_partake) : 1) == 0)
                      {
                      ...
                      int num3 = 1;
                      if (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_min_range))
                        num3 = attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_min_range);
                      int[] range = new int[2]
                      {
                        num3,
                        attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_max_range)
                      };
                      List<BL.ISkillEffectListUnit> list1 = BattleFuncs.getTargets(this.attacker.originalUnit, range, new BL.ForceID[1]
                      {
                        forceId
                      }, BL.Unit.TargetAttribute.all, (this.isAI ? 1 : 0) != 0, nonFacility: true).Select<BL.UnitPosition, BL.ISkillEffectListUnit>((Func<BL.UnitPosition, BL.ISkillEffectListUnit>) (x => BattleFuncs.unitPositionToISkillEffectListUnit(x))).ToList<BL.ISkillEffectListUnit>();
                      attackerGenericWork2.duelParam = new Judgement.BeforeDuelParameter[length];
                      attackerGenericWork2.isMagic = new bool[length];
                      attackerGenericWork2.rangeAddDamage = 0.0f;
                      attackerGenericWork2.combiUnits = new BL.ISkillEffectListUnit[length];
                      ...
                      if (list1.Count >= length)
                      {
                        ...
                        int combi_cross_type = attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_cross_type) ? attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_cross_type) : 0;
                        for (int index1 = 0; index1 < length; ++index1)
                        {
                          int target_skill_id = targetSkillIds[index1];
                          List<BL.ISkillEffectListUnit> list2 = list1.Where<BL.ISkillEffectListUnit>((Func<BL.ISkillEffectListUnit, bool>) (x => ((IEnumerable<BL.Skill>) x.originalUnit.duelSkills).Any<BL.Skill>((Func<BL.Skill, bool>) (duelSkill => duelSkill.id == target_skill_id)) && this.attacker.originalUnit.unit.character.ID != x.originalUnit.unit.character.ID)).Where<BL.ISkillEffectListUnit>(closure_1 ?? (closure_1 = (Func<BL.ISkillEffectListUnit, bool>) (x =>
                          {
                          ...
                          if (list2.Count > 0)
                          {
                            BL.ISkillEffectListUnit skillEffectListUnit2 = list2.OrderBy<BL.ISkillEffectListUnit, int>(closure_2 ?? (closure_2 = (Func<BL.ISkillEffectListUnit, int>) (x =>
                            {
                              int num1 = 0;
                              Tuple<int, int> unitCell = BattleFuncs.getUnitCell(x.originalUnit, this.isAI);
                              int num2 = BL.fieldDistance(pos.Item1, pos.Item2, unitCell.Item1, unitCell.Item2);
                              int num3 = unitCell.Item1 - pos.Item1;
                              int num4 = unitCell.Item2 - pos.Item2;
                              int num5 = 0;
                              for (int index = 0; index < num2; ++index)
                                num5 += 4 * index;
                              if (num3 < 0)
                                num1 = num5 + num2 * 3 - num4;
                              else if (num3 > 0)
                                num1 = num5 + num2 + num4;
                              else if (num4 > 0)
                                num1 = num5 + num2 * 2;
                        ...
                        if (skillEffectListUnitArray[length - 1] != null)
                        {
                          for (int index = 0; index < length; ++index)
                          {
                            ...
                            {
                              beAttackMagicBullet = (BL.MagicBullet) null;
                              attackerGenericWork2.isMagic[index] = false;
                            }
                            else
                            {
                              ...
                              attackerGenericWork2.isMagic[index] = beAttackMagicBullet != null;
                            }
                            attackerGenericWork2.duelParam[index] = Judgement.BeforeDuelParameter.CreateDuelSkill(skillEffectListUnitArray[index], beAttackMagicBullet, BattleFuncs.getPanel(pos.Item1, pos.Item2), this.defender, BattleFuncs.getPanel(epos.Item1, epos.Item2), this.distance, this.currentDefenderHp);
                            ...
                            attackerGenericWork2.combiUnits[index] = skillEffectListUnitArray[index];
                          }
                          int num6 = Mathf.Max(0, range[1] - (num4 - 1));
                          if (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_range_add_percentage_invocation))
                            percentage_invocation += (float) num6 * attackerGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.combi_range_add_percentage_invocation);
                          if (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_range_add_percentage_damage))
                            attackerGenericWork2.rangeAddDamage = (float) num6 * attackerGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.combi_range_add_percentage_damage);
                        }
                      }
                      if (!attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_cross_type) || attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_cross_type) == 0 || skillEffectListUnit1 != null)
                      {
                        int num5 = 0;
                        int num6 = 0;
                        if (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_min_distance))
                          num5 = attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_min_distance);
                        if (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_max_distance))
                          num6 = attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_max_distance);
                        if (num5 != 0 && num6 != 0 && (num4 == int.MinValue || num4 < num5 || num4 > num6) || attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.combi_is_none) && attackerGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.combi_is_none) == 1 && num4 != int.MinValue)
                          continue;
                      }
                      else
                        continue;
                  ...
                  if (num1 != 0)
                    intSet.Add(num1);
                  if (this.isInvoke(this.attacker, this.defender, this.attackStatus.duelParameter.attackerUnitParameter, this.attackStatus.duelParameter.defenderUnitParameter, this.attackStatus, this.defenseStatus, duelSkill1.level, percentage_invocation, this.currentAttakerHp, this.currentDefenderHp, base_invocation: (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.base_invocation) ? attackerGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.base_invocation) : 0.0f), invocation_skill_ratio: (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invocation_skill_ratio) ? attackerGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.invocation_skill_ratio) : 1f), invocation_luck_ratio: (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invocation_luck_ratio) ? attackerGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.invocation_luck_ratio) : 1f), invalidSkillLogics: attackerGenericWork2.GetInvalidSkillsAndLogics()))
                  {
                    bool flag = false;
                    attackerGenericWork2.attackCount = num2;
                    foreach (BattleskillEffectLogicArgumentEnum key in dictionary.Keys)
                    {
                      if (attackerGenericWork2.HasKey(key) && dictionary[key](attackerGenericWork2, key))
                        flag = true;
                    }
                    if (flag || num2 >= 2 || (attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invalid_skill_id) || attackerGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invalid_logic_id)))
                    {
                      this.attackCount = num2;
                      if (attackerGenericWork2.combiUnits != null && attackerGenericWork2.combiUnits[attackerGenericWork2.combiUnits.Length - 1] != null)
                        this.attackerCombiUnit = attackerGenericWork2.combiUnits;
                      this.invokeAttackerSkill = duelSkill1;
                      this.invokeAttackerSkillEffects.AddRange((IEnumerable<BattleskillEffect>) battleskillEffectList);
                      this.invokeAttackerDuelSkillEffectIds.Add(battleskillEffectList[0].ID);
                      if (!this.isSimulate)
    ...
    private BL.Skill[] InvokeDefenderGeneric()
    {
      ...
      foreach (BL.Skill duelSkill in this.defender.originalUnit.duelSkills)
      {
        if (((IEnumerable<BattleskillEffect>) duelSkill.skill.Effects).Any<BattleskillEffect>((Func<BattleskillEffect, bool>) (x => x.HasKey(BattleskillEffectLogicArgumentEnum.gdd_percentage_invocation))) && !this.defender.IsDontUseSkill(duelSkill.id) && this.defender.checkEnableSkill(duelSkill.skill))
        {
          ...
          {
            BattleDuelSkill.InvokeDefenderGenericWork defenderGenericWork1 = new BattleDuelSkill.InvokeDefenderGenericWork();
            defenderGenericWork1.skill = duelSkill;
            defenderGenericWork1.effects = battleskillEffectList;
            BattleDuelSkill.InvokeDefenderGenericWork defenderGenericWork2 = defenderGenericWork1;
            bool flag1 = defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.suppress_duel_skill_percentage);
            if ((flag1 || !this.isPrecede) && (!flag1 || this.isPrecede))
            {
              int num1 = defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.duel_skill_effect_group) ? defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.duel_skill_effect_group) : 0;
              if (num1 == 0 || !intSet.Contains(num1))
              {
                if (suppressSkill == null)
                  suppressSkill = this.GetSuppressSkill(this.attacker, this.defender, this.attackPanel);
                if (this.CheckInvokeGeneric((BattleDuelSkill.InvokeGenericWork) defenderGenericWork2, this.defender, suppressSkill))
                {
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.is_attack))
                  {
                    bool flag2 = this.isInvokedAmbush ? this.isAttacker : !this.isAttacker;
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.is_attack);
                    if (num2 == 1 && !flag2 || num2 == 2 & flag2)
                      continue;
                  }
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.skill_id))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.skill_id);
                    if (num2 != 0)
                    {
                      BL.Skill invokeAttackerSkill = this.biAttackDuelSkill.invokeAttackerSkill;
                      if (invokeAttackerSkill == null || invokeAttackerSkill.id != num2)
                        continue;
                    }
                  }
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.logic_id))
                  {
                    int logic_id = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.logic_id);
                    if (logic_id != 0)
                    {
                  ...
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invoke_suisei))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.invoke_suisei);
                    if (num2 == 1 && !this.isBiattack || num2 == 2 && this.isBiattack)
                      continue;
                  }
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invoke_drain))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.invoke_drain);
                    if (num2 != 0)
                    {
                      bool flag2 = this.isDefenderGenericDrainTarget();
                      if (num2 == 1 && !flag2 || num2 == 2 & flag2)
                        continue;
                    }
                  }
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invoke_decrease))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.invoke_decrease);
                    if (num2 != 0)
                    {
                      bool flag2 = (double) this.biAttackDuelSkill.defenseDownPhysicalRate != 1.0;
                      if (num2 == 1 && !flag2 || num2 == 2 & flag2)
                        continue;
                    }
                  }
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invoke_magic_decrease))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.invoke_magic_decrease);
                    if (num2 != 0)
                    {
                      bool flag2 = (double) this.biAttackDuelSkill.defenseDownMagicRate != 1.0;
                      if (num2 == 1 && !flag2 || num2 == 2 & flag2)
                        continue;
                    }
                  }
                  if (this.distance != 0 && defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.out_of_range))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.out_of_range);
                    if (num2 != 0)
                    {
                      bool flag2 = this.isDefenderInRange();
                      if (num2 == 1 & flag2 || num2 == 2 && !flag2)
                        continue;
                    }
                  }
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invoke_skill))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.invoke_skill);
                    if (num2 != 0)
                    {
                      bool flag2 = this.biAttackDuelSkill.invokeAttackerSkill != null;
                      if (num2 == 1 && !flag2 || num2 == 2 & flag2)
                        continue;
                    }
                  }
                  if (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invoke_critical))
                  {
                    int num2 = defenderGenericWork2.GetInt(BattleskillEffectLogicArgumentEnum.invoke_critical);
                    if (num2 != 0 && (num2 == 1 && !this.isCritical || num2 == 2 && this.isCritical))
                      continue;
                  }
                  if (num1 != 0)
                    intSet.Add(num1);
                  float percentage_invocation = defenderGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.gdd_percentage_invocation);
                  if (this.isInvoke(this.defender, this.attacker, this.attackStatus.duelParameter.defenderUnitParameter, this.attackStatus.duelParameter.attackerUnitParameter, this.defenseStatus, this.attackStatus, duelSkill.level, percentage_invocation, this.currentDefenderHp, this.currentAttakerHp, base_invocation: (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.base_invocation) ? defenderGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.base_invocation) : 0.0f), invocation_skill_ratio: (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invocation_skill_ratio) ? defenderGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.invocation_skill_ratio) : 1f), invocation_luck_ratio: (defenderGenericWork2.HasKey(BattleskillEffectLogicArgumentEnum.invocation_luck_ratio) ? defenderGenericWork2.GetFloat(BattleskillEffectLogicArgumentEnum.invocation_luck_ratio) : 1f), invalidSkillLogics: defenderGenericWork2.GetInvalidSkillsAndLogics()))
                  {
                    bool flag2 = false;
                    foreach (BattleskillEffectLogicArgumentEnum key in dictionary.Keys)
                    {
                      if (defenderGenericWork2.HasKey(key) && dictionary[key](defenderGenericWork2, key))
                        flag2 = true;
                    }
                    if (flag2)
                    {
                      this.invokeDefenseGenericWork = (BattleDuelSkill.InvokeGenericWork) defenderGenericWork2;
    ...
    private bool isDefenderInRange()
    {
      ...
      bool flag = (uint) this.defender.originalUnit.magicBullets.Length > 0U;
    ...
    private class InvokeGenericWork
    {
      ...
      public bool HasKey(BattleskillEffectLogicArgumentEnum key) => this.effects.Any<BattleskillEffect>((Func<BattleskillEffect, bool>) (x => x.HasKey(key)));

      public int GetInt(BattleskillEffectLogicArgumentEnum key) => this.effects.Where<BattleskillEffect>((Func<BattleskillEffect, bool>) (x => x.HasKey(key))).First<BattleskillEffect>().GetInt(key);

      public float GetFloat(BattleskillEffectLogicArgumentEnum key) => this.effects.Where<BattleskillEffect>((Func<BattleskillEffect, bool>) (x => x.HasKey(key))).First<BattleskillEffect>().GetFloat(key);

      public List<BattleFuncs.InvalidSpecificSkillLogic> GetInvalidSkillsAndLogics() => BattleFuncs.GetInvalidSkillsAndLogics((IEnumerable<BattleskillEffect>) this.effects);
