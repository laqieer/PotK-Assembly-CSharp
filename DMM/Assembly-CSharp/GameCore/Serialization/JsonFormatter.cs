...
namespace GameCore.Serialization
{
  public class JsonFormatter : ICrossFormatter
  {
    ...
    public static CrossSerializer MakeSerializer() => new CrossSerializer((ICrossFormatter) new JsonFormatter());

    public static CrossSerializer MakeSerializer(Encoding encoding) => new CrossSerializer((ICrossFormatter) new JsonFormatter(encoding));
  }
}
