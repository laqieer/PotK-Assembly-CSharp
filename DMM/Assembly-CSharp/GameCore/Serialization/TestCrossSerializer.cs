...
namespace GameCore.Serialization
{
  public class TestCrossSerializer
  {
    ...
    private static bool ArrayEqual(object a, object b) => TestCrossSerializer.ArrayEqual(a, b, new Func<object, object, bool>(TestCrossSerializer.Eq));
    ...
    private static bool ArrayArrayEqual(object a, object b) => TestCrossSerializer.ArrayEqual(a, b, (Func<object, object, bool>) ((x, y) => TestCrossSerializer.ArrayEqual(x, y)));
    ...
    public static void Run()
    {
      ...
      {
        CrossSerializer serializer1 = JsonFormatter.MakeSerializer();
        CrossSerializer serializer2 = BinaryFormatter.MakeSerializer(true);
        if (!TestCrossSerializer.ArrayEqual((object) serializer1.SerializeToMemory(serializer2.DeserializeFromMemory(serializer2.SerializeToMemory(obj))), (object) serializer1.SerializeToMemory(obj)))
          throw new Exception("hoge-");
        return serializer1.SerializeToMemory(obj);
      });
    ...
    private class HogeEx : TestCrossSerializer.Hoge
    {
      ...
      public override bool Equals(object obj) => obj is TestCrossSerializer.HogeEx hogeEx && base.Equals(obj) && this.intValue2 == hogeEx.intValue2;
    ...
    private class Hoge2
    {
      ...
      public override bool Equals(object obj) => obj is TestCrossSerializer.Hoge2 hoge2 && this.h.Equals((object) hoge2.h) && this.hex.Equals((object) hoge2.hex);
