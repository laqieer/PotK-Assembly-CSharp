...
public class ExploreTaskManager : MonoBehaviour
{
  ...
  private void StartTask()
  {
    ...
    if (!this.mFirstRunTask && this.mCurrentTask is IEpAdjustableTask mCurrentTask)
    {
      mCurrentTask.SetTakeOverTime(this.mTakeOverTime);
      this.mTakeOverTime = 0L;
    }
    if (this.mCurrentTask is IEpBattleTask mCurrentTask)
      mCurrentTask.SetBattleCache();
