...
public class GuildMemberInfoPopup : BackButtonMenuBase
{
    ...
    System.Action action = null)
  {
    ...
    if ((UnityEngine.Object) guildMemberInfoPopup.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      guildMemberInfoPopup.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    guildMemberInfoPopup.actionClose = (System.Action) null;
    guildMemberInfoPopup.buttonMap.gameObject.SetActive(true);
    ...
    bool fromPlayerRankingDamage = false)
  {
    ...
    guildMemberInfoPopup.actionClose = !showMapButton ? (System.Action) (() =>
    {
      if (!Singleton<NGSceneManager>.GetInstance().sceneName.Equals("guild028_2") || !((UnityEngine.Object) Singleton<NGSceneManager>.GetInstance().sceneBase != (UnityEngine.Object) null) || !((UnityEngine.Object) Singleton<NGSceneManager>.GetInstance().sceneBase.GetComponent<Guild0282Menu>() != (UnityEngine.Object) null))
        return;
    ...
    guildMemberInfoPopup.buttonMap.gameObject.SetActive(showMapButton);
    guildMemberInfoPopup.SetRoleChangeButton();
  ...
  private void SetRoleChangeButton()
  {
    if (this.isEnemy)
    {
      this.buttonChangeRole.gameObject.SetActive(false);
    }
    else
    {
      ...
      this.buttonChangeRole.gameObject.SetActive(false);
label_6:
      if (PlayerAffiliation.Current.onGvgOperation && this.buttonChangeRole.gameObject.activeSelf)
        this.buttonChangeRole.isEnabled = false;
      if (!this.buttonChangeRole.gameObject.activeSelf || !PlayerAffiliation.Current.IsRaidGuildNotMovePeriod())
        return;
      this.buttonChangeRole.isEnabled = false;
    }
  }
  ...
  public IEnumerator SetUnitIcon(GuildMembership info)
  {
    ...
    if (info != null)
    {
      ...
      if ((UnityEngine.Object) this.unitIcon == (UnityEngine.Object) null)
        this.unitIcon = this.unitIconPrefab.CloneAndGetComponent<UnitIcon>(this.playerImage.gameObject);
    ...
    Future<UnityEngine.Sprite> image = EmblemUtility.LoadEmblemSprite(info.player.player_emblem_id);
    e = image.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  {
    GuildMemberInfoPopup guildMemberInfoPopup = this;
    if ((UnityEngine.Object) guildMemberInfoPopup.guildBaseMenu != (UnityEngine.Object) null)
    ...
    if ((UnityEngine.Object) guildMemberInfoPopup.guild282Menu != (UnityEngine.Object) null)
    {
      ...
      if ((UnityEngine.Object) guild0282MemberBase == (UnityEngine.Object) null && guildMemberInfoPopup.guild282Menu.EnGuildUI != null)
      {
        // ISSUE: reference to a compiler-generated method
  ...
  private void ShowChangeRolePopup()
  {
    ...
    component.Initialize(this.guild282Menu, this.memberInfo, this.guildBaseMenu, this.guildMemberObjs, this.actionAfterRoleChange, this.buttonMap.gameObject.activeSelf);
  ...
  {
    if (!((UnityEngine.Object) this.guildMemberObjs.GuildMemberListPopup == (UnityEngine.Object) null))
    {
