...
public class PopupCoinExchangeConfirmation : BackButtonMenuBase
{
    ...
    Func<IEnumerator> onPurchased)
  {
    ...
    Future<UnityEngine.Sprite> future = commonTicket.LoadIconSSpriteF();
    IEnumerator e = future.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (!((UnityEngine.Object) this.dynIcon == (UnityEngine.Object) null))
    {
  ...
  private IEnumerator ShopBuy()
  {
    ...
    Future<WebAPI.Response.ShopBuy> paramF = WebAPI.ShopBuy(exchangeConfirmation.playerShopArticle.article.ID, exchangeConfirmation.selectedCount, (System.Action<WebAPI.Response.UserError>) (e =>
    {
