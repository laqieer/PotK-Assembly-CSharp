...
public class Battle01961Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(BL.UnitPosition attack, BL.UnitPosition defense)
  {
    ...
    e = battle01961Scene.gameObject.GetComponent<AttachSEtoButtonOnBattle>().AddSEtoButton();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Battle019_6_1_RecoveryButton[] componentsInChildren = battle01961Scene.GetComponentsInChildren<Battle019_6_1_RecoveryButton>(true);
