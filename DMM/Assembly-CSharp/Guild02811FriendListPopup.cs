...
public class Guild02811FriendListPopup : BackButtonMenuBase
{
    ...
    DateTime now)
  {
    ...
    {
      bool flag = true;
      PlayerFriend[] playerFriendArray = SMManager.Get<PlayerFriend[]>();
      foreach (FriendAffiliation friendAffiliation in friends.friend_affiliations)
      {
        ...
        {
          PlayerFriend friend1 = ((IEnumerable<PlayerFriend>) playerFriendArray).FirstOrDefault<PlayerFriend>((Func<PlayerFriend, bool>) (z => z.target_player_id == friend.player_id));
          if (friend1 != null)
          {
            GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(parts);
