...
public class Battle01SkillUseSelect : BattleHorizontalSelect<BL.Unit>
{
  ...
  protected override void initialize(BE e) => this.skillSubject = NGUITools.FindInParents<Battle01SkillSubject>(this.transform);
    ...
    List<BL.Panel> panels)
  {
    ...
    Singleton<NGBattleManager>.GetInstance().getController<BattleInputObserver>().setTargetSelectMode(attackTargets, healTargets, grayTargets, panels, new System.Action<BL.Unit, BL.Panel>(this.onSelect));
  }
}
