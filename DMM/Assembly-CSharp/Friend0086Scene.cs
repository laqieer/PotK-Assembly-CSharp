...
public class Friend0086Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    Future<WebAPI.Response.FriendDetail> ft = WebAPI.FriendDetail(receivedFriend[0].target_player_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    ResourceObject backGroundResource)
  {
    ...
    friend0086Scene.menu.gameObject.SetActive(false);
    ...
    Future<WebAPI.Response.FriendDetail> ft = WebAPI.FriendDetail(in_target_player_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      Singleton<CommonRoot>.GetInstance().loadingMode = 0;
      WebAPI.DefaultUserErrorCallback(e);
      MypageScene.ChangeSceneOnError();
    ...
    if (ft.Result != null)
    {
      ...
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
      friend0086Scene.menu.gameObject.SetActive(true);
    }
  }
