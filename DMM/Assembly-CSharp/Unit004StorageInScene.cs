...
public class Unit004StorageInScene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, bool isBack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_storage_in", (stack ? 1 : 0) != 0, (object) isBack);

  public static void changeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_storage_in", stack);
