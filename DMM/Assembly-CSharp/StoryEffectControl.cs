...
public class StoryEffectControl : MonoBehaviour
{
  ...
  private IEnumerator coInitializeLocal(int id, string namePrefab)
  {
    ...
    this.isStart_ = false;
    this.isSkip_ = false;
    if ((Object) this.prefab_ == (Object) null)
    {
  ...
  public IEnumerator coInitializeEmotion(int id, int noColor)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    StoryEffectEmotion component = storyEffectControl.prefab_.Clone(storyEffectControl.gameObject.transform).GetComponent<StoryEffectEmotion>();
  ...
  public IEnumerator coInitializeEnvironment(int id, int noColor)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    GameObject gameObject = storyEffectControl.prefab_.Clone(storyEffectControl.gameObject.transform);
  ...
  private void Update()
  {
    if (!((Object) this.effect_ != (Object) null))
      return;
    if (this.isChange_)
    {
