...
public class Unit00468Scene : NGSceneBase
{
  ...
  public override IEnumerator Start()
  {
    ...
    unit00468Scene.menuBases = source.Where<NGMenuBase>((Func<NGMenuBase, bool>) (m => (UnityEngine.Object) m != (UnityEngine.Object) null)).ToArray<NGMenuBase>();
    if (unit00468Scene.menuBases != null)
      ((IEnumerable<NGMenuBase>) unit00468Scene.menuBases).ForEach<NGMenuBase>((System.Action<NGMenuBase>) (x =>
      {
        if (!((UnityEngine.Object) x != (UnityEngine.Object) null))
          return;
        x.enabled = false;
      }));
    if ((UnityEngine.Object) unit00468Scene.currentMenu != (UnityEngine.Object) null)
      unit00468Scene.currentMenu.enabled = true;
  }

  public static void changeScene(bool bStack, EditUnitParam param) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (bStack ? 1 : 0) != 0, (object) param);

  public static void changeScene00468(bool stack, PlayerDeck playerDeck) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00468, (object) playerDeck);

  public static void changeScene00468GvgAtk(bool stack, GvgDeck gvgDeck) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00468GvgAtk, (object) gvgDeck);

  public static void changeScene00468GvgDef(bool stack, GvgDeck gvgDeck) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00468GvgDef, (object) gvgDeck);
  ...
  public static void changeScene00412Raid(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00412Raid);

  public static void changeScene004682(bool stack, Unit0046Menu.OneFormationInfo info) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit004682, (object) info);

  public static void changeScene0048(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_UnitTraining_List", stack);

  public static void changeScene00481Reinforce(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00481);

  public static void changeScene00491Evolution(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_UnitTraining_List", stack);

  public static void changeScene00492EvolutionMaterial(bool stack, Unit00492Menu.Param param) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8_2", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00492EvoMaterial, (object) param);

  public static void changeScene00491Trans(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00491Trans);

  public static void changeScene00410(bool stack, Unit00410Menu.FromType fromtype) => Unit00468Scene.callChangeSale(stack, fromtype, false);

  public static void changeScene00410WithInitialize(bool stack, Unit00410Menu.FromType fromtype) => Unit00468Scene.callChangeSale(stack, fromtype, true);
  ...
  public static void changeScene00411(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_unit_list", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00411);

  public static void changeScene00411WithInitialize(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_unit_list", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00411, (object) true);

  public static void changeScene00414WithInitialize(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00414, (object) true);

  public static void changeScene00412(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00412);

  public static void changeScene00412Gvg(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00412Gvg);

  public static void changeScene004431(bool stack, Unit004431Menu.Param sendParam) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit004431, (object) sendParam);

  public static void changeScene00414(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_6_8", (stack ? 1 : 0) != 0, (object) Unit00468Scene.Mode.Unit00414);
  ...
  public void onStartScene(Unit00468Scene.Mode mode, PlayerDeck playerDeck) => this.StartCoroutine(this.hideLoading());

  public void onStartScene(Unit00468Scene.Mode mode, GvgDeck gvgDeck) => this.StartCoroutine(this.hideLoading());

  public void onStartScene(Unit00410Menu.FromType type, bool clearInitFlg) => this.StartCoroutine(this.hideLoading());

  public void onStartScene(Unit00468Scene.Mode mode, Unit0046Menu.OneFormationInfo info) => this.StartCoroutine(this.hideLoading());

  public void onStartScene(Unit00468Scene.Mode mode, Unit004431Menu.Param sendParam) => this.StartCoroutine(this.hideLoading());

  public void onStartScene(Unit00468Scene.Mode mode, Unit00492Menu.Param param) => this.StartCoroutine(this.hideLoading());
...
label_6:
  ...
  public IEnumerator onStartSceneAsync(
    ...
    Unit0046Menu.OneFormationInfo info)
  {
    this.SetTitle(mode);
    Player player = SMManager.Get<Player>();
    PlayerUnit[] playerUnits = SMManager.Get<PlayerUnit[]>();
...
label_6:
  ...
  private IEnumerator initMenu(Unit00468Scene.Mode mode)
  {
    ...
    switch (mode)
    {
      ...
      case Unit00468Scene.Mode.Unit00491Trans:
        yield return (object) this.changeMenu((UnitMenuBase) this.menu00491);
        if ((UnityEngine.Object) this.objRegression != (UnityEngine.Object) null)
  ...
  private IEnumerator reloadMenu(Unit00468Scene.Mode mode)
  {
    Player player = SMManager.Get<Player>();
    PlayerUnit[] playerUnits = SMManager.Get<PlayerUnit[]>();
    PlayerMaterialUnit[] playerMaterialUnits1 = SMManager.Get<PlayerMaterialUnit[]>();
    switch (mode)
    {
      case Unit00468Scene.Mode.Unit0048:
      ...
      case Unit00468Scene.Mode.Unit00410:
        ...
        PlayerMaterialUnit[] playerMaterialUnits2 = playerMaterialUnits1;
        switch (this.fromType)
        {
          case Unit00410Menu.FromType.UnitList:
            playerMaterialUnits2 = new PlayerMaterialUnit[0];
            break;
          case Unit00410Menu.FromType.MaterialList:
        ...
        yield return (object) this.menu00410.UpdateInfoAndScroll(playerUnits1, playerMaterialUnits2);
      ...
      case Unit00468Scene.Mode.Unit00412Gvg:
        ...
        break;
      case Unit00468Scene.Mode.Unit00414:
        yield return (object) this.menu00414.UpdateInfoAndScroll((PlayerUnit[]) null, playerMaterialUnits1);
        break;
      case Unit00468Scene.Mode.Unit00468Raid:
      case Unit00468Scene.Mode.Unit00468RaidSim:
  ...
  {
    if (!((UnityEngine.Object) this.currentMenu != (UnityEngine.Object) null))
      return;
  ...
  private IEnumerator changeMenu(UnitMenuBase menu)
  {
    ...
    if ((UnityEngine.Object) this.objStorage != (UnityEngine.Object) null)
      this.objStorage.SetActive(menu.isStorageButton);
    if ((UnityEngine.Object) this.objMaterialSell != (UnityEngine.Object) null)
      this.objMaterialSell.SetActive(menu.isMaterialButton);
    if ((UnityEngine.Object) this.objRegression != (UnityEngine.Object) null)
      this.objRegression.SetActive(menu.isRegressionButton);
    if ((UnityEngine.Object) this.sortAndFilertObject != (UnityEngine.Object) null)
      this.sortAndFilertObject.SetActive(!menu.isHideSortAndFilterButton);
    if ((UnityEngine.Object) this.TopObj != (UnityEngine.Object) null && (UnityEngine.Object) this.ShortTopObj != (UnityEngine.Object) null)
    {
  ...
  private void setAnchorBottomAbsolute(int viewAbsolute, int barAbsolute)
  {
    if (!this.scrollViewAnchorBottomAbsolute_.HasValue)
      this.scrollViewAnchorBottomAbsolute_ = new int?(this.scrollPanel.bottomAnchor.absolute);
    this.scrollPanel.bottomAnchor.absolute = viewAbsolute;
    if (!this.scrollBarAnchorBottomAbsolute_.HasValue)
      this.scrollBarAnchorBottomAbsolute_ = new int?(this.scrollBarWidget.bottomAnchor.absolute);
    this.scrollBarWidget.bottomAnchor.absolute = barAbsolute;
  }

  private void resetAnchorBottomAbsolute()
  {
    if (this.scrollViewAnchorBottomAbsolute_.HasValue)
      this.scrollPanel.bottomAnchor.absolute = this.scrollViewAnchorBottomAbsolute_.Value;
    if (!this.scrollBarAnchorBottomAbsolute_.HasValue)
      return;
    this.scrollBarWidget.bottomAnchor.absolute = this.scrollBarAnchorBottomAbsolute_.Value;
  }
  ...
  public void onBackScene(Unit00468Scene.Mode mode, Unit0046Menu.OneFormationInfo info) => this.onBackScene();

  public void onBackScene(Unit00468Scene.Mode mode, Unit004431Menu.Param sendParam) => this.onBackScene();

  public void onBackScene(Unit00468Scene.Mode mode, Unit00492Menu.Param param) => this.onBackScene();
