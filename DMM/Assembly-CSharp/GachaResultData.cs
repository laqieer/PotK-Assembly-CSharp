...
public class GachaResultData : MonoBehaviour
{
  ...
  {
    if ((UnityEngine.Object) GachaResultData.Instance == (UnityEngine.Object) null)
    {
  ...
  public void SetData(WebAPI.Response.GachaG001ChargeMultiPay data)
  {
    ...
    if (length > 10)
    {
      GachaResultData.Result[] resultArray = new GachaResultData.Result[length];
      int index1 = 0;
  ...
  public bool hasCoinResult() => this.resultData.playerCommonTicket != null && this.resultData.playerCommonTicket.Length != 0;
  ...
  public IEnumerator SheetGachaResultPopup()
  {
    if (this.resultData.openPanelResult != null)
    {
      ...
      bool isFinished = false;
      script.SetCallback((System.Action) (() => isFinished = true));
  ...
  public IEnumerator StartSheetEffect()
  {
    ...
    {
      transform = {
        parent = gachaResultData.gameObject.transform
      },
      layer = gachaResultData.gameObject.layer
    };
    ...
    bool isFinished = false;
    e = gameObject.GetComponent<SheetGachaStart>().Init((System.Action) (() => isFinished = true));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    while (!isFinished)
  ...
  public IEnumerator CoinAcquisitionPopup()
  {
    if (this.hasCoinResult())
    {
      ...
      int quantity = this.resultData.playerCommonTicket[0].quantity;
      ...
      int num = playerCommonTicket == null ? 0 : playerCommonTicket.quantity;
      int acquisitionValue = quantity - num;
  ...
  public class Result
  {
    ...
    private bool ProbabilityEffectShow(float probability) => (double) UnityEngine.Random.Range(0.0f, 1f) <= (double) probability;

    private int ProbabilityEffectStartColor(bool isPickUp) => isPickUp ? UnityEngine.Random.Range(1, 4) : UnityEngine.Random.Range(1, 3);
  }
  ...
  public class ResultData
  {
    ...
    public bool hasPlayerUnitReserves => this.playerUnitReserves != null && (uint) this.playerUnitReserves.Length > 0U;
