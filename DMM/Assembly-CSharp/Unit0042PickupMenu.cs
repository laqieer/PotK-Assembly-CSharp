...
public class Unit0042PickupMenu : BackButtonMenuBase, IDetailMenuContainer
{
  ...
  private PlayerUnit getUnit(int index)
  {
    ...
    if (!this.dicUnits_[index].TryGetValue(this.unitTypes_[index], out playerUnit))
    {
      this.unitTypes_[index] = this.dicUnits_[index].Keys.First<UnitTypeEnum>();
      this.dicUnits_[index].TryGetValue(this.unitTypes_[index], out playerUnit);
    }
    return playerUnit;
  }

  private GameObject currentDetail => this.dicPage_ == null || this.currentIndex < 0 ? (GameObject) null : this.dicPage_.FirstOrDefault<KeyValuePair<GameObject, Unit0042PickupMenu.UnitPage>>((Func<KeyValuePair<GameObject, Unit0042PickupMenu.UnitPage>, bool>) (x => x.Value.index == this.currentIndex)).Key;
  ...
  private void SetTitleBarInfo(bool isSe)
  {
    ...
    if ((UnityEngine.Object) this.txtJobName_ != (UnityEngine.Object) null)
      this.txtJobName_.SetText(currentUnit.getJobData().name);
    if ((UnityEngine.Object) this.slcAwakening_ != (UnityEngine.Object) null)
      this.slcAwakening_.SetActive(unit.awake_unit_flag);
    if ((UnityEngine.Object) this.gearKindIcon_ == (UnityEngine.Object) null)
    {
      this.gearKindIcon_ = this.gearKindIconPrefab.Clone(this.weaponTypeIcon_.transform).GetComponent<GearKindIcon>();
      this.gearKindIcon_.gameObject.GetComponent<UI2DSprite>().depth = this.weaponTypeIcon_.depth + 1;
    }
    ...
    {
      this.dotScrollView_.GetComponent<TweenController>().isActive = true;
  ...
  private void updateBlank()
  {
    foreach (Unit0042PickupMenu.UnitPage unitPage in this.dicPage_.Values)
    {
      ...
      {
        unitPage.detail.gameObject.SetActive(false);
        unitPage.index = -1;
  ...
  private void updateScroll()
  {
    ...
    else
    {
      ...
      float x = this.scrollView_.transform.localPosition.x;
      ...
      if (this.dicPage_ != null)
      {
        if ((UnityEngine.Object) this.wheelLog_ != (UnityEngine.Object) null)
        {
      ...
      this.dotScrollView_.GetComponent<TweenController>().isActive = false;
    }
  }
  ...
  private UIDragScrollView[] dragScrollViews
  {
    get
    {
      ...
      this.dragScrollViews_ = ((IEnumerable<UIDragScrollView>) this.GetComponentsInChildren<UIDragScrollView>()).Where<UIDragScrollView>((Func<UIDragScrollView, bool>) (x => (UnityEngine.Object) x.scrollView == (UnityEngine.Object) this.scrollView_)).ToArray<UIDragScrollView>();
      return this.dragScrollViews_;
    }
  }
  ...
  private List<int> createLoadReserves(int center, float dir = 0.0f)
  {
    ...
    if ((double) dir == 0.0)
    {
      if (intList.Count < capacity)
        intList.Add((center + 1) % this.numUnit_);
      if (intList.Count < capacity)
        intList.Add((this.numUnit_ + center - 1) % this.numUnit_);
    }
    else if ((double) dir > 0.0)
    {
      if (intList.Count < capacity)
        intList.Add((center + 1) % this.numUnit_);
      if (intList.Count < capacity)
        intList.Add((center + 2) % this.numUnit_);
    }
    else
    {
      if (intList.Count < capacity)
        intList.Add((this.numUnit_ + center - 1) % this.numUnit_);
      if (intList.Count < capacity)
        intList.Add((this.numUnit_ + center - 2) % this.numUnit_);
    }
    return intList;
  }
  ...
  protected virtual IEnumerator LoadPrefabs()
  {
    ...
    if (!(bool) (UnityEngine.Object) unit0042PickupMenu.scroll_.dotPrefab)
    {
    ...
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.detailPrefab))
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.gearKindIconPrefab))
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.skillDetailDialogPrefab))
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.specialPointDetailDialogPrefab))
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.skillTypeIconPrefab))
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.skillfullnessIconPrefab))
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.commonElementIconPrefab))
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.GroupDetailDialogPrefab))
    {
    ...
    if (!(bool) (UnityEngine.Object) unit0042PickupMenu.unitIconPrefab)
    {
    ...
    // ISSUE: explicit non-virtual call
    if (!(bool) (UnityEngine.Object) __nonvirtual (unit0042PickupMenu.skillLockIconPrefab))
    {
  ...
  public IEnumerator Init(Dictionary<UnitTypeEnum, PlayerUnit>[] playerUnits)
  {
    ...
    if ((UnityEngine.Object) unit0042PickupMenu1.slcGroupBase_ != (UnityEngine.Object) null)
    {
      foreach (TweenHeight componentsInChild in unit0042PickupMenu1.slcGroupBase_.GetComponentsInChildren<TweenHeight>())
      {
        switch (componentsInChild.tweenGroup)
        {
          case 100:
    ...
    if (unit0042PickupMenu1.dicPage_ != null)
    {
      ...
      {
        if ((UnityEngine.Object) keyValuePair.Value.tween != (UnityEngine.Object) null)
          UnityEngine.Object.Destroy((UnityEngine.Object) keyValuePair.Value.tween.gameObject);
    ...
    yield return (object) null;
    unit0042PickupMenu1.scroll_.content.gameObject.SetActive(true);
    ...
    unit0042PickupMenu1.scrollView_.transform.localPosition = new Vector3((float) (-unit0042PickupMenu1.scroll_.content.itemSize * unit0042PickupMenu1.currentIndex), 0.0f, 0.0f);
    ...
    {
      unit0042PickupMenu1.scrollView_.enabled = true;
      unit0042PickupMenu1.dotScrollView_.enabled = true;
      unit0042PickupMenu1.isDisabledScroll_ = false;
      unit0042PickupMenu1.wheelLog_ = unit0042PickupMenu1.scrollView_.GetComponent<WheelScrollLog>();
      unit0042PickupMenu1.dotWidgets_ = new UIWidget[unit0042PickupMenu1.numUnit_];
      Transform transform = unit0042PickupMenu1.scroll_.dot.transform;
      for (int index = 0; index < unit0042PickupMenu1.numUnit_; ++index)
        unit0042PickupMenu1.dotWidgets_[index] = transform.GetChild(index).GetComponentInChildren<UIWidget>(true);
      ((IEnumerable<GameObject>) unit0042PickupMenu1.objArrows_).SetActives(true);
    }
    else
    {
      unit0042PickupMenu1.scrollView_.enabled = false;
      unit0042PickupMenu1.dotScrollView_.enabled = false;
    ...
    yield return (object) null;
    unit0042PickupMenu1.dotScrollView_.GetComponent<TweenController>().isActive = false;
    while (unit0042PickupMenu1.dotScrollView_.gameObject.activeSelf)
      yield return (object) null;
  ...
  private bool setTabButton(UnitTypeEnum type)
  {
    ...
    for (int index = 0; index < this.tabUnitTypes_.Length; ++index)
    {
      ...
      if (tabUnitType.type == type)
      {
        ...
        tabUnitType.button.isEnabled = false;
      }
      else if (dicUnit.ContainsKey(tabUnitType.type))
      {
        tabUnitType.top.SetActive(true);
        tabUnitType.objDisabled.SetActive(false);
        tabUnitType.button.isEnabled = true;
      }
      else
      {
  ...
  {
    Unit0042PickupMenu.UnitNode unitNode = new Unit0042PickupMenu.UnitNode()
    {
  ...
  private Unit0042PickupMenu.UnitNode createNode(
    Unit0042PickupMenu.UnitNode original)
  {
    Unit0042PickupMenu.UnitNode unitNode = new Unit0042PickupMenu.UnitNode()
    {
  ...
  private IEnumerator doCreatePage(Unit0042PickupMenu.UnitPage page, int index)
  {
    ...
    GameObject gameObject = detail.gameObject;
  ...
  private IEnumerator doStartStatusPanel(GameObject go, bool bImmediate)
  {
    ...
    if (page.mode == Unit0042PickupMenu.StatusMode.FadeOut)
    {
      ...
      else
      {
        ...
        if (bImmediate)
        {
          tween.GetComponent<UIRect>().alpha = 1f;
          tween.resetActive(true);
        }
        else
        {
          tween.GetComponent<UIRect>().alpha = 0.0f;
  ...
  private void startStatusFadeOut(GameObject goExclude, bool bImmediate)
  {
    ...
    {
      if (!((UnityEngine.Object) key == (UnityEngine.Object) goExclude))
      {
        ...
        switch (unitPage.mode)
        {
          ...
          case Unit0042PickupMenu.StatusMode.FadeIn:
            ...
            if (bImmediate)
            {
              ...
              unitPage.tween.GetComponent<UIRect>().alpha = 0.0f;
              continue;
            }
  ...
  private void displayGroupLogo(UnitUnit playerUnit)
  {
    ...
    if (groupInfo != null)
    {
      ...
      if (groupLargeCategory != null && groupLargeCategory.ID != 1)
      {
        ...
        this.groupSprites_[index].gameObject.SetActive(true);
        ++index;
      }
    ...
    if (!((UnityEngine.Object) this.slcGroupBase_ != (UnityEngine.Object) null))
      return;
    ...
    if (this.dispGroupCount_ != 0)
      return;
    this.btnGroupTabIdle_.gameObject.SetActive(false);
    this.dirGroupPressed_.SetActive(false);
  }

  private void setDuelSkill()
  {
    if ((UnityEngine.Object) this.btnPlayDuelSkill_ == (UnityEngine.Object) null)
      return;
  ...
  {
    if (this.recommendPrefabs == null || (UnityEngine.Object) this.recommendPrefabs[0] == (UnityEngine.Object) null)
      return;
  ...
  public void onFinishedGroupClose()
  {
    if (!this.isGroupTween_)
      return;
    if (this.dispGroupCount_ > 0)
      this.btnGroupTabIdle_.gameObject.SetActive(true);
    else
      this.btnGroupTabIdle_.gameObject.SetActive(false);
    this.dirGroupPressed_.SetActive(false);
  ...
  private void setGroupPos()
  {
    ...
    {
      this.slcGroupBase_.GetComponent<UISprite>().height = (int) this.getGroupHeightTarget();
    ...
    {
      this.slcGroupBase_.GetComponent<UISprite>().height = 36;
  ...
  private float getGroupHeightTarget() => (float) (36.0 + 46.5 * (double) this.dispGroupCount_ + 8.0);
  ...
  private bool movePage(int dir)
  {
    ...
    this.scroll_.centerOnChild.onFinished = new SpringPanel.OnFinished(this.OnCocFinished);
