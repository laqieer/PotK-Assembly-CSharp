...
public class GuildTownTopPopup : BackButtonMonoBehaiviour
{
  ...
  private System.Action eventFinished;

  private void OnEnable()
  {
    this.isPush = false;
    this.lblMedalNum.SetTextLocalize(PlayerAffiliation.Current.guild_medal);
    this.lblMedalNum.color = new Color(1f, 1f, 1f, 1f);
    this.iconMedal.color = new Color(1f, 1f, 1f, 1f);
  }
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    if ((UnityEngine.Object) this.mapStoragePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.facilityStoragePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.facilityDetailPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.facilitySellNumEnterPopup == (UnityEngine.Object) null)
    {
    ...
    bool includeTrap)
  {
    ...
    {
      GuildTownMapScroll component = this.mapChipPrefab.Clone(this.grid.transform).GetComponent<GuildTownMapScroll>();
    ...
    this.scrollParts.enabled = true;
    this.defaultSlotNo = default_town_slot_number;
    this.currentSlotNo = default_town_slot_number;
    Transform child = this.grid.transform.GetChild(this.currentSlotNo);
    this.currentObject = (UnityEngine.Object) child != (UnityEngine.Object) null ? child.gameObject : (GameObject) null;
  }
  ...
  private void onFinished()
  {
    ...
    if (this.eventFinished == null)
      return;
    this.eventFinished();
    this.eventFinished = (System.Action) null;
  }
  ...
  private void UpdateMapInfo()
  {
    ...
    {
      if (this.grid.transform.GetChild(i).Equals((object) this.centerOnChild.centeredObject.transform))
      {
  ...
  private IEnumerator RefreshMapchipInfo()
  {
    ...
    {
      GuildTownMapScroll component = guildTownTopPopup.grid.transform.GetChild(i).gameObject.GetComponent<GuildTownMapScroll>();
    ...
    guildTownTopPopup.focusCurrentMap(GuildUtil.last_edit_slot_no, new System.Action(guildTownTopPopup.\u003CRefreshMapchipInfo\u003Eb__36_0));
  }
  ...
  private IEnumerator ShowFacilityStoragePopup()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = script.initialize(SMManager.Get<PlayerGuildFacility[]>(), new System.Action<PlayerGuildFacility>(guildTownTopPopup.\u003CShowFacilityStoragePopup\u003Eb__38_0), new System.Action(guildTownTopPopup.\u003CShowFacilityStoragePopup\u003Eb__38_1), (Dictionary<int, int>) null, int.MaxValue, int.MaxValue);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator onSelectFacility(PlayerGuildFacility facility)
  {
    ...
    popup.SetActive(false);
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = popup.GetComponent<PopupFacilityDetailMenu>().InitializeAsync(guildTownTopPopup.guildMapMenu, facility, guildTownTopPopup.facilitySellNumEnterPopup, new System.Action<int, int, int>(guildTownTopPopup.\u003ConSelectFacility\u003Eb__39_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    popup.SetActive(true);
  ...
  private IEnumerator onSellFacility(int amount, int facilityID, int totalMedal)
  {
    ...
    Future<WebAPI.Response.GuildtownSellFacility> sellFacility = WebAPI.GuildtownSellFacility(amount, facilityID, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
    ...
    if (sellFacility.Result != null)
    {
      ...
      }), new System.Action(guildTownTopPopup.\u003ConSellFacility\u003Eb__40_1)));
    }
  }

  public void focusCurrentMap(int slotNo, System.Action callbackFinished = null)
  {
    if ((UnityEngine.Object) this.centerOnChild == (UnityEngine.Object) null)
      return;
    this.eventFinished = callbackFinished;
    this.centerOnChild.onFinished = new SpringPanel.OnFinished(this.onFinished);
    ...
    Guild0282MemberBaseMenu memberMenu)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) this.scrollView == (UnityEngine.Object) null || (UnityEngine.Object) this.grid == (UnityEngine.Object) null || ((UnityEngine.Object) this.centerOnChild == (UnityEngine.Object) null || (UnityEngine.Object) this.scrollParts == (UnityEngine.Object) null))
      {
        Singleton<CommonRoot>.GetInstance().isLoading = false;
        Singleton<CommonRoot>.GetInstance().loadingMode = 0;
      }
      ...
      {
        this.scrollParts.enabled = false;
      ...
      else
      {
        ...
        else
        {
          ...
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
          this.btnTestBattle.enabled = PlayerAffiliation.Current.guild.gvg_status != GvgStatus.fighting;
          this.btnTestBattle.isEnabled = PlayerAffiliation.Current.guild.gvg_status != GvgStatus.fighting;
          Singleton<CommonRoot>.GetInstance().isLoading = false;
          Singleton<CommonRoot>.GetInstance().loadingMode = 0;
        }
      }
  ...
  public void editButton()
  {
    ...
    this.isPush = true;
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    this.guildMapMenu.SetGvgPopup(GuildUtil.GvGPopupState.TownTop, (System.Action) (() => this.StartCoroutine(this.RefreshMapchipInfo())));
  ...
  {
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    this.guildMapMenu.SetGvgPopup(GuildUtil.GvGPopupState.None, (System.Action) null);
  ...
  {
    if (PlayerAffiliation.Current.guild.gvg_status == GvgStatus.fighting || PlayerAffiliation.Current.guild.gvg_status == GvgStatus.aggregating || ((UnityEngine.Object) this.scrollView == (UnityEngine.Object) null || (UnityEngine.Object) this.centerOnChild == (UnityEngine.Object) null) || ((UnityEngine.Object) this.currentObject != (UnityEngine.Object) this.centerOnChild.centeredObject || this.scrollView.isDragging || (this.currentSlotNo == this.defaultSlotNo || this.isPush)))
      return;
    this.isPush = true;
  ...
  private IEnumerator doSetDefenceTown()
  {
    ...
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Future<WebAPI.Response.GuildtownSelect> future = WebAPI.GuildtownSelect(selectedSlot, (System.Action<WebAPI.Response.UserError>) (err =>
    {
    ...
    if (future.Result != null)
    {
      ...
      if ((UnityEngine.Object) ldPopup.Result != (UnityEngine.Object) null)
      {
        ...
        System.Action ok = (System.Action) (() => bWait = false);
