...
public class Bugu005ReisouFusionMaterialMenu : Bugu005ReisouListMenu
{
  ...
  protected override IEnumerator InitExtension()
  {
    ...
    fusionMaterialMenu.removeReisouCallback = new System.Action(((Bugu005ReisouListMenu) fusionMaterialMenu).cbRemoveReisou);
  ...
  protected override void CreateItemIconAdvencedSetting(int inventoryItemIdx, int allItemIdx)
  {
    ...
    {
      itemIcon.Gray = false;
      itemIcon.onClick = (System.Action<ItemIcon>) (playeritem => this.OpenReisouFusion(playeritem.ItemInfo));
    }
  ...
  protected IEnumerator OpenReisouFusionAsync(GameCore.ItemInfo item)
  {
    ...
    {
      IEnumerator e;
      if ((UnityEngine.Object) fusionMaterialMenu.reisouFusionPopupPrefab == (UnityEngine.Object) null)
      {
      ...
      e = component.Init(new System.Action(((Bugu005ItemListMenuBase) fusionMaterialMenu).IbtnBack), fusionMaterialMenu.recipe, fusionMaterialMenu.baseItem, item.playerItem);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
