...
public class PopupUnityValueDetailStageItem : MonoBehaviour
{
  ...
  private System.Action<System.Action> beforeChangeSceneAction;
  private System.Action<PopupUtility.SceneTo> onChangeOtherScene;
  ...
  public void OnClick()
  {
    ...
    this.StartCoroutine(orAddComponent.PopupJudge(this.stageData, new System.Action<System.Action>(this.OnBeforeSceneChange), new System.Action<PopupUtility.SceneTo>(this.OnChangeOtherScene), Event, storyOnly));
  }
  ...
  private void OnBeforeSceneChange(System.Action endAsyncWait)
  {
    ...
    {
      System.Action<System.Action> changeSceneAction = this.beforeChangeSceneAction;
  ...
  {
    System.Action<PopupUtility.SceneTo> changeOtherScene = this.onChangeOtherScene;
