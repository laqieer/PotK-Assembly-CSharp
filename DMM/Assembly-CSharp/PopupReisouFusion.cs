...
public class PopupReisouFusion : BackButtonPopupBase
{
  ...
  protected IEnumerator CallFusionAPI()
  {
    ...
    Future<WebAPI.Response.ItemGearReisouFusion> paramF = WebAPI.ItemGearReisouFusion(this.chaosItem.id, this.holyItem.id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
