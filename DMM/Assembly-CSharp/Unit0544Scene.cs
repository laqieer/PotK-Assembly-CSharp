...
public class Unit0544Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, PlayerUnit basePlayerUnit, int changeGearIndex) => Singleton<NGSceneManager>.GetInstance().changeScene("unit054_4", (stack ? 1 : 0) != 0, (object) basePlayerUnit, (object) changeGearIndex);
