...
public class Unit004682Menu : Unit00468Menu
{
    ...
    bool isEquip)
  {
    ...
    unit004682Menu.InitializeInfo((IEnumerable<PlayerUnit>) playerUnits, (IEnumerable<PlayerMaterialUnit>) null, Persist.unit00468SortAndFilter, isEquip, unit004682Menu.GetRemoveBtnFlg(playerDeck, number), false, true, true, (System.Action) (() => this.InitializeAllUnitInfosExtend(playerDeck)));
  ...
  public IEnumerator Init(EditUnitParam param)
  {
    ...
    unit004682Menu.InitializeInfo((IEnumerable<PlayerUnit>) param.units, (IEnumerable<PlayerMaterialUnit>) null, Persist.unit00468SortAndFilter, false, (uint) param.deck.unit_parameter_list[param.single.index].player_unit_id > 0U, false, true, true, (System.Action) (() => this.InitializeAllUnitInfosExtend(param)));
    e = unit004682Menu.CreateUnitIcon();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
