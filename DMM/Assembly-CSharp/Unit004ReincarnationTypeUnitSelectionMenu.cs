...
public class Unit004ReincarnationTypeUnitSelectionMenu : UnitMenuBase
{
  ...
  private int convertParamString(string s) => !s.Contains(".") ? Convert.ToInt32(s) : Convert.ToInt32(Convert.ToDouble(s));
  ...
  private IEnumerator openPopupTypeSelection(PlayerUnit PlayerUnit)
  {
    ...
    e = Singleton<PopupManager>.GetInstance().open(result).GetComponent<Unit004ReincarnationTypeTicketPopupExchangeMenu>().coInitialize(menu.ticket_, PlayerUnit, menu, new System.Action<UnitTypeEnum, bool>(menu.OnUseSelected));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator openPopupReincarnationTypeRandom()
  {
    ...
    if (num != 0)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.\u003C\u003E1__state = -1;
      Singleton<PopupManager>.GetInstance().open(prefabF2.Result).GetComponent<Popup004ReincarnationTypeMenu>().Init(unitSelectionMenu.selectedPlayerUnit.unit_type.name, "ランダム", new System.Action(unitSelectionMenu.reincarnationTypeRandom));
      return false;
    }
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
  ...
  private IEnumerator doReincarnationTypeRandom()
  {
    ...
    {
      bool bReject = true;
      yield return (object) PopupManager.StartTowerEntryUnitWarningPopupProc((System.Action<bool>) (bYes => bReject = !bYes));
      if (bReject)
      {
        unitSelectionMenu.isPopupOpen = false;
        yield break;
    ...
    Future<WebAPI.Response.UnittypeticketSpend> paramF = WebAPI.UnittypeticketSpend(unitSelectionMenu.selectedPlayerUnit.id, unitSelectionMenu.ticket_.ID, 0, (System.Action<WebAPI.Response.UserError>) (error =>
    {
