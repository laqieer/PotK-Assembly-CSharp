...
public class PopupCoinLimit : BackButtonMenuBase
{
  ...
  {
    this.CoinLimitScrollContainer.scrollView.gameObject.SetActive(false);
    IEnumerator e = this.CoinLimitScrollContainer.Init();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.CoinLimitScrollContainer.scrollView.gameObject.SetActive(true);
    this.CoinLimitScrollContainer.scrollView.SetDragAmount(0.0f, this.CoinLimitScrollContainer.scrollBar.value, true);
  }
