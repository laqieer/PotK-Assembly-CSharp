...
public class Colosseum0236Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Initialize(ColosseumUtility.Info info)
  {
    ...
    IEnumerator e = Singleton<CommonRoot>.GetInstance().GetColosseumHeaderComponent().SetInfo(CommonColosseumHeader.BtnMode.Back, new System.Action(colosseum0236Menu.IbtnBack));
    while (e.MoveNext())
