...
public class BattleUI05AlbumCompleteMenu : ResultMenuBase
{
  ...
  public override IEnumerator Run()
  {
    ...
    foreach (int albumId1 in albumCompleteMenu.albumIds)
    {
      ...
      albumCompleteMenu.popupObject.SetParent(albumCompleteMenu.gameObject);
      ...
      if (album != null)
      {
        ...
        if (list != null)
        {
          ...
          UnityEngine.Object.DestroyObject((UnityEngine.Object) albumCompleteMenu.popupObject);
  ...
  private IEnumerator SetColorBackground()
  {
    ...
    gameObject.layer = albumCompleteMenu.gameObject.layer;
