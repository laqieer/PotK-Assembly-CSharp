...
public class SeaTalkMessageScene : NGSceneBase
{
    ...
    Sea030HomeMenu homeMenu)
  {
    ...
    if (talkMessageScene.isInit)
    {
      ...
      talkMessageScene.GetComponent<UIPanel>().alpha = 1f;
    ...
    else
    {
      ...
      {
        Future<WebAPI.Response.SeaTalkPartner> api = WebAPI.SeaTalkPartner((System.Action<WebAPI.Response.UserError>) (e =>
        {
      ...
      Future<WebAPI.Response.SeaTalkMessage> seaTalkMessageApi = WebAPI.SeaTalkMessage(talkUnitInfo.unit.same_character_id, (System.Action<WebAPI.Response.UserError>) (e =>
      {
        WebAPI.DefaultUserErrorCallback(e);
        MypageScene.ChangeSceneOnError();
      }));
