...
public class Guild0282GuildBaseMenu : GuildMapObject
{
  ...
  private IEnumerator ShowMemberList()
  {
    ...
    IEnumerator e = component.Initialize(baseMenu.isEnemy, baseMenu.menu, baseMenu, baseMenu.guildMemberObj, baseMenu.guild, new System.Action(baseMenu.\u003CShowMemberList\u003Eb__13_0));
    while (e.MoveNext())
  ...
  private IEnumerator ShowBattleRecord()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.guildBattleRecordPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.guildBattleMemberScorePopup == (UnityEngine.Object) null)
    {
    ...
    bool success = false;
    e = script.InitializeAsync(this.isEnemy, this.guild.guild_id, this.guildBattleMemberScorePopup, (System.Action) (() => success = true));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (success)
