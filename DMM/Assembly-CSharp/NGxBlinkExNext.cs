        ...
        if (pairs != null)
        {
          if (pairs.Length != 1)
          {
            ...
            for (int index = 0; index < pairArray.Length; ++index)
            {
              ...
              nextTween.from = 0.0f;
              nextTween.to = 1f;
              currentTween.animationCurve = ngxBlinkExNext.animationApply.animationCurve;
              nextTween.animationCurve = ngxBlinkExNext.animationApply.animationCurve;
              currentTween.duration = ngxBlinkExNext.durationTime;
              nextTween.duration = ngxBlinkExNext.durationTime;
