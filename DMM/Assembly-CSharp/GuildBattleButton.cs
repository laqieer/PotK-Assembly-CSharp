...
public class GuildBattleButton : MypageEventButton
{
  ...
  {
    this.mTimerTask = GuildUtil.TimeCountText(this.mMatchingTimeRestLbl, Consts.GetInstance().GUILD_TOP_REMAIN_TIME, (double) GuildUtil.GVGStartHour(), (System.Action) (() => this.UpdateButtonState()), (MonoBehaviour) this);
    this.StartCoroutine(this.mTimerTask);
  }

  private void StartGVGEndTimerTask()
  {
    this.mTimerTask = GuildUtil.TimeCountText(this.mBattleTimeRestLbl, Consts.GetInstance().GUILD_TOP_REMAIN_TIME, (double) GuildUtil.GVGEndHour(), (System.Action) (() => this.UpdateButtonState()), (MonoBehaviour) this);
    this.StartCoroutine(this.mTimerTask);
  }
