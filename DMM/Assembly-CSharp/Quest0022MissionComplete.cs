...
public class Quest0022MissionComplete : MonoBehaviour
{
  ...
  public IEnumerator missionCompleteRate(QuestConverterData quest, int M)
  {
    ...
    if (missionRewardList != null)
    {
      ...
      foreach (Component component in this.MissionCompleteItem.transform)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) component.gameObject);
      IEnumerator e = this.MissionCompleteItem.gameObject.GetOrAddComponent<CreateIconObject>().CreateThumbnail(storyMissionReward.reward_type, storyMissionReward.reward_id, storyMissionReward.quantity);
      while (e.MoveNext())
  ...
  public IEnumerator missionCompleteRate_sea(QuestConverterData quest, int M)
  {
    ...
    {
      this.MissionCompleteItem.transform.parent.gameObject.SetActive(false);
    }
    else
    {
      ...
      foreach (Component component in this.MissionCompleteItem.transform)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) component.gameObject);
      IEnumerator e = this.MissionCompleteItem.gameObject.GetOrAddComponent<CreateIconObject>().CreateThumbnail(seaMissionReward.reward_type, seaMissionReward.reward_id, seaMissionReward.quantity);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
  ...
  private IEnumerator setDetailPopup()
  {
    ...
    {
      IEnumerator e;
      if ((UnityEngine.Object) this.itemDetailPopupF == (UnityEngine.Object) null)
      {
