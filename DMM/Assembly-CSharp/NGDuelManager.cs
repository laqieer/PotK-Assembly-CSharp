...
public class NGDuelManager : MonoBehaviour
{
  ...
  public bool isWait
  {
    ...
    set
    {
      ...
      if (this._isWait)
        return;
      if ((UnityEngine.Object) this.mPlayerDUnit != (UnityEngine.Object) null)
        this.mPlayerDUnit.TimeReset();
      if (!((UnityEngine.Object) this.mEnemyDUnit != (UnityEngine.Object) null))
        return;
  ...
  public GameObject currentCamera => !((UnityEngine.Object) this.mCameraManager != (UnityEngine.Object) null) ? (GameObject) null : this.mCameraManager.currentCamera;
  ...
  public static void actScreen(bool darken = true) => Singleton<CommonRoot>.GetInstance().isActiveBlackBGPanel = darken;
    ...
    bool selfStart = true)
  {
    ...
    if ((UnityEngine.Object) null != (UnityEngine.Object) this.mCameraManager)
    {
  ...
  {
    if ((UnityEngine.Object) this.mMyArrowUp == (UnityEngine.Object) null || (UnityEngine.Object) this.mMyArrowDown == (UnityEngine.Object) null || ((UnityEngine.Object) this.mEArrowUp == (UnityEngine.Object) null || (UnityEngine.Object) this.mEArrowDown == (UnityEngine.Object) null))
      return;
    ...
    {
      this.mMyArrowUp.enabled = false;
      this.mMyArrowDown.enabled = false;
      this.mEArrowUp.enabled = false;
      this.mEArrowDown.enabled = false;
    }
    else if (kindCorrelations.is_advantage)
    {
      this.mMyArrowUp.enabled = true;
      this.mMyArrowDown.enabled = false;
      this.mEArrowUp.enabled = false;
      this.mEArrowDown.enabled = true;
    }
    else
    {
      this.mMyArrowUp.enabled = false;
      this.mMyArrowDown.enabled = true;
      this.mEArrowUp.enabled = true;
      this.mEArrowDown.enabled = false;
    }
  }
  ...
  private IEnumerator makePlayerUnit(DuelResult result)
  {
    ...
    if ((UnityEngine.Object) null == (UnityEngine.Object) result1)
    {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) effectPoint == (UnityEngine.Object) null)
      ...
      if (result.isExplore)
      {
        ...
        clipEffectPlayer component = this.mPlayerDUnit.GetComponent<clipEffectPlayer>();
  ...
  private IEnumerator makeEnemyUnit(DuelResult result)
  {
    ...
    else
    {
      ...
      {
        ExploreFloor floorData = Singleton<ExploreDataManager>.GetInstance().FloorData;
        clipEffectPlayer component = this.mEnemyDUnit.GetComponent<clipEffectPlayer>();
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        {
          switch (floorData.folder_path)
          {
    ...
    bool isPlayer = true)
  {
    ...
    if ((UnityEngine.Object) null != (UnityEngine.Object) this.mRoot3d)
  ...
  private void Update()
  {
    ...
    {
      if ((UnityEngine.Object) this.mPlayerDUnit == (UnityEngine.Object) null || (UnityEngine.Object) this.mEnemyDUnit == (UnityEngine.Object) null)
        return;
      float distance = Math.Abs(this.mPlayerDUnit.transform.position.x - this.mEnemyDUnit.transform.position.x);
  ...
  private void FinishDuel()
  {
    ...
    UnityEngine.Object.Destroy((UnityEngine.Object) this.mPlayerDUnit.baseGameObject);
    UnityEngine.Object.Destroy((UnityEngine.Object) this.mEnemyDUnit.baseGameObject);
  ...
  private IEnumerator waitCurrentStatusEnd(
    NGDuelManager.DuelStatus status,
    float duration = 1.6f)
  {
  ...
  private IEnumerator startDuelStartAnimation(
    NGDuelManager.DuelStatus status,
    float duration = 1.6f)
  {
  ...
  public void ResetLight() => Singleton<NGDuelDataManager>.GetInstance().ResetLight(this.directionalLight);
  ...
  public void ActAttackBeginCamera() => this.mCameraManager.ActAttackBeginCamera(this.mDuelResult, this.mPlayerDUnit);

  public void ActCameraToCenter() => this.mCameraManager.ActCameraToCenter();

  public void ActKoyuCamera(RuntimeAnimatorController rac) => this.mCameraManager.ActKoyuCamera(rac);
  ...
  public void WarpCameraToPrincess() => this.mCameraManager.WarpCamera1stAttackPos(true, this.mEnemyDUnit.gameObject.transform);

  public void WarpCameraToEnemy() => this.mCameraManager.WarpCamera1stAttackPos(false, this.mPlayerDUnit.gameObject.transform);

  public void WarpCameraToPrincessAsRemote(Transform bullet, float delay = 2f) => this.StartCoroutine(this.mCameraManager.WarpCamera1stAttackPosRemoteEnemy(this.mEnemyDUnit.gameObject.transform, delay, bullet));

  public void WarpCameraToEnemyAsRemote(Transform bullet = null, float delay = 2f) => this.StartCoroutine(this.mCameraManager.WarpCamera1stAttackPosRemoteEnemy(this.mPlayerDUnit.gameObject.transform, delay, bullet));
  ...
  public void ChangeCameraToRemotoSuiseiHalf() => this.StartCoroutine(this.mCameraManager.changeCamera("attack_long_lastattck_cam"));
  ...
  public void SetActiveMap(bool active) => Singleton<NGDuelDataManager>.GetInstance().SetActiveMap(active);
