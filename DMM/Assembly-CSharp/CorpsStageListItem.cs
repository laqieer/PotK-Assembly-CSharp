...
public class CorpsStageListItem : MonoBehaviour
{
    ...
    System.Action<GameObject> clickAction)
  {
    ...
    this.SpriteButton.onClick.Add(new EventDelegate((EventDelegate.Callback) (() => clickAction(this.gameObject))));
    this.UpdateView();
  }
  ...
  private void UpdateView()
  {
    ...
    this.LblStageName.color = this.LblColor[index];
    this.LblStageName.effectStyle = this.LblEffectStyle[index];
