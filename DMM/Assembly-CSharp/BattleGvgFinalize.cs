...
public class BattleGvgFinalize : BattleMonoBehaviour
{
  ...
  private GVGManager gvgManager
  {
    get
    {
      if ((UnityEngine.Object) this._gvgManager == (UnityEngine.Object) null)
...
label_33:
      ...
      ModalWindow.Show(resultErrorTitle, message, new System.Action(battleGvgFinalize.\u003CStart_Battle\u003Eb__3_0));
    ...
    else
    {
      ...
      Future<WebAPI.Response.GvgBattleForceClose> futureF = WebAPI.GvgBattleForceClose(battleGvgFinalize.battleManager.battleInfo.battleId, (System.Action<WebAPI.Response.UserError>) (e =>
      {
        errCode = e.Code;
        if (!e.Code.Equals("GLD014"))
          return;
      ...
      if (futureF.Result == null)
      {
        if (errCode.Equals("GLD014"))
        {
          ...
          ModalWindow.Show(Consts.GetInstance().POPUP_GUILD_BATTLE_FORCE_CLOSE_ERROR_TITLE, Consts.GetInstance().POPUP_GUILD_BATTLE_FORCE_CLOSE_ERROR_MESSAGE, (System.Action) (() => {}));
      }
      sm.clearStack();
      sm.destroyLoadedScenes();
      battleGvgFinalize.battleManager.deleteSavedEnvironment();
  ...
  private IEnumerator ForceClose()
  {
    ...
    NGSceneManager sm = Singleton<NGSceneManager>.GetInstance();
    bool maintenance = false;
    IEnumerator e1 = WebAPI.GvgBattleForceClose(Singleton<NGBattleManager>.GetInstance().battleInfo.battleId, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      if (e.Code.Equals("GLD014"))
        maintenance = true;
      WebAPI.DefaultUserErrorCallback(e);
