...
public class Unit00468RaidMenu : Unit00468Menu
{
    ...
    bool isSimulated)
  {
    ...
    ((IEnumerable<GameObject>) unit00468RaidMenu.linkCharacters).ForEach<GameObject>((System.Action<GameObject>) (v => v.transform.Clear()));
    ...
    unit00468RaidMenu.InitializeInfo((IEnumerable<PlayerUnit>) playerUnits, (IEnumerable<PlayerMaterialUnit>) null, Persist.unit00468SortAndFilter, false, false, false, true, true, (System.Action) (() => this.InitializeAllUnitInfosExtend(deck)));
