    ...
    bool bActiveSkillZoom = false)
  {
    ...
    if (master != null)
    {
      ...
      if (Singleton<NGGameDataManager>.GetInstance().IsSea)
      {
        ...
        {
          this.txtJobDescription.gameObject.SetActive(false);
          this.txtJobDescriptionNoBtn.SetTextLocalize(skill.description);
          this.txtJobDescriptionNoBtn.gameObject.SetActive(true);
        }
      }
      else
        this.txtJobDescription.SetTextLocalize(skill.description);
      ...
      switch (groupMode)
      {
        case 1:
          ...
          if (bActiveSkillZoom)
          {
            this.popupSkillDetail = (System.Action) (() => PopupSkillDetails.show(this.skillDetailPrefab, new PopupSkillDetails.Param(skill, UnitParameter.SkillGroup.JobAbility, new int?(nextLevel))));
        ...
        case 2:
          ...
          if (bActiveSkillZoom)
          {
            this.popupSkillDetail = (System.Action) (() => PopupSkillDetails.show(this.skillDetailPrefab, new PopupSkillDetails.Param(skill, UnitParameter.SkillGroup.JobAbility, new int?(jobAbility.level))));
            this.objSkillZoom.SetActive(true);
          }
