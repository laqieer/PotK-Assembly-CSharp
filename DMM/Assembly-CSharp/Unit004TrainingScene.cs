...
public class Unit004TrainingScene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, PlayerUnit target) => Unit004TrainingScene.changeScene(stack, new Ingredients(Singleton<NGGameDataManager>.GetInstance().currentTraining)
  {
    baseUnit = target
  }, new bool?(false));
  ...
  private void autoOpenUnityToutaPopupCoroutine()
  {
    ...
    if (instance.fromPopup != NGGameDataManager.FromPopup.Unit004Combine)
      return;
    instance.OnceOpenPopup<GameObject>(this.menu.unityDetailPrefabs, (NGMenuBase) null, (System.Action) null);
  ...
  public void onStartScene(bool bReset, bool bDisabledTab, System.Action exceptionBackScene) => this.onStartScene(bReset, bDisabledTab);

  public void onStartScene(bool bReset, bool bDisabledTab) => this.autoOpenUnityToutaPopupCoroutine();
  ...
  public void onBackScene(bool bReset, bool bDisabledTab, System.Action exceptionBackScene) => this.onBackScene(false, bDisabledTab);
  ...
  private void OnDestroy() => Singleton<NGGameDataManager>.GetInstance().resetTrainingParam(Singleton<TutorialRoot>.GetInstance().IsTutorialFinish());
}
