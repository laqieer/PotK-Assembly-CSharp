...
public class Guild02861Menu : Guild0286Scroll
{
  ...
  public IEnumerator Init(GuildMemberGift[] gifts)
  {
    ...
    guild02861Menu.SetInitEndAction(new System.Action(guild02861Menu.CheckAllSend));
    e = guild02861Menu.Init(gifts, new System.Action<GuildMemberGift>(guild02861Menu.onButtonSend));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator SendConnection(GuildMemberGift gift)
  {
    ...
    if (send.Result != null)
    {
      ...
      if (send.Result != null)
      {
        ...
        guild02861Menu.popup = ModalWindow.Show(Consts.GetInstance().GUILD_GIFT_SEND_TITLE, Consts.GetInstance().GUILD_GIFT_SEND_MESSAGE, new System.Action(guild02861Menu.\u003CSendConnection\u003Eb__16_1));
  ...
  private IEnumerator SendAll()
  {
    ...
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    Future<WebAPI.Response.GuildGiftSendExecute> send = WebAPI.GuildGiftSendExecute(false, ((IEnumerable<GuildMemberGift>) guild02861Menu.memberGifts).Select<GuildMemberGift, string>((Func<GuildMemberGift, string>) (x => x.player_id)).ToArray<string>(), (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      Singleton<CommonRoot>.GetInstance().loadingMode = 0;
      WebAPI.DefaultUserErrorCallback(error);
    ...
    if (send.Result != null)
    {
      ...
      {
        // ISSUE: reference to a compiler-generated method
        guild02861Menu.popup = ModalWindow.Show(Consts.GetInstance().GUILD_GIFT_SEND_ALL_TITLE, Consts.GetInstance().GUILD_GIFT_SEND_ALL_MESSAGE, new System.Action(guild02861Menu.\u003CSendAll\u003Eb__17_2));
        guild02861Menu.StartCoroutine(guild02861Menu.UpdateList(send.Result.player_send));
        Singleton<CommonRoot>.GetInstance().loadingMode = 0;
      }
      else
