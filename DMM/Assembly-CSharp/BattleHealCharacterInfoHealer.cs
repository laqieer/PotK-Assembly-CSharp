...
public class BattleHealCharacterInfoHealer : BattleHealCharacterInfoBase
{
  ...
  public override IEnumerator Init(BL.UnitPosition up, AttackStatus[] attacks)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) null != (UnityEngine.Object) characterInfoHealer.gearIconPrefab)
      {
        GameObject gameObject1 = characterInfoHealer.gearIconPrefab.Clone(characterInfoHealer.iconGear.transform);
        gameObject1.GetComponent<UI2DSprite>().depth = characterInfoHealer.iconGear.depth + 1;
        gameObject1.GetComponent<GearKindIcon>().Init(characterInfoHealer.currentUnit.unit.unit.kind);
        if (characterInfoHealer.tweenAlpha_second_weapon.gameObject.activeSelf)
        {
          GameObject gameObject2 = characterInfoHealer.gearIconPrefab.Clone(characterInfoHealer.iconSecondGear.transform);
          gameObject2.GetComponent<UI2DSprite>().depth = characterInfoHealer.iconSecondGear.depth + 1;
          ...
          int num = (int) commonElement;
          component.Init(kind, (CommonElement) num);
        }
      }
      if (((IEnumerable<AttackStatus>) characterInfoHealer.magicBullets).Any<AttackStatus>())
      {
        ...
        {
          if ((UnityEngine.Object) null != (UnityEngine.Object) characterInfoHealer.mDotContainer)
            characterInfoHealer.mDotContainer.SetActive(false);
        }
        else if ((UnityEngine.Object) null != (UnityEngine.Object) characterInfoHealer.mDotContainer)
        {
  ...
  protected void setCurrentAttack(AttackStatus attackStatus)
  {
    ...
    if (this.currentAttack == null)
    {
      ...
      this.iconSecondGear.gameObject.SetActive(false);
    ...
    else
    {
      ...
      int num = !((UnityEngine.Object) null != (UnityEngine.Object) this.mInjured) || this.mInjured.getCurrent().unit.CanHeal(this.currentAttack.magicBullet.skill.skill_type) ? this.currentAttack.healAttack((BL.ISkillEffectListUnit) this.currentUnit.unit, (UnityEngine.Object) this.mInjured != (UnityEngine.Object) null ? (BL.ISkillEffectListUnit) this.mInjured.getCurrent().unit : (BL.ISkillEffectListUnit) null) : 0;
      this.TxtHealAmount.SetTextLocalize(num);
      if ((UnityEngine.Object) null != (UnityEngine.Object) this.mInjured)
      ...
      this.tweenAlpha_second_weapon.gameObject.SetActive(flag);
