...
public class Coloseum02342Menu : BackButtonMenuBase
{
  ...
  public IEnumerator LoadResource(int duelCount)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) coloseum02342Menu.loseAnimation == (UnityEngine.Object) null)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      coloseum02342Menu.loseAnimation = loseAnimationPrefab.Result.Clone(coloseum02342Menu.dirAnimation.transform);
      loseAnimationPrefab = (Future<GameObject>) null;
    }
    coloseum02342Menu.loseAnimation.SetActive(false);
    if ((UnityEngine.Object) coloseum02342Menu.resultAnimations[0] == (UnityEngine.Object) null)
    {
      loseAnimationPrefab = new ResourceObject(coloseum02342Menu.loseAnimPath).Load<GameObject>();
      e = loseAnimationPrefab.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      coloseum02342Menu.resultAnimations[0] = loseAnimationPrefab.Result.Clone(coloseum02342Menu.dirAnimResult.transform).GetComponent<Animator>();
      loseAnimationPrefab = (Future<GameObject>) null;
    }
    coloseum02342Menu.resultAnimations[0].gameObject.SetActive(false);
    if ((UnityEngine.Object) coloseum02342Menu.resultAnimations[1] == (UnityEngine.Object) null)
    {
      loseAnimationPrefab = new ResourceObject(coloseum02342Menu.winAnimPath).Load<GameObject>();
      e = loseAnimationPrefab.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      coloseum02342Menu.resultAnimations[1] = loseAnimationPrefab.Result.Clone(coloseum02342Menu.dirAnimResult.transform).GetComponent<Animator>();
      loseAnimationPrefab = (Future<GameObject>) null;
    }
    coloseum02342Menu.resultAnimations[1].gameObject.SetActive(false);
    if ((UnityEngine.Object) coloseum02342Menu.battleResults == (UnityEngine.Object) null)
    {
      loseAnimationPrefab = new ResourceObject(coloseum02342Menu.battleResultAnimPath).Load<GameObject>();
      e = loseAnimationPrefab.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      GameObject gameObject = loseAnimationPrefab.Result.Clone(coloseum02342Menu.dirResult.transform);
      coloseum02342Menu.battleResults = gameObject.GetComponent<global::BattleResult>();
      coloseum02342Menu.battleResults.Initialize(new System.Action(coloseum02342Menu.Replay));
      loseAnimationPrefab = (Future<GameObject>) null;
    }
    NGTween.setOnTweenFinishedIncludeDelay(NGTween.findTweenersGroup(coloseum02342Menu.gameObject, 14, true), (MonoBehaviour) coloseum02342Menu, "DoAdvanceNextDuel");
    ...
    if ((UnityEngine.Object) coloseum02342Menu.playerGearKindIcon1 == (UnityEngine.Object) null)
      coloseum02342Menu.playerGearKindIcon1 = result.Clone(coloseum02342Menu.playerKind1.gameObject.transform).GetComponent<GearKindIcon>();
    if ((UnityEngine.Object) coloseum02342Menu.playerGearKindIcon2 == (UnityEngine.Object) null)
      coloseum02342Menu.playerGearKindIcon2 = result.Clone(coloseum02342Menu.playerKind2.gameObject.transform).GetComponent<GearKindIcon>();
    if ((UnityEngine.Object) coloseum02342Menu.enemyGearKindIcon1 == (UnityEngine.Object) null)
      coloseum02342Menu.enemyGearKindIcon1 = result.Clone(coloseum02342Menu.enemyKind1.gameObject.transform).GetComponent<GearKindIcon>();
    if ((UnityEngine.Object) coloseum02342Menu.enemyGearKindIcon2 == (UnityEngine.Object) null)
      coloseum02342Menu.enemyGearKindIcon2 = result.Clone(coloseum02342Menu.enemyKind2.gameObject.transform).GetComponent<GearKindIcon>();
    if ((UnityEngine.Object) coloseum02342Menu.playerElementIcon == (UnityEngine.Object) null)
      coloseum02342Menu.playerElementIcon = result.Clone(coloseum02342Menu.linkPlayerElement.transform).GetComponent<GearKindIcon>();
    if ((UnityEngine.Object) coloseum02342Menu.enemyElementIcon == (UnityEngine.Object) null)
      coloseum02342Menu.enemyElementIcon = result.Clone(coloseum02342Menu.linkEnemyElement.gameObject.transform).GetComponent<GearKindIcon>();
    e = coloseum02342Menu.SetUnit(unitPrefab, duelCount);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Modified<Player> modified = SMManager.Observe<Player>();
    coloseum02342Menu.TxtOwn.SetText(modified.Value.name.ToConverter());
    coloseum02342Menu.TxtEnemy.SetText(coloseum02342Menu.gladiator.name.ToConverter());
    int currentEmblemId = modified.Value.current_emblem_id;
    int emblemIdEnemy = coloseum02342Menu.gladiator.current_emblem_id;
    e = coloseum02342Menu.SetEmblem(coloseum02342Menu.Emblems[0], currentEmblemId);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    e = coloseum02342Menu.SetEmblem(coloseum02342Menu.Emblems[1], emblemIdEnemy);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  {
    if ((UnityEngine.Object) this.playerGearKindIcon1 == (UnityEngine.Object) null)
      this.playerGearKindIcon1 = weaponPrefab.Clone(this.playerKind1.gameObject.transform).GetComponent<GearKindIcon>();
    if ((UnityEngine.Object) this.playerGearKindIcon2 == (UnityEngine.Object) null)
      this.playerGearKindIcon2 = weaponPrefab.Clone(this.playerKind2.gameObject.transform).GetComponent<GearKindIcon>();
    if ((UnityEngine.Object) this.enemyGearKindIcon1 == (UnityEngine.Object) null)
      this.enemyGearKindIcon1 = weaponPrefab.Clone(this.enemyKind1.gameObject.transform).GetComponent<GearKindIcon>();
    if (!((UnityEngine.Object) this.enemyGearKindIcon2 == (UnityEngine.Object) null))
      return;
    this.enemyGearKindIcon2 = weaponPrefab.Clone(this.enemyKind2.gameObject.transform).GetComponent<GearKindIcon>();
  }
  ...
  private IEnumerator StartDuel()
  {
    ...
    IEnumerator e = coloseum02342Menu.UnitBattleResultAnimation(coloseum02342Menu.resultIndex, new System.Action(coloseum02342Menu.\u003CStartDuel\u003Eb__124_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator StartWalkover()
  {
    Coloseum02342Menu coloseum02342Menu = this;
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = coloseum02342Menu.UnitBattleResultAnimation(coloseum02342Menu.resultIndex, new System.Action(coloseum02342Menu.\u003CStartWalkover\u003Eb__125_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator StartFinalDuel()
  {
    ...
    coloseum02342Menu.AnimateTargets(14, false);
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = coloseum02342Menu.UnitBattleResultAnimation(coloseum02342Menu.resultIndex, new System.Action(coloseum02342Menu.\u003CStartFinalDuel\u003Eb__126_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private void ShowWinOrLoss()
  {
    ...
    this.resultAnimations[this.resultEffectType].gameObject.SetActive(true);
    this.ibtnResult.gameObject.SetActive(true);
    if (!((UnityEngine.Object) this.battleResults != (UnityEngine.Object) null))
      return;
    ...
    ResourceObject resource)
  {
    ...
    tweenColor.duration = component.duration;
    tweenColor.delay = component.delay;
    tweenColor.tweenGroup = component.tweenGroup;
    tweenColor.ignoreTimeScale = component.ignoreTimeScale;
    tweenColor.animationCurve = component.animationCurve;
    tweenColor.style = component.style;
    tweenColor.GetComponent<TweenColor>().enabled = false;
  ...
  private IEnumerator UnitBattleResultAnimation(int index, System.Action CallBack = null)
  {
    ...
    // ISSUE: reference to a compiler-generated method
    CallBack = CallBack ?? new System.Action(coloseum02342Menu.\u003CUnitBattleResultAnimation\u003Eb__136_0);
  ...
  private IEnumerator LoadMatchIcon(
    GameObject go,
    ResourceObject ro,
  ...
  {
    GameObject[] array = go.transform.GetChildren().Select<Transform, GameObject>((Func<Transform, GameObject>) (x => x.gameObject)).ToArray<GameObject>();
    if (after < before)
    {
  ...
  private void SetBattleParam(int duelCount)
  {
    ...
    {
      this.playerElementIcon.gameObject.SetActive(true);
      this.playerElementIcon.Init(duelColosseumResult.player.unit.kind, duelColosseumResult.player.GetElement());
      this.TxtCharaname.gameObject.SetActive(false);
      this.TxtCharaname_ElementOn.gameObject.SetActive(true);
      this.TxtCharaname_ElementOn.SetTextLocalize(duelColosseumResult.player.playerUnit.unit.name);
      if ((UnityEngine.Object) this.slcCountryOwn != (UnityEngine.Object) null)
      {
        this.slcCountryOwn.gameObject.SetActive(false);
        if (duelColosseumResult.player.unit.country_attribute.HasValue)
        {
          this.slcCountryOwn.gameObject.SetActive(true);
    ...
    else
    {
      ...
      ((IEnumerable<GameObject>) this.playerAttackValues).ForEach<GameObject>((System.Action<GameObject>) (v => v.SetActive(false)));
      ...
      this.SetValueColor(this.TxtDexterityOwn);
      this.SetValueColor(this.TxtCriticalOwn);
      this.playerElementIcon.gameObject.SetActive(false);
      this.playerKind1.GetComponentInChildren<GearKindIcon>(true).GetComponent<UI2DSprite>().sprite2D = (UnityEngine.Sprite) null;
      this.playerKind2.GetComponentInChildren<GearKindIcon>(true).GetComponent<UI2DSprite>().sprite2D = (UnityEngine.Sprite) null;
    }
    if (duelColosseumResult.opponent != (BL.Unit) null)
    {
      this.enemyElementIcon.gameObject.SetActive(true);
      this.enemyElementIcon.Init(duelColosseumResult.opponent.unit.kind, duelColosseumResult.opponent.GetElement());
      this.TxtUnitNameEnemy.gameObject.SetActive(false);
      this.TxtUnitNameEnemy_ElementOn.gameObject.SetActive(true);
      this.TxtUnitNameEnemy_ElementOn.SetText(duelColosseumResult.opponent.playerUnit.unit.name);
      if ((UnityEngine.Object) this.slcCountryEnemy != (UnityEngine.Object) null)
      {
        this.slcCountryEnemy.gameObject.SetActive(false);
        if (duelColosseumResult.opponent.unit.country_attribute.HasValue)
        {
          this.slcCountryEnemy.gameObject.SetActive(true);
      ...
      {
        num1 = duelColosseumResult.opponentAttackStatus.duelParameter.DamageRate;
      ...
      if (flag && duelColosseumResult.opponentAttackStatus != null)
        duelColosseumResult.opponentAttackStatus.duelParameter.DamageRate = num1;
      ...
      int num2 = !flag || duelColosseumResult.opponentAttackStatus == null ? 1 : NC.Clamp(1, 4, duelColosseumResult.opponentAttackStatus.attackCount);
      if (duelColosseumResult.opponent.playerUnit.getDualWieldSkillData() != null)
        num2 /= duelColosseumResult.opponent.playerUnit.normalAttackCount;
      for (int index = 0; index < this.enemyAttackValues.Length; ++index)
        this.enemyAttackValues[index].SetActive(flag && index + 2 == num2);
    ...
    else
    {
      ...
      ((IEnumerable<GameObject>) this.enemyAttackValues).ForEach<GameObject>((System.Action<GameObject>) (v => v.SetActive(false)));
      ...
      this.SetValueColor(this.TxtDexterityEnemy);
      this.SetValueColor(this.TxtCriticalEnemy);
      this.enemyElementIcon.gameObject.SetActive(false);
      this.enemyKind1.GetComponentInChildren<GearKindIcon>(true).GetComponent<UI2DSprite>().sprite2D = (UnityEngine.Sprite) null;
      this.enemyKind2.GetComponentInChildren<GearKindIcon>(true).GetComponent<UI2DSprite>().sprite2D = (UnityEngine.Sprite) null;
    }
    ((IEnumerable<GameObject>) this.playerAttackAdvantage).ForEach<GameObject>((System.Action<GameObject>) (v => v.SetActive(false)));
    ((IEnumerable<GameObject>) this.enemyAttackAdvantage).ForEach<GameObject>((System.Action<GameObject>) (v => v.SetActive(false)));
    if (!flag)
      return;
  ...
  private UnitIcon.ColosseumResult[] ChangeResultEnum(DuelColosseumResult result) => result.judgment == 0 ? new UnitIcon.ColosseumResult[2]
  {
  ...
  private IEnumerator StartRoundButton(float delay)
  {
    ...
    if (!coloseum02342Menu.isSkip)
    {
      ...
      iTween.ScaleTo(coloseum02342Menu.roundButtonAnimate, iTween.Hash((object) "x", (object) 1f, (object) "time", (object) 0.05f, (object) "easetype", (object) iTween.EaseType.easeInCubic, (object) "oncomplete", (object) "StartRoundButtonY", (object) "oncompletetarget", (object) coloseum02342Menu.gameObject));
    }
  }
  ...
  private void AnimateTargets(int id, bool isPlay = true, bool isReverse = false) => ((IEnumerable<UITweener>) this.gameObject.GetComponentsInChildren<UITweener>()).Where<UITweener>((Func<UITweener, bool>) (v => v.tweenGroup == id)).ForEach<UITweener>((System.Action<UITweener>) (v2 =>
  {
    if (isReverse)
    {
      v2.PlayReverse();
  ...
  public virtual void GoToResult() => Colosseum02346Scene.ChangeScene(this.info, this.result, this.gladiator);

  private IEnumerator SetEmblem(UI2DSprite emblem, int id = 0)
  {
    Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadEmblemSprite(id);
  ...
  public virtual void Replay()
  {
    ...
    this.resultAnimations[0].gameObject.SetActive(false);
    this.resultAnimations[1].gameObject.SetActive(false);
    this.ibtnResult.gameObject.SetActive(false);
    if ((UnityEngine.Object) this.battleResults != (UnityEngine.Object) null)
    {
  ...
  {
    unitIcons.ForEach((System.Action<UnitIcon>) (x => x.SetColosseumResult(UnitIcon.ColosseumResult.NONE)));
    foreach (Component unitIcon in unitIcons)
    {
      foreach (UnityEngine.Object componentsInChild in unitIcon.GetComponentsInChildren<iTween>())
  ...
  private string GetWeaponName(PlayerUnit unit)
  {
    ...
    if (unit.equippedGear != (PlayerItem) null)
      str = unit.equippedGearName;
    else if (unit.equippedGear3 != (PlayerItem) null)
      str = unit.equippedGearName3;
    else if (unit.equippedGear2 != (PlayerItem) null)
      str = unit.equippedGearName2;
    return str;
  }

  private CommonElement GetWeaponElement(PlayerUnit unit) => !(unit.equippedGear != (PlayerItem) null) ? (!(unit.equippedGear2 != (PlayerItem) null) ? unit.equippedGearOrInitial.GetElement() : unit.equippedGear2.GetElement()) : unit.equippedGear.GetElement();

  private GearKind GetWeaponKind(PlayerUnit unit) => !(unit.equippedGear != (PlayerItem) null) ? unit.equippedGear2OrInitial.kind : unit.equippedGearOrInitial.kind;
  ...
  {
    if ((UnityEngine.Object) tweenAlphaFirstWeapon == (UnityEngine.Object) null || (UnityEngine.Object) tweenAlphaSecondWeapon == (UnityEngine.Object) null)
      return;
    PlayerItem equippedGear = pu.equippedGear;
    PlayerItem equippedGear2 = pu.equippedGear2;
    tweenAlphaFirstWeapon.gameObject.SetActive(true);
    tweenAlphaSecondWeapon.gameObject.SetActive(equippedGear2 != (PlayerItem) null);
    tweenAlphaFirstWeapon.enabled = false;
    tweenAlphaSecondWeapon.enabled = false;
    kindIcon1.gameObject.SetActive(false);
    kindIcon2.gameObject.SetActive(false);
    if (equippedGear != (PlayerItem) null && equippedGear2 != (PlayerItem) null)
    {
      tweenAlphaFirstWeapon.ResetToBeginning();
      tweenAlphaSecondWeapon.ResetToBeginning();
      tweenAlphaFirstWeapon.PlayForward();
      tweenAlphaSecondWeapon.PlayForward();
      weapon1.SetTextLocalize(equippedGear.name);
      weapon2.SetTextLocalize(equippedGear2.name);
      kindIcon1.gameObject.SetActive(true);
      kindIcon1.Init(equippedGear.gear.kind, equippedGear.gear.GetElement());
      kindIcon2.gameObject.SetActive(true);
    ...
    else if (pu.unit.awake_unit_flag)
    {
      if (equippedGear == (PlayerItem) null && equippedGear2 != (PlayerItem) null)
      {
        tweenAlphaSecondWeapon.gameObject.SetActive(false);
        tweenAlphaFirstWeapon.GetComponent<UIWidget>().alpha = 1f;
      ...
      else
      {
        ...
        tweenAlphaFirstWeapon.GetComponent<UIWidget>().alpha = 1f;
        tweenAlphaSecondWeapon.GetComponent<UIWidget>().alpha = 0.0f;
