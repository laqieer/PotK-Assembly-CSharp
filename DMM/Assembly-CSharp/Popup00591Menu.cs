    ...
    GameObject iconPrefab = null)
  {
    ...
    if (afterReisou != (PlayerItem) null)
    {
      if (afterReisou.gear.isMythologyReisou())
      {
        ...
        string str1 = this.setLevelString(mythologyGearStatus1.holy_gear_level, mythologyGearStatus2.holy_gear_level);
        string str2 = this.setLevelString(mythologyGearStatus1.holy_gear_level_limit, mythologyGearStatus2.holy_gear_level_limit);
        this.m_DescriptionReisou.SetTextLocalize(consts.Popup00591HolyReisouDescriptionText.F((object) mythologyGearStatus1.holy_gear_level, (object) mythologyGearStatus1.holy_gear_level_limit, (object) str1, (object) str2));
        string str3 = this.setLevelString(mythologyGearStatus1.chaos_gear_level, mythologyGearStatus2.chaos_gear_level);
        string str4 = this.setLevelString(mythologyGearStatus1.chaos_gear_level_limit, mythologyGearStatus2.chaos_gear_level_limit);
        this.m_DescriptionReisou2.SetTextLocalize(consts.Popup00591ChaosReisouDescriptionText.F((object) mythologyGearStatus1.chaos_gear_level, (object) mythologyGearStatus1.chaos_gear_level_limit, (object) str3, (object) str4));
      }
      else
      {
        string str1 = this.setLevelString(beforeReisou.gear_level, afterReisou.gear_level);
        string str2 = this.setLevelString(beforeReisou.gear_level_limit, afterReisou.gear_level_limit);
        if (afterReisou.gear.isHolyReisou())
        {
          this.m_DescriptionReisou.SetTextLocalize(consts.Popup00591HolyReisouDescriptionText.F((object) beforeReisou.gear_level, (object) beforeReisou.gear_level_limit, (object) str1, (object) str2));
          this.m_DescriptionReisou2.gameObject.SetActive(false);
        }
        else
        {
          this.m_DescriptionReisou.SetTextLocalize(consts.Popup00591ChaosReisouDescriptionText.F((object) beforeReisou.gear_level, (object) beforeReisou.gear_level_limit, (object) str1, (object) str2));
          this.m_DescriptionReisou2.gameObject.SetActive(false);
        }
      }
    }
