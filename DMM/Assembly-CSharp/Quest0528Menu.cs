...
public class Quest0528Menu : BackButtonMenuBase
{
  ...
  {
    this.fieldUnitInfoList.ForEach((System.Action<Quest0528Menu.FieldUnitInfo>) (x => x.mapchip.StopSelectAnim()));
    this.fieldUnitInfoList[index].mapchip.StartSelectAnim();
  }

  private void DisableMapChipEffect() => this.fieldUnitInfoList.ForEach((System.Action<Quest0528Menu.FieldUnitInfo>) (x => x.mapchip.StopSelectAnim()));

  public IEnumerator Init(BattleStage stage)
  {
    this.ibtnBattleStart0028.isEnabled = true;
    if (this.extraQuest != null && Singleton<EarthDataManager>.GetInstance().GetEventQuestDeckCharacterCount() == 0)
      this.ibtnBattleStart0028.isEnabled = false;
  ...
  private Quest0528Menu.FieldUnitInfo getFieldPlayerUnit(
    ...
    int mapy)
  {
    Quest0528Menu.FieldUnitInfo fieldUnitInfo = (Quest0528Menu.FieldUnitInfo) null;
    ...
    if (player != null)
    {
      fieldUnitInfo = new Quest0528Menu.FieldUnitInfo();
      fieldUnitInfo.deck_position = player.deck_position;
      fieldUnitInfo.unit = (PlayerUnit) null;
      fieldUnitInfo.unitType = BL.ForceID.player;
      fieldUnitInfo.mapchip = (Quest0528MenuMapChipNum) null;
      ...
      if (earthCharacter != null)
        fieldUnitInfo.unit = earthCharacter.GetPlayerUnit();
    }
    return fieldUnitInfo;
  }

  private Quest0528Menu.FieldUnitInfo getFieldEnemyUnit(
    BattleStage stage,
    int mapx,
    int mapy)
  {
    ...
    {
      fieldUnitInfo = new Quest0528Menu.FieldUnitInfo();
      fieldUnitInfo.deck_position = -1;
      fieldUnitInfo.unitType = BL.ForceID.enemy;
      fieldUnitInfo.unit = PlayerUnit.FromEnemy(enemy);
    }
    return fieldUnitInfo;
  }
  ...
  private int getFieldPanel(BattleStage stage, int mapx, int mapy)
  {
    ...
    if (battleMapLandform != null)
      num = battleMapLandform.landform_BattleLandform;
    return num;
  }
  ...
  private IEnumerator setupMapChipsWithInfoIndicator(BattleStage stage)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.battleMapChipSpritePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.numPrefab == (UnityEngine.Object) null)
    {
    ...
    float b = (float) inParents.height / (float) mapHeight;
    int size = (int) Mathf.Min((float) inParents.width / (float) mapWidth, b);
    ...
    GameObject numPrefab)
  {
    ...
    if ((UnityEngine.Object) numPrefab != (UnityEngine.Object) null)
    {
      quest0528MenuMapChipNum = numPrefab.CloneAndGetComponent<Quest0528MenuMapChipNum>(component.gameObject);
  ...
  private IEnumerator createBattleUnitInfo(List<Quest0528Menu.FieldUnitInfo> unitInfoList)
  {
    Future<GameObject> prefabF;
    IEnumerator e;
    if ((UnityEngine.Object) this.unitStatusPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.gearKindPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.unitDetailInfoPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.battleSkillIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.skillDialogPrefab == (UnityEngine.Object) null)
    {
