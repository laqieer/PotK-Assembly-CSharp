...
public class Battle01PlayerUnit : BattleMonoBehaviour
{
  ...
  private void Awake() => this.character.enabled = false;
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    battle01PlayerUnit.unitIcon = result.CloneAndGetComponent<UnitIcon>(battle01PlayerUnit.character.gameObject.transform);
    UIWidget component = battle01PlayerUnit.GetComponent<UIWidget>();
    if ((Object) component != (Object) null)
      NGUITools.AdjustDepth(battle01PlayerUnit.unitIcon.gameObject, component.depth);
    battle01PlayerUnit.unitIcon.SetBasedOnHeight(battle01PlayerUnit.character.height);
    NGUITools.MarkParentAsChanged(battle01PlayerUnit.unitIcon.gameObject);
  }

  private IEnumerator doSetIcon(BL.Unit unit, bool isGray)
  {
    BL.Unit unit1 = unit;
    SkillMetamorphosis metamorphosis = (object) unit1 != null ? unit1.metamorphosis : (SkillMetamorphosis) null;
  ...
  {
    if (this.modified == null || !((Object) this.unitIcon != (Object) null))
      return;
    ...
    if (this.battleManager.isOvo & flag1)
    {
      if (unit.isDead)
      {
        this.pvpRespawnCount.gameObject.SetActive(true);
        this.pvpRespawnCount.setCount(unit.pvpRespawnCount);
      }
      else
        this.pvpRespawnCount.gameObject.SetActive(false);
    }
