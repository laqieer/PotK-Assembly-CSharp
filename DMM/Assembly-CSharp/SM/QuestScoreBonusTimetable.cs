...
namespace SM
{
  ...
  public class QuestScoreBonusTimetable : KeyCompare
  {
    ...
    public QuestScoreBonusTimetable(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (rules)])
        questScoreBonusRuleList.Add(obj == null ? (QuestScoreBonusRule) null : new QuestScoreBonusRule((Dictionary<string, object>) obj));
