...
namespace SM
{
  ...
  public class QuestScoreCampaignProgress : KeyCompare
  {
    ...
    public QuestScoreCampaignProgress(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (score_total_rewards)])
        scoreTotalRewardList.Add(obj == null ? (QuestScoreTotalReward) null : new QuestScoreTotalReward((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (score_achivement_rewards)])
        achivementRewardsList.Add(obj == null ? (QuestScoreCampaignProgressScore_achivement_rewards) null : new QuestScoreCampaignProgressScore_achivement_rewards((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (score_ranking_rewards)])
        scoreRankingRewardList.Add(obj == null ? (QuestScoreRankingReward) null : new QuestScoreRankingReward((Dictionary<string, object>) obj));
    ...
    public int GetQuestSScore(int sid)
    {
      ...
      if (questScoreExtraS != null)
        num = questScoreExtraS.score_max;
      return num;
    }
    ...
    public int GetQuestMScoreFromSID(int sid)
    {
      ...
      if (playerExtraQuestSArray == null || this.player.battle_score_max.Length == 0)
        return 0;
      PlayerExtraQuestS playerExtraQuestS = ((IEnumerable<PlayerExtraQuestS>) ((IEnumerable<PlayerExtraQuestS>) playerExtraQuestSArray).CheckMasterData().ToArray<PlayerExtraQuestS>()).FirstOrDefault<PlayerExtraQuestS>((Func<PlayerExtraQuestS, bool>) (x => x._quest_extra_s == sid));
      if (playerExtraQuestS != null)
      {
        int questM = playerExtraQuestS.quest_extra_s.quest_m_QuestExtraM;
        MasterData.QuestExtraS.Where<KeyValuePair<int, QuestExtraS>>((Func<KeyValuePair<int, QuestExtraS>, bool>) (x => x.Value.quest_m_QuestExtraM == questM)).ForEach<KeyValuePair<int, QuestExtraS>>((System.Action<KeyValuePair<int, QuestExtraS>>) (x => score += this.GetQuestSScore(x.Value.ID)));
      }
      return score;
    }
    ...
    {
      int score = 0;
      MasterData.QuestExtraS.Where<KeyValuePair<int, QuestExtraS>>((Func<KeyValuePair<int, QuestExtraS>, bool>) (x => x.Value.quest_m_QuestExtraM == mid)).ForEach<KeyValuePair<int, QuestExtraS>>((System.Action<KeyValuePair<int, QuestExtraS>>) (x => score += this.GetQuestSScore(x.Value.ID)));
      return score;
    }
  }
}
