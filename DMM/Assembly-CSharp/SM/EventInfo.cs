...
namespace SM
{
  ...
  public class EventInfo : KeyCompare
  {
    ...
    {
      SM.Period[] periodArray = SMManager.Get<SM.Period[]>();
      return periodArray != null && periodArray.Length != 0 ? ((IEnumerable<SM.Period>) periodArray).FirstOrDefault<SM.Period>((Func<SM.Period, bool>) (x => x.period_id == this.period_id)) : (SM.Period) null;
    }
