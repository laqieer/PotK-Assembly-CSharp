...
namespace SM
{
  ...
  public class PlayerMaterialGear : KeyCompare
  {
    ...
    public static bool operator ==(PlayerMaterialGear lhs, PlayerMaterialGear rhs) => (object) lhs == null ? (object) rhs == null : lhs.Equals(rhs);
    ...
    public static PlayerMaterialGear CreateForKey(int id, int quantity)
    {
      ...
      playerMaterialGear._key = (object) id;
      playerMaterialGear.quantity = quantity;
    ...
    public bool isCompse() => !this.isSupply() && (this.gear.kind.Enum == GearKindEnum.smith && this.gear.compose_kind.kind.Enum != GearKindEnum.smith || (this.gear.kind.Enum == GearKindEnum.drilling || this.gear.kind.Enum == GearKindEnum.special_drilling) || this.gear.kind.Enum == GearKindEnum.sea_present);

    public bool isDilling() => !this.isSupply() && (this.gear.kind.Enum == GearKindEnum.drilling || this.gear.kind.Enum == GearKindEnum.sea_present);

    public bool isSpecialDilling() => !this.isSupply() && this.gear.kind.Enum == GearKindEnum.special_drilling;

    public bool isExchangable() => this.gear != null && !this.isSupply() && (this.gear.kind.Enum == GearKindEnum.smith && this.gear.compose_kind.kind.Enum == GearKindEnum.smith);
