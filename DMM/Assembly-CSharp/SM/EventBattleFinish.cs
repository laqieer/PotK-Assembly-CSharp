...
namespace SM
{
  ...
  public class EventBattleFinish : KeyCompare
  {
    ...
    public EventBattleFinish(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (destroy_enemys)])
        finishDestroyEnemysList.Add(obj == null ? (EventBattleFinishDestroy_enemys) null : new EventBattleFinishDestroy_enemys((Dictionary<string, object>) obj));
