...
namespace SM
{
  ...
  public class PlayerCharacterIntimate : KeyCompare
  {
    ...
    {
      PlayerCharacterIntimate characterIntimate = new PlayerCharacterIntimate();
      characterIntimate._hasKey = true;
      int num1;
      int num2 = num1 = id;
      characterIntimate.id = num1;
      characterIntimate._key = (object) num2;
