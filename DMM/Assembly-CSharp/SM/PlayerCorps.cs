...
namespace SM
{
  ...
  public class PlayerCorps : KeyCompare
  {
    ...
    public PlayerCorps(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (corps_stages)])
        playerCorpsStageList.Add(obj == null ? (PlayerCorpsStage) null : new PlayerCorpsStage((Dictionary<string, object>) obj));
