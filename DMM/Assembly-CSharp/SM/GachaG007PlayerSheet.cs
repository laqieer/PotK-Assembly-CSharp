...
namespace SM
{
  ...
  public class GachaG007PlayerSheet : KeyCompare
  {
    ...
    public GachaG007PlayerSheet(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (player_panels)])
        gachaG007PlayerPanelList.Add(obj == null ? (GachaG007PlayerPanel) null : new GachaG007PlayerPanel((Dictionary<string, object>) obj));
