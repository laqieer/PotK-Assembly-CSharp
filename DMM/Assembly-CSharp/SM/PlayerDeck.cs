...
namespace SM
{
  ...
  public class PlayerDeck : KeyCompare
  {
    ...
    public static DeckInfo createDeckInfo(PlayerDeck deck) => (DeckInfo) new PlayerDeck.ImpPlayerDeck(deck);

    public static DeckInfo createGuildRaidDeck(PlayerUnit[] units) => (DeckInfo) new PlayerDeck.ImpGuildRaidDeck(units);
