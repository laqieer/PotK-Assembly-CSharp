...
namespace SM
{
  ...
  public class QuestScoreBattleFinishContext : KeyCompare
  {
    ...
    public QuestScoreBattleFinishContext(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (score_acquisitions)])
        scoreAcquisitionList.Add(obj == null ? (QuestScoreAcquisition) null : new QuestScoreAcquisition((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (score_total_rewards)])
        scoreTotalRewardsList.Add(obj == null ? (QuestScoreBattleFinishContextScore_total_rewards) null : new QuestScoreBattleFinishContextScore_total_rewards((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (score_achivement_rewards)])
        achivementRewardsList.Add(obj == null ? (QuestScoreBattleFinishContextScore_achivement_rewards) null : new QuestScoreBattleFinishContextScore_achivement_rewards((Dictionary<string, object>) obj));
