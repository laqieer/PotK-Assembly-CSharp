...
public class MapEdit031MenuSlotList : MapEditMenuBase
{
  ...
  protected override IEnumerator initializeAsync()
  {
    ...
    if (!((UnityEngine.Object) ldprefab.Result == (UnityEngine.Object) null))
    {
      ...
      e = edit031MenuSlotList.selector_.initialize(SMManager.Get<PlayerGuildTownSlot[]>(), edit031MenuSlotList.topMenu_.data_.editId_, edit031MenuSlotList.topMenu_.data_.defaultSlot_, new System.Action<int, PlayerGuildTownSlotPosition[]>(edit031MenuSlotList.onClickedMapDetail), new System.Action<int>(edit031MenuSlotList.onClickedSelect), new System.Action(edit031MenuSlotList.onClickedClose));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  private IEnumerator doPopupMapDetail(
    int maptownId,
    PlayerGuildTownSlotPosition[] facilitiesData)
  {
    MapEdit031MenuSlotList edit031MenuSlotList = this;
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) ldDetail.Result == (UnityEngine.Object) null)
    {
      edit031MenuSlotList.clearWait();
    }
    else
    {
      List<Tuple<int, int>> facilityPositions = facilitiesData != null ? ((IEnumerable<PlayerGuildTownSlotPosition>) facilitiesData).Select<PlayerGuildTownSlotPosition, Tuple<int, int>>((Func<PlayerGuildTownSlotPosition, Tuple<int, int>>) (f => new Tuple<int, int>(f.x, f.y))).ToList<Tuple<int, int>>() : (List<Tuple<int, int>>) null;
      GameObject go = Singleton<PopupManager>.GetInstance().open(ldDetail.Result, isNonSe: true, isNonOpenAnime: true);
      e = go.GetComponent<PopupMapDetailMenu>().InitializeAsync(maptownId, facilityPositions);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  private IEnumerator doConfirmSave(int slotId)
  {
    ...
    string message = Consts.Format(instance.MAPEDIT_031_MESSAGE_CONFIRM_SAVESLOT, (IDictionary) hashtable);
    ...
    bool bWait = true;
    bool bOK = false;
    ModalWindow.ShowYesNo(instance.MAPEDIT_031_TITLE_CONFIRM_SAVESLOT, message, (System.Action) (() =>
    {
      bOK = true;
      bWait = false;
  ...
  {
    MapEdit031MenuSlotList edit031MenuSlotList = this;
    if (!((UnityEngine.Object) edit031MenuSlotList.selector_ == (UnityEngine.Object) null))
    {
