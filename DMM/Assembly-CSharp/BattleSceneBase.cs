...
public class BattleSceneBase : NGSceneBase
{
  public override IEnumerator onInitSceneAsync()
  {
    ...
    BattleMonoBehaviour[] battleMonoBehaviourArray = battleSceneBase.GetComponentsInChildren<BattleMonoBehaviour>(true);
    int index;
    IEnumerator e;
    ...
    NGBattleMenuBase[] ngBattleMenuBaseArray = battleSceneBase.GetComponentsInChildren<NGBattleMenuBase>(true);
  ...
  public override IEnumerator onEndSceneAsync()
  {
    ...
    BattleMonoBehaviour[] battleMonoBehaviourArray = battleSceneBase.GetComponentsInChildren<BattleMonoBehaviour>();
    int index;
    float startTime;
    for (index = 0; index < battleMonoBehaviourArray.Length; ++index)
    {
    ...
    battleMonoBehaviourArray = (BattleMonoBehaviour[]) null;
    NGBattleMenuBase[] ngBattleMenuBaseArray = battleSceneBase.GetComponentsInChildren<NGBattleMenuBase>();
    for (index = 0; index < ngBattleMenuBaseArray.Length; ++index)
    {
