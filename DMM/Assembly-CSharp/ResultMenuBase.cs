...
public class ResultMenuBase : NGMenuBase
{
  ...
  {
    o.SetActive(true);
    ((IEnumerable<UITweener>) o.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
    {
      if (x.tweenGroup != 0)
        return;
      x.ResetToBeginning();
  ...
  protected IEnumerator ShowUnitEXP()
  {
    ...
    ((IEnumerable<GameObject>) resultMenuBase.DirUnit).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    IEnumerator e1;
    ...
    else
    {
      ...
      ((IEnumerable<GameObject>) resultMenuBase.DirUnit).ForEachIndex<GameObject>((System.Action<GameObject, int>) ((panel, index) =>
      {
        if (index >= this.afterUnits.Count<KeyValuePair<int, PlayerUnit>>())
          return;
        panel.SetActive(true);
        this.PlayTween(panel);
        Singleton<NGSoundManager>.GetInstance().playSE("SE_1016", delay: ((float) ((double) index / 10.0 + 0.899999976158142)));
      }));
      ...
      if ((UnityEngine.Object) unitList.FirstOrDefault<ColosseumResultUnit>((Func<ColosseumResultUnit, bool>) (x => (uint) x.GetUnitExp > 0U)) != (UnityEngine.Object) null)
      {
        ...
        unitLevelUpGauge.ForEach((System.Action<GaugeRunner>) (x => e2.Add(x, GaugeRunner.Run(x))));
        while (true)
        {
          bool loop = false;
          e2.ForEach<KeyValuePair<GaugeRunner, IEnumerator>>((System.Action<KeyValuePair<GaugeRunner, IEnumerator>>) (x =>
          {
            if (!x.Value.MoveNext())
              return;
            loop = true;
        ...
        if (resultMenuBase.isSkip)
        {
          ...
          removeKey.ForEach((System.Action<GaugeRunner>) (x => e2.Remove(x)));
          unitLevelUpGauge.Clear();
          unitList.ForEach((System.Action<ColosseumResultUnit>) (x =>
          {
          ...
          for (index1 = 0; index1 < playerItemArray.Length; ++index1)
          {
            ...
            if (beforeGear != (PlayerItem) null)
            {
              ...
              if (playerItem != (PlayerItem) null)
              {
                ...
                resultMenuBase.StartCoroutine(PopupCommon.Show(accessoryDisappearTitle, disappearanceType1.discription, (System.Action) (() => isdisappearedPopupFinished = true)));
      ...
      if ((bool) (UnityEngine.Object) unitList.FirstOrDefault<ColosseumResultUnit>((Func<ColosseumResultUnit, bool>) (x => x.IsProficiencyLevelUp())))
      {
      ...
      foreach (ColosseumResultUnit colosseumResultUnit in unitList)
      {
        ...
        {
          if ((UnityEngine.Object) popup1 == (UnityEngine.Object) null)
          {
  ...
  private IEnumerator doCharacterLevelUp(PopupResultUnitBase popupMain)
  {
    ...
    popupMain.onNext = new System.Action(o.IbtnScreen);
    bool isFinished = false;
    o.SetCallback((System.Action) (() => isFinished = true));
    while (!isFinished)
    {
  ...
  {
    bool bWait = true;
    popupMain.onNext = (System.Action) (() => bWait = false);
  ...
  private IEnumerator CharacterIntimates(
    BattleEndPlayer_character_intimates_in_battle p,
    int i)
  {
    if ((UnityEngine.Object) this.CharacterIntimateUpPrefab == (UnityEngine.Object) null)
    {
  ...
  {
    IEnumerator e;
    if ((UnityEngine.Object) this.IntimateSkillGetPrefab == (UnityEngine.Object) null)
    {
  ...
  {
    if ((UnityEngine.Object) this.CharacterLoveLimitUpPrefab == (UnityEngine.Object) null)
    {
  ...
  protected IEnumerator CharacterStoryPopup()
  {
    ...
    {
      IEnumerator e;
      if ((UnityEngine.Object) this.CharacterStoryPrefab == (UnityEngine.Object) null)
      {
  ...
  private IEnumerator HarmonyStory(int i)
  {
    ...
    {
      if ((UnityEngine.Object) this.prefabCombi == (UnityEngine.Object) null)
      {
    ...
    {
      if ((UnityEngine.Object) this.prefabTrio == (UnityEngine.Object) null)
      {
  ...
  private IEnumerator UnityGrowthEffect(
    List<KeyValuePair<PlayerUnit, PlayerUnit>> results)
  {
    ...
    e = (IEnumerator) null;
    bool isFinished = false;
    popup.SetOnFinishCallback((System.Action) (() => isFinished = true));
  ...
  protected void patchPUNK_DEBUG_21142(PlayerItem[] beforeGears, PlayerItem[] afterGears)
  {
    ...
    foreach (PlayerItem beforeGear in beforeGears)
    {
      ...
      int num = (object) playerItem2 != null ? playerItem2.gear_accessory_remaining_amount : 0;
      playerItem1.gear_accessory_remaining_amount = num;
    }
    ...
    PlayerItem[] gears)
  {
    ...
    PlayerUnit[] playerUnitArray = new PlayerUnit[targets.Length];
    for (int n = 0; n < playerUnitArray.Length; ++n)
    {
      ...
      playerUnitArray[n] = unitParameterList.createPlayerUnitByBattleResults(targets[n], array2);
    }
