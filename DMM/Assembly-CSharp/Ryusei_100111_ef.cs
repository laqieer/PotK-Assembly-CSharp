...
public class Ryusei_100111_ef : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    if ((Object) this.myUnit != (Object) null)
    {
  ...
  private IEnumerator loadPrefab(string pname, Vector3 pos, Vector3 rot)
  {
    ...
    else if ((Object) null != (Object) this.bip)
    {
      go.transform.localPosition = this.bip.position + pos;
    ...
    Vector3 rot)
  {
    ...
    {
      parent = ryusei100111Ef.transform.GetChildInFind(parent_name);
      if ((Object) parent == (Object) null && (Object) ryusei100111Ef.Root3d != (Object) null)
    ...
    Vector3 vector3 = pos;
    if (isAddBip)
      vector3 += ryusei100111Ef.bip.position;
    if (isLocalPos)
  ...
  {
    if (!((Object) null != (Object) this.myUnit))
      return;
  ...
  {
    clipEffectPlayer clipEffectPlayer = this.gameObject.GetComponentInChildren<clipEffectPlayer>();
    if ((Object) null == (Object) clipEffectPlayer)
      clipEffectPlayer = this.gameObject.AddComponent<clipEffectPlayer>();
  ...
  {
    if (!((Object) null != (Object) this.manager))
      return;
