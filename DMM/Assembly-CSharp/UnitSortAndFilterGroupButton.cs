...
public class UnitSortAndFilterGroupButton : UnitSortAndFilterButton
{
  ...
  private System.Action<UnitGroupHead, int, bool> onSwitch;
  ...
  {
    this.Menu = menu;
    this.onSwitch = (System.Action<UnitGroupHead, int, bool>) null;
    this.init(type, id, text, spriteName);
  }

  public void Init(
    System.Action<UnitGroupHead, int, bool> eventSwitch,
    UnitGroupHead type,
    int id,
    string text,
    string spriteName)
