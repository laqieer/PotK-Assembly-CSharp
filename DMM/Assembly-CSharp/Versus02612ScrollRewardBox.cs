...
public class Versus02612ScrollRewardBox : MonoBehaviour
{
    ...
    IEnumerable<WebAPI.Response.PvpSeasonCloseClass_rewards> data)
  {
    ...
    data.ForEach<WebAPI.Response.PvpSeasonCloseClass_rewards>((System.Action<WebAPI.Response.PvpSeasonCloseClass_rewards>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
  ...
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach((System.Action<PvpClassReward>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
      type = x.reward_type,
  ...
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach<WebAPI.Response.PvpRankingCloseRanking_rewards>((System.Action<WebAPI.Response.PvpRankingCloseRanking_rewards>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
      type = (MasterDataTable.CommonRewardType) x.reward_type_id,
      txt = x.show_text
  ...
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach<PvpClassRankingReward>((System.Action<PvpClassRankingReward>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
      type = x.reward_type,
      txt = x.reward_message
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) this.slcRankTitleBase != (UnityEngine.Object) null & is_belong)
    {
      ...
      if (!is_period)
      {
        ...
        if ((UnityEngine.Object) this.slcAcquired != (UnityEngine.Object) null)
  ...
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach((System.Action<QuestScoreRankingReward>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
      type = (MasterDataTable.CommonRewardType) x.reward_type_id,
  ...
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach((System.Action<QuestScoreAchivementReward>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
      type = (MasterDataTable.CommonRewardType) x.reward_type_id,
      txt = CommonRewardType.GetRewardName((MasterDataTable.CommonRewardType) x.reward_type_id, x.reward_id, x.reward_quantity)
  ...
  public IEnumerator Init(
    List<WebAPI.Response.QuestscoreRewardRewards> data,
    int scoreCampaignID)
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach((System.Action<WebAPI.Response.QuestscoreRewardRewards>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
  ...
  public IEnumerator Init(
    List<PunitiveExpeditionEventReward> data,
    bool all,
    bool isClear)
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach((System.Action<PunitiveExpeditionEventReward>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
  ...
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach((System.Action<GvgWholeRewardMaster>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
      type = x.reward_type,
  ...
  {
    List<Versus02612ScrollRewardBox.RewardData> setData = new List<Versus02612ScrollRewardBox.RewardData>();
    data.ForEach<QuestScoreTotalReward>((System.Action<QuestScoreTotalReward>) (x => setData.Add(new Versus02612ScrollRewardBox.RewardData()
    {
      rewardID = x.reward_id,
      type = (MasterDataTable.CommonRewardType) x.reward_type_id,
      txt = CommonRewardType.GetRewardName((MasterDataTable.CommonRewardType) x.reward_type_id, x.reward_id, x.reward_quantity)
    ...
    bool isUnitRarityCenter = false)
  {
    ...
    {
      versus02612ScrollRewardBox.slcStateDescription.gameObject.SetActive(true);
      versus02612ScrollRewardBox.slcStateDescription.SetText(spriteDescription);
    }
    if ((UnityEngine.Object) versus02612ScrollRewardBox.slcGotReward != (UnityEngine.Object) null)
      versus02612ScrollRewardBox.slcGotReward.SetActive(gotReward.HasValue && gotReward.Value);
    if ((UnityEngine.Object) versus02612ScrollRewardBox.slcNotGotReward != (UnityEngine.Object) null)
    ...
    UISprite component1 = versus02612ScrollRewardBox.GetComponent<UISprite>();
    BoxCollider component2 = versus02612ScrollRewardBox.GetComponent<BoxCollider>();
    component1.height = yPos - versus02612ScrollRewardBox.betweenMargin + versus02612ScrollRewardBox.belowMargin - (int) versus02612ScrollRewardBox.dirTarget.localPosition.y;
    component2.size = new Vector3((float) component1.width, (float) component1.height);
    component2.center = new Vector3(0.0f, (float) (-component1.height / 2));
  }
