...
public class ItemIconDetail : MonoBehaviour
{
    ...
    Func<bool> openDetailValidate = null)
  {
    ...
    if (iconInfo != null)
    {
      Transform transform = this.icon.gameObject.transform;
      Vector3 vector3 = new Vector3(transform.localPosition.x - iconInfo.PositionX, transform.localPosition.y - iconInfo.PositionY, 0.0f);
    ...
    {
      this.quantitySprite.gameObject.transform.localPosition = new Vector3(quantitySpriteInfo.PositionX, quantitySpriteInfo.PositionY, 0.0f);
      this.quantitySprite.SetDimensions(quantitySpriteInfo.SizeX, quantitySpriteInfo.SizeY);
    }
