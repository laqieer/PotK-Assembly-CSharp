...
public class Friend00894Menu : NGMenuBase
{
  ...
  public void SetRejectNumMessage(int num) => this.txtDescription1.SetTextLocalize(Consts.Format(Consts.GetInstance().FRIEND_00894_MENU, (IDictionary) new Hashtable()
  {
    {
      (object) nameof (num),
      (object) num.ToString()
