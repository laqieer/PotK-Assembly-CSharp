...
public class MapEditFacilityStorage : MonoBehaviour
{
  ...
  private System.Action<PlayerGuildFacility> eventSelect_;
  ...
  public IEnumerator initialize(
    ...
    System.Action<PlayerGuildFacility> eventSelect,
  ...
  private IEnumerator Start()
  {
    ...
    while ((UnityEngine.Object) editFacilityStorage.prefabPart_ == (UnityEngine.Object) null || (UnityEngine.Object) editFacilityStorage.prefabGenre_ == (UnityEngine.Object) null || (UnityEngine.Object) editFacilityStorage.prefabIcon_ == (UnityEngine.Object) null)
    ...
    if (editFacilityStorage.usedFacilities_ != null && editFacilityStorage.usedFacilities_.Any<Tuple<PlayerGuildFacility, int>>())
    {
      ...
      editFacilityStorage.btnSwitch_.isEnabled = true;
      ...
      editFacilityStorage.scroll_.GridReposition(new UIGrid.OnReposition(editFacilityStorage.\u003CStart\u003Eb__47_0));
    }
    else
    {
      editFacilityStorage.btnSwitch_.isEnabled = false;
  ...
  public bool checkAvailability(int id)
  {
    if (!this.isNotLocate_ && this.storage_ != null)
    {
      ...
      if ((UnityEngine.Object) editFacilityList != (UnityEngine.Object) null)
  ...
  public PlayerGuildFacility getFacility(int id)
  {
    ...
    return !((UnityEngine.Object) editFacilityList != (UnityEngine.Object) null) ? (PlayerGuildFacility) null : editFacilityList.facility_;
  }
  ...
  public void resetFacilityCountAll(int numLocation, int limitedCost) => this.resetCountAll(numLocation, limitedCost);
  ...
  private void updateTotal()
  {
    ...
    if (!this.isLayoutEdit_ || !((UnityEngine.Object) this.txtCost_ != (UnityEngine.Object) null))
      return;
    ...
    this.txtCost_.SetTextLocalize(Consts.Format(instance.MAPEDIT_031_FOOTER_COST, (IDictionary) hashtable));
  }

  public void UpdatePossession(int facilityID)
  {
    MapEditFacilityList[] componentsInChildren = this.scroll_.GetComponentsInChildren<MapEditFacilityList>();
    if (componentsInChildren == null || componentsInChildren.Length == 0)
      return;
    int num = 0;
    for (int index1 = 0; index1 < componentsInChildren.Length; ++index1)
    {
      if (componentsInChildren[index1].facility_._master == facilityID)
      {
        PlayerGuildFacility playerGuildFacility = ((IEnumerable<PlayerGuildFacility>) SMManager.Get<PlayerGuildFacility[]>()).FirstOrDefault<PlayerGuildFacility>((Func<PlayerGuildFacility, bool>) (x => x._master == facilityID));
        if (playerGuildFacility != null)
        {
          if (playerGuildFacility.hasnum <= 0)
          {
            UnityEngine.Object.Destroy((UnityEngine.Object) componentsInChildren[index1].gameObject);
            this.scroll_.Reset();
            for (int index2 = 0; index2 < componentsInChildren.Length; ++index2)
            {
              if (index1 != index2)
                this.scroll_.Add(componentsInChildren[index2].gameObject);
            }
            this.scroll_.GridReposition((UIGrid.OnReposition) (() => this.scroll_.scrollView.UpdatePosition()));
    ...
    this.btnSwitch_.isEnabled = num > 0;
  }
