...
public class Story0091ScrollParts : MonoBehaviour
{
  ...
  public void Init(PlayerStoryQuestS quest, NGMenuBase menu, int XL)
  {
    ...
    ((IEnumerable<PlayerStoryQuestS>) SMManager.Get<PlayerStoryQuestS[]>().M(quest.quest_story_s.quest_xl.ID, quest.quest_story_s.quest_l.ID)).OrderBy<PlayerStoryQuestS, int>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.ID)).ForEach<PlayerStoryQuestS>((System.Action<PlayerStoryQuestS>) (q => ((IEnumerable<PlayerStoryQuestS>) SMManager.Get<PlayerStoryQuestS[]>().S(q.quest_story_s.quest_xl.ID, q.quest_story_s.quest_l.ID, q.quest_story_s.quest_m.ID)).OrderBy<PlayerStoryQuestS, int>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.ID)).ForEach<PlayerStoryQuestS>((System.Action<PlayerStoryQuestS>) (m =>
    {
