...
public class Bugu00523Menu : Bugu005SelectItemListMenuBase
{
  ...
  public override Persist<Persist.ItemSortAndFilterInfo> GetPersist() => Persist.bugu0052BuildupMaterialSortAndFilter;
  ...
  protected override IEnumerator InitExtension()
  {
    ...
    if (bugu00523Menu.firstInit)
    {
      ...
      if (bugu00523Menu.FirstSelectItemList != null && bugu00523Menu.FirstSelectItemList.Count > 0)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        bugu00523Menu.FirstSelectItemList.ForEach(new System.Action<GameCore.ItemInfo>(bugu00523Menu.\u003CInitExtension\u003Eb__12_1));
      }
    }
    else if (bugu00523Menu.SelectItemList != null && bugu00523Menu.SelectItemList.Count > 0)
    {
      ...
      bugu00523Menu.SelectItemList.Clear();
      // ISSUE: reference to a compiler-generated method
      System.Action<InventoryItem> action = new System.Action<InventoryItem>(bugu00523Menu.\u003CInitExtension\u003Eb__12_3);
      list.ForEach(action);
    }
    return false;
  }
  ...
  protected override void BottomInfoUpdate()
  {
    ...
    this.txtSpendzenieNum.color = player.money >= (long) buildupCost ? Color.white : Color.red;
    this.ibtnYes.isEnabled = num > 0 && player.money >= (long) buildupCost;
  }
