...
public class Unit00468GvgMenu : Unit00468Menu
{
    ...
    PlayerUnit baseUnit = null)
  {
    ...
    if (!((UnityEngine.Object) allUnitIcon == (UnityEngine.Object) null))
    {
  ...
  public override void IbtnClearS()
  {
    ...
    {
      if ((UnityEngine.Object) displayUnitInfo.icon != (UnityEngine.Object) null && this.CheckWeaponBreak(displayUnitInfo.icon))
      {
    ...
    GuildUtil.GvGPopupState state)
  {
    ...
    ((IEnumerable<GameObject>) unit00468GvgMenu.linkCharacters).ForEach<GameObject>((System.Action<GameObject>) (v => v.transform.Clear()));
    ...
    unit00468GvgMenu.InitializeInfo((IEnumerable<PlayerUnit>) playerUnits, (IEnumerable<PlayerMaterialUnit>) null, Persist.unit00468SortAndFilter, isEquip, false, false, true, true, (System.Action) (() => this.InitializeAllUnitInfosExtend(gvgDeck)));
  ...
  public IEnumerator UpdateGvgDeck(
    ...
    string guild_id)
  {
    ...
    switch (mode)
    {
      case Unit00468Scene.Mode.Unit00468GvgAtk:
        enumerator = GuildUtil.UpdateGuildDeckAttack(guild_id, player_id, (System.Action) (() => {}));
        break;
      case Unit00468Scene.Mode.Unit00468GvgDef:
        enumerator = GuildUtil.UpdateGuildDeckDefanse(guild_id, player_id, (System.Action) (() => {}));
        break;
    }
    if (enumerator != null)
    {
