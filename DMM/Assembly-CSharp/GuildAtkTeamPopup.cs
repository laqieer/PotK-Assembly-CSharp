...
public class GuildAtkTeamPopup : BackButtonMenuBase
{
  ...
  private IEnumerator SetDeck(string player_id)
  {
    if (this.deckInfo != null)
    {
      ...
      if (player_id != null)
      {
        ...
        e = GuildUtil.UpdateGuildDeckAttack(this.isEnemy ? this.guild0282Menu.EnGuild.guild_id : this.guild0282Menu.MyGuild.guild_id, player_id, (System.Action) (() => isSuccess = true));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        if (!isSuccess)
  ...
  private IEnumerator LoadUnitPrefab(int index, PlayerUnit unit, bool isFriend)
  {
    ...
    {
      unitScript.onClick = (System.Action<UnitIconBase>) (x => this.StartCoroutine(this.ChangeDetailScene(unit, isFriend, index)));
  ...
  private IEnumerator ChangeDetailScene(PlayerUnit unit, bool isFriend, int index)
  {
    ...
    guildAtkTeamPopup.gameObject.SetActive(false);
  }
    ...
    System.Action success = null)
  {
    ...
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    bool isSuccess = false;
    e = GuildUtil.UpdateGuildDeckAttack(isEnemy ? menu.EnGuild.guild_id : menu.MyGuild.guild_id, info.player.player_id, (System.Action) (() => isSuccess = true));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (isSuccess)
    {
      ...
      this.btnTeamEdit.isEnabled = !onGuildBattle;
      ...
      this.guild0282Menu.SetGvgPopup(GuildUtil.GvGPopupState.AtkTeam, (System.Action) (() =>
      {
  ...
  {
    if ((UnityEngine.Object) this.guild0282Menu == (UnityEngine.Object) null || this.IsPushAndSet())
      return;
  ...
  public void onClickedLeaderSkillZoom()
  {
    ...
    PopupSkillDetails.show(this.skillDetailPrefab, new PopupSkillDetails.Param(this.leaderSkill), this.isEnemy, (System.Action) (() =>
    {
      this.IsPush = false;
