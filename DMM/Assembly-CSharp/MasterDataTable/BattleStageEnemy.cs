...
namespace MasterDataTable
{
  ...
  public class BattleStageEnemy
  {
    ...
    public BattleStageEnemySkill[] EnemySkills => ((IEnumerable<BattleStageEnemySkill>) MasterData.BattleStageEnemySkillList).Where<BattleStageEnemySkill>((Func<BattleStageEnemySkill, bool>) (x =>
    {
    ...
    public static BattleStageEnemy Parse(MasterDataReader reader) => new BattleStageEnemy()
    {
      ID = reader.ReadInt(),
    ...
    public BattleEnemyParameterTable parameter_table
    {
      get
      {
        ...
        BattleEnemyParameterTable enemyParameterTable;
        if (!MasterData.BattleEnemyParameterTable.TryGetValue(this.parameter_table_BattleEnemyParameterTable.Value, out enemyParameterTable))
    ...
    public BattleAIScript ai_script_id
    {
      get
      {
        ...
        BattleAIScript battleAiScript;
        if (!MasterData.BattleAIScript.TryGetValue(this.ai_script_id_BattleAIScript.Value, out battleAiScript))
          Debug.LogError((object) ("Key not Found: MasterData.BattleAIScript[" + (object) this.ai_script_id_BattleAIScript.Value + "]"));
        return battleAiScript;
      }
    }
  }
}
