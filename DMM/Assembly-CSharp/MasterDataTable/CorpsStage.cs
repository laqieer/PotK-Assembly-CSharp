...
namespace MasterDataTable
{
  ...
  public class CorpsStage
  {
    ...
    public static CorpsStage Parse(MasterDataReader reader) => new CorpsStage()
    {
      ID = reader.ReadInt(),
    ...
    public CorpsStageBackground back_ground
    {
      get
      {
        CorpsStageBackground corpsStageBackground;
        if (!MasterData.CorpsStageBackground.TryGetValue(this.back_ground_CorpsStageBackground, out corpsStageBackground))
          Debug.LogError((object) ("Key not Found: MasterData.CorpsStageBackground[" + (object) this.back_ground_CorpsStageBackground + "]"));
        return corpsStageBackground;
      }
    }
