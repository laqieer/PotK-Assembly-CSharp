...
namespace MasterDataTable
{
  ...
  public class StoryPlaybackStoryDetail
  {
    ...
    public static StoryPlaybackStoryDetail Parse(MasterDataReader reader) => new StoryPlaybackStoryDetail()
    {
      ID = reader.ReadInt(),
    ...
    public StoryPlaybackStory story
    {
      get
      {
        StoryPlaybackStory storyPlaybackStory;
        if (!MasterData.StoryPlaybackStory.TryGetValue(this.story_StoryPlaybackStory, out storyPlaybackStory))
          Debug.LogError((object) ("Key not Found: MasterData.StoryPlaybackStory[" + (object) this.story_StoryPlaybackStory + "]"));
        return storyPlaybackStory;
      }
    }
