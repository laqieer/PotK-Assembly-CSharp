...
namespace MasterDataTable
{
  ...
  public class UnitTypeTicket
  {
    ...
    public static UnitTypeTicket Parse(MasterDataReader reader) => new UnitTypeTicket()
    {
      ID = reader.ReadInt(),
    ...
    public UnitTypeTicketType ticketTypeID => (UnitTypeTicketType) this.ticketTypeID_UnitTypeTicketType;
  }
}
