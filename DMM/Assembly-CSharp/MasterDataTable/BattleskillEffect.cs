  ...
  public class BattleskillEffect
  {
    ...
    public bool checkUseSkillCount(int nowUseCount)
    {
      ...
      if (nullable.GetValueOrDefault() == num4 & nullable.HasValue)
        return true;
      int num5 = nowUseCount;
      nullable = this.useSkillCountMaxCache;
      int valueOrDefault1 = nullable.GetValueOrDefault();
      return num5 <= valueOrDefault1 & nullable.HasValue;
    }
    ...
    public static BattleskillEffect Parse(MasterDataReader reader) => new BattleskillEffect()
    {
      ID = reader.ReadInt(),
