...
namespace MasterDataTable
{
  ...
  public class UnitCharacter
  {
    ...
    public static UnitCharacter Parse(MasterDataReader reader) => new UnitCharacter()
    {
      ID = reader.ReadInt(),
    ...
    public UnitUnit GetDefaultUnitUnit() => Array.Find<UnitUnit>(MasterData.UnitUnitList, (Predicate<UnitUnit>) (uu => uu.character_UnitCharacter == this.ID));

    public Future<UnityEngine.Sprite> LoadCutin() => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Characters/{0}/battle_cutin", (object) this.ID));
  }
}
