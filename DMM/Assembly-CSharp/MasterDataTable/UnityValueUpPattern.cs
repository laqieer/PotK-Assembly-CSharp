...
namespace MasterDataTable
{
  ...
  public class UnityValueUpPattern
  {
    ...
    public static UnityValueUpPattern Parse(MasterDataReader reader) => new UnityValueUpPattern()
    {
      ID = reader.ReadInt(),
    ...
    public UnitCharacter character
    {
      get
      {
        ...
        if (!MasterData.UnitCharacter.TryGetValue(this.character_UnitCharacter.Value, out unitCharacter))
