...
namespace MasterDataTable
{
  ...
  public class GearGearComposeParameter
  {
    ...
    public static GearGearComposeParameter Parse(MasterDataReader reader) => new GearGearComposeParameter()
    {
      ID = reader.ReadInt(),
    ...
    public GearModelKind compose_kind
    {
      get
      {
        ...
        if (!MasterData.GearModelKind.TryGetValue(this.compose_kind_GearModelKind, out gearModelKind))
