...
namespace MasterDataTable
{
  ...
  public class UnitSEASkill
  {
    ...
    public static UnitSEASkill Parse(MasterDataReader reader) => new UnitSEASkill()
    {
      ID = reader.ReadInt(),
    ...
    public BattleskillSkill skill_1
    {
      get
      {
        ...
        if (!MasterData.BattleskillSkill.TryGetValue(this.skill_1_BattleskillSkill.Value, out battleskillSkill))
    ...
    public BattleskillSkill skill_2
    {
      get
      {
        if (!this.skill_2_BattleskillSkill.HasValue)
          return (BattleskillSkill) null;
        BattleskillSkill battleskillSkill;
        if (!MasterData.BattleskillSkill.TryGetValue(this.skill_2_BattleskillSkill.Value, out battleskillSkill))
    ...
    public BattleskillSkill skill_3
    {
      get
      {
        if (!this.skill_3_BattleskillSkill.HasValue)
          return (BattleskillSkill) null;
        BattleskillSkill battleskillSkill;
        if (!MasterData.BattleskillSkill.TryGetValue(this.skill_3_BattleskillSkill.Value, out battleskillSkill))
    ...
    public BattleskillSkill skill_4
    {
      get
      {
        if (!this.skill_4_BattleskillSkill.HasValue)
          return (BattleskillSkill) null;
        BattleskillSkill battleskillSkill;
        if (!MasterData.BattleskillSkill.TryGetValue(this.skill_4_BattleskillSkill.Value, out battleskillSkill))
