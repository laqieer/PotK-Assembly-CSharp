...
namespace MasterDataTable
{
  ...
  public class UnitUnit
  {
    ...
    public static UnitUnit Parse(MasterDataReader reader) => new UnitUnit()
    {
      ID = reader.ReadInt(),
    ...
    public UnitUnitParameter parameter_data
    {
      get
      {
        ...
        if (!MasterData.UnitUnitParameter.TryGetValue(this.parameter_data_UnitUnitParameter, out unitUnitParameter))
          Debug.LogError((object) ("Key not Found: MasterData.UnitUnitParameter[" + (object) this.parameter_data_UnitUnitParameter + "]"));
        return unitUnitParameter;
      }
    }
    ...
    public UnitUnitDescription etc_data
    {
      get
      {
        UnitUnitDescription unitUnitDescription;
        if (!MasterData.UnitUnitDescription.TryGetValue(this.etc_data_UnitUnitDescription, out unitUnitDescription))
          Debug.LogError((object) ("Key not Found: MasterData.UnitUnitDescription[" + (object) this.etc_data_UnitUnitDescription + "]"));
        return unitUnitDescription;
      }
    }
    ...
    public UnitUnit resource_reference_unit_id
    {
      ...
      {
        UnitUnit unitUnit;
        if (!MasterData.UnitUnit.TryGetValue(this.resource_reference_unit_id_UnitUnit, out unitUnit))
    ...
    public GearGear initial_gear
    {
      ...
      {
        GearGear gearGear;
        if (!MasterData.GearGear.TryGetValue(this.initial_gear_GearGear, out gearGear))
    ...
    public UnitFootstepType footstep_type
    {
      get
      {
        ...
        if (!MasterData.UnitFootstepType.TryGetValue(this.footstep_type_UnitFootstepType, out unitFootstepType))
    ...
    public UnitCameraPattern camera_pattern
    {
      get
      {
        ...
        if (!MasterData.UnitCameraPattern.TryGetValue(this.camera_pattern_UnitCameraPattern, out unitCameraPattern))
    ...
    public UnitIllustPattern illust_pattern
    {
      get
      {
        UnitIllustPattern unitIllustPattern;
        if (!MasterData.UnitIllustPattern.TryGetValue(this.illust_pattern_UnitIllustPattern, out unitIllustPattern))
          Debug.LogError((object) ("Key not Found: MasterData.UnitIllustPattern[" + (object) this.illust_pattern_UnitIllustPattern + "]"));
        return unitIllustPattern;
      }
    }
    ...
    public UnitUnitBuildupLimitRelease buildup_limit_release_id
    {
      get
      {
        UnitUnitBuildupLimitRelease buildupLimitRelease;
        if (!MasterData.UnitUnitBuildupLimitRelease.TryGetValue(this.buildup_limit_release_id_UnitUnitBuildupLimitRelease, out buildupLimitRelease))
    ...
    public ComposeMaxUnityValueSetting compose_max_unity_value_setting_id
    {
      get
      {
        ComposeMaxUnityValueSetting unityValueSetting;
        if (!MasterData.ComposeMaxUnityValueSetting.TryGetValue(this.compose_max_unity_value_setting_id_ComposeMaxUnityValueSetting, out unityValueSetting))
    ...
    public UnitExpireDate expire_date
    {
      get
      {
        ...
        UnitExpireDate unitExpireDate;
        if (!MasterData.UnitExpireDate.TryGetValue(this.expire_date_UnitExpireDate.Value, out unitExpireDate))
          Debug.LogError((object) ("Key not Found: MasterData.UnitExpireDate[" + (object) this.expire_date_UnitExpireDate.Value + "]"));
        return unitExpireDate;
      }
    }

    public bool IsNormalUnit => this.is_consume_only == 0 && this.is_evolution_only == 0 && (this.skillup_type == 0 && this.is_breakthrough_only == 0) && (this.is_buildup_only == 0 && !this.is_unity_value_up) && !this.is_exp_material;

    public bool IsMaterialUnit => this.is_consume_only != 0 || this.is_evolution_only != 0 || (this.skillup_type != 0 || this.is_breakthrough_only != 0) || (this.is_buildup_only != 0 || this.is_unity_value_up) || this.is_exp_material;

    public bool IsTougouUnit => this.is_consume_only != 0 || this.skillup_type != 0 || (this.is_breakthrough_only != 0 || this.is_buildup_only != 0) || this.is_unity_value_up;
    ...
    public bool IsPureValueUp => this.is_consume_only == 1 && ((IEnumerable<UnityPureValueUpPattern>) MasterData.UnityPureValueUpPatternList).Any<UnityPureValueUpPattern>((Func<UnityPureValueUpPattern, bool>) (x => x.material_unit == this));

    public bool IsBreakThrougPureValueUp(PlayerUnit basePlayerUnit) => this.IsPureValueUp && basePlayerUnit.breakthrough_count < basePlayerUnit.unit.breakthrough_limit;

    public bool IsSkillLevelUpPureValueUp(PlayerUnit basePlayerUnit) => this.IsPureValueUp && ((IEnumerable<PlayerUnitSkills>) basePlayerUnit.skills).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (x => x.level < x.skill.upper_level)).ToArray<PlayerUnitSkills>().Length != 0;
    ...
    public bool CheckBreakThroughInTargetUnit(List<UnitBreakThrough> list, PlayerUnit baseUnit) => list.Any<UnitBreakThrough>((Func<UnitBreakThrough, bool>) (x => x.target_unit != null && x.target_unit == baseUnit.unit));
    ...
    public bool CheckBreakThroughAllFree(List<UnitBreakThrough> list) => list.Any<UnitBreakThrough>((Func<UnitBreakThrough, bool>) (x => x.target_unit == null && x.rarity == null && x.kind == null));

    public bool IsMaterialUnitSkillUp => (uint) this.skillup_type > 0U;

    public bool IsBuildUpMaterial(PlayerUnit baseUnit) => !((IEnumerable<UnitBuildupMaterialPattern>) MasterData.UnitBuildupMaterialPatternList).Any<UnitBuildupMaterialPattern>((Func<UnitBuildupMaterialPattern, bool>) (x => x.material_unit == this)) ? this.IsBuildup : this.BuildupMaterialUnit(baseUnit) != null;

    public UnitBuildupMaterialPattern BuildupMaterialUnit(
      PlayerUnit BaseUnit)
    {
    ...
    public UnitTransmigrationPattern TransmigratePattern => ((IEnumerable<UnitTransmigrationPattern>) MasterData.UnitTransmigrationPatternList).Where<UnitTransmigrationPattern>((Func<UnitTransmigrationPattern, bool>) (p => p.rarity_name.index == this.rarity.index)).First<UnitTransmigrationPattern>();
    ...
    public UnitEvolutionPattern[] EvolutionPattern => ((IEnumerable<UnitEvolutionPattern>) MasterData.UnitEvolutionPatternList).Where<UnitEvolutionPattern>((Func<UnitEvolutionPattern, bool>) (p => p.unit_UnitUnit == this.ID)).ToArray<UnitEvolutionPattern>();
    ...
    public Dictionary<int, UnitUnit[]> EvolutionUnits
    {
      get
      {
        Dictionary<int, UnitUnit[]> dictionary = new Dictionary<int, UnitUnit[]>();
        foreach (UnitEvolutionPattern evolutionPattern in this.EvolutionPattern)
        {
          ...
          dictionary.Add(pattern.ID, array);
        }
        return dictionary;
      }
    }
    ...
    public bool HasSkillGroupId(int skillGroupId) => ((IEnumerable<int>) this.SkillGroupIds).Contains<int>(skillGroupId);

    public BattleskillSkill RememberLeaderSkill => ((IEnumerable<UnitLeaderSkill>) MasterData.UnitLeaderSkillList).FirstOrDefault<UnitLeaderSkill>((Func<UnitLeaderSkill, bool>) (x => x.unit_UnitUnit == this.ID))?.skill;

    public BattleskillSkill[] RememberSkills(int unit_type_id = 0) => ((IEnumerable<UnitSkill>) MasterData.UnitSkillList).Where<UnitSkill>((Func<UnitSkill, bool>) (x =>
    {
    ...
    public UnitSkill[] RememberUnitSkills(int unit_type_id = 0) => ((IEnumerable<UnitSkill>) MasterData.UnitSkillList).Where<UnitSkill>((Func<UnitSkill, bool>) (x =>
    {
      if (x.unit_UnitUnit != this.ID)
        return false;
      return x.unit_type == 0 || x.unit_type == unit_type_id;
    ...
    public UnitSkill[] RememberUnitAllSkills() => ((IEnumerable<UnitSkill>) MasterData.UnitSkillList).Where<UnitSkill>((Func<UnitSkill, bool>) (x => x.unit_UnitUnit == this.ID)).ToArray<UnitSkill>();
    ...
    public UnitProficiency default_weapon_proficiency => this.parameter_data.default_weapon_proficiency;

    public UnitProficiency default_shield_proficiency => this.parameter_data.default_shield_proficiency;
    ...
    public BattleskillSkill PickupSkill => ((IEnumerable<UnitPickupSkill>) MasterData.UnitPickupSkillList).FirstOrDefault<UnitPickupSkill>((Func<UnitPickupSkill, bool>) (x => x.unit.ID == this.ID))?.skill;
    ...
    public BattleUnitLandformFootstep GetFootstep(BattleLandform landform) => ((IEnumerable<BattleUnitLandformFootstep>) MasterData.BattleUnitLandformFootstepList).Single<BattleUnitLandformFootstep>((Func<BattleUnitLandformFootstep, bool>) (x => x.unit_footstep_type.ID == this.footstep_type.ID && x.landform_footstep_type.ID == landform.footstep_type.ID));
    ...
    public MapFacility facility => ((IEnumerable<FacilityLevel>) MasterData.FacilityLevelList).Where<FacilityLevel>((Func<FacilityLevel, bool>) (x => x.unit_UnitUnit == this.ID)).FirstOrDefault<FacilityLevel>()?.facility;
    ...
    public PlayerUnitSkills[] facilitySkills
    {
      get
      {
        PlayerUnitSkills[] playerUnitSkillsArray = new PlayerUnitSkills[0];
        ...
        if (levelInfo != null)
          playerUnitSkillsArray = ((IEnumerable<FacilitySkillGroup>) MasterData.FacilitySkillGroupList).Where<FacilitySkillGroup>((Func<FacilitySkillGroup, bool>) (x => x.facility_level_info_FacilityLevel == levelInfo.ID)).Select<FacilitySkillGroup, PlayerUnitSkills>((Func<FacilitySkillGroup, PlayerUnitSkills>) (x => new PlayerUnitSkills()
          {
            skill_id = x.skill_BattleskillSkill,
            level = 1
          })).ToArray<PlayerUnitSkills>();
        return playerUnitSkillsArray;
      }
    }

    public bool canUseAllGearHackSkill => this.awake_special_skill_category_id.HasValue && this.awake_special_skill_category_id.Value == 4;
    ...
    public bool CanEquipAwakeSkill(PlayerAwakeSkill skill) => this.CanEquipAwakeSkillByType((AwakeSkillCategory.Type) skill.masterData.awake_skill_category_id);

    public PlayerAwakeSkill[] GetAllEquipableAwakeSkills(PlayerAwakeSkill[] skills = null) => ((IEnumerable<PlayerAwakeSkill>) (skills ?? SMManager.Get<PlayerAwakeSkill[]>())).Where<PlayerAwakeSkill>((Func<PlayerAwakeSkill, bool>) (x => this.CanEquipAwakeSkill(x))).ToArray<PlayerAwakeSkill>();
    ...
    public UnitAffiliationIcon getAffiliationIcon()
    {
      ...
      UnitAffiliationIcon unitAffiliationIcon1 = (UnitAffiliationIcon) null;
      foreach (UnitAffiliationIcon unitAffiliationIcon2 in MasterData.UnitAffiliationIconList)
      {
        if (unitAffiliationIcon1 == null)
          unitAffiliationIcon1 = unitAffiliationIcon2;
        else if (unitAffiliationIcon2.priority < unitAffiliationIcon1.priority)
        {
          switch (unitAffiliationIcon2.unit_group_head)
          {
            case UnitGroupHead.group_all:
              unitAffiliationIcon1 = unitAffiliationIcon2;
              continue;
            case UnitGroupHead.group_large:
              if (unitAffiliationIcon2.group_refer_id == num1)
                goto case UnitGroupHead.group_all;
              else
                continue;
            case UnitGroupHead.group_small:
              if (unitAffiliationIcon2.group_refer_id == num2)
                goto case UnitGroupHead.group_all;
              else
                continue;
            case UnitGroupHead.group_clothing:
              if (unitAffiliationIcon2.group_refer_id == num3)
                goto case UnitGroupHead.group_all;
              else
                continue;
            case UnitGroupHead.group_generation:
              if (unitAffiliationIcon2.group_refer_id != num4)
                continue;
              goto case UnitGroupHead.group_all;
            default:
    ...
    public UnitTypeEnum[] validUnitTypes
    {
      get
      {
        ...
        string[] strArray = Consts.GetInstance().ALL_UNIT_TYPE_ENTRY_UNIT_IDS.Split(',');
        if ((this.magic_warrior_flag ? 1 : (((IEnumerable<string>) strArray).Contains<string>(this.ID.ToString()) ? 1 : 0)) == 0)
        {
    ...
    public GearKindEnum primaryGearKind => this.kind_GearKind == 8 ? (GearKindEnum) this.initial_gear.kind_GearKind : (GearKindEnum) this.kind_GearKind;
    ...
    public UnitSEASkill SEASkill
    {
      get
      {
        ...
        if (this.exist_overkillers_slot)
          MasterData.UnitSEASkill.TryGetValue(this.same_character_id, out unitSeaSkill);
        else
          unitSeaSkill = (UnitSEASkill) null;
        return unitSeaSkill;
      }
    }
    ...
    {
      UnitLeaderSkill unitLeaderSkill = ((IEnumerable<UnitLeaderSkill>) MasterData.UnitLeaderSkillList).FirstOrDefault<UnitLeaderSkill>((Func<UnitLeaderSkill, bool>) (x => x.unit_UnitUnit == this.ID));
      List<UnitBattleSkillOrigin> battleSkillOriginList;
      if (unitLeaderSkill == null)
      {
      ...
      {
        battleSkillOriginList = new List<UnitBattleSkillOrigin>();
        battleSkillOriginList.Add(new UnitBattleSkillOrigin((object) unitLeaderSkill, unitLeaderSkill.skill));
      }
    ...
    public List<string> GetUIResourcePaths(bool imageLarge = true, bool imageFull = false)
    {
      ...
      if (imageLarge)
        stringList.Add(str + "unit_large");
      if (imageFull)
        stringList.Add(str + "unit_full");
      return stringList;
    }

    public Future<UnityEngine.Sprite> LoadCutin(int metamor_id = 0)
    {
      if (metamor_id != 0)
      {
        ...
        if (unitModel != null)
        {
          ...
          if ((referenceImage = unitModel.cutin_frame?.reference_image) != null)
            return Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(referenceImage.filePath(this));
          if (unitModel.cutin_pattern.HasValue)
            return Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format(UnitUnit.PATH_CUTIN_PATTERN, (object) this.character_UnitCharacter, (object) unitModel.cutin_pattern.Value));
        }
      }
      UnitReferenceImage referenceImage1;
      if ((referenceImage1 = UnitCutinInfo.find(this)?.reference_image) != null)
        return Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(referenceImage1.filePath(this));
      return this.cutin_pattern_id.HasValue ? Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format(UnitUnit.PATH_CUTIN_PATTERN, (object) this.character_UnitCharacter, (object) this.cutin_pattern_id.Value)) : Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Characters/{0}/battle_cutin", (object) this.character_UnitCharacter));
    }

    public Future<UnityEngine.Sprite> LoadSpriteMedium(
      int jobOrMetamorId,
      float pixelsPerUnit = 1f)
    {
      string path = this.combinePath2D(jobOrMetamorId, "c_400x400").Replace("AssetBundle/Resources/", "");
      return Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(path, pixelsPerUnit);
    }

    public Future<UnityEngine.Sprite> LoadSpriteMedium(float pixelsPerUnit = 1f) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("Units/{0}/2D/c_400x400", (object) this.resource_reference_unit_id.ID), pixelsPerUnit);

    public Future<UnityEngine.Sprite> LoadSpriteLarge(float pixelsPerUnit = 1f) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_large", (object) this.resource_reference_unit_id.ID), pixelsPerUnit);

    public Future<UnityEngine.Sprite> LoadSpriteLarge(
      int jobOrMetamorId,
      float pixelsPerUnit = 1f)
    {
      return Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(this.combinePath2D(jobOrMetamorId, "unit_large"), pixelsPerUnit);
    }

    public bool ExistSpriteStory() => Singleton<ResourceManager>.GetInstance().Contains(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_story", (object) this.resource_reference_unit_id.ID));

    public bool ExistSpriteStory(int jobOrMetamorId) => Singleton<ResourceManager>.GetInstance().Contains((this.job_UnitJob == jobOrMetamorId ? UnitUnit.sDirectory2D(this.resource_reference_unit_id_UnitUnit) : UnitUnit.sDirectory2D(this.ID, this.resource_reference_unit_id_UnitUnit, jobOrMetamorId)) + "unit_story");

    public Future<UnityEngine.Sprite> LoadSpriteStory() => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_story", (object) this.resource_reference_unit_id.ID));

    public Future<UnityEngine.Sprite> LoadSpriteStory(int jobOrMetamorId) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(this.combinePath2D(jobOrMetamorId, "unit_story"));

    private static string GetSpriteFacePath(int id, string name) => UnitUnit.sDirectory2D(id) + "Face/" + name;

    private static string GetSpriteFacePath(int unitId, int id, int jobOrMetamorId, string name) => UnitUnit.sDirectory2D(unitId, id, jobOrMetamorId) + "Face/" + name;

    public bool HasSpriteFace(string name) => Singleton<ResourceManager>.GetInstance().Contains(UnitUnit.GetSpriteFacePath(this.resource_reference_unit_id.ID, name));

    public bool HasSpriteFace(int jobOrMetamorId, string name) => Singleton<ResourceManager>.GetInstance().Contains(this.job_UnitJob == jobOrMetamorId ? UnitUnit.GetSpriteFacePath(this.resource_reference_unit_id_UnitUnit, name) : UnitUnit.GetSpriteFacePath(this.ID, this.resource_reference_unit_id_UnitUnit, jobOrMetamorId, name));

    public Future<UnityEngine.Sprite> LoadSpriteFace(string name) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(UnitUnit.GetSpriteFacePath(this.resource_reference_unit_id.ID, name));

    public Future<UnityEngine.Sprite> LoadSpriteFace(int jobOrMetamorId, string name) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(this.job_UnitJob == jobOrMetamorId ? UnitUnit.GetSpriteFacePath(this.resource_reference_unit_id_UnitUnit, name) : UnitUnit.GetSpriteFacePath(this.ID, this.resource_reference_unit_id_UnitUnit, jobOrMetamorId, name));

    private static string GetSpriteEyePath(int id, string name) => UnitUnit.sDirectory2D(id) + "Eye/" + name;

    private static string GetSpriteEyePath(int unitId, int refId, int jobOrMetamorId, string name) => UnitUnit.sDirectory2D(unitId, refId, jobOrMetamorId) + "Eye/" + name;

    public bool HasSpriteEye(string name) => Singleton<ResourceManager>.GetInstance().Contains(UnitUnit.GetSpriteEyePath(this.resource_reference_unit_id.ID, name));

    public bool HasSpriteEye(int jobOrMetamorId, string name) => Singleton<ResourceManager>.GetInstance().Contains(this.job_UnitJob == jobOrMetamorId ? UnitUnit.GetSpriteEyePath(this.resource_reference_unit_id_UnitUnit, name) : UnitUnit.GetSpriteEyePath(this.ID, this.resource_reference_unit_id_UnitUnit, jobOrMetamorId, name));

    public Future<UnityEngine.Sprite> LoadSpriteEye(string name) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(UnitUnit.GetSpriteEyePath(this.resource_reference_unit_id.ID, name));

    public Future<UnityEngine.Sprite> LoadSpriteEye(int jobOrMetamorId, string name) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(this.job_UnitJob == jobOrMetamorId ? UnitUnit.GetSpriteEyePath(this.resource_reference_unit_id_UnitUnit, name) : UnitUnit.GetSpriteEyePath(this.ID, this.resource_reference_unit_id_UnitUnit, jobOrMetamorId, name));

    public Future<UnityEngine.Sprite> LoadSpriteThumbnail() => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/c_thum", (object) this.resource_reference_unit_id.ID));

    public Future<UnityEngine.Sprite> LoadSpriteThumbnail(int jobOrMetamorId) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(this.combinePath2D(jobOrMetamorId, "c_thum"));
    ...
    private string directory2DWithJob(int jobOrMetamorId) => this.job_UnitJob != jobOrMetamorId ? this.directory2D(jobOrMetamorId) : this.directory2D();

    private string directory2D(int jobOrMetamorId) => UnitUnit.sDirectory2D(this.ID, this.resource_reference_unit_id_UnitUnit, jobOrMetamorId);
    ...
    private static string sDirectory2D(int refId) => "AssetBundle/Resources/Units/" + refId.ToString() + "/2D/";

    public Future<UnityEngine.Sprite> LoadSpriteBasic() => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_large", (object) this.resource_reference_unit_id.ID));

    public Future<UnityEngine.Sprite> LoadSpriteBasic(int jobOrMetamorId) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(this.combinePath2D(jobOrMetamorId, "unit_large"));
    ...
    public Future<GameObject> LoadModelDuel() => this.model_reference_id != 0 ? Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("Units/{0}/3D/duel/prefab", (object) this.model_reference_id)) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("Units/{0}/3D/duel/prefab", (object) this.resource_reference_unit_id_UnitUnit));
    ...
    public Future<GameObject> LoadModelField() => this.model_reference_id != 0 ? Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("Units/{0}/3D/field/prefab", (object) this.model_reference_id)) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("Units/{0}/3D/field/prefab", (object) this.resource_reference_unit_id_UnitUnit));

    public Future<GameObject> LoadModelDuelVehicle() => string.IsNullOrEmpty(this.vehicle_model_name) ? Future.Single<GameObject>((GameObject) null) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("UnitVehicle/{0}/3D/duel/prefab", (object) this.vehicle_model_name));
    ...
    public Future<GameObject> LoadModelFieldVehicle() => string.IsNullOrEmpty(this.vehicle_model_name) ? Future.Single<GameObject>((GameObject) null) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("UnitVehicle/{0}/3D/field/prefab", (object) this.vehicle_model_name));

    public Future<GameObject> LoadModelDuelEquip() => string.IsNullOrEmpty(this.equip_model_name) ? Future.Single<GameObject>((GameObject) null) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("UnitEquips/{0}/3D/duel/prefab", (object) this.equip_model_name));

    public Future<GameObject> LoadModelFieldEquip() => string.IsNullOrEmpty(this.equip_model_name) ? Future.Single<GameObject>((GameObject) null) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("UnitEquips/{0}/3D/field/prefab", (object) this.equip_model_name));

    public Future<GameObject> LoadModelDuelEquipB() => string.IsNullOrEmpty(this.equip_model_b_name) ? Future.Single<GameObject>((GameObject) null) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("UnitEquips_b/{0}/3D/duel/prefab", (object) this.equip_model_b_name));

    public Future<GameObject> LoadModelFieldEquipB() => string.IsNullOrEmpty(this.equip_model_b_name) ? Future.Single<GameObject>((GameObject) null) : Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("UnitEquips_b/{0}/3D/field/prefab", (object) this.equip_model_b_name));
    ...
    private void AttachAwakeEffect(GameObject unitObj, GameObject effectPrefab)
    {
      ...
      if (!((UnityEngine.Object) childInFind != (UnityEngine.Object) null) || !((UnityEngine.Object) effectPrefab != (UnityEngine.Object) null))
        return;
    ...
    private static bool IsAttachedAwakeEffect(GameObject unitObj) => (UnityEngine.Object) unitObj.transform.GetChildInFind("ef_root") != (UnityEngine.Object) null;

    public Future<UnityEngine.Sprite> LoadFullSprite(float pixelsPerUnit = 1f) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_full", (object) this.resource_reference_unit_id.ID), pixelsPerUnit);

    public Future<UnityEngine.Sprite> LoadFullSprite(int ext_id, float pixelsPerUnit = 1f)
    {
      ...
      return Singleton<ResourceManager>.GetInstance().Contains(path) ? Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(path) : this.LoadFullSprite(pixelsPerUnit);
    }
    ...
    public Future<UnityEngine.Sprite> LoadHiResSprite() => Singleton<ResourceManager>.GetInstance().LoadOrNull<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_hires", (object) this.resource_reference_unit_id.ID));

    public Future<UnityEngine.Sprite> LoadHiResSprite(int job_id)
    {
      ...
      return Singleton<ResourceManager>.GetInstance().Contains(path) ? Singleton<ResourceManager>.GetInstance().LoadOrNull<UnityEngine.Sprite>(path) : this.LoadHiResSprite();
    }

    public Future<UnityEngine.Sprite> LoadJobFullSprite(int ext_id)
    {
      ...
      return Singleton<ResourceManager>.GetInstance().Contains(path) ? Singleton<ResourceManager>.GetInstance().LoadOrNull<UnityEngine.Sprite>(path) : this.LoadFullSprite();
    }

    public Future<UnityEngine.Sprite> LoadAwakeningText(int textNumber) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/text{1}", (object) this.resource_reference_unit_id.ID, (object) textNumber));

    public Future<UnityEngine.Sprite> LoadSpriteEventImage(float pixelsPerUnit = 1f) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/EventImages/c{0}", (object) this.resource_reference_unit_id.ID), pixelsPerUnit);

    public Future<UnityEngine.Sprite> LoadSpriteFlavorText(float pixelsPerUnit = 1f) => Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/flavor_text", (object) this.resource_reference_unit_id.ID), pixelsPerUnit);

    public Future<UnityEngine.Material> LoadFieldNormalFaceMaterial()
    {
    ...
    public Future<UnityEngine.Material> LoadFieldNormalFaceMaterial(int extID)
    {
    ...
    public IEnumerator SetLargeSprite(GameObject go, int depth = 1000)
    {
      ...
      Future<UnityEngine.Sprite> large = this.LoadSpriteLarge();
    ...
    public IEnumerator SetLargeSpriteSnap(GameObject go, int depth = 1000)
    {
      ...
      sprite.sprite2D = large.Result;
      sprite.depth = depth;
      sprite.SetDimensions((int) sprite.sprite2D.textureRect.width, (int) sprite.sprite2D.textureRect.height);
    }

    public IEnumerator SetLargeSpriteSnap(int jobOrMetamorId, GameObject go, int depth = 1000)
    {
      UI2DSprite sprite = go.GetComponent<UI2DSprite>();
      Future<UnityEngine.Sprite> large = this.LoadSpriteLarge(jobOrMetamorId, 1f);
      IEnumerator e = large.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      ...
      int y = 0)
    {
      ...
      Future<UnityEngine.Sprite> spriteFuture = this.LoadSpriteLarge();
    ...
    {
      UI2DSprite ui2dsprite = go.GetComponent<UI2DSprite>();
      Future<UnityEngine.Sprite> spriteFuture = this.LoadSpriteLarge(jobOrMetamorId, 1f);
      IEnumerator e = spriteFuture.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    ...
    {
      UI2DSprite sprite = go.GetComponent<UI2DSprite>();
      Future<UnityEngine.Sprite> medium = this.LoadSpriteMedium();
    ...
    {
      UI2DSprite ui2dsprite = go.GetComponent<UI2DSprite>();
      Future<UnityEngine.Sprite> spriteFuture = this.LoadSpriteMedium();
      IEnumerator e = spriteFuture.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    ...
    private Future<GameObject> fullGameObject(float scale, int x, int y) => Singleton<ResourceManager>.GetInstance().Load<GameObject>("Prefabs/UnitIcon/full").Then<GameObject>((Func<GameObject, GameObject>) (full =>
    {
    ...
    private Future<GameObject> fullGameObject() => Singleton<ResourceManager>.GetInstance().Load<GameObject>("Prefabs/UnitIcon/full").Then<GameObject>((Func<GameObject, GameObject>) (full =>
    {
    ...
    private Future<GameObject> fullWithFaceGameObject() => Singleton<ResourceManager>.GetInstance().Load<GameObject>("Prefabs/UnitIcon/fullWithFace");
    ...
    public void SetStoryData(GameObject go, string name = "normal", int? ext_id = null)
    {
      ...
      component3.EyeUI2DSprite.gameObject.SetActive(false);
    ...
    public Future<GameObject> LoadInitialEquippedGearModel() => MasterData.GearGear[this.initial_gear.ID].LoadModel();

    public void SetCuntrySpriteName(ref UISprite refSprite)
    {
      if (!this.country_attribute.HasValue || !((UnityEngine.Object) refSprite != (UnityEngine.Object) null))
        return;
      string name = string.Format("slc_{0}.png__GUI__unit_sort_country__unit_sort_country_prefab", (object) this.country_attribute.Value);
      UISpriteData sprite = refSprite.atlas.GetSprite(name);
      if (sprite == null)
        return;
      refSprite.spriteName = name;
      refSprite.SetDimensions(sprite.width, sprite.height);
    }

    public void SetNonCuntrySpriteName(ref UISprite refSprite)
    {
      if (!((UnityEngine.Object) refSprite != (UnityEngine.Object) null))
        return;
      string name = "slc_blank.png__GUI__unit_sort_country__unit_sort_country_prefab";
      UISpriteData sprite = refSprite.atlas.GetSprite(name);
      if (sprite == null)
        return;
      refSprite.spriteName = name;
    ...
    public IEnumerator SetInclusionIP(UI2DSprite sprite)
    {
      ...
      {
        Future<UnityEngine.Sprite> sprite2d = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/slc_attribute", (object) this.inclusion_ip.Value));
        IEnumerator e = sprite2d.Wait();
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        UnityEngine.Sprite result = sprite2d.Result;
        sprite.sprite2D = result;
        sprite.GetComponent<UIWidget>().SetDimensions((int) result.rect.width, (int) result.rect.height);
        sprite2d = (Future<UnityEngine.Sprite>) null;
      }
    }
    ...
    public UnitCharacterExtension getCharacterExtension(int job_metamor_id) => job_metamor_id == 0 ? (UnitCharacterExtension) null : Array.Find<UnitCharacterExtension>(MasterData.UnitCharacterExtensionList, (Predicate<UnitCharacterExtension>) (x => x.unit_id_UnitUnit == this.ID && x.job_metamor_id == job_metamor_id));
    ...
    public bool GetPiece => Singleton<NGGameDataManager>.GetInstance().GetTablePieceSameCharacterIds.ContainsKey(this.same_character_id);
    ...
    public bool IsTrustMaterial(PlayerUnit baseUnit) => this.isTrustMaterial && this.TrustMaterialUnit(baseUnit) != null;

    public UnitTrustLevelMaterialPattern TrustMaterialUnit(
      PlayerUnit BaseUnit)
    {
      UnitUnit bUnit = BaseUnit.unit;
    ...
    public List<int> getClassChangeJobIdList()
    {
      ...
      {
        intList.Add(jobChangePatterns.job1_UnitJob);
        intList.Add(jobChangePatterns.job2_UnitJob);
        if (jobChangePatterns.job3_UnitJob.HasValue)
          intList.Add(jobChangePatterns.job3_UnitJob.Value);
        else
          intList.Add(0);
        if (jobChangePatterns.job4_UnitJob.HasValue)
          intList.Add(jobChangePatterns.job4_UnitJob.Value);
        else
          intList.Add(0);
        if (jobChangePatterns.job5_UnitJob.HasValue)
          intList.Add(jobChangePatterns.job5_UnitJob.Value);
        else
          intList.Add(0);
        if (jobChangePatterns.job6_UnitJob.HasValue)
          intList.Add(jobChangePatterns.job6_UnitJob.Value);
        else
          intList.Add(0);
        if (jobChangePatterns.job7_UnitJob.HasValue)
          intList.Add(jobChangePatterns.job7_UnitJob.Value);
        else
          intList.Add(0);
      }
      return intList;
    ...
    public bool IsAllEquipUnit => ((IEnumerable<string>) Consts.GetInstance().ALL_GEAR_EQUIP_UNIT_IDS.Split(',')).Contains<string>(this.ID.ToString());
