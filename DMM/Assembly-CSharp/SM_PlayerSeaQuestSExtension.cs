...
{
  public static PlayerSeaQuestS[] XL(this PlayerSeaQuestS[] self) => ((IEnumerable<PlayerSeaQuestS>) self).Distinct<PlayerSeaQuestS>((IEqualityComparer<PlayerSeaQuestS>) new LambdaEqualityComparer<PlayerSeaQuestS>((Func<PlayerSeaQuestS, PlayerSeaQuestS, bool>) ((a, b) => a.quest_sea_s.quest_xl.ID == b.quest_sea_s.quest_xl.ID))).OrderBy<PlayerSeaQuestS, int>((Func<PlayerSeaQuestS, int>) (x => x.quest_sea_s.quest_xl.priority)).ToArray<PlayerSeaQuestS>();

  public static PlayerSeaQuestS[] L(this PlayerSeaQuestS[] self, int xl) => ((IEnumerable<PlayerSeaQuestS>) self).Where<PlayerSeaQuestS>((Func<PlayerSeaQuestS, bool>) (q => q.quest_sea_s.quest_xl.ID == xl)).Distinct<PlayerSeaQuestS>((IEqualityComparer<PlayerSeaQuestS>) new LambdaEqualityComparer<PlayerSeaQuestS>((Func<PlayerSeaQuestS, PlayerSeaQuestS, bool>) ((a, b) => a.quest_sea_s.quest_l.ID == b.quest_sea_s.quest_l.ID))).OrderBy<PlayerSeaQuestS, int>((Func<PlayerSeaQuestS, int>) (x => x.quest_sea_s.quest_l.priority)).ToArray<PlayerSeaQuestS>();

  public static PlayerSeaQuestS[] M(this PlayerSeaQuestS[] self, int xl, int l) => ((IEnumerable<PlayerSeaQuestS>) self).Where<PlayerSeaQuestS>((Func<PlayerSeaQuestS, bool>) (q => q.quest_sea_s.quest_xl.ID == xl && q.quest_sea_s.quest_l.ID == l)).Distinct<PlayerSeaQuestS>((IEqualityComparer<PlayerSeaQuestS>) new LambdaEqualityComparer<PlayerSeaQuestS>((Func<PlayerSeaQuestS, PlayerSeaQuestS, bool>) ((a, b) => a.quest_sea_s.quest_m.ID == b.quest_sea_s.quest_m.ID))).OrderBy<PlayerSeaQuestS, int>((Func<PlayerSeaQuestS, int>) (x => x.quest_sea_s.quest_m.priority)).ToArray<PlayerSeaQuestS>();

  public static PlayerSeaQuestS[] S(
    this PlayerSeaQuestS[] self,
    int xl,
    int l,
    int m)
  {
  ...
  public static PlayerSeaQuestS[] DisplayScrollXL(this PlayerSeaQuestS[] self) => ((IEnumerable<PlayerSeaQuestS>) self).Where<PlayerSeaQuestS>((Func<PlayerSeaQuestS, bool>) (q => q.is_clear)).Distinct<PlayerSeaQuestS>((IEqualityComparer<PlayerSeaQuestS>) new LambdaEqualityComparer<PlayerSeaQuestS>((Func<PlayerSeaQuestS, PlayerSeaQuestS, bool>) ((a, b) => a.quest_sea_s.quest_xl.ID == b.quest_sea_s.quest_xl.ID))).OrderBy<PlayerSeaQuestS, int>((Func<PlayerSeaQuestS, int>) (x => x.quest_sea_s.quest_xl.priority)).ToArray<PlayerSeaQuestS>();

  public static PlayerSeaQuestS[] DisplayScrollL(this PlayerSeaQuestS[] self, int xl) => ((IEnumerable<PlayerSeaQuestS>) self).Where<PlayerSeaQuestS>((Func<PlayerSeaQuestS, bool>) (q => q.is_clear && q.quest_sea_s.quest_xl.ID == xl && !q.quest_sea_s.quest_l.origin_id.HasValue)).Distinct<PlayerSeaQuestS>((IEqualityComparer<PlayerSeaQuestS>) new LambdaEqualityComparer<PlayerSeaQuestS>((Func<PlayerSeaQuestS, PlayerSeaQuestS, bool>) ((a, b) => a.quest_sea_s.quest_l.ID == b.quest_sea_s.quest_l.ID))).OrderBy<PlayerSeaQuestS, int>((Func<PlayerSeaQuestS, int>) (x => x.quest_sea_s.quest_l.priority)).ToArray<PlayerSeaQuestS>();

  public static PlayerSeaQuestS[] DisplayScrollM(this PlayerSeaQuestS[] self, int xl) => ((IEnumerable<PlayerSeaQuestS>) self).Where<PlayerSeaQuestS>((Func<PlayerSeaQuestS, bool>) (q => q.is_clear && q.quest_sea_s.quest_xl.ID == xl)).Distinct<PlayerSeaQuestS>((IEqualityComparer<PlayerSeaQuestS>) new LambdaEqualityComparer<PlayerSeaQuestS>((Func<PlayerSeaQuestS, PlayerSeaQuestS, bool>) ((a, b) => a.quest_sea_s.quest_m.ID == b.quest_sea_s.quest_m.ID))).OrderBy<PlayerSeaQuestS, int>((Func<PlayerSeaQuestS, int>) (x => x.quest_sea_s.quest_m.priority)).ToArray<PlayerSeaQuestS>();
}
