...
namespace Net
{
  public class AppPeer : Peer
  {
    ...
    public Future<AppPeer.ReceivedMessage> ReceiveOps(params AppServerOperation[] ops) => this.ReceiveUntil(-1, (Func<AppPeer.ReceivedMessage, bool>) (r => ((IEnumerable<AppServerOperation>) ops).Any<AppServerOperation>((Func<AppServerOperation, bool>) (c => r.Error != null || c == (AppServerOperation) r.Header.Type))));
    ...
    public Future<AppPeer.ReceivedMessage> ReceiveType(int timeoutMilliseconds = -1) => new Future<AppPeer.ReceivedMessage>((Func<Promise<AppPeer.ReceivedMessage>, IEnumerator>) (promise => this.ReceiveTypeE(timeoutMilliseconds, promise)));

    private IEnumerator SendNothrowE(
      Func<Future<int>> send,
      Promise<AppPeer.SendMessage> promise)
    {
      Future<int> f = send();
    ...
    public Future<AppPeer.SendMessage> SendNothrow(Func<Future<int>> send) => new Future<AppPeer.SendMessage>((Func<Promise<AppPeer.SendMessage>, IEnumerator>) (promise => this.SendNothrowE(send, promise)));
    ...
    public Future<AppPeer.SendMessage> LocateUnitsCompleted(
      Tuple<int, int, int>[] unitPositions)
    {
      AssocList<string, object> args = new AssocList<string, object>(new string[1]
      {
    ...
    public Future<AppPeer.SendMessage> MoveUnit(
      int unitPositionId,
      int row,
      int column)
    {
    ...
    public Future<AppPeer.SendMessage> UseCallSkill(
      int[] targetUnitPositionIds,
      int skillId)
    {
    ...
    public class Stat
    {
      ...
      public override string ToString() => "Stat(" + string.Format("stat={0}, ", this.stat != null ? (object) this.stat.ToString() : (object) "[null]") + ")";
    ...
    public class GameInitialize
    {
      ...
      public override string ToString() => "GameInitialize(" + string.Format("unitPositions={0}, ", this.unitPositions != null ? (object) this.unitPositions.ToString() : (object) "[null]") + ")";
    ...
    public class ActionUnit
    {
      ...
      public override string ToString() => "ActionUnit(" + string.Format("aiUnit={0}, ", this.aiUnit != null ? (object) this.aiUnit.ToString() : (object) "[null]") + string.Format("points={0}, ", this.points != null ? (object) this.points.ToString() : (object) "[null]") + string.Format("deadUnitRespawnCounts={0}, ", this.deadUnitRespawnCounts != null ? (object) this.deadUnitRespawnCounts.ToString() : (object) "[null]") + ")";
    ...
    public class WipedOut
    {
      ...
      public override string ToString() => "WipedOut(" + string.Format("isWipedOuts={0}, ", this.isWipedOuts != null ? (object) this.isWipedOuts.ToString() : (object) "[null]") + string.Format("points={0}, ", this.points != null ? (object) this.points.ToString() : (object) "[null]") + ")";
    ...
    public class FinishBattle
    {
      ...
      public override string ToString() => "FinishBattle(" + string.Format("victoryEffects={0}, ", this.victoryEffects != null ? (object) this.victoryEffects.ToString() : (object) "[null]") + ")";
    ...
    public class Recovery
    {
      ...
      public override string ToString() => "Recovery(" + string.Format("recovery={0}, ", this.recovery != null ? (object) this.recovery.ToString() : (object) "[null]") + ")";
    ...
    public class ActionCallSkill
    {
      ...
      public override string ToString() => "ActionCallSkill(" + string.Format("battleCallSkillResult={0}, ", this.battleCallSkillResult != null ? (object) this.battleCallSkillResult.ToString() : (object) "[null]") + string.Format("points={0}, ", this.points != null ? (object) this.points.ToString() : (object) "[null]") + string.Format("deadUnitRespawnCounts={0}, ", this.deadUnitRespawnCounts != null ? (object) this.deadUnitRespawnCounts.ToString() : (object) "[null]") + string.Format("callSkillPoints={0}, ", this.callSkillPoints != null ? (object) this.callSkillPoints.ToString() : (object) "[null]") + ")";
    ...
    public class SendMessage
    {
      ...
      public override string ToString() => string.Format("SendMessage(SendId={0}, Error={1})", (object) this.SendId, (object) this.Error);
