...
namespace Net
{
  public class MatchingPeer : Peer
  {
    ...
    public Future<MatchingPeer.ReceivedMessage> ReceiveType(
    ...
    public Future<MatchingPeer.SendMessage> SendNothrow(Func<Future<int>> send) => new Future<MatchingPeer.SendMessage>((Func<Promise<MatchingPeer.SendMessage>, IEnumerator>) (promise => this.SendNothrowE(send, promise)));
    ...
    public class Message
    {
      ...
      public override string ToString() => "Message(" + string.Format("title={0}, ", this.title != null ? (object) this.title.ToString() : (object) "[null]") + string.Format("message={0}, ", this.message != null ? (object) this.message.ToString() : (object) "[null]") + ")";
    ...
    public class MatchedConfirmation
    {
      ...
      public override string ToString() => "MatchedConfirmation(" + string.Format("player_id={0}, ", this.player_id != null ? (object) this.player_id.ToString() : (object) "[null]") + ")";
