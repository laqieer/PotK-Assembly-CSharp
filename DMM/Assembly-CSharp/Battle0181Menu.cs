...
public class Battle0181Menu : BackButtonMenuBase
{
    ...
    int enemyFirstAttack)
  {
    ...
    List<Future<UnityEngine.Sprite>> futures = new List<Future<UnityEngine.Sprite>>();
    if ((UnityEngine.Object) this.mDirColosseumSkillOwn_Prefab != (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.mDirColosseumSkillEnemy_Prefab != (UnityEngine.Object) null)
    {
      List<BL.Skill> skillList = new List<BL.Skill>();
    ...
    if (tweenPartsList.Count > 0)
    {
      if (futures.Count > 0)
      {
        IEnumerator e = futures.Sequence<UnityEngine.Sprite>().Wait();
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
      }
