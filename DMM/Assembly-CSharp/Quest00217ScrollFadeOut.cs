...
public class Quest00217ScrollFadeOut : MonoBehaviour
{
  ...
  private void Start()
  {
    Quest00217ScrollFadeOut.setWidget(this.gameObject, this.offsetDepth_);
    TweenAlpha.Begin(this.gameObject, this.duration_, 0.0f).SetOnFinished((EventDelegate.Callback) (() =>
    {
  ...
  {
    if ((Object) go.GetComponent<UIRect>() != (Object) null)
