...
public class Scroll0079 : MonoBehaviour
{
  ...
  public IEnumerator Init(Scroll0079Arg arg)
  {
    ...
    if (this.coinProduct.type == 2 || this.coinProduct.type == 6)
      this.iconLoupe.gameObject.SetActive(false);
    else
      this.iconLoupe.gameObject.SetActive(true);
  ...
  {
    Future<UnityEngine.Sprite> linkItemF = CoinProduct.LoadSpriteThumbnail(false, packIconResourceName);
  ...
  private void SetTextPack(string name, string description)
  {
    ...
    this.TxtPopupkisekinum.gameObject.SetActive(false);
  }
  ...
  {
    this.benefitsFirstLimited.gameObject.SetActive(false);
    this.benefitsMultibuy.gameObject.SetActive(false);
    this.benefitsOnceADay.gameObject.SetActive(false);
    this.benefitsBenefits.gameObject.SetActive(false);
    this.benefitsLimitedTime.gameObject.SetActive(false);
    switch (badgecategory)
    {
      case Badgecategory.First:
        this.benefitsFirstLimited.gameObject.SetActive(true);
        break;
      case Badgecategory.Multiple:
        this.benefitsMultibuy.gameObject.SetActive(true);
        break;
      case Badgecategory.OnedayFirst:
        this.benefitsOnceADay.gameObject.SetActive(true);
        break;
      case Badgecategory.Benefits:
        this.benefitsBenefits.gameObject.SetActive(true);
        break;
      case Badgecategory.Period:
        this.benefitsLimitedTime.gameObject.SetActive(true);
        break;
    }
  }
  ...
  public void OnItemDetailButton() => Singleton<NGSceneManager>.GetInstance().StartCoroutine(this.ShowItemDetailPopup());
