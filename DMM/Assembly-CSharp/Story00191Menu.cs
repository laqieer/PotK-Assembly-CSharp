...
public class Story00191Menu : BackButtonMenuBase
{
  ...
  public IEnumerator onInitSceneAsync()
  {
    ...
    if ((UnityEngine.Object) this.dataDeletePrefab == (UnityEngine.Object) null)
    {
  ...
  public void InitAsync() => this.LoginBonusMonthly.SetActive(SMManager.Get<Player>().IsLoginBonusMonthly());
  ...
  public void IbtnTitle() => this.modalWindow = ModalWindow.ShowYesNo(Consts.GetInstance().titleback_title, Consts.GetInstance().titleback_text, (System.Action) (() => StartScript.Restart()), (System.Action) (() => this.DeleteModalWindow())).gameObject;

  private void DeleteModalWindow() => UnityEngine.Object.Destroy((UnityEngine.Object) this.modalWindow);
  ...
  public void IbtnBeginnerNavi() => Singleton<NGSceneManager>.GetInstance().changeScene("help015_5", true);
  ...
  private IEnumerator bulkDownLoadCheck()
  {
    ...
    if (requiredSize > 0L)
    {
      ...
      PopupCommonYesNo.Show(instance.bulk_download_title, instance.bulkDownloadText(requiredSize), new System.Action(story00191Menu.\u003CbulkDownLoadCheck\u003Eb__41_0), (System.Action) (() => {}));
    }
    else
