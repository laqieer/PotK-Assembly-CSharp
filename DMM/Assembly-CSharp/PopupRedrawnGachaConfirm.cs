...
public class PopupRedrawnGachaConfirm : BackButtonMonoBehaiviour
{
    ...
    DateTime? expired_at = null)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    if ((UnityEngine.Object) redrawnGachaConfirm.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      redrawnGachaConfirm.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    if (nullable.HasValue)
    {
      ...
      {
        redrawnGachaConfirm.txt_remain_time.gameObject.SetActive(false);
        ...
        redrawnGachaConfirm.ibtn_redrawn.isEnabled = false;
      }
  ...
  public IEnumerator UpdateRemainTime()
  {
    if (this.expiredAt.HasValue)
    {
      ...
      this.txt_remain_time.gameObject.SetActive(false);
      ...
      this.ibtn_redrawn.isEnabled = false;
    }
  }
