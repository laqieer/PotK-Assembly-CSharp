...
public class Unit004ExtraskillInfo : MonoBehaviour
{
    ...
    bool isSelectUnit = true)
  {
    ...
    IEnumerator e = unit004ExtraskillInfo.extraSkillInfo.Init(invSkill.skill, invSkill.favorite, menu.SpriteCache(invSkill.skill.masterData), menu.SkillGenrePrefab, new System.Action<bool>(unit004ExtraskillInfo.chageFavorite));
    while (e.MoveNext())
    ...
    unitIconScript.onClick = (System.Action<UnitIconBase>) (ui => menu.changeSceneExtraSkillEquipment(invSkill.equipUnit, invSkill.skill));
    if ((UnityEngine.Object) unit004ExtraskillInfo.skillDetailPrefab == (UnityEngine.Object) null)
    {
  ...
  public void chageFavorite(bool favorite) => this.menuInstanc.changeExtraSkillFavorite(this.inventorySkill, favorite);

  public void setEnableIbtnDecision(bool isEnable)
  {
    this.btnDecision.isEnabled = isEnable;
    this.slcBtnDecisionText.color = isEnable ? Color.white : Color.gray;
  }
  ...
  {
    if (this.inventorySkill == null || (UnityEngine.Object) this.skillDetailPrefab == (UnityEngine.Object) null)
      return;
    PopupSkillDetails.show(this.skillDetailPrefab, PopupSkillDetails.Param.createBySkillView(this.inventorySkill.skill));
  }

  public void setEnableFavoriteSwitch(bool bEnabled) => this.extraSkillInfo.setEnableFavoriteSwitch(bEnabled);
}
