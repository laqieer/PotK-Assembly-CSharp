...
public class Unit0046Scene : NGSceneBase
{
  ...
  public void onStartScene(Unit0046Scene.From fromScene) => Singleton<CommonRoot>.GetInstance().isLoading = false;

  public void onStartScene(ColosseumUtility.Info colosseumInfo) => this.onStartScene(Unit0046Scene.From.Colosseum);
