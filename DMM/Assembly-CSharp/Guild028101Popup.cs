...
public class Guild028101Popup : BackButtonMenuBase
{
  ...
  private void Init(GuildSetting guildsetting)
  {
    ...
    ((IEnumerable<GuildAtmosphere>) MasterData.GuildAtmosphereList).ForEach<GuildAtmosphere>((System.Action<GuildAtmosphere>) (x => this.atmosphereList.items.Add(x.name)));
    ...
    ((IEnumerable<GuildApprovalPolicy>) MasterData.GuildApprovalPolicyList).ForEach<GuildApprovalPolicy>((System.Action<GuildApprovalPolicy>) (x => this.approvalList.items.Add(x.name)));
    ...
    ((IEnumerable<GuildAutoApproval>) MasterData.GuildAutoApprovalList).ForEach<GuildAutoApproval>((System.Action<GuildAutoApproval>) (x => this.autoApprovalList.items.Add(x.name)));
    ...
    ((IEnumerable<GuildAvailability>) MasterData.GuildAvailabilityList).ForEach<GuildAvailability>((System.Action<GuildAvailability>) (x => this.availabilityList.items.Add(x.name)));
    ...
    ((IEnumerable<GuildAutokick>) MasterData.GuildAutokickList).ForEach<GuildAutokick>((System.Action<GuildAutokick>) (x => this.autokickList.items.Add(x.name)));
  ...
  public void onButtonSerch()
  {
    ...
    switch (this.aMenu)
    {
      case GuildUtil.MenuType.menu2811:
        ...
        this.StartCoroutine(this.menu2811.SearchGuild(new System.Action(this.menu2811.DrawGuildList)));
        break;
      case GuildUtil.MenuType.menu2812:
        this.menu2812.Setting(data);
        Singleton<PopupManager>.GetInstance().dismiss();
        this.StartCoroutine(this.menu2812.SearchGuild(new System.Action(this.menu2812.DrawGuildList)));
        break;
    }
  }
  ...
  public void onButtonBest()
  {
    ...
    {
      case GuildUtil.MenuType.menu2811:
        this.StartCoroutine(this.menu2811.SearchBestGuild(new System.Action(this.menu2811.DrawGuildList)));
        break;
      case GuildUtil.MenuType.menu2812:
        this.StartCoroutine(this.menu2812.SearchBestGuild(new System.Action(this.menu2812.DrawGuildList)));
        break;
    }
  }
