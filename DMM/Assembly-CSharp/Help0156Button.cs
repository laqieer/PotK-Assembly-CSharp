...
public class Help0156Button : MonoBehaviour
{
  ...
  private UnityEngine.Sprite descSprite;
  ...
  public IEnumerator setTitleText(BeginnerNaviTitle bnTitle)
  {
    ...
    {
      Future<UnityEngine.Sprite> textureF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("BeginnerNavi/" + bnDetail.descriptionImage);
      e = textureF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      this.descSprite = textureF.Result;
      textureF = (Future<UnityEngine.Sprite>) null;
    }
