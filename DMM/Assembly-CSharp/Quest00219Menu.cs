...
public class Quest00219Menu : BackButtonMenuBase
{
  ...
  protected void ChangeScene00220(PlayerExtraQuestS extra, GameObject obj, bool Guerrilla = false) => this.StartCoroutine(this.QuestTimeCompare(extra, obj, (System.Action) (() =>
  {
  ...
  private void changeScene002201(PlayerExtraQuestS extra, GameObject obj) => this.StartCoroutine(this.QuestTimeCompare(extra, obj, (System.Action) (() =>
  {
    QuestExtraS questExtraS = extra.quest_extra_s;
