...
public class EffectControllerPrincessAwake : EffectControllerPrincessEvolutionBase
{
  ...
  public override IEnumerator Initialize(PrincesEvolutionParam param, GameObject backBtn)
  {
    ...
    {
      Future<UnityEngine.Sprite> loader = param.baseUnit.unit.LoadFullSprite();
      ...
      controllerPrincessAwake.unitEffectBefore.sprite2D = UnityEngine.Sprite.Create(glowBorderTexture1, new Rect(0.0f, 0.0f, (float) glowBorderTexture1.width, (float) glowBorderTexture1.height), new Vector2(0.5f, 0.5f), 100f, 0U, SpriteMeshType.FullRect);
      ...
      controllerPrincessAwake.unitEffectAfter.sprite2D = UnityEngine.Sprite.Create(glowBorderTexture2, new Rect(0.0f, 0.0f, (float) glowBorderTexture2.width, (float) glowBorderTexture2.height), new Vector2(0.5f, 0.5f), 100f, 0U, SpriteMeshType.FullRect);
      ...
      Rect clipRegion1 = new Rect((float) unitAwakeningEffect1.x, (float) unitAwakeningEffect1.y, (float) unitAwakeningEffect1.width, (float) unitAwakeningEffect1.height);
      ...
      controllerPrincessAwake.unitBlack.sprite2D = UnityEngine.Sprite.Create(blackOrGodTexture1, new Rect(0.0f, 0.0f, (float) blackOrGodTexture1.width, (float) blackOrGodTexture1.height), new Vector2(0.5f, 0.5f));
      ...
      Rect clipRegion2 = new Rect((float) unitAwakeningEffect2.x, (float) unitAwakeningEffect2.y, (float) unitAwakeningEffect2.width, (float) unitAwakeningEffect2.height);
      Color mainColor = new Color(unitAwakeningEffect2.god_color_r, unitAwakeningEffect2.god_color_g, unitAwakeningEffect2.god_color_b);
      ...
      controllerPrincessAwake.unitGod.sprite2D = UnityEngine.Sprite.Create(blackOrGodTexture2, new Rect(0.0f, 0.0f, (float) blackOrGodTexture2.width, (float) blackOrGodTexture2.height), new Vector2(0.5f, 0.5f));
    ...
    controllerPrincessAwake.back_button_.GetComponent<BoxCollider>().enabled = false;
    controllerPrincessAwake.back_button_.GetComponent<UIButton>().enabled = false;
  ...
  {
    if ((Object) this.back_button_ != (Object) null)
    {
      this.back_button_.SetActive(true);
      this.back_button_.GetComponent<BoxCollider>().enabled = true;
      this.back_button_.GetComponent<UIButton>().enabled = true;
    }
