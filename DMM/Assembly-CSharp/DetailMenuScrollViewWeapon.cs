...
public class DetailMenuScrollViewWeapon : DetailMenuScrollViewBase
{
    ...
    GameObject[] prefabs)
  {
    ...
    if (scrollViewWeapon.showSkillDialog == null)
    {
      ...
      if ((UnityEngine.Object) scrollViewWeapon.floatingSkillDialogObject == (UnityEngine.Object) null)
      ...
      scrollViewWeapon.floatingSkillDialogObject.transform.parent.gameObject.SetActive(false);
      // ISSUE: reference to a compiler-generated method
      scrollViewWeapon.showSkillDialog = new System.Action<BattleskillSkill>(scrollViewWeapon.\u003CinitAsync\u003Eb__27_0);
      // ISSUE: reference to a compiler-generated method
      scrollViewWeapon.showSkillLevel = new System.Action<int, int>(scrollViewWeapon.\u003CinitAsync\u003Eb__27_1);
    }
    if (gear2 == null)
    {
  ...
  {
    if ((UnityEngine.Object) _gearKindIconObject == (UnityEngine.Object) null)
    {
      _gearKindIconObject = _weaponIconPrefab.Clone(_dynWeaponType.transform);
      _gearKindIconObject.GetComponent<UI2DSprite>().depth = _dynWeaponType.depth + 1;
    }
    _gearKindIconObject.GetComponent<GearKindIcon>().Init(gear.kind, element);
    UIButton component = _dynWeaponType.transform.parent.gameObject.GetComponent<UIButton>();
    ...
    UI2DSprite[] _dynMagicElementTypes)
  {
    ...
    foreach (PlayerUnitSkills playerUnitSkills in skills)
    {
      ...
      if (masterSkill.skill_type == BattleskillSkillType.magic)
      {
        if (index < _txtMagicNames.Length)
        {
          ...
          _txtMagicRanges[index].gameObject.SetActive(true);
          _txtMagicCosts[index].SetTextLocalize(consumeHp);
          _txtMagicCosts[index].gameObject.SetActive(true);
          _dynMagicElementTypes[index].gameObject.SetActive(true);
          if ((UnityEngine.Object) this.magicElemmentObject[index] == (UnityEngine.Object) null)
            this.magicElemmentObject[index] = this.createIcon(_magicElementPrefab, _dynMagicElementTypes[index].transform);
          ...
          this.magicButtons[index] = _txtMagicNames[index].transform.parent.gameObject.GetComponent<UIButton>();
          this.magicButtons[index].GetComponent<Collider>().enabled = true;
          this.magicButtons[index].enabled = true;
    ...
    for (; index < _txtMagicNames.Length; ++index)
    {
      ...
      _txtMagicRanges[index].gameObject.SetActive(false);
      _txtMagicCosts[index].gameObject.SetActive(false);
      _dynMagicElementTypes[index].gameObject.SetActive(false);
    }
  }
