...
namespace Earth
{
  ...
  public class EarthQuestProgress : BL.ModelBase
  {
    ...
    public EarthQuestEpisode currentEpisode => ((IEnumerable<EarthQuestEpisode>) MasterData.EarthQuestEpisodeList).Where<EarthQuestEpisode>((Func<EarthQuestEpisode, bool>) (x => x.stage_index == this.mCurrentStageIndex)).FirstOrDefault<EarthQuestEpisode>();

    public List<EarthForcedSortieCharacter> forcedSortieCharacters => ((IEnumerable<EarthForcedSortieCharacter>) MasterData.EarthForcedSortieCharacterList).Where<EarthForcedSortieCharacter>((Func<EarthForcedSortieCharacter, bool>) (x => x.episode.ID == this.currentEpisode.ID)).ToList<EarthForcedSortieCharacter>();

    public int forcedSortieCharacterMaxPosition => this.forcedSortieCharacters.Count > 0 ? this.forcedSortieCharacters.Max<EarthForcedSortieCharacter>((Func<EarthForcedSortieCharacter, int>) (x => x.sortie_position)) : 1;

    public List<EarthImpossibleOFSortieCharacter> impossibleOfSortieCharacter => ((IEnumerable<EarthImpossibleOFSortieCharacter>) MasterData.EarthImpossibleOFSortieCharacterList).Where<EarthImpossibleOFSortieCharacter>((Func<EarthImpossibleOFSortieCharacter, bool>) (x => x.episode.ID == this.currentEpisode.ID)).ToList<EarthImpossibleOFSortieCharacter>();
    ...
    public bool isPrologue => this.mPrologueIndex <= ((IEnumerable<EarthQuestPologue>) MasterData.EarthQuestPologueList).Max<EarthQuestPologue>((Func<EarthQuestPologue, int>) (x => x.number));
    ...
    public EarthQuestPologue GetPrologueData() => ((IEnumerable<EarthQuestPologue>) MasterData.EarthQuestPologueList).FirstOrDefault<EarthQuestPologue>((Func<EarthQuestPologue, bool>) (x => x.number == this.mPrologueIndex));
    ...
    public bool isImpossibleOfSortie(int character_id) => this.impossibleOfSortieCharacter.Any<EarthImpossibleOFSortieCharacter>((Func<EarthImpossibleOFSortieCharacter, bool>) (x => x.character_id == character_id));

    public string GetSeverString() => string.Format(EarthQuestProgress.serverDataFormat, (object) this.mCurrentStageIndex, (object) (this.mIsCleared ? 1 : 0), (object) (this.mIsRead ? 1 : 0), (object) this.mPrologueIndex);
      ...
      System.Action nextStageOpenCallback)
    {
      ...
      progress.mIsCleared = (uint) (int) (long) json["is_clear"] > 0U;
      if (json.ContainsKey("is_read"))
        progress.mIsRead = (uint) (int) (long) json["is_read"] > 0U;
