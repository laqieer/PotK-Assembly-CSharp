...
namespace Earth
{
  ...
  public class EarthCharacterIntimate : BL.ModelBase
  {
    ...
    public static EarthCharacterIntimate Create(
      int characterID1,
      int characterID2)
    {
    ...
    public string GetSeverString() => string.Format(EarthCharacterIntimate.serverDataFormat, (object) this.mCharacterID1, (object) this.mCharacterID2, (object) this.mExperience);

    public static EarthCharacterIntimate JsonLoad(
