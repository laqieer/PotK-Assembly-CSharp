...
namespace Earth
{
  ...
  public class EarthCharacter : BL.ModelBase
  {
    ...
    private int CalcUpParamter(float growth) => (double) UnityEngine.Random.value >= (double) Mathf.Min(0.95f, growth) ? 0 : 1;
    ...
    public static EarthCharacter JsonLoad(Dictionary<string, object> json)
    {
      ...
      earthCharacter.mIsFall = (uint) (int) (long) json["is_fall"] > 0U;
      ...
      if (json.ContainsKey("is_desert"))
        earthCharacter.mIsDesert = (uint) (int) (long) json["is_desert"] > 0U;
