...
namespace Earth
{
  ...
  public class EarthGear : BL.ModelBase
  {
    ...
    public static EarthGear Create(int gearID) => new EarthGear()
    {
    ...
    public string GetSeverString() => string.Format(EarthGear.serverDataFormat, (object) this.mID, (object) this.mItemID, (object) this.mExperience, (object) (this.mIsFavorite ? 1 : 0), (object) (this.mIsLost ? 1 : 0));

    public static EarthGear JsonLoad(Dictionary<string, object> json) => new EarthGear()
    {
      mID = (int) (long) json["id"],
      mItemID = (int) (long) json["gear_id"],
      mExperience = (int) (long) json["experience"],
      mIsFavorite = (uint) (int) (long) json["favorite"] > 0U,
      mIsLost = json.ContainsKey("is_lost") && (uint) (int) (long) json["is_lost"] > 0U
    };
  }
}
