...
public class BattlePrepareCharacterInfoPlayer : BattlePrepareCharacterInfoBase
{
    ...
    BattleUI04Menu baseMenu)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) characterInfoPlayer.mDotContainer != (UnityEngine.Object) null)
      {
  ...
  private void setIndicatorVisible() => this.indicator.gameObject.GetComponent<TweenAlpha>().PlayForward();
