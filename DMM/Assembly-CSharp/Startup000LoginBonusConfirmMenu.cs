...
public class Startup000LoginBonusConfirmMenu : BackButtonMenuBase
{
    ...
    bool gray = false)
  {
    ...
    UIButton component1 = thum.GetComponent<UIButton>();
  ...
  public IEnumerator Init(WebAPI.Response.LoginbonusTop loginBonus)
  {
    ...
    if ((UnityEngine.Object) this.finishStampGameObject == (UnityEngine.Object) null)
    {
    ...
    for (int index = 0; index < num2; ++index)
      this.finishStampGameObject.Clone(this.dirThumList[index].transform).transform.localPosition = new Vector3(0.0f, 5f, 0.0f);
