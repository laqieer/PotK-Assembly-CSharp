...
public class AnimationItemIcon : MonoBehaviour
{
  ...
  public void SetBroken(bool flag) => this.break_.gameObject.SetActive(flag);

  public void SetFavorite(bool flag) => this.favorite_.gameObject.SetActive(flag);

  public void SetNew(bool flag) => this.new_.gameObject.SetActive(flag);

  private UnityEngine.Sprite GetGearTypeIcon(GearKindEnum kind, CommonElement element) => Resources.Load<UnityEngine.Sprite>(string.Format("Icons/Materials/GearKind_Element_Icon/slc_{0}_{1}_34_30", (object) kind.ToString(), (object) element.ToString()));

  public void SetType(GearKind kind, CommonElement element)
  {
    if (kind.isEquip)
    {
      this.type_.gameObject.SetActive(true);
    ...
    {
      this.type_.gameObject.SetActive(false);
  ...
  public void SetRank(int id)
  {
    ...
    {
      this.rank_.gameObject.SetActive(false);
    }
    else
    {
      this.rank_.gameObject.SetActive(true);
  ...
  {
    this.frame_.gameObject.SetActive(true);
  ...
  public void SetSimpleMode()
  {
    ...
    this.rank_.gameObject.SetActive(false);
    this.SetNew(false);
    this.frame_.gameObject.SetActive(false);
