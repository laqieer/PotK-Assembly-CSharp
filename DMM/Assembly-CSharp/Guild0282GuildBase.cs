...
public class Guild0282GuildBase : MonoBehaviour
{
    ...
    GameObject levelupAnimObj = null)
  {
    ...
    if (!((UnityEngine.Object) levelupAnimObj != (UnityEngine.Object) null))
      return;
    if ((UnityEngine.Object) this.levelupAnim != (UnityEngine.Object) null)
      UnityEngine.Object.Destroy((UnityEngine.Object) this.levelupAnim.gameObject);
  ...
  public void AdjustRootPositionByFortress(Vector3 basePos)
  {
    ...
    float num1 = (float) ((446.0 - (double) texture.width) * 0.25);
    float num2 = (float) ((470.0 - (double) texture.height) * 0.5);
    ...
    List<GameObject> animList)
  {
    ...
    {
      target.GetComponent<UI2DSprite>().SetDimensions(sprite.texture.width, sprite.texture.height);
