...
public class Quest002SideStoryScene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene(Quest002SideStoryScene.DefaultSceneName, stack);

  public static void ChangeScene(bool stack, int activeTabIndex) => Singleton<NGSceneManager>.GetInstance().changeScene(Quest002SideStoryScene.DefaultSceneName, (stack ? 1 : 0) != 0, (object) activeTabIndex);
