...
public class Quest0022Hscroll : QuestHScrollButton
{
    ...
    EventDelegate.Callback onLongPressed)
  {
    ...
    StageAvailibilityCheckHelper stageCheckHelper = quest0022Hscroll.gameObject.GetOrAddComponent<StageAvailibilityCheckHelper>();
    EventDelegate.Set(quest0022Hscroll.StageButton.onClick, (EventDelegate.Callback) (() =>
    {
      ...
      this.StartCoroutine(stageCheckHelper.PopupJudge(StageData, (System.Action<System.Action>) (endWait =>
      {
        act();
        if (endWait == null)
          return;
        endWait();
      }), (System.Action<PopupUtility.SceneTo>) null, eventquest, storyOnly));
    }));
