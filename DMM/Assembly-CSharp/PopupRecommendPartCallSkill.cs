...
public class PopupRecommendPartCallSkill : PopupRecommendPart
{
  ...
  public override IEnumerator doInitialize(PlayerUnit playerUnit, UnitUnit target)
  {
    ...
    if (callChara != null)
    {
      ...
      if ((Object) this.popupCallSkillDetailsPrefab == (Object) null)
      {
      ...
      if ((Object) this.genrePrefab == (Object) null)
      {
      ...
      this.genre1.gameObject.SetActive(genre1.HasValue);
      if (genre1.HasValue)
      {
        SkillGenreIcon component = this.genrePrefab.Clone(this.genre1).GetComponent<SkillGenreIcon>();
        component.Init(genre1);
        component.iconSprite.depth = this.genreDepth;
      }
      this.genre2.gameObject.SetActive(genre2.HasValue);
      if (genre2.HasValue)
      {
