...
public class CorpsQuestManualScene : NGSceneBase
{
  ...
  public static void ChangeScene(CorpsSetting setting) => Singleton<NGSceneManager>.GetInstance().changeScene("CorpsQuest_manual", true, (object) setting);
  ...
  public void onStartScene(CorpsSetting setting) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
