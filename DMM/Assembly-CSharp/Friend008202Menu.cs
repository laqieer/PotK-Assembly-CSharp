...
public class Friend008202Menu : BackButtonMenuBase
{
  ...
  public void SetAcceptNumMessage(int num) => this.txtDescription1.SetTextLocalize(Consts.Format(Consts.GetInstance().FRIEND_008202_MENU, (IDictionary) new Hashtable()
  {
    {
      (object) nameof (num),
      (object) num.ToString()
