...
public class Quest00217ScrollCorps : Quest00217Scroll
{
  ...
  public new void Setup(Quest00217Scroll.Parameter param, DateTime serverTime)
  {
    ...
    this.New.gameObject.SetActive(param.isNew);
    this.Clear.gameObject.SetActive(param.isClear);
  ...
  protected override void setQuestLockText() => this.txtLock.SetTextLocalize(MasterData.CorpsEntryConditions[this.initData.entryConditionID].text);
}
