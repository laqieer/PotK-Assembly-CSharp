...
public class Guild0285Scroll : MonoBehaviour
{
  ...
  public IEnumerator SetUnitIcon()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) guild0285Scroll.unitIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if (guild0285Scroll.applicantInfo != null)
    {
      ...
      if ((UnityEngine.Object) guild0285Scroll.unitIcon == (UnityEngine.Object) null)
        guild0285Scroll.unitIcon = guild0285Scroll.unitIconPrefab.CloneAndGetComponent<UnitIcon>(guild0285Scroll.playerImage.gameObject);
      // ISSUE: reference to a compiler-generated method
      guild0285Scroll.unitIcon.onClick = new System.Action<UnitIconBase>(guild0285Scroll.\u003CSetUnitIcon\u003Eb__15_0);
    ...
    Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadEmblemSprite(guild0285Scroll.applicantInfo.player.player_emblem_id);
    e = sprF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public void onDetails(GuildPlayerInfo playerInfo, int playerUnitID) => Unit0042Scene.changeSceneFriendUnit(true, playerInfo.player_id, playerUnitID);
  ...
  private IEnumerator Accept()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = guild0285Scroll.menu.Accept(guild0285Scroll.player_ids.ToArray(), new System.Action(guild0285Scroll.\u003CAccept\u003Eb__19_0), new System.Action<WebAPI.Response.UserError>(guild0285Scroll.\u003CAccept\u003Eb__19_1));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator Refuse()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = guild0285Scroll.menu.Refuse(guild0285Scroll.player_ids.ToArray(), new System.Action(guild0285Scroll.\u003CRefuse\u003Eb__21_0), new System.Action<WebAPI.Response.UserError>(guild0285Scroll.\u003CRefuse\u003Eb__21_1));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
