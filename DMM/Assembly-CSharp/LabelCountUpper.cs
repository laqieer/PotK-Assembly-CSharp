...
public class LabelCountUpper : MonoBehaviour
{
  ...
  public void StartCountup(System.Action onEndCallback = null) => this.StartCoroutine(this.Countup(onEndCallback));

  public void Skip() => this.mNeedSkip = true;

  private IEnumerator Countup(System.Action onEndCallback = null)
  {
    this.isAnime = true;
    do
    {
