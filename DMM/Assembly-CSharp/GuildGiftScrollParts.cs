...
public class GuildGiftScrollParts : MonoBehaviour
{
  ...
  {
    this.gift = data;
    if ((UnityEngine.Object) this.LimitTimeLabel != (UnityEngine.Object) null)
    {
    ...
    Future<UnityEngine.Sprite> emblem = EmblemUtility.LoadEmblemSprite(data.player.player_emblem_id);
    ...
    if ((UnityEngine.Object) this.itemIcon.GetIcon() != (UnityEngine.Object) null)
      UnityEngine.Object.Destroy((UnityEngine.Object) this.itemIcon.GetIcon());
    ...
    switch (data.gift_reward_type_id)
    {
      ...
      case 35:
        ...
        break;
      default:
        if ((UnityEngine.Object) this.itemIcon.GetIcon().GetComponent<UnitIcon>() != (UnityEngine.Object) null)
        {
        ...
        if ((UnityEngine.Object) this.itemIcon.GetIcon().GetComponent<ItemIcon>() != (UnityEngine.Object) null)
        {
        ...
        if ((UnityEngine.Object) this.itemIcon.GetIcon().GetComponent<UniqueIcons>() != (UnityEngine.Object) null)
        {
  ...
  public void FriendDetailScene(GuildMemberGift data) => Unit0042Scene.changeSceneFriendUnit(true, data.player.player_id, 0);
}
