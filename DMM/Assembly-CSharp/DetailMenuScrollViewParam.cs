...
public class DetailMenuScrollViewParam : DetailMenuScrollViewBase
{
  ...
  private DetailMenuOverkillersSlots overkillersSlots => !((UnityEngine.Object) this.overkillersSlots_ != (UnityEngine.Object) null) ? (this.overkillersSlots_ = this.GetComponent<DetailMenuOverkillersSlots>()) : this.overkillersSlots_;
  ...
  private IEnumerator LoadSkillIcon(
    ...
    bool isGray)
  {
    Future<UnityEngine.Sprite> spriteF = skill.LoadBattleSkillIcon();
    ...
    GameObject[] prefabs)
  {
    ...
    if ((bool) (UnityEngine.Object) menuScrollViewParam.overkillersSlots)
    {
    ...
    if ((bool) (UnityEngine.Object) menuScrollViewParam.IbtnIntimacy)
      menuScrollViewParam.IbtnIntimacy.isEnabled = flag3;
    if ((bool) (UnityEngine.Object) menuScrollViewParam.IbtnUnitTraining)
      menuScrollViewParam.IbtnUnitTraining.isEnabled = flag2;
    if ((bool) (UnityEngine.Object) menuScrollViewParam.IbtnUnitQuest)
      menuScrollViewParam.IbtnUnitQuest.isEnabled = flag4;
    menuScrollViewParam.levelDetailPrefab = prefabs.Length > 7 ? prefabs[7] : (GameObject) null;
    menuScrollViewParam.isXLevelLimited = true;
    if ((UnityEngine.Object) menuScrollViewParam.dirLvDetail != (UnityEngine.Object) null)
    {
      ...
      if ((UnityEngine.Object) menuScrollViewParam.levelDetailPrefab == (UnityEngine.Object) null | flag5 | flag1)
  ...
  public override bool Init(PlayerUnit playerUnit, PlayerUnit baseUnit)
  {
    ...
    if (n > max)
      n = max;
    if ((bool) (UnityEngine.Object) this.lvGauge)
    ...
    if (flag)
    {
      OverkillersParameter overkillersParameter = (object) baseUnit != null ? baseUnit.getOverkillersParameter(playerUnit) : (OverkillersParameter) null;
...
label_23:
  ...
  private void setTextOverkillersParameter(UILabel label, int percentage) => label.text = "x" + OverkillersParameter.toStringPercentage(percentage) + "%";

  private OverkillersSkillRelease getOverkillersSkill() => this.isMine(this.playerUnit) ? this.playerUnit.overkillersSkill : (OverkillersSkillRelease) null;
  ...
  private void setParamUnity(PlayerUnit playerUnit)
  {
    ...
    if ((bool) (UnityEngine.Object) this.gauge_Unity)
    ...
    if (this.isMine(playerUnit) && this.controlFlags.IsOff(Control.OverkillersUnit | Control.CustomDeck))
    {
      ...
      this.popupUnityDetail = (System.Action<GameObject[], NGMenuBase>) ((prefabs, menu) =>
      {
        if (prefabs == null)
          return;
        if (bUpdateUnit)
        {
          PlayerUnit playerUnit1 = Array.Find<PlayerUnit>(SMManager.Get<PlayerUnit[]>(), closure_0 ?? (closure_0 = (Predicate<PlayerUnit>) (x => x.id == playerUnit.id)));
        ...
        PopupUnityValueDetail.show(prefabs[0], prefabs[1], (float) playerUnit.unity_value, playerUnit.buildup_unity_value_f, playerUnit, (System.Action<System.Action>) (endWait =>
        {
          bUpdateUnit = true;
          ...
          if ((UnityEngine.Object) sceneBase == (UnityEngine.Object) null)
            return;
          string sceneName = sceneBase.sceneName;
        ...
        }), (System.Action<PopupUtility.SceneTo>) (_ => {}), bDisabledSelect.Value);
      });
    }
    else
      this.popupUnityDetail = (System.Action<GameObject[], NGMenuBase>) null;
    if (!((UnityEngine.Object) this.btnUnityDetail != (UnityEngine.Object) null))
      return;
    this.btnUnityDetail.SetActive(this.popupUnityDetail != null);
  }

  private bool isDisabledQuestSelect => this.playerUnit.is_storage || this.controlFlags.IsAnyOn(Control.Limited | Control.ToutaPlusNoEnable) || DetailMenuScrollViewParam.checkDisableQuestSelect();
  ...
  public static bool checkDisableQuestSelect()
  {
    ...
    if (sceneName == "unit004_2" || sceneName == "unit004_JobChange")
    ...
    return !(sceneName == "unit004_2_sea") || instance.isMatchSceneNameInStack("^quest002_8_sea$");
  }
  ...
  private bool isMine(PlayerUnit unit) => !unit.is_enemy && !unit.is_guest && Player.Current.id == unit.player_id;
  ...
  public void onClickExtraSKill()
  {
    ...
    if (awakeSkills == null || awakeSkills.Length == 0)
      return;
    bool bDisabledStatus = !(bool) (UnityEngine.Object) this.txtDearDegree && !(bool) (UnityEngine.Object) this.txtDearDegreeMax;
  ...
  public void onClicedUnity()
  {
    ...
    if (popupUnityDetail == null)
      return;
    popupUnityDetail(this.unityDetailPrefabs, (NGMenuBase) NGUITools.FindInParents<Unit0042Menu>(this.gameObject));
  }

  public void onClickedTabEquipment() => this.onClickedTab(DetailMenuScrollViewParam.TabMode.Equipment);

  public void onClickedTabOverkillers() => this.onClickedTab(DetailMenuScrollViewParam.TabMode.Overkillers);
  ...
  {
    if ((UnityEngine.Object) this.levelDetailPrefab == (UnityEngine.Object) null)
      return;
    PopupXLevelDetail.show(this.levelDetailPrefab, this.isXLevelLimited, this.playerUnit, new System.Action<PlayerUnit>(this.updateUnit), (System.Action<PlayerUnit>) (resultReincarnation => {}));
  }
  ...
  private IEnumerator doUpdateUnit()
  {
    ...
    Unit0042Menu menu = NGUITools.FindInParents<Unit0042Menu>(menuScrollViewParam.gameObject);
  ...
  public void IbtnBuguLock2()
  {
    ...
    if (!((UnityEngine.Object) inParents != (UnityEngine.Object) null))
      return;
    PopupBuguSlotRelease.show(inParents.buguReleaseDialogPrefab, this.targetUnit, this, (System.Action) (() => this.StartCoroutine(this.doUnlockBugu(0))));
  }
  ...
  public void IbtnBuguLock3()
  {
    ...
    if (!((UnityEngine.Object) inParents != (UnityEngine.Object) null))
      return;
    PopupBuguSlotRelease.show(inParents.buguReleaseDialogPrefab, this.targetUnit, this, (System.Action) (() => this.StartCoroutine(this.doUnlockBugu(1))));
  }
  ...
  private IEnumerator doUnlockBugu(int no)
  {
    ...
    Unit0042Menu inParents = NGUITools.FindInParents<Unit0042Menu>(menuScrollViewParam.gameObject);
    if ((UnityEngine.Object) inParents != (UnityEngine.Object) null)
    {
      bool bWait = true;
    ...
    IEnumerator e = WebAPI.UnitOpenGearEquipNumber(menuScrollViewParam.targetUnit.id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
    ...
    menuScrollViewParam.BuguReleaseAnimator[no].startUnlock((System.Action) (() => this.onFinishedEffectUnlock(no)));
    yield return (object) null;
  }
