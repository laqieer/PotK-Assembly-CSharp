...
public class GaugeRunner
{
  ...
  public static IEnumerator Run(GaugeRunner runner) => GaugeRunner.Run(new GaugeRunner[1]
  {
    runner
  });
    ...
    float duration = 0.6f)
  {
    ...
    this.count = 0;
    UnityEngine.Object.Destroy((UnityEngine.Object) obj.GetComponent<TweenScale>());
  }
  ...
  private float to()
  {
    ...
    return (UnityEngine.Object) component == (UnityEngine.Object) null ? 0.0f : component.to.x;
  }
  ...
  private IEnumerator Run(float from, float to)
  {
    ...
    tween.delay = 0.0f;
    tween.duration = Mathf.Abs(tween.to.x - tween.from.x) * this.duration;
    tween.PlayForward();
    while (tween.enabled)
    {
      if (this.skipDirty)
    ...
    UnityEngine.Object.Destroy((UnityEngine.Object) tween);
  }
