...
public class PopupSkillDetails : BackButtonPopupBase
{
  ...
  private System.Action onClosed_;
  private int center_;
  ...
  public static Future<GameObject> createPrefabLoader(bool isSea) => new ResourceObject(isSea ? "Prefabs/UnitGUIs/PopupSkillDetailsSea" : "Prefabs/UnitGUIs/PopupSkillDetails").Load<GameObject>();
  ...
  private UIPanel parentPanel => !((UnityEngine.Object) this.parentPanel_ != (UnityEngine.Object) null) ? (this.parentPanel_ = this.transform.parent.GetComponent<UIPanel>()) : this.parentPanel_;

  private int cellWidth => !this.cellWidth_.HasValue ? (this.cellWidth_ = new int?(Mathf.CeilToInt(this.parentPanel.width))).Value : this.cellWidth_.Value;
  ...
  private Dictionary<UnitParameter.SkillGroup, string> dicTitle => this.dicTitle_ ?? (this.dicTitle_ = ((IEnumerable<PopupSkillDetails.TitleTable>) this.titles_).ToDictionary<PopupSkillDetails.TitleTable, UnitParameter.SkillGroup, string>((Func<PopupSkillDetails.TitleTable, UnitParameter.SkillGroup>) (k => k.group), (Func<PopupSkillDetails.TitleTable, string>) (v => v.name)));
  ...
  private void preInitialize() => this.setTopObject(this.gameObject);
  ...
  private IEnumerator Start()
  {
    ...
    while (popupSkillDetails.caches_[popupSkillDetails.current_].initiailze)
      yield return (object) null;
    Singleton<PopupManager>.GetInstance().startOpenAnime(popupSkillDetails.gameObject);
  }
  ...
  private void initializeDetails()
  {
    ...
    if (this.scroll_.enabled)
    {
      ...
      while (index1 <= num)
      {
        ...
        GameObject gameObject2 = this.details_[index2].gameObject;
      ...
      foreach (PopupSkillDetail detail in (IEnumerable<PopupSkillDetail>) ((IEnumerable<PopupSkillDetail>) this.details_).Where<PopupSkillDetail>((Func<PopupSkillDetail, bool>) (x => x.gameObject.activeSelf)).OrderBy<PopupSkillDetail, int>((Func<PopupSkillDetail, int>) (y => y.index != this.current_ ? 1 : 0)))
  ...
  {
    Vector3 localPosition = this.scroll_.transform.localPosition;
    float x = this.details_[this.center_].transform.localPosition.x;
    localPosition.x = x * -1f;
    this.scroll_.transform.localPosition = localPosition;
    ...
    this.uiCenter_.CenterOn(this.details_[this.center_].transform);
  }
  ...
  protected override void Update()
  {
    ...
    else
    {
      ...
      int nextCurrent;
      if ((UnityEngine.Object) gameObject == (UnityEngine.Object) this.details_[this.center_].gameObject && (this.scroll_.isDragging || (double) this.wheelScrollLog_.amount != 0.0))
      {
        float f = this.scroll_.transform.localPosition.x * -1f - this.details_[this.center_].transform.localPosition.x;
        if ((double) Mathf.Abs(f) >= (double) this.gridWidth / 2.0)
        {
          nextCurrent = (double) f >= 0.0 ? this.details_[this.center_].index + 1 : this.details_[this.center_].index - 1;
          if (nextCurrent >= 0 && nextCurrent < this.params_.Length)
          {
            ...
            {
              gameObject = this.details_[nullable.Value].gameObject;
      ...
      if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null && (UnityEngine.Object) gameObject != (UnityEngine.Object) this.details_[this.center_].gameObject)
      {
        ...
        if (next >= 0 && !((IEnumerable<PopupSkillDetail>) this.details_).Any<PopupSkillDetail>((Func<PopupSkillDetail, bool>) (x => x.index == next)))
        {
          ...
          if (num1 != 0)
          {
            this.resetParent(detail.gameObject, this.scrollNode_.transform);
            this.resetPosition(detail.gameObject, detail.index);
          ...
          foreach (PopupSkillDetail popupSkillDetail in (IEnumerable<PopupSkillDetail>) ((IEnumerable<PopupSkillDetail>) this.details_).OrderBy<PopupSkillDetail, int>((Func<PopupSkillDetail, int>) (x => x.index)))
          {
            if (popupSkillDetail.index >= 0)
              popupSkillDetail.transform.SetSiblingIndex(num3++);
  ...
  private void OnDestroy()
  {
    if (this.details_ == null)
      return;
    foreach (UnityEngine.Object @object in ((IEnumerable<PopupSkillDetail>) this.details_).Where<PopupSkillDetail>((Func<PopupSkillDetail, bool>) (x => (UnityEngine.Object) x != (UnityEngine.Object) null)).Select<PopupSkillDetail, GameObject>((Func<PopupSkillDetail, GameObject>) (y => y.gameObject)))
  ...
  private void resetIcons(PopupSkillDetail detail)
  {
    ...
    if (cache.initiailze)
    {
      detail.resetIcons((UnityEngine.Sprite) null, (UnityEngine.Sprite) null, (UnityEngine.Sprite) null);
  ...
  {
    Vector3 localPosition = this.detail_.transform.localPosition;
  ...
  private int getFarDetail(int index)
  {
    int num1 = 0;
    int num2 = -1;
    for (int index1 = 0; index1 < this.details_.Length; ++index1)
    {
      int index2 = this.details_[index1].index;
      if (index2 < 0)
        return index1;
      int num3 = Math.Abs(index2 - index);
      if (num1 < num3)
      {
        num1 = num3;
        num2 = index1;
  ...
  {
    if (this.scroll_.enabled && this.scroll_.isDragging || this.IsPushAndSetEnd())
      return;
  ...
  public void onClickedClose()
  {
    ...
    System.Action onClosed = this.onClosed_;
    if (onClosed == null)
      return;
    onClosed();
  }
  ...
  private void changeCenter(int dir)
  {
    ...
    if (!((UnityEngine.Object) popupSkillDetail != (UnityEngine.Object) null))
      return;
    this.uiCenter_.CenterOn(popupSkillDetail.transform);
  }
  ...
  private IEnumerator doLoadLeader(
    PopupSkillDetails.Cache cache,
    BattleskillSkill s,
    bool bEnemy)
  {
    Future<UnityEngine.Sprite> ld = s.LoadBattleSkillIcon(new BattleFuncs.InvestSkill()
    {
      skill = s,
      isEnemyIcon = bEnemy
    });
  ...
  {
    cache.genreL = gL.HasValue ? SkillGenreIcon.loadSprite(gL.Value, this.isSea) : (UnityEngine.Sprite) null;
    cache.genreR = gR.HasValue ? SkillGenreIcon.loadSprite(gR.Value, this.isSea) : (UnityEngine.Sprite) null;
  }
  ...
  public class Param
  {
    ...
    public System.Action onClickedChange { get; private set; }
    ...
    public static PopupSkillDetails.Param createByUnitView(
      UnitSkillAwake s,
      PlayerUnit unit,
      System.Action onClickedChange = null,
      bool bDisabledStatus = false)
    {
      BattleskillSkill skill = s.skill;
      PopupSkillDetails.Param obj = new PopupSkillDetails.Param(skill, UnitParameter.SkillGroup.Extra);
      Consts instance = Consts.GetInstance();
      if ((double) unit.trust_rate < (double) unit.trust_max_rate)
      {
        obj.message = Consts.Format(unit.unit.IsSea ? instance.popup_004_ExtraSkill_affection_condition : instance.popup_004_ExtraSkill_affection_condition_second, (IDictionary) new Hashtable()
        {
          {
            (object) "percent",
      ...
      {
        obj.level = new int?(skill.upper_level);
        obj.message = instance.popup_004_ExtraSkill_affection_complete;
      }
      if (!bDisabledStatus)
      {
        ...
        obj.remainingSkillAcquisition = Consts.Format(instance.popup_Skill_Detail_Remaining_Skill_Acquisition, (IDictionary) new Hashtable()
        {
          {
            (object) "count",
            (object) num2
      ...
      obj.onClickedChange = onClickedChange;
      return obj;
    }
    ...
    public static PopupSkillDetails.Param createBySEASkillView(BL.Skill s, int num) => PopupSkillDetails.Param.createBySEASkillView(s.skill, true, num);
  ...
  private class Cache
  {
    ...
    public UnityEngine.Sprite genreL;
    public UnityEngine.Sprite genreR;
  }
}
