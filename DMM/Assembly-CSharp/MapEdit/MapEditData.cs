...
namespace MapEdit
{
  public class MapEditData
  {
    ...
    public void resetDefaultSlot() => this.defaultSlot_ = PlayerAffiliation.Current.default_town_slot_number;
    ...
    private PlayerGuildTownSlot getOriginalSlot(int slotId)
    {
      ...
      if (playerGuildTownSlotArray != null && playerGuildTownSlotArray.Length != 0)
        return ((IEnumerable<PlayerGuildTownSlot>) playerGuildTownSlotArray).FirstOrDefault<PlayerGuildTownSlot>((Func<PlayerGuildTownSlot, bool>) (s => s.slot_number == slotId));
      this.isError_ = true;
    ...
    private PlayerGuildTownSlotPosition[] finalizePositions(
      PlayerGuildTownSlotPosition[] positions)
    {
    ...
    private PlayerGuildTownSlotPosition[] finalizePositions(
      IEnumerable<MapEditOrnament> ornaments)
    {
    ...
    public IEnumerator doSave(
      int slotId,
      System.Action<WebAPI.Response.UserError> userErrorCallback)
    {
      this.editId_ = slotId;
      ...
      System.Action<WebAPI.Response.UserError> userErrorCallback)
    {
      ...
      if (bChangeDefaultSlot)
      {
        ...
        ModalWindow.ShowYesNo(instance.MAPEDIT_031_TITLE_SETTING_DEFAULTSLOT, instance.MAPEDIT_031_MESSAGE_SETTING_DEFAULTSLOT, (System.Action) (() => bWait = false), (System.Action) (() =>
        {
      ...
      bool bError = false;
      IEnumerator e = WebAPI.GuildtownSave(facilities_id, facilities_position_x, facilities_position_y, this.editId_ == this.defaultSlot_, this.editId_, this.mapTown_.ID, (System.Action<WebAPI.Response.UserError>) (err =>
      {
        bError = true;
      ...
      if (!bError && bChangeDefaultSlot)
      {
        bool bWait = true;
        Consts instance = Consts.GetInstance();
        ModalWindow.Show(instance.MAPEDIT_031_TITLE_SETTING_DEFAULTSLOT, instance.MAPEDIT_031_RESULT_SETTING_DEFAULTSLOT, (System.Action) (() => bWait = false));
        while (bWait)
          yield return (object) null;
      }
    }
