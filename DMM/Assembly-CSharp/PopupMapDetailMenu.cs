...
public class PopupMapDetailMenu : PopupMapCheckBase
{
  ...
  public IEnumerator InitializeAsync(int maptown_id, System.Action actionClose = null)
  {
  ...
  public IEnumerator InitializeAsync(
    ...
    System.Action actionClose = null)
  {
    ...
    if (maptown != null)
    {
      ...
      if (stage != null)
      {
        if ((UnityEngine.Object) popupMapDetailMenu.GetComponent<UIWidget>() != (UnityEngine.Object) null)
          popupMapDetailMenu.GetComponent<UIWidget>().alpha = 0.0f;
        ...
        e = (IEnumerator) null;
        if ((UnityEngine.Object) popupMapDetailMenu.lblMapName != (UnityEngine.Object) null)
          popupMapDetailMenu.lblMapName.SetTextLocalize(maptown.name);
        if ((UnityEngine.Object) popupMapDetailMenu.lblDescription != (UnityEngine.Object) null)
          popupMapDetailMenu.lblDescription.SetTextLocalize(maptown.description);
        if ((UnityEngine.Object) popupMapDetailMenu.lblCost != (UnityEngine.Object) null)
