...
public class Bugu0053Menu : BackButtonMenuBase
{
  ...
  public void SetZenie() => this.TxtZenie.SetTextLocalize(CalcItemCost.GetCompositeCost(this.playerGears));
  ...
  private void DestroySelectIcon()
  {
    foreach (GameObject gameObject in this.iconParent)
      ((IEnumerable<ItemIcon>) gameObject.GetComponentsInChildren<ItemIcon>()).ForEach<ItemIcon>((System.Action<ItemIcon>) (x => UnityEngine.Object.Destroy((UnityEngine.Object) x.gameObject)));
  }
  ...
  private IEnumerator StartComposite()
  {
    ...
    if (list2.Count == 0)
    {
      GearGear gearGear = countCompositeManaseed <= 0 || countCompositeManaseed != bugu0053Menu.SendGears.Count ? (GearGear) null : bugu0053Menu.SendGears.First<GameCore.ItemInfo>().gear;
      System.Action execComposite = gearGear != null ? (bugu0053Menu.findManaseedCombineRecipe(gearGear.group_id, countCompositeManaseed) != null ? (System.Action) (() => PopupCommonNoYes.Show(Consts.GetInstance().POPUP_005_COMPOSITE_MANASEEDS_WARNING_TITLE2, Consts.GetInstance().POPUP_005_COMPOSITE_MANASEEDS_WARNING_MESSAGE2, (System.Action) (() => this.CompositeAPIEvent()), (System.Action) (() => {}), callbackAfterClose: true)) : (num > gearGear.manaSeedRecoveryLimit ? (System.Action) (() => PopupCommonNoYes.Show(Consts.GetInstance().POPUP_005_COMPOSITE_MANASEEDS_WARNING_TITLE, Consts.GetInstance().POPUP_005_COMPOSITE_MANASEEDS_WARNING_MESSAGE, (System.Action) (() => this.CompositeAPIEvent()), (System.Action) (() => {}), callbackAfterClose: true)) : (System.Action) (() => this.CompositeAPIEvent()))) : (System.Action) (() => this.CompositeAPIEvent());
      if (list1.Count >= 1)
      {
        IEnumerator e;
        if ((UnityEngine.Object) bugu0053Menu.rarityWarningPrefab == (UnityEngine.Object) null)
        {
  ...
  private GearCombineRecipe findManaseedCombineRecipe(int id, int quantity) => ((IEnumerable<GearCombineRecipe>) MasterData.GearCombineRecipeList).FirstOrDefault<GearCombineRecipe>((Func<GearCombineRecipe, bool>) (x =>
  {
  ...
  public IEnumerator CompositeAPI()
  {
    ...
    Future<WebAPI.Response.ItemGearCombine> futureF = WebAPI.ItemGearCombine(this.playerGears.ToGearId().ToArray(), this.playerGears.ToMaterialId().ToArray(), (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    if (result != null)
    {
      ...
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      this.isInit = true;
      Bugu00539Scene.ChangeScene(true, new Bugu00539ChangeSceneParam(numList, isNew, result.animation_pattern, (GameCore.ItemInfo) null, (PlayerItem) null, (System.Action) null, addReisouJewel));
    }
  }
