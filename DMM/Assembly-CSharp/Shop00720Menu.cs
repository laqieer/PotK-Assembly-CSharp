...
public class Shop00720Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Initialize()
  {
    ...
    e = (IEnumerator) null;
    menu.slot = UnityEngine.Object.Instantiate<GameObject>(fPopUp.Result);
  ...
  private void SetMedalInfo(int num) => this.MedalInfo.GetComponentInChildren<UILabel>().SetTextLocalize(num);
  ...
  private IEnumerator MedalPay(bool bShowLoading)
  {
    ...
    Future<WebAPI.Response.SlotS001MedalPay> feature = WebAPI.SlotS001MedalPay(shop00720Menu.currentSlot, new System.Action<WebAPI.Response.UserError>(shop00720Menu.\u003CMedalPay\u003Eb__32_0));
  ...
  {
    if ((UnityEngine.Object) this.slot != (UnityEngine.Object) null)
