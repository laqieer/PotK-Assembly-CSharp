...
public class UnitMenuBase : BackButtonMenuBase
{
  ...
  protected System.Action extendFunc;
  ...
  protected int displayIconSize => !this.displayIconSize_.HasValue ? (this.displayIconSize_ = new int?(Mathf.Min(this.iconMaxValue, this.displayUnitInfos.Count))).Value : this.displayIconSize_.Value;
  ...
  private void Awake()
  {
    if (!((UnityEngine.Object) this.BottomViewPossession != (UnityEngine.Object) null))
      return;
  ...
  private bool[] CreateFilterTable()
  {
    ...
    bool[] flagArray = new bool[60];
    List<bool> filter = this.persist.Data.filter;
    int count = filter.Count;
    for (int index = 0; index < 60; ++index)
      flagArray[index] = index < count && filter[index];
    return flagArray;
  }

  private Dictionary<UnitGroupHead, List<int>> GetGroupIDs()
  {
    Dictionary<UnitGroupHead, List<int>> dictionary;
    if (this.persist == null || this.persist.Data.groupIDs == null)
    {
      dictionary = new Dictionary<UnitGroupHead, List<int>>()
      {
        [UnitGroupHead.group_all] = new List<int>()
        {
          2
        },
      ...
      if (this.persist != null)
        this.persist.Data.groupIDs = dictionary;
    }
    else
      dictionary = this.persist.Data.groupIDs;
    return dictionary;
  }
  ...
  {
    System.Action<PlayerUnit[]> action = (System.Action<PlayerUnit[]>) (units =>
    {
      if (units == null)
        return;
    ...
    PlayerMaterialUnit[] playerMaterialUnits = null)
  {
    ...
    if ((UnityEngine.Object) this.unitPrefab != (UnityEngine.Object) null)
    {
      ...
      {
        UnitIconBase component = UnityEngine.Object.Instantiate<GameObject>(this.unitPrefab).GetComponent<UnitIconBase>();
        UnitIcon unitIcon = component as UnitIcon;
        if ((UnityEngine.Object) unitIcon != (UnityEngine.Object) null)
  ...
  protected virtual void Sort(SortInfo info)
  {
    ...
    {
      if ((UnityEngine.Object) unitIcon != (UnityEngine.Object) null && unitIcon.PlayerUnit != (PlayerUnit) null)
  ...
  protected void UpdateSortSprite(UnitSortAndFilter.SORT_TYPES type)
  {
    ...
    if (sprite == null)
    {
      Debug.LogError((object) (name + "    is not exist!!!"));
    ...
    this.SortSprite.GetComponent<UIWidget>().SetDimensions(sprite.width, sprite.height);
  }
  ...
  protected virtual void SortAndSetIcons(
    ...
    bool isTowerEntry)
  {
    bool flag = (UnityEngine.Object) this.SortSprite != (UnityEngine.Object) null;
    if (flag)
      this.UpdateSortSprite(type);
    if (this.allUnitIcons.Count < 1 || this.allUnitIcons.Any<UnitIconBase>((Func<UnitIconBase, bool>) (v => (UnityEngine.Object) v == (UnityEngine.Object) null)))
      return;
    if (flag)
    {
      ...
      if (Singleton<NGSceneManager>.GetInstance().sceneName == "unit004_8_6")
      {
        ...
        List<UnitIconInfo> unitIconInfoList = list2;
        List<UnitIconInfo> list4 = list1.Concat<UnitIconInfo>((IEnumerable<UnitIconInfo>) unitIconInfoList).Concat<UnitIconInfo>((IEnumerable<UnitIconInfo>) list3).ToList<UnitIconInfo>().OrderByDescending<UnitIconInfo, bool>((Func<UnitIconInfo, bool>) (ui => ui.for_battle)).ThenByDescending<UnitIconInfo, bool>((Func<UnitIconInfo, bool>) (ui => ui.is_rental)).ThenByDescending<UnitIconInfo, bool>((Func<UnitIconInfo, bool>) (ui => ui.playerUnit.favorite)).ToList<UnitIconInfo>();
    ...
    {
      allUnitIcon.transform.parent = this.transform;
      allUnitIcon.gameObject.SetActive(false);
    }
    int displayIconSize = this.displayIconSize;
    for (int index = 0; index < displayIconSize; ++index)
    {
      this.scroll.Add(this.allUnitIcons[index].gameObject, this.iconWidth, this.iconHeight, index);
      this.allUnitIcons[index].gameObject.SetActive(true);
    ...
    while (true)
    {
      do
      {
        ...
        foreach (GameObject gameObject in this.scroll)
        {
          ...
          {
            int? nullable = this.displayUnitInfos.FirstIndexOrNull<UnitIconInfo>((Func<UnitIconInfo, bool>) (v => (UnityEngine.Object) v.icon != (UnityEngine.Object) null && (UnityEngine.Object) v.icon.gameObject == (UnityEngine.Object) unit));
...
label_27:;
  ...
  {
    if (this.allUnitIcons == null || this.allUnitIcons.Count == 0 || this.allUnitIcons.Any<UnitIconBase>((Func<UnitIconBase, bool>) (v => (UnityEngine.Object) v == (UnityEngine.Object) null)))
      return;
    ...
    if (this.iconType == UnitMenuBase.IconType.Normal || this.iconType == UnitMenuBase.IconType.EarthNormal || this.iconType == UnitMenuBase.IconType.NormalWithHpGauge)
      ...
      unitIcon.Deselect();
    this.displayUnitInfos.Where<UnitIconInfo>((Func<UnitIconInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)).ForEach<UnitIconInfo>((System.Action<UnitIconInfo>) (b => b.icon = (UnitIconBase) null));
  }
  ...
  protected virtual IEnumerator CreateUnitIconBase(GameObject prefab)
  {
    ...
    {
      UnitIconBase component = UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<UnitIconBase>();
    ...
    if (this.IsRecord)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      this.allUnitIcons.ForEach((System.Action<UnitIconBase>) (x => x.SetRecordObj(prefabF.Result)));
    }
    this.scroll.ResolvePosition();
    for (int index = 0; index < Mathf.Min(this.iconMaxValue, this.displayUnitInfos.Count); ++index)
      this.ResetUnitIcon(index);
  ...
  protected virtual IEnumerator CreateUnitIcon(
    int info_index,
    int unit_index,
    PlayerUnit baseUnit = null)
  {
    ...
    if (!((UnityEngine.Object) unitIcon == (UnityEngine.Object) null))
    {
      ...
      if (!this.displayUnitInfos[info_index].removeButton)
        unitIcon.ShowBottomInfo(this.sortType);
      if (!unitIcon.gameObject.activeSelf)
  ...
  protected virtual void InitializeInfoEx(
    ...
    bool bGroupUniqueMaterialUnit,
    bool isSpecialIcon,
    System.Action createAllUnitInfoExtendFunc,
    bool battleFirst,
    bool towerEntry)
  {
    this.IsEquip = isEquip;
  ...
  {
    Dictionary<UnitGroupHead, List<int>> dictionary = new Dictionary<UnitGroupHead, List<int>>();
    ...
    dictionary.Add(UnitGroupHead.group_large, new List<int>());
    if (groupLargeCategories != null)
    {
      foreach (UnitGroupLargeCategory groupLargeCategory in groupLargeCategories)
      {
        if (!string.IsNullOrEmpty(groupLargeCategory.name))
          dictionary[UnitGroupHead.group_large].Add(groupLargeCategory.ID);
      }
    }
    ...
    dictionary.Add(UnitGroupHead.group_small, new List<int>());
    if (groupSmallCategories != null)
    {
      foreach (UnitGroupSmallCategory groupSmallCategory in groupSmallCategories)
      {
        if (!string.IsNullOrEmpty(groupSmallCategory.name))
          dictionary[UnitGroupHead.group_small].Add(groupSmallCategory.ID);
      }
    }
    ...
    dictionary.Add(UnitGroupHead.group_clothing, new List<int>());
    if (clothingCategories != null)
    {
      foreach (UnitGroupClothingCategory clothingCategory in clothingCategories)
      {
        if (!string.IsNullOrEmpty(clothingCategory.name))
          dictionary[UnitGroupHead.group_clothing].Add(clothingCategory.ID);
      }
    }
    ...
    dictionary.Add(UnitGroupHead.group_generation, new List<int>());
    if (generationCategories != null)
    {
      foreach (UnitGroupGenerationCategory generationCategory in generationCategories)
      {
        if (!string.IsNullOrEmpty(generationCategory.name))
          dictionary[UnitGroupHead.group_generation].Add(generationCategory.ID);
      }
    }
    return dictionary;
  }
  ...
  protected PlayerUnit[] getUnits() => this.displayUnitInfos.Select<UnitIconInfo, PlayerUnit>((Func<UnitIconInfo, PlayerUnit>) (x => x.playerUnit)).ToArray<PlayerUnit>();
  ...
  protected virtual IEnumerator ShowSortAndFilterPopup()
  {
    ...
    if (!Singleton<PopupManager>.GetInstance().isOpen)
    {
      ...
      e = filter.Initialize(new System.Action<SortInfo>(menu.Sort), menu.persist, menu, menu.isDispOnlyNormalUnit, menu.isFriendSupport);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      filter.SetUnitNum(menu.displayUnitInfos, menu.allUnitInfos);
      filter.SortFilterUnitNum = (System.Action<SortInfo>) (x => filter.SetUnitNum(unitMenuBase.FilterBy(x.filters, x.groupIDs).ToList<UnitIconInfo>(), unitMenuBase.allUnitInfos));
