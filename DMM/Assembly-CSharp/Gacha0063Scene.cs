...
public class Gacha0063Scene : NGSceneBase
{
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    if (!Singleton<TutorialRoot>.GetInstance().IsTutorialFinish())
    {
      ...
      if ((UnityEngine.Object) gacha0063Scene.scrollParts.rightArrow != (UnityEngine.Object) null)
      {
        UnityEngine.Object.Destroy((UnityEngine.Object) gacha0063Scene.scrollParts.rightArrow);
  ...
  private bool IsSyncRemote() => ((IEnumerable<bool>) new bool[4]
  {
    this.apiUpdate,
  ...
  public IEnumerator onStartSceneAsync(int gachaNumber)
  {
    ...
    if (gacha0063Scene.gachaMaintenance)
    {
      ...
      if (!Singleton<TutorialRoot>.GetInstance().IsTutorialFinish())
        ModalWindow.Show(instance.GACHA_MAINTENANCE_TITLE, instance.GACHA_MAINTENANCE_DESCRIPTION, (System.Action) (() => Singleton<NGSceneManager>.GetInstance().RestartGame()));
      else
        ModalWindow.Show(instance.GACHA_MAINTENANCE_TITLE, instance.GACHA_MAINTENANCE_DESCRIPTION, (System.Action) (() => MypageScene.ChangeScene(MypageRootMenu.Mode.STORY)));
    }
    else
    {
      ...
      gacha0063Scene.centerOnChild.transform.localPosition = new Vector3(0.0f, 0.0f, 0.0f);
      // ISSUE: reference to a compiler-generated method
      gacha0063Scene.centerOnChild.onFinished = new SpringPanel.OnFinished(gacha0063Scene.\u003ConStartSceneAsync\u003Eb__38_3);
      gacha0063Scene.centerOnChild.onFinished();
  ...
  private IEnumerator CreatePrefab()
  {
    ...
    if ((UnityEngine.Object) this.dotContainerPrefab == (UnityEngine.Object) null)
    {
  ...
  public GameObject GetTutorialGachaTop() => this.gacha0063hindicatorList[0].gameObject;

  public bool IsCenterCheck(int index) => !((UnityEngine.Object) this.scrollParts == (UnityEngine.Object) null) && this.scrollParts.selected == index;

  private void Update()
  {
    if (!((UnityEngine.Object) this.scrollParts != (UnityEngine.Object) null) || Singleton<CommonRoot>.GetInstance().isLoading)
      return;
