...
public class GuildChatMessageItemController : MonoBehaviour
{
  ...
  public void InitializeDetailedMessageItem(GuildChatMessageData messageData)
  {
    ...
    if (this.originalMessageData.messageType != GuildChatMessageData.GuildChatMessageType.SystemLog && this.originalMessageData.messageType != GuildChatMessageData.GuildChatMessageType.GuildRaidSystemLog)
    {
      ...
      if ((UnityEngine.Object) this.senderName2 != (UnityEngine.Object) null)
        this.senderName2.SetTextLocalize(this.originalMessageData.senderName);
      if ((UnityEngine.Object) this.guildMasterIcon != (UnityEngine.Object) null)
        this.guildMasterIcon.gameObject.SetActive(false);
      if ((UnityEngine.Object) this.guildSubmasterIcon != (UnityEngine.Object) null)
        this.guildSubmasterIcon.gameObject.SetActive(false);
      if ((UnityEngine.Object) this.senderName != (UnityEngine.Object) null)
        this.senderName.gameObject.SetActive(false);
      if ((UnityEngine.Object) this.senderName2 != (UnityEngine.Object) null)
        this.senderName2.gameObject.SetActive(false);
      if (this.originalMessageData.membership != null)
      {
        switch (this.originalMessageData.membership.role)
        {
          case GuildRole.sub_master:
            if ((bool) (UnityEngine.Object) this.guildSubmasterIcon)
              this.guildSubmasterIcon.gameObject.SetActive(true);
            if ((UnityEngine.Object) this.senderName2 != (UnityEngine.Object) null)
            {
              this.senderName2.gameObject.SetActive(true);
              break;
            }
            break;
          case GuildRole.master:
            if ((bool) (UnityEngine.Object) this.guildMasterIcon)
              this.guildMasterIcon.gameObject.SetActive(true);
            if ((UnityEngine.Object) this.senderName2 != (UnityEngine.Object) null)
            {
              this.senderName2.gameObject.SetActive(true);
              break;
          ...
          default:
            if ((UnityEngine.Object) this.senderName != (UnityEngine.Object) null)
            {
              this.senderName.gameObject.SetActive(true);
              break;
            }
            break;
        }
      }
      else if ((UnityEngine.Object) this.senderName != (UnityEngine.Object) null)
        this.senderName.gameObject.SetActive(true);
    }
    ...
    if (this.originalMessageData.messageType != GuildChatMessageData.GuildChatMessageType.GuildRaidLog)
      return;
    if ((UnityEngine.Object) this.sprBtnTeamLog != (UnityEngine.Object) null)
      this.sprBtnTeamLog.SetActive(messageData.isRaidDeckView);
    this.messageButton.enabled = messageData.isRaidDeckView;
  }
  ...
  public void InitializeSimpleMessageItem(GuildChatMessageData messageData)
  {
    ...
    {
      color = new Color(0.278f, 0.776f, 0.349f);
    ...
    {
      color = new Color(1f, 0.706f, 0.0f);
      this.messageContent.supportEncoding = true;
    }
    ...
    this.messageContent.color = color;
  ...
  public void UpdateDisplayingSendTime() => this.sendTime.SetTextLocalize(this.originalMessageData.GetFormattedSendTime());
  ...
  public void OnLogMessageClicked() => Debug.Log((object) ("<color=yellow>Scene name: </color>" + this.originalMessageData.transition.scene_name));
  ...
  public void OnRaidLogMessageClicked() => this.StartCoroutine(this.ShowRaidLogPopup(this.originalMessageData));

  private IEnumerator ShowRaidLogPopup(GuildChatMessageData data)
  {
    if ((UnityEngine.Object) this.guildRaidLogDeckPrefab == (UnityEngine.Object) null)
    {
