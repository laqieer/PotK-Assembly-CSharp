...
public class MypagePopupInformation : MonoBehaviour
{
  ...
  public IEnumerator init()
  {
    ...
    popupInformation.enabled = false;
    ...
    for (int index = 0; index < this.popups_.Length; ++index)
    {
      ...
      if (popup != null)
      {
        ...
        else if (this.clearAnime_ || popup.ending_)
        {
          ...
          UnityEngine.Object.Destroy((UnityEngine.Object) popup.popup_);
  ...
  private void attachAnimationOut(GameObject go)
  {
    ...
    Vector3 pos = this.outTweenPosition.to - this.gameObject.transform.localPosition;
  ...
  private void createSheets(List<MypagePopupInformation.Sheet> slst)
  {
    ...
    foreach (MypagePopupInformation.Sheet sheet in slst)
    {
      ...
      if ((UnityEngine.Object) popup.popup_ != (UnityEngine.Object) null)
      {
  ...
  private GameObject createSheet(GameObject parent, MypagePopupInformation.Sheet s)
  {
    ...
    GameObject gameObject = NGUITools.AddChild(parent, baseSheet.prefab_);
    MypageInformationSheet component = gameObject.GetComponent<MypageInformationSheet>();
    if ((UnityEngine.Object) component != (UnityEngine.Object) null)
    {
      if ((UnityEngine.Object) component.txtTitle_ != (UnityEngine.Object) null)
        component.txtTitle_.SetTextLocalize(string.IsNullOrEmpty(s.title_) ? baseSheet.title_ : s.title_);
      if ((UnityEngine.Object) component.txtMessage_ != (UnityEngine.Object) null && !string.IsNullOrEmpty(s.message_))
  ...
  private class Popup
  {
    ...
    ~Popup()
    {
      ...
      if (!((UnityEngine.Object) this.popup_ != (UnityEngine.Object) null))
        return;
      UnityEngine.Object.Destroy((UnityEngine.Object) this.popup_);
