...
public class MapEdit031TopMenu : BackButtonMenuBase
{
  ...
  private UnityEngine.Material matOrnamentSelected_;
  [SerializeField]
  [Tooltip("設置操作中の設置済みモデルに使う")]
  private UnityEngine.Material matOrnamentNotLocation_;
  [SerializeField]
  ...
  public void requestActivate(List<GameObject> objs) => this.requestActivate_.AddRange((IEnumerable<GameObject>) objs);

  public MapEditData data_ => this.editData_;

  public MapEditOrnament currentOrnament_
  {
    get => this.wCurrentOrnament_ == null || !this.wCurrentOrnament_.IsAlive ? (MapEditOrnament) null : this.wCurrentOrnament_.Target as MapEditOrnament;
    private set
    {
      if ((UnityEngine.Object) this.currentOrnament_ == (UnityEngine.Object) value)
        return;
      this.wCurrentOrnament_ = (UnityEngine.Object) value != (UnityEngine.Object) null ? new WeakReference((object) value) : (WeakReference) null;
    }
  }
  ...
  private NGBattleManager bm_
  {
    get
    {
      if ((UnityEngine.Object) this.managerBattle_ == (UnityEngine.Object) null)
      {
  ...
  private bool isDisplayCost_ => (uint) this.swCost_ > 0U;

  private bool isActiveUI3DEvent_
  {
    get => this.uiEventTrigger_.gameObject.activeSelf && this.uiEventTrigger_.isEnabled_;
    set
    {
      ...
      if (value)
      {
        this.uiEventTrigger_.gameObject.SetActive(true);
  ...
  {
    if ((UnityEngine.Object) this.information_ == (UnityEngine.Object) null)
      return;
  ...
  {
    get => (UnityEngine.Object) this.btnStorage_ != (UnityEngine.Object) null && this.btnStorage_.isEnabled;
    set
    {
      if (!((UnityEngine.Object) this.btnStorage_ != (UnityEngine.Object) null))
        return;
      this.btnStorage_.isEnabled = value;
    }
  }

  public bool isActiveButtonStorage_
  {
    get => (UnityEngine.Object) this.btnStorage_ != (UnityEngine.Object) null && this.btnStorage_.gameObject.activeSelf;
    set
    {
      if (!((UnityEngine.Object) this.btnStorage_ != (UnityEngine.Object) null))
        return;
      this.btnStorage_.gameObject.SetActive(value);
    }
  }
  ...
  public IEnumerator initialize(MapEditData editData, bool isEdit)
  {
    ...
    Future<UnityEngine.Material> ldMat = MapEditFacilityShaderSetting.LoadMaterial("EditFacility_mat_000");
    IEnumerator e = ldMat.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.matOrnamentNotLocation_ = ldMat.Result;
    ldMat = (Future<UnityEngine.Material>) null;
  ...
  private IEnumerator Start()
  {
    ...
    mapEdit031TopMenu.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.Start, new System.Action(mapEdit031TopMenu.\u003CStart\u003Eb__90_0));
  }
  ...
  protected override void Update()
  {
    ...
    if (!this.enabledInformation_ || !((UnityEngine.Object) this.currentOrnament_ != (UnityEngine.Object) null))
      return;
    this.isActiveButtonStorage_ = false;
    if ((UnityEngine.Object) this.tweenInformation_ != (UnityEngine.Object) null)
    {
    ...
    {
      if (!((UnityEngine.Object) this.information_ != (UnityEngine.Object) null) || this.information_.gameObject.activeSelf)
        return;
      this.information_.gameObject.SetActive(true);
    }
  }
  ...
  private void setupBattleManager(NGBattleManager bm)
  {
    ...
    bm.order = 0;
    bm.resetEnvironment();
    ((IEnumerable<BattleMonoBehaviour>) bm.GetComponentsInChildren<BattleMonoBehaviour>()).ForEach<BattleMonoBehaviour>((System.Action<BattleMonoBehaviour>) (m => m.resetEnvironment()));
    ((IEnumerable<NGBattleMenuBase>) this.root3D_.GetComponentsInChildren<NGBattleMenuBase>()).ForEach<NGBattleMenuBase>((System.Action<NGBattleMenuBase>) (m => m.resetEnvironment()));
  }
  ...
  private IEnumerator coInitUI()
  {
    ...
    if ((UnityEngine.Object) menu.selectSight_ != (UnityEngine.Object) null)
      menu.selectSight_.setFirstValue(menu.sight_);
    if ((UnityEngine.Object) menu.selectCost_ != (UnityEngine.Object) null)
      menu.selectCost_.setFirstValue(menu.swCost_);
    if ((UnityEngine.Object) menu.topFacilityCost_ != (UnityEngine.Object) null)
      menu.topFacilityCost_.SetActive(menu.isDisplayCost_);
    Future<GameObject> ldprefab;
    IEnumerator e;
    if ((UnityEngine.Object) menu.information_ == (UnityEngine.Object) null && (UnityEngine.Object) menu.topInformation_ != (UnityEngine.Object) null)
    {
      ...
      if ((UnityEngine.Object) ldprefab.Result != (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) menu.information_ != (UnityEngine.Object) null)
          menu.information_.initialize(menu);
        if ((UnityEngine.Object) menu.tweenInformation_ != (UnityEngine.Object) null)
    ...
    ldprefab = (Future<GameObject>) null;
    MapEditMenuBase[] mapEditMenuBaseArray = menu.GetComponents<MapEditMenuBase>();
    for (int index = 0; index < mapEditMenuBaseArray.Length; ++index)
    {
      MapEditMenuBase mapEditMenuBase = mapEditMenuBaseArray[index];
      if (!((UnityEngine.Object) mapEditMenuBase == (UnityEngine.Object) null))
      {
  ...
  private IEnumerator coInit3DObj(bool bClearedFacility = false)
  {
    ...
    this.editData_.stage_.ApplyLandforms((System.Action<int, int, BattleMapLandform>) ((x, y, landform) => env.core.setFeildPanel(landform.ID, y, x, landform.landform.ID, 0, (BL.DropData) null)));
    IEnumerator e = this.m3DObj_.initializeForEdit(env);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.battle3DRoot_ = this.m3DObj_.objectRoot.GetComponent<Battle3DRoot>();
    BattlePanelParts[] componentsInChildren = this.battle3DRoot_.panelPoint.GetComponentsInChildren<BattlePanelParts>();
    ...
    foreach (BattlePanelParts battlePanelParts in componentsInChildren)
    {
      ...
      if (panel != null && panel.row < lengthRow && panel.column < lengthColumn)
      {
        ...
        this.editData_.matrix_[panel.row, panel.column] = MapEditPanel.attach(battlePanelParts.gameObject, panel, mapFacilitySetting != null, num == 1, num == 0);
      }
    }
    this.bm_.initialized = true;
    while (!this.cntlCamera_.initialized_)
      yield return (object) null;
    this.nodeOrnament_ = this.battle3DRoot_.panelPoint.transform.GetChildInFind("Units");
      ...
      for (int index = 0; index < townSlotPositionArray.Length; ++index)
      {
        ...
        if (!((UnityEngine.Object) p == (UnityEngine.Object) null))
        {
          ...
          if (facility != null)
          {
            ...
            e = this.instantiateOrnament(facility, p.center_, (System.Action<MapEditOrnament>) (ret => ornament = ret));
            while (e.MoveNext())
              yield return e.Current;
            e = (IEnumerator) null;
  ...
  public MapEditPanel hitPanel(Vector2 pos) => this.castPanel(NGBattle3DObjectManager.hitPanel(pos));

  public MapEditPanel castPanel(BL.Panel panel) => panel == null ? (MapEditPanel) null : this.editData_.matrix_[panel.row, panel.column];
  ...
  public bool setCurrentPanel(
    ...
    bool isInit = false)
  {
    if (!isInit && (UnityEngine.Object) this.currentPanel_ == (UnityEngine.Object) panel)
      return false;
    ...
    Singleton<NGBattleManager>.GetInstance().environment.core.fieldCurrent.value = isInit || (UnityEngine.Object) panel == (UnityEngine.Object) null ? (BL.Panel) null : panel.panel_;
    if ((UnityEngine.Object) this.tweenGroundStatus_ != (UnityEngine.Object) null)
      this.tweenGroundStatus_.isActive = !isInit && (UnityEngine.Object) panel != (UnityEngine.Object) null;
    return true;
  }
  ...
  public void onExitNG() => this.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.View);

  public void onClickedSightDistance()
  {
    if ((UnityEngine.Object) this.selectSight_ == (UnityEngine.Object) null || this.selectSight_.inclementLoop() == this.sight_)
      return;
  ...
  private void changeSightDistance(int noSight)
  {
    ...
    if (!((UnityEngine.Object) this.topFacilityCost_ != (UnityEngine.Object) null) || !this.topFacilityCost_.activeSelf)
      return;
  ...
  {
    if ((UnityEngine.Object) this.selectCost_ == (UnityEngine.Object) null || this.selectCost_.inclementLoop() == this.swCost_)
      return;
  ...
  {
    this.swCost_ = sw;
    if (!((UnityEngine.Object) this.topFacilityCost_ != (UnityEngine.Object) null))
      return;
  ...
  public void startLayout(System.Action onInit = null) => this.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.Layout, onInit);

  public void backLayout() => this.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.View);
  ...
  public MapEditPanel getPanel(int row, int column) => row < 0 || row >= this.editData_.lengthRow_ || (column < 0 || column >= this.editData_.lengthColumn_) ? (MapEditPanel) null : this.editData_.matrix_[row, column];
  ...
  public void startLayout(MapEditOrnament ornament)
  {
    ...
    if (ornament.hasLocation_)
    {
      ...
      if ((UnityEngine.Object) mapEditPanel.ornament_ == (UnityEngine.Object) ornament)
      {
  ...
  public bool setLocation()
  {
    ...
    if (!((UnityEngine.Object) this.currentPanel_ != (UnityEngine.Object) null) || !((UnityEngine.Object) currentOrnament != (UnityEngine.Object) null) || !this.currentPanel_.checkLocation())
      return false;
  ...
  public void changeOrnamentDrawLayout()
  {
    ...
    {
      if (!((UnityEngine.Object) currentOrnament != (UnityEngine.Object) null) || keyValuePair.Key != currentOrnament.ID_)
  ...
  {
    if (!((UnityEngine.Object) this.storage_ == (UnityEngine.Object) null))
    {
      PlayerGuildFacility newFacility = this.storage_.useFacility(id);
      if (newFacility != null)
      {
        this.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.Effect, (System.Action) (() => this.stateMenu_[MapEdit031TopMenu.EditState.Effect].setProcessAsync(new Func<object, IEnumerator>(this.doCreateOrnament), (object) newFacility)));
        return;
      }
    }
    this.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.View);
  ...
  private IEnumerator doCreateOrnament(object arg1)
  {
    ...
    else
    {
      ...
      firstpos = camera.transform.position + camera.transform.forward * this.cntlCamera_.sightDistance;
    }
    RaycastHit hitInfo;
    Vector3 pos = !Physics.Raycast(this.cntlCamera_.Camera.ScreenPointToRay(UICamera.currentCamera.WorldToScreenPoint(this.positionStorage_.transform.position)), out hitInfo, 1000f, MapEdit031TopMenu.LAYER_MASK_TERRAIN) ? firstpos : hitInfo.point;
    MapEditOrnament ornament = (MapEditOrnament) null;
    IEnumerator e = this.instantiateOrnament(newFacility, pos, (System.Action<MapEditOrnament>) (ret => ornament = ret));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) ornament == (UnityEngine.Object) null)
  ...
  private IEnumerator instantiateOrnament(
    ...
    Vector3 pos,
    System.Action<MapEditOrnament> callbackReturn)
  {
    ...
    if (ldPrefab == null || (UnityEngine.Object) ldPrefab.Result == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator doReturnStorage(object arg1)
  {
    ...
    if ((UnityEngine.Object) cur == (UnityEngine.Object) null)
    {
  ...
  private void returnStorage(MapEditOrnament ornament)
  {
    if ((UnityEngine.Object) ornament == (UnityEngine.Object) null)
      return;
    if ((UnityEngine.Object) this.currentOrnament_ == (UnityEngine.Object) ornament)
      this.currentOrnament_ = (MapEditOrnament) null;
    ...
    int maxRange)
  {
    ...
    if (maxRange < 1)
      return ret;
    this.applyPanelEffectRange(centerRow, centerColumn, maxRange, (System.Action<int, int>) ((row, column) => ret.AddLast(new MapEdit031TopMenu.PanelPos(row, column))));
    --minRange;
    if (minRange > 0)
      this.applyPanelEffectRange(centerRow, centerColumn, minRange, (System.Action<int, int>) ((row, column) =>
      {
  ...
  private void updateTitle()
  {
    ...
    this.txtTitleSlot_.SetTextLocalize(Consts.Format(instance.MAPEDIT_031_SLOT_NAME, (IDictionary) hashtable));
  }

  public void updateCost()
  {
    MapTown mapTown = this.editData_.mapTown_;
    if (mapTown == null || (UnityEngine.Object) this.storage_ == (UnityEngine.Object) null)
      return;
    Hashtable hashtable = new Hashtable()
    {
      {
    ...
    this.txtCost_.SetTextLocalize(Consts.Format(Consts.GetInstance().MAPEDIT_031_FOOTER_COST, (IDictionary) hashtable));
  }
  ...
  private IEnumerator doPopupConfirmSaveSlot()
  {
    MapEdit031TopMenu mapEdit031TopMenu = this;
    bool bExec = false;
    IEnumerator e = MapEditPopupConfirmSaveSlot.show(mapEdit031TopMenu.editData_.editId_, mapEdit031TopMenu.editData_.defaultSlot_, mapEdit031TopMenu.editData_.checkModified(mapEdit031TopMenu.editData_.editId_), (System.Action) (() => bExec = true), (System.Action) (() => {}), new System.Action(mapEdit031TopMenu.gotoSlotList));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (bExec)
    {
      bool bErr = false;
      e = mapEdit031TopMenu.editData_.doSave((System.Action<WebAPI.Response.UserError>) (err =>
      {
        bErr = true;
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      if (!bErr && (UnityEngine.Object) mapEdit031TopMenu.slotList_ != (UnityEngine.Object) null)
      {
  ...
  public void backSlotList() => this.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.View);

  public void onChangedSlotAndSave(int slotId) => this.StartCoroutine(this.doChangedSlotAndSave(slotId));

  private IEnumerator doChangedSlotAndSave(int slotId)
  {
    MapEdit031TopMenu mapEdit031TopMenu = this;
    mapEdit031TopMenu.IsPush = true;
    mapEdit031TopMenu.nextState_ = new MapEdit031TopMenu.StateParam(MapEdit031TopMenu.EditState.View, (System.Action) (() => this.IsPush = true));
    bool bErr = false;
    IEnumerator e = mapEdit031TopMenu.editData_.doSave(slotId, (System.Action<WebAPI.Response.UserError>) (err =>
    {
      bErr = true;
      WebAPI.DefaultUserErrorCallback(err);
      if (!err.Code.Equals("GVG002"))
  ...
  private class StateParam
  {
    ...
    public System.Action onInit_ { get; private set; }

    public StateParam(MapEdit031TopMenu.EditState editstate, System.Action eventInit = null)
    {
