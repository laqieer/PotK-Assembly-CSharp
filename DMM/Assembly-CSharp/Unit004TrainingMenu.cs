...
public class Unit004TrainingMenu : BackButtonMenuBase
{
  ...
  public System.Action exceptionBackScene { get; set; }
  ...
  public IEnumerator doInitialize(Ingredients param, bool bReset, bool bDisabledTab)
  {
    ...
    for (int index = 0; index < unit004TrainingMenu.tabButtons_.Length; ++index)
    {
      bool flag = (TrainingType) index == param.type;
      unit004TrainingMenu.tabButtons_[index].isEnabled = !flag;
      if (unit004TrainingMenu.dicPage_.TryGetValue((TrainingType) index, out next) && !flag)
        next.hide(true);
    }
    if (bReset)
  ...
  {
    Unit004TrainingMenu unit004TrainingMenu = this;
    if (!((UnityEngine.Object) unit004TrainingMenu.current_ == (UnityEngine.Object) null) && unit004TrainingMenu.current_.page == param.type)
    {
      unit004TrainingMenu.IsPush = true;
  ...
  public void showAdvice(string name)
  {
    if (string.IsNullOrEmpty(name))
      ...
      this.isWaitChangePage_ = Singleton<TutorialRoot>.GetInstance().ShowAdvice(name, finishCallback: new System.Action(this.finishedAdvice));
  }
  ...
  {
    if (this.isWaitChangePage_ || this.isLoading_ || ((UnityEngine.Object) this.current_ == (UnityEngine.Object) null || this.isDisabledTab_) || this.IsPushAndSet())
      return;
    this.isWaitChangePage_ = true;
    this.tabButtons_[(int) this.current_.page].isEnabled = true;
    this.tabButtons_[(int) page].isEnabled = false;
    ...
    {
      if (!((UnityEngine.Object) this.current_ != (UnityEngine.Object) next))
        return;
  ...
  private IEnumerator doNewPage(Ingredients param)
  {
    ...
    if ((UnityEngine.Object) main.current_ != (UnityEngine.Object) null)
  ...
  {
    if ((UnityEngine.Object) off != (UnityEngine.Object) null && (UnityEngine.Object) off != (UnityEngine.Object) on)
  ...
  {
    if ((UnityEngine.Object) this.current_ == (UnityEngine.Object) null)
      return;
