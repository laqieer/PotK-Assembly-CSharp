...
public class Shop007_MaterialExchangePackMenu : BackButtonMenuBase
{
  ...
  public IEnumerator InitMaterialIcon(SelectTicketSelectSample sample)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) exchangePackMenu.dir_product == (UnityEngine.Object) null)
    {
    ...
    {
      GameObject obj = UnityEngine.Object.Instantiate<GameObject>(exchangePackMenu.dir_product);
      obj.SetActive(false);
      e = obj.GetComponent<Shop00722Product>().Init(samples[i], new System.Action<SelectTicketSelectSample>(exchangePackMenu.IconBtnAction));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    ...
    foreach (Component child in exchangePackMenu.scroll.grid.transform.GetChildren())
    ...
    if ((UnityEngine.Object) exchangePackMenu.detailPopup == (UnityEngine.Object) null)
    {
  ...
  public void IconBtnAction(SelectTicketSelectSample content) => this.StartCoroutine(this.ShowDetailPopup(content));
