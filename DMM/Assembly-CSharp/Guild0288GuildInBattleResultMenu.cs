...
public class Guild0288GuildInBattleResultMenu : ResultMenuBase
{
  ...
  private IEnumerator LoadResources()
  {
    ...
    Future<UnityEngine.Sprite> manaPointTextureF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Icons/ManaPoint_Icon");
    e = manaPointTextureF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.manaPointSprite.sprite2D = manaPointTextureF.Result;
    Future<UnityEngine.Sprite> phankillMedalTextureF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Icons/BattleMedal_Icon");
