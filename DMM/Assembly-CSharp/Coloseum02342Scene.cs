...
public class Coloseum02342Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    if (this.duelCount <= 0)
    {
      ...
      else
      {
        ...
        this.battle_result = ColosseumBattleCalc.calcColosseum(ColosseumEnvironmentInitializer.initializeData(!((UnityEngine.Object) this.test_assets != (UnityEngine.Object) null) ? new ColosseumInitialData() : new ColosseumInitialData(new WebAPI.Response.ColosseumStart((Dictionary<string, object>) Json.Deserialize(this.test_assets.text)), 0), (ColosseumEnvironment) null));
  ...
  public void onStartScene(ColosseumUtility.Info info, GameCore.ColosseumResult result) => this.onStartScene();
