...
public class Story0093Scene : NGSceneBase
{
  ...
  public static void changeScene009_3(bool stack, int scriptId) => Singleton<NGSceneManager>.GetInstance().changeScene(Story0093Scene.sceneNormal_, true, (object) scriptId);

  public static void changeScene009_3(bool stack, int scriptId, bool call) => Singleton<NGSceneManager>.GetInstance().changeScene(Story0093Scene.sceneNormal_, true, (object) scriptId, (object) call);
  ...
  public IEnumerator onStartSceneAsync() => this.onStartSceneAsync(MasterData.ScriptScriptList[0].ID);
    ...
    if ((UnityEngine.Object) this.executer != (UnityEngine.Object) null)
    {
      ...
      if (this.modeScript_ != StoryExecuter.ScriptMode.Date)
      {
        ...
        else
        {
          ...
          if (this.callFlag && (UnityEngine.Object) this.executer.skipBtn != (UnityEngine.Object) null)
  ...
  public void onStartScene(int scriptId, System.Action endAction) => this.onStartScene();
