...
public class Popup02689Menu : MonoBehaviour
{
    ...
    Versus02610Menu menu)
  {
    ...
    popup02689Menu.afterResult.alpha = 0.0f;
    ...
    Popup02689Effect ef = popup02689Menu.GetComponent<Popup02689Effect>();
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    rf.Result.Clone(popup02689Menu.effectParent.transform).GetComponentInChildren<PopupPvpClassEffect>().Init(new System.Action(popup02689Menu.EffectEndProvide), new System.Action(popup02689Menu.EffectEndEnable));
  ...
  private IEnumerator StartResultRanking()
  {
    ...
    string text = Consts.Format(versus0026810Period, (IDictionary) hashtable);
  ...
  private IEnumerator StartScroll()
  {
    ...
    foreach (IGrouping<int, WebAPI.Response.PvpSeasonCloseClass_rewards> grouping in ((IEnumerable<WebAPI.Response.PvpSeasonCloseClass_rewards>) this.rewards).GroupBy<WebAPI.Response.PvpSeasonCloseClass_rewards, int>((Func<WebAPI.Response.PvpSeasonCloseClass_rewards, int>) (x => x.class_reward_type)))
    {
      GameObject gameObject = boxPrefab.Clone();
      this.Scroll.Add(gameObject);
      e = gameObject.GetComponent<Versus02612ScrollRewardBox>().Init((IEnumerable<WebAPI.Response.PvpSeasonCloseClass_rewards>) grouping);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
