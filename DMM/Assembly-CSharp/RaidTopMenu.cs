...
public class RaidTopMenu : BackButtonMenuBase
{
  ...
  private IEnumerator CallGuildraidRaidTopAPI()
  {
    ...
    else
    {
      ...
      raidTopMenu.damage_rewards = ((IEnumerable<WebAPI.Response.GuildraidRaidTopDamage_rewards>) guildraidRaidTop.Result.damage_rewards).Where<WebAPI.Response.GuildraidRaidTopDamage_rewards>((Func<WebAPI.Response.GuildraidRaidTopDamage_rewards, bool>) (x => (uint) x.rewards.Length > 0U)).ToArray<WebAPI.Response.GuildraidRaidTopDamage_rewards>();
  ...
  public IEnumerator InitializeAsync(bool fromBattle = false)
  {
    ...
    if (!raidTopMenu.isFailedInit)
    {
      ...
      if (raidTopMenu.periodData != null && raidTopMenu.periodData.bg_path != null)
      {
        ...
        spriteF = Singleton<ResourceManager>.GetInstance().LoadOrNull<UnityEngine.Sprite>(bgPath);
        e = spriteF.Wait();
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
      ...
      if ((UnityEngine.Object) raidTopMenu.raidBasePrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) raidTopMenu.lapPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) raidTopMenu.cloudPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) raidTopMenu.raidEndlessChallengeWindow == (UnityEngine.Object) null)
      {
      ...
      ((IEnumerable<GameObject>) raidTopMenu.slcRPIconBase).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
      ...
      if ((UnityEngine.Object) raidTopMenu.lapInfo == (UnityEngine.Object) null)
      {
        // ISSUE: reference to a compiler-generated method
...
label_82:
      if (raidTopMenu.periodData != null)
      {
        ...
        spriteF = Singleton<ResourceManager>.GetInstance().LoadOrNull<UnityEngine.Sprite>(path);
        e = spriteF.Wait();
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        ...
        else
        {
          ...
          DateTime dateTime2 = raidTopMenu.periodData.start_at.Value;
          objArray[1] = (object) dateTime2.Day;
          dateTime2 = raidTopMenu.periodData.end_at.Value;
          objArray[2] = (object) dateTime2.Month;
          dateTime2 = raidTopMenu.periodData.end_at.Value;
          objArray[3] = (object) dateTime2.Day;
  ...
  private void Clear3DModel()
  {
    ...
    {
      if ((UnityEngine.Object) uiModel != (UnityEngine.Object) null)
      {
        if ((UnityEngine.Object) uiModel.model_creater_ != (UnityEngine.Object) null)
          uiModel.DestroyModelCamera();
        if ((UnityEngine.Object) uiModel.gameObject != (UnityEngine.Object) null && uiModel.gameObject.name == "slc_3DModel(Clone)")
          UnityEngine.Object.Destroy((UnityEngine.Object) uiModel.gameObject);
      }
    }
    this.UIModels.Clear();
  ...
  {
    IEnumerator e;
    if ((UnityEngine.Object) this.ui3DModelPrefab == (UnityEngine.Object) null)
    {
    ...
    for (int i = 0; i < cnt; ++i)
    {
      ...
      if (targetInfo != null)
      {
        ...
        if (!((UnityEngine.Object) uiModelTransfrom == (UnityEngine.Object) null))
        {
          ...
          Vector3 vector3 = new Vector3(targetInfo.boss_model_offset_x, targetInfo.boss_model_offset_y, targetInfo.boss_model_offset_z);
          UIModel.ModelTarget.localPosition = UIModel.ModelTarget.localPosition + this.UIModelPosOffset + vector3;
          ...
          UIModel.GetComponent<BoxCollider>().enabled = false;
          this.UIModels[i] = UIModel;
          UIModel.ModelCamera.transform.localPosition = new Vector3(0.0f, (float) (i * 1000), 0.0f);
  ...
  private int getOrderMax(int lap) => MasterData.GuildRaid.Count<KeyValuePair<int, GuildRaid>>((Func<KeyValuePair<int, GuildRaid>, bool>) (x => x.Value.period_id == this.period_id && x.Value.lap == lap));
  ...
  private IEnumerator setWantedAndRoad(bool enableBossTouch = true)
  {
    ...
    ((IEnumerable<GameObject>) raidTopMenu.slcRoadOnList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    ((IEnumerable<GameObject>) raidTopMenu.slcRoadOffList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    ((IEnumerable<GameObject>) raidTopMenu.dirRoadAnimList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    ((IEnumerable<GameObject>) raidTopMenu.dynRaidBaseList).ForEach<GameObject>((System.Action<GameObject>) (x => x.transform.Clear()));
    ((IEnumerable<GameObject>) raidTopMenu.dynRaidBaseList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    IEnumerator e;
    if (raidTopMenu.raidPeriodStatus == RaidTopMenu.RaidPeriodStatus.ENABLE)
    {
      ...
      for (i = 0; i <= raidTopMenu.orderMax - 1; ++i)
      {
        ...
        e = unitWanted.Init(targetInfo.Value, new System.Action(raidTopMenu.ShowTargetDetail));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
    ...
    for (int index = 0; index <= raidTopMenu.orderMax - 1; ++index)
    {
      ...
      if (!((UnityEngine.Object) componentInChildren == (UnityEngine.Object) null))
      {
        ...
        if (index < order - 1 || raidTopMenu.isComplete && !raidTopMenu.isDefeatBoss)
        {
          ...
          componentInChildren.setHpGaugeEnable(false);
          TweenColor component = raidTopMenu.UIModels[index].GetComponent<TweenColor>();
  ...
  public IEnumerator runBossDefeat()
  {
    ...
    if (!((UnityEngine.Object) unitWantedPre == (UnityEngine.Object) null))
    {
      unitWantedPre.playClearAnim();
      if ((UnityEngine.Object) this.UIModels[this.defeatCurrentOrder - 1] != (UnityEngine.Object) null)
      {
        this.UIModels[this.defeatCurrentOrder - 1].AnimDeath();
        this.UIModels[this.defeatCurrentOrder - 1].setSpeedAnim(2f);
        TweenColor component = this.UIModels[this.defeatCurrentOrder - 1].GetComponent<TweenColor>();
  ...
  public IEnumerator runAllClear()
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      e = WebAPI.GuildraidRaidEndlessEntry(raidTopMenu.period_id, new System.Action<WebAPI.Response.UserError>(raidTopMenu.\u003CrunAllClear\u003Eb__115_0)).Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  public IEnumerator runCircling()
  {
    ...
    loader.Result.Clone(this.dynRaidCircling.transform);
    yield return (object) new WaitForSeconds((float) this.circlingWaitMSec / 1000f);
    ((IEnumerable<GameObject>) this.slcRoadOnList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    ((IEnumerable<GameObject>) this.slcRoadOffList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    ((IEnumerable<GameObject>) this.dirRoadAnimList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    ((IEnumerable<GameObject>) this.dynRaidBaseList).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    this.isDefeatBoss = false;
    ...
    this.dirMapTweenAlpha.PlayForward();
  ...
  {
    this.ibtnRaidShop.enabled = value;
    this.ibtnRank.enabled = value;
    this.ibtnHelp.enabled = value;
    this.ibtnHuntingInfo.enabled = value;
    this.ibtnBack.enabled = value;
    if ((UnityEngine.Object) this.currentWanted != (UnityEngine.Object) null)
    ...
    switch (this.raidPeriodStatus)
    {
      case RaidTopMenu.RaidPeriodStatus.ENABLE:
        ...
        if (!this.isDefeatBoss && !this.isRankingResult && this.isComplete)
        {
          ...
          this.dirRaidBossDefeatLabel.SetTextLocalize(this.canEndless ? Consts.GetInstance().RAID_BOSS_DEFEAT_ENDLESS : Consts.GetInstance().RAID_BOSS_DEFEAT);
          if (flag && (UnityEngine.Object) this.endless == (UnityEngine.Object) null)
          {
            this.endless = this.raidEndlessChallengeWindow.Clone().GetComponent<RaidEndlessChallenge>();
            if ((UnityEngine.Object) this.endless.GetComponent<UIWidget>() != (UnityEngine.Object) null)
              this.endless.GetComponent<UIWidget>().alpha = 0.0f;
            this.endless.Init(this.period_id, this);
            Singleton<PopupManager>.GetInstance().open(this.endless.gameObject, isCloned: true);
          }
        }
        this.ibtnHuntingInfo.enabled = true;
        this.ibtnHuntingInfo.GetComponent<UIWidget>().color = new Color(1f, 1f, 1f);
        foreach (Component component1 in this.ibtnHuntingInfo.transform)
        {
          UISprite component2 = component1.GetComponent<UISprite>();
          if ((UnityEngine.Object) component2 != (UnityEngine.Object) null)
            component2.color = new Color(0.5f, 0.5f, 0.5f);
        }
        this.sprZoom.color = new Color(0.5f, 0.5f, 0.5f);
        this.ibtnRank.enabled = true;
        break;
      case RaidTopMenu.RaidPeriodStatus.AGGREGATING:
        ...
        this.ibtnHuntingInfo.enabled = false;
        this.ibtnHuntingInfo.GetComponent<UIWidget>().color = new Color(0.5f, 0.5f, 0.5f);
        foreach (Component component1 in this.ibtnHuntingInfo.transform)
        {
          UISprite component2 = component1.GetComponent<UISprite>();
          if ((UnityEngine.Object) component2 != (UnityEngine.Object) null)
            component2.color = new Color(0.25f, 0.25f, 0.25f);
        }
        this.sprZoom.color = new Color(0.25f, 0.25f, 0.25f);
        this.ibtnRank.enabled = false;
        break;
