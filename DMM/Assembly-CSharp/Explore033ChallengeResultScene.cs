...
public class Explore033ChallengeResultScene : NGSceneBase
{
  ...
  public static void ChangeScene(GameCore.ColosseumResult result, Gladiator gladiator) => Singleton<NGSceneManager>.GetInstance().changeScene("explore033_Challenge_Result", false, (object) result, (object) gladiator);
  ...
  public IEnumerator onStartSceneAsync(GameCore.ColosseumResult result, Gladiator gladiator)
  {
    ...
    Future<WebAPI.Response.ExploreChallengeFinish> receive = WebAPI.ExploreChallengeFinish(result.colosseumTransactionID, result.GetResultJsonString(), challengeResultScene.isWin, (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    if (receive.Result != null)
    {
      ...
      {
        (ResultMenuBase) challengeResultScene.GetComponent<Explore033ChallengeResultMenu>(),
        (ResultMenuBase) challengeResultScene.GetComponent<Explore033ChallengeRewardMenu>(),
        (ResultMenuBase) null
      };
