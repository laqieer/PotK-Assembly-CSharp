...
public class Story0592Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("story059_2", stack);

  public override IEnumerator onInitSceneAsync()
  {
    Story0592Scene story0592Scene = this;
    story0592Scene.menu = story0592Scene.menuBase as Story0592Menu;
    if (!((Object) story0592Scene.menu == (Object) null))
    {
  ...
  {
    if (!this.isInit && !((Object) this.menu == (Object) null))
    {
