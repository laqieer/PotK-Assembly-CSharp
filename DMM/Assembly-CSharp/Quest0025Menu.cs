...
public class Quest0025Menu : BackButtonMenuBase
{
    ...
    bool restart = false)
  {
    ...
    L_Ids.ForEach<int>((System.Action<int>) (x => Debug.LogWarning((object) ("解放章：" + (object) x))));
    if (restart)
    {
      quest0025Menu.circul = (Quest0025CircularMotionSet) null;
      if ((UnityEngine.Object) quest0025Menu.jog != (UnityEngine.Object) null)
      {
        UnityEngine.Object.Destroy((UnityEngine.Object) quest0025Menu.jog);
        quest0025Menu.jog = (GameObject) null;
      }
    }
    if ((UnityEngine.Object) quest0025Menu.circul == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) quest0025Menu.circul != (UnityEngine.Object) null)
    {
      foreach (Quest0025SlidePanelDragged componentsInChild in quest0025Menu.circul.GetComponentsInChildren<Quest0025SlidePanelDragged>())
      {
        componentsInChild.Initialize(quest0025Menu.GetComponent<BGChange>());
        ...
        else
        {
          ...
          if (LNum == componentsInChild.Lid)
            quest0025Menu.circul.SetCenter(componentsInChild.transform);
        }
      }
  ...
  private IEnumerator ChangeStoryMode(PlayerStoryQuestS[] stories, int XL, int L)
  {
    ...
    IEnumerator e = quest0025Menu.GetComponent<BGChange>().SetChapterBg((Quest00240723Menu.StoryMode) XL);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public void btnChangeStoryHeaven() => Singleton<CommonRoot>.GetInstance().GetHeavenCommonFooter().onButtonQuest();

  public void btnChangeStoryLostRagnarok() => Singleton<CommonRoot>.GetInstance().GetHeavenCommonFooter().onButtonQuest();
