...
public class Unit004813Menu : BackButtonMenuBase
{
  ...
  private void OnDisable()
  {
    if ((UnityEngine.Object) this.sm != (UnityEngine.Object) null)
      this.sm.stopVoice();
    if (!((UnityEngine.Object) this.loveGaugeController != (UnityEngine.Object) null))
      return;
  ...
  {
    Future<UnityEngine.Sprite> iconF = beforeSkill.skill.LoadBattleSkillIcon();
    ...
    List<int> otherData)
  {
    ...
    if (m.AfterUnit.skills != null)
    {
      ...
      for (int index = 0; index < playerUnitSkillsArray.Length; ++index)
      {
        ...
        Future<UnityEngine.Sprite> iconF = skill.skill.LoadBattleSkillIcon();
        e = iconF.Wait();
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
    ...
    if ((UnityEngine.Object) m.lnkOverkillersSkill != (UnityEngine.Object) null && m.AfterUnit.unit.exist_overkillers_skill)
    {
  ...
  {
    if (!((UnityEngine.Object) this.UnityGrowthResultPrefab == (UnityEngine.Object) null))
    {
  ...
  private IEnumerator ExtraSKillReleaseSequence()
  {
    if (this.isExtraSkillRelease)
    {
      ...
      {
        bool isFinished = false;
        e = Prefab.GetComponent<FavorabilityRatingEffect>().Init(FavorabilityRatingEffect.AnimationType.SkillFrameRelease, this.AfterUnit, (System.Action) (() =>
        {
  ...
  private IEnumerator ExtraSKillRemembereSequence()
  {
    if (this.isExtraSkillRemembere)
    {
      ...
      {
        bool isFinished = false;
        e = Prefab.GetComponent<FavorabilityRatingEffect>().Init(FavorabilityRatingEffect.AnimationType.SkillRelease, this.AfterUnit, (System.Action) (() =>
        {
          Singleton<PopupManager>.GetInstance().dismiss();
          isFinished = true;
  ...
  private IEnumerator FinishSequence()
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    if ((UnityEngine.Object) unit004813Menu.parameterPanel != (UnityEngine.Object) null)
      unit004813Menu.parameterPanel.RemoveTween();
    if ((UnityEngine.Object) unit004813Menu.overkillersSkill != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) unit004813Menu.overkillersSkill.gameObject);
