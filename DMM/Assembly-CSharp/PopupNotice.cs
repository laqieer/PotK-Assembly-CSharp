...
public class PopupNotice : BackButtonMenuBase
{
  ...
  public IEnumerator Initialize(OfficialInfoPopupSchema[] contentsData, int index)
  {
    ...
    for (int index1 = 0; index1 < this.mContentsData.Length; ++index1)
      this.mDotIndexPrefab.Clone(this.mDotIndexAnchor.transform);
    this.mDotIndexAnchor.Reposition();
    this.mDotIndexParts = this.mDotIndexAnchor.GetComponentsInChildren<SelectParts>();
  ...
  private IEnumerator LoadContent(int index, System.Action callback = null)
  {
  ...
  private void StartLoadCurrentContent(System.Action callback)
  {
    if (this.mContentLoader != null)
  ...
  public void IncreasePageIndex()
  {
    ...
    if (currentPageIndex1 == currentPageIndex2)
      ...
      this.StartLoadCurrentContent((System.Action) (() => this.IsPush = false));
  }
