...
public class Tower029SupplyEditScene : NGSceneBase
{
  ...
  public static void ChangeScene(List<SupplyItem> supplyItems) => Singleton<NGSceneManager>.GetInstance().changeScene("tower029_supplies_edit", false, (object) supplyItems);
  ...
  public void onStartScene(List<SupplyItem> supplyItems) => Singleton<CommonRoot>.GetInstance().isLoading = false;
