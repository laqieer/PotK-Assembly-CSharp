...
public class Unit004ExtraskillListMenu : Unit004SelectExtraSkillListMenuBase
{
  ...
  protected override List<PlayerAwakeSkill> GetExtraSkills() => ((IEnumerable<PlayerAwakeSkill>) SMManager.Get<PlayerAwakeSkill[]>()).ToList<PlayerAwakeSkill>();
  ...
  public IEnumerator onBacSceneAsync()
  {
    ...
    IEnumerator e = extraskillListMenu.extraSkillInfo.InitSkillInfo((Unit004SelectExtraSkillListMenuBase) extraskillListMenu, extraskillListMenu.selectSkill, -1);
    while (e.MoveNext())
  ...
  protected override IEnumerator InitExtension()
  {
    ...
    if ((UnityEngine.Object) extraskillListMenu.unitIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) extraskillListMenu.skillGenrePrefab == (UnityEngine.Object) null)
    {
  ...
  {
    if ((UnityEngine.Object) this.scrollBottom == (UnityEngine.Object) null || (UnityEngine.Object) this.scrollBarWidget == (UnityEngine.Object) null)
      return;
    if (type != this.bottomInfoType | force)
    {
      ...
      switch (this.bottomInfoType)
      {
        ...
        case Unit004ExtraskillListMenu.BottomInfoType.SELL:
          ...
          this.scrollBarWidget.bottomAnchor.absolute = this.SCROLL_BAR_BOTTOM_SELL;
          break;
        case Unit004ExtraskillListMenu.BottomInfoType.SKILL_COMPOSITE:
          ((IEnumerable<GameObject>) this.bottomInfos).ToggleOnceEx(1);
          if (num > ExtraSkillIcon.Height)
            this.scrollBottom.height = this.SCROLL_BOTTOM_COMPOSITE;
          this.scrollBarWidget.bottomAnchor.absolute = this.SCROLL_BAR_BOTTOM_COMPOSITE;
  ...
  public void onIbtnComposite() => this.bottomInfoType = Unit004ExtraskillListMenu.BottomInfoType.SKILL_COMPOSITE;

  public void onIbtnClose() => this.extraSkillInfo.StartTween(Unit004ExtraskillInfo.EndTweenID);

  public void CloseTweenFinish()
  {
    if (this.selectSkill != null && (UnityEngine.Object) this.selectSkill.icon != (UnityEngine.Object) null)
  ...
  {
    this.StartCoroutine(this.changeFavorite((System.Action) (() => Unit004ExtraskillEquipUnitListScene.changeScene(true, targetUnit, targetSkill))));
  }
