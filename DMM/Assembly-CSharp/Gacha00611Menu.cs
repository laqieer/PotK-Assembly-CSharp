...
public class Gacha00611Menu : EquipmentDetailMenuBase
{
  ...
  {
    if (this.IsPushAndSet() || !this.btnBack.GetComponent<Collider>().enabled)
      return;
    this.doBackScene();
  }
    ...
    int? addReisouJewel = null)
  {
    ...
    if (baseInfo != null)
    {
      Decimal num3 = baseInfo.gearExpNext + baseInfo.gearExp == 0 ? 0M : (Decimal) baseInfo.gearExp / (Decimal) (baseInfo.gearExpNext + baseInfo.gearExp);
      Decimal num4 = TargetInfo.gearExpNext + TargetInfo.gearExp == 0 ? 0M : (Decimal) TargetInfo.gearExp / (Decimal) (TargetInfo.gearExpNext + TargetInfo.gearExp);
    ...
    PlayerItem baseItem)
  {
    ...
    if (baseItem != (PlayerItem) null)
      playerItem = baseItem;
    reisouExpGauge.maxReisouWidth = reisouExpGauge.SlcReisouGauge.width;
    ...
    else
    {
      ...
      reisouExpGauge.SlcReisouGauge.width = (int) num4;
    }
      ...
      while (now < ReisouExpGauge.addReisouGauge)
      {
        ...
        if (ReisouExpGauge.isReisouRankup && int32_1 < int32_2)
        {
          ...
          if ((UnityEngine.Object) this.rankUpReisouObject != (UnityEngine.Object) null)
          {
            ...
            ReisouExpGauge.SlcReisouGauge.width = ReisouExpGauge.maxReisouWidth;
          }
          yield return (object) new WaitForSeconds(0.6f);
          if (!this.isStopSe)
            seChannel = Singleton<NGSoundManager>.GetInstance().playSE(this.seGaugeUp, true);
        }
        if ((UnityEngine.Object) ReisouExpGauge.SlcReisouGauge != (UnityEngine.Object) null)
        {
  ...
  public void SetChangeScene(System.Action changeScene) => this.cahngeSceneCallback = changeScene;
