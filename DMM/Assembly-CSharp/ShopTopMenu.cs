...
public class ShopTopMenu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(WebAPI.Response.ShopStatus shopStatus)
  {
    ...
    foreach (SelectTicket selectTicket in selectTicketArray)
    {
      ...
      PlayerSelectTicketSummary selectTicketSummary = ((IEnumerable<PlayerSelectTicketSummary>) selectTicketSummaryArray).FirstOrDefault<PlayerSelectTicketSummary>((Func<PlayerSelectTicketSummary, bool>) (x => x.ticket_id == unitTicket.id));
    ...
    {
      foreach (Component component in menu.LimitedShopGrid.transform)
    ...
    if (!menu.isInit)
    {
      ...
      menu.LimitedShopGrid.transform.Clear();
      ...
      if (menu.IsOpenLimitedShop())
      {
        foreach (LimitedShopBanner limitedShopBanner1 in (IEnumerable<LimitedShopBanner>) ((IEnumerable<LimitedShopBanner>) shopStatus.shop_banners).OrderByDescending<LimitedShopBanner, int>((Func<LimitedShopBanner, int>) (x => x.id)))
        {
          ...
          GameObject limitedShopBanner = menu.LimitedShopBannerPrefab.Clone(menu.LimitedShopGrid.transform);
      ...
      {
        GameObject gameObject = menu.CommingSoonBannerPrefab.Clone(menu.LimitedShopGrid.transform);
        menu.LimitedShopBanners.Add(gameObject);
      }
      foreach (Transform transform in menu.NormalShopGrid.transform)
      {
        menu.NormalShopBanners.Add(transform.gameObject);
        transform.GetComponent<ShopBanner>().Init(menu, 0, "");
        transform.GetComponent<UIButton>();
      }
      menu.LimitedDots.Clear();
      foreach (Transform transform in menu.LimitedShopGrid.transform)
      {
      ...
      menu.LimitedTabButton.isEnabled = false;
      menu.NormalTabButton.isEnabled = true;
      menu.LimitedTabButtonSprite.color = ShopCommon.TabDisableTextColor;
      menu.NormalTabButtonSprite.color = new Color(0.3490196f, 0.3490196f, 0.3490196f);
      menu.LimitedShopDot.SetActive(true);
      menu.NormalShopDot.SetActive(false);
      // ISSUE: reference to a compiler-generated method
      menu.LimitedCenterOnChild.onFinished = new SpringPanel.OnFinished(menu.\u003CInit\u003Eb__41_0);
      // ISSUE: reference to a compiler-generated method
      menu.NormalCenterOnChild.onFinished = new SpringPanel.OnFinished(menu.\u003CInit\u003Eb__41_1);
  ...
  public IEnumerator InitAnimation()
  {
    ...
    {
      shopTopMenu.shopAnimator.enabled = true;
      shopTopMenu.StartCoroutine(shopTopMenu.shopAnimation.Init());
      while ((double) shopTopMenu.LimitedShopContainer.alpha < 1.0)
  ...
  private void BannerCenterOnChildEvent(bool isLimited)
  {
    ...
    if (isLimited)
    {
      ...
      foreach (GameObject limitedShopBanner in this.LimitedShopBanners)
      {
        ...
        if ((UnityEngine.Object) limitedShopBanner == (UnityEngine.Object) centeredObject)
        {
          num1 = num2;
          if ((UnityEngine.Object) component.Button != (UnityEngine.Object) null)
      ...
      if ((UnityEngine.Object) this.currentLimitedBanner != (UnityEngine.Object) null && (UnityEngine.Object) this.currentLimitedBanner != (UnityEngine.Object) centeredObject)
    ...
    else
    {
      ...
      foreach (GameObject normalShopBanner in this.NormalShopBanners)
      {
        ...
        if ((UnityEngine.Object) normalShopBanner == (UnityEngine.Object) centeredObject)
        {
          num1 = num2;
          component.Button.isEnabled = true;
        }
      ...
      if ((UnityEngine.Object) this.currentNormalBanner != (UnityEngine.Object) null && (UnityEngine.Object) this.currentNormalBanner != (UnityEngine.Object) centeredObject)
        Singleton<NGSoundManager>.GetInstance().playSE("SE_1005");
  ...
  private IEnumerator popup00714()
  {
    ...
    gameObject.GetComponent<Shop00714Menu>().Init(price, quantity, new System.Action<int>(gameObject.GetComponent<Shop00714SetText>().SetText));
  }

  private bool IsAllAnimationWait() => this.shopAnimation.IsWait() && ShopBackgroundAnimation.CurrentShopBackground.GetComponent<ShopBackgroundAnimation>().IsWait();

  public void IbtnLimitedTab()
  {
    if (!this.IsAllAnimationWait())
      return;
    this.LimitedTabButton.isEnabled = false;
    this.NormalTabButton.isEnabled = true;
    this.LimitedTabButtonSprite.color = ShopCommon.TabDisableTextColor;
    this.NormalTabButtonSprite.color = new Color(0.3490196f, 0.3490196f, 0.3490196f);
  ...
  public void IbtnNormalTab()
  {
    if (!this.IsAllAnimationWait())
      return;
    this.LimitedTabButton.isEnabled = true;
    this.NormalTabButton.isEnabled = false;
    this.LimitedTabButtonSprite.color = new Color(0.3490196f, 0.3490196f, 0.3490196f);
    this.NormalTabButtonSprite.color = ShopCommon.TabDisableTextColor;
  ...
  public void IbtnLimitedLeftArrow() => this.OnArrowButton(this.LimitedCenterOnChild, this.LimitedShopBanners, true);

  public void IbtnLimitedRightArrow() => this.OnArrowButton(this.LimitedCenterOnChild, this.LimitedShopBanners, false);

  public void IbtnNormalLeftArrow() => this.OnArrowButton(this.NormalCenterOnChild, this.NormalShopBanners, true);

  public void IbtnNormalRightArrow() => this.OnArrowButton(this.NormalCenterOnChild, this.NormalShopBanners, false);
    ...
    bool isLeft)
  {
    ...
    foreach (UnityEngine.Object banner in banners)
    {
      if (banner == (UnityEngine.Object) centeredObject)
      {
        num2 = num1;
        break;
      }
  ...
  public bool IsBannerSpringPanelSlideing() => (UnityEngine.Object) this.LimitedCenterOnChild.centeredObject != (UnityEngine.Object) this.currentLimitedBanner || (UnityEngine.Object) this.NormalCenterOnChild.centeredObject != (UnityEngine.Object) this.currentNormalBanner;
  ...
  public IEnumerator FadeOut()
  {
    ...
    alpha.duration = 0.2f;
    alpha.animationCurve = new AnimationCurve();
    alpha.animationCurve.AddKey(new Keyframe(0.0f, 0.0f, 2f, 2f));
    alpha.animationCurve.AddKey(new Keyframe(1f, 1f, 0.0f, 0.0f));
    while ((double) alpha.value > 0.0)
      yield return (object) null;
    this.mainPanel.SetActive(false);
    yield return (object) null;
    UnityEngine.Object.Destroy((UnityEngine.Object) alpha);
    this.mainPanel.GetComponent<UIPanel>().alpha = 1f;
  }
}
