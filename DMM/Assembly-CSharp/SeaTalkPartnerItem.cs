    ...
    PlayerTalkPartner[] playerTalkPartners)
  {
    ...
    switch (playerTalkPartner.letter.call_status)
    {
      ...
      case 2:
        ...
        break;
      case 3:
        this.background.color = new Color(0.9647059f, 0.8745098f, 1f);
        this.partnerName.color = new Color(0.6588235f, 0.3372549f, 0.7803922f);
        this.pledgeCompletedIcon.SetActive(false);
    ...
    if (playerTalkPartner.letter.mood_status == 3)
    {
      ...
      this.background.color = new Color(1f, 0.7647059f, 0.7647059f);
      this.partnerName.color = new Color(1f, 0.0f, 0.2352941f);
    }
    else
