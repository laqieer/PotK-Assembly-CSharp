...
public class Popup02646Menu : MonoBehaviour
{
    ...
    WebAPI.Response.PvpFriend fData)
  {
    ...
    Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadEmblemSprite(fData.current_emblem_id);
  ...
  private void Update()
  {
    ...
    if (Singleton<CommonRoot>.GetInstance().isInputBlock || !Input.GetKeyUp(KeyCode.Escape))
      return;
    this.IbtnNo();
  }
