...
public class BattlePanelParts : BattleMonoBehaviour
{
  ...
  private void Awake() => this._renderer = this.GetComponent<Renderer>();
  ...
  public void setGuardArea(GameObject prefab) => prefab.Clone(this.transform).transform.localPosition = this.getLocalPosition();
  ...
  {
    if ((Object) this.waitButton == (Object) null)
  ...
  public Vector3 getLocalPosition() => new Vector3(0.0f, this.GetComponent<PanelInit>().panelHeightNonScale + 0.1f, 0.0f);

  public BL.Panel getPanel() => this.modified.value;

  public float getHeight() => this.GetComponent<PanelInit>().panelHeight;
  ...
  protected override void LateUpdate_Battle()
  {
    ...
    if ((Object) this._renderer.material != (Object) material)
    {
      if ((Object) this._renderer.material != (Object) null)
    ...
    if (panel.isJumping)
    {
      if (!((Object) this.fieldJumpEffect == (Object) null))
        return;
      this.fieldJumpEffect = Singleton<NGBattleManager>.GetInstance().fieldJumpEffectPrefab.Clone(this.transform);
