...
public class gacha006_effectScene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(GachaResultData.ResultData resultData)
  {
    ...
    IEnumerator e;
    if ((Object) gacha006EffectScene.gacha2d == (Object) null)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      gacha006EffectScene.gacha2d = future.Result.Clone(gacha006EffectScene.mainPanel.transform);
      future = (Future<GameObject>) null;
    }
    gacha006EffectScene.gacha2d.SetActive(false);
    if ((Object) gacha006EffectScene.gacha3d == (Object) null)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      gacha006EffectScene.gacha3d = future.Result.Clone(gacha006EffectScene.transform.parent);
      future = (Future<GameObject>) null;
    }
    gacha006EffectScene.gacha3d.transform.localPosition = new Vector3(1000f, 0.0f, 0.0f);
    if ((Object) gacha006EffectScene.menu.Effect == (Object) null)
    ...
    gacha006EffectScene.menu.Effect.enabled = true;
