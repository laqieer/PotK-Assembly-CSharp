...
{
  public static void ChangeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("raid032_shop", stack);
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    Future<WebAPI.Response.ShopStatus> shopT = WebAPI.ShopStatus((System.Action<WebAPI.Response.UserError>) (e =>
    {
