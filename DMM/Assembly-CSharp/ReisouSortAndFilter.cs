...
public class ReisouSortAndFilter : SortAndFilter
{
  ...
  private void SetListTypeBtn(ReisouSortAndFilter.ModeTypes mode)
  {
    if ((UnityEngine.Object) this.ListBtns[0] != (UnityEngine.Object) null && (UnityEngine.Object) this.ListBtns[1] != (UnityEngine.Object) null)
    {
      ...
      else
      {
        ...
        System.Action sortFilterItemNum = this.SortFilterItemNum;
  ...
  private void SetSortTabLabel() => this.sortLabel.SetText(this.sortLabelDic[this.menuBase.ReisouSortCategory]);
  ...
  public static UISprite SortSpriteLabel(
    ...
    UISprite SortSprite)
  {
    string str = ReisouSortAndFilter.SetSortLabelSpriteName(type);
