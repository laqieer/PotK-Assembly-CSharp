...
public class CorpsQuestTopMenu : BackButtonMenuBase
{
  ...
  private IEnumerator CreateStageList()
  {
    ...
    this.CenterOnChild.transform.Clear();
    ...
    for (int index = 0; index < this.StageMaster.Length; ++index)
    {
      ...
      {
        CorpsStageListItem component = result.CloneAndGetComponent<CorpsStageListItem>(this.CenterOnChild.gameObject);
        ...
        component.Init(stage, ((IEnumerable<int>) this.ClearedStageIDs).Contains<int>(stage.ID), isRewardGotten, (System.Action<GameObject>) (obj => this.CenterOnChild.CenterOn(obj.transform)));
    ...
    for (int index = 0; index < list.Count; ++index)
      list[index].transform.localPosition = new Vector3(0.0f, -1f * this.Grid.cellHeight * (float) index, 0.0f);
    this.TopStageID = list[0].StageID;
    this.BottomStageID = list[list.Count - 1].StageID;
    this.CenterOnChild.CenterOn(list[0].transform);
  }
  ...
  private IEnumerator SetTicketIcon()
  {
    ...
    if (MasterData.CommonTicket.TryGetValue(this.PeriodMaster.trade_coin_id, out commonTicket))
    {
      ...
      this.ShopTicketIcon.gameObject.SetActive(true);
      future = (Future<UnityEngine.Sprite>) null;
    }
    else
      this.ShopTicketIcon.gameObject.SetActive(false);
  }
  ...
  private IEnumerator SetBackGround()
  {
    if (!((UnityEngine.Object) this.BgObject != (UnityEngine.Object) null))
    {
      ...
      {
        Future<UnityEngine.Sprite> f = new ResourceObject("Prefabs/BackGround/" + backgroundFile).Load<UnityEngine.Sprite>();
        IEnumerator e = f.Wait();
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
  ...
  {
    float num1 = this.ScrollView.transform.localPosition.y - this.ScrollStartY;
    ...
    for (int index = 0; index < this.Grid.transform.childCount; ++index)
    {
      ...
      {
        num2 = num3;
        corpsStageListItem = child.gameObject.GetComponent<CorpsStageListItem>();
      }
    ...
    if (!((UnityEngine.Object) corpsStageListItem != (UnityEngine.Object) null) || !((UnityEngine.Object) this.CurrentlListItem != (UnityEngine.Object) corpsStageListItem))
      return;
    ...
    this.LblRewardAchieved.gameObject.SetActive(this.CurrentlListItem.IsRewardGotten);
  ...
  private IEnumerator ShowEnemyListPopup()
  {
    ...
    yield return (object) null;
    IEnumerator e;
    if ((UnityEngine.Object) corpsQuestTopMenu.EnemyListPopupPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator ShowMapCheckPopup()
  {
    ...
    yield return (object) null;
    IEnumerator e;
    if ((UnityEngine.Object) corpsQuestTopMenu.MapCheckPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator ShowMissionListPopup()
  {
    ...
    yield return (object) null;
    IEnumerator e;
    if ((UnityEngine.Object) corpsQuestTopMenu.MissionListPrefab == (UnityEngine.Object) null)
    {
    ...
    Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
    Singleton<PopupManager>.GetInstance().open(popup.gameObject, isCloned: true);
  ...
  private IEnumerator ShowStageRewardPopup()
  {
    ...
    yield return (object) null;
    IEnumerator e;
    if ((UnityEngine.Object) corpsQuestTopMenu.StageRewardPrefab == (UnityEngine.Object) null)
    {
    ...
    else
    {
      ...
      switch (this.ViewMode)
      {
        ...
        case CorpsQuestTopMenu.Mode.Annihilation:
          ModalWindow.Show(Consts.GetInstance().CORPS_MODAL_UNIT_ANNIHILATION_TITLE, Consts.GetInstance().CORPS_MODAL_UNIT_ANNIHILATION_DESC, (System.Action) (() => {}));
          break;
      }
    }
  }
  ...
  private void SetMode(CorpsQuestTopMenu.Mode mode)
  {
    ...
    switch (this.ViewMode)
    {
      case CorpsQuestTopMenu.Mode.Normal:
        ...
        this.SetChallengeButtonEnable((UnityEngine.Object) this.CurrentlListItem != (UnityEngine.Object) null && !this.CurrentlListItem.IsCleared);
  ...
  private void SetChallengeButtonEnable(bool enable)
  {
    if (enable)
    {
      this.BtnBattleChallenge.isEnabled = true;
      this.TweenBattleChallengeSub.PlayReverse();
    }
    else
    {
      this.BtnBattleChallenge.isEnabled = false;
  ...
  {
    this.BtnEnemyInfo.isEnabled = enable;
    this.BtnMapInfo.isEnabled = enable;
    if (enable)
    {
  ...
  private IEnumerator MemberResetProc()
  {
    ...
    bool wait = true;
    bool cancel = false;
    PopupCommonNoYes.Show(Consts.GetInstance().CORPS_POPUP_PROGRESS_RESET_TITLE, Consts.GetInstance().CORPS_POPUP_PROGRESS_RESET_MESSAGE, (System.Action) (() => wait = false), (System.Action) (() =>
    {
      cancel = true;
      wait = false;
    }));
  ...
  {
    base.Update();
    float num = this.ScrollView.transform.localPosition.y - this.ScrollStartY;
