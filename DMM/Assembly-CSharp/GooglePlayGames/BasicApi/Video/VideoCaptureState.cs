...
namespace GooglePlayGames.BasicApi.Video
{
  public class VideoCaptureState
  {
    ...
    public override string ToString() => string.Format("[VideoCaptureState: mIsCapturing={0}, mCaptureMode={1}, mQualityLevel={2}, mIsOverlayVisible={3}, mIsPaused={4}]", (object) this.mIsCapturing, (object) this.mCaptureMode.ToString(), (object) this.mQualityLevel.ToString(), (object) this.mIsOverlayVisible, (object) this.mIsPaused);
  }
}
