...
namespace GooglePlayGames.OurUtils
{
  public class PlayGamesHelperObject : MonoBehaviour
  {
    ...
    public static bool RemoveFocusCallback(Action<bool> callback) => PlayGamesHelperObject.sFocusCallbackList.Remove(callback);
    ...
    public static bool RemovePauseCallback(Action<bool> callback) => PlayGamesHelperObject.sPauseCallbackList.Remove(callback);
  }
}
