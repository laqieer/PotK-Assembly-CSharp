...
public class Unit004ExtraskillEquipUnitListScene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, PlayerUnit targetUnit, PlayerAwakeSkill targetSkill) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_extraskill_equip_unit_list", (stack ? 1 : 0) != 0, (object) targetUnit, (object) targetSkill);
