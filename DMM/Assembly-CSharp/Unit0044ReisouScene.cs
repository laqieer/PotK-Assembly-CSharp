...
public class Unit0044ReisouScene : NGSceneBase
{
  ...
  public static void changeScene(bool bStack, EditReisouParam param) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_4_reisou", (bStack ? 1 : 0) != 0, (object) param);

  public static void ChangeScene(bool stack, ItemInfo gearInfo, ItemInfo reisouInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_4_reisou", (stack ? 1 : 0) != 0, (object) gearInfo, (object) reisouInfo);
  ...
  public void onStartScene(EditReisouParam param) => this.onStartScene((ItemInfo) null, (ItemInfo) null);
