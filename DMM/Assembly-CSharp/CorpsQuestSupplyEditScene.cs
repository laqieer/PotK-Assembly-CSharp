...
public class CorpsQuestSupplyEditScene : NGSceneBase
{
  ...
  public static void ChangeScene(object[] args, SupplyItem[] supplyItems) => CorpsQuestSupplyEditScene.changeScene(false, (PlayerCorps) args[0], (int[]) args[1], supplyItems, (CorpsUtil.SequenceType) args[2]);
