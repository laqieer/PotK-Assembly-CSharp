...
public class Guide0112BuguDetail : Unit00443Menu
{
  ...
  public IEnumerator Init(Guide01142Menu m, GearGear gear, bool isDispNumber)
  {
    ...
    if ((Object) guide0112BuguDetail.dirNumber != (Object) null)
    ...
    guide0112BuguDetail.indicatorPage1.transform.localScale = Vector3.one;
    e = guide0112BuguDetail.SetIncrementalParameter(guide0112BuguDetail.actualGear, guide0112BuguDetail.DirAddStauts);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Future<UnityEngine.Sprite> spriteF = guide0112BuguDetail.actualGear.LoadSpriteBasic();
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ...
    guide0112BuguDetail.DynWeaponIll.transform.localScale = (Vector3) new Vector2(0.8f, 0.8f);
  ...
  public void SetContainerPosition(Guide01142Menu m)
  {
    ...
    childInFind1.transform.localPosition = new Vector3(0.0f, (float) (((double) m.scroll.scrollView.panel.GetViewSize().y - (double) childInFind1.GetComponent<UIWidget>().height) / 2.0), 0.0f);
    Transform childInFind2 = this.transform.GetChildInFind("Bottom__anim_fade01");
    childInFind2.transform.localPosition = new Vector3(0.0f, (float) -(((double) m.scroll.scrollView.panel.GetViewSize().y - (double) childInFind2.GetComponent<UIWidget>().height) / 2.0), 0.0f);
  }
  ...
  {
    if ((Object) this.zoomButton == (Object) null)
      return;
