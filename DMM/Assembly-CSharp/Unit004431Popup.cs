...
public class Unit004431Popup : BackButtonMenuBase
{
  ...
  private IEnumerator createPopup()
  {
    ...
    this.beforeGearIcon = UnityEngine.Object.Instantiate<GameObject>(iconPrefab);
    ...
    this.afterGearIcon = UnityEngine.Object.Instantiate<GameObject>(iconPrefab);
  ...
  private IEnumerator SelectIcon()
  {
    ...
    unit004431Popup.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    if (unit004431Popup.TakeOffUnit != (PlayerUnit) null)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      unit004431Popup.GetComponent<UIWidget>().alpha = 1f;
  ...
  public void IbtnNo()
  {
    if (this.IsPushAndSet())
      return;
    if ((UnityEngine.Object) this.beforeGearIcon != (UnityEngine.Object) null)
      UnityEngine.Object.Destroy((UnityEngine.Object) this.beforeGearIcon);
    if ((UnityEngine.Object) this.afterGearIcon != (UnityEngine.Object) null)
      UnityEngine.Object.Destroy((UnityEngine.Object) this.afterGearIcon);
    if (this.beforeSkillTypeIcons != null)
    {
      foreach (UnityEngine.Object beforeSkillTypeIcon in this.beforeSkillTypeIcons)
        UnityEngine.Object.Destroy(beforeSkillTypeIcon);
    }
    if (this.afterSkillTypeIcons != null)
    {
      foreach (UnityEngine.Object afterSkillTypeIcon in this.afterSkillTypeIcons)
        UnityEngine.Object.Destroy(afterSkillTypeIcon);
    }
