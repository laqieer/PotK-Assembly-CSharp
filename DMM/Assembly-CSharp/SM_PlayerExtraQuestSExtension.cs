...
public static class SM_PlayerExtraQuestSExtension
{
  ...
  public static PlayerExtraQuestS[] L(
    this IEnumerable<PlayerExtraQuestS> self,
    bool checkedMaster = false)
  {
  ...
  public static PlayerExtraQuestS[] M_ClearedStory(
    this PlayerExtraQuestS[] self,
    int l)
  {
    Dictionary<int, StoryPlaybackExtra> dic = ((IEnumerable<StoryPlaybackExtra>) MasterData.StoryPlaybackExtraList).ToDictionary<StoryPlaybackExtra, int>((Func<StoryPlaybackExtra, int>) (x => x.quest.ID));
  ...
  public static PlayerExtraQuestS[] S_ClearedStory(
    this PlayerExtraQuestS[] self,
    int l,
    int m)
  {
  ...
  public static bool HasStory(this PlayerExtraQuestS self) => self.StoryDetails().Any<StoryPlaybackStoryDetail>();

  public static List<StoryPlaybackStoryDetail> StoryDetails(
    this PlayerExtraQuestS self)
  {
  ...
  public static PlayerQuestGate GetPlayerQuestGate(this PlayerExtraQuestS self)
  {
    ...
    return playerQuestGateArray == null ? (PlayerQuestGate) null : ((IEnumerable<PlayerQuestGate>) playerQuestGateArray).SingleOrDefault<PlayerQuestGate>((Func<PlayerQuestGate, bool>) (x => ((IEnumerable<int>) x.quest_ids).Any<int>((Func<int, bool>) (y => y == self._quest_extra_s))));
  }
