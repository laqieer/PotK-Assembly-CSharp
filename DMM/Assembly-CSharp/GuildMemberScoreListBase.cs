...
public class GuildMemberScoreListBase : BackButtonMonoBehaiviour
{
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.allScoreInfo.FirstIndexOrNull<GuildMemberScoreBarInfo>((Func<GuildMemberScoreBarInfo, bool>) (v => (UnityEngine.Object) v.scrollParts != (UnityEngine.Object) null && (UnityEngine.Object) v.scrollParts.gameObject == (UnityEngine.Object) unit));
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allScoreInfo.Count); ++index)
      this.allScoreBar.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<GuildMemberScoreScroll>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allScoreBar.Count); ++index)
      this.scroll.AddColumn1(this.allScoreBar[index].gameObject, this.barWidth, this.barHeight);
  ...
  protected void ResetScroll(int index)
  {
    ...
    this.allScoreInfo.Where<GuildMemberScoreBarInfo>((Func<GuildMemberScoreBarInfo, bool>) (a => (UnityEngine.Object) a.scrollParts == (UnityEngine.Object) scrollParts)).ForEach<GuildMemberScoreBarInfo>((System.Action<GuildMemberScoreBarInfo>) (b => b.scrollParts = (GuildMemberScoreScroll) null));
  }
