  ...
  protected override void LateUpdate_Battle()
  {
    ...
    else
    {
      ...
      if (!flag3 && skill.skill.target_type == BattleskillTargetType.myself)
        flag3 = this.modifiedUnit.value.skillEffects.CanUseSkill(skill.skill, skill.level, (BL.ISkillEffectListUnit) this.modifiedUnit.value, this.env.core, (BL.ISkillEffectListUnit) this.modifiedUnit.value, skill.nowUseCount) == 1;
      if (!flag3)
        flag3 = this.modifiedUnit.value.IsDontUseCommand(skill);
      if (!flag3)
        flag3 = !this.IsUIActive;
