...
public class GuildTownMapScroll : PopupMapCheckBase
{
    ...
    Guild0282MemberBaseMenu memberBaseMenu)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) guildTownMapScroll.testBattleBtn != (UnityEngine.Object) null)
      guildTownMapScroll.testBattleBtn.gameObject.SetActive(showTestBattleBtn && PlayerAffiliation.Current.guild.gvg_status != GvgStatus.fighting);
  }
  ...
  {
    if (this.isPush || (UnityEngine.Object) this.memberBaseMenu == (UnityEngine.Object) null)
      return;
    this.isPush = true;
