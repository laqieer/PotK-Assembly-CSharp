...
public class GuildDefTeamEditPopup : BackButtonMenuBase
{
  ...
  private int totalCombat
  {
    get
    {
      if (this.deckInfo == null)
        return 0;
      int combat = 0;
      ((IEnumerable<PlayerUnit>) this.deckInfo.player_units).ForEach<PlayerUnit>((System.Action<PlayerUnit>) (x =>
      {
  ...
  private IEnumerator SetDeck(string player_id)
  {
    if (this.deckInfo != null)
    {
      ...
      if (player_id != null)
      {
        ...
        e = GuildUtil.UpdateGuildDeckDefanse(this.isEnemy ? this.guild0282Menu.EnGuild.guild_id : this.guild0282Menu.MyGuild.guild_id, player_id, (System.Action) (() => isSuccess = true));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        if (!isSuccess)
  ...
  private IEnumerator ChangeDetailScene(PlayerUnit unit, bool isFriend, int index)
  {
    ...
    defTeamEditPopup.gameObject.SetActive(false);
  }
  ...
  public void ShowOkPopup(string title, string message, System.Action ok = null) => Singleton<PopupManager>.GetInstance().open(this.commonOkPopup).GetComponent<GuildOkPopup>().Initialize(title, message, ok: ok);
    ...
    GuildMembership info)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.btnTeamEdit.gameObject.SetActive(this.myself);
    this.btnTeamEdit.isEnabled = !this.onGuildBattle;
    this.dir_unavailable_teamformation.SetActive(this.myself && this.onGuildBattle);
    this.guild0282Menu.SetGvgPopup(GuildUtil.GvGPopupState.DefTeam, (System.Action) (() =>
    {
  ...
  public IEnumerator SetFriendUnit(GvgCandidate candidate)
  {
    ...
    if (candidate != null)
    {
      Future<WebAPI.Response.GvgDeckDefenseReinforcement> ft = WebAPI.GvgDeckDefenseReinforcement(candidate.player_id, (System.Action<WebAPI.Response.UserError>) (e =>
      {
        errCode = e.Code;
    ...
    else
    {
      ...
      Future<WebAPI.Response.GvgDeckDefenseRemoveReinforcement> ft = WebAPI.GvgDeckDefenseRemoveReinforcement((System.Action<WebAPI.Response.UserError>) (e =>
      {
        errCode = e.Code;
  ...
  {
    if (this.IsPushAndSet() || !this.gameObject.activeSelf || (this.parent.Mode != GuildDefTeamPopup.MODE.Edit || (UnityEngine.Object) this.guild0282Menu == (UnityEngine.Object) null))
      return;
  ...
  public void onClickedLeaderSkillZoom()
  {
    ...
    PopupSkillDetails.show(this.skillDetailPrefab, new PopupSkillDetails.Param(this.leaderSkill), this.isEnemy, new System.Action(this.onClosedSkillZoom));
  }
  ...
  public void onClickedFriendSkillZoom()
  {
    if (this.friendSkill == null || (UnityEngine.Object) this.skillDetailPrefab == (UnityEngine.Object) null || this.IsPushAndSet())
      return;
    this.guild0282Menu.isClosePopupByBackBtn = false;
    PopupSkillDetails.show(this.skillDetailPrefab, new PopupSkillDetails.Param(this.friendSkill), this.isEnemy, new System.Action(this.onClosedSkillZoom));
  }
}
