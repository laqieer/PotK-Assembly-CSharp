...
public class Unit004JobChangeCursor : MonoBehaviour
{
    ...
    EventDelegate.Callback btnCallback)
  {
    ...
    if (isCurrent)
    {
      if ((Object) sprFrame != (Object) null)
  ...
  {
    if ((Object) this.objChain_ != (Object) null)
      this.objChain_.SetActive(!unlock | conditionsLocked);
    if ((Object) this.objActive_ != (Object) null)
      this.objActive_.SetActive(activeChange && !conditionsLocked);
    if (!((Object) this.objUnopened_ != (Object) null))
      return;
  ...
  {
    if (!((Object) this.objFocus_ != (Object) null))
      return;
