...
public class MyPageGuildMenu : MyPageSubMenu
{
  ...
  [Header("Resource")]
  [SerializeField]
  private UnityEngine.Material mUi3dModelMaterial;
  ...
  private IEnumerator CreateGuildBase()
  {
    ...
    this.mGuildBase.GetComponent<BoxCollider>().enabled = false;
  ...
  private IEnumerator CreateUi3dModel()
  {
    ...
    this.mUi3dModel.uiTexture.depth = 5;
  }
  ...
  public void OnIntroFinished() => this.mUi3dModel.ModelCamera.gameObject.SetActive(true);

  public void OnEndScene() => this.mUi3dModel.ModelCamera.gameObject.SetActive(false);
  ...
  public void OnPushBBSView()
  {
    ...
    Singleton<PopupManager>.GetInstance().open(component.gameObject, isCloned: true);
  }
  ...
  public void OnPushBBSEdit()
  {
    ...
    component.InitializeBBSEditorDialog((System.Action) (() =>
    {
  ...
  private IEnumerator StartOpenGuildMemberPopup()
  {
    ...
    e = popup.Initialize(myPageGuildMenu.mGuildMemberObj, new System.Action(myPageGuildMenu.OnPushGuildMember));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator StartOpenGuildInfoPopup()
  {
    ...
    if (myPageGuildMenu.mGuildInfoPopup == null)
    {
      ...
      myPageGuildMenu.mGuildInfoPopup.SetSendRequestCallback(new System.Action(myPageGuildMenu.OnPushGuildInfo));
      myPageGuildMenu.mGuildInfoPopup.SetCancelRequestCallback(new System.Action(myPageGuildMenu.OnPushGuildInfo));
  ...
  private IEnumerator StartOpenBattleLog()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.mBattleLogPopupPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.mBattleMemberScorePopupPrefab == (UnityEngine.Object) null)
    {
    ...
    popup.transform.localScale = Vector3.zero;
    bool success = false;
    e = popup.InitializeAsync(false, this.mGuildData.guild_id, this.mBattleMemberScorePopupPrefab, (System.Action) (() => success = true));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (success)
  ...
  {
    Future<UnityEngine.Sprite> ft = EmblemUtility.LoadGuildEmblemSprite(this.mGuildData.appearance._current_emblem);
    IEnumerator e = ft.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private void UpdateRoleRelationObject()
  {
    ...
    this.mMessageEditBtn.gameObject.SetActive(guildMembership != null && guildMembership.role == GuildRole.master);
    if (guildMembership != null)
    {
      ...
      this.mMessageEditBtn.gameObject.SetActive(flag1);
    ...
    else
    {
      ...
      this.mMessageEditBtn.gameObject.SetActive(false);
