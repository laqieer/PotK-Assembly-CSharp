...
public class Quest002201Menu : UnitMenuBase
{
  ...
  private System.Action<GameObject[], NGMenuBase> openPopupUnityDetail_;
  ...
  private void createUnitIconAction(int unit_index)
  {
    ...
    unitIcon.onClick = (System.Action<UnitIconBase>) (_ => this.onClickIcon(unitIcon.PlayerUnit));
  }
  ...
  private void selectedUnit(PlayerUnit unit)
  {
    ...
    if ((UnityEngine.Object) unitIconBase != (UnityEngine.Object) null)
  ...
  {
    bool bUpdate = false;
    this.openPopupUnityDetail_ = (System.Action<GameObject[], NGMenuBase>) ((prefabs, menu) =>
    {
      if (prefabs == null)
        return;
      if (bUpdate)
      ...
      if ((UnityEngine.Object) questMenu != (UnityEngine.Object) null)
        questMenu.selectedUnit(unit);
      PopupUnityValueDetail.showSoloQuests(prefabs[0], prefabs[1], (float) unit.unity_value, unit.buildup_unity_value_f, unit, (System.Action<System.Action>) (endWait =>
      {
        bUpdate = true;
        ...
        object[] args = instance2.GetSavedChangeSceneParam().args;
        instance2.ReplaceSavedChangeSceneParamArgs(new object[3]
        {
          args[0],
          args[1],
          (object) unit.id
        });
        instance1.setSceneChangeLog(instance2.exportSceneChangeLog());
        instance1.OpenPopup = this.openPopupUnityDetail_;
        if (endWait != null)
          endWait();
        if (!((UnityEngine.Object) questMenu != (UnityEngine.Object) null))
          return;
        this.deselectedUnit();
      }), (System.Action<PopupUtility.SceneTo>) (_ => {}));
    });
    ...
    if (seekType.HasValue)
    {
      switch (seekType.GetValueOrDefault())
      {
        ...
        case QuestExtra.SeekType.L:
          ...
          if (campaignProgressArray != null && ((IEnumerable<QuestScoreCampaignProgress>) campaignProgressArray).Any<QuestScoreCampaignProgress>((Func<QuestScoreCampaignProgress, bool>) (x => x.quest_extra_l == master.quest_l_QuestExtraL)))
          {
