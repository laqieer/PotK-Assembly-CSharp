...
public class Unit004StatusDetailDialog : BackButtonMenuBase
{
  ...
  public virtual void Initialize(PlayerUnit playerUnit, UnityEngine.Sprite unitLargeSprite, bool isMemory = false)
  {
    ...
    this.txt_combina_add_title.gameObject.SetActive(playerUnit.unit.compose_max_unity_value_setting_id_ComposeMaxUnityValueSetting > 0);
  ...
  protected void SetUnitSprite(PlayerUnit playerUnit, UnityEngine.Sprite sprite)
  {
    this.dyn_Unit.sprite2D = sprite;
    this.dyn_Unit.GetComponent<NGxMaskSpriteWithScale>().FitMask();
  }
  ...
  private void setupProncessType(PlayerUnit playerUnit)
  {
    ...
    if ((UnityEngine.Object) this.txt_hime_type != (UnityEngine.Object) null && Singleton<NGGameDataManager>.GetInstance().IsSea)
  ...
  private void SetCombinePos(PlayerUnit playerUnit)
  {
    ...
    this.txt_combine_title.transform.localPosition = new Vector3((float) num2, this.txt_combine_title.transform.localPosition.y, this.txt_combine_title.transform.localPosition.z);
    ...
    for (int index = 0; index < this.StatusDetailList.Count; ++index)
    {
      ...
      Vector3 localPosition = statusDetail.Txt_combine.gameObject.transform.localPosition;
      statusDetail.Txt_combine.gameObject.transform.localPosition = new Vector3((float) num3, localPosition.y, localPosition.z);
      statusDetail.Txt_combine_max.gameObject.transform.localPosition = new Vector3((float) num4, localPosition.y, localPosition.z);
    }
  }
