...
public class Popup026821Menu : Popup02682MenuBase
{
    ...
    Versus0268Menu.PvpParam.CampaignNextReward nextReward)
  {
    ...
    IEnumerator e = this.icon.gameObject.GetOrAddComponent<CreateIconObject>().CreateThumbnail((MasterDataTable.CommonRewardType) reward.reward_type_id, reward.reward_id);
    while (e.MoveNext())
