...
public class Bugu0058Menu : BackButtonMenuBase
{
  ...
  [SerializeField]
  private UnityEngine.Sprite[] gearRankList;
  [SerializeField]
  ...
  public IEnumerator PakuPakuAPI()
  {
    ...
    Future<WebAPI.Response.ItemGearBuildup> f = WebAPI.ItemGearBuildup(this.gearEntryBase.itemID, this.gearEntryMaterial.Select<GameCore.ItemInfo, int>((Func<GameCore.ItemInfo, int>) (x => x.itemID)).ToArray<int>(), (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    if (f.Result != null)
    {
      ...
      Bugu00539Scene.ChangeScene(true, new Bugu00539ChangeSceneParam(numList, false, f.Result.animation_pattern, this.gearEntryBase, (PlayerItem) null, (System.Action) null, addReisouJewel));
  ...
  {
    Future<UnityEngine.Sprite> spriteF = gearData.gear.LoadSpriteBasic();
    IEnumerator e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.gearImg.sprite2D = spriteF.Result;
    this.gearImg.width = Mathf.FloorToInt(spriteF.Result.textureRect.width);
    this.gearImg.height = Mathf.FloorToInt(spriteF.Result.textureRect.height);
  }
  ...
  private void InitGearMaterialList() => this.gearMaterialList.ForEach((System.Action<GearAddMaterial>) (x => x.Init()));

  private IEnumerator SetGearMaterialList(
    GameCore.ItemInfo gearData,
  ...
  private void InitGearRank() => this.gearRank.gameObject.SetActive(false);
  ...
  {
    this.gearRank.gameObject.SetActive(true);
