...
public class Unit004CombinePage : Unit004TrainingPage
{
  ...
  private System.Action<GameObject[], NGMenuBase> popupUnityDetail;
  ...
  private IEnumerator Init()
  {
    ...
    if (unit004CombinePage1.baseUnitUnit_.IsEvolutioned)
    {
      ...
      if (list.Any<int>())
      {
        ...
        {
          Future<WebAPI.Response.UnitPreviewInheritance> future = WebAPI.UnitPreviewInheritance(unit004CombinePage1.baseUnit.id, list.ToArray(), (System.Action<WebAPI.Response.UserError>) (error =>
          {
    ...
    unit004CombinePage1.grid.transform.Clear();
    UnitUnit nextUnit = unit004CombinePage1.checkAwaking() ?? unit004CombinePage1.baseUnitUnit_;
    int limitBreakCount = 0;
    int b = unit004CombinePage1.grid.maxPerLine * unit004CombinePage1.tilingLine_;
    ...
    {
      unit004CombinePage1.uiDragScrollView.enabled = false;
      ...
      for (int index = 0; index < b; ++index)
        unit004CombinePage1.DirSozaiItemPrefab.CloneAndGetComponent<SozaiItem>(unit004CombinePage1.grid.transform).SetOnlyWLine();
    }
    else
    {
      unit004CombinePage1.uiDragScrollView.enabled = true;
      ...
      int numTile = Mathf.Max((unit004CombinePage1.selectUnits.Length + unit004CombinePage1.grid.maxPerLine - 1) / unit004CombinePage1.grid.maxPerLine * unit004CombinePage1.grid.maxPerLine, b);
      List<UIWidget> widgetList = new List<UIWidget>();
      for (int i = 0; i < numTile; ++i)
      {
        SozaiItem component1 = unit004CombinePage1.DirSozaiItemPrefab.CloneAndGetComponent<SozaiItem>(unit004CombinePage1.grid.transform);
        ...
        else
        {
          ...
          else
          {
            ...
            widgetList.AddRange((IEnumerable<UIWidget>) component2.gameObject.GetComponentsInChildren<UIWidget>());
            ...
            widgetList.AddRange((IEnumerable<UIWidget>) component3.gameObject.GetComponentsInChildren<UIWidget>());
            ...
            unitIcon.onClick = new System.Action<UnitIconBase>(unit004CombinePage1.\u003CInit\u003Eb__56_8);
            ...
            int num = nextUnit.breakthrough_limit - unit004CombinePage1.baseUnit.breakthrough_count;
    ...
    // ISSUE: reference to a compiler-generated method
    unit004CombinePage1.grid.onReposition = new UIGrid.OnReposition(unit004CombinePage1.\u003CInit\u003Eb__56_2);
    ...
    unit004CombinePage1.ibtnCombine.isEnabled = unit004CombinePage1.duplicationSelectUnits.Length != 0 && OverkillersUtil.checkDelete(((IEnumerable<PlayerUnit>) unit004CombinePage1.selectUnits).Where<PlayerUnit>((Func<PlayerUnit, bool>) (x => x.unit.IsNormalUnit)).ToArray<PlayerUnit>());
  }
  ...
  protected override IEnumerator loadResources()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) unit004CombinePage.upperParameterPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004CombinePage.upperParameterLabelPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004CombinePage.skillTypeIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004CombinePage.statusGaugePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004CombinePage.DirSozaiItemPrefab == (UnityEngine.Object) null)
    {
...
label_26:
  ...
  private void setPrice(PlayerUnit[] select) => this.setCostZeny(CalcUnitCompose.priceCompose(this.baseUnit, select));
  ...
  private void setUnityValue(PlayerUnit[] materialUnits)
  {
    ...
    if ((double) unityValueCount == 0.0 && (double) buildupUnityCount == 0.0)
    {
      ...
      this.TxtBuildupUnity.color = Color.white;
    }
    else
    {
      this.TxtUnity.color = Color.yellow;
      this.TxtBuildupUnity.color = Color.yellow;
    }
    double unityTotal = (double) this.baseUnit.unityTotal;
    double num = (double) Mathf.Min(this.baseUnit.unityTotal + unityValueCount + buildupUnityCount, MAX_UNITYVALUE);
    int integer = ((float) num).GetInteger();
    int decimalAsPercent = ((float) num).GetDecimalAsPercent();
    ...
    this.popupUnityDetail = (System.Action<GameObject[], NGMenuBase>) ((prefabs, m) =>
    {
      if (prefabs.Length != 2)
        return;
      ...
      PopupUnityValueDetail.show(prefabs[0], prefabs[1], unityValue, buildupUnity, target, (System.Action<System.Action>) (endWait =>
      {
        ...
        instance.returnSceneFromQuest = (System.Action) (() => Unit004CombinePage.returnSceneFromQuest(target));
        if (endWait == null)
          return;
        endWait();
      }), (System.Action<PopupUtility.SceneTo>) (_ => {}), bDisabledSelect);
    });
  }
  ...
  private int getTrustUpValue(PlayerUnit[] materialUnits)
  {
    ...
    foreach (PlayerUnit materialUnit in materialUnits)
    {
      if (materialUnit.unit.IsNormalUnit && materialUnit.unit.same_character_id == this.baseUnitUnit_.same_character_id)
        a += (int) materialUnit.trust_max_rate;
      else if (materialUnit.unit.IsPureValueUp)
        a += (int) materialUnit.trust_max_rate;
    }
    return Mathf.Min(a, PlayerUnit.GetTrustRateMax());
  }
  ...
  private void setLimitBreak(int limitBreakCount)
  {
    ...
    for (int breakthroughCount = this.baseUnit.breakthrough_count; breakthroughCount < num; ++breakthroughCount)
    {
      ...
      NGTween.playTweens(NGTween.findTweenersAll(uiSprite.gameObject, false), 0);
    }
  ...
  private IEnumerator setSkillIcon()
  {
    ...
    foreach (int key in allSkillIDs)
      intList1.Add(unit004CombinePage.baseUnit.evolutionSkill(MasterData.BattleskillSkill[key]).ID);
  ...
  private IEnumerator doCombine()
  {
    ...
    Future<WebAPI.Response.UnitCompose> paramF = WebAPI.UnitCompose(base_id, intList2.ToArray(), intList3.ToArray(), intList1.ToArray(), (System.Action<WebAPI.Response.UserError>) (error =>
    {
  ...
  private IEnumerator IbtnCombineAsync()
  {
    ...
    if (unit004CombinePage.isMaterialOverUsed)
    {
      bool bCancel = false;
      bool bWait = true;
      Singleton<PopupManager>.GetInstance().monitorCoroutine(PopupCommon.Show(consts.POPUP_00484_ALERT_TITLE, consts.POPUP_00484_MATERIAL_OVER_USE, (System.Action) (() =>
      {
        bCancel = true;
        bWait = false;
      })));
    ...
    if (isRarity | isMemoryAlert | isAlertOverkillersSlot)
    {
      ...
      PopupCommonNoYes.Show(instance.POPUP_00484_ALERT_TITLE, message, new System.Action(unit004CombinePage.combine), new System.Action(unit004CombinePage.cancelCombineAsync), alignment, messageB, alignmentB, true);
    }
    else
      yield return (object) unit004CombinePage.doCombine();
  }

  private void combine() => Singleton<PopupManager>.GetInstance().monitorCoroutine(this.doCombine());

  private void beginSequenceCombine() => Singleton<PopupManager>.GetInstance().open((GameObject) null, isViewBack: false);
  ...
  {
    System.Action<GameObject[], NGMenuBase> popupUnityDetail = this.popupUnityDetail;
  ...
  private IEnumerator doLoadResult()
  {
    ...
    if ((UnityEngine.Object) unit004CombinePage.resultBackground_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004CombinePage.resultMain_ == (UnityEngine.Object) null)
    {
      ld = new ResourceObject("Animations/Unit_Integration/dir_Unit_Integration").Load<GameObject>();
      yield return (object) ld.Wait();
      unit004CombinePage.resultMain_ = ld.Result.Clone(unit004CombinePage.mainMenu_.transform).GetComponent<Unit004813Menu>();
      unit004CombinePage.resultMain_.mode = Unit00468Scene.Mode.Unit0048;
      yield return (object) null;
      unit004CombinePage.resultMain_.gameObject.SetActive(false);
      ld = (Future<GameObject>) null;
    }
  }
  ...
  {
    Unit004CombinePage unit004CombinePage = this;
    while ((UnityEngine.Object) unit004CombinePage.resultBackground_ == (UnityEngine.Object) null || (UnityEngine.Object) unit004CombinePage.resultMain_ == (UnityEngine.Object) null)
      yield return (object) null;
    ...
    bool bWait = true;
    unit004CombinePage.resultMain_.onFinished = (System.Action) (() => bWait = false);
    ...
    Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
    unit004CombinePage.resultMain_.gameObject.SetActive(true);
    while (bWait)
      yield return (object) null;
