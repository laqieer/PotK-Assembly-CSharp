...
public class Quest00226Scene : NGSceneBase
{
  ...
  public static void ChangeScene(int Sid, bool stack = true) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_26", (stack ? 1 : 0) != 0, (object) Sid);
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    if (!quest00226Scene.IsInit)
    {
      ...
      IEnumerator e = quest00226Scene.GetComponent<BGChange>().ExtraBGprefabCreate("");
      while (e.MoveNext())
  ...
  public IEnumerator onStartSceneAsync(int Sid)
  {
    ...
    if (!quest00226Scene.IsInit)
    {
      ...
      quest00226Scene.IsInit = true;
      Future<WebAPI.Response.QuestscoreReward> reward = WebAPI.QuestscoreReward((System.Action<WebAPI.Response.UserError>) (e =>
      {
      ...
      if (reward.Result != null)
      {
        ...
        foreach (PlayerExtraQuestS playerExtraQuestS in Extra)
        {
          ...
          if (ex.quest_extra_s != null && ex.quest_extra_s.ID == Sid)
          {
            ...
            campaignData = ((IEnumerable<QuestScoreCampaignProgress>) campaignProgressArray).FirstOrDefault<QuestScoreCampaignProgress>((Func<QuestScoreCampaignProgress, bool>) (x => x.quest_extra_l == ex.quest_extra_s.quest_l.ID));
            break;
          }
        }
        ...
        if (campaignData != null)
          quest00226Scene.initialize = true;
        e1 = quest00226Scene.GetComponent<BGChange>().ExtraBGprefabCreate(name);
        while (e1.MoveNext())
          yield return e1.Current;
        e1 = (IEnumerator) null;
    ...
    {
      e1 = quest00226Scene.GetComponent<BGChange>().ExtraBGprefabCreate(quest00226Scene.bgName_);
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    }
