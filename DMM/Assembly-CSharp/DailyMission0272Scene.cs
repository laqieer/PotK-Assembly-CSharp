...
public class DailyMission0272Scene : NGSceneBase
{
  ...
  public static void ChangeScene0272(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("dailymission027_2", stack);
  ...
  {
    if ((Object) this.mainPanel != (Object) null)
