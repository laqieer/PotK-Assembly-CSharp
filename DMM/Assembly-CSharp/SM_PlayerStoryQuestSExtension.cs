...
{
  public static PlayerStoryQuestS[] XL(this PlayerStoryQuestS[] self) => ((IEnumerable<PlayerStoryQuestS>) self).Distinct<PlayerStoryQuestS>((IEqualityComparer<PlayerStoryQuestS>) new LambdaEqualityComparer<PlayerStoryQuestS>((Func<PlayerStoryQuestS, PlayerStoryQuestS, bool>) ((a, b) => a.quest_story_s.quest_xl.ID == b.quest_story_s.quest_xl.ID))).OrderBy<PlayerStoryQuestS, int>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.quest_xl.priority)).ToArray<PlayerStoryQuestS>();

  public static PlayerStoryQuestS[] L(this PlayerStoryQuestS[] self, int xl) => ((IEnumerable<PlayerStoryQuestS>) self).Where<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (q => q.quest_story_s.quest_xl.ID == xl)).Distinct<PlayerStoryQuestS>((IEqualityComparer<PlayerStoryQuestS>) new LambdaEqualityComparer<PlayerStoryQuestS>((Func<PlayerStoryQuestS, PlayerStoryQuestS, bool>) ((a, b) => a.quest_story_s.quest_l.ID == b.quest_story_s.quest_l.ID))).OrderBy<PlayerStoryQuestS, int>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.quest_l.priority)).ToArray<PlayerStoryQuestS>();

  public static PlayerStoryQuestS[] M(
    this PlayerStoryQuestS[] self,
    int xl,
    int l)
  {
  ...
  public static PlayerStoryQuestS[] S(
    this PlayerStoryQuestS[] self,
    int xl,
    int l,
    int m)
  ...
  public static PlayerStoryQuestS[] DisplayScrollM(
    this PlayerStoryQuestS[] self,
    int xl,
    int l)
  {
