...
public class NGSceneManager : Singleton<NGSceneManager>
{
  ...
  public void ClearSavedChangeSceneParam() => this.savedChangeSceneParam = (NGSceneManager.ChangeSceneParam) null;

  public void SaveCurrentChangeSceneParam() => this.savedChangeSceneParam = new NGSceneManager.ChangeSceneParam(this.currentScene.sceneBase.sceneName, this.currentScene.args, false, false);
  ...
  public bool isSceneInitialized => !this.isStartSceneInit && this.tempScene == null && this.loadAsync == null;
  ...
  public NGSceneManager.SceneLog FindAliveSceneLog()
  {
    ...
    for (sceneLog = this.stackChangeLog.Any<NGSceneManager.SceneLog>() ? this.stackChangeLog.Peek() : (NGSceneManager.SceneLog) null; sceneLog != null && !sceneLog.isAliveArgs; sceneLog = this.stackChangeLog.Any<NGSceneManager.SceneLog>() ? this.stackChangeLog.Peek() : (NGSceneManager.SceneLog) null)
  ...
  public List<NGSceneManager.SavedSceneLog> exportSceneChangeLog() => this.stackChangeLog.Select<NGSceneManager.SceneLog, NGSceneManager.SavedSceneLog>((Func<NGSceneManager.SceneLog, NGSceneManager.SavedSceneLog>) (x => new NGSceneManager.SavedSceneLog(x))).Reverse<NGSceneManager.SavedSceneLog>().ToList<NGSceneManager.SavedSceneLog>();
  ...
  {
    this.loadAsync = SceneManager.LoadSceneAsync(scene.name, LoadSceneMode.Additive);
    yield return (object) this.loadAsync;
  }

  public Coroutine loadResource(GameObject gameObject) => this.StartCoroutine(Singleton<ResourceManager>.GetInstance().LoadResource(gameObject));
  ...
  private string getTypeName(IEnumerable<System.Type> xs) => string.Join(", ", xs.Select<System.Type, string>((Func<System.Type, string>) (x => x.ToString())).ToArray<string>());
  ...
  private IEnumerator changeSceneUpdate(bool isBackScene)
  {
    ...
    while (true)
    {
      ...
      IEnumerator e;
      if (ngSceneManager.currentScene != null && (UnityEngine.Object) ngSceneManager.currentScene.sceneBase != (UnityEngine.Object) null)
      {
        ngSceneManager.currentScene.sceneBase.endTweens();
        ngSceneManager.currentScene.sceneBase.onEndScene();
        if (ngSceneManager.currentScene.sceneBase.currentSceneGuildChatDisplayingStatus != NGSceneBase.GuildChatDisplayingStatus.Closed && (UnityEngine.Object) Singleton<CommonRoot>.GetInstance().guildChatManager != (UnityEngine.Object) null)
      ...
      {
        while ((UnityEngine.Object) ngSceneManager.currentScene.sceneBase != (UnityEngine.Object) null && !ngSceneManager.currentScene.sceneBase.isTweenFinished)
        {
          if (!ngSceneManager.errorCheck())
          {
        ...
        if ((UnityEngine.Object) ngSceneManager.currentScene.sceneObject != (UnityEngine.Object) null)
        {
          if (ngSceneManager.currentScene.sceneBase.isAlphaActive)
            ngSceneManager.currentScene.sceneObject.GetComponent<UIPanel>().alpha = 0.0f;
          else
            ngSceneManager.currentScene.sceneObject.SetActive(false);
        }
        if ((UnityEngine.Object) ngSceneManager.currentScene.sceneBase != (UnityEngine.Object) null && ngSceneManager.currentScene.sceneBase.lockLayout == NGSceneBase.LockLayout.Heaven && !ngSceneManager.currentScene.sceneBase.IsModifiedIsSea)
      ...
      while ((UnityEngine.Object) ngSceneManager.tempScene.sceneObject == (UnityEngine.Object) null)
        yield return (object) new WaitForEndOfFrame();
      ...
      if ((UnityEngine.Object) tempUIPanel != (UnityEngine.Object) null)
        tempUIPanel.alpha = 0.0f;
      ...
      for (int index = 0; index < sceneWrapperArray.Length; ++index)
      {
        ...
        {
          if ((UnityEngine.Object) scene.sceneBase != (UnityEngine.Object) null)
          {
      ...
      while ((UnityEngine.Object) tmpCurrent.sceneBase != (UnityEngine.Object) null && !tmpCurrent.sceneBase.isTweenFinished)
      {
        yield return (object) null;
...
label_105:
  ...
  public bool IsSeaByChangeScene() => this.currentScene != null && (UnityEngine.Object) this.currentScene.sceneBase != (UnityEngine.Object) null && (this.currentScene.sceneBase.lockLayout == NGSceneBase.LockLayout.Heaven && !this.currentScene.sceneBase.IsModifiedIsSea) && this.currentScene.sceneBase.stackIsSea;
  ...
  private IEnumerator processChangeSceneQueueCore(
    NGSceneManager.ChangeSceneParam nextScene)
  {
    ...
    else
    {
      ...
      this.loadAsync = SceneManager.LoadSceneAsync(this.tempScene.name, LoadSceneMode.Additive);
      e = this.changeSceneUpdate(isBackScene);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  public void waitSceneAction(System.Action callback) => this.StartCoroutine(this.waitSceneActionImpl(callback));
  ...
  public string getSceneStackPath() => string.Join(".", this.stackChangeLog.Select<NGSceneManager.SceneLog, string>((Func<NGSceneManager.SceneLog, string>) (x => x.name)));
  ...
  public bool destroyScene(string sceneName) => this.loadedScenes.ContainsKey(sceneName) && this.destroyScene(this.loadedScenes[sceneName]);
  ...
  public bool destroyScene(GameObject sceneObject)
  {
    ...
    {
      if ((UnityEngine.Object) sceneWrapper.sceneObject == (UnityEngine.Object) sceneObject)
      {
        scene = sceneWrapper;
        break;
      }
  ...
  public bool destroyCurrentScene() => this.currentScene != null && this.destroyScene(this.currentScene);
  ...
  public IEnumerator destroyLoadedScenesImmediate()
  {
    this.clearStack();
    IEnumerator e;
    if (this.currentScene != null && (UnityEngine.Object) this.currentScene.sceneBase != (UnityEngine.Object) null)
    {
  ...
  public void onChangeSceneAwake(NGSceneBase sceneBase)
  {
    if (sceneBase.isAlphaActive)
      sceneBase.gameObject.GetComponent<UIPanel>().alpha = 0.0f;
    else
      sceneBase.gameObject.SetActive(false);
    ...
    foreach (Component componentsInChild in sceneBase.GetComponentsInChildren<UICamera>(true))
      UnityEngine.Object.Destroy((UnityEngine.Object) componentsInChild.gameObject);
    UIRoot component1 = sceneBase.gameObject.GetComponent<UIRoot>();
    if (!((UnityEngine.Object) component1 != (UnityEngine.Object) null))
      return;
    UIRoot component2 = Singleton<CommonRoot>.GetInstance().GetComponent<UIRoot>();
  ...
  public static MethodInfo getMethod(object obj, string methodName, object[] parameters)
  {
    ...
    if (array1.Length != 0)
    {
      ...
      {
        MethodInfo methodInfo = array1[index];
  ...
  public class SceneWrapper
  {
    ...
    public GameObject sceneObject => (UnityEngine.Object) this.sceneBase != (UnityEngine.Object) null ? this.sceneBase.gameObject : (GameObject) null;
    ...
    {
      if ((UnityEngine.Object) this.sceneObject == (UnityEngine.Object) null)
        return;
    ...
    public override string ToString() => string.Format("SceneWrapper {0} : {1} : {2} : {3} : {4}", (object) this.name, (object) this.args, (object) this.isStack, (object) this.sceneObject, (object) this.sceneBase);
  }
  ...
  public class SceneLog
  {
    ...
    {
      get => this.wArgs_ == null || !this.wArgs_.IsAlive ? new object[0] : (object[]) this.wArgs_.Target;
      protected set => this.wArgs_ = value == null || value.Length == 0 ? (WeakReference) null : new WeakReference((object) value);
    }
