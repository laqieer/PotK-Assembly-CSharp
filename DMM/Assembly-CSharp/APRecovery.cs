...
public class APRecovery : BackButtonMenuBase
{
  ...
  private IEnumerator DisplayAPRecoveryitemList()
  {
    ...
    targetContainer.GetComponent<APRecoveryScrollContainer>().SetBtnAct(this.btnAct);
    IEnumerator e = targetContainer.Create();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    targetContainer.SetVisible(true);
    targetContainer.scrollView.SetDragAmount(0.0f, targetContainer.scrollBar.value, true);
