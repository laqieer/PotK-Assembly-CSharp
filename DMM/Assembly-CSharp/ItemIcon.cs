...
public class ItemIcon : IconPrefabBase
{
  ...
  public UnityEngine.Sprite nonBackSpriteByJingi_;
  ...
  public UnityEngine.Sprite[] holyReisouRankNumSprite;
  public UnityEngine.Sprite[] chaosReisouRankNumSprite;
  ...
  public UnityEngine.Sprite[] renseiNumSprites;
  ...
  public bool NewItem
  {
    get => this.gear.root.activeSelf ? this.gear.newGear.activeSelf : this.supply.newSupply.activeSelf;
    set
    {
  ...
  {
    if (this.gear == null || (UnityEngine.Object) this.gear.blinkIcons == (UnityEngine.Object) null)
      return;
    ...
    this.gear.blinkIcons.gameObject.SetActive(false);
    ...
    if (num >= 2)
    {
      ...
      if (this.ForBattle)
        gameObjectList.Add(this.gear.forbattle);
      if (this.FusionPossible)
        gameObjectList.Add(this.gear.fusionPossible);
      this.gear.blinkIcons.resetBlinks((IEnumerable<GameObject>) gameObjectList);
    }
    if (!this.ForBattle && !this.FusionPossible)
      return;
    this.gear.blinkIcons.gameObject.SetActive(true);
  }
  ...
  {
    get => !((UnityEngine.Object) this.maxUpMark == (UnityEngine.Object) null) && this.maxUpMark.activeSelf;
    set
    {
  ...
  public IEnumerator InitByItemInfo(GameCore.ItemInfo info)
  {
    ...
    this.gear.blinkIcons.gameObject.SetActive(true);
    this.gear.blinkReisouRanks.gameObject.SetActive(false);
    IEnumerator e;
    if (!info.isSupply)
    {
  ...
  private void setReisouRank(GameCore.ItemInfo info)
  {
    ...
    if (info.gear.isMythologyReisou())
    {
      ...
      gameObjectList.Add(this.gear.chaosReisouRank);
      ...
      {
        int index1 = mythologyGearStatus.holy_gear_level / 10;
        int index2 = mythologyGearStatus.holy_gear_level % 10;
        this.gear.holyReisouRankDigit[0].GetComponent<UI2DSprite>().sprite2D = this.holyReisouRankNumSprite[index1];
        this.gear.holyReisouRankDigit[1].SetActive(true);
        this.gear.holyReisouRankDigit[1].GetComponent<UI2DSprite>().sprite2D = this.holyReisouRankNumSprite[index2];
      }
      gameObjectList.Add(this.gear.holyReisouRank);
    }
    else if (info.gear.isHolyReisou())
    {
      ...
      {
        int index1 = info.gearLevel / 10;
        int index2 = info.gearLevel % 10;
        this.gear.holyReisouRankDigit[0].GetComponent<UI2DSprite>().sprite2D = this.holyReisouRankNumSprite[index1];
        this.gear.holyReisouRankDigit[1].SetActive(true);
        this.gear.holyReisouRankDigit[1].GetComponent<UI2DSprite>().sprite2D = this.holyReisouRankNumSprite[index2];
      }
    ...
    if (gameObjectList.Count >= 2)
      this.gear.blinkReisouRanks.resetBlinks((IEnumerable<GameObject>) gameObjectList);
    this.gear.blinkReisouRanks.gameObject.SetActive(true);
  }
  ...
  public void initManaseedsInfo(GameCore.ItemInfo info) => this.InitManaseedsInfo(info.gear, info.gearAccessoryRemainingAmount);

  public void initManaseedsInfo(PlayerItem playerItem) => this.InitManaseedsInfo(playerItem.gear, playerItem.gear_accessory_remaining_amount);
  ...
  public static GameObject loadReisouEffect(bool isReisou, GearReisouType reisou_type)
  {
    switch (reisou_type)
    {
      ...
      case GearReisouType.chaos:
        if (isReisou)
        {
          if ((UnityEngine.Object) ItemIcon.reisouEffect02Prefab == (UnityEngine.Object) null)
        ...
        if ((UnityEngine.Object) ItemIcon.buguReisouEffect02Prefab == (UnityEngine.Object) null)
      ...
      case GearReisouType.mythology:
        if (isReisou)
        {
          if ((UnityEngine.Object) ItemIcon.reisouEffect03Prefab == (UnityEngine.Object) null)
        ...
        if ((UnityEngine.Object) ItemIcon.buguReisouEffect03Prefab == (UnityEngine.Object) null)
...
label_11:
  ...
  public static IEnumerator LoadSprite(GearGear gear, System.Action<UnityEngine.Sprite> callbackLoaded)
  {
    if (gear != null)
    {
  ...
  public static UnityEngine.Sprite GetSprite(GearGear gear)
  {
    if (gear == null)
      return (UnityEngine.Sprite) null;
    UnityEngine.Sprite sprite;
    return !ItemIcon.gearCache.TryGetValue(gear.ID, out sprite) ? (UnityEngine.Sprite) null : sprite;
  }
    ...
    PlayerItem customGearBase = null)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          if ((UnityEngine.Object) ItemIcon.reisouPopupDualSkillPrefab == (UnityEngine.Object) null)
          {
        ...
        {
          if ((UnityEngine.Object) ItemIcon.reisouPopupPrefab == (UnityEngine.Object) null)
          {
          ...
          if (isFusionPossible && (bool) (UnityEngine.Object) GameObject.Find("popup_Reisou_fusion(Clone)"))
  ...
  public bool Selected => this.EnabledGear ? this.gear.selectedBack.activeSelf : this.supply.selectedBack.activeSelf;
  ...
  public UnityEngine.Sprite IconSprite => !this.EnabledGear ? this.supply.icon.sprite2D : this.gear.icon.sprite2D;
  ...
  private void SetGearType(GearKind kind, CommonElement element)
  {
    ...
    else
    {
      ...
      UnityEngine.Sprite sprite = GearKindIcon.LoadSprite(kind.Enum, element);
      this.gear.type.GetComponent<UI2DSprite>().sprite2D = sprite;
      this.gear.type.SetActive(true);
    }
  }

  private void SetCross(ItemIcon.CounterDigits digits) => ((IEnumerable<GameObject>) new GameObject[4]
  {
  ...
  private void SetCrossBonus(ItemIcon.CounterDigits digits) => ((IEnumerable<GameObject>) new GameObject[4]
  {
  ...
  private UnityEngine.Sprite nonBackSpriteByJingi => (UnityEngine.Object) this.nonBackSpriteByJingi_ != (UnityEngine.Object) null ? this.nonBackSpriteByJingi_ : this.nonBackSprite;
  ...
  {
    if (this.gear.bottomBlink == null || (UnityEngine.Object) this.gear.bottomBlink.blink == (UnityEngine.Object) null)
      return;
    ...
    foreach (ItemIcon.ControlBottomBlink controlBottomBlink in controlBottomBlinkArray)
    {
      ...
      if (controlBottomBlink.blink.gameObject.activeSelf)
      {
        controlBottomBlink.blink.gameObject.SetActive(false);
  ...
  public static bool IsCache(SupplyItem supply) => supply != null && ItemIcon.supplyCache.ContainsKey(supply.Supply.ID);
  ...
  public void resetExpireDate()
  {
    ...
    else
    {
      ...
      {
        this.gear.star,
        this.gear.sortRankMaxRank.gameObject
      };
    }
    ...
    for (int index = 0; index < gameObjectArray.Length; ++index)
    {
      ...
      {
        gameObjectList.Add(gameObjectArray[index]);
        break;
      }
    }
    ...
    if (endAt.HasValue)
    {
      ...
      gameObjectList.Add(this.gear.currentBlink.remainDays);
    }
    else
    ...
    {
      this.gear.currentBlink.blink.gameObject.SetActive(true);
      this.gear.currentBlink.blink.resetBlinks((IEnumerable<GameObject>) gameObjectList);
    }
    else
      this.gear.currentBlink = (ItemIcon.ControlBottomBlink) null;
  }

  private bool IsRankGear(GameCore.ItemInfo item) => item != null && !item.isWeaponMaterial && (item.gear != null && item.gear.kind.isEquip) && item.gear.disappearance_type_GearDisappearanceType == 0;
  ...
  public void SetRenseiMaterialNum(int num)
  {
    if (num <= 0)
    {
      this.renseiMeterialNum[0].gameObject.SetActive(false);
      this.renseiMeterialNum[1].gameObject.SetActive(false);
    ...
    else
    {
      ...
      if (num < 10)
      {
        this.renseiMeterialNum[0].gameObject.SetActive(true);
        this.renseiMeterialNum[0].sprite2D = this.renseiNumSprites[num];
        this.renseiMeterialNum[1].gameObject.SetActive(false);
        this.renseiMeterialNum[2].gameObject.SetActive(false);
      }
      else
      {
        for (int index = 0; index < this.renseiMeterialNum.Length; ++index)
          this.renseiMeterialNum[index].gameObject.SetActive(false);
        int[] array = this.intToArray(num);
        int index1 = array.Length - 1;
        for (int index2 = 0; index2 < array.Length; ++index2)
        {
          this.renseiMeterialNum[index1].gameObject.SetActive(true);
  ...
  {
    if (this.gear == null || (UnityEngine.Object) this.gear.root == (UnityEngine.Object) null)
      return;
    ...
    if ((UnityEngine.Object) transform == (UnityEngine.Object) null)
    {
      ...
      if ((UnityEngine.Object) componentInChildren.trueTypeFont != (UnityEngine.Object) null)
      ...
      uiLabel.height = 84;
      uiLabel.width = 84;
      uiLabel.depth = (int) byte.MaxValue;
      uiLabel.text = "神";
      uiLabel.effectStyle = UILabel.Effect.None;
      uiLabel.applyGradient = false;
    }
    transform.gameObject.SetActive(target != null && target.is_jingi);
  }
