...
public class Unit00499Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, PlayerUnit playerUnit, Unit00499Scene.Mode mode) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_9_9", (stack ? 1 : 0) != 0, (object) playerUnit, (object) mode);
  ...
  public IEnumerator onStartSceneAsync(PlayerUnit playerUnit, Unit00499Scene.Mode mode)
  {
    ...
    if (mode == Unit00499Scene.Mode.Evolution || mode == Unit00499Scene.Mode.AwakeUnit || mode == Unit00499Scene.Mode.CommonAwakeUnit)
    {
      ...
      Future<WebAPI.Response.UnitEvolutionParameter> paramF = WebAPI.UnitEvolutionParameter(playerUnit.unit.IsMaterialUnit ? playerUnit.id : 0, playerUnit.unit.IsNormalUnit ? playerUnit.id : 0, 0, array, (System.Action<WebAPI.Response.UserError>) (e =>
      {
    ...
    {
      Future<WebAPI.Response.UnitTransmigrateParameter> paramF = WebAPI.UnitTransmigrateParameter(playerUnit.id, playerUnit.unit.TransmigratePattern.ID, (System.Action<WebAPI.Response.UserError>) (e =>
      {
        WebAPI.DefaultUserErrorCallback(e);
        MypageScene.ChangeSceneOnError();
      }));
