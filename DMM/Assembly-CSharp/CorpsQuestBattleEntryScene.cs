...
public class CorpsQuestBattleEntryScene : NGSceneBase
{
  ...
  public static void ChangeScene(int periodId, int stageId) => Singleton<NGSceneManager>.GetInstance().changeScene("CorpsQuest_battle_entry", true, (object) periodId, (object) stageId);
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    battleEntryScene.menu = battleEntryScene.menuBase.GetComponent<CorpsQuestBattleEntryMenu>();
  ...
  public IEnumerator onBackSceneAsync(int periodId, int stageId)
  {
    ...
    {
      Future<WebAPI.Response.QuestCorpsTop> f = WebAPI.QuestCorpsTop(periodId, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
  ...
  public void onStartScene(int periodId, int stageId) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
