...
public class Guild011PledgeMenu : BackButtonMenuBase
{
  ...
  private IEnumerator CreateUnitIcon(GameObject prefab)
  {
    ...
    UnitIcon firstUnitIcon = UnityEngine.Object.Instantiate<GameObject>(prefab, guild011PledgeMenu1.firsrUnit.transform).GetComponent<UnitIcon>();
    ...
    {
      GameObject UnitIconObj = UnityEngine.Object.Instantiate<GameObject>(prefab, guild011PledgeMenu1.scrollGrid.gameObject.transform);
      ...
      UnityEngine.Object.Instantiate<GameObject>(guild011PledgeMenu1.pledgeNumPrefab, UnitIconObj.transform).GetComponent<PledgeHimeNum>().SetPledgeNum(guild011PledgeMenu1.divorceList[i].divorce_number);
