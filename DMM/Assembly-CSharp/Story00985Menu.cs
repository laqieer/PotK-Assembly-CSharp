...
public class Story00985Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitScene(QuestExtraS extra_m, bool listBack, int id)
  {
    ...
    foreach (QuestExtraS questExtraS in list)
    {
      ...
      ((IEnumerable<StoryPlaybackExtraDetail>) MasterData.StoryPlaybackExtraDetailList).ForEach<StoryPlaybackExtraDetail>((System.Action<StoryPlaybackExtraDetail>) (detail =>
      {
  ...
  {
    GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.scrollPartsPrefab);
