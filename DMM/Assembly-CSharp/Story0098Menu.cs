...
public class Story0098Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitScene(bool connect)
  {
    ...
    if (connect || gameDataManager.clearedExtraQuestSIds == null || (gameDataManager.clearedTowerStageIds == null || gameDataManager.clearedRaidQuestSIds == null))
    {
      ...
      Future<WebAPI.Response.QuestHistoryExtra> ft = WebAPI.QuestHistoryExtra(new System.Action<WebAPI.Response.UserError>(story0098Menu.\u003CInitScene\u003Eb__8_0));
      e = ft.Wait();
      while (e.MoveNext())
  ...
  {
    GameObject scrollObj = UnityEngine.Object.Instantiate<GameObject>(prefab);
    scrollObj.transform.parent = this.scroll.grid.transform;
