...
public class GuildAtkGuestSelectPopup : GuildGuestListBase
{
  ...
  protected override IEnumerator CreateScroll(int info_index, int bar_index)
  {
    ...
    if (bar_index < guestSelectPopup.allGuestBar.Count && info_index < guestSelectPopup.allGuestInfo.Count)
    {
      ...
      IEnumerator e = scrollParts.InitializeAsync(guestBarInfo.friend, GuildGuestSelectScroll.MODE.Atk, new System.Action<GvgCandidate>(guestSelectPopup.\u003CCreateScroll\u003Eb__9_0));
      while (e.MoveNext())
  ...
  public void SetGvgPopup() => this.guild0282Menu.SetGvgPopup(GuildUtil.GvGPopupState.Sortie, (System.Action) (() =>
  {
  ...
  {
    if (this.IsPushAndSet() || !this.gameObject.activeSelf || this.parent.Mode != GuildBattlePreparationPopup.MODE.Guest)
      return;
