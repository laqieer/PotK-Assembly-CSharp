...
public class MypageRootMenu : BackButtonMenuBase
{
  ...
  public IEnumerator InitSceneAsync()
  {
    ...
    rootMenu.mScene = rootMenu.GetComponent<MypageScene>();
  ...
  {
    if (introFinished)
      yield return (object) this.WaitForUIAnimationFinish(0, (System.Action) (() => Singleton<CommonRoot>.GetInstance().ShowLoadingLayer(0)));
    else
      yield return (object) this.WaitForUIAnimationFinish(0, (System.Action) (() => MypageRootMenu.sFirstPlay = true));
  }
  ...
  private IEnumerator LoadResources()
  {
    ...
    this.mGuildMenu.gameObject.name = "dir_Guild";
  ...
  public void SwitchMode()
  {
    ...
    this.StartCoroutine(this.WaitForUIAnimationFinish(0, (System.Action) (() =>
    {
  ...
  public void SwitchGuildMenu()
  {
    ...
    this.StartCoroutine(this.WaitForUIAnimationFinish(1, (System.Action) (() => this.IsPush = false)));
  }
  ...
  private IEnumerator WaitForUIAnimationFinish(int layer, System.Action finishCallback = null)
  {
    ...
    while ((double) this.mUiAnimController.GetCurrentAnimatorStateInfo(layer).normalizedTime < 1.0);
  ...
  public virtual IEnumerator CloudAnimationStart()
  {
    ...
    IEnumerator e = Singleton<CommonRoot>.GetInstance().StartCloudAnim(MypageCloudAnim.HeavenOut, MypageCloudAnim.EarthIn, new System.Action(mypageRootMenu.\u003CCloudAnimationStart\u003Eb__43_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator CheckAndStartHotDeal()
  {
    ...
    if (MypageRootMenu.CurrentMode == MypageRootMenu.Mode.STORY)
    {
      ...
      if (info != null)
      {
        ...
        IEnumerator e = mypageRootMenu.WaitForUIAnimationFinish(0, (System.Action) (() => {}));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
  ...
  private void StartBeginnersQuestAdvice01() => Singleton<TutorialRoot>.GetInstance().ForceShowAdviceInNextButton("2020_home2_tutorial01", new Dictionary<string, Func<Transform, UIButton>>()
  {
    {
      "chapter_home_Quest",
  ...
  private void StartBeginnersQuestAdvice02() => Singleton<TutorialRoot>.GetInstance().ForceShowAdviceInNextButton("2020_home2_tutorial02", new Dictionary<string, Func<Transform, UIButton>>()
  {
    {
      "chapter_home_Quest_Event",
      (Func<Transform, UIButton>) (root => root.GetChildInFind("Bottom").GetComponentInChildren<UIButton>())
    }
  }, (System.Action) (() => Singleton<CommonRoot>.GetInstance().GetHeavenCommonFooter().onButtonOpenEventQuest()));
