...
public class BattleUI01ShortCutConfig : BattleMonoBehaviour
{
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    if ((ui01ShortCutConfig.battleManager.isPvp || ui01ShortCutConfig.battleManager.isPvnpc) && !PerformanceConfig.GetInstance().EnablePvPAutoButton)
    {
      ...
      ui01ShortCutConfig.btnEnabledAutoBattle_.gameObject.SetActive(false);
      ui01ShortCutConfig.btnDisabledAutoBattle_.gameObject.SetActive(false);
    ...
    bool enabledBattleSpeed)
  {
    ...
    this.isControlAutoBattle_ = enabledAutoBattle && (UnityEngine.Object) this.topAutoBattle_ != (UnityEngine.Object) null && ((UnityEngine.Object) this.btnEnabledAutoBattle_ != (UnityEngine.Object) null && (UnityEngine.Object) this.btnDisabledAutoBattle_ != (UnityEngine.Object) null) && (UnityEngine.Object) this.objWaitAutoBattle_ != (UnityEngine.Object) null;
    if (!this.isControlAutoBattle_ && (UnityEngine.Object) this.topAutoBattle_ != (UnityEngine.Object) null)
    {
      if (flag)
        ((IEnumerable<UIButton>) this.topAutoBattle_.transform.GetComponentsInChildren<UIButton>()).ForEach<UIButton>((System.Action<UIButton>) (x => x.isEnabled = false));
      else
        this.topAutoBattle_.SetActive(false);
    }
    this.isControlSimpleBattle_ = enabledSimpleBattle && (UnityEngine.Object) this.topSimpleBattle_ != (UnityEngine.Object) null && ((UnityEngine.Object) this.btnEnabledSimpleBattle_ != (UnityEngine.Object) null && (UnityEngine.Object) this.btnDisabledSimpleBattle_ != (UnityEngine.Object) null) && (UnityEngine.Object) this.objWaitSimpleBattle_ != (UnityEngine.Object) null;
    if (!this.isControlSimpleBattle_ && (UnityEngine.Object) this.topSimpleBattle_ != (UnityEngine.Object) null)
    {
      if (flag)
        ((IEnumerable<UIButton>) this.topSimpleBattle_.transform.GetComponentsInChildren<UIButton>()).ForEach<UIButton>((System.Action<UIButton>) (x => x.isEnabled = false));
      else
        this.topSimpleBattle_.SetActive(false);
    }
    this.isControlBattleSpeed_ = enabledBattleSpeed && (UnityEngine.Object) this.topBattleSpeed_ != (UnityEngine.Object) null;
    if (!this.isControlBattleSpeed_ && (UnityEngine.Object) this.topBattleSpeed_ != (UnityEngine.Object) null)
      this.topBattleSpeed_.SetActive(false);
    this.isControlAll_ = (UnityEngine.Object) this.topConfig_ != (UnityEngine.Object) null && (UnityEngine.Object) this.selectNode_ != (UnityEngine.Object) null && (this.isControlAutoBattle_ || this.isControlSimpleBattle_ || this.isControlBattleSpeed_);
    if (!((UnityEngine.Object) this.topConfig_ != (UnityEngine.Object) null))
      return;
    if (this.isControlAll_)
  ...
  {
    if ((UnityEngine.Object) this.selectNode_ != (UnityEngine.Object) null && (this.selectNode_.IsPush || this.selectNode_.IsForceAutoDisable) || (this.isWait_ || !this.isControlAutoBattle_))
      return;
  ...
  {
    if ((UnityEngine.Object) btn == (UnityEngine.Object) this.btnEnabledAutoBattle_)
    {
  ...
  {
    BattleUI01ShortCutConfig ui01ShortCutConfig = this;
    if ((UnityEngine.Object) btn == (UnityEngine.Object) ui01ShortCutConfig.btnEnabledAutoBattle_)
    {
...
label_8:
  ...
  {
    if ((UnityEngine.Object) btn == (UnityEngine.Object) this.btnEnabledSimpleBattle_)
    {
