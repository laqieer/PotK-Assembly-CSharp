...
public class Quest052171Scroll : BannerBase
{
  ...
  private string GetSpritePath(int id, bool canplay) => BannerBase.GetSpriteIdlePath(id, BannerBase.Type.quest_lock, QuestExtra.SeekType.None, canplay, true);
  ...
  public void StartQuestReleasePopup(EarthExtraQuest quest, MasterDataTable.EarthQuestKey questKey) => this.StartCoroutine(this.OpenQuestReleasePopup(quest, questKey, this.menu, this));
