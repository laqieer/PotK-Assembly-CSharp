...
public class ExploreRankingRewardPopupSequence : MonoBehaviour
{
  ...
  private IEnumerator LoadPopupPrefab()
  {
    Future<GameObject> f;
    IEnumerator e;
    if ((Object) this.exploreRankingResultAnimPrefab == (Object) null)
    {
    ...
    if ((Object) this.exploreResultRewardPrefab == (Object) null)
    {
