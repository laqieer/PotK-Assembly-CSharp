...
public class GearIconWithNumber : MonoBehaviour
{
  ...
  private void onClickButton() => Singleton<NGSceneManager>.GetInstance().changeScene("guide011_4_1", true, (object) this.gearData);
  ...
  public IEnumerator SetGear(GearGear gear, bool contains, BattleInfo info = null)
  {
    ...
    GearGear gear1 = contains ? gearIconWithNumber.gearData : (GearGear) null;
    e = itemIcon.InitByGear(gear1, gear1 != null ? gear1.GetElement() : CommonElement.none);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (contains)
