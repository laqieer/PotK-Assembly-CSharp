...
public class Quest00214DetailDisplay : MonoBehaviour
{
  ...
  {
    this.Txt_GenderRestriction.gameObject.SetActive(false);
    ...
    int num)
  {
    ...
    if ((UnityEngine.Object) this.Txt_Rest != (UnityEngine.Object) null)
    {
      ...
      this.Txt_Rest.GetComponent<UIWidget>().color = color;
    ...
    {
      this.Txt_GenderRestriction.gameObject.SetActive(true);
