...
public class ExtraSkillSortAndFilter : SortAndFilter
{
  ...
  public System.Action SortFilterSkillNum;
  ...
  public void SetValueWindow()
  {
    ...
    foreach (ExtraSkillSortAndFilterButton filterBtn in this.FilterBtns)
    {
      if (!((UnityEngine.Object) filterBtn == (UnityEngine.Object) null) && filterBtn.gameObject.activeSelf)
      {
  ...
  public static UISprite SortSpriteLabel(
    ...
    UISprite SortSprite)
  {
    string str = ExtraSkillSortAndFilter.SetSortLabelSpriteName(type);
    if (!string.IsNullOrEmpty(str))
    {
      string name = string.Format("slc_Label_{0}.png__GUI__unit_title_short__unit_title_short_prefab", (object) str);
