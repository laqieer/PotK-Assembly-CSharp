...
public class Battle01718Menu : BattleBackButtonMenuBase
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    if ((UnityEngine.Object) battle01718Menu.waveDir != (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) battle01718Menu.auto_button != (UnityEngine.Object) null)
    ...
    if ((UnityEngine.Object) battle01718Menu.mission_button != (UnityEngine.Object) null)
    ...
    {
      if ((UnityEngine.Object) battle01718Menu.btnSimpleStandby != (UnityEngine.Object) null)
        battle01718Menu.btnSimpleStandby.isEnabled = false;
      if ((UnityEngine.Object) battle01718Menu.btnSkillConfirmation != (UnityEngine.Object) null)
        battle01718Menu.btnSkillConfirmation.isEnabled = false;
    }
  }
  ...
  private IEnumerator setupMapChips()
  {
    ...
    float b = (float) inParents.height / (float) fieldHeight;
    int size = (int) Mathf.Min((float) inParents.width / (float) fieldWidth, b);
