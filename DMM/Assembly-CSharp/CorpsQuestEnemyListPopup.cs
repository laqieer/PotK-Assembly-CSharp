...
public class CorpsQuestEnemyListPopup : BackButtonMonoBehaiviour
{
  ...
  private const float GRAY = 0.4196078f;
  [SerializeField]
  ...
  private IEnumerator CreateUnitIcon(bool isCleared)
  {
    ...
    for (i = 0; i < Mathf.Min(UnitIcon.MaxValue, this.allEnemyInfo.Count); ++i)
    {
      ...
      this.scroll.Add(unitIcon.gameObject, UnitIcon.Width, flag ? UnitIcon.HeightWithHpGauge : UnitIcon.Height);
    ...
    PlayerUnit baseUnit = null)
  {
    ...
    this.allEnemyInfo.Where<CorpsQuestEnemyListPopup.EnemyUnitIconInfo>((Func<CorpsQuestEnemyListPopup.EnemyUnitIconInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)).ForEach<CorpsQuestEnemyListPopup.EnemyUnitIconInfo>((System.Action<CorpsQuestEnemyListPopup.EnemyUnitIconInfo>) (b => b.icon = (UnitIconBase) null));
  ...
  private PlayerUnit[] getUnits() => this.allEnemyInfo.Select<CorpsQuestEnemyListPopup.EnemyUnitIconInfo, PlayerUnit>((Func<CorpsQuestEnemyListPopup.EnemyUnitIconInfo, PlayerUnit>) (x => x.playerUnit)).ToArray<PlayerUnit>();
