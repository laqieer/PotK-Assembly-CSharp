...
public class Battle01SkillUse : NGBattleMenuBase
{
  ...
  public void setCallSkillTargets(BL.Skill skill, List<BL.Unit> targets)
  {
    ...
    Singleton<NGBattleManager>.GetInstance().getController<BattleInputObserver>().setTargetSelectMode(attackTargets, healTargets, list2, panels, (System.Action<BL.Unit, BL.Panel>) ((u, p) =>
    {
      Battle01CommandSkillUse[] componentsInChildren = this.GetComponentsInChildren<Battle01CommandSkillUse>();
      if (componentsInChildren.Length == 0)
        return;
  ...
  public void onClickedZoom()
  {
    ...
    if (!((UnityEngine.Object) this.skillDetailPrefab != (UnityEngine.Object) null) || obj == null)
      return;
  ...
  private IEnumerator OpenCallSkillPopup(BattleskillSkill s)
  {
    ...
    if ((UnityEngine.Object) battle01SkillUse.callSkillDetailPrefab == (UnityEngine.Object) null)
    {
  ...
  public void SetDetailCollider(bool value) => this.btnSkillAll.enabled = value;
