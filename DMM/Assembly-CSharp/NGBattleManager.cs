...
public class NGBattleManager : Singleton<NGBattleManager>
{
  ...
  public bool isPvnpc
  {
    get
    {
      if ((UnityEngine.Object) this._pvnpcManager != (UnityEngine.Object) null)
        return true;
      return this.mBattleInfo != null && this.mBattleInfo.pvp && this.mBattleInfo.pvp_vs_npc;
    }
  }
  ...
  public bool isGvg => (UnityEngine.Object) this._gvgManager != (UnityEngine.Object) null;
  ...
  public bool isTower => this.mBattleInfo != null && this.mBattleInfo.quest_type == CommonQuestType.Tower;

  public bool isRaid => this.mBattleInfo != null && this.mBattleInfo.quest_type == CommonQuestType.GuildRaid;

  public bool isCorps => this.mBattleInfo != null && this.mBattleInfo.quest_type == CommonQuestType.Corps;

  public bool isRaidBoss(BL.Unit unit) => this.isRaid && this.environment.core.enemyUnits.value.First<BL.Unit>((Func<BL.Unit, bool>) (u => u.playerUnit.id == this.battleInfo.raidBossDamage.Key)).Equals(unit);
  ...
  public IGameEngine gameEngine
  {
    get
    {
      ...
      return (UnityEngine.Object) this._gvgManager != (UnityEngine.Object) null ? (IGameEngine) this._gvgManager : (IGameEngine) null;
    }
  }
  ...
  public bool isSea => this.mBattleInfo != null && this.mBattleInfo.isSea && this.mBattleInfo.seaQuest != null;
  ...
  protected override void Initialize() => this.managerList = new List<System.Type>()
  {
  ...
  {
    Future<WebAPI.Response.BattleResume> battleF = WebAPI.BattleResume((System.Action<WebAPI.Response.UserError>) (e => ModalWindow.Show(e.Code, e.Reason, (System.Action) (() =>
    {
    ...
    if (battleF.Result != null)
    {
      ...
      if (battle.wave_stage.Length != 0)
      {
        ...
        this.mBattleInfo = BattleInfo.MakeBattleInfo(battle.battle_uuid, (CommonQuestType) battle.quest_type, battle.quest_s_id, battle.deck_type_id, battle.quest_loop_count, battle.deck_number, helper, guests, (IEnumerable<BattleInfo.Wave>) waveList);
      }
      else
      {
  ...
  {
    Future<WebAPI.Response.TowerBattleResume> ft = WebAPI.TowerBattleResume((System.Action<WebAPI.Response.UserError>) (e => ModalWindow.Show(e.Code, e.Reason, (System.Action) (() =>
    {
      NGSceneManager instance = Singleton<NGSceneManager>.GetInstance();
      instance.clearStack();
      instance.destroyCurrentScene();
  ...
  {
    bool errorWait = true;
    Future<WebAPI.Response.QuestCorpsBattleResume> battleF = WebAPI.QuestCorpsBattleResume((System.Action<WebAPI.Response.UserError>) (e => ModalWindow.Show(e.Code, e.Reason, (System.Action) (() => errorWait = false))));
    IEnumerator e1 = battleF.Wait();
    while (e1.MoveNext())
      yield return e1.Current;
    e1 = (IEnumerator) null;
  ...
  {
    bool errorWait = true;
    Future<WebAPI.Response.GuildraidBattleResume> battleF = WebAPI.GuildraidBattleResume((System.Action<WebAPI.Response.UserError>) (e => ModalWindow.Show(e.Code, e.Reason, (System.Action) (() => errorWait = false))));
    IEnumerator e1 = battleF.Wait();
    while (e1.MoveNext())
      yield return e1.Current;
    e1 = (IEnumerator) null;
  ...
  private IEnumerator resumeQuestFromWeb(
    bool isModeResume,
    CommonQuestType mode,
    int period_id)
  {
    if (isModeResume)
    {
  ...
  public IEnumerator initBattle()
  {
    if (!this._thisInitialized)
    {
      ...
      float num = 960f / (float) Singleton<CommonRoot>.GetInstance().GetComponent<UIRoot>().manualHeight;
  ...
  {
    IEnumerator e;
    if ((UnityEngine.Object) this.managers != (UnityEngine.Object) null)
    {
      System.Type[] typeArray = this.managerList;
      for (int index = 0; index < typeArray.Length; ++index)
      {
      ...
      typeArray = (System.Type[]) null;
      UnityEngine.Object.Destroy((UnityEngine.Object) this.managers);
      this.managers = (GameObject) null;
    }
    if ((UnityEngine.Object) this.effects != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) this.effects);
  ...
  public T getManager<T>() where T : BattleManagerBase => (UnityEngine.Object) this.managers == (UnityEngine.Object) null ? default (T) : this.managers.GetComponent<T>();

  public T getController<T>() where T : BattleMonoBehaviour => (UnityEngine.Object) this.managers == (UnityEngine.Object) null ? default (T) : this.managers.GetComponent<T>();
  ...
  public List<string> createResourceLoadList(BattleInfo info = null)
  {
    ...
    if (this.isOvo)
    {
      foreach (PlayerUnit playerUnit in ((IEnumerable<PlayerUnit>) info.pvp_player_units).Where<PlayerUnit>((Func<PlayerUnit, bool>) (x => x != (PlayerUnit) null)))
        stringList.AddRange((IEnumerable<string>) instance.PathsFromUnit(playerUnit.unit));
    ...
    else
    {
      ...
      if (info.helper != null && info.helper.leader_unit != (PlayerUnit) null && info.helper.leader_unit.unit != null)
        stringList.AddRange((IEnumerable<string>) instance.PathsFromUnit(info.helper.leader_unit.unit));
      if (info.Enemies != null)
      {
        foreach (BattleStageEnemy enemy in info.Enemies)
          stringList.AddRange((IEnumerable<string>) instance.PathsFromUnit(enemy.unit));
      }
      if (info.user_units != null)
      {
        foreach (PlayerUnit userUnit in info.user_units)
          stringList.AddRange((IEnumerable<string>) instance.PathsFromUnit(userUnit.unit));
      }
      if (this.battleInfo.quest_type == CommonQuestType.Earth || this.battleInfo.quest_type == CommonQuestType.EarthExtra)
      {
        if (info.EarthGuests != null)
        {
          foreach (BattleEarthStageGuest earthGuest in info.EarthGuests)
            stringList.AddRange((IEnumerable<string>) instance.PathsFromUnit(earthGuest.unit));
        }
      }
      else if (info.Guests != null)
      {
        foreach (BattleStageGuest guest in info.Guests)
          stringList.AddRange((IEnumerable<string>) instance.PathsFromUnit(guest.unit));
      }
    }
    stringList.AddRange((IEnumerable<string>) instance.PathsFromBattleMap(info.stage.map));
    return stringList;
  }
    ...
    BL.Unit defense)
  {
    ...
    foreach (Tuple<BL.Unit, BattleskillSkill> key1 in skillTargets.Keys)
    {
      ...
      if (skillTargets[key].Count<BL.Unit>() >= 1)
      {
        ...
        List<BL.Unit> skillTarget = skillTargets[key];
        this.battleEffects.skillFieldEffectStartCore(battleskillSkill.passive_effect, (BL.Unit) null, skillTarget.ToList<BL.Unit>(), skillResource.effectPrefab, skillResource.invokedEffectPrefab, skillResource.targetEffectPrefab, (System.Action) null, (System.Action) (() =>
        {
          if (key != hpDispKey)
            return;
          foreach (BL.Unit key in hpDispUnit)
          {
            BE.UnitResource unitResource = this.environment.unitResource[key];
            unitResource.unitParts_.dispHpNumber(hpCount[key].Item1, hpCount[key].Item2);
            unitResource.unitParts_.setHpGauge(hpCount[key].Item1, hpCount[key].Item2);
          }
  ...
  {
    List<System.Action> afterDuelSchedules = new List<System.Action>();
    List<System.Action> sceneEndSchedules = new List<System.Action>();
    ...
    if (this.environment != null)
    {
      ...
      btm.setScheduleAction((System.Action) (() =>
      {
        ...
        else
        {
          if (afterApplyDuelSkillEffectsHp <= 0)
            return;
          bool flag2 = duelResult.moveUnit != attack.originalUnit;
          this.environment.core.getUnitPosition(duelResult.moveUnit).actionActionUnit(this.environment.core, attack: (!flag2 ? attack : defense), defense: (!flag2 ? defense : attack), defenseHp: (!flag2 ? duelDefenseHp : duelAttackHp));
        }
      }));
      ...
      if (flag1)
      {
        if (attack.isView && defense.isView)
          afterDuelSchedules.Add((System.Action) (() =>
          {
            this.environment.core.setCurrentUnitWith((BL.Unit) null, (System.Action<BL.UnitPosition>) (_ => {}));
            BE.UnitResource defense = this.environment.unitResource[defense];
            BE.UnitResource attack = this.environment.unitResource[attack];
            ...
            foreach (List<BL.DuelTurn> duelTurnList in duelTurnListList)
            {
              ...
              this.setBattleEffectSchedule(btm, duelTurnList, attack, preAttackerHP, defense, preDefenseHP);
      ...
      else
      {
        ...
        sceneEndSchedules.Add((System.Action) (() =>
        {
          if (attack.isView)
      ...
      BattleFuncs.applyDuelResultEffects(duelResult, (BL.ISkillEffectListUnit) attack, (BL.ISkillEffectListUnit) defense, this.environment.core, (System.Action<BL.Unit, Tuple<int, int>>) ((unit, hp) => swapHealDamageHp[unit] = hp));
      BattleFuncs.applyDuelSkillEffects(duelResult, (BL.ISkillEffectListUnit) attack, (BL.ISkillEffectListUnit) defense, this.environment.core, removeSkillEffects, (System.Action<BL.ISkillEffectListUnit, int>) ((target, prevHp) => effectTargetsAddHp[target as BL.Unit] = new Tuple<int, int>(prevHp, target.hp)), (System.Action<BL.ISkillEffectListUnit, int>) ((target, prevHp) =>
      {
      ...
      }), (System.Action<BL.ISkillEffectListUnit, int>) ((target, prevHp) => effectTargetsPenetrateSubHp[target as BL.Unit] = new Tuple<int, int>(prevHp, target.hp)), (System.Action<BL.ISkillEffectListUnit, int>) ((target, prevHp) =>
      {
        BL.Unit key = target as BL.Unit;
      ...
      }), (System.Action<BL.ISkillEffectListUnit, int>) ((target, prevHp) =>
      {
        BL.Unit key = target as BL.Unit;
      ...
      }), (System.Action<BattleskillSkill, BL.Unit, Dictionary<BL.Unit, Tuple<int, int>>, float?>) ((skill, unit, targets, rotate) =>
      {
      ...
      if (this.useGameEngine)
      {
        ...
        foreach (List<BL.Unit> unitList in lifeAbsorbSkillTarget.Values)
          source.AddRange((IEnumerable<BL.Unit>) unitList);
        foreach (List<BL.Unit> unitList in curseReflectionSkillTarget.Values)
          source.AddRange((IEnumerable<BL.Unit>) unitList);
        foreach (Tuple<List<BL.Unit>, float> tuple in penetrateSkillTarget.Values)
          source.AddRange((IEnumerable<BL.Unit>) tuple.Item1);
        foreach (List<BL.Unit> unitList in rangeAttackSkillTarget.Values)
          source.AddRange((IEnumerable<BL.Unit>) unitList);
        foreach (BL.Unit key in damageShareSkillTarget.Keys)
        {
          source.Add(key);
          foreach (List<BL.Unit> unitList in damageShareSkillTarget[key].Values)
            source.AddRange((IEnumerable<BL.Unit>) unitList);
        }
        ...
        foreach (BL.Unit key in swapHealDamageHp.Keys)
          source.Add(key);
        foreach (BL.Unit attack1 in source.Distinct<BL.Unit>())
        {
          if (!attack1.Equals(attack) && !attack1.Equals(defense))
            this.gameEngine.applyDeadUnit(attack1, (BL.Unit) null);
        }
      }
        ...
        afterDuelSchedules.Add((System.Action) (() =>
        {
          ...
          foreach (Tuple<BL.Unit, BattleskillSkill> key in afterDuelInvestLandTagKeys)
          {
            if (afterDuelInvestLandTagSkillTarget[key].Count >= 1)
            {
              BattleskillSkill battleskillSkill = key.Item2;
              BE.SkillResource skillResource = this.environment.skillResource[battleskillSkill.passive_effect.ID];
              List<BL.Panel> list = afterDuelInvestLandTagSkillTarget[key].Except<BL.Panel>((IEnumerable<BL.Panel>) panelList).ToList<BL.Panel>();
              panelList.AddRange((IEnumerable<BL.Panel>) list);
              source.Add(battleskillSkill.passive_effect);
              unitListList1.Add((List<BL.Unit>) null);
              gameObjectList1.Add(skillResource.invokedEffectPrefab);
              gameObjectList2.Add(skillResource.targetEffectPrefab);
              unitListList2.Add(new List<BL.Unit>()
              {
          ...
          if (source.Count<BattleskillFieldEffect>() >= 1)
            this.battleEffects.skillFieldEffectMultiStartCore(source.ToArray(), unitListList1.ToArray(), gameObjectList1.ToArray(), gameObjectList2.ToArray(), unitListList2.ToArray(), aryTargetPanels: panelListList.ToArray());
          btm.setEnableWait(1.5f);
        }));
        ...
        afterDuelSchedules.Add((System.Action) (() =>
        {
          ...
          foreach (Tuple<BL.Unit, BattleskillSkill> key in stealSkillTarget.Keys)
          {
            if (stealSkillTarget[key].Count<BL.Unit>() >= 1)
            {
              ...
              BE.SkillResource skillResource = this.environment.skillResource[battleskillSkill.passive_effect.ID];
              source.Add(battleskillSkill.passive_effect);
              unitListList1.Add(stealSkillTarget[key]);
              gameObjectList1.Add(skillResource.invokedEffectPrefab);
              gameObjectList2.Add(skillResource.targetEffectPrefab);
              unitListList2.Add(new List<BL.Unit>()
              {
          ...
          if (source.Count<BattleskillFieldEffect>() >= 1)
            this.battleEffects.skillFieldEffectMultiStartCore(source.ToArray(), unitListList1.ToArray(), gameObjectList1.ToArray(), gameObjectList2.ToArray(), unitListList2.ToArray());
          btm.setEnableWait(1.5f);
        }));
      if (effectTargetsDamageShareSubHp.Count >= 1)
        afterDuelSchedules.Add((System.Action) (() =>
        {
          ...
          List<GameObject> gameObjectList2 = new List<GameObject>();
          List<List<BL.Unit>> unitListList2 = new List<List<BL.Unit>>();
          foreach (BL.Unit key1 in damageShareSkillTarget.Keys)
          {
            BL.Unit unit = key1;
            foreach (BattleskillSkill key2 in damageShareSkillTarget[key1].Keys)
            {
              BE.SkillResource skillResource = this.environment.skillResource[key2.passive_effect.ID];
              List<BL.Unit> source2 = new List<BL.Unit>()
              {
                unit
              };
              source2.AddRange((IEnumerable<BL.Unit>) damageShareSkillTarget[key1][key2]);
              source1.Add(key2.passive_effect);
              unitListList1.Add(source2.Distinct<BL.Unit>().ToList<BL.Unit>());
              gameObjectList1.Add((GameObject) null);
              gameObjectList2.Add(skillResource.targetEffectPrefab);
              unitListList2.Add((List<BL.Unit>) null);
            }
          }
          if (source1.Count<BattleskillFieldEffect>() >= 1)
            this.battleEffects.skillFieldEffectMultiStartCore(source1.ToArray(), unitListList1.ToArray(), gameObjectList1.ToArray(), gameObjectList2.ToArray(), unitListList2.ToArray());
          btm.setScheduleAction((System.Action) (() =>
          {
        ...
        afterDuelSchedules.Add((System.Action) (() =>
        {
          ...
          foreach (Tuple<BL.Unit, BattleskillSkill> key in penetrateSkillTarget.Keys)
          {
            if (penetrateSkillTarget[key].Item1.Count<BL.Unit>() >= 1)
            {
              ...
              BE.SkillResource skillResource = this.environment.skillResource[battleskillSkill.passive_effect.ID];
              source.Add(battleskillSkill.passive_effect);
              unitListList1.Add(penetrateSkillTarget[key].Item1);
              gameObjectList1.Add(skillResource.invokedEffectPrefab);
              gameObjectList2.Add(skillResource.targetEffectPrefab);
              unitListList2.Add(new List<BL.Unit>()
              {
          ...
          if (source.Count<BattleskillFieldEffect>() >= 1)
            this.battleEffects.skillFieldEffectMultiStartCore(source.ToArray(), unitListList1.ToArray(), gameObjectList1.ToArray(), gameObjectList2.ToArray(), unitListList2.ToArray(), nullableListList.ToArray());
          btm.setScheduleAction((System.Action) (() =>
          {
        ...
        afterDuelSchedules.Add((System.Action) (() =>
        {
          ...
          foreach (Tuple<BL.Unit, BattleskillSkill> key in rangeAttackSkillTarget.Keys)
          {
            if (rangeAttackSkillTarget[key].Count<BL.Unit>() >= 1)
            {
              ...
              HashSet<BL.Unit> source2 = new HashSet<BL.Unit>();
              foreach (BattleskillEffect battleskillEffect in battleskillEffects)
              {
                BL.Unit unit = battleskillEffect.GetInt(BattleskillEffectLogicArgumentEnum.is_range_from_enemy) == 0 ? (flag2 ? attack : defense) : (flag2 ? defense : attack);
                source2.Add(unit);
              }
              BE.SkillResource skillResource = this.environment.skillResource[battleskillSkill.passive_effect.ID];
              source1.Add(battleskillSkill.passive_effect);
              unitListList1.Add(rangeAttackSkillTarget[key]);
              gameObjectList1.Add(skillResource.invokedEffectPrefab);
              gameObjectList2.Add(skillResource.targetEffectPrefab);
              unitListList2.Add(source2.ToList<BL.Unit>());
            }
          }
          if (source1.Count<BattleskillFieldEffect>() >= 1)
            this.battleEffects.skillFieldEffectMultiStartCore(source1.ToArray(), unitListList1.ToArray(), gameObjectList1.ToArray(), gameObjectList2.ToArray(), unitListList2.ToArray());
      ...
      if (effectTargetsSnake.Count >= 1)
        afterDuelSchedules.Add((System.Action) (() =>
        {
          ...
          foreach (Tuple<BattleskillSkill, BL.Unit> key in effectTargetsSnake.Keys)
          {
            ...
            HashSet<BL.Unit> source2 = effectTargetsSnake[key];
            if (source2.Count >= 1)
            {
              ...
              bool flag2 = unit1 == attack;
              IEnumerable<BattleskillEffect> source3 = ((IEnumerable<BattleskillEffect>) battleskillSkill.Effects).Where<BattleskillEffect>((Func<BattleskillEffect, bool>) (x => x.EffectLogic.Enum == BattleskillEffectLogicEnum.snake_venom || x.EffectLogic.Enum == BattleskillEffectLogicEnum.snake_venom_damage));
              HashSet<BL.Unit> source4 = (HashSet<BL.Unit>) null;
              if (source3 != null && source3.Count<BattleskillEffect>() > 0)
              {
                source4 = new HashSet<BL.Unit>();
                foreach (BattleskillEffect battleskillEffect in source3)
                {
                  BL.Unit unit2 = battleskillEffect.GetInt(BattleskillEffectLogicArgumentEnum.is_range_from_enemy) == 0 ? (flag2 ? attack : defense) : (flag2 ? defense : attack);
                  source4.Add(unit2);
                }
              ...
              source1.Add(battleskillFieldEffect);
              unitListList1.Add(source2.ToList<BL.Unit>());
              gameObjectList1.Add(skillResource.invokedEffectPrefab);
              gameObjectList2.Add(skillResource.targetEffectPrefab);
              unitListList2.Add(source4.ToList<BL.Unit>());
          ...
          if (source1.Count<BattleskillFieldEffect>() >= 1)
            this.battleEffects.skillFieldEffectMultiStartCore(source1.ToArray(), unitListList1.ToArray(), gameObjectList1.ToArray(), gameObjectList2.ToArray(), unitListList2.ToArray(), nullableListList1.ToArray());
      ...
      if (duelResult.moveUnit.hp > 0)
      {
        ...
        bool flag2 = duelResult.moveUnit != attack.originalUnit;
        if (BattleFuncs.getNextCompleteActionCount((BL.ISkillEffectListUnit) duelResult.moveUnit, unitPosition, !flag2 ? (BL.ISkillEffectListUnit) attack : (BL.ISkillEffectListUnit) defense, !flag2 ? (BL.ISkillEffectListUnit) defense : (BL.ISkillEffectListUnit) attack, !flag2 ? duelDefenseHp : duelAttackHp, true).Item1 >= 1)
        {
      ...
      afterDuelSchedules.Add((System.Action) (() => btm.setScheduleAction((System.Action) (() =>
      {
        foreach (BL.Unit key in effectModeUnits)
        {
          if (key.isView)
    ...
    if (flag1)
    {
      ...
      btm.changeSceneWithReturnWait(this.duelScene, (isStack ? 1 : 0) != 0, (System.Action) (() =>
      {
      ...
      }), (System.Action) null, (System.Action) (() =>
      {
        foreach (System.Action action in sceneEndSchedules)
          action();
    ...
    if (afterDuelSchedules.Count >= 1)
    {
      ...
      btm.setScheduleAction((System.Action) (() =>
      {
        foreach (System.Action action in afterDuelSchedules)
          action();
  ...
  public void startStory(BL.Story story)
  {
    ...
    }), (System.Action) null, (object) story.scriptId);
  }
  ...
  private void startStoryOnlyScript()
  {
    ...
    Story0093Scene.changeScene(true, scriptId, new bool?(this.isSea), (System.Action) (() => this.StartCoroutine(this.endStoryOnlyStage())));
  ...
  private IEnumerator endStoryOnlyStage()
  {
    ...
    if (ngBattleManager.CharacterQuestAfterBattleInfo != null && ngBattleManager.CharacterQuestAfterBattleScriptId != 0)
    {
      ...
      Story0093Scene.changeScene(true, ngBattleManager.CharacterQuestAfterBattleScriptId, new bool?(ngBattleManager.isSea), new System.Action(ngBattleManager.\u003CendStoryOnlyStage\u003Eb__174_0));
