...
public class MypageEditScene : NGSceneBase
{
  ...
  public override IEnumerator Start()
  {
    ...
    mypageEditScene.menuBases = source.Where<NGMenuBase>((Func<NGMenuBase, bool>) (m => (UnityEngine.Object) m != (UnityEngine.Object) null)).ToArray<NGMenuBase>();
    if (mypageEditScene.menuBases != null)
      ((IEnumerable<NGMenuBase>) mypageEditScene.menuBases).ForEach<NGMenuBase>((System.Action<NGMenuBase>) (x =>
      {
        if (!((UnityEngine.Object) x != (UnityEngine.Object) null))
          return;
        x.enabled = false;
      }));
    if ((UnityEngine.Object) mypageEditScene.currentMenu != (UnityEngine.Object) null)
      mypageEditScene.currentMenu.enabled = true;
  }
  ...
  public override void onSceneInitialized() => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
  ...
  private IEnumerator changeMenu(UnitMenuBase menu, string title = null)
  {
    ...
    if ((UnityEngine.Object) this.TopObj != (UnityEngine.Object) null)
    ...
    {
      this.scrollPanel.bottomAnchor.absolute = this.FORMATION_SCROLLPANEL_BOTTOMANCHOR;
      this.scrollBarWidget.bottomAnchor.absolute = this.FORMATION_SCROLLBAR_BOTTOMANCHOR;
    }
  ...
  private void SetTitle(MypageEditScene.Mode mode) => this.textTitle.SetTextLocalize(Consts.GetInstance().MYPAGE_EDIT_UNIT_SELECT_TITLE);
  ...
  public void onBackScene(MypageEditScene.Mode mode, Unit0046Menu.OneFormationInfo info) => this.onBackScene();

  public void onBackScene(MypageEditScene.Mode mode, Unit004431Menu.Param sendParam) => this.onBackScene();

  public void onBackScene(MypageEditScene.Mode mode, Unit00492Menu.Param param) => this.onBackScene();
