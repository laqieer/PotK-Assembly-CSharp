...
public class DailyMissionWindow : BackButtonPopupWindow
{
  ...
  private void updateBulkReceiveButton(DailyMissionWindow.ScrollType type, bool bInitialize)
  {
    ...
    if (!bInitialize && this.BulkReceiveButton.isEnabled == flag)
      return;
    this.BulkReceiveButton.isEnabled = flag;
    if (flag)
      this.BulkReceiveSprite.color = this.BulkReceiveButton.defaultColor;
    else
      this.BulkReceiveSprite.color = this.BulkReceiveButton.disabledColor;
  }
  ...
  private IEnumerator DailymissionBulkReceive()
  {
    ...
    if (window.scrollType == DailyMissionWindow.ScrollType.Daily)
    {
      ...
      Future<WebAPI.Response.DailymissionReceiveDailyAll> future = WebAPI.DailymissionReceiveDailyAll((System.Action<WebAPI.Response.UserError>) (e =>
      {
        WebAPI.DefaultUserErrorCallback(e);
    ...
    {
      Future<WebAPI.Response.DailymissionBulkReceive> future = WebAPI.DailymissionBulkReceive((int) (window.scrollType + 1), (System.Action<WebAPI.Response.UserError>) (e =>
      {
        WebAPI.DefaultUserErrorCallback(e);
        common.DailyMissionController.Hide();
      }));
    ...
    if (window.rewardModelList.Any<DailyMission0272Panel.RewardViewModel>() || window.resultPointRewards.Any<PointReward>())
    {
      ...
      ModalWindow.Show("ミッション報酬受け取り", "報酬が上限に達して受け取れないミッションがあります", (System.Action) (() => {}));
  ...
  private bool isNotReceivedRewards => this.notReceiveList.Any<int>() || this.not_received_pointrewards.Any<int>();
  ...
  private IEnumerator GuildmissionBulkReceive()
  {
    ...
    int[] types = new int[1]{ (int) window.scrollType };
    Future<WebAPI.Response.GuildmissionBulkReceive> future = WebAPI.GuildmissionBulkReceive((System.Action<WebAPI.Response.UserError>) (e =>
    {
      WebAPI.DefaultUserErrorCallback(e);
  ...
  public void onClickedHelp()
  {
    if (this.helpCategory == null || this.IsPushAndSet())
      return;
    Help0152Scene component = Singleton<NGSceneManager>.GetInstance().sceneBase.GetComponent<Help0152Scene>();
    if ((UnityEngine.Object) component != (UnityEngine.Object) null && component.menu.titleName.Equals("ミッション"))
    {
      Singleton<CommonRoot>.GetInstance().DailyMissionController.Hide();
    }
    else
  ...
  public override void onBackButton() => Singleton<CommonRoot>.GetInstance().DailyMissionController.Hide();
