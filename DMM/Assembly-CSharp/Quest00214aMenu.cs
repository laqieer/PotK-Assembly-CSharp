...
public class Quest00214aMenu : BackButtonMenuBase
{
  ...
  private System.Action<System.Action> onBeforeChangeScne_;
  ...
  public IEnumerator doLoadResources()
  {
    ...
    if ((UnityEngine.Object) this.releaseConditionPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.bgMaskTexture == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.hscrollPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator SetBg(
    ...
    int index)
  {
    Future<UnityEngine.Sprite> bgSprite = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(questData.quest_m.background_image_path);
  ...
  public IEnumerator showPopup(
    int id,
    WebAPI.Response.QuestProgressCharacter apiResponse,
    System.Action<System.Action> beforeChangeScene)
  {
    Quest00214aMenu quest00214aMenu = this;
    quest00214aMenu.gameObject.SetActive(true);
  ...
  private void setEventFinished(UITweener tween) => tween.SetOnFinished((EventDelegate.Callback) (() =>
  {
  ...
  public void changeScene(PlayerCharacterQuestS episode) => Quest0028Scene.changeScene(true, episode);
