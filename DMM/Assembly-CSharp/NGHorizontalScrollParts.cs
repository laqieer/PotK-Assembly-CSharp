...
public class NGHorizontalScrollParts : MonoBehaviour
{
  ...
  protected GameObject scrollGrid => !(bool) (UnityEngine.Object) this.scrollGrid_ ? (this.scrollGrid_ = this.grid.gameObject) : this.scrollGrid_;
  ...
  private UIGrid grid => !(bool) (UnityEngine.Object) this.grid_ ? (this.grid_ = this.scrollView.GetComponentInChildren<UIGrid>(true)) : this.grid_;
  ...
  {
    if (!(bool) (UnityEngine.Object) this.dot)
      return;
    this.dot.transform.Clear();
    this.dotList.Clear();
    this.nbParts = 0;
...
label_5:
  ...
  {
    if ((UnityEngine.Object) this.leftArrow != (UnityEngine.Object) null && !this.leftArrow.activeSelf && idx > 0)
    {
      this.leftArrow.SetActive(true);
      this.leftArrow.GetComponent<NGTweenParts>().isActive = true;
    }
    if (!((UnityEngine.Object) this.rightArrow != (UnityEngine.Object) null) || this.rightArrow.activeSelf || idx >= this.nbParts - 1)
      return;
  ...
  public GameObject GridChild(int index) => this.scrollGrid.transform.GetChild(index).gameObject;

  public IEnumerable<GameObject> GridChildren() => this.scrollGrid.transform.GetChildren().Select<Transform, GameObject>((Func<Transform, GameObject>) (t => t.gameObject));
