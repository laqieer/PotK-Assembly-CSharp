...
public class MapEditFacilityList : MonoBehaviour
{
  ...
  private int remainingCost_ => this.modRemainingCost_ == null ? int.MaxValue : this.modRemainingCost_.value.value;

  private bool isChangedRemainingCost_ => this.modRemainingCost_ != null && this.modRemainingCost_.isChanged;
    ...
    BL.StructValue<bool> notLocate = null)
  {
    ...
    if (facility != null)
    {
      ...
      if (u != null && master != null)
      {
        ...
        if (playerUnitSkills != null && (UnityEngine.Object) prefabGenre != (UnityEngine.Object) null)
        {
          BattleskillSkill skill = playerUnitSkills.skill;
          BattleskillGenre? genre1 = skill.genre1;
          if (genre1.HasValue)
          {
            GameObject go = prefabGenre.Clone(this.lnkProperty0_.transform);
            UIWidget component2 = this.lnkProperty0_.GetComponent<UIWidget>();
            SkillGenreIcon component3 = go.GetComponent<SkillGenreIcon>();
            ...
            NGUITools.AdjustDepth(go, this.depthProperty_);
          }
          BattleskillGenre? genre2 = skill.genre2;
          if (genre2.HasValue)
          {
            GameObject go = prefabGenre.Clone(this.lnkProperty1_.transform);
            UIWidget component2 = this.lnkProperty1_.GetComponent<UIWidget>();
            SkillGenreIcon component3 = go.GetComponent<SkillGenreIcon>();
            component3.Init(genre2);
            if ((UnityEngine.Object) component2 != (UnityEngine.Object) null)
              component3.SetSize(Mathf.RoundToInt(component2.localSize.x), Mathf.RoundToInt(component2.localSize.y));
            NGUITools.AdjustDepth(go, this.depthProperty_);
          }
  ...
  public void updateQuantity() => this.currentLayout_.setQuantity(this.facility_.hasnum, this.used_);

  private void updateButton()
  {
    bool flag = !this.isNotLocate_ && this.facility_.hasnum > this.used_ && this.cost_ <= this.remainingCost_;
    this.btnSelect_.isEnabled = flag;
    if ((UnityEngine.Object) this.facilityIcon_ != (UnityEngine.Object) null)
      this.facilityIcon_.Gray = !flag;
    MapEditFacilityList.ErrorIndex errorIndex = MapEditFacilityList.ErrorIndex.None;
    if (this.facility_.hasnum <= this.used_)
      errorIndex = MapEditFacilityList.ErrorIndex.Soldout;
    else if (this.cost_ > this.remainingCost_)
      errorIndex = MapEditFacilityList.ErrorIndex.CostOver;
    else if (this.isNotLocate_)
      errorIndex = MapEditFacilityList.ErrorIndex.NoSpace;
    ((IEnumerable<GameObject>) this.toggleError_).ToggleOnceEx((int) errorIndex);
  }
