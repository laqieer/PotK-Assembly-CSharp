...
public class Shop00742KisekiAndMedal : MonoBehaviour
{
  ...
  private IEnumerator doCoin()
  {
    ...
    Future<UnityEngine.Sprite> r = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Icons/Detail/kiseki_basic");
  ...
  private IEnumerator doMedal()
  {
    ...
    Future<UnityEngine.Sprite> r = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("AssetBundle/Resources/ItemDetails/ItemDetails_medal");
    IEnumerator e = r.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator doBattleMedal()
  {
    ...
    Future<UnityEngine.Sprite> r = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("AssetBundle/Resources/ItemDetails/ItemDetails_battle_medal");
    IEnumerator e = r.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
