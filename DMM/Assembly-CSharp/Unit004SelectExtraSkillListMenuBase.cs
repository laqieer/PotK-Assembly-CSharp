...
public class Unit004SelectExtraSkillListMenuBase : Unit004ExtraSkillListMenuBase
{
  ...
  protected override void CreateItemIconAdvencedSetting(int inventoryIdx, int allItemIdx)
  {
    ...
    extraSkillIcon.ClickAction = (System.Action<InventoryExtraSkill>) (skill => this.SelectItemProc(skill));
    ...
    {
      extraSkillIcon.ClickAction = (System.Action<InventoryExtraSkill>) (_ => {});
  ...
  public bool IsSelectItem(InventoryExtraSkill invItem) => this.SelectItemList.Any<InventoryExtraSkill>((Func<InventoryExtraSkill, bool>) (x => x == invItem));
  ...
  public void RemoveSelectItem(int idx) => this.RemoveSelectItem(this.InventoryExtraSkills.FirstOrDefault<InventoryExtraSkill>((Func<InventoryExtraSkill, bool>) (x => x.index == idx)));
