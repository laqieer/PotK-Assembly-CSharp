...
public class StageAvailibilityCheckHelper : MonoBehaviour
{
  public IEnumerator PopupJudge(
    ...
    System.Action<System.Action> act,
    System.Action<PopupUtility.SceneTo> changeOtherScene,
    bool Event,
    bool storyOnly)
  {
    ...
    else if (player.ap - StageData.lost_ap < 0)
    {
      ...
      {
        e = StageAvailibilityCheckHelper.noAP_Popup((System.Action) (() =>
        {
          act((System.Action) null);
  ...
  private static IEnumerator noAP_Popup(System.Action questChangeScene)
  {
    ...
    System.Action<System.Action> act)
  {
    ...
    if (current.ap - questData.lost_ap < 0)
    {
      if (current.ap_max - questData.lost_ap < 0)
        ...
        yield return (object) StageAvailibilityCheckHelper.noAP_Popup((System.Action) (() => Singleton<PopupManager>.GetInstance().monitorCoroutine(StageAvailibilityCheckHelper.doSkipQuestExtraSortie(questData, act))));
    }
    else
    {
      ...
      {
        int nWait = 0;
        PopupCommonNoYes.Show(instance1.EXPLORE_POPUP_REPAIR_CONFIRM_TITLE, instance1.EXPLORE_POPUP_REPAIR_CONFIRM_MESSAGE, (System.Action) (() => nWait = 1), (System.Action) (() => nWait = 2));
        while (nWait == 0)
      ...
      {
        int nWait = 0;
        PopupCommonNoYes.Show(instance1.POPUP_SKIP_SORTIE_TITLE, instance1.POPUP_SKIP_SORTIE_MESSAGE, (System.Action) (() => nWait = 1), (System.Action) (() => nWait = 2));
        while (nWait == 0)
          yield return (object) null;
        if (nWait != 2)
        {
          bool bWait = true;
          act((System.Action) (() => bWait = false));
          while (bWait)
            yield return (object) null;
          BattleInfo battleInfo = (BattleInfo) null;
          yield return (object) BattleInfoUtil.doMakeExtraSoloBattleInfo(playerUnit.id, questData.id_S, (System.Action<BattleInfo>) (info => battleInfo = info), (System.Action<WebAPI.Response.UserError>) (error =>
          {
  ...
  private void setNoReturnScene(bool bSea) => Singleton<NGSceneManager>.GetInstance().destroyLoadedScenes();
}
