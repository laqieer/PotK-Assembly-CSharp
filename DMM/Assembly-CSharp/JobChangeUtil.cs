...
{
  public static PlayerUnit[] getTargets() => ((IEnumerable<PlayerUnit>) SMManager.Get<PlayerUnit[]>()).Where<PlayerUnit>((Func<PlayerUnit, bool>) (pu => JobChangeUtil.getJobChangePatterns(pu) != null)).ToArray<PlayerUnit>();
  ...
  public static bool checkDiff3DModel(PlayerUnit a, PlayerUnit b) => a._unit != b._unit || a.job_id != b.job_id;
