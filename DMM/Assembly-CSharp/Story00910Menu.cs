...
public class Story00910Menu : BackButtonMenuBase
{
  ...
  private IEnumerator API()
  {
    ...
    if (!WebAPI.IsResponsedAtContainsKey(KeyWebAPI))
    {
      ...
      Future<WebAPI.Response.QuestProgressHarmony> response = WebAPI.QuestProgressHarmony(new System.Action<WebAPI.Response.UserError>(story00910Menu.\u003CAPI\u003Eb__11_0));
  ...
  private IEnumerator CreateList()
  {
    ...
    story00910Menu.ngxScroll.scrollView.gameObject.SetActive(false);
      ...
      if (harmony.is_playable)
      {
        ...
        if (questSTable != null)
        {
          if (questSTable.target_unit2 == null)
          {
            ...
            e = gameObject.GetComponent<Quest00214DirCombi>().InitStoryPlayBack(questSTable, story00910Menu.harmoniesS, story00910Menu.unitIconPrefab, new System.Action<int, int>(story00910Menu.SelectHarmony));
            while (e.MoveNext())
              yield return e.Current;
            e = (IEnumerator) null;
          }
          else
          {
            ...
            story00910Menu.ngxScroll.Add(gameObject);
            e = gameObject.GetComponent<Quest00214DirTrio>().InitStoryPlayBack(questSTable, new System.Action<int, int[], int>(story00910Menu.SelectHarmonyTrio));
            while (e.MoveNext())
              yield return e.Current;
            e = (IEnumerator) null;
          }
    ...
    story00910Menu.ngxScroll.scrollView.gameObject.SetActive(true);
    story00910Menu.dirNoStory.SetActive(story00910Menu.ngxScroll.grid.transform.childCount <= 0);
