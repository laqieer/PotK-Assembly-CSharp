...
public class ShopItemListMenu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(int shopId, int bannerId, string shopName, string shopTime)
  {
    ...
    if (!menu.isInitEnd)
    {
      ...
      {
        ShopItemIcon component = UnityEngine.Object.Instantiate<GameObject>(menu.ItemIconPrefab).GetComponent<ShopItemIcon>();
        menu.shopItemIcons.Add(component);
        menu.scroll.AddColumn3(menu.shopItemIcons[i].gameObject, 206, 240, i);
      ...
      menu.scrollViewTransform = menu.scroll.scrollView.transform;
      menu.scrollStartY = menu.scroll.scrollView.transform.localPosition.y;
  ...
  private void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.shopItemIconInfos.FirstIndexOrNull<ShopItemIconInfo>((Func<ShopItemIconInfo, bool>) (v => (UnityEngine.Object) v.shopItemIcon != (UnityEngine.Object) null && (UnityEngine.Object) v.shopItemIcon.gameObject == (UnityEngine.Object) item));
  ...
  private void ScrollIconUpdate(int index, int count)
  {
    ...
    this.shopItemIconInfos.First<ShopItemIconInfo>((Func<ShopItemIconInfo, bool>) (a => (UnityEngine.Object) a.shopItemIcon == (UnityEngine.Object) shopItemIcon)).shopItemIcon = (ShopItemIcon) null;
  ...
  {
    GameObject prefab = UnityEngine.Object.Instantiate<GameObject>(this.battleMedaldetailPopup);
