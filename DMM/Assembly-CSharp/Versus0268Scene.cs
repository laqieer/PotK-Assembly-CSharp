...
public class Versus0268Scene : NGSceneBase
{
  ...
  public static void ChangeScene() => Singleton<NGSceneManager>.GetInstance().changeScene("versus026_8", false);

  public static void ChangeScene(bool isDebug) => Singleton<NGSceneManager>.GetInstance().changeScene("versus026_8", false, (object) isDebug);

  public static void ChangeScene(WebAPI.Response.PvpPlayerNpcFinish resNpcFinish) => Singleton<NGSceneManager>.GetInstance().changeScene("versus026_8", false, (object) resNpcFinish);
  ...
  {
    Future<WebAPI.Response.PvpPlayerFinish> futureF = WebAPI.PvpPlayerFinish((System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  public IEnumerator onStartSceneAsync(WebAPI.Response.PvpPlayerFinish result)
  {
    ...
    {
      (ResultMenuBase) versus0268Scene.GetComponent<Versus0268Menu>(),
      (ResultMenuBase) null
    };
    if (!result.target_player_is_friend)
      versus0268Scene.sequences.Add((ResultMenuBase) versus0268Scene.GetComponent<FriendMenu>());
  ...
  private IEnumerator InitMenus(WebAPI.Response.PvpPlayerFinish result)
  {
    ...
    this.scrollPanelButton.isEnabled = false;
  ...
  private IEnumerator RunMenus()
  {
    ...
    while (seqe.MoveNext())
    {
      ...
      if (!((UnityEngine.Object) versus0268Scene.nowPlayBase == (UnityEngine.Object) null))
      {
        ...
        versus0268Scene.touchToNext.SetActive(true);
        versus0268Scene.scrollPanelButton.isEnabled = true;
        while (!versus0268Scene.toNextSequence)
          yield return (object) null;
        versus0268Scene.toNextSequence = false;
        versus0268Scene.touchToNext.SetActive(false);
        versus0268Scene.scrollPanelButton.isEnabled = false;
    ...
    versus0268Scene.touchToNext.SetActive(true);
    versus0268Scene.touchToNext.GetComponent<BoxCollider>().enabled = false;
    while (seqe.MoveNext())
    {
      e = seqe.Current.Run();
      while (e.MoveNext())
    ...
    if (versus0268Scene.pvpInfo.is_tutorial && Persist.pvpInfo.Data.currentPage == 2)
      versus0268Scene.StartTutorial(new System.Action(versus0268Scene.FinishScene));
    else
      versus0268Scene.FinishScene();
  }

  private void StartTutorial(System.Action finishScene) => Singleton<TutorialRoot>.GetInstance().ForceShowAdvice("pvp3", (System.Action) (() =>
  {
  ...
  private void FinishScene()
  {
    if (this.pvpInfo.pvp_maintenance)
      this.StartCoroutine(PopupCommon.Show(this.pvpInfo.pvp_maintenance_title, this.pvpInfo.pvp_maintenance_message, (System.Action) (() => MypageScene.ChangeScene())));
  ...
  {
    IEnumerator e = PopupCommon.Show(pvpInfo.pvp_maintenance_title, pvpInfo.pvp_maintenance_message, (System.Action) (() =>
    {
  ...
  private WebAPI.Response.PvpPlayerFinish ForDebugData(WebAPI.Response.PvpPlayerFinish data)
  {
    ...
    ((IEnumerable<PlayerUnit>) array1).ForEach<PlayerUnit>((System.Action<PlayerUnit>) (p =>
    {
      ...
      try
      {
        PlayerItem playerItem = array2[(int) ((double) UnityEngine.Random.value * (double) (array2.Length - 1))];
    ...
    ((IEnumerable<PlayerUnit>) array3).Skip<PlayerUnit>(2).ForEach<PlayerUnit>((System.Action<PlayerUnit>) (p =>
    {
    ...
    ((IEnumerable<PlayerItem>) array4).ForEach<PlayerItem>((System.Action<PlayerItem>) (x => x.broken = GearBrokenEffectOn));
    ...
    data.campaigns = new SM.Campaign[1]
    {
      new SM.Campaign() { campaign_type_id = 1 }
    };
    return data;
  }
}
