...
public class Unit0046Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitPlayerDecks(PlayerDeck[] _playerDecks)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) unit0046Menu.prefabResult == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit0046Menu.LeaderSkillPopupPrefab == (UnityEngine.Object) null)
    {
    ...
    // ISSUE: reference to a compiler-generated method
    ((IEnumerable<UIButton>) unit0046Menu.buttons).ForEach<UIButton>(new System.Action<UIButton>(unit0046Menu.\u003CInitPlayerDecks\u003Eb__65_0));
    if ((bool) (UnityEngine.Object) unit0046Menu.buttonLockControl)
  ...
  private IEnumerator coOpenPopupAutoOrganization()
  {
    ...
    IEnumerator waitPopup = Unit0046ConfirmAutoOrganization.doPopup(unit0046Menu.limitationData != null ? unit0046Menu.limitationData.description_ : (string) null, (System.Action<CommonElement>) (_element =>
    {
      bok = true;
      element = _element;
    }));
    ...
    else
    {
      ...
      if ((unit0046Menu.limitationData == null || unit0046Menu.limitationData.limitations_ == null ? 0 : ((uint) unit0046Menu.limitationData.limitations_.Length > 0U ? 1 : 0)) != 0)
      {
        int filterno = 0;
