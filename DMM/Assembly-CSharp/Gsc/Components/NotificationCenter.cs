...
namespace Gsc.Components
{
  public class NotificationCenter
  {
    ...
    private readonly Dictionary<System.Type, NotificationCenter.ObserverList> observers = new Dictionary<System.Type, NotificationCenter.ObserverList>();
    ...
    public void AddObserver<TMessage>(NotificationObserver<TMessage> observer) where TMessage : INotification => this.AddObserver<TMessage>(observer, (object) null);
    ...
    public void RemoveObserversWithSender<TMessage>(object sender) where TMessage : INotification => this.RemoveObserversWithSender(typeof (TMessage), sender);

    public void RemoveObserversWithSender(object sender)
    {
      foreach (KeyValuePair<System.Type, NotificationCenter.ObserverList> observer in this.observers)
    ...
    private class ObserverList
    {
      ...
      public void Post<TMessage>(ref TMessage message, object sender)
      {
        ...
        {
          NotificationCenter.Observer aliveObserver = this.aliveObservers[index];
          if ((UnityEngine.Object) aliveObserver.target == (UnityEngine.Object) null)
            NotificationCenter.ObserverList.deadObservers.Add(aliveObserver);
