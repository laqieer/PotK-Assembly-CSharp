...
namespace Gsc.DOM.Json
{
  public struct Value : IValue
  {
    ...
    public bool GetValueByPointer(string pointer, bool defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);

    public string GetValueByPointer(string pointer, string defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);

    public int GetValueByPointer(string pointer, int defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);

    public uint GetValueByPointer(string pointer, uint defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);

    public long GetValueByPointer(string pointer, long defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);

    public ulong GetValueByPointer(string pointer, ulong defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);

    public float GetValueByPointer(string pointer, float defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);

    public double GetValueByPointer(string pointer, double defaultValue) => this.value.GetValueByPointer(pointer, defaultValue);
