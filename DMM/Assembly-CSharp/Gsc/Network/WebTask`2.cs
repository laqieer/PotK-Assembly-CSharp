...
namespace Gsc.Network
{
    ...
    where TResponse : Gsc.Network.Response<TResponse>
  {
    ...
    public bool IsAcceptResult(WebTaskResult result) => (this.acceptResults & result) > WebTaskResult.None;

    public bool HasAttributes(WebTaskAttribute attributes) => (this.attributes & attributes) == attributes;
