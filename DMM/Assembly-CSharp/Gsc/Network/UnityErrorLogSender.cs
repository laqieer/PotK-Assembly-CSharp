...
namespace Gsc.Network
{
  public class UnityErrorLogSender : IEnumerator
  {
    ...
    public System.Action<CustomHeaders, Dictionary<string, object>, Dictionary<string, object>, Dictionary<string, object>> Callback { get; set; }
      ...
      Dictionary<string, object> extra)
    {
      ...
      if (data.logType == LogType.Exception)
      {
    ...
    private static Dictionary<string, object> CreateExtraData()
    {
      try
      {
        return new Dictionary<string, object>()
        {
          ...
          {
            "os_info",
            (object) Gsc.Device.DeviceInfo.OperatingSystem
          },
          {
            "cpu_info",
            (object) Gsc.Device.DeviceInfo.ProcessorType
          },
          {
            "device_model",
            (object) Gsc.Device.DeviceInfo.DeviceModel
          },
          {
            "device_vendor",
            (object) Gsc.Device.DeviceInfo.DeviceVendor
          }
        };
      }
      catch (Exception ex)
