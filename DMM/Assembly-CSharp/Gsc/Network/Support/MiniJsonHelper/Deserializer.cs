...
namespace Gsc.Network.Support.MiniJsonHelper
{
  public class Deserializer
  {
    ...
    public static DateTime ToDateTime(object source) => source == null ? DateTime.MinValue : DateTime.Parse((string) source);
    ...
    {
      public static ObfuscatedBool boolean(object source) => (ObfuscatedBool) (bool) source;

      public static ObfuscatedSByte int8(object source) => (ObfuscatedSByte) Deserializer.ToIntegerType.int8(source);

      public static ObfuscatedShort int16(object source) => (ObfuscatedShort) Deserializer.ToIntegerType.int16(source);

      public static ObfuscatedInt int32(object source) => (ObfuscatedInt) Deserializer.ToIntegerType.int32(source);

      public static ObfuscatedLong int64(object source) => (ObfuscatedLong) Deserializer.ToIntegerType.int64(source);

      public static ObfuscatedByte uint8(object source) => (ObfuscatedByte) Deserializer.ToIntegerType.uint8(source);

      public static ObfuscatedUShort uint16(object source) => (ObfuscatedUShort) Deserializer.ToIntegerType.uint16(source);

      public static ObfuscatedUInt uint32(object source) => (ObfuscatedUInt) Deserializer.ToIntegerType.uint32(source);

      public static ObfuscatedULong uint64(object source) => (ObfuscatedULong) Deserializer.ToIntegerType.uint64(source);

      public static ObfuscatedFloat float32(object source) => (ObfuscatedFloat) Deserializer.ToNumberType.float32(source);

      public static ObfuscatedDouble float64(object source) => (ObfuscatedDouble) Deserializer.ToNumberType.float64(source);
    }
  }
}
