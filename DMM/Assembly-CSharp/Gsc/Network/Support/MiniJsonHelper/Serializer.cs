...
namespace Gsc.Network.Support.MiniJsonHelper
{
  public class Serializer
  {
    ...
    public static object FromObject<T>(T source) where T : IRequestObject => (object) source.GetPayload();

    public static object FromDateTime(DateTime source) => source == DateTime.MinValue ? (object) null : (object) source.ToUniversalTime().ToString("u");
