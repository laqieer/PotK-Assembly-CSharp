...
public class Explore033BattleScene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, DuelResult duelResult, DuelEnvironment duelEnv) => Singleton<NGSceneManager>.GetInstance().changeScene("explore033_Encount", (stack ? 1 : 0) != 0, (object) duelResult, (object) duelEnv);
  ...
  {
    this.mDuelManager.gameObject.SetActive(true);
    ...
    else
    {
      ...
      if ((UnityEngine.Object) this.mNonDuelDirectionalLight != (UnityEngine.Object) null)
