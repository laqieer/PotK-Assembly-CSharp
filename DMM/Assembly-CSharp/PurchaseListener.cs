...
public class PurchaseListener : IPurchaseGlobalListener, IPurchaseResultListener
{
  ...
  public void OnPurchaseCanceled() => Debug.Log((object) "*** PurchaseListener OnPurchaseCanceled ***");

  public void OnPurchaseAlreadyOwned() => Debug.Log((object) "*** PurchaseListener OnPurchaseAlreadyOwned ***");

  public void OnPurchaseDeferred() => Debug.Log((object) "*** PurchaseListener OnPurchaseDeferred ***");

  public void OnPurchasePending() => Debug.Log((object) "*** PurchaseListener OnPurchasePending ***");

  public void OnPurchasePendingExists() => Debug.Log((object) "*** PurchaseListener OnPurchasePendingExists ***");

  public void OnOverCreditLimited() => Debug.Log((object) "*** PurchaseListener OnOverCreditLimited ***");

  public void OnInsufficientBalances()
  {
  }

  public void OnFinished(bool isSuccess) => Debug.Log((object) ("*** PurchaseListener OnFinished : " + isSuccess.ToString() + " ***"));
}
