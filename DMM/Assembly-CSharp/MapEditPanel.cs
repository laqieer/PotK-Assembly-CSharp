...
public class MapEditPanel : MonoBehaviour
{
  ...
  public MapEditOrnament ornament_ => this.wOrnament_ == null || !this.wOrnament_.IsAlive ? (MapEditOrnament) null : this.wOrnament_.Target as MapEditOrnament;
  ...
  {
    this.panel_ = panel;
    this.battlePanel_ = this.gameObject.GetComponent<BattlePanelParts>();
    PanelInit component = this.gameObject.GetComponent<PanelInit>();
    Vector3 position = this.battlePanel_.gameObject.transform.position;
  ...
  {
    if ((UnityEngine.Object) this.ornament_ == (UnityEngine.Object) ornament)
      return;
    this.wOrnament_ = (UnityEngine.Object) ornament != (UnityEngine.Object) null ? new WeakReference((object) ornament) : (WeakReference) null;
  }

  public bool checkLocation() => this.isLocate_ && (UnityEngine.Object) this.ornament_ == (UnityEngine.Object) null;
}
