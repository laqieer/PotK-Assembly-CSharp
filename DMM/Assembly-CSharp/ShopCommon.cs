...
public class ShopCommon
{
  ...
  public static UnityEngine.Sprite PayTypeZeny;
  public static UnityEngine.Sprite PayTypeMedal;
  public static UnityEngine.Sprite PayTypeBattleMedal;
  public static UnityEngine.Sprite PayTypeCoin;
  public static UnityEngine.Sprite PayTypeRaidJuel;
  public static UnityEngine.Sprite PayTypeGuildMedal;
  public static UnityEngine.Sprite PayTypeTowerMedal;
  ...
  public static IEnumerator Init()
  {
    ...
    Future<UnityEngine.Sprite> zenySpriteF = Res.Icons.Zeny_Icon.Load<UnityEngine.Sprite>();
    e = zenySpriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ShopCommon.PayTypeZeny = zenySpriteF.Result;
    Future<UnityEngine.Sprite> medalSpriteF = Res.Icons.Medal_Icon.Load<UnityEngine.Sprite>();
    e = medalSpriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ShopCommon.PayTypeMedal = medalSpriteF.Result;
    Future<UnityEngine.Sprite> battleMedalSpriteF = Res.Icons.BattleMedal_Icon.Load<UnityEngine.Sprite>();
    e = battleMedalSpriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ShopCommon.PayTypeBattleMedal = battleMedalSpriteF.Result;
    Future<UnityEngine.Sprite> coinSpriteF = Res.Icons.Kiseki_Icon.Load<UnityEngine.Sprite>();
    e = coinSpriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  {
    Future<UnityEngine.Sprite> f = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("ShopIcon/" + resourceName);
  ...
  {
    Future<UnityEngine.Sprite> f = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("ShopPack/" + resourceName);
    IEnumerator e = f.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public static IEnumerator CreateThum(
    Transform parent,
    MasterDataTable.CommonRewardType commonRewardType,
    int id)
  {
  ...
  public static UnityEngine.Sprite GetPayTypeIcon(CommonPayType payType)
  {
    ...
    switch (payType)
    {
      ...
      case CommonPayType.paid_coin:
        sprite = ShopCommon.PayTypeCoin;
        break;
      case CommonPayType.money:
        sprite = ShopCommon.PayTypeZeny;
        break;
      case CommonPayType.medal:
        sprite = ShopCommon.PayTypeMedal;
        break;
      case CommonPayType.battle_medal:
        sprite = ShopCommon.PayTypeBattleMedal;
        break;
      default:
        Debug.LogError((object) string.Format("想定していない支払い種別です. {0}", (object) payType));
        sprite = (UnityEngine.Sprite) null;
        break;
    }
    return sprite;
  }
  ...
  public static string GetLimitCountText(int? limitType, int? limitCount)
  {
    ...
    switch (limitType.HasValue ? (ShopCommon.LimitType) limitType.Value : ShopCommon.LimitType.None)
    {
      ...
      case ShopCommon.LimitType.OneMonth:
        str = string.Format("あと{0}回", (object) limitCount);
        break;
      case ShopCommon.LimitType.OneDay:
        str = string.Format("１日{0}回", (object) limitCount);
        break;
      default:
        str = "";
        break;
  ...
  public static long GetHaveCount(CommonPayType payType)
  {
    ...
    switch (payType)
    {
      ...
      case CommonPayType.tower_medal:
        num = (long) TowerUtil.TowerPlayer.tower_medal;
        break;
      case CommonPayType.paid_coin:
        num = (long) SMManager.Get<Player>().paid_coin;
        break;
      case CommonPayType.guild_medal:
        num = (long) PlayerAffiliation.Current.guild_medal;
        break;
      case CommonPayType.raid_medal:
        num = (long) SMManager.Get<Player>().raid_medal;
        break;
      default:
        Debug.LogError((object) string.Format("想定していない支払い種別です. {0}", (object) payType));
        break;
  ...
  public static IEnumerator ShowSimpleDetailPopup(
  ...
  public static IEnumerator ShowMoreDetailPopup(
    MasterDataTable.CommonRewardType rewardType,
    int rewardId)
  {
    Future<GameObject> prefabF = Res.Prefabs.popup.popup_000_7_4_2__anim_popup01.Load<GameObject>();
