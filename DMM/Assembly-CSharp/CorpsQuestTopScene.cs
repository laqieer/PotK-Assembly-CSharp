...
public class CorpsQuestTopScene : NGSceneBase
{
  ...
  public static void ChangeScene(int periodId, bool isAllClear = false) => Singleton<NGSceneManager>.GetInstance().changeScene("CorpsQuest_top", false, (object) periodId, (object) isAllClear);
  ...
  public IEnumerator onStartSceneAsync(int periodId, bool isAllClear)
  {
    ...
    {
      ModalWindow.Show("エラー", "軍団戦のデータがありません。", (System.Action) (() => {}));
      Singleton<NGSceneManager>.GetInstance().ChangeErrorPage();
      yield return (object) null;
    }
