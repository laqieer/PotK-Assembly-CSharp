...
public class PopupReisouMixer : BackButtonMenuBase
{
  ...
  private System.Action<InventoryItem, int> cbOK;
  ...
  public IEnumerator Init(
    ...
    int maxCountLimit,
    int selectedCount,
    System.Action<InventoryItem, int> cbOK)
  {
  ...
  {
    this.sliderCount = Mathf.RoundToInt(this.slider.value * (float) this.maxCount);
    this.UpdateInfo();
  }
  ...
  private void UpdateInfo()
  {
    ...
    this.slider.value = (float) this.sliderCount / (float) this.maxCount;
    this.txtZenyCostValue.SetTextLocalize(this.zenyAmount * this.sliderCount);
  ...
  public void IbtnOK()
  {
    if (this.IsPushAndSet())
      return;
    System.Action<InventoryItem, int> cbOk = this.cbOK;
    if (cbOk != null)
