...
public class CommonSeaHeader : CommonHeaderBase
{
  ...
  public void UpdateHeaderBikkuriIcon() => this.kisekiBikkuriIcon.SetActive(Singleton<NGGameDataManager>.GetInstance().receivableGift);

  private void SetSeaPlayerParameter(SeaPlayer player) => ((IEnumerable<GameObject>) this.dpObjects).ForEachIndex<GameObject>((System.Action<GameObject, int>) ((g, i) =>
  {
    if ((UnityEngine.Object) g != (UnityEngine.Object) null && player != null)
  ...
  public void OnFiniseMenuTween()
  {
    ...
    if ((UnityEngine.Object) instance.sceneBase != (UnityEngine.Object) null)
  ...
  {
    NGSceneManager instance = Singleton<NGSceneManager>.GetInstance();
    if ((UnityEngine.Object) instance != (UnityEngine.Object) null && instance.sceneBase.IsPush)
      return true;
