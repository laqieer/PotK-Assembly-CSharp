...
public class AnimatorCtrl : MonoBehaviour
{
  ...
  public void SetBool(string param_name, bool flag) => this.set_type_list_.Add(new AnimatorCtrl.SetParType(param_name, AnimatorCtrl.spt.BOOL, this.set_type_list_.Count)
  {
    flag = flag
  });

  public void SetFloat(string param_name, float value) => this.set_type_list_.Add(new AnimatorCtrl.SetParType(param_name, AnimatorCtrl.spt.FLOAT, this.set_type_list_.Count)
  {
    val_float = value
  });

  public void SetInteger(string param_name, int value) => this.set_type_list_.Add(new AnimatorCtrl.SetParType(param_name, AnimatorCtrl.spt.INT, this.set_type_list_.Count)
  {
    val_int = value
  });

  public void SetTrigger(string param_name) => this.set_type_list_.Add(new AnimatorCtrl.SetParType(param_name, AnimatorCtrl.spt.TRIGGER, this.set_type_list_.Count)
  {
    trigger = true
  });
