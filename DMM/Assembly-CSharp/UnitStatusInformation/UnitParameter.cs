...
namespace UnitStatusInformation
{
  public class UnitParameter
  {
    ...
    public MasterDataTable.UnitJob job => this.masterJob_ ?? (this.masterJob_ = this.playerUnit.getJobData());

    public Judgement.NonBattleParameter nonBattleParam => this.nonBattleParam_ ?? (this.nonBattleParam_ = this.isMemory ? Judgement.NonBattleParameter.FromPlayerUnitMemory(this.playerUnit) : Judgement.NonBattleParameter.FromPlayerUnit(this.playerUnit));

    public Judgement.BattleParameter battleParam => this.battleParam_ ?? (this.battleParam_ = this.isInColosseum ? Judgement.BattleParameter.FromBeColosseumUnit(this.battleUnit, this.playerUnit.equippedGear, this.playerUnit.equippedGear2, this.playerUnit.equippedReisou, this.playerUnit.equippedReisou2, this.playerUnit.equippedReisou3) : Judgement.BattleParameter.FromBeUnit((BL.ISkillEffectListUnit) this.battleUnit));
    ...
    private PlayerUnitSkills[] displaySkills => this.displaySkills_ ?? (this.displaySkills_ = this.getDisplaySkills());

    private PlayerUnitSkills[] getDisplaySkills()
    {
      PlayerUnit playerUnit = this.playerUnit;
      return ((object) playerUnit != null ? playerUnit.skills : (PlayerUnitSkills[]) null) != null ? ((IEnumerable<PlayerUnitSkills>) this.playerUnit.skills).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (x =>
      {
    ...
    private List<UnitParameter.SkillSortUnit> setDuelSkill(
      List<UnitParameter.SkillSortUnit> lstSort)
    {
    ...
    private List<UnitParameter.SkillSortUnit> setJobAbility(
      List<UnitParameter.SkillSortUnit> lstSort)
    {
      if (this.playerUnit.job_abilities != null && ((IEnumerable<PlayerUnitJob_abilities>) this.playerUnit.job_abilities).Any<PlayerUnitJob_abilities>((Func<PlayerUnitJob_abilities, bool>) (x => (uint) x.job_ability_id > 0U)))
      {
        HashSet<int> ignoreIds = new HashSet<int>(((IEnumerable<PlayerUnitJob_abilities>) this.playerUnit.job_abilities).Where<PlayerUnitJob_abilities>((Func<PlayerUnitJob_abilities, bool>) (x => x.job_ability_id != 0 && (uint) x.skill2_id > 0U)).Select<PlayerUnitJob_abilities, int>((Func<PlayerUnitJob_abilities, int>) (y => y.skill2_id)));
    ...
    private List<UnitParameter.SkillSortUnit> setSEASkill(
      List<UnitParameter.SkillSortUnit> lstSort)
    {
    ...
    public abstract class SkillSortUnit
    {
      ...
      public int priority => (int) (this.priority_.HasValue ? new UnitParameter.SkillPriority?(this.priority_.Value) : (this.priority_ = new UnitParameter.SkillPriority?(this.getPriority()))).Value;
      ...
      public static UnitParameter.SkillSortUnit create(PlayerUnitLeader_skills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.LeaderSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByElement(PlayerUnitSkills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.ElementSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByMulti(PlayerUnitSkills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.MultiSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByOverkillers(
        PlayerUnitSkills skill)
      {
        return (UnitParameter.SkillSortUnit) new UnitParameter.OverkillersSkillSortUnit(skill);
      }

      public static UnitParameter.SkillSortUnit createByRelease(PlayerUnitSkills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.ReleaseSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByCommand(PlayerUnitSkills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.CommandSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByPrincess(PlayerUnitSkills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.PrincessSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByGrant(PlayerUnitSkills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.GrantSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByDuel(PlayerUnitSkills skill) => (UnitParameter.SkillSortUnit) new UnitParameter.DuelSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit create(GearGearSkill skill) => (UnitParameter.SkillSortUnit) new UnitParameter.EquipSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByReisou(GearReisouSkill skill) => (UnitParameter.SkillSortUnit) new UnitParameter.ReisouSkillSortUnit(skill);

      public static UnitParameter.SkillSortUnit createByExtra(PlayerAwakeSkill skill) => (UnitParameter.SkillSortUnit) new UnitParameter.ExtraSkillSortUnit(skill);
      ...
      public static UnitParameter.SkillSortUnit createByJobAbility(
        PlayerUnitSkills skill)
      {
    ...
    private class LeaderSkillSortUnit : UnitParameter.SkillSortUnit
    {
      ...
      public override PopupSkillDetails.Param toPopupParam => new PopupSkillDetails.Param(this.skill_);
    }
    ...
    private class ElementSkillSortUnit : UnitParameter.SkillSortUnit
    {
      ...
      public override PopupSkillDetails.Param toPopupParam => new PopupSkillDetails.Param(this.skill_, this.group);
    }
    ...
    private class SEASkillSortUnit : UnitParameter.SkillSortUnit
    {
      ...
      public override PopupSkillDetails.Param toPopupParam => PopupSkillDetails.Param.createBySEASkillView(this.skill_, this.isUnlocked_, this.numEquipped_);
    }
  }
}
