...
public class QuestBG : MonoBehaviour
{
  ...
  private void Awake()
  {
    if ((Object) this.current_xl != (Object) null)
    {
  ...
  {
    if ((Object) this.current_xl == (Object) null || (Object) this.current_l == (Object) null)
      return;
  ...
  public void CloudAnim(bool reverse)
  {
    if (reverse)
    {
      if ((Object) this.cloudanimRev != (Object) null)
      {
        this.cloudanimRev.gameObject.SetActive(true);
        this.cloudanimRev.Play();
      }
    }
    else if ((Object) this.cloudanimFow != (Object) null)
    {
      this.cloudanimFow.gameObject.SetActive(true);
  ...
  {
    if ((Object) this.current == (Object) null)
      return;
    if ((Object) this.current == (Object) this.current_xl)
      this.current = this.current_l;
    ...
    orAddComponent.to = Color.Lerp(Color.white, Color.black, t1);
    orAddComponent.from = Color.Lerp(Color.white, Color.black, t2);
