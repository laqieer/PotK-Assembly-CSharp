...
public class Unit004UnitMaterialsListScene : NGSceneBase
{
  ...
  {
    Unit004UnitMaterialsListScene materialsListScene = this;
    if ((Object) materialsListScene.unit00491Menu == (Object) null)
      materialsListScene.unit00491Menu = materialsListScene.gameObject.GetComponent<Unit00491Menu>();
    if ((Object) materialsListScene.unit00414Menu == (Object) null)
      materialsListScene.unit00414Menu = materialsListScene.gameObject.GetComponent<Unit00414Menu>();
    ...
    materialsListScene.HimeMaterialEvolutionBtn.gameObject.SetActive(true);
  ...
  private IEnumerator OnHimeMaterialEvolutionButton()
  {
    ...
    this.HimeMaterialEvolutionBtn.gameObject.SetActive(false);
  }

  private IEnumerator changeMenu(UnitMenuBase menu)
  {
    this.unit00414Menu.enabled = false;
    this.unit00491Menu.enabled = false;
    this.bottomSell.gameObject.SetActive(true);
    menu.enabled = true;
    this.SetTitle();
  ...
  public static void changeScene(bool isStack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_UnitMaterials_List", isStack);
