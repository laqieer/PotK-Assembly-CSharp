...
public class Unit0046ConfirmAutoOrganization : BackButtonMenuBase
{
  ...
  private System.Action<CommonElement> eventYes_;

  public static IEnumerator doPopup(
    string modeLimitedDescription,
    System.Action<CommonElement> eventYes)
  {
  ...
  private void Initialize(string modeLimitedDescription, System.Action<CommonElement> eventYes)
  {
    ...
    Unit0046ConfirmAutoOrganization.ButtonElement buttonElement)
  {
    for (int index = 0; index < this.selectElementButtons.Length; ++index)
    {
      if ((Unit0046ConfirmAutoOrganization.ButtonElement) index == buttonElement)
        this.selectElementButtons[index].color = Color.white;
      else
        this.selectElementButtons[index].color = new Color(0.5019608f, 0.5019608f, 0.5019608f);
    }
  }
