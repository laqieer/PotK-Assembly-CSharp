...
public class ExploreSceneManager : Singleton<ExploreSceneManager>
{
  ...
  public bool IsSceneActive => Singleton<NGSceneManager>.GetInstance().sceneName.Equals("explore033_Top") && Singleton<NGSceneManager>.GetInstance().isSceneInitialized;
  ...
  public static void DestroyInstance()
  {
    ...
    if ((UnityEngine.Object) instanceOrNull == (UnityEngine.Object) null)
      return;
    UnityEngine.Object.Destroy((UnityEngine.Object) instanceOrNull.gameObject);
  ...
  public IEnumerator PriorityToExploreUpdate(System.Action changeScene)
  {
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    this.Pause(true);
