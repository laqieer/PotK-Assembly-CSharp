...
public class Bugu005ReisouMixerMenu : Bugu005SelectItemListMenuBase
{
  ...
  public override Persist<Persist.ItemSortAndFilterInfo> GetPersist() => Persist.bugu005ReisouMixerSortAndFilter;
  ...
  protected override List<PlayerMaterialGear> GetMaterialList()
  {
    ...
    foreach (PlayerMaterialGear playerMaterialGear in SMManager.Get<PlayerMaterialGear[]>())
    {
      if (playerMaterialGear.isWeaponMaterial() && !playerMaterialGear.isManaSeed())
        playerMaterialGearList.Add(playerMaterialGear);
    }
    return playerMaterialGearList;
  }
  ...
  public override IEnumerator Init()
  {
    ...
    Future<UnityEngine.Sprite> spriteF = new ResourceObject("Icons/ChaosJewel_Icon").Load<UnityEngine.Sprite>();
  ...
  protected override void BottomInfoUpdate()
  {
    ...
    this.txtZenyNumber.color = (long) reisouMixingCost < this.player.money ? Color.white : Color.red;
    ...
    this.ibtnYes.isEnabled = this.player.money >= (long) reisouMixingCost && allSelectCount > 0;
  }
  ...
  protected int getReisouJewel()
  {
    ...
    foreach (InventoryItem selectItem in this.SelectItemList)
    {
      int num2 = 1;
      if (selectItem.Item.isTempSelectedCount)
        num2 = selectItem.Item.tempSelectedCount;
      num1 += selectItem.Item.gear.rarity.combine_reisou_jewel * num2;
    }
    return num1;
  }
  ...
  private IEnumerator ShowMaterialsPopup(GameCore.ItemInfo item)
  {
    ...
    if (!Singleton<PopupManager>.GetInstance().isOpen)
    {
      ...
      if (selectItem != null)
      {
        ...
        {
          IEnumerator e;
          if ((UnityEngine.Object) bugu005ReisouMixerMenu.popupReisouMixerPrefab == (UnityEngine.Object) null)
          {
          ...
          e = component.Init(selectItem, reisouMixingCost, maxCountLimit, selectedCount, new System.Action<InventoryItem, int>(bugu005ReisouMixerMenu.cbSelectMaterialNum));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
  ...
  private IEnumerator ShowDecisionPopup()
  {
    ...
    if (bugu005ReisouMixerMenu.isSelectedHighRarity())
    {
      ...
      IEnumerator e;
      if ((UnityEngine.Object) bugu005ReisouMixerMenu.m_ItemIconPrefab == (UnityEngine.Object) null)
      {
      ...
      {
        if ((UnityEngine.Object) bugu005ReisouMixerMenu.m_CheckMaterialPopupPrefab == (UnityEngine.Object) null)
        {
      ...
      {
        if ((UnityEngine.Object) bugu005ReisouMixerMenu.m_CheckMaterialPopupPrefabMini == (UnityEngine.Object) null)
        {
      ...
      // ISSUE: reference to a compiler-generated method
      e = obj.GetComponent<PopupReisouMixerConfirm>().Init(bugu005ReisouMixerMenu.SelectItemList, new System.Action(bugu005ReisouMixerMenu.\u003CShowDecisionPopup\u003Eb__34_2), bugu005ReisouMixerMenu.m_ItemIconPrefab);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    ...
    {
      // ISSUE: reference to a compiler-generated method
      PopupCommonNoYes.Show(Consts.GetInstance().POPUP_REISOU_MIXER_DECISION_TITLE, Consts.GetInstance().POPUP_REISOU_MIXER_DECISION_MESSAGE, new System.Action(bugu005ReisouMixerMenu.\u003CShowDecisionPopup\u003Eb__34_0), (System.Action) (() => {}));
    }
  ...
  private IEnumerator CallAPIMixer()
  {
    ...
    Future<WebAPI.Response.ItemGearMixer> paramF = WebAPI.ItemGearMixer(intList3.ToArray(), intList1.ToArray(), intList2.ToArray(), (System.Action<WebAPI.Response.UserError>) (error =>
    {
    ...
    if (paramF.Result != null)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      if ((UnityEngine.Object) bugu005ReisouMixerMenu.popupReisouMixerResultPrefab == (UnityEngine.Object) null)
      {
