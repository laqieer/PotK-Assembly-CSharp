...
public class Unit00499UnitStatus : MonoBehaviour
{
  ...
  {
    if ((UnityEngine.Object) this.dirLimitBreaks == (UnityEngine.Object) null)
      return;
  ...
  public void SetStatusText(PlayerUnit playerUnit, bool enableAwake = false)
  {
    ...
    this.TxtJobname.SetTextLocalize(playerUnit.getJobData().name);
    if (unit.awake_unit_flag & enableAwake && (UnityEngine.Object) this.dirAwake != (UnityEngine.Object) null && (UnityEngine.Object) this.slcUnitbaseAfter != (UnityEngine.Object) null)
    {
