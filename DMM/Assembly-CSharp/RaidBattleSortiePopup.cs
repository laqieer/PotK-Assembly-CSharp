...
public class RaidBattleSortiePopup : BackButtonMenuBase
{
    ...
    string recommendCombat)
  {
    ...
    IEnumerator e;
    if ((bool) (UnityEngine.Object) battleSortiePopup.lnkTeamMain && !(bool) (UnityEngine.Object) battleSortiePopup.mainPanel)
    {
    ...
    if ((bool) (UnityEngine.Object) battleSortiePopup.mainPanel && battleSortiePopup.isInitMainPanel)
    {
      e = battleSortiePopup.mainPanel.doLoadResources();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      battleSortiePopup.resetModeSwitch(Util.checkUnlockedPlayerLevel(Player.Current.level) && ((IEnumerable<PlayerCustomDeck>) SMManager.Get<PlayerCustomDeck[]>()).Any<PlayerCustomDeck>((Func<PlayerCustomDeck, bool>) (x => ((IEnumerable<int>) x.player_unit_ids).Any<int>((Func<int, bool>) (i => (uint) i > 0U)))));
      battleSortiePopup.mainPanel.eventDeckChanged = new System.Action<DeckInfo>(battleSortiePopup.updateDeckInfo);
      battleSortiePopup.mainPanel.eventClickedFriendUnit = new System.Action<PlayerUnit, string, int>(battleSortiePopup.onClickedFriendUnit);
      battleSortiePopup.mainPanel.eventClickedEditItem = new System.Action(battleSortiePopup.OnSupplyEquipButton);
      battleSortiePopup.mainPanel.eventClickedSupply = new System.Action<int>(battleSortiePopup.onClickedSupply);
      battleSortiePopup.mainPanel.eventClickedBattleSetting = new System.Action(battleSortiePopup.OnBattleConfigButton);
      battleSortiePopup.mainPanel.eventClickedEditDeck = new System.Action(battleSortiePopup.OnDeckEditButton);
      battleSortiePopup.isInitMainPanel = false;
    }
    if ((UnityEngine.Object) battleSortiePopup.unitIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) battleSortiePopup.itemIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) battleSortiePopup.skillDetailPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((bool) (UnityEngine.Object) battleSortiePopup.mainPanel)
    {
  ...
  public void resetModeSwitch(bool bExistCustom) => this.mainPanel.initModeSwitch(new bool[2]
  {
    true,
    bExistCustom
  }, new System.Action<SortieDeckMainPanel.DeckMode>(this.onChangedDeckMode));
  ...
  public IEnumerator ReloadAsync(
    ...
    PlayerItem[] supplys)
  {
    if ((bool) (UnityEngine.Object) this.mainPanel)
    {
  ...
  private IEnumerator SetDeck(PlayerUnit[] deck, int[] usedUnitIds)
  {
    ...
    ((IEnumerable<PlayerUnit>) deck).ForEach<PlayerUnit>(new System.Action<PlayerUnit>(battleSortiePopup.\u003CSetDeck\u003Eb__39_0));
  ...
  private void onClickedFriendUnit(PlayerUnit unit, string player_id, int unit_id) => this.parent.OnClickUnitIcon(unit, true);
  ...
  private IEnumerator SetSupplys(PlayerItem[] supplys)
  {
    ...
    for (int i = 0; i < supplys.Length; ++i)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      itemIconScript.onClick = (System.Action<ItemIcon>) (supplyicon => this.StartCoroutine(this.setDetailPopup(supplys[temp].supply.ID)));
  ...
  public void onClickedLeaderSkillZoom()
  {
    if (this.leaderSkill == null || (UnityEngine.Object) this.skillDetailPrefab == (UnityEngine.Object) null || this.IsPushAndSet())
      return;
    PopupSkillDetails.show(this.skillDetailPrefab, new PopupSkillDetails.Param(this.leaderSkill), onClosed: new System.Action(this.onClosedSkillZoom));
  }
  ...
  public void onClickedFriendSkillZoom()
  {
    if (this.friendSkill == null || (UnityEngine.Object) this.skillDetailPrefab == (UnityEngine.Object) null || this.IsPushAndSet())
      return;
    PopupSkillDetails.show(this.skillDetailPrefab, new PopupSkillDetails.Param(this.friendSkill), onClosed: new System.Action(this.onClosedSkillZoom));
  }
