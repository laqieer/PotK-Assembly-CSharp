...
public class Tower029SupplyEditMenu : BackButtonMenuBase
{
  ...
  private IEnumerator ResourceLoad()
  {
    Future<GameObject> f;
    IEnumerator e;
    if ((UnityEngine.Object) this.confirmPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.warningPopup == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator SetSelectionUnitAndSupply()
  {
    ...
    {
      Future<WebAPI.Response.TowerRestart> f = WebAPI.TowerRestart(intList1.ToArray(), intList2.ToArray(), tower029SupplyEditMenu.selectedUnitIDs, tower029SupplyEditMenu.progress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
    ...
    {
      Future<WebAPI.Response.TowerReassign> f = WebAPI.TowerReassign(intList1.ToArray(), intList2.ToArray(), TowerUtil.PayRecoveryCoinNum == 0, tower029SupplyEditMenu.selectedUnitIDs, tower029SupplyEditMenu.progress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    {
      Future<WebAPI.Response.TowerEntry> f = WebAPI.TowerEntry(intList1.ToArray(), intList2.ToArray(), tower029SupplyEditMenu.selectedUnitIDs, tower029SupplyEditMenu.progress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    e1 = tower029SupplyEditMenu.UpdateTowerDeck((System.Action) (() =>
    {
  ...
  private IEnumerator UpdateTowerDeck(System.Action successAction)
  {
    ...
    else
    {
      ...
      if (flag)
      {
        Future<WebAPI.Response.TowerDeckEdit> f = WebAPI.TowerDeckEdit(intList.ToArray(), this.progress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
    ...
    TowerUtil.SequenceType type)
  {
    ...
    for (int index = 0; index < Consts.GetInstance().DECK_SUPPLY_MAX; ++index)
    {
      GameObject self = UnityEngine.Object.Instantiate<GameObject>(this.iconPrefab);
      if ((UnityEngine.Object) this.icons[index] != (UnityEngine.Object) null)
        UnityEngine.Object.Destroy((UnityEngine.Object) this.icons[index].gameObject);
  ...
  public void onDecideButton()
  {
    ...
    prefab.GetComponent<Tower029SupplyConfirmPopup>().Initialize((System.Action) (() => this.StartCoroutine(this.SetSelectionUnitAndSupply())));
