...
public class Versus026DirWinLossRecordsDetailItem : MonoBehaviour
{
    ...
    string duel)
  {
    ...
    UnitIcon unitIconScript = iconPrefab.GetComponent<UnitIconBase>().GetComponent<UnitIcon>();
  ...
  public void OpenPopupInfo() => Singleton<PopupManager>.GetInstance().open(this.popupInfoPrefab).GetComponent<BattleUI01UnitInformation>().InitFromHistory(this.blUnit, this.isPLayerUnit);
}
