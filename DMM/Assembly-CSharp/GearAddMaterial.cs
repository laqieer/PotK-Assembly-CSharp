...
public class GearAddMaterial : MonoBehaviour
{
  ...
  public void Init()
  {
    ...
    if ((UnityEngine.Object) this.itemIcon == (UnityEngine.Object) null)
      return;
    UnityEngine.Object.Destroy((UnityEngine.Object) this.itemIcon.gameObject);
  ...
  private IEnumerator CreateIcon(GameCore.ItemInfo gear)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    gearAddMaterial.itemIcon = fp.Result.Clone(gearAddMaterial.transform).GetComponent<ItemIcon>();
