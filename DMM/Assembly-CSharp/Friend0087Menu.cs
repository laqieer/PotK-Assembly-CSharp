...
public class Friend0087Menu : BackButtonMenuBase
{
  ...
  private IEnumerator FriendAcceptAsync()
  {
    ...
    Future<WebAPI.Response.FriendAccept> future = WebAPI.FriendAccept(friend0087Menu1.target_friend_ids.ToArray(), new System.Action<WebAPI.Response.UserError>(friend0087Menu1.\u003CFriendAcceptAsync\u003Eb__6_0));
    ...
    if (future.Result != null)
    {
      if (future.HasResult)
      {
        ...
        Singleton<PopupManager>.GetInstance().onDismiss(true);
        string playerName = "";
        ((IEnumerable<PlayerFriend>) SMManager.Get<PlayerFriend[]>()).ForEach<PlayerFriend>((System.Action<PlayerFriend>) (fr =>
        {
