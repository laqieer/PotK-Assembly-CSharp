...
public class GachaPlay : MonoBehaviour
{
    ...
    else
    {
      switch (gacha_type)
      {
        ...
        default:
          ...
          {
            // ISSUE: reference to a compiler-generated method
            Future<WebAPI.Response.GachaG075ChargePay> paramF3 = WebAPI.GachaChargePay<WebAPI.Response.GachaG075ChargePay>(name, num, gacha_id, new System.Action<WebAPI.Response.UserError>(gachaPlay.\u003CChargeGacha\u003Eb__6_3));
            e = paramF3.Wait();
            while (e.MoveNext())
              yield return e.Current;
            e = (IEnumerator) null;
            WebAPI.Response.GachaG075ChargePay result_list3 = paramF3.Result;
            if (result_list3 == null)
            {
              yield break;
            }
            else
            {
              ...
              while (e.MoveNext())
                yield return e.Current;
              e = (IEnumerator) null;
              GachaResultData.GetInstance().SetData(result_list3, beforePlayerCommonTicket);
              paramF3 = (Future<WebAPI.Response.GachaG075ChargePay>) null;
              result_list3 = (WebAPI.Response.GachaG075ChargePay) null;
              break;
            }
          }
      }
    ...
    int payment_amount)
  {
    ...
    switch (gacha_type)
    {
      ...
      default:
        ...
        {
          // ISSUE: reference to a compiler-generated method
          Future<WebAPI.Response.GachaG075ChargeMultiPay> paramF3 = WebAPI.GachaChargeMultiPay<WebAPI.Response.GachaG075ChargeMultiPay>(name, gacha_id, new System.Action<WebAPI.Response.UserError>(gachaPlay.\u003CChargeGachaMulti\u003Eb__7_3));
          e = paramF3.Wait();
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
          WebAPI.Response.GachaG075ChargeMultiPay result_list3 = paramF3.Result;
          if (result_list3 == null)
          {
            yield break;
          }
          else
          {
            ...
            e = (IEnumerator) null;
            GachaResultData.GetInstance().SetData(result_list3, beforePlayerCommonTicket);
            paramF3 = (Future<WebAPI.Response.GachaG075ChargeMultiPay>) null;
            result_list3 = (WebAPI.Response.GachaG075ChargeMultiPay) null;
            break;
          }
        }
    }
  ...
  public IEnumerator FriendGacha(string name, int num, int gacha_id)
  {
    ...
    gachaPlay.cleanup();
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.GachaG002FriendpointPay> paramF = WebAPI.GachaFriendPointPay(name, num, gacha_id, new System.Action<WebAPI.Response.UserError>(gachaPlay.\u003CFriendGacha\u003Eb__8_0));
    ...
    GameObject popupPrefab)
  {
    ...
    gachaPlay.cleanup();
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.GachaG004TicketPay> paramF = WebAPI.GachaTicketPay<WebAPI.Response.GachaG004TicketPay>(name, num, gachaData.id, new System.Action<WebAPI.Response.UserError>(gachaPlay.\u003CTicketGacha\u003Eb__9_0));
    IEnumerator e = paramF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ...
    int payment_amount)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      Future<WebAPI.Response.GachaG001ChargeMultiPay> paramF = WebAPI.GachaChargeMultiPay<WebAPI.Response.GachaG001ChargeMultiPay>(name, gacha_id, new System.Action<WebAPI.Response.UserError>(gachaPlay.\u003CTutorialGacha\u003Eb__10_0));
      IEnumerator e = paramF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  {
    yield return (object) PopupCommon.Show(error.Code, error.Reason, (System.Action) (() => Singleton<NGSceneManager>.GetInstance().changeScene("gacha006_3", false)));
  }
}
