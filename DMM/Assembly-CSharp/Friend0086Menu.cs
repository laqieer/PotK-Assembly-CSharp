...
public class Friend0086Menu : BackButtonMenuBase
{
  ...
  private IEnumerator openPopup0087()
  {
    ...
    Singleton<PopupManager>.GetInstance().open(result).GetComponent<Friend0087Menu>().Init0087PopUp(friend0086Menu.target_player_id, new System.Action(friend0086Menu.backToScene));
  }
  ...
  private IEnumerator Cancellation()
  {
    ...
    component.SetCallback(new System.Action(friend0086Menu.callbackFriendCancellation));
  }
    ...
    string[] unlock_target_player_ids)
  {
    ...
    Future<WebAPI.Response.FriendFavorite> ft = WebAPI.FriendFavorite(target_player_ids, unlock_target_player_ids, (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    if (ft.Result != null)
    {
      ...
      this.changeFavorite((uint) target_player_ids.Length > 0U);
      Singleton<CommonRoot>.GetInstance().loadingMode = 0;
    }
  }

  public virtual void IbtnFavoriteiOff() => this.StartCoroutine(this.FriendFavoriteAsync(new string[1]
  {
    this.target_player_id
  }, new string[0]));

  public virtual void IbtnFavoriteiOn() => this.StartCoroutine(this.FriendFavoriteAsync(new string[0], new string[1]
  {
    this.target_player_id
  }));
  ...
  private IEnumerator openPopup0089()
  {
    ...
    e = (IEnumerator) null;
    GameObject result = prefabF.Result;
    Singleton<PopupManager>.GetInstance().open(result).GetComponent<Friend0089Menu>().InitPopup(friend0086Menu.target_player_id, new System.Action(friend0086Menu.backToScene));
  }
  ...
  public void changeFavorite(bool favorite)
  {
    ...
    {
      this.favorite = false;
      this.BtnFavoritOn.gameObject.SetActive(false);
      this.BtnFavoritOff.gameObject.SetActive(false);
      this.BtnCancellation.gameObject.SetActive(false);
      this.BtnApplication.gameObject.SetActive(false);
      this.slcFriendBadge.gameObject.SetActive(false);
      this.slcGuildBadge.gameObject.SetActive(false);
    }
    else
    {
      this.favorite = favorite;
      this.BtnFavoritOn.gameObject.SetActive(this.favorite);
      this.BtnFavoritOff.gameObject.SetActive(!this.favorite);
  ...
  {
    GameObject gameObject = this.BtnApplication.gameObject.transform.Find("slc_applying").gameObject;
    switch (this.friendStatus)
    {
      case 1:
        this.BtnFavoritOn.gameObject.SetActive(false);
        this.BtnFavoritOff.gameObject.SetActive(true);
        this.BtnFavoritOff.isEnabled = false;
        this.BtnCancellation.gameObject.SetActive(false);
        this.BtnApplication.gameObject.SetActive(true);
        gameObject.gameObject.SetActive(true);
        this.slcFriendBadge.gameObject.SetActive(false);
        this.slcGuildBadge.gameObject.SetActive(this.isGuildMember);
        break;
      case 2:
        this.BtnFavoritOff.isEnabled = true;
        this.BtnCancellation.gameObject.SetActive(true);
        this.BtnApplication.gameObject.SetActive(false);
        gameObject.gameObject.SetActive(false);
        this.slcFriendBadge.gameObject.SetActive(!this.isGuildMember);
        this.slcGuildBadge.gameObject.SetActive(this.isGuildMember);
        break;
      default:
        this.BtnFavoritOn.gameObject.SetActive(false);
  ...
  private IEnumerator SetGuildInfo(GuildDirectory guild)
  {
    ...
    else
    {
      ...
      if (data.level < 10)
      {
        this.GuildLevel.gameObject.SetActive(false);
        this.GuildLevel10.gameObject.SetActive(true);
      ...
      {
        this.GuildLevel.gameObject.SetActive(true);
        this.GuildLevel10.gameObject.SetActive(true);
      ...
      if ((UnityEngine.Object) this.guildBase != (UnityEngine.Object) null)
        UnityEngine.Object.Destroy((UnityEngine.Object) this.guildBase);
  ...
  public void FriendDetailScene(PlayerUnit playerUnit) => Unit0042Scene.changeSceneFriendUnit(true, this.target_player_id, playerUnit);

  private void SetIconEvent(UIButton button, PlayerUnit unit) => EventDelegate.Add(button.onClick, (EventDelegate.Callback) (() => this.FriendDetailScene(unit)));
    ...
    bool in_is_favorite)
  {
    ...
    if (!friend0086Menu.isInit)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadEmblemSprite(friendDetail.player_current_emblem_id);
      e = sprF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      ...
      e = (IEnumerator) null;
      int combat = 0;
      ((IEnumerable<PlayerUnit>) deck).ForEach<PlayerUnit>((System.Action<PlayerUnit>) (x =>
      {
  ...
  private void SetTextRecord(SM.FriendDetail friendDetail)
  {
    ...
    else
    {
      ...
      this.BtnBattleRecoed.isEnabled = false;
    }
    this.BtnBattleRecoed.gameObject.SetActive(friendDetail.is_display_pvp_history);
  }
  ...
  {
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Future<WebAPI.Response.FriendPvpClassMatchHistory> futureF = WebAPI.FriendPvpClassMatchHistory(this.target_player_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  private IEnumerator ShowGuildInfo()
  {
    ...
    friend0086Menu.guildInfoPopup.SetRequestMaintenanceCallback(new System.Action(friend0086Menu.SetActionGuildMaintenance));
    friend0086Menu.guildInfoPopup.SetRequestAlreadyGuildCallback(new System.Action(friend0086Menu.SetActionAlreadyGuild));
    return false;
  }
  ...
  public void SetActionAlreadyGuild() => this.StartCoroutine(PopupCommon.Show(Consts.GetInstance().POPUP_028_1_1_5_TITLE, Consts.GetInstance().POPUP_028_1_1_6_NO_APPLICANT));

  private IEnumerator LoadCharacterSprite(int id, int job_id, GameObject locationObject)
  {
    if (MasterData.UnitUnit.ContainsKey(id))
    {
      Future<UnityEngine.Sprite> mainFuture = MasterData.UnitUnit[id].LoadSpriteLarge(job_id, 1f);
      ...
      component.FitMask();
      mainFuture = (Future<UnityEngine.Sprite>) null;
  ...
  public void onButtonFriendApplication()
  {
    ...
    if (this.friendStatus == 1)
      ...
      PopupCommonNoYes.Show(Consts.GetInstance().FRIEND_0086_MENU_APPLICATION_TITLE, Consts.GetInstance().FRIEND_0086_MENU_APPLICATION_MESSAGE, (System.Action) (() =>
      {
  ...
  private IEnumerator FriendApplyAsync()
  {
    ...
    else
    {
      ...
      Future<WebAPI.Response.FriendApply> future = WebAPI.FriendApply(friend0086Menu.target_friend_ids.ToArray(), new System.Action<WebAPI.Response.UserError>(friend0086Menu.\u003CFriendApplyAsync\u003Eb__82_0));
