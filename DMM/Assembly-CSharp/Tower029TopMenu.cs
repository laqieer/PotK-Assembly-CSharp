...
public class Tower029TopMenu : BackButtonMenuBase
{
  ...
  private IEnumerator ResourceLoad(int towerID)
  {
    Future<GameObject> f;
    IEnumerator e;
    if ((UnityEngine.Object) this.recoveryByStonePopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.unitSelectionPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.restartUnitSelectionPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.floorListPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.bgPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.unitSelectionStartPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.restartPopup == (UnityEngine.Object) null)
    {
  ...
  private void SetFloor(int maxFloor, int currentFloor)
  {
    ...
    if (this.centerOnChild.transform.childCount > 0)
    {
      for (int index = 0; index < this.centerOnChild.transform.childCount; ++index)
        this.centerOnChild.transform.GetChild(index).GetComponent<TowerLevelList>().Init(this.isClearAllFloor || this.progress.floor > index + 1, this.progress.floor < index + 1, index + 1, (GameObject) null, (System.Action<GameObject>) (obj => this.centerOnChild.CenterOn(obj.transform)), towerPeriod?.floor_id);
      this.centerOnChild.CenterOn(this.centerOnChild.transform.GetChild(currentFloor - 1).transform);
    }
    else
    {
      for (int index = 0; index < maxFloor; ++index)
      {
        ...
        GameObject gameObject = this.floorListPrefab.Clone(this.centerOnChild.transform);
        gameObject.GetComponent<TowerLevelList>().Init(this.isClearAllFloor || this.progress.floor > index + 1, this.progress.floor < index + 1, index + 1, (GameObject) null, (System.Action<GameObject>) (obj => this.centerOnChild.CenterOn(obj.transform)), towerPeriod?.floor_id);
        gameObject.transform.localPosition = new Vector3(0.0f, (float) this.direction * this.grid.cellHeight * (float) index, 0.0f);
      }
      this.scroll_start_y = this.scrollView.transform.localPosition.y;
  ...
  {
    if ((UnityEngine.Object) this.bgObject != (UnityEngine.Object) null)
      return;
  ...
  private IEnumerator CreateClearBonusIcon()
  {
    ...
    for (int index = 0; index < this.dyn_reward_icon_unit.transform.childCount; ++index)
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dyn_reward_icon_unit.transform.GetChild(0).gameObject);
    this.dyn_reward_icon_unit.SetActive(false);
    for (int index = 0; index < this.dyn_reward_icon_item.transform.childCount; ++index)
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dyn_reward_icon_item.transform.GetChild(0).gameObject);
  ...
  {
    float num1 = this.scrollView.transform.localPosition.y - this.scroll_start_y;
    ...
    {
      Transform child = this.grid.transform.GetChild(index);
      float num3 = Mathf.Abs(child.localPosition.y + num1);
      if ((double) num3 < (double) num2)
      {
        num2 = num3;
        towerLevelList = child.gameObject.GetComponent<TowerLevelList>();
      }
    ...
    if (!((UnityEngine.Object) towerLevelList != (UnityEngine.Object) null) || !((UnityEngine.Object) this.currentTowerLevelList != (UnityEngine.Object) towerLevelList))
      return;
    ...
    if (this.mode == Tower029TopMenu.Mode.Normal)
    {
      if (towerLevelList.isClear || towerLevelList.isLocked)
        this.btnBattleChallenge.GetComponent<SpreadColorButton>().isEnabled = false;
      else
        this.btnBattleChallenge.GetComponent<SpreadColorButton>().isEnabled = true;
    }
    else if (this.mode == Tower029TopMenu.Mode.NoUnit)
      this.btnBattleChallenge.GetComponent<SpreadColorButton>().isEnabled = towerLevelList.floorNum == this.progress.floor;
    this.lblRewardAchieved.gameObject.SetActive(towerLevelList.isClear && !string.IsNullOrEmpty(this.lblRewardValue.text));
  ...
  private IEnumerator ShowEnemyListPopup()
  {
    ...
    yield return (object) null;
    IEnumerator e;
    if ((UnityEngine.Object) this.enemyListPopup == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator ShowMapCheckPopup()
  {
    ...
    {
      IEnumerator e;
      if ((UnityEngine.Object) tower029TopMenu.mapCheckPrefab == (UnityEngine.Object) null)
      {
  ...
  private void ShowUnitSelectionStartPopup()
  {
    ...
    prefab.GetComponent<Tower029UnitSelectionStartPopup>().Initialize((System.Action<TowerUtil.UnitSelectionMode, TowerUtil.SequenceType>) ((x, y) => this.StartCoroutine(this.ShowUnitSelectionScene(x, y))), (System.Action) null);
    Singleton<PopupManager>.GetInstance().open(prefab, isCloned: true);
  }

  private void ShowNoAvailableUnitPopup() => ModalWindow.Show(Consts.GetInstance().TOWER_MODAL_WARNING_NO_UNIT_TITLE, Consts.Format(Consts.GetInstance().TOWER_MODAL_WARNING_NO_UNIT_DESC, (IDictionary) new Hashtable()
  {
    {
      (object) "level",
    ...
    if (!((IEnumerable<PlayerUnit>) this.towerEntryUnit).Any<PlayerUnit>())
    {
      ...
      else if (((IEnumerable<PlayerUnit>) SMManager.Get<PlayerUnit[]>()).Any<PlayerUnit>((Func<PlayerUnit, bool>) (u => u.level >= TowerUtil.BorderLevel)))
      {
        if (this.progress.is_entry)
        {
          ...
          if (!this.isInit)
            ModalWindow.Show(Consts.GetInstance().TOWER_MODAL_UNIT_ANNIHILATION_TITLE, Consts.GetInstance().TOWER_MODAL_UNIT_ANNIHILATION_DESC, (System.Action) (() => {}));
        }
        else
        {
...
label_21:
  ...
  private void SetMode(Tower029TopMenu.Mode mode)
  {
    switch (mode)
    {
      case Tower029TopMenu.Mode.Normal:
        ...
        if ((UnityEngine.Object) this.currentTowerLevelList != (UnityEngine.Object) null && this.currentTowerLevelList.floorNum == this.progress.floor)
          this.btnBattleChallenge.GetComponent<SpreadColorButton>().isEnabled = true;
        else
          this.btnBattleChallenge.GetComponent<SpreadColorButton>().isEnabled = false;
        this.btnUnitList.isEnabled = true;
        this.btnRecovery.isEnabled = true;
        break;
      case Tower029TopMenu.Mode.Restriction:
        this.btnUnitList.isEnabled = false;
        this.btnRecovery.isEnabled = false;
        this.btnRestart.SetActive(false);
        this.btnBattleChallenge.SetActive(true);
        this.btnBattleChallenge.GetComponent<SpreadColorButton>().isEnabled = false;
        break;
  ...
  private IEnumerator SetHeaderIcon()
  {
    ...
    Future<UnityEngine.Sprite> ft = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Icons/Kiseki_Icon");
  ...
  {
    base.Update();
    if ((double) this.scrollView.transform.localPosition.y > (double) this.maxScrollHeight)
    {
      this.scrollView.scrollWheelFactor = 1f / 1000f;
      this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, (float) this.maxScrollHeight, 0.0f);
    }
    else if ((double) this.scrollView.transform.localPosition.y < (double) this.minScrollHeight)
    {
      this.scrollView.scrollWheelFactor = 1f / 1000f;
      this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, (float) this.minScrollHeight, 0.0f);
    }
    else
      this.scrollView.scrollWheelFactor = 0.25f;
    this.isScroll = (double) this.scrollView.transform.localPosition.y - (double) this.scroll_start_y != (double) this.scroll_delta_tmp;
    if (!this.isScroll)
      return;
    this.scroll_delta_tmp = this.scrollView.transform.localPosition.y - this.scroll_start_y;
  ...
  public IEnumerator InitializeAsync(bool forceInitialize = false)
  {
    ...
    Future<WebAPI.Response.TowerTop> f = WebAPI.TowerTop(tower029TopMenu.towerID, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
    e1 = f.Wait();
    while (e1.MoveNext())
      yield return e1.Current;
    e1 = (IEnumerator) null;
    ...
    else
    {
      ...
      Future<UnityEngine.Sprite> ft = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Icons/TowerMedal_Icon");
      e1 = ft.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
      ...
      ft = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Icons/Item_Icon_Kiseki");
      e1 = ft.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
      ...
      if (!tower029TopMenu.isInit)
      {
        ...
        tower029TopMenu.centerOnChild.onFinished = new SpringPanel.OnFinished(tower029TopMenu.onFinished);
  ...
  public void onChallengeButton()
  {
    ...
    if (this.mode == Tower029TopMenu.Mode.Normal)
    {
      if (TowerUtil.TowerPlayer.tower_medal >= TowerUtil.MaxTowerMedalNum)
        ModalWindow.Show(Consts.GetInstance().TOWER_MODAL_GOTO_SHOPPING_TITLE, Consts.GetInstance().TOWER_MODAL_GOTO_SHOPPING_DESC, (System.Action) (() => {}));
      else
  ...
  public void onRestartButton()
  {
    ...
    System.Action<TowerUtil.UnitSelectionMode, TowerUtil.SequenceType> action = (System.Action<TowerUtil.UnitSelectionMode, TowerUtil.SequenceType>) ((x, y) => this.StartCoroutine(this.ShowUnitSelectionScene(x, y)));
    int coin = this.progress.completed_count == 1 ? 0 : TowerUtil.RestartCoinNum;
    component.Initialize(unitSelectionPopup, progress, action, coin);
  ...
  public void onRecoveryButton()
  {
    ...
    TowerProgress progress = this.progress;
    System.Action<TowerUtil.UnitSelectionMode, TowerUtil.SequenceType> action = (System.Action<TowerUtil.UnitSelectionMode, TowerUtil.SequenceType>) ((x, y) => this.StartCoroutine(this.ShowUnitSelectionScene(x, y)));
    int coin = this.dir_recovery_time.activeSelf ? TowerUtil.RecoveryCoinNum : 0;
    int num = flag ? 1 : 0;
    component.Initialize(popup, progress, action, coin, num != 0);
    prefab.SetActive(true);
    Singleton<PopupManager>.GetInstance().open(prefab, isCloned: true);
  }
