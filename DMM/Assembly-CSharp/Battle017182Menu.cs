...
public class Battle017182Menu : BattleBackButtonMenuBase
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    battle017182Menu.victory_conditions_txt.gameObject.SetActive(true);
  ...
  private IEnumerator setupMapChips()
  {
    ...
    int cellSize = (int) Mathf.Min((float) inParents.width / (float) fieldWidth, b);
  ...
  private string GetFormationSpriteName(int order)
  {
    ...
    {
      case 0:
        str = "slc_mapchip_ownarea";
        break;
      case 1:
        str = "slc_mapchip_enemyarea";
        break;
    }
    return str;
  }
