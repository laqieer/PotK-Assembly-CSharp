...
public class RouletteAwardResultPopupController : MonoBehaviour
{
  ...
  private void ShowCampaignPopup() => Singleton<PopupManager>.GetInstance().open(this.campaignPopupPrefab).GetComponent<RouletteCampaignPopupController>().Init(this.campaignURL);
}
