...
public class Sea030_questScene : NGSceneBase
{
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    if ((UnityEngine.Object) sea030QuestScene.menu == (UnityEngine.Object) null)
    {
      ...
      sea030QuestScene.menu = ldMain.Result.Clone(sea030QuestScene.gameObject.transform).GetComponent<Sea030_questMenu>();
      ...
      sea030QuestScene.menu.gameObject.SetActive(false);
  ...
  public IEnumerator onStartSceneAsync(bool forceInitialize = false)
  {
    ...
    {
      sea030QuestScene.menu.gameObject.SetActive(true);
      yield return (object) null;
  ...
  public void onStartScene(bool forceInitialize = false) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
  ...
  public override IEnumerator onEndSceneAsync()
  {
    ...
    while (!sea030QuestScene.isTweenFinished && (double) Time.time - (double) startTime < (double) sea030QuestScene.tweenTimeoutTime)
      yield return (object) null;
    sea030QuestScene.gameObject.GetComponent<UIRect>().alpha = 0.0f;
    if ((UnityEngine.Object) sea030QuestScene.menu != (UnityEngine.Object) null)
