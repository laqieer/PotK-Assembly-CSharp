...
public class DetailMenuScrollView01 : DetailMenuScrollViewBase
{
  ...
  {
    Future<UnityEngine.Sprite> spriteF = skill.skill.LoadBattleSkillIcon();
    ...
    if ((double) skill.need_affection > (double) unit.trust_rate)
      this.extraSKill.color = Color.gray;
  }
    ...
    GameObject[] prefabs)
  {
    ...
    if ((UnityEngine.Object) this.floatingSkillDialog != (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.extraSkillObject != (UnityEngine.Object) null)
    {
  ...
  private void setParamUnity(PlayerUnit playerUnit) => this.txt_Unity.SetTextLocalize(playerUnit.unityTotal.ToString());
    ...
    System.Action action = null)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    if ((UnityEngine.Object) menuScrollView01.unitmodel != (UnityEngine.Object) null)
      UnityEngine.Object.Destroy((UnityEngine.Object) menuScrollView01.unitmodel);
    if ((UnityEngine.Object) menuScrollView01.ui_3DModel == (UnityEngine.Object) null)
    {
    ...
    menuScrollView01.ui_3DModel.ModelCamera.transform.localPosition = modelPos;
    menuScrollView01.ui_3DModel.Remove();
    menuScrollView01.ui_3DModel.uiTexture.alpha = 0.0f;
  ...
  private IEnumerator loadUI3DModelAsync(
    PlayerUnit playerUnit,
    Vector3 modelPos,
    System.Action action = null)
  {
    yield return (object) new WaitWhile((Func<bool>) (() => Singleton<NGSceneManager>.GetInstance().IsDangerAsyncLoadResource()));
    yield return (object) this.ui_3DModel.Unit(playerUnit, (System.Action) (() =>
    {
      this.unitmodel = this.ui_3DModel.model_creater_.BaseModel;
      this.ui_3DModel.ModelCamera.transform.localPosition = modelPos;
      this.ui_3DModel.uiTexture.alpha = 1f;
  ...
  {
    if ((UnityEngine.Object) this.ui_3DModel == (UnityEngine.Object) null || (UnityEngine.Object) this.ui_3DModel.ModelCamera == (UnityEngine.Object) null || (UnityEngine.Object) this.ui_3DModel.ModelCamera.gameObject == (UnityEngine.Object) null)
      return;
    this.ui_3DModel.ModelCamera.gameObject.SetActive(bActive);
  }
}
