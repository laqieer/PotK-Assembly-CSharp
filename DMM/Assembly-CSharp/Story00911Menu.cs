...
public class Story00911Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(int id, int id2)
  {
    ...
    story00911Menu.ScrollContainer.GridReposition(new UIGrid.OnReposition(story00911Menu.\u003CInit\u003Eb__5_0));
  }
  ...
  public IEnumerator CreateEpisodes(int id, int id2)
  {
    ...
    for (int index = 0; index < questsList.Count; ++index)
    {
      ...
      story00911Menu.ScrollContainer.Add(gameObject);
      gameObject.GetComponent<Story0096EpisodeParts>().setData(questsList[index], playbackList[index], (NGMenuBase) story00911Menu, continuousDataList);
    }
    story00911Menu.DirNoStory.SetActive(story00911Menu.ScrollContainer.grid.transform.childCount <= 0);
  }
}
