...
public class LumpToutaResultMenu : MonoBehaviour
{
    ...
    UnlockQuest[] unlockQuests)
  {
    ...
    {
      UnitResult unitResultScript = unitResultPrefab.CloneAndGetComponent<UnitResult>(lumpToutaResultMenu.grid.transform);
    ...
    lumpToutaResultMenu.grid.onReposition = new UIGrid.OnReposition(lumpToutaResultMenu.\u003CInit\u003Eb__6_0);
  ...
  public void OnStartScene() => Singleton<NGSceneManager>.GetInstance().StartCoroutine(this.gaugeAnimation());
