...
public class GuildBattleRecordPopup : GuildBattleRecordListBase
{
  ...
  private void SetLabel() => this.lblPopupTitle.SetTextLocalize(Consts.GetInstance().POPUP_GUILD_BATTLE_RECORD_TITLE);
    ...
    System.Action success = null)
  {
    ...
    Future<WebAPI.Response.GvgHistoryHistoryGet> ft = WebAPI.GvgHistoryHistoryGet(true, guild_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    {
      if ((UnityEngine.Object) battleRecordPopup.GetComponent<UIWidget>() != (UnityEngine.Object) null)
        battleRecordPopup.GetComponent<UIWidget>().alpha = 0.0f;
