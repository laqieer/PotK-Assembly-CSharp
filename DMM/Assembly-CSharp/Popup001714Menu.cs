...
public class Popup001714Menu : NGMenuBase
{
  ...
  public void SetText(string str) => this.TxtDescription.SetTextLocalize(Consts.Format(Consts.GetInstance().POPUP_001714_DESCRIPT_TEXT, (IDictionary) new Hashtable()
  {
    {
      (object) "Item",
      (object) str
