...
public class Quest00210Scene : NGSceneBase
{
  ...
  public void onStartScene(Quest00210Scene.Mode mode) => Singleton<CommonRoot>.GetInstance().isLoading = false;

  public void onStartScene(Quest00210Scene.Mode mode, List<SupplyItem> SupplyItems) => Singleton<CommonRoot>.GetInstance().isLoading = false;
