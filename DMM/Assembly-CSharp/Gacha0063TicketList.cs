...
public class Gacha0063TicketList : Gacha0063hindicator
{
    ...
    int prefabCount)
  {
    ...
    Transform transform = gacha0063Menu.transform.Find("MainPanel").transform;
  ...
  public override IEnumerator Set(GameObject detailPopup)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) gacha0063TicketList.listItem == (UnityEngine.Object) null)
    {
    ...
    if (!((UnityEngine.Object) gacha0063TicketList.listItem == (UnityEngine.Object) null))
    {
      ...
      gacha0063TicketList.mScrollGrid.transform.Clear();
      ...
      {
        Gacha0063TicketItem component = gacha0063TicketList.listItem.CloneAndGetComponent<Gacha0063TicketItem>(gacha0063TicketList.mScrollGrid.gameObject);
      ...
      NGxScroll componentInChildren = gacha0063TicketList.transform.GetComponentInChildren<NGxScroll>();
      if ((UnityEngine.Object) componentInChildren != (UnityEngine.Object) null)
        componentInChildren.ResolvePosition(Vector2.zero);
      BoxCollider[] components = gacha0063TicketList.mScrollGrid.GetComponents<BoxCollider>();
  ...
  private IEnumerator MakeList(
    ...
    List<Gacha0063TicketItem> setupList)
  {
