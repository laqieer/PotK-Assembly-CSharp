...
public class Gacha00613Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool isStack, bool is_retry = false) => Singleton<NGSceneManager>.GetInstance().changeScene("gacha006_13", (isStack ? 1 : 0) != 0, (object) is_retry);
  ...
  public IEnumerator onStartSceneAsync(bool is_retry = false)
  {
    ...
    if (ggrd.GetData() == null)
    {
      if (is_retry)
      {
        ...
        Future<WebAPI.Response.GachaResume> paramF = WebAPI.GachaResume(new System.Action<WebAPI.Response.UserError>(gacha00613Scene.\u003ConStartSceneAsync\u003Eb__4_0));
        e = paramF.Wait();
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
    ...
    if (gacha00613Scene.isError)
    {
      gacha00613Scene.Menu.gameObject.SetActive(false);
    }
    else
    {
  ...
  {
    Gacha00613Scene gacha00613Scene = this;
    IEnumerator e = gacha00613Scene.Menu.OpenBonusIcon();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (GachaResultData.GetInstance().IsPopupEffect())
    {
      gacha00613Scene.Menu.BtnActionEnable(false);
      Singleton<CommonRoot>.GetInstance().SetFooterEnable(false);
      e = gacha00613Scene.SheetGachaResult();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      e = gacha00613Scene.CharacterStory();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      e = gacha00613Scene.CoinAcquisition();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
    gacha00613Scene.Menu.BtnActionEnable(true);
    if (gacha00613Scene.IsPickupResult() && gacha00613Scene.IsAppReviewEnable() && SMManager.Observe<Player>().Value.level >= 150)
      PopupAppReview.Show((MonoBehaviour) gacha00613Scene);
  ...
  private IEnumerator SetBackGround()
  {
    ...
    gacha00613Scene.backgroundPrefab.GetComponent<UI2DSprite>().color = Color.white;
  }
