...
public class Guild0284Menu : BackButtonMenuBase
{
  ...
  public void Initialize() => this.txtTitle.SetTextLocalize(Consts.GetInstance().GUILD_28_4_MENU_TITLE);
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    if ((UnityEngine.Object) this.guildTitleSortPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.guild02841Popup == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator ScrollInit(GuildDisplayEmblem emblem)
  {
    ...
    GameObject gameObject = baseMenu.scrollObj.Clone(baseMenu.grid.transform);
    bool isNew = false;
    ...
    IEnumerator e = gameObject.GetComponent<GuildTItleScroll>().Init(emblem.is_enabled, emblem.unit.ID, emblem.unit.rarity_GuildEmblemRarity, emblem.unit.description, emblem.in_use, isNew, emblem.is_enabled ? emblem.created_at : new DateTime?(), new System.Action(baseMenu.EmblemsScrollUpdate), baseMenu);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator SortPopup()
  {
    ...
    if ((UnityEngine.Object) guildTitleSortPopup.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      guildTitleSortPopup.GetComponent<UIWidget>().alpha = 0.0f;
    Singleton<PopupManager>.GetInstance().open(guildTitleSortPopup).GetComponent<Guild0284TitleSortPopup>().Init(new System.Action(guild0284Menu.ListSort));
    return false;
  }

  private IEnumerator EmblemsUpdate()
  {
    Future<WebAPI.Response.GuildEmblemIndex> emblemData = WebAPI.GuildEmblemIndex((System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
  ...
  {
    ((IEnumerable<GameObject>) this.DisplayOrderSprites).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
  ...
  {
    Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadGuildEmblemSprite(this.curEmblemID);
