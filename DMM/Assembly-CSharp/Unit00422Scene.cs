...
public class Unit00422Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, PlayerUnit playerUnit) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_2_2", (stack ? 1 : 0) != 0, (object) playerUnit);
