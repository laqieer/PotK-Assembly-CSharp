...
public class Friend00819Menu : FriendBarBase
{
  ...
  private IEnumerator openPopup00893()
  {
    ...
    component.setData(stringList.ToArray(), new System.Action<PlayerFriend[]>(friend00819Menu.\u003CopenPopup00893\u003Eb__15_0));
  }
  ...
  private IEnumerator openPopup008202()
  {
    ...
    Future<WebAPI.Response.FriendAccept> future = WebAPI.FriendAccept(friend_ids.ToArray(), (System.Action<WebAPI.Response.UserError>) (e =>
    {
      ...
      if (e.Code.CompareTo("FRD010") == 0)
        Singleton<PopupManager>.GetInstance().open(prefab0088).GetComponent<Friend0088Menu>().InitPopup(e.Reason, new System.Action(this.RefreshFriendRequests));
  ...
  public void RefreshScrollEvent(PlayerFriend[] friends) => this.StartCoroutine(this.RefreshScroll(friends));
  ...
  public void IbtnDeselectAll()
  {
    if (this.IsPush)
      return;
    this.allFriendInfo.ForEach((System.Action<FriendBarInfo>) (x => x.select = false));
  ...
  public void IbtnSelectAll()
  {
    if (this.IsPush)
      return;
    this.allFriendInfo.ForEach((System.Action<FriendBarInfo>) (x => x.select = true));
    foreach (Component component in this.allFriendBar)
      component.GetComponent<Friend00819Scroll>().CheckMarkUpdate();
    this.CheckSelect();
  }
