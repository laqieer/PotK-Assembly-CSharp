...
public class GuildFacilitySellNumEnterPopup : BackButtonMonoBehaiviour
{
  ...
  private IEnumerator SetIcon(PlayerGuildFacility facility)
  {
    ...
    if (battleskill != null && (battleskill.genre1.HasValue || battleskill.genre2.HasValue))
    {
      ...
      if (genre1.HasValue)
      {
        GameObject go = this.prefabGenre.Clone(this.lnkProperty1.transform);
        ...
        NGUITools.AdjustDepth(go, this.depthProperty);
      }
      BattleskillGenre? genre2 = battleskill.genre2;
      if (genre2.HasValue)
      {
        GameObject go = this.prefabGenre.Clone(this.lnkProperty2.transform);
        UIWidget component1 = this.lnkProperty2.GetComponent<UIWidget>();
        SkillGenreIcon component2 = go.GetComponent<SkillGenreIcon>();
  ...
  {
    this.facilityCount = (int) ((double) this.slider.value * (double) this.totalFacility);
    if (this.totalFacility <= 1 && (double) this.slider.value < 1.0)
    {
    ...
    else if (this.facilityCount > this.totalFacility)
    {
      ...
      this.slider.value = (float) this.facilityCount / (float) this.totalFacility;
    }
    ...
    System.Action<int, int, int> actionSell)
  {
    ...
    if ((UnityEngine.Object) sellNumEnterPopup.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      sellNumEnterPopup.GetComponent<UIWidget>().alpha = 0.0f;
  ...
  public void IbtnPopupOk()
  {
    ...
    if (this.facilityCount <= 0)
    {
      ...
      }), (System.Action) (() => this.isPush = false));
  }
