...
public class PVNpcManager : Singleton<PVNpcManager>, IGameEngine
{
  ...
  public static PVNpcManager createPVNpcManager()
  {
    ...
    if ((UnityEngine.Object) pvNpcManager == (UnityEngine.Object) null)
  ...
  public static IEnumerator destroyPVNpcManager()
  {
    ...
    if (!((UnityEngine.Object) manager == (UnityEngine.Object) null))
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) manager.gameObject);
  ...
  private BattleTimeManager timeManager
  {
    get
    {
      if ((UnityEngine.Object) this._timeManager == (UnityEngine.Object) null)
  ...
  private BattleAIController aiController
  {
    get
    {
      if ((UnityEngine.Object) this._aiController == (UnityEngine.Object) null)
  ...
  private BattleInputObserver inputObserver
  {
    get
    {
      if ((UnityEngine.Object) this._inputObserver == (UnityEngine.Object) null)
  ...
  private HashSet<BL.Panel> createFormationPanels(int order)
  {
    ...
    foreach (PvpStageFormation pvpStageFormation in ((IEnumerable<PvpStageFormation>) MasterData.PvpStageFormationList).Where<PvpStageFormation>((Func<PvpStageFormation, bool>) (x => x.stage.ID == this.stage.stage_id && x.player_order == order)))
      panelSet.Add(this.envCore.getFieldPanel(pvpStageFormation.formation_y - 1, pvpStageFormation.formation_x - 1));
    return panelSet;
  }
  ...
  public Future<None> startBattle(BattleInfo battleInfo, bool isRestart) => new Future<None>((Func<Promise<None>, IEnumerator>) (promise => this._startBattle(promise, battleInfo, isRestart)));
    ...
    bool isRestart)
  {
    ...
    else
    {
      ...
      yield return (object) pvNpcManager.battleResume((System.Action) (() => resumeSucceeded = true));
      if (!resumeSucceeded)
      {
  ...
  {
    IEnumerator e = WebAPI.PvpNpcForceClose(true, new System.Action<WebAPI.Response.UserError>(this.webErrorCallback)).Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    bool popupOpen = true;
    ModalWindow.Show(Consts.GetInstance().VERSUS_POPUP_BATTLE_RESUME_ERROR_TITLE, Consts.GetInstance().VERSUS_POPUP_BATTLE_RESUME_ERROR_MESSAGE, (System.Action) (() => popupOpen = false));
    yield return (object) new WaitWhile((Func<bool>) (() => popupOpen));
  }

  private void webErrorCallback(WebAPI.Response.UserError error) => Singleton<NGSceneManager>.GetInstance().StartCoroutine(PopupCommon.Show(error.Code, error.Reason, (System.Action) (() =>
  {
  ...
  private IEnumerator initPrefabs()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.winLosePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.spawnPlayerPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.spawnEnemyPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator battleResume(System.Action onSuccessCallBack)
  {
    ...
    if (Persist.pvpSuspend.Exists && this.battleManager.hasSavedEnvironment())
    {
      ...
      if (this.resumePhase == BL.Phase.battle_start)
        this.envCore.phaseState.setStateWith(this.resumePhase, this.envCore, (System.Action) (() => {}));
      else
        this.envCore.phaseState.setStateWith(BL.Phase.pvp_restart, this.envCore, (System.Action) (() => {}));
  ...
  private IEnumerator mainUpdate()
  {
    ...
    while (true)
    {
      ...
      while (((UnityEngine.Object) pvNpcManager.timeManager == (UnityEngine.Object) null || pvNpcManager.timeManager.isRunning || (sceneManager.changeSceneQueueCount > 0 || !sceneManager.isSceneInitialized) || (!pvNpcManager.battleManager.isBattleEnable || __nonvirtual (pvNpcManager.isWaitAction))) && (pvNpcManager.battleManager.isBattleEnable || pvNpcManager.envCore.phaseState.state != BL.Phase.pvp_disposition))
      {
      ...
      if (pvNpcManager.nextStateWaitAction != null && pvNpcManager.checkNextStateFlags())
      {
        ...
        pvNpcManager.nextStateWaitAction = (System.Action) null;
      }
      else
      {
        switch (pvNpcManager.envCore.phaseState.state)
        {
          ...
          case BL.Phase.pvp_restart:
            // ISSUE: reference to a compiler-generated method
            pvNpcManager.timeManager.setScheduleAction(new System.Action(pvNpcManager.\u003CmainUpdate\u003Eb__115_1));
  ...
  private bool isGameFinish() => this.playerPoint_reserve >= this.endPoint || this.enemyPoint_reserve >= this.endPoint || this.remainTurn.value <= 0;
  ...
  public bool checkDuelDeadUnitAndFinish(BL.Unit attack, BL.Unit defense) => this.deadUnitAndFinish(attack) || this.deadUnitAndFinish(defense);
  ...
  private int calcPoint(BL.Unit unit) => (int) (this.POINT_BASE_FACTOR + ((double) (unit.unit.rarity.index + 1) * this.POINT_RARITY_FACTOR + (double) unit.playerUnit.cost * this.POINT_COST_FACTOR) * (unit.is_leader ? this.POINT_LEADER_FACTOR : this.POINT_NO_LEADER_FACTOR));

  private int calcRespawnCount(BL.Unit unit) => (int) (this.RESPAWN_BASE_FACTOR + ((double) (unit.unit.rarity.index + 1) * this.RESPAWN_RARITY_FACTOR + (double) unit.playerUnit.cost * this.RESPAWN_COST_FACTOR));
  ...
  public void deadReserveToPoint(bool isEnemyDead, bool needAnnihilateCheck)
  {
    ...
    if (isEnemyDead)
    {
      if (!this.checkAnnihilation((IEnumerable<BL.Unit>) this.envCore.enemyUnits.value))
        return;
      this.timeManager.setScheduleAction((System.Action) (() =>
      {
  ...
  private void finishBattle()
  {
    ...
    this.battleManager.battleEffects.startEffect((Transform) null, 3f, popupPrefab: this.winLosePrefab, cloneAction: ((System.Action<GameObject>) (o => o.GetComponent<PopupPvpMatchResult>().setResult(this.getFinishBattle(), this.playerOrder))));
  ...
  public PvpVictoryTypeEnum GetPlayerVictory() => this.GetLeftVictory(this.playerPoint.value, this.enemyPoint.value);

  public PvpVictoryTypeEnum GetEnemyVictory() => this.GetLeftVictory(this.enemyPoint.value, this.playerPoint.value);
  ...
  public PvpVictoryEffectEnum GetPlayerVictoryEffect() => this.GetLeftVictoryEffect(this.playerPoint.value, this.enemyPoint.value);

  public PvpVictoryEffectEnum GetEnemyVictoryEffect() => this.GetLeftVictoryEffect(this.enemyPoint.value, this.playerPoint.value);

  private PvpVictoryEffectEnum GetLeftVictoryEffect(
    int leftPoint,
    int rightPoint)
  {
    int num1 = Mathf.Min(leftPoint, this.stage.point);
  ...
  {
    this.envCore.phaseState.setStateWith(BL.Phase.none, this.envCore, (System.Action) (() => {}));
  ...
  private bool isTimeOut() => this.stopWatch != null && this.stopWatch.IsRunning && this._timeLimit.value == 0;
  ...
  public void moveUnit(BL.UnitPosition up)
  {
    ...
    this.timeManager.setScheduleAction((System.Action) (() => this.nextState(this.envCore.phaseState.state)));
  }
