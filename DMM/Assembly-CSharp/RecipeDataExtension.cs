...
{
  public static IEnumerable<RecipeData> FilterBy(
  ...
  private static bool CheckAllEnumStateEqual(bool[] blist) => ((IEnumerable<bool>) blist).All<bool>((Func<bool, bool>) (v => v == blist[0]));
  ...
  private static IOrderedEnumerable<RecipeData> RecipeExistFirst(
    this IEnumerable<RecipeData> self)
  {
