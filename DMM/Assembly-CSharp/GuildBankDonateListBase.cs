...
public class GuildBankDonateListBase : BackButtonMenuBase
{
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.allDonateInfo.FirstIndexOrNull<DonateBarInfo>((Func<DonateBarInfo, bool>) (v => (UnityEngine.Object) v.scrollParts != (UnityEngine.Object) null && (UnityEngine.Object) v.scrollParts.gameObject == (UnityEngine.Object) unit));
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allDonateInfo.Count); ++index)
      this.allDonateBar.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<GuildBankDonateListParts>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allDonateBar.Count); ++index)
      this.scroll.AddColumn1(this.allDonateBar[index].gameObject, this.barWidth, this.barHeight);
  ...
  protected void ResetScroll(int index)
  {
    ...
    this.allDonateInfo.Where<DonateBarInfo>((Func<DonateBarInfo, bool>) (a => (UnityEngine.Object) a.scrollParts == (UnityEngine.Object) scrollParts)).ForEach<DonateBarInfo>((System.Action<DonateBarInfo>) (b => b.scrollParts = (GuildBankDonateListParts) null));
  }
