...
public class ShopMaterialExchangeListMenu : BackButtonMenuBase
{
    ...
    PlayerSelectTicketSummary playerMaterialTicket)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) exchangeListMenu1.prefabMaterial_ == (UnityEngine.Object) null)
    {
      iswait = true;
    ...
    if ((UnityEngine.Object) exchangeListMenu1.prefabIconMaterial == (UnityEngine.Object) null)
    {
      iswait = true;
    ...
    if ((UnityEngine.Object) exchangeListMenu1.unitIconPrefab == (UnityEngine.Object) null)
    {
      iswait = true;
    ...
    if ((UnityEngine.Object) exchangeListMenu1.uniqueIconPrefab == (UnityEngine.Object) null)
    {
      iswait = true;
    ...
    if ((UnityEngine.Object) exchangeListMenu1.prefabExchange_ == (UnityEngine.Object) null)
    {
      iswait = true;
    ...
    if ((UnityEngine.Object) exchangeListMenu1.prefabMaterialPack == (UnityEngine.Object) null)
    {
      iswait = true;
    ...
    if ((UnityEngine.Object) exchangeListMenu1.prefabSkillDetail_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) exchangeListMenu1.detailPopup == (UnityEngine.Object) null)
    {
  ...
  public void onClickSkillDetail(SelectTicketSelectSample material) => PopupSkillDetails.show(this.prefabSkillDetail_, PopupSkillDetails.Param.createByShopSkillView(new PlayerAwakeSkill()
  {
    ...
    bool isDisplayCounter = false)
  {
    ...
    switch (sample_.entity_type)
    {
      ...
      default:
        ...
        {
          component.onClick = (System.Action<UniqueIcons>) null;
          component.onClick = (System.Action<UniqueIcons>) (x => this.ShowTicketDetail(sample_.entity_type, sample_.reward_id));
        }
        switch (sample_.entity_type)
        {
          ...
          case MasterDataTable.CommonRewardType.awake_skill:
            component.onClick = (System.Action<UniqueIcons>) null;
            component.onClick = (System.Action<UniqueIcons>) (x => this.onClickSkillDetail(sample_));
  ...
  public int GetItemCurrNum(SelectTicketSelectSample sample)
  {
    ...
    switch (sample.entity_type)
    {
      ...
      default:
        ...
        {
          case MasterDataTable.CommonRewardType.quest_key:
            num4 = playerQuestKey == null ? 0 : playerQuestKey.quantity;
            break;
          case MasterDataTable.CommonRewardType.gacha_ticket:
            ...
            num4 = playerGachaTicket == null ? 0 : playerGachaTicket.quantity;
            break;
          case MasterDataTable.CommonRewardType.season_ticket:
            ...
            num4 = playerSeasonTicket == null ? 0 : playerSeasonTicket.quantity;
            break;
          case MasterDataTable.CommonRewardType.unit_ticket:
            ...
            num4 = ((IEnumerable<SM.SelectTicket>) SMManager.Get<SM.SelectTicket[]>()).FirstOrDefault<SM.SelectTicket>((Func<SM.SelectTicket, bool>) (x => x.id == sample.reward_id)) == null ? 0 : selectTicketSummary.quantity;
            break;
          case MasterDataTable.CommonRewardType.awake_skill:
            num4 = ((IEnumerable<PlayerAwakeSkill>) SMManager.Get<PlayerAwakeSkill[]>()).Count<PlayerAwakeSkill>((Func<PlayerAwakeSkill, bool>) (x => x.skill_id == sample.reward_id));
            break;
          case MasterDataTable.CommonRewardType.guild_facility:
            ...
            num4 = playerGuildFacility == null ? 0 : playerGuildFacility.hasnum;
            break;
          case MasterDataTable.CommonRewardType.reincarnation_type_ticket:
            ...
            num4 = playerUnitTypeTicket == null ? 0 : playerUnitTypeTicket.quantity;
            break;
        }
        break;
    }
  ...
  public void ShowTicketDetail(MasterDataTable.CommonRewardType rType, int rID) => Singleton<PopupManager>.GetInstance().monitorCoroutine(this.ShowDetailPopup(rType, rID));
  ...
  public void doExchangeMaterial(int nums, int useCount) => Singleton<PopupManager>.GetInstance().monitorCoroutine(this.coExchangeMaterial(nums, this.iconObj, useCount));

  private IEnumerator coExchangeMaterial(int nums, GameObject icon, int useCount)
  {
    ShopMaterialExchangeListMenu exchangeListMenu1 = this;
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Future<WebAPI.Response.SelectticketSpend> future = WebAPI.SelectticketSpend(exchangeListMenu1.currentMaterialExchange__.ID, 0, useCount, (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    if (future.Result != null)
    {
      ...
      {
        // ISSUE: reference to a compiler-generated method
        ModalWindow.Show(Consts.GetInstance().VERSUS_0026872POPUP_TITLE2, string.Format(Consts.GetInstance().VERSUS_0026872POPUP_DESCRIPTION3, (object) exchangeListMenu1.currentMaterialExchange__.reward_title), new System.Action(exchangeListMenu1.\u003CcoExchangeMaterial\u003Eb__49_2));
      }
      else
  ...
  private IEnumerator OpenPopup0078(int nums, GameObject icon, int useCount)
  {
    ...
    // ISSUE: reference to a compiler-generated method
    component.InitDataSet(exchangeListMenu.currentMaterialExchange__.reward_title, exchangeListMenu.currentMaterialExchange__.reward_value, nums, new System.Action(exchangeListMenu.\u003COpenPopup0078\u003Eb__50_0), true, useCount);
  ...
  private IEnumerator materialPopupInit(SelectTicketSelectSample sample)
  {
    ...
    Singleton<PopupManager>.GetInstance().open(go, isCloned: true, isNonSe: true, isNonOpenAnime: true).GetComponent<UIWidget>().alpha = 0.0f;
