...
public class Setting01013Menu : BackButtonMenuBase
{
  ...
  private void Start() => this.InpId01.GetComponent<UIInput>().caretColor = Color.black;
  ...
  private void alert(string message) => Singleton<TutorialRoot>.GetInstance().showAdvice("#character 6\n#background black\n" + message);
}
