...
public class Versus0262Menu : Versus026MatchBase
{
    ...
    WebAPI.Response.PvpBoot pvpInfo)
  {
    ...
    versus0262Menu.txtPass.GetComponent<UIInput>().caretColor = Color.black;
    ...
    if (pvpInfo.is_tutorial)
    {
      if (Persist.pvpInfo.Data.currentPage == 1 && (type == PvpMatchingTypeEnum.challenge || type == PvpMatchingTypeEnum.normal))
        ...
        {
          {
            ...
            (Func<Transform, UIButton>) (root =>
            {
              ...
              UILabel component1 = childInFind.GetChildInFind("txt_Bonus").GetComponent<UILabel>();
              UILabel component2 = childInFind.GetChildInFind("txt_Timelimit").GetComponent<UILabel>();
          ...
          },
          {
            ...
            (Func<Transform, UIButton>) (root =>
            {
              ...
              if (this.isRepair)
              {
                childInFind2.gameObject.SetActive(false);
                childInFind3.gameObject.SetActive(true);
              }
              else
              {
                childInFind2.gameObject.SetActive(true);
                childInFind3.gameObject.SetActive(false);
              }
              return (UIButton) null;
            })
          },
          {
            ...
            (Func<Transform, UIButton>) (root =>
            {
              UIButton[] componentsInChildren = root.GetChildInFind("Bottom").GetComponentsInChildren<UIButton>();
              UIButton uiButton1 = ((IEnumerable<UIButton>) componentsInChildren).First<UIButton>((Func<UIButton, bool>) (v => v.name == "ibtn_StartMatch"));
              UIButton uiButton2 = ((IEnumerable<UIButton>) componentsInChildren).First<UIButton>((Func<UIButton, bool>) (v => v.name == "ibtn_GearRepair"));
              if (this.isRepair)
              {
        ...
        Singleton<TutorialRoot>.GetInstance().ForceShowAdvice("pvp6", (System.Action) (() =>
        {
  ...
  {
    Future<WebAPI.Response.PvpTutorialProgressFinish> futureF = WebAPI.PvpTutorialProgressFinish((System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  private void ChangeStrengthCondition(int index) => ((IEnumerable<GameObject>) this.btnStrengthOn).ForEachIndex<GameObject>((System.Action<GameObject, int>) ((x, i) => x.SetActive(i == index)));
  ...
  public void CheckRoomkey()
  {
    ...
    this.txtPass.GetComponent<UIInput>().value = "";
    this.txtPass.text = "";
  }
