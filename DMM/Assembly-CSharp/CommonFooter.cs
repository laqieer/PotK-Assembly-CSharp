...
public class CommonFooter : CommonFooterBase
{
  ...
  private void Start()
  {
    ...
    if (!(bool) (UnityEngine.Object) this.unitMenu)
      this.StartCoroutine(this.InitUnitMenuPrefab());
    Singleton<NGSceneManager>.GetInstance().act = (System.Action) (() =>
    {
  ...
  public void CloseSubMenu()
  {
    ...
    if ((UnityEngine.Object) this.unitMenu != (UnityEngine.Object) null && this.unitMenu.activeSelf)
      this.unitMenu.GetComponent<UnitMenu>().Close();
    if (!this.isOpenPopup)
      return;
  ...
  private void SetTweenAlpha(TweenAlpha alpha, float from, float end, bool isOpen)
  {
    ...
    if (!isOpen)
      alpha.onFinished.Add(new EventDelegate((EventDelegate.Callback) (() => this.mypageMenuPopup.SetActive(false))));
    alpha.PlayForward();
  }
  ...
  private IEnumerator doHomeButtonOnExploreScene()
  {
    ...
    yield return (object) Singleton<ExploreDataManager>.GetInstance().SaveSuspendData((System.Action) (() => {}));
  ...
  public void onButtonOpenSeaQuest()
  {
    ...
    this.preChangeScene(true);
    if (num != 0)
      this.StartCoroutine(this.doWaitDestroyLoadedScenes((System.Action) (() => Sea030_questScene.ChangeScene(false))));
    else
      Sea030_questScene.ChangeScene(false);
  }

  private IEnumerator doWaitDestroyLoadedScenes(System.Action actFinish)
  {
  ...
  public void onButtonUnit()
  {
    ...
    if (Singleton<CommonRoot>.GetInstance().DailyMissionController.IsOpened)
      Singleton<CommonRoot>.GetInstance().DailyMissionController.Hide();
    if ((UnityEngine.Object) Singleton<CommonRoot>.GetInstance().GetSeaHeaderComponent() != (UnityEngine.Object) null)
  ...
  public void enableExploreButton(bool enable) => this.exploreButton.isEnabled = enable;

  public void onButtonExplore()
  {
    if (!Singleton<TutorialRoot>.GetInstance().IsTutorialFinish() || this.IsPush || (bool) (UnityEngine.Object) Singleton<ExploreSceneManager>.GetInstanceOrNull())
      return;
    this.mypageMenuPopup.SetActive(false);
    Singleton<CommonRoot>.GetInstance().ShowLoadingLayer(0);
  ...
  private void Update()
  {
    ...
    {
      NGSceneManager instance = Singleton<NGSceneManager>.GetInstance();
      if (instance.sceneName == "guild028_2" && (UnityEngine.Object) instance.sceneBase != (UnityEngine.Object) null)
      {
        Guild0282Menu component = instance.sceneBase.GetComponent<Guild0282Menu>();
  ...
  private void SetGuildBadge()
  {
    ...
    else
    {
      ...
      bool flag3 = (UnityEngine.Object) instance.sceneBase != (UnityEngine.Object) null && instance.sceneBase.currentSceneGuildChatDisplayingStatus == NGSceneBase.GuildChatDisplayingStatus.Opened;
...
label_15:
  ...
  private IEnumerator openStorySelectPopup()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    e = popup.GetComponent<PopupMypageStorySelect>().Initialize(new System.Action<int, bool>(commonFooter.\u003CopenStorySelectPopup\u003Eb__74_0), new System.Action(commonFooter.\u003CopenStorySelectPopup\u003Eb__74_1), (MonoBehaviour) commonFooter);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
