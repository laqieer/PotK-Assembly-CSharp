...
public class Gacha99931Menu : BackButtonMenuBase
{
    ...
    Gacha99931Menu.PaymentType paymentType = Gacha99931Menu.PaymentType.ALL)
  {
    ...
    if ((Object) this.uiBuyButton == (Object) null)
      this.uiBuyButton = this.transform.Find("ibtn_Buy_Kiseki").GetComponent<UIButton>();
    if ((Object) this.uiBackButton == (Object) null)
      this.uiBackButton = this.transform.Find("ibtn_Popup_Back").GetComponent<UIButton>();
    if (text1 == "")
