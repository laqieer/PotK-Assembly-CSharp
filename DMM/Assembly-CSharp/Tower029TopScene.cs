...
public class Tower029TopScene : NGSceneBase
{
  ...
  public static void ChangeScene(bool isStack, bool forceInitialize = false) => Singleton<NGSceneManager>.GetInstance().changeScene("tower029_top", (isStack ? 1 : 0) != 0, (object) forceInitialize);
