...
public class PopupMypageStorySelect : BackButtonPopupWindow
{
  ...
  private System.Action<int, bool> onSceneChange;
  ...
  public IEnumerator Initialize(
    System.Action<int, bool> onSceneChange,
    System.Action onClosePopup,
    MonoBehaviour behaviour = null)
  {
    ...
    mypageStorySelect.btnLostRagnarokStory.enabled = true;
    mypageStorySelect.btnHeavenStory.enabled = true;
    mypageStorySelect.onSceneChange = onSceneChange;
    mypageStorySelect.animator = mypageStorySelect.GetComponent<Animator>();
    if (mypageStorySelect.gameObject.activeInHierarchy)
    {
      mypageStorySelect.isDisabledTouchWhilePlayingAnime = false;
      // ISSUE: reference to a compiler-generated method
      mypageStorySelect.StartCoroutine(mypageStorySelect.waitEndOpenAnimation(new System.Action(mypageStorySelect.\u003CInitialize\u003Eb__16_0)));
    }
    else
  ...
  public void OnEverAfter()
  {
    ...
    if (Persist.everAfterProcess.Exists && Persist.everAfterProcess.Data.lastEverAfterSId != 0 && (((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Any<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (q => q._quest_story_s == Persist.everAfterProcess.Data.lastEverAfterSId)) && MasterData.QuestStoryS.TryGetValue(Persist.everAfterProcess.Data.lastEverAfterSId, out questStoryS) && questStoryS.quest_xl_QuestStoryXL == 7))
    {
    ...
    if (key < 0 && playerStoryQuestSArray != null)
    {
      PlayerStoryQuestS[] array = ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Where<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x.quest_story_s.quest_xl_QuestStoryXL == 7)).ToArray<PlayerStoryQuestS>();
      if (array.Length != 0)
      {
  ...
  public void OnIntegralNoah()
  {
    ...
    bool flag = false;
    QuestStoryS questStoryS;
    if (Persist.integralNoahProcess.Exists && Persist.integralNoahProcess.Data.lastIntegralNoahSId != 0 && (((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Any<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (q => q._quest_story_s == Persist.integralNoahProcess.Data.lastIntegralNoahSId)) && MasterData.QuestStoryS.TryGetValue(Persist.integralNoahProcess.Data.lastIntegralNoahSId, out questStoryS) && questStoryS.quest_xl_QuestStoryXL == 6))
    {
      key = questStoryS.quest_l_QuestStoryL;
      QuestStoryL questStoryL;
      if (MasterData.QuestStoryL.TryGetValue(key, out questStoryL) && questStoryL.origin_id.HasValue)
    ...
    if (key < 0 && playerStoryQuestSArray != null)
    {
      key = ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Where<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x.quest_story_s.quest_xl_QuestStoryXL == 6)).Max<PlayerStoryQuestS>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.quest_l_QuestStoryL));
      QuestStoryL questStoryL;
      if (MasterData.QuestStoryL.TryGetValue(key, out questStoryL) && questStoryL.origin_id.HasValue)
      {
        flag = true;
  ...
  public void onLostRagnarokStory()
  {
    ...
    else if (key < 0)
    {
      ...
      {
        key = ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Where<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x.quest_story_s.quest_xl_QuestStoryXL == 4)).Max<PlayerStoryQuestS>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.quest_l_QuestStoryL));
        QuestStoryL questStoryL;
        if (MasterData.QuestStoryL.TryGetValue(key, out questStoryL) && questStoryL.origin_id.HasValue)
        {
          flag = true;
  ...
  public void onHeavenStory()
  {
    ...
    else if (key < 0)
    {
      ...
      if (playerStoryQuestSArray != null)
      {
        key = ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Where<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x.quest_story_s.quest_xl_QuestStoryXL == 1)).Max<PlayerStoryQuestS>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.quest_l_QuestStoryL));
        QuestStoryL questStoryL;
        if (MasterData.QuestStoryL.TryGetValue(key, out questStoryL) && questStoryL.origin_id.HasValue)
        {
          flag = true;
  ...
  private IEnumerator ZeroApi()
  {
    ...
    Future<WebAPI.Response.ZeroLoad> rq = WebAPI.ZeroLoad((System.Action<WebAPI.Response.UserError>) (error =>
    {
  ...
  private void ShowPopUp(Future<WebAPI.Response.ZeroLoad> rq)
  {
    ...
    PopupCommonNoYes.Show(Consts.GetInstance().Bugu005RecipeCompositeMenu_Title, Consts.GetInstance().EARTH_QUEST_POPUP, (System.Action) (() =>
    {
  ...
  private void OnEnable()
  {
    ...
    this.isDisabledTouchWhilePlayingAnime = false;
    this.isPush = true;
    this.StartCoroutine(this.waitEndOpenAnimation((System.Action) (() => this.isPush = false)));
  }
  ...
  private void EnterEarthQuest(Future<WebAPI.Response.ZeroLoad> rq)
  {
    ...
    if ((UnityEngine.Object) sceneBase1 != (UnityEngine.Object) null)
    ...
    if ((bool) (UnityEngine.Object) sceneBase2)
    {
  ...
  private IEnumerator procDismissPopup()
  {
    ...
    while (true)
    {
      ...
      if (!animatorStateInfo.shortNameHash.Equals(outName2) || (double) animatorStateInfo.normalizedTime < 1.0)
        yield return (object) null;
      else
        break;
    }
    foreach (Behaviour componentsInChild in mypageStorySelect.GetComponentsInChildren<SpriteTransitionController>())
      componentsInChild.enabled = false;
    Singleton<PopupManager>.GetInstance().dismiss();
  }

  private IEnumerator waitEndOpenAnimation(System.Action callbackEnd)
  {
    do
    {
      yield return (object) null;
    }
    while ((double) this.animator.GetCurrentAnimatorStateInfo(0).normalizedTime < 1.0);
    Animator[] animators = ((IEnumerable<Animator>) this.buttonAnimators).Where<Animator>((Func<Animator, bool>) (x => (UnityEngine.Object) x != (UnityEngine.Object) null && x.gameObject.activeInHierarchy)).ToArray<Animator>();
    while (animators.Length != 0)
    {
      ...
      {
        if (!animator.gameObject.activeInHierarchy || (double) animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0)
          dels.Add(animator);
      }
