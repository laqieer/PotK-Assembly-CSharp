...
public class StoryEffectMulti : StoryEffectBase
{
  ...
  protected override void awakeLocal()
  {
    ...
    foreach (StoryEffectBase.ParticleControl particle in this.particles_)
    {
      if (!string.IsNullOrEmpty(particle.name_))
      {
        ...
        {
          Debug.LogError((object) string.Format("StoryEffectMulti.particles_[].name_=\"{0}\" is aleady", (object) particle.name_), (UnityEngine.Object) this);
        }
        else
        {
  ...
  public void setPattern(int noPattern, int noColor)
  {
    ...
    {
      if (!((UnityEngine.Object) particle.particle_ == (UnityEngine.Object) null) && !string.IsNullOrEmpty(particle.key_) && this.dicParticles_.ContainsKey(particle.key_))
      {
