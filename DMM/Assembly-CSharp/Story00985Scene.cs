...
public class Story00985Scene : NGSceneBase
{
  ...
  public static void changeScene(QuestExtraS extra) => Singleton<NGSceneManager>.GetInstance().changeScene("story009_8_5", false, (object) extra.ID, (object) false);

  public static void changeScene(TowerPlaybackStory story) => Singleton<NGSceneManager>.GetInstance().changeScene("story009_8_5", false, (object) story, (object) false);

  public static void changeScene(RaidPlaybackStory story) => Singleton<NGSceneManager>.GetInstance().changeScene("story009_8_5", false, (object) story, (object) false);
