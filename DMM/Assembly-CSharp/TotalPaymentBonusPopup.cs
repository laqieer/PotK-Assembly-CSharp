...
public class TotalPaymentBonusPopup : BackButtonMenuBase
{
  ...
  private IEnumerator RefreshContentList(
    PlayerPaymentBonusReceiveHistory[] receiveHistory)
  {
    ...
    if (parent.mListItems != null)
    {
      ...
      foreach (Component mListItem in parent.mListItems)
        UnityEngine.Object.Destroy((UnityEngine.Object) mListItem.gameObject);
    ...
    parent.mScrollGrid.scrollView.panel.alpha = 0.0f;
    foreach (PlayerPaymentBonusReceiveHistory bonus in bonusReceiveHistoryList)
    {
      ...
      parent.mScrollGrid.Add(contentObj.gameObject);
    ...
    parent.mScrollGrid.grid.onReposition = new UIGrid.OnReposition(parent.\u003CRefreshContentList\u003Eb__9_1);
    parent.mScrollGrid.ResolvePosition();
    if ((UnityEngine.Object) parent.mMypageButton != (UnityEngine.Object) null)
    {
  ...
  private IEnumerator SendContentGet(int contentId)
  {
    ...
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.PaymentbonusReceive> api = WebAPI.PaymentbonusReceive(contentId, new System.Action<WebAPI.Response.UserError>(paymentBonusPopup.\u003CSendContentGet\u003Eb__14_0));
    ...
    else
    {
      ...
      if ((UnityEngine.Object) paymentBonusPopup.mMypageButton != (UnityEngine.Object) null)
      ...
      e = component.Init(paymentBonusPopup.ConvertToResultInfoList(response), false, new System.Action(paymentBonusPopup.OnFinishShopItemGetResult));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
  ...
  {
    List<ShopItemGetResultInfo> itemGetResultInfoList = new List<ShopItemGetResultInfo>();
    foreach (PlayerPresent playerPresent in response.player_presents)
      itemGetResultInfoList.Add(new ShopItemGetResultInfo((MasterDataTable.CommonRewardType) playerPresent.reward_type_id.Value, playerPresent.reward_id.Value, playerPresent.reward_quantity.Value));
    return itemGetResultInfoList;
  }
}
