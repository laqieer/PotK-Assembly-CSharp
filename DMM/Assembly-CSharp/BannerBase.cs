...
public class BannerBase : MonoBehaviour
{
  ...
  public static bool PathExist(QuestExtraS masterS, int id, QuestExtra.SeekType seek_type) => Singleton<ResourceManager>.GetInstance().Contains(BannerBase.GetSpriteIdlePathQuest(masterS, id, seek_type));
    ...
    bool isEarth = false)
  {
    ...
    switch (type)
    {
      case BannerBase.Type.mypage:
        str = string.Format("Prefabs/Banners/MypageBanner/{0}/MypageBanner_idle", (object) id);
        break;
      case BannerBase.Type.quest:
        str = BannerBase.GetSpriteIdlePathQuest((QuestExtraS) null, id, seek_type);
        break;
      case BannerBase.Type.quest_lock:
        str = !canplay ? (!isEarth ? string.Format("Prefabs/Banners/KeyQuest/{0}/Specialquest_idle_lock", (object) id) : string.Format("Prefabs/Banners/EarthKeyQuest/{0}/Specialquest_idle_lock", (object) id)) : (!isEarth ? string.Format("Prefabs/Banners/KeyQuest/{0}/Specialquest_idle", (object) id) : string.Format("Prefabs/Banners/EarthKeyQuest/{0}/Specialquest_idle", (object) id));
        break;
      case BannerBase.Type.tower:
        str = string.Format("Prefabs/Banners/TowerBanner/{0}/TowerBanner_idle", (object) id);
        break;
      case BannerBase.Type.raid:
        str = string.Format("Prefabs/Banners/RaidBanner/{0}/RaidBanner_idle", (object) id);
        break;
      case BannerBase.Type.corps:
        str = string.Format("Prefabs/Banners/Corps/{0}_CorpsBanner", (object) id);
        break;
      default:
  ...
  {
    if ((UnityEngine.Object) this.slcTimeNotice == (UnityEngine.Object) null || this.TimenoticeLimit == null || (this.TimenoticeLimit.Length == 0 || this.TimenoticeLeft == null) || (this.TimenoticeLeft.Length == 0 || this.TimenoticeCenter == null || (this.TimenoticeCenter.Length == 0 || this.TimenoticeRight == null)) || this.TimenoticeRight.Length == 0)
      return false;
  ...
  public void SetTime(DateTime serverTime, CampaignQuest.RankingEventTerm rankingEventTerm)
  {
    ...
    if ((UnityEngine.Object) this.slcRankingEventBlackBase != (UnityEngine.Object) null)
      this.slcRankingEventBlackBase.SetActive(false);
    if ((UnityEngine.Object) this.slcTimeNotice != (UnityEngine.Object) null)
      this.slcTimeNotice.SetActive(false);
    if ((UnityEngine.Object) this.slcTimeNoticeSoon != (UnityEngine.Object) null)
  ...
  protected void updateTime(TimeSpan tspan, float duration = 0.0f)
  {
    ...
    else
    {
      ...
      {
        int num4 = (int) (tspan.TotalSeconds / 60.0) + (tspan.TotalSeconds % 60.0 != 0.0 ? 1 : 0);
        num1 = num4 / 10;
        num2 = num4 % 10;
      }
      num3 = 2;
    }
    if (num3 == 2 && num1 == 0 && (num2 == 1 && this.EndTimeAsStart) && (UnityEngine.Object) this.slcTimeNoticeSoon != (UnityEngine.Object) null)
    {
      num3 = -1;
      num2 = -1;
    }
    ...
    {
      ((IEnumerable<GameObject>) this.currentLeft).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
      ((IEnumerable<GameObject>) this.currentRight).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
      ((IEnumerable<GameObject>) this.currentCenter).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
      ((IEnumerable<GameObject>) this.currentLimit).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
      if (num1 == 0)
      {
  ...
  public void fadeOut(float duration)
  {
    ...
    this.fadeOut(this.IdleSprite.gameObject, duration);
  }
  ...
  protected void terminateAnimation()
  {
    ...
    foreach (TweenAlpha tweenAlpha in this.animations_.ToArray())
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) tweenAlpha);
    }
