...
public class GuildGBResultAnim : MonoBehaviour
{
  ...
  private void OnDisable() => UnityEngine.Object.Destroy((UnityEngine.Object) this.resultObj);

  private IEnumerator Animation()
  {
    GuildGBResultAnim guildGbResultAnim = this;
    guildGbResultAnim.skipFlag = false;
    bool noneSe = (UnityEngine.Object) Singleton<NGSoundManager>.GetInstanceOrNull() == (UnityEngine.Object) null;
    int se = 0;
    if (!noneSe)
    ...
    if ((UnityEngine.Object) guildGbResultAnim.resultObj != (UnityEngine.Object) null)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) guildGbResultAnim.resultObj);
      guildGbResultAnim.skipFlag = false;
    }
    while (!guildGbResultAnim.skipFlag)
      yield return (object) null;
  ...
  private class GuildData
  {
      ...
      GuildAppearance guildData)
    {
      ...
      Future<UnityEngine.Sprite> futureGuildTitleImage = EmblemUtility.LoadGuildEmblemSprite(guildData._current_emblem);
    ...
    public void SetUseSStart(int starValue)
    {
      if (starValue < 10)
      {
        this.dir_s_star[0].transform.parent.parent.gameObject.SetActive(false);
        this.dir_s_star_until_10[0].transform.parent.parent.gameObject.SetActive(true);
      }
      else
      {
        this.dir_s_star[0].transform.parent.parent.gameObject.SetActive(true);
        this.dir_s_star_until_10[0].transform.parent.parent.gameObject.SetActive(false);
      }
      this.Reset();
    }
          ...
          if (i % maxLStar == maxLStar - 1)
          {
            if (!this.cntrl.skipFlag)
            {
              ...
              if (!this.cntrl.skipFlag)
              {
                ...
                if (firstCarryL && (UnityEngine.Object) this.dc_l_.positionCarry_ != (UnityEngine.Object) null)
                {
                  Vector3 vector3 = this.dc_l_.positionCarry_.to - this.dc_l_.positionCarry_.from;
                  ((IEnumerable<Transform>) this.dc_l_.positions_).First<Transform>().parent.localPosition += vector3;
                  this.dc_l_.effCarry_.transform.parent.localPosition += vector3;
                }
                firstCarryL = false;
...
label_15:
      ...
      string nextIndicate)
    {
      ...
      if ((UnityEngine.Object) cntlNow.positionCarry_ != (UnityEngine.Object) null && index == 0)
        cntlNow.positionCarry_.PlayForward();
      Transform position = cntlNext.positions_[index];
      Transform parent = position.parent;
      position.parent = cntlNow.effCarry_.transform.parent;
      Vector3 localPosition = position.localPosition;
      position.parent = parent;
      cntlNow.effCarry_.to = localPosition;
      cntlNow.effCarry_.ResetToBeginning();
      cntlNow.effCarry_.PlayForward();
    }
      ...
      float waitTime = 0.0f)
    {
      ...
      if (moveCarry && (UnityEngine.Object) dc.positionCarry_ != (UnityEngine.Object) null)
        dc.positionCarry_.PlayForward();
      if (num != nStar)
      {
    ...
    public void DamageAnimation() => ((IEnumerable<UITweener>) this.txt_guild_damage_num.GetComponents<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x => x.enabled = true));
  }
}
