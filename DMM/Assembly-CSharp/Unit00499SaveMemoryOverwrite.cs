...
{
  public void Initialize(PlayerUnit unit, System.Action endUpdate)
  {
    ...
    hashtable.Add((object) "index", (object) (nullable2.HasValue ? new int?(nullable2.GetValueOrDefault() + 1) : new int?()));
    string text = Consts.Format(overwriteDescription, (IDictionary) hashtable);
