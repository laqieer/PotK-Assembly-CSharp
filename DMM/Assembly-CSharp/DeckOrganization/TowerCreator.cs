...
namespace DeckOrganization
{
  public class TowerCreator : Creator
  {
    ...
    private IEnumerable<Unit> sortForTower(IEnumerable<Unit> units) => (IEnumerable<Unit>) units.OrderByDescending<Unit, int>((Func<Unit, int>) (u => u.unit_.level)).ThenByDescending<Unit, int>((Func<Unit, int>) (u => u.unit_.combat)).ThenByDescending<Unit, int>((Func<Unit, int>) (u => u.unit_.total_hp));
