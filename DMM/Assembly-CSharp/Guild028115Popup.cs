...
public class Guild028115Popup : BackButtonMenuBase
{
    ...
    bool changeGuild)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.commonDlgObj == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator SendRequest()
  {
    ...
    Future<WebAPI.Response.GuildApplicantsSend> ft = WebAPI.GuildApplicantsSend(false, target_guild_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      if (e.Code.Equals("GLD001"))
        applied = true;
      else if (e.Code.Equals("GLD020"))
      {
        this.ShowOkPopup(Consts.GetInstance().POPUP_028_3_2_2_IN_RAID_TITLE, Consts.GetInstance().POPUP_028_3_2_2_IN_RAID_DESC, (System.Action) (() => {}));
      }
      else
      {
    ...
    else if (applied)
    {
      if (this.guildPopupInfo.RequestAlreadyGuildCallback == null)
      {
        Singleton<CommonRoot>.GetInstance().isLoading = false;
        Singleton<CommonRoot>.GetInstance().loadingMode = 0;
        this.ShowOkPopup(Consts.GetInstance().POPUP_028_1_1_5_TITLE, Consts.GetInstance().POPUP_028_1_1_6_NO_APPLICANT, (System.Action) (() =>
        {
          Singleton<CommonRoot>.GetInstance().isLoading = true;
    ...
    else if (ft.Result != null)
    {
      if (PlayerAffiliation.Current.status == GuildMembershipStatus.membership)
      {
        ...
        this.ShowOkPopup(title, message, (System.Action) (() =>
        {
          Singleton<CommonRoot>.GetInstance().isLoading = true;
          MypageScene.ChangeScene(MypageRootMenu.Mode.GUILD, true);
        }));
      ...
      else
      {
        ...
        if ((this.guildRegistration != null ? (this.guildRegistration.auto_approval.auto_approval ? 1 : 0) : (this.guildDirectory.auto_approval.auto_approval ? 1 : 0)) != 0)
        {
          ...
          if (PlayerAffiliation.Current.status == GuildMembershipStatus.applicant)
          {
            if (this.guildDirectory != null && this.guildDirectory.in_gvg || this.guildRegistration != null && PlayerAffiliation.Current.onGvgOperation)
              this.ShowOkPopup(Consts.GetInstance().POPUP_028_1_1_5_TITLE_IN_GVG, Consts.GetInstance().POPUP_028_1_1_5_IN_GVG, (System.Action) (() =>
              {
              ...
              this.ShowOkPopup(Consts.Format(Consts.GetInstance().POPUP_028_1_1_5_TITLE_IN_RAID), Consts.Format(Consts.GetInstance().POPUP_028_1_1_5_IN_RAID), (System.Action) (() =>
              {
                if (this.guildPopupInfo.SendRequestCallback == null)
                  return;
                this.guildPopupInfo.SendRequestCallback();
              ...
              this.ShowOkPopup(Consts.Format(Consts.GetInstance().POPUP_028_1_1_5_TITLE), Consts.Format(Consts.GetInstance().POPUP_028_1_1_6_MEMBER_LIMIT), (System.Action) (() =>
              {
                if (this.guildPopupInfo.SendRequestCallback == null)
                  return;
                this.guildPopupInfo.SendRequestCallback();
            ...
            this.ShowOkPopup(Consts.Format(Consts.GetInstance().POPUP_028_1_1_5_TITLE), Consts.Format(Consts.GetInstance().POPUP_028_1_1_6_NOT_ELIGIBLE), (System.Action) (() => {}));
        }
        else if (PlayerAffiliation.Current.status == GuildMembershipStatus.applicant)
        {
          ...
          if ((UnityEngine.Object) gameObject.GetComponent<Guild0281151Popup>().GetComponent<UIWidget>() != (UnityEngine.Object) null)
            gameObject.GetComponent<Guild0281151Popup>().GetComponent<UIWidget>().alpha = 0.0f;
  ...
  private void ShowOkPopup(string title, string message, System.Action action) => Singleton<PopupManager>.GetInstance().open(this.commonDlgObj).GetComponent<GuildOkPopup>().Initialize(title, message, ok: action);
}
