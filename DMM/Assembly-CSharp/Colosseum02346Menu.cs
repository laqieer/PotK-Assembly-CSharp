...
public class Colosseum02346Menu : ResultMenuBase
{
    ...
    Gladiator gladiator)
  {
    ...
    ((IEnumerable<GameObject>) colosseum02346Menu.Campaing).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
  }
  ...
  private IEnumerator ShowRankUp()
  {
    ...
    if (menu.nowBattleType != 0)
    {
      ...
      menu.touchToNext.gameObject.SetActive(false);
      menu.DirRankupEffect.SetActive(true);
      menu.RankBattleResultEffectPrefab.Clone(menu.DirRankupEffect.transform).transform.Find("ddd").GetComponent<ColosseumRankBattleEffect>().Init(menu);
      ...
      yield return (object) new WaitForSeconds(0.6f);
      menu.touchToNext.gameObject.SetActive(true);
    }
  }
  ...
  private IEnumerator ShowRankPoint()
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (menu.info.campaigns != null && ((IEnumerable<SM.Campaign>) menu.info.campaigns).FirstOrDefault<SM.Campaign>((Func<SM.Campaign, bool>) (x => x.campaign_type_id == 2)) != null)
    ...
    menu.TxtGetPoint.gameObject.SetActive(false);
    yield return (object) new WaitForSeconds(0.9f);
    menu.PlayTween(menu.TxtGetPoint.gameObject);
    bool isLow = false;
    if (beforeID > afterID)
      isLow = true;
  ...
  private IEnumerator ShowTitleEXP()
  {
    ...
    if (colosseum02346Menu.info.campaigns != null && ((IEnumerable<SM.Campaign>) colosseum02346Menu.info.campaigns).FirstOrDefault<SM.Campaign>((Func<SM.Campaign, bool>) (x => x.campaign_type_id == 1)) != null)
  ...
  private IEnumerator ShowBottomMessage()
  {
    ...
    if (colosseum02346Menu.info.campaigns != null && ((IEnumerable<SM.Campaign>) colosseum02346Menu.info.campaigns).FirstOrDefault<SM.Campaign>((Func<SM.Campaign, bool>) (x => x.campaign_type_id == 3)) != null)
