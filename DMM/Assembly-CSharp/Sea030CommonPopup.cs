...
public class Sea030CommonPopup : BackButtonMonoBehaiviour
{
  ...
  private System.Action<PlayerTalkMessage> message;

  public IEnumerator initialize(
    PlayerUnit unit,
    PlayerCallLetter[] callLetter,
    System.Action<PlayerTalkMessage> act)
  {
    this.unitData = unit;
    if (act != null)
      this.message = act;
  ...
  private IEnumerator CallMakeApi()
  {
    ...
    Future<WebAPI.Response.SeaCallMakeletter> futureAPI = WebAPI.SeaCallMakeletter(sea030CommonPopup.unitData.id, new System.Action<WebAPI.Response.UserError>(sea030CommonPopup.\u003CCallMakeApi\u003Eb__13_0));
  ...
  private void TalkIdExchangeText()
  {
    this.notObject.SetActive(true);
    this.yesNoObject.SetActive(false);
    this.notText1.transform.localPosition = new Vector3(this.notText1.transform.localPosition.x, 81f, this.notText1.transform.localPosition.z);
