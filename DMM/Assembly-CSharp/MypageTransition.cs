...
public class MypageTransition : MonoBehaviour
{
  ...
  private IEnumerator openStorySelectPopup()
  {
    ...
    e = popup.GetComponent<PopupMypageStorySelect>().Initialize(new System.Action<int, bool>(mypageTransition.\u003CopenStorySelectPopup\u003Eb__31_0), (System.Action) null, (MonoBehaviour) mypageTransition.menu);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator openBattleSelectPopup()
  {
    ...
    popup.SetActive(false);
    // ISSUE: reference to a compiler-generated method
    e = popup.GetComponent<PopupMypageBattleSelect>().Initialize(new System.Action<PopupMypageBattleSelect.Selection>(mypageTransition.\u003CopenBattleSelectPopup\u003Eb__32_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator OpenTotalPaymentBonusPopup()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.PaymentbonusList> api = WebAPI.PaymentbonusList(new System.Action<WebAPI.Response.UserError>(mypageTransition.\u003COpenTotalPaymentBonusPopup\u003Eb__35_0));
