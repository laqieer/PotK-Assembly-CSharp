...
public static class UnitPositionExtension
{
    ...
    System.Action action = null)
  {
    ...
    if (!unit.isEnable || (UnityEngine.Object) unitResource.gameObject == (UnityEngine.Object) null || unit.hp <= 0)
      return;
  ...
  public static void cancelMove(this BL.UnitPosition up, BE env, System.Action endMoving = null)
  {
    BL.Unit unit = up.unit;
    if (!unit.isView)
      return;
  ...
  public static bool isMoving(this BL.UnitPosition up, BE env)
  {
    ...
    if (!unit.isView)
      return false;
    BE.UnitResource unitResource = env.unitResource[up.unit];
    return unit.isEnable && !((UnityEngine.Object) unitResource.gameObject == (UnityEngine.Object) null) && unitResource.unitParts_.isMoving;
  }
