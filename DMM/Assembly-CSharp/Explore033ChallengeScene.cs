...
public class Explore033ChallengeScene : NGSceneBase
{
  ...
  public static void changeScene(ChallengeNpc gladiator, GameCore.ColosseumResult battle_result) => Singleton<NGSceneManager>.GetInstance().changeScene("explore033_Challenge", false, (object) gladiator, (object) battle_result);
  ...
  public void onStartScene(ChallengeNpc gladiator, GameCore.ColosseumResult battle_result) => this.onStartScene();
