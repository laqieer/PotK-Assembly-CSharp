...
public class Sea030GiftDetailsScrollList : MonoBehaviour
{
  ...
  private IEnumerator CreateRecipeLsit()
  {
    ...
    {
      this.recipeYes.isEnabled = false;
    ...
    int column_num)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    gearIcon.onClick = (System.Action<ItemIcon>) (_ => this.OnDownItemList(column_num));
    ...
    if (column_num == 0)
      gearIcon.EnableLongPressEvent(true, new System.Action<ItemIcon>(detailsScrollList.GearDetail));
    else
      gearIcon.EnableLongPressEvent(true, new System.Action<ItemIcon>(detailsScrollList.OnMaterialPopup));
  }
