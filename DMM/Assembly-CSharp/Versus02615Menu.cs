...
public class Versus02615Menu : BackButtonMenuBase
{
  ...
  private IEnumerator CreateDisplay()
  {
    ...
    if ((UnityEngine.Object) versus02615Menu.pullDownUI != (UnityEngine.Object) null)
    {
  ...
  {
    string str = Consts.GetInstance().COMMON_NOVALUE;
    ...
    if (startTime.HasValue && finishTime.HasValue)
    {
      ...
      hashtable.Add((object) "year", (object) dateTime.Year.ToLocalizeNumberText());
      dateTime = startTime.Value;
      hashtable.Add((object) "month", (object) dateTime.Month.ToLocalizeNumberText());
      dateTime = startTime.Value;
      hashtable.Add((object) "day", (object) dateTime.Day.ToLocalizeNumberText());
      ...
      str = Consts.Format(versus002614Term, (IDictionary) hashtable);
    }
    return str;
  }
  ...
  {
    Versus02615Menu versus02615Menu = this;
    versus02615Menu.Scroll.Scroll.gameObject.transform.Clear();
    versus02615Menu.Scroll.Reset();
    versus02615Menu.Scroll.Scroll.gameObject.SetActive(false);
    Future<GameObject> boxPrefabF;
    IEnumerator e;
    if ((UnityEngine.Object) versus02615Menu.boxPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) versus02615Menu.boxEventPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) versus02615Menu.marginPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) versus02615Menu.classSelectPrefab == (UnityEngine.Object) null)
    {
    ...
    versus02615Menu.pullDownUI = gameObject1.transform.GetChildInFind("classes").GetComponent<UIPopupList>();
    ...
    list.ForEach(new System.Action<KeyValuePair<int, PvpRankingKind>>(versus02615Menu.\u003CSetScroll\u003Eb__19_3));
    // ISSUE: reference to a compiler-generated method
    ...
    foreach (IGrouping<int, PvpClassRankingReward> source in (IEnumerable<IGrouping<int, PvpClassRankingReward>>) ((IEnumerable<PvpClassRankingReward>) rewards).GroupBy<PvpClassRankingReward, int>((Func<PvpClassRankingReward, int>) (x => x.ranking_category.ID)).OrderBy<IGrouping<int, PvpClassRankingReward>, int>((Func<IGrouping<int, PvpClassRankingReward>, int>) (x => MasterData.PvpRankingCondition[x.Key].priority)))
    {
      int rankingCondition = source.First<PvpClassRankingReward>().ranking_category_PvpRankingCondition;
      ...
      e = gameObject2.GetComponent<Versus02612ScrollRewardBox>().Init((IEnumerable<PvpClassRankingReward>) source, data.my_ranking.ranking, is_belong, isPeriod);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      versus02615Menu.Scroll.Add(versus02615Menu.marginPrefab.Clone());
    }
    versus02615Menu.Scroll.Scroll.gameObject.SetActive(true);
  ...
  {
    this.btnNext.isEnabled = this.nowIndex >= 1;
    this.btnPrevious.isEnabled = this.nowIndex < this.ranking_data.Length - 1;
  }
