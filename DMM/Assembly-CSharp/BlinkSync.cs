...
public class BlinkSync : MonoBehaviour
{
  ...
  public void resetBlinks(IEnumerable<GameObject> blinks, bool bRestart = false)
  {
    if (blinks == null)
      ...
      this.resetBlinks(blinks.Select<GameObject, UIRect>((Func<GameObject, UIRect>) (x => x.GetComponent<UIRect>())).Where<UIRect>((Func<UIRect, bool>) (y => (UnityEngine.Object) y != (UnityEngine.Object) null)).ToArray<UIRect>(), bRestart);
  }
