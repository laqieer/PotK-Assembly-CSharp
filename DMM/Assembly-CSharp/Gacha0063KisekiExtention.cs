...
public class Gacha0063KisekiExtention : MonoBehaviour
{
  ...
  private void DispDetailButton(bool canDisp) => this.detailButton.gameObject.SetActive(canDisp);
  ...
  {
    if ((bool) (UnityEngine.Object) this.Menu && this.Menu.IsPushAndSet())
      return;
  ...
  private IEnumerator ShowProgressSheet()
  {
    ...
    script.SetCallback(new System.Action(kisekiExtention.\u003CShowProgressSheet\u003Eb__77_1));
  ...
  {
    if (!(bool) (UnityEngine.Object) this.statusButton)
      return;
    this.statusButton.gameObject.SetActive(bEnabled);
  }

  private void SetSelectButton(bool bEnabled, bool bSelected)
  {
    if (!(bool) (UnityEngine.Object) this.selectButton)
      return;
  ...
  {
    if (!(bool) (UnityEngine.Object) this.Menu || this.Menu.IsPushAndSet() || !this.isActivePickupSelector)
      return;
    Singleton<NGGameDataManager>.GetInstance().currentGachaNumber = this.gachaModule.number;
    GachaPickupSelectScene.changeScene(true, this.gachaModule.gacha[0], (System.Action) (() => this.Menu.forceApiUpdate()));
  }

  private bool isActivePickupSelector => this.gachaModule != null && this.gachaModule.gacha[0].is_pickup_select && this.gachaModule.gacha[0].pickup_select_count.HasValue;
