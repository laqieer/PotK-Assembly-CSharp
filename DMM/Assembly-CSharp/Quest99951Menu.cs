...
public class Quest99951Menu : BackButtonMenuBase
{
  ...
  public System.Action<PopupUtility.SceneTo> onChangedScene { get; set; }

  public bool isStackScene { get; set; } = true;

  public virtual void SetText(int have_unit, int max_have_unit, Player player_data) => this.TxtPopupdescripton03.SetTextLocalize(Consts.GetInstance().GACHA_0065MENU_DESCRIPTION02 + "：[ff0000]" + have_unit.ToLocalizeNumberText() + "[-]/[ff0000]" + max_have_unit.ToLocalizeNumberText() + "[-]");
  ...
  public void IbtnPopupCom()
  {
    ...
    System.Action<PopupUtility.SceneTo> onChangedScene = this.onChangedScene;
