...
public class Popup02351Menu : Popup0235MenuBase
{
    ...
    GameObject uniqueObject)
  {
    ...
    if (reward.reward_type_id == 3 || reward.reward_type_id == 26 || reward.reward_type_id == 35)
    {
      ...
      {
        e = ColosseumUtility.CreateWeaponMaterialIcon(gearObject, gear, this.icon.transform);
        while (e.MoveNext())
      ...
      {
        e = ColosseumUtility.CreateGearIcon(gearObject, gear, this.icon.transform);
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
      }
    ...
    {
      e = ColosseumUtility.CreateUnitIcon(unitObject, ((IEnumerable<UnitUnit>) MasterData.UnitUnitList).FirstOrDefault<UnitUnit>((Func<UnitUnit, bool>) (x => x.ID == reward.reward_id)), this.icon.transform);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
    ...
    {
      e = ColosseumUtility.CreateSupplyIcon(gearObject, ((IEnumerable<SupplySupply>) MasterData.SupplySupplyList).FirstOrDefault<SupplySupply>((Func<SupplySupply, bool>) (x => x.ID == reward.reward_id)), this.icon.transform);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
    ...
    {
      e = ColosseumUtility.CreateUniqueIcon(uniqueObject, this.icon.transform, reward.reward_type_id, reward.reward_id, 0, false);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
