...
public class BattleStateController : BattleMonoBehaviour
{
  ...
  private bool startStroyWithNextState(BL.StoryType stype, BL.Phase state) => this.startStroyWithNextState(this.env.core.getStory(stype), state);
  ...
  private void executeJumpSkillEffects(IEnumerable<BL.UnitPosition> ups, BL.ForceID phaseForce = BL.ForceID.none) => this.btm.setScheduleAction((System.Action) (() =>
  {
    ...
    foreach (BL.UnitPosition unitPosition in array1)
    {
      ...
      if (targetUp != null && targetUp.unit.hp >= 1 && !targetUp.unit.IsJumping)
      {
        ...
        if (array2.Length >= 1)
        {
          ...
          System.Action invokedAction = (System.Action) (() =>
          {
  ...
  private void SetCallEntrySchedule(BL.Unit[] callUnitUps) => this.btm.setScheduleAction((System.Action) (() =>
  {
    foreach (BL.UnitPosition unitPosition in this.env.core.unitPositions.value)
      this.env.unitResource[unitPosition.unit].unitParts_.SetEffectMode(true);
    List<BattleUnitParts> source = new List<BattleUnitParts>();
    foreach (BL.Unit callUnitUp in callUnitUps)
    {
      ...
      this.btm.setScheduleAction((System.Action) (() => unitParts.callEntry()));
      source.Add(unitParts);
    ...
    this.btm.setScheduleAction((System.Action) (() =>
    {
      ...
      if (source.Any<BattleUnitParts>())
      {
        foreach (BattleUnitParts battleUnitParts in source)
        {
          ...
          this.btm.setScheduleAction((System.Action) null, comleteCheckFunc: ((Func<bool>) (() => bup.checkEffectCompleted())));
        }
      }
      this.btm.setScheduleAction((System.Action) (() =>
      {
    ...
    List<Quaternion?> invokedEffectRotate = null)
  {
    ...
    System.Action<BL.Unit> targetEndAction = (System.Action<BL.Unit>) (targetUnit =>
    {
    ...
    System.Action action = invokedAction;
    List<Quaternion?> invokedEffectRotate1 = invokedEffectRotate;
    System.Action invokedAction1 = action;
    List<BL.Panel> targetPanels = es.targetPanels;
    battleEffects.skillFieldEffectStartCore(fe, unit1, targets, effectPrefab, invokedEffectPrefab, targetEffectPrefab, (System.Action) null, (System.Action) null, invokedTargetUnits1, targetEndAction, 1, invokedEffectRotate1, invokedAction1, targetPanels);
  }
  ...
  private void completedSkillEffects(BL.UnitPosition up)
  {
    ...
    System.Action effectAction = (System.Action) (() =>
    {
    ...
    {
      System.Action waitAction = (System.Action) null;
      waitAction = (System.Action) (() =>
      {
        if (!this.battleManager.isAfterDuelEffectWaiting)
          effectAction();
        else
          this.btm.setScheduleAction((System.Action) (() => waitAction()));
      });
      waitAction();
    }
  }
  ...
  private void doExecuteCompletedSkillEffects(BL.UnitPosition up, BL.ExecuteSkillEffectResult es)
  {
    ...
    if (es.skill.skill_type == BattleskillSkillType.ailment)
    {
      ...
      this.battleManager.battleEffects.skillFieldEffectStartCore(fe, (BL.Unit) null, es.second_targets, (GameObject) null, (GameObject) null, targetEffectPrefab, (System.Action) null, targetAction, (List<BL.Unit>) null, targetEndAction);
      if (!es.second_targets.Any<BL.Unit>((Func<BL.Unit, bool>) (x => x.hp <= 0)))
        return;
      this.btm.setScheduleAction((System.Action) null, 1.5f);
    }
    else
    {
      BattleskillFieldEffect passiveEffect = es.skill.passive_effect;
  ...
  private void spawnUnit(BL.UnitPosition up)
  {
    ...
    this.btm.setTargetPanel(this.env.core.getFieldPanel(up), 0.3f, (System.Action) (() => this.battleManager.battleEffects.fieldEffectsStart(this.spawnEffectPrefab, up.unit)), (System.Action) (() => up.unit.spawn(this.env, true)));
  ...
  private void startBattleStartEffect()
  {
    ...
    this.battleManager.battleEffects.startEffect("Condition_forVictory", 2.8f, (System.Action) (() => this.startStroyWithNextState(story, BL.Phase.turn_initialize)), isBattleEnableControl, true);
  }

  private void startBattlePvpStartEffect() => this.battleManager.battleEffects.startEffect((Transform) null, 5f, (System.Action) (() => this.battleManager.gameEngine.startMain()), true, this.pvpMatchStartPrefab, cloneE: ((BattleEffects.CloneEnumlator) new BattleStateController.PvpMatchEffect(this)));

  private void startBattleFieldEffect(BL.FieldEffectType type) => this.btm.setScheduleAction((System.Action) (() =>
  {
  ...
  private void battleStartOvo() => this.btm.setScheduleAction((System.Action) (() =>
  {
  ...
  private void battleStartNormal() => this.btm.setScheduleAction((System.Action) (() =>
  {
  ...
  private float getEffectStageClearTime() => !Singleton<NGGameDataManager>.GetInstance().questAutoLap ? 5f : 3f;

  private bool isEffectStageClearSkippedVoiceStop() => Singleton<NGGameDataManager>.GetInstance().questAutoLap;
  ...
  protected override void LateUpdate_Battle()
  {
    ...
    switch (this.phaseStateModified.value.state)
    {
      case BL.Phase.player_start:
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          this.setStateWithEffect("PlayerPhase", 1.5f, BL.Phase.player_start_post, (System.Action) null, true, true);
          this.isAutoBattleModified.notifyChanged();
        }));
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          ...
          if (!((IEnumerable<BL.UnitPosition>) array).Any<BL.UnitPosition>())
            return;
          foreach (BL.UnitPosition unitPosition2 in array)
          {
            this.env.core.playerActionUnits.value.Remove(unitPosition2);
            unitPosition2.recoveryCompleteUnit();
          }
          this.env.core.playerActionUnits.commit();
        }), isInsertMode: true);
        this.btm.setScheduleAction((System.Action) (() => this.env.core.createDangerAria()));
        break;
      case BL.Phase.neutral_start:
        ...
        {
          this.battleManager.saveEnvironment();
          this.setStateWithEffect("NeutralPhase", 1.5f, BL.Phase.neutral_start_post, (System.Action) null, true, true);
        }));
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          ...
          foreach (BL.UnitPosition unitPosition2 in array)
          {
            this.env.core.neutralActionUnits.value.Remove(unitPosition2);
            unitPosition2.recoveryCompleteUnit();
          }
          this.env.core.neutralActionUnits.commit();
        }), isInsertMode: true);
      ...
      case BL.Phase.enemy_start:
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          ...
          this.setStateWithEffect("EnemyPhase", 1.5f, BL.Phase.enemy_start_post, (System.Action) null, true, true);
        }));
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          ...
          foreach (BL.UnitPosition unitPosition2 in array)
          {
            this.env.core.enemyActionUnits.value.Remove(unitPosition2);
            unitPosition2.recoveryCompleteUnit();
          }
          this.env.core.enemyActionUnits.commit();
        }), isInsertMode: true);
        ...
        if (!Singleton<NGBattleManager>.GetInstance().isEarth)
        {
          if (this.env.core.playerCallSkillState.isCanUseCallSkill && !this.env.core.playerCallSkillState.isChargedCallGauge)
          {
            if (this.env.core.enemyCallSkillState.isCanUseCallSkill && !this.env.core.enemyCallSkillState.isChargedCallGauge)
              ...
              this.btm.setScheduleAction((System.Action) (() => this.StartCoroutine(this.uiNode.dispCallSkillChargedOwn())), 2f);
          }
          else if (this.env.core.enemyCallSkillState.isCanUseCallSkill && !this.env.core.enemyCallSkillState.isChargedCallGauge)
            this.btm.setScheduleAction((System.Action) (() => this.StartCoroutine(this.uiNode.dispCallSkillChargedEnemy(false))), 2f);
        }
        this.btm.setScheduleAction((System.Action) (() =>
        {
          this.env.core.createDangerAria();
      ...
      case BL.Phase.finalize:
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          ...
          {
            this.gameObject.AddComponent<BattleCorpsFinalize>();
          }
          else
          {
            if ((UnityEngine.Object) this.finalize == (UnityEngine.Object) null)
              this.finalize = this.gameObject.AddComponent<BattleFinalize>();
      ...
      case BL.Phase.stageclear:
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          ...
          this.setStateWithEffect("StageClear", this.getEffectStageClearTime(), BL.Phase.win_finalize, (System.Action) (() => this.env.core.isWin = true), false, this.isEffectStageClearSkippedVoiceStop(), new System.Action<ScheduleEnumerator>(this.SkipEffect));
        }));
        break;
      case BL.Phase.gameover:
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          ...
          this.setStateWithEffect(effectName, effectTime, BL.Phase.finalize, (System.Action) (() => this.env.core.isWin = false), needNabi, isSkippedVoiceStop, new System.Action<ScheduleEnumerator>(this.SkipEffect));
        }));
        break;
