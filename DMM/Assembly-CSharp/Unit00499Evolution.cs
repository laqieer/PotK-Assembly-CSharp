...
public class Unit00499Evolution : NGMenuBase
{
  ...
  private void Update()
  {
    ...
    {
      if (this.menu.evolutionBtn.isEnabled == this.isEvolutionButtonEnabled)
        return;
  ...
  public IEnumerator Init(
    PlayerUnit basePlayUnit,
    PlayerUnit[] afterPlayerUnits,
    bool fromEarth = false)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    unit00499Evolution.indicator.dot.gameObject.SetActive(true);
    if (unit00499Evolution.orderList.Count<int>() == 1)
      unit00499Evolution.indicator.dot.gameObject.SetActive(false);
  ...
  private IEnumerator createPrefab()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.indicatorPrefab == (UnityEngine.Object) null)
    {
    ...
    PlayerMaterialUnit[] playerMaterialUnits)
  {
    ...
    component.TxtZeny.color = player.money >= (long) evolutionPattern.money ? Color.white : Color.red;
  ...
  private void CheckEvolutionPossible()
  {
    ...
    {
      this.menu.awakeBtn.isEnabled = this.isEvolutionButtonEnabled;
    }
    else
    {
