...
public class Guide0112Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, Guide0111Scene.UpdateInfo updateInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("guide011_2", (stack ? 1 : 0) != 0, (object) updateInfo);
  ...
  public IEnumerator onStartSceneAsync(Guide0111Scene.UpdateInfo updateInfo)
  {
    ...
    Future<WebAPI.Response.ZukanUnit> unit = WebAPI.ZukanUnit((System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    else
    {
      ...
      List<UnitUnit> source = new List<UnitUnit>(unit.Result.histories.Length);
      ...
      if (source.Any<UnitUnit>())
        yield return (object) OnDemandDownload.WaitLoadUnitResource((IEnumerable<UnitUnit>) source, false);
