...
public class HenshinControl : MonoBehaviour
{
  ...
  public IEnumerator coSetUnit(int id, GameObject unitBefore, GameObject unitAfter)
  {
    ...
    if ((Object) henshinControl.prefab_ == (Object) null)
    {
    ...
    GameObject gameObject = henshinControl.prefab_.Clone(henshinControl.gameObject.transform);
    henshinControl.container_ = gameObject.GetComponent<HenshinContainer>();
    if ((Object) henshinControl.container_ != (Object) null)
    {
  ...
  private void Update()
  {
    ...
    if (this.isPause_ || !((Object) this.container_ != (Object) null))
      return;
  ...
  {
    if (!((Object) this.container_ != (Object) null))
      return;
    this.isPause_ = false;
