...
public class Tower029RankingScene : NGSceneBase
{
  ...
  public static void changeScene(int period_id, int tower_id, bool bstack = true) => Singleton<NGSceneManager>.GetInstance().changeScene(Tower029RankingScene.DEFAULT_NAME, (bstack ? 1 : 0) != 0, (object) period_id, (object) tower_id);
  ...
  public void onStartScene(int period_id, int tower_id) => Singleton<CommonRoot>.GetInstance().isLoading = false;

  public override void onEndScene() => Singleton<CommonRoot>.GetInstance().headerType = CommonRoot.HeaderType.Normal;
}
