...
public class DailyMission0271SelectCompRewardList : MonoBehaviour
{
  ...
  public IEnumerator CompRewardPopup()
  {
    ...
    e = popupPrefab.GetComponent<DailyMission0271CompRewardPopup>().Init(selectCompRewardList.completeReward, new System.Action(selectCompRewardList.\u003CCompRewardPopup\u003Eb__9_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
