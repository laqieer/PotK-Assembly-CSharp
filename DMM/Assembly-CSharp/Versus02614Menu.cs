...
public class Versus02614Menu : BackButtonMenuBase
{
  ...
  private IEnumerator requestAPIPvpOtherRanking(int rank_kind)
  {
    ...
    {
      Future<WebAPI.Response.PvpOtherRanking> f = WebAPI.PvpOtherRanking(rank_kind, (System.Action<WebAPI.Response.UserError>) (e =>
      {
  ...
  public IEnumerator InitOne()
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(prefabF.Result, versus02614Menu.parentPulldown.transform);
  ...
  {
    Versus02614Menu versus02614Menu = this;
    versus02614Menu.scrollContainer_long.GetComponent<UIWidget>().alpha = 0.0001f;
    ...
    versus02614Menu.scrollContainer_long.gameObject.SetActive(!isMyRankEnable);
    versus02614Menu.lineDecoBottom.SetActive(isMyRankEnable);
    versus02614Menu.dirBottomBtn.SetActive(isMyRankEnable);
    versus02614Menu.scrollContainer_short.gameObject.SetActive(isMyRankEnable);
    ...
    if (versus02614Menu.ranking_data.Length != 0)
    {
      ...
      versus02614Menu.btnNext.isEnabled = versus02614Menu.nowIndex >= 1;
      versus02614Menu.btnPrevious.isEnabled = versus02614Menu.nowIndex < versus02614Menu.ranking_data.Length - 1;
      if (versus02614Menu.isSelectTop30)
      {
        versus02614Menu.btnTop30.isEnabled = false;
        versus02614Menu.btnMyRankSuperior.isEnabled = true;
        versus02614Menu.slcTxtTop30.color = Color.white;
        versus02614Menu.slcTxtMyRankSuperior.color = Color.gray;
      }
      else
      {
        versus02614Menu.btnTop30.isEnabled = true;
        versus02614Menu.btnMyRankSuperior.isEnabled = false;
        versus02614Menu.slcTxtTop30.color = Color.gray;
        versus02614Menu.slcTxtMyRankSuperior.color = Color.white;
      }
      ...
      if (startTime.HasValue && finishTime.HasValue)
      {
        ...
        hashtable.Add((object) "year", (object) startTime.Value.Year.ToLocalizeNumberText());
        hashtable.Add((object) "month", (object) startTime.Value.Month.ToLocalizeNumberText());
        hashtable.Add((object) "day", (object) startTime.Value.Day.ToLocalizeNumberText());
        DateTime dateTime = finishTime.Value;
        hashtable.Add((object) "month2", (object) dateTime.Month.ToLocalizeNumberText());
        dateTime = finishTime.Value;
        hashtable.Add((object) "day2", (object) dateTime.Day.ToLocalizeNumberText());
        string text = Consts.Format(versus002614Term, (IDictionary) hashtable);
    ...
    else
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      versus02614Menu.btnNext.isEnabled = false;
      versus02614Menu.btnPrevious.isEnabled = false;
    ...
    list.ForEach(new System.Action<KeyValuePair<int, PvpRankingKind>>(versus02614Menu.\u003CCreateDisplay\u003Eb__30_1));
    // ISSUE: reference to a compiler-generated method
    ...
    Singleton<CommonRoot>.GetInstance().isLoading = false;
    Singleton<CommonRoot>.GetInstance().loadingMode = 0;
    versus02614Menu.scrollContainer_long.GetComponent<UIWidget>().alpha = 1f;
