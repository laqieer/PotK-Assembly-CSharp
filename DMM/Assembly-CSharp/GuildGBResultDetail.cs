...
public class GuildGBResultDetail : MonoBehaviour
{
  ...
  public void Initialize()
  {
    ...
    int num1 = UnityEngine.Random.Range(0, 30);
    string startNum1 = num1.ToString();
    num1 = UnityEngine.Random.Range(0, 1000);
    ...
    int num2 = UnityEngine.Random.Range(0, 30);
    ...
    string _addString = "+%(value)s")
  {
    ...
    while (sumValue < _baseValue + _addValue)
    {
      ...
      test += Time.deltaTime;
      float f = (float) _addValue / duration * Time.deltaTime;
      sumValue += Mathf.CeilToInt(f);
      addValue -= Mathf.CeilToInt(f);
    }
    _baseLabel.SetTextLocalize(Consts.Format(_baseString, (IDictionary) new Hashtable()
    {
      {
  ...
  private class GuildResult
  {
    ...
    {
      if ((UnityEngine.Object) this.txt_guild_name != (UnityEngine.Object) null && guildName != "")
        this.txt_guild_name.SetTextLocalize(guildName);
      if ((UnityEngine.Object) this.txt_stars_earned != (UnityEngine.Object) null && startNum != "")
        this.txt_stars_earned.SetTextLocalize(startNum);
      if (!((UnityEngine.Object) this.txt_total_damages != (UnityEngine.Object) null) || !(totalDamage != ""))
        return;
  ...
  private class GuildLevel
  {
    ...
    private void SetExperienceNextLabel(int expNext) => this.txt_guild_exp_for_next_level.SetTextLocalize(Consts.Format(Consts.GetInstance().GUILD_BANK_EXP_NEXT_LEVEL, (IDictionary) new Hashtable()
    {
      {
        (object) "exp",
        (object) expNext
    ...
    private void SetGuildLevelLabel(int level) => this.txt_guild_level_num.SetTextLocalize(level.ToString());
    ...
    public IEnumerator StartAnimation(System.Action callback)
    {
      ...
      if (guildLevel.levelupCnt > 0)
      {
        ...
        guildLevel.guildBaseEffPrefab.gameObject.SetActive(false);
        ...
        guildLevel.guildBasePrefab.gameObject.SetActive(false);
        ...
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        if ((UnityEngine.Object) guildLevel.levelUpPrefab == (UnityEngine.Object) null)
        {
      ...
      e = GaugeRunner.Run(new GaugeRunner(guildLevel.slc_gauge_exp.gameObject, guildLevel.beforeRate, guildLevel.afterRate, guildLevel.levelupCnt, levelupCallback));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      if ((UnityEngine.Object) guildLevel.guildBasePrefab != (UnityEngine.Object) null)
      {
        UnityEngine.Object.Destroy((UnityEngine.Object) guildLevel.guildBasePrefab.gameObject);
        guildLevel.guildBasePrefab = (Guild0282GuildBase) null;
      }
      if ((UnityEngine.Object) guildLevel.guildBaseEffPrefab != (UnityEngine.Object) null)
      {
        UnityEngine.Object.Destroy((UnityEngine.Object) guildLevel.guildBaseEffPrefab.gameObject);
    ...
    public IEnumerator Levelup(GameObject obj, int count)
    {
      ...
      GameObject gameObject1 = this.guildBasePrefab.gameObject;
      GameObject gameObject2 = this.guildBaseEffPrefab.gameObject;
      ...
      while (!((UnityEngine.Object) prefab == (UnityEngine.Object) null))
        yield return (object) null;
