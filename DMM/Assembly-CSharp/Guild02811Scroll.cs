...
public class Guild02811Scroll : MonoBehaviour
{
  ...
  public void UpdateApply(string guildID) => this.applyObj.SetActive(this.guild.guild_id == guildID);
  ...
  private IEnumerator SetGuildData(GuildDirectory data)
  {
    ...
    Future<UnityEngine.Sprite> futureGuildTitleImage = EmblemUtility.LoadGuildEmblemSprite(this.guild.appearance._current_emblem);
