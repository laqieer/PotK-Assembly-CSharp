...
public class Popup001713Menu : BackButtonMenuBase
{
  ...
  private IEnumerator ReceiveAll()
  {
    ...
    Future<WebAPI.Response.PresentRead> receive = WebAPI.PresentRead(popup001713Menu.receiveList.Select<PlayerPresent, int>((Func<PlayerPresent, int>) (x => x.id)).ToArray<int>(), (System.Action<WebAPI.Response.UserError>) (error =>
    {
    ...
    if (receive.Result != null)
    {
      ...
      if (receive.Result.is_success)
      {
        ...
        popup001713Menu.receiveList.ForEach((System.Action<PlayerPresent>) (x => ((IEnumerable<PlayerPresent>) ((IEnumerable<PlayerPresent>) receive.Result.player_presents).Where<PlayerPresent>((Func<PlayerPresent, bool>) (y => x.id == y.id)).ToArray<PlayerPresent>()).ForEach<PlayerPresent>((System.Action<PlayerPresent>) (z =>
        {
