...
public class NGMessageUI : Singleton<NGMessageUI>
{
    ...
    bool enabledSe)
  {
    ...
    if (enabledSe)
      this.PlaySE();
    this.messageObj.transform.localPosition = (Vector3) new Vector2(0.0f, (float) this.GetPosTypeValue() + offset);
    ...
    component.SetOnFinished((EventDelegate.Callback) (() => this.TurnOff()));
  ...
  private void ChangeBG(NGMessageUI.ColorType colorType) => ((System.Action<UISprite[]>) (sprites =>
  {
