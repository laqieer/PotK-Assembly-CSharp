...
public class RaidBattleEnemyInfoPopup : BackButtonMonoBehaiviour
{
    ...
    int loopCount)
  {
    ...
    if ((UnityEngine.Object) battleEnemyInfoPopup.iconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) battleEnemyInfoPopup.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      battleEnemyInfoPopup.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    battleEnemyInfoPopup.scrool_start_y = battleEnemyInfoPopup.scroll.scrollView.transform.localPosition.y;
  ...
  private IEnumerator CreateBossIcon()
  {
    if (this.bossIconInfo != null && !((UnityEngine.Object) this.bossIconInfo.icon == (UnityEngine.Object) null))
    {
      ...
      if (!((UnityEngine.Object) ft.Result == (UnityEngine.Object) null))
      {
        ...
        ui2Dsprite.transform.SetParent(this.bossIconInfo.icon.transform);
        ui2Dsprite.transform.localPosition = new Vector3(this.bossIconLocalPos.x, this.bossIconLocalPos.y, 0.0f);
      }
    }
  }
  ...
  private IEnumerator CreateUnitIcon()
  {
    ...
    for (i = 0; i < Mathf.Min(UnitIcon.MaxValue, this.allEnemyInfo.Count); ++i)
    {
      ...
      this.scroll.Add(unitIcon.gameObject, UnitIcon.Width, heightWithHpGauge);
    ...
    PlayerUnit baseUnit = null)
  {
    ...
    this.allEnemyInfo.Where<RaidBattleEnemyInfoPopup.EnemyUnitIconInfo>((Func<RaidBattleEnemyInfoPopup.EnemyUnitIconInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)).ForEach<RaidBattleEnemyInfoPopup.EnemyUnitIconInfo>((System.Action<RaidBattleEnemyInfoPopup.EnemyUnitIconInfo>) (b => b.icon = (UnitIconBase) null));
    ...
    while (true)
    {
      do
      {
        ...
        foreach (GameObject gameObject in this.scroll)
        {
          ...
          {
            int? nullable = this.allEnemyInfo.FirstIndexOrNull<RaidBattleEnemyInfoPopup.EnemyUnitIconInfo>((Func<RaidBattleEnemyInfoPopup.EnemyUnitIconInfo, bool>) (v => (UnityEngine.Object) v.icon != (UnityEngine.Object) null && (UnityEngine.Object) v.icon.gameObject == (UnityEngine.Object) unit));
