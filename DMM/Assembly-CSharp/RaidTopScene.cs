...
public class RaidTopScene : NGSceneBase
{
  ...
  public static void ChangeScene() => Singleton<NGSceneManager>.GetInstance().changeScene("raid_top", Singleton<NGSceneManager>.GetInstance().sceneName != "raid_top");
  ...
  private void ShowAdvice() => Singleton<TutorialRoot>.GetInstance().ShowAdvice("guild028_1_raid_tutorial");
