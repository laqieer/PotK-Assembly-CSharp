...
public class Unit004JobChangeScene : NGSceneBase
{
  ...
  public static void changeSceneBySelector(int playerUnitId, int? jobId = null) => Singleton<NGSceneManager>.GetInstance().changeScene(Unit004JobChangeScene.DefaultName, false, (object) new SceneParam(playerUnitId, jobId, (System.Action) (() => Unit004JobChangeUnitSelectScene.changeScene(false))));

  public static void changeScene(
    bool isStack,
    int playerUnitId,
    int? jobId = null,
    System.Action eventBackScene = null)
  {
  ...
  {
    Unit004JobChangeScene unit004JobChangeScene = this;
    if ((UnityEngine.Object) unit004JobChangeScene.background_ == (UnityEngine.Object) null)
    {
  ...
  private void AutoOpenUnityToutaPopupCoroutine()
  {
    ...
    }, (NGMenuBase) null, (System.Action) null);
