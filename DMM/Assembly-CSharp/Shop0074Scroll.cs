...
public class Shop0074Scroll : MonoBehaviour
{
    ...
    long sub_holding = 0)
  {
    ...
    switch (entityType)
    {
      ...
      case MasterDataTable.CommonRewardType.material_unit:
        ...
        int num1 = playerMaterialUnit != null ? playerMaterialUnit.quantity : 0;
        shop0074Scroll2._playerUnitQuantity = num1;
        break;
    ...
    switch (shop0074Scroll1._menu.currencyType)
    {
      ...
      case ShopArticleListMenu.CurrencyType.TowerMedal:
        ...
        long num2 = towerPlayer != null ? (long) towerPlayer.tower_medal : 0L;
        shop0074Scroll3.holding = num2;
        break;
      case ShopArticleListMenu.CurrencyType.GuildMedal:
        ...
        long num3 = current != null ? (long) current.guild_medal : 0L;
        shop0074Scroll4.holding = num3;
        break;
    ...
    if ((UnityEngine.Object) shop0074Scroll1.ibtnDetailCollider != (UnityEngine.Object) null)
      shop0074Scroll1.ibtnDetailCollider.enabled = true;
    if ((UnityEngine.Object) shop0074Scroll1.unitIconObj != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) shop0074Scroll1.unitIconObj);
      shop0074Scroll1.unitIconObj = (GameObject) null;
    }
    if ((UnityEngine.Object) shop0074Scroll1.itemIconObj != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) shop0074Scroll1.itemIconObj);
      shop0074Scroll1.itemIconObj = (GameObject) null;
    }
    if ((UnityEngine.Object) shop0074Scroll1.uniqueIconObj != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) shop0074Scroll1.uniqueIconObj);
      ...
      default:
        ...
        switch (content.entity_type)
        {
          ...
          case MasterDataTable.CommonRewardType.gacha_ticket:
            ...
            if ((UnityEngine.Object) shop0074Scroll1.ibtnDetailCollider != (UnityEngine.Object) null)
              shop0074Scroll1.ibtnDetailCollider.enabled = false;
  ...
  {
    GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(prefab, this.dirThum.transform);
