...
public class Versus0262MenuBase : NGMenuBase
{
  ...
  public virtual void IbtnOrganization() => Debug.Log((object) "click default event IbtnOrganization");
  ...
  public virtual void IbtnTeamCondition() => Debug.Log((object) "click default event IbtnTeamCondition");

  public virtual void IbtnWarExperience() => Debug.Log((object) "click default event IbtnWarExperience");
}
