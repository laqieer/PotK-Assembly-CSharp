...
public class DailyMission0271MissionRoot : MonoBehaviour
{
  ...
  public DailyMission0271Menu menu
  {
    get
    {
      if ((UnityEngine.Object) this._menu == (UnityEngine.Object) null)
        this._menu = this.gameObject.transform.root.GetComponent<DailyMission0271Menu>();
      return this._menu;
    }
  }
  ...
  public IEnumerator SetMissionData(PlayerBingo playerBingoData)
  {
    ...
    {
      this.CompleateRewardBtn.isEnabled = false;
    ...
    {
      this.CompleateRewardBtn.isEnabled = true;
      e = this.SetPanel();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  private IEnumerator SetSelectCompReward()
  {
    ...
    missionRoot.grid.transform.Clear();
    ...
    for (int index = 0; index < strArray.Length; ++index)
    {
      ...
      if (int.TryParse(s, out local))
      {
        ...
        {
          IEnumerator e = missionRoot.compleateMissonSelectPrefab.CloneAndGetComponent<DailyMission0271SelectCompRewardList>(missionRoot.grid.gameObject).Init(source.First<MasterDataTable.BingoRewardGroup>(), missionRoot, missionRoot.compleateMissionRewardDetailPrefab);
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
        }
  ...
  private IEnumerator SetPanel()
  {
    ...
    mission0271MissionRoot.compRewardImage.gameObject.SetActive(false);
    ...
    if (source.Count<MasterDataTable.BingoRewardGroup>() > 0)
    {
      Future<UnityEngine.Sprite> BackgroundImageF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("PanelMission/Background/{0}", (object) source.First<MasterDataTable.BingoRewardGroup>().background_image_name));
      e = BackgroundImageF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      UnityEngine.Sprite result = BackgroundImageF.Result;
      if ((UnityEngine.Object) result != (UnityEngine.Object) null)
      {
        mission0271MissionRoot.compRewardImage.gameObject.SetActive(true);
        mission0271MissionRoot.compRewardImage.sprite2D = result;
        mission0271MissionRoot.compRewardImage.width = (int) result.textureRect.width;
        mission0271MissionRoot.compRewardImage.height = (int) result.textureRect.height;
      }
      BackgroundImageF = (Future<UnityEngine.Sprite>) null;
    }
  ...
  private IEnumerator createBingoMission(PlayerBingoPanel[] panels)
  {
    ...
    {
      missionRoot.panelRoots[i].transform.Clear();
  ...
  public void SetCompReward(int reward_group_id) => this.StartCoroutine(this.SelectCompReward(reward_group_id));
  ...
  private IEnumerator SelectCompReward(int reward_group_id)
  {
    ...
    Future<WebAPI.Response.BingoSelectComplete> future = WebAPI.BingoSelectComplete(mission0271MissionRoot.playerBingo.bingo_id, reward_group_id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
  ...
  private IEnumerator playCompRewardEffect(MasterDataTable.BingoRewardGroup[] Rewards)
  {
    ...
    if ((UnityEngine.Object) prefab2.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      prefab2.GetComponent<UIWidget>().alpha = 0.0f;
