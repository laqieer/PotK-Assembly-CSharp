...
public class PopupNotificationGetItem : MonoBehaviour
{
  ...
  {
    Future<UnityEngine.Sprite> spriteF = new ResourceObject(reward_type_id == MasterDataTable.CommonRewardType.reisou_jewel ? "Icons/ChaosJewel_Icon" : "Icons/Common_Icon").Load<UnityEngine.Sprite>();
