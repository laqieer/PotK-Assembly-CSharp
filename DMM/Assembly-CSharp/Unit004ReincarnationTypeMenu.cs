...
public class Unit004ReincarnationTypeMenu : BackButtonMenuBase
{
  ...
  {
    if ((UnityEngine.Object) this.afterUnit == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator openPopupTypeConfirm()
  {
    ...
    if (num != 0)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.\u003C\u003E1__state = -1;
      Singleton<PopupManager>.GetInstance().open(prefabF.Result).GetComponent<Popup004ReincarnationTypeMenu>().Init(reincarnationTypeMenu.playerUnitBefore.unit_type.name, reincarnationTypeMenu.playerUnitAfter.unit_type.name, new System.Action(reincarnationTypeMenu.OnReincarnation));
      return false;
    }
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
  ...
  public IEnumerator ReincarnationType()
  {
    ...
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      Future<WebAPI.Response.UnittypeticketSpend> paramF = WebAPI.UnittypeticketSpend(reincarnationTypeMenu.playerUnitBefore.id, reincarnationTypeMenu.ticket.ID, reincarnationTypeMenu.playerUnitAfter.unit_type.ID, (System.Action<WebAPI.Response.UserError>) (error =>
      {
