...
public class Colosseum02371Scene : NGSceneBase
{
  ...
  public static void ChangeScene(ColosseumUtility.Info colosseumInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("colosseum023_7_1", false, (object) colosseumInfo);
