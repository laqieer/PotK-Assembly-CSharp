...
public class Unit00410Popup : BackButtonMenuBase
{
  ...
  public IEnumerator Show(
    ...
    List<System.Action> callbackList,
  ...
  private IEnumerator InitIcon(PlayerUnit playerUnit)
  {
    ...
    e = (IEnumerator) null;
    GameObject unitIconObj = UnityEngine.Object.Instantiate<GameObject>(unitIconPrefab.Result, this.m_unitIconImage.transform.parent.Find("dir_thum"));
  ...
  {
    this.m_unitIconImage.enabled = false;
  ...
  private int GetUnitSellingQuantity(float sliderValue, int maxSellableQuantity, int unitCount) => (int) ((double) sliderValue * (double) Mathf.Min(maxSellableQuantity, unitCount));
