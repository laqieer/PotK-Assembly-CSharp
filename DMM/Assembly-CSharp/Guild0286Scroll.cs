...
public class Guild0286Scroll : BackButtonMenuBase
{
  ...
  private System.Action<GuildMemberGift> buttonAction;
  ...
  public IEnumerator Init(GuildMemberGift[] gifts, System.Action<GuildMemberGift> action)
  {
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        {
          int? nullable = this.allGuildGiftInfos.FirstIndexOrNull<GuildGiftInfo>((Func<GuildGiftInfo, bool>) (v => (UnityEngine.Object) v.scroll != (UnityEngine.Object) null && (UnityEngine.Object) v.scroll.gameObject == (UnityEngine.Object) unit));
  ...
  private void ResetScroll(int index)
  {
    ...
    this.allGuildGiftInfos.Where<GuildGiftInfo>((Func<GuildGiftInfo, bool>) (a => (UnityEngine.Object) a.scroll == (UnityEngine.Object) scroll)).ForEach<GuildGiftInfo>((System.Action<GuildGiftInfo>) (b => b.scroll = (GuildGiftScrollParts) null));
  }
  ...
  private IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.setting.iconMaxValue, this.allGuildGiftInfos.Count); ++index)
      this.allScroll.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<GuildGiftScrollParts>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.setting.iconMaxValue, this.allScroll.Count); ++index)
      this.scroll.AddColumn1(this.allScroll[index].gameObject, this.setting.iconWidth, this.setting.iconHeight);
