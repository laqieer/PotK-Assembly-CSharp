...
public class Title0241Scene : NGSceneBase
{
  ...
  public static void ChangeScene00241(bool stack, string target_player_id) => Singleton<NGSceneManager>.GetInstance().changeScene("title024_1", (stack ? 1 : 0) != 0, (object) target_player_id);
