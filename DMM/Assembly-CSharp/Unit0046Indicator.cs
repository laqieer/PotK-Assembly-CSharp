    ...
    GameObject leaderSkillPopupPrefab)
  {
    ...
    if (playerUnit != (PlayerUnit) null)
    {
      if (playerUnit.leader_skill != null)
      {
        ...
        unit0046Indicator.popupLeaderSkillDetail_ = (System.Action) (() => PopupSkillDetails.show(leaderSkillPopupPrefab, new PopupSkillDetails.Param(s, UnitParameter.SkillGroup.Leader)));
