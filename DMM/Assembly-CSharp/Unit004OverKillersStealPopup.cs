...
public class Unit004OverKillersStealPopup : BackButtonMenuBase
{
  ...
  public void Init(PlayerUnit playerUnit, System.Action yes = null, System.Action no = null)
  {
  ...
  private IEnumerator SetSprite()
  {
    ...
    killersStealPopup.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    killersStealPopup.GetComponent<UIWidget>().alpha = 1f;
  }
