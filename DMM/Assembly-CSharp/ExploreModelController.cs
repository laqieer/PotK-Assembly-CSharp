...
public class ExploreModelController : MonoBehaviour
{
  ...
  private void Awake()
  {
    this.mExploreModelCreate = this.mRootExplore.GetComponentInChildren<Explore3DModelCreate>();
    this.mCampModelCreates = this.mRootCamp.gameObject.GetComponentsInChildren<Explore3DModelCreate>();
  }
  ...
  public void SetExploreVisible(bool visible) => this.mRoot3d.gameObject.SetActive(visible);
  ...
  public void SetBattleMapMode(bool enable)
  {
    ...
    this.mRootNonBattle.gameObject.SetActive(!enable);
  }

  public void ResetCameraPosition()
  {
    if ((Object) this.mPlayerVehicleAnimator != (Object) null)
    {
      this.mMainCamera.transform.localPosition = this.mMainCameraPosRider;
      this.mTreasureCamera.transform.localPosition = this.mTreasureCameraPosRider;
    }
    else
    {
      this.mMainCamera.transform.localPosition = this.mMainCameraPosSoldier;
      this.mTreasureCamera.transform.localPosition = this.mTreasureCameraPosSoldier;
    }
  }

  public void ChangeMainCamera()
  {
    this.mMainCamera.gameObject.SetActive(true);
    this.mTreasureCamera.gameObject.SetActive(false);
  }

  public void ChangeTreasureCamera()
  {
    this.mTreasureCamera.gameObject.SetActive(true);
    this.mMainCamera.gameObject.SetActive(false);
  }
  ...
  public void PlayTreasureCamera()
  {
    ...
    {
      this.mMainCamera.transform.localPosition
    };
    vector3List.AddRange((IEnumerable<Vector3>) this.mTreasureCameraPath);
    vector3List.Add(this.mTreasureCamera.transform.localPosition);
  ...
  public IEnumerator LoadExploreUnitModel(PlayerUnit playerUnit)
  {
    if (playerUnit != this.mPlayerUnit)
    {
      ...
      if ((Object) this.mExclamationPrefab == (Object) null)
      {
  ...
  public IEnumerator CreateExploreUnit(PlayerUnit playerUnit)
  {
    if (playerUnit != this.mPlayerUnit)
    {
      ...
      this.mPlayerUnitModel.SetParent(this.mExploreModelCreate.gameObject);
  ...
  private void setExclamationMark()
  {
    ...
    this.mExclamation.transform.localPosition = !((Object) this.mPlayerVehicleAnimator != (Object) null) ? this.mExclamationPosSoldier : this.mExclamationPosRider;
  ...
  {
    if ((Object) this.mExploreModelCreate.VehicleModel != (Object) null)
    {
      this.mMainCamera.transform.localPosition = this.mMainCameraPosRider;
      this.mTreasureCamera.transform.localPosition = this.mTreasureCameraPosRider;
    }
  ...
  {
    if ((Object) this.mTreasureBoxAnimator == (Object) null)
    {
  ...
  {
    this.mTreasureBoxAnimator.gameObject.SetActive(true);
    Singleton<ExploreSceneManager>.GetInstance().PlaySe("SE_2451");
  }

  public void CloseTreasureBox() => this.mTreasureBoxAnimator.gameObject.SetActive(false);

  public void SetCampVisible(bool visible)
  {
    this.mRootCamp.gameObject.SetActive(visible);
    this.mRootExplore.gameObject.SetActive(!visible);
    this.mCampCamera.gameObject.SetActive(visible);
    this.mMainCamera.gameObject.SetActive(!visible);
    if (visible)
    ...
    foreach (Explore3DModelCreate mCampModelCreate in this.mCampModelCreates)
    {
      if (index < playerUnits.Length && playerUnits[index] != (PlayerUnit) null)
      {
        if (this.mPlayerUnits[index] != playerUnits[index])
        {
          ...
          mCampModelCreate.BaseModel.SetParent(mCampModelCreate.gameObject);
