...
public class Guide0112Menu : GuideZukanListManager
{
  ...
  public override int ResourceID(GuideUnitUnit unit) => unit.Unit.resource_reference_unit_id_UnitUnit;

  public override Future<UnityEngine.Sprite> ResourceSprite(GuideUnitUnit unit) => unit.Unit.LoadSpriteThumbnail();
  ...
  public override void SortAndFilter()
  {
    ...
    ((IEnumerable<UnitUnit>) MasterData.UnitUnitList).Where<UnitUnit>((Func<UnitUnit, bool>) (x => x.character.category == UnitCategory.player && x.history_group_number < 20000)).ForEach<UnitUnit>((System.Action<UnitUnit>) (obj =>
    {
