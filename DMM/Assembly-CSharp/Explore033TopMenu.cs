...
public class Explore033TopMenu : BackButtonMenuBase
{
  ...
  private IEnumerator openRewardBoxPopup()
  {
    ...
    exploreRewardBoxAnim.dirMessageRewardsEmpty = UnityEngine.Object.Instantiate<GameObject>(Resources.Load<GameObject>("Prefabs/GoogleFeature/dir_noList"), exploreRewardBoxAnim.transform);
