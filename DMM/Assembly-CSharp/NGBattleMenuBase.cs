...
public class NGBattleMenuBase : NGMenuBase
{
  ...
  public virtual void setText(UILabel label, int v) => label.SetTextLocalize(string.Concat((object) v));

  public virtual void setText(UILabel label, long v) => label.SetTextLocalize(string.Concat((object) v));

  public bool isStartInitialized() => !this.gameObject.activeSelf || !this.isDoStart || this.bmStatus.IsBattleManagerCompleted();
