...
public class GuildApplicantsBarBase : BackButtonMenuBase
{
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.allApplicantInfo.FirstIndexOrNull<ApplicantBarInfo>((Func<ApplicantBarInfo, bool>) (v => (UnityEngine.Object) v.scroll != (UnityEngine.Object) null && (UnityEngine.Object) v.scroll.gameObject == (UnityEngine.Object) unit));
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allApplicantInfo.Count); ++index)
      this.allApplicantBar.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<Guild0285Scroll>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allApplicantBar.Count); ++index)
      this.scroll.AddColumn1(this.allApplicantBar[index].gameObject, this.barWidth, this.barHeight);
  ...
  protected void ResetScroll(int index)
  {
    ...
    this.allApplicantInfo.Where<ApplicantBarInfo>((Func<ApplicantBarInfo, bool>) (a => (UnityEngine.Object) a.scroll == (UnityEngine.Object) scroll)).ForEach<ApplicantBarInfo>((System.Action<ApplicantBarInfo>) (b => b.scroll = (Guild0285Scroll) null));
  }
