...
public class Story00913ScrollParts : MonoBehaviour
{
  ...
  public void Init(Story00913Menu menu, PlayerSeaQuestS quest)
  {
    ...
    ((IEnumerable<PlayerSeaQuestS>) SMManager.Get<PlayerSeaQuestS[]>().S(quest.quest_sea_s.quest_xl.ID, quest.quest_sea_s.quest_l.ID, quest.quest_sea_s.quest_m.ID)).OrderBy<PlayerSeaQuestS, int>((Func<PlayerSeaQuestS, int>) (x => x.quest_sea_s.ID)).ForEach<PlayerSeaQuestS>((System.Action<PlayerSeaQuestS>) (q =>
    {
