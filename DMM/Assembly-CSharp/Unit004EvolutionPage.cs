...
public class Unit004EvolutionPage : Unit004TrainingPage
{
  ...
  protected override IEnumerator loadResources()
  {
    ...
    if ((UnityEngine.Object) unit004EvolutionPage.indicatorPrefab_ == (UnityEngine.Object) null)
    {
  ...
  protected override bool isDisabledAfterUnitIconButton => this.errFlags_.IsOn(Unit004TrainingPage.ErrorFlag.Limit);
    ...
    if (unit004EvolutionPage.isResetBase_)
    {
      ...
      switch (unit004EvolutionPage.evolutionType_)
      {
        case EvolutionType.Normal:
          ...
          {
            unit004EvolutionPage.beforeAwake_.gameObject,
            unit004EvolutionPage.afterAwake_.gameObject,
            unit004EvolutionPage.awakeBtn_.gameObject
          });
          selfs2.AddRange((IEnumerable<GameObject>) new GameObject[4]
          {
            unit004EvolutionPage.beforeEvolution_.gameObject,
            unit004EvolutionPage.afterEvolution_.gameObject,
            unit004EvolutionPage.evolutionBtn_.gameObject,
          ...
          unit004EvolutionPage.evolutionBtn_.isEnabled = false;
          break;
        case EvolutionType.Awake:
          ...
          unit004EvolutionPage.awakeBtn_.isEnabled = true;
          break;
      ...
      if (unit004EvolutionPage.evolutionType_ != EvolutionType.Limit && unit004EvolutionPage.target_.estimatesEvolution == null)
      {
        ...
        Future<WebAPI.Response.UnitEvolutionParameter> paramF = WebAPI.UnitEvolutionParameter(base_player_material_unit_id, base_player_unit_id, 0, array, (System.Action<WebAPI.Response.UserError>) (e =>
        {
  ...
  private IEnumerator doEvolution()
  {
    ...
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      Future<WebAPI.Response.UnitEvolution> paramF = WebAPI.UnitEvolution(base_player_material_unit_id, base_player_unit_id, unit004EvolutionPage.materialMaterialUnitIds_.ToArray(), unit004EvolutionPage.materialUnitIds_.ToArray(), unit004EvolutionPage.currentEvolutionPatternId_, (System.Action<WebAPI.Response.UserError>) (error =>
      {
      ...
      if (paramF.Result != null)
      {
        ...
        {
          UnitIcon componentInChildren = lnkEvolutionUnit.GetComponent<UI2DSprite>().GetComponentInChildren<UnitIcon>();
  ...
  private PlayerUnit[] getMaterialPlayerUnits() => ((IEnumerable<PlayerUnit>) SMManager.Get<PlayerUnit[]>()).Where<PlayerUnit>((Func<PlayerUnit, bool>) (unit => this.materialUnitIds_.Contains(unit.id))).ToArray<PlayerUnit>();
    ...
    IEnumerator execute)
  {
    Unit004EvolutionPage unit004EvolutionPage = this;
    int nWait = 0;
    System.Action yes = (System.Action) (() => nWait = 1);
    System.Action no = (System.Action) (() => nWait = 2);
    if (string.IsNullOrEmpty(messageSub))
      PopupCommonNoYes.Show(title, message, yes, no);
    else
      PopupCommonNoYes.Show(title, message, yes, no, messageB: messageSub, alignmentB: NGUIText.Alignment.Center);
    ...
    UnitUnit[] evoUnits)
  {
    ...
    {
      GameObject gameObject1 = objects[n];
      ...
      GameObject gameObject2 = selectIcons == null || n >= selectIcons.Length ? (GameObject) null : selectIcons[n].top_;
      if ((UnityEngine.Object) gameObject2 != (UnityEngine.Object) null)
        gameObject2.SetActive(canCompleted && unit1 != null && selector.isSelectable(unit1.ID));
      UnitIcon component = unit004EvolutionPage.unitIconPrefab_.CloneAndGetComponent<UnitIcon>(gameObject1.transform);
    ...
    bool canCompleted)
  {
    ...
    {
      icon.onClick = (System.Action<UnitIconBase>) (x => this.ShowMaterialQuestInfo(x.Unit));
  ...
  public List<int> getEvolutionMaterialSelectedUnitIds(int patternId) => this.dicSelector_ == null || !this.dicSelector_.ContainsKey(patternId) ? new List<int>() : ((IEnumerable<Unit004EvolutionPage.SelectCell>) this.dicSelector_[patternId].selected_).Where<Unit004EvolutionPage.SelectCell>((Func<Unit004EvolutionPage.SelectCell, bool>) (c => c != null && c.unit_.unit.IsNormalUnit)).Select<Unit004EvolutionPage.SelectCell, int>((Func<Unit004EvolutionPage.SelectCell, int>) (cc => cc.unit_.id)).ToList<int>();

  public List<int> getEvolutionMaterialSelectedMaterialIds(int patternId) => this.dicSelector_ == null || !this.dicSelector_.ContainsKey(patternId) ? new List<int>() : ((IEnumerable<Unit004EvolutionPage.SelectCell>) this.dicSelector_[patternId].selected_).Where<Unit004EvolutionPage.SelectCell>((Func<Unit004EvolutionPage.SelectCell, bool>) (c => c != null && c.unit_.unit.IsMaterialUnit)).Select<Unit004EvolutionPage.SelectCell, int>((Func<Unit004EvolutionPage.SelectCell, int>) (cc => cc.unit_.id)).ToList<int>();
  ...
  private void Update()
  {
    ...
    else if (this.evolutionBtn_.isEnabled != this.isEvolutionButtonEnabled)
      this.evolutionBtn_.isEnabled = this.isEvolutionButtonEnabled;
    bool flag1 = (UnityEngine.Object) Singleton<PopupManager>.GetInstanceOrNull() != (UnityEngine.Object) null && Singleton<PopupManager>.GetInstance().isOpen;
    bool flag2 = (UnityEngine.Object) Singleton<CommonRoot>.GetInstanceOrNull() != (UnityEngine.Object) null && Singleton<CommonRoot>.GetInstance().isInputBlock;
    if (!Singleton<NGSceneManager>.GetInstance().isSceneInitialized || Singleton<TutorialRoot>.GetInstance().IsAdviced || (!Input.GetKeyUp(KeyCode.Escape) || flag1) || (flag2 || Singleton<NGSceneManager>.GetInstance().changeSceneQueueCount != 0))
      return;
  ...
  private IEnumerator initIndicator()
  {
    ...
    if (unit004EvolutionPage.errFlags_.IsOn(Unit004TrainingPage.ErrorFlag.Limit))
    {
      ...
      unit004EvolutionPage.indicator_.gameObject.SetActive(false);
    ...
    {
      unit004EvolutionPage.indicator_.gameObject.SetActive(true);
      // ISSUE: reference to a compiler-generated method
      ...
      unit004EvolutionPage.indicator_.dot.gameObject.SetActive(true);
      if (unit004EvolutionPage.evolutionPatterns_.Length == 1)
        unit004EvolutionPage.indicator_.dot.gameObject.SetActive(false);
  ...
  {
    this.evolutionBtn_.isEnabled = false;
  ...
  private void CheckEvolutionPossible()
  {
    ...
    switch (this.evolutionType_)
    {
      case EvolutionType.Normal:
        ...
        break;
      case EvolutionType.Awake:
        this.awakeBtn_.isEnabled = this.isEvolutionButtonEnabled;
        break;
      case EvolutionType.CommonAwake:
        this.awakeBtn_.isEnabled = this.isEvolutionButtonEnabled;
        break;
  ...
  private class EvolutionSelectMap
  {
    ...
    public void setUnselected(Unit004EvolutionPage.SelectCell cell) => this.setUnselected(cell.column_);
    ...
    public bool updateNormalUnit(PlayerUnit[] playerUnits)
    {
      bool flag = false;
      PlayerDeck[] decks = SMManager.Get<PlayerDeck[]>();
      foreach (Unit004EvolutionPage.SelectCell[] selectCellArray in this.sources_.Values)
      {
        if (selectCellArray.Length != 0 && ((IEnumerable<Unit004EvolutionPage.SelectCell>) selectCellArray).First<Unit004EvolutionPage.SelectCell>().unit_.unit.IsNormalUnit)
        {
          foreach (Unit004EvolutionPage.SelectCell selectCell in selectCellArray)
          {
