...
public class Quest00230NextRewardObject : MonoBehaviour
{
    ...
    System.Action hiddenAction)
  {
    ...
    {
      nextRewardObject.tweenAlphas = nextRewardObject.GetComponents<TweenAlpha>();
      ...
      {
        nextRewardObject.nextRewardThums[i].transform.DetachChildren();
    ...
    nextRewardObject.gameObject.SetActive(false);
  }
