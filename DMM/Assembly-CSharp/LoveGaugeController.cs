...
public class LoveGaugeController : MonoBehaviour
{
    ...
    bool isSe = false)
  {
    ...
    if (start != end)
    {
      ...
      while (!loopFinish)
      {
        ...
        if (flag)
        {
          loveGaugeController.gauge.setValue(num5, num6, doTween, 0.75f);
          if (((!doTween ? 0 : ((Object) loveGaugeController.positionTween != (Object) null ? 1 : 0)) & (isSe ? 1 : 0)) != 0)
          {
          ...
          loveGaugeController.gauge.setValue(num5, num6, doTween, 0.0f);
  ...
  public void StopSE()
  {
    ...
    if ((Object) instance != (Object) null && this.seChannel != -1)
