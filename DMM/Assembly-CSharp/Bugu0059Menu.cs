...
public class Bugu0059Menu : BackButtonMenuBase
{
    ...
    bool canDriling = true)
  {
    ...
    Future<UnityEngine.Sprite> basicSpriteF = baseGear.gear.LoadSpriteBasic();
    ...
    float x1 = baseGear.gearExp + baseGear.gearExpNext > 0 ? (float) baseGear.gearExp / (float) (baseGear.gearExp + baseGear.gearExpNext) : 0.0f;
    if ((double) x1 != 0.0)
    {
      this.m_GaugeBeforeNextRankToObject.SetActive(true);
      this.m_GaugeBeforeNextRankToObject.transform.localScale = new Vector3(x1, 1f, 1f);
    }
    else
    ...
    this.m_DrillingBtn.isEnabled = this.m_Materials.Any<InventoryItem>() & canDriling;
    if ((UnityEngine.Object) this.scrollView_ != (UnityEngine.Object) null)
    {
      this.scrollView_.ClearBounds();
      int maxPerLine = this.scrollView_.GetComponentInChildren<UIGrid>().maxPerLine;
      ...
      foreach (int index in intList)
      {
        ...
        this.scrollView_.AddBounds((index == 0 ? (IEnumerable<UIWidget>) uiWidgetArray : (IEnumerable<UIWidget>) materialIcon.m_ItemIcon.GetComponentsInChildren<UIWidget>()).Where<UIWidget>((Func<UIWidget, bool>) (x => x.enabled && x.gameObject.activeInHierarchy)));
      }
  ...
  private IEnumerator SetReisouInfo()
  {
    ...
    else
    {
      ...
      else
      {
        ...
        bugu0059Menu.reisouIcon.onClick = (System.Action<ItemIcon>) (x => this.OpenReisouDetailPopup(dispInfoTemp, dispReisouInfo, new System.Action(this.cbRemoveReisou)));
        bugu0059Menu.EnableLongPressEventReisou(dispInfoTemp, bugu0059Menu.reisouIcon, dispReisouInfo, new System.Action(bugu0059Menu.cbRemoveReisou));
    ...
    System.Action removeCallback = null)
  {
    ...
    else
    {
      ...
      if (item.gear.isMythologyReisou())
      {
        ...
        if ((UnityEngine.Object) Bugu0059Menu.reisouPopupDualSkillPrefab == (UnityEngine.Object) null)
        {
      ...
      {
        if ((UnityEngine.Object) Bugu0059Menu.reisouPopupPrefab == (UnityEngine.Object) null)
        {
  ...
  private IEnumerator OpenMaterialCheckPopup()
  {
    ...
    IEnumerator e = obj.GetComponent<Popup00591Menu>().Init(bugu0059Menu.m_Base, bugu0059Menu.m_After, bugu0059Menu.reisouInfo, bugu0059Menu.reisouInfoAfter, bugu0059Menu.m_Materials, new System.Action(bugu0059Menu.\u003COpenMaterialCheckPopup\u003Eb__68_0), bugu0059Menu.m_ItemIconPrefab);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator drilling()
  {
    ...
    Bugu00539Scene.ChangeScene(true, new Bugu00539ChangeSceneParam(list, false, result.animation_pattern, this.m_Base, this.reisouInfo, flag ? (System.Action) (() =>
    {
    ...
    }) : (System.Action) null, addReisouJewel));
