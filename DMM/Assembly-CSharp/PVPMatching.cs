...
public class PVPMatching : MonoBehaviour
{
  ...
  public Future<MatchingPeer.Matched> matchingReady(bool enable) => new Future<MatchingPeer.Matched>((Func<Promise<MatchingPeer.Matched>, IEnumerator>) (promise => this._ready(promise, enable)));
