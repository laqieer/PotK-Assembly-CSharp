...
public class ShopItemIcon : MonoBehaviour
{
    ...
    string shopTime)
  {
    ...
    shopItemIcon.button.GetComponent<UIDragScrollView>().scrollView = scrollView;
    ...
    shopItemIcon.PackThum.gameObject.SetActive(false);
  ...
  public IEnumerator UpdateView()
  {
    ...
    if (this.info.playerShopArticle.article.shop.ID != 5000)
    {
      ...
      {
        if ((UnityEngine.Object) this.limitEmphasieScript == (UnityEngine.Object) null)
        {
          ...
          this.limitEmphasieScript.Init(ShopCommon.LoginTime, this.info.playerShopArticle.end_at);
        this.limitEmphasieScript.gameObject.SetActive(true);
      }
      else if ((UnityEngine.Object) this.limitEmphasieScript != (UnityEngine.Object) null)
        this.limitEmphasieScript.gameObject.SetActive(false);
    }
    this.LimitLabel.text = ShopCommon.GetLimitCountText(this.info.LimitType, this.info.LimitCount);
    if (this.info.IsPack)
    {
      this.HavingNumLabel.gameObject.SetActive(false);
    }
    else
    {
      this.HavingNumLabel.gameObject.SetActive(true);
  ...
  private IEnumerator UpdateThum()
  {
    ...
    {
      shopItemIcon.Decoration.gameObject.SetActive(true);
      ...
      shopItemIcon.Decoration.gameObject.SetActive(false);
    ...
    if (shopItemIcon.info.playerShopArticle.icon_resource != "")
    {
      ...
      shopItemIcon.PackThum.gameObject.SetActive(true);
