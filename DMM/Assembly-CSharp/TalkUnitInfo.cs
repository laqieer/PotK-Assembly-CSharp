...
public class TalkUnitInfo
{
  ...
  public void Init(int sameCharacterId)
  {
    ...
    IEnumerable<SeaDateHitExpansionLottery> source1 = ((IEnumerable<SeaDateHitExpansionLottery>) MasterData.SeaDateHitExpansionLotteryList).Where<SeaDateHitExpansionLottery>((Func<SeaDateHitExpansionLottery, bool>) (x => x.time_zone_id_SeaHomeTimeZone != 0 && (uint) x.date_spot_id_SeaDateDateSpot > 0U));
