...
public class Sea030HomePresentPopup : BackButtonMonoBehaiviour
{
  ...
  public IEnumerator Init(PlayerUnit unit, System.Action<GameCore.ItemInfo, int> apiCallback)
  {
    ...
    for (int i = 0; i < homePresentPopup.presentIconContainers.Length; ++i)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          e = (IEnumerator) null;
          itemIcon.Gray = false;
          itemIcon.onClick = new System.Action<ItemIcon>(homePresentPopup.clickFunc);
        }
