...
public class Quest00240723Menu : BackButtonMenuBase
{
    ...
    bool mustCreateBG = false)
  {
    ...
    quest00240723Menu.SlcBeginerSupport.gameObject.SetActive(Quest00240723Menu.IsBeginnerSupport());
    ...
    {
      BGChange bgChange = quest00240723Menu.GetComponent<BGChange>();
      bgChange.getCurrentBG();
      if ((UnityEngine.Object) bgChange.Current == (UnityEngine.Object) null | mustCreateBG)
      {
      ...
      if (quest00240723Menu.from2_5)
        quest00240723Menu.GetComponent<BGChange>().BlackHangingBackGround(quest00240723Menu.thisCondition == Quest00240723Menu.StoryCondition.HARD, true);
  ...
  {
    Quest0024StoryButton componentInChildren = btnContainer.transform.GetComponentInChildren<Quest0024StoryButton>();
    ...
    if (!isStart)
      return;
    TweenPosition component1 = componentInChildren.GetComponent<TweenPosition>();
    TweenAlpha component2 = componentInChildren.GetComponent<TweenAlpha>();
    float num = (float) (0.5 + (double) index * 0.100000001490116);
    ...
    componentInChildren.ibtnStory.enabled = false;
  }
  ...
  private IEnumerator StoryChoiceButtonSetting(
    ...
    PlayerStoryQuestS[] StoryDataM)
  {
    QuestBG.AnimApply[] animApplyArray = new QuestBG.AnimApply[5]
    {
    ...
    this.StoryM.ForEach<GameObject, PlayerStoryQuestS, QuestBG.AnimApply>((IEnumerable<PlayerStoryQuestS>) StoryDataM, (IEnumerable<QuestBG.AnimApply>) animApplyArray, (System.Action<GameObject, PlayerStoryQuestS, QuestBG.AnimApply>) ((storyM, storyDataM, animApply) =>
    {
      PlayerStoryQuestS[] playerStoryQuestSArray = StoryData.S((int) this.currentStoryMode, this.passLdata, storyDataM.quest_story_s.quest_m_QuestStoryM);
      bool clearflag = ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Count<PlayerStoryQuestS>() == ((IEnumerable<PlayerStoryQuestS>) ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Where<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x.is_clear)).ToArray<PlayerStoryQuestS>()).Count<PlayerStoryQuestS>();
      Quest0024StoryButton storyButton = storyM.transform.GetComponentInChildren<Quest0024StoryButton>();
      storyButton.UnLock(clearflag, playerStoryQuestSArray[0].is_new);
      storyButton.onClick = new EventDelegate((EventDelegate.Callback) (() =>
      {
        this.StoryM.ForEach((System.Action<GameObject>) (x => x.GetComponentInChildren<Quest0024StoryButton>().ibtnStory.enabled = false));
        storyButton.changeClickMySelf();
        this.ChangeScene(storyButton.Mnumber);
      }));
      storyButton.PathNumber = playerStoryQuestSArray[0].quest_story_s.quest_m.number_m;
      storyButton.Mnumber = playerStoryQuestSArray[0].quest_story_s.quest_m_QuestStoryM;
    }));
    for (int i = 0; i < ((IEnumerable<PlayerStoryQuestS>) StoryDataM).Count<PlayerStoryQuestS>(); ++i)
    {
      IEnumerator e = this.StoryM[i].transform.GetComponentInChildren<Quest0024StoryButton>().InitButton(this.thisCondition == Quest00240723Menu.StoryCondition.HARD, this.currentStoryMode);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
    ...
    {
      if (this.StoryM[index].transform.GetComponentInChildren<Quest0024StoryButton>().isActive())
      {
        ...
        if (playerStoryQuestSArray.Length != 0)
          this.MissionAchievementRate(playerStoryQuestSArray[0], this.StoryM[index].transform.GetComponentInChildren<Quest0024StoryButton>());
      }
    }
  }
  ...
  public void ClickHardSwitch()
  {
    ...
    this.GetComponent<BGChange>().BlackHangingBackGround(flag);
  ...
  {
    if ((UnityEngine.Object) this.StoryButtons == (UnityEngine.Object) null)
      return;
  ...
  public void StoryChoiceButtonTween(int tweengroup)
  {
    if ((UnityEngine.Object) this.StoryButtons == (UnityEngine.Object) null)
      return;
    ((IEnumerable<UITweener>) this.StoryButtons.GetComponents<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
    {
  ...
  private Quest00240723Menu.StoryMode GetStoryMode(
    PlayerStoryQuestS[] StoryData,
    int L)
  {
    if (StoryData == null)
  ...
  public void IbtnStoryChangeHeaven() => Singleton<CommonRoot>.GetInstance().GetHeavenCommonFooter().onButtonQuest();

  public void IbtnStoryChangeLostRagnarok() => Singleton<CommonRoot>.GetInstance().GetHeavenCommonFooter().onButtonQuest();
  ...
  private IEnumerator ChangeStoryMode(PlayerStoryQuestS[] stories, int L)
  {
    ...
    if ((UnityEngine.Object) Singleton<CommonRoot>.GetInstance().getBackgroundComponent<QuestBG>() != (UnityEngine.Object) null)
