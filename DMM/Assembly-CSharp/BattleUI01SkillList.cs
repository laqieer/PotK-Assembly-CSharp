...
public class BattleUI01SkillList : BattleMonoBehaviour
{
  ...
  private bool setReplacementSkill()
  {
    int index = 0;
    bool flag = false;
    if (!((UnityEngine.Object) this.battleManager != (UnityEngine.Object) null) || !this.battleManager.isEarth)
    {
      if (this.playerUnit.unit.trust_target_flag && !this.playerUnit.is_guest)
      {
        if (this.playerUnit.is_enemy && (!((UnityEngine.Object) this.battleManager != (UnityEngine.Object) null) || !this.battleManager.isOvo))
        {
          flag = true;
        }
        else
    ...
    this.slc_Replacement_Skill_none[index].gameObject.transform.parent = (Transform) null;
    this.slc_Replacement_Skill_none[index].gameObject.SetActive(false);
    UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Replacement_Skill_have[index].gameObject);
    UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_Replacement_Skill_none[index].gameObject);
    return false;
  }
  ...
  private bool setMultiSkill()
  {
    int index = 1;
    bool flag = false;
    if (this.playerUnit.skills != null && (!((UnityEngine.Object) this.battleManager != (UnityEngine.Object) null) || !this.battleManager.isEarth))
    {
  ...
  private bool setReplacementSkillRow()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Replacement_Skill.gameObject);
      return num != 0;
    }
  ...
  private bool setUnitSkillRow()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Unit_Skill.gameObject);
      return num != 0;
    }
  ...
  private bool setLSSkill()
  {
    ...
    else
    {
      ...
      this.slc_LS_Skill_none[index].gameObject.transform.parent = (Transform) null;
      this.slc_LS_Skill_none[index].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_LS_Skill_have[index].gameObject);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_LS_Skill_none[index].gameObject);
    }
    return flag;
  }
  ...
  private bool setElementSkill()
  {
    ...
    if (!flag)
    {
      ...
      this.slc_LS_Skill_none[index1].gameObject.transform.parent = (Transform) null;
      this.slc_LS_Skill_none[index1].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_LS_Skill_have[index1].gameObject);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_LS_Skill_none[index1].gameObject);
    }
    return flag;
  }
  ...
  private bool setLSSkillRow()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_LS_Skill.gameObject);
      return num != 0;
    }
  ...
  private bool setDuelSkill()
  {
    ...
    for (int index = num; index < this.dir_Duel_Skill_have.Length; ++index)
    {
      ...
      this.slc_Duel_Skill_none[index].gameObject.transform.parent = (Transform) null;
      this.slc_Duel_Skill_none[index].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Duel_Skill_have[index].gameObject);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_Duel_Skill_none[index].gameObject);
    }
    return flag;
  }
  ...
  private bool setDuelSkillRow()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Duel_Skill.gameObject);
      return num != 0;
    }
  ...
  private bool setReleaseSkill()
  {
    ...
    if (!flag)
    {
      ...
      this.slc_Command_Skill_none[index].gameObject.transform.parent = (Transform) null;
      this.slc_Command_Skill_none[index].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Command_Skill_have[index].gameObject);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_Command_Skill_none[index].gameObject);
    }
    return flag;
  }
  ...
  private bool setCommandSkillRow()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Command_Skill.gameObject);
      return num != 0;
    }
  ...
  private bool setGrantSkill()
  {
    ...
    if (array.Length > this.dir_Grant_Skill_have.Length)
      this.slc_line_Grant_Skil.gameObject.SetActive(false);
    for (int index = num; index < this.dir_Grant_Skill_have.Length; ++index)
    {
      ...
      this.slc_Grant_Skill_none[index].gameObject.transform.parent = (Transform) null;
      this.slc_Grant_Skill_none[index].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Grant_Skill_have[index].gameObject);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_Grant_Skill_none[index].gameObject);
    }
    return flag;
  }
  ...
  private bool setGrantSkill02()
  {
    ...
    for (int index = num; index < this.dir_Grant_Skill_02_have.Length; ++index)
    {
      ...
      this.slc_Grant_Skill_02_none[index].gameObject.transform.parent = (Transform) null;
      this.slc_Grant_Skill_02_none[index].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Grant_Skill_02_have[index].gameObject);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_Grant_Skill_02_none[index].gameObject);
    }
    return flag;
  }
  ...
  private bool setGrantSkillRow()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Grant_Skill.gameObject);
      return num != 0;
    }
  ...
  private bool setGrantSkill02Row()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Grant_Skill_02.gameObject);
      return num != 0;
    }
  ...
  private bool setArmorSkill()
  {
    ...
    {
      for (int index2 = 0; index2 < equippedGear2.skills.Length && index1 < num; ++index2)
      {
        if (!this.setSkills.Contains(equippedGear2.skills[index2].skill.ID))
        {
          this.createBattleSkillIcon(this.dir_Armor_Skill_have[index1], equippedGear2.skills[index2]);
          ++index1;
          flag = true;
        }
      }
    ...
    {
      for (int index2 = 0; index2 < equippedGear3.skills.Length && index1 < num; ++index2)
      {
        if (!this.setSkills.Contains(equippedGear3.skills[index2].skill.ID))
        {
          this.createBattleSkillIcon(this.dir_Armor_Skill_have[index1], equippedGear3.skills[index2]);
          ++index1;
          flag = true;
        }
      }
    ...
    {
      this.dir_Armor_Skill_have[index2].gameObject.transform.parent = (Transform) null;
      this.dir_Armor_Skill_have[index2].gameObject.SetActive(false);
      this.slc_Armor_Skill_none[index2].gameObject.transform.parent = (Transform) null;
      this.slc_Armor_Skill_none[index2].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Armor_Skill_have[index2].gameObject);
      UnityEngine.Object.Destroy((UnityEngine.Object) this.slc_Armor_Skill_none[index2].gameObject);
    }
    return flag;
  }
  ...
  private bool setArmorSkillRow()
  {
    ...
    if (num == 0)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) this.dir_Armor_Skill.gameObject);
      return num != 0;
    }
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    if ((UnityEngine.Object) this.skillDialogChangePrefab != (UnityEngine.Object) null)
    {
    ...
    this.skillIconDepth = this.dir_Replacement_Skill.GetComponentInChildren<UISprite>().depth + 100;
    ...
    if ((UnityEngine.Object) this.bottomLineSpr != (UnityEngine.Object) null)
      this.bottomLineSpr.gameObject.SetActive(false);
    this.scrollGrid.Reposition();
    int num1 = this.scrollGrid.maxPerLine;
    if (num1 < 1)
      num1 = 1;
    int num2 = this.scrollGrid.transform.childCount;
    if (num2 > 7)
      num2 = 7;
  ...
  private void SetExtraSkillIconNoneSprite(UISprite spr, GameObject parent)
  {
    ...
    if (!((UnityEngine.Object) this.skillDialogChange != (UnityEngine.Object) null))
      return;
  ...
  {
    if ((UnityEngine.Object) this.battleManager == (UnityEngine.Object) null || this.battleManager.isSea)
      return;
    ...
    ((IEnumerable<UISprite>) this.slc_Unit_Skill_none).ForEach<UISprite>((System.Action<UISprite>) (f => f.spriteName = name));
    ((IEnumerable<UISprite>) this.slc_LS_Skill_none).ForEach<UISprite>((System.Action<UISprite>) (f => f.spriteName = name));
    ((IEnumerable<UISprite>) this.slc_Duel_Skill_none).ForEach<UISprite>((System.Action<UISprite>) (f => f.spriteName = name));
    ((IEnumerable<UISprite>) this.slc_Command_Skill_none).ForEach<UISprite>((System.Action<UISprite>) (f => f.spriteName = name));
    ((IEnumerable<UISprite>) this.slc_Grant_Skill_none).ForEach<UISprite>((System.Action<UISprite>) (f => f.spriteName = name));
  }
