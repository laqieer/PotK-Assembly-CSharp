...
public class BattleUI01UnitInformation : BackButtonPopupBase
{
  ...
  private GameObject createIcon(GameObject prefab, Transform trans)
  {
    ...
    componentInChildren1.depth = this.iconDepth_;
    return gameObject;
  }
  ...
  public void initializeWeapon(BattleUI01UnitInformation.WeaponRow row, GearGear gear)
  {
    ...
    row.button_.GetComponent<Collider>().enabled = false;
  }
  ...
  private string toRangeString(int min, int max) => string.Format("{0} - {1}", (object) min, (object) max);

  private UnityEngine.Sprite loadGearKindIcon(GearKindEnum kind) => GearKindIcon.LoadSprite(kind, CommonElement.none);

  private UnityEngine.Sprite loadElementIcon(CommonElement element) => this.elementTypeIconPrefab.GetComponent<CommonElementIcon>().getIcon(element);
  ...
  public void setPopupSkillParams(PopupSkillDetails.Param[] param) => this.popupSkillParams_ = param;

  public IEnumerator createAndSetEventBattleSkillIcon(
    GameObject parent,
  ...
  private IEnumerator createBattleSkillIcon(GameObject parent, BattleskillSkill skill)
  {
    ...
    icon.GetComponentInChildren<UI2DSprite>().depth = parent.transform.GetComponentInChildren<UI2DSprite>().depth;
    ...
    if (transformationGroupId.HasValue)
    {
      ...
      if (!(metamorphosisGroupId == valueOrDefault & nullable.HasValue))
      {
        ...
        icon.GetComponentInChildren<BattleSkillIcon>().iconSprite.color = Color.gray;
      }
    }
  }
  ...
  public IEnumerator LoadLSSkillIcon(GameObject parent, BattleskillSkill in_skill)
  {
    ...
    Future<UnityEngine.Sprite> spriteF = s.skill.LoadBattleSkillIcon(s);
  ...
  private void setIconEvent(GameObject obj, BattleskillSkill skill) => this.setEventPopupSkill(obj.GetComponentInChildren<UIButton>(), skill);

  private void setEventPopupSkill(UIButton btn, BattleskillSkill skill) => EventDelegate.Set(btn.onClick, (EventDelegate.Callback) (() => this.popupSkill(skill)));
  ...
  private void popupSkill(BattleskillSkill skill) => PopupSkillDetails.show(this.skillDialogPrefab, this.popupSkillParams_, ((IEnumerable<PopupSkillDetails.Param>) this.popupSkillParams_).FirstIndexOrNull<PopupSkillDetails.Param>((Func<PopupSkillDetails.Param, bool>) (x => x.skill == skill)).Value, this.pUnit_.playerUnit.is_enemy, isAutoClose: (!this.fromHistoryPanel_));

  private void popupSkill(BattleskillSkill skill, UnitParameter.SkillGroup group, int level) => PopupSkillDetails.show(this.skillDialogPrefab, new PopupSkillDetails.Param(skill, group, new int?(level)), this.pUnit_.playerUnit.is_enemy, isAutoClose: (!this.fromHistoryPanel_));
  ...
  {
    if (!((UnityEngine.Object) btn != (UnityEngine.Object) null))
      return;
  ...
  {
    if ((UnityEngine.Object) this.attackMethodParent == (UnityEngine.Object) null)
      return;
    if ((UnityEngine.Object) this.attackMethodDialog == (UnityEngine.Object) null)
  ...
  private IEnumerator initializeAsync(BL.Unit v)
  {
    ...
    main.setTopObject(main.gameObject);
    UIWidget w = main.GetComponent<UIWidget>();
    ...
    gearKindIconPrefabF = (Future<GameObject>) null;
    if ((UnityEngine.Object) main.attackMethodParent != (UnityEngine.Object) null)
    {
      ...
      main.attackClassIcon = main.gameObject.GetOrAddComponent<AttackClassIcon>();
      gearKindIconPrefabF = (Future<GameObject>) null;
    }
    ...
    if ((UnityEngine.Object) main.iconWeaponType_ != (UnityEngine.Object) null)
    ...
    int n1 = main.displayMaxHp_ ? battleParameter.Hp : v.hp;
    main.hpGauge.setValue(n1, hp, false);
    main.setText(main.txt_Hp, (object) n1);
    if ((UnityEngine.Object) main.txt_Hp_Enemy != (UnityEngine.Object) null)
      main.setText(main.txt_Hp_Enemy, (object) n1);
    main.setText(main.txt_Hpmax, "/" + (object) hp);
    if ((UnityEngine.Object) main.txt_Hpmax_Enemy != (UnityEngine.Object) null)
    ...
    string formalName = unitUnit1.getFormalName(metamor_id);
    ...
    if ((UnityEngine.Object) main.txt_Jobname_Enemy != (UnityEngine.Object) null)
    ...
    GearGear gear1 = (object) equippedGear != null ? equippedGear.gear : (GearGear) null;
    PlayerItem equippedReisou = pu.equippedReisou;
    GearGear reisou1 = (object) equippedReisou != null ? equippedReisou.gear : (GearGear) null;
    ...
    main.gearLayouts_[index].reset(gear1, element1, level1, reisou1, pu.unit.IsAllEquipUnit);
    if (gear1 == null)
    ...
    if (is_awake)
    {
      ...
      gear2 = (object) equippedGear2 != null ? equippedGear2.gear : (GearGear) null;
      PlayerItem equippedReisou2 = pu.equippedReisou2;
      reisou2 = (object) equippedReisou2 != null ? equippedReisou2.gear : (GearGear) null;
    }
    else
    {
      PlayerItem equippedGear3 = pu.equippedGear3;
      gear2 = (object) equippedGear3 != null ? equippedGear3.gear : (GearGear) null;
      PlayerItem equippedReisou3 = pu.equippedReisou3;
      reisou2 = (object) equippedReisou3 != null ? equippedReisou3.gear : (GearGear) null;
    }
    ...
    main.gearLayouts_[index].reset(gear2, element2, level2, reisou2, pu.unit.IsAllEquipUnit);
    bool awakeUnitFlag1 = pu.unit.awake_unit_flag;
    if (awakeUnitFlag1 && gear2 == null)
    {
      if (k2 == null)
    ...
    if (!is_awake)
    {
      gearGear1 = (GearGear) null;
    }
    else
    {
      PlayerItem equippedGear3 = pu.equippedGear3;
      gearGear1 = (object) equippedGear3 != null ? equippedGear3.gear : (GearGear) null;
    }
    GearGear gear3 = gearGear1;
    if (gear3 == null)
    {
    ...
    else
    {
      ...
      if (!is_awake)
      {
        gearGear2 = (GearGear) null;
      }
      else
      {
        PlayerItem equippedReisou3 = pu.equippedReisou3;
        gearGear2 = (object) equippedReisou3 != null ? equippedReisou3.gear : (GearGear) null;
      }
      GearGear reisou3 = gearGear2;
      ...
      if (gear3 != null)
      {
        ...
        if (gear3.elements != null && gear3.elements.Length != 0)
          element3 = gear3.elements[0].element;
      }
      else
        kind = (GearKind) null;
      main.gearLayouts_[index].reset(gear3, element3, level3, reisou3, pu.unit.IsAllEquipUnit);
      bool awakeUnitFlag2 = pu.unit.awake_unit_flag;
      if (awakeUnitFlag2 && gear3 == null)
      {
        if (kind == null)
    ...
    {
      int nextDepth = NGUITools.CalculateNextDepth(main.characterTransform.gameObject);
  ...
  private class GearLayout
  {
    ...
    public IEnumerator initAsync(bool displayEmpty = false, bool is_hide_proficiency = false)
    {
      ...
      else
      {
        ...
        foreach (Collider componentsInChild in this.gear_.GetComponentsInChildren<Collider>())
