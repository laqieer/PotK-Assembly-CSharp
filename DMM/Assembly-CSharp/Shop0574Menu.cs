...
public class Shop0574Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitSceneAsync()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.ListPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.ConfirmPopupPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.FinalConfirmPopupPrefab == (UnityEngine.Object) null)
    {
  ...
  public IEnumerator StartSceneAsync()
  {
    ...
    if ((UnityEngine.Object) earthDataManager != (UnityEngine.Object) null)
    ...
    foreach (EarthShopArticle article in list)
    {
      ...
      IEnumerator e = gameObject.GetComponent<Shop0574Scroll>().Init(article, new System.Action<EarthShopArticle, GameObject>(shop0574Menu.openConfirmPopup), new System.Action<EarthShopArticle>(shop0574Menu.openDetailPopup));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
    foreach (Component child in shop0574Menu.scroll.grid.transform.GetChildren())
  ...
  private void openDetailPopup(EarthShopArticle article) => this.StartCoroutine(this.openDetailPopupAsync(article));
  ...
  private void openConfirmPopup(EarthShopArticle article, GameObject thum)
  {
    ...
    prefab.GetComponent<Shop0574ConfirmPopup>().Init(article, thum, this.FinalConfirmPopupPrefab, new System.Action<EarthShopArticle, GameObject, int>(this.completeBuy));
