...
public class Unit004UnitTrainingListScene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(int playerUnitId)
  {
    ...
    if ((UnityEngine.Object) trainingListScene.unit004UnitTrainingListMenu == (UnityEngine.Object) null)
      trainingListScene.unit004UnitTrainingListMenu = trainingListScene.gameObject.GetComponent<Unit004UnitTrainingListMenu>();
  ...
  public static void changeScene(bool isStack) => Singleton<NGSceneManager>.GetInstance().changeScene(Unit004UnitTrainingListScene.DefaultName, isStack);
}
