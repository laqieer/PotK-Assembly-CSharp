...
public class Popup02349Menu : NGMenuBase
{
  ...
  public void SetText(string name, int point)
  {
    ...
    if (point > 0)
      ...
      this.TxtGetPoint.gameObject.SetActive(false);
  }
  ...
  private IEnumerator FriendApplyAsync()
  {
    ...
    else
    {
      ...
      Future<WebAPI.Response.FriendApply> future = WebAPI.FriendApply(popup02349Menu.target_friend_ids.ToArray(), new System.Action<WebAPI.Response.UserError>(popup02349Menu.\u003CFriendApplyAsync\u003Eb__18_0));
