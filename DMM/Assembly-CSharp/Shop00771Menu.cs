...
public class Shop00771Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(ShopItemIconInfo info, int selectCount, string shopTime)
  {
    if (info.playerShopArticle.icon_resource != "")
    {
      ...
      this.PackThum.gameObject.SetActive(true);
    ...
    else
    {
      ...
      this.PackThum.gameObject.SetActive(false);
  ...
  private void SetTxtDescriptionPayPrice(PlayerShopArticle psa)
  {
    ...
    else if (psa.article.pay_type == CommonPayType.tower_medal)
    {
      ...
      this.TxtDescription03.SetTextLocalize(Consts.Format(Consts.GetInstance().SHOP_007X_TXT_DESCRIPTION03_xMEDALxUNIT, (IDictionary) hashtable));
    }
  ...
  private void SetTxtDescriptionSumPrice(PlayerShopArticle psa)
  {
    ...
    else if (psa.article.pay_type == CommonPayType.tower_medal)
    {
      ...
      this.TxtDescription05.SetTextLocalize(Consts.Format(Consts.GetInstance().SHOP_007X_TXT_DESCRIPTION05_xMEDALxUNIT, (IDictionary) hashtable));
    }
    else if (psa.article.pay_type == CommonPayType.guild_medal)
      this.TxtDescription05.SetTextLocalize(Consts.Format(Consts.GetInstance().SHOP_007X_TXT_DESCRIPTION05_MEDAL, (IDictionary) new Hashtable()
      {
  ...
  private void SetTxtDescriptionBeforAfter(CommonPayType paytype)
  {
    switch (paytype)
    {
      ...
      case CommonPayType.tower_medal:
        ...
        this.NormalBeforeAfterPayValue.SetTextLocalize(Consts.Format(Consts.GetInstance().SHOP_00771_TXT_DESCRIPTION02_xMEDALxUNIT, (IDictionary) hashtable));
        this.Paid.SetActive(false);
        this.Normal.SetActive(true);
    ...
    if (this.Normal.activeSelf)
    {
      ...
      this.popupBaseSprite.SetDimensions(this.popupBaseSprite.width, 620);
    }
    else
    {
  ...
  private IEnumerator ShopBuy()
  {
    ...
    Future<WebAPI.Response.ShopBuy> shopInfoF = WebAPI.ShopBuy(this._itemId, this._purchasedQuantity, (System.Action<WebAPI.Response.UserError>) (error =>
    {
    ...
    if (shopBuyError != null)
      ModalWindow.Show(shopBuyError.Code, shopBuyError.Reason, (System.Action) (() => MypageScene.ChangeScene(MypageRootMenu.Mode.STORY)));
    else if (shopInfoF.Result != null)
    {
      ...
      else
      {
        ...
        ShopItemListMenu shopItemListMenu = UnityEngine.Object.FindObjectsOfType<ShopItemListMenu>()[0];
