...
public class BattleCameraController : BattleMonoBehaviour
{
  ...
  public bool isCameraMove => !((Object) this.lookAt == (Object) null) && this.lookAtTarget != this.lookAt.position;

  private void SetCamera()
  {
    if (!((Object) this.cCamera == (Object) null))
      return;
  ...
  protected override void Update_Battle()
  {
    ...
    {
      if ((Object) this.battleManager.battleCamera == (Object) null)
        return;
      this.initVariables();
    }
    if (this.isCameraMove)
    {
      ...
      if ((double) (this.lookAtTarget - this.lookAt.position).magnitude < 0.00999999977648258)
      {
  ...
  public void setMoveUnit(BL.Panel panel, float time)
  {
    ...
    if ((double) this.moveUnitTime < 0.0160000007599592)
