...
public class Guide0112UnitSortAndFilter : GuideSortAndFilter
{
  ...
  {
    foreach (Guide0112UnitSortAndFilterButton sortAndFilterButton in this.dir_fil1)
    ...
    foreach (Guide0112UnitSortAndFilterButton sortAndFilterButton in this.dir_fil2)
    ...
    foreach (Guide0112UnitSortAndFilterButton sortAndFilterButton in this.dir_fil3)
      this.GrayCheck<GuideSortAndFilter.GUIDE_CATEGORY_TYPE>(this.unitCategoryList, sortAndFilterButton.unitCategory, (SortAndFilterButton) sortAndFilterButton);
