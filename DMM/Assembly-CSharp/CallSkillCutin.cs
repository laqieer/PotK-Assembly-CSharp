...
public class CallSkillCutin : MonoBehaviour
{
  ...
  {
    if (!((Object) this.cutinObject == (Object) null))
    {
      ...
      {
        Future<UnityEngine.Sprite> fs = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(eventImageName);
        ...
        if ((Object) texture != (Object) null)
          this.cutinObject.materials[0].SetTexture("_MainTex", texture);
      }
    }
  }
}
