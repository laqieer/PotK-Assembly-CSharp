...
public class Startup00014Renzoku : Startup00014Menu
{
  ...
  protected UnityEngine.Sprite mainSprite;
  ...
  private void RewardReset()
  {
    ...
    foreach (UnityEngine.Object stamp in this.stampList)
      UnityEngine.Object.Destroy(stamp);
  }
  ...
  private void SceneEnd()
  {
    ...
    this.fade.gameObject.GetComponent<UIButton>().enabled = false;
  }
  ...
  protected void DestroyTrash()
  {
    foreach (Component stampFrame in this.stampFrameList)
      UnityEngine.Object.Destroy((UnityEngine.Object) stampFrame.gameObject);
    foreach (UnityEngine.Object stamp in this.stampList)
      UnityEngine.Object.Destroy(stamp);
    UnityEngine.Object.Destroy((UnityEngine.Object) this.getItem);
    UnityEngine.Object.Destroy((UnityEngine.Object) this.nextItem);
    UnityEngine.Object.Destroy((UnityEngine.Object) this.naviChara);
    this.itemList.Clear();
  ...
  protected virtual IEnumerator LoadResource()
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.naviChara = naviF.Result.Clone(this.charaContainer.transform);
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.mainSprite = spriteF.Result;
    Future<UnityEngine.Sprite> futureC = Res.GUI._009_3_sozai.mask_Chara_C.Load<UnityEngine.Sprite>();
    e = futureC.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.back.mainTexture = backF.Result;
    this.back.SetDimensions(this.back.mainTexture.width, this.back.mainTexture.height);
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.title.mainTexture = titleF.Result;
    this.title.SetDimensions(this.title.mainTexture.width, this.title.mainTexture.height);
  ...
  protected string LoadString(int number, string name) => string.Format("Prefabs/startup000_14/image/{0}/{1}", (object) number, (object) name);
  ...
  public override IEnumerator InitSceneAsync(PlayerLoginBonus lB)
  {
    ...
    startup00014Renzoku.gameObject.SetActive(true);
  ...
  {
    GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.loginAnime);
  ...
  private void SetStampFrame()
  {
    ...
    {
      Startup00014StampFrame component = this.stampFrame.Clone(this.listIcons[index].transform).GetComponent<Startup00014StampFrame>();
  ...
  protected void OldStamp()
  {
    ...
    {
      GameObject gameObject = this.finishStamp.Clone(this.listIcons[index].transform);
  ...
  {
    this.onStampSE();
    GameObject gameObject = this.todayStamp.Clone(this.listIcons[this.stampValue - 1].transform);
    gameObject.transform.localPosition = new Vector3(0.0f, 5f, 0.0f);
    this.stampList.Add(gameObject);
  }
}
