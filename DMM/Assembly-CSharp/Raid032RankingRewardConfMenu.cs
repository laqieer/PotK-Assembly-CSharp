...
public class Raid032RankingRewardConfMenu : BackButtonMenuBase
{
  ...
  private void ResetScrollObject(EventPointType type)
  {
    ...
    switch (this.listType)
    {
      case EventPointType.all:
        this.scrollContainerTop100.gameObject.SetActive(true);
      ...
      default:
        ...
        this.scrollContainerTop100.gameObject.SetActive(false);
  ...
  public IEnumerator Init(GuildRaid raid)
  {
    ...
    {
      this.scrollContainerTop100.Scroll.transform.Clear();
    ...
    {
      this.scrollContainerGuild.Scroll.transform.Clear();
