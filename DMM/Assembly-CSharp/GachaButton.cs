...
public class GachaButton : MonoBehaviour
{
    ...
    GachaModule gachaModule)
  {
    ...
    {
      if ((bool) (UnityEngine.Object) this.slc_GachaPTNeed)
        this.slc_GachaPTNeed.localPosition = this.yon_slc_GachaPTNeedPosition.localPosition;
      if ((bool) (UnityEngine.Object) this.dir_GachaPointUse)
    ...
    if (!(bool) (UnityEngine.Object) this.use_point_)
      return;
  ...
  public void SetMaxPlayNum(int max_play_nam)
  {
    ...
    if (!(bool) (UnityEngine.Object) this.play_num_)
      return;
  ...
  private void InitPlayGeneralGachaTicket(GachaModuleGacha gachaData, Gacha0063Menu menu)
  {
    ...
    menuPopup.Init(gachaData, (System.Action) (() => this.StartCoroutine(this.PlayTicket(menuPopup.currentPlayTime, gachaData, menu.gachaTicketSliderSelectPopupPrefab))));
  }
  ...
  public IEnumerator PlayTicket(
    int num,
    GachaModuleGacha gacha_data,
  ...
  {
    UIButton component = this.gameObject.GetComponent<UIButton>();
