...
public class Unit004ReincarnationPage : Unit004TrainingPage
{
  ...
  protected override IEnumerator loadResources()
  {
    ...
    if ((UnityEngine.Object) reincarnationPage.changeCntlPrefab_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) reincarnationPage.statusUpPrefab_ == (UnityEngine.Object) null)
    {
      prefabF = Res.Prefabs.unit004_9_9.dir_Uppt.Load<GameObject>();
      yield return (object) prefabF.Wait();
      reincarnationPage.statusUpPrefab_ = prefabF.Result;
    }
    if ((UnityEngine.Object) reincarnationPage.saveMemorySlotSelectPrefab_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) reincarnationPage.memorySlotOverwritePrefab_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) reincarnationPage.transPopupPrefab_ == (UnityEngine.Object) null)
    {
      prefabF = Res.Prefabs.popup.popup_004_13_1__anim_popup01.Load<GameObject>();
      yield return (object) prefabF.Wait();
      reincarnationPage.transPopupPrefab_ = prefabF.Result;
    }
    if ((UnityEngine.Object) reincarnationPage.recordPopupPrefab_ == (UnityEngine.Object) null)
    {
      prefabF = Res.Prefabs.popup.popup_004_13_1__anim_popup01.Load<GameObject>();
      yield return (object) prefabF.Wait();
  ...
  protected override bool isDisabledAfterUnitIconButton => this.errFlags_.IsOn(Unit004TrainingPage.ErrorFlag.Level);
  ...
  private IEnumerator Init()
  {
    ...
    else
    {
      ...
      if (Singleton<TutorialRoot>.GetInstance().IsTutorialFinish())
      {
        ...
        {
          Future<WebAPI.Response.UnitTransmigrateParameter> wapp = WebAPI.UnitTransmigrateParameter(reincarnationPage.baseUnit.id, reincarnationPage.transmigratePattern_.ID, (System.Action<WebAPI.Response.UserError>) (e =>
          {
  ...
  private void showTransmigrationPopup()
  {
    ...
    Singleton<PopupManager>.GetInstance().open(this.transPopupPrefab_).GetComponent<Popup004131Menu>().Init(new System.Action<bool>(this.onResultTransmigration));
  }

  private void showRecordTransmigrationPopup()
  {
    this.isActivePopup_ = true;
    Singleton<PopupManager>.GetInstance().open(this.recordPopupPrefab_).GetComponent<Popup004131Menu>().Init(new System.Action<bool>(this.onResultRecord), true);
  }
  ...
  private IEnumerator doTransmigration(bool isRecod)
  {
    ...
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      Future<WebAPI.Response.UnitTransmigrate> paramF = WebAPI.UnitTransmigrate(reincarnationPage.baseUnit.id, isRecod, reincarnationPage.materialMaterialUnitIds_.ToArray(), reincarnationPage.materialUnitIds_.ToArray(), reincarnationPage.baseUnit.unit.TransmigratePattern.ID, (System.Action<WebAPI.Response.UserError>) (error =>
      {
      ...
      if (paramF.Result != null)
      {
        ...
        {
          UnitIcon componentInChildren = lnkTransUnit.GetComponent<UI2DSprite>().GetComponentInChildren<UnitIcon>();
  ...
  {
    this.transBtn_.gameObject.SetActive(true);
    this.recordBtn_.gameObject.SetActive(false);
  ...
  {
    this.transBtn_.gameObject.SetActive(false);
    this.recordBtn_.gameObject.SetActive(true);
  ...
  {
    Unit004ReincarnationPage reincarnationPage = this;
    if ((UnityEngine.Object) reincarnationPage.afterUnit_ == (UnityEngine.Object) null)
    {
      ...
      reincarnationPage.reincarnationChangeCtrl_.SetAction(new System.Action(reincarnationPage.DrawTransButton), new System.Action(reincarnationPage.DrawRecordButton));
    ...
    if (reincarnationPage.recordPlayerUnit_ != (PlayerUnit) null)
    {
      ...
      {
        reincarnationPage.afterUnit_.gameObject.SetActive(true);
        reincarnationPage.recordUnit_.gameObject.SetActive(true);
      ...
      {
        reincarnationPage.recordUnit_.gameObject.SetActive(true);
        reincarnationPage.afterUnit_.gameObject.SetActive(false);
    ...
    else
    {
      reincarnationPage.reincarnationChangeCtrl_.SetActiveChangeButton(false);
      reincarnationPage.afterUnit_.gameObject.SetActive(true);
      reincarnationPage.recordUnit_.gameObject.SetActive(false);
      reincarnationPage.DrawTransButton();
      reincarnationPage.reincarnationChangeCtrl_.AfterFront();
    }
    ...
    foreach (GameObject gameObject in objects)
    {
      ...
      if (index < cnt)
      {
        ...
        if (icon.unit.IsMaterialUnit)
        {
          ...
          num = ((IEnumerable<PlayerUnit>) playerUnitArray).Count<PlayerUnit>((Func<PlayerUnit, bool>) (x => icon.Unit.ID == x._unit));
        ...
        icon.onClick = new System.Action<UnitIconBase>(reincarnationPage.\u003CdoInitTransmigrationUnits\u003Eb__63_1);
  ...
  private void setEnabledBottomButtons(int money)
  {
    ...
    this.transBtn_.isEnabled = !this.errFlags_.Any();
    this.recordBtn_.isEnabled = this.recordPlayerUnit_ != (PlayerUnit) null && this.errFlags_.IsOff(Unit004TrainingPage.ErrorFlag.Money | Unit004TrainingPage.ErrorFlag.Material | Unit004TrainingPage.ErrorFlag.Favorite);
    this.ibtn_Save_Memory_.isEnabled = this.baseUnit.level == this.baseUnit.max_level;
  }
  ...
  public void IbtnRecord()
  {
    ...
    {
      if ((UnityEngine.Object) this.memorySlotOverwritePrefab_ == (UnityEngine.Object) null)
        return;
      Singleton<PopupManager>.GetInstance().open(this.memorySlotOverwritePrefab_).GetComponent<Unit00499SaveMemoryOverwrite>().Initialize(this.baseUnit, new System.Action(this.recordEndUpdate));
    }
    else
    {
      if ((UnityEngine.Object) this.saveMemorySlotSelectPrefab_ == (UnityEngine.Object) null)
        return;
      this.StartCoroutine(Singleton<PopupManager>.GetInstance().open(this.saveMemorySlotSelectPrefab_).GetComponent<Unit00499SaveMemorySlotSelect>().Initialize(this.baseUnit, new System.Action(this.recordEndUpdate)));
    }
  }
  ...
  private IEnumerator IbtnRecordTransAsync()
  {
    ...
    if (reincarnationPage.baseUnit.is_memory_over)
      ModalWindow.ShowYesNo(Consts.GetInstance().MEMORY_LOAD_ALERT_TITLE, Consts.GetInstance().MEMORY_LOAD_ALERT_DESCRIPTION, new System.Action(reincarnationPage.showRecordTransmigrationPopup), (System.Action) (() => {}));
    else
