...
{
  [SerializeField]
  private Color EnableColor = (Color) new Color32((byte) 128, (byte) 128, (byte) 128, byte.MaxValue);
  [SerializeField]
  private Color DisableColor = (Color) new Color32((byte) 64, (byte) 64, (byte) 64, byte.MaxValue);
  [Space(8f)]
  [SerializeField]
  ...
  public void InitializeEmpty()
  {
    ...
    this.mDayLbl.gameObject.SetActive(false);
    this.mIconBase.color = this.DisableColor;
  }
  ...
  public void SetGetMark(bool isGotten)
  {
    ...
    if ((Object) icon.GetComponent<UnitIcon>() != (Object) null)
      icon.GetComponent<UnitIcon>().Gray = isGotten;
    else if ((Object) icon.GetComponent<ItemIcon>() != (Object) null)
      icon.GetComponent<ItemIcon>().Gray = isGotten;
    else if ((Object) icon.GetComponent<UniqueIcons>() != (Object) null)
    ...
    if (isGotten)
    {
      ...
      this.mIconBase.color = this.EnableColor;
  }
