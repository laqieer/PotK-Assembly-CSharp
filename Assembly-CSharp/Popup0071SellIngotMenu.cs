...
public class Popup0071SellIngotMenu : BackButtonMenuBase
{
  ...
  private System.Action requestSell_;

  public int[] targetIds => this.targetIds_;

  public static IEnumerator show(
    System.Action<bool> actionEnd,
    System.Action<WebAPI.Response.UserError> actionWebError = null,
    System.Action actionReload = null)
  {
    ...
    PlayerMaterialGear[] hasItems = (playerMaterialGearArray != null ? ((IEnumerable<PlayerMaterialGear>) playerMaterialGearArray).Where<PlayerMaterialGear>((Func<PlayerMaterialGear, bool>) (x => x.isExchangable() && x.quantity > 0 && targets.Contains(x.gear_id))).ToArray<PlayerMaterialGear>() : (PlayerMaterialGear[]) null) ?? new PlayerMaterialGear[0];
    if (hasItems.Length != 0)
    {
      ...
      if (exchanges.Length != 0)
      {
        ...
        yield return (object) go.GetComponent<Popup0071SellIngotMenu>().initialize(exchanges, (System.Action) (() => bSell = true));
  ...
  private IEnumerator initialize(
    KeyValuePair<PlayerMaterialGear, long>[] items,
    System.Action requestSell)
  {
    Popup0071SellIngotMenu popup0071SellIngotMenu = this;
    popup0071SellIngotMenu.GetComponent<UIWidget>().alpha = 0.0f;
  ...
  private IEnumerator initItem(
    GameObject prefab,
    PlayerMaterialGear item,
    long amount,
    int index)
  {
    GameObject go = prefab.Clone(this.gridItemIcons_.transform);
