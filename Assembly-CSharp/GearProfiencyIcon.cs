...
public class GearProfiencyIcon : IconPrefabBase
{
  ...
  public void Init(int level, bool bHyphen = false)
  {
    ...
    this.iconSprite.sprite2D = Resources.Load<UnityEngine.Sprite>(string.Format("Icons/Materials/{0}GearProficiency/dyn_Rankicon_{1}", Singleton<NGGameDataManager>.GetInstance().IsSea ? (object) "Sea/" : (object) "", (object) GearProfiencyIcon.IconName[level]));
  }
