...
public class Unit0044ReisouMenu : Bugu005SelectItemListMenuBase
{
  ...
  public override IEnumerator Init()
  {
    ...
    if ((UnityEngine.Object) unit0044ReisouMenu.SortPopupPrefab == (UnityEngine.Object) null)
    {
      ...
      e = (IEnumerator) null;
      unit0044ReisouMenu.SortPopupPrefab = SortPopupPrefabF.Result;
      SortPopupPrefabF = (Future<GameObject>) null;
    }
    unit0044ReisouMenu.SortPopupPrefab.GetComponent<ReisouSortAndFilter>().Initialize((Bugu005ItemListMenuBase) unit0044ReisouMenu);
    unit0044ReisouMenu.isInitSortPrefab = true;
    // ISSUE: reference to a compiler-generated method
    yield return (object) unit0044ReisouMenu.\u003C\u003En__0();
  }
  ...
  protected override IEnumerator InitExtension()
  {
    ...
    unit0044ReisouMenu.removeReisouCallback = new System.Action(unit0044ReisouMenu.cbRemoveReisou);
    return false;
  }
  ...
  protected override void BottomInfoUpdate() => this.TxtNumberpossession.SetTextLocalize(string.Format("{0}/{1}", (object) ((IEnumerable<PlayerItem>) (this.EditParam?.reisous ?? SMManager.Get<PlayerItem[]>())).Count<PlayerItem>((Func<PlayerItem, bool>) (x => x.isReisou())), (object) SMManager.Get<Player>().max_reisou_items));
  ...
  protected override void CreateItemIconAdvencedSetting(int inventoryItemIdx, int allItemIdx)
  {
    ...
    else
    {
      ...
      itemIcon.SetupIconsBlink();
      itemIcon.onClick = !this.IsGrayIcon(displayItem) ? (System.Action<ItemIcon>) (playeritem => this.SelectItemProc(playeritem.ItemInfo)) : (this.EditParam != null ? (System.Action<ItemIcon>) (playeritem =>
      {
      ...
      }) : (System.Action<ItemIcon>) (playeritem =>
      {
        if (this.gearInfo.reisou != (PlayerItem) null && this.gearInfo.reisou.id == playeritem.ItemInfo.itemID)
          return;
    ...
    GameCore.ItemInfo currWeapon)
  {
    Unit0044ReisouMenu unit0044ReisouMenu = this;
    IEnumerator e;
    if ((UnityEngine.Object) unit0044ReisouMenu.reisouRemovePopupPrefab == (UnityEngine.Object) null)
    {
  ...
  protected override bool DisableTouchIcon(InventoryItem item) => item.Item == null || item.Item.ForBattle;
...
label_19:
        ...
        case GuildUtil.GvGPopupState.AtkTeam:
          // ISSUE: reference to a compiler-generated method
          e = GuildUtil.UpdateGuildDeckAttack(PlayerAffiliation.Current.guild_id, Player.Current.id, new System.Action(unit0044ReisouMenu.\u003CcallEquipReisouAPI\u003Eb__30_1));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
          break;
        case GuildUtil.GvGPopupState.DefTeam:
          // ISSUE: reference to a compiler-generated method
          e = GuildUtil.UpdateGuildDeckDefanse(PlayerAffiliation.Current.guild_id, Player.Current.id, new System.Action(unit0044ReisouMenu.\u003CcallEquipReisouAPI\u003Eb__30_2));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
          break;
