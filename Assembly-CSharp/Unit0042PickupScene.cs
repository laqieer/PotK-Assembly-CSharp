...
public class Unit0042PickupScene : NGSceneBase
{
  ...
  public static void changeScene(bool bStack, string gacha_name, GachaModuleGacha gacha) => Singleton<NGSceneManager>.GetInstance().changeScene(Unit0042PickupScene.defName, (bStack ? 1 : 0) != 0, (object) gacha_name, (object) gacha);

  public static void changeScene(bool bStack, int unitID) => Singleton<NGSceneManager>.GetInstance().changeScene(Unit0042PickupScene.defName, (bStack ? 1 : 0) != 0, (object) unitID);
  ...
  public IEnumerator onStartSceneAsync(string gacha_name, GachaModuleGacha gacha)
  {
    ...
    {
      Future<WebAPI.Response.GachaGetPickupUnitMaxStatus> wapi = WebAPI.GachaGetPickupUnitMaxStatus(gacha.id, gacha_name, (System.Action<WebAPI.Response.UserError>) (error => WebAPI.DefaultUserErrorCallback(error)));
  ...
  private IEnumerator commonStartSceneAsync(
    Dictionary<UnitTypeEnum, PlayerUnit>[] dicUnits)
  {
  ...
  public void onStartScene(string gacha_name, GachaModuleGacha gacha) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
  ...
  public void onBackScene(string gacha_name, GachaModuleGacha gacha) => this.onStartScene(gacha_name, gacha);
