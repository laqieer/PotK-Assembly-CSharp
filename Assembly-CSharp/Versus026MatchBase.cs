...
public class Versus026MatchBase : BackButtonMenuBase
{
    ...
    WebAPI.Response.PvpBoot pvpInfo)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) this.uiCenter != (UnityEngine.Object) null)
    {
      int countWait = 0;
      while (!this.uiCenter.gameObject.activeInHierarchy)
      {
        ++countWait;
  ...
  protected bool[] getUnitRegulation()
  {
    ...
    bool[] flagArray = new bool[playerUnits.Length];
    for (int index = 0; index < playerUnits.Length; ++index)
      flagArray[index] = func(playerUnits[index]);
    return flagArray;
  }
  ...
  private void changeSceneCustomDeckEdit() => EditCustomDeckScene.changeScene(true, bSetFromScene: true);
  ...
  protected void SetMatchButton()
  {
    ...
    {
      this.btnBreakRepair.gameObject,
      this.btnStartMatch.gameObject,
      this.objButtonDeckEdit
    };
    bool[] flagArray;
    if ((UnityEngine.Object) this.objButtonDeckEdit != (UnityEngine.Object) null)
    {
  ...
  private void setStatusBoards()
  {
    ...
    else
    {
      ...
      UIScrollView inParents = NGUITools.FindInParents<UIScrollView>(this.uiCenter.gameObject);
      if ((UnityEngine.Object) inParents != (UnityEngine.Object) null)
        inParents.enabled = flag;
      if (flag)
        this.uiCenter.onFinished = new SpringPanel.OnFinished(this.onChangedStatusBoard);
      else
  ...
  private void onChangedStatusBoard()
  {
    ...
    this.currentStatusBoard = ((IEnumerable<Versus026MatchBase.StatusBoard>) this.statusBoards).Select<Versus026MatchBase.StatusBoard, GameObject>((Func<Versus026MatchBase.StatusBoard, GameObject>) (x => x.top)).FirstIndexOrNull<GameObject>((Func<GameObject, bool>) (y => (UnityEngine.Object) y == (UnityEngine.Object) go)) ?? this.currentStatusBoard;
  }
  ...
  private void setCenterStatusBoard(int firstIndex = -1)
  {
    ...
    if (flag)
    {
      ...
      while ((UnityEngine.Object) (transform = transform.parent) != (UnityEngine.Object) null)
      {
        UIScrollView component = transform.GetComponent<UIScrollView>();
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        {
          component.DisableSpring();
          Vector2 vector2 = new Vector2(-x, transform.localPosition.y);
  ...
  private Bonus[] bonusArray => this.pvpInfo.bonus.IsNullOrEmpty<Bonus>() ? (Bonus[]) null : ((IEnumerable<Bonus>) this.pvpInfo.bonus).Where<Bonus>((Func<Bonus, bool>) (x => x.category != 12)).ToArray<Bonus>();
  ...
  private void setBonusDisplay(Bonus[] bonus, UILabel ulDetail, UILabel ulTimeLimit) => new BonusDisplay().Set(bonus, ulDetail, ulTimeLimit, false, true);
  ...
  private PlayerUnit GetLeaderUnit(DeckInfo deck) => ((IEnumerable<PlayerUnit>) deck.player_units).FirstOrDefault<PlayerUnit>();
          ...
          else
          {
            ...
            else if (mF.Exception != null)
            {
              ...
              if (mF.Exception.ToString().IndexOf("timeout") != -1 || mF.Exception.ToString().IndexOf("UN-Matched") != -1)
                versus026MatchBase.PopupMatchingServerConnectError(new System.Action(versus026MatchBase.CancelBattle), instance.VERSUS_002645POPUP_TITLE, instance.VERSUS_002645POPUP_DESCRIPTION);
              else if (mF.Exception.ToString().IndexOf("Connect Failed") != -1)
              {
                ...
                versus026MatchBase.PopupMatchingServerConnectError(new System.Action(versus026MatchBase.CancelBattle), instance.VERSUS_002645POPUP_TITLE, description);
              }
  ...
  private IEnumerator prepareToStartPvP(System.Action successCallback)
  {
    ...
    if (rF.Exception != null)
    {
      ...
      else if (rF.Exception.ToString().IndexOf("Create Room Request Error") != -1)
      {
        ...
        versus026MatchBase.PopupCreateRoomError(new System.Action(versus026MatchBase.CancelBattle), instance.VERSUS_002645POPUP_TITLE, description);
        // ISSUE: reference to a compiler-generated method
  ...
  private IEnumerator prepareToStartPvNpc(System.Action successCallback)
  {
    ...
    Singleton<CommonRoot>.GetInstance().loadingMode = 2;
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.PvpPlayerNpcStart> startF = WebAPI.PvpPlayerNpcStart(versus026MatchBase.deckInfo.deck_number, versus026MatchBase.deckInfo.deck_type_id, (int) versus026MatchBase.type, new System.Action<WebAPI.Response.UserError>(versus026MatchBase.\u003CprepareToStartPvNpc\u003Eb__66_0));
  ...
  private IEnumerator GetEnemyInfo(string id, System.Action<WebAPI.Response.PvpFriend> callback)
  {
    Versus026MatchBase versus026MatchBase = this;
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.PvpFriend> f = WebAPI.PvpFriend(id, new System.Action<WebAPI.Response.UserError>(versus026MatchBase.\u003CGetEnemyInfo\u003Eb__69_0));
  ...
  private IEnumerator PopupConfirmationMatching()
  {
    ...
    else
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      Singleton<PopupManager>.GetInstance().open(popupF.Result).GetComponent<Popup02641Menu>().Initialize(new System.Action(versus026MatchBase.StartMatch), new System.Action(versus026MatchBase.CancelBattle));
    }
  }
  ...
  private void PopupMatchingServerConnectError(System.Action OkAction, string title, string description)
  {
    if (!this.isMatched)
      return;
    Singleton<PopupManager>.GetInstance().closeAll();
  ...
  private void PopupCreateRoomError(System.Action OkAction, string title, string description)
  {
    if (!this.isMatched)
      return;
    Singleton<PopupManager>.GetInstance().closeAll();
    Consts.GetInstance();
    ModalWindow.Show(title, description, (System.Action) (() =>
    {
      OkAction();
      this.isCancel = true;
    }));
  ...
  private IEnumerator PopupConnectMatching(System.Action<GameObject> obj)
  {
    ...
    // ISSUE: reference to a compiler-generated method
    gameObject.GetComponent<Popup02642SerchMatching>().Init(new System.Action(versus026MatchBase.\u003CPopupConnectMatching\u003Eb__80_0));
    if (obj != null)
      obj(gameObject);
  }
  ...
  private IEnumerator PopupFindMatching()
  {
    ...
    e = (IEnumerator) null;
    // ISSUE: reference to a compiler-generated method
    yield return (object) Singleton<PopupManager>.GetInstance().open(prefabF.Result).GetComponent<Popup02646Menu>().Init(new System.Action(versus026MatchBase.OkFriendMatch), new System.Action(versus026MatchBase.CancelFriendMatch), new System.Action(versus026MatchBase.\u003CPopupFindMatching\u003Eb__81_0), Singleton<PVPManager>.GetInstance().enemyInfo);
  }
