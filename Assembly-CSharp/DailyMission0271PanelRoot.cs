...
public class DailyMission0271PanelRoot : MonoBehaviour
{
    ...
    GameObject prefab)
  {
    ...
    DailyMission0271Panel script = prefab.CloneAndGetComponent<DailyMission0271Panel>(mission0271PanelRoot.gameObject);
    IEnumerator e = script.Init(mission0271PanelRoot.viewModel);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    mission0271PanelRoot.panel = script.gameObject;
  ...
  private IEnumerator clearMission()
  {
    ...
    Future<WebAPI.Response.BingoReceiveReward> receiveF = WebAPI.BingoReceiveReward(mission0271PanelRoot.playerBingoPanel.bingo_id, mission0271PanelRoot.playerBingoPanel.panel_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    if (r != null)
    {
      ...
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
      GameObject breakPanelAnimation = breakPanelF.Result.Clone(mission0271PanelRoot.transform.parent.gameObject.transform);
      ...
      if ((UnityEngine.Object) sm != (UnityEngine.Object) null)
        sm.playSE("SE_0580");
      Singleton<CommonRoot>.GetInstance().GetNormalHeaderComponent().GetComponentInChildren<CommonHeaderExp>().SetIsButtonEnable(false);
      ...
      while (!DailyMission0271PanelRoot.isAnimationEnd)
        yield return (object) new WaitForSeconds(0.3f);
      UnityEngine.Object.Destroy((UnityEngine.Object) breakPanelAnimation);
      ...
      if ((UnityEngine.Object) prefab.GetComponent<UIWidget>() != (UnityEngine.Object) null)
        prefab.GetComponent<UIWidget>().alpha = 0.0f;
      ...
      Singleton<CommonRoot>.GetInstance().GetNormalHeaderComponent().GetComponentInChildren<CommonHeaderExp>().SetIsButtonEnable(true);
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) mission0271PanelRoot.panel);
    }
  }
  ...
  public class DailyMissionView
  {
    ...
    public MasterDataTable.BingoRewardGroup[] rewards => ((IEnumerable<MasterDataTable.BingoRewardGroup>) MasterData.BingoRewardGroupList).Where<MasterDataTable.BingoRewardGroup>((Func<MasterDataTable.BingoRewardGroup, bool>) (x => x.reward_group_id == this.reward_id)).ToArray<MasterDataTable.BingoRewardGroup>();
