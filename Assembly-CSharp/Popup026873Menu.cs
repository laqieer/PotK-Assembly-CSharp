...
public class Popup026873Menu : Popup02610Base
{
  ...
  private IEnumerator TicketRecovery()
  {
    ...
    Future<WebAPI.Response.ShopBuy> paramF = WebAPI.ShopBuy(10000006, 1, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
    ...
    if (paramF.Result != null)
    {
      ...
      ModalWindow.Show(instance.VERSUS_0026873POPUP_TITLE, instance.VERSUS_0026873POPUP_RECOVERY_DESCRIPTION, new System.Action(popup026873Menu.\u003CTicketRecovery\u003Eb__9_1));
    }
  }
