...
public class Guild0282Menu : BackButtonMenuBase
{
  ...
  public bool IsOpposedPlayer(string player_id) => ((IEnumerable<string>) this.opposed_player_ids).Any<string>((Func<string, bool>) (x => x == player_id));
  ...
  public IEnumerator InitializeAsync(bool guildBattleResult = false, bool fromBattle = false)
  {
    ...
    if (!this.isFailedInit)
    {
      ...
      this.isCloud = false;
      if ((UnityEngine.Object) this.cloudAnimParent != (UnityEngine.Object) null)
  ...
  private IEnumerator GBResultAnimation(GuildMembership member, int captureStar)
  {
    ...
    if ((UnityEngine.Object) ene == (UnityEngine.Object) null)
    {
    ...
    {
      Vector3 pos1 = guild0282menu.CalcGuildMapPosition(ene.transform.parent.localPosition, guild0282menu.sightPattern[0].MapScale);
      ...
      if (captureStar > 0)
      {
        Guild0282MemberBase memberBase = guild0282menu.guildMemberBasePrefabForGBResult.CloneAndGetComponent<Guild0282MemberBase>(ene.transform);
        memberBase.Initialize(member, guild0282menu, guild0282menu.memberImageCache, true, guild0282menu.MyGuild.gvg_status);
        Singleton<PopupManager>.GetInstance().open(memberBase.gameObject, isCloned: true);
      ...
      Vector3 pos2 = guild0282menu.CalcGuildMapPosition(ene.transform.parent.localPosition, guild0282menu.sightPattern[guild0282menu.sightUseNumber].MapScale);
  ...
  public void MemberBaseUpdate()
  {
    foreach (GuildMembership membership in this.MyGuild.memberships)
    {
      ...
      if ((UnityEngine.Object) guild0282MemberBase != (UnityEngine.Object) null)
  ...
  {
    if (trans.name == "cloud(Clone)")
      UnityEngine.Object.Destroy((UnityEngine.Object) trans.gameObject);
    foreach (Transform child in trans.GetChildren())
    ...
    else
    {
      switch (this.MyGuild.gvg_status)
      {
        ...
        case GvgStatus.can_entry:
          ...
          this.entryButton.gameObject.SetActive(false);
          this.entryButton.gameObject.SetActive(true);
          this.entryButton.isEnabled = true;
          TweenColor component1 = this.entryButton.GetComponent<TweenColor>();
        ...
        case GvgStatus.matching:
          ...
          this.entryButton.isEnabled = true;
          TweenColor component2 = this.entryButton.GetComponent<TweenColor>();
  ...
  public void JumpGuildBase()
  {
    ...
    if (this.MyGuild.gvg_status == GvgStatus.fighting)
      this.Focus(this.CalcGuildMapPosition(this.EnGuildUI.guildBase.transform.parent.localPosition, mapScale), mapScale, "");
    else
      this.Focus(this.CalcGuildMapPosition(this.MyGuildUI.guildBase.transform.parent.localPosition, mapScale), mapScale, "");
  }
  ...
  public void JumpMember(GuildMembership member)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) guild0282MemberBase1 != (UnityEngine.Object) null)
      {
        this.Focus(this.CalcGuildMapPosition(guild0282MemberBase1.transform.parent.localPosition, this.sightPattern[0].MapScale), this.sightPattern[0].MapScale, "OpenMyMemberBaseMenu");
      }
      else
      {
        ...
        if (!((UnityEngine.Object) guild0282MemberBase2 != (UnityEngine.Object) null))
          return;
        this.Focus(this.CalcGuildMapPosition(guild0282MemberBase2.transform.parent.localPosition, this.sightPattern[0].MapScale), this.sightPattern[0].MapScale, "OpenEnMemberBaseMenu");
      }
    }
  }
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) guild0282Menu.myGuildMemberMenuPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guild0282Menu.myGuildBaseMenuPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guild0282Menu.enGuildMemberMenuPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guild0282Menu.enGuildBaseMenuPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guild0282Menu.guildMemberBasePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guild0282Menu.guildBasePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guild0282Menu.cloudPrefab == (UnityEngine.Object) null)
    {
    ...
    while (!guild0282Menu.myGuildMemberMenuPrefab.IsInitialize || !guild0282Menu.myGuildBaseMenuPrefab.IsInitialize || (!guild0282Menu.enGuildMemberMenuPrefab.IsInitialize || !guild0282Menu.enGuildMemberMenuPrefab.IsInitialize))
      yield return (object) null;
    if ((UnityEngine.Object) guild0282Menu.guildDefTeamPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guild0282Menu.guildAtkTeamPopup == (UnityEngine.Object) null)
    {
    ...
    bool isEnemy)
  {
    ...
    guildMapUI.guildBase.GetComponent<BoxCollider>().enabled = true;
    guildMapUI.guildBase.Initialize(guildData, this, guildImageCache, isEnemy);
    float num = guildData.memberships.Length < 10 ? 1f : (float) guildMapUI.memberBasePosition.Count / (float) guildData.memberships.Length;
    float f = 0.0f;
    for (int index = 0; index < guildData.memberships.Length; ++index)
    {
      Guild0282MemberBase component = this.guildMemberBasePrefab.Clone(guildMapUI.memberBasePosition[Mathf.FloorToInt(f)].transform).GetComponent<Guild0282MemberBase>();
    ...
    bool isEnemy)
  {
    ...
    foreach (GuildMembership guildMembership in (IEnumerable<GuildMembership>) ((IEnumerable<GuildMembership>) guildData.memberships).Where<GuildMembership>((Func<GuildMembership, bool>) (x => x.role != GuildRole.master && x.role != GuildRole.sub_master)).OrderByDescending<GuildMembership, int>((Func<GuildMembership, int>) (x => x.contribution)))
      guildMembershipList.Add(guildMembership);
    guildData.memberships = guildMembershipList.ToArray();
    if ((UnityEngine.Object) guildMapUI.guildBase != (UnityEngine.Object) null)
  ...
  private IEnumerator ShowMyMemberList()
  {
    ...
    IEnumerator e = component.Initialize(false, menu, menu.myGuildBaseMenuPrefab, menu.guildMemberPopup, menu.MyGuild, new System.Action(menu.\u003CShowMyMemberList\u003Eb__132_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator ShowEnMemberList()
  {
    ...
    popup.SetActive(false);
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = component.Initialize(true, menu, menu.myGuildBaseMenuPrefab, menu.guildMemberPopup, menu.EnGuild, new System.Action(menu.\u003CShowEnMemberList\u003Eb__133_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    popup.SetActive(true);
  ...
  {
    this.CloseLingMenu();
    Vector3 newPos = new Vector3(this.guildMap.transform.localPosition.x, this.guildMap.transform.localPosition.y);
    Vector3 vector3_1 = new Vector3(this.scrollView.transform.localPosition.x, this.scrollView.transform.localPosition.y);
    Vector3 vector3_2 = new Vector3(this.guildMap.transform.localScale.x, this.guildMap.transform.localScale.y);
    ++this.sightUseNumber;
    if (this.sightPattern.Count <= this.sightUseNumber)
      this.sightUseNumber = 0;
    Vector3 vector3_3 = new Vector3(this.sightPattern[this.sightUseNumber].MapScale.x, this.sightPattern[this.sightUseNumber].MapScale.y);
    newPos = new Vector3((newPos.x + vector3_1.x) / vector3_2.x * vector3_3.x - vector3_1.x, (newPos.y + vector3_1.y) / vector3_2.y * vector3_3.y - vector3_1.y);
    this.SetSightPattern(this.sightUseNumber);
  ...
  {
    base.Update();
    Vector3 vector3_1 = new Vector3(this.guildMap.transform.localPosition.x, this.guildMap.transform.localPosition.y);
    Vector3 vector3_2 = new Vector3(this.scrollView.transform.localPosition.x, this.scrollView.transform.localPosition.y);
    vector3_1 = new Vector3(vector3_1.x + vector3_2.x, vector3_1.y + vector3_2.y);
  ...
  {
    if (this.isTouchBlock || this.IsLingMenu() && !this.DoLingMenuDismiss() || (UnityEngine.Object) this.guildMap.GetComponent<iTween>() != (UnityEngine.Object) null)
      return;
    this.selectGuildData = guild;
    Vector3 pos = this.CalcGuildMapPosition(data.transform.parent.localPosition, this.sightPattern[0].MapScale);
    if (data.IsEnemy)
  ...
  public void Focus(Vector3 pos, Vector3 scale, string functionName)
  {
    if (!string.IsNullOrEmpty(functionName))
      this.gameObject.SendMessage(functionName);
  ...
  private void OnOpenMenu()
  {
    ...
    ((IEnumerable<UITweener>) this.dir_player_situation.gameObject.GetComponents<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x => x.PlayReverse()));
    ((IEnumerable<UITweener>) this.dir_battle_ready.GetComponents<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x => x.PlayReverse()));
  ...
  {
    this.OnOpenMenu();
    this.myGuildBaseMenuPrefab.GetComponent<Guild0282GuildBaseMenu>().Initialize(this.selectGuildData, this.guildInfoPopup, this.guildMemberPopup, this);
  ...
  {
    this.OnOpenMenu();
    this.myGuildMemberMenuPrefab.GetComponent<Guild0282MemberBaseMenu>().Initialize(this.selectMemberData, this.guildMemberPopup, this, false, this.MyGuild.gvg_status);
  ...
  {
    this.OnOpenMenu();
    this.enGuildBaseMenuPrefab.GetComponent<Guild0282GuildBaseMenu>().Initialize(this.selectGuildData, this.guildInfoPopup, this.guildMemberPopup, this);
  ...
  {
    this.OnOpenMenu();
    this.enGuildMemberMenuPrefab.GetComponent<Guild0282MemberBaseMenu>().Initialize(this.selectMemberData, this.guildMemberPopup, this, true, this.MyGuild.gvg_status);
  ...
  {
    bool flag = false;
    if (this.enGuildMemberMenuPrefab.gameObject.activeSelf)
      flag = this.enGuildMemberMenuPrefab.PlayTween(false);
    if (this.enGuildBaseMenuPrefab.gameObject.activeSelf)
      flag = this.enGuildBaseMenuPrefab.PlayTween(false);
    if (this.myGuildMemberMenuPrefab.gameObject.activeSelf)
      flag = this.myGuildMemberMenuPrefab.PlayTween(false);
    if (this.myGuildBaseMenuPrefab.gameObject.activeSelf)
      flag = this.myGuildBaseMenuPrefab.PlayTween(false);
    ((IEnumerable<UITweener>) this.dir_battle_ready.GetComponents<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x => x.PlayForward()));
    ((IEnumerable<UITweener>) this.dir_player_situation.gameObject.GetComponents<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x => x.PlayForward()));
    this.ibtn_Back.GetComponent<NGTweenParts>().isActive = true;
    return flag;
  }

  private bool IsLingMenu() => this.enGuildMemberMenuPrefab.gameObject.activeSelf || this.enGuildBaseMenuPrefab.gameObject.activeSelf || this.myGuildMemberMenuPrefab.gameObject.activeSelf || this.myGuildBaseMenuPrefab.gameObject.activeSelf;

  public bool DoLingMenuDismiss()
  {
    if (!this.IsLingMenu() || (UnityEngine.Object) this.scrollView.GetComponent<iTween>() != (UnityEngine.Object) null || !this.CloseLingMenu())
      return false;
    ...
    if (this.sightUseNumber != 0)
    {
      Vector3 newPos = new Vector3(this.guildMap.transform.localPosition.x, this.guildMap.transform.localPosition.y);
      Vector3 vector3_1 = new Vector3(this.scrollView.transform.localPosition.x, this.scrollView.transform.localPosition.y);
      Vector3 vector3_2 = new Vector3(this.sightPattern[0].MapScale.x, this.sightPattern[0].MapScale.y);
      Vector3 vector3_3 = new Vector3(this.sightPattern[this.sightUseNumber].MapScale.x, this.sightPattern[this.sightUseNumber].MapScale.y);
      newPos = new Vector3((newPos.x + vector3_1.x) / vector3_2.x * vector3_3.x - vector3_1.x, (newPos.y + vector3_1.y) / vector3_2.y * vector3_3.y - vector3_1.y);
  ...
  {
    if ((bool) (UnityEngine.Object) ui.guildBase)
      UnityEngine.Object.Destroy((UnityEngine.Object) ui.guildBase.gameObject);
    if (ui.memberBaseList != null)
    {
      ui.memberBaseList.ForEach((System.Action<Guild0282MemberBase>) (x => UnityEngine.Object.Destroy((UnityEngine.Object) x.gameObject)));
  ...
  {
    if ((bool) (UnityEngine.Object) target.GetComponent<TweenPosition>())
    {
      if (!forced)
        return false;
      UnityEngine.Object.Destroy((UnityEngine.Object) target.GetComponent<TweenPosition>());
    }
  ...
  private bool SetTweenScale(
    ...
    System.Action action = null)
  {
    if ((bool) (UnityEngine.Object) target.GetComponent<TweenScale>())
    {
      if (!forced)
        return false;
      UnityEngine.Object.Destroy((UnityEngine.Object) target.GetComponent<TweenScale>());
    }
  ...
  private Vector3 CalcGuildMapPosition(Vector3 pos, Vector3 scale) => new Vector3(-pos.x * scale.x - this.scrollView.transform.localPosition.x, -pos.y * scale.y - this.scrollView.transform.localPosition.y);
  ...
  {
    if ((UnityEngine.Object) org == (UnityEngine.Object) null)
      return;
    this.blackBg.SetActive(true);
    if (this.gvgPopup.Count > 0 && !isStack)
    {
      for (int index = 0; index < this.gvgPopup.Count; ++index)
        UnityEngine.Object.Destroy((UnityEngine.Object) this.gvgPopup.Pop().popup);
      this.gvgPopup.Clear();
    }
    ...
    {
      gvgPopup.popup = org;
      if ((UnityEngine.Object) org.transform.parent == (UnityEngine.Object) null)
  ...
  public void closePopup()
  {
    ...
    this._actionForGvgPopup = this.gvgPopup.Count > 0 ? this.gvgPopup.Peek().action : (System.Action) null;
  ...
  public IEnumerator waitForTweenFinish(
    GvgPopup popup,
    NGTweenParts tween,
    bool clearPush = true)
  {
    ...
    UnityEngine.Object.Destroy((UnityEngine.Object) popup.popup);
  ...
  private IEnumerator showAtkTeamPopup()
  {
    ...
    if (nullable.HasValue)
    {
      ...
      bool success = false;
      IEnumerator e = component.InitializeAsync(false, menu, menu.MyGuild.memberships[nullable.Value], (System.Action) (() => success = true));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      if (success)
      {
        ...
        UnityEngine.Object.Destroy((UnityEngine.Object) popup);
    }
  }
  ...
  private IEnumerator Aggregating()
  {
    ...
    if (!guild0282Menu.isAggregatingPopup)
    {
      ...
      while (guild0282Menu.isBattleResultAnimation)
        yield return (object) null;
      // ISSUE: reference to a compiler-generated method
      ModalWindow.Show(Consts.GetInstance().GUILD_BATTLE_RESULT_NOWAGGREGATING_TITLE, Consts.GetInstance().GUILD_BATTLE_RESULT_NOWAGGREGATING_MESSAGE, new System.Action(guild0282Menu.\u003CAggregating\u003Eb__180_0));
    }
  }

  private bool IsEnemy() => GuildUtil.isBattleOrPreparing(this.MyGuild.gvg_status) && this.EnGuild != null;
  ...
  private void AdvantageEffect()
  {
    ...
    int myStar = 0;
    int enStar = 0;
    ((IEnumerable<GuildMembership>) this.MyGuild.memberships).ForEach<GuildMembership>((System.Action<GuildMembership>) (x => myStar += x.own_star));
    ((IEnumerable<GuildMembership>) this.EnGuild.memberships).ForEach<GuildMembership>((System.Action<GuildMembership>) (x => enStar += x.own_star));
    int num = myStar - enStar;
    if (num >= 6)
    {
      this.AdvantageList.ForEach((System.Action<GameObject>) (x => x.SetActive(true)));
      this.DisAdvantageList.ForEach((System.Action<GameObject>) (x => x.SetActive(false)));
    }
    else if (num <= -6)
    {
      this.AdvantageList.ForEach((System.Action<GameObject>) (x => x.SetActive(false)));
      this.DisAdvantageList.ForEach((System.Action<GameObject>) (x => x.SetActive(true)));
    }
    else
    {
      this.AdvantageList.ForEach((System.Action<GameObject>) (x => x.SetActive(false)));
