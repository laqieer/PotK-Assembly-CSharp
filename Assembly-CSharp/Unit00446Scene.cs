...
public class Unit00446Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, GearGear targetgear) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_4_6", (stack ? 1 : 0) != 0, (object) targetgear);
