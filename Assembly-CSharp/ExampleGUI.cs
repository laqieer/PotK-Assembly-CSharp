...
public class ExampleGUI : MonoBehaviour
{
  ...
  {
    if (this.showPopUp)
      UnityEngine.GUI.Window(0, new Rect((float) (Screen.width / 2 - 150), (float) (Screen.height / 2 - 65), 300f, 130f), new UnityEngine.GUI.WindowFunction(this.ShowGUI), "Is SDK enabled?");
    int height = Screen.height;
    if (UnityEngine.GUI.Button(new Rect(0.0f, (float) (0 / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), this.txtManualLaunch) && !string.Equals(this.txtManualLaunch, "SDK Launched", StringComparison.OrdinalIgnoreCase))
    {
      AdjustConfig adjustConfig = new AdjustConfig("2fm9gkqubvpc", AdjustEnvironment.Sandbox);
      adjustConfig.setLogLevel(AdjustLogLevel.Verbose);
      adjustConfig.setLogDelegate((System.Action<string>) (msg => Debug.Log((object) msg)));
      adjustConfig.setEventSuccessDelegate(new System.Action<AdjustEventSuccess>(this.EventSuccessCallback));
      adjustConfig.setEventFailureDelegate(new System.Action<AdjustEventFailure>(this.EventFailureCallback));
      adjustConfig.setSessionSuccessDelegate(new System.Action<AdjustSessionSuccess>(this.SessionSuccessCallback));
      adjustConfig.setSessionFailureDelegate(new System.Action<AdjustSessionFailure>(this.SessionFailureCallback));
      adjustConfig.setDeferredDeeplinkDelegate(new System.Action<string>(this.DeferredDeeplinkCallback));
      adjustConfig.setAttributionChangedDelegate(new System.Action<AdjustAttribution>(this.AttributionChangedCallback));
      Adjust.start(adjustConfig);
      this.isEnabled = true;
      this.txtManualLaunch = "SDK Launched";
    }
    if (UnityEngine.GUI.Button(new Rect(0.0f, (float) (Screen.height / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), "Track Simple Event"))
      Adjust.trackEvent(new AdjustEvent("g3mfiw"));
    if (UnityEngine.GUI.Button(new Rect(0.0f, (float) (Screen.height * 2 / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), "Track Revenue Event"))
    {
      AdjustEvent adjustEvent = new AdjustEvent("a4fd35");
      adjustEvent.setRevenue(0.25, "EUR");
      Adjust.trackEvent(adjustEvent);
    }
    if (UnityEngine.GUI.Button(new Rect(0.0f, (float) (Screen.height * 3 / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), "Track Callback Event"))
    {
    ...
    if (UnityEngine.GUI.Button(new Rect(0.0f, (float) (Screen.height * 4 / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), "Track Partner Event"))
    {
    ...
    if (UnityEngine.GUI.Button(new Rect(0.0f, (float) (Screen.height * 5 / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), this.txtSetOfflineMode))
    {
    ...
    if (UnityEngine.GUI.Button(new Rect(0.0f, (float) (Screen.height * 6 / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), this.txtSetEnabled))
    {
    ...
    if (!UnityEngine.GUI.Button(new Rect(0.0f, (float) (Screen.height * 7 / this.numberOfButtons), (float) Screen.width, (float) (Screen.height / this.numberOfButtons)), "Is SDK Enabled?"))
      return;
  ...
  {
    if (this.isEnabled)
      UnityEngine.GUI.Label(new Rect(65f, 40f, 200f, 30f), "Adjust SDK is ENABLED!");
    else
      UnityEngine.GUI.Label(new Rect(65f, 40f, 200f, 30f), "Adjust SDK is DISABLED!");
    if (!UnityEngine.GUI.Button(new Rect(90f, 75f, 120f, 40f), "OK"))
      return;
    this.showPopUp = false;
  }

  public void HandleGooglePlayId(string adId) => Debug.Log((object) ("Google Play Ad ID = " + adId));
