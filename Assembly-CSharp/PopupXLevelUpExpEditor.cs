...
public class PopupXLevelUpExpEditor : VolumeEditor
{
  ...
  public static Future<GameObject> createLoader() => new ResourceObject("Prefabs/unit004_2/dir_vscroll_ExpItem").Load<GameObject>();
    ...
    PlayerMaterialUnit item)
  {
    ...
    xlevelUpExpEditor.txtExp_.color = popup.isBoostExp ? Color.yellow : Color.white;
