...
public class BattleUnitController : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    battleUnitController.inputObserver = battleUnitController.GetComponent<BattleInputObserver>();
    return false;
  }
  ...
  protected override void LateUpdate_Battle()
  {
    ...
    if (!flag)
      return;
    this.btm.setScheduleAction((System.Action) (() => this.cameraController.setLookAtTarget(panel)));
  }

  public bool CanMoveUnit(BL.UnitPosition up) => !this.env.core.isAutoBattle.value && up.unit.isPlayerControl && !up.isCompleted && this.env.core.currentPhaseUnitp(up);

  public bool isMoveUnit(GameObject o)
  {
    BL.Unit unit = this.env.core.unitCurrent.unit;
    return this.battleManager.isBattleEnable && unit != (BL.Unit) null && ((UnityEngine.Object) this.env.unitResource[unit].gameObject == (UnityEngine.Object) o && !this.env.core.isCompleted(unit)) && this.env.core.currentPhaseUnitp(unit) && !unit.IsDontMove;
  }
}
