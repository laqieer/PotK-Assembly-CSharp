...
public class MovieLibraryPlayer : MonoBehaviour
{
  ...
  public void AttachStoryQuestMovie(int id) => this.StartCoroutine(this.Play(this.GetQuestMoviePaht(id)));
  ...
  private void Show()
  {
    ...
    Singleton<CommonRoot>.GetInstance().getBackgroundComponent<Transform>().gameObject.SetActive(true);
