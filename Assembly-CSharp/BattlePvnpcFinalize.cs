  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    if (battlePvnpcFinalize.pvnpcManager.isResult)
    {
      ...
      while (true)
      {
        ...
        System.Action<WebAPI.Response.UserError> userErrorCallback = (System.Action<WebAPI.Response.UserError>) (e => errorCode = e.Code);
...
label_23:
      ...
      ModalWindow.Show(Consts.GetInstance().PVP_NO_RESULT_ERROR_POPUP_TITLE, Consts.GetInstance().PVP_NO_RESULT_ERROR_POPUP_MESSAGE, new System.Action(battlePvnpcFinalize.\u003CStart_Battle\u003Eb__3_0));
    ...
    {
      Future<WebAPI.Response.PvpNpcForceClose> futureF = WebAPI.PvpNpcForceClose(true, new System.Action<WebAPI.Response.UserError>(battlePvnpcFinalize.errorCallback));
      e1 = futureF.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
  ...
  {
    IEnumerator e1 = WebAPI.PvpNpcForceClose(false, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e))).Wait();
    while (e1.MoveNext())
      yield return e1.Current;
    e1 = (IEnumerator) null;
    NGSceneManager instance = Singleton<NGSceneManager>.GetInstance();
