...
public class AttackClassIcon : IconPrefabBase
{
  ...
  private UI2DSprite sprite => this.GetComponent<UI2DSprite>();
  ...
  private class SpriteCache
  {
    ...
    private Dictionary<string, UnityEngine.Sprite> dicSprite_ = new Dictionary<string, UnityEngine.Sprite>();
      ...
      CommonElement element = CommonElement.none)
    {
      ...
      if (this.dicSprite_.TryGetValue(key, out sprite1))
        return sprite1;
      UnityEngine.Sprite sprite2 = this.loadSprite(attackClass, element);
      this.dicSprite_.Add(key, sprite2);
      return sprite2;
    }

    private UnityEngine.Sprite loadSprite(
      GearAttackClassification attackClass,
      CommonElement element)
    {
      string path = this.toSpritePath(attackClass, element);
      if (path == null)
      {
