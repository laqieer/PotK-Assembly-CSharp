...
public class Guide0114Menu : GuideZukanListManager
{
  ...
  public override int ResourceID(GuideUnitUnit unit) => unit.Gear.resource_reference_gear_id_GearGear;

  public override Future<UnityEngine.Sprite> ResourceSprite(GuideUnitUnit unit) => unit.Gear.LoadSpriteThumbnail();

  public override int HistroyNumber(GuideUnitUnit unit) => unit.Gear.history_group_number;

  public override DateTime? PublishedTime(GuideUnitUnit unit) => new DateTime?(unit.Gear.published_at);
  ...
  public override void SortAndFilter()
  {
    ...
    ((IEnumerable<GearGear>) MasterData.GearGearList).ForEach<GearGear>((System.Action<GearGear>) (obj =>
    {
