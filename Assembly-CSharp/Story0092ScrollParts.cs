...
public class Story0092ScrollParts : MonoBehaviour
{
    ...
    int XL)
  {
    ...
    ((IEnumerable<PlayerStoryQuestS>) SMManager.Get<PlayerStoryQuestS[]>().S(quest.quest_story_s.quest_xl.ID, quest.quest_story_s.quest_l.ID, quest.quest_story_s.quest_m.ID)).OrderBy<PlayerStoryQuestS, int>((Func<PlayerStoryQuestS, int>) (x => x.quest_story_s.ID)).ForEach<PlayerStoryQuestS>((System.Action<PlayerStoryQuestS>) (q =>
    {
