...
public class Sea030GiftDetailsScrollContainer : MonoBehaviour
{
  ...
  public IEnumerator InitScrollList(GearGear item)
  {
    ...
    menu.Scroll = menu.GetComponent<NGxScrollMasonry>();
    menu.Scroll.Scroll.transform.Clear();
    menu.Scroll.Reset();
    menu.Scroll.Scroll.gameObject.SetActive(false);
    ...
    menu.Scroll.Scroll.gameObject.SetActive(true);
    ...
    int line_num)
  {
    ...
    {
      Transform child = menu.Scroll.Scroll.transform.GetChild(child_line_num);
    ...
    if (column_num == 0)
    {
      ...
      menu.Scroll.Scroll.transform.GetChild(child_line_num).gameObject.SetActive(false);
      menu.Scroll.Scroll.transform.GetChild(child_line_num).gameObject.SetActive(true);
    ...
    else
    {
      ...
      menu.Scroll.Scroll.transform.GetChild(child_line_num + 1).gameObject.SetActive(false);
      menu.Scroll.Scroll.transform.GetChild(child_line_num).gameObject.SetActive(true);
      menu.Scroll.Scroll.transform.GetChild(child_line_num + 1).gameObject.SetActive(true);
