...
public class Gacha00611Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(
    ...
    int addReisouJewel)
  {
    IEnumerator e = this.onStartSceneAsync(NewFlag, countWeapon, TargetData, (GameCore.ItemInfo) null, (PlayerItem) null, (PlayerItem) null, (System.Action) null, false, addReisouJewel);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  public void onStartScene(bool NewFlag, GameCore.ItemInfo TargetData) => Singleton<PopupManager>.GetInstance().closeAll();

  public void onStartScene(bool NewFlag, int countWeapon, GameCore.ItemInfo TargetData, int addReisouJewel) => Singleton<PopupManager>.GetInstance().closeAll();
