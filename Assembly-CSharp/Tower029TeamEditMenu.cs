...
public class Tower029TeamEditMenu : UnitSelectMenuBase
{
  ...
  {
    if ((UnityEngine.Object) this.comfirmPopup == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator ShowComfirmPopup()
  {
    ...
    IEnumerator e = popup.GetComponent<TowerTeamEditComfirmPopup>().InitializeAsync(tower029TeamEditMenu.selectedUnitIcons.OrderBy<UnitIconInfo, int>((Func<UnitIconInfo, int>) (x => x.select)).ToList<UnitIconInfo>(), tower029TeamEditMenu.unitPrefab, tower029TeamEditMenu.goHpGauge, new System.Action(tower029TeamEditMenu.\u003CShowComfirmPopup\u003Eb__11_1));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  {
    target.gray = bGray;
    if (!((UnityEngine.Object) target.icon != (UnityEngine.Object) null))
      return;
    target.icon.Gray = bGray;
  }

  private TowerDeckUnit CreateTowerDeckUnit(int player_unit_id, int position_id) => new TowerDeckUnit()
  {
  ...
  {
    if (unit_index >= this.allUnitIcons.Count || (UnityEngine.Object) this.allUnitIcons[unit_index] == (UnityEngine.Object) null)
      return;
    ...
    if ((UnityEngine.Object) allUnitIcon.HpGauge == (UnityEngine.Object) null)
      return;
  ...
  public IEnumerator InitializeAsync(TowerProgress progress)
  {
    ...
    else
    {
      ...
      tower029TeamEditMenu.InitializeInfo((IEnumerable<PlayerUnit>) tower029TeamEditMenu.playerUnits, (IEnumerable<PlayerMaterialUnit>) null, Persist.tower029UnitListSortAndFilter, false, false, true, true, true, new System.Action(tower029TeamEditMenu.InitializeAllUnitInfosExtend));
  ...
  public override void UpdateInfomation() => this.TxtNumber.SetTextLocalize(string.Format("{0}/{1}", (object) this.selectedUnitIcons.Count, (object) this.SelectMax));
  ...
  public new void IbtnClearS()
  {
    ...
    {
      if ((UnityEngine.Object) allUnitIcon != (UnityEngine.Object) null && allUnitIcon.PlayerUnit != (PlayerUnit) null)
      {
        ...
        if (allUnitIcon.Button.enabled && flag)
          allUnitIcon.Gray = this.checkGrayStatus(allUnitIcon.PlayerUnit);
      }
    }
    this.allUnitInfos.ForEach((System.Action<UnitIconInfo>) (v => v.select = -1));
    this.displayUnitInfos.ForEach((System.Action<UnitIconInfo>) (v => v.select = -1));
    this.selectedUnitIcons.Clear();
  ...
  protected override IEnumerator CreateUnitIconBase(GameObject prefab)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) tower029TeamEditMenu.goHpGauge == (UnityEngine.Object) null)
    {
