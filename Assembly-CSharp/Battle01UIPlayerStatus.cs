...
public class Battle01UIPlayerStatus : NGBattleMenuBase
{
  ...
  private bool isSea => !this.isSea_.HasValue ? (this.isSea_ = new bool?(this.battleManager.isSea)).Value : this.isSea_.Value;

  private bool isEarth => !this.isEarth_.HasValue ? (this.isEarth_ = new bool?(this.battleManager.isEarth)).Value : this.isEarth_.Value;
  ...
  private string pathPlayerStatusPrefab => "Prefabs/battleUI_03/" + (this.env.core.battleInfo.isEarthMode ? "Battle030627_UI_PlayerStatus" : "Battle030627_UI_PlayerStatus_2");
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    e = (IEnumerator) null;
    this.unitIcon = f.Result.CloneAndGetComponent<UnitIcon>(this.character.gameObject.transform);
    NGUITools.AdjustDepth(this.unitIcon.gameObject, this.character.depth);
    this.unitIcon.SetBasedOnHeight(this.character.height);
    ...
    {
      if (!((UnityEngine.Object) this.weaponsIcons[index] == (UnityEngine.Object) null))
      {
        this.gearIcons[index] = result.CloneAndGetComponent<GearKindIcon>(this.weaponsIcons[index].gameObject.transform);
        NGUITools.AdjustDepth(this.gearIcons[index].gameObject, this.weaponsIcons[index].depth);
        this.gearIcons[index].SetBasedOnHeight(this.weaponsIcons[index].height);
      }
    }
    ...
    if (this.isEarth)
    {
      ...
      if ((UnityEngine.Object) this.JobAbilityDialogRoot != (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) component1 != (UnityEngine.Object) null)
          component1.depth += (UnityEngine.Object) component2 != (UnityEngine.Object) null ? component2.depth + 1 : 30;
  ...
  protected override void LateUpdate_Battle()
  {
    ...
    if (flag1 | flag2 | flag3 | flag4)
    {
      ...
      foreach (UIWidget componentsInChild in this.gameObject.GetComponentsInChildren<UIWidget>(true))
      {
        if ((UnityEngine.Object) componentsInChild.GetComponent<UIButton>() == (UnityEngine.Object) null && (double) componentsInChild.alpha == 0.0)
    ...
    if ((UnityEngine.Object) this.txt_Hp_Large != (UnityEngine.Object) null)
  ...
  private void UpdateUnitBaseInfo()
  {
    ...
    if (this.slcCountry != null)
    {
      if (unit2.country_attribute.HasValue)
      {
        ...
        {
          this.slcCountry[index].gameObject.SetActive(true);
      ...
      else
      {
        for (int index = 0; index < this.slcCountry.Length; ++index)
        {
          ...
          this.slcCountry[index].gameObject.SetActive(false);
        }
      }
    }
    if (!((UnityEngine.Object) this.iconAttackClass != (UnityEngine.Object) null))
      return;
    ...
    if (equippedGearOrInitial != null)
    {
      ...
      this.iconAttackClass.gameObject.SetActive(true);
    }
    else
      this.iconAttackClass.gameObject.SetActive(false);
  }
  ...
  private void UpdateAlimentsIcons()
  {
    ...
    foreach (Component ailmentsIcon in this.ailmentsIcons)
      UnityEngine.Object.Destroy((UnityEngine.Object) ailmentsIcon.gameObject);
    this.ailmentsIcons.Clear();
    foreach (UnityEngine.Object groupIcon in this.groupIcons)
      UnityEngine.Object.Destroy(groupIcon);
    ...
    foreach (BattleFuncs.InvestSkill investSkill in BattleFuncs.getInvestSkills(this.env.core.getUnitPosition(unit)))
    {
      ...
      component.transform.position = this.ailmentsPos[index2].gameObject.transform.position;
      component.transform.localScale = this.ailmentsPos[index2].gameObject.transform.localScale;
      component.SetDepth(this.dirAilments.GetComponent<UIWidget>().depth - 1);
  ...
  {
    this.groupIcons.Add(this.groupSkillsIconPrefab.Clone(this.dirAilments.gameObject.transform));
  ...
  public void setUnit(BL.Unit unit)
  {
    ...
    if ((UnityEngine.Object) this.txt_Hp_Large != (UnityEngine.Object) null)
    {
      ...
      {
        this.txt_Hp_Large.gameObject.SetActive(true);
        this.txt_Hp.gameObject.SetActive(false);
        this.txt_Hpmax.gameObject.SetActive(false);
      }
      else
      {
        this.txt_Hp_Large.gameObject.SetActive(false);
        this.txt_Hp.gameObject.SetActive(true);
        this.txt_Hpmax.gameObject.SetActive(true);
      }
    }
  ...
  private void setColordTextChangeSea(UILabel label, int v, int bd, string before_string = "")
  {
    ...
    if (bd > 0)
      ...
      label.color = this.isSea ? this.mSeaOrigin : this.mOrigin;
  }
  ...
  {
    if ((UnityEngine.Object) this.dirSkillList == (UnityEngine.Object) null)
      return;
  ...
  private void createBattleSkillIcon(GameObject parent, BattleskillSkill skill)
  {
    ...
    componentInChildren.iconSprite.color = Color.gray;
  }
  ...
  private void onButtonIcon(BattleskillSkill skill)
  {
    ...
    BL.BattleModified<BL.Unit> modified = this.modified;
    PlayerUnit playerUnit1;
    if (modified == null)
    {
      playerUnit1 = (PlayerUnit) null;
    }
    else
    {
      BL.Unit unit = modified.value;
      playerUnit1 = (object) unit != null ? unit.playerUnit : (PlayerUnit) null;
    }
    PlayerUnit playerUnit2 = playerUnit1;
    if (!nullable.HasValue || playerUnit2 == (PlayerUnit) null)
      return;
    PopupSkillDetails.show(this.skillDialogPrefab, this.skillParams_, nullable.Value, playerUnit2.is_enemy, isAutoClose: true);
  }
  ...
  private void onButtonJobAbilityOld(BattleskillSkill skill, int level)
  {
    ...
    if (!((UnityEngine.Object) this.jobAbilityDialog != (UnityEngine.Object) null))
      return;
    this.jobAbilityDialog.gameObject.SetActive(true);
