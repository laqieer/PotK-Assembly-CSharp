...
namespace GameCore
{
  public static class EnumerableExtension
  {
    ...
    public static string Join(this IEnumerable<string> self, string separator) => string.Join(separator, self.ToArray<string>());
    ...
    public static string ToStringForChars(this IEnumerable<char> str) => new string(str.ToArray<char>());
    ...
    public static IEnumerable<T> Shuffle<T>(this IEnumerable<T> self) => self.Shuffle<T>(new Random());
