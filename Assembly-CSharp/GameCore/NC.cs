...
namespace GameCore
{
  ...
  {
    private static GameGlobalVariable<System.Random> r = GameGlobalVariable<System.Random>.New();
    ...
    public static int Lot(int[] weights, System.Random r)
    {
    ...
    public static float Clampf(float min, float max, float val) => Mathf.Min(max, Mathf.Max(min, val));
