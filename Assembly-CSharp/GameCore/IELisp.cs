  ...
  public class IELisp
  {
    ...
    public static Cons nthCons(int idx, Cons l)
    {
      switch (idx)
      {
        ...
        case 2:
          return l.cdr is Cons cdr ? cdr.cdr as Cons : (Cons) null;
        case 3:
          return l.cdr is Cons cdr && cdr.cdr is Cons cdr ? cdr.cdr as Cons : (Cons) null;
        case 4:
          return l.cdr is Cons cdr && cdr.cdr is Cons cdr && cdr.cdr is Cons cdr ? cdr.cdr as Cons : (Cons) null;
        default:
