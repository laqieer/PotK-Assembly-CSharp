...
namespace GameCore
{
  public static class BattleFuncs
  {
    ...
    public static AttackStatus selectCounterAttackStatus(AttackStatus[] attacks) => attacks.Length == 0 ? (AttackStatus) null : ((IEnumerable<AttackStatus>) attacks).Where<AttackStatus>((Func<AttackStatus, bool>) (x => x.magicBullet == null || x.magicBullet.isAttack)).OrderBy<AttackStatus, int>((Func<AttackStatus, int>) (x => x.magicBullet != null ? x.magicBullet.cost : 0)).ThenByDescending<AttackStatus, int>((Func<AttackStatus, int>) (x =>
    {
    ...
    public static bool isCounterAttack(
      ...
      bool isAI)
    {
      return (uint) BattleFuncs.getAttackStatusArray(defense, defensePanel, defenseNeighbors, attack, attackPanel, attackNeighbors, defenseHp, false, false, isAI: isAI, makeEmptyArray: true).Length > 0U;
    }
...
label_50:
      ...
      if (ret.isHit)
      {
        ...
        System.Action<BattleskillEffectLogicEnum> action2 = (System.Action<BattleskillEffectLogicEnum>) (logic =>
        {
          ...
          {
            int num2 = x.effect.GetInt(BattleskillEffectLogicArgumentEnum.attack_phase);
            bool flag = invokedAmbush ? !isAttacker : isAttacker;
            switch (num2)
            {
              case 0:
        ...
        foreach (IGrouping<int, BattleFuncs.SkillParam> grouping in BattleFuncs.gearSkillParamFilter(skillParams1).GroupBy<BattleFuncs.SkillParam, int>((Func<BattleFuncs.SkillParam, int>) (x => x.effect.effectId)))
        {
          ...
          foreach (BattleFuncs.SkillParam skillParam in (IEnumerable<BattleFuncs.SkillParam>) grouping)
          {
            ...
            if (BattleFuncs.isInvoke(invoke, target, attackerUnitParameter, defenderUnitParameter, invokeAS, targetAS, baseSkillLevel, (float) num9, random1, false, invokeHp, targetHp, colosseumTurn1, invokeRate1))
            {
              ...
              else
              {
                if (!nullable8.HasValue)
                {
                  ...
                  nullable8 = new Decimal?(!packedSkillEffect.HasKey(BattleskillEffectLogicArgumentEnum.max_percentage) ? Decimal.MaxValue : (Decimal) packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.max_percentage));
                }
                Decimal num11 = num8;
        ...
        if ((baseDuelSkill.attackerSkills.Length >= 1 ? 1 : (ret.duelSkillProc.attackerSkills.Length >= 1 ? 1 : 0)) != 0)
        {
          ...
          num7 *= BattleFuncs.calcSkillParamMul(skillParams2);
        }
                ...
                if (BattleFuncs.isInvoke(effectUnit, targetUnit, invokeParameter, targetParameter, invokeAS, targetAS, effect.baseSkillLevel, effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage_invocation), random, false, effectHp, targetHp, colosseumTurn, base_invocation: effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.base_invocation), invocation_skill_ratio: effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.invocation_skill_ratio), invocation_luck_ratio: effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.invocation_luck_ratio)))
                {
                  ...
                  else
                  {
                    if (!nullable8.HasValue)
                    {
                      ...
                      nullable8 = new Decimal?((double) num10 == 0.0 ? Decimal.MaxValue : (Decimal) num10);
                    }
                    Decimal num11 = num8;
                    Decimal? nullable9 = nullable8;
                    Decimal valueOrDefault = nullable9.GetValueOrDefault();
        ...
        float num13 = Judgement.CalcMaximumFloatValue(((Decimal) Mathf.Max(1f, attackStatus.originalAttackExcludeBaseDamage) + (Decimal) ret.duelSkillProc.additionalDamage + (Decimal) baseDuelSkill.additionalDamage) * (Decimal) num7 * num12);
        if ((double) num13 < 1.0)
          num13 = 1f;
        float num14 = Judgement.CalcMaximumFloatValue((Decimal) num13 + (Decimal) attackStatus.duelParameter.BaseDamage);
        ...
        if ((double) num15 >= 1.0)
        {
          ...
          if (array.Any<BL.SkillEffect>())
          {
            foreach (BL.SkillEffect skillEffect in (IEnumerable<BL.SkillEffect>) array.OrderByDescending<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (x => BattleFuncs.getShieldRemain(x, defense))).ThenBy<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (x => x.effectId)))
            {
              ...
              int num9 = num8 + (int) num15;
              if (num9 > shieldHp)
              {
                num15 = (float) (num9 - shieldHp);
                num9 = shieldHp;
              }
              else
                num15 = 0.0f;
        ...
        ret.duelSkillProc.InvokeDamageSkill((int) num15);
        if (!invokedPrayer)
        ...
        if (!invokedPrayer)
        {
          ...
          if ((double) num15 >= (double) num8 && defenderDuelBeginHp >= 2)
          {
        ...
        {
          int num8 = isAttacker ? hp.defenderHp : hp.attackerHp;
          if ((double) num15 >= (double) num8)
            num15 = (float) (num8 - 1);
          if (val >= num8)
            val = num8 - 1;
        }
        if ((double) num15 >= 1.0 && !isColosseum)
        {
            ...
            if (unit != defense)
            {
              ...
              if (ret.hp.otherHp[unit].hp > 0)
              {
                List<BL.SkillEffect> list1 = unit.skillEffects.Where(BattleskillEffectLogicEnum.damage_share, (Func<BL.SkillEffect, bool>) (x =>
                {
                  ...
                  int num3 = BL.fieldDistance(unitCell2.Item1, unitCell2.Item2, unitCell1.Item1, unitCell1.Item2);
                  return num3 >= effect.GetInt(BattleskillEffectLogicArgumentEnum.min_range) && num3 <= effect.GetInt(BattleskillEffectLogicArgumentEnum.max_range) && !BattleFuncs.isSealedSkillEffect(unit, x) && ((effect.GetInt(BattleskillEffectLogicArgumentEnum.target_gear_kind_id) == 0 || effect.GetInt(BattleskillEffectLogicArgumentEnum.target_gear_kind_id) == defense.originalUnit.unit.kind.ID) && (effect.GetInt(BattleskillEffectLogicArgumentEnum.target_family_id) == 0 || defense.originalUnit.playerUnit.HasFamily((UnitFamily) effect.GetInt(BattleskillEffectLogicArgumentEnum.target_family_id)))) && (effect.GetInt(BattleskillEffectLogicArgumentEnum.target_element) == 0 || (CommonElement) effect.GetInt(BattleskillEffectLogicArgumentEnum.target_element) == defense.originalUnit.playerUnit.GetElement()) && effect.GetPackedSkillEffect().CheckLandTag(panel, isAI);
                ...
                if (list2.Count > 0)
                {
                  ...
                  {
                    int num9 = Judgement.CalcMaximumLongToInt(0L + (long) (skillEffect2.effect.GetInt(BattleskillEffectLogicArgumentEnum.value) + skillEffect2.baseSkillLevel * skillEffect2.effect.GetInt(BattleskillEffectLogicArgumentEnum.value_skill_ratio)) + (long) Judgement.CalcMaximumCeilToIntValue((Decimal) num15 * (Decimal) (skillEffect2.effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage) + (float) skillEffect2.baseSkillLevel * skillEffect2.effect.GetFloat(BattleskillEffectLogicArgumentEnum.percentage_skill_ratio))));
                    if (num9 > num8)
                    {
                      num8 = num9;
          ...
          if (source.Count > 0)
          {
            ...
            else
            {
              ...
              for (int index2 = 1; index2 <= 50; ++index2)
              {
                ...
                {
                  index1 = list.IndexOf(Tuple.Create<int, int>(num11, num16));
                  if (index1 == -1)
                  {
                    --num11;
                    ++num16;
            ...
            int num17 = num8;
            int num18 = val - num8;
            float num19 = !packedSkillEffect.HasKey(BattleskillEffectLogicArgumentEnum.damage_percentage) ? 1f : packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.damage_percentage);
            float num20 = !packedSkillEffect.HasKey(BattleskillEffectLogicArgumentEnum.target_damage_percentage) ? 1f : packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.target_damage_percentage);
            int num21 = Judgement.CalcMaximumCeilToIntValue((Decimal) num17 * (Decimal) num19);
            int num22 = Judgement.CalcMaximumCeilToIntValue((Decimal) num18 * (Decimal) num20);
            if (num21 < 0)
              num21 = 0;
            if (num22 < 0)
              num22 = 0;
            ret.hp.otherHp[key].hp -= num21;
            num15 = (float) num22;
            val = num22;
            ret.hp.otherHp[key].consumeSkillEffect.Add(skillEffect);
            ret.damageShareUnit.Add(key);
            ret.damageShareDamage.Add(num21);
        ...
        if (ret.duelSkillProc.isInvokeCounterAttack)
        {
          float num8 = num15 * ret.duelSkillProc.counterAttackRate;
        ...
        if ((isAttacker ? (!hp.defenderIsDontAction ? 1 : 0) : (!hp.attackerIsDontAction ? 1 : 0)) != 0)
        {
          ...
          if (array1.Length != 0 || array2.Length != 0)
          {
            ...
            foreach (BL.SkillEffect effect in array1)
            {
              ...
              int healValue = BattleFuncs.getHealValue(defense, defensePanel, (int) ((Decimal) ret.damage * num9), effect.baseSkill.skill_type, attack);
            ...
            foreach (BattleFuncs.SkillParam skillParam in BattleFuncs.gearSkillParamFilter(skillParams))
            {
              ...
              {
                int num9 = (int) skillParam.addParam.Value;
                if (num9 > 0)
                  ret.defenderDispDrainDamage += num9;
                else if (num9 < 0)
                  ret.defenderSwapHealDamage -= num9;
              }
            }
        ...
        ret.drainDamage = 0;
        int hp1 = attack.originalUnit.parameter.Hp;
        float num23 = ret.duelSkillProc.attackerSkills.Length >= 1 || baseDuelSkill.attackerSkills.Length >= 1 ? ret.duelSkillProc.drainRateRatio * drainRateRatio : 1f;
        int num24 = 0;
        if ((double) ret.duelSkillProc.drainRate > 0.0)
          num24 = BattleFuncs.getHealValue(attack, attackPanel, Mathf.CeilToInt((float) ret.damage * ret.duelSkillProc.drainRate * num23), BattleskillSkillType.duel, defense);
        else if ((double) drainRate > 0.0)
          num24 = BattleFuncs.getHealValue(attack, attackPanel, Mathf.CeilToInt((float) ret.damage * drainRate * num23), BattleskillSkillType.duel, defense);
        else if (attackStatus.isDrain)
          num24 = BattleFuncs.getHealValue(attack, attackPanel, Mathf.CeilToInt((float) ret.damage * attackStatus.drainRate * num23), BattleskillSkillType.magic, defense);
        if (num24 > 0)
        {
          ret.dispDrainDamage = num24;
          ret.drainDamage = NC.Clamp(0, hp1, ret.dispDrainDamage);
        }
        else if (num24 < 0)
          ret.attackerSwapHealDamage = -num24;
        if (isAttacker)
        {
      ...
      System.Action<IEnumerable<BL.SkillEffect>, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, int, int, bool> action4 = (System.Action<IEnumerable<BL.SkillEffect>, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, int, int, bool>) ((efs, effectUnit, targetUnit, effectUnitHp, targetUnitHp, isDefenseEffect) =>
      {
        ...
        {
          int num2 = headerEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_id);
          bool flag1;
          if (num2 < 0)
          {
            flag1 = true;
            ...
            flag1 = false;
          if (num2 != 0 && MasterData.BattleskillSkill.ContainsKey(num2))
          {
            ...
            BattleskillSkill battleskillSkill = MasterData.BattleskillSkill[num2];
            foreach (BL.ISkillEffectListUnit skillEffectListUnit in BattleFuncs.getInvestUnit(effectUnit, targetUnit, num2, headerEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.range_type), isAI, isColosseum))
            {
              if (battleskillSkill.skill_type == BattleskillSkillType.ailment)
              {
                int num3 = skillEffectListUnit != effectUnit ? (skillEffectListUnit != targetUnit ? (!ret.hp.otherHp.ContainsKey(skillEffectListUnit) ? skillEffectListUnit.hp : ret.hp.otherHp[skillEffectListUnit].hp) : targetUnitHp) : effectUnitHp;
                List<BL.SkillEffect> useResistEffects;
                bool flag2 = BattleFuncs.isAilmentInvest(lottery, num2, skillEffectListUnit, effectUnit, random, colosseumTurn, out useResistEffects, ret.hp, new int?(num3), new int?(effectUnitHp));
                ret.duelSkillProc.addInvestSkills(skillEffectListUnit, BattleFuncs.ailmentInvest(num2, skillEffectListUnit), new int[1]
                {
                  num2
                }, effectUnit, headerEffect.baseSkillId, true, (flag1 ? 1 : 0) != 0, 0, onceInvestFlag, (flag2 ? 1 : 0) != 0, useResistEffects);
              }
              else if ((double) lottery >= (double) random.NextFloat())
                ret.duelSkillProc.addInvestSkills(skillEffectListUnit, new BL.Skill[1]
                {
                  new BL.Skill() { id = num2, level = 1 }
                }, new int[1]{ num2 }, effectUnit, headerEffect.baseSkillId, false, (flag1 ? 1 : 0) != 0, 0, onceInvestFlag);
            }
          }
        }
      });
      ...
      bool isEnableOverKill)
    {
      ...
      List<BL.ISkillEffectListUnit> turnInvestUnit1 = new List<BL.ISkillEffectListUnit>();
      List<int> turnInvestSkillIds1 = new List<int>();
      List<BL.ISkillEffectListUnit> turnInvestFrom1 = new List<BL.ISkillEffectListUnit>();
      ...
      if (battleDuelSkill1.attackCount > 1)
      {
        ...
        for (int index = 0; index < battleDuelSkill1.attackCount; ++index)
        {
          ...
          BattleFuncs.assortOneAttackInvest(attack, defense, battleDuelSkill1, attackDamageData.duelSkillProc, turnInvestUnit1, turnInvestSkillIds1, turnInvestFrom1, turnInvestFromSkillIds, givePassiveSkills, skillList2, skillList1, suiseiResult.isHit, index, turns, useResistEffects);
        }
      ...
      else
      {
        ...
        BattleFuncs.assortOneAttackInvest(attack, defense, battleDuelSkill1, attackDamageData.duelSkillProc, turnInvestUnit1, turnInvestSkillIds1, turnInvestFrom1, turnInvestFromSkillIds, givePassiveSkills, giveAttackerAilmentSkills, giveDefenderAilmentSkills, turn.isHit, 0, turns, useResistEffects);
      ...
      if (!hasValue)
      {
        ...
        if (turn.isHit)
        {
          ...
          {
            turnInvestUnit1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList.Item1);
            turnInvestSkillIds1.AddRange((IEnumerable<int>) allInvestList.Item2);
            turnInvestFrom1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList.Item3);
        ...
        {
          turnInvestUnit1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList1.Item1);
          turnInvestSkillIds1.AddRange((IEnumerable<int>) allInvestList1.Item2);
          turnInvestFrom1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList1.Item3);
        ...
        List<BL.ISkillEffectListUnit> turnInvestUnit2 = new List<BL.ISkillEffectListUnit>((IEnumerable<BL.ISkillEffectListUnit>) turnInvestUnit1);
        List<int> turnInvestSkillIds2 = new List<int>((IEnumerable<int>) turnInvestSkillIds1);
        List<BL.ISkillEffectListUnit> turnInvestFrom2 = new List<BL.ISkillEffectListUnit>((IEnumerable<BL.ISkillEffectListUnit>) turnInvestFrom1);
        if (turn.isHit)
        {
          BL.Skill[] investSkills2 = battleDuelSkill2.getInvestSkills(attack, false, false, 0, turns, turnInvestUnit2, turnInvestSkillIds2, turnInvestFrom2);
          if (investSkills2 != null)
            skillList3.AddRange((IEnumerable<BL.Skill>) investSkills2);
          BL.Skill[] investSkills4 = battleDuelSkill2.getInvestSkills(defense, false, false, 0, turns, turnInvestUnit2, turnInvestSkillIds2, turnInvestFrom2);
          if (investSkills4 != null)
            skillList3.AddRange((IEnumerable<BL.Skill>) investSkills4);
          Tuple<BL.ISkillEffectListUnit[], int[], BL.ISkillEffectListUnit[], int[], BL.ISkillEffectListUnit[], BL.SkillEffect[]> allInvestList2 = battleDuelSkill2.getAllInvestList(false, false, 0, turns, turnInvestUnit2, turnInvestSkillIds2, turnInvestFrom2);
          if (allInvestList2 != null)
          {
            turnInvestUnit1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList2.Item1);
            turnInvestSkillIds1.AddRange((IEnumerable<int>) allInvestList2.Item2);
            turnInvestFrom1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList2.Item3);
            turnInvestFromSkillIds.AddRange((IEnumerable<int>) allInvestList2.Item4);
          }
        }
        BL.Skill[] investSkills5 = battleDuelSkill2.getInvestSkills(attack, false, true, 0, turns, turnInvestUnit2, turnInvestSkillIds2, turnInvestFrom2);
        if (investSkills5 != null)
          skillList3.AddRange((IEnumerable<BL.Skill>) investSkills5);
        BL.Skill[] investSkills6 = battleDuelSkill2.getInvestSkills(defense, false, true, 0, turns, turnInvestUnit2, turnInvestSkillIds2, turnInvestFrom2);
        if (investSkills6 != null)
          skillList3.AddRange((IEnumerable<BL.Skill>) investSkills6);
        Tuple<BL.ISkillEffectListUnit[], int[], BL.ISkillEffectListUnit[], int[], BL.ISkillEffectListUnit[], BL.SkillEffect[]> allInvestList3 = battleDuelSkill2.getAllInvestList(false, true, 0, turns, turnInvestUnit2, turnInvestSkillIds2, turnInvestFrom2);
        if (allInvestList3 != null)
        {
          turnInvestUnit1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList3.Item1);
          turnInvestSkillIds1.AddRange((IEnumerable<int>) allInvestList3.Item2);
          turnInvestFrom1.AddRange((IEnumerable<BL.ISkillEffectListUnit>) allInvestList3.Item3);
          turnInvestFromSkillIds.AddRange((IEnumerable<int>) allInvestList3.Item4);
        }
        if (skillList3.Count > 0)
          turn.invokeGiveSkills = turn.invokeGiveSkills == null ? skillList3.ToArray() : ((IEnumerable<BL.Skill>) turn.invokeGiveSkills).Concat<BL.Skill>((IEnumerable<BL.Skill>) skillList3).ToArray<BL.Skill>();
      ...
      turn.investUnit = turnInvestUnit1.ToArray();
      turn.investSkillIds = turnInvestSkillIds1.ToArray();
      turn.investFrom = turnInvestFrom1.ToArray();
    ...
    public static BL.ForceID[] getForceIDArray(BL.Unit unit, BL _env) => BattleFuncs.getForceIDArray(_env.getForceID(unit));
    ...
    public static HashSet<BL.Panel> createMovePanels(BL.UnitPosition up) => BattleFuncs.createMovePanels(up.originalRow, up.originalColumn, up.moveCost, up.unit);

    public static BL.Panel getPanel(BL.UnitPosition up) => BattleFuncs.env.getFieldPanel(up.originalRow, up.originalColumn);

    public static BL.Panel getPanel(int row, int column) => BattleFuncs.env.getFieldPanel(row, column);
...
label_54:
    ...
    public static HashSet<BL.Panel> createDangerPanels(BL.ForceID byForce) => BattleFuncs.createDangerPanels<BL.UnitPosition>((IEnumerable<BL.UnitPosition>) BattleFuncs.env.getActionUnits(byForce).value);
      ...
      bool isOriginal = true)
    {
      ...
      foreach (BL.Panel panel in panels)
      {
        BL.UnitPosition[] unitPositionArray = isAI ? BattleFuncs.env.getFieldUnitsAI(panel, isOriginal, includeJumping: true) : BattleFuncs.env.getFieldUnits(panel.row, panel.column, isOriginal, includeJumping: true);
        if (unitPositionArray == null)
          panelSet.Add(panel);
        else if (!((IEnumerable<BL.UnitPosition>) unitPositionArray).Any<BL.UnitPosition>((Func<BL.UnitPosition, bool>) (up => up != null && up.unit != unit && !up.unit.isPutOn)))
          panelSet.Add(panel);
      }
      return panelSet;
    }
    ...
    public static List<BL.UnitPosition> getNeighbors(BL.UnitPosition up, bool isAI = false) => BattleFuncs.getFourForceUnits(up.row, up.column, BattleFuncs.getForceIDArray(up.unit, BattleFuncs.env), isAI);
    ...
    public static int getMoveCost(BL.Panel panel, BL.Unit unit, bool enabledIgnoreMoveCost) => BattleFuncs.getMoveCost(panel, unit.job.move_type, enabledIgnoreMoveCost);
    ...
    public static BL.ISkillEffectListUnit unitPositionToISkillEffectListUnit(BL.UnitPosition up) => !(up is BL.ISkillEffectListUnit) ? (BL.ISkillEffectListUnit) up.unit : up as BL.ISkillEffectListUnit;
    ...
    public static BL.PhaseState getPhaseState() => BattleFuncs.env != null ? BattleFuncs.env.phaseState : (BL.PhaseState) null;
      ...
      }))).OrderByDescending<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (x => x.baseSkill.weight)).ThenBy<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (x => x.baseSkillId)).ThenByDescending<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (x => x.baseSkillLevel)))
      {
        foreach (BattleskillEffect effect in BattleFuncs.PackedSkillEffect.Create(headerEffect).GetEffects())
        {
          if (effect.HasKey(BattleskillEffectLogicArgumentEnum.invalid_skill_id))
            specificSkillLogicList.Add(BattleFuncs.InvalidSpecificSkillLogic.Create(effect.GetInt(BattleskillEffectLogicArgumentEnum.invalid_skill_id), effect.GetInt(BattleskillEffectLogicArgumentEnum.invalid_logic_id), (object) headerEffect));
        }
      }
      return specificSkillLogicList;
    }
      ...
      List<BattleFuncs.InvalidSpecificSkillLogic> invalidSkillLogics = null)
    {
      ...
      {
        float num4 = (float) (((Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.min_percentage) + (Decimal) skillEffect.baseSkillLevel * (Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.min_skill_ratio)) * 100M);
...
label_13:
        float num8 = (float) (((Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.max_percentage) + (Decimal) skillEffect.baseSkillLevel * (Decimal) skillEffect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.max_skill_ratio)) * 100M);
        if (nullable4.HasValue)
        {
          double num5 = (double) num8;
          nullable1 = nullable4;
          double valueOrDefault = (double) nullable1.GetValueOrDefault();
          if (!(num5 < valueOrDefault & nullable1.HasValue))
            continue;
      ...
      BL.Unit unit)
    {
      ...
      IEnumerable<Tuple<BattleskillSkill, int, int>> first = ((IEnumerable<PlayerAwakeSkill>) playerAwakeSkillArray).Select<PlayerAwakeSkill, Tuple<BattleskillSkill, int, int>>((Func<PlayerAwakeSkill, Tuple<BattleskillSkill, int, int>>) (x => new Tuple<BattleskillSkill, int, int>(x.masterData, x.level, 0)));
...
label_9:
      ...
      Dictionary<BL.ISkillEffectListUnit, List<BL.SkillEffect>> removeSkillEffects = null)
    {
      ...
      {
        List<BL.UseSkillEffect> useSkillEffectList = new List<BL.UseSkillEffect>();
        foreach (BL.UseSkillEffect useSkillEffect in defAttackStatus.duelParameter.defenderUnitParameter.useSkillEffects)
        {
          ...
          if (!source1.Any<BL.UseSkillEffect>((Func<BL.UseSkillEffect, bool>) (x => x.effectUniqueId == useEffect.effectUniqueId)))
            useSkillEffectList.Add(useEffect);
        }
        source1.AddRange((IEnumerable<BL.UseSkillEffect>) useSkillEffectList);
        useSkillEffectList.Clear();
        ...
        source2.AddRange((IEnumerable<BL.UseSkillEffect>) useSkillEffectList);
      }
    ...
    public static BL.ForceID[] getTargetForce(BL.Unit unit, bool isCharm) => BattleFuncs.env.getTargetForce(unit, isCharm);

    public static BL.ClassValue<List<BL.Unit>> forceUnits(BL.ForceID forceId) => BattleFuncs.env.forceUnits(forceId);
    ...
    public static BL.UnitPosition[] getFieldUnitsAI(int row, int column, bool includeJumping = false) => BattleFuncs.env.getFieldUnitsAI(row, column, includeJumping: includeJumping);
...
label_65:
      ...
      BattleFuncs.ApplyChangeSkillEffects applyChangeSkillEffects)
    {
      ...
      if (skillArray != null)
      {
        foreach (BL.Skill skill in skillArray)
        {
          ...
          System.Action<BattleskillEffect> action = (System.Action<BattleskillEffect>) (e =>
          {
      ...
      IEnumerable<BL.Unit> opponentDeckUnits)
    {
      ...
      foreach (BattleskillEffectLogicEnum battleskillEffectLogicEnum in BattleFuncs.DeckEveryGeSkillAddEnum)
      {
        ...
        flag1 |= beUnit.skillEffects.RemoveEffect(beUnit.skillEffects.Where(battleskillEffectLogicEnum).Except<BL.SkillEffect>(beUnit.skillEffects.GetFixEffectParams(battleskillEffectLogicEnum).Select<Tuple<BL.SkillEffect, int>, BL.SkillEffect>((Func<Tuple<BL.SkillEffect, int>, BL.SkillEffect>) (x => x.Item1))));
      }
      foreach (BattleskillEffectLogicEnum battleskillEffectLogicEnum in BattleFuncs.DeckEveryGeSkillMulEnum)
      {
        ...
        flag1 |= beUnit.skillEffects.RemoveEffect(beUnit.skillEffects.Where(battleskillEffectLogicEnum).Except<BL.SkillEffect>(beUnit.skillEffects.GetRatioEffectParams(battleskillEffectLogicEnum).Select<Tuple<BL.SkillEffect, float>, BL.SkillEffect>((Func<Tuple<BL.SkillEffect, float>, BL.SkillEffect>) (x => x.Item1))));
      }
      ...
      Func<BattleFuncs.PackedSkillEffect, BattleskillEffectLogicArgumentEnum, BattleskillEffectLogicArgumentEnum, BattleskillEffectLogicArgumentEnum, Func<int, int, bool>, IEnumerable<BL.Unit>, bool> func1 = (Func<BattleFuncs.PackedSkillEffect, BattleskillEffectLogicArgumentEnum, BattleskillEffectLogicArgumentEnum, BattleskillEffectLogicArgumentEnum, Func<int, int, bool>, IEnumerable<BL.Unit>, bool>) ((pse, typeArg, effectTypeArg, kindArg, condFunc, units) =>
      {
        ...
        foreach (int key in dictionary.Keys)
        {
          int kind = key;
          if (num3 == 1 && !flag2)
            flag2 |= isTarget(beUnit.originalUnit, kind);
          int num1 = units.Count<BL.Unit>((Func<BL.Unit, bool>) (x => isTarget(x, kind)));
          if (!condFunc(num1, dictionary[kind]))
            return false;
        }
        return flag2;
      });
      HashSet<BL.SkillEffect> source1 = new HashSet<BL.SkillEffect>();
      ...
      {
        foreach (IEnumerable<BL.SkillEffect> source3 in source2.GroupBy(x => new
        {
          baseSkillId = x.baseSkillId,
          effectId = x.effectId
        }))
        {
          foreach (BL.SkillEffect skillEffect in source3.Skip<BL.SkillEffect>(1))
            source1.Add(skillEffect);
        }
      }
      if (source1.Any<BL.SkillEffect>())
        flag1 |= beUnit.skillEffects.RemoveEffect((IEnumerable<BL.SkillEffect>) source1);
      ...
      {
        int num1 = pse.GetInt(kindCountArg);
        IEnumerable<int> source3 = (IEnumerable<int>) null;
        int num2 = pse.GetInt(typeArg);
        int typeId = 0;
        switch (num2)
        {
          case 0:
        ...
        return source3 != null && source3.Any<int>() && condFunc(source3, num1);
      });
      HashSet<BL.SkillEffect> source4 = new HashSet<BL.SkillEffect>();
      List<BL.SkillEffect> source5 = new List<BL.SkillEffect>();
      foreach (BL.SkillEffect skillEffect in beUnit.skillEffects.All())
      {
        BattleFuncs.PackedSkillEffect packedSkillEffect = skillEffect.effect.GetPackedSkillEffect();
      ...
      if (source5.Any<BL.SkillEffect>())
      {
        foreach (IEnumerable<BL.SkillEffect> source3 in source5.GroupBy(x => new
        {
          baseSkillId = x.baseSkillId,
          effectId = x.effectId
        }))
      ...
      if (source4.Any<BL.SkillEffect>())
        flag1 |= beUnit.skillEffects.RemoveEffect((IEnumerable<BL.SkillEffect>) source4);
      if (flag1)
      ...
      bool includeJumping = false)
    {
      ...
      else
      {
        ...
        {
          if (includeJumping || !unit.IsJumping)
            yield return (BL.ISkillEffectListUnit) unit;
        }
      }
    }
      ...
      List<BL.SkillEffect> newUseEffects = null)
    {
      ...
      if (type == 0)
      {
        Func<BL.SkillEffect, bool> checkDamage = (Func<BL.SkillEffect, bool>) (effect =>
        {
          ...
          if (damage < effect1.GetInt(BattleskillEffectLogicArgumentEnum.border_min_value))
            return false;
          int num1 = effect1.GetInt(BattleskillEffectLogicArgumentEnum.border_max_value);
          return num1 == 0 || damage <= num1;
        });
      ...
      foreach (BL.SkillEffect effect in BattleFuncs.GetEnabledDamageCutBuffDebuff(beUnit.skillEffects, BattleFuncs.DamageCut2RatioEnum[type], beUnit, beTarget, invokePanel))
      {
        ...
        {
          float num1 = effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.border_percentage) + (float) effect.baseSkillLevel * effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.skill_ratio);
          skillParams2.Add(BattleFuncs.SkillParam.CreateAdd(beUnit.originalUnit, effect, (float) Mathf.CeilToInt((float) beUnit.originalUnit.parameter.Hp * num1)));
        }
      }
      ...
      if (damage != 0 && type != 0)
      {
        ...
        foreach (BL.SkillEffect effect in BattleFuncs.GetEnabledDamageCutBuffDebuff(beUnit.skillEffects, BattleFuncs.DamageCut4RatioEnum[type], beUnit, beTarget, invokePanel))
        {
          ...
          {
            Decimal num1 = (Decimal) effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.damage_percentage) + (Decimal) effect.baseSkillLevel * (Decimal) effect.effect.GetFloat(BattleskillEffectLogicArgumentEnum.skill_ratio);
            if (num1 < 0M)
              num1 = 0M;
            skillParams3.Add(BattleFuncs.SkillParam.CreateMul(beUnit.originalUnit, effect, (float) num1));
          }
        }
        Decimal num2 = (Decimal) BattleFuncs.calcSkillParamMul(skillParams3);
        if (num2 > 1.0M)
          damage = Judgement.CalcMaximumCeilToIntValue((Decimal) damage * num2);
        else if (num2 < 1.0M)
          damage = Judgement.CalcMaximumFloorToIntValue((Decimal) damage * num2);
        if (damage < 0)
          damage = 0;
      }
      return damage;
      ...
      bool isRangeFromTarget)
    {
      ...
      for (int index2 = num3; index2 <= index1; ++index2)
      {
        Tuple<int, int, int> tuple = penetratePosition[index2];
        int num9 = penetratePosition[index2].Item2;
        int num10 = penetratePosition[index2].Item1;
        for (int index4 = -radius; index4 <= radius; ++index4)
        {
          for (int index5 = -radius; index5 <= radius; ++index5)
          {
            if (index5 * index5 + index4 * index4 <= num8)
            {
              int num11 = num9 + index5;
              int num12 = num10 + index4;
              if (num1 * (num11 - num4) + num2 * (num12 - num5) > 0 && -num1 * (num11 - num6) + -num2 * (num12 - num7) >= 0)
                tupleSet.Add(Tuple.Create<int, int>(num12, num11));
            }
          }
        }
      }
      ...
      BattleFuncs.BuffDebuffSwapState swapState)
    {
      ...
      if (swapState == null || (double) num == 1.0)
        return num;
      if ((double) num > 1.0)
        return !swapState.isBuffSwap(sp.effect) ? num : (float) (1.0M / (Decimal) num);
      if (!swapState.isDebuffSwap(sp.effect))
        return num;
      if ((double) num < 0.100000001490116)
        num = 0.1f;
      return (float) (1.0M / (Decimal) num);
    }
      ...
      float extraAdd)
    {
      ...
      if (exist123)
      {
        foreach (IGrouping<BattleskillSkillType, BattleFuncs.SkillParam> grouping in skillParams.Where<BattleFuncs.SkillParam>((Func<BattleFuncs.SkillParam, bool>) (x => x.param != null && (int) x.param != 0 && (int) x.param != 4)).GroupBy<BattleFuncs.SkillParam, BattleskillSkillType>((Func<BattleFuncs.SkillParam, BattleskillSkillType>) (x => x.effect.baseSkill.skill_type)))
        {
      ...
      BattleFuncs.BuffDebuffSwapState swapState = null)
    {
      ...
      else
      {
        ...
        if (skillParamClamp.fixMax.HasValue)
        {
          ...
          nullable1 = skillParamClamp.fixMax;
          int valueOrDefault = nullable1.GetValueOrDefault();
          if (num13 > valueOrDefault & nullable1.HasValue)
        ...
        if (skillParamClamp.ratioMax.HasValue)
        {
          ...
          nullable2 = skillParamClamp.ratioMax;
          Decimal valueOrDefault = nullable2.GetValueOrDefault();
          if (num13 > valueOrDefault & nullable2.HasValue)
      ...
      foreach (BL.SkillEffect skillEffect1 in skillEffects)
      {
        ...
        else if (skillEffect1.gearIndex == 3)
        {
          ...
          if (existGearTwo == null)
            existGearTwo = new HashSet<Tuple<int, bool>>();
          BL.Unit effectUnit1 = BattleFuncs.getEffectUnit(skillEffect1, hasUnit);
          Tuple<int, bool> tuple = Tuple.Create<int, bool>(effectUnit1.index, effectUnit1.isPlayerForce);
          if (!existGearOne.Contains(tuple) && !existGearTwo.Contains(tuple))
          {
            ...
            foreach (BL.SkillEffect skillEffect2 in skillEffects)
            {
              ...
              {
                BL.Unit effectUnit2 = BattleFuncs.getEffectUnit(skillEffect2, hasUnit);
                if (Tuple.Create<int, bool>(effectUnit2.index, effectUnit2.isPlayerForce).Equals((object) tuple))
                {
      ...
      switch (effect.EffectLogic.Enum)
      {
                  ...
                  while (enumerator.MoveNext())
                  {
                    ...
                    switch (current.EffectLogic.Enum)
                    {
                      case BattleskillEffectLogicEnum.seal:
                        ...
                        int num1 = current.HasKey(BattleskillEffectLogicArgumentEnum.invest_type) ? current.GetInt(BattleskillEffectLogicArgumentEnum.invest_type) : 0;
                        int num2 = current.GetInt(BattleskillEffectLogicArgumentEnum.skill_id);
                        int num3 = current.GetInt(BattleskillEffectLogicArgumentEnum.skill_type);
                        int num4 = current.HasKey(BattleskillEffectLogicArgumentEnum.logic_id) ? current.GetInt(BattleskillEffectLogicArgumentEnum.logic_id) : 0;
                        switch (num3)
                        {
                          case 0:
                            if (func2(num2, 1, 0, num4) || func2(num2, 2, 0, num4) || (func2(num2, 3, num1, num4) || func2(num2, 6, 0, num4)) || (func2(num2, 7, 0, num4) || func2(num2, 14, 0, num4) || num4 == 0 && func1(num2)))
                              return true;
                            continue;
                          case 1:
                          case 2:
                      ...
                      case BattleskillEffectLogicEnum.do_not_use_ougi:
                        if (unit.hasOugi)
                        {
                          int num5 = current.GetInt(BattleskillEffectLogicArgumentEnum.skill_id);
        ...
        case BattleskillEffectLogicEnum.rescue:
          if (useUnit != null)
          {
            ...
            if (BattleFuncs.getAnchorGroundEffects(unit, useUnit, panel2, BattleFuncs.getPanel(unitPosition4.row, unitPosition4.column)).Any<BL.SkillEffect>())
            {
        ...
        case BattleskillEffectLogicEnum.attract:
          if (useUnit != null)
          {
            ...
            if (BattleFuncs.getAnchorGroundEffects(unit, useUnit, BattleFuncs.getPanel(unitPosition4.row, unitPosition4.column), BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column)).Any<BL.SkillEffect>())
            {
              enableAnchorGround = true;
              break;
            }
            if (BattleFuncs.getAnchorGroundEffects(useUnit, useUnit, BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column), BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column)).Any<BL.SkillEffect>())
            {
              enableAnchorGround = true;
              break;
            }
            ...
            {
              BL.Panel panel2 = BattleFuncs.getPanel(unitPosition4.row, unitPosition4.column);
              if (effect.GetPackedSkillEffect().CheckTargetLandTag(panel2, unit is BL.AIUnit))
              {
                int[] attractDelta = BattleFuncs.getAttractDelta(unitPosition2, unitPosition4);
                BL.Unit[] unitArray = new BL.Unit[2]
                {
                  useUnit.originalUnit,
                  unit.originalUnit
                };
                if (BattleFuncs.isResetPositionOK(useUnit.originalUnit, unitPosition2.row + attractDelta[0], unitPosition2.column + attractDelta[1], unitPosition2.unit.parameter.Move, (IEnumerable<BL.Unit>) unitArray) && BattleFuncs.isResetPositionOK(unit.originalUnit, unitPosition4.row + attractDelta[0], unitPosition4.column + attractDelta[1], unitPosition4.unit.parameter.Move, (IEnumerable<BL.Unit>) unitArray))
                  return true;
                break;
              }
              break;
          ...
          if (useUnit != null)
          {
            ...
            if (!BattleFuncs.getAnchorGroundEffects(useUnit, useUnit, BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column), BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column)).Any<BL.SkillEffect>())
            {
              ...
              if ((effect.GetInt(BattleskillEffectLogicArgumentEnum.target_gear_kind_id) == 0 || effect.GetInt(BattleskillEffectLogicArgumentEnum.target_gear_kind_id) == unit.originalUnit.unit.kind.ID) && (effect.GetInt(BattleskillEffectLogicArgumentEnum.target_family_id) == 0 || unit.originalUnit.playerUnit.HasFamily((UnitFamily) effect.GetInt(BattleskillEffectLogicArgumentEnum.target_family_id))) && (effect.GetInt(BattleskillEffectLogicArgumentEnum.target_element) == 0 || (CommonElement) effect.GetInt(BattleskillEffectLogicArgumentEnum.target_element) == unit.originalUnit.playerUnit.GetElement()))
              {
                BL.UnitPosition unitPosition4 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
                BL.Panel panel2 = BattleFuncs.getPanel(unitPosition4.row, unitPosition4.column);
                if (effect.GetPackedSkillEffect().CheckTargetLandTag(panel2, unit is BL.AIUnit) && BattleFuncs.getShiftBreakPosition(useUnit, unit, effect.GetInt(BattleskillEffectLogicArgumentEnum.range), out int _, out int _))
                  return true;
                break;
              }
              break;
          ...
          if (useUnit != null)
          {
            ...
            if ((effect.GetInt(BattleskillEffectLogicArgumentEnum.target_gear_kind_id) == 0 || effect.GetInt(BattleskillEffectLogicArgumentEnum.target_gear_kind_id) == unit.originalUnit.unit.kind.ID) && (effect.GetInt(BattleskillEffectLogicArgumentEnum.target_family_id) == 0 || unit.originalUnit.unit.HasFamily((UnitFamily) effect.GetInt(BattleskillEffectLogicArgumentEnum.target_family_id))) && (effect.GetInt(BattleskillEffectLogicArgumentEnum.target_element) == 0 || (CommonElement) effect.GetInt(BattleskillEffectLogicArgumentEnum.target_element) == unit.originalUnit.playerUnit.GetElement()))
            {
              ...
              if (effect.GetPackedSkillEffect().CheckTargetLandTag(panel2, unit is BL.AIUnit))
              {
                ...
                List<Tuple<int, int, int>> penetratePosition = BattleFuncs.getPenetratePosition(unitPosition2.row, unitPosition2.column, unitPosition4.row, unitPosition4.column, penetrateCount);
                ...
                using (List<Tuple<int, int, int>>.Enumerator enumerator = penetratePosition.GetEnumerator())
                {
                  while (enumerator.MoveNext())
                  {
                    ...
                    if (BattleFuncs.isResetPositionOK(unit.originalUnit, current.Item1, current.Item2, unitPosition4.unit.parameter.Move, (IEnumerable<BL.Unit>) unitArray))
                      return true;
                  }
                  break;
                }
        ...
        case BattleskillEffectLogicEnum.dance:
          if (useUnit != null)
          {
            ...
            if (BattleFuncs.checkInvokeSkillEffect(pse, useUnit, unit))
            {
              BL.UnitPosition unitPosition2 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
              BL.Panel panel2 = BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column);
              if (pse.CheckTargetLandTag(panel2, unit is BL.AIUnit))
              {
                if (!(useUnit is BL.AIUnit))
                {
                  if (BattleFuncs.env.getActionUnits(unitPosition2) == null)
                    return true;
                  break;
                }
        ...
        case BattleskillEffectLogicEnum.changing:
          if (useUnit != null)
          {
            BL.UnitPosition unitPosition2 = BattleFuncs.iSkillEffectListUnitToUnitPosition(useUnit);
            BL.UnitPosition unitPosition4 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
            if (!BattleFuncs.getAnchorGroundEffects(unit, useUnit, BattleFuncs.getPanel(unitPosition4.row, unitPosition4.column), BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column)).Any<BL.SkillEffect>() && !BattleFuncs.getAnchorGroundEffects(useUnit, useUnit, BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column), BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column)).Any<BL.SkillEffect>())
            {
              BattleFuncs.PackedSkillEffect pse = BattleFuncs.PackedSkillEffect.Create(effect);
              if (BattleFuncs.checkInvokeSkillEffect(pse, useUnit, unit))
              {
                ...
                if (pse.CheckTargetLandTag(panel2, unit is BL.AIUnit))
                {
                  ...
                  if (BattleFuncs.isResetPositionOK(useUnit.originalUnit, unitPosition4.row, unitPosition4.column, unitPosition2.unit.parameter.Move, (IEnumerable<BL.Unit>) unitArray) && BattleFuncs.isResetPositionOK(unit.originalUnit, unitPosition2.row, unitPosition2.column, unitPosition4.unit.parameter.Move, (IEnumerable<BL.Unit>) unitArray))
                    return true;
                  break;
                }
                break;
        ...
        case BattleskillEffectLogicEnum.steal:
          if (useUnit != null)
          {
            ...
            if (BattleFuncs.checkInvokeSkillEffect(pse, useUnit, unit))
            {
              BL.UnitPosition unitPosition2 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
              BL.Panel panel2 = BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column);
              if (pse.CheckTargetLandTag(panel2, unit is BL.AIUnit) && BattleFuncs.calcStealEffectParam(unit.parameter, effect, out int _))
                return true;
              break;
            }
            break;
        ...
        case BattleskillEffectLogicEnum.transformation:
          if (useUnit != null)
          {
            BL.UnitPosition unitPosition2 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
            BL.Panel panel2 = BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column);
            if (effect.GetPackedSkillEffect().CheckTargetLandTag(panel2, unit is BL.AIUnit) && useUnit.transformationGroupId != effect.GetInt(BattleskillEffectLogicArgumentEnum.transformation_group_id))
              return true;
            break;
          }
          break;
        case BattleskillEffectLogicEnum.jump:
          if (useUnit != null)
          {
            ...
            BL.UnitPosition unitPosition2 = BattleFuncs.iSkillEffectListUnitToUnitPosition(useUnit);
            BL.UnitPosition unitPosition4 = BattleFuncs.iSkillEffectListUnitToUnitPosition(skillEffectListUnit);
            if (!BattleFuncs.getAnchorGroundEffects(skillEffectListUnit, useUnit, BattleFuncs.getPanel(unitPosition4.row, unitPosition4.column), BattleFuncs.getPanel(unitPosition2.row, unitPosition2.column)).Any<BL.SkillEffect>() && BattleFuncs.checkInvokeSkillEffect(BattleFuncs.PackedSkillEffect.Create(effect), useUnit, unit))
              return true;
            break;
          }
          break;
...
label_92:
      ...
      bool checkPassiveEffectEnabled = false)
    {
      ...
      if (pse.HasKey(BattleskillEffectLogicArgumentEnum.family_id))
      {
        ...
        if (num != 0 && (unit == null || !unit.originalUnit.playerUnit.HasFamily((UnitFamily) num)))
          return false;
      }
    ...
    public static float GetPeculiarParameterValue(BL.ISkillEffectListUnit unit, int paramType)
    {
      ...
      {
        case 1:
          num = unit.originalUnit.playerUnit.unityTotal;
          break;
        case 2:
          num = (float) unit.originalUnit.playerUnit.cost;
          break;
      }
      return num;
    }
    ...
    public static int GetBattleParameterValue(BL.ISkillEffectListUnit unit, int paramType)
    {
      ...
      switch (paramType)
      {
        case 1:
          ...
          break;
        case 2:
          num = unit.parameter.Hp;
          break;
        case 3:
          num = unit.parameter.Strength;
          break;
        case 4:
          num = unit.parameter.Intelligence;
          break;
        case 5:
          num = unit.parameter.Vitality;
          break;
        case 6:
          num = unit.parameter.Mind;
          break;
        case 7:
          num = unit.parameter.Agility;
          break;
        case 8:
          num = unit.parameter.Dexterity;
          break;
        case 9:
          num = unit.parameter.Luck;
          break;
        case 10:
          num = unit.parameter.Hit;
          break;
        case 11:
          num = unit.parameter.Evasion;
          break;
        case 12:
          num = unit.parameter.Critical;
          break;
        case 13:
          num = unit.parameter.Move;
          break;
        case 14:
          num = unit.parameter.PhysicalAttack;
          break;
        case 15:
          num = unit.parameter.MagicAttack;
          break;
        case 16:
          num = unit.parameter.PhysicalDefense;
          break;
        case 17:
          num = unit.parameter.MagicDefense;
          break;
        case 18:
          num = unit.parameter.Combat;
          break;
      }
      return num;
    }
    ...
    public static int getParameterReferenceHealValue(
      ...
      BattleskillEffect effect)
    {
      Decimal battleParameterValue = (Decimal) BattleFuncs.GetBattleParameterValue(selfUnit, effect.GetInt(BattleskillEffectLogicArgumentEnum.param_reference_type));
      Decimal num1 = targetUnit != null ? (Decimal) BattleFuncs.GetBattleParameterValue(targetUnit, effect.GetInt(BattleskillEffectLogicArgumentEnum.target_param_reference_type)) : 0M;
      Decimal num2 = (Decimal) effect.GetFloat(BattleskillEffectLogicArgumentEnum.param_reference_percentage);
      Decimal num3 = (Decimal) effect.GetFloat(BattleskillEffectLogicArgumentEnum.target_param_reference_percentage);
      Decimal num4 = num2;
      int num5 = (int) (battleParameterValue * num4 + num1 * num3);
      if (num5 < 1)
        num5 = 1;
      int num6 = effect.GetInt(BattleskillEffectLogicArgumentEnum.limit);
      if (num6 != 0 && num5 > num6)
        num5 = num6;
      return num5;
    }

    public static int getRunAwayValue(BL.ISkillEffectListUnit unit) => unit.enabledSkillEffect(BattleskillEffectLogicEnum.run_away).Sum<BL.SkillEffect>((Func<BL.SkillEffect, int>) (x => x.effect.GetInt(BattleskillEffectLogicArgumentEnum.add_value)));
      ...
      BL.ISkillEffectListUnit moveUnit = null)
    {
          ...
          if (flag)
          {
            ...
            if (skillEffect1.useRemain.HasValue)
            {
              ...
              if (useRemain1.GetValueOrDefault() >= num1 & useRemain1.HasValue)
              {
                ...
                int? useRemain3 = skillEffect1.useRemain;
                int num2 = 0;
                if (useRemain3.GetValueOrDefault() == num2 & useRemain3.HasValue && !isAI && skillEffect1.isLandTagEffect)
      ...
      {
        int num1 = pattern.Item1;
        int num2 = pattern.Item2;
        int num3 = pattern.Item3;
        int num4 = pattern.Item4;
        int num5 = pattern.Item5;
        if (e.baseSkill.skill_type == BattleskillSkillType.ailment)
        {
          BattleFuncs.PackedSkillEffect packedSkillEffect = BattleFuncs.PackedSkillEffect.Create(e);
          if ((packedSkillEffect.HasKey(BattleskillEffectLogicArgumentEnum.ailment_group_id) ? packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.ailment_group_id) : 0) != num5)
            return false;
        }
        if (num1 != 0 && e.effect.EffectLogic.Enum != (BattleskillEffectLogicEnum) num1 || num2 != 0 && e.baseSkill.ID != num2 || num3 != 0 && e.baseSkill.skill_type != (BattleskillSkillType) num3)
          return false;
        if (num4 == 0 || num4 == 1 && !e.isBaseSkill)
          return true;
        return num4 == 2 && e.isBaseSkill;
      })));
      BL.SkillEffect[] skillEffectArray = target.skillEffects.RemoveEffect(removeLogicId, removeSkillId, removeSkillType, BattleFuncs.env, target, (Func<BL.SkillEffect, bool>) (e => BattleFuncs.cantRemoveSkillEffect(e, removeInvestType, removeAilmentGroupId, rangeEffectRemoveFlag, target) || checkInvalid(e)));
      BL.SkillEffect[] removePassiveRangeEffects = ((IEnumerable<BL.SkillEffect>) skillEffectArray).Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (x => x.baseSkill.skill_type == BattleskillSkillType.passive && x.baseSkill.range_effect_passive_skill)).ToArray<BL.SkillEffect>();
      ...
      BL.Panel defensePanel = null)
    {
      ...
      List<BattleFuncs.SkillParam> skillParams3 = new List<BattleFuncs.SkillParam>();
      List<BattleFuncs.SkillParam> skillParams4 = new List<BattleFuncs.SkillParam>();
      System.Action<BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BattleskillEffectLogicEnum, BattleskillEffectLogicArgumentEnum, List<BattleFuncs.SkillParam>, List<BattleFuncs.SkillParam>, BL.Panel> action = (System.Action<BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BattleskillEffectLogicEnum, BattleskillEffectLogicArgumentEnum, List<BattleFuncs.SkillParam>, List<BattleFuncs.SkillParam>, BL.Panel>) ((effectUnit, targetUnit, logic, argument, buffParams, debuffParams, effectPanel) =>
      {
        foreach (BL.SkillEffect effect in effectUnit.skillEffects.Where(logic, (Func<BL.SkillEffect, bool>) (x =>
        {
          BattleskillEffect effect = x.effect;
          ...
          {
            int num1 = packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.min_range);
            int num2 = packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.max_range);
            if (attackPanel == null)
            {
              if (num1 != 0 || num2 != 0)
                return false;
            ...
            {
              int num3 = BL.fieldDistance(attackPanel, defensePanel);
              if (num1 != 0 && num3 < num1 || num2 != 0 && num3 > num2)
                return false;
            }
          }
      ...
      Decimal num4 = skillParams1.Count > 0 ? (Decimal) BattleFuncs.gearSkillParamFilter(skillParams1).Max<BattleFuncs.SkillParam>((Func<BattleFuncs.SkillParam, float>) (x => x.mulParam.Value)) : 0.0M;
      Decimal num5 = skillParams2.Count > 0 ? (Decimal) BattleFuncs.gearSkillParamFilter(skillParams2).Min<BattleFuncs.SkillParam>((Func<BattleFuncs.SkillParam, float>) (x => x.mulParam.Value)) : 0.0M;
      Decimal num6 = 1.0M + ((skillParams3.Count > 0 ? (Decimal) BattleFuncs.gearSkillParamFilter(skillParams3).Max<BattleFuncs.SkillParam>((Func<BattleFuncs.SkillParam, float>) (x => x.mulParam.Value)) : 0.0M) + (skillParams4.Count > 0 ? (Decimal) BattleFuncs.gearSkillParamFilter(skillParams4).Min<BattleFuncs.SkillParam>((Func<BattleFuncs.SkillParam, float>) (x => x.mulParam.Value)) : 0.0M) - num4 - num5);
      if (num6 < 0.01M)
        num6 = 0.01M;
      Decimal d = 1.0M / num6;
      if (d < 0M)
      ...
      BL.ISkillEffectListUnit unit)
    {
      ...
      if (!instance.isGvg)
        return (uint) (invokeGamemode & 4) > 0U;
      return (invokeGamemode & 128) != 0 && unit != null && unit.originalUnit.isPlayerForce || (invokeGamemode & 256) != 0 && unit != null && !unit.originalUnit.isPlayerForce || (uint) (invokeGamemode & 16) > 0U;
    }
    ...
    public static List<BL.Unit> getProvokeUnits(BL.ISkillEffectListUnit unit, BL.Panel panel = null)
    {
      ...
      System.Action<BL.Unit, BL.SkillEffect> action = (System.Action<BL.Unit, BL.SkillEffect>) ((target, effect) =>
      {
        if (!isAI)
        {
...
label_4:
      ...
      int? fromHp = null)
    {
      if (MasterData.BattleskillSkill.ContainsKey(skillId))
      {
        ...
        if (skill.skill_type == BattleskillSkillType.ailment)
        {
          ...
          foreach (BL.SkillEffect skillEffect in BattleFuncs.gearSkillEffectFilter(myself.originalUnit, skillEffects))
            yield return skillEffect;
        }
      }
    }
    ...
    public static bool isDontUseSEA(BL.ISkillEffectListUnit unit, BL.Skill skill) => skill != null && (!BattleFuncs.checkUseSkillInvokeGameMode(unit, skill, false) || !BattleFuncs.checkUseSEASkillMaxCountInDeck(unit, skill)) || unit.skillEffects.Where(BattleskillEffectLogicEnum.do_not_use_command).Any<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (x => x.baseSkillId == 300001382 || x.baseSkillId == 300003113));
      ...
      if (!isSample)
      {
        for (int index = 0; index < 2; ++index)
        {
          ...
          if (skillEffect1 != null && skillEffect1.useRemain.HasValue)
          {
            ...
            int num3 = 0;
            if (useRemain2.GetValueOrDefault() == num3 & useRemain2.HasValue && skillEffect1.isLandTagEffect)
              unit.skillEffects.LandTagModified.commit();
          }
        }
      }
    ...
    public static IEnumerable<BL.Skill> getReductCommandSkillUseTargetSkills(
      ...
      int useSkillId)
    {
      foreach (BL.Skill skill in (IEnumerable<BL.Skill>) ((IEnumerable<BL.Skill>) unit.skills).Where<BL.Skill>((Func<BL.Skill, bool>) (skill =>
      {
      ...
      {
        if (useUnit == unit && useSkillId == skill.id)
        {
          int? remain = skill.remain;
          int num = 1;
    ...
    public static void applyDuelResultEffects(
      ...
      BL.ISkillEffectListUnit def,
      BL env,
      System.Action<BL.Unit, Tuple<int, int>> swapHealDamageFunction = null)
    {
    ...
    public static HashSet<BL.ISkillEffectListUnit> applyDuelSkillEffects(
      ...
      System.Action<BattleskillSkill, BL.Unit, Dictionary<BL.Unit, Tuple<int, int>>, float?> snakeFunction = null,
    ...
    private static void applyDuelDamageSkillEffects(
      ...
      System.Action<BattleskillSkill, BL.Unit, Dictionary<BL.Unit, Tuple<int, int>>, float?> snakeFunction,
      ...
      List<Tuple<BL.Unit, BattleskillSkill>> afterDuelInvestLandTagKeys = null)
    {
        ...
        if (source.Any<BL.SkillEffect>())
        {
          foreach (BL.SkillEffect skillEffect in BattleFuncs.gearSkillEffectFilter(skillEffectListUnit1.originalUnit, (IEnumerable<BL.SkillEffect>) source))
          {
            ...
            foreach (BL.UnitPosition unitPosition in targets)
            {
              ...
              BL.SkillEffect[] skillEffectArray = BattleFuncs.removeSkillEffect(skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.logic_id), skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_id), skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_type), skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.invest_type), skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.ailment_group_id), skillEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.range_effect_remove_flag), iskillEffectListUnit, applyChangeSkillEffects, skillEffectListUnit1, skillEffect.effect, myself);
              if (!removeSkillEffects.ContainsKey(iskillEffectListUnit))
                removeSkillEffects[iskillEffectListUnit] = new List<BL.SkillEffect>();
              removeSkillEffects[iskillEffectListUnit].AddRange((IEnumerable<BL.SkillEffect>) skillEffectArray);
      ...
      for (int index = 0; index < 2; ++index)
      {
        BL.ISkillEffectListUnit skillEffectListUnit2 = myself;
        myself = enemy;
        enemy = skillEffectListUnit2;
      ...
      for (int index = 0; index < 2; ++index)
      {
        ...
        foreach (BL.SkillEffect skillEffect1 in myself.skillEffects.Where(BattleskillEffectLogicEnum.slash_back))
        {
          ...
          if (skillEffect1.useRemain.HasValue)
          {
            ...
            if (!(useRemain1.GetValueOrDefault() <= num1 & useRemain1.HasValue))
            {
              ...
              int? useRemain2 = skillEffect2.useRemain;
              skillEffect2.useRemain = useRemain2.HasValue ? new int?(useRemain2.GetValueOrDefault() - 1) : new int?();
              nullable = skillEffect1.useRemain;
              int num2 = 0;
              if (nullable.GetValueOrDefault() == num2 & nullable.HasValue && !isAI && skillEffect1.isLandTagEffect)
                myself.skillEffects.LandTagModified.commit();
            }
            else
              continue;
          }
          if (!BattleFuncs.isSkillsAndEffectsInvalid(myself, enemy) && !BattleFuncs.isSealedSkillEffect(myself, skillEffect1))
          {
            BattleFuncs.PackedSkillEffect packedSkillEffect = BattleFuncs.PackedSkillEffect.Create(skillEffect1);
        ...
        myself = enemy;
        enemy = skillEffectListUnit2;
        BL.UnitPosition unitPosition3 = unitPosition6;
        unitPosition6 = unitPosition7;
        unitPosition7 = unitPosition3;
      }
      for (int index = 0; index < 2; ++index)
      {
      ...
      foreach (BL.DuelTurn turn in duelResult.turns)
      {
        ...
        for (int index = 0; index < count; ++index)
        {
          ...
          if (!isAI)
            originalUnit = (BL.ISkillEffectListUnit) originalUnit.originalUnit;
          List<BL.SkillEffect> source1 = new List<BL.SkillEffect>((IEnumerable<BL.SkillEffect>) originalUnit.skillEffects.All());
          if (removeSkillEffects.ContainsKey(originalUnit))
            source1.AddRange((IEnumerable<BL.SkillEffect>) removeSkillEffects[originalUnit]);
          BL.SkillEffect[] array = source1.Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (x =>
          {
...
label_8:
          ...
          {
            int? useRemain1 = x.useRemain;
            int num = 1;
            return useRemain1.GetValueOrDefault() >= num & useRemain1.HasValue;
          }));
          if (skillEffect1 != null)
          {
            BL.SkillEffect skillEffect2 = skillEffect1;
            useRemain4 = skillEffect2.useRemain;
            int? nullable = useRemain4;
            skillEffect2.useRemain = nullable.HasValue ? new int?(nullable.GetValueOrDefault() - 1) : new int?();
            useRemain4 = skillEffect1.useRemain;
            int num = 0;
            if (useRemain4.GetValueOrDefault() == num & useRemain4.HasValue && !isAI && skillEffect1.isLandTagEffect)
          ...
          if (skillEffect3 != null)
          {
            source3.Add(Tuple.Create<BL.ISkillEffectListUnit, int, BL.SkillEffect, BL.ISkillEffectListUnit>(originalUnit, damage, skillEffect3, turn.isAtackker ? atk : def));
            if (damageShareSkillTarget != null)
            {
              ...
              if (!damageShareSkillTarget[key].ContainsKey(skillEffect3.baseSkill))
                damageShareSkillTarget[key][skillEffect3.baseSkill] = new List<BL.Unit>();
            }
          }
        }
      }
      if (source3.Any<Tuple<BL.ISkillEffectListUnit, int, BL.SkillEffect, BL.ISkillEffectListUnit>>())
      {
        ...
        foreach (Tuple<BL.ISkillEffectListUnit, int, BL.SkillEffect, BL.ISkillEffectListUnit> tuple in source3)
        {
          ...
          if (!removeSkillEffects.ContainsKey(unit) || !removeSkillEffects[unit].Contains(headerEffect))
          {
            ...
            {
              int num2 = packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.reflect_target_gear_kind_id);
              if (num2 == 0 || num2 == enemyUnit.originalUnit.unit.kind.ID)
              {
                int num3 = packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.reflect_target_element);
                if (num3 == 0 || (CommonElement) num3 == enemyUnit.originalUnit.playerUnit.GetElement())
                {
                  ...
                  int num4 = Judgement.CalcMaximumLongToInt((long) packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.reflect_value) + (long) Judgement.CalcMaximumCeilToIntValue((Decimal) num1 * (Decimal) packedSkillEffect.GetFloat(BattleskillEffectLogicArgumentEnum.reflect_percentage)));
                  if (num4 != 0)
                  {
                    int[] range = new int[2]
                    {
                    ...
                    int num5 = packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.reflect_is_range_from_enemy);
                    BL.ISkillEffectListUnit forceFromUnit = num5 == 0 ? unit : enemyUnit;
                    int num6 = packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.reflect_effect_target);
                    List<BL.UnitPosition> source1;
                    switch (num6)
                    {
                      case 0:
                      case 2:
                        source1 = BattleFuncs.getTargets(forceFromUnit.originalUnit, range, BattleFuncs.getForceIDArray(env.getForceID(unit.originalUnit)), BL.Unit.TargetAttribute.all, isAI, nonFacility: true);
                        if (num6 == 2)
                        {
                          source1 = source1.Where<BL.UnitPosition>((Func<BL.UnitPosition, bool>) (x => BattleFuncs.unitPositionToISkillEffectListUnit(x) == unit)).ToList<BL.UnitPosition>();
                          break;
                        }
                        break;
                      default:
                        source1 = BattleFuncs.getTargets(forceFromUnit.originalUnit, range, BattleFuncs.getForceIDArray(env.getForceID(enemyUnit.originalUnit)), BL.Unit.TargetAttribute.all, isAI, nonFacility: true);
                        if (num6 == 3)
                        {
                          source1 = source1.Where<BL.UnitPosition>((Func<BL.UnitPosition, bool>) (x => BattleFuncs.unitPositionToISkillEffectListUnit(x) == enemyUnit)).ToList<BL.UnitPosition>();
                          break;
                        }
                        break;
                    }
                    List<BL.Unit> unitList = new List<BL.Unit>();
                    foreach (BL.UnitPosition up in source1)
                    {
                      BL.ISkillEffectListUnit iskillEffectListUnit = BattleFuncs.unitPositionToISkillEffectListUnit(up);
                      if (iskillEffectListUnit.hp > 0)
                      {
                        ...
                        if (damage1 < 0)
                        {
                          num7 = BattleFuncs.getHealValue(iskillEffectListUnit, BattleFuncs.getPanel(up.row, up.column), -damage1, headerEffect.baseSkill.skill_type);
                          if (num7 < 0)
                            damage1 = 0;
                          else
                            num7 = 0;
                        }
                        int damage2 = BattleFuncs.applyFieldDamageFluctuate(atk, def, unit, iskillEffectListUnit, num5 == 0, damage1, forceFromUnit);
                        if (damage2 < 0 && !iskillEffectListUnit.CanHeal(headerEffect.baseSkill.skill_type))
                          damage2 = 0;
                        unitList.Add(iskillEffectListUnit.originalUnit);
                        if (damage2 >= 0)
                        {
                    ...
                    damageShareSkillTarget?[unit as BL.Unit][headerEffect.baseSkill].AddRange((IEnumerable<BL.Unit>) unitList);
                  }
                }
              }
            }
      ...
      for (is_attack = 1; is_attack <= 2; is_attack++)
      {
        ...
        {
          useRemain4 = effect.useRemain;
          if (useRemain4.HasValue)
          {
            useRemain4 = effect.useRemain;
            int num = 0;
            if (!(useRemain4.GetValueOrDefault() <= num & useRemain4.HasValue))
            {
              BL.SkillEffect skillEffect = effect;
              useRemain4 = skillEffect.useRemain;
              int? nullable = useRemain4;
              skillEffect.useRemain = nullable.HasValue ? new int?(nullable.GetValueOrDefault() - 1) : new int?();
            }
            else
        ...
        foreach (BL.SkillEffect skillEffect in BattleFuncs.gearSkillEffectFilter(myself.originalUnit, (IEnumerable<BL.SkillEffect>) skillEffectList))
        {
          ...
          if (effect.effect.HasKey(BattleskillEffectLogicArgumentEnum.enable_combi) && effect.effect.GetInt(BattleskillEffectLogicArgumentEnum.enable_combi) == 1)
          {
            ...
            for (int index = duelResult.turns.Length - 1; index >= 0; --index)
            {
              ...
              if (turn.isAtackker == flag && turn.invokeGiveSkills != null && ((IEnumerable<BL.Skill>) turn.invokeGiveSkills).Any<BL.Skill>((Func<BL.Skill, bool>) (skill => ((IEnumerable<BattleskillEffect>) skill.skill.Effects).Any<BattleskillEffect>((Func<BattleskillEffect, bool>) (e => e.skill.ID == effect.baseSkillId)))))
              {
                ...
                {
                  foreach (BL.ISkillEffectListUnit skillEffectListUnit2 in turn.attackerCombiUnit)
                  {
                    if (skillEffectListUnit2 != null)
                    {
                      BL.ISkillEffectListUnit unit = skillEffectListUnit2;
                      if (!isAI)
          ...
          {
            List<Tuple<int, int, int>> penetratePosition = BattleFuncs.getPenetratePosition(up1.row, up1.column, unitPosition3.row, unitPosition3.column, penetrateCount);
                    ...
                    if (((IEnumerable<BL.ForceID>) forceIds2).Contains<BL.ForceID>(env.getForceID(up2.unit)) && !up2.unit.isFacility)
                    {
                      ...
                      if (effect.effect.GetPackedSkillEffect().CheckTargetLandTag(panel, isAI))
                      {
                        ...
                        if (damage != 0)
                        {
                          ...
                          dictionaryArray[index][iskillEffectListUnit2] = Judgement.CalcMaximumLongToInt((long) dictionaryArray[index][iskillEffectListUnit2] + (long) num3);
      ...
      {
        {
          ...
          }), (Func<BL.SkillEffect, bool>) null, (System.Action<BL.SkillEffect, BL.ISkillEffectListUnit>) ((effect, unit) =>
          {
            ...
            BL.UnitPosition unitPosition3 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
            lifeAbsorbTargetHeal[unit] += BattleFuncs.getHealValue(unit, BattleFuncs.getPanel(unitPosition3.row, unitPosition3.column), healValue, effect.baseSkill.skill_type);
        ...
        },
        {
          ...
          }), (System.Action<BL.SkillEffect>) (effect =>
          {
            ...
            if (!(useRemain1.GetValueOrDefault() >= num1 & useRemain1.HasValue))
              return;
            BL.SkillEffect skillEffect = effect;
            useRemain1 = skillEffect.useRemain;
            int? nullable = useRemain1;
            skillEffect.useRemain = nullable.HasValue ? new int?(nullable.GetValueOrDefault() - 1) : new int?();
            useRemain1 = effect.useRemain;
            int num2 = 0;
            if (!(useRemain1.GetValueOrDefault() == num2 & useRemain1.HasValue) || isAI || !effect.isLandTagEffect)
              return;
            myself.skillEffects.LandTagModified.commit();
          }))
        },
        {
          ...
          }), (System.Action<BL.SkillEffect, BL.ISkillEffectListUnit>) ((effect, unit) =>
          {
            ...
            {
              BL.UnitPosition unitPosition3 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
              num1 = BattleFuncs.getHealValue(unit, BattleFuncs.getPanel(unitPosition3.row, unitPosition3.column), -damage, effect.baseSkill.skill_type);
              if (num1 < 0)
                damage = 0;
              else
                num1 = 0;
            }
            int num2 = BattleFuncs.applyFieldDamageFluctuate(atk, def, myself, unit, effect.effect, damage);
            if (num2 < 0 && !unit.CanHeal(effect.baseSkill.skill_type))
              num2 = 0;
            int index = is_attack - 1;
            ...
            curseReflectionTargetDamage[index][unit] = Judgement.CalcMaximumLongToInt((long) curseReflectionTargetDamage[index][unit] + (long) num2);
            curseReflectionTargetSwapHeal[index][unit] = Judgement.CalcMaximumLongToInt((long) curseReflectionTargetSwapHeal[index][unit] + (long) num1);
        ...
        },
        {
          ...
          }), (System.Action<BL.SkillEffect, BL.ISkillEffectListUnit>) ((effect, unit) =>
          {
            ...
            {
              int num4 = (double) num2 >= 0.0 ? Judgement.CalcMaximumCeilToIntValue((Decimal) snakeVenomDamageData.turnDamage * (Decimal) num2) : Judgement.CalcMaximumFloorToIntValue((Decimal) snakeVenomDamageData.turnDamage * (Decimal) num2);
              int damage = Judgement.CalcMaximumLongToInt((long) effect.effect.GetInt(BattleskillEffectLogicArgumentEnum.venom_value) + (long) num3 + (long) num4);
              int num5 = 0;
              if (damage < 0)
              {
                BL.UnitPosition unitPosition3 = BattleFuncs.iSkillEffectListUnitToUnitPosition(unit);
                num5 = BattleFuncs.getHealValue(unit, BattleFuncs.getPanel(unitPosition3.row, unitPosition3.column), -damage, effect.baseSkill.skill_type);
                if (num5 < 0)
                  damage = 0;
                else
                  num5 = 0;
              }
              int num6 = BattleFuncs.applyFieldDamageFluctuate(atk, def, myself, unit, effect.effect, damage);
              if (num6 < 0 && !unit.CanHeal(effect.baseSkill.skill_type))
                num6 = 0;
              if (num6 < 0 && unit == myself && myself.hp <= 0)
              {
                BattleFuncs.PackedSkillEffect packedSkillEffect = BattleFuncs.PackedSkillEffect.Create(effect);
              ...
              snakeVenomDamageData.unitDamage[unit] = num6;
              snakeVenomDamageData.unitSwapHealDamage[unit] = num5;
            }
          }), (System.Action<BL.SkillEffect>) null)
        }
      };
      foreach (BattleskillEffectLogicEnum key in dictionary1.Keys)
      {
        for (is_attack = 1; is_attack <= 2; is_attack++)
        {
          ...
          {
            BL.UnitPosition unitPosition3 = BattleFuncs.iSkillEffectListUnitToUnitPosition(myself);
            if ((effect.effect.GetInt(BattleskillEffectLogicArgumentEnum.is_attack_nc) == 0 || effect.effect.GetInt(BattleskillEffectLogicArgumentEnum.is_attack_nc) == is_attack) && (effect.effect.GetPackedSkillEffect().CheckLandTag(BattleFuncs.getPanel(unitPosition3.row, unitPosition3.column), isAI) && !BattleFuncs.isSkillsAndEffectsInvalid(myself, enemy)) && (!BattleFuncs.isSealedSkillEffect(myself, effect) && dictionary1[key].Item1(effect)))
              skillEffectList.Add(effect);
          ...
          foreach (BL.SkillEffect headerEffect in BattleFuncs.gearSkillEffectFilter(myself.originalUnit, (IEnumerable<BL.SkillEffect>) skillEffectList))
          {
            if (dictionary1[key].Item2 == null || dictionary1[key].Item2(headerEffect))
            {
              ...
              IEnumerable<BL.UnitPosition> source1;
              if (range_form == 3)
              {
                BL.UnitPosition unitPosition3 = BattleFuncs.iSkillEffectListUnitToUnitPosition(myself);
                BL.UnitPosition unitPosition4 = BattleFuncs.iSkillEffectListUnitToUnitPosition(enemy);
                HashSet<Tuple<int, int>> laserPosition = BattleFuncs.getLaserPosition(unitPosition3.row, unitPosition3.column, unitPosition4.row, unitPosition4.column, range[0], range[1], packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.penetrate_radius), headerEffect.effect.GetInt(BattleskillEffectLogicArgumentEnum.is_range_from_enemy) == 1);
                List<BL.UnitPosition> unitPositionList = new List<BL.UnitPosition>();
                foreach (Tuple<int, int> tuple in laserPosition)
                {
                  ...
                  if (unitPositionArray2 != null)
                  {
                    foreach (BL.UnitPosition unitPosition5 in unitPositionArray2)
                    {
                      if (!unitPosition5.unit.isFacility)
                      {
                        if (num == 0 || num == 2)
                        {
                          if (!((IEnumerable<BL.ForceID>) forceIds1).Contains<BL.ForceID>(env.getForceID(unitPosition5.unit)))
                            continue;
                        }
                        else if (!((IEnumerable<BL.ForceID>) forceIds2).Contains<BL.ForceID>(env.getForceID(unitPosition5.unit)))
                          continue;
                        unitPositionList.Add(unitPosition5);
                      }
                    }
                  }
                }
                source1 = (IEnumerable<BL.UnitPosition>) unitPositionList;
              }
              else
              {
                ...
                source1 = num == 0 || num == 2 ? (IEnumerable<BL.UnitPosition>) BattleFuncs.getTargets(rangeOriginUnit, range, forceIds1, BL.Unit.TargetAttribute.all, isAI, nonFacility: true) : (IEnumerable<BL.UnitPosition>) BattleFuncs.getTargets(rangeOriginUnit, range, forceIds2, BL.Unit.TargetAttribute.all, isAI, nonFacility: true);
                if (range_form == 1 || range_form == 2)
                  source1 = source1.Where<BL.UnitPosition>((Func<BL.UnitPosition, bool>) (up =>
                  {
                    switch (range_form)
                    {
                      case 1:
                        Tuple<int, int> unitCell1 = BattleFuncs.getUnitCell(rangeOriginUnit, isAI);
                        if (up.row != unitCell1.Item1 && up.column != unitCell1.Item2)
                          return false;
                        break;
                      case 2:
                        Tuple<int, int> unitCell2 = BattleFuncs.getUnitCell(rangeOriginUnit, isAI);
                        if (Mathf.Abs(up.row - unitCell2.Item1) != Mathf.Abs(up.column - unitCell2.Item2))
                          return false;
                        break;
                    }
                    return true;
              ...
              {
                case 2:
                  source1 = source1.Where<BL.UnitPosition>(closure_6 ?? (closure_6 = (Func<BL.UnitPosition, bool>) (x => BattleFuncs.unitPositionToISkillEffectListUnit(x) == myself)));
                  break;
                case 3:
                  source1 = source1.Where<BL.UnitPosition>(closure_7 ?? (closure_7 = (Func<BL.UnitPosition, bool>) (x => BattleFuncs.unitPositionToISkillEffectListUnit(x) == enemy)));
                  break;
              }
              foreach (BL.UnitPosition unitPosition3 in (IEnumerable<BL.UnitPosition>) source1.ToList<BL.UnitPosition>())
              {
                BL.ISkillEffectListUnit skillEffectListUnit2 = unitPosition3 is BL.ISkillEffectListUnit ? unitPosition3 as BL.ISkillEffectListUnit : (BL.ISkillEffectListUnit) unitPosition3.unit;
                if (skillEffectListUnit2 != null)
                  dictionary1[key].Item3(headerEffect, skillEffectListUnit2);
              }
            }
          }
          BL.ISkillEffectListUnit skillEffectListUnit3 = myself;
      ...
      if (lifeAbsorbTargetHeal.Count >= 1)
      {
        foreach (BL.ISkillEffectListUnit key1 in lifeAbsorbTargetHeal.Keys)
        {
          ...
          if (hp >= 1)
          {
            ...
            if (key1.hp <= 0 && key1 != atk && key1 != def)
              deads.Add(key1);
      ...
      foreach (BattleFuncs.SnakeVenomDamageData snakeVenomDamageData in (IEnumerable<BattleFuncs.SnakeVenomDamageData>) snakeVenomDamage.OrderBy<BattleFuncs.SnakeVenomDamageData, int>((Func<BattleFuncs.SnakeVenomDamageData, int>) (x => x.invokeOrder)).ThenByDescending<BattleFuncs.SnakeVenomDamageData, int>((Func<BattleFuncs.SnakeVenomDamageData, int>) (x => x.effect.baseSkill.weight)).ThenBy<BattleFuncs.SnakeVenomDamageData, int>((Func<BattleFuncs.SnakeVenomDamageData, int>) (x => x.effect.baseSkillId)))
      {
        ...
        if (snakeVenomDamageData.unitDamage != null)
        {
          ...
          if (dictionary2 != null)
          {
            ...
            if ((!packedSkillEffect.HasKey(BattleskillEffectLogicArgumentEnum.range_form) ? 0 : packedSkillEffect.GetInt(BattleskillEffectLogicArgumentEnum.range_form)) == 3)
            {
              BL.UnitPosition unitPosition3 = BattleFuncs.iSkillEffectListUnitToUnitPosition(atk);
              BL.UnitPosition unitPosition4 = BattleFuncs.iSkillEffectListUnitToUnitPosition(def);
              nullable = snakeVenomDamageData.invokeUnit != atk ? new float?(Mathf.Atan2((float) (unitPosition3.column - unitPosition4.column), (float) (unitPosition3.row - unitPosition4.row)) * 57.29578f) : new float?(Mathf.Atan2((float) (unitPosition4.column - unitPosition3.column), (float) (unitPosition4.row - unitPosition3.row)) * 57.29578f);
            }
            else
              nullable = new float?();
    ...
    public static bool applyServantsJoy(BL.ISkillEffectListUnit unit, int healHpTotal)
    {
      ...
      {
        int healValue1 = effect.effect.GetInt(BattleskillEffectLogicArgumentEnum.value) + effect.effect.GetInt(BattleskillEffectLogicArgumentEnum.skill_ratio) * effect.baseSkillLevel;
        int healValue2 = BattleFuncs.getHealValue(unit, panel, healValue1, effect.baseSkill.skill_type);
        skillParams.Add(BattleFuncs.SkillParam.CreateAdd(unit.originalUnit, effect, (float) healValue2));
        flag = true;
      }
    ...
    public static bool isCharismaEffect(BattleskillEffectLogicEnum e) => ((IEnumerable<BattleskillEffectLogicEnum>) BattleFuncs.charismaEffectsEnum).Contains<BattleskillEffectLogicEnum>(e);
    ...
    public class PackedSkillEffect
    {
      ...
      public bool HasKey(BattleskillEffectLogicArgumentEnum key) => this.GetEffects().Find((Predicate<BattleskillEffect>) (x => x.HasKey(key))) != null;

      public int GetInt(BattleskillEffectLogicArgumentEnum key) => this.GetEffects().Find((Predicate<BattleskillEffect>) (x => x.HasKey(key))).GetInt(key);

      public float GetFloat(BattleskillEffectLogicArgumentEnum key) => this.GetEffects().Find((Predicate<BattleskillEffect>) (x => x.HasKey(key))).GetFloat(key);
      ...
      public List<BattleskillEffect> GetEffects() => !this.ignoreHeader ? this.effects : this.ignoreHeaderEffects;
      ...
      public bool CheckLandTag(BL.Panel panel, bool isAI) => this.CheckLandTag(panel, BattleskillEffectLogicArgumentEnum.land_tag1, BattleskillEffectLogicArgumentEnum.land_tag10, isAI);

      public bool CheckTargetLandTag(BL.Panel panel, bool isAI) => this.CheckLandTag(panel, BattleskillEffectLogicArgumentEnum.target_land_tag1, BattleskillEffectLogicArgumentEnum.target_land_tag10, isAI);
    }
    ...
    public class SkillParam
    {
      ...
      public static BattleFuncs.SkillParam Create(BL.Unit hasUnit, BL.SkillEffect effect) => new BattleFuncs.SkillParam()
      {
        hasUnit = hasUnit,
        effect = effect
      };
    ...
    public class BuffDebuffSwapState
    {
      ...
      public bool isBuffSwap(BL.SkillEffect effect) => effect.effect.canBuffDebuffSwap() && this.flagBuff.Contains(this.getFlag(effect)) && !BattleFuncs.isBonusSkillId(effect.baseSkillId);

      public bool isDebuffSwap(BL.SkillEffect effect) => effect.effect.canBuffDebuffSwap() && this.flagDebuff.Contains(this.getFlag(effect)) && !BattleFuncs.isBonusSkillId(effect.baseSkillId);
    }
    ...
    public class ApplyChangeSkillEffects
    {
      ...
      public void add(BL.UnitPosition tup, bool isMoveUnit = false) => this.add(tup, BattleFuncs.unitPositionToISkillEffectListUnit(tup), isMoveUnit);

      public void add(BL.ISkillEffectListUnit target, bool isMoveUnit = false) => this.add(BattleFuncs.iSkillEffectListUnitToUnitPosition(target), target, isMoveUnit);
      ...
      public void execute()
      {
        ...
        if (!this.clearMovePanelCacheAll)
          return;
        BattleFuncs.getAllUnits(this.isAI, true).ForEach<BL.ISkillEffectListUnit>((System.Action<BL.ISkillEffectListUnit>) (x => BattleFuncs.iSkillEffectListUnitToUnitPosition(x).clearMovePanelCache()));
      }
    }
    ...
    public class ApplyChangeSkillEffectsOne
    {
      ...
      public void doAfter(bool isClearMovePanelCacheAll = true, bool setMoveUnitDistance = false)
      {
        ...
        if (!this.isAI)
        {
          BL.SkillEffect[] array2 = this.target.skillEffects.All().Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (x => x.effect.GetPackedSkillEffect().HasKey(BattleskillEffectLogicArgumentEnum.land_tag1))).ToArray<BL.SkillEffect>();
          if (((IEnumerable<BL.SkillEffect>) this.landTagEffect).Union<BL.SkillEffect>((IEnumerable<BL.SkillEffect>) array2).Except<BL.SkillEffect>(((IEnumerable<BL.SkillEffect>) this.landTagEffect).Intersect<BL.SkillEffect>((IEnumerable<BL.SkillEffect>) array2)).Any<BL.SkillEffect>())
    ...
    public class CheckInvokeGeneric
    {
      ...
      private class CheckPatternIsAttack : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public override BattleFuncs.CheckInvokeGeneric.CheckPattern.Category GetCategory() => BattleFuncs.CheckInvokeGeneric.CheckPattern.Category.Var;
      ...
      private class CheckPatternInvokeGamemode : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public override BattleFuncs.CheckInvokeGeneric.CheckPattern.Category GetCategory() => BattleFuncs.CheckInvokeGeneric.CheckPattern.Category.Fix;
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit, bool isColosseum) => BattleFuncs.checkInvokeGamemode(this.invokeGamemode, isColosseum, unit);
      }
      ...
      private class CheckPatternEquipGearKindId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && BattleFuncs.isGearEquipped(unit.originalUnit.playerUnit, this.equipGearKindId);
      }
      ...
      private class CheckPatternTargetEquipGearKindId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && BattleFuncs.isGearEquipped(target.originalUnit.playerUnit, this.targetEquipGearKindId);
      }
      ...
      private class CheckPatternExcludeEquipGearKindId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && !BattleFuncs.isGearEquipped(unit.originalUnit.playerUnit, this.excludeEquipGearKindId);
      }
        ...
        BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && !BattleFuncs.isGearEquipped(target.originalUnit.playerUnit, this.targetExcludeEquipGearKindId);
      }
      ...
      private class CheckPatternGearKindId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && this.gearKindId == unit.originalUnit.unit.kind.ID;
      }
      ...
      private class CheckPatternTargetGearKindId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && this.targetGearKindId == target.originalUnit.unit.kind.ID;
      }
      ...
      private class CheckPatternExcludeGearKindId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && this.excludeGearKindId != unit.originalUnit.unit.kind.ID;
      }
      ...
      private class CheckPatternTargetExcludeGearKindId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && this.targetExcludeGearKindId != target.originalUnit.unit.kind.ID;
      }
      ...
      private class CheckPatternTargetElement : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => BattleFuncs.checkElement(target, this.targetElement);
      }
      ...
      private class CheckPatternTargetExcludeElement : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => BattleFuncs.checkElement(target, this.targetExcludeElement, false);
      }
      ...
      private class CheckPatternJobId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && this.jobId == unit.originalUnit.job.ID;
      }
      ...
      private class CheckPatternTargetJobId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && this.targetJobId == target.originalUnit.job.ID;
      }
      ...
      private class CheckPatternExcludeJobId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && this.excludeJobId != unit.originalUnit.job.ID;
      }
      ...
      private class CheckPatternTargetExcludeJobId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && this.targetExcludeJobId != target.originalUnit.job.ID;
      }
      ...
      private class CheckPatternFamilyId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && unit.originalUnit.playerUnit.HasFamily((UnitFamily) this.familyId);
      }
      ...
      private class CheckPatternTargetFamilyId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && target.originalUnit.playerUnit.HasFamily((UnitFamily) this.targetFamilyId);
      }
      ...
      private class CheckPatternExcludeFamilyId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && !unit.originalUnit.playerUnit.HasFamily((UnitFamily) this.excludeFamilyId);
      }
      ...
      private class CheckPatternTargetExcludeFamilyId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && !target.originalUnit.playerUnit.HasFamily((UnitFamily) this.targetExcludeFamilyId);
      }
      ...
      private class CheckPatternGroupLargeId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && unit.originalUnit.unitGroup != null && this.groupLargeId == unit.originalUnit.unitGroup.group_large_category_id.ID;
      }
      ...
      private class CheckPatternTargetGroupLargeId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && target.originalUnit.unitGroup != null && this.targetGroupLargeId == target.originalUnit.unitGroup.group_large_category_id.ID;
      }
      ...
      private class CheckPatternGroupSmallId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && unit.originalUnit.unitGroup != null && this.groupSmallId == unit.originalUnit.unitGroup.group_small_category_id.ID;
      }
      ...
      private class CheckPatternTargetGroupSmallId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && target.originalUnit.unitGroup != null && this.targetGroupSmallId == target.originalUnit.unitGroup.group_small_category_id.ID;
      }
      ...
      private class CheckPatternGroupClothingId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && unit.originalUnit.unitGroup != null && (this.groupClothingId == unit.originalUnit.unitGroup.group_clothing_category_id.ID || this.groupClothingId == unit.originalUnit.unitGroup.group_clothing_category_id_2.ID);
      }
      ...
      private class CheckPatternTargetGroupClothingId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && target.originalUnit.unitGroup != null && (this.targetGroupClothingId == target.originalUnit.unitGroup.group_clothing_category_id.ID || this.targetGroupClothingId == target.originalUnit.unitGroup.group_clothing_category_id_2.ID);
      }
      ...
      private class CheckPatternGroupGenerationId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && unit.originalUnit.unitGroup != null && this.groupGenerationId == unit.originalUnit.unitGroup.group_generation_category_id.ID;
      }
      ...
      private class CheckPatternTargetGroupGenerationId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && target.originalUnit.unitGroup != null && this.targetGroupGenerationId == target.originalUnit.unitGroup.group_generation_category_id.ID;
      }
      ...
      private class CheckPatternSkillGroupId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && unit.originalUnit.unit.HasSkillGroupId(this.skillGroupId);
      }
      ...
      private class CheckPatternTargetSkillGroupId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && target.originalUnit.unit.HasSkillGroupId(this.targetSkillGroupId);
      }
      ...
      private class CheckPatternExcludeSkillGroupId : BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit) => unit != null && !unit.originalUnit.unit.HasSkillGroupId(this.excludeSkillGroupId);
      }
        ...
        BattleFuncs.CheckInvokeGeneric.CheckPattern
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit target) => target != null && !target.originalUnit.unit.HasSkillGroupId(this.targetExcludeSkillGroupId);
      }
        ...
        BattleFuncs.CheckInvokeGeneric.CheckPatternOnemanCharge
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit, bool isColosseum) => this.DoCheck(0, unit, isColosseum);
      }
        ...
        BattleFuncs.CheckInvokeGeneric.CheckPatternOnemanCharge
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit, bool isColosseum) => this.DoCheck(1, unit, isColosseum);
      }
        ...
        BattleFuncs.CheckInvokeGeneric.CheckPatternOnemanCharge
      {
        ...
        public bool DoCheck(BL.ISkillEffectListUnit unit, bool isColosseum) => this.DoCheck(2, unit, isColosseum);
      }
