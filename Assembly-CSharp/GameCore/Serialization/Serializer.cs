      ...
      try
      {
        ...
        else
        {
          ...
          else if (type.IsArray)
          {
            ...
            int index = 0;
            foreach (object obj1 in ar)
            {
              v1[index] = this.Serialize(obj1);
              ++index;
            }
          ...
          else
          {
            foreach (FieldInfo allField in type.GetAllFields())
            {
              ...
              {
                object obj1 = allField.GetValue(obj);
                treeObject.fields[allField.Name] = this.Serialize(obj1);
              }
            }
          }
        }
