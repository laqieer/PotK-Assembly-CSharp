...
public class GuildDefGuestSelectPopup : GuildGuestListBase
{
  ...
  public IEnumerator InitializeAsync(
    ...
    GuildDefTeamEditPopup editPopup)
  {
    this.parent = parent;
  ...
  protected override IEnumerator CreateScroll(int info_index, int bar_index)
  {
    ...
    if (bar_index < guestSelectPopup.allGuestBar.Count && info_index < guestSelectPopup.allGuestInfo.Count)
    {
      ...
      IEnumerator e = scrollParts.InitializeAsync(guestBarInfo.friend, GuildGuestSelectScroll.MODE.Def, new System.Action<GvgCandidate>(guestSelectPopup.\u003CCreateScroll\u003Eb__10_0));
      while (e.MoveNext())
  ...
  {
    if (this.IsPushAndSet() || !this.gameObject.activeSelf || this.parent.Mode != GuildDefTeamPopup.MODE.Guest)
      return;
