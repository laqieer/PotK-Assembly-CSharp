...
public class Battle01CommandSEA : BattleMonoBehaviour, IButtonEnableBeheviour
{
  ...
  public bool buttonEnable
  {
    set
    {
      ...
      this.button.isEnabled = ((!this.mButtonEnable || this.env.core.currentUnitPosition.isActionComleted ? 0 : (!this.battleManager.getController<BattleStateController>().isWaitCurrentAIActionCancel ? 1 : 0)) & (flag ? 1 : 0)) != 0;
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    battle01CommandSea.button = battle01CommandSea.GetComponent<UIButton>();
    EventDelegate.Set(battle01CommandSea.button.onClick, new EventDelegate((MonoBehaviour) battle01CommandSea, "onClick"));
    battle01CommandSea.battleManager.getManager<NGBattleUIManager>().controller.setButtonBehaviour((IButtonEnableBeheviour) battle01CommandSea);
    return false;
  }
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    battle01CommandSea.selectNode = NGUITools.FindInParents<Battle01SelectNode>(battle01CommandSea.transform);
  ...
  private bool IsEnabledSEASkillButton() => this.mButtonEnable && !this.env.core.currentUnitPosition.isActionComleted && (!this.waitAIActionCancelModified.value.value && this.isUsableSEASkill());
  ...
  public void onClick()
  {
    ...
    if ((UnityEngine.Object) controller != (UnityEngine.Object) null && controller.isUnitScrollDragging)
      return;
