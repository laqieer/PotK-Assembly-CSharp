...
public class Versus02612Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, int id, int best_class) => Singleton<NGSceneManager>.GetInstance().changeScene("versus026_12", (stack ? 1 : 0) != 0, (object) id, (object) best_class);
