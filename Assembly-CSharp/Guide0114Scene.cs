...
public class Guide0114Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, Guide0111Scene.UpdateInfo updateInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("guide011_4", (stack ? 1 : 0) != 0, (object) updateInfo);
