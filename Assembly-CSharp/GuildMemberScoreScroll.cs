...
public class GuildMemberScoreScroll : MonoBehaviour
{
  ...
  private IEnumerator SetMemberScoreData(GvgPlayerHistory score)
  {
    ...
    if ((Object) unitIcon != (Object) null)
      Object.Destroy((Object) unitIcon.gameObject);
    unitIcon = (UnitIcon) null;
    IEnumerator e;
    if ((Object) this.unitIconPrefab == (Object) null)
    {
    ...
    if (score != null && (Object) this.unitIconPrefab != (Object) null)
    {
    ...
    Future<UnityEngine.Sprite> image = EmblemUtility.LoadEmblemSprite(score.player_emblem_id.Value);
    e = image.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
