...
public class Quest0022Menu : QuestStageMenuBase
{
    ...
    bool focus)
  {
    ...
    e = (IEnumerator) null;
    if (!bgCreate)
      quest0022Menu.GetComponent<Quest0022Scene>().bgchange.M_BGAnimation(quest0022Menu.StageDataS[0].numM_in_thisL, Hard: quest0022Menu.hardmode);
  }
    ...
    bool focus)
  {
    ...
    e = (IEnumerator) null;
    if (!bgCreate)
      quest0022Menu.GetComponent<Quest0022Scene>().bgchange.M_BGAnimation(quest0022Menu.StageDataS[0].numM_in_thisL);
  }
  ...
  public override void IbtnBack()
  {
    ...
    BGChange component = this.GetComponent<BGChange>();
    if (Singleton<NGGameDataManager>.GetInstance().IsSea)
    {
  ...
  private void OnDisable() => UnityEngine.Object.Destroy((UnityEngine.Object) this.bonusTimeContainer);
