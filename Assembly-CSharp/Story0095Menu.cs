...
public class Story0095Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitScene(bool connect)
  {
    ...
    if (connect)
    {
      ...
      if (!WebAPI.IsResponsedAtContainsKey(KeyWebAPI))
      {
        ...
        Future<WebAPI.Response.QuestProgressCharacter> ft = WebAPI.QuestProgressCharacter(new System.Action<WebAPI.Response.UserError>(story0095Menu.\u003CInitScene\u003Eb__7_0));
        e = ft.Wait();
        while (e.MoveNext())
  ...
  public IEnumerator InitCharacterQuestButton(PlayerUnit[] characterQuests)
  {
    ...
    for (int index = 0; index < playerUnitArray.Length; ++index)
    {
      ...
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(unitIconPrefab);
      ...
      e = (IEnumerator) null;
      // ISSUE: reference to a compiler-generated method
      unitIcon.onClick = new System.Action<UnitIconBase>(story0095Menu.\u003CInitCharacterQuestButton\u003Eb__8_1);
  ...
  public IEnumerator InitCharacterQuestButton(PlayerCharacterQuestS[] characterQuests)
  {
    ...
    for (int index = 0; index < playerCharacterQuestSArray.Length; ++index)
    {
      ...
      e = (IEnumerator) null;
      // ISSUE: reference to a compiler-generated method
      unitIcon.onClick = new System.Action<UnitIconBase>(story0095Menu.\u003CInitCharacterQuestButton\u003Eb__9_1);
