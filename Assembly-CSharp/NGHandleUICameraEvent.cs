...
public class NGHandleUICameraEvent : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    if (!((UnityEngine.Object) UICamera.genericEventHandler == (UnityEngine.Object) null))
      return;
  ...
  private void clickBlock(GameObject go) => Singleton<CommonRoot>.GetInstance().isTouchBlockAutoClose = true;
  ...
  private bool IsSeaSE() => Singleton<NGGameDataManager>.GetInstance().IsSea && Singleton<NGSceneManager>.GetInstance().sceneName != "help015_2";
