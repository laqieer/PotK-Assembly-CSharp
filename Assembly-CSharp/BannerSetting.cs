...
public class BannerSetting : BannerBase
{
  ...
  private bool isUseWebImage(Banner banner) => !(banner.transition.scene_name == "quest002_20") && !(banner.transition.scene_name == "quest002_19") && !(banner.transition.scene_name == "quest002_26");
  ...
  public static bool judgeTime(Banner banner, DateTime now) => !banner.end_at.HasValue || now < banner.end_at.Value;
  ...
  public void Next() => this.transform.parent.GetComponent<BannersProc>().LoopBannerNext();
