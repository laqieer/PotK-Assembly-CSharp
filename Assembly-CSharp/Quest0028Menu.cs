...
public class Quest0028Menu : BackButtonMenuBase
{
  ...
  public void setEventSetHelper(System.Action<PlayerHelper> eventSetHelper) => this.onSetHelper_ = eventSetHelper;

  private DeckInfo[] getDecks() => this.deckMode == Quest0028Menu.DeckMode.Custom ? ((IEnumerable<PlayerCustomDeck>) SMManager.Get<PlayerCustomDeck[]>()).Select<PlayerCustomDeck, DeckInfo>((Func<PlayerCustomDeck, DeckInfo>) (x => PlayerCustomDeck.createDeckInfo(x))).ToArray<DeckInfo>() : this.funcGetNormalDecks();
    ...
    bool story_only)
  {
    ...
    bool flag7 = !flag6 || !((IEnumerable<PlayerCustomDeck>) SMManager.Get<PlayerCustomDeck[]>()).Any<PlayerCustomDeck>((Func<PlayerCustomDeck, bool>) (x => (uint) ((IEnumerable<int>) x.player_unit_ids).FirstOrDefault<int>() > 0U));
    if (flag7)
      this.deckMode = Quest0028Menu.DeckMode.Normal;
    ...
    if ((UnityEngine.Object) this.toggleAuto_ != (UnityEngine.Object) null)
      this.toggleAuto_.resetSwitch(Persist.autoBattleSetting.Data.isAutoBattle);
    else if ((UnityEngine.Object) this.slcAutoBattleToggle != (UnityEngine.Object) null)
      this.slcAutoBattleToggle.SetActive(Persist.autoBattleSetting.Data.isAutoBattle);
    if ((UnityEngine.Object) this.toggleItemAutoLap_ != (UnityEngine.Object) null)
      this.toggleItemAutoLap_.resetSwitch(Singleton<NGGameDataManager>.GetInstance().questAutoLap);
    else if ((UnityEngine.Object) this.slcAutoLapToggle != (UnityEngine.Object) null)
    ...
    if ((UnityEngine.Object) this.prefabItemIcon == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator doInitDeckPanels()
  {
    ...
    quest0028Menu.btnSelectFriend.enabled = false;
  ...
  private int firstDeckNumber
  {
    ...
    {
      int num;
      if (!this.dicStackSelected.TryGetValue(this.deckMode, out num))
      {
        num = this.deckMode != Quest0028Menu.DeckMode.Custom ? (this.isSea_ ? Persist.seaDeckOrganized.Data.number : Persist.deckOrganized.Data.number) : Persist.deckOrganized.Data.customNumber;
        this.dicStackSelected[this.deckMode] = num;
      }
      return num;
    }
  }
  ...
  private void updateDeck()
  {
    ...
    if (this.isBreakGearUnits)
    {
      ...
      {
        if (!((UnityEngine.Object) this.slcAutoLapToggle != (UnityEngine.Object) null))
          return;
    ...
    else
    {
      ...
      if ((UnityEngine.Object) this.selectedDeck != (UnityEngine.Object) null && !this.selectedDeck.isCompletedOverkillersDeck)
        this.setMainButtonEdit();
      else if (this.isLimitation && this.regulationDeck != null)
      {
        PlayerUnit[] playerUnitArray = new PlayerUnit[5];
        if ((UnityEngine.Object) this.selectedDeck != (UnityEngine.Object) null)
        {
          for (int index = 0; index < this.selectedDeck.maxPlayer; ++index)
            playerUnitArray[index] = this.selectedDeck.deckUnitData[index];
        }
        int[] array = ((IEnumerable<PlayerUnit>) playerUnitArray).Where<PlayerUnit>((Func<PlayerUnit, bool>) (x => x != (PlayerUnit) null && !x.is_guest)).Select<PlayerUnit, int>((Func<PlayerUnit, int>) (x => x.id)).ToArray<int>();
        HashSet<int> checkedDeckIds = new HashSet<int>(((IEnumerable<int>) this.regulationDeck[this.selectDeck].player_unit_ids).Where<int>((Func<int, bool>) (n => (uint) n > 0U)));
  ...
  private Quest0028Menu.FriendInfo getFriendInfoCache(
    string player_id,
    int player_unit_id)
  {
  ...
  private Quest0028Menu.FriendInfo getSeaFriendInfoCache(
    string player_id,
    int player_unit_id)
  {
    Dictionary<int, Quest0028Menu.FriendInfo> dictionary;
  ...
  {
    Quest0028Menu quest0028Menu = this;
    quest0028Menu.btnSelectFriend.enabled = true;
    quest0028Menu.slcFriendTextGuest.SetActive(false);
    ...
    if (quest0028Menu.friend != null)
    {
      ...
      if (Singleton<NGGameDataManager>.GetInstance().IsSea)
      {
        ...
        if (info == null)
        {
          ...
          Future<WebAPI.Response.SeaFriendStatus> futureF = WebAPI.SeaFriendStatus(quest0028Menu.friend.target_player_id, quest0028Menu.friend.leader_player_unit_id, new System.Action<WebAPI.Response.UserError>(quest0028Menu.\u003CsetHelperUI\u003Eb__135_0));
          e = futureF.Wait();
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
      ...
      else
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          Future<WebAPI.Response.FriendStatus> futureF = WebAPI.FriendStatus(quest0028Menu.friend.target_player_id, quest0028Menu.friend.leader_player_unit_id, new System.Action<WebAPI.Response.UserError>(quest0028Menu.\u003CsetHelperUI\u003Eb__135_1));
          e = futureF.Wait();
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
  ...
  public IEnumerator SetFriendUnitIcon(PlayerUnit unit = null, bool isSortie = true)
  {
    ...
    if ((UnityEngine.Object) this.friendUnitIcon != (UnityEngine.Object) null)
    {
      this.friendUnitIcon = (UnitIcon) null;
      UnitIcon componentInChildren = this.linkFriendCharacter.transform.GetComponentInChildren<UnitIcon>();
    ...
    if (this.friendItemIcon != null)
    {
      for (int index = 0; index < this.friendItemIcon.Length; ++index)
      {
        ...
        ItemIcon componentInChildren = this.linkFriendGear[index].transform.GetComponentInChildren<ItemIcon>();
        if ((UnityEngine.Object) componentInChildren != (UnityEngine.Object) null)
          UnityEngine.Object.Destroy((UnityEngine.Object) componentInChildren.gameObject);
      }
    }
    ...
    if (unit != (PlayerUnit) null & isSortie)
    {
      ...
      for (int i = 0; i < slotNum; ++i)
      {
        ...
        if (Singleton<NGGameDataManager>.GetInstance().IsSea)
          component.transform.localScale = new Vector3(0.65f, 0.65f);
        else
    ...
    {
      this.friendUnitIcon.onClick = (System.Action<UnitIconBase>) (_ => Unit0042Scene.changeSceneGuestUnit(true, unit, new PlayerUnit[1]
      {
        unit
      }));
    ...
    {
      this.friendUnitIcon.onClick = (System.Action<UnitIconBase>) (_ => this.IbtnSelectFriend());
      if (this.friend != null)
  ...
  public virtual void IbtnSortie()
  {
    ...
    if (Singleton<NGGameDataManager>.GetInstance().questAutoLap && this.friend != null)
      PopupCommonNoYes2.Show("オート周回確認", "[ffff00]オート周回中はフレンドユニットを\n連れて行くことができません\n\n自分のユニットのみで出撃しますか？[-]", new System.Action(this.AutoLapFriendConfirmation), (System.Action) (() => {}));
    else
      this.QuestStart();
  }
  ...
  {
    DeckInfo playerDeck = this.playerDecks[this.selectDeck];
    WebAPI.BattleStoryStart(playerDeck.deck_number, playerDeck.deck_type_id, 0, this.story_quest.quest_story_s.ID, this.friend == null ? "" : this.friend.target_player_id, this.friend == null ? 0 : this.friend.leader_player_unit_id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
  ...
  private void ExtraStartApi()
  {
    ...
    if (this.extra_quest.quest_extra_s.wave != null)
      WebAPI.BattleWaveStart(playerDeck.deck_number, playerDeck.deck_type_id, 0, this.extra_quest.quest_extra_s.ID, this.friend == null ? "" : this.friend.target_player_id, this.friend == null ? 0 : this.friend.leader_player_unit_id, (System.Action<WebAPI.Response.UserError>) (error =>
      {
        Singleton<CommonRoot>.GetInstance().isLoading = false;
        WebAPI.DefaultUserErrorCallback(error);
        MypageScene.ChangeSceneOnError();
      ...
      WebAPI.BattleExtraStart(playerDeck.deck_number, playerDeck.deck_type_id, 0, this.extra_quest.quest_extra_s.ID, this.friend == null ? "" : this.friend.target_player_id, this.friend == null ? 0 : this.friend.leader_player_unit_id, (System.Action<WebAPI.Response.UserError>) (error =>
      {
        Singleton<CommonRoot>.GetInstance().isLoading = false;
        WebAPI.DefaultUserErrorCallback(error);
        MypageScene.ChangeSceneOnError();
  ...
  {
    DeckInfo playerDeck = this.playerDecks[this.selectDeck];
    WebAPI.BattleCharacterStart(playerDeck.deck_number, playerDeck.deck_type_id, 0, this.char_quest.quest_character_s.ID, this.friend == null ? "" : this.friend.target_player_id, this.friend == null ? 0 : this.friend.leader_player_unit_id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      WebAPI.DefaultUserErrorCallback(error);
      MypageScene.ChangeSceneOnError();
  ...
  {
    DeckInfo playerDeck = this.playerDecks[this.selectDeck];
    WebAPI.BattleCharacterStart(playerDeck.deck_number, playerDeck.deck_type_id, 0, this.convert_quest.questS.ID, this.friend == null ? "" : this.friend.target_player_id, this.friend == null ? 0 : this.friend.leader_player_unit_id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      WebAPI.DefaultUserErrorCallback(error);
      MypageScene.ChangeSceneOnError();
  ...
  {
    DeckInfo playerDeck = this.playerDecks[this.selectDeck];
    WebAPI.BattleHarmonyStart(playerDeck.deck_number, playerDeck.deck_type_id, 0, this.convert_quest.questS.ID, this.friend == null ? "" : this.friend.target_player_id, this.friend == null ? 0 : this.friend.leader_player_unit_id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      WebAPI.DefaultUserErrorCallback(error);
      MypageScene.ChangeSceneOnError();
  ...
  {
    DeckInfo playerDeck = this.playerDecks[this.selectDeck];
    WebAPI.SeaBattleStart(playerDeck.deck_number, playerDeck.deck_type_id, 0, this.sea_quest.quest_sea_s.ID, this.friend == null ? "" : this.friend.target_player_id, this.friend == null ? 0 : this.friend.leader_player_unit_id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
  ...
  private IEnumerator SetSupplyIcons(List<PlayerItem> SupplyList)
  {
    for (int i = 0; i < SupplyList.Count; ++i)
    {
      ...
      if (Singleton<NGGameDataManager>.GetInstance().IsSea)
        itemIconScript.transform.localScale = new Vector3(1f, 1f);
      else
        itemIconScript.transform.localScale = new Vector3(0.7f, 0.7f);
    ...
    for (int count = SupplyList.Count; count < Consts.GetInstance().DECK_SUPPLY_MAX; ++count)
    {
      ...
      if (Singleton<NGGameDataManager>.GetInstance().IsSea)
        ...
        component.transform.localScale = new Vector3(0.7f, 0.7f);
    }
  }

  private void setClickSupplyIconEvents(ItemIcon icon, int itemId)
  {
    icon.onClick = (System.Action<ItemIcon>) (_ => this.IbtnItemedit());
    icon.EnableLongPressEvent((System.Action<GameCore.ItemInfo>) (_ => this.StartCoroutine(this.setDetailPopup(itemId))));
  }
  ...
  private int lastSelectedNumber => this.deckIndexs[Mathf.Clamp(this.indicator.selected, 0, this.playerDecks.Length - 1)];
  ...
  public void IbtnBack()
  {
    ...
    if (instance1.HasSavedChangeSceneParam() && instance2.IsFromPopupStageList)
    {
      ...
      if (!(sceneName == "unit004_JobChange"))
      {
        if (!(sceneName == "unit004_2") && !(sceneName == "unit004_2_sea"))
          instance2.fromPopup = sceneName == "unit004_training" ? NGGameDataManager.FromPopup.Unit004Combine : NGGameDataManager.FromPopup.None;
        else if (instance2.fromPopup != NGGameDataManager.FromPopup.Unit0042SceneCharacterQuest)
      ...
      instance2.returnSceneFromQuest = (System.Action) null;
      base.backScene();
    }
    else
      this.backScene();
    ...
    switch (info.quest_type)
    {
      ...
      case CommonQuestType.Character:
        ...
        if (source.Count<StoryPlaybackCharacterDetail>() > 0)
        {
          ...
          {
            num = playbackCharacterDetail1.script_id;
  ...
  public static bool IsExtraLimitation(PlayerExtraQuestS extraQuest) => ((IEnumerable<QuestExtraLimitation>) MasterData.QuestExtraLimitationList).Any<QuestExtraLimitation>((Func<QuestExtraLimitation, bool>) (n => n.quest_s_id_QuestExtraS == extraQuest.quest_extra_s.ID));

  public static bool IsStoryLimitation(PlayerStoryQuestS storyQuest) => ((IEnumerable<QuestStoryLimitation>) MasterData.QuestStoryLimitationList).Any<QuestStoryLimitation>((Func<QuestStoryLimitation, bool>) (n => n.quest_s_id_QuestStoryS == storyQuest.quest_story_s.ID));

  public static bool IsCharaLimitation(PlayerCharacterQuestS charaQuest) => ((IEnumerable<QuestCharacterLimitation>) MasterData.QuestCharacterLimitationList).Any<QuestCharacterLimitation>((Func<QuestCharacterLimitation, bool>) (n => n.quest_s_id_QuestCharacterS == charaQuest.quest_character_s.ID));
  ...
  public static bool IsSeaLimitation(PlayerSeaQuestS seaQuest) => ((IEnumerable<QuestStoryLimitation>) MasterData.QuestStoryLimitationList).Any<QuestStoryLimitation>((Func<QuestStoryLimitation, bool>) (n => n.quest_s_id_QuestStoryS == seaQuest.quest_sea_s.ID));
  ...
  {
    if (!(bool) (UnityEngine.Object) this.topDeckModeButtons)
      return false;
    int num = this.deckMode != mode ? 1 : 0;
    this.deckMode = mode;
    ((IEnumerable<GameObject>) this.objDeckModeButtons).ToggleOnce((int) mode);
    this.objDeckModeButtons[(int) mode].GetComponent<UIButton>().isEnabled = bEnable;
  ...
  private IEnumerator doPopupEditDeckName()
  {
    ...
    if (deck.isCustom)
    {
      if (!(bool) (UnityEngine.Object) this.prefabEditDeckName_)
      {
