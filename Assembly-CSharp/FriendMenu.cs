...
public class FriendMenu : ResultMenuBase
{
  ...
  private System.Action questAutoLapSkipAction;
  [SerializeField]
  ...
  private IEnumerator popup0202501()
  {
    ...
    o.SetCallback(new System.Action(friendMenu.\u003Cpopup0202501\u003Eb__15_0));
    friendMenu.questAutoLapSkipAction = new System.Action(o.IbtnNo);
  }
  ...
  private IEnumerator popup0202502()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    friendMenu.questAutoLapSkipAction = new System.Action(friendMenu.\u003Cpopup0202502\u003Eb__16_1);
  }
  ...
  private IEnumerator popup02349()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    o.SetCallback(new System.Action(friendMenu.\u003Cpopup02349\u003Eb__17_0));
    friendMenu.questAutoLapSkipAction = new System.Action(o.IbtnNo);
  }
}
