...
public class Versus0268Menu : ResultMenuBase
{
  ...
  public void SetActiveObj()
  {
    ...
    ((IEnumerable<GameObject>) this.DirClassUnit).ForEach<GameObject>((System.Action<GameObject>) (x => x.gameObject.SetActive(false)));
    this.DirTitle.SetActive(false);
    ((IEnumerable<GameObject>) this.Campaing).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
    ((IEnumerable<GameObject>) this.DirBattleResult).ForEach<GameObject>((System.Action<GameObject>) (x => x.SetActive(false)));
  ...
  private IEnumerator ShowTitleEXP()
  {
    ...
    if (versus0268Menu.info.campaigns != null && ((IEnumerable<SM.Campaign>) versus0268Menu.info.campaigns).FirstOrDefault<SM.Campaign>((Func<SM.Campaign, bool>) (x => x.campaign_type_id == 1)) != null)
  ...
  private IEnumerator PvpCharacterIntimatesPopup()
  {
    ...
    for (int i = 0; i < versus0268Menu.intimates.Count<PvPEndPlayer_character_intimates_in_battle>(); ++i)
    {
      ...
      {
        if ((UnityEngine.Object) CharacterIntimateUpPrefab == (UnityEngine.Object) null)
        {
        ...
        bool isFinished = false;
        component.SetCallback((System.Action) (() => isFinished = true));
        while (!isFinished)
          yield return (object) null;
        yield return (object) new WaitForSeconds(0.6f);
      }
  ...
  {
    Versus0268Menu versus0268Menu = this;
    if (versus0268Menu.info.campaigns != null && ((IEnumerable<SM.Campaign>) versus0268Menu.info.campaigns).FirstOrDefault<SM.Campaign>((Func<SM.Campaign, bool>) (x => x.campaign_type_id == 2)) != null)
