...
public class ReisouCreationSkillDetail : MonoBehaviour
{
  ...
  protected System.Action cbCreation;

  public virtual IEnumerator Init(GearReisouChaosCreation recipe, System.Action cbCreation)
  {
    ...
    itemIcon.onClick = (System.Action<ItemIcon>) (item => itemIcon.OpenReisouDetailPopup(item.ItemInfo, creationSkillDetail.playerItem));
  ...
  {
    IEnumerator e;
    if ((UnityEngine.Object) this.reisouPopupReisouCreationPrefab == (UnityEngine.Object) null)
    {
