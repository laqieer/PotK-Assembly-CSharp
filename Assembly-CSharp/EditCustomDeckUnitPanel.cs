...
public class EditCustomDeckUnitPanel : MonoBehaviour
{
  ...
  public GameObject objIcon => this.iconUnit_.gameObject;

  public void setBlank()
  {
    ((IEnumerable<GameObject>) this.topStatus_).SetActives(false);
    ((IEnumerable<GameObject>) this.disabledTopStatus_).Where<GameObject>((Func<GameObject, bool>) (go => (UnityEngine.Object) go != (UnityEngine.Object) null)).SetActives(true);
    if (!(bool) (UnityEngine.Object) this.iconUnit_)
    {
  ...
  private void setBlankGear(int no, bool bDisp, bool bJingi = false)
  {
    ...
    iconGear.gameObject.SetActive(bDisp);
    if (!bDisp)
      return;
  ...
  private void setBlankEquippedUnit(int no)
  {
    ...
    this.iconEquippedUnits_[no].gameObject.SetActive(false);
    this.objLockEquippedUnits_[no].gameObject.SetActive(false);
  }

  private void setBlankAwakeSkill(bool bDisp) => this.iconAwakeSkill_.gameObject.SetActive(false);
  ...
  public IEnumerator doInitialize(PlayerCustomDeckUnit_parameter_list param)
  {
    ...
    else
    {
      ...
      customDeckUnitPanel1.btnEdit_.isEnabled = pu != (PlayerUnit) null;
      ...
      for (oIndex = 0; oIndex < customDeckUnitPanel1.iconEquippedUnits_.Length && oIndex < param.over_killers_ids.Length; ++oIndex)
      {
        ...
        {
          case -1:
            customDeckUnitPanel1.iconEquippedUnits_[oIndex].gameObject.SetActive(false);
            break;
          case 0:
            customDeckUnitPanel1.iconEquippedUnits_[oIndex].gameObject.SetActive(false);
            flag = false;
            break;
          default:
            customDeckUnitPanel1.iconEquippedUnits_[oIndex].gameObject.SetActive(true);
      ...
      {
        customDeckUnitPanel1.iconAwakeSkill_.gameObject.SetActive(true);
  ...
  private IEnumerator doSetGears(
    ...
    PlayerCustomDeckUnit_parameter_list param)
  {
    ...
    int[] imap = (object) playerUnit1 != null ? playerUnit1.equippedGearIndexMapByCustomDeck : (int[]) null;
    PlayerUnit playerUnit2 = playerUnit;
    bool flag = (object) playerUnit2 != null && playerUnit2.isPossibleEquippedGear3;
  ...
  private int? getJingiIndex(PlayerItem[] gears, bool bAwakedUnit, bool bOpenedEquippedGear3) => !bOpenedEquippedGear3 || !((IEnumerable<PlayerItem>) gears).Any<PlayerItem>((Func<PlayerItem, bool>) (x => x != (PlayerItem) null)) ? new int?() : Gears.getIndexJingiSpace(((IEnumerable<PlayerItem>) gears).Select<PlayerItem, GearGear>((Func<PlayerItem, GearGear>) (x => (object) x == null ? (GearGear) null : x.gear)).ToArray<GearGear>(), bAwakedUnit, true);
  ...
  public IEnumerator doUpdateUnit(PlayerUnit target)
  {
    ...
    {
      if ((bool) (UnityEngine.Object) this.disabledTopStatus_[index])
