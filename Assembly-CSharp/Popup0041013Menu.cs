...
public class Popup0041013Menu : BackButtonMenuBase
{
  ...
  private IEnumerator UnitSellAsync()
  {
    ...
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      popup0041013Menu.sellUnitIcons.ForEach((System.Action<PlayerUnit>) (ic =>
      {
      ...
      if (popup0041013Menu.comeFromStorage)
      {
        ...
        Future<WebAPI.Response.UnitReservesSell> ft = WebAPI.UnitReservesSell(player_unit_ids.ToArray(), new System.Action<WebAPI.Response.UserError>(popup0041013Menu.\u003CUnitSellAsync\u003Eb__12_1));
        e1 = ft.Wait();
        while (e1.MoveNext())
      ...
      {
        // ISSUE: reference to a compiler-generated method
        Future<WebAPI.Response.UnitSell> ft = WebAPIUtil.UnitSell(player_material_unit_ids.ToArray(), player_unit_ids.ToArray(), new System.Action<WebAPI.Response.UserError>(popup0041013Menu.\u003CUnitSellAsync\u003Eb__12_4));
        e1 = ft.Wait();
        while (e1.MoveNext())
          yield return e1.Current;
        e1 = (IEnumerator) null;
