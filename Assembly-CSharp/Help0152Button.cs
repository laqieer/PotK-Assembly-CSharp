...
public class Help0152Button : MonoBehaviour
{
  ...
  private UnityEngine.Sprite helpSprite;
  ...
  public IEnumerator setTextHelp01(string str, HelpHelp help)
  {
    ...
    if (help.image_name != "")
    {
      Future<UnityEngine.Sprite> textureF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Help/" + help.image_name);
      e = textureF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
