...
public class NGGameDataManager : Singleton<NGGameDataManager>
{
  ...
  public void Set_opened_equip_number_player_unit_ids(int[] ids) => this.opened_equip_number_player_unit_ids = ids != null ? new HashSet<int>((IEnumerable<int>) ids) : new HashSet<int>();
  ...
  public bool IsHotDealActive => this.HotDealInfo != null && ((IEnumerable<SM.HotDealInfo>) this.HotDealInfo).Any<SM.HotDealInfo>((Func<SM.HotDealInfo, bool>) (x => x.IsActive));
  ...
  public System.Action returnSceneFromQuest { get; set; }

  public System.Action<GameObject[], NGMenuBase> OpenPopup { private get; set; }
  ...
  public void clearScenePopupRecovery()
  {
    ...
    this.returnSceneFromQuest = (System.Action) null;
    this.OpenPopup = (System.Action<GameObject[], NGMenuBase>) null;
    this.setSceneChangeLog();
  }

  public void OnceOpenPopup<T>(T[] prefabLoaders, NGMenuBase menu, System.Action preOpenPopup) where T : class
  {
  ...
  private IEnumerator doOpenPopup<T>(
    T[] prefabLoaders,
    NGMenuBase menu,
    System.Action preOpenPopup,
    System.Action<GameObject[], NGMenuBase> openPopup)
  {
    if (openPopup != null)
    {
      System.Action action = preOpenPopup;
      if (action != null)
        action();
      GameObject[] prefabs;
  ...
  private void OnApplicationPause(bool pause)
  {
    ...
    if (pause)
    {
      ...
      {
        int seconds = Mathf.FloorToInt(this.timeInstance.BpFullRecoverySeconds);
        if (seconds > 0)
          LocalNotification.ScheduleWithTimeInterval(new LocalNotification.Notification()
          {
  ...
  private IEnumerator UpdateGuildTop()
  {
    ...
    {
      Future<WebAPI.Response.GuildTop> handler = WebAPI.GuildTop(Persist.guildHeaderChat.Data.latestLogId, (System.Action<WebAPI.Response.UserError>) (e => Debug.LogError((object) ("GameManager Failed Update Guild : " + e.Code))));
      ...
      else
      {
        ...
        Future<WebAPI.Response.GuildlogAutoupdate> future = WebAPI.SilentGuildlogAutoupdate("0", (System.Action<WebAPI.Response.UserError>) (e => {}));
        e1 = future.Wait();
        while (e1.MoveNext())
          yield return e1.Current;
        e1 = (IEnumerator) null;
    ...
    Promise<NGGameDataManager.StartSceneProxyResult> promise)
  {
    ...
    while (true)
    {
        ...
        if (flag || WebAPI.LastPlayerBoot.player_is_create)
        {
          ...
          if (ngGameDataManager.isSea)
          {
            if (ngGameDataManager.isCallHomeUpdateAllData)
            {
              ...
              Future<WebAPI.Response.SeaStartUp2> handler = WebAPI.SeaStartUp2(new System.Action<WebAPI.Response.UserError>(ngGameDataManager.\u003CStartSceneAsyncProxyImpl\u003Eb__193_0));
              e1 = handler.Wait();
              while (e1.MoveNext())
                yield return e1.Current;
              e1 = (IEnumerator) null;
            ...
            else
            {
              ...
              // ISSUE: reference to a compiler-generated method
              Future<WebAPI.Response.SeaStartUp> handler = WebAPI.SeaStartUp(new System.Action<WebAPI.Response.UserError>(ngGameDataManager.\u003CStartSceneAsyncProxyImpl\u003Eb__193_1));
              e1 = handler.Wait();
              while (e1.MoveNext())
                yield return e1.Current;
              e1 = (IEnumerator) null;
      ...
      {
        e1 = WebAPI.PlayerHelpers(0, (System.Action<WebAPI.Response.UserError>) (e => Debug.LogError((object) ("GameManager Failed Update PlayerHelper : " + e.Code)))).Wait();
        while (e1.MoveNext())
          yield return e1.Current;
        e1 = (IEnumerator) null;
        GuildUtil.resetSettingPersist();
...
label_74:
  ...
  private void postStartUp2(WebAPI.Response.SeaStartUp2 result) => this.Set_opened_equip_number_player_unit_ids(result.opened_equip_number_player_unit_ids);
    ...
    else
    {
      ...
      if (WebAPI.LastPlayerBoot.player_during_battle)
      {
        ...
        if (this.isCallHomeUpdateAllData)
        {
          ...
          handler.RunOn<WebAPI.Response.HomeStartUp2>((MonoBehaviour) this, (System.Action<WebAPI.Response.HomeStartUp2>) (_ =>
          {
            this.isCallHomeUpdateAllData = false;
            this.postStartUp2(handler.Result);
          ...
          WebAPI.HomeStartUp().RunOn<WebAPI.Response.HomeStartUp>((MonoBehaviour) this, (System.Action<WebAPI.Response.HomeStartUp>) (_ => Singleton<NGBattleManager>.GetInstance().startBattle((BattleInfo) null, WebAPI.LastPlayerBoot.continue_count)));
      }
      else if (WebAPI.LastPlayerBoot.player_during_sea_battle)
      {
        ...
        else
        {
          ...
          handler.RunOn<WebAPI.Response.SeaStartUp>((MonoBehaviour) this, (System.Action<WebAPI.Response.SeaStartUp>) (_ =>
          {
            this.SetTablePieceSameCharacterIds(handler.Result.gettable_piece_same_character_ids);
            Singleton<NGBattleManager>.GetInstance().startBattle((BattleInfo) null, WebAPI.LastPlayerBoot.continue_count);
          }));
      ...
      else if (WebAPI.LastPlayerBoot.player_during_tower_battle)
      {
        ...
        if (this.isCallHomeUpdateAllData)
        {
          ...
          WebAPI.HomeStartUp().RunOn<WebAPI.Response.HomeStartUp>((MonoBehaviour) this, (System.Action<WebAPI.Response.HomeStartUp>) (_ => Singleton<NGBattleManager>.GetInstance().startBattle(bi, WebAPI.LastPlayerBoot.continue_count)));
      }
      ...
      else if (WebAPI.LastPlayerBoot.player_during_pvp)
      {
        ...
        if (this.isCallHomeUpdateAllData)
        {
          ...
          WebAPI.HomeStartUp().RunOn<WebAPI.Response.HomeStartUp>((MonoBehaviour) this, (System.Action<WebAPI.Response.HomeStartUp>) (_ =>
          {
            BattleInfo battleInfo = new BattleInfo();
            battleInfo.pvp = true;
            battleInfo.pvp_restart = true;
      ...
      else if (WebAPI.LastPlayerBoot.player_during_pvp_result)
      {
        if (this.isCallHomeUpdateAllData)
        {
          ...
          WebAPI.HomeStartUp().RunOn<WebAPI.Response.HomeStartUp>((MonoBehaviour) this, (System.Action<WebAPI.Response.HomeStartUp>) (_ => Singleton<NGSceneManager>.GetInstance().changeScene("versus026_8", false)));
      }
      ...
      else if (WebAPI.LastPlayerBoot.during_retry_gacha)
      {
        ...
        if (this.isCallHomeUpdateAllData)
        {
          ...
          WebAPI.HomeStartUp().RunOn<WebAPI.Response.HomeStartUp>((MonoBehaviour) this, (System.Action<WebAPI.Response.HomeStartUp>) (_ => Gacha00613Scene.ChangeScene(false, true)));
      }
      else
      {
  ...
  public void resetOverkillersSlotReleaseConditions() => this.dicOverkillersSlotReleaseConditions.Clear();
  ...
  public NGGameDataManager.UnitTrainingOption unitTrainingOption => this.unitTrainingOption_ ?? (this.unitTrainingOption_ = new NGGameDataManager.UnitTrainingOption());
  ...
  public void setSceneChangeLog(List<NGSceneManager.SavedSceneLog> log = null) => this.sceneChangeLog_ = log;
  ...
  public IEnumerator downloadGachaPickupSelect(
    int gacha_id,
    System.Action<WebAPI.Response.GachaG301PickupSelectPlayerPickup> callbackResult,
    System.Action<WebAPI.Response.UserError> actError = null)
  {
  ...
  public class TimeCounter
  {
    ...
    public float ApRecoverySecondsPerPoint => this.player.Value == null || this.player.Value.ap >= this.player.Value.ap_max ? 0.0f : (float) this.player.Value.ap_auto_healing_sec - this.apElapsedSeconds;

    public float ApFullRecoverySeconds => this.player.Value == null ? 0.0f : (float) ((this.player.Value.ap_max - this.player.Value.ap) * this.player.Value.ap_auto_healing_sec) - this.apElapsedSeconds;

    public float BpRecoverySecondsPerPoint => this.player.Value == null || this.player.Value.bp >= this.player.Value.bp_max ? 0.0f : (float) this.player.Value.bp_auto_healing_sec - this.bpElapsedSeconds;

    public float BpFullRecoverySeconds => this.player.Value == null ? 0.0f : (float) ((this.player.Value.bp_max - this.player.Value.bp) * this.player.Value.bp_auto_healing_sec) - this.bpElapsedSeconds;

    public float DpRecoverySecondsPerPoint => this.seaPlayer.Value == null || this.seaPlayer.Value.dp >= this.seaPlayer.Value.dp_max ? 0.0f : (float) this.seaPlayer.Value.dp_auto_healing_sec - this.dpElapsedSeconds;

    public float DpFullRecoverySeconds => this.seaPlayer.Value == null ? 0.0f : (float) ((this.seaPlayer.Value.dp_max - this.seaPlayer.Value.dp) * this.seaPlayer.Value.dp_auto_healing_sec) - this.dpElapsedSeconds;
  ...
  public class Boost
  {
    ...
    public float? XExperience => Array.Find<BoostXExperience>(MasterData.BoostXExperienceList, (Predicate<BoostXExperience>) (x => ((IEnumerable<int>) this.m_PeriodActiveList).Contains<int>(x.period_BoostPeriod)))?.scale;
