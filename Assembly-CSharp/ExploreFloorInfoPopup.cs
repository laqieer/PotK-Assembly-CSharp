...
public class ExploreFloorInfoPopup : BackButtonMenuBase
{
  ...
  {
    if ((UnityEngine.Object) this.mCreateIconPrefab == (UnityEngine.Object) null)
    {
  ...
  private void SetupWeakPointIcon(List<ExploreEnemy> floorEnemyList)
  {
    ...
    {
      CommonElementIcon component = this.mElementIconPrefab.CloneAndGetComponent<CommonElementIcon>(this.mWeakPointGridElement.transform);
      component.Init(element);
      UI2DSprite componentInChildren = component.GetComponentInChildren<UI2DSprite>();
      componentInChildren.width = 46;
      componentInChildren.height = 42;
      componentInChildren.depth = 100;
    }
    this.mWeakPointGridElement.Reposition();
    foreach (GearKindEnum kind in gearKindEnumSet)
    {
      GearKindButtonIcon component = this.mGearKindIconPrefab.CloneAndGetComponent<GearKindButtonIcon>(this.mWeakPointGridGearKind.transform);
      component.Init(kind);
      UI2DSprite componentInChildren = component.GetComponentInChildren<UI2DSprite>();
      componentInChildren.width = 46;
      componentInChildren.height = 42;
    ...
    {
      PrincessTypeIcon component = this.mPrincessTypeIconPrefab.CloneAndGetComponent<PrincessTypeIcon>(this.mWeakPointGridPrincessType.transform);
      component.SetPrincessType(unitType);
      component.GetComponentInChildren<UISprite>().depth = 100;
    }
  ...
  {
    ExploreFloorInfoPopup exploreFloorInfoPopup = this;
    exploreFloorInfoPopup.mRewardScroll.scrollView.panel.alpha = 0.0f;
    ...
    exploreFloorInfoPopup.mRewardScroll.GridReposition(new UIGrid.OnReposition(exploreFloorInfoPopup.\u003CSetupDropRewardIcon\u003Eb__12_0));
  }
  ...
  private IEnumerator CreateRewardIcon(int rewardId)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    createIcon.transform.localScale = new Vector3(0.8f, 0.8f, 1f);
