...
public class Bugu005510Menu : BackButtonMenuBase
{
  ...
  public void Show(PlayerItem[] playerItems) => this.StartCoroutine(this.SetSelectedItemIcons(playerItems));
  ...
  private IEnumerator SetSelectedItemIcons(PlayerItem[] playerItems)
  {
    ...
    this.SetBuguForm1.SetActive((uint) (rarePlayerItems.Count % 2) > 0U);
