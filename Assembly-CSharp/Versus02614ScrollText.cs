...
public class Versus02614ScrollText : MonoBehaviour
{
  ...
  public IEnumerator Init(PvPRankingPlayer data, GameObject iconPrefab)
  {
    if (data != null)
    {
      ...
      this.TxtVictory.gameObject.SetActive(false);
      this.TxtLose.gameObject.SetActive(false);
      this.TxtTotalVictory.gameObject.SetActive(true);
      ...
      Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadEmblemSprite(data.current_emblem_id);
      e = sprF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
