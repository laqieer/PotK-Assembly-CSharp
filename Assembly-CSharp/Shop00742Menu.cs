...
public class Shop00742Menu : MonoBehaviour
{
  ...
  {
    IEnumerator e = this.GetComponent<ItemDetailPopupBase>().SetInfo(type, id);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  {
    ItemDetailPopupBase component = this.GetComponent<ItemDetailPopupBase>();
  ...
  public static bool IsEnableShowPopup(MasterDataTable.CommonRewardType type) => type == MasterDataTable.CommonRewardType.unit || type == MasterDataTable.CommonRewardType.material_unit || (type == MasterDataTable.CommonRewardType.gear || type == MasterDataTable.CommonRewardType.material_gear) || (type == MasterDataTable.CommonRewardType.gear_body || type == MasterDataTable.CommonRewardType.quest_key) || type == MasterDataTable.CommonRewardType.season_ticket;
}
