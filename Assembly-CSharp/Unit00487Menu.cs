...
public class Unit00487Menu : Unit00486Menu
{
    ...
    int selMax)
  {
    ...
    unit00487Menu.InitializeInfoEx((IEnumerable<PlayerUnit>) playerUnitArray, (IEnumerable<PlayerMaterialUnit>) array, Persist.unit00487SortAndFilter, isEquip, false, true, true, true, false, (System.Action) (() => this.InitializeAllUnitInfosExtend(playerDeck)));
