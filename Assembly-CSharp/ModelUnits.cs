...
public class ModelUnits : MonoBehaviour
{
  ...
  {
    if (!((UnityEngine.Object) ModelUnits.instance == (UnityEngine.Object) this))
      return;
      ...
      for (int i = 0; i < 5; ++i)
      {
        ...
        else
        {
          ...
          if (modelUnits.PlayerDecks[j].player_units[i] != (PlayerUnit) null)
          {
            ...
            while ((UnityEngine.Object) ui3DModel.model_creater_.UnitModel == (UnityEngine.Object) null)
              yield return (object) null;
          }
          ui3DModel.ModelCamera.transform.localPosition = new Vector3((float) (j * 1000), (float) (i * 1000), 0.0f);
  ...
  public GameObject InstantiateModelUnits(GameObject character) => this.Characters.ContainsValue(character) ? ObjectPoolController.Instantiate(character) : (GameObject) null;

  public void DestroyModelUnits()
  {
    for (int index = 0; index < this.ModelList.Count; ++index)
    {
      if ((bool) (UnityEngine.Object) this.ModelList[index] && (bool) (UnityEngine.Object) this.ModelList[index].gameObject)
  ...
  private void LayerChange(int layer, Transform to)
  {
    ...
    foreach (Component componentsInChild in to.GetComponentsInChildren<Transform>())
  ...
  public void DidReceiveMemoryWarning(string message)
  {
    ...
    for (int index = 0; index < this.ModelList.Count; ++index)
    {
      if ((bool) (UnityEngine.Object) this.ModelList[index].gameObject)
      {
        this.ModelList[index].SetActive(false);
        UnityEngine.Object.Destroy((UnityEngine.Object) this.ModelList[index]);
      }
    }
