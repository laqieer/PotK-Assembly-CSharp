...
public class Quest00214Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_14", stack);

  public static void ChangeScene(bool stack, int unitId) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_14", (stack ? 1 : 0) != 0, (object) unitId, (object) false, (object) false);

  public static void ChangeScene(bool stack, int unitOrQuestId, bool is_change_combi) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_14", (stack ? 1 : 0) != 0, (object) unitOrQuestId, (object) is_change_combi, (object) false);

  public static void ChangeScene(bool stack, int unitId, bool is_change_combi, bool isSameUnit) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_14", (stack ? 1 : 0) != 0, (object) unitId, (object) is_change_combi, (object) isSameUnit);
    ...
    bool isSameUnit)
  {
    ...
    if (quest00214Scene.isInit)
    {
      ...
      if (apiF.Result != null)
      {
        ...
        LambdaEqualityComparer<UnitUnit> equalityComparer = new LambdaEqualityComparer<UnitUnit>((Func<UnitUnit, UnitUnit, bool>) ((a, b) => a.resource_reference_unit_id_UnitUnit == b.resource_reference_unit_id_UnitUnit));
        ...
        foreach (UnitUnit unitUnit in ((IEnumerable<QuestCharacterS>) array1).Select<QuestCharacterS, int>((Func<QuestCharacterS, int>) (y => y.unit_UnitUnit)).Distinct<int>().Select<int, UnitUnit>((Func<int, UnitUnit>) (n => MasterData.UnitUnit[n])).Distinct<UnitUnit>((IEqualityComparer<UnitUnit>) equalityComparer))
          stringList.AddRange((IEnumerable<string>) unitUnit.GetUIResourcePaths());
  ...
  private List<int> getUnits(QuestHarmonyS quest)
  {
    ...
    if (quest.target_unit2_UnitUnit.HasValue && quest.target_unit2_UnitUnit.Value != 0)
      intList.Add(quest.target_unit2_UnitUnit.Value);
    return intList;
  }
