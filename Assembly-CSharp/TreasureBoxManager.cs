...
public class TreasureBoxManager : BattleManagerBase
{
  ...
  public void execute(
    ...
    BL.Panel panel,
    Vector3 target,
    System.Action<BL.DropData> firstCallback,
    System.Action<BL.DropData> endCallback,
    float time)
  {
  ...
  private class Continuer
  {
    ...
    private System.Action<BL.DropData> firstCallback;
    private System.Action<BL.DropData> endCallback;
    ...
    public void execute(TreasureBoxManager tm)
    {
      ...
      if (this.drop.isDropBox)
      {
        ...
        Vector3 vector3 = Vector3.forward * Vector3.Distance(this.boxObject.transform.position, componentsInChildren[0].transform.position);
        this.targetPosition = componentsInChildren[0].ScreenToWorldPoint(this.target + vector3);
        this.velocity = Vector3.zero;
        foreach (Camera camera in componentsInChildren)
        {
          if (camera.name == "3D Camera Front")
          {
            this.frontCamera = camera;
            this.cameraParent = this.frontCamera.transform.parent;
            this.frontCamera.transform.parent = (Transform) null;
          }
        }
      }
    ...
    {
      if ((UnityEngine.Object) this.boxObject == (UnityEngine.Object) null)
        return;
    ...
    {
      if (this.endCallback == null && (UnityEngine.Object) this.boxObject == (UnityEngine.Object) null || this.isDoEndRunning)
        return;
      ...
      {
        if (!((UnityEngine.Object) this.moveEffect != (UnityEngine.Object) null))
          return;
        ...
        if ((double) Vector3.Distance(this.moveEffect.transform.position, this.targetPosition) >= 0.00999999977648258)
          return;
        tm.StartCoroutine(this.doEnd(tm));
      }
    }
    ...
    private IEnumerator doEnd(TreasureBoxManager tm)
    {
      ...
      if ((UnityEngine.Object) this.boxObject != (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) this.frontCamera != (UnityEngine.Object) null)
        {
          this.frontCamera.transform.parent = this.cameraParent;
          this.frontCamera.transform.localPosition = Vector3.zero;
          this.frontCamera = (Camera) null;
        }
        UnityEngine.Object.Destroy((UnityEngine.Object) this.boxObject);
        ...
        if (this.endCallback != null)
        {
          ...
          this.endCallback = (System.Action<BL.DropData>) null;
