  ...
  public class MeshIDList
  {
    ...
    public AnimationItemIcon SetCloneIcon(GameObject obj)
    {
      if ((Object) this.icon == (Object) null)
        this.icon = obj.Clone(this.mesh.transform).GetComponent<AnimationItemIcon>();
      this.icon.transform.localPosition = new Vector3(0.0f, 0.0f, -0.05f);
      this.icon.gameObject.name = "AnimationItemIcon";
