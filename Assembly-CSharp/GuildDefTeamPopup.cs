...
public class GuildDefTeamPopup : MonoBehaviour
{
    ...
    System.Action success = null)
  {
    ...
    IEnumerator e = GuildUtil.UpdateGuildDeckDefanse(isEnemy ? menu.EnGuild.guild_id : menu.MyGuild.guild_id, info.player.player_id, (System.Action) (() => isSuccess = true));
    while (e.MoveNext())
    ...
    if (isSuccess)
    {
      ...
      if ((UnityEngine.Object) parent.teamEditPopup != (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) parent.guestSelectPopup != (UnityEngine.Object) null)
      {
  ...
  public IEnumerator ShowGuestSelect()
  {
    ...
    Future<WebAPI.Response.GvgDeckReinforcementCandidates> ft = WebAPI.GvgDeckReinforcementCandidates(true, (System.Action<WebAPI.Response.UserError>) (e =>
    {
