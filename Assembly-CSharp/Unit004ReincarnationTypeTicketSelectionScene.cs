...
public class Unit004ReincarnationTypeTicketSelectionScene : NGSceneBase
{
  ...
  public static void changeScene(bool isStack = true) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_Reincarnation_Type_TicketSelection", isStack);
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    {
      Future<WebAPI.Response.UnittypeticketIndex> future = WebAPI.UnittypeticketIndex((System.Action<WebAPI.Response.UserError>) (e =>
      {
  ...
  private int GetTicketsPriority(UnitTypeTicket[] ticketsDataList, PlayerUnitTypeTicket ticket) => ((IEnumerable<UnitTypeTicket>) ticketsDataList).First<UnitTypeTicket>((Func<UnitTypeTicket, bool>) (x => x.ID == ticket.ticket_id)).priority;
