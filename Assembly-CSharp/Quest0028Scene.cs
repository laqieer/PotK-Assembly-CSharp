...
public class Quest0028Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, PlayerStoryQuestS story_quest, bool story_only = false) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_8", (stack ? 1 : 0) != 0, (object) story_quest, (object) story_only);

  public static void changeScene(bool stack, PlayerExtraQuestS extra_quest, bool story_only = false) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_8", (stack ? 1 : 0) != 0, (object) extra_quest, (object) story_only);

  public static void changeScene(bool stack, PlayerCharacterQuestS char_quest, bool story_only = false) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_8", (stack ? 1 : 0) != 0, (object) char_quest, (object) story_only);

  public static void changeScene(bool stack, PlayerQuestSConverter char_quest, bool story_only = false) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_8", (stack ? 1 : 0) != 0, (object) char_quest, (object) story_only);

  public static void changeScene(bool stack, PlayerSeaQuestS sea_quest, bool story_only = false) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_8_sea", (stack ? 1 : 0) != 0, (object) sea_quest, (object) story_only);
