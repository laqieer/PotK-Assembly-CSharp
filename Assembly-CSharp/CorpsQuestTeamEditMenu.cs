...
public class CorpsQuestTeamEditMenu : UnitSelectMenuBase
{
  ...
  private IEnumerator EditTeam()
  {
    ...
    Future<WebAPI.Response.QuestCorpsDeckEdit> f = WebAPI.QuestCorpsDeckEdit(questTeamEditMenu.playerCorps.period_id, questTeamEditMenu.selectedUnitIcons.OrderBy<UnitIconInfo, int>((Func<UnitIconInfo, int>) (x => x.select)).Select<UnitIconInfo, int>((Func<UnitIconInfo, int>) (x => x.playerUnit.id)).ToArray<int>(), (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
  ...
  private IEnumerator ShowComfirmPopup()
  {
    ...
    IEnumerator e = popup.GetComponent<CorpsQuestTeamEditComfirmPopup>().InitializeAsync(questTeamEditMenu.selectedUnitIcons.OrderBy<UnitIconInfo, int>((Func<UnitIconInfo, int>) (x => x.select)).ToList<UnitIconInfo>(), questTeamEditMenu.unitPrefab, questTeamEditMenu.goHpGauge, new System.Action(questTeamEditMenu.\u003CShowComfirmPopup\u003Eb__11_1));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public IEnumerator InitializeAsync(PlayerCorps corps)
  {
    ...
    else
    {
      ...
      questTeamEditMenu.InitializeInfo((IEnumerable<PlayerUnit>) questTeamEditMenu.playerUnits, (IEnumerable<PlayerMaterialUnit>) null, Persist.corpsUnitListSortAndFilter, false, false, true, true, true, new System.Action(questTeamEditMenu.InitializeAllUnitInfosExtend));
  ...
  protected override IEnumerator CreateUnitIconBase(GameObject prefab)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) questTeamEditMenu.goHpGauge != (UnityEngine.Object) null)
    {
