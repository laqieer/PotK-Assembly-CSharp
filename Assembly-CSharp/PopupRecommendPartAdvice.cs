...
public class PopupRecommendPartAdvice : PopupRecommendPart
{
  ...
  public override IEnumerator doInitialize(PlayerUnit playerUnit, UnitUnit target)
  {
    ...
    {
      recommendPartAdvice.gameObject.SetActive(false);
    }
    else
    {
      ...
      recommendPartAdvice.gameObject.SetActive(true);
  ...
  {
    if ((Object) this.fullPrefab_ == (Object) null)
    {
  ...
  private void setHeadline(string txt) => this.objFull_.SetActive(this.txtHeadline_.SetHeadline(txt));
