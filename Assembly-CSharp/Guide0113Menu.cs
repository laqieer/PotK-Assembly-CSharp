...
public class Guide0113Menu : GuideZukanListManager
{
  ...
  public override void SortAndFilter()
  {
    ...
    ((IEnumerable<UnitUnit>) MasterData.UnitUnitList).Where<UnitUnit>((Func<UnitUnit, bool>) (x => x.character.category == UnitCategory.enemy)).ToList<UnitUnit>().ForEach((System.Action<UnitUnit>) (obj =>
    {
