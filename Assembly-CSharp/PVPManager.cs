...
public class PVPManager : Singleton<PVPManager>, IGameEngine
{
  ...
  {
    PVPMatching pvpMatching = this.gameObject.GetComponent<PVPMatching>();
    if ((UnityEngine.Object) pvpMatching == (UnityEngine.Object) null)
      pvpMatching = this.gameObject.AddComponent<PVPMatching>();
    return pvpMatching;
  }
    ...
    bool isRestart)
  {
    ...
    if ((UnityEngine.Object) pvpManager.bm == (UnityEngine.Object) null)
    ...
    else
    {
      ...
      pvpManager.bm.environment.core.phaseState.setStateWith(BL.Phase.pvp_restart, pvpManager.bm.environment.core, (System.Action) (() => {}));
      pvpManager.StartCoroutine(pvpManager.doErrorRecovery(true));
    }
    promise.Result = None.Value;
  }

  public Future<AppPeer> connectServer(string host, int port, string battleToken) => new Future<AppPeer>((Func<Promise<AppPeer>, IEnumerator>) (promise => this._connectServer(promise, host, port, battleToken)));
  ...
  private IEnumerator initPrefabs()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.loadingPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator doPvpDisposition()
  {
    ...
    while (true)
    {
      ...
      {
        if ((bool) (UnityEngine.Object) this.selectNode)
...
label_41:
  ...
  private IEnumerator doPvpMain()
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    while ((UnityEngine.Object) this.btm == (UnityEngine.Object) null || this.btm.isRunning)
      ...
      while (e.MoveNext())
      {
        ...
        else
        {
          if (sm.sceneName != this.bm.topScene)
            this.btm.setScheduleAction(closure_2 ?? (closure_2 = (System.Action) (() => sm.backScene())));
          yield return e.Current;
        }
      }
      e = (IEnumerator) null;
            ...
            else
            {
              ...
              if (this.timeLimit.value == 0 && env.core.phaseState.state == BL.Phase.player)
              {
                while (sm.changeSceneQueueCount > 0 || !sm.isSceneInitialized)
                  yield return (object) new WaitForSeconds(0.1f);
                if (sm.sceneName != this.bm.topScene)
                  this.btm.setScheduleAction(closure_3 ?? (closure_3 = (System.Action) (() => sm.backScene())));
                this._viewLoading(true);
            ...
            this.btm.setScheduleAction((System.Action) (() =>
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  this.btm.setScheduleAction((System.Action) null, 1.5f, (System.Action) (() =>
                  {
                    ...
                    __nonvirtual (this.actionUnitCompleted());
                  }));
                }
  ...
  private IEnumerator hideLoading()
  {
    if (this.isLoading)
    {
      float seconds = this.loadingMinTime - (float) (DateTime.Now - this.loadingStartTime).TotalSeconds;
  ...
  public static PVPManager createPVPManager()
  {
    ...
    if ((UnityEngine.Object) pvpManager == (UnityEngine.Object) null)
  ...
  public static IEnumerator destroyPVPManager()
  {
    ...
    if (!((UnityEngine.Object) pm == (UnityEngine.Object) null))
    {
      IEnumerator e = pm.cleanupPVP();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      PVPMatching component = pm.gameObject.GetComponent<PVPMatching>();
      if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        component.cleanupDestroy();
      UnityEngine.Object.Destroy((UnityEngine.Object) pm.gameObject);
      pm.clearInstance();
    }
  }
  ...
  private HashSet<BL.Panel> createFormationPanels(int order)
  {
    ...
    foreach (PvpStageFormation pvpStageFormation in ((IEnumerable<PvpStageFormation>) MasterData.PvpStageFormationList).Where<PvpStageFormation>((Func<PvpStageFormation, bool>) (x => x.stage.ID == this.stage.stage_id)).Where<PvpStageFormation>((Func<PvpStageFormation, bool>) (x => x.player_order == order)))
      panelSet.Add(environment.core.getFieldPanel(pvpStageFormation.formation_y - 1, pvpStageFormation.formation_x - 1));
    return panelSet;
  }
  ...
  public void turnInitializeCompleted()
  {
    ...
    this.btm.setScheduleAction((System.Action) (() => this.StartCoroutine(this._TurnInitializeCompleted())));
  }
  ...
  private void resetPosition(BL.UnitPosition up, int row, int column, bool resetDirection)
  {
    ...
    PvpStageFormation pvpStageFormation2 = ((IEnumerable<PvpStageFormation>) MasterData.PvpStageFormationList).First<PvpStageFormation>((Func<PvpStageFormation, bool>) (x => x.stage.ID == this.stage.stage_id && (uint) x.player_order > 0U));
  ...
  public void PopupBattleReceiveError(string title, string description, string errorCode = "") => ModalWindow.ShowYesNo(title, string.Format(description, (object) errorCode), (System.Action) (() => this.errorRecovery()), (System.Action) (() => this.btm.setPhaseState(BL.Phase.finalize)));

  private void finishBattle(AppPeer.FinishBattle freq)
  {
    this.bm.battleEffects.startEffect((Transform) null, 3f, popupPrefab: this.winLosePrefab, cloneAction: ((System.Action<GameObject>) (o => o.GetComponent<PopupPvpMatchResult>().setResult(freq, this.playerOrder))));
  ...
  private IEnumerator noRoomFinish(AppPeer.NoRoom nreq)
  {
    ...
    Future<WebAPI.Response.PvpPlayerStatus> futureP = WebAPI.PvpPlayerStatus(new System.Action<WebAPI.Response.UserError>(pvpManager.errorCallback));
    ...
    if (futureP.Result != null)
    {
      ...
      bool close = false;
      ModalWindow.Show(title, message, (System.Action) (() => close = true));
      while (!close)
        yield return (object) null;
  ...
  private void errorCallback(WebAPI.Response.UserError error) => Singleton<NGSceneManager>.GetInstance().StartCoroutine(PopupCommon.Show(error.Code, error.Reason, (System.Action) (() =>
  {
