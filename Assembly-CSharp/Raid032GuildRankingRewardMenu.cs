...
public class Raid032GuildRankingRewardMenu : BackButtonMenuBase
{
  ...
  private void Start() => this.backBtn.onClick.Add(new EventDelegate((EventDelegate.Callback) (() => this.onBackButton())));
  ...
  private IEnumerator SetRewardInfo(bool isImmediate = false)
  {
    ...
    {
      Versus02612ScrollRewardBox component = rankingRewardMenu.rewardBox.Clone(rankingRewardMenu.body.transform).GetComponent<Versus02612ScrollRewardBox>();
