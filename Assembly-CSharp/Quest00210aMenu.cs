...
public class Quest00210aMenu : BackButtonMenuBase
{
  ...
  public IEnumerator InitSupplyList(Quest00210Menu.Param param, bool fromTower)
  {
    ...
    {
      quest00210aMenu.scroll.Add(quest00210aMenu.allSupplyIcon[index].gameObject, quest00210aMenu.iconWidth, quest00210aMenu.iconHeight);
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        else if ((double) num5 < -((double) num4 - (double) num1))
        {
          ...
          int? nullable = this.showSupplyItems.FirstIndexOrNull<SupplyItem>((Func<SupplyItem, bool>) (v => (UnityEngine.Object) v.icon != (UnityEngine.Object) null && (UnityEngine.Object) v.icon.gameObject == (UnityEngine.Object) item));
          int num7 = nullable.Value - num6;
          if (nullable.HasValue && num7 >= 0)
          {
            item.transform.localPosition = new Vector3(item.transform.localPosition.x, item.transform.localPosition.y + num4, 0.0f);
            if (this.showSupplyItems[num7].removeButton || ItemIcon.IsCache(this.showSupplyItems[num7]))
              this.CreateItemIconCache(num7, item_index);
            else
              this.StartCoroutine(this.CreateItemIcon(num7, item_index));
            flag = true;
          }
        }
        ++item_index;
  ...
  private void ResetItemIcon(int index) => this.allSupplyIcon[index].gameObject.SetActive(false);
  ...
  private void SetIconGray()
  {
    ...
    if (this.currSelectedItemList.Count >= Consts.GetInstance().DECK_SUPPLY_MAX)
    {
      for (int index = 0; index < showSupplyItems.Count; ++index)
      {
        if (showSupplyItems[index].SelectCount < 1)
        {
          ...
          showSupplyItems[index].icon.supply.button.enabled = false;
        }
      }
    }
    else
    {
      for (int index = 0; index < showSupplyItems.Count; ++index)
      {
        ...
        showSupplyItems[index].icon.supply.button.enabled = true;
      }
    }
  }
  ...
  private IEnumerator OpenTowerPopup()
  {
    ...
    Future<GameObject> f;
    IEnumerator e;
    if ((UnityEngine.Object) quest00210aMenu.confirmPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) quest00210aMenu.warningPopup == (UnityEngine.Object) null)
    {
    ...
    // ISSUE: reference to a compiler-generated method
    prefab.GetComponent<Tower029SupplyConfirmPopup>().Initialize(new System.Action(quest00210aMenu.\u003COpenTowerPopup\u003Eb__61_0));
  ...
  private IEnumerator OpenCorpsPopup()
  {
    ...
    if ((UnityEngine.Object) quest00210aMenu.iconPrefab == (UnityEngine.Object) null)
    {
    ...
    prefab.SetActive(false);
    // ISSUE: reference to a compiler-generated method
    prefab.GetComponent<Tower029SupplyConfirmPopup>().Initialize(new System.Action(quest00210aMenu.\u003COpenCorpsPopup\u003Eb__62_0));
    prefab.SetActive(true);
    Singleton<PopupManager>.GetInstance().open(prefab, isCloned: true);
  }
  ...
  private IEnumerator SetTowerSelectionUnitAndSupply()
  {
    ...
    {
      Future<WebAPI.Response.TowerRestart> f = WebAPI.TowerRestart(intList1.ToArray(), intList2.ToArray(), quest00210aMenu.towerSelectedUnitIDs, quest00210aMenu.towerProgress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
    ...
    {
      Future<WebAPI.Response.TowerReassign> f = WebAPI.TowerReassign(intList1.ToArray(), intList2.ToArray(), TowerUtil.PayRecoveryCoinNum == 0, quest00210aMenu.towerSelectedUnitIDs, quest00210aMenu.towerProgress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    {
      Future<WebAPI.Response.TowerEntry> f = WebAPI.TowerEntry(intList1.ToArray(), intList2.ToArray(), quest00210aMenu.towerSelectedUnitIDs, quest00210aMenu.towerProgress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    e1 = quest00210aMenu.UpdateTowerDeck((System.Action) (() =>
    {
  ...
  private IEnumerator SetCorpsSelectionUnitAndSupply()
  {
    ...
    {
      Future<WebAPI.Response.QuestCorpsReset> f = WebAPI.QuestCorpsReset(intList1.ToArray(), intList2.ToArray(), quest00210aMenu.playerCorps.period_id, quest00210aMenu.corpsSelectedUnitIDs, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    {
      Future<WebAPI.Response.QuestCorpsEntry> f = WebAPI.QuestCorpsEntry(intList1.ToArray(), intList2.ToArray(), quest00210aMenu.playerCorps.period_id, quest00210aMenu.corpsSelectedUnitIDs, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    // ISSUE: reference to a compiler-generated method
    e1 = quest00210aMenu.UpdateCorpsDeck(new System.Action(quest00210aMenu.\u003CSetCorpsSelectionUnitAndSupply\u003Eb__64_2));
    while (e1.MoveNext())
      yield return e1.Current;
    e1 = (IEnumerator) null;
  }

  private IEnumerator UpdateTowerDeck(System.Action successAction)
  {
    ...
    else
    {
      ...
      if (flag)
      {
        Future<WebAPI.Response.TowerDeckEdit> f = WebAPI.TowerDeckEdit(intList.ToArray(), this.towerProgress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
  ...
  private IEnumerator UpdateCorpsDeck(System.Action successAction)
  {
    Quest00210aMenu quest00210aMenu = this;
    ...
    else
    {
      ...
      if (flag)
      {
        Future<WebAPI.Response.QuestCorpsDeckEdit> f = WebAPI.QuestCorpsDeckEdit(quest00210aMenu.playerCorps.period_id, intList.ToArray(), (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
        IEnumerator e1 = f.Wait();
        while (e1.MoveNext())
          yield return e1.Current;
        e1 = (IEnumerator) null;
