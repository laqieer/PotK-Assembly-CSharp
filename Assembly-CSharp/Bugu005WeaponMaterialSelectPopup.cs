...
public class Bugu005WeaponMaterialSelectPopup : BackButtonMenuBase
{
    ...
    Bugu005WeaponMaterialConversionMenu menu)
  {
    ...
    if (num != 0)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.\u003C\u003E1__state = -1;
      materialSelectPopup.LinkItem.enabled = false;
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) Bugu005711Menu.InitIcon(item, materialSelectPopup.LinkItem.transform.parent.Find("dir_thum"));
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
