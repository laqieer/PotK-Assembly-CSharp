...
public class Quest002201Scene : NGSceneBase
{
  ...
  public static void changeScene(bool bStack, int Lid, int Mid) => Singleton<NGSceneManager>.GetInstance().changeScene(Quest002201Scene.defName, (bStack ? 1 : 0) != 0, (object) Lid, (object) Mid);
  ...
  public void onStartScene(int Lid, int Mid, int lastReferenceUnitId) => this.onStartScene(Lid, Mid);
  ...
  public IEnumerator onStartSceneAsync(int Lid, int Mid)
  {
    ...
    if (!WebAPI.IsResponsedAtRecent("QuestProgressExtra") && !WebAPI.IsResponsedAtRecent("QuestProgressLimited"))
    {
      ...
      Future<WebAPI.Response.QuestProgressLimited> qProgress = WebAPI.QuestProgressLimited((System.Action<WebAPI.Response.UserError>) (e =>
      {
  ...
  private IEnumerator doLoadBackground(int Lid)
  {
    ...
    {
      yield return (object) null;
      yield return (object) quest002201Scene.gameObject.GetOrAddComponent<BGChange>().ExtraBGprefabCreate(extraL.background_image_name);
      quest002201Scene.isInitializeBG_ = false;
    }
  }
  ...
  private void autoOpenPopup()
  {
    ...
    if (instance.fromPopup != NGGameDataManager.FromPopup.Quest002201Scene)
      return;
    instance.OnceOpenPopup<Future<GameObject>>(this.menu_.unityDetailPrefabs, (NGMenuBase) this.menu_, new System.Action(this.menu_.preOpenUnityPopup));
