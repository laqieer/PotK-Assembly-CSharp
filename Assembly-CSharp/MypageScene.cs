...
public class MypageScene : NGSceneBase
{
  ...
  public bool isAnimePlaying => (UnityEngine.Object) this.Menu != (UnityEngine.Object) null && this.Menu.isAnimePlaying;
  ...
  public override List<string> createResourceLoadList()
  {
    ...
    stringList1.AddRange((IEnumerable<string>) stringList1);
    return stringList1;
  }
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    mypageScene.Transition = mypageScene.GetComponent<MypageTransition>();
  ...
  public IEnumerator onStartSceneAsync(bool fromEarthTop, bool isEarthSuspend)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    mypageScene.BgChange = mypageScene.GetComponent<BGChange>();
  ...
  public void onStartScene(bool fromEarthTop, bool isEarthSuspend)
  {
    ...
    this.IntroControler.setEnd((System.Action<int>) (executed => this.finishedIntroScene(fromEarthTop, executed)));
  ...
  public void onBackScene(bool fromEarthTop, bool isEarthSuspend) => this.onStartScene(false, false);
  ...
  private IEnumerator LoadBackGround()
  {
    ...
    IEnumerator e;
    if (flag || (UnityEngine.Object) this.BgChange == (UnityEngine.Object) null || ((UnityEngine.Object) questBG.current_xl == (UnityEngine.Object) null || (UnityEngine.Object) questBG.current_l == (UnityEngine.Object) null))
    {
    ...
    else if (!questBG.current_xl.GetComponent<UI2DSprite>().sprite2D.name.Equals(this.MyPageImagePath) && (UnityEngine.Object) this.BgChange != (UnityEngine.Object) null)
    {
      e = this.BgChange.SetXLBg();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      this.MyPageImagePath = questBG.current_xl.GetComponent<UI2DSprite>().sprite2D.name;
    }
  }
  ...
  {
    MypageScene mypageScene = this;
    IEnumerator e = mypageScene.GetComponent<BGChange>().MypageBGprefabCreate();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private bool IsExploreRankingResult() => Singleton<ExploreDataManager>.GetInstance().HasRankingResult();

  private IEnumerator doExploreRankingPopup(int executed)
  {
    Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
    Singleton<CommonRoot>.GetInstance().isTouchBlock = true;
    Future<WebAPI.Response.ExploreRankingResult> futureF = WebAPI.ExploreRankingResult((System.Action<WebAPI.Response.UserError>) (e => Debug.LogError((object) ("MypageTopEvent Failed Load ExploreRankingResult : " + e.Code))));
  ...
  private bool IsGuildLvUpEffect() => Persist.guildTopLevel.Data.level < PlayerAffiliation.Current.guild.appearance.level;
  ...
  private IEnumerator doShowGuildLvUpEffect(int executed)
  {
    ...
    Singleton<PopupManager>.GetInstance().open(guildLvUpAnimPopup.gameObject, isCloned: true);
  ...
  private IEnumerator doShowGuildTransferPopup(int executed)
  {
    Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
    bool bWait = true;
    ModalWindow.Show(Consts.GetInstance().GUILD_APPLY_APPLICANT_TITLE_CHANGE_GUILD, Consts.GetInstance().GUILD_APPLY_APPLICANT_MESSAGE_CHANGE_GUILD, (System.Action) (() => bWait = false));
    while (bWait)
      yield return (object) null;
  }
  ...
  private IEnumerator doShowGuildBattleResult(int executed)
  {
    Singleton<NGGameDataManager>.GetInstance().refreshGuildTop = true;
    Singleton<CommonRoot>.GetInstance().ShowLoadingLayer(1);
    Future<WebAPI.Response.GvgResult> webApi = WebAPI.GvgResult((System.Action<WebAPI.Response.UserError>) (e => Debug.LogError((object) ("MypageTopEvent Failed Load GuildBattleResult : " + e.Code))));
    ...
    if ((current != null ? (current.isGuildMember() ? 1 : 0) : 0) != 0)
    {
      switch (PlayerAffiliation.Current.guild.gvg_status)
      {
        ...
        case GvgStatus.aggregating:
          bool showPopup;
          System.Action varificationProc = (System.Action) (() => ModalWindow.ShowYesNo(consts.POPUP_GUILD_BATTLE_NOT_RESUME_TITLE, consts.POPUP_GUILD_BATTLE_NOT_RESUME_DESC, (System.Action) (() =>
          {
          ...
          {
            showPopup = true;
            ModalWindow.ShowYesNo(consts.POPUP_GUILD_BATTLE_RESUME_TITLE, consts.POPUP_GUILD_BATTLE_RESUME_DESC, (System.Action) (() =>
            {
          ...
          yield return (object) null;
          varificationProc = (System.Action) null;
          break;
      }
    }
    IEnumerator e;
  ...
  private IEnumerator ResumeGvg()
  {
    ...
    Future<WebAPI.Response.GvgBattleResume> ft = WebAPI.GvgBattleResume((System.Action<WebAPI.Response.UserError>) (e => errorCode = e.Code));
    ...
    if (ft.Result == null)
    {
      if (errorCode.Equals("GVG001"))
        ...
        ModalWindow.Show("GLD014", Consts.GetInstance().POPUP_GUILD_BATTLE_RESUME_ERROR_BATTLE_EXPIRED, (System.Action) (() => {}));
      else
  ...
  private IEnumerator ForceCloseGvg()
  {
    ...
    {
      Future<WebAPI.Response.GvgBattleResume> wabApi = WebAPI.GvgBattleResume((System.Action<WebAPI.Response.UserError>) (e => Debug.LogError((object) ("MypageTopEvent Failed GvgBattleResume : " + e.Code))));
      e1 = wabApi.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    {
      e1 = WebAPI.GvgBattleForceClose(battleId, (System.Action<WebAPI.Response.UserError>) (e => Debug.LogError((object) ("MypageTopEvent Failed Close GuildBattle : " + e.Code)))).Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    }
  ...
  private IEnumerator doShowGuildCheckin(int executed)
  {
    ...
    Future<WebAPI.Response.GuildCheckin> webapi = WebAPI.GuildCheckin((System.Action<WebAPI.Response.UserError>) (e => Debug.LogError((object) ("MypageTopEvent Failed GuildCheckin : " + e.Code))));
    IEnumerator e1 = webapi.Wait();
    while (e1.MoveNext())
      yield return e1.Current;
    e1 = (IEnumerator) null;
