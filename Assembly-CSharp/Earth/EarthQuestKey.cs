...
namespace Earth
{
  ...
  public class EarthQuestKey : BL.ModelBase
  {
    ...
    public static EarthQuestKey Create(int keyID, int quantity) => new EarthQuestKey()
    {
      mKeyID = keyID,
      mQuantity = quantity
    };
    ...
    public string GetSeverString() => string.Format(EarthQuestKey.serverDataFormat, (object) this.mKeyID, (object) this.mQuantity);

    public static EarthQuestKey JsonLoad(Dictionary<string, object> json) => new EarthQuestKey()
    {
