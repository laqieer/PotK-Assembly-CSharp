...
public class ExploreRankingPopup : BackButtonMenuBase
{
  ...
  {
    Future<WebAPI.Response.ExploreRankingRanking> futureF = WebAPI.ExploreRankingRanking((System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  {
    if ((UnityEngine.Object) this.statusScrollPrefab == (UnityEngine.Object) null)
    {
  ...
  public void setRankingInfo()
  {
    ...
    if (this.prefabList.Count > 7)
    {
      ...
      this.scroll = this.scrollGrid.transform.parent.GetComponent<UIScrollView>();
      if ((UnityEngine.Object) this.scroll != (UnityEngine.Object) null)
      {
        ...
        this.bottomEmptyObj.localPosition = (Vector3) new Vector2(0.0f, (float) (-(double) this.scrollLength + 30.0));
        this.scroll.ResetPosition();
        this.wrap.transform.localPosition = (Vector3) Vector2.zero;
      }
    ...
    else
    {
      this.scrollBar.SetActive(false);
      this.wrap = this.scrollGrid.GetComponent<UIGridCycle>();
      this.wrap.enabled = false;
      for (int index = 0; index < this.prefabList.Count; ++index)
      {
        this.prefabList[index].gameObject.transform.localPosition = (Vector3) new Vector2(0.0f, (float) -(index * 30 * 2));
      ...
      if ((UnityEngine.Object) this.scroll != (UnityEngine.Object) null)
      {
        ...
        this.bottomEmptyObj.localPosition = (Vector3) Vector2.zero;
        this.wrap.transform.localPosition = (Vector3) new Vector2(0.0f, 20f);
      }
      this.scroll.ResetPosition();
    }
