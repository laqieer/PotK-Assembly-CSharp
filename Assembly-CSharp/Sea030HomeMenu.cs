...
public class Sea030HomeMenu : BackButtonMenuBase
{
  ...
  public IEnumerator onStartSceneAsync(bool isDuringDate)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) loadFt.Result != (UnityEngine.Object) null)
    {
      sea030HomeMenu1.callTouchEffect = UnityEngine.Object.Instantiate<GameObject>(loadFt.Result);
    ...
    if (isDuringDate)
    {
      ...
      Future<WebAPI.Response.SeaDateResume> futureAPI = WebAPI.SeaDateResume(new System.Action<WebAPI.Response.UserError>(sea030HomeMenu1.\u003ConStartSceneAsync\u003Eb__102_1));
      e = futureAPI.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      ...
      Story0093Scene.changeSceneModeDate(true, dateFlows[index], sea030HomeMenu1.current2DUnitData.Unit, sea030HomeMenu1.dateSetting.GetImageHash(), new System.Action<int, int>(sea030HomeMenu1.EventSelected), isSea: new bool?(true), questionId: sea030HomeMenu1.quizId);
    }
  ...
  public IEnumerator onBackSceneAsync()
  {
      ...
      else
      {
        ...
        if (!isSeaSeasonEnd)
        {
          ...
          if (((seaPlayer == null || !seaPlayer.is_released_sea_call || flag2 ? 0 : ((double) updatePlayerUnit.trust_rate >= (double) float.Parse(Consts.GetInstance().CALL_TRUST_NUM) ? 1 : 0)) & (flag3 ? 1 : 0)) != 0)
          {
            ...
            // ISSUE: reference to a compiler-generated method
            yield return (object) go.GetComponent<Sea030CommonPopup>().initialize(updatePlayerUnit, futureAPI.Result.player_call_letters, new System.Action<PlayerTalkMessage>(sea030HomeMenu1.\u003ConBackSceneAsync\u003Eb__103_4));
    ...
    else
    {
      ...
      if ((UnityEngine.Object) sea030HomeMenu1.callPopupObject != (UnityEngine.Object) null && sea030HomeMenu1.callPopupObject.IsInitialize)
      {
        ...
        else
        {
          ...
          while (e1.MoveNext())
            yield return e1.Current;
          e1 = (IEnumerator) null;
          UnityEngine.Object.Destroy((UnityEngine.Object) sea030HomeMenu1.callPopupObject.gameObject);
      ...
      if ((UnityEngine.Object) sea030HomeMenu1.callPopupObject != (UnityEngine.Object) null && sea030HomeMenu1.callPopupObject.IsShow)
        sea030HomeMenu1.displayTouchEffectController.SetEnable(false);
      else
  ...
  {
    this.resultEffectAnimator.enabled = false;
    this.resultGaugeEffectAnimator.enabled = false;
    this.resultParticleList.ForEach((System.Action<ParticleSystem>) (p =>
    {
      p.Stop(true, ParticleSystemStopBehavior.StopEmittingAndClear);
      p.gameObject.SetActive(false);
    }));
    this.resultUISpriteList.ForEach((System.Action<UISprite>) (s => s.gameObject.SetActive(false)));
    this.trustUpLabelAnimator.enabled = false;
  ...
  private void OpenSeaMessage()
  {
    ...
    {
      if (!((UnityEngine.Object) this.noticeManager != (UnityEngine.Object) null))
        return;
      this.noticeManager.gameObject.SetActive(false);
    }
    else
    {
      if ((UnityEngine.Object) this.noticeManager != (UnityEngine.Object) null)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) this.noticeManager.gameObject);
  ...
  public void OnDateBadMood() => Singleton<NGMessageUI>.GetInstance().SetMessageByPosType(Consts.GetInstance().CALL_HOME_BAD_MOOD_PUSH_BUTTON);
  ...
  public void ChangeTalkMode(SeaHomeManager.UnitConrtolleData unitData)
  {
    ...
    if (this.mode == Sea030HomeMenu.HomeMode.Talk)
      return;
    List<SwitchUnitComponentBase> list = ((IEnumerable<SwitchUnitComponentBase>) this.GetComponentsInChildren<SwitchUnitComponentBase>(true)).ToList<SwitchUnitComponentBase>();
    ...
    this.tweeners = ((IEnumerable<UITweener>) this.tweeners).Where<UITweener>((Func<UITweener, bool>) (x => (UnityEngine.Object) x != (UnityEngine.Object) null)).ToArray<UITweener>();
  ...
  public IEnumerator InternalChangeTalkMode(SeaHomeManager.UnitConrtolleData unitData)
  {
    ...
    List<SwitchUnitComponentBase> list = ((IEnumerable<SwitchUnitComponentBase>) sea030HomeMenu.GetComponentsInChildren<SwitchUnitComponentBase>(true)).ToList<SwitchUnitComponentBase>();
    for (int index = 0; index < list.Count; ++index)
      list[index].SwitchMaterial(unitData.UnitID);
  ...
  private void SetUnitData(SeaHomeManager.UnitConrtolleData unitData)
  {
    ...
    if (unitData.PlayerUnit == (PlayerUnit) null)
    {
      ...
      this.BtnDateBadMood.gameObject.SetActive(false);
      this.BtnDate.gameObject.SetActive(true);
    }
    else
    {
      bool isEnabled = player.IsSeaDate() && !((IEnumerable<SeaDateProhibition>) MasterData.SeaDateProhibitionList).Any<SeaDateProhibition>((Func<SeaDateProhibition, bool>) (x =>
      {
      ...
      {
        this.BtnDateBadMood.gameObject.SetActive(true);
        this.BtnDate.gameObject.SetActive(false);
        this.BtnDateBadMood.EnableImmediately(isEnabled);
      }
      else
      {
        this.BtnDateBadMood.gameObject.SetActive(false);
        this.BtnDate.gameObject.SetActive(true);
        this.BtnDate.EnableImmediately(isEnabled);
      }
    ...
    int trust = this.IsBadMood(unitData) ? 0 : (int) unitData.PlayerUnit.trust_rate;
    this.serifIndexCount = 0;
    SeaHomeSerif[] serifs = ((IEnumerable<SeaHomeSerif>) MasterData.SeaHomeSerifList).GetSerifs(ServerTime.NowAppTimeAddDelta(), unitData.Unit, unitData.PlayerUnit != (PlayerUnit) null, trust);
  ...
  private IEnumerator internalPresentGive(GameCore.ItemInfo present, int selected)
  {
    ...
    cr.loadingMode = 1;
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.SeaPresentGive> future = WebAPI.SeaPresentGive(intList.ToArray(), sea030HomeMenu.current2DUnitData.PlayerUnit.id, new System.Action<WebAPI.Response.UserError>(sea030HomeMenu.\u003CinternalPresentGive\u003Eb__138_1));
    IEnumerator e = future.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public static bool hasQuiz(SeaDateDateFlow dateFlow) => dateFlow == SeaDateDateFlow.happening_choices || dateFlow == SeaDateDateFlow.quiz_choices;
    ...
    PlayerUnit unit)
  {
    ...
    {
      this.resultEffectAnimator.enabled = true;
    ...
    {
      this.resultGaugeEffectAnimator.enabled = true;
    ...
    if ((double) trustUp > 0.0)
    {
      ...
      this.trustUpLabelAnimator.enabled = true;
    ...
    bool isFirstTimeGaugeMax = false)
  {
    ...
    else
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      Singleton<PopupManager>.GetInstance().open(script.gameObject, isCloned: true);
  ...
  private void LevelUpPopupShow(List<LevelRewardSchemaMixin> levelRewards, System.Action finish) => ModalWindow.Show(levelRewards[this.LevelUpBonusCloseCounter].reward_title, levelRewards[this.LevelUpBonusCloseCounter].reward_message, (System.Action) (() =>
  {
  ...
  public IEnumerator OpenSeaHomeTutorial()
  {
    ...
    if (seaPlayer != null && seaPlayer.is_released_sea_call && (!Persist.seaTutorialData.Exists || Persist.seaTutorialData.Exists && !Persist.seaTutorialData.Data.seaHomeTutorial))
    {
      ...
      IEnumerator e;
      if ((UnityEngine.Object) sea030HomeMenu.seaHomeTutorial == (UnityEngine.Object) null)
      {
      ...
      // ISSUE: reference to a compiler-generated method
      GameObject popup = Singleton<PopupManager>.GetInstance().open(sea030HomeMenu.seaHomeTutorial, isNonSe: true, isNonOpenAnime: true, closeAnim: new System.Action(sea030HomeMenu.\u003COpenSeaHomeTutorial\u003Eb__157_0));
