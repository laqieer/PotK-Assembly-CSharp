...
public class Versus02622Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, PvPRecord freeInfo, PvPRecord friendInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("versus026_2_2", (stack ? 1 : 0) != 0, (object) freeInfo, (object) friendInfo);
