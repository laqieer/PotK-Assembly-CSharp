...
public class Friend0081Menu : FriendBarBase
{
  ...
  public IEnumerator InitFriendScroll(PlayerFriend[] friends)
  {
    ...
    if ((UnityEngine.Object) friend0081Menu.prefabScroll == (UnityEngine.Object) null)
    {
  ...
  private void FriendScrollAction(int info_index, int bar_index) => ((Friend0081ScrollParts) this.allFriendBar[bar_index]).Set(info_index, this);
