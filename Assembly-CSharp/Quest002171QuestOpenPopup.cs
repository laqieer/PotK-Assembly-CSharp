...
public class Quest002171QuestOpenPopup : BackButtonMenuBase
{
  ...
  public IEnumerator Init(
    ...
    BattleUI05PopupResortie battleResortie)
  {
  ...
  private IEnumerator QuestRelease(PlayerQuestGate gate)
  {
    ...
    bool isFaildSpend = false;
    IEnumerator e = WebAPI.QuestkeySpend(gate.quest_key_id, gate.consume_quantity, gate.quest_gate_id, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      WebAPI.DefaultUserErrorCallback(error);
      Singleton<CommonRoot>.GetInstance().loadingMode = 0;
      Singleton<CommonRoot>.GetInstance().isLoading = false;
  ...
  private IEnumerator CreateBanner(int num)
  {
    ...
    if (num > 4 && (UnityEngine.Object) this.scrollbar != (UnityEngine.Object) null)
  ...
  {
    if (!((UnityEngine.Object) this.ngxScroll != (UnityEngine.Object) null))
      return;
