...
public class CutSceneClipEffectPlayer : MonoBehaviour
{
  ...
  private void Awake()
  {
    this.mUnitModel = this.GetComponent<CutSceneUnitModel>();
    if ((Object) this.mUnitModel == (Object) null && (Object) this.transform.parent != (Object) null)
      this.mUnitModel = this.transform.parent.GetComponent<CutSceneUnitModel>();
    this.mUnit = this.mUnitModel.Unit;
    this.mTrail = this.GetComponentInChildren<WeaponTrail>();
  }
  ...
  public void playSound(string seName)
  {
    ...
    if (string.IsNullOrEmpty(seName) || !((Object) instance != (Object) null))
      return;
  ...
  public void playEffect(string str)
  {
    ...
    {
      if (!((Object) this.mTrail != (Object) null))
        return;
      this.mTrail.On(this.transform);
    }
    ...
    else if (str.Contains("_locus_hit"))
    {
  ...
  private IEnumerator loadEffect(string effectName, string target, string parent_name)
  {
    ...
    if (!effectName.Contains("weapon_trail_"))
    {
      ...
      {
        GameObject goef = self.Clone(clipEffectPlayer.transform);
  ...
  {
    goef.transform.localRotation = this.transform.rotation;
    if (kwd2 == "0")
    {
      if (!string.IsNullOrEmpty(kwd3))
      {
        Transform transform = this.transform.GetChildInFind(kwd3);
      ...
      {
        goef.transform.localPosition = kwd1.Equals("ef515_def_hit") || kwd1.Equals("ef703_duel_holysheeld") ? this.mUnitModel.Bip.position : this.transform.position;
        goef.transform.parent = this.transform;
      }
    }
    else if (kwd2 == "1")
    ...
    {
      Transform transform1 = this.transform.GetChildInFind("weaponr");
    ...
    else if (kwd2 == "3")
    {
      ...
      if (!((Object) parentInRoot != (Object) null))
        return;
  ...
  private IEnumerator loadPrefab(string pname, Vector3 pos, Vector3 rot)
  {
    ...
    else
    {
      ...
      if (pname == "ef1004_attack_rune")
      {
        go.transform.localPosition = Vector3.zero;
        go.transform.localRotation = Quaternion.identity;
      }
      else if (pname == "ef703_duel_holysheeld")
      {
      ...
      {
        go.transform.localPosition = this.mUnitModel.Bip.position + pos;
  ...
  private IEnumerator loadPrefab(string data_name)
  {
    ...
    IEnumerator e;
    if ((Object) clipEventEffectData == (Object) null)
    {
    ...
    Vector3 rot)
  {
    ...
    else
    {
      ...
      {
        parent = clipEffectPlayer.transform.GetChildInFind(parent_name);
        if ((Object) parent == (Object) null && (Object) clipEffectPlayer.mUnitModel.Root3D != (Object) null)
      ...
      Vector3 vector3 = pos;
      if (isAddBip)
        vector3 += clipEffectPlayer.mUnitModel.Bip.position;
      if (isLocalPos)
  ...
  public void play_ef703() => this.StartCoroutine(this.loadPrefab("ef703_duel_holysheeld", this.position703, this.rotate703));

  public void play_ef704() => this.StartCoroutine(this.loadPrefab("ef704_duel_holysheeld", this.position704, this.rotate704));

  public void play_ef705() => this.StartCoroutine(this.loadPrefab("ef705_duel_sword_hit_moon", this.position705, this.rotate705));

  public void play_ef706() => this.StartCoroutine(this.loadPrefab("ef706_duel_sword_reservoir", this.position706, this.rotate706));

  public void play_ef707() => this.StartCoroutine(this.loadPrefab("ef707_duel_sword_trail", this.position707, this.rotate707));

  public void play_ef708() => this.StartCoroutine(this.loadPrefab("ef708_duel_sword_smoke", this.position708, this.rotate708));

  public void play_ef709() => this.StartCoroutine(this.loadPrefab("ef709_duel_spear_attack_star_s", this.position709, this.rotate709));

  public void play_ef710() => this.StartCoroutine(this.loadPrefab("ef710_duel_spear_attack_star_l", this.position710, this.rotate710));

  public void play_ef711() => this.StartCoroutine(this.loadPrefab("ef711_duel_spear_hit_star", this.position711, this.rotate711));

  public void play_ef712() => this.StartCoroutine(this.loadPrefab("ef712_duel_spear_trail_star", this.position712, this.rotate712));

  public void play_ef713() => this.StartCoroutine(this.loadPrefab("ef713_duel_damage_hit", this.position713, this.rotate713));

  public void play_ef714() => this.StartCoroutine(this.loadPrefab("ef714_duel_scatters_heal_sun", this.position714, this.rotate714));

  public void play_ef715() => this.StartCoroutine(this.loadPrefab("ef715_duel_sword_hit_sun", this.position715, this.rotate715));

  public void play_ef716() => this.StartCoroutine(this.loadPrefab("ef716_duel_sword_trail_sun", this.position716, this.rotate716));

  public void play_ef717() => this.StartCoroutine(this.loadPrefab("ef717_duel_dorain_sun", this.position717, this.rotate717));

  public void play_ef718() => this.StartCoroutine(this.loadPrefab("ef718_duel_heal_sun", this.position718, this.rotate718));

  public void play_ef719() => this.StartCoroutine(this.loadPrefab("ef719_duel_blast", this.position719, this.rotate719));

  public void play_ef720() => this.StartCoroutine(this.loadPrefab("ef720_duel_spear_attack_moon_l", this.position720, this.rotate720));

  public void play_ef721() => this.StartCoroutine(this.loadPrefab("ef721_duel_spear_hit_moon", this.position721, this.rotate721));

  public void play_ef722() => this.StartCoroutine(this.loadPrefab("ef722_duel_spear_shine_moon", this.position722, this.rotate722));

  public void play_ef723() => this.StartCoroutine(this.loadPrefab("ef723_duel_spear_explosion_moon", this.position723, this.rotate723));

  public void play_ef724() => this.StartCoroutine(this.loadPrefab("ef724_duel_spear_trail_moon", this.position724, this.rotate724));

  public void play_ef725() => this.StartCoroutine(this.loadPrefab("ef725_duel_damage_hit_sword", this.position725, this.rotate725));

  public void play_ef726() => this.StartCoroutine(this.loadPrefab("ef726_duel_chocolate_damage", this.position726, this.rotate726));

  public void play_ef1000() => this.StartCoroutine(this.loadPrefab("ef1000_cook_masamune", this.position1000, this.rotate1000));

  public void play_ef1001() => this.StartCoroutine(this.loadPrefab("ef1001_cat_mjollnir", this.position1001, this.rotate1001));

  public void play_ef1002() => this.StartCoroutine(this.loadPrefab("ef1002_rose_parashu", this.position1002, this.rotate1002));

  public void play_ef1003() => this.StartCoroutine(this.loadPrefab("ef1003_idol_labrusse", this.position1003, this.rotate1003));

  public void play_ef1004() => this.StartCoroutine(this.loadPrefab("ef1004_attack_rune", this.position1004, this.rotate1004));

  public void play_ef1005() => this.StartCoroutine(this.loadPrefab("ef1005_alone_leavatain", this.position1005, this.rotate1005));

  public void play_ef1006() => this.StartCoroutine(this.loadPrefab("ef1006_denial_megido", this.position1006, this.rotate1006));

  public void play_ef1007() => this.StartCoroutine(this.loadPrefab("ef1007_scream_longinus", this.position1007, this.rotate1007));

  public void play_ef1008() => this.StartCoroutine(this.loadPrefab("ef1008_valentine_perun", this.position1008, this.rotate1008));
  ...
  public void play_DamageNumber() => Debug.LogWarning((object) "CutScene can`t use play_DamageNumber.");

  public void play_DamageNumber_BiAttack() => Debug.LogWarning((object) "CutScene can`t use play_DamageNumber_BiAttack.");
