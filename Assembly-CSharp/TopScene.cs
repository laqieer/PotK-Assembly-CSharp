...
public class TopScene : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    if (!((UnityEngine.Object) this.debugContainer != (UnityEngine.Object) null))
      return;
    UnityEngine.Object.Destroy((UnityEngine.Object) this.debugContainer);
  ...
  public void IbtnAccountDeleteNext()
  {
    Singleton<NGSoundManager>.GetInstance().playSE("SE_1002");
    Singleton<NGSoundManager>.GetInstance().playSE("SE_1006");
    this.popupAccountDelete2Next.isEnabled = false;
  ...
  private IEnumerator AccountDeleteApi()
  {
    ...
    IEnumerator e = WebAPI.DeleteAccount((System.Action<WebAPI.Response.UserError>) (error => WebAPI.DefaultUserErrorCallback(error))).Wait();
    while (e.MoveNext())
  ...
  public void DeleteCacheOn()
  {
    ...
    else
    {
      ...
      Singleton<NGSoundManager>.GetInstance().playSE("SE_1006");
      this.nowPopup = ModalWindow.ShowYesNo(instance.clear_cache_title, cacheTextNoMobile, (System.Action) (() =>
      {
        Singleton<NGSoundManager>.GetInstance().playSE("SE_1002");
        this.StartCoroutine(this.startClearCacheWithAutoSleep());
      }), (System.Action) (() =>
  ...
  private IEnumerator startClearCache()
  {
    ...
    ModalWindow window = ModalWindow.Show(c.clear_cache_title, c.clearCacheProgress(0, 0), (System.Action) (() =>
    {
      this.pCond = TopScene.PopupCondition.NONE;
      Singleton<NGSoundManager>.GetInstance().playSE("SE_1002");
    }));
  ...
  {
    if ((UnityEngine.Object) this.termsOfService == (UnityEngine.Object) null)
    {
  ...
  public void UserPolicyDissent()
  {
    ...
    this.userPolicy.gameObject.SetActive(false);
    Singleton<NGSoundManager>.GetInstance().playSE("SE_1006");
    this.StartCoroutine(PopupCommon.ShowUserPolicyDissent(this.termsOfService.content.titleDissent, this.termsOfService.content.textDissent, this.popupPanel.transform, (System.Action) (() =>
    {
      Singleton<NGSoundManager>.GetInstance().playSE("SE_1002");
      this.BackCollider.gameObject.SetActive(false);
      this.pCond = TopScene.PopupCondition.NONE;
  ...
  private IEnumerator Start()
  {
    ...
    if (Persist.userInfo.Exists)
    {
      ...
      scene.popupAccountDeleteBtn.isEnabled = true;
    ...
    Singleton<SocialManager>.GetInstance().Auth((System.Action<bool>) (success => {}));
  ...
  private void ShowSocialSignOutPopup()
  {
    ...
    this.nowPopup = ModalWindow.ShowYesNo(Consts.GetInstance().SOCIAL_PLATFORM_NAME, "サインアウトしますか？", (System.Action) (() =>
    {
  ...
  public IEnumerator UserPolicy()
  {
    if (!this.isIntoTouch)
    {
      ...
      else
      {
        ...
        if (!Persist.appFPS.Data.IsSetup && (UnityEngine.Object) this.popupSelectFPS != (UnityEngine.Object) null)
        {
          this.SelectFPSOn();
        ...
        bool flag = false;
        if ((UnityEngine.Object) this.popupSpeedPriority != (UnityEngine.Object) null)
        {
          if (!Persist.speedPriority.Data.IsSpeedPrioritySetup)
          {
            ...
            this.popupSpeedPriority.gameObject.SetActive(true);
            while (!Persist.speedPriority.Data.IsSpeedPrioritySetup)
              yield return (object) null;
            this.popupSpeedPriority.gameObject.SetActive(false);
            this.pCond = TopScene.PopupCondition.NONE;
            this.BackCollider.gameObject.SetActive(false);
            flag = true;
          }
        ...
        if ((UnityEngine.Object) this.popupConfirmFPSAndSound != (UnityEngine.Object) null && isFpsConfirm | isSoundConfirm | flag)
        {
          Singleton<NGSoundManager>.GetInstance().playSE("SE_1006");
          this.BackCollider.gameObject.SetActive(true);
          this.pCond = TopScene.PopupCondition.SELECT_FPS_AND_SOUND_CONFIRM;
          this.popupConfirmFPSAndSound.gameObject.SetActive(true);
          string str1 = "";
          ...
          while (!this.popupConfirmFPSAndSound.IsDecide)
            yield return (object) null;
          this.popupConfirmFPSAndSound.gameObject.SetActive(false);
          this.pCond = TopScene.PopupCondition.NONE;
          this.BackCollider.gameObject.SetActive(false);
        }
  ...
  public void OnCheckBox()
  {
    ...
    this.popupAccountDelete2Next.isEnabled = this.AccountDeleteCheckBoxOn.activeSelf;
  }

  public void changeNextSceneAfterAnim()
  {
    if ((UnityEngine.Object) this.backGroundAnim != (UnityEngine.Object) null)
      this.backGroundAnim.StartFinishAnim(new System.Action(this.changeNextScene));
    else
