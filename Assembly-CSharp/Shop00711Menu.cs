...
public class Shop00711Menu : BackButtonMenuBase
{
  ...
  {
    Future<UnityEngine.Sprite> coinF = CoinProduct.LoadSpriteThumbnail(product, false);
  ...
  public void SetSprite(UnityEngine.Sprite spr) => this.linkItem.sprite2D = spr;

  public void SetText(int befereCoin, int afterCoin) => this.TxtDescription03.SetTextLocalize(Consts.Format(Consts.GetInstance().SHPT_0711_MENU_BUY_KISEKI, (IDictionary) new Hashtable()
  {
    {
      (object) "before",
      (object) befereCoin
