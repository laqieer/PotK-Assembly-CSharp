...
public class ExploreResultReport : BackButtonMenuBase
{
  ...
  {
    if ((UnityEngine.Object) this.mPlayerLevelupPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator CreateExploreBoxView(List<int> rewardsId)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) exploreResultReport.mRewardIconPrefab == (UnityEngine.Object) null)
    {
    ...
    foreach (int key in rewardsId)
    {
      ...
      CreateIconObject icon = exploreResultReport.mRewardIconPrefab.CloneAndGetComponent<CreateIconObject>(exploreResultReport.mItemBoxGrid.transform);
    ...
    exploreResultReport.mItemBoxGrid.onReposition = new UIGrid.OnReposition(exploreResultReport.\u003CCreateExploreBoxView\u003Eb__22_0);
  ...
  private IEnumerator LoadUnitSprite(PlayerUnit unit)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    GameObject imgObj = future.Result.Clone(this.mUnitImage.transform);
  ...
  {
    if (this.mPlaySeDirty && this.mAnimator.GetCurrentAnimatorStateInfo(0).IsName("explore_Result_In_Reward"))
    {
  ...
  private IEnumerator OnExpGaugeMax(GameObject obj, int count)
  {
    if (this.mReportInfo.BeforePlayerLevel + count + 1 == this.mReportInfo.AfterPlayerLevel)
    {
      ...
      component.SetCallback((System.Action) (() => onFinished = true));
      while (!onFinished)
