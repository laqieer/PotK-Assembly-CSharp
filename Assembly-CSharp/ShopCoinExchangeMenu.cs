...
public class ShopCoinExchangeMenu : ShopArticleListMenu
{
  ...
  public IEnumerator Init(int select_id)
  {
    ...
    if (coinExchangeMenu.coinIds.Count <= 0)
    {
      ...
      coinExchangeMenu.txtCoinExplanation.gameObject.SetActive(false);
      coinExchangeMenu.txtCoinNum.gameObject.SetActive(false);
      coinExchangeMenu.txtAfter.gameObject.SetActive(false);
      coinExchangeMenu.txtDayValue.gameObject.SetActive(false);
      coinExchangeMenu.txtDay.gameObject.SetActive(false);
      coinExchangeMenu.txtNoDeadLine.gameObject.SetActive(false);
    ...
    else
    {
      ...
      dirCoinExchangeIconPrefabF = (Future<GameObject>) null;
      if ((UnityEngine.Object) coinExchangeMenu.unitIconPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) coinExchangeMenu.itemIconPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) coinExchangeMenu.uniqueIconPrefab == (UnityEngine.Object) null)
      {
      ...
      for (int i = 0; i < coinExchangeMenu.coinIds.Count; ++i)
      {
        ...
        yield return (object) icon.GetComponent<CoinExchangeIcon>().Init(coinExchangeMenu.coinIds[i], i, new System.Action<int>(coinExchangeMenu.OnCoinIcon));
  ...
  private IEnumerator SetContents(ShopCoinExchangeMenu.SetContentsParam sParam)
  {
    ...
    if (commonTicket != null)
    {
        ...
        if (shopStatu.id == 9000)
        {
          foreach (PlayerShopArticle article in shopStatu.articles)
          {
            if (article.article.pay_id.Equals((object) sParam.id))
            {
              ...
              coinExchangeMenu.info.onPurchasedHolding = new System.Action<long>(((ShopArticleListMenu) coinExchangeMenu).UpdatePurchasedHolding);
      ...
      if (MasterData.CommonTicketEndAt.ContainsKey(sParam.id))
      {
        ...
        coinExchangeMenu.txtAfter.gameObject.SetActive(true);
        coinExchangeMenu.txtDayValue.gameObject.SetActive(true);
        coinExchangeMenu.txtDay.gameObject.SetActive(true);
        coinExchangeMenu.txtNoDeadLine.gameObject.SetActive(false);
      ...
      coinExchangeMenu.scrollBarArticles.ForceUpdate();
  ...
  public void InitArticleScroll()
  {
    ...
    this.scrollBarArticles.ForceUpdate();
  ...
  {
    if (this.iconsCoin == null || (UnityEngine.Object) this.nowCenterCoinObj == (UnityEngine.Object) null)
      return;
    GameObject centeredObject = this.gridCoin.transform.GetComponent<UICenterOnChild>().centeredObject;
    if (!((UnityEngine.Object) this.nowCenterCoinObj != (UnityEngine.Object) centeredObject))
      return;
    int num = 0;
    foreach (GameObject targetIcon in this.iconsCoin)
    {
      this.HscrollButtonCenterChange(targetIcon);
      if ((UnityEngine.Object) targetIcon == (UnityEngine.Object) centeredObject)
  ...
  private void HscrollButtonCenterChange(GameObject targetIcon)
  {
    ...
    if ((UnityEngine.Object) targetIcon == (UnityEngine.Object) this.gridCoin.transform.GetComponent<UICenterOnChild>().centeredObject)
    {
