...
public class Quest052171Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init()
  {
    ...
    if (!((UnityEngine.Object) earthDataManager == (UnityEngine.Object) null))
    {
      ...
      IEnumerator e;
      if ((UnityEngine.Object) this.ScrollPrefab == (UnityEngine.Object) null)
      {
    ...
    GameObject prefab)
  {
    ...
    gameObject.transform.parent = menu.grid.transform;
  ...
  public void StartAPI_QuestRelease(EarthExtraQuest quest, MasterDataTable.EarthQuestKey questKey, bool canPlay) => this.StartCoroutine(this.QuestRelease(quest, questKey, canPlay));

  private IEnumerator QuestRelease(
    EarthExtraQuest quest,
    MasterDataTable.EarthQuestKey questKey,
    bool canPlay)
  {
    ...
    if (canPlay)
    {
      ModalWindow.Show(Consts.GetInstance().QUEST_052171_RELEASEFAILED_POPUP_TITLE, Consts.GetInstance().QUEST_052171_RELEASEFAILED_POPUP_DESCRIPTION, (System.Action) (() => Singleton<PopupManager>.GetInstance().onDismiss()));
    }
    else
    {
      int num = 0;
      ...
      {
        ModalWindow.Show(Consts.GetInstance().QUEST_052171_RELEASEFAILED_POPUP_TITLE2, Consts.GetInstance().QUEST_052171_RELEASEFAILED_POPUP_DESCRIPTION2, (System.Action) (() => Singleton<PopupManager>.GetInstance().onDismiss()));
      }
      else
      {
