...
public class Explore3DModelCreate : UI3DModelCreate
{
  ...
  public IEnumerator LoadModel(PlayerUnit playerUnit)
  {
    ...
    if ((UnityEngine.Object) explore3DmodelCreate.shadowPrefab == (UnityEngine.Object) null)
    {
  ...
  {
    string controllerName = this.unit_animator_.runtimeAnimatorController.name;
    ...
    if ((UnityEngine.Object) this.vehicle_animator_ != (UnityEngine.Object) null || MasterData.UnitJob.TryGetValue(this.job_id, out unitJob) && unitJob.move_type == UnitMoveType.fuyu)
      return string.Empty;
  ...
  {
    UnityEngine.Object.Destroy((UnityEngine.Object) this.BaseModel);
    UnityEngine.Object.Destroy((UnityEngine.Object) this.UnitModel);
  }

  public void AdjustTransform()
  {
    if (!((UnityEngine.Object) this.BaseModel != (UnityEngine.Object) null))
      return;
    if ((UnityEngine.Object) this.VehicleModel != (UnityEngine.Object) null)
    {
  ...
  private void OnEnable()
  {
    ...
    materialPropertyBlock.SetFloat("_rainbow_On", 1f);
