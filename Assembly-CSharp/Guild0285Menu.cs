...
public class Guild0285Menu : GuildApplicantsBarBase
{
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    if (PlayerAffiliation.Current.onGvgOperation)
    {
      ...
      guild0285Menu.ShowOkPopup(Consts.GetInstance().GUILD_28_5_MENU_TITLE, PlayerAffiliation.Current.guild.gvg_status == GvgStatus.preparing ? Consts.GetInstance().GUILD_28_5_MENU_ERROR_GVG_PREPARE : Consts.GetInstance().GUILD_28_5_MENU_ERROR_GVG, new System.Action(guild0285Menu.\u003CInitializeAsync\u003Eb__17_0));
    }
    else
    {
      Singleton<CommonRoot>.GetInstance().loadingMode = 1;
      Singleton<CommonRoot>.GetInstance().isLoading = true;
      Future<WebAPI.Response.GuildTop> guildTop = WebAPI.GuildTop(Persist.guildHeaderChat.Data.latestLogId, (System.Action<WebAPI.Response.UserError>) (e =>
      {
  ...
  public IEnumerator InitApplicantScroll(GuildApplicant[] applicants)
  {
    ...
    guild0285Menu.btnAllReject.isEnabled = guild0285Menu.allApplicantInfo.Count > 0;
    guild0285Menu.btnAllAccept.isEnabled = guild0285Menu.allApplicantInfo.Count > 0;
  ...
  public IEnumerator Accept(
    ...
    System.Action<WebAPI.Response.UserError> actionFailure = null)
  {
    ...
    IEnumerator e1 = WebAPI.GuildApplicantsAccept(false, ((IEnumerable<string>) player_ids).ToArray<string>(), (System.Action<WebAPI.Response.UserError>) (e =>
    {
      errorCode = e.Code;
      this.HideLoading();
    ...
    System.Action<WebAPI.Response.UserError> actionFailure = null)
  {
    ...
    string errorCode = string.Empty;
    bool isMaintenance = false;
    IEnumerator e1 = WebAPI.GuildApplicantsReject(false, player_ids, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      errorCode = e.Code;
      this.HideLoading();
      if (e.Code.Equals("GLD014"))
  ...
  public void onRefuseBulkButton()
  {
    ...
    this.StartCoroutine(this.Refuse(stringList.ToArray(), (System.Action) (() => this.ShowOkPopup(Consts.Format(Consts.GetInstance().GUILD_28_5_REJECT_REQUEST_TITLE), Consts.Format(Consts.GetInstance().GUILD_28_5_REJECT_BULK_DESC))), (System.Action<WebAPI.Response.UserError>) (error =>
    {
