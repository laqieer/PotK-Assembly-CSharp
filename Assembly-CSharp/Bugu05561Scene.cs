...
public class Bugu05561Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu055_6_1", stack);

  public static void changeScene(bool stack, ItemInfo item) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu055_6_1", (stack ? 1 : 0) != 0, (object) item);

  public static void changeScene(bool stack, ItemInfo item, bool isNew, bool isScreenTouch) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu055_6_1", (stack ? 1 : 0) != 0, (object) item, (object) isNew, (object) isScreenTouch);
    ...
    bool isGacha)
  {
    ...
    if (isGacha)
    {
      ...
      bugu05561Scene.backgroundPrefab.GetComponent<UI2DSprite>().color = Consts.GetInstance().GACHA_RESULT_BACKGROUND_COLOR;
