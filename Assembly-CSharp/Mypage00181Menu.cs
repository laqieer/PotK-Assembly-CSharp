...
public class Mypage00181Menu : BackButtonMenuBase
{
  ...
  {
    Mypage00181Menu mypage00181Menu = this;
    foreach (Mypage00181TabPage tabPage in mypage00181Menu.tabPages)
    {
      ...
      IEnumerator e = tab.GetComponent<Mypage00181TabPage>().CreateScroll(array, (NGMenuBase) mypage00181Menu);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
