...
public class GuildChatDetailedListController : MonoBehaviour
{
  ...
  private IEnumerator WaitForNGUIProcessToFinish()
  {
    ...
    yield return (object) new WaitForSeconds(0.01f);
    this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, -(this.tailPlaceholder.transform.localPosition.y + this.panel.finalClipRegion.w), this.scrollView.transform.localPosition.z);
    this.panel.clipOffset = new Vector2(-this.scrollView.transform.localPosition.x, -this.scrollView.transform.localPosition.y);
  ...
  public void ResetPlaceholderPosition()
  {
    ...
    this.grid.transform.localPosition = new Vector3(0.0f, this.panel.finalClipRegion.w / 2f, 0.0f);
    ...
    if ((double) this.panel.finalClipRegion.w > (double) messageListHeight)
    {
      ...
      this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, 0.0f - this.clipSoftnessY, this.scrollView.transform.localPosition.z);
      this.panel.clipOffset = new Vector2(-this.scrollView.transform.localPosition.x, -this.scrollView.transform.localPosition.y);
    }
    else
    {
      this.tailPlaceholder.transform.localPosition = new Vector3(0.0f, -messageListHeight, 0.0f);
      this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, messageListHeight - this.panel.finalClipRegion.w + this.clipSoftnessY, this.scrollView.transform.localPosition.z);
      this.panel.clipOffset = new Vector2(-this.scrollView.transform.localPosition.x, -this.scrollView.transform.localPosition.y);
    }
    ...
    bool scrollToBottomNow = false)
  {
    ...
    this.headPlaceholder.transform.localPosition += new Vector3(0.0f, this.GetMessageListHeight(oldDataList) - this.GetMessageListHeight(deletedDataList), 0.0f);
    this.tailPlaceholder.transform.localPosition = this.headPlaceholder.transform.localPosition + new Vector3(0.0f, -this.GetMessageListHeight(this.displayingMessageDataList), 0.0f);
    if ((double) this.headPlaceholder.transform.localPosition.y - (double) this.tailPlaceholder.transform.localPosition.y < (double) this.panel.finalClipRegion.w)
      this.tailPlaceholder.transform.localPosition = this.headPlaceholder.transform.localPosition - new Vector3(0.0f, this.panel.finalClipRegion.w, 0.0f);
    if ((double) this.panel.finalClipRegion.y > (double) this.headPlaceholder.transform.localPosition.y && !this.scrollView.isDragging)
    {
      this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, -this.headPlaceholder.transform.localPosition.y - this.clipSoftnessY, this.scrollView.transform.localPosition.z);
      this.panel.clipOffset = new Vector2(-this.scrollView.transform.localPosition.x, -this.scrollView.transform.localPosition.y);
    }
    ...
    {
      this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, (float) -((double) this.tailPlaceholder.transform.localPosition.y + (double) this.panel.finalClipRegion.w) + this.clipSoftnessY, this.scrollView.transform.localPosition.z);
      this.panel.clipOffset = new Vector2(-this.scrollView.transform.localPosition.x, -this.scrollView.transform.localPosition.y);
    }
    if (newDataList.Count > 0)
    {
      ...
      {
        this.springPanel.target = new Vector3(this.scrollView.transform.localPosition.x, -(this.tailPlaceholder.transform.localPosition.y + this.panel.finalClipRegion.w) + this.clipSoftnessY, this.scrollView.transform.localPosition.z);
  ...
  public void SetDisplayingMessageDataList(List<GuildChatMessageData> messageDataList) => this.displayingMessageDataList = messageDataList;
  ...
  private void UpdateDetailedMessageList()
  {
    ...
    if (!(this.scrollView.currentMomentum != Vector3.zero) && !this.springPanel.isActiveAndEnabled)
      return;
    this.shouldUpdateDetailedMessageItemList = true;
  }
  ...
  private void ShowBottomArrow()
  {
    ...
    componentInChildren.GetComponent<TweenPosition>().PlayForward();
  ...
  private void UpdateMessageItem(GuildChatMessageData data)
  {
    ...
    for (int index = 0; index < gameObjectList.Count; ++index)
    {
      if (!gameObjectList[index].activeSelf)
      {
        ...
        component.transform.SetParent(this.grid.transform);
        component.transform.localScale = Vector3.one;
        component.transform.localPosition = new Vector3(0.0f, data.topPosition, 0.0f);
  ...
  private void InitializeBufferedMessageItems()
  {
    ...
    this.clipSoftnessY = this.scrollView.GetComponent<UIPanel>().clipSoftness.y;
  ...
  {
    this.scrollView.transform.localPosition = new Vector3(this.scrollView.transform.localPosition.x, -this.headPlaceholder.transform.localPosition.y, this.scrollView.transform.localPosition.z);
    this.panel.clipOffset = new Vector2(-this.scrollView.transform.localPosition.x, -this.scrollView.transform.localPosition.y);
  }
