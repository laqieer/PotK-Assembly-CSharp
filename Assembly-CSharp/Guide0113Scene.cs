...
public class Guide0113Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, Guide0111Scene.UpdateInfo updateInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("guide011_3", (stack ? 1 : 0) != 0, (object) updateInfo);
