...
public class Guild028114Popup : BackButtonMenuBase
{
  ...
  private void SetButton(GuildInfoPopup popup)
  {
    if (this.fromChangeGuild)
    {
      ...
      {
        this.btnSendRequest.gameObject.SetActive(false);
        this.btnCancelRequest.gameObject.SetActive(true);
      }
      else
      {
        this.btnSendRequest.gameObject.SetActive(true);
        this.btnCancelRequest.gameObject.SetActive(false);
      }
      if (PlayerAffiliation.Current.guild_id == this.guildDirectory.guild_id)
        this.btnSendRequest.isEnabled = false;
      else
        this.btnSendRequest.isEnabled = true;
      this.btnStatement.gameObject.SetActive(false);
    }
    else
    {
      ...
      if (this.guildDirectory == null && !this.isEnemy)
      {
        ...
        this.btnStatement.gameObject.SetActive(true);
      }
      else
        this.btnStatement.gameObject.SetActive(false);
    }
  ...
  private IEnumerator SetGuildData(GuildRegistration data)
  {
    ...
    Future<UnityEngine.Sprite> futureGuildTitleImage = EmblemUtility.LoadGuildEmblemSprite(this.guildRegistration.appearance._current_emblem);
    IEnumerator e = futureGuildTitleImage.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.guildTitleImage.sprite2D = futureGuildTitleImage.Result;
    if ((Object) this.guildBasePrefab == (Object) null)
    {
    ...
    if ((Object) this.guildStatement.GetComponent<BoxCollider>() != (Object) null)
    {
      this.guildStatement.GetComponent<BoxCollider>().size = new Vector3((float) this.guildStatement.width, (float) this.guildStatement.height, 0.0f);
      this.guildStatement.GetComponent<BoxCollider>().center = new Vector3(0.0f, (float) -this.guildStatement.height * 0.5f, 0.0f);
    }
  }
  ...
  private IEnumerator SetGuildData(GuildDirectory data)
  {
    ...
    Future<UnityEngine.Sprite> futureGuildTitleImage = EmblemUtility.LoadGuildEmblemSprite(this.guildDirectory.appearance._current_emblem);
    IEnumerator e = futureGuildTitleImage.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  {
    if ((Object) this.guildBase != (Object) null)
    ...
    if (data.level < 10)
    {
      this.guildLv_1.gameObject.SetActive(false);
      this.guildLv_10.gameObject.SetActive(true);
    ...
    {
      this.guildLv_1.gameObject.SetActive(true);
      this.guildLv_10.gameObject.SetActive(true);
    ...
    if (data.experience_next > 0)
      x = (float) data.experience / (float) (data.experience + data.experience_next);
    this.gaugeExp.transform.localScale = new Vector3(x, 1f, 1f);
  ...
  {
    if (Singleton<NGSceneManager>.GetInstance().sceneName.Equals("guild028_2") && (Object) Singleton<NGSceneManager>.GetInstance().sceneBase != (Object) null && (Object) Singleton<NGSceneManager>.GetInstance().sceneBase.GetComponent<Guild0282Menu>() != (Object) null)
  ...
  public void onButtonSendRequest()
  {
    ...
    if ((Object) gameObject.GetComponent<Guild028115Popup>().GetComponent<UIWidget>() != (Object) null)
      gameObject.GetComponent<Guild028115Popup>().GetComponent<UIWidget>().alpha = 0.0f;
    if (this.guildDirectory == null)
  ...
  public void onButtonCancelRequest()
  {
    ...
    if ((Object) gameObject.GetComponent<Guild028116Popup>().GetComponent<UIWidget>() != (Object) null)
      gameObject.GetComponent<Guild028116Popup>().GetComponent<UIWidget>().alpha = 0.0f;
    if (this.guildDirectory == null)
