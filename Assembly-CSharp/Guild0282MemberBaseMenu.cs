...
public class Guild0282MemberBaseMenu : GuildMapObject
{
  ...
  public IEnumerator ResourceLoad()
  {
    ...
    if ((UnityEngine.Object) this.guildBattlePreparationPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.guildTownTopPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.guildTownTopEnemyPopup == (UnityEngine.Object) null)
    {
    ...
    GvgStatus gvgStatus)
  {
    ...
    if (this.isEnemy)
    {
      ...
      this.ibtn_Town.isEnabled = PlayerAffiliation.Current.guild_map_enabled && GuildUtil.isBattle(gvgStatus) && this.memberData.scouted;
      this.txt_comeout_before_battle_map.SetActive(PlayerAffiliation.Current.guild_map_enabled && !this.ibtn_Town.isEnabled);
    }
    else if (PlayerAffiliation.Current.guild_map_enabled)
    {
      this.ibtn_attack_team.isEnabled = true;
      this.ibtn_defense_team.isEnabled = true;
      this.ibtn_Town.isEnabled = true;
    }
    else
    {
      ...
      this.ibtn_Town.isEnabled = false;
    }
  }
  ...
  public void onButtonMemberLog() => Singleton<CommonRoot>.GetInstance().guildChatManager.OpenMemberLogDialog(this.MemberData.player.player_id);
  ...
  private IEnumerator ShowMemberInfo()
  {
    ...
    IEnumerator e = component.Initialize(guild0282MemberBaseMenu.isEnemy, guild0282MemberBaseMenu.guild0282Menu, guild0282MemberBaseMenu.MemberData, guild0282MemberBaseMenu.memberPopup, new System.Action(guild0282MemberBaseMenu.\u003CShowMemberInfo\u003Eb__25_0), false);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public void onButtonBattle()
  {
    if (this.MemberData.own_star > 0)
      ...
      ModalWindow.ShowYesNo(Consts.GetInstance().GUILD_BATTLE_NON_STAR_TITLE, Consts.GetInstance().GUILD_BATTLE_NON_STAR_MESSAGE, (System.Action) (() => this.StartCoroutine(this.ShowBattlePreparationPopup(-1))), (System.Action) (() => {}));
  }
  ...
  private IEnumerator showAtkTeamPopup()
  {
    ...
    bool success = false;
    IEnumerator e = component.InitializeAsync(this.isEnemy, this.guild0282Menu, this.MemberData, (System.Action) (() => success = true));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (success)
  ...
  public IEnumerator ShowBattlePreparationPopup(int testSlotNo, bool isPopupStack = false)
  {
    ...
    bool success = false;
    IEnumerator e = script.InitializeAsync(this.guild0282Menu, this.MemberData.player.player_id, testSlotNo, (System.Action) (() => success = true));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if (success)
  ...
  private IEnumerator ShowGuildTownPopup()
  {
    ...
    {
      Future<WebAPI.Response.GuildtownShow> guildTownShow = WebAPI.GuildtownShow(memberMenu.memberData.player.player_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
    ...
    script.focusCurrentMap(defaultSlotNo, (System.Action) (() => this.guild0282Menu.openPopup(popup, GuildUtil.GvGPopupState.TownTop, true)));
  }
