...
public class Quest00226Menu : Quest00219Menu
{
    ...
    int lid)
  {
    ...
    if (!AlreadyReceived && menu.questScoreCampaignProgress.player.score_total > 0)
    {
      ...
      e = rewardPopup.GetComponent<Popup002261Menu>().Init(menu.questScoreCampaignProgress, rewards, menu, (System.Action) (() => UnityEngine.Object.DestroyObject((UnityEngine.Object) rewardPopup.gameObject)));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    ...
    int score)
  {
    ...
    list.transform.parent = quest00226Menu.grid.transform;
  ...
  public void IbtnRewardCheck() => Quest00227Scene.ChangeScene(this.questScoreCampaignProgress, true);

  public void IbtnRanking() => Quest00229Scene.ChangeScene(this.questScoreCampaignProgress.id, true);
