...
public class Startup00014Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("startup000_14", stack);
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    if ((UnityEngine.Object) this.loginBonusPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.loginBonusMonthlyPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.loginBonusMakeupPrefab == (UnityEngine.Object) null)
    {
  ...
  public override IEnumerator onEndSceneAsync()
  {
    if (this.doExploreLoginCalc)
    {
      ...
      if (explore.LoginCalcDirty)
      {
        ...
        yield return (object) explore.SaveSuspendData((System.Action) (() => saveFailed = true), true);
        if (saveFailed)
  ...
  {
    IOrderedEnumerable<PlayerLoginBonus> orderedEnumerable1 = loginBonusList.Where<PlayerLoginBonus>((Func<PlayerLoginBonus, bool>) (x => x.loginbonus.draw_type == LoginbonusDrawType.monthly_by_day)).OrderBy<PlayerLoginBonus, int>((Func<PlayerLoginBonus, int>) (x => x.loginbonus.ID));
    IOrderedEnumerable<PlayerLoginBonus> orderedEnumerable2 = loginBonusList.Where<PlayerLoginBonus>((Func<PlayerLoginBonus, bool>) (x => x.loginbonus.draw_type == LoginbonusDrawType.monthly)).OrderBy<PlayerLoginBonus, int>((Func<PlayerLoginBonus, int>) (x => x.loginbonus.ID));
    PlayerLoginBonus[] array = loginBonusList.Where<PlayerLoginBonus>((Func<PlayerLoginBonus, bool>) (x => x.loginbonus.draw_type != LoginbonusDrawType.monthly && x.loginbonus.draw_type != LoginbonusDrawType.monthly_by_day && x.loginbonus.draw_type != LoginbonusDrawType.popup)).OrderBy<PlayerLoginBonus, int>((Func<PlayerLoginBonus, int>) (x => x.loginbonus.ID)).Concat<PlayerLoginBonus>((IEnumerable<PlayerLoginBonus>) orderedEnumerable2).Concat<PlayerLoginBonus>((IEnumerable<PlayerLoginBonus>) orderedEnumerable1).ToArray<PlayerLoginBonus>();
