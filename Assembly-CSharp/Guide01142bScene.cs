...
public class Guide01142bScene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, GearGear[] itemInfo, int index) => Singleton<NGSceneManager>.GetInstance().changeScene("guide011_4_2b", (stack ? 1 : 0) != 0, (object) itemInfo, (object) false, (object) index);
