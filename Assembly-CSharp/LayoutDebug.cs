...
public class LayoutDebug : NGMenuBase
{
  ...
  private void OnGUI()
  {
    ...
    if (GUILayout.Button("<<<", GUILayout.MinWidth((float) (int) ((double) Screen.width * 0.2)), GUILayout.MinHeight((float) (int) ((double) Screen.height * 0.1))))
    {
      --this.currentScene;
    ...
    GUILayout.Label(this.sceneTitle, this.guiSkin.label);
  }
}
