...
public class unit00497Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, PrincesEvolutionParam param) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_9_7", (stack ? 1 : 0) != 0, (object) param);
