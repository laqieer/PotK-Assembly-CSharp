...
public class Sea030HomeScene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(bool isDuringDate)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) sea030HomeScene.sea030Menu != (UnityEngine.Object) null)
      {
    ...
    if (!this.isLoginOrInfo && !this.sea030Menu.ExistDateFlows() && !this.playStory)
    {
      ...
      if (Singleton<NGGameDataManager>.GetInstance().loginBonuses != null)
      {
        ...
        if (list.Count > 0)
        {
          ...
          this.sea030Menu.LoginPopupStart(list, list.Count<PlayerLoginBonus>(), new System.Action(this.ShowAdvice));
          flag = true;
        }
      }
      if (!flag)
      {
        ...
        {
          this.sea030Menu.openningNoticePrefab = true;
          this.sea030Menu.LevelUpPopupStart(playerLevelRewards, new System.Action(this.ShowAdvice));
          flag = true;
        }
      }
      if (!flag)
  ...
  private void ShowAdvice()
  {
    ...
    if (Singleton<TutorialRoot>.GetInstance().ShowAdvice("sea030_home_tutorial", finishCallback: ((System.Action) (() => this.StartCoroutine(this.sea030Menu.OpenSeaHomeTutorial())))))
      return;
  ...
  public void PlayBgm() => Singleton<NGSoundManager>.GetInstance().PlayBgmFile(this.bgmFile, this.bgmName);
}
