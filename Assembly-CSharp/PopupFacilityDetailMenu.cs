...
public class PopupFacilityDetailMenu : BackButtonMonoBehaiviour
{
  ...
  private System.Action<int, int, int> actionSell;
  private bool isPush;
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    if ((UnityEngine.Object) this.prefabGenre == (UnityEngine.Object) null)
    {
  ...
  public IEnumerator InitializeAsync(
    ...
    System.Action<int, int, int> actionSell)
  {
  ...
  {
    PopupFacilityDetailMenu facilityDetailMenu = this;
    if ((UnityEngine.Object) facilityDetailMenu.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      facilityDetailMenu.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    if (facilityData != null)
    {
      ...
      {
        if ((UnityEngine.Object) facilityDetailMenu.prefabGenre == (UnityEngine.Object) null)
        {
        ...
        if (genre1.HasValue)
        {
          GameObject go = facilityDetailMenu.prefabGenre.Clone(facilityDetailMenu.dyn_Skillproperty1.transform);
          UIWidget component1 = facilityDetailMenu.dyn_Skillproperty1.GetComponent<UIWidget>();
          SkillGenreIcon component2 = go.GetComponent<SkillGenreIcon>();
          ...
          NGUITools.AdjustDepth(go, facilityDetailMenu.depthProperty);
        }
        BattleskillGenre? genre2 = battleskill.genre2;
        if (genre2.HasValue)
        {
          GameObject go = facilityDetailMenu.prefabGenre.Clone(facilityDetailMenu.dyn_Skillproperty2.transform);
          UIWidget component1 = facilityDetailMenu.dyn_Skillproperty2.GetComponent<UIWidget>();
          SkillGenreIcon component2 = go.GetComponent<SkillGenreIcon>();
  ...
  public void onSellButton()
  {
    if (this.isPush)
      return;
    this.isPush = true;
    if ((UnityEngine.Object) this.sellnumEnterPopup == (UnityEngine.Object) null)
      return;
