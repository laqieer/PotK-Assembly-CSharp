...
public class Tower029RankingMenu : BackButtonMenuBase
{
  ...
  private bool isLoadedRanking(Tower029RankingStatus.StatusEnum eStatus) => this.dicRanking_.ContainsKey(eStatus);

  private T getRanking<T>(Tower029RankingStatus.StatusEnum eStatus)
  {
    object obj = (object) null;
    this.dicRanking_.TryGetValue(eStatus, out obj);
    return (T) obj;
  }
  ...
  public IEnumerator coInitalize(int tower_period, int tower_id)
  {
    ...
    ((IEnumerable<UIGrid>) this.gridsRanking_).ForEach<UIGrid>((System.Action<UIGrid>) (g => g.transform.Clear()));
    ((IEnumerable<UIGrid>) this.gridsHierarchy_).ForEach<UIGrid>((System.Action<UIGrid>) (g => g.transform.Clear()));
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.prefabRankingRow_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.prefabStatusRow_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.prefabUnitIcon_ == (UnityEngine.Object) null)
    {
    ...
    if (index1 >= 0 && index1 < 3)
    {
      ...
      else
      {
          ...
          case Tower029RankingStatus.StatusEnum.Speed:
            ...
            if (ranking1 != null && ranking1.speed_rankings != null && ranking1.speed_rankings.Length != 0)
            {
              ...
              for (index2 = 0; index2 < speedSpeedRankingsArray.Length; ++index2)
              {
                ...
                GameObject gameObject = this.prefabRankingRow_.Clone(grid.transform);
        ...
        if (grid.transform.childCount == 0)
          this.prefabRankingRow_.Clone(grid.transform).GetComponent<Tower029RankingPlayer>().initialize(this.prefabUnitIcon_, eStatus);
  ...
  private void changeDisplayMode(Tower029RankingMenu.DisplayMode dmode, bool isImmediate = false)
  {
    if (isImmediate)
    {
      ...
      if (!((UnityEngine.Object) this.topNewStatus_ != (UnityEngine.Object) null))
        return;
    ...
    else
    {
      ...
      if (this.modeDisplay_ == Tower029RankingMenu.DisplayMode.Status && (UnityEngine.Object) this.topNewStatus_ != (UnityEngine.Object) null)
      ...
      if (dmode == Tower029RankingMenu.DisplayMode.Status && (UnityEngine.Object) this.topNewStatus_ != (UnityEngine.Object) null)
  ...
  private void changeDisplayStatus(Tower029RankingStatus.StatusEnum eStatus, bool bInit = false)
  {
    ...
    }))
    {
      if (!((UnityEngine.Object) data.v == (UnityEngine.Object) null))
        data.v.isEnabled = (Tower029RankingStatus.StatusEnum) data.i != eStatus;
    }
  }
  ...
  private IEnumerator coChangeMyStatus()
  {
    ...
    else
    {
      Singleton<CommonRoot>.GetInstance().loadingMode = 1;
      Singleton<CommonRoot>.GetInstance().isLoading = true;
      Future<WebAPI.Response.TowerScoreDetail> future = WebAPI.TowerScoreDetail(this.periodId_, this.towerId_, (System.Action<WebAPI.Response.UserError>) (e =>
      {
        WebAPI.DefaultUserErrorCallback(e);
        MypageScene.ChangeSceneOnError();
      }));
      ...
      if (future.Result != null)
      {
        ...
        for (int ng = 0; ng < this.gridsHierarchy_.Length; ++ng)
        {
          ...
          switch (initStatus)
          {
            case Tower029RankingStatus.StatusEnum.Speed:
              foreach (WebAPI.Response.TowerScoreDetailTower_scores detailTowerScores in ((IEnumerable<WebAPI.Response.TowerScoreDetailTower_scores>) detail.tower_scores).Where<WebAPI.Response.TowerScoreDetailTower_scores>((Func<WebAPI.Response.TowerScoreDetailTower_scores, bool>) (s => s.speed_score > 0)).ToList<WebAPI.Response.TowerScoreDetailTower_scores>())
              {
                ...
                e1 = this.prefabStatusRow_.Clone(grid.transform).GetComponent<Tower029RankingHierarchy>().coInitialize(detailTowerScores.floor, initStatus, newflags, statusvalues, detailTowerScores.speed_score);
                while (e1.MoveNext())
                  yield return e1.Current;
                e1 = (IEnumerator) null;
              }
            ...
            case Tower029RankingStatus.StatusEnum.Technic:
              foreach (WebAPI.Response.TowerScoreDetailTower_scores detailTowerScores in ((IEnumerable<WebAPI.Response.TowerScoreDetailTower_scores>) detail.tower_scores).Where<WebAPI.Response.TowerScoreDetailTower_scores>((Func<WebAPI.Response.TowerScoreDetailTower_scores, bool>) (s => s.technical_score > 0)).ToList<WebAPI.Response.TowerScoreDetailTower_scores>())
              {
                ...
                int?[] statusvalues = nullableArray;
                e1 = this.prefabStatusRow_.Clone(grid.transform).GetComponent<Tower029RankingHierarchy>().coInitialize(detailTowerScores.floor, initStatus, newflags, statusvalues, detailTowerScores.technical_score);
                while (e1.MoveNext())
                  yield return e1.Current;
                e1 = (IEnumerator) null;
              }
            ...
            case Tower029RankingStatus.StatusEnum.Damage:
              foreach (WebAPI.Response.TowerScoreDetailTower_scores detailTowerScores in ((IEnumerable<WebAPI.Response.TowerScoreDetailTower_scores>) detail.tower_scores).Where<WebAPI.Response.TowerScoreDetailTower_scores>((Func<WebAPI.Response.TowerScoreDetailTower_scores, bool>) (s => s.damage_score > 0)).ToList<WebAPI.Response.TowerScoreDetailTower_scores>())
              {
                ...
                int?[] statusvalues = nullableArray;
                e1 = this.prefabStatusRow_.Clone(grid.transform).GetComponent<Tower029RankingHierarchy>().coInitialize(detailTowerScores.floor, initStatus, newflags, statusvalues, detailTowerScores.damage_score);
                while (e1.MoveNext())
                  yield return e1.Current;
                e1 = (IEnumerator) null;
              }
          ...
          isempty &= grid.transform.childCount == 0;
          if (this.newStatus_ != null && this.newStatus_.Length > ng && (UnityEngine.Object) this.newStatus_[ng] != (UnityEngine.Object) null)
            this.newStatus_[ng].SetActive(isnew);
          grid = (UIGrid) null;
        }
        if ((UnityEngine.Object) this.topNoneStatus_ != (UnityEngine.Object) null)
  ...
  protected override void Update()
  {
    ...
    List<GameObject> self = this.lstInitializeObjs_.Count > modeStatus ? this.lstInitializeObjs_[modeStatus] : (List<GameObject>) null;
    if (self == null || self.Count == 0)
      return;
    Transform transform = this.gridsRanking_[modeStatus].transform;
    ...
    for (; index < num3; ++index)
    {
      ...
      {
        this.queInitialize_.Enqueue(self[nullable.Value]);
