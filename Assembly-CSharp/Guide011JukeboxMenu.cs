...
public class Guide011JukeboxMenu : BackButtonMenuBase
{
  ...
  {
    this.transformMusicListScroll = this.musicListScroll.transform;
    ...
    foreach (GameObject musicTab in this.musicTabs)
    {
      ...
      this.tabDict.Add(musicTab.name, musicTabId);
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    guide011JukeboxMenu.musicTabCenterOnChild.onFinished = new SpringPanel.OnFinished(guide011JukeboxMenu.\u003ConStartSceneAsync\u003Eb__52_0);
    int tabId = 1;
  ...
  private void SetTab(int tabId) => this.musicTabCenterOnChild.CenterOn(this.musicTabCenterOnChild.transform.GetChild(this.tabIdToIndex[tabId]));
  ...
  private void SetMusicScroll(int tabId)
  {
    ...
    {
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.baseMusicScrollItem);
    ...
    else
    {
      if (this.currentMusic != null && music.ID != this.currentMusic.ID)
      {
        ...
        if (nullable.HasValue)
        {
          ...
          if ((UnityEngine.Object) this.musicItemAllInfos[nullable.Value].MusicScrollItem != (UnityEngine.Object) null)
      ...
      if ((UnityEngine.Object) component != (UnityEngine.Object) null)
      {
        ...
        else
        {
          ...
          component.SetColor(component.disabledColor);
        }
      }
      ...
      if (this.currentMusic.purchase_site_link == "")
        this.buySiteButton.isEnabled = false;
      else
        this.buySiteButton.isEnabled = true;
  ...
  protected override void Update()
  {
    base.Update();
    this.UpdateDisc();
    if ((UnityEngine.Object) this.transformMusicListScroll == (UnityEngine.Object) null)
      return;
    ...
    do
    {
      ...
      {
        GameObject go = transformScrollItem.gameObject;
        float num3 = transformScrollItem.localPosition.y + num1;
        if ((double) num3 > (double) this.checkHeight)
        {
          int? nullable = this.musicItemAllInfos.FirstIndexOrNull<MusicItemInfo>((Func<MusicItemInfo, bool>) (v => (UnityEngine.Object) v.MusicScrollItem != (UnityEngine.Object) null && (UnityEngine.Object) v.MusicScrollItem.gameObject == (UnityEngine.Object) go));
  ...
  {
    if ((UnityEngine.Object) this.slc_Record == (UnityEngine.Object) null)
      return;
    if (this.isPause)
    {
  ...
  private void ResetScroll(int index)
  {
    ...
    {
      if ((UnityEngine.Object) musicItemAllInfo.MusicScrollItem == (UnityEngine.Object) musicScrollItem)
        musicItemAllInfo.MusicScrollItem = (MusicScrollItem) null;
    }
    musicScrollItem.gameObject.SetActive(false);
  }
  ...
  private void CreateScroll(int info_index, int unit_index)
  {
    ...
    {
      if ((UnityEngine.Object) musicItemAllInfo2.MusicScrollItem == (UnityEngine.Object) musicScrollItem)
    ...
    musicScrollItem.gameObject.SetActive(true);
  ...
  {
    if (this.musicTabScrollSpringPanel.enabled)
      return;
  ...
  public void onMusicPlay()
  {
    ...
    else
    {
      ...
      if (musicItemInfo != null)
      {
        ...
        if ((UnityEngine.Object) musicItemInfo.MusicScrollItem != (UnityEngine.Object) null)
  ...
  private int getCurrentPlayMusicIndex()
  {
    ...
    for (int index = 0; index < this.plaingMusicList.Length; ++index)
    {
      if (this.plaingMusicList[index].ID == id)
        return index;
    }
    return -1;
  }
  ...
  private void SetPlaingMusic(Music music)
  {
    ...
    if ((UnityEngine.Object) currentPlayScrollItem != (UnityEngine.Object) null)
    {
