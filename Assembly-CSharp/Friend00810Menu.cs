...
public class Friend00810Menu : BackButtonMenuBase
{
  ...
  private IEnumerator SearchUser(string short_id)
  {
    ...
    else
    {
      ...
      Future<WebAPI.Response.PlayerSearch> searchF = WebAPI.PlayerSearch(short_id, new System.Action<WebAPI.Response.UserError>(friend00810Menu.\u003CSearchUser\u003Eb__13_0));
      e = searchF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
