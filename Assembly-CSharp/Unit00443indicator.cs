...
public class Unit00443indicator : MonoBehaviour
{
  ...
  private bool isEarth => !this.isEarth_.HasValue ? (this.isEarth_ = new bool?(Singleton<NGGameDataManager>.GetInstance().IsEarth)).Value : this.isEarth_.Value;
  ...
  public IEnumerator LoadPrefabs()
  {
    ...
    if ((UnityEngine.Object) this.WeaponSkillPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.popupAttackPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.popupElementPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.commonElementIconPrefab == (UnityEngine.Object) null)
    {
  ...
  protected void SetSkillDialog(UIButton button, GearGearSkill skill_data, bool isRelease)
  {
    if (this.showSkillDialog == null)
    {
      if (this.isEarth)
      {
        ...
        this.showSkillDialog = (System.Action<GearGearSkill, bool>) ((skill, release) => PopupSkillDetails.show(this.SkillDialog, new PopupSkillDetails.Param(skill.skill, UnitParameter.SkillGroup.Equip, release ? new int?(skill.skill_level) : new int?())));
    }
  ...
  protected void SetSkillDeteilEvent(GearGear gear)
  {
    ...
    if (gear.rememberSkills.Count > 0)
    {
      ...
      if (num != 0)
      {
        ...
        {
          BattleSkillIcon battleSkillIcon = uiWidgetArray[index].GetComponentInChildren<BattleSkillIcon>();
          if ((UnityEngine.Object) battleSkillIcon == (UnityEngine.Object) null)
            battleSkillIcon = this.WeaponSkillPrefab.Clone(uiWidgetArray[index].transform).GetComponent<BattleSkillIcon>();
    ...
    else
    {
      ...
      {
        foreach (Component componentsInChild in uiWidgetArray[index].GetComponentsInChildren<BattleSkillIcon>(true))
  ...
  protected void SetSkillDeteilEvent(GameCore.ItemInfo gear)
  {
    ...
    if (gear1.rememberSkills.Count > 0)
    {
      ...
      else if (flag)
      {
        ...
        {
          BattleSkillIcon component = this.WeaponSkillPrefab.Clone(uiWidgetArray[index].transform).GetComponent<BattleSkillIcon>();
  ...
  {
    if ((UnityEngine.Object) this.WeaponSpAttack == (UnityEngine.Object) null)
      return;
    this.WeaponSpAttack.gameObject.SetActive(gear.kind.is_attack);
    this.TxtWeaponAttack.gameObject.SetActive(gear.hasAttackClass);
  ...
  {
    if ((UnityEngine.Object) this.WeaponSpElement == (UnityEngine.Object) null)
      return;
    this.WeaponSpElement.gameObject.SetActive(gear.kind.is_attack);
    this.TxtWeaponElement.gameObject.SetActive(gear.kind.is_attack);
    if (!gear.kind.is_attack && !gear.hasAttackClass)
      return;
  ...
  public void OpenPopupWeaponAttack() => this.StartCoroutine(PopupAttackClassDetail.show(this.popupAttackPrefab, this.current_));

  public void OpenPopupWeaponElement() => this.StartCoroutine(PopupGearAttachedElementDetail.show(this.popupElementPrefab, this.current_));
