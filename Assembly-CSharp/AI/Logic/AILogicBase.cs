...
namespace AI.Logic
{
  public abstract class AILogicBase
  {
    ...
    public bool isInitialized => this.env.aiUnits.value != null && this.env.aiUnits.value.Count != 0 && this.env.aiActionUnits.value != null && (uint) this.env.aiActionUnits.value.Count > 0U;

    public bool isCompleted => this.env.aiActionUnits.value != null && this.env.aiActionUnits.value.Count == 0 && this.env.aiActionOrder.value != null && (uint) this.env.aiActionOrder.value.Count > 0U;
  }
}
