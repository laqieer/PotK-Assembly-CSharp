...
public class ShopArticleListMenu : BackButtonMenuBase
{
      ...
      })).ThenBy<PlayerShopArticle, int>((Func<PlayerShopArticle, int>) (x => x.article.view_order)).ToList<PlayerShopArticle>())
      {
        if (playerShopArticle.article.shop.ID == this.EnableShopID)
        {
          ...
          this.allArticleInfos.Add(new ArticleInfo()
          {
            ...
            onPurchasedHolding = new System.Action<long>(this.UpdatePurchasedHolding)
          });
        }
      }
    }
  ...
  public virtual IEnumerator Init(Future<GameObject> cellPrefab)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) shopArticleListMenu.CellObject == (UnityEngine.Object) null && cellPrefab != null)
    {
      e = cellPrefab.Wait();
      while (e.MoveNext())
        yield return e.Current;
    ...
    if ((UnityEngine.Object) shopArticleListMenu.unitIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) shopArticleListMenu.itemIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) shopArticleListMenu.uniqueIconPrefab == (UnityEngine.Object) null)
    {
    ...
    shopArticleListMenu.scrool_start_y = shopArticleListMenu.scroll.scrollView.transform.localPosition.y;
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        {
          int? nullable = this.allArticleInfos.FirstIndexOrNull<ArticleInfo>((Func<ArticleInfo, bool>) (v => (UnityEngine.Object) v.scroll != (UnityEngine.Object) null && (UnityEngine.Object) v.scroll.gameObject == (UnityEngine.Object) go));
  ...
  private void ResetScroll(int index)
  {
    ...
    this.allArticleInfos.Where<ArticleInfo>((Func<ArticleInfo, bool>) (a => (UnityEngine.Object) a.scroll == (UnityEngine.Object) scroll)).ForEach<ArticleInfo>((System.Action<ArticleInfo>) (b => b.scroll = (Shop0074Scroll) null));
  }
  ...
  private IEnumerator CreateCellBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.CellMaxValue, this.allArticleInfos.Count); ++index)
      this.allCellObject.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<Shop0074Scroll>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.CellMaxValue, this.allCellObject.Count); ++index)
      this.scroll.AddColumn1(this.allCellObject[index].gameObject, this.CellWidth, this.CellHeight);
