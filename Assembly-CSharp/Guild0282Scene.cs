...
public class Guild0282Scene : NGSceneBase
{
  ...
  public static void ChangeScene() => Singleton<NGSceneManager>.GetInstance().changeScene("guild028_2", Singleton<NGSceneManager>.GetInstance().sceneName != "guild028_2");

  public static void ChangeSceneBattleFinish(string targetPlayerID, int captureStar, bool isTest) => Singleton<NGSceneManager>.GetInstance().changeScene("guild028_2", true, (object) targetPlayerID, (object) captureStar, (object) isTest);
  ...
  public static void ChangeSceneOrMemberFocus(GuildMembership member, Guild0282Menu menu)
  {
    ...
    else
    {
      ...
      {
        menu = Singleton<NGSceneManager>.GetInstance().sceneBase.GetComponent<Guild0282Menu>();
        if ((UnityEngine.Object) menu == (UnityEngine.Object) null)
        {
