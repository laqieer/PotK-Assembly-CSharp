...
public class BattlePvpFinalize : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    if (battlePvpFinalize.pvpManager.isResult)
    {
      ...
      do
      {
        ...
        Future<WebAPI.Response.PvpPlayerStatus> futureP = WebAPI.PvpPlayerStatus(new System.Action<WebAPI.Response.UserError>(battlePvpFinalize.errorCallback));
        e = futureP.Wait();
        while (e.MoveNext())
      ...
      else
      {
        ...
        ModalWindow.Show(Consts.GetInstance().PVP_NO_RESULT_ERROR_POPUP_TITLE, Consts.GetInstance().PVP_NO_RESULT_ERROR_POPUP_MESSAGE, new System.Action(battlePvpFinalize.\u003CStart_Battle\u003Eb__3_0));
      }
    }
    else
    {
      Future<WebAPI.Response.PvpForceClose> futureF = WebAPI.PvpForceClose(true, new System.Action<WebAPI.Response.UserError>(battlePvpFinalize.errorCallback));
      e = futureF.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  {
    IEnumerator e1 = WebAPI.PvpForceClose(false, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e))).Wait();
    while (e1.MoveNext())
