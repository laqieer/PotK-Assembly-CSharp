...
public class Quest00230Menu : BackButtonMenuBase
{
  ...
  public void ShowTargetDetail(EnemyTopInfo[] infos) => this.StartCoroutine(this.ShowTargetDetailAsync(infos));

  private IEnumerator ShowTargetDetailAsync(EnemyTopInfo[] infos)
  {
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    Future<WebAPI.Response.EventDetail> receive = WebAPI.EventDetail(this.eventInfo.period_id, ((IEnumerable<EnemyTopInfo>) infos).Select<EnemyTopInfo, int>((Func<EnemyTopInfo, int>) (x => x.unit_id)).ToArray<int>(), (System.Action<WebAPI.Response.UserError>) (error =>
    {
  ...
  public IEnumerator Init(EventInfo eventInfo, WebAPI.Response.EventTop eventTopInfo)
  {
    ...
    if (quest00230Menu.isInit)
    {
      ...
      if ((UnityEngine.Object) quest00230Menu.targetUnitPrefab == (UnityEngine.Object) null)
      {
      ...
      {
        ((IEnumerable<Quest00230NextRewardObject>) quest00230Menu.nextRewardObjects).ForEach<Quest00230NextRewardObject>((System.Action<Quest00230NextRewardObject>) (x => x.gameObject.SetActive(false)));
      ...
      else
      {
        ...
        if (ServerTime.NowAppTime() < eventTopInfo.end_at)
        {
          ...
          e = quest00230Menu.nextRewardObjects[0].Init(eventTopInfo, nextRewardList, EventPointType.all, new System.Action(quest00230Menu.NextRewardDisplayWait), new System.Action(quest00230Menu.NextRewardDisplayStart));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
          e = quest00230Menu.nextRewardObjects[1].Init(eventTopInfo, nextRewardList, EventPointType.personal, new System.Action(quest00230Menu.NextRewardDisplayWait), new System.Action(quest00230Menu.NextRewardDisplayStart));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
          e = quest00230Menu.nextRewardObjects[2].Init(eventTopInfo, nextRewardList, EventPointType.guild, new System.Action(quest00230Menu.NextRewardDisplayWait), new System.Action(quest00230Menu.NextRewardDisplayStart));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
      ...
      if ((UnityEngine.Object) quest00230Menu.targetUnitDetailPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) quest00230Menu.targetUnitQuestListPrefab == (UnityEngine.Object) null)
      {
      ...
      if (eventTopInfo.enemy_infos != null && eventTopInfo.enemy_infos.Length != 0)
      {
        ...
        {
          e = quest00230Menu.indicatorContainerAnimFade01.instantiateParts(quest00230Menu.targetUnitPrefab).GetComponent<UnitWanted>().Init(source2.ToArray<EnemyTopInfo>(), new System.Action<EnemyTopInfo[]>(quest00230Menu.ShowTargetDetail));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
        }
      ...
      if (targetCnt < 3)
      {
        ...
        {
          e = quest00230Menu.indicatorContainerAnimFade01.instantiateParts(quest00230Menu.targetUnitPrefab).GetComponent<UnitWanted>().Init((EnemyTopInfo[]) null, new System.Action<EnemyTopInfo[]>(quest00230Menu.ShowTargetDetail));
          while (e.MoveNext())
            yield return e.Current;
          e = (IEnumerator) null;
        }
  ...
  private void NextRewardDisplayStart() => this.nextRewardObjects[this.enableNextRewardObjectIndexList[this.nowDisplayNextRewardIndex]].Display();
