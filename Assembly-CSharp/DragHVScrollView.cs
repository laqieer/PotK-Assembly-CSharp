...
public class DragHVScrollView : MonoBehaviour
{
  ...
  public UIScrollView hscroll
  {
    ...
    set
    {
      if ((Object) this.horizontal_ == (Object) value)
        return;
  ...
  public UIScrollView vscroll
  {
    ...
    set
    {
      if ((Object) this.vertical_ == (Object) value)
        return;
  ...
  {
    this.isError_ = (Object) this.vertical_ == (Object) null || (Object) this.horizontal_ == (Object) null;
    if (!this.isError_)
      return;
    this.isDraggable_ = false;
  }
  ...
  {
    if (this.isError_ || !this.enabled || !NGUITools.GetActive(this.gameObject))
      return;
    DragHVScrollView.MoveMode moveMode = DragHVScrollView.MoveMode.Neutral;
    if (pressed)
    {
      bool flag1 = this.vertical_.enabled && this.vertical_.gameObject.activeSelf;
      bool flag2 = this.horizontal_.enabled && this.horizontal_.gameObject.activeSelf;
  ...
  private void OnDrag(Vector2 delta)
  {
    ...
    if (this.mode_ == DragHVScrollView.MoveMode.Neutral)
    {
      ...
      if ((double) this.thresholdVertical_ >= (double) (Mathf.Atan2(Mathf.Abs(normalized.x), Mathf.Abs(normalized.y)) * 57.29578f))
      {
