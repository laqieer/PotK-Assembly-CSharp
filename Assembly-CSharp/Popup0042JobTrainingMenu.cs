...
public class Popup0042JobTrainingMenu : BackButtonMenuBase
{
  ...
  private IEnumerator CreateButton(string txt, bool active, System.Action callFunction)
  {
    GameObject btn = this.button.Clone(this.buttonsGrid.transform);
    btn.SetActive(false);
    DetailJobTraining component = btn.GetComponent<DetailJobTraining>();
    component.dragScrollView.scrollView = this.scrollview;
    IEnumerator e = component.Init(txt, active, (System.Action) (() => callFunction()));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    btn.SetActive(true);
  ...
  {
    IEnumerator e = this.CreateButton(btnTitle, active, (System.Action) (() => this.ShowCallDialogPrefab(skill, attackClass)));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private void ShowCallDialogPrefab(BattleskillSkill skill, GearAttackClassification attackClass)
  {
    ...
    {
      this.attackMethodDialog = this.attackMethodDialogPrefab.Clone(this.transform);
