...
public class DetailMenuJobAbilityParts : MonoBehaviour
{
  ...
  public bool hasOnClickLevelUp => (bool) (Object) this.dir_LevelUp;

  public List<EventDelegate> onClickLevelUp => this.dir_LevelUp.GetComponentInChildren<UIButton>(true).onClick;
  ...
  public bool Initialize(PlayerUnitJob_abilities jobAbility, bool diffView = false, bool bActiveLevelUp = false)
  {
    ...
    if ((Object) this.master_icon != (Object) null)
      this.master_icon.SetActive(flag);
    if ((Object) this.not_master_icon != (Object) null)
      this.not_master_icon.SetActive(!flag);
    if ((Object) this.txt_MasterBonus != (Object) null)
    {
      this.txt_MasterBonus.color = (Color) (flag ? new Color32(byte.MaxValue, byte.MaxValue, (byte) 0, byte.MaxValue) : new Color32((byte) 175, (byte) 175, (byte) 175, byte.MaxValue));
    ...
    if ((bool) (Object) this.dir_LevelUp)
    {
