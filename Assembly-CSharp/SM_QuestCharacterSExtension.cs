...
{
  public static PlayerCharacterQuestS[] M(this PlayerCharacterQuestS[] self) => ((IEnumerable<PlayerCharacterQuestS>) self).Distinct<PlayerCharacterQuestS>((IEqualityComparer<PlayerCharacterQuestS>) new LambdaEqualityComparer<PlayerCharacterQuestS>((Func<PlayerCharacterQuestS, PlayerCharacterQuestS, bool>) ((a, b) => a.quest_character_s.quest_m.ID == b.quest_character_s.quest_m.ID))).OrderBy<PlayerCharacterQuestS, int>((Func<PlayerCharacterQuestS, int>) (x => x.quest_character_s.quest_m.priority)).ToArray<PlayerCharacterQuestS>();

  public static PlayerCharacterQuestS[] SelectReleased(
    this PlayerCharacterQuestS[] self)
  {
