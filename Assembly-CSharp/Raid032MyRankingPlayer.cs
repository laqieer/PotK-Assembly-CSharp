...
public class Raid032MyRankingPlayer : Raid032MyRankingStatus
{
  ...
  public IEnumerator coInitImage()
  {
    if (this.initData != null && !this.isInitImage)
    {
      ...
      Future<UnityEngine.Sprite> ldemblem = EmblemUtility.LoadEmblemSprite(this.initData.emblem);
      e = ldemblem.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      ...
      ldemblem = (Future<UnityEngine.Sprite>) null;
      this.initData = (Raid032MyRankingPlayer.Data) null;
      this.isInitImage = true;
    }
  }

  public void changeStatus(Raid032MyRankingStatus.StatusEnum estatus) => this.changeDrawStatus(estatus);
  ...
  public void changeDrawRank(int rank = 0)
  {
    ...
    if (this.rankBoards != null)
    {
      ...
      {
        if (rankBoard != null && !((UnityEngine.Object) rankBoard.top == (UnityEngine.Object) null))
        {
    ...
    if ((UnityEngine.Object) this.topInfo != (UnityEngine.Object) null)
      this.topInfo.SetActive((uint) rankEnum > 0U);
    if (!((UnityEngine.Object) this.txtRank != (UnityEngine.Object) null))
      return;
    this.txtRank.gameObject.SetActive(flag1);
    if (!flag1)
      return;
    ...
    this.txtRank.SetTextLocalize(Consts.Format(Consts.GetInstance().GUILD_RAID_RANKING_RANK, (IDictionary) hashtable2));
  }
  ...
  public class Data
  {
    ...
    {
      int leaderUnitId = unit != (PlayerUnit) null ? unit.unit.ID : 0;
      int leaderUnitLvl = unit != (PlayerUnit) null ? unit.total_level : 1;
      int leaderJobId = unit != (PlayerUnit) null ? unit.job_id : 0;
      this.init(rank, player.name, player.level, player.id, playerAffiliation.guild.guild_name, leaderUnitId, leaderUnitLvl, leaderJobId, player.current_emblem_id);
    }
  ...
  public class InsBoard
  {
    ...
    public void drawDecimal(int num)
    {
      ...
      for (int index = 0; index < this.@decimal.Length; ++index)
      {
        ...
        if (decimalSprite != null && !((UnityEngine.Object) decimalSprite.top == (UnityEngine.Object) null))
        {
          if (num2 == index)
