...
public class Mypage0017Scroll : MonoBehaviour
{
  ...
  public IEnumerator Init(PlayerPresent present)
  {
    ...
    {
      this.PresentReceive[mode].gameObject.SetActive(true);
      this.PresentHaveReceive[mode].gameObject.SetActive(false);
      this.PresentNew[mode].gameObject.SetActive(true);
    }
    else
    {
      this.PresentReceive[mode].gameObject.SetActive(false);
      this.PresentHaveReceive[mode].gameObject.SetActive(true);
      this.PresentNew[mode].gameObject.SetActive(false);
    }
    this.PresentLock[mode].gameObject.SetActive(false);
    if (this.mode == Mypage0017Scroll.Mode.Present)
    {
      ...
      this.Present.gameObject.SetActive(true);
      yield break;
    }
  }
