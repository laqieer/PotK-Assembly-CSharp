...
public class Guild0287Menu : GuildBankDonateListBase
{
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.donateResultPopup == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.donateListPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.levelUpPrefab == (UnityEngine.Object) null)
    {
  ...
  private void SetAppearance()
  {
    ...
    if (this.bank.experience_next > 0)
      x = (float) this.bank.experience / (float) (this.bank.experience + this.bank.experience_next);
    this.lvGauge.transform.localScale = new Vector3(x, 1f, 1f);
  ...
  private void SetGuildLevelLabel(int level)
  {
    if (level < 10)
    {
      this.lv1.gameObject.SetActive(false);
      this.lv10.gameObject.SetActive(true);
    ...
    {
      this.lv1.gameObject.SetActive(true);
      this.lv10.gameObject.SetActive(true);
  ...
  private void SetExperienceNextLabel(int expNext) => this.exp_next_level.SetTextLocalize(Consts.Format(Consts.GetInstance().GUILD_BANK_EXP_NEXT_LEVEL, (IDictionary) new Hashtable()
  {
    {
      (object) "exp",
      (object) expNext
  ...
  private void SetRateButton()
  {
    for (int index = 0; index < this.bank.scales.Length; ++index)
    {
      ...
      {
        this.rateBtns[index].btn.transform.parent.gameObject.SetActive(false);
      }
      else
      {
        this.rateBtns[index].btn.transform.parent.gameObject.SetActive(true);
        ...
        {
          if ((UnityEngine.Object) this.rateBtns[index].dir_open_condition != (UnityEngine.Object) null)
        ...
        else
        {
          ...
          if ((UnityEngine.Object) this.rateBtns[index].txt_crest_guild_condition != (UnityEngine.Object) null)
          ...
          if ((UnityEngine.Object) this.rateBtns[index].txt_crest_guild_condition_shadow != (UnityEngine.Object) null)
  ...
  public void SetRateButtonColor()
  {
    for (int index = 0; index < this.rateBtns.Count; ++index)
    {
      if (this.rateBtns[index].btn.isEnabled)
      {
        ...
        this.rateBtns[index].btn.GetComponent<SpreadColorButton>().SetColor(color);
      }
    }
  }
  ...
  private IEnumerator ExecuteDonation(GuildMoneyRate moneyRate)
  {
    ...
    Future<WebAPI.Response.GuildBankInvest> fObj = WebAPI.GuildBankInvest(moneyRate.rate_id, guild0287Menu.currentScale, (System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  private IEnumerator StartAnimation()
  {
    ...
    float currentGaugeScaleX = guild0287Menu.lvGauge.transform.localScale.x;
    ...
    if (levelupCnt > 0)
    {
      ...
      guildBaseEffPrefab.gameObject.SetActive(false);
      ...
      guildBasePrefab.gameObject.SetActive(false);
    ...
    while (!maxLevel)
    {
      ...
      guild0287Menu.lvGauge.transform.localScale = new Vector3(Mathf.Min(1f, currentGaugeScaleX), 1f, 1f);
      if (currentLv < guild0287Menu.bankAfter.level && (double) currentExp >= (double) nextExp)
      {
        GaugeRunner.StopSE();
        currentGaugeScaleX = 0.0f;
        guild0287Menu.lvGauge.transform.localScale = new Vector3(0.0f, 1f, 1f);
        currentExp = 0.0f;
        ...
        e = guild0287Menu.showLevelupAnim(currentLv, guildBasePrefab.gameObject, guildBaseEffPrefab.gameObject);
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        if (!maxLevel)
    ...
    if ((UnityEngine.Object) guildBasePrefab != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) guildBasePrefab.gameObject);
      guildBasePrefab = (Guild0282GuildBase) null;
    }
    if ((UnityEngine.Object) guildBaseEffPrefab != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) guildBaseEffPrefab.gameObject);
  ...
  protected override IEnumerator CreateScroll(int info_index, int bar_index)
  {
    ...
    if (bar_index < guild0287Menu.allDonateBar.Count && info_index < guild0287Menu.allDonateInfo.Count)
    {
      ...
      IEnumerator e = scrollParts.Initialize(guild0287Menu.bank.available && guild0287Menu.bank.released, donateBarInfo.moneyRate, guild0287Menu.currentScale, new System.Action<GuildMoneyRate>(guild0287Menu.\u003CCreateScroll\u003Eb__36_0));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      scrollParts.gameObject.SetActive(true);
    }
  }
