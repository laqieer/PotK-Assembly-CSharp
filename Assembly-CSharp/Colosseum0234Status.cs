...
public class Colosseum0234Status : MonoBehaviour
{
  ...
  private bool DispReward(ColosseumUtility.Info colosseumInfo) => colosseumInfo.colosseum_record.current_rank + 1 > colosseumInfo.colosseum_record.max_rank && colosseumInfo.colosseum_record.max_rank != colosseumInfo.colosseum_record.enabled_max_rank;
  ...
  private void SetBattlePoint(int point, bool dispReward)
  {
    if (dispReward)
    {
      this.TxtBattlept.gameObject.SetActive(false);
      this.TxtBattlept_thum.gameObject.SetActive(true);
      this.TxtBattlept_thum.SetTextLocalize(point);
    }
    else
    {
      this.TxtBattlept_thum.gameObject.SetActive(false);
      this.TxtBattlept.gameObject.SetActive(true);
  ...
  private void SetCombatPow(int combat, bool dispReward)
  {
    ...
    if (dispReward)
    {
      this.TxtFighting.gameObject.SetActive(false);
      this.TxtFighting_thum.gameObject.SetActive(true);
      this.TxtFighting_thum.SetTextLocalize(combat);
    }
    else
    {
      this.TxtFighting.gameObject.SetActive(true);
      this.TxtFighting_thum.gameObject.SetActive(false);
  ...
  {
    if (this.colosseumInfo == null || (UnityEngine.Object) this.menu == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator LoadRewardObject()
  {
    ...
    if ((UnityEngine.Object) this.uniquePrefab == (UnityEngine.Object) null)
    {
