...
public class UniqueIcons : IconPrefabBase
{
  ...
  private IEnumerator InitNumber()
  {
    ...
    {
      Future<UnityEngine.Sprite> equalsF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Icons/slc_equals");
  ...
  public IEnumerator SetAwakeSkill(int id = 0)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Future<UnityEngine.Sprite> spriteF = MasterData.BattleskillSkill[id].LoadBattleSkillIcon();
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public IEnumerator SetRecoveryItemIconImage(int rewardID, int count = 0)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Future<UnityEngine.Sprite> spriteF = new ResourceObject("AssetBundle/Resources/recovery_item/{0}/2D/item_thum".F((object) rewardID)).Load<UnityEngine.Sprite>();
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public IEnumerator SetKillersTicket(int id, int count = 0)
  {
    ...
    Future<UnityEngine.Sprite> spriteF = data.createLoaderThumb();
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public IEnumerator SetMaterialPack(int ticketID, int count = 0)
  {
    ...
    Future<UnityEngine.Sprite> spriteF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format(format, (object) data.packID));
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public IEnumerator SetGuildMap(int id)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Future<UnityEngine.Sprite> spriteF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/GuildMap/{0}/2D/c_thum", (object) id));
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public IEnumerator SetReincarnationTypeTicket(int id, int count = 0)
  {
    ...
    Future<UnityEngine.Sprite> spriteF = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("ReincarnationTypeTicket/{0}/ticket", (object) data.icon_id));
  ...
  public IEnumerator SetCommonTicket(int id, int count = 0)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Future<UnityEngine.Sprite> spriteF = ticketMaster.LoadIconMSpriteF();
    e = spriteF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public void DisableButton()
  {
    if ((UnityEngine.Object) this.button_ == (UnityEngine.Object) null)
    {
      Transform transform = this.transform.Find("ibtn_button");
      if ((UnityEngine.Object) transform == (UnityEngine.Object) null)
        return;
      this.button_ = transform.GetComponent<LongPressButton>();
    }
    this.button_.onClick.Clear();
    this.button_.onLongPress.Clear();
    this.button_.gameObject.GetComponent<BoxCollider>().enabled = false;
  }
