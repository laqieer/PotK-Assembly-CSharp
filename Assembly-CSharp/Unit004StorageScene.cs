...
public class Unit004StorageScene : NGSceneBase
{
  ...
  public override IEnumerator Start()
  {
    ...
    unit004StorageScene.menuBases = source.Where<NGMenuBase>((Func<NGMenuBase, bool>) (m => (UnityEngine.Object) m != (UnityEngine.Object) null)).ToArray<NGMenuBase>();
    if (unit004StorageScene.menuBases != null)
      ((IEnumerable<NGMenuBase>) unit004StorageScene.menuBases).ForEach<NGMenuBase>((System.Action<NGMenuBase>) (x =>
      {
        if (!((UnityEngine.Object) x != (UnityEngine.Object) null))
          return;
        x.enabled = false;
      }));
    if ((UnityEngine.Object) unit004StorageScene.currentMenu != (UnityEngine.Object) null)
      unit004StorageScene.currentMenu.enabled = true;
  }

  public static void changeSceneList(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_storage", (stack ? 1 : 0) != 0, (object) Unit004StorageScene.Mode.List);

  public static void changeSceneListWithInitialize(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_storage", (stack ? 1 : 0) != 0, (object) Unit004StorageScene.Mode.List, (object) true);

  public static void changeSceneSell(bool stack, bool bFromAlertUnitOver) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_storage", (stack ? 1 : 0) != 0, (object) Unit004StorageScene.Mode.Sell, (object) false, (object) bFromAlertUnitOver);

  private void changeMenu(UnitMenuBase menu)
  {
    this.currentMenu = menu;
    this.textTitle.SetText(this.currentMenu.Title);
    if ((UnityEngine.Object) this.currentMenu == (UnityEngine.Object) this.menuList)
    {
      ...
      this.menuSell.enabled = false;
      this.menuList.enabled = true;
      this.bottomStorage.SetActive(true);
      this.bottomPossession.SetActive(true);
      this.bottomSell.SetActive(false);
      this.scrollPanel.bottomAnchor.absolute = this.POSSESION_SCROLLPANEL_BOTTOMANCHOR;
      this.scrollBarWidget.bottomAnchor.absolute = this.POSSESION_SCROLLBAR_BOTTOMANCHOR;
    }
    else
    {
      if (!((UnityEngine.Object) this.currentMenu == (UnityEngine.Object) this.menuSell))
        return;
      ...
      this.menuSell.enabled = true;
      this.menuList.enabled = false;
      this.bottomStorage.SetActive(false);
      this.bottomPossession.SetActive(false);
      this.bottomSell.SetActive(true);
      this.scrollPanel.bottomAnchor.absolute = this.SELL_SCROLLPANEL_BOTTOMANCHOR;
      this.scrollBarWidget.bottomAnchor.absolute = this.SELL_SCROLLBAR_BOTTOMANCHOR;
    }
  }
  ...
  public IEnumerator onStartSceneAsync(Unit004StorageScene.Mode mode)
  {
    ...
    e1 = (IEnumerator) null;
    Future<WebAPI.Response.UnitReservesIndex> f = WebAPI.UnitReservesIndex((System.Action<WebAPI.Response.UserError>) (e =>
    {
