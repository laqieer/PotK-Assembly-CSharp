...
public class Sea030AlbumIllustrationScene : NGSceneBase
{
  ...
  public static void ChangeScene(float width, int album_id, bool isStack) => Singleton<NGSceneManager>.GetInstance().changeScene("sea030_album_illustration", (isStack ? 1 : 0) != 0, (object) width, (object) album_id);
  ...
  public void onStartScene(float width, int album_id) => Singleton<CommonRoot>.GetInstance().isLoading = false;
  ...
  private IEnumerator SetSeaBackground()
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((Object) bgF.Result != (Object) null)
