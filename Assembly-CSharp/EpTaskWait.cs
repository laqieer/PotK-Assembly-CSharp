...
public class EpTaskWait : ExploreTask, IEpAdjustableTask
{
  ...
  public override long GetRestReqiredTime() => Math.Min(this.GetReqiredTime() - this.ProcTime, this.mReqiredTime);

  public override long GetTakeOverTime() => Math.Max(this.mTakeOverTime - this.ProcTime, 0L);

  public override void OnBackExplore() => Singleton<ExploreSceneManager>.GetInstance().PlayLoopSe("SE_2452");
