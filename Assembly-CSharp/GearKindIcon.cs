...
public class GearKindIcon : IconPrefabBase
{
  ...
  public void Init(GearKind kind, CommonElement element = CommonElement.none) => this.iconSprite.sprite2D = GearKindIcon.LoadSprite(kind.Enum, element);

  public void Init(int ID, CommonElement element = CommonElement.none) => this.iconSprite.sprite2D = GearKindIcon.LoadSprite((GearKindEnum) ID, element);
  ...
  {
    string empty = string.Empty;
    this.iconSprite.sprite2D = Resources.Load<UnityEngine.Sprite>(!Singleton<NGGameDataManager>.GetInstance().IsSea ? string.Format("Icons/Materials/GearKindIcon/9") : string.Format("Icons/Materials/Sea/GearKindIcon/s_type_none"));
  }

  public static GameObject GetPrefab()
  {
    if ((Object) GearKindIcon.self == (Object) null)
