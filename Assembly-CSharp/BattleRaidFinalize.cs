...
public class BattleRaidFinalize : BattleMonoBehaviour
{
  protected override IEnumerator Start_Battle()
  {
    ...
    Future<WebAPI.Response.GuildraidBattleFinish> f = WebAPI.RaidBattleFinish(req, battleRaidFinalize.env, new System.Action<WebAPI.Response.UserError>(battleRaidFinalize.errorCallback));
  ...
  private void errorCallback(WebAPI.Response.UserError error)
  {
    ...
    Singleton<NGSceneManager>.GetInstance().StartCoroutine(PopupCommon.Show(title, message, (System.Action) (() =>
    {
