...
public class MapEditFacilityInformation : MonoBehaviour
{
  ...
  private bool isActiveInformation_ => !((UnityEngine.Object) this.tween_ != (UnityEngine.Object) null) ? this.gameObject.activeSelf : this.tween_.isActive;

  private void setActiveInformation(bool bActive, bool bInit = false)
  {
    if ((UnityEngine.Object) this.tween_ != (UnityEngine.Object) null)
    {
      if (bInit)
  ...
  {
    get => this.wCurrent_ == null || !this.wCurrent_.IsAlive ? (MapEditOrnament) null : this.wCurrent_.Target as MapEditOrnament;
    set
    {
      if ((UnityEngine.Object) this.current_ == (UnityEngine.Object) value)
        return;
      this.wCurrent_ = (UnityEngine.Object) value != (UnityEngine.Object) null ? new WeakReference((object) value) : (WeakReference) null;
    }
  }
  ...
  public void initialize(MapEdit031TopMenu menu)
  {
    ...
    if ((UnityEngine.Object) menu == (UnityEngine.Object) null)
      return;
    this.tween_ = this.GetComponent<NGTweenParts>();
    this.setActiveInformation(false, true);
    this.menu_.isActiveButtonStorage_ = true;
    this.isWait_ = false;
    if ((UnityEngine.Object) this.btnRemove_ != (UnityEngine.Object) null)
      EventDelegate.Set(this.btnRemove_.onClick, (EventDelegate.Callback) (() =>
      {
        if ((UnityEngine.Object) this.menu_.currentOrnament_ == (UnityEngine.Object) null || this.waitAndSet())
          return;
        this.menu_.returnStorageWithEffect();
      }));
    if (!((UnityEngine.Object) this.btnToLayout_ != (UnityEngine.Object) null))
      return;
    EventDelegate.Set(this.btnToLayout_.onClick, (EventDelegate.Callback) (() =>
    {
      ...
      if ((UnityEngine.Object) currentOrnament == (UnityEngine.Object) null || this.waitAndSet())
        return;
  ...
  private void Update()
  {
    if ((UnityEngine.Object) this.menu_ == (UnityEngine.Object) null)
      return;
    MapEditOrnament currentOrnament = this.menu_.currentOrnament_;
    bool flag = this.menu_.enabledInformation_ && (UnityEngine.Object) currentOrnament != (UnityEngine.Object) null;
    ...
    if (!this.isActiveInformation_)
      return;
    if (!this.isWait_ && (UnityEngine.Object) this.current_ != (UnityEngine.Object) currentOrnament)
    {
      if ((UnityEngine.Object) this.current_ == (UnityEngine.Object) null || this.current_.facility_ != currentOrnament.facility_)
      {
  ...
  public void updateInformation(MapEditOrnament ornament)
  {
    ...
    if ((UnityEngine.Object) ornament == (UnityEngine.Object) null || ornament.facility_ == null)
    {
      this.menu_.isActiveButtonStorage_ = true;
    ...
    else
    {
      ...
      if ((UnityEngine.Object) this.iconGenre0_ != (UnityEngine.Object) null)
      {
        UnityEngine.Object.Destroy((UnityEngine.Object) this.iconGenre0_);
        this.iconGenre0_ = (GameObject) null;
      }
      if ((UnityEngine.Object) this.iconGenre1_ != (UnityEngine.Object) null)
      {
        UnityEngine.Object.Destroy((UnityEngine.Object) this.iconGenre1_);
      ...
      if ((UnityEngine.Object) this.prefabGenre_ != (UnityEngine.Object) null && skill != null)
      {
        ...
        if (genre2.HasValue)
        {
          ...
          UIWidget component1 = this.lnkProperty1_.GetComponent<UIWidget>();
          SkillGenreIcon component2 = this.iconGenre1_.GetComponent<SkillGenreIcon>();
          component2.Init(genre2);
          if ((UnityEngine.Object) component1 != (UnityEngine.Object) null)
            component2.SetSize(Mathf.RoundToInt(component1.localSize.x), Mathf.RoundToInt(component1.localSize.y));
