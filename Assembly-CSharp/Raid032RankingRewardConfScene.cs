...
public class Raid032RankingRewardConfScene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, GuildRaid raid) => Singleton<NGSceneManager>.GetInstance().changeScene("raid032_PlayerRankingReward_conf", (stack ? 1 : 0) != 0, (object) raid);
