...
public class Explore033RankingRewardMenu : BackButtonMenuBase
{
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.boxPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.scrollContainerRanking != (UnityEngine.Object) null)
    {
      this.scrollContainerRanking.Scroll.transform.Clear();
    ...
    if ((UnityEngine.Object) this.scrollContainerFloor != (UnityEngine.Object) null)
    {
      this.scrollContainerFloor.Scroll.transform.Clear();
      ...
      if ((UnityEngine.Object) indexObj == (UnityEngine.Object) null)
      {
  ...
  private void ResetScrollObject(Explore033RankingRewardMenu.RewardTabType type)
  {
    ...
    switch (this.tabType)
    {
      case Explore033RankingRewardMenu.RewardTabType.RANKING:
        this.scrollContainerRanking?.gameObject.SetActive(true);
        this.scrollContainerFloor?.gameObject.SetActive(false);
        this.btnRanking?.SetColor(Color.white);
        this.btnFloor?.SetColor(Color.gray);
        break;
      default:
        this.scrollContainerFloor?.gameObject.SetActive(true);
        this.scrollContainerRanking?.gameObject.SetActive(false);
