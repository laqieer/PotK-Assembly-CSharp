...
public class Unit004ExtraskillEquipListMenu : Unit004SelectExtraSkillListMenuBase
{
  ...
  protected override List<PlayerAwakeSkill> GetExtraSkills() => ((IEnumerable<PlayerAwakeSkill>) this.targetUnit.unit.GetAllEquipableAwakeSkills(this.EditParam?.skills)).ToList<PlayerAwakeSkill>();
  ...
  protected override IEnumerator InitExtension()
  {
    ...
    if (extraskillEquipListMenu.EditParam == null)
    {
      if ((UnityEngine.Object) extraskillEquipListMenu.skillEquipedByOthersPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) extraskillEquipListMenu.extraSkillEquipUnitConfirm1DlgPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) extraskillEquipListMenu.extraSkillEquipUnitConfirm2DlgPrefab == (UnityEngine.Object) null)
      {
    ...
    if ((UnityEngine.Object) extraskillEquipListMenu.unitIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) extraskillEquipListMenu.skillGenrePrefab == (UnityEngine.Object) null)
    {
    ...
    SortAndFilter.SORT_TYPE_ORDER_BUY order)
  {
    ...
    if ((UnityEngine.Object) this.scroll.BottomObject != (UnityEngine.Object) null)
      this.scrollBottom = this.scroll.BottomObject.GetComponent<UIWidget>();
    if ((UnityEngine.Object) this.scroll.TopObject != (UnityEngine.Object) null)
  ...
  {
    if ((UnityEngine.Object) this.scrollBottom == (UnityEngine.Object) null || (UnityEngine.Object) this.scrollBarWidget == (UnityEngine.Object) null || !(type != this.bottomInfoType | force))
      return;
    ...
    switch (this.bottomInfoType)
    {
      case Unit004ExtraskillEquipListMenu.BottomInfoType.LIST:
        ...
        this.scrollBarWidget.bottomAnchor.absolute = this.SCROLL_BAR_BOTTOM_FULL;
        break;
      case Unit004ExtraskillEquipListMenu.BottomInfoType.SKILL_INFO:
        ((IEnumerable<GameObject>) this.bottomInfos).ToggleOnceEx(1);
        if (num > ExtraSkillIcon.Height)
          this.scrollBottom.height = this.SCROLL_BOTTOM_INFO;
        this.scrollBarWidget.bottomAnchor.absolute = this.SCROLL_BAR_BOTTOM_INFO;
        break;
    }
  ...
  private IEnumerator ShowEquipedByOthersDig(InventoryExtraSkill awakeSKill)
  {
    ...
    IEnumerator e = prefab.GetComponent<Popup004ExtraSkillEquipedByOthers>().Init(awakeSKill.skill, awakeSKill.equipUnit, extraskillEquipListMenu.targetUnit, new System.Action<PlayerAwakeSkill, PlayerUnit, PlayerUnit>(extraskillEquipListMenu.SwapEquipExtraSkill));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator ShowEquipUnitConfirm1Dlg(InventoryExtraSkill awakeSKill)
  {
    ...
    prefab.SetActive(false);
    IEnumerator e = prefab.GetComponent<Popup004ExtraSkillEquipConfirm1Menu>().Init(awakeSKill.skill, extraskillEquipListMenu.targetUnit, new System.Action<PlayerAwakeSkill, PlayerUnit>(extraskillEquipListMenu.EquipExtraSkill));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Singleton<PopupManager>.GetInstance().open(prefab, isCloned: true);
  ...
  private IEnumerator ShowEquipUnitConfirm2Dlg(PlayerAwakeSkill awakeSKill)
  {
    ...
    else
    {
      ...
      prefab.SetActive(false);
      IEnumerator e = prefab.GetComponent<Popup004ExtraSkillEquipConfirm2Menu>().Init(extraskillEquipListMenu.targetUnit.equippedExtraSkill, awakeSKill, extraskillEquipListMenu.targetUnit, new System.Action<PlayerAwakeSkill, PlayerAwakeSkill, PlayerUnit>(extraskillEquipListMenu.ChangeExtraSkill));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      Singleton<PopupManager>.GetInstance().open(prefab, isCloned: true);
  ...
  private IEnumerator changeFavorite(System.Action endAct)
  {
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    Future<WebAPI.Response.AwakeSkillFavorite> fav = WebAPI.AwakeSkillFavorite(this.extraSkillFavoriteDic.Where<KeyValuePair<int, bool>>((Func<KeyValuePair<int, bool>, bool>) (x => x.Value)).Select<KeyValuePair<int, bool>, int>((Func<KeyValuePair<int, bool>, int>) (x => x.Key)).ToArray<int>(), this.extraSkillFavoriteDic.Where<KeyValuePair<int, bool>>((Func<KeyValuePair<int, bool>, bool>) (x => !x.Value)).Select<KeyValuePair<int, bool>, int>((Func<KeyValuePair<int, bool>, int>) (x => x.Key)).ToArray<int>(), (System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  public override void IbtnBack()
  {
    ...
    if (this.extraSkillFavoriteDic != null && this.extraSkillFavoriteDic.Count<KeyValuePair<int, bool>>() > 0)
      this.StartCoroutine(this.changeFavorite((System.Action) (() => this.backScene())));
    else
      this.backScene();
  }
  ...
  private void RemoveExtraSkill(PlayerUnit unit)
  {
    if (this.EditParam != null)
      ...
      this.StartCoroutine(new ExtraskillUtil().RemoveExtraSkillAsync(unit, new System.Action(((Unit004ExtraSkillListMenuBase) this).IbtnBack)));
  }

  private void EquipExtraSkill(PlayerAwakeSkill skill, PlayerUnit unit) => this.StartCoroutine(new ExtraskillUtil().EquipExtraSkillAsync(skill, unit, new System.Action(((Unit004ExtraSkillListMenuBase) this).IbtnBack)));
  ...
  private void ChangeExtraSkill(
    ...
    PlayerUnit unit)
  {
    this.StartCoroutine(new ExtraskillUtil().ChangeEquipExtraSkillAsync(beforeSkill, afterSkill, unit, new System.Action(((Unit004ExtraSkillListMenuBase) this).IbtnBack)));
  }
  ...
  protected override void UpdateInventoryExtraSkillList()
  {
    ...
    {
      PlayerAwakeSkill[] playerAwakeSkillArray = SMManager.Get<PlayerAwakeSkill[]>();
      foreach (InventoryExtraSkill inventoryExtraSkill in list)
      {
        InventoryExtraSkill invItem = inventoryExtraSkill;
        PlayerAwakeSkill skill = ((IEnumerable<PlayerAwakeSkill>) playerAwakeSkillArray).FirstOrDefault<PlayerAwakeSkill>((Func<PlayerAwakeSkill, bool>) (x => x.id == invItem.uniqueID));
        if (skill != null)
          this.UpdateInventoryExtraSkillList(invItem, skill, this.isUpdateInfoData ? skill.favorite : invItem.favorite);
      }
    }
    this.SelectItemList.ForEachIndex<InventoryExtraSkill>((System.Action<InventoryExtraSkill, int>) ((x, idx) =>
    {
      x.select = true;
  ...
  protected override InventoryExtraSkill CreateInventoryExtraSkill(
    PlayerAwakeSkill skill)
  {
    if (this.EditParam == null)
