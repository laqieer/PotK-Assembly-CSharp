...
public class CreateIconObject : MonoBehaviour
{
  ...
  private static ResourceObject UniqueIconPrefab_sea => new ResourceObject("Icons/UniqueIconPrefab_sea");
    ...
    bool isRouletteWheelIcon = false)
  {
    ...
    bool isQuantity = (uint) quantity > 0U;
    ...
    GameObject linkTarget = createIconObject.gameObject;
    ...
    switch (rewardType)
    {
      ...
      case MasterDataTable.CommonRewardType.material_unit:
        ...
        if (MasterData.UnitUnit.TryGetValue(rewardID, out unit1))
        {
          ...
          link.SetEmpty();
        createIconObject.objIcon = link.gameObject;
      ...
      case MasterDataTable.CommonRewardType.supply:
        ...
        createIconObject.objIcon = supplyPrefab.gameObject;
        break;
      ...
      case MasterDataTable.CommonRewardType.gear_body:
        ...
        createIconObject.objIcon = gearIcon.gameObject;
        break;
      case MasterDataTable.CommonRewardType.guild_facility:
        ...
        createIconObject.objIcon = FacilityIcon.gameObject;
        break;
      default:
    ...
    if ((UnityEngine.Object) createIconObject.uniqueIcon != (UnityEngine.Object) null)
      createIconObject.objIcon = createIconObject.uniqueIcon.gameObject;
  }
    ...
    GameObject popupPrefab = null)
  {
    ...
    switch (rewardType)
    {
      ...
      case MasterDataTable.CommonRewardType.material_unit:
        ...
        component1.onClick = (System.Action<UnitIconBase>) (x => this.onDetail());
        component1.onLongPress = (System.Action<UnitIconBase>) (x => this.onDetail());
        break;
      case MasterDataTable.CommonRewardType.supply:
      case MasterDataTable.CommonRewardType.gear:
      case MasterDataTable.CommonRewardType.material_gear:
      case MasterDataTable.CommonRewardType.gear_body:
        ...
        component2.onClick = (System.Action<ItemIcon>) (x => this.onDetail());
        component2.EnableLongPressEvent(isGear, new System.Action<ItemIcon>(this.onDetailByItemIcon));
        break;
      default:
        this.uniqueIcon.onClick = (System.Action<UniqueIcons>) (x => this.onDetail());
        this.uniqueIcon.onLongPress = (System.Action<UniqueIcons>) (x => this.onDetail());
        break;
    }
  ...
  {
    if ((UnityEngine.Object) popupPrefab == (UnityEngine.Object) null)
    {
  ...
  {
    if (!((UnityEngine.Object) this.uniqueIcon != (UnityEngine.Object) null))
      return;
    this.uniqueIcon.gameObject.AddComponent<UIDragScrollView>();
  }
  ...
  public void DisableLongPressEvent()
  {
    switch (this.rewardType)
    {
      case MasterDataTable.CommonRewardType.unit:
      case MasterDataTable.CommonRewardType.material_unit:
        this.objIcon.GetComponent<UnitIcon>().Button.gameObject.SetActive(false);
        break;
      case MasterDataTable.CommonRewardType.supply:
      case MasterDataTable.CommonRewardType.gear:
      case MasterDataTable.CommonRewardType.material_gear:
      case MasterDataTable.CommonRewardType.gear_body:
        ...
        break;
      default:
        if (!(bool) (UnityEngine.Object) this.uniqueIcon)
          break;
