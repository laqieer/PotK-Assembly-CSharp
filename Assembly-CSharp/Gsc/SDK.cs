...
namespace Gsc
{
  public static class SDK
  {
    ...
    public static Coroutine Initialize<T>(
      Configuration.Builder<T> confBuilder,
      string specifiedEnv = null)
      where T : struct, Configuration.IEnvironment
    {
      SDK.hasError = true;
    ...
    private static void _PreInit(string appName, IWebQueueObserver webQueueObserver)
    {
      ...
      LogKit.Logger.Init(appName, Path.applicationDataPath + "/_logs", ImmortalObject.Instance.gameObject);
    }
    ...
    private static void _PostInit(Configuration conf)
    {
      ...
      App.Hardkey.Init(ImmortalObject.Instance.gameObject);
    ...
    public class BootLoader : MonoBehaviour
    {
      ...
      {
        if ((UnityEngine.Object) SDK.BootLoader.currentLoader != (UnityEngine.Object) null)
          UnityEngine.Object.Destroy((UnityEngine.Object) SDK.BootLoader.currentLoader.gameObject);
      ...
      private IEnumerator Start()
      {
        ...
        if (num != 0)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          this.\u003C\u003E1__state = -1;
          UnityEngine.Object.Destroy((UnityEngine.Object) bootLoader.gameObject);
