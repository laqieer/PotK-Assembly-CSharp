...
namespace Gsc.Network.Data
{
  public class EntityRepository
  {
    ...
    public static EntityList<T> GetAll<T>() where T : Entity<T> => EntityRepository.repository.GetRepository<T>().PublicList;
    ...
    private EntityRepository.SimpleRepository<T> GetRepository<T>() where T : Entity<T> => (EntityRepository.SimpleRepository<T>) this.GetRepository(typeof (T));
    ...
    private class SimpleRepository<T> : EntityRepository.ISimpleRepository where T : Entity<T>
    {
      ...
      void EntityRepository.ISimpleRepository.Push(IEntity value, bool isPermanent) => this.Push((T) value, isPermanent);
