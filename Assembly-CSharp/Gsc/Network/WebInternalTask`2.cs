...
namespace Gsc.Network
{
    ...
    where TResponse : Gsc.Network.Response<TResponse>
  {
    ...
    protected override WebTaskResult ProcessResponse(WebInternalResponse response) => WebTask<TRequest, TResponse>.TryGetResponse(this._request, response, out this._response, out this._error);
  }
}
