...
namespace Gsc.Network
{
  public class WebQueue : IEnumerator
  {
    ...
    private System.Type execludRetryType = typeof (AccessTokenVerify);
    ...
    private bool HasNext() => this.needAuthorization || this.serialQueue.HasNext() || this.parallelQueue.HasNext();
    ...
    private class SerialQueue : IEnumerator
    {
      ...
      public bool isRunning => this.currentTask != null && !this.currentTask.HasAttributes(WebTaskAttribute.Silent) || this.queuedTasks.Where<IWebTask>((Func<IWebTask, bool>) (x => !x.HasAttributes(WebTaskAttribute.Silent))).Count<IWebTask>() > 0;
      ...
      public object Current => this.currentTask != null ? (object) this.currentTask.Run() : (object) null;
    ...
    private class ParallelQueue
    {
      ...
      public bool isRunning => this.queuedTasks.Where<IWebTask>((Func<IWebTask, bool>) (x => !x.HasAttributes(WebTaskAttribute.Silent))).Count<IWebTask>() + this.runningTasks.Where<IWebTask>((Func<IWebTask, bool>) (x => !x.HasAttributes(WebTaskAttribute.Silent))).Count<IWebTask>() > 0;
