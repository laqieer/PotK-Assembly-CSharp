...
namespace Gsc.Core
{
  public static class AssemblySupport
  {
    ...
    public static T CreateInstance<T>(params object[] args) => AssemblySupport.CreateInstance<T>(typeof (T), args);

    public static T CreateInstance<T>(string typeName) => AssemblySupport.CreateInstance<T>(AssemblySupport.GetType(typeName));

    public static T CreateInstance<T>(string typeName, params object[] args) => AssemblySupport.CreateInstance<T>(AssemblySupport.GetType(typeName), args);

    public static T CreateInstance<T>(Type type) => (T) Activator.CreateInstance(type);

    public static T CreateInstance<T>(Type type, params object[] args) => (T) Activator.CreateInstance(type, args);
    ...
    public static AssemblySupport.MethodInfo GetConstructor(
      string typeName,
      params Type[] types)
    {
    ...
    public class MethodInfo
    {
      ...
      public static AssemblySupport.MethodInfo Create(
        Type type,
      ...
      public void CallVoidMethod(object obj, params object[] args) => this.methodInfo.Invoke(obj, args);

      public T CallMethod<T>(object obj, params object[] args) => (T) this.methodInfo.Invoke(obj, args);

      public void CallStaticVoidMethod(params object[] args) => this.CallVoidMethod((object) null, args);
