...
namespace Gsc.Purchase
{
  ...
  {
    private static bool IsAliveMethod(bool enabledInactiveCallback, Delegate method) => ListenerSupport.IsAliveObject<object>(enabledInactiveCallback, method.Target);
    ...
    public static bool IsAliveObject<T>(bool enabledInactiveCallback, T obj)
    {
      ...
      if ((UnityEngine.Object) monoBehaviour == (UnityEngine.Object) null || !monoBehaviour.enabled)
        return false;
      return enabledInactiveCallback || monoBehaviour.gameObject.activeInHierarchy;
    }
