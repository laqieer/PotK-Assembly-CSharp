...
namespace Gsc.Purchase.Platform
{
  public class AUMarket : FlowWithPurchaseKit
  {
    ...
    protected override IWebTask CreateFulfillmentTask(PurchaseKit.PurchaseResponse response)
    {
      ...
      WebTask<Verify, Verify.Response> task = new Verify(response.Meta.Data1, response.Meta.Data0, purchaseDataList).GetTask(WebTaskAttribute.Reliable | WebTaskAttribute.Silent | WebTaskAttribute.Parallel);
