...
{
  public class BinaryRequest : Gsc.Network.Request<BinaryRequest, BinaryResponse>
  {
    ...
    public override WebTaskResult InquireResult(
    ...
    public static IEnumerator OnFailed(WebTaskResult result) => BinaryRequest.OnFailed(result, new WebRequest("auth", WebRequest.RequestMethod.GET, (string) null, (System.Action<WebResponse>) null), new WebResponse(), (Func<WebError, IEnumerator>) null);
      ...
      if (callback != null)
      {
        ...
        switch (result)
        {
          ...
          case WebTaskResult.ExpiredSessionError:
            ModalWindow.Show("セッションエラー", "アプリを再起動して下さい", (System.Action) (() => Application.Quit()));
            yield break;
