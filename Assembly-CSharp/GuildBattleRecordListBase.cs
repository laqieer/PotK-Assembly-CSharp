...
public class GuildBattleRecordListBase : BackButtonMonoBehaiviour
{
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.allRecordInfo.FirstIndexOrNull<GuildBattleRecordBarInfo>((Func<GuildBattleRecordBarInfo, bool>) (v => (UnityEngine.Object) v.scrollParts != (UnityEngine.Object) null && (UnityEngine.Object) v.scrollParts.gameObject == (UnityEngine.Object) unit));
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allRecordInfo.Count); ++index)
      this.allRecordBar.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<GuildBattleRecordScroll>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allRecordBar.Count); ++index)
      this.scroll.AddColumn1(this.allRecordBar[index].gameObject, this.barWidth, this.barHeight);
  ...
  protected void ResetScroll(int index)
  {
    ...
    scrollParts.gameObject.SetActive(false);
    this.allRecordInfo.Where<GuildBattleRecordBarInfo>((Func<GuildBattleRecordBarInfo, bool>) (a => (UnityEngine.Object) a.scrollParts == (UnityEngine.Object) scrollParts)).ForEach<GuildBattleRecordBarInfo>((System.Action<GuildBattleRecordBarInfo>) (b => b.scrollParts = (GuildBattleRecordScroll) null));
  }
