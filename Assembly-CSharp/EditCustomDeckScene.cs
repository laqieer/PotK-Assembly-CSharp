...
public class EditCustomDeckScene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(string fromScene, int deckNumber, int[] usedIds)
  {
    ...
    foreach (string str in strArray)
    {
      if (!(str == "quest002_8"))
      {
        if (!(str == "versus026_2") && !(str == "versus026_10"))
        {
          if (str == "raid032_battle")
  ...
  public void onStartScene(string fromScene, int deckNumber, int[] usedIds) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
  ...
  public void onBackScene(string fromScene, int deckNumber, int[] usedIds) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
  ...
  public void onStartScene(string fromScene, ColosseumUtility.Info colosseumInfo) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
  ...
  public void onBackScene(string fromScene, ColosseumUtility.Info colosseumInfo) => Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
