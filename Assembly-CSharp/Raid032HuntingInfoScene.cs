...
public class Raid032HuntingInfoScene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, int period_id) => Singleton<NGSceneManager>.GetInstance().changeScene("raid032_HuntingInfo", (stack ? 1 : 0) != 0, (object) period_id);
