...
public class CorpsQuestBattleEntryMenu : BackButtonMenuBase
{
  ...
  private const float ICON_SCALE = 0.8070176f;
  [SerializeField]
  ...
  private string totalCombat => this.selectedUnits.Sum<PlayerUnit>((Func<PlayerUnit, int>) (x => !(x != (PlayerUnit) null) ? 0 : Judgement.NonBattleParameter.FromPlayerUnit(x).Combat)).ToString();
  ...
  private IEnumerator SetSupply()
  {
    ...
    for (int i = 0; i < this.supplyItems.Length; ++i)
    {
      ...
      if (i < items.Length)
      {
        ...
        e = (IEnumerator) null;
        int temp = i;
        n.onClick = (System.Action<ItemIcon>) (supplyicon => this.StartCoroutine(this.setDetailPopup(items[temp].supply.ID)));
      }
      else
      {
        n.SetModeSupply();
  ...
  private IEnumerator StartSortie()
  {
    ...
    Future<WebAPI.Response.QuestCorpsBattleStart> f = WebAPI.QuestCorpsBattleStart(this.PeriodID, this.StageID, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
  ...
  private IEnumerator AutoSelectAsync()
  {
    ...
    IEnumerator waitPopup = Unit0046ConfirmAutoOrganization.doPopup((string) null, (System.Action<CommonElement>) (_element =>
    {
      bok = true;
      element = _element;
    }));
    ...
    if (bok)
    {
      ...
      Creator deckCreator = new Creator((PlayerUnit[]) null, source.ToArray<PlayerUnit>(), (List<Filter>) null, 1, 6);
      ...
      if (deckCreator.isSuccess)
      {
        ...
        Future<WebAPI.Response.QuestCorpsDeckEdit> f = WebAPI.QuestCorpsDeckEdit(this.PeriodID, player_unit_ids, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
        e1 = f.Wait();
        while (e1.MoveNext())
          yield return e1.Current;
        e1 = (IEnumerator) null;
