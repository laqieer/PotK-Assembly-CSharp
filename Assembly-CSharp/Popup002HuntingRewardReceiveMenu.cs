...
public class Popup002HuntingRewardReceiveMenu : BackButtonMenuBase
{
    ...
    bool isGuild)
  {
    ...
    if (isGuild)
    {
      this.txt_PlayerTotalHunting.SetAnchor(this.txt_GuildHuntingPt.gameObject);
      this.txt_PlayerTotalHuntingPt.SetAnchor(this.txt_GuildHuntingPt.gameObject);
    ...
    {
      this.txt_PlayerTotalHunting.SetAnchor(this.txt_AllPlayerTotalHuntingPt.gameObject);
      this.txt_PlayerTotalHuntingPt.SetAnchor(this.txt_AllPlayerTotalHuntingPt.gameObject);
