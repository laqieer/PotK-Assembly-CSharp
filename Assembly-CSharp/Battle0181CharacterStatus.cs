...
public class Battle0181CharacterStatus : NGBattleMenuBase
{
    ...
    bool isDemo)
  {
    ...
    this.maxHp = ((object) unit != null ? __nonvirtual (unit.parameter)?.Hp : new int?()) ?? this.currentHp;
    ...
    if (isDemo)
    {
      ...
      {
        (UnityEngine.Object) this.link_spattackUp != (UnityEngine.Object) null ? this.link_spattackUp.gameObject : (GameObject) null,
        (UnityEngine.Object) this.link_spattackDown != (UnityEngine.Object) null ? this.link_spattackDown.gameObject : (GameObject) null
      }).ToggleOnceEx(-1);
      this.TxtHpNumber.applyGradient = false;
      this.TxtHpNumber.color = this.txt_attack.color = this.txt_critical.color = this.txt_dex.color = Color.grey;
    }
    ...
    if ((UnityEngine.Object) this.gearTypeIcon == (UnityEngine.Object) null)
      this.gearTypeIcon = this.createIcon(this.go_weaponTypeIcon, this.link_weaponIcon.transform);
    if ((UnityEngine.Object) null != (UnityEngine.Object) this.gearTypeIcon)
    {
    ...
    if ((bool) (UnityEngine.Object) this.txt_consumeHp)
  ...
  protected void SetUnitGearIcon(BL.Unit unit)
  {
    ...
    string name = unit1.getName(metamor_id);
  ...
  private IEnumerator LoadCharaIcon()
  {
    ...
    if ((UnityEngine.Object) this.unitIcon == (UnityEngine.Object) null)
    {
      ...
      e = (IEnumerator) null;
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(f.Result);
      gameObject.transform.parent = this.link_characterIcon.transform;
  ...
  public void Damaged(int damage, int? heal = null)
  {
    ...
    ((IEnumerable<UITweener>) this.txt_consumeHp.GetComponentsInChildren<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
    {
      x.ResetToBeginning();
      x.PlayForward();
    }));
  ...
  public void skillInvoke(BL.Skill[] skills, bool bResetEntry) => this.severalSkillsInvoke(skills, bResetEntry);
  ...
  private void startDisplaySkill(int posIndex, BL.Skill skill)
  {
    if (this.skill_slide_anims[posIndex] != null)
    {
      ...
      if ((UnityEngine.Object) this.go_skillBases[posIndex] != (UnityEngine.Object) null)
  ...
  private IEnumerator displaySkill(int posIndex, BL.Skill iskill)
  {
    ...
    Future<UnityEngine.Sprite> fsi = skill.LoadBattleSkillIcon();
    ...
    if ((UnityEngine.Object) null != (UnityEngine.Object) battle0181CharacterStatus.go_skillBases[posIndex])
    ...
    GameObject downEffect)
  {
    ...
    if (num1 != num2)
    {
      ...
      if (num1 < num2)
      {
        ParticleSystem component = upEffect.CloneAndGetComponent<ParticleSystem>(this.txt_attack.gameObject.transform);
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          this.particleList.Add(component);
      }
      else if (num1 > num2)
      {
        ParticleSystem component = downEffect.CloneAndGetComponent<ParticleSystem>(this.txt_attack.gameObject.transform);
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          this.particleList.Add(component);
      }
    }
    if (attackStatus.dexerityDisplay() != newAttackStatus.dexerityDisplay())
    {
      ...
      if (attackStatus.dexerityDisplay() < newAttackStatus.dexerityDisplay())
      {
        ParticleSystem component = upEffect.CloneAndGetComponent<ParticleSystem>(this.txt_dex.gameObject.transform);
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          this.particleList.Add(component);
      }
      else if (attackStatus.dexerityDisplay() > newAttackStatus.dexerityDisplay())
      {
        ParticleSystem component = downEffect.CloneAndGetComponent<ParticleSystem>(this.txt_dex.gameObject.transform);
        if ((UnityEngine.Object) component != (UnityEngine.Object) null)
          this.particleList.Add(component);
      }
    }
    ...
    if (attackStatus.criticalDisplay() < newAttackStatus.criticalDisplay())
    {
      ParticleSystem component = upEffect.CloneAndGetComponent<ParticleSystem>(this.txt_critical.gameObject.transform);
      if (!((UnityEngine.Object) component != (UnityEngine.Object) null))
        return;
      this.particleList.Add(component);
    }
    else
    {
      if (attackStatus.criticalDisplay() <= newAttackStatus.criticalDisplay())
        return;
      ParticleSystem component = downEffect.CloneAndGetComponent<ParticleSystem>(this.txt_critical.gameObject.transform);
      if (!((UnityEngine.Object) component != (UnityEngine.Object) null))
        return;
      this.particleList.Add(component);
    }
  ...
  private CommonElement GetWeaponElement(PlayerUnit unit) => !(unit.equippedGear == (PlayerItem) null) || !(unit.equippedGear2 != (PlayerItem) null) ? (unit.equippedGear != (PlayerItem) null ? unit.equippedGear.GetElement() : unit.equippedGearOrInitial.GetElement()) : unit.equippedGear2.GetElement();

  private GearKind GetWeaponKind(PlayerUnit unit) => !(unit.equippedGear == (PlayerItem) null) || !(unit.equippedGear2 != (PlayerItem) null) ? unit.equippedGearOrInitial.kind : unit.equippedGear2OrInitial.kind;
}
