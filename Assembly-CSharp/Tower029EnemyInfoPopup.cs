...
public class Tower029EnemyInfoPopup : BackButtonMonoBehaiviour
{
  ...
  public IEnumerator InitializeAsync(
    BL.Unit playerUnit,
    Tower029EnemyInfoPopup.Force force)
  {
    this.forceId = force;
  ...
  private IEnumerator laodAndSetupObjects()
  {
    ...
    if ((UnityEngine.Object) this.abilityDialogParent != (UnityEngine.Object) null)
    {
      ...
      UIWidget component1 = this.abilityDialogParent.GetComponent<UIWidget>();
      ...
      this.abilityDialog.gameObject.SetActive(false);
      abilityDialogPrefabF = (Future<GameObject>) null;
    }
    this.setSkills.Clear();
    this.isEnabledGearLayout_ = this.gearLayouts_ != null && (uint) this.gearLayouts_.Length > 0U;
  ...
  private void initialize(BL.Unit v)
  {
    ...
    PlayerItem equippedGear2_1 = v.playerUnit.equippedGear2;
    if (equippedGear2_1 != (PlayerItem) null && equippedGear2_1.gear != null)
    {
      GameObject gameObject = this.elementTypeIcon[5] = this.createIcon(this.elementTypeIconPrefab, this.elementTypeIconParent[5]);
      if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
      {
        if (equippedGear2_1.gear.elements.Length != 0)
          gameObject.GetComponentInChildren<CommonElementIcon>().Init(equippedGear2_1.gear.elements[0].element);
        else
          gameObject.GetComponentInChildren<CommonElementIcon>().Init(CommonElement.none);
        BL.Unit.GearRange gearRange = v.gearRange();
        ...
        if ((UnityEngine.Object) label != (UnityEngine.Object) null)
        {
          BL.MagicBullet bulletByGear = this.getBulletByGear(v.magicBullets, equippedGear2_1);
          this.setText(label, bulletByGear != null ? bulletByGear.cost.ToString() : "-");
        }
      }
    }
    ...
    if (this.isEnabledGearLayout_)
    {
      ...
      this.gearLayouts_[index1].reset(gear1, element1, level1);
      if (gear1 == null)
        this.gearLayouts_[index1].setKind(k1);
      this.queGearInit_.Enqueue(this.gearLayouts_[index1].initAsync());
      setKind.Add(k1.ID);
      int index2 = index1 + 1;
      PlayerItem equippedGear2_2 = playerUnit.equippedGear2;
      GearGear gear2 = (object) equippedGear2_2 != null ? equippedGear2_2.gear : (GearGear) null;
      ...
      this.gearLayouts_[index2].reset(gear2, element2, level2);
      bool awakeUnitFlag = playerUnit.unit.awake_unit_flag;
      if (awakeUnitFlag && gear2 == null)
      {
        if (k2 == null)
          k2 = MasterData.GearKind[7];
        this.gearLayouts_[index2].setKind(k2);
      }
      this.queGearInit_.Enqueue(this.gearLayouts_[index2].initAsync(awakeUnitFlag));
    }
  ...
  private void SetPrincessType(BL.Unit blUnit)
  {
    ...
    else
    {
      ...
      this.princessTypeSprite.gameObject.SetActive(true);
