...
public class Guild028OptionEditConfirmPopup : BackButtonMenuBase
{
  ...
  private IEnumerator SendGuildSetting()
  {
    ...
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    Future<WebAPI.Response.GuildSettings> ft = WebAPI.GuildSettings(editConfirmPopup.approval_policy_id, editConfirmPopup.atmosphere_id, editConfirmPopup.auto_approval_id, editConfirmPopup.auto_kick_id, editConfirmPopup.guildName.text, false, new System.Action<WebAPI.Response.UserError>(editConfirmPopup.ErrorCallback));
