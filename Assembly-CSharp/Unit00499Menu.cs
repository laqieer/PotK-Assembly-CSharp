...
public class Unit00499Menu : BackButtonMenuBase
{
  ...
  private UnityEngine.Sprite unitLargeSprite;
    ...
    bool fromEarth = false)
  {
    ...
    {
      UnitUnit unit1 = n < evoUnits.Length ? evoUnits[n] : (UnitUnit) null;
      Unit00499Menu.SelectCell selectCell = n < selector.selected_.Length ? selector.selected_[n] : (Unit00499Menu.SelectCell) null;
      GameObject gameObject = selectIcons == null || n >= selectIcons.Length ? (GameObject) null : selectIcons[n].top_;
      if ((UnityEngine.Object) gameObject != (UnityEngine.Object) null)
        gameObject.SetActive(canCompleted && unit1 != null && selector.isSelectable(unit1.ID));
      ...
      if (unit1 != null)
      {
        if (selectCell != null)
        {
          PlayerUnit unit2 = selectCell.unit_;
          enumerator = unit1.IsMaterialUnit ? component.SetMaterialUnit(unit2, false, (PlayerUnit[]) null) : component.SetPlayerUnit(unit2, (PlayerUnit[]) null, (PlayerUnit) null, false, false);
          if (unit2.favorite)
            this.isFavorite = false;
        }
        else
        {
          enumerator = component.SetUnit(unit1, unit1.GetElement(), true);
          this.isUnit = false;
        }
      }
      else
    ...
    foreach (GameObject gameObject in objects)
    {
      UnitIcon icon = gameObject.GetComponent<UI2DSprite>().GetComponentInChildren<UnitIcon>();
      if (column < selector.samples_.Length)
      {
        icon.Button.enabled = true;
        icon.buttonBoxCollider.enabled = true;
        int num = 0;
        ...
        label[column].gameObject.SetActive(true);
      }
      else
      {
        icon.Button.enabled = false;
        icon.buttonBoxCollider.enabled = false;
        icon.SetEmpty();
        icon.setSilhouette(fromEarth);
        label[column].gameObject.SetActive(false);
  ...
  private void setEventMaterialClicked(
    ...
    bool canCompleted)
  {
    if ((UnityEngine.Object) toSelect == (UnityEngine.Object) null || !canCompleted)
    {
      icon.onClick = (System.Action<UnitIconBase>) (x =>
      {
        if (fromEarth)
          return;
  ...
  public List<int> getEvolutionMaterialSelectedUnitIds(int patternId) => this.dicSelector_ == null || !this.dicSelector_.ContainsKey(patternId) ? new List<int>() : ((IEnumerable<Unit00499Menu.SelectCell>) this.dicSelector_[patternId].selected_).Where<Unit00499Menu.SelectCell>((Func<Unit00499Menu.SelectCell, bool>) (c => c != null && c.unit_.unit.IsNormalUnit)).Select<Unit00499Menu.SelectCell, int>((Func<Unit00499Menu.SelectCell, int>) (cc => cc.unit_.id)).ToList<int>();

  public List<int> getEvolutionMaterialSelectedMaterialIds(int patternId) => this.dicSelector_ == null || !this.dicSelector_.ContainsKey(patternId) ? new List<int>() : ((IEnumerable<Unit00499Menu.SelectCell>) this.dicSelector_[patternId].selected_).Where<Unit00499Menu.SelectCell>((Func<Unit00499Menu.SelectCell, bool>) (c => c != null && c.unit_.unit.IsMaterialUnit)).Select<Unit00499Menu.SelectCell, int>((Func<Unit00499Menu.SelectCell, int>) (cc => cc.unit_.id)).ToList<int>();
  ...
  public IEnumerator Transmigration(bool isRecod)
  {
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      Future<WebAPI.Response.UnitTransmigrate> paramF = WebAPI.UnitTransmigrate(this.baseUnit.id, isRecod, this.materialMaterialUnitIds.ToArray(), this.materialUnitIds.ToArray(), this.baseUnit.unit.TransmigratePattern.ID, (System.Action<WebAPI.Response.UserError>) (error =>
      {
      ...
      if (paramF.Result != null)
      {
        ...
        {
          UnitIcon componentInChildren = linkTransUnit.GetComponent<UI2DSprite>().GetComponentInChildren<UnitIcon>();
  ...
  protected virtual IEnumerator Evolution()
  {
    ...
    {
      Singleton<CommonRoot>.GetInstance().isLoading = true;
      Future<WebAPI.Response.UnitEvolution> paramF = WebAPI.UnitEvolution(this.baseUnit.unit.IsMaterialUnit ? this.baseUnit.id : 0, this.baseUnit.unit.IsNormalUnit ? this.baseUnit.id : 0, this.materialMaterialUnitIds.ToArray(), this.materialUnitIds.ToArray(), this.selectEvolutionPatternId, (System.Action<WebAPI.Response.UserError>) (error =>
      {
        WebAPI.DefaultUserErrorCallback(error);
        MypageScene.ChangeSceneOnError();
      }));
      ...
      if (paramF.Result != null)
      {
        ...
        else
        {
          foreach (PlayerUnit playerUnit2 in paramF.Result.player_units)
          {
            if (targetUnit.ID == playerUnit2.unit.ID)
            {
              playerUnit1 = playerUnit2;
              break;
            }
        ...
        {
          UnitIcon componentInChildren = linkEvolutionUnit.GetComponent<UI2DSprite>().GetComponentInChildren<UnitIcon>();
          if (componentInChildren.PlayerUnit != (PlayerUnit) null)
            playerUnitList.Add(componentInChildren.PlayerUnit);
        }
        unit00497Scene.ChangeScene(false, new PrincesEvolutionParam()
  ...
  {
    this.transBtn.gameObject.SetActive(true);
    this.recordBtn.gameObject.SetActive(false);
  }

  private void DrawRecordButton()
  {
    this.transBtn.gameObject.SetActive(false);
    this.recordBtn.gameObject.SetActive(true);
  }
  ...
  protected void InitNumber(
    ...
    bool isAwake = false)
  {
    System.Action<string, UILabel> action = (System.Action<string, UILabel>) ((v, label) =>
    {
  ...
  {
    if ((UnityEngine.Object) afterUnit == (UnityEngine.Object) null)
      return true;
    ...
    bool fromEarth = false)
  {
    ...
    if (unit00499Menu.mustCreateAfterUnitObject(unit00499Menu.sceneMode, unit00499Menu.afterUnit))
    {
      ...
      switch (unit00499Menu.sceneMode)
      {
        ...
        case Unit00499Scene.Mode.Transmigration:
          ...
          unit00499Menu.ReinCarnationChangeCtrl.SetAction(new System.Action(unit00499Menu.DrawTransButton), new System.Action(unit00499Menu.DrawRecordButton));
    ...
    if (unit00499Menu.sceneMode == Unit00499Scene.Mode.Transmigration)
    {
      ...
      if ((UnityEngine.Object) unit00499Menu.recordUnit != (UnityEngine.Object) null && unit00499Menu.recordPlayerUnit != (PlayerUnit) null)
      {
        if (playerUnit.level >= playerUnit.unit.rarity.reincarnation_level)
        {
          unit00499Menu.afterUnit.gameObject.SetActive(true);
          unit00499Menu.recordUnit.gameObject.SetActive(true);
        ...
        {
          unit00499Menu.recordUnit.gameObject.SetActive(true);
          unit00499Menu.afterUnit.gameObject.SetActive(false);
      ...
      {
        unit00499Menu.ReinCarnationChangeCtrl.SetActiveChangeButton(false);
        unit00499Menu.recordUnit.gameObject.SetActive(false);
        unit00499Menu.DrawTransButton();
        unit00499Menu.ReinCarnationChangeCtrl.AfterFront();
        if (unit00499Menu.transMode == Unit00499Menu.TransMode.Record)
        {
    ...
    bool isMemory = false)
  {
    ...
    unitIcon.onClick = (System.Action<UnitIconBase>) (icon =>
    {
      if (before)
      {
        if (fromEarth)
    ...
    bool fromEarth = false)
  {
    ...
    yield return (object) unit00499Menu.StartCoroutine(((IEnumerable<GameObject>) objects).Select<GameObject, IEnumerator>((Func<GameObject, int, IEnumerator>) ((link, n) =>
    {
      UnitUnit unit = n < evoUnits.Length ? evoUnits[n] : (UnitUnit) null;
      UnitIcon component = unitIconPrefab.CloneAndGetComponent<UnitIcon>(link.transform);
      IEnumerator enumerator;
      if (unit != null)
      {
        if (playerUnitDic.ContainsKey(unit.ID))
        {
          PlayerUnit playerUnit = playerUnitDic[unit.ID].Dequeue();
          if (playerUnitDic[unit.ID].Count == 0)
    ...
    foreach (GameObject gameObject in objects)
    {
      ...
      if (index < evoUnitCnt)
      {
        ...
        label[index].gameObject.SetActive(true);
        icon.RarityCenter();
        icon.onClick = (System.Action<UnitIconBase>) (x =>
        {
          if (fromEarth)
      ...
      else
      {
        ...
        icon.SetEmpty();
        icon.setSilhouette(fromEarth);
        label[index].gameObject.SetActive(false);
        gameObject.GetComponentInChildren<UIButton>().onClick.Clear();
      }
      ++index;
    }
  ...
  public List<int> GetMaterialUnitIDS(PlayerUnit baseUnit, PlayerUnit[] units, UnitUnit[] evo)
  {
    ...
    ((IEnumerable<UnitUnit>) evo).ForEach<UnitUnit>((System.Action<UnitUnit>) (x =>
    {
      if (!x.IsNormalUnit)
        return;
  ...
  private PlayerUnit[] getMaterialPlayerUnits() => ((IEnumerable<PlayerUnit>) SMManager.Get<PlayerUnit[]>()).Where<PlayerUnit>((Func<PlayerUnit, bool>) (unit => this.materialUnitIds.Any<int>((Func<int, bool>) (id => id == unit.id)))).ToArray<PlayerUnit>();
  ...
  private PlayerMaterialUnit[] getMaterialMaterialPlayerUnits() => ((IEnumerable<PlayerMaterialUnit>) SMManager.Get<PlayerMaterialUnit[]>()).Where<PlayerMaterialUnit>((Func<PlayerMaterialUnit, bool>) (unit => this.materialMaterialUnitIds.Any<int>((Func<int, bool>) (id => id == unit.id)))).ToArray<PlayerMaterialUnit>();
    ...
    Unit00499Scene.GvgCostInfo gvgCostInfo = Unit00499Scene.GvgCostInfo.None)
  {
    ...
    if (!fromEarth)
    {
      ...
      this.transBtn.isEnabled = false;
    }
    this.evolutionBtn.isEnabled = false;
    this.awakeBtn.isEnabled = false;
    ...
    if (this.sceneMode == Unit00499Scene.Mode.Evolution || this.sceneMode == Unit00499Scene.Mode.EarthEvolution)
    {
      ...
      if (!fromEarth)
      {
        ...
        this.awakeBtn.gameObject.SetActive(false);
        this.evolutionBtn.gameObject.SetActive(true);
    ...
    {
      this.DirTransmigration.SetActive(false);
      this.evolutionBtn.gameObject.SetActive(false);
      this.dirEvolutionMaterials.SetActive(true);
      this.awakeBtn.isEnabled = true;
      this.awakeBtn.gameObject.SetActive(true);
    ...
    else
    {
      ...
      this.comShortage.transform.localPosition = Vector3.zero;
      if ((UnityEngine.Object) this.StatusUpPrefab == (UnityEngine.Object) null)
      {
      ...
      Future<GameObject> prefabF = (Future<GameObject>) null;
      if ((UnityEngine.Object) this.SaveMemorySlotSelectPrefab == (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) this.MemorySlotOverwritePrefab == (UnityEngine.Object) null)
      {
      ...
      this.TxtTransZeny.color = player.money >= (long) price ? Color.white : Color.red;
      ...
      this.transBtn.isEnabled = flag;
      this.recordBtn.isEnabled = flag;
      this.ibtn_Save_Memory.isEnabled = playerUnit.level == playerUnit.max_level;
      prefabF = (Future<GameObject>) null;
      unitIconPrefabF = (Future<GameObject>) null;
      unitIconPrefab = (GameObject) null;
    }
    if ((UnityEngine.Object) this.statusDetailPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator IbtnComAsync()
  {
    ...
    if (unit00499Menu.baseUnit.tower_is_entry || unit00499Menu.baseUnit.corps_is_entry || ((IEnumerable<PlayerUnit>) unit00499Menu.getMaterialPlayerUnits()).Any<PlayerUnit>((Func<PlayerUnit, bool>) (unit => unit.tower_is_entry || unit.corps_is_entry)))
    {
      ...
      yield return (object) PopupManager.StartTowerEntryUnitWarningPopupProc((System.Action<bool>) (selected => isRejected = !selected));
      if (isRejected)
        yield break;
    }
  ...
  public void IbtnRecord()
  {
    if (PlayerTransmigrateMemoryPlayerUnitIds.Current != null && PlayerTransmigrateMemoryPlayerUnitIds.Current.PlayerUnits().Any<PlayerUnit>((Func<PlayerUnit, bool>) (x => x != (PlayerUnit) null && x.id == this.playerUnit.id)))
      Singleton<PopupManager>.GetInstance().open(this.MemorySlotOverwritePrefab).GetComponent<Unit00499SaveMemoryOverwrite>().Initialize(this.playerUnit, new System.Action(this.RecordEndUpdate));
    else
      this.StartCoroutine(Singleton<PopupManager>.GetInstance().open(this.SaveMemorySlotSelectPrefab).GetComponent<Unit00499SaveMemorySlotSelect>().Initialize(this.playerUnit, new System.Action(this.RecordEndUpdate)));
  }

  public void RecordEndUpdate() => this.StartCoroutine(this.Init(this.playerUnit, this.targetPlayerUnits, this.sceneMode, this.fromEarth, this.gvgCostInfo));
    ...
    IEnumerator execute)
  {
    ...
    bool bDo = false;
    bool bWait = true;
    ModalWindow mv = ModalWindow.ShowYesNo(title, message, (System.Action) (() =>
    {
      bDo = true;
      bWait = false;
    }), (System.Action) (() =>
  ...
  private IEnumerator IbtnTransAsync()
  {
    ...
    {
      bool isRejected = false;
      yield return (object) PopupManager.StartTowerEntryUnitWarningPopupProc((System.Action<bool>) (selected => isRejected = !selected), true);
      if (isRejected)
        yield break;
    }
  ...
  public void IbtnStatusDetail() => Singleton<PopupManager>.GetInstance().open(this.statusDetailPrefab).GetComponent<Unit004StatusDetailDialog>().Initialize(this.baseUnit, this.unitLargeSprite);
  ...
  private IEnumerator IbtnRecordTransAsync()
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      ModalWindow.ShowYesNo(Consts.GetInstance().MEMORY_LOAD_ALERT_TITLE, Consts.GetInstance().MEMORY_LOAD_ALERT_DESCRIPTION, new System.Action(unit00499Menu.\u003CIbtnRecordTransAsync\u003Eb__103_0), (System.Action) (() => {}));
    }
    else
  ...
  private class EvolutionSelectMap
  {
    ...
    public bool updateNormalUnit(PlayerUnit[] playerUnits)
    {
      bool flag = false;
      PlayerDeck[] decks = SMManager.Get<PlayerDeck[]>();
      foreach (Unit00499Menu.SelectCell[] selectCellArray in this.sources_.Values)
      {
        if (selectCellArray.Length != 0 && ((IEnumerable<Unit00499Menu.SelectCell>) selectCellArray).First<Unit00499Menu.SelectCell>().unit_.unit.IsNormalUnit)
        {
          foreach (Unit00499Menu.SelectCell selectCell in selectCellArray)
          {
