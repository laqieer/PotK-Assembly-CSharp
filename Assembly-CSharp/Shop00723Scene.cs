...
public class Shop00723Scene : NGSceneBase
{
  ...
  public static void changeScene(PlayerSelectTicketSummary playerUnitTicket, bool isStack = true) => Singleton<NGSceneManager>.GetInstance().changeScene(Shop00723Scene.DEFAULT_NAME, (isStack ? 1 : 0) != 0, (object) playerUnitTicket);
