...
public abstract class MapEditMenuBase : BackButtonMenuBase
{
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    mapEditMenuBase.topMenu_ = mapEditMenuBase.GetComponent<MapEdit031TopMenu>();
  ...
  private void forceActive(bool isEnabled)
  {
    ...
    if (this.cntlObjects_ == null)
      return;
    if ((UnityEngine.Object) this.topMenu_ != (UnityEngine.Object) null)
    {
      if (isEnabled)
  ...
  protected void setCurrentOrnament(MapEditOrnament ornament) => this.topMenu_.setCurrentOrnament(ornament);

  protected void clearCurrentOrnament() => this.topMenu_.clearCurrentOrnamnet();

  protected MapEditPanel getPanelUnderOrnament() => !((UnityEngine.Object) this.currentOrnament_ != (UnityEngine.Object) null) ? (MapEditPanel) null : this.topMenu_.castPanel(this.currentOrnament_.hitPanel());
  ...
  protected Vector2 position3Dto2D(Vector3 worldPos)
  {
    ...
    return (Vector2) UICamera.currentCamera.ViewportToWorldPoint(viewportPoint);
  }
}
