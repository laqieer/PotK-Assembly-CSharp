...
public class Versus026DirWinLossRecordsMenu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(Versus02613Scene.BootParam param)
  {
    ...
    Future<WebAPI.Response.PvpClassMatchHistory> apiF = WebAPI.PvpClassMatchHistory(param.current.playerId, (System.Action<WebAPI.Response.UserError>) (error =>
    {
  ...
  public void ChangeSceneToDetails(string battleID) => Versus026DirWinLossRecordsDetailsScene.ChangeScene(true, this.param_, battleID, this.param_.current.playerId);
