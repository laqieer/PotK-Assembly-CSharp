...
public class Quest00282FriendManager : MonoBehaviour
{
    ...
    bool backSceneSelected)
  {
    ...
    if (quest00282FriendManager.gender_restriction != UnitGender.none)
      quest00282FriendManager.Decision.isEnabled = friend.leader_unit.unit.character.gender == quest00282FriendManager.gender_restriction;
    Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadEmblemSprite(quest00282FriendManager.friend.current_emblem_id);
  ...
  public void FriendDetailScene() => Unit0042Scene.changeSceneFriendUnit(true, this.friend.target_player_id, this.friend.rental_player_unit_id);
  ...
  {
    this.Decision.isEnabled = isEnabled;
    this.skillAllBtn.isEnabled = isEnabled;
    this.DecisionNone.isEnabled = isEnabled;
  }
}
