    ...
    else
    {
      ...
      do
      {
        ...
        else
        {
          ...
          if (BattleUI05PopupResortie.checkResortie(consumedAP, (System.Action<IEnumerator>) (ie => initPopup = ie)))
          {
...
label_29:
  ...
  {
    base.Update();
    if (!this.txtAutoLapTime_.gameObject.activeSelf)
      return;
  ...
  {
    if (!this.btnResortie_.isEnabled || !BattleUI05PopupResortie.isQuestAutoLap)
    {
      Singleton<NGGameDataManager>.GetInstance().questAutoLap = false;
      BattleUI05PopupResortie.isQuestAutoLap = false;
    }
  ...
  {
    DeckInfo selectDeck = this.getSelectDeck();
    WebAPI.BattleStoryStart(selectDeck.deck_number, selectDeck.deck_type_id, 0, this.storyQuest_.quest_story_s.ID, "", 0, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
  ...
  private void ExtraStartApi()
  {
    ...
    if (this.extraQuest_.quest_extra_s.wave != null)
      WebAPI.BattleWaveStart(selectDeck.deck_number, selectDeck.deck_type_id, 0, this.extraQuest_.quest_extra_s.ID, "", 0, (System.Action<WebAPI.Response.UserError>) (error =>
      {
        Singleton<CommonRoot>.GetInstance().isLoading = false;
        WebAPI.DefaultUserErrorCallback(error);
        MypageScene.ChangeSceneOnError();
      ...
      WebAPI.BattleExtraStart(selectDeck.deck_number, selectDeck.deck_type_id, 0, this.extraQuest_.quest_extra_s.ID, "", 0, (System.Action<WebAPI.Response.UserError>) (error =>
      {
        Singleton<CommonRoot>.GetInstance().isLoading = false;
        WebAPI.DefaultUserErrorCallback(error);
        MypageScene.ChangeSceneOnError();
  ...
  {
    DeckInfo selectDeck = this.getSelectDeck();
    WebAPI.BattleCharacterStart(selectDeck.deck_number, selectDeck.deck_type_id, 0, this.charaQuest_._quest_s_id, "", 0, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      WebAPI.DefaultUserErrorCallback(error);
      MypageScene.ChangeSceneOnError();
  ...
  {
    DeckInfo selectDeck = this.getSelectDeck();
    WebAPI.BattleHarmonyStart(selectDeck.deck_number, selectDeck.deck_type_id, 0, this.charaQuest_._quest_s_id, "", 0, (System.Action<WebAPI.Response.UserError>) (error =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      WebAPI.DefaultUserErrorCallback(error);
      MypageScene.ChangeSceneOnError();
  ...
  {
    DeckInfo selectDeck = this.getSelectDeck();
    WebAPI.SeaBattleStart(selectDeck.deck_number, selectDeck.deck_type_id, 0, this.seaQuest_.quest_sea_s.ID, "", 0, (System.Action<WebAPI.Response.UserError>) (error =>
    {
