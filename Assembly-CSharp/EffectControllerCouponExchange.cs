  ...
  public IEnumerator coExchangeUnit(WebAPI.Response.SelectticketSpend unitticketSpend)
  {
    ...
    if (unit.unit.IsMaterialUnit)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      controllerCouponExchange.rarityAnim_.image_.gameObject.SetActive(false);
      controllerCouponExchange.rarityAnim_.image400_.gameObject.SetActive(true);
    }
    else
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      controllerCouponExchange.rarityAnim_.image_.gameObject.SetActive(true);
      controllerCouponExchange.rarityAnim_.image400_.gameObject.SetActive(false);
    }
    ...
    if ((UnityEngine.Object) controllerCouponExchange.effNew_ != (UnityEngine.Object) null)
