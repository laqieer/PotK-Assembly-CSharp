...
public class DailyMission0272DetailPopup : BackButtonMonoBehaiviour
{
    ...
    bool isCleared)
  {
    ...
    UIWidget component = mission0272DetailPopup.GetComponent<UIWidget>();
  ...
  public void onTry()
  {
    ...
    if (this.changeScene_ == "quest002_4")
    {
      ...
      if (questStoryS != null && ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Any<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x._quest_story_s == this.condition_)))
      {
...
label_30:
  ...
  {
    Future<WebAPI.Response.DailymissionExternalLink> future = WebAPI.DailymissionExternalLink(this.missionId_, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      WebAPI.DefaultUserErrorCallback(e);
      MypageScene.ChangeSceneOnError();
    }));
