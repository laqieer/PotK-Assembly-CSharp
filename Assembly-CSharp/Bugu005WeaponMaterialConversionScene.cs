...
public class Bugu005WeaponMaterialConversionScene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, Bugu005WeaponMaterialConversionScene.Mode mode) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_weapon_material", (stack ? 1 : 0) != 0, (object) mode);
  ...
  public virtual IEnumerator onStartSceneAsync(
    Bugu005WeaponMaterialConversionScene.Mode mode)
  {
