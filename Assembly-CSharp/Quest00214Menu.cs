...
public class Quest00214Menu : BackButtonMenuBase
{
  ...
  public IEnumerator doLoadResources()
  {
    ...
    if ((UnityEngine.Object) this.popupReleaseConditonPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.dirCombiPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.dirTrioPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.dirClearPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.filterPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.filterPartsPrefab == (UnityEngine.Object) null)
    {
    ...
    bool isSameUnit = false)
  {
    ...
    foreach (NGTweenParts ngTweenParts in ngTweenPartsArray)
    {
      ...
      ngTweenParts.GetComponent<UIRect>().alpha = 0.0f;
    }
  ...
  private bool IconEnable
  {
    set
    {
      foreach (UnitIcon unitIcon in this.unitIcons)
        unitIcon.buttonBoxCollider.enabled = value;
  ...
  private bool CellEnable
  {
    set
    {
      foreach (Quest00214DirCombi allQuestCombiCell in this.allQuestCombiCells)
        allQuestCombiCell.buttonBoxCollider.enabled = value;
      foreach (Quest00214DirTrio allQuestTrioCell in this.allQuestTrioCells)
        allQuestTrioCell.buttonBoxCollider.enabled = value;
  ...
  {
    if (this.CharaQuest.gameObject.activeSelf)
    {
    ...
    while (true)
    {
      do
      {
        ...
        foreach (GameObject gameObject in this.ScrollContainerChara)
        {
          ...
          {
            int? nullable = ((IEnumerable<UnitIconInfo>) this.sortedUnitInfos).FirstIndexOrNull<UnitIconInfo>((Func<UnitIconInfo, bool>) (v => (UnityEngine.Object) v.icon != (UnityEngine.Object) null && (UnityEngine.Object) v.icon.gameObject == (UnityEngine.Object) obj));
...
label_1:;
  ...
  private void ResetUnitIcon(int index)
  {
    ...
    foreach (UnitIconInfo unitIconInfo in ((IEnumerable<UnitIconInfo>) this.sortedUnitInfos).Where<UnitIconInfo>((Func<UnitIconInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)))
  ...
  private IEnumerator doResetUnitIcons(bool bLoadAsync = true)
  {
    ...
    {
      quest00214Menu.scrool_start_y = quest00214Menu.ScrollContainerChara.scrollView.transform.localPosition.y;
  ...
  private void resetUnitIconBlank()
  {
    ...
    else
    {
      ...
      {
        GameObject gameObject = this.unitIcons[index].gameObject;
  ...
  private IEnumerator CreateUnitIcon(int info_index, int unit_index, bool bInitLink = true)
  {
    ...
    if (bInitLink)
    {
      foreach (UnitIconInfo unitIconInfo in ((IEnumerable<UnitIconInfo>) this.allUnitInfos).Where<UnitIconInfo>((Func<UnitIconInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)))
        unitIconInfo.icon = (UnitIconBase) null;
    }
    if (info.is_unknown)
    {
  ...
  private void resetInfo(UnitIconInfo info, UnitIcon icon)
  {
    ...
    if (info.callback != null)
      icon.onClick = (System.Action<UnitIconBase>) (x => info.callback());
    else
      icon.onClick = (System.Action<UnitIconBase>) (_ => {});
    ...
    PlayerCharacterQuestM questM)
  {
    ...
    if (questCondition == null | isPlayable)
    {
      ...
      unitIconInfo.callback = (System.Action) (() => this.SelectCharacter(unit.ID));
    }
    else
    {
      unitIconInfo.is_unknown = true;
      unitIconInfo.callback = (System.Action) (() => Singleton<PopupManager>.GetInstance().open(this.popupReleaseConditonPrefab).GetComponent<Quest00214PopupReleaseCondition>().Init(questCondition.required_condition));
    }
    return unitIconInfo;
  }
  ...
  public void onClickedSort()
  {
    ...
    this.filterPopup.Initialize(this.filterPartsPrefab, this.charaFilter, new System.Action(this.filtered), new System.Action(this.changeFilterSetting));
  }
  ...
  private void changeFilterSetting() => this.filterPopup.SetUnitNum(this.filterPopup.filterBy(this.allUnitInfos), this.allUnitInfos);
  ...
  private void setLabelFilterButton()
  {
    ...
    if (sprite != null)
    {
      ...
      this.labelFilterButton.width = sprite.width;
      this.labelFilterButton.height = sprite.height;
      this.labelFilterButton.gameObject.SetActive(true);
    }
    else
      this.labelFilterButton.gameObject.SetActive(false);
  }
