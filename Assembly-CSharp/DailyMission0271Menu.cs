...
public class DailyMission0271Menu : BackButtonMenuBase
{
  ...
  public bool CheckIsPush() => this.isPlayingEffect || this.bannerScrollView.isDragging || this.IsPush;
  ...
  private void Start() => this.bannerScrollView = this.scrollParts.scrollView.GetComponent<UIScrollView>();
}
