...
public class Unit004JobAbilityDetail : BackButtonMenuBase
{
  ...
  private System.Action<System.Action> mOnPreUpdateJobAbility;
  private System.Action mOnUpdatedJobAbility;
    ...
    System.Action<System.Action> eventPreUpdateJobAbility = null)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.mLvUpButton.isEnabled = enableLvUp;
  }
  ...
  private IEnumerator SetupInfomation()
  {
    ...
    gameObject1.GetComponent<UI2DSprite>().depth = 9;
    ...
    gameObject2.GetComponent<UI2DSprite>().depth = 9;
