...
public class Battle01SkillSubject : NGBattleMenuBase
{
  ...
  private void OnEnable()
  {
    ...
    Battle01SkillUseSelect[] componentsInChildren = this.GetComponentsInChildren<Battle01SkillUseSelect>(true);
  ...
  protected override void Update_Battle()
  {
    ...
    if ((UnityEngine.Object) this.slc_skillselect != (UnityEngine.Object) null && (UnityEngine.Object) this.slc_SEAskillselect != (UnityEngine.Object) null)
    {
    ...
    if (!((UnityEngine.Object) this.notAvailable != (UnityEngine.Object) null) || this.notAvailableReason == null || this.notAvailableReason.Count <= 0)
      return;
    ...
    bool isSelectPanel)
  {
    ...
    Battle01SkillUseSelect[] componentsInChildren1 = this.GetComponentsInChildren<Battle01SkillUseSelect>(true);
    ...
    Battle01SkillTitle[] componentsInChildren2 = this.GetComponentsInChildren<Battle01SkillTitle>(true);
  ...
  {
    if ((UnityEngine.Object) this._scroll == (UnityEngine.Object) null)
    {
  ...
  public void useUnit(BL.Unit unit, BL.Panel panel)
  {
    if (this.modified == null)
      return;
    Battle01SelectNode inParents = NGUITools.FindInParents<Battle01SelectNode>(this.transform);
  ...
  {
    BL.Skill s;
    if ((UnityEngine.Object) this.skillDetailPrefab == (UnityEngine.Object) null || this.modified == null || (s = this.modified.value) == null)
      return;
