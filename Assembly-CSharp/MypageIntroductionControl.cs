...
public class MypageIntroductionControl
{
  ...
  public void addExecute(Func<int, bool> check, Func<int, IEnumerator> execute) => this.queUnits_.Enqueue(new MypageIntroductionControl.Unit(check, execute));

  public void setEnd(System.Action<int> actEnd) => this.onEnd_ = actEnd;
  ...
  public void clear()
  {
    ...
    this.onEnd_ = (System.Action<int>) null;
  }
