...
public class PurchaseBehavior : Singleton<PurchaseBehavior>
{
  ...
  public static IEnumerator OpenAPRecoveryItemList(
    bool isAPShortage,
    System.Action questChangeScene)
  {
  ...
  public static GameObject PopupOpen(GameObject prefab) => PurchaseBehavior.IsBattleNow ? Singleton<NGBattleManager>.GetInstance().popupOpen(prefab) : Singleton<PopupManager>.GetInstance().open(prefab);
  ...
  public static void ShowPopupYesNo(string title, string message, System.Action callback = null) => ModalWindow.ShowYesNo(title, message, (System.Action) (() =>
  {
  ...
  public static void SendAge(int year, int month, int day) => PurchaseBehavior.actualFlow.InputBirthday(year, month, day);
