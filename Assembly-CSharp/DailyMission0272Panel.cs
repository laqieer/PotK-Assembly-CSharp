...
public class DailyMission0272Panel : MonoBehaviour
{
    ...
    int type)
  {
    ...
    this.slcDisable.SetActive(this.rewardProgress == DailyMission0272Panel.RewardProgress.Received && (UnityEngine.Object) this.slcDisable != (UnityEngine.Object) null);
...
label_6:
    hashtable.Add((object) nameof (count), (object) progressNonmember);
    hashtable.Add((object) "max", (object) mission.progress_max);
    string text = Consts.Format(missionProgressFmT2, (IDictionary) hashtable);
  ...
  private IEnumerator receiveReward()
  {
    ...
    {
      Future<WebAPI.Response.DailymissionReceive> future = WebAPI.DailymissionReceive(this.playerDailyMission.mission_id, (System.Action<WebAPI.Response.UserError>) (e =>
      {
    ...
    {
      Future<WebAPI.Response.GuildmissionReceive> future = WebAPI.GuildmissionReceive(this.playerDailyMission.mission_id, (System.Action<WebAPI.Response.UserError>) (e =>
      {
        WebAPI.DefaultUserErrorCallback(e);
        Singleton<CommonRoot>.GetInstance().DailyMissionController.Hide();
      }));
      ...
      if (instance.sceneName != this.mission.scene)
      {
        ...
        else
        {
          ...
          if (this.mission.scene == "quest002_4")
          {
            ...
            instance.clearStack();
            if (questStoryS != null && ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Any<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x._quest_story_s == this.mission.condition)))
            {
              Quest00240723Scene.ChangeScene0024(false, MasterData.QuestStoryS[this.mission.condition].quest_l_QuestStoryL, true);
            }
            else
            {
              int? nullable = ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Select<PlayerStoryQuestS, QuestStoryS>((Func<PlayerStoryQuestS, QuestStoryS>) (x => x.quest_story_s)).Where<QuestStoryS>((Func<QuestStoryS, bool>) (s => (Quest00240723Menu.StoryMode) s.quest_xl_QuestStoryXL == storyMode)).Select<QuestStoryS, int?>((Func<QuestStoryS, int?>) (s => new int?(s.quest_l_QuestStoryL))).Max();
...
label_40:
  ...
  {
    Future<WebAPI.Response.DailymissionReview> future = WebAPI.DailymissionReview((System.Action<WebAPI.Response.UserError>) (e =>
    {
      WebAPI.DefaultUserErrorCallback(e);
      MypageScene.ChangeSceneOnError();
    }));
  ...
  {
    Future<WebAPI.Response.DailymissionExternalLink> future = WebAPI.DailymissionExternalLink(this.mission.ID, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      WebAPI.DefaultUserErrorCallback(e);
      MypageScene.ChangeSceneOnError();
    }));
  ...
  public void OnReceiveButton()
  {
    ...
    switch (this.playerDailyMission.rewards[0].reward_type_id)
    {
      case 11:
        ...
        {
          ModalWindow.Show("AP回復", "APが上限のため、受け取れません。", (System.Action) (() => this.IsPush = false));
          return;
        }
        break;
      case 18:
        ...
        {
          ModalWindow.Show("CP回復", "CPが上限のため、受け取れません。", (System.Action) (() => this.IsPush = false));
          return;
        }
        break;
      case 30:
        ...
        {
          ModalWindow.Show("DP回復", "DPが上限のため、受け取れません。", (System.Action) (() => this.IsPush = false));
          return;
        }
        break;
    }
  ...
  private IEnumerator OpenChallengeAgainConfirmationPopup()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = Singleton<PopupManager>.GetInstance().open(mission0272Panel.controller.challengeAgainConfirmationPopupPrefab).GetComponent<ChallengeAgainConfirmationPopupController>().Init(new System.Action(mission0272Panel.\u003COpenChallengeAgainConfirmationPopup\u003Eb__43_0), new System.Action(mission0272Panel.\u003COpenChallengeAgainConfirmationPopup\u003Eb__43_1));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  public class RewardViewModel
  {
    ...
    public IEnumerator LoadThumb(GameObject go)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      if ((UnityEngine.Object) target.GetIcon() != (UnityEngine.Object) null)
      {
