...
public class EffectSkillAcquisition : MonoBehaviour
{
  ...
  public static Future<GameObject> createLoader() => new ResourceObject("Prefabs/battle/Unit_Skill_Acquisition").Load<GameObject>();
    ...
    bool autoDelete)
  {
    ...
    bool bWait = true;
    popupBase.onNext = (System.Action) (() =>
    {
      if (effect.isRunning)
        return;
      bWait = false;
  ...
  private IEnumerator Start()
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    panel = skillAcquisition.GetComponent<UIPanel>();
    panel.alpha = 0.0f;
