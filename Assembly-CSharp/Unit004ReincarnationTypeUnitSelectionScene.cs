...
public class Unit004ReincarnationTypeUnitSelectionScene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, UnitTypeTicket ticket) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_Reincarnation_Type_UnitSelection", (stack ? 1 : 0) != 0, (object) ticket);
