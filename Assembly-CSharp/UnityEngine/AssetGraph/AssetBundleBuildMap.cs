...
namespace UnityEngine.AssetGraph
{
  public class AssetBundleBuildMap : ScriptableObject
  {
    ...
    {
      if ((UnityEngine.Object) AssetBundleBuildMap.s_map == (UnityEngine.Object) null && !AssetBundleBuildMap.Load())
      {
    ...
    {
      AssetBundleBuildMap.AssetBundleEntry assetBundleEntry = this.m_assetBundles.Find((Predicate<AssetBundleBuildMap.AssetBundleEntry>) (v => v.m_fullName == assetBundleFullName));
      if (assetBundleEntry == null)
      {
        string[] nameAndVariant = AssetBundleBuildMap.FullNameToNameAndVariant(assetBundleFullName);
        assetBundleEntry = new AssetBundleBuildMap.AssetBundleEntry(registererId, nameAndVariant[0], nameAndVariant[1]);
        this.m_assetBundles.Add(assetBundleEntry);
    ...
    public void ClearFromId(string id) => this.m_assetBundles.RemoveAll((Predicate<AssetBundleBuildMap.AssetBundleEntry>) (e => e.m_registererId == id));
    ...
    public string GetImplicitAssetBundleName(string assetPath) => this.GetAssetBundleName(assetPath);

    public string[] GetAllAssetBundleNames() => this.m_assetBundles.Select<AssetBundleBuildMap.AssetBundleEntry, string>((Func<AssetBundleBuildMap.AssetBundleEntry, string>) (e => e.m_fullName)).ToArray<string>();
