...
public class Tower029RankingPlayer : Tower029RankingStatus
{
  ...
  public IEnumerator coInitImage()
  {
    if (this.initData_ != null)
    {
      ...
      if ((UnityEngine.Object) uniticon != (UnityEngine.Object) null && playerunit != (PlayerUnit) null)
      {
        ...
        this.lnkUnit_.SetActive(false);
      Future<UnityEngine.Sprite> ldemblem = EmblemUtility.LoadEmblemSprite(this.initData_.emblem_);
      e = ldemblem.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
  ...
  public void changeStatus(Tower029RankingStatus.StatusEnum estatus) => this.changeDrawStatus(estatus);
  ...
  public void changeDrawRank(int rank = 0)
  {
    ...
    if (this.rankBoards_ != null)
    {
      ...
      {
        if (rankBoard != null && !((UnityEngine.Object) rankBoard.top_ == (UnityEngine.Object) null))
        {
    ...
    if ((UnityEngine.Object) this.topInfo_ != (UnityEngine.Object) null)
      this.topInfo_.SetActive((uint) rankEnum > 0U);
    if (!((UnityEngine.Object) this.txtRank_ != (UnityEngine.Object) null))
      return;
    this.txtRank_.gameObject.SetActive(flag1);
    if (!flag1)
      return;
    if (rank <= TowerUtil.MaxRankingNum)
    {
      ...
      this.txtRank_.SetTextLocalize(Consts.Format(Consts.GetInstance().TOWER_RANKING_RANK, (IDictionary) hashtable2));
    }
    else
  ...
  public class Data
  {
    ...
    {
      int leaderUnitId = playerUnit != (PlayerUnit) null ? playerUnit.unit.ID : 0;
      int leaderUnitLvl = playerUnit != (PlayerUnit) null ? playerUnit.level : 1;
      this.init(rank, player.name, player.level, leaderUnitId, leaderUnitLvl, player.current_emblem_id, playerUnit.job_id);
    }
  ...
  public class InsBoard
  {
    ...
    public void drawDecimal(int num)
    {
      ...
      for (int index = 0; index < this.decimal_.Length; ++index)
      {
        ...
        if (decimalSprite != null && !((UnityEngine.Object) decimalSprite.top_ == (UnityEngine.Object) null))
        {
          if (num2 == index)
