...
public class NGSceneBase : MonoBehaviour
{
  ...
  protected UITweener[] getTweeners()
  {
    ...
    for (int index = 0; index < this.tweens.Length; ++index)
    {
      ...
      if (!((UnityEngine.Object) tween == (UnityEngine.Object) null) && !((UnityEngine.Object) tween.gameObject == (UnityEngine.Object) null))
      {
        if ((UnityEngine.Object) gameObject != (UnityEngine.Object) tween.gameObject)
        {
  ...
  public void startTweens()
  {
    ...
    foreach (UITweener uiTweener in tweens)
    {
      ...
      if (uiTweener.style == UITweener.Style.Once && uiTweener.gameObject.activeInHierarchy && (num1 == 11 || num1 == 12))
      {
  ...
  public void endTweens()
  {
    ...
    {
      int num1 = Mathf.Abs(uiTweener.tweenGroup);
      if (uiTweener.style == UITweener.Style.Once && uiTweener.gameObject.activeInHierarchy && (num1 == 11 || num1 == 13))
      {
        float num2 = uiTweener.duration + uiTweener.delay;
        if ((double) this.tweenTimeoutTime < (double) num2)
          this.tweenTimeoutTime = num2;
  ...
  {
    if (!((UnityEngine.Object) Singleton<CommonRoot>.GetInstance().GetNormalHeaderComponent() != (UnityEngine.Object) null))
      return;
