...
public class Unit004ReincarnationTypeTicketPopupExchangeMenu : BackButtonMenuBase
{
  ...
  private System.Action<UnitTypeEnum, bool> onSelectPopup;

  public IEnumerator coInitialize(
    UnitTypeTicket ticket,
    PlayerUnit playerUnit,
    Unit004ReincarnationTypeUnitSelectionMenu menu,
    System.Action<UnitTypeEnum, bool> onSelect = null)
  {
    ...
    if (ticket.unit_type_random_flag)
    {
      ...
      popupExchangeMenu.popupType_.gameObject.SetActive(false);
    }
    else
    {
    ...
    popupExchangeMenu.labelSelectType.gameObject.SetActive(!ticket.unit_type_random_flag);
    popupExchangeMenu.labelRandom.gameObject.SetActive(ticket.unit_type_random_flag);
