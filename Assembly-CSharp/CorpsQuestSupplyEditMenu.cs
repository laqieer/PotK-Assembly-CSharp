...
public class CorpsQuestSupplyEditMenu : BackButtonMenuBase
{
  ...
  private IEnumerator SetSelectionUnitAndSupply()
  {
    ...
    {
      Future<WebAPI.Response.QuestCorpsReset> f = WebAPI.QuestCorpsReset(intList1.ToArray(), intList2.ToArray(), questSupplyEditMenu.playerCorps.period_id, questSupplyEditMenu.selectedUnitIDs, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
    ...
    {
      Future<WebAPI.Response.QuestCorpsEntry> f = WebAPI.QuestCorpsEntry(intList1.ToArray(), intList2.ToArray(), questSupplyEditMenu.playerCorps.period_id, questSupplyEditMenu.selectedUnitIDs, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
      e1 = f.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
    ...
    e1 = questSupplyEditMenu.UpdateCorpsDeck(new System.Action(questSupplyEditMenu.\u003CSetSelectionUnitAndSupply\u003Eb__14_2));
    while (e1.MoveNext())
      yield return e1.Current;
    e1 = (IEnumerator) null;
  }
  ...
  private IEnumerator UpdateCorpsDeck(System.Action successAction)
  {
    ...
    else
    {
      ...
      if (flag)
      {
        Future<WebAPI.Response.QuestCorpsDeckEdit> f = WebAPI.QuestCorpsDeckEdit(questSupplyEditMenu.playerCorps.period_id, intList.ToArray(), (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
    ...
    CorpsUtil.SequenceType type)
  {
    ...
    for (int index = 0; index < Consts.GetInstance().DECK_SUPPLY_MAX; ++index)
    {
      GameObject self = UnityEngine.Object.Instantiate<GameObject>(questSupplyEditMenu.iconPrefab);
      if ((UnityEngine.Object) questSupplyEditMenu.icons[index] != (UnityEngine.Object) null)
        UnityEngine.Object.Destroy((UnityEngine.Object) questSupplyEditMenu.icons[index].gameObject);
    ...
    int counter = 0;
    foreach (SupplyItem supplyItem in questSupplyEditMenu.SupplyItems)
    {
