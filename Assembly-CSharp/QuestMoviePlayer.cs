...
public class QuestMoviePlayer : MonoBehaviour
{
  ...
  private string moviePath() => this.index >= this.windowsMoviePath.Count ? "" : this.windowsMoviePath[this.index++];
  ...
  public IEnumerator Play(bool enabledSkip = true)
  {
    ...
    while (true)
    {
      ...
      if (!(moviepath == ""))
      {
        ...
        GameObject gameObject = UnityEngine.Object.Instantiate(Resources.Load("Prefabs/WindowsMovie")) as GameObject;
  ...
  public void HideMainPanel()
  {
    ...
    if ((UnityEngine.Object) Singleton<CommonRoot>.GetInstance().getBackgroundComponent<Transform>() != (UnityEngine.Object) null)
      Singleton<CommonRoot>.GetInstance().getBackgroundComponent<Transform>().gameObject.SetActive(false);
