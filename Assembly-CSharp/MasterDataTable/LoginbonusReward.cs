...
namespace MasterDataTable
{
  ...
  public class LoginbonusReward
  {
    ...
    public static LoginbonusReward Parse(MasterDataReader reader) => new LoginbonusReward()
    {
      ID = reader.ReadInt(),
    ...
    public LoginbonusLoginbonus loginbonus
    {
      get
      {
        LoginbonusLoginbonus loginbonusLoginbonus;
        if (!MasterData.LoginbonusLoginbonus.TryGetValue(this.loginbonus_LoginbonusLoginbonus, out loginbonusLoginbonus))
          Debug.LogError((object) ("Key not Found: MasterData.LoginbonusLoginbonus[" + (object) this.loginbonus_LoginbonusLoginbonus + "]"));
        return loginbonusLoginbonus;
      }
    }
