...
namespace MasterDataTable
{
  ...
  public class OverkillersSlotRelease
  {
    ...
    public static OverkillersSlotRelease Parse(MasterDataReader reader) => new OverkillersSlotRelease()
    {
      ID = reader.ReadInt(),
    ...
    public static OverkillersSlotRelease find(int same_character_id) => Array.Find<OverkillersSlotRelease>(MasterData.OverkillersSlotReleaseList, (Predicate<OverkillersSlotRelease>) (x => x.same_character_id == same_character_id));

    public OverkillersSlotRelease.Conditions[] getConditions()
    {
      OverkillersSlotRelease.Conditions[] conditionsArray = new OverkillersSlotRelease.Conditions[this.num_slot];
      for (int slot_no = 0; slot_no < conditionsArray.Length; ++slot_no)
        conditionsArray[slot_no] = this.getConditions(slot_no);
      return conditionsArray;
    }

    public OverkillersSlotRelease.Conditions getConditions(int slot_no) => new OverkillersSlotRelease.Conditions(this, slot_no);
    ...
    public class Conditions
    {
      ...
      public PlayerMaterialUnit[] getPlayerMaterials()
      {
        ...
        PlayerMaterialUnit[] playerMaterialUnitArray = new PlayerMaterialUnit[this.materials.Length];
