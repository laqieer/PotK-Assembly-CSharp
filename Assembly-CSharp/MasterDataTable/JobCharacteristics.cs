...
namespace MasterDataTable
{
  ...
  public class JobCharacteristics
  {
    ...
    public static JobCharacteristics Parse(MasterDataReader reader) => new JobCharacteristics()
    {
      ID = reader.ReadInt(),
    ...
    public JobCharacteristicsLevelmaxBonus levelmax_bonus => (JobCharacteristicsLevelmaxBonus) this.levelmax_bonus_JobCharacteristicsLevelmaxBonus;

    public JobCharacteristicsLevelmaxBonus levelmax_bonus2 => (JobCharacteristicsLevelmaxBonus) this.levelmax_bonus2_JobCharacteristicsLevelmaxBonus;

    public JobCharacteristicsLevelmaxBonus levelmax_bonus3 => (JobCharacteristicsLevelmaxBonus) this.levelmax_bonus3_JobCharacteristicsLevelmaxBonus;
    ...
    public int[] levelup_patterns => this.levelup_patterns_ ?? (this.levelup_patterns_ = this.stringToIntegers(this.level_pattern_id));
