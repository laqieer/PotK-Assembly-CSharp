...
namespace MasterDataTable
{
  ...
  public class OverkillersMaterial
  {
    ...
    public static OverkillersMaterial Parse(MasterDataReader reader) => new OverkillersMaterial()
    {
      ID = reader.ReadInt(),
    ...
    public UnitUnit material
    {
      get
      {
        ...
        UnitUnit unitUnit;
        if (!MasterData.UnitUnit.TryGetValue(this.material_UnitUnit.Value, out unitUnit))
    ...
    private static void errorLog(OverkillersMaterial dat) => Debug.LogError((object) ("Bad Data \"OverkillersMaterial{ID=" + dat.ID.ToString() + ", materials_no=" + dat.materials_no.ToString() + ", materials_set=" + (dat.materials_set.HasValue ? dat.materials_set.Value.ToString() : "null") + ", material=" + (dat.material_UnitUnit.HasValue ? dat.material_UnitUnit.Value.ToString() : "null") + "}\""));
  }
}
