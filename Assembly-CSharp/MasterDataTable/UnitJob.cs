...
namespace MasterDataTable
{
  ...
  public class UnitJob
  {
    ...
    public static UnitJob Parse(MasterDataReader reader) => new UnitJob()
    {
      ID = reader.ReadInt(),
    ...
    public JobCharacteristics[] JobAbilities => this.jobAbilities_ ?? (this.jobAbilities_ = ((IEnumerable<int>) this.JobAbilityIds).Select<int, JobCharacteristics>((Func<int, JobCharacteristics>) (i => MasterData.JobCharacteristics[i])).ToArray<JobCharacteristics>());

    public int[] JobAbilityIds => this.jobAbilityIds_ ?? (this.jobAbilityIds_ = this.stringToIntegers(this.job_characteristics_id));
