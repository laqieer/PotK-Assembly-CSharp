...
namespace MasterDataTable
{
  ...
  public class StoryPlaybackCharacterDetail
  {
    ...
    public static StoryPlaybackCharacterDetail Parse(
    ...
    public StoryPlaybackCharacter character
    {
      get
      {
        StoryPlaybackCharacter playbackCharacter;
        if (!MasterData.StoryPlaybackCharacter.TryGetValue(this.character_StoryPlaybackCharacter, out playbackCharacter))
          Debug.LogError((object) ("Key not Found: MasterData.StoryPlaybackCharacter[" + (object) this.character_StoryPlaybackCharacter + "]"));
        return playbackCharacter;
      }
    }
