...
namespace MasterDataTable
{
  ...
  public class BattleskillSkill
  {
    ...
    public bool PassiveSkill => this.skill_type == BattleskillSkillType.leader || this.skill_type == BattleskillSkillType.duel || this.skill_type == BattleskillSkillType.passive;

    public bool DispSkillList => this.skill_type != BattleskillSkillType.leader && this.skill_type != BattleskillSkillType.magic;
    ...
    public bool checkEnableUnit(BL.ISkillEffectListUnit unit) => BattleFuncs.checkEnableUnitSkill(unit, this);

    public BattleskillTargetType GetRangeEffect(
      out int minRange,
      out int maxRange)
    {
      minRange = 0;
      ...
      BattleskillEffectLogicEnum[] battleskillEffectLogicEnumArray1 = new BattleskillEffectLogicEnum[3]
      {
      ...
      BattleskillEffectLogicEnum[] battleskillEffectLogicEnumArray2 = new BattleskillEffectLogicEnum[3]
      {
      ...
      foreach (BattleskillEffect battleskillEffect in effects)
      {
        ...
        if (((IEnumerable<BattleskillEffectLogicEnum>) battleskillEffectLogicEnumArray1).Contains<BattleskillEffectLogicEnum>(battleskillEffectLogicEnum))
        {
        ...
        if (((IEnumerable<BattleskillEffectLogicEnum>) battleskillEffectLogicEnumArray2).Contains<BattleskillEffectLogicEnum>(battleskillEffectLogicEnum))
        {
          minRange = battleskillEffect.GetInt(BattleskillEffectLogicArgumentEnum.min_range);
          maxRange = battleskillEffect.GetInt(BattleskillEffectLogicArgumentEnum.max_range);
    ...
    public bool IsJobAbility => !this.isJobAbility_.HasValue ? (this.isJobAbility_ = new bool?(Array.Find<JobCharacteristics>(MasterData.JobCharacteristicsList, (Predicate<JobCharacteristics>) (jc =>
    {
    ...
    public bool IsCallTargetPlayer => this.target_type == BattleskillTargetType.myself || this.target_type == BattleskillTargetType.player_range || this.target_type == BattleskillTargetType.player_single;

    public bool IsCallTargetEnemy => this.target_type == BattleskillTargetType.enemy_range || this.target_type == BattleskillTargetType.enemy_single;

    public bool IsCallTargetComplex => this.target_type == BattleskillTargetType.complex_range || this.target_type == BattleskillTargetType.complex_single;

    public static BattleskillSkill Parse(MasterDataReader reader) => new BattleskillSkill()
    {
      ID = reader.ReadInt(),
    ...
    public BattleskillSkillType skill_type => (BattleskillSkillType) this.skill_type_BattleskillSkillType;
    ...
    public BattleskillTargetType target_type => (BattleskillTargetType) this.target_type_BattleskillTargetType;
    ...
    public BattleskillFieldEffect field_effect
    {
      get
      {
        ...
        BattleskillFieldEffect battleskillFieldEffect;
        if (!MasterData.BattleskillFieldEffect.TryGetValue(this.field_effect_BattleskillFieldEffect.Value, out battleskillFieldEffect))
    ...
    public BattleskillDuelEffect duel_effect
    {
      get
      {
        ...
        BattleskillDuelEffect battleskillDuelEffect;
        if (!MasterData.BattleskillDuelEffect.TryGetValue(this.duel_effect_BattleskillDuelEffect.Value, out battleskillDuelEffect))
          Debug.LogError((object) ("Key not Found: MasterData.BattleskillDuelEffect[" + (object) this.duel_effect_BattleskillDuelEffect.Value + "]"));
        return battleskillDuelEffect;
      }
    }
    ...
    public BattleskillFieldEffect passive_effect
    {
      get
      {
        if (!this.passive_effect_BattleskillFieldEffect.HasValue)
          return (BattleskillFieldEffect) null;
        BattleskillFieldEffect battleskillFieldEffect;
        if (!MasterData.BattleskillFieldEffect.TryGetValue(this.passive_effect_BattleskillFieldEffect.Value, out battleskillFieldEffect))
    ...
    public BattleskillAilmentEffect ailment_effect
    {
      get
      {
        ...
        BattleskillAilmentEffect battleskillAilmentEffect;
        if (!MasterData.BattleskillAilmentEffect.TryGetValue(this.ailment_effect_BattleskillAilmentEffect.Value, out battleskillAilmentEffect))
        ...
        return battleskillAilmentEffect;
      }
    }
    ...
    public Future<UnityEngine.Sprite> LoadBattleSkillIcon(BattleFuncs.InvestSkill s = null)
    {
      ...
      return Singleton<ResourceManager>.GetInstance().LoadOrNull<UnityEngine.Sprite>(path);
    }

    public Future<UnityEngine.Sprite> LoadCallSkillIcon() => Singleton<ResourceManager>.GetInstance().LoadOrNull<UnityEngine.Sprite>("BattleSkills/call_skill_icon");
