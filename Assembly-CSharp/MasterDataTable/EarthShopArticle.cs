...
namespace MasterDataTable
{
  ...
  public class EarthShopArticle
  {
    ...
    public static EarthShopArticle Parse(MasterDataReader reader) => new EarthShopArticle()
    {
      ID = reader.ReadInt(),
    ...
    public EarthShopContent ShopContents => ((IEnumerable<EarthShopContent>) MasterData.EarthShopContentList).FirstOrDefault<EarthShopContent>((Func<EarthShopContent, bool>) (x => x.article.ID == this.ID));
