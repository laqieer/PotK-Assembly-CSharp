...
public class GuideZukanListManager : BackButtonMenuBase
{
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        {
          int? nullable = this.withNumberInfoList.FirstIndexOrNull<WithNumberInfo>((Func<WithNumberInfo, bool>) (v => (UnityEngine.Object) v.icon != (UnityEngine.Object) null && (UnityEngine.Object) v.icon.gameObject == (UnityEngine.Object) unit));
  ...
  public virtual int ResourceID(GuideUnitUnit unit) => unit.Unit.resource_reference_unit_id_UnitUnit;

  public virtual Future<UnityEngine.Sprite> ResourceSprite(GuideUnitUnit unit) => unit.Unit.LoadSpriteThumbnail();
  ...
  public virtual IEnumerator CreateSpriteCashList()
  {
    ...
    foreach (GuideUnitUnit guideUnitUnit in list)
    {
      GuideUnitUnit unit = guideUnitUnit;
  ...
  protected void CreateUnitIconBase()
  {
    ...
    {
      GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.numberPrefab);
  ...
  protected void CreateUnitIcon(int info_index, int unit_index)
  {
    ...
    this.withNumberInfoList.Where<WithNumberInfo>((Func<WithNumberInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)).ForEach<WithNumberInfo>((System.Action<WithNumberInfo>) (b => b.icon = (WithNumber) null));
  ...
  public void AddSpriteCashList(int id, Future<UnityEngine.Sprite> fSprite)
  {
  ...
  public void IbtnUse()
  {
    foreach (WithNumber withNumber in this.withNumberList)
    {
      withNumber.button.enabled = true;
  ...
  public void IbtnFreeze()
  {
    foreach (WithNumber withNumber in this.withNumberList)
    {
      withNumber.button.enabled = false;
  ...
  protected int RarityOrder(GuideUnitUnit unit) => unit.Unit.history_group_number + unit.Unit.rarity.index * 10000;

  protected int RarityOrderGear(GuideUnitUnit gear) => gear.Gear.history_group_number + gear.Gear.rarity.index * 10000;
}
