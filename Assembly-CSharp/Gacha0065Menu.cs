...
public class Gacha0065Menu : BackButtonMenuBase
{
  ...
  public void Init(string name, GachaModuleGacha gacha_data, Gacha0063Scene scene = null)
  {
    ...
    this.scene = scene;
    if ((UnityEngine.Object) this.scene != (UnityEngine.Object) null)
    {
    ...
    if (gacha_data.payment_type_id == Gacha0063Menu.PaymentTypeIDCompensation)
    {
      ...
      this.popupBaseSprite.SetDimensions(this.popupBaseSprite.width, 560);
    }
    else if (gacha_data.payment_type_id == 5)
    {
      if (gacha_data.payment_id.HasValue)
      {
        ...
        this.TxtNumber.SetText(Consts.Format(Consts.GetInstance().GACHA_0065MENU_DESCRIPTION03, (IDictionary) new Hashtable()
        {
          {
            (object) "nowcrystal",
            (object) num.ToString().ToConverter()
          }
        }));
  ...
  private bool IsGachaEX() => !((UnityEngine.Object) this.scene == (UnityEngine.Object) null) && this.scene.gachaType != MasterDataTable.GachaType.normal && (this.scene.gachaType != MasterDataTable.GachaType.friend && this.scene.gachaType != MasterDataTable.GachaType.ticket) && this.scene.gachaType != MasterDataTable.GachaType.sheet;
    ...
    int? payment_id)
  {
    ...
    if (bonusCountDown.HasValue)
    {
      nullable = bonusCountDown;
      int num2 = 0;
      num3 = nullable.GetValueOrDefault() > num2 & nullable.HasValue ? 1 : 0;
    }
    else
      num3 = 0;
    bool flag2 = num3 != 0;
