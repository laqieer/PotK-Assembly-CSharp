...
public class Bugu0053Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, List<InventoryItem> gearList) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_3", (stack ? 1 : 0) != 0, (object) gearList);
