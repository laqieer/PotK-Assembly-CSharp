...
public class BattleCutSceneMenu : BackButtonMenuBase
{
  ...
  public IEnumerator OnStartSceneAsync(BL.Unit unit, BL.Skill skill)
  {
    ...
    battleCutSceneMenu.mMainCameraObj.GetComponentInChildren<Camera>().enabled = false;
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    UnityEngine.Object.Destroy((UnityEngine.Object) unitObj.GetComponent<NGDuelUnit>());
    battleCutSceneMenu.mUnitModel = unitObj.AddComponent<CutSceneUnitModel>();
    e = battleCutSceneMenu.mUnitModel.Initialize(unit, skill, battleCutSceneMenu.mRoot3d.gameObject, battleCutSceneMenu.mMainCameraObj, battleCutSceneMenu.mSubCameraObj);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  {
    this.mMainCameraObj.GetComponentInChildren<Camera>().enabled = true;
  ...
  public void OnEndScene()
  {
    ...
    this.mRoot3d.gameObject.SetActive(false);
  }
