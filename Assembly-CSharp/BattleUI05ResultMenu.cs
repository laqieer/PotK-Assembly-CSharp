...
public class BattleUI05ResultMenu : ResultMenuBase
{
  ...
  public override IEnumerator Init(BattleInfo info, BattleEnd result)
  {
    ...
    if ((UnityEngine.Object) battleUi05ResultMenu.bonus == (UnityEngine.Object) null)
    {
  ...
  public bool IsNotLastPlayerLevelUp() => this.result.before_player.level + this.nowLevelupCount >= SMManager.Get<Player>().level - 1;
  ...
  public IEnumerator OnLastPlayerLevelup(GameObject obj, int count)
  {
    ...
    o.SetCallback((System.Action) (() => onFinished = true));
    while (!onFinished)
    {
  ...
  private IEnumerator ShowPlayerEXP()
  {
    ...
    while (e.MoveNext() && !battleUi05ResultMenu.isSkip)
      yield return e.Current;
    e = (IEnumerator) null;
    UnityEngine.Object.Destroy((UnityEngine.Object) battleUi05ResultMenu.PlayerEXPGauge.GetComponent<TweenScale>());
    ...
    bool isAcquire)
  {
    ...
    foreach (FavorabilityRatingEffect.AnimationType anmType in animationTypeList)
    {
      ...
      if (!((UnityEngine.Object) go == (UnityEngine.Object) null))
      {
        ...
        IEnumerator e = favorabilityRatingEffect.Init(anmType, afterUnit, (System.Action) (() =>
        {
          isFinished = true;
    ...
    else
    {
      ...
      if (missions != null && missions.Length != 0)
      {
        ...
        if (!flag)
        {
          ...
          ((IEnumerable<UITweener>) popup.GetComponents<UITweener>()).ForEach<UITweener>((System.Action<UITweener>) (x =>
          {
            x.enabled = false;
            x.onFinished.Clear();
          }));
          ...
          {
            Quest0022MissionList component = battleUi05ResultMenu.mStageMissionItemPrefab.Clone(oo.grid.transform).GetComponent<Quest0022MissionList>();
            component.transform.localPosition = new Vector3(0.0f, (float) -index * oo.grid.cellHeight, 0.0f);
            oo.MissionList.Add(component);
            oo.ThumbnailList.Add(component.LinkParent.gameObject);
          }
          oo.grid.Reposition();
          ...
          {
            oo.MissionList.ForEach((System.Action<Quest0022MissionList>) (x => x.InitEffects()));
            ...
            System.Action closeStageMissionPopupAction = (System.Action) (() =>
            {
            ...
            Singleton<PopupManager>.GetInstance().dismiss();
            closeStageMissionPopupAction = (System.Action) null;
          }
        }
      }
    }
  ...
  private IEnumerator StageMissionCompletePopup()
  {
    ...
    else
    {
      ...
      if (missionCompleteRewards != null && missionCompleteRewards.Length != 0)
      {
        ...
        {
          transform = {
            parent = battleUi05ResultMenu.gameObject.transform
          },
          layer = battleUi05ResultMenu.gameObject.layer
        };
  ...
  public void SetBonus(int category, bool isClear = false) => this.bonusScript.SetBonusTitle(category, isClear);
