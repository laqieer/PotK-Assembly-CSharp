  ...
  private IEnumerator AutoSelectAsync()
  {
    ...
    if (bok)
    {
      ...
      if (deckCreator.isSuccess)
      {
        ...
        Future<WebAPI.Response.TowerDeckEdit> f = WebAPI.TowerDeckEdit(player_unit_ids, this.progress.tower_id, (System.Action<WebAPI.Response.UserError>) (e => WebAPI.DefaultUserErrorCallback(e)));
        e1 = f.Wait();
        while (e1.MoveNext())
          yield return e1.Current;
        e1 = (IEnumerator) null;
