...
public class HpGauge : BattleMonoBehaviour
{
  ...
  public void enableBossMode()
  {
    if (this.bossParts == null || this.bossParts.Length < 1)
      return;
    this.gauge.transform.parent.gameObject.SetActive(false);
  ...
  {
    ((IEnumerable<HpGauge.ElementIcons>) this.gears).ForEach<HpGauge.ElementIcons>((System.Action<HpGauge.ElementIcons>) (x =>
    {
      if (!((UnityEngine.Object) x.parent != (UnityEngine.Object) null))
        return;
    ...
    if (this.gears.Length <= index || !((UnityEngine.Object) this.gears[index].parent != (UnityEngine.Object) null))
      return;
    HpGauge.ElementIcons gear = this.gears[index];
    gear.parent.SetActive(true);
    ((IEnumerable<GameObject>) gear.icons).ForEach<GameObject>((System.Action<GameObject>) (x =>
    {
    ...
    if (!((UnityEngine.Object) gear.icons[element - 1] != (UnityEngine.Object) null))
      return;
  ...
  public bool setValue(int n, int max)
  {
    ...
    if (Mathf.Approximately(this.gaugeValue, b))
      return false;
    this.gauge.transform.localScale = new Vector3(b * 2.54f, this.gauge.transform.localScale.y, this.gauge.transform.localScale.z);
    this.gaugeValue = b;
    return true;
  }
