...
public class Help0151Button : MonoBehaviour
{
  ...
  public static List<HelpHelp> getHelpList(HelpCategory helpCategory) => ((IEnumerable<HelpHelp>) MasterData.HelpHelpList).Where<HelpHelp>((Func<HelpHelp, bool>) (x => x.category_HelpCategory == helpCategory.ID)).OrderByDescending<HelpHelp, int>((Func<HelpHelp, int>) (x => x.priority)).ToList<HelpHelp>();
