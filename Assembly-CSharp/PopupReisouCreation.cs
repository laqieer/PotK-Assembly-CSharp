...
public class PopupReisouCreation : BackButtonMenuBase
{
  ...
  public IEnumerator Init(GearReisouChaosCreation recipe, System.Action cbCreation)
  {
  ...
  private IEnumerator SetReisouIcon(GearGear gear, GameObject prefab)
  {
    ...
    itemIcon.onClick = (System.Action<ItemIcon>) (item => itemIcon.OpenReisouDetailPopup(item.ItemInfo, playerItem));
  }
  ...
  private IEnumerator CallReisouCreationAPI()
  {
    ...
    Future<WebAPI.Response.ItemGearReisouCreation> paramF = WebAPI.ItemGearReisouCreation(this.recipe.ID, this.selectedCount, (System.Action<WebAPI.Response.UserError>) (error =>
    {
    ...
    if (paramF.Result != null)
    {
      ...
      System.Action cbCreation = this.cbCreation;
      if (cbCreation != null)
        cbCreation();
    }
  }
