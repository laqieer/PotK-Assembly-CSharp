...
public static class RarityIcon
{
  ...
  public static string GetSpriteName(UnitUnit unit, bool isDetail = true, bool isSame = false, bool isAwake = false) => RarityIcon._GetSpriteName((PlayerUnit) null, unit, isDetail, isSame, isAwake);
    ...
    bool isAwake = false)
  {
    ...
    switch (num1)
    {
      ...
      case 3:
      case 4:
        str = !isDetail ? string.Format(RarityIcon.SLIVER_IMG_NAME, (object) RarityIcon.CURRENT_PATH, (object) num1, (object) num2) : string.Format(RarityIcon.DETAIL_SLIVER_IMG_NAME, (object) RarityIcon.DETAIL_CURRENT_PATH, (object) num1, (object) num2);
        break;
      case 5:
        str = !isDetail ? string.Format(RarityIcon.GOLD_IMG_NAME, (object) RarityIcon.CURRENT_PATH, (object) num1, (object) num2) : string.Format(RarityIcon.DETAIL_GOLD_IMG_NAME, (object) RarityIcon.DETAIL_CURRENT_PATH, (object) num1, (object) num2);
        break;
      case 6:
        str = !isDetail ? string.Format(RarityIcon.RAINBOW_IMG_NAME, (object) RarityIcon.CURRENT_PATH, (object) num1, (object) num2) : string.Format(RarityIcon.DETAIL_RAINBOW_IMG_NAME, (object) RarityIcon.DETAIL_CURRENT_PATH, (object) num1, (object) num2);
        break;
      default:
  ...
  private static UnityEngine.Sprite GetSprite(GearRarity rarity) => Resources.Load<UnityEngine.Sprite>(RarityIcon.spriteNameTBL[rarity.index - 1]);

  public static UnityEngine.Sprite GetSprite(
    PlayerUnit plyaerUnit,
    bool isDetail = true,
    bool isSame = false,
    bool isAwake = false)
  {
    return Resources.Load<UnityEngine.Sprite>(RarityIcon.GetSpriteName(plyaerUnit, isDetail, isSame, isAwake));
  }
  ...
  public static UnityEngine.Sprite GetSprite(
    ...
    bool isAwake = false)
  {
    return Resources.Load<UnityEngine.Sprite>(RarityIcon.GetSpriteName(unit, isDetail, isSame, isAwake));
  }
    ...
    bool isAwake = false)
  {
    if ((UnityEngine.Object) dstSprite == (UnityEngine.Object) null)
      return;
    UnityEngine.Sprite sprite = !(playerUnit == (PlayerUnit) null) ? RarityIcon.GetSprite(playerUnit, isDetail, isSame, isAwake) : RarityIcon.GetSprite(unit, isDetail, isSame, isAwake);
  ...
  public static void SetRarity(GearGear gear, UI2DSprite dstSprite)
  {
    ...
    if (gear.rarity.index <= 0)
      return;
    UnityEngine.Sprite sprite = RarityIcon.GetSprite(gear.rarity);
    if (!((UnityEngine.Object) sprite != (UnityEngine.Object) null))
      return;
    dstSprite.sprite2D = sprite;
    dstSprite.SetDimensions((int) sprite.textureRect.width, (int) sprite.textureRect.height);
