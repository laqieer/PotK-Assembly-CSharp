...
public class Unit004JobDialogConfirmationPopup : BackButtonMenuBase
{
  ...
  private IEnumerator openAnimationLevelUp()
  {
    ...
    Future<WebAPI.Response.UnitSaveJobAbility> paramF = WebAPI.UnitSaveJobAbility(confirmationPopup._unit.id, confirmationPopup._jobAbility.job_ability_id, confirmationPopup._targetLevel, (System.Action<WebAPI.Response.UserError>) (error =>
    {
    ...
    if (result != null)
    {
      ...
      System.Action updatedJobAbility = confirmationPopup.onUpdatedJobAbility_;
