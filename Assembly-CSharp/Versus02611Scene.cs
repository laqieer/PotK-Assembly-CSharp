...
public class Versus02611Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, WebAPI.Response.PvpBoot pvpInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("versus026_11", (stack ? 1 : 0) != 0, (object) pvpInfo);
