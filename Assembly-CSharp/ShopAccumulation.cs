...
public class ShopAccumulation : MonoBehaviour
{
  ...
  public IEnumerator Init(WebAPI.Response.CoinbonusHistory coinbonusHistory)
  {
    ...
    yield return (object) this.CreateStage(this.stepupPackInfo.pack_steps[0].rewards, withLoupeIcon, this.stage1Grid.transform);
    this.stage1Grid.Reposition();
    yield return (object) this.CreateStage(this.stepupPackInfo.pack_steps[1].rewards, withLoupeIcon, this.stage2Grid.transform);
    this.stage2Grid.Reposition();
    yield return (object) this.CreateStage(this.stepupPackInfo.pack_steps[2].rewards, withLoupeIcon, this.stage3Grid.transform);
...
label_13:
    ...
    {
      case 1:
        target = this.stage1Grid.transform.parent;
        break;
      case 2:
        target = this.stage2Grid.transform.parent;
        break;
      case 3:
        target = this.stage3Grid.transform.parent;
        break;
      default:
        Debug.LogError((object) ("想定していないステージです: " + (object) num1));
        break;
    }
    this.centerOnChild.onFinished = (SpringPanel.OnFinished) (() => this.centerOnFinished());
  ...
  {
    if ((UnityEngine.Object) this.stage2Grid.transform.parent.gameObject == (UnityEngine.Object) this.centerOnChild.centeredObject)
    {
      this.centerOnChild.CenterOn(this.stage1Grid.transform.parent);
    }
    else
    {
      if (!((UnityEngine.Object) this.stage3Grid.transform.parent.gameObject == (UnityEngine.Object) this.centerOnChild.centeredObject))
        return;
      this.centerOnChild.CenterOn(this.stage2Grid.transform.parent);
    }
  }

  public void OrRightArrow()
  {
    if ((UnityEngine.Object) this.stage1Grid.transform.parent.gameObject == (UnityEngine.Object) this.centerOnChild.centeredObject)
    {
      this.centerOnChild.CenterOn(this.stage2Grid.transform.parent);
    }
    else
    {
      if (!((UnityEngine.Object) this.stage2Grid.transform.parent.gameObject == (UnityEngine.Object) this.centerOnChild.centeredObject))
        return;
      this.centerOnChild.CenterOn(this.stage3Grid.transform.parent);
    }
  }
  ...
  private void centerOnFinished()
  {
    ...
    if ((UnityEngine.Object) this.stage1Grid.transform.parent.gameObject == (UnityEngine.Object) this.centerOnChild.centeredObject)
      nullable1 = new int?(0);
    else if ((UnityEngine.Object) this.stage2Grid.transform.parent.gameObject == (UnityEngine.Object) this.centerOnChild.centeredObject)
      nullable1 = new int?(1);
    else if ((UnityEngine.Object) this.stage3Grid.transform.parent.gameObject == (UnityEngine.Object) this.centerOnChild.centeredObject)
    {
      nullable1 = new int?(2);
    }
    else
    ...
    if (nullable5.HasValue)
    {
      nullable3 = nullable5;
      int num2 = 6;
      if (nullable3.GetValueOrDefault() == num2 & nullable3.HasValue && this.stepupPackInfo.player_pack.is_received)
      {
...
label_25:
    ...
    else
    {
      ...
      if (num4 == valueOrDefault1 & nullable3.HasValue)
      {
        this.kisekiInfo.SetActive(false);
...
label_40:
    if (this.stepupPackInfo.player_pack.is_purchasable || !this.stepupPackInfo.player_pack.is_received)
    {
      ...
      if (num2 == valueOrDefault & nullable3.HasValue)
      {
        this.priceOrReceiveButton.isEnabled = true;
        goto label_44;
      }
    }
    this.priceOrReceiveButton.isEnabled = false;
label_44:
    if (num3 != 1)
    {
      int num2 = num3;
      ...
      nullable3 = nullable7.HasValue ? new int?(nullable7.GetValueOrDefault() + 1) : new int?();
      int valueOrDefault = nullable3.GetValueOrDefault();
      if (num2 == valueOrDefault & nullable3.HasValue && !nullable6.HasValue)
      {
    ...
    if (!(num5 == valueOrDefault2 & nullable3.HasValue))
    {
      ...
      nullable3 = nullable7.HasValue ? new int?(nullable7.GetValueOrDefault() + 1) : new int?();
      int valueOrDefault1 = nullable3.GetValueOrDefault();
      if (num2 < valueOrDefault1 & nullable3.HasValue)
      {
    ...
    if (!(num6 == valueOrDefault3 & nullable3.HasValue))
    {
      int num2 = num3;
      nullable7 = nullable1;
      nullable3 = nullable7.HasValue ? new int?(nullable7.GetValueOrDefault() + 1) : new int?();
