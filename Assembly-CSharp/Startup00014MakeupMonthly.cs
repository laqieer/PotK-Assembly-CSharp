...
public class Startup00014MakeupMonthly : Startup00014Menu
{
  ...
  public bool isStartupScene => (UnityEngine.Object) this.Parent != (UnityEngine.Object) null;
  ...
  public override IEnumerator InitSceneAsync(PlayerLoginBonus loginBonus)
  {
    ...
    startup00014MakeupMonthly.mNextButton.isEnabled = false;
    ...
    e = (IEnumerator) null;
    startup00014MakeupMonthly.mNextButton.isEnabled = true;
  ...
  public IEnumerator InitSceneAsync(WebAPI.Response.LoginbonusTop loginBonus)
  {
    ...
    {
      startup00014MakeupMonthly.mRewardIconEffectAnim.gameObject.SetActive(false);
    ...
    bool enableAnime)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    this.mScroll.transform.parent.gameObject.SetActive(false);
    if ((UnityEngine.Object) this.mHelpButton != (UnityEngine.Object) null && Persist.integralNoaTutorial.Data.beginnersQuest)
      this.mHelpButton.gameObject.SetActive(false);
  }
  ...
  private IEnumerator CreateBackground(string name)
  {
    ...
    {
      Future<UnityEngine.Sprite> loadFt = new ResourceObject("Prefabs/BackGround/" + name).Load<UnityEngine.Sprite>();
      ...
      if ((UnityEngine.Object) loadFt.Result != (UnityEngine.Object) null)
      {
        ...
        this.mBackground.width = loadFt.Result.texture.width;
        this.mBackground.height = loadFt.Result.texture.height;
        isBgChanged = true;
      }
      loadFt = (Future<UnityEngine.Sprite>) null;
    }
    if (isBgChanged)
  ...
  private IEnumerator CreateNaviChara(LoginbonusReward reward)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    UnityEngine.Sprite mainSprite = spriteF.Result;
    ...
    if ((UnityEngine.Object) startup00014MakeupMonthly.mNaviFace != (UnityEngine.Object) null)
    {
  ...
  private void CreateNaviFaceData(string face1, string face2, string face3) => this.mNaviFaceData = new string[3]
  {
    face1,
    face2,
    face3
  ...
  private IEnumerator CreateMakeupRewardIcon(LoginbonusReward reward)
  {
    ...
    if ((UnityEngine.Object) icon != (UnityEngine.Object) null)
      UnityEngine.Object.Destroy((UnityEngine.Object) icon);
  ...
  private IEnumerator CreateRewardListIcons(
    LoginbonusReward[] rewardList,
    bool enableAnime)
  {
    ...
    for (int i = 0; i < 31; ++i)
    {
      Startup00014MakeupRewardIcon rewardIcon = icon.CloneAndGetComponent<Startup00014MakeupRewardIcon>(parent.mScroll.grid.gameObject);
    ...
    float num = Mathf.Ceil((float) parent.mLoginDay / (float) parent.mScroll.grid.maxPerLine);
    float y = (double) num < 3.0 ? 0.0f : ((double) num > 3.0 ? 1f : 0.5f);
    parent.mScroll.ResolvePosition(new Vector2(0.0f, y));
  }
    ...
    switch (this.mStepCount)
    {
      case 0:
        ...
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        while ((UnityEngine.Object) this.mNaviMsgNextArrow.GetComponent<TweenPosition>() == (UnityEngine.Object) null)
          yield return (object) null;
        this.mNaviMsgNextArrow.GetComponent<TweenPosition>().enabled = true;
        Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
        break;
      case 1:
        this.StepLock = true;
        if ((UnityEngine.Object) this.mStampInstance == (UnityEngine.Object) null)
          this.Stamp();
        ...
        {
          this.mRewardIconEffectAnim.gameObject.SetActive(false);
  ...
  {
    if ((UnityEngine.Object) this.mNaviFace != (UnityEngine.Object) null && !string.IsNullOrEmpty(this.mNaviFaceData[index]))
    {
  ...
  public void Stamp()
  {
    ...
    if (this.mIsLastDay)
      return;
    this.mNextMarkEffect.Clone(this.mRewardIconList[this.mLoginDay].transform);
  }

  private void Stamp(int index)
  {
    this.mIsStamping = true;
    Vector3 position = this.mRewardIconList[index].transform.position;
    this.mStampInstance = this.mGetMarkEffect.Clone(this.mEffectPanel.transform);
    this.mStampInstance.transform.position = position;
    this.mStampInstance.GetComponentInChildren<TweenScale>().SetOnFinished((EventDelegate.Callback) (() =>
    {
  ...
  public void EndScene()
  {
    foreach (GameObject mDestroyObj in this.mDestroyObjList)
    {
      ...
      UnityEngine.Object.Destroy((UnityEngine.Object) mDestroyObj);
    }
  ...
  private IEnumerator OpenMakeupConfirm(LoginbonusReward reward)
  {
    ...
    e = Singleton<PopupManager>.GetInstance().open(result).GetComponent<PopupWithThumNoYes>().Initialize(Consts.GetInstance().POPUP_LOGIN_BONUS_MAKEUP_CONFIRM_TITLE, Consts.GetInstance().POPUP_LOGIN_BONUS_MAKEUP_CONFIRM_MESSAGE, reward.reward_type, reward.reward_id, reward.reward_quantity, (System.Action) (() => this.StartCoroutine(this.SendMakeup(reward))), (System.Action) (() =>
    {
      this.IsPush = false;
  ...
  private IEnumerator SendMakeup(LoginbonusReward reward)
  {
    ...
    else
    {
      ...
      Singleton<CommonRoot>.GetInstance().HideLoadingLayer();
      e = Singleton<PopupManager>.GetInstance().open(result2).GetComponent<PopupWithThumOk>().Initialize(Consts.GetInstance().POPUP_LOGIN_BONUS_MAKEUP_TITLE, Consts.GetInstance().POPUP_LOGIN_BONUS_MAKEUP_MESSAGE, reward.reward_type, reward.reward_id, reward.reward_quantity, (System.Action) (() => this.StartCoroutine(this.WaitPopupCloseAndStamp(reward.number - 1))));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
