...
public class Guide01122Menu : BackButtonMenuBase
{
  ...
  public virtual void updateMenu(UnitUnit unit, int job_id) => this.StartCoroutine(this.onStartSceneAsync(unit, false, job_id));
  ...
  public IEnumerator onStartSceneAsync(UnitUnit unit, bool voiceFlag, int select_job_id = 0)
  {
    ...
    else
    {
      ...
      else if (jobIdList.Any<int>((Func<int, bool>) (x => (uint) x > 0U)))
      {
        jobIdList.Reverse();
      ...
      else
      {
        ...
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        if ((bool) (UnityEngine.Object) this.slc_GroupBase)
        {
        ...
        if (this.commonUnitList.Length < 2 && jobIdList.Count < 2)
        {
          ...
          this.ibtnEvolution.enabled = false;
        }
  ...
  public void SetNumber(UnitUnit unit) => this.txt_number.SetTextLocalize("NO." + (unit.history_group_number % 10000).ToString().PadLeft(4, '0'));

  public void SetDefeat(UnitUnit unit, PlayerUnitHistory[] historyList)
  {
    int defeat = 0;
    ((IEnumerable<PlayerUnitHistory>) historyList).ForEach<PlayerUnitHistory>((System.Action<PlayerUnitHistory>) (obj =>
    {
  ...
  {
    if ((UnityEngine.Object) this.refUnitObject != (UnityEngine.Object) null)
    {
      UnityEngine.Object.Destroy((UnityEngine.Object) this.refUnitObject);
    ...
    Future<UnityEngine.Sprite> loader2 = unit.job_UnitJob == this.job_id ? unit.LoadFullSprite() : unit.LoadJobFullSprite(this.job_id);
    e = loader2.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    dynCharacter.sprite2D = loader2.Result;
    loader2 = (Future<UnityEngine.Sprite>) null;
  }
