...
public class UnitUnityGrowthResult : MonoBehaviour
{
  ...
  public IEnumerator Initialize(PlayerUnit beforeUnit, PlayerUnit afterUnit)
  {
    ...
    unityGrowthResult.mTxtBuildupUnityPer.alpha = 0.0f;
    ...
    unityGrowthResult.mBuildupUnityPerUpObj.alpha = 0.0f;
    ...
    unityGrowthResult.mGaugeAnime.onFinishCallback = (System.Action) (() =>
    {
      this.mTxtBuildupUnity.SetTextLocalize((int) Math.Floor((double) after));
      TweenAlpha component = this.mBuildupUnityPerUpObj.GetComponent<TweenAlpha>();
      if ((UnityEngine.Object) component != (UnityEngine.Object) null)
        component.enabled = true;
      else
        this.mBuildupUnityPerUpObj.alpha = 1f;
      this.mTxtBuildupUnityPer.alpha = 1f;
    });
