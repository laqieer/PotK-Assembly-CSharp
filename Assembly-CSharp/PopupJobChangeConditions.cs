...
public class PopupJobChangeConditions : BackButtonPopupBase
{
  ...
  public static Future<GameObject> createLoader() => new ResourceObject("Prefabs/unit004_Job/popup_JobReleasedClass_Conditions__anim_popup01").Load<GameObject>();
  ...
  private void adjustBaseHeight() => this.baseSprite_.height = this.contentHeight_ * ((IEnumerable<PopupJobChangeConditions.UnitJob>) this.jobs_).Count<PopupJobChangeConditions.UnitJob>((Func<PopupJobChangeConditions.UnitJob, bool>) (x => x.isActive)) + this.baseOffsetHeight_;
