...
public class ShopMaterialExchangeListScene : NGSceneBase
{
  ...
  public static void changeScene(PlayerSelectTicketSummary playerUnitTicket, bool isStack = true) => Singleton<NGSceneManager>.GetInstance().changeScene(ShopMaterialExchangeListScene.DEFAULT_NAME, (isStack ? 1 : 0) != 0, (object) playerUnitTicket);
  ...
  public IEnumerator onStartSceneAsync(PlayerSelectTicketSummary playerUnitTicket)
  {
    ...
    if (!scene.isInitialized_)
    {
      ...
      if (scene.playerUnitTicket_ != null)
      {
        ...
        scene.unitTicket_ = ((IEnumerable<SelectTicket>) selectTicketArray).FirstOrDefault<SelectTicket>(new Func<SelectTicket, bool>(scene.\u003ConStartSceneAsync\u003Eb__12_0));
...
label_15:
  ...
  public IEnumerator coEndSceneErrorTicketShortage()
  {
    bool berrorwait = true;
    Consts instance = Consts.GetInstance();
    ModalWindow.Show(instance.SHOP_00723_ERROR_SHORTAGE_TITLE, instance.SHOP_00723_ERROR_SHORTAGE_MESSAGE, (System.Action) (() => berrorwait = false));
    while (berrorwait)
      yield return (object) null;
    MypageScene.ChangeSceneOnError();
  }
