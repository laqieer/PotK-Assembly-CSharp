...
public class PopupRecommendMenu : BackButtonPopupBase
{
  ...
  public static Future<GameObject> loadResource() => new ResourceObject("Prefabs/unit/Popup_Recommend_Info").Load<GameObject>();

  public static void open(
    GameObject prefab,
    PlayerUnit playerUnit,
    System.Action actChangedScene = null,
    System.Action<System.Action> actChangedQuest = null,
  ...
  public static void openReturnScene(
    GameObject prefab,
    PlayerUnit playerUnit,
    System.Action actChangedScene,
    System.Action<System.Action> actChangedQuest,
  ...
  public System.Action onChangedScene { get; private set; }

  public System.Action<System.Action> onChangedQuest { get; private set; }
  ...
  private PopupRecommendPart[] recommendParts => new PopupRecommendPart[7]
  {
  ...
  private IEnumerator Start()
  {
    ...
    if (!popupRecommendMenu.isAutoBootQuestList)
      Singleton<PopupManager>.GetInstance().startOpenAnime(popupRecommendMenu.gameObject);
  ...
  private void repositionScrollItems()
  {
    if (this.GetCallChara() == null)
      this.callSkill_.gameObject.SetActive(false);
    GameObject[] array1 = ((IEnumerable<PopupRecommendPart>) this.recommendParts).Select<PopupRecommendPart, GameObject>((Func<PopupRecommendPart, GameObject>) (x => x.gameObject)).ToArray<GameObject>();
  ...
  private CallCharacter GetCallChara()
  {
    ...
    CallCharacter callCharacter1 = (CallCharacter) null;
    foreach (CallCharacter callCharacter2 in callCharacterList)
    {
      if (callCharacter2.same_character_id == this.playerUnit_.unit.same_character_id)
      {
        callCharacter1 = callCharacter2;
        break;
      }
    }
    return callCharacter1;
  }
