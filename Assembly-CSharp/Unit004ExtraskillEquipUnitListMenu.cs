...
public class Unit004ExtraskillEquipUnitListMenu : UnitMenuBase
{
  ...
  public void createAllUnitInfoExtendFunc() => this.allUnitInfos.ForEach((System.Action<UnitIconInfo>) (x =>
  {
    x.equip = false;
  ...
  public IEnumerator Init(PlayerUnit unit, PlayerAwakeSkill skill)
  {
    ...
    if ((UnityEngine.Object) equipUnitListMenu.skillEquipedByOthersPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) equipUnitListMenu.extraSkillEquipUnitConfirm1DlgPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) equipUnitListMenu.extraSkillEquipUnitConfirm2DlgPrefab == (UnityEngine.Object) null)
    {
    ...
    if (equipUnitListMenu.targetSkill.EqupmentUnit != (PlayerUnit) null)
      equipUnitListMenu.InitializeInfo((IEnumerable<PlayerUnit>) playerUnitArray, (IEnumerable<PlayerMaterialUnit>) null, Persist.unit004ExtraSkillEquipUnitListSortAndFilter, true, equipUnitListMenu.nowEquiptUnit != (PlayerUnit) null, false, true, false, new System.Action(equipUnitListMenu.createAllUnitInfoExtendFunc));
    else
      equipUnitListMenu.InitializeInfo((IEnumerable<PlayerUnit>) playerUnitArray, (IEnumerable<PlayerMaterialUnit>) null, Persist.unit004ExtraSkillEquipUnitListSortAndFilter, true, equipUnitListMenu.nowEquiptUnit != (PlayerUnit) null, false, true, false, new System.Action(equipUnitListMenu.createAllUnitInfoExtendFunc));
  ...
  private PlayerUnit[] SetEquipUnits(PlayerUnit[] units, PlayerAwakeSkill skill) => ((IEnumerable<PlayerUnit>) units).Where<PlayerUnit>((Func<PlayerUnit, bool>) (x => x.can_equip_awake_skill && x.unit.CanEquipAwakeSkill(skill))).ToArray<PlayerUnit>();
  ...
  private IEnumerator ShowEquipedByOthersDig(PlayerUnit equipUnit)
  {
    ...
    IEnumerator e = prefab.GetComponent<Popup004ExtraSkillEquipedByOthers>().Init(equipUnitListMenu.targetSkill, equipUnitListMenu.nowEquiptUnit, equipUnit, new System.Action<PlayerAwakeSkill, PlayerUnit, PlayerUnit>(equipUnitListMenu.SwapEquipExtraSkill));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator ShowEquipUnitConfirm1Dlg(PlayerUnit unit)
  {
    ...
    prefab.SetActive(false);
    IEnumerator e = prefab.GetComponent<Popup004ExtraSkillEquipConfirm1Menu>().Init(equipUnitListMenu.targetSkill, unit, new System.Action<PlayerAwakeSkill, PlayerUnit>(equipUnitListMenu.EquipExtraSkill));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    Singleton<PopupManager>.GetInstance().open(prefab, isCloned: true);
  ...
  private IEnumerator ShowEquipUnitConfirm2Dlg(
    PlayerAwakeSkill awakeSKill,
    PlayerUnit targetUnit)
  {
    ...
    else
    {
      ...
      prefab.SetActive(false);
      IEnumerator e = prefab.GetComponent<Popup004ExtraSkillEquipConfirm2Menu>().Init(targetUnit.equippedExtraSkill, awakeSKill, targetUnit, new System.Action<PlayerAwakeSkill, PlayerAwakeSkill, PlayerUnit>(equipUnitListMenu.ChangeExtraSkill));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      Singleton<PopupManager>.GetInstance().open(prefab, isCloned: true);
  ...
  private void SetUnitIconAction(int info_index, int unit_index)
  {
    ...
    {
      unitIcon.onClick = (System.Action<UnitIconBase>) (iconBase => this.RemoveExtraSkill(this.nowEquiptUnit));
    }
    else
    {
  ...
  private void RemoveExtraSkill(PlayerUnit unit) => this.StartCoroutine(new ExtraskillUtil().RemoveExtraSkillAsync(unit, new System.Action(((UnitMenuBase) this).IbtnBack)));

  private void EquipExtraSkill(PlayerAwakeSkill skill, PlayerUnit unit) => this.StartCoroutine(new ExtraskillUtil().EquipExtraSkillAsync(skill, unit, new System.Action(((UnitMenuBase) this).IbtnBack)));
  ...
  private void ChangeExtraSkill(
    ...
    PlayerUnit unit)
  {
    this.StartCoroutine(new ExtraskillUtil().ChangeEquipExtraSkillAsync(beforeSkill, afterSkill, unit, new System.Action(((UnitMenuBase) this).IbtnBack)));
  }
