...
public class Unit0044Scene : NGSceneBase
{
  ...
  public static void changeScene(bool bStack, EditGearParam param) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_4", (bStack ? 1 : 0) != 0, (object) param);

  public static void ChangeScene(bool stack, PlayerUnit basePlayerUnit, int changeGearIndex) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_4", (stack ? 1 : 0) != 0, (object) basePlayerUnit, (object) changeGearIndex);
  ...
  public void onStartScene(EditGearParam param) => this.onStartScene(param.baseUnit, param.slotNo + 1);
  ...
  public void onStartScene(PlayerUnit basePlayerUnit, GearGear specialGgear) => this.onStartScene(basePlayerUnit, 1);
