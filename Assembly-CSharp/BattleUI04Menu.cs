...
public class BattleUI04Menu : BattleBackButtonMenuBase
{
  ...
  public IEnumerator Init(BL.UnitPosition attack, BL.UnitPosition defense)
  {
    ...
    baseMenu.attackButton.isEnabled = (uint) baseMenu.attackStatus.Length > 0U;
    baseMenu.GetComponent<UIPanel>().SetDirty();
  }
...
label_5:
  ...
  {
    if (!((UnityEngine.Object) this.indicator != (UnityEngine.Object) null))
      return;
