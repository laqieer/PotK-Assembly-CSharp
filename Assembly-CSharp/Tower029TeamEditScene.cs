...
public class Tower029TeamEditScene : NGSceneBase
{
  ...
  public static void ChangeScene(TowerProgress progress) => Singleton<NGSceneManager>.GetInstance().changeScene("tower029_team_edit", true, (object) progress);
  ...
  public void onStartScene(TowerProgress progress) => Singleton<CommonRoot>.GetInstance().isLoading = false;
