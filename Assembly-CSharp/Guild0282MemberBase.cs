...
public class Guild0282MemberBase : MonoBehaviour
{
  ...
  private IEnumerator DamageAnimation(int lastStar)
  {
    ...
    while (!this.DamageAnimator.GetCurrentAnimatorStateInfo(0).IsName("end"));
    this.endAnimation = true;
  }

  private void SetStar(int nowStar, int maxStar)
  {
    if ((UnityEngine.Object) this.topSimpleBottom_ != (UnityEngine.Object) null && this.topSimpleBottom_.activeSelf)
    {
  ...
  {
    if ((UnityEngine.Object) this.animStarCount_ == (UnityEngine.Object) null)
      return;
    this.nowStar_ = nowStar;
    this.toStar_ = breakStar;
    this.endCountDown_ = false;
    this.numSprites_ = this.starNumerator_.gameObject.GetComponentsInChildren<UISprite>(true);
    this.clipStarCount_.setEventSetNumberColor(new System.Action<string>(this.onSetNumberColor));
    this.clipStarCount_.setEventCountDownStar(new System.Action(this.onCountDownStar));
  ...
  private void onCountDownStar()
  {
    ...
    if ((UnityEngine.Object) this.animStarBreak_ != (UnityEngine.Object) null)
  ...
  private Color parseColor(string sColor)
  {
    ...
    if (!this.dicColor_.TryGetValue(sColor, out color))
    {
      if (!ColorUtility.TryParseHtmlString(sColor, out color))
        ColorUtility.TryParseHtmlString("#" + sColor, out color);
      this.dicColor_.Add(sColor, color);
    }
    return color;
  }
    ...
    GvgStatus gvgStatus)
  {
    ...
    if ((UnityEngine.Object) this.topSimpleBottom_ != (UnityEngine.Object) null)
  ...
  public void ControlSituationIcon()
  {
    if (this.isEnemy)
    {
      if ((UnityEngine.Object) this.slc_icon_caution != (UnityEngine.Object) null)
      {
      ...
      if ((UnityEngine.Object) this.slc_icon_have_battled != (UnityEngine.Object) null)
        this.slc_icon_have_battled.SetActive(this.menu.IsOpposedPlayer(this.member.player.player_id));
      if (!((UnityEngine.Object) this.slc_icon_status_open != (UnityEngine.Object) null))
        return;
  ...
  public void InitializePlayerSituation(GuildMembership memberData, GuildImageCache imageCache)
  {
    ...
    if (!this.isInitializePlayrtSituation)
    {
      ...
      this.GetUIWidgetChildren(this.transform, list);
      list.ForEach((System.Action<UIWidget>) (x => x.depth += 200));
    }
    this.ControlSituationIcon();
  }
  ...
  {
    if ((UnityEngine.Object) this.dir_guild_battle_anim == (UnityEngine.Object) null)
      return;
  ...
  {
    if (!((UnityEngine.Object) this.whiteFlag != (UnityEngine.Object) null))
      return;
  ...
  private List<GameObject> ClearAnimation(List<GameObject> objList)
  {
    ...
    if (objList.Count > 0)
    {
      objList.ForEach((System.Action<GameObject>) (x => UnityEngine.Object.Destroy((UnityEngine.Object) x)));
      objList.Clear();
    }
    return objList;
  }
