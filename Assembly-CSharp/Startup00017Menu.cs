...
public class Startup00017Menu : NGMenuBase
{
  ...
  public void MigrateAPI()
  {
    ...
    {
      WebAPI.AuthAddDevice(this.inputID.value, this.inputPassword.value, (System.Action) (() =>
      {
        ...
        this.EndTutorial();
      }), (System.Action<AddDeviceWithEmailAddressAndPasswordResult>) (error => this.ErrorPopup(error)));
    }
    else
    {
      Singleton<NGSoundManager>.GetInstance().playSE("SE_1006");
