...
public class BattleUI55Continue : ResultMenuBase
{
  ...
  public override IEnumerator Run()
  {
    ...
    {
      Singleton<PopupManager>.GetInstance().open(battleUi55Continue.popup1).GetComponent<Popup0701Menu>().Init((System.Action<bool>) (reset =>
      {
        isFinish = true;
        this.isReset = reset;
    ...
    if (!battleUi55Continue.isReset)
    {
      ...
      battleUi55Continue.GetComponent<BattleUI55Scene>().IbtnTouchToNext();
    }
  }
}
