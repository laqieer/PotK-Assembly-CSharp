...
public class QuestStageMenuBase : BackButtonMenuBase
{
  ...
  {
    if (this.ScrollView.isDragging || this.ButtonMove || (UnityEngine.Object) targetButton != (UnityEngine.Object) this.nowCenterObj)
    {
  ...
  {
    if (this.isFirstTime || (UnityEngine.Object) this.nowCenterObj == (UnityEngine.Object) this.grid.transform.GetComponent<UICenterOnChild>().centeredObject || !((UnityEngine.Object) targetButton == (UnityEngine.Object) this.grid.transform.GetComponent<UICenterOnChild>().centeredObject))
      return;
  ...
  public static List<QuestConverterData> Convert(
    PlayerExtraQuestS[] e,
    bool? isOpen)
  {
    List<QuestConverterData> questConverterDataList = new List<QuestConverterData>();
  ...
  public IEnumerator InitSeaQuest(
    PlayerSeaQuestS[] StoryDataS,
    int L,
    int M,
    int S,
    bool forcus)
    ...
    bool forcus)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) questStageMenuBase.EntryInfo == (UnityEngine.Object) null && (UnityEngine.Object) questStageMenuBase.Container != (UnityEngine.Object) null)
    {
    ...
    questStageMenuBase.btnBack.enabled = true;
    // ISSUE: reference to a compiler-generated method
    questStageMenuBase.grid.GetComponent<UICenterOnChild>().onFinished = new SpringPanel.OnFinished(questStageMenuBase.\u003CInit\u003Eb__52_0);
  }
    ...
    bool forcus)
  {
    ...
    if ((UnityEngine.Object) this.MissionAchievement != (UnityEngine.Object) null)
    ...
    if (!((UnityEngine.Object) this.ButtonMission != (UnityEngine.Object) null))
      return;
    this.ButtonMission.GetComponent<UIButton>().isEnabled = true;
  }

  public IEnumerator UnitCreate()
  {
    foreach (Component component in this.Character.transform)
    ...
    else
    {
      ...
      PlayerUnit playerUnit2 = ((IEnumerable<PlayerUnit>) playerDeckArray[Persist.deckOrganized.Data.number].player_units).FirstOrDefault<PlayerUnit>();
      if ((object) playerUnit2 == null)
        playerUnit2 = ((IEnumerable<PlayerUnit>) playerDeckArray[0].player_units).First<PlayerUnit>();
      playerUnit1 = playerUnit2;
    }
    IEnumerator e = playerUnit1.unit.LoadQuestWithMask(playerUnit1.job_id, this.Character.transform, this.Character.GetComponent<UIWidget>().depth, Res.GUI._002_2_sozai.mask_chara.Load<Texture2D>());
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  public IEnumerator subBackGroundCrate(QuestConverterData quest)
  {
    ...
    Future<UnityEngine.Sprite> bgSprite = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(path);
  ...
  public IEnumerator MissionWindowCreate(bool eventquest)
  {
    ...
    if ((bool) (UnityEngine.Object) component.description.btnClose)
  ...
  public IEnumerator InitHscroll()
  {
    ...
    {
      e = questStageMenuBase.initHscrollObj(questStageMenuBase.hscrollButtons[i], questStageMenuBase.StageDataS[i], questStageMenuBase.grid.cellWidth, questStageMenuBase.initCenter, new System.Action(questStageMenuBase.tweenSettingDefault), eventquest);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
    ...
    {
      if ((UnityEngine.Object) hscrollButton != (UnityEngine.Object) questStageMenuBase.hscrollButtons[questStageMenuBase.initCenter])
        hscrollButton.GetComponent<Quest0022Hscroll>().NotTouch(true);
    }
    questStageMenuBase.hscrollButtons.ForEach((System.Action<GameObject>) (x => x.GetComponent<Quest0022Hscroll>().onSetValue()));
  ...
  {
    Quest0022Hscroll component = targetButton.GetComponent<Quest0022Hscroll>();
    this.hscrollButtons.ForEach((System.Action<GameObject>) (x => x.GetComponent<Quest0022Hscroll>().NotTouch(true)));
    component.NotTouch(false);
    if ((UnityEngine.Object) targetButton != (UnityEngine.Object) this.nowCenterObj)
    {
      ...
      if ((UnityEngine.Object) this.missionWindow != (UnityEngine.Object) null)
      ...
      foreach (QuestConverterData questConverterData in this.StageDataS)
      {
        ...
        if (campaignProgressArray != null && campaignProgressArray.Length != 0)
          qscp = ((IEnumerable<QuestScoreCampaignProgress>) campaignProgressArray).FirstOrDefault<QuestScoreCampaignProgress>((Func<QuestScoreCampaignProgress, bool>) (x => x.quest_extra_l == stageDataS.id_L));
  ...
  private IEnumerator ibtnMission()
  {
    ...
    if ((UnityEngine.Object) component.description != (UnityEngine.Object) null && (UnityEngine.Object) component.description.btnClose != (UnityEngine.Object) null)
      menu.ButtonMission.GetComponent<UIButton>().isEnabled = !menu.MissionActiveFlag;
  }
  ...
  public void CenterAnimation()
  {
    ...
    this.hscrollButtons.ForEach((System.Action<GameObject>) (x =>
    {
      if (!((UnityEngine.Object) x != (UnityEngine.Object) target))
        return;
  ...
  {
    this.startAllpostween.ForEach((System.Action<TweenPosition>) (x => x.tweenGroup = Math.Abs(x.tweenGroup)));
    this.startAllalphatween.ForEach((System.Action<TweenAlpha>) (x => x.tweenGroup = Math.Abs(x.tweenGroup)));
  }

  public void tweenSettingNoAnim()
  {
    this.startAllpostween.ForEach((System.Action<TweenPosition>) (x =>
    {
      if (x.tweenGroup != 11 && x.tweenGroup != 12)
        return;
      x.tweenGroup = -Math.Abs(x.tweenGroup);
      x.gameObject.transform.localPosition = x.to;
    }));
    this.startAllalphatween.ForEach((System.Action<TweenAlpha>) (x =>
    {
      if (x.tweenGroup != 11 && x.tweenGroup != 12)
        return;
      x.tweenGroup = -Math.Abs(x.tweenGroup);
      x.GetComponent<UIWidget>().alpha = x.to;
    }));
  }
  ...
  {
    this.grid.GetComponent<UICenterOnChild>().onFinished = (SpringPanel.OnFinished) null;
    if (!((UnityEngine.Object) this.missionWindow != (UnityEngine.Object) null))
      return;
    this.MissionActiveFlag = false;
    this.activeIbtnMission = false;
    UnityEngine.Object.Destroy((UnityEngine.Object) this.missionWindow);
  }
