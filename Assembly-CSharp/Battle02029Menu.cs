...
public class Battle02029Menu : NGMenuBase
{
    ...
    bool sea_effect = false)
  {
    ...
    this.elementIconParentBefore.gameObject.SetActive(false);
    this.skillIconBase.SetActive(false);
    this.elementIconParent.gameObject.SetActive(false);
    ...
    UIWidget _elementIconParent)
  {
    ...
    {
      Future<UnityEngine.Sprite> skillIconSprite = skill.LoadBattleSkillIcon();
      ...
      skillIconSprite = (Future<UnityEngine.Sprite>) null;
    }
    else
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      GameObject gameObject = elementLoader.Result.Clone(_elementIconParent.transform);
      UI2DSprite component1 = gameObject.GetComponent<UI2DSprite>();
      component1.depth = _elementIconParent.depth + 1;
      CommonElementIcon component2 = gameObject.GetComponent<CommonElementIcon>();
      component2.Init(skill.element);
      component1.width = component2.iconSprite.sprite2D.texture.width;
      component1.height = component2.iconSprite.sprite2D.texture.height;
      _elementIconParent.gameObject.SetActive(true);
  ...
  private IEnumerator Play(bool sea_effect = false)
  {
    ...
    battle02029Menu.tweens = battle02029Menu.transform.GetComponentsInChildren<UITweener>();
    battle02029Menu.gameObject.SetActive(true);
    ...
    for (int index = 0; index < uiTweenerArray.Length; ++index)
    {
      ...
      while (!battle02029Menu.isSkip && tween.enabled)
        yield return (object) null;
