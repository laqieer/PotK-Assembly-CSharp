...
public class Gacha00613Menu : BackButtonMenuBase
{
  ...
  public IEnumerator CreateGetListAsync(GachaResultData.ResultData resultData)
  {
    ...
    if (resultData.resultList.Length > 10)
    {
      ...
      if (resultData.additionalItems.Length != 0)
        gacha00613Menu.resultItemScrollView.GetComponentInParent<UIWidget>().bottomAnchor.target = gacha00613Menu.dir_bonus.transform.Find("dir_Title").gameObject.transform;
      else
        gacha00613Menu.resultItemScrollView.GetComponentInParent<UIWidget>().bottomAnchor.target = gacha00613Menu.dir_next.transform.Find("slc_ClickForDetail").gameObject.transform;
    }
    else
    {
    ...
    gacha00613Menu.resultItemScrollView.GetComponentInParent<UIWidget>().ResetAnchors();
    gacha00613Menu.resultItemScrollView.GetComponentInParent<UIWidget>().UpdateAnchors();
  ...
  private IEnumerator SetBonus()
  {
    ...
    for (int index = 0; index < additionalItemArray.Length; ++index)
    {
      ...
      go.transform.parent = gacha00613Menu.gridForBonus.transform;
    ...
    gacha00613Menu.gridForBonus.onReposition = new UIGrid.OnReposition(gacha00613Menu.\u003CSetBonus\u003Eb__48_0);
  ...
  private IEnumerator doShowRetryPopup()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = script.Initialize(menu, new System.Action(menu.\u003CdoShowRetryPopup\u003Eb__54_0), new System.Action(menu.\u003CdoShowRetryPopup\u003Eb__54_1), new System.Action(menu.\u003CdoShowRetryPopup\u003Eb__54_2), menu.remainingRetryCount, menu.expiredAt);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
