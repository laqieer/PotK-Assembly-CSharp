...
public class GuildGuestListBase : BackButtonMenuBase
{
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.allGuestInfo.FirstIndexOrNull<GuestBarInfo>((Func<GuestBarInfo, bool>) (v => (UnityEngine.Object) v.scrollParts != (UnityEngine.Object) null && (UnityEngine.Object) v.scrollParts.gameObject == (UnityEngine.Object) unit));
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allGuestInfo.Count); ++index)
      this.allGuestBar.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<GuildGuestSelectScroll>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(this.MaxValue, this.allGuestBar.Count); ++index)
      this.scroll.AddColumn1(this.allGuestBar[index].gameObject, this.barWidth, this.barHeight);
  ...
  protected void ResetScroll(int index)
  {
    ...
    this.allGuestInfo.Where<GuestBarInfo>((Func<GuestBarInfo, bool>) (a => (UnityEngine.Object) a.scrollParts == (UnityEngine.Object) scrollParts)).ForEach<GuestBarInfo>((System.Action<GuestBarInfo>) (b => b.scrollParts = (GuildGuestSelectScroll) null));
  }
