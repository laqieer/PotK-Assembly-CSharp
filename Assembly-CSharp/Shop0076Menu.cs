...
public class Shop0076Menu : BackButtonMenuBase
{
    ...
    int? quantityLimit)
  {
    ...
    float duration1 = this.btnMinus.duration;
    this.btnMinus.duration = 0.0f;
    this.btnMinus.isEnabled = false;
    this.btnMinus.duration = duration1;
    float duration2 = this.btnPlus.duration;
    this.btnPlus.duration = 0.0f;
    this.btnPlus.isEnabled = false;
    this.btnPlus.duration = duration2;
    float duration3 = this.btnYes.duration;
    this.btnYes.duration = 0.0f;
    this.btnYes.isEnabled = false;
    this.btnYes.duration = duration3;
  ...
  public void SetTxtDescription05(ShopArticle sa)
  {
    ...
    else if (sa.pay_type == CommonPayType.tower_medal)
    {
      ...
      this.TxtDescription05.SetTextLocalize(this.holding >= (long) (this.quantity * this.price) ? Consts.Format(Consts.GetInstance().SHOP_007X_TXT_DESCRIPTION05_xMEDALxUNIT, (IDictionary) hashtable) : Consts.Format(Consts.GetInstance().SHOP_0076_TXT_DESCRIPTION05_xMEDALxUNIT_OVER, (IDictionary) hashtable));
    }
    else if (sa.pay_type == CommonPayType.guild_medal)
    {
      string text;
  ...
  public void SetTxtDescription06(ShopArticle sa)
  {
    ...
    else if (sa.pay_type == CommonPayType.tower_medal)
    {
      ...
      this.TxtDescription06.SetTextLocalize(Consts.Format(Consts.GetInstance().SHOP_0076_TXT_DESCRIPTION06_xMEDALxUNIT, (IDictionary) hashtable));
    }
    else if (sa.pay_type == CommonPayType.guild_medal)
      this.TxtDescription06.SetTextLocalize(Consts.Format(Consts.GetInstance().SHOP_0076_TXT_DESCRIPTION06_MEDAL, (IDictionary) new Hashtable()
      {
