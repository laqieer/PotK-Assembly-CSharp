...
{
  private IEnumerator WebAPIAwakeSkillEquip(
    int idx,
    PlayerAwakeSkill skill,
    PlayerUnit unit)
  {
    Future<WebAPI.Response.AwakeSkillEquip> equip = WebAPI.AwakeSkillEquip(idx, skill == null ? new int?() : new int?(skill.id), unit.id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  public IEnumerator RemoveExtraSkillAsync(PlayerUnit unit, System.Action endAct)
  {
  ...
  public IEnumerator EquipExtraSkillAsync(
    PlayerAwakeSkill skill,
    PlayerUnit unit,
    System.Action endAct)
  {
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    ...
    System.Action endAct)
  {
    Singleton<CommonRoot>.GetInstance().loadingMode = 1;
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    PlayerUnit unit1 = beforeSkill != null ? beforeSkill.EqupmentUnit : (PlayerUnit) null;
    PlayerUnit afterSkillUnit = afterSkill != null ? afterSkill.EqupmentUnit : (PlayerUnit) null;
    IEnumerator e;
    if (unit1 != (PlayerUnit) null)
    {
      e = this.WebAPIAwakeSkillEquip(1, (PlayerAwakeSkill) null, unit1);
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
