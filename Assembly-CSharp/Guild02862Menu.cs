...
public class Guild02862Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    Future<WebAPI.Response.GuildGiftGetWishListMaster> ft = WebAPI.GuildGiftGetWishListMaster(true, new System.Action<WebAPI.Response.UserError>(guild02862Menu.\u003CInitializeAsync\u003Eb__9_0));
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.giftIcon == (UnityEngine.Object) null)
    {
  ...
  private void CreateItemIcon(int info_index, int item_index) => this.StartCoroutine(this.loadThumb(this.allGiftItemInfo[info_index], this.showGiftList[item_index]));
  ...
  private IEnumerator loadThumb(Guild02862Menu.GiftIconInfo itemIcon, GameObject parent)
  {
    ...
    switch (rewardTypeID)
    {
      case 1:
      case 24:
        component1.GetComponent<BoxCollider>().enabled = false;
        ...
        if (!((UnityEngine.Object) component2 == (UnityEngine.Object) null))
        {
          ...
          component2.buttonBoxCollider.enabled = false;
          break;
        }
        break;
      case 2:
  ...
  public IEnumerator InitGiftList()
  {
    ...
    {
      if (!((UnityEngine.Object) this.showGiftList[index] == (UnityEngine.Object) null))
    ...
    for (int i = 0; i < Mathf.Min(ItemIcon.MaxValue, this.allGiftItemInfo.Count); ++i)
    {
      ...
      this.showGiftList[i].GetComponent<UIWidget>().alpha = 1f;
    }
    for (int index = 0; index < Mathf.Min(ItemIcon.MaxValue, this.allGiftItemInfo.Count); ++index)
  ...
  private IEnumerator SetItem(Guild02862Menu.GiftIconInfo iconInfo)
  {
    ...
    Singleton<CommonRoot>.GetInstance().isLoading = true;
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.GuildGiftUpdateWishList> ft = WebAPI.GuildGiftUpdateWishList(iconInfo.gift.id, false, new System.Action<WebAPI.Response.UserError>(guild02862Menu.\u003CSetItem\u003Eb__17_0));
    IEnumerator e = ft.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        int? nullable = this.allGiftItemInfo.FirstIndexOrNull<Guild02862Menu.GiftIconInfo>((Func<Guild02862Menu.GiftIconInfo, bool>) (v => (UnityEngine.Object) v.iconObj != (UnityEngine.Object) null && (UnityEngine.Object) v.iconObj.gameObject == (UnityEngine.Object) item));
  ...
  protected void ResetScroll(int index)
  {
    ...
    for (int index1 = 0; index1 < item.transform.childCount; ++index1)
      UnityEngine.Object.Destroy((UnityEngine.Object) item.transform.GetChild(index1).gameObject);
    item.SetActive(false);
    this.allGiftItemInfo.Where<Guild02862Menu.GiftIconInfo>((Func<Guild02862Menu.GiftIconInfo, bool>) (a => (UnityEngine.Object) a.iconObj == (UnityEngine.Object) item.GetComponent<CreateIconObject>())).ForEach<Guild02862Menu.GiftIconInfo>((System.Action<Guild02862Menu.GiftIconInfo>) (b => b.iconObj = (CreateIconObject) null));
  }
