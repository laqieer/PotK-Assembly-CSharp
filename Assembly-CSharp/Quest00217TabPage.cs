...
public class Quest00217TabPage : MonoBehaviour
{
  ...
  public void AddRequest(EventInfo param, GameObject prefab) => this.RequestList.Add(new Quest00217TabPage.RequestParam()
  {
    Param = (object) param,
    Prefab = prefab
  });

  public void AddRequest(SM.TowerPeriod param, GameObject prefab) => this.RequestList.Add(new Quest00217TabPage.RequestParam()
  {
    Param = (object) param,
    Prefab = prefab
  });

  public void AddRequest(CorpsPeriod param, GameObject prefab) => this.RequestList.Add(new Quest00217TabPage.RequestParam()
  {
    Param = (object) param,
    Prefab = prefab
  });

  public void AddRequest(GameObject prefab) => this.RequestList.Add(new Quest00217TabPage.RequestParam()
  {
    Prefab = prefab
  });
  ...
  private List<T> getItems<T>() where T : MonoBehaviour => this.cells_.Select<Quest00217TabPage.Cell, T>((Func<Quest00217TabPage.Cell, T>) (i => i.item.GetComponent<T>())).Where<T>((Func<T, bool>) (c => (bool) (UnityEngine.Object) c)).ToList<T>();
