...
public class Quest00240723Scene : NGSceneBase
{
  ...
  public static void ChangeScene0024(bool stack, int L, bool passOriginID, bool mustCreateBG) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_4", (stack ? 1 : 0) != 0, (object) L, (object) passOriginID, (object) mustCreateBG);

  public static void ChangeScene0024(bool stack, int L, bool mustCreateBG) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_4", (stack ? 1 : 0) != 0, (object) L, (object) mustCreateBG);
  ...
  public IEnumerator onStartSceneAsync(int L, bool passOriginID, bool mustCreateBG)
  {
    ...
    if ((UnityEngine.Object) backgroundComponent != (UnityEngine.Object) null)
