...
public class Raid032GuildRankingMenu : BackButtonMenuBase
{
  ...
  public IEnumerator Initalize(GuildRaid mMasterData)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) guildRankingMenu.prefabRankingRow_ == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) guildRankingMenu.prefabUnitIcon_ == (UnityEngine.Object) null)
    {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    if ((UnityEngine.Object) guildRankingMenu.myRanking == (UnityEngine.Object) null)
    {
      GameObject gameObject = guildRankingMenu.prefabRankingRow_.Clone(guildRankingMenu.bottom.transform);
      guildRankingMenu.myRanking = gameObject.GetComponent<Raid032GuildRankingPlayer>();
      guildRankingMenu.myRanking.gameObject.transform.localPosition = (Vector3) new Vector2(0.0f, -288f);
    }
    guildRankingMenu.myRanking.showGuildPopUp = (System.Action<GuildDirectory>) (x => this.StartCoroutine(this.ShowGuildPopUp(x)));
  ...
  private WebAPI.Response.GuildraidRankingGuildDamage_rankings GetMyRankingData()
  {
    ...
    WebAPI.Response.GuildraidRankingGuildDamage_rankings guildDamageRankings = new WebAPI.Response.GuildraidRankingGuildDamage_rankings();
    if (currentGuildLeaderInfo != null)
    {
      guildDamageRankings.leader_unit_id = currentGuildLeaderInfo._leader_unit_unit;
      guildDamageRankings.leader_unit_level = currentGuildLeaderInfo.leader_unit_level;
      guildDamageRankings.leader_unit_job_id = currentGuildLeaderInfo.leader_unit_job_id;
    }
    else
      Debug.LogError((object) "leaderInfo is null");
    guildDamageRankings.guild_name = PlayerAffiliation.Current.guild.guild_name;
    guildDamageRankings.guild_id = PlayerAffiliation.Current.guild.guild_id;
    guildDamageRankings.current_emblem_id = PlayerAffiliation.Current.guild.appearance._current_emblem;
    guildDamageRankings.membership_num = PlayerAffiliation.Current.guild.appearance.membership_num;
    guildDamageRankings.membership_capacity = PlayerAffiliation.Current.guild.appearance.membership_capacity;
    guildDamageRankings.score = this.rankingDic[this.periodId[this.currentIndex]].player_guild_score.damage_score;
    guildDamageRankings.rank = this.rankingDic[this.periodId[this.currentIndex]].player_guild_score.damage_rank.HasValue ? this.rankingDic[this.periodId[this.currentIndex]].player_guild_score.damage_rank.Value : 0;
    return guildDamageRankings;
  }
  ...
  private IEnumerator SetRankInfo(bool isImmediate = false)
  {
    ...
    {
      guildRankingMenu.prefabList[index].gameObject.SetActive(false);
      UnityEngine.Object.Destroy((UnityEngine.Object) guildRankingMenu.prefabList[index].gameObject);
    }
    ...
    {
      guildRankingMenu.nextPageBtn.gameObject.SetActive(false);
      guildRankingMenu.previousPageBtn.gameObject.SetActive(false);
    ...
    else
    {
      ...
      if (guildRankingMenu.ranking.damage_rankings.Length > 2)
      {
        ...
        guildRankingMenu.wrap.enabled = true;
        ...
        guildRankingMenu.wrap.onInitializeItem = (UIGridCycle.OnInitializeItem) ((obj, idx, realIdx) =>
        {
          ...
          {
            rankingPlayerCatch.showGuildPopUp = (System.Action<GuildDirectory>) (x => this.StartCoroutine(this.ShowGuildPopUp(x)));
        ...
        guildRankingMenu.scroll = guildRankingMenu.body.transform.parent.GetComponent<UIScrollView>();
        if ((UnityEngine.Object) guildRankingMenu.scroll != (UnityEngine.Object) null)
        {
          ...
          guildRankingMenu.bottomEmptyObj.localPosition = (Vector3) new Vector2(0.0f, (float) (-(double) guildRankingMenu.scrollLength + 90.0));
          guildRankingMenu.topEmptyObj.localPosition = new Vector3(0.0f, 73f, 0.0f);
          guildRankingMenu.scroll.ResetPosition();
          guildRankingMenu.wrap.transform.localPosition = (Vector3) Vector2.zero;
        }
      }
      else
      {
        guildRankingMenu.wrap = guildRankingMenu.body.GetComponent<UIGridCycle>();
        guildRankingMenu.wrap.enabled = false;
        for (int index = 0; index < guildRankingMenu.prefabList.Count; ++index)
        {
          guildRankingMenu.prefabList[index].gameObject.transform.localPosition = (Vector3) new Vector2(0.0f, (float) -(index * 90 * 2));
          guildRankingMenu.prefabList[index].showGuildPopUp = (System.Action<GuildDirectory>) (x => this.StartCoroutine(this.ShowGuildPopUp(x)));
        ...
        if ((UnityEngine.Object) guildRankingMenu.scroll != (UnityEngine.Object) null)
        {
          ...
          guildRankingMenu.bottomEmptyObj.localPosition = (Vector3) new Vector2(0.0f, (float) (-(double) guildRankingMenu.scrollLength + 90.0));
          guildRankingMenu.topEmptyObj.localPosition = new Vector3(0.0f, 73f, 0.0f);
          guildRankingMenu.wrap.transform.localPosition = (Vector3) new Vector2(0.0f, 20f);
        }
        guildRankingMenu.scroll.ResetPosition();
      }
      ...
      guildRankingMenu.previousPageBtn.gameObject.SetActive(guildRankingMenu.currentIndex > 0);
      guildRankingMenu.nextPageBtn.gameObject.SetActive(guildRankingMenu.currentIndex < guildRankingMenu.periodId.Length - 1);
      if (guildRankingMenu.currentIndex < guildRankingMenu.periodId.Length - 1)
        guildRankingMenu.nextPageBtn.isEnabled = guildRankingMenu.serverTime >= MasterData.GuildRaidPeriod[guildRankingMenu.periodId[guildRankingMenu.currentIndex + 1]].start_at.Value;
      if (guildRankingMenu.isInitialized_)
      {
