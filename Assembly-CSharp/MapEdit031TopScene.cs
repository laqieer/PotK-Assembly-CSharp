...
public class MapEdit031TopScene : NGSceneBase
{
  ...
  public static void changeScene(bool isStack, int slotId, bool isEdit) => Singleton<NGSceneManager>.GetInstance().changeScene(MapEdit031TopScene.defaultName, (isStack ? 1 : 0) != 0, (object) slotId, (object) isEdit);

  public IEnumerator onStartSceneAsync(int slotId, bool isEdit)
  {
    MapEdit031TopScene mapEdit031TopScene = this;
    mapEdit031TopScene.menuBases = mapEdit031TopScene.GetComponents<NGMenuBase>();
  ...
  public void onStartScene(int slotId, bool isEdit) => Singleton<CommonRoot>.GetInstance().isLoading = false;
