...
public class Bugu005ReisouCreationMenu : BackButtonMenuBase
{
  ...
  {
    if ((UnityEngine.Object) this.reisouRecipePrefab == (UnityEngine.Object) null)
    {
    ...
    spriteF = new ResourceObject("Icons/BattleMedal_Icon").Load<UnityEngine.Sprite>();
    yield return (object) spriteF.Wait();
  ...
  protected IEnumerator createRecipeBar(GearReisouChaosCreation recipe)
  {
    ...
    go.SetActive(false);
    IEnumerator e = component.Init(recipe, new System.Action(reisouCreationMenu.updateInventoryText));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
