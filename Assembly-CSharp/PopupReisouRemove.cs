...
public class PopupReisouRemove : BackButtonPopupBase
{
  ...
  public IEnumerator Init(PlayerItem item, System.Action removeCallback = null)
  {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    itemIcon.EnableLongPressEvent(new System.Action<GameCore.ItemInfo>(popupReisouRemove.onLongPressItemIcon));
  }
  ...
  private IEnumerator callEquipReisouAPI()
  {
    ...
    int num = 0;
    IEnumerator e = WebAPI.ItemGearReisouEquip(popupReisouRemove.item.id, new int?(num), (System.Action<WebAPI.Response.UserError>) (error =>
    {
      if (error == null)
        return;
    ...
    switch (GuildUtil.gvgPopupState)
    {
      case GuildUtil.GvGPopupState.AtkTeam:
        ...
        e = GuildUtil.UpdateGuildDeckAttack(PlayerAffiliation.Current.guild_id, Player.Current.id, new System.Action(popupReisouRemove.\u003CcallEquipReisouAPI\u003Eb__8_1));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        break;
      case GuildUtil.GvGPopupState.DefTeam:
        // ISSUE: reference to a compiler-generated method
        e = GuildUtil.UpdateGuildDeckDefanse(PlayerAffiliation.Current.guild_id, Player.Current.id, new System.Action(popupReisouRemove.\u003CcallEquipReisouAPI\u003Eb__8_2));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        break;
    }
    System.Action removeCallback = popupReisouRemove.removeCallback;
