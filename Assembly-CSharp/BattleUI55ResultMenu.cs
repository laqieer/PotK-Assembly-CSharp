...
public class BattleUI55ResultMenu : ResultMenuBase
{
  ...
  protected IEnumerator ShowUnitEXPForEarth()
  {
    ...
    battleUi55ResultMenu.grid.arrangement = UIGrid.Arrangement.Horizontal;
    ...
    foreach (KeyValuePair<int, PlayerUnit> afterUnit1 in battleUi55ResultMenu.afterUnits)
    {
      ...
      unit = battleUi55ResultMenu.DirUnitPrefab.Clone(battleUi55ResultMenu.grid.transform).GetComponent<ColosseumResultUnit>();
    ...
    foreach (ColosseumResultUnit colosseumResultUnit in unitList)
    {
      ...
      if (unit.IsLevelUP())
      {
        if ((UnityEngine.Object) UnitLevelupPrefab == (UnityEngine.Object) null)
        {
        ...
        for (int i = 0; i < equippedGears.Length; ++i)
        {
          ...
          if (beforeGear != (PlayerItem) null)
          {
            ...
            if (playerItem != (PlayerItem) null)
            {
              ...
              battleUi55ResultMenu.StartCoroutine(PopupCommon.Show(accessoryDisappearTitle, disappearanceType1.discription, (System.Action) (() => isdisappearedPopupFinished = true)));
