...
public class PopupXLevelUpResult : BackButtonPopupBase
{
  ...
  public static Future<GameObject> createLoader() => new ResourceObject("Prefabs/unit004_2/popup_XLvUp_StatusUp").Load<GameObject>();

  public static void show(GameObject prefab, PlayerUnit before, PlayerUnit after, System.Action eventEnd)
  {
  ...
  private IEnumerator Start()
  {
    ...
    popupXlevelUpResult1.gameObject.GetComponent<UIRect>().alpha = 0.0f;
    popupXlevelUpResult1.btnClose_.isEnabled = false;
    ...
    popupXlevelUpResult2.fromExp_ = num;
    ...
    popupXlevelUpResult1.txtResultLevel_.color = PopupXLevelUpResult.NORMAL_COLOR;
    ...
    Singleton<PopupManager>.GetInstance().startOpenAnime(popupXlevelUpResult1.gameObject);
  ...
  private int[] getParams(PlayerUnit target) => new int[8]
  {
    target.hp.x_level,
  ...
  private void updateInfo(bool bSkip, bool bInit)
  {
    ...
    if (!(this.txtLevel_.text != this.txtResultLevel_.text))
      return;
    this.txtResultLevel_.color = PopupXLevelUpResult.CHANGED_COLOR;
  }
  ...
  private IEnumerator doStartParamUp(bool bSkip)
  {
    ...
    popupXlevelUpResult.btnClose_.isEnabled = true;
  ...
  private class ParamControl
  {
    ...
    public void setStart()
    {
      ...
      this.txtNumber.color = PopupXLevelUpResult.NORMAL_COLOR;
    ...
    public void setEnd()
    {
      ...
      this.txtNumber.color = PopupXLevelUpResult.CHANGED_COLOR;
