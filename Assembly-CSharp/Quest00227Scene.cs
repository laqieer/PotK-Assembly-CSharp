...
public class Quest00227Scene : NGSceneBase
{
  ...
  public static void ChangeScene(QuestScoreCampaignProgress qscp, bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_27", (stack ? 1 : 0) != 0, (object) qscp);
