...
public class Tower029EnemyListPopup : BackButtonMonoBehaiviour
{
  ...
  private const float GrayColor = 0.4196078f;
  [SerializeField]
  ...
  {
    if (this.bossIconInfo != null && !((UnityEngine.Object) this.bossIconInfo.icon == (UnityEngine.Object) null))
    {
      Future<UnityEngine.Sprite> ft = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>("Prefabs/UnitIcon/Materials/slc_icon_boss");
      ...
      if (!((UnityEngine.Object) ft.Result == (UnityEngine.Object) null))
      {
        ...
        ui2Dsprite.depth = this.bossIconDepth;
        ui2Dsprite.SetDimensions(48, 26);
        gameObject.transform.SetParent(this.bossIconInfo.icon.transform);
        ...
        if ((double) this.bossIconInfo.playerUnit.TowerHpRate <= 0.0)
          ui2Dsprite.color = new Color(0.4196078f, 0.4196078f, 0.4196078f);
      }
    }
  }
  ...
  private IEnumerator CreateUnitIcon()
  {
    ...
    {
      UnitIconBase unitIcon = UnityEngine.Object.Instantiate<GameObject>(this.iconPrefab).GetComponent<UnitIconBase>();
      ...
      this.scroll.Add(unitIcon.gameObject, UnitIcon.Width, height);
    ...
    PlayerUnit baseUnit = null)
  {
    ...
    this.allEnemyInfo.Where<Tower029EnemyListPopup.EnemyUnitIconInfo>((Func<Tower029EnemyListPopup.EnemyUnitIconInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)).ForEach<Tower029EnemyListPopup.EnemyUnitIconInfo>((System.Action<Tower029EnemyListPopup.EnemyUnitIconInfo>) (b => b.icon = (UnitIconBase) null));
  ...
  {
    if ((UnityEngine.Object) icon.HpGauge != (UnityEngine.Object) null)
  ...
  private PlayerUnit[] getUnits() => this.allEnemyInfo.Select<Tower029EnemyListPopup.EnemyUnitIconInfo, PlayerUnit>((Func<Tower029EnemyListPopup.EnemyUnitIconInfo, PlayerUnit>) (x => x.playerUnit)).ToArray<PlayerUnit>();

  private IEnumerator ResourceLoad()
  {
    if ((UnityEngine.Object) this.iconPrefab == (UnityEngine.Object) null)
    {
    ...
    while (true)
    {
      do
      {
        ...
        foreach (GameObject gameObject in this.scroll)
        {
          ...
          {
            int? nullable = this.allEnemyInfo.FirstIndexOrNull<Tower029EnemyListPopup.EnemyUnitIconInfo>((Func<Tower029EnemyListPopup.EnemyUnitIconInfo, bool>) (v => (UnityEngine.Object) v.icon != (UnityEngine.Object) null && (UnityEngine.Object) v.icon.gameObject == (UnityEngine.Object) unit));
...
label_27:;
  ...
  private void CreateUnitIconAction(int info_index, int unit_index)
  {
    ...
    icon.onClick = (System.Action<UnitIconBase>) (u => this.StartCoroutine(this.ShowEnemyDetailPopup(unitInfo.blUnit)));
    icon.Button.onLongPress.Clear();
  }

  private IEnumerator ShowEnemyDetailPopup(BL.Unit unit)
  {
    if ((UnityEngine.Object) this.enemyDetailPopup == (UnityEngine.Object) null)
    {
    ...
    bool clearAllFloor)
  {
    ...
    if ((UnityEngine.Object) tower029EnemyListPopup.GetComponent<UIWidget>() != (UnityEngine.Object) null)
      tower029EnemyListPopup.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    tower029EnemyListPopup.scrool_start_y = tower029EnemyListPopup.scroll.scrollView.transform.localPosition.y;
  ...
  private Future<BL.Unit> createUnitByPlayerUnit(PlayerUnit pu, int index, bool friend)
  {
    ...
    GearGearSkill[] gearGearSkillArray1 = pu.equippedGear != (PlayerItem) null ? ((IEnumerable<GearGearSkill>) pu.equippedGear.skills).Where<GearGearSkill>((Func<GearGearSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.command)).ToArray<GearGearSkill>() : new GearGearSkill[0];
    GearGearSkill[] gearGearSkillArray2 = pu.equippedGear != (PlayerItem) null ? ((IEnumerable<GearGearSkill>) pu.equippedGear.skills).Where<GearGearSkill>((Func<GearGearSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.duel)).ToArray<GearGearSkill>() : new GearGearSkill[0];
    GearGearSkill[] gearGearSkillArray3 = pu.equippedGear != (PlayerItem) null ? ((IEnumerable<GearGearSkill>) pu.equippedGear.skills).Where<GearGearSkill>((Func<GearGearSkill, bool>) (v => v.skill.skill_type == BattleskillSkillType.magic)).ToArray<GearGearSkill>() : new GearGearSkill[0];
    ...
    Future<List<BL.Skill>> future5 = ((IEnumerable<GearGearSkill>) gearGearSkillArray1).Select<GearGearSkill, Future<BL.Skill>>((Func<GearGearSkill, Future<BL.Skill>>) (v => this.createSkill(v))).Sequence<BL.Skill>();
    Future<List<BL.Skill>> future6 = ((IEnumerable<GearGearSkill>) gearGearSkillArray2).Select<GearGearSkill, Future<BL.Skill>>((Func<GearGearSkill, Future<BL.Skill>>) (v => this.createSkill(v))).Sequence<BL.Skill>();
    Future<List<BL.MagicBullet>> future7 = ((IEnumerable<GearGearSkill>) gearGearSkillArray3).Select<GearGearSkill, Future<BL.MagicBullet>>((Func<GearGearSkill, Future<BL.MagicBullet>>) (v => this.createMagicBullet(v))).Sequence<BL.MagicBullet>();
