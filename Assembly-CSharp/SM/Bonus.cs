...
namespace SM
{
  ...
  public class Bonus : KeyCompare
  {
    ...
    public static string ToRemainingTime(int remaining_time)
    {
      ...
      string str2;
      if (num1 > 0)
        str2 = str1 + Consts.Format(Consts.GetInstance().COLOSSEUM_BONUS_DAY, (IDictionary) new Hashtable()
        {
          {
            (object) "day",
            (object) num1
        ...
        str2 = str1 + Consts.Format(Consts.GetInstance().COLOSSEUM_BONUS_HOUR, (IDictionary) new Hashtable()
        {
          {
            (object) "hour",
            (object) num2
        ...
        str2 = str1 + Consts.Format(Consts.GetInstance().COLOSSEUM_BONUS_MINUE, (IDictionary) new Hashtable()
        {
          {
            (object) "min",
            (object) num3
