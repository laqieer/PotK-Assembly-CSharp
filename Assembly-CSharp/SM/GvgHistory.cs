...
namespace SM
{
  ...
  public class GvgHistory : KeyCompare
  {
    ...
    public GvgHistory(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (player_histories)])
        gvgPlayerHistoryList.Add(obj == null ? (GvgPlayerHistory) null : new GvgPlayerHistory((Dictionary<string, object>) obj));
