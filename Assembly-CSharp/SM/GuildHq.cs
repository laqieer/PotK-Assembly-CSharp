...
namespace SM
{
  ...
  public class GuildHq : KeyCompare
  {
    ...
    public GuildBaseBonus[] bonuses => ((IEnumerable<int>) this._bonuses).Select<int, GuildBaseBonus>((Func<int, GuildBaseBonus>) (x => MasterData.GuildBaseBonus[x])).ToArray<GuildBaseBonus>();
