...
namespace SM
{
  ...
  public class PlayerUnit : KeyCompare
  {
    ...
    public static bool operator ==(PlayerUnit lhs, PlayerUnit rhs) => (object) lhs == null ? (object) rhs == null : lhs.Equals(rhs);
    ...
    public static PlayerUnit CreateByPlayerMaterialUnit(
      PlayerMaterialUnit playerUnit,
      int count = 0)
    {
    ...
    {
      PlayerUnit playerUnit = new PlayerUnit();
      playerUnit._hasKey = true;
      int num1;
      int num2 = num1 = id;
      playerUnit.id = num1;
      playerUnit._key = (object) num2;
      return playerUnit;
    }
      ...
      bool isRaidBoss = false)
    {
      ...
      pu.is_enemy_leader = (uint) pu.leader_skills.Length > 0U;
    ...
    private static PlayerUnitJob_abilities createJobAbility(
      JobCharacteristics ja,
      int level)
    {
    ...
    public float unityTotal => Mathf.Min((float) this.unity_value + this.buildup_unity_value_f, (float) PlayerUnit.GetUnityValueMax());

    public void setUnity(int v) => this.unity_value = Mathf.Min(v, PlayerUnit.GetUnityValueMax());

    public void addUnity(int v) => this.unity_value = Mathf.Min(this.unity_value + v, PlayerUnit.GetUnityValueMax());

    public void setBuildupUnity(int v) => this.buildup_unity_value_f = (float) Mathf.Min(v, PlayerUnit.GetUnityValueMax());

    public void addBuildupUnity(int v) => this.buildup_unity_value_f = Mathf.Min(this.buildup_unity_value_f + (float) v, (float) PlayerUnit.GetUnityValueMax());
    ...
    public Judgement.NonBattleParameter nonbattleParameter => Judgement.NonBattleParameter.FromPlayerUnit(this);

    public int combat => Judgement.NonBattleParameter.FromPlayerUnit(this).Combat;

    public int total_hp => this.unit.IsNormalUnit ? this.hp.initial + this.hp.level + this.hp.compose + this.hp.inheritance + this.hp.buildup + this.hp.transmigrate + this.hp.x_level + this.bonus_hp + this.hp.overkillersValue : 1;

    public int self_total_hp => this.unit.IsNormalUnit ? this.hp.initial + this.hp.level + this.hp.compose + this.hp.inheritance + this.hp.buildup + this.hp.transmigrate + this.hp.x_level + this.bonus_hp : 1;

    public int self_hp_without_x => this.unit.IsNormalUnit ? this.hp.initial + this.hp.level + this.hp.compose + this.hp.inheritance + this.hp.buildup + this.hp.transmigrate + this.bonus_hp : 1;

    public int bonus_hp => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.hp_add);

    public int total_strength => this.unit.IsNormalUnit ? this.strength.initial + this.strength.level + this.strength.compose + this.strength.inheritance + this.strength.buildup + this.strength.transmigrate + this.strength.x_level + this.bonus_strength + this.strength.overkillersValue : 1;

    public int self_total_strength => this.unit.IsNormalUnit ? this.strength.initial + this.strength.level + this.strength.compose + this.strength.inheritance + this.strength.buildup + this.strength.transmigrate + this.strength.x_level + this.bonus_strength : 1;

    public int self_strength_without_x => this.unit.IsNormalUnit ? this.strength.initial + this.strength.level + this.strength.compose + this.strength.inheritance + this.strength.buildup + this.strength.transmigrate + this.bonus_strength : 1;

    public int bonus_strength => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.strength_add);

    public int total_intelligence => this.unit.IsNormalUnit ? this.intelligence.initial + this.intelligence.level + this.intelligence.compose + this.intelligence.inheritance + this.intelligence.buildup + this.intelligence.transmigrate + this.intelligence.x_level + this.bonus_intelligence + this.intelligence.overkillersValue : 1;

    public int self_total_intelligence => this.unit.IsNormalUnit ? this.intelligence.initial + this.intelligence.level + this.intelligence.compose + this.intelligence.inheritance + this.intelligence.buildup + this.intelligence.transmigrate + this.intelligence.x_level + this.bonus_intelligence : 1;

    public int self_intelligence_without_x => this.unit.IsNormalUnit ? this.intelligence.initial + this.intelligence.level + this.intelligence.compose + this.intelligence.inheritance + this.intelligence.buildup + this.intelligence.transmigrate + this.bonus_intelligence : 1;

    public int bonus_intelligence => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.intelligence_add);

    public int total_vitality => this.unit.IsNormalUnit ? this.vitality.initial + this.vitality.level + this.vitality.compose + this.vitality.inheritance + this.vitality.buildup + this.vitality.transmigrate + this.vitality.x_level + this.bonus_vitality + this.vitality.overkillersValue : 1;

    public int self_total_vitality => this.unit.IsNormalUnit ? this.vitality.initial + this.vitality.level + this.vitality.compose + this.vitality.inheritance + this.vitality.buildup + this.vitality.transmigrate + this.vitality.x_level + this.bonus_vitality : 1;

    public int self_vitality_without_x => this.unit.IsNormalUnit ? this.vitality.initial + this.vitality.level + this.vitality.compose + this.vitality.inheritance + this.vitality.buildup + this.vitality.transmigrate + this.bonus_vitality : 1;

    public int bonus_vitality => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.vitality_add);

    public int total_dexterity => this.unit.IsNormalUnit ? this.dexterity.initial + this.dexterity.level + this.dexterity.compose + this.dexterity.inheritance + this.dexterity.buildup + this.dexterity.transmigrate + this.dexterity.x_level + this.bonus_dexterity + this.dexterity.overkillersValue : 1;

    public int self_total_dexterity => this.unit.IsNormalUnit ? this.dexterity.initial + this.dexterity.level + this.dexterity.compose + this.dexterity.inheritance + this.dexterity.buildup + this.dexterity.transmigrate + this.dexterity.x_level + this.bonus_dexterity : 1;

    public int self_dexterity_without_x => this.unit.IsNormalUnit ? this.dexterity.initial + this.dexterity.level + this.dexterity.compose + this.dexterity.inheritance + this.dexterity.buildup + this.dexterity.transmigrate + this.bonus_dexterity : 1;

    public int bonus_dexterity => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.dexterity_add);

    public int total_agility => this.unit.IsNormalUnit ? this.agility.initial + this.agility.level + this.agility.compose + this.agility.inheritance + this.agility.buildup + this.agility.transmigrate + this.agility.x_level + this.bonus_agility + this.agility.overkillersValue : 1;

    public int self_total_agility => this.unit.IsNormalUnit ? this.agility.initial + this.agility.level + this.agility.compose + this.agility.inheritance + this.agility.buildup + this.agility.transmigrate + this.agility.x_level + this.bonus_agility : 1;

    public int self_agility_without_x => this.unit.IsNormalUnit ? this.agility.initial + this.agility.level + this.agility.compose + this.agility.inheritance + this.agility.buildup + this.agility.transmigrate + this.bonus_agility : 1;

    public int bonus_agility => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.agility_add);

    public int total_mind => this.unit.IsNormalUnit ? this.mind.initial + this.mind.level + this.mind.compose + this.mind.inheritance + this.mind.buildup + this.mind.transmigrate + this.mind.x_level + this.bonus_mind + this.mind.overkillersValue : 1;

    public int self_total_mind => this.unit.IsNormalUnit ? this.mind.initial + this.mind.level + this.mind.compose + this.mind.inheritance + this.mind.buildup + this.mind.transmigrate + this.mind.x_level + this.bonus_mind : 1;

    public int self_mind_without_x => this.unit.IsNormalUnit ? this.mind.initial + this.mind.level + this.mind.compose + this.mind.inheritance + this.mind.buildup + this.mind.transmigrate + this.bonus_mind : 1;

    public int bonus_mind => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.mind_add);

    public int total_lucky => this.unit.IsNormalUnit ? this.lucky.initial + this.lucky.level + this.lucky.compose + this.lucky.inheritance + this.lucky.buildup + this.lucky.transmigrate + this.lucky.x_level + this.bonus_lucky + this.lucky.overkillersValue : 1;

    public int self_total_lucky => this.unit.IsNormalUnit ? this.lucky.initial + this.lucky.level + this.lucky.compose + this.lucky.inheritance + this.lucky.buildup + this.lucky.transmigrate + this.lucky.x_level + this.bonus_lucky : 1;

    public int self_lucky_without_x => this.unit.IsNormalUnit ? this.lucky.initial + this.lucky.level + this.lucky.compose + this.lucky.inheritance + this.lucky.buildup + this.lucky.transmigrate + this.bonus_lucky : 1;

    public int bonus_lucky => this.getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus.lucky_add);

    public int getJobAbilityLevelmaxBonus(JobCharacteristicsLevelmaxBonus type) => this.all_saved_job_abilities == null ? 0 : ((IEnumerable<PlayerUnitAll_saved_job_abilities>) this.all_saved_job_abilities).Sum<PlayerUnitAll_saved_job_abilities>((Func<PlayerUnitAll_saved_job_abilities, int>) (x =>
    {
      int num = 0;
      ...
      if (MasterData.JobCharacteristics.TryGetValue(x.job_ability_id, out jobCharacteristics) && jobCharacteristics.skill.upper_level <= x.level)
      {
        if (jobCharacteristics.levelmax_bonus == type)
          num += jobCharacteristics.levelmax_bonus_value;
        if (jobCharacteristics.levelmax_bonus2 == type)
          num += jobCharacteristics.levelmax_bonus_value2;
        if (jobCharacteristics.levelmax_bonus3 == type)
          num += jobCharacteristics.levelmax_bonus_value3;
      }
      return num;
    }));

    public int memory_hp => this.unit.IsNormalUnit && this.MemoryData != null ? (this.hp.level_up_max_status < this.MemoryData.hp + this.hp.buildup ? this.hp.level_up_max_status : this.MemoryData.hp + this.hp.buildup) + this.hp.initial + this.hp.compose + this.hp.inheritance + this.hp.transmigrate + this.bonus_hp : 1;

    public int memory_strength => this.unit.IsNormalUnit && this.MemoryData != null ? (this.strength.level_up_max_status < this.MemoryData.strength + this.strength.buildup ? this.strength.level_up_max_status : this.MemoryData.strength + this.strength.buildup) + this.strength.initial + this.strength.compose + this.strength.inheritance + this.strength.transmigrate + this.bonus_strength : 1;

    public int memory_intelligence => this.unit.IsNormalUnit && this.MemoryData != null ? (this.intelligence.level_up_max_status < this.MemoryData.intelligence + this.intelligence.buildup ? this.intelligence.level_up_max_status : this.MemoryData.intelligence + this.intelligence.buildup) + this.intelligence.initial + this.intelligence.compose + this.intelligence.inheritance + this.intelligence.transmigrate + this.bonus_intelligence : 1;

    public int memory_vitality => this.unit.IsNormalUnit && this.MemoryData != null ? (this.vitality.level_up_max_status < this.MemoryData.vitality + this.vitality.buildup ? this.vitality.level_up_max_status : this.MemoryData.vitality + this.vitality.buildup) + this.vitality.initial + this.vitality.compose + this.vitality.inheritance + this.vitality.transmigrate + this.bonus_vitality : 1;

    public int memory_dexterity => this.unit.IsNormalUnit && this.MemoryData != null ? (this.dexterity.level_up_max_status < this.MemoryData.dexterity + this.dexterity.buildup ? this.dexterity.level_up_max_status : this.MemoryData.dexterity + this.dexterity.buildup) + this.dexterity.initial + this.dexterity.compose + this.dexterity.inheritance + this.dexterity.transmigrate + this.bonus_dexterity : 1;

    public int memory_agility => this.unit.IsNormalUnit && this.MemoryData != null ? (this.agility.level_up_max_status < this.MemoryData.agility + this.agility.buildup ? this.agility.level_up_max_status : this.MemoryData.agility + this.agility.buildup) + this.agility.initial + this.agility.compose + this.agility.inheritance + this.agility.transmigrate + this.bonus_agility : 1;

    public int memory_mind => this.unit.IsNormalUnit && this.MemoryData != null ? (this.mind.level_up_max_status < this.MemoryData.mind + this.mind.buildup ? this.mind.level_up_max_status : this.MemoryData.mind + this.mind.buildup) + this.mind.initial + this.mind.compose + this.mind.inheritance + this.mind.transmigrate + this.bonus_mind : 1;

    public int memory_lucky => this.unit.IsNormalUnit && this.MemoryData != null ? (this.lucky.level_up_max_status < this.MemoryData.lucky + this.lucky.buildup ? this.lucky.level_up_max_status : this.MemoryData.lucky + this.lucky.buildup) + this.lucky.initial + this.lucky.compose + this.lucky.inheritance + this.lucky.transmigrate + this.bonus_lucky : 1;

    public bool is_memory_hp_max => this.unit.IsNormalUnit && this.MemoryData != null && this.hp.level_up_max_status <= this.MemoryData.hp + this.hp.buildup;

    public bool is_memory_strength_max => this.unit.IsNormalUnit && this.MemoryData != null && this.strength.level_up_max_status <= this.MemoryData.strength + this.strength.buildup;

    public bool is_memory_intelligence_max => this.unit.IsNormalUnit && this.MemoryData != null && this.intelligence.level_up_max_status <= this.MemoryData.intelligence + this.intelligence.buildup;

    public bool is_memory_vitality_max => this.unit.IsNormalUnit && this.MemoryData != null && this.vitality.level_up_max_status <= this.MemoryData.vitality + this.vitality.buildup;

    public bool is_memory_dexterity_max => this.unit.IsNormalUnit && this.MemoryData != null && this.dexterity.level_up_max_status <= this.MemoryData.dexterity + this.dexterity.buildup;

    public bool is_memory_agility_max => this.unit.IsNormalUnit && this.MemoryData != null && this.agility.level_up_max_status <= this.MemoryData.agility + this.agility.buildup;

    public bool is_memory_mind_max => this.unit.IsNormalUnit && this.MemoryData != null && this.mind.level_up_max_status <= this.MemoryData.mind + this.mind.buildup;

    public bool is_memory_lucky_max => this.unit.IsNormalUnit && this.MemoryData != null && this.lucky.level_up_max_status <= this.MemoryData.lucky + this.lucky.buildup;

    public bool is_memory_over => this.is_memory_hp_over || this.is_memory_strength_over || (this.is_memory_intelligence_over || this.is_memory_vitality_over) || (this.is_memory_dexterity_over || this.is_memory_agility_over || this.is_memory_mind_over) || this.is_memory_lucky_over;

    public bool is_memory_hp_over => this.unit.IsNormalUnit && this.MemoryData != null && this.hp.level_up_max_status < this.MemoryData.hp + this.hp.buildup;

    public bool is_memory_strength_over => this.unit.IsNormalUnit && this.MemoryData != null && this.strength.level_up_max_status < this.MemoryData.strength + this.strength.buildup;

    public bool is_memory_intelligence_over => this.unit.IsNormalUnit && this.MemoryData != null && this.intelligence.level_up_max_status < this.MemoryData.intelligence + this.intelligence.buildup;

    public bool is_memory_vitality_over => this.unit.IsNormalUnit && this.MemoryData != null && this.vitality.level_up_max_status < this.MemoryData.vitality + this.vitality.buildup;

    public bool is_memory_dexterity_over => this.unit.IsNormalUnit && this.MemoryData != null && this.dexterity.level_up_max_status < this.MemoryData.dexterity + this.dexterity.buildup;

    public bool is_memory_agility_over => this.unit.IsNormalUnit && this.MemoryData != null && this.agility.level_up_max_status < this.MemoryData.agility + this.agility.buildup;

    public bool is_memory_mind_over => this.unit.IsNormalUnit && this.MemoryData != null && this.mind.level_up_max_status < this.MemoryData.mind + this.mind.buildup;

    public bool is_memory_lucky_over => this.unit.IsNormalUnit && this.MemoryData != null && this.lucky.level_up_max_status < this.MemoryData.lucky + this.lucky.buildup;

    public int memory_level => this.unit.IsNormalUnit && this.MemoryData != null ? this.MemoryData.level : 1;

    public int compose_hp_max => this.UnitTypeParameter.hp_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.HP);

    public int compose_strength_max => this.UnitTypeParameter.strength_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.STRENGTH);

    public int compose_vitality_max => this.UnitTypeParameter.vitality_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.VITALITY);

    public int compose_intelligence_max => this.UnitTypeParameter.intelligence_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.INTELLIGENCE);

    public int compose_mind_max => this.UnitTypeParameter.mind_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.MIND);

    public int compose_agility_max => this.UnitTypeParameter.agility_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.AGILITY);

    public int compose_dexterity_max => this.UnitTypeParameter.dexterity_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.DEXTERITY);

    public int compose_lucky_max => this.UnitTypeParameter.lucky_compose_max + this.getComposeAddValue(PlayerUnit.ParamType.LUCKY);
    ...
    public PlayerItem equippedGear => this.primary_equipped_gear != (PlayerItem) null ? (this.primary_equipped_gear.id == 0 ? (PlayerItem) null : this.primary_equipped_gear) : (this.used_primary != 0 ? (PlayerItem) null : this.FindEquippedGear(SMManager.Get<PlayerItem[]>()));
    ...
    public PlayerItem FindEquippedReisou(
      PlayerItem[] gears,
    ...
    public PlayerItem FindEquippedReisou2(
      PlayerItem[] gears,
      PlayerGearReisouSchema[] reisous)
    {
      if (reisous.IsNullOrEmpty<PlayerGearReisouSchema>())
    ...
    public PlayerItem FindEquippedReisou3(
      PlayerItem[] gears,
      PlayerGearReisouSchema[] reisous)
    {
      if (reisous.IsNullOrEmpty<PlayerGearReisouSchema>())
    ...
    public UnitTypeParameter UnitTypeParameter => ((IEnumerable<UnitTypeParameter>) MasterData.UnitTypeParameterList).Single<UnitTypeParameter>((Func<UnitTypeParameter, bool>) (x => x.unit_type.ID == this.unit_type.ID && x.rarity.ID == this.unit.rarity.ID));

    public int amountIncrementInCompose => this.unit.IsNormalUnit ? this.hp.compose + this.vitality.compose + this.strength.compose + this.lucky.compose + this.intelligence.compose + this.mind.compose + this.agility.compose + this.dexterity.compose : 0;

    public bool isMaxParamInCompose => this.unit.IsNormalUnit && this.hp.compose >= this.compose_hp_max && (this.vitality.compose >= this.compose_vitality_max && this.strength.compose >= this.compose_strength_max) && (this.lucky.compose >= this.compose_lucky_max && this.intelligence.compose >= this.compose_intelligence_max && (this.mind.compose >= this.compose_mind_max && this.agility.compose >= this.compose_agility_max)) && this.dexterity.compose >= this.compose_dexterity_max;
    ...
    public bool isMaxLevelupParam => this.hp.is_max && this.strength.is_max && (this.intelligence.is_max && this.vitality.is_max) && (this.mind.is_max && this.agility.is_max) && this.lucky.is_max;
    ...
    public PlayerUnitLeader_skills leader_skill => this.leader_skills.Length == 0 ? (PlayerUnitLeader_skills) null : this.leader_skills[0];
    ...
    public UnitProficiencyIncr ProficiencyIncr => this.GetProficiencyIncr((this.equippedGear != (PlayerItem) null ? this.equippedGear.gear : (this.equippedGear2 != (PlayerItem) null ? this.equippedGear2.gear : this.initial_gear)).kind);
    ...
    public UnitProficiencyIncr GetProficiencyIncr(GearKind kind) => UnitProficiencyIncr.FromKindProficiency(kind, this.GetProficiency(kind));
    ...
    public PlayerUnitSkills[] GetAcquireSkills() => this.skills == null ? new PlayerUnitSkills[0] : ((IEnumerable<PlayerUnitSkills>) this.skills).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (x => x.skill.skill_type != BattleskillSkillType.magic && x.skill.skill_type != BattleskillSkillType.leader)).ToArray<PlayerUnitSkills>();
    ...
    public Dictionary<int, int> GetAcquireSkillsDictionary()
    {
      ...
      foreach (PlayerUnitSkills acquireSkill in this.GetAcquireSkills())
        dictionary.Add(acquireSkill.skill_id, acquireSkill.level);
      return dictionary;
    }

    public UnitSkill[] GetSkills() => ((IEnumerable<UnitSkill>) this.unit.RememberUnitSkills(this._unit_type)).Where<UnitSkill>((Func<UnitSkill, bool>) (x => x.skill.skill_type != BattleskillSkillType.magic && x.skill.skill_type != BattleskillSkillType.leader)).ToArray<UnitSkill>();
    ...
    public UnitSkillCharacterQuest[] GetCharacterSkills() => ((IEnumerable<UnitSkillCharacterQuest>) MasterData.UnitSkillCharacterQuestList).Where<UnitSkillCharacterQuest>((Func<UnitSkillCharacterQuest, bool>) (x => x.unit.ID == this.unit.ID && x.skill.skill_type != BattleskillSkillType.magic && x.skill.skill_type != BattleskillSkillType.leader)).ToArray<UnitSkillCharacterQuest>();

    public UnitSkillHarmonyQuest[] GetHarmonySkills() => ((IEnumerable<UnitSkillHarmonyQuest>) MasterData.UnitSkillHarmonyQuestList).Where<UnitSkillHarmonyQuest>((Func<UnitSkillHarmonyQuest, bool>) (x => x.character.ID == this.unit.character.ID && x.skill.skill_type != BattleskillSkillType.magic && x.skill.skill_type != BattleskillSkillType.leader)).ToArray<UnitSkillHarmonyQuest>();

    public UnitSkillIntimate[] GetIntimateSkills() => ((IEnumerable<UnitSkillIntimate>) MasterData.UnitSkillIntimateList).Where<UnitSkillIntimate>((Func<UnitSkillIntimate, bool>) (x => x.unit.ID == this.unit.ID && x.skill.skill_type != BattleskillSkillType.magic && x.skill.skill_type != BattleskillSkillType.leader)).ToArray<UnitSkillIntimate>();

    public UnitSkillAwake[] GetAwakeSkills() => ((IEnumerable<UnitSkillAwake>) MasterData.UnitSkillAwakeList).Where<UnitSkillAwake>((Func<UnitSkillAwake, bool>) (x => x.character_id == this.unit.same_character_id)).ToArray<UnitSkillAwake>();
    ...
    public int TowerHp
    {
      get
      {
        ...
        if ((double) this.TowerHpRate == 100.0)
          return totalHp;
        int num = Mathf.CeilToInt((float) ((double) totalHp * (double) this.TowerHpRate / 100.0));
        if (num == totalHp && (double) this.TowerHpRate < 100.0)
          --num;
        return num;
      }
    }
    ...
    public MasterDataTable.UnitJob getJobData() => this.unitJob_ ?? (this.unitJob_ = MasterData.UnitJob[this.job_id != 0 ? this.job_id : (this.job_id = this.unit.job_UnitJob)]);
    ...
    public bool isJobChange() => !this.isJobChange_.HasValue ? (this.isJobChange_ = new bool?(this.job_id != this.unit.job_UnitJob)).Value : this.isJobChange_.Value;

    public UnitFamily[] Families => this.families_ ?? (this.families_ = this.isJobChange() ? this.unit.FamiliesWithJob(this.job_id) : this.unit.Families);

    public bool HasFamily(UnitFamily family) => ((IEnumerable<UnitFamily>) this.Families).Any<UnitFamily>((Func<UnitFamily, bool>) (x => x == family));

    public AttackMethod[] attackMethods => ((IEnumerable<AttackMethod>) MasterData.AttackMethodList).Where<AttackMethod>((Func<AttackMethod, bool>) (x => x.unit_UnitUnit == this._unit && x.job_UnitJob == this.job_id)).ToArray<AttackMethod>();

    public IAttackMethod[] battleOptionAttacks => this.battleOptionAttacks_ ?? (this.battleOptionAttacks_ = ((IEnumerable<AttackMethod>) MasterData.AttackMethodList).Where<AttackMethod>((Func<AttackMethod, bool>) (x => x.unit_UnitUnit == this._unit && x.job_UnitJob == this.job_id)).Select<AttackMethod, IAttackMethod>((Func<AttackMethod, IAttackMethod>) (y => y.CreateInterface())).ToArray<IAttackMethod>());

    public void setBattleOptionAttacks(IAttackMethod[] attacks) => this.battleOptionAttacks_ = attacks;
    ...
    public void importOverkillersUnits() => this.importOverkillersUnits(SMManager.Get<PlayerUnit[]>(), true);
    ...
    public bool isReleasedOverkillersSlot(int slot_no) => this.unit.exist_overkillers_slot && this.over_killers_player_unit_ids != null && this.over_killers_player_unit_ids.Length > slot_no && this.over_killers_player_unit_ids[slot_no] > -1;
    ...
    public bool hasOverkillersUnit(int slot_no) => this.unit.exist_overkillers_slot && this.over_killers_player_unit_ids != null && this.over_killers_player_unit_ids.Length > slot_no && this.over_killers_player_unit_ids[slot_no] > 0;
    ...
    public void resetOverkillersParameter()
    {
      ...
      {
        PlayerUnit target_unit = this.cache_overkillers_units.Length > index ? this.cache_overkillers_units[index] : (PlayerUnit) null;
        if (!(target_unit == (PlayerUnit) null))
        {
          OverkillersParameter overkillersParameter = this.getOverkillersParameter(target_unit);
          if (overkillersParameter != null)
          {
            num2 += OverkillersParameter.calcParameter(target_unit.self_total_dexterity, overkillersParameter.dexterity);
            num3 += OverkillersParameter.calcParameter(target_unit.self_total_intelligence, overkillersParameter.intelligence);
            num4 += OverkillersParameter.calcParameter(target_unit.self_total_mind, overkillersParameter.mind);
            num5 += OverkillersParameter.calcParameter(target_unit.self_total_strength, overkillersParameter.strength);
            num6 += OverkillersParameter.calcParameter(target_unit.self_total_agility, overkillersParameter.agility);
            num7 += OverkillersParameter.calcParameter(target_unit.self_total_hp, overkillersParameter.hp);
            num8 += OverkillersParameter.calcParameter(target_unit.self_total_lucky, overkillersParameter.lucky);
            num9 += OverkillersParameter.calcParameter(target_unit.self_total_vitality, overkillersParameter.vitality);
          }
        }
      }
    ...
    public OverkillersParameter getOverkillersParameter(PlayerUnit target_unit) => OverkillersParameter.getParameter(this.getOverkillersParameterNo(this.unit.ID, target_unit.unit), (int) target_unit.unityTotal);
    ...
    public bool isUnlockedSEASkillWithoutMasterData => this.isReleasedOverkillersSlot(PlayerUnit.SEASkillUnlockConditions - 1);

    public int countEquippedOverkillers => this.over_killers_player_unit_ids == null || this.over_killers_player_unit_ids.Length == 0 ? 0 : ((IEnumerable<int>) this.over_killers_player_unit_ids).Count<int>((Func<int, bool>) (n => n > 0));
    ...
    public int x_level => this.x_job_status == null ? 0 : UnitXLevel.expToLevel(this.x_job_status.total_exp);
        ...
        for (int index = 0; index < this.all_saved_job_abilities.Length; ++index)
        {
          ...
          if (MasterData.JobCharacteristics.TryGetValue(allSavedJobAbility.job_ability_id, out jobCharacteristics))
          {
            ...
            if (xlevelLimits != null)
              num += xlevelLimits.getLimit(allSavedJobAbility.level);
          }
        }
        return num;
      }
    ...
    public PlayerUnit(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (job_abilities)])
        unitJobAbilitiesList.Add(obj == null ? (PlayerUnitJob_abilities) null : new PlayerUnitJob_abilities((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (all_saved_job_abilities)])
        savedJobAbilitiesList.Add(obj == null ? (PlayerUnitAll_saved_job_abilities) null : new PlayerUnitAll_saved_job_abilities((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (leader_skills)])
        unitLeaderSkillsList.Add(obj == null ? (PlayerUnitLeader_skills) null : new PlayerUnitLeader_skills((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (gear_proficiencies)])
        unitGearProficiencyList.Add(obj == null ? (PlayerUnitGearProficiency) null : new PlayerUnitGearProficiency((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (x_job_proficiencies)])
        jobProficienciesList.Add(obj == null ? (PlayerUnitX_job_proficiencies) null : new PlayerUnitX_job_proficiencies((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (skills)])
        playerUnitSkillsList.Add(obj == null ? (PlayerUnitSkills) null : new PlayerUnitSkills((Dictionary<string, object>) obj));
    ...
    public void setStatusOpenedEquippedGear3(bool bOpened) => this.noOpenedEquippedGear3_ = this.isPossibleEquippedGear3 & bOpened ? (byte) 2 : (byte) 1;
    ...
    public bool hasAwakeState => ((IEnumerable<int>) SMManager.Get<PlayerAwakeStatePlayerUnitIds>().awake_state_player_unit_ids).Contains<int>(this.id);
    ...
    public static PlayerUnit create_by_unitunit(Helper helper) => new PlayerUnit()
    {
    ...
    public static PlayerUnit create_by_unitunit(Gladiator gladiator) => new PlayerUnit()
    {
    ...
    {
      Dictionary<UnitTypeEnum, PlayerUnit>[] dictionaryArray = new Dictionary<UnitTypeEnum, PlayerUnit>[data.pickup_units.Length];
      for (int index1 = 0; index1 < dictionaryArray.Length; ++index1)
      {
        WebAPI.Response.GachaGetPickupUnitMaxStatusPickup_units pickupUnit = data.pickup_units[index1];
        dictionaryArray[index1] = new Dictionary<UnitTypeEnum, PlayerUnit>(pickupUnit.statuses.Length);
        ...
        for (int index2 = 0; index2 < pickupUnit.statuses.Length; ++index2)
          dictionaryArray[index1].Add((UnitTypeEnum) pickupUnit.statuses[index2].unit_type, PlayerUnit.create_for_pickup(unit, parameterData, job, leaderSkill, skills, pickupUnit.statuses[index2]));
      }
    ...
    public static Dictionary<UnitTypeEnum, PlayerUnit> create_for_pickup_without_param(
      int unitID)
    {
      UnitUnit unit = MasterData.UnitUnit[unitID];
      UnitTypeEnum[] validUnitTypes = unit.validUnitTypes;
      Dictionary<UnitTypeEnum, PlayerUnit> dictionary = new Dictionary<UnitTypeEnum, PlayerUnit>(validUnitTypes.Length);
      UnitUnitParameter parameterData = unit.parameter_data;
      MasterDataTable.UnitJob job = unit.job;
      UnitBattleSkillOrigin[] leaderSkill = unit.MakeLeaderSkillOrigins();
      UnitBattleSkillOrigin[][] skills = unit.MakeSkillOrigins();
      for (int index = 0; index < validUnitTypes.Length; ++index)
        dictionary.Add(validUnitTypes[index], PlayerUnit.create_for_pickup_without_param(unit, validUnitTypes[index], parameterData, job, leaderSkill, skills));
      return dictionary;
    }
    ...
    private static PlayerUnitLeader_skills[] makeLeaderSkillsForPickup(
      UnitBattleSkillOrigin[] skill)
    {
    ...
    public Future<GameObject> LoadEquippedNonShieldGearModel() => this.unit.non_disp_weapon > 0 ? Future.Single<GameObject>((GameObject) null) : MasterData.GearGear[this.equippedWeaponGearOrInitial.ID].LoadModel();

    public Future<GameObject> LoadEquippedGearModel() => this.unit.non_disp_weapon > 0 ? Future.Single<GameObject>((GameObject) null) : MasterData.GearGear[this.equippedGearOrInitial.ID].LoadModel();

    public string getDuelAnimatorControllerName(int metamorId = 0) => this.getGearModelKind(metamorId).duel_animator_controller_name;
    ...
    public string getWinAnimatorControllerName(int metamorId = 0) => this.getGearModelKind(metamorId).winning_animator_controller_name;
    ...
    private UnitUnitGearModelKind getGearModelKind(int metamorId)
    {
      ...
      while (true)
      {
        if (this.isJobChange() || metamorId != 0)
          unitGearModelKind = this.getUnitGearModelKind(gearGear.model_kind, metamorId);
        if (unitGearModelKind == null)
        {
          unitGearModelKind = this.unit.getUnitGearModelKind(gearGear.model_kind);
          if (unitGearModelKind == null && gearGear != this.initial_gear)
    ...
    public UnitUnitGearModelKind getUnitGearModelKind(
    ...
    public Future<UnityEngine.Material> LoadFieldNormalFaceMaterial(int metamorId = 0)
    {
      if (metamorId != 0)
