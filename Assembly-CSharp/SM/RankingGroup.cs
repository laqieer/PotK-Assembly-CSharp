...
namespace SM
{
  ...
  public class RankingGroup : KeyCompare
  {
    ...
    public RankingGroup(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (high_group_ranking)])
        pvPrankingPlayerList1.Add(obj == null ? (PvPRankingPlayer) null : new PvPRankingPlayer((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (top_group_ranking)])
        pvPrankingPlayerList2.Add(obj == null ? (PvPRankingPlayer) null : new PvPRankingPlayer((Dictionary<string, object>) obj));
