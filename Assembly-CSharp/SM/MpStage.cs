...
namespace SM
{
  ...
  public class MpStage : KeyCompare
  {
    ...
    public string victory_condition => Consts.Format(Consts.GetInstance().VERSUS_VICTORY_CONDITION, (IDictionary) new Hashtable()
    {
      {
        (object) "cnt",
    ...
    public string victory_sub_condition => Consts.Format(Consts.GetInstance().VERSUS_VICTORY_SUB_CONDITION1, (IDictionary) new Hashtable()
    {
      {
        (object) "cnt",
        (object) this.turns.ToLocalizeNumberText()
    ...
    public string victory_sub_condition2 => Consts.Format(Consts.GetInstance().VERSUS_VICTORY_SUB_CONDITION2, (IDictionary) new Hashtable()
    {
      {
        (object) "cnt",
        (object) this.turns.ToLocalizeNumberText()
