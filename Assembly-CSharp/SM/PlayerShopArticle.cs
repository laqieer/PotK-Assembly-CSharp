...
namespace SM
{
  ...
  public class PlayerShopArticle : KeyCompare
  {
    ...
    public PlayerShopArticle(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (contents)])
        shopArticleContentsList.Add(obj == null ? (PlayerShopArticleContents) null : new PlayerShopArticleContents((Dictionary<string, object>) obj));
