  ...
  public class HotDealInfo : KeyCompare
  {
    ...
    public HotDealInfo(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (rewards)])
        dealRewardSchemaList.Add(obj == null ? (HotDealRewardSchema) null : new HotDealRewardSchema((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (descriptions)])
        packDescriptionList.Add(obj == null ? (PackDescription) null : new PackDescription((Dictionary<string, object>) obj));
    ...
    public HotdealPack GetHotdealPack() => !this.IsActive ? (HotdealPack) null : MasterData.HotdealPack[this.pack_id];
