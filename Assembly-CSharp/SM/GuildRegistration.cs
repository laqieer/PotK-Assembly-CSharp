...
namespace SM
{
  ...
  public class GuildRegistration : KeyCompare
  {
    ...
    public GuildRegistration(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (hqs)])
        guildHqList.Add(obj == null ? (GuildHq) null : new GuildHq((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (memberships)])
        guildMembershipList.Add(obj == null ? (GuildMembership) null : new GuildMembership((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (applicants)])
        guildApplicantList.Add(obj == null ? (GuildApplicant) null : new GuildApplicant((Dictionary<string, object>) obj));
