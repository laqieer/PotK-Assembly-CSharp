  ...
  public class PlayerUnitReserves : KeyCompare
  {
    ...
    public PlayerUnitReserves(Dictionary<string, object> json)
    {
      ...
      foreach (object obj in (List<object>) json[nameof (leader_skills)])
        reservesLeaderSkillsList.Add(obj == null ? (PlayerUnitReservesLeader_skills) null : new PlayerUnitReservesLeader_skills((Dictionary<string, object>) obj));
      ...
      foreach (object obj in (List<object>) json[nameof (skills)])
        unitReservesSkillsList.Add(obj == null ? (PlayerUnitReservesSkills) null : new PlayerUnitReservesSkills((Dictionary<string, object>) obj));
