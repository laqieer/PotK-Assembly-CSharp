...
public class TweenController : MonoBehaviour
{
  ...
  {
    get => !this.isActive_.HasValue ? (this.isActive_ = new bool?(this.gameObject.activeSelf)).Value : this.isActive_.Value;
    set
    {
  ...
  private void playTweens(bool v)
  {
    ...
    {
      this.tweens_ = NGTween.findTweeners(this.gameObject, this.includeTweenChildren);
  ...
  public void onTweenFinished()
  {
    if (this.isDestroyed_)
      return;
    this.isRunning_ = false;
    this.gameObject.SetActive(this.isActive_.Value);
  }
