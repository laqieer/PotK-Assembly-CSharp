...
public class DetailMenuScrollViewInfo : DetailMenuScrollViewBase
{
  ...
  public void ShowOtherWeapons()
  {
    ...
    this.infoWeapon.gameObject.SetActive(this.isInfoWeapon);
    this.infoOption.gameObject.SetActive(!this.isInfoWeapon);
  }
  ...
  public IEnumerator initializeMagic(
    DetailMenuScrollViewInfo.WeaponRow row,
    PlayerUnitSkills magic)
  {
  ...
  private PlayerUnitSkills getBulletByGear(
    PlayerUnitSkills[] bullets,
    PlayerItem gear)
  {
