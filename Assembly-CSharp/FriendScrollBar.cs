...
public class FriendScrollBar : MonoBehaviour
{
  ...
  public virtual IEnumerator SetUnitIcon()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) friendScrollBar.unitIconPrefab == (UnityEngine.Object) null)
    {
    ...
    {
      if ((UnityEngine.Object) friendScrollBar.unitIcon == (UnityEngine.Object) null)
      ...
      friendScrollBar.unitIcon.onClick = new System.Action<UnitIconBase>(friendScrollBar.\u003CSetUnitIcon\u003Eb__16_0);
    ...
    Future<UnityEngine.Sprite> sprF = EmblemUtility.LoadEmblemSprite(friendScrollBar.friend.current_emblem_id);
    e = sprF.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
