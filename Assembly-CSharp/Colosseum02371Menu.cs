...
public class Colosseum02371Menu : BackButtonMenuBase
{
    ...
    ColosseumUtility.Info colosseumInfo)
  {
    ...
    IEnumerator e = Singleton<CommonRoot>.GetInstance().GetColosseumHeaderComponent().SetInfo(CommonColosseumHeader.BtnMode.Back, new System.Action(colosseum02371Menu.\u003CInitialize\u003Eb__20_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ...
    colosseum02371Menu.RankingBtn.GetComponent<SpreadColorButton>().SetColor(new Color(0.5f, 0.5f, 0.5f));
    colosseum02371Menu.FriendRankibBtn.GetComponent<SpreadColorButton>().SetColor(new Color(0.25f, 0.25f, 0.25f));
  }
  ...
  private IEnumerator InitBottomParts(RankingPlayer rankingData)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) colosseum02371MenuTextParts == (UnityEngine.Object) null)
  ...
  private void DispBottomParts(bool canDisp)
  {
    ...
    UIWidget component = this.ScrollContainer.GetComponent<UIWidget>();
  ...
  public virtual void IbtnRanking()
  {
    if (this.rankingType == Colosseum02371Menu.RANKINGTYPE.RANKING)
      return;
    this.RankingBtn.GetComponent<SpreadColorButton>().SetColor(new Color(0.5f, 0.5f, 0.5f));
    this.FriendRankibBtn.GetComponent<SpreadColorButton>().SetColor(new Color(0.25f, 0.25f, 0.25f));
  ...
  public virtual void IbtnRankingFriend()
  {
    if (this.rankingType == Colosseum02371Menu.RANKINGTYPE.FRIENDRANKING)
      return;
    this.RankingBtn.GetComponent<SpreadColorButton>().SetColor(new Color(0.25f, 0.25f, 0.25f));
    this.FriendRankibBtn.GetComponent<SpreadColorButton>().SetColor(new Color(0.5f, 0.5f, 0.5f));
