...
public class Sea030HomeCallPopup : BackButtonMonoBehaiviour
{
  ...
  private System.Action<SeaHomeManager.UnitConrtolleData> clickCallback;
  ...
  public IEnumerator Init(
    ...
    System.Action<SeaHomeManager.UnitConrtolleData> callback,
    System.Action backButton,
    bool isShowGuestDebug = false)
  {
    ...
    if ((UnityEngine.Object) result != (UnityEngine.Object) null)
    {
      ...
      {
        GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(result);
  ...
  public void Show()
  {
    ...
    UITweener component = this.gameObject.GetComponent<UITweener>();
  ...
  private void ResetUnitIcon(int index)
  {
    ...
    this.displayUnitInfos.Where<Sea030HomeCallPopup.UnitInfo>((Func<Sea030HomeCallPopup.UnitInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon.gameObject)).ForEach<Sea030HomeCallPopup.UnitInfo>((System.Action<Sea030HomeCallPopup.UnitInfo>) (b => b.icon = (GameObject) null));
  }
    ...
    while (true)
    {
      do
      {
        ...
        foreach (GameObject gameObject in this.scroll)
        {
          ...
          {
            int? nullable = this.displayUnitInfos.FirstIndexOrNull<Sea030HomeCallPopup.UnitInfo>((Func<Sea030HomeCallPopup.UnitInfo, bool>) (x => (UnityEngine.Object) x.icon == (UnityEngine.Object) unit));
...
label_27:;
    ...
    PlayerUnit baseUnit = null)
  {
    ...
    this.displayUnitInfos.Where<Sea030HomeCallPopup.UnitInfo>((Func<Sea030HomeCallPopup.UnitInfo, bool>) (a => (UnityEngine.Object) a.icon == (UnityEngine.Object) unitIcon)).ForEach<Sea030HomeCallPopup.UnitInfo>((System.Action<Sea030HomeCallPopup.UnitInfo>) (b => b.icon = (GameObject) null));
    unitIcon.SetCounter(0);
    this.displayUnitInfos[info_index].icon = unitIcon.gameObject;
