...
public class Unit00443Menu : EquipmentDetailMenuBase
{
    ...
    List<InventoryItem> sortGears = null)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) unit00443Menu.scrollObj != (UnityEngine.Object) null)
        unit00443Menu.scrollObj.scrollView.enabled = unit00443Menu.sortGearList.Count > 1;
      ...
      if ((UnityEngine.Object) unit00443Menu.buguDetail == (UnityEngine.Object) null)
      {
      ...
      {
        unit00443Menu.detailObject[index] = UnityEngine.Object.Instantiate<GameObject>(unit00443Menu.buguDetail);
      ...
      unit00443Menu.scrollObj.scrollView.transform.localPosition = new Vector3(-unit00443Menu.scrollObj.grid.cellWidth * (float) unit00443Menu.currentIndex, 0.0f, 0.0f);
      ...
      yield return (object) null;
      if ((UnityEngine.Object) unit00443Menu.nowFavorite != (UnityEngine.Object) null)
      {
    ...
    else
    {
      ...
      else
      {
        ...
        if (unit00443Menu.customGearInfo == null)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          unit00443Menu.reisouIcon.onClick = !(unit00443Menu.is_for_reisou | limited) ? new System.Action<ItemIcon>(unit00443Menu.\u003CSetReisouInfo\u003Eb__73_1) : new System.Action<ItemIcon>(unit00443Menu.\u003CSetReisouInfo\u003Eb__73_0);
          unit00443Menu.reisouIcon.EnableLongPressEventReisou(removeCallback: new System.Action(unit00443Menu.cbRemoveReisou));
        }
        else
        {
          // ISSUE: reference to a compiler-generated method
          unit00443Menu.reisouIcon.onClick = new System.Action<ItemIcon>(unit00443Menu.\u003CSetReisouInfo\u003Eb__73_2);
  ...
  private IEnumerator SetEquipUnit(
    PlayerUnit equiptargets,
    GameCore.ItemInfo targetGear,
    bool limited)
  {
    Unit00443Menu unit00443Menu = this;
    IEnumerator e;
    if ((UnityEngine.Object) unit00443Menu.uniticon == (UnityEngine.Object) null)
    {
    ...
    if (equiptargets == (PlayerUnit) null)
    {
      ...
      if (!targetGear.broken)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        unit00443Menu.uniticon.onClick = new System.Action<UnitIconBase>(unit00443Menu.\u003CSetEquipUnit\u003Eb__75_0);
      }
      else
        unit00443Menu.uniticon.onClick = (System.Action<UnitIconBase>) (_ => {});
    }
    else
    {
      ...
      // ISSUE: reference to a compiler-generated method
      unit00443Menu.uniticon.onClick = new System.Action<UnitIconBase>(unit00443Menu.\u003CSetEquipUnit\u003Eb__75_2);
  ...
  protected void SelectReisou(GameCore.ItemInfo item) => Unit0044ReisouScene.ChangeScene(true, this.RetentionGear, this.reisouInfo);

  protected void InitReisouEmpty()
  {
    this.DirReisou.SetActive(true);
    this.BtnReisou.gameObject.SetActive(true);
    ...
    {
      this.BtnReisou.isEnabled = false;
      this.SlcAddReisou.SetActive(false);
    }
    else
    {
      this.BtnReisou.isEnabled = true;
    ...
    Unit00443Menu.ReisouExpGauge reisouExpGauge)
  {
    ...
    else
    {
      ...
      reisouExpGauge.SlcReisouGauge.width = (int) num;
    }
  }
  ...
  public void cbRemoveReisou()
  {
    ...
    foreach (Component component in this.DynReisouIcon.transform)
      UnityEngine.Object.Destroy((UnityEngine.Object) component.gameObject);
    if ((UnityEngine.Object) this.reisouIcon != (UnityEngine.Object) null)
      UnityEngine.Object.Destroy((UnityEngine.Object) this.reisouIcon);
  ...
  public virtual IEnumerator FavoriteAPI()
  {
    if (this.countChangedSetting != 0)
    {
      ...
      if (source1.Any<int>() || source2.Any<int>())
      {
        ...
        if (!this.isTerminal)
        {
          IEnumerator f = WebAPI.ItemGearFavorite(((IEnumerable<int>) array1).ToArray<int>(), ((IEnumerable<int>) array2).ToArray<int>(), (System.Action<WebAPI.Response.UserError>) (error => WebAPI.DefaultUserErrorCallback(error))).Wait();
          while (f.MoveNext())
  ...
  public virtual void choiceUnitChangeScene() => Unit00468Scene.changeScene004431(true, this.sendParam);
  ...
  public IEnumerator CreatePages(int gearIndex, bool isChangePage = false)
  {
    ...
    Vector3 gridPos = m.scrollObj.grid.transform.localPosition;
    ...
    d.index = gearIndex;
    go.transform.localPosition = new Vector3(m.scrollObj.grid.cellWidth * (float) gearIndex, 0.0f, 0.0f);
    m.scrollObj.grid.transform.localPosition = gridPos;
  ...
  private void UpdateCurrentItem()
  {
    ...
    if ((double) this.scrollObj.scrollView.transform.localPosition.x < 0.0)
    {
      int num2 = (int) Mathf.Abs((this.scrollObj.scrollView.transform.localPosition.x - this.scrollObj.grid.cellWidth / 2f) / this.scrollObj.grid.cellWidth);
    ...
    else
    {
      if (this.isScrollViewDragStarts && this.scrollStartCurrents == this.currentIndex)
      {
        ...
        double num2 = -(double) this.scrollObj.grid.cellWidth * (double) this.currentIndex;
        float num3 = this.scrollObj.grid.cellWidth * 0.25f;
        float num4 = (float) num2 - num3;
        float num5 = (float) num2 + num3;
        if ((double) this.scrollObj.scrollView.transform.localPosition.x <= (double) num4)
          ++currentIndex;
        else if ((double) this.scrollObj.scrollView.transform.localPosition.x >= (double) num5)
          --currentIndex;
  ...
  private void SetMenuInformation(int idx)
  {
    ...
    if ((UnityEngine.Object) this.rightArrows != (UnityEngine.Object) null)
      this.rightArrows.SetActive(true);
    if ((UnityEngine.Object) this.leftArrows != (UnityEngine.Object) null)
      this.leftArrows.SetActive(true);
    if (idx == 0 && (UnityEngine.Object) this.leftArrows != (UnityEngine.Object) null)
      this.leftArrows.SetActive(false);
    if (idx == this.sortGearList.Count - 1 && (UnityEngine.Object) this.rightArrows != (UnityEngine.Object) null)
  ...
  private IEnumerator RefreshInfo()
  {
    ...
    if ((UnityEngine.Object) unit00443Menu.nowFavorite != (UnityEngine.Object) null)
    {
      unit00443Menu.nowFavorite.gameObject.SetActive(unit00443Menu.RetentionGear.favorite);
      unit00443Menu.yetFavorite.gameObject.SetActive(!unit00443Menu.RetentionGear.favorite);
    }
