...
public class FullScreenRGBSeparation : MonoBehaviour
{
  ...
  private UnityEngine.Material GetFullScreenRGBSeparationMaterial()
  {
    if ((Object) UnityEngine.Shader.Find("Custom/FullScreenRGBSeparation") == (Object) null)
    {
      Debug.Log((object) "Shader not found!");
      return (UnityEngine.Material) null;
    }
    UnityEngine.Material material = new UnityEngine.Material(UnityEngine.Shader.Find("Custom/FullScreenRGBSeparation"));
