...
public class CommonGuildButton : MypageEventButton
{
  ...
  public IEnumerator UpdateButtonState(WebAPI.Response.GuildTop guildTopResponse)
  {
    ...
    {
      Future<UnityEngine.Sprite> ft = new ResourceObject(string.Format("Prefabs/Banners/RaidButton/{0}/ibtn_Raid", (object) guildRaidPeriod.button_id)).Load<UnityEngine.Sprite>();
  ...
  public override bool IsActive() => this.mGuildTopResponse == null || this.mGuildTopResponse.raid_period == null;
  ...
  public void SetGuildFooterBadgeLabel(GuildUtil.GuildBadgeLabelType labelType)
  {
    ...
    this.guildBtnSprite.gameObject.GetComponent<UIButton>().normalSprite = "ibtn_guild_Change.png__GUI__mypage_sozai__mypage_sozai_prefab";
    this.guildBtnSprite.gameObject.GetComponent<UIButton>().pressedSprite = "ibtn_guild_Change.png__GUI__mypage_sozai__mypage_sozai_prefab";
    this.guildBtnSprite.MakePixelPerfect();
    ...
    if (labelType != GuildUtil.GuildBadgeLabelType.prepare && labelType != GuildUtil.GuildBadgeLabelType.battle)
      return;
    this.guildBtnSprite.gameObject.GetComponent<UIButton>().normalSprite = "ibtn_GuildBattle_myapage.png__GUI__mypage_sozai__mypage_sozai_prefab";
    this.guildBtnSprite.gameObject.GetComponent<UIButton>().pressedSprite = "ibtn_GuildBattle_myapage.png__GUI__mypage_sozai__mypage_sozai_prefab";
    this.guildBtnSprite.SetDimensions(110, 142);
    this.mNormalObj.SetActive(true);
    this.mRaidObj.SetActive(false);
  }
}
