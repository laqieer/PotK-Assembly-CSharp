...
public class DuelDemoSettings
{
  ...
  public Future<DuelResult> makeResult(
    PlayerUnit target,
  ...
  private BattleStage battleStage => Array.Find<BattleStage>(MasterData.BattleStageList, (Predicate<BattleStage>) (x => x.map_BattleMap == this.mapID));
  ...
  public DuelEnvironment makeEnvironment() => new DuelEnvironment()
  {
  ...
  public void playBGM()
  {
    ...
    if (string.IsNullOrEmpty(this.bgmName) || (UnityEngine.Object) (instance = Singleton<NGSoundManager>.GetInstance()) == (UnityEngine.Object) null)
      return;
