...
public class Bugu00561Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_6_1", stack);

  public static void changeScene(bool stack, ItemInfo item) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_6_1", (stack ? 1 : 0) != 0, (object) item);

  public static void changeScene(bool stack, ItemInfo item, bool isNew, bool isScreenTouch) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_6_1", (stack ? 1 : 0) != 0, (object) item, (object) isNew, (object) isScreenTouch);
  ...
  public static void changeScene(bool stack, ItemInfo item, ItemInfo[] items, int index) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_6_1", (stack ? 1 : 0) != 0, (object) item, (object) items, (object) index);
    ...
    int counter)
  {
    ...
    if (isGacha)
    {
      ...
      bugu00561Scene.backgroundPrefab.GetComponent<UI2DSprite>().color = Consts.GetInstance().GACHA_RESULT_BACKGROUND_COLOR;
