...
public class RaidBattlePreparationPopup : MonoBehaviour
{
    ...
    string recommendCombat)
  {
    ...
    if ((bool) (UnityEngine.Object) parent.toggleAuto_)
  ...
  private void Update()
  {
    if (!(bool) (UnityEngine.Object) this.toggleAuto_ || this.saveData_ == null || this.saveData_.isAutoBattle == this.toggleAuto_.isSwitch)
      return;
