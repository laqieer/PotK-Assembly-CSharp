...
public class Shop00742CommonTicket : MonoBehaviour
{
  ...
  private IEnumerator doGachaTicket(int entity_id)
  {
    ...
    Future<UnityEngine.Sprite> r = gachaTicket.LoadSpriteOrDefault();
  ...
  private IEnumerator doUnitTicket(int entity_id)
  {
    ...
    if (MasterData.SelectTicket.TryGetValue(entity_id, out selectTicket))
    {
      ...
      Future<UnityEngine.Sprite> r = selectTicket.createLoaderThumb();
  ...
  private IEnumerator doTicket(int entity_id)
  {
    ...
    Future<UnityEngine.Sprite> r = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("ReincarnationTypeTicket/{0}/ticket", (object) unitTypeTicket.icon_id));
    IEnumerator e = r.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator doRecoveryItem(int entity_id)
  {
    ...
    Future<UnityEngine.Sprite> r = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(string.Format("AssetBundle/Resources/recovery_item/{0}/2D/item_thum", (object) entity_id));
    IEnumerator e = r.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private IEnumerator doCommonTicket(int entity_id)
  {
    ...
    if (commonTicket != null)
    {
      ...
      Future<UnityEngine.Sprite> r = commonTicket.LoadIconMSpriteF();
      IEnumerator e = r.Wait();
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
