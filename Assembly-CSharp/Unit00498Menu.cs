...
public class Unit00498Menu : BackButtonMenuBase
{
  ...
  private IEnumerator OpenJobChangeXTutorial()
  {
    ...
    e = popup.GetComponent<SimpleScrollContentsPopup>().Initialize(new System.Action(unit00498Menu.\u003COpenJobChangeXTutorial\u003Eb__28_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  private void SetMaxLv(int beforeLv, int afterLv)
  {
    ...
    this.maxLevelLabel.color = beforeLv < afterLv ? Color.yellow : Color.white;
  }
    ...
    Unit00499Scene.Mode mode)
  {
    ...
    if (mode == Unit00499Scene.Mode.Transmigration)
      this.jobNameLabel.color = Color.white;
    if ((UnityEngine.Object) this.jobRankLabel != (UnityEngine.Object) null)
    ...
    if ((UnityEngine.Object) this.DirAnimRevival != (UnityEngine.Object) null)
      this.DirAnimRevival.SetActive(false);
    if ((UnityEngine.Object) this.DirAnimEvolutionX != (UnityEngine.Object) null)
    ...
    if (mode == Unit00499Scene.Mode.JobChange)
    {
      ...
      else
      {
        ...
        if (unitFamilyValues1.Length == 1)
        {
          ...
          this.topAfterFamilies.transform.localPosition = (Vector3) new Vector2(this.localXBeforeSingleFamily, this.topAfterFamilies.transform.localPosition.y);
        }
        else if (this.localXBeforeDoubleFamily.HasValue)
          this.topAfterFamilies.transform.localPosition = (Vector3) new Vector2(this.localXBeforeDoubleFamily.Value, this.topAfterFamilies.transform.localPosition.y);
    ...
    int now)
  {
    ...
    if (!((UnityEngine.Object) resultParameter != (UnityEngine.Object) null))
      return;
    resultParameter.color = now == prev ? Color.white : (now > prev ? Color.yellow : Color.red);
  }
