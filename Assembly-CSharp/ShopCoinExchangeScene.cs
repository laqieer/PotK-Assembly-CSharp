...
public class ShopCoinExchangeScene : NGSceneBase
{
  ...
  public static void changeScene(bool isStack = true) => Singleton<NGSceneManager>.GetInstance().changeScene(ShopCoinExchangeScene.SCENE_NAME, isStack);

  public static void changeScene(int id, bool isStack = true) => Singleton<NGSceneManager>.GetInstance().changeScene(ShopCoinExchangeScene.SCENE_NAME, (isStack ? 1 : 0) != 0, (object) id);
