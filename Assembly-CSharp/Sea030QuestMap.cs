...
public class Sea030QuestMap : NGMenuBase
{
  ...
  private UIScrollView scrollView => !((UnityEngine.Object) this.scrollView_ != (UnityEngine.Object) null) ? (this.scrollView_ = NGUITools.FindInParents<UIScrollView>(this.gameObject)) : this.scrollView_;
  ...
  private IEnumerator StoryChoiceButtonSetting(
    ...
    int Mid)
  {
    List<Tuple<GameObject, bool>> source = new List<Tuple<GameObject, bool>>(this.storyList.Length);
    ...
    for (int i = 0; i < this.storyList.Length; i++)
    {
      ...
      if (storyData != null && storyData.Length != 0)
      {
        ...
        int cnt = 0;
        ((IEnumerable<GameObject>) storyInst.storyM).ForEach<GameObject, PlayerSeaQuestS>((IEnumerable<PlayerSeaQuestS>) storyData, (System.Action<GameObject, PlayerSeaQuestS>) ((storyM, storyDataM) =>
        {
          PlayerSeaQuestS[] playerSeaQuestSArray = StoryData.S(this.XL_, storyInst.L, storyDataM.quest_sea_s.quest_m_QuestSeaM);
          bool clearflag = ((IEnumerable<PlayerSeaQuestS>) playerSeaQuestSArray).All<PlayerSeaQuestS>((Func<PlayerSeaQuestS, bool>) (x => x.is_clear));
          ...
          if (storyInst.line.Length != 0 && (UnityEngine.Object) storyInst.line[cnt] != (UnityEngine.Object) null)
          ...
          QuestSeaS questSeaS = playerSeaQuestSArray[0].quest_sea_s;
          ...
          if ((UnityEngine.Object) slcPointerArea != (UnityEngine.Object) null)
            slcPointerArea.SetActive(!clearflag);
          ++cnt;
        }));
        int lastIndex = clearedList.FindLastIndex((Predicate<Tuple<GameObject, bool>>) (x => x.Item2));
        source.Add(clearedList[lastIndex == clearedList.Count - 1 ? lastIndex : lastIndex + 1]);
        ...
        for (int index = 0; index < storyInst.storyM.Length && index < array.Length; ++index)
        {
          ...
          if (playerSeaQuestSArray.Length != 0)
            this.MissionAchievementRate(playerSeaQuestSArray[0], storyInst.storyM[index].transform.GetComponentInChildren<Sea030StoryButton>());
        }
      }
    }
    if ((UnityEngine.Object) lastSelect != (UnityEngine.Object) null)
      this.lastButton = lastSelect;
    else if (source.Any<Tuple<GameObject, bool>>())
    {
      int lastIndex = source.FindLastIndex((Predicate<Tuple<GameObject, bool>>) (y => y.Item2));
      this.lastButton = source[lastIndex == source.Count - 1 ? lastIndex : lastIndex + 1].Item1;
    }
    else
    {
  ...
  private void TweenMap(int L, int M, int tweenIndex)
  {
    ...
    EventDelegate.Set(orAddComponent1.onFinished, (EventDelegate.Callback) (() => this.ChangeScene(L, M)));
    ...
    int Mid = 0)
  {
    ...
    else
    {
      ...
      else if ((UnityEngine.Object) sea030QuestMap1.tweenObject != (UnityEngine.Object) null)
      ...
      {
        if ((bool) (UnityEngine.Object) sea030QuestMap1.currentTweenPos)
        {
            ...
            if (array.Length != 0)
            {
              ...
              foreach (GameObject gameObject in storyInst.storyM)
              {
                ...
                if ((UnityEngine.Object) componentInChildren != (UnityEngine.Object) null)
                  sea030QuestMap1.destroyObject(componentInChildren.gameObject);
        ...
        if (isTowerOpen)
        {
          ...
          Sea030StoryTowerButton componentInChildren = transform.GetComponentInChildren<Sea030StoryTowerButton>();
          if ((UnityEngine.Object) componentInChildren != (UnityEngine.Object) null)
            sea030QuestMap1.destroyObject(componentInChildren.gameObject);
      ...
      else if ((bool) (UnityEngine.Object) sea030QuestMap1.currentTweenPos)
      {
        // ISSUE: reference to a compiler-generated method
        EventDelegate.Set(sea030QuestMap1.currentTweenPos.onFinished, new EventDelegate.Callback(sea030QuestMap1.\u003CInit\u003Eb__44_0));
        sea030QuestMap1.currentTweenScale.PlayReverse();
        sea030QuestMap1.currentTweenPos.PlayReverse();
      }
      else
      ...
      if (StoryData != null)
      {
        for (int index1 = 0; index1 < sea030QuestMap1.storyList.Length; ++index1)
        {
          ...
          if (array.Length != 0)
          {
            ...
            {
              if (index2 < storyInst.storyM.Length)
              {
  ...
  public void activateEffects(bool bEnable)
  {
    ...
    else
    {
      ...
      {
        if (!((UnityEngine.Object) effect == (UnityEngine.Object) null) && effect.activeSelf)
          source.AddRange(effect.transform.GetChildren().Select<Transform, GameObject>((Func<Transform, GameObject>) (x => x.gameObject)).Where<GameObject>((Func<GameObject, bool>) (y => y.gameObject.activeSelf && (UnityEngine.Object) y.gameObject.GetComponent<ParticleSystem>() != (UnityEngine.Object) null)));
      }
