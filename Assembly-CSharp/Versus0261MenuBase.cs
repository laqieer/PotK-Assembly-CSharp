...
public class Versus0261MenuBase : NGMenuBase
{
  ...
  public virtual void IbtnRundomMatch() => Debug.Log((object) "click default event IbtnRundomMatch");

  public virtual void IbtnFriendMatch() => Debug.Log((object) "click default event IbtnFriendMatch");
