...
public class Unit05499Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, PlayerUnit selectUnit) => Singleton<NGSceneManager>.GetInstance().changeScene("unit054_9_9", (stack ? 1 : 0) != 0, (object) selectUnit);
