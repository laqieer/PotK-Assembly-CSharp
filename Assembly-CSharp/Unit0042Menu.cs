...
public class Unit0042Menu : BackButtonMenuBase
{
  ...
  public PlayerUnit CurrentUnit => this.unitList == null || this.unitList.Length <= this.currentIndex ? (PlayerUnit) null : this.unitList[this.currentIndex];

  public GameObject CurrentScrollObject => this.detailMenuPrefabDict == null || this.CurrentIndex < 0 ? (GameObject) null : this.detailMenuPrefabDict.FirstOrDefault<KeyValuePair<GameObject, DetailMenuPrefab>>((Func<KeyValuePair<GameObject, DetailMenuPrefab>, bool>) (x => x.Value.Index == this.CurrentIndex)).Key;
  ...
  public virtual Control controlFlags => !this.controlFlags_.HasValue ? (this.controlFlags_ = new Control?(this.GetComponent<Unit0042Scene>().bootParam.controlFlags)).Value : this.controlFlags_.Value;
  ...
  private void OnCocFinished()
  {
    ...
    if (!(bool) (UnityEngine.Object) centeredObject1)
      return;
    ...
    if (!(bool) (UnityEngine.Object) componentInChildren2 || !(bool) (UnityEngine.Object) (centeredObject2 = componentInChildren2.centeredObject) || !(bool) (UnityEngine.Object) (component = centeredObject2.GetComponent<DetailMenuScrollViewBase>()))
      return;
  ...
  private void SetTitleBarInfo(bool isSe, PlayerUnit target = null)
  {
    ...
    if ((UnityEngine.Object) this.btnCallSkill != (UnityEngine.Object) null)
    {
      ...
      switch (index)
      {
        case 0:
          EventDelegate.Set(this.btnToJobChange_.onClick, (EventDelegate.Callback) (() =>
          {
            if (this.IsPushAndSet())
              return;
            Unit004JobChangeScene.changeScene(true, target.id, eventBackScene: ((System.Action) (() =>
            {
              if (!Singleton<NGSceneManager>.GetInstance().SceneStack.Any<NGSceneManager.SceneWrapper>())
              {
                ...
                if (aliveSceneLog != null && aliveSceneLog.args[2] is Unit0042Scene.BootParam bootParam)
    ...
    if (!((UnityEngine.Object) this.zoomBtn != (UnityEngine.Object) null))
      return;
  ...
  private IEnumerator doMoveUnitPage(PlayerUnit target, System.Action actMoveFinished)
  {
    ...
    else
    {
      ...
      if ((UnityEngine.Object) this.bottomBase != (UnityEngine.Object) null)
      {
        this.centerStatus = -1;
...
label_8:
  ...
  public void UploadFavorites(System.Action endWait) => this.StartCoroutine(this.doUploadFavorites(endWait));

  public IEnumerator doUploadFavorites(System.Action endWait = null)
  {
    if (this.countChangedSetting == 0)
    {
      System.Action action = endWait;
      if (action != null)
        action();
    }
    else
    ...
    PlayerUnit baseUnit = null)
  {
    ...
    unit0042Menu.isControlledJobChange_ = (bool) (UnityEngine.Object) unit0042Menu.btnToJobChange_;
    if (unit0042Menu.isControlledJobChange_)
    {
      ...
      unit0042Menu.topJobChangeButton_.GetComponent<UIWidget>().alpha = 1f;
    }
    ...
    if ((UnityEngine.Object) unit0042Menu.btnRecommend != (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit0042Menu.bottomBase != (UnityEngine.Object) null)
    {
      ...
      {
        foreach (GameObject gameObject in unit0042Menu.dicBottomTweenParts.Values.Select<NGTweenParts, GameObject>((Func<NGTweenParts, GameObject>) (x => !((UnityEngine.Object) x != (UnityEngine.Object) null) ? (GameObject) null : x.gameObject)))
        {
    ...
    unit0042Menu.isDisabledScroll = !unit0042Menu.scrollView.scrollView.enabled || unit0042Menu.unitList.Length <= 1;
    unit0042Menu.wheelLog = !unit0042Menu.isDisabledScroll ? unit0042Menu.scrollView.scrollView.GetComponent<WheelScrollLog>() : (WheelScrollLog) null;
    ...
    {
      if ((bool) (UnityEngine.Object) unit0042Menu.btnFavoritedOff)
        unit0042Menu.btnFavoritedOff.GetComponentInChildren<UIButton>(true).isEnabled = false;
      if ((bool) (UnityEngine.Object) unit0042Menu.btnFavoritedOn)
        unit0042Menu.btnFavoritedOn.GetComponentInChildren<UIButton>(true).isEnabled = false;
    }
  }

  public virtual IEnumerator CreatePage(
    int unitIdx,
    bool isUpdate = true,
    bool isDownloadResourceCheck = false)
  {
  ...
  private IEnumerator downloadOwnResource(int targetIndex)
  {
    ...
    if (!unit0042Menu.IsLimitMode)
    {
      ...
      UnitUnit[] array = source.Where<PlayerUnit>((Func<PlayerUnit, bool>) (x => x != (PlayerUnit) null && x.job_abilities != null && (uint) x.job_abilities.Length > 0U)).SelectMany<PlayerUnit, UnitUnit>(new Func<PlayerUnit, IEnumerable<UnitUnit>>(unit0042Menu.\u003CdownloadOwnResource\u003Eb__239_1)).Distinct<UnitUnit>().ToArray<UnitUnit>();
      if (array.Length != 0)
  ...
  private IEnumerator doStartStatusPanel(GameObject go, bool bImmediate)
  {
    ...
    if (unit0042Menu.dicStatusMode[go] == Unit0042Menu.StatusMode.FadeOut)
    {
      ...
      else
      {
        ...
        if (bImmediate)
        {
          dicBottomTweenPart.GetComponent<UIRect>().alpha = 1f;
          dicBottomTweenPart.resetActive(true);
        }
        else
        {
          dicBottomTweenPart.GetComponent<UIRect>().alpha = 0.0f;
      ...
      switch (this.dicStatusMode[key])
      {
        ...
        case Unit0042Menu.StatusMode.FadeIn:
          ...
          if (bImmediate)
          {
            ...
            this.dicBottomTweenParts[key].GetComponent<UIRect>().alpha = 0.0f;
            continue;
          }
  ...
  public bool CheckLength(PlayerUnit[] playerUnits) => this.unitList == null || this.unitList.Length == playerUnits.Length;
  ...
  private IEnumerator updatePages(List<int> unitIdxs, bool bCrossFade)
  {
    ...
    foreach (Transform child in menu.scrollView.grid.transform.GetChildren())
    {
      DetailMenuPrefab script = menu.detailMenuPrefabDict[child.gameObject];
      if (unitIdxs.Contains(script.Index))
      {
        ...
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        script.transform.localPosition = new Vector3(menu.scrollView.grid.cellWidth * (float) script.Index, 0.0f, 0.0f);
      }
  ...
  private IEnumerator updatePageForEarth(List<int> unitIdxs)
  {
    ...
    {
      DetailMenuPrefab script = menu.detailMenuPrefabDict[transform.gameObject];
      if (unitIdxs.Contains(script.Index))
      {
  ...
  {
    if (!this.isEnabledRecommend || this.recommendPrefabs == null || (UnityEngine.Object) this.recommendPrefabs[0] == (UnityEngine.Object) null)
      return;
  ...
  private static System.Action<GameObject[], NGMenuBase> actionPopupRecommend(
    int playerUnitId,
    bool bReturnScene)
  {
    return !bReturnScene ? (System.Action<GameObject[], NGMenuBase>) ((prefabs, menu) =>
    {
    ...
    }) : (System.Action<GameObject[], NGMenuBase>) ((prefabs, menu) =>
    {
      PlayerUnit playerUnit = Array.Find<PlayerUnit>(SMManager.Get<PlayerUnit[]>(), (Predicate<PlayerUnit>) (x => x.id == playerUnitId));
      if (!(playerUnit != (PlayerUnit) null) || prefabs.Length == 0)
        return;
  ...
  private static System.Action<GameObject[], NGMenuBase> actionPopupReturnRecommendQuest(
    int playerUnitId)
  {
    return (System.Action<GameObject[], NGMenuBase>) ((prefabs, menu) =>
    {
      PlayerUnit playerUnit = Array.Find<PlayerUnit>(SMManager.Get<PlayerUnit[]>(), (Predicate<PlayerUnit>) (x => x.id == playerUnitId));
      if (!(playerUnit != (PlayerUnit) null) || prefabs.Length == 0)
        return;
  ...
  private static System.Action createActionOnChangeScene(PlayerUnit unit) => (System.Action) (() =>
  {
  ...
  private static System.Action<System.Action> createActionOnChangeQuest(
    NGMenuBase menu,
    PlayerUnit unit)
  {
    return (System.Action<System.Action>) (endWait =>
    {
      NGSceneManager instance = Singleton<NGSceneManager>.GetInstance();
      Unit0042Menu unit0042Menu = (Unit0042Menu) menu;
      if ((UnityEngine.Object) unit0042Menu != (UnityEngine.Object) null)
      {
  ...
  public void IbtnGroupOpen()
  {
    ...
    NGTween.playTweens(this.GetComponentsInChildren<UITweener>(true), 100);
  ...
  public void IbtnGroupClose()
  {
    if (this.isGroupTween || !this.isGroupOpen)
      return;
    NGTween.playTweens(this.GetComponentsInChildren<UITweener>(true), 101);
  ...
  private float getGroupHeightTarget() => (float) ((double) this.groupBaseHeightInit + (double) this.groupSpriteHeight * (double) this.dispGroupCount + 8.0);

  private float getGroupPositionTarget() => 0.0f;

  private float getGroupPositionInit() => (float) (-(double) this.groupSpriteHeight * (double) this.dispGroupCount - 8.0);
  ...
  private IEnumerator OpenCallSkillPopup()
  {
    ...
    if (key != 0)
    {
      ...
      if ((UnityEngine.Object) unit0042Menu.popupCallSkillDetailsPrefab == (UnityEngine.Object) null)
      {
  ...
  private void resetScrollViewPosition(Vector3 target) => this.scrollView.scrollView.ResetHorizontalCenter(target.x);
  ...
  {
    if (!(bool) (UnityEngine.Object) this.questMenu_ || !this.questMenu_.gameObject.activeSelf)
      return;
    this.questMenu_.Hide();
  }

  public void showCharacterQuests(PlayerUnit playerUnit) => Unit0042Menu.createMethodPopupCharacterQuests(playerUnit.id)((GameObject[]) null, (NGMenuBase) this);

  private static System.Action<GameObject[], NGMenuBase> createMethodPopupCharacterQuests(
    int playerUnitId)
  {
    return (System.Action<GameObject[], NGMenuBase>) ((prefabs, mb) =>
    {
      Unit0042Menu unit0042Menu = (Unit0042Menu) mb;
      if ((bool) (UnityEngine.Object) unit0042Menu.questMenu_ && unit0042Menu.questMenu_.gameObject.activeSelf)
        return;
      PlayerUnit playerUnit = Array.Find<PlayerUnit>(SMManager.Get<PlayerUnit[]>(), (Predicate<PlayerUnit>) (x => x.id == playerUnitId));
  ...
  private IEnumerator doShowCharacterQuests(PlayerUnit playerUnit)
  {
    ...
    bool bLoading = false;
    IEnumerator e;
    if (!(bool) (UnityEngine.Object) unit0042Menu.questMenu_)
    {
      ...
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      GameObject go = ld.Result.Clone(unit0042Menu.transform.Find("MainPanel"));
      ...
      rTop.alpha = 1f;
      unit0042Menu.GetComponent<Unit0042Scene>().entryMenu((NGMenuBase) unit0042Menu.questMenu_);
    ...
    if (unit0042Menu.questDatas_ == null || Unit0042Menu.isRequestedResetCharacterQuests)
    {
      ...
      if (!bLoading)
        Singleton<CommonRoot>.GetInstance().ShowLoadingLayer(1);
      bLoading = true;
      Future<WebAPI.Response.QuestProgressCharacter> webApi = WebAPI.QuestProgressCharacter((System.Action<WebAPI.Response.UserError>) (err =>
      {
    ...
    e = unit0042Menu.questMenu_.showPopup(quest.unit_UnitUnit, unit0042Menu.questDatas_, (System.Action<System.Action>) (endWait =>
    {
  ...
  private IEnumerator doChangeJob(int jobId)
  {
    ...
    for (int index = 0; index < confirmPopupArray.Length; ++index)
    {
      ...
      if (confirmPopup2.checkOpen())
      {
        bool bWait = true;
        bool bCancel = false;
        PopupCommonNoYes.Show(confirmPopup2.title, confirmPopup2.desc, (System.Action) (() => bWait = false), (System.Action) (() =>
        {
          bCancel = true;
          bWait = false;
        }));
    ...
    unit0042Menu.StartCoroutine(unit0042Menu.doInitializeEffectJobChange((System.Action<SimpleEffectJobChange>) (s => effect = s)));
    CommonRoot cRoot = Singleton<CommonRoot>.GetInstance();
    cRoot.ShowLoadingLayer(1, true);
    bool bWait1 = true;
    unit0042Menu.StartCoroutine(unit0042Menu.doUploadFavorites((System.Action) (() => bWait1 = false)));
    while (bWait1)
      yield return (object) null;
    Future<WebAPI.Response.UnitJobchange> future = WebAPI.UnitJobchange(playerUnit.id, new int[0], jobId, (System.Action<WebAPI.Response.UserError>) (error =>
    {
    ...
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    while (!(bool) (UnityEngine.Object) effect)
      yield return (object) null;
    if (future.Result != null)
    {
      ...
      if ((bool) (UnityEngine.Object) unit0042Menu.topJobChangeButton_)
  ...
  private IEnumerator doInitializeEffectJobChange(
    System.Action<SimpleEffectJobChange> eventReady)
  {
    IEnumerator e;
    if (!(bool) (UnityEngine.Object) this.prefabEffectJobChange_)
    {
