...
public class Bugu00539Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, Bugu00539ChangeSceneParam param) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_3_9", (stack ? 1 : 0) != 0, (object) param);
  ...
  public IEnumerator onStartSceneAsync(Bugu00539ChangeSceneParam param)
  {
    ...
    IEnumerator e;
    if ((Object) this.armorSythesisAnimationPrefab == (Object) null)
    {
    ...
    if ((Object) this.menu.effect == (Object) null)
