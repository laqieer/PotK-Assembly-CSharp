...
public class TutorialRoot : Singleton<TutorialRoot>
{
  ...
  private GameObject wrap => this.mainPanel.gameObject;
  ...
  private IEnumerator initAsync()
  {
    ...
    tutorialRoot.progress.OnNextPageCallback = new System.Action(tutorialRoot.\u003CinitAsync\u003Eb__39_1);
    tutorialRoot.progress.OnFinishCallback = new System.Action(tutorialRoot.finish);
  ...
  private void finish()
  {
    ...
    this.wrap.SetActive(false);
    this.wrap.SetActive(false);
    this.StartCoroutine(this.signUpLoop(true, (System.Action) (() =>
    {
      this.endTutorial();
      Singleton<CommonRoot>.GetInstance().isTouchBlock = false;
  ...
  public IEnumerator signUpLoop(bool isFinish, System.Action callback)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        PopupCommonOkTitle.Show(instance.tutorial_fail_signup_title, instance.tutorial_fail_signup_text, (System.Action) (() => this.StartCoroutine(this.signUpLoop(isFinish, callback))), (System.Action) (() =>
        {
  ...
  public IEnumerator debugTutorialGacha()
  {
    if (!Persist.newTutorialGacha.Data.tutorialGacha)
    {
      this.setTutorialGachaModule();
      GachaModule[] gachaModuleArray = SMManager.Get<GachaModule[]>();
      if (gachaModuleArray != null && ((IEnumerable<GachaModule>) gachaModuleArray).Any<GachaModule>())
      {
        IEnumerator e = GachaPlay.GetInstance().ChargeGacha("g030_tutorial", 10, gachaModuleArray[0].gacha[0].id, (MasterDataTable.GachaType) 30, 1);
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
      }
  ...
  public bool FirstAnnihilated(BL env)
  {
    ...
    {
      Singleton<NGBattleManager>.GetInstance().isBattleEnable = false;
      if (!this.ShowAdvice("firstgameover", finishCallback: ((System.Action) (() => Singleton<NGBattleManager>.GetInstance().isBattleEnable = true))))
      {
  ...
  public bool isReadHint(string sceneName, int id) => string.IsNullOrEmpty(this.getTipsMessage(sceneName, id));
  ...
  public bool ForceShowAdvice(string sceneName = null, System.Action finishCallback = null) => this.ForceShowAdviceInNextButton(sceneName, finishCallback: finishCallback);
  ...
  private IEnumerator bulkDownLoadCheck()
  {
    ...
    {
      // ISSUE: reference to a compiler-generated method
      PopupCommonYesNo.Show(instance.bulk_download_title, instance.bulkDownloadText(requiredSize), new System.Action(tutorialRoot.\u003CbulkDownLoadCheck\u003Eb__74_0), (System.Action) (() => {}));
    }
    else
