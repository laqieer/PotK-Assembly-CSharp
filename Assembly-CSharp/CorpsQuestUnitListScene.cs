...
public class CorpsQuestUnitListScene : NGSceneBase
{
  ...
  public static void ChangeScene(int periodId) => Singleton<NGSceneManager>.GetInstance().changeScene("CorpsQuest_unit_list", true, (object) periodId);
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    questUnitListScene.menu = questUnitListScene.menuBase.GetComponent<CorpsQuestUnitListMenu>();
