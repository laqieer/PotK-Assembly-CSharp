...
public class Popup004UnitTransformConfirm : BackButtonMenuBase
{
  ...
  private IEnumerator StorageIn()
  {
    ...
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      transformConfirm.storageUnitIcons.ForEach((System.Action<PlayerUnit>) (ic =>
      {
      ...
      Future<WebAPI.Response.UnitReservesAdd> ft = WebAPIUtil.UnitReservesAdd(player_unit_ids.ToArray(), new System.Action<WebAPI.Response.UserError>(transformConfirm.\u003CStorageIn\u003Eb__8_1));
  ...
  private IEnumerator StorageOut()
  {
    ...
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      Future<WebAPI.Response.UnitReservesRestore> ft = WebAPI.UnitReservesRestore(player_unit_ids.ToArray(), new System.Action<WebAPI.Response.UserError>(transformConfirm.\u003CStorageOut\u003Eb__9_1));
      IEnumerator e1 = ft.Wait();
      while (e1.MoveNext())
        yield return e1.Current;
      e1 = (IEnumerator) null;
  ...
  public void IbtnYes()
  {
    switch (this.confirmMode)
    {
      case Popup004UnitTransformConfirm.StorageConfirmMode.StorageIn:
        if (this.isMemoryAlert)
        {
          this.txtDescription.gameObject.SetActive(false);
  ...
  public IEnumerator UpdateList()
  {
    Popup004UnitTransformConfirm transformConfirm = this;
    PlayerUnit[] playerUnits = SMManager.Get<PlayerUnit[]>();
    IEnumerator e1 = WebAPI.UnitReservesCount((System.Action<WebAPI.Response.UserError>) (e =>
    {
      Singleton<CommonRoot>.GetInstance().loadingMode = 0;
      WebAPI.DefaultUserErrorCallback(e);
    })).Wait();
