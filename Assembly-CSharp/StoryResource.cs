...
public class StoryResource
{
  ...
  public UnityEngine.Sprite GetLargeTexture(int character_id) => this.unitResource(character_id).Large;
  ...
  private IEnumerator dispatch(Cons cons)
  {
    ...
    else if (cons.cdr is Cons cdr && (car == "chara" || car == "body" || car == "entry"))
    {
      Decimal? car1 = cdr.car as Decimal?;
      if (!car1.HasValue)
      {
      ...
      else
      {
        ...
        if (!this.unitResources.ContainsKey(character_id))
        {
          ...
          Future<UnityEngine.Sprite> fLarge;
          if (character_id <= 999)
          {
          ...
          fLarge = (Future<UnityEngine.Sprite>) null;
        }
      }
    }
  }
  ...
  private class UnitResource
  {
    ...
    public readonly UnityEngine.Sprite Large;

    public UnitResource(GameObject prefab, UnityEngine.Sprite large)
    {
      this.Prefab = prefab;
      this.Large = large;
    }
