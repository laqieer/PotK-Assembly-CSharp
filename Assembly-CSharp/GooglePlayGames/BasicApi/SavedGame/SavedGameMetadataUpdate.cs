...
namespace GooglePlayGames.BasicApi.SavedGame
{
  public struct SavedGameMetadataUpdate
  {
    ...
    public struct Builder
    {
      ...
      public SavedGameMetadataUpdate.Builder WithUpdatedDescription(
        string description)
      {
      ...
      public SavedGameMetadataUpdate.Builder WithUpdatedPngCoverImage(
      ...
      public SavedGameMetadataUpdate.Builder WithUpdatedPlayedTime(
        TimeSpan newPlayedTime)
      {
        this.mNewPlayedTime = newPlayedTime.TotalMilliseconds <= 1.84467440737096E+19 ? new TimeSpan?(newPlayedTime) : throw new InvalidOperationException("Timespans longer than ulong.MaxValue milliseconds are not allowed");
        return this;
      }
