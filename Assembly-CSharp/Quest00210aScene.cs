...
public class Quest00210aScene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, Quest00210Menu.Param param, bool fromTower = false) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_10a", (stack ? 1 : 0) != 0, (object) param, (object) fromTower);
