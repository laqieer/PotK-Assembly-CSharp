...
label_16:
    ...
    {
      PlayerUnitHistory[] playerUnitHistoryArray = SMManager.Get<PlayerUnitHistory[]>();
      if (playerUnitHistoryArray != null)
      {
        // ISSUE: reference to a compiler-generated method
        unit0043Menu.SEAHistory = ((IEnumerable<PlayerUnitHistory>) playerUnitHistoryArray).FirstOrDefault<PlayerUnitHistory>(new Func<PlayerUnitHistory, bool>(unit0043Menu.\u003CInit\u003Eb__129_13));
      }
    }
    ...
    {
      unit0043Menu.viewBtn.gameObject.SetActive(false);
      unit0043Menu.voiceBtn.gameObject.SetActive(false);
    }
    // ISSUE: reference to a compiler-generated method
    ...
    if (SEA != null)
    {
      ...
      if (MasterData.ScriptScript != null && MasterData.ScriptScript.ContainsKey(SEA.script_id))
        ...
        unit0043Menu.SEAScenarioBtn.gameObject.SetActive(false);
      if (unit0043Menu.isLibrary)
      {
        ...
        {
          unit0043Menu.SEAScenarioBtn.isEnabled = false;
    ...
    if ((bool) (UnityEngine.Object) unit0043Menu.currentLayout.dirNode)
    {
      Vector3 localPosition;
      if (unit0043Menu.currentLayout.storeNodeX.HasValue)
      {
        unit0043Menu.currentLayout.btnProfile.transform.localPosition = (Vector3) unit0043Menu.currentLayout.storePos.Value;
      ...
      {
        unit0043Menu.currentLayout.storePos = new Vector2?((Vector2) unit0043Menu.currentLayout.btnProfile.transform.localPosition);
        unit0043Menu.currentLayout.storeNodeX = new float?(unit0043Menu.currentLayout.dirNode.transform.localPosition.x);
      }
      if (!unit0043Menu.isEnabledEventImage)
      {
        unit0043Menu.currentLayout.btnProfile.transform.localPosition = unit0043Menu.btnShowEventImage.transform.localPosition;
        if (!unit0043Menu.isLibrary)
        {
          localPosition = unit0043Menu.currentLayout.dirNode.transform.localPosition;
    ...
    if ((UnityEngine.Object) unit0043Menu.slcCountry != (UnityEngine.Object) null)
    {
      unit0043Menu.slcCountry.gameObject.SetActive(false);
      if (unit0043Menu.targetUnit.country_attribute.HasValue)
      {
        unit0043Menu.slcCountry.gameObject.SetActive(true);
        unit0043Menu.targetUnit.SetCuntrySpriteName(ref unit0043Menu.slcCountry);
      }
    }
    if ((UnityEngine.Object) unit0043Menu.slcInclusion != (UnityEngine.Object) null)
    {
      unit0043Menu.slcInclusion.gameObject.SetActive(false);
      if (unit0043Menu.targetUnit.inclusion_ip.HasValue)
      {
        unit0043Menu.slcInclusion.gameObject.SetActive(true);
    ...
    if ((UnityEngine.Object) unit0043Menu.slcAwakening != (UnityEngine.Object) null)
    ...
    unit0043Menu.mainPanel.alpha = 1f;
    unit0043Menu.cam3d = unit0043Menu.camera3dModel.GetComponent<Camera>();
    unit0043Menu.SetRenderTexture();
    unit0043Menu.modelTex3d.gameObject.SetActive(false);
    if (!unit0043Menu.SEAScenarioBtn.gameObject.activeSelf)
      unit0043Menu.SEAIllustBtn.gameObject.transform.localPosition = new Vector3(70f, 0.0f, 0.0f);
    if (!unit0043Menu.SEAIllustBtn.gameObject.activeSelf)
      unit0043Menu.SEAScenarioBtn.transform.localPosition = new Vector3(70f, 0.0f, 0.0f);
  ...
  protected override void Update()
  {
    ...
    {
      if (this.hits[index].transform.name == "bg")
      {
  ...
  private IEnumerator setEventImage()
  {
    ...
    else
    {
      ...
      {
        this.SEAIllustBtn.isEnabled = false;
      ...
      {
        Future<UnityEngine.Sprite> ldImage = Singleton<ResourceManager>.GetInstance().Load<UnityEngine.Sprite>(eventImageName);
        ...
        if ((UnityEngine.Object) ldImage.Result != (UnityEngine.Object) null)
        {
          ...
          this.SEAIllustBtn.isEnabled = true;
        }
        else
          this.SEAIllustBtn.isEnabled = false;
      }
  ...
  private UnitSEASkill MasterDataUnitSEASkill
  {
    get
    {
      ...
      MasterData.UnitSEASkill.TryGetValue(this.targetUnit.same_character_id, out unitSeaSkill);
      return unitSeaSkill;
    }
  }
  ...
  public void Show3dModel()
  {
    ...
    this.viewBtn.gameObject.SetActive(false);
    this.voiceBtn.gameObject.SetActive(false);
    this.unitViewObj.SetActive(false);
    this.voicePanel.SetActive(false);
  }
  ...
  public void Show2dIllust()
  {
    ...
    if (this.isLibrary || !this.nohave)
      return;
    this.viewBtn.gameObject.SetActive(true);
    this.voiceBtn.gameObject.SetActive(true);
  }
  ...
  {
    this.trustViewBtn.gameObject.SetActive(this.targetUnit.IsResonanceUnit || this.targetUnit.IsSea);
    ...
    if (this.trustViewBtn.gameObject.activeSelf && (double) this.targetPlayerUnit.trust_rate < 100.0)
    {
      this.trustViewBtn.hover = this.trustViewBtn.pressed = this.trustViewBtn.defaultColor = Color.gray;
      this.trustViewBtn.pressedSprite = this.trustViewBtn.normalSprite;
      this.trustViewBtn.GetComponent<UISprite>().color = Color.gray;
      foreach (UIWidget componentsInChild in this.trustViewBtn.GetComponentsInChildren<UISprite>())
        componentsInChild.color = Color.gray;
    }
    this.awakeViewBtn.gameObject.SetActive(false);
    if (this.targetUnit.CanAwakeUnitFlag)
    {
      this.awakeViewBtn.gameObject.SetActive(true);
      this.awakeViewBtn.defaultColor = Color.gray;
      this.awakeViewBtn.GetComponent<UISprite>().color = Color.gray;
      foreach (UIWidget componentsInChild in this.awakeViewBtn.GetComponentsInChildren<UISprite>())
        componentsInChild.color = Color.gray;
    }
    if (this.targetUnit.awake_unit_flag)
      this.awakeViewBtn.gameObject.SetActive(true);
    this.callViewBtn.gameObject.SetActive(((IEnumerable<int>) SMManager.Get<Player>().call_skill_same_character_ids).Contains<int>(this.targetPlayerUnit.unit.same_character_id) || this.hitDivorce != null);
    if (this.callViewBtn.gameObject.activeSelf)
    {
      if (!this.trustViewBtn.gameObject.activeSelf && this.awakeViewBtn.gameObject.activeSelf)
      {
        this.gachaViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x - (double) this.gachaViewBtn.GetComponent<UISprite>().width - 10.0), this.gachaViewBtn.transform.localPosition.y);
        this.awakeViewBtn.transform.localPosition = (Vector3) new Vector2(this.bg.transform.localPosition.x, this.gachaViewBtn.transform.localPosition.y);
        this.callViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x + (double) this.gachaViewBtn.GetComponent<UISprite>().width + 10.0), this.gachaViewBtn.transform.localPosition.y);
      }
      else if (this.trustViewBtn.gameObject.activeSelf && !this.awakeViewBtn.gameObject.activeSelf)
      {
        this.trustViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x - (double) this.gachaViewBtn.GetComponent<UISprite>().width - 10.0), this.gachaViewBtn.transform.localPosition.y);
        this.gachaViewBtn.transform.localPosition = (Vector3) new Vector2(this.bg.transform.localPosition.x, this.gachaViewBtn.transform.localPosition.y);
        this.callViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x + (double) this.gachaViewBtn.GetComponent<UISprite>().width + 10.0), this.gachaViewBtn.transform.localPosition.y);
      }
      else
      {
        this.trustViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x - (double) (this.gachaViewBtn.GetComponent<UISprite>().width / 2) - 10.0) - (float) this.gachaViewBtn.GetComponent<UISprite>().width, this.gachaViewBtn.transform.localPosition.y);
        this.gachaViewBtn.transform.localPosition = (Vector3) new Vector2(this.bg.transform.localPosition.x - (float) (this.gachaViewBtn.GetComponent<UISprite>().width / 2), this.gachaViewBtn.transform.localPosition.y);
        this.awakeViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x + (double) (this.gachaViewBtn.GetComponent<UISprite>().width / 2) + 10.0), this.gachaViewBtn.transform.localPosition.y);
        this.callViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x + (double) (this.gachaViewBtn.GetComponent<UISprite>().width / 2) + 20.0) + (float) this.gachaViewBtn.GetComponent<UISprite>().width, this.gachaViewBtn.transform.localPosition.y);
      }
    }
    else
    {
      ...
      if (!this.trustViewBtn.gameObject.activeSelf || this.awakeViewBtn.gameObject.activeSelf)
        return;
      this.trustViewBtn.transform.localPosition = (Vector3) new Vector2(this.bg.transform.localPosition.x - (float) (this.gachaViewBtn.GetComponent<UISprite>().width / 2), this.gachaViewBtn.transform.localPosition.y);
      this.gachaViewBtn.transform.localPosition = (Vector3) new Vector2((float) ((double) this.bg.transform.localPosition.x + (double) (this.gachaViewBtn.GetComponent<UISprite>().width / 2) + 10.0), this.gachaViewBtn.transform.localPosition.y);
    }
  }
  ...
  private void SetMessageInfo(string str)
  {
    ...
    this.messageObj.GetComponent<TweenAlpha>().ResetToBeginning();
    this.messageObj.GetComponent<TweenAlpha>().PlayForward();
  }
  ...
  private IEnumerator PlayTrustView()
  {
    ...
    if (!unit0043Menu.isPlayCutin)
    {
      ...
      else
      {
        ...
        {
          if ((UnityEngine.Object) unit0043Menu.trustEffectprefab == (UnityEngine.Object) null)
          {
        ...
        {
          if ((UnityEngine.Object) unit0043Menu.gearEffectprefab == (UnityEngine.Object) null)
          {
        ...
        if ((UnityEngine.Object) Prefab == (UnityEngine.Object) null)
          unit0043Menu.isPlayCutin = false;
        else if ((UnityEngine.Object) Singleton<CommonRoot>.GetInstance() == (UnityEngine.Object) null || (UnityEngine.Object) Singleton<CommonRoot>.GetInstance().LoadTmpObj == (UnityEngine.Object) null)
        {
          unit0043Menu.isPlayCutin = false;
        }
        else
        {
          ...
          {
            // ISSUE: reference to a compiler-generated method
            e = Prefab.GetComponent<FavorabilityRatingEffect>().Init(FavorabilityRatingEffect.AnimationType.SkillRelease, baseUnit, new System.Action(unit0043Menu.\u003CPlayTrustView\u003Eb__178_0), isPreview: true);
            while (e.MoveNext())
              yield return e.Current;
            e = (IEnumerator) null;
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        {
          int? nullable = this.voiceInfo.FirstIndexOrNull<Unit0043Menu.VoiceInfo>((Func<Unit0043Menu.VoiceInfo, bool>) (v => (UnityEngine.Object) v.scroll != (UnityEngine.Object) null && (UnityEngine.Object) v.scroll.gameObject == (UnityEngine.Object) unit));
  ...
  private void CreateScroll(int info_index, int unit_index)
  {
    ...
    this.voiceInfo.Where<Unit0043Menu.VoiceInfo>((Func<Unit0043Menu.VoiceInfo, bool>) (a => (UnityEngine.Object) a.scroll == (UnityEngine.Object) scroll)).ForEach<Unit0043Menu.VoiceInfo>((System.Action<Unit0043Menu.VoiceInfo>) (b => b.scroll = (Unit0043VoiceItem) null));
    this.voiceInfo[info_index].scroll = scroll;
    scroll.Init(this, this.voiceInfo[info_index].voiceView, this.targetPlayerUnit, ref this.lockedCount, (System.Action<string>) (x => this.SetMessageInfo(x)));
  ...
  private void CreateScrollBase(GameObject prefab)
  {
    ...
    for (int index = 0; index < Mathf.Min(10, this.voiceInfo.Count); ++index)
      this.voiceItemList.Add(UnityEngine.Object.Instantiate<GameObject>(prefab).GetComponent<Unit0043VoiceItem>());
    this.scroll.Reset();
    for (int index = 0; index < Mathf.Min(10, this.voiceItemList.Count); ++index)
      this.scroll.AddColumn1(this.voiceItemList[index].gameObject, 578, 75, true);
  ...
  public void OpenConfession() => Sea030CallSkillReleaseScene.changeScene(true, this.targetUnit.same_character_id);
