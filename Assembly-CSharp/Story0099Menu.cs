...
public class Story0099Menu : BackButtonMenuBase
{
  ...
  public bool onStartMovie()
  {
    ...
    if ((UnityEngine.Object) this.btnBack_ != (UnityEngine.Object) null)
      this.btnBack_.isEnabled = false;
    this.movieObj.endAction = (System.Action) (() =>
    {
      Singleton<CommonRoot>.GetInstance().isTouchBlock = false;
      Singleton<CommonRoot>.GetInstance().setDisableFooterColor(false);
      if ((UnityEngine.Object) this.btnBack_ != (UnityEngine.Object) null)
        this.btnBack_.isEnabled = true;
      this.IsPush = false;
    });
    return true;
  }
  ...
  public IEnumerator InitScene()
  {
    ...
    foreach (QuestMovieQuest questMovieQuest in questMovieQuestList)
    {
      ...
      PlayerStoryQuestS playerStoryQuestS = ((IEnumerable<PlayerStoryQuestS>) playerStoryQuestSArray).Where<PlayerStoryQuestS>((Func<PlayerStoryQuestS, bool>) (x => x.quest_story_s.ID == movie.quest_s_id)).FirstOrDefault<PlayerStoryQuestS>();
