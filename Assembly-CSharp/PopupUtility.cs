...
public static class PopupUtility
{
  ...
  public static IEnumerator _007_14(float wait)
  {
    ...
    e = (IEnumerator) null;
    GameObject gameObject = Singleton<PopupManager>.GetInstance().open(fobj.Result);
    gameObject.GetComponent<Shop00714Menu>().Init(pri, add, new System.Action<int>(gameObject.GetComponent<Shop00714SetText>().SetText));
  }
  ...
  public static IEnumerator _999_5_1(
    System.Action<PopupUtility.SceneTo> callChangedScene = null,
  ...
  public static IEnumerator RecoveryAP(bool isAPShortage = false, System.Action questChange = null)
  {
    IEnumerator e;
    if (questChange == null)
    {
      e = PurchaseBehavior.OpenAPRecoveryItemList(isAPShortage, (System.Action) (() => {}));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
    }
  ...
  public static IEnumerator SeaErrorStartUp(WebAPI.Response.UserError error)
  {
    ModalWindow.Show(error.Code, error.Reason, (System.Action) (() =>
    {
      ...
      Singleton<NGGameDataManager>.GetInstance().StartSceneAsyncProxy((System.Action<NGGameDataManager.StartSceneProxyResult>) (data => MypageScene.ChangeSceneOnError()));
    }));
    yield return (object) null;
  }
