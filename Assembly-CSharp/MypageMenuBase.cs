...
public abstract class MypageMenuBase : BackButtonMenuBase
{
  ...
  public abstract IEnumerator onStartSceneAsync(
    bool isCloudAnim,
  ...
  public void ResetTweenDelay() => ((IEnumerable<UITweener>) this.GetComponentsInChildren<UITweener>(true)).ForEach<UITweener>((System.Action<UITweener>) (x =>
  {
  ...
  protected virtual IEnumerator CreateCharcterAnimation()
  {
    ...
    ((IEnumerable<UI2DSprite>) mypageMenuBase.CharaSprites).ForEach<UI2DSprite>(new System.Action<UI2DSprite>(mypageMenuBase.\u003CCreateCharcterAnimation\u003Eb__43_0));
...
label_14:
  ...
  public virtual IEnumerator CloudAnimationStart()
  {
    ...
    // ISSUE: reference to a compiler-generated method
    IEnumerator e = Singleton<CommonRoot>.GetInstance().StartCloudAnim(MypageCloudAnim.HeavenOut, MypageCloudAnim.EarthIn, new System.Action(mypageMenuBase.\u003CCloudAnimationStart\u003Eb__52_0));
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  }
  ...
  private IEnumerator Advice()
  {
    ...
    else if (Persist.integralNoaTutorial.Data.beginnersQuest)
    {
      ...
      Singleton<TutorialRoot>.GetInstance().ForceShowAdviceInNextButton("newchapter_home2_tutorial", new Dictionary<string, Func<Transform, UIButton>>()
      {
        {
          "chapter_home2",
          (Func<Transform, UIButton>) (root => (UIButton) root.GetChildInFind("Top").GetComponentInChildren<FloatButton>())
        }
      });
    }
  }
