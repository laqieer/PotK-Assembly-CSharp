...
public class BattleUI04CommandPrefab : MonoBehaviour
{
    ...
    CommonElement element)
  {
    ...
    this.decHP.gameObject.SetActive(false);
  ...
  private IEnumerator initializeIcons(AttackStatus attack, BL.MagicBullet magicBullet)
  {
    ...
    this.decHP.gameObject.SetActive(true);
  ...
  private class IconControl
  {
    ...
    {
      AttackClassIcon attackClassIcon = (UnityEngine.Object) this.icon != (UnityEngine.Object) null ? this.icon.GetComponent<AttackClassIcon>() : (AttackClassIcon) null;
      if (!((UnityEngine.Object) attackClassIcon != (UnityEngine.Object) null))
        return;
      attackClassIcon.Initialize(attackClass);
    }
