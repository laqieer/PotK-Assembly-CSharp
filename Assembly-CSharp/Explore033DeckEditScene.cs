...
public class Explore033DeckEditScene : NGSceneBase
{
  ...
  public static void ChangeSceneExploreDeckEdit() => Singleton<NGSceneManager>.GetInstance().changeScene("explore033_DeckEdit", true, (object) Explore033DeckEditScene.Mode.Explore);

  public static void ChangeSceneChallengeDeckEdit() => Singleton<NGSceneManager>.GetInstance().changeScene("explore033_DeckEdit", true, (object) Explore033DeckEditScene.Mode.Challenge);
  ...
  public void onStartScene(Explore033DeckEditScene.Mode mode) => Singleton<CommonRoot>.GetInstance().isLoading = false;
  ...
  public void onBackScene(Explore033DeckEditScene.Mode mode) => Singleton<CommonRoot>.GetInstance().isLoading = false;
