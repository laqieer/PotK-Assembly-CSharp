...
public class battle01718aMission : MonoBehaviour
{
  ...
  public IEnumerator SetSprite(bool clearflag, QuestStoryMission story)
  {
    ...
    this.UniqueIcon = this.LinkParent.gameObject.GetOrAddComponent<CreateIconObject>();
    if (story != null)
    {
  ...
  public void SetValue(bool clearflag)
  {
    ...
    this.SlcUnAttainment.gameObject.SetActive(!clearflag);
    this.SlcStarAttainment.gameObject.SetActive(clearflag);
    this.SlcStarUnAttainment.gameObject.SetActive(!clearflag);
    ...
    if (this.SlcAttainment.gameObject.activeSelf)
    {
      ...
      if ((Object) this.LinkPrefab.GetComponent<IconPrefabBase>() != (Object) null)
        this.LinkPrefab.GetComponent<IconPrefabBase>().Gray = true;
      else
        this.LinkPrefab.GetComponent<UIWidget>().color = color;
      if (Singleton<NGGameDataManager>.GetInstance().IsSea)
      {
        this.TxtDescription.GetComponent<UIWidget>().color = new Color(1f, 1f, 1f, 0.8f);
        this.SlcDescriptionBase.GetComponent<UIWidget>().color = new Color(1f, 1f, 1f, 0.4823529f);
      }
      else
      {
    ...
    if (!((Object) this.LinkPrefab != (Object) null))
      return;
