...
public class Unit004OverkillersSlotUnitSelectMenu : UnitMenuBase
{
    ...
    EditOverkillersParam editParam = null)
  {
    ...
    slotUnitSelectMenu1.InitializeInfo((IEnumerable<PlayerUnit>) lst, (IEnumerable<PlayerMaterialUnit>) null, Persist.unit004OverkillersSlotUnitSortAndFilter, false, (uint) selected_id > 0U, true, true, false);
  ...
  private void postCreateUnitIcon(UnitIconInfo dispInfo, UnitIconBase unitIcon)
  {
    ...
    {
      unitIcon.onLongPress = (System.Action<UnitIconBase>) (x => Unit0042Scene.changeOverkillersUnitDetail(this.baseUnit, x.PlayerUnit, this.getUnits()));
  ...
  private IEnumerator doSetUnit(PlayerUnit unit)
  {
    ...
    if (slotUnitSelectMenu.checkOnceAlertOverkillersUnits())
    {
      ...
      PopupCommonNoYes.Show(instance.POPUP_004_TITLE_ALERT_TEAMS_OVERKILLERS, instance.POPUP_004_MESSAGE_ALERT_TEAMS_OVERKILLERS, (System.Action) (() => nSelect = 1), (System.Action) (() => nSelect = 2), NGUIText.Alignment.Left);
      while (nSelect == 0)
    ...
    {
      if ((UnityEngine.Object) slotUnitSelectMenu.StealAlertPopupPrefab == (UnityEngine.Object) null)
      {
      ...
      int nSelect = 0;
      Singleton<PopupManager>.GetInstance().open(slotUnitSelectMenu.StealAlertPopupPrefab).GetComponent<Unit004OverKillersStealPopup>().Init(base_unit, (System.Action) (() => nSelect = 1), (System.Action) (() => nSelect = 2));
      while (nSelect == 0)
        yield return (object) null;
      if (nSelect == 2)
      {
    ...
    else if (unit.isAnyOverkillersUnits)
    {
      int nSelect = 0;
      Consts instance = Consts.GetInstance();
      PopupCommonNoYes.Show(instance.POPUP_004_TITLE_ALERT_OVERKILLERS_ALL_REMOVE, instance.POPUP_004_MESSAGE_ALERT_OVERKILLERS_ALL_REMOVE, (System.Action) (() => nSelect = 1), (System.Action) (() => nSelect = 2), NGUIText.Alignment.Left);
      while (nSelect == 0)
        yield return (object) null;
      if (nSelect == 2)
      {
