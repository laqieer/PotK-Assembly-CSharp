...
public class Unit00443Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack, GameCore.ItemInfo choiceGear, List<InventoryItem> sortGears = null) => Unit00443Scene.callChangeScene(stack, choiceGear, false, false, sortGears);
