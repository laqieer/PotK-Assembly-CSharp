...
public class Battle01Item : NGBattleMenuBase
{
  ...
  private void Awake() => this.item.enabled = false;
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    battle01Item.itemIcon = result.CloneAndGetComponent<ItemIcon>(battle01Item.item.gameObject.transform);
    NGUITools.AdjustDepth(battle01Item.itemIcon.gameObject, battle01Item.item.depth);
    battle01Item.itemIcon.SetBasedOnHeight(battle01Item.item.height);
  }
