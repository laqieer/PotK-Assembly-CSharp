...
namespace Net
{
  public class Peer
  {
    ...
    public Future<Tuple<Peer.CommonHeader, byte[]>> Receive(int timeoutMilliseconds = -1) => new Future<Tuple<Peer.CommonHeader, byte[]>>((Func<Promise<Tuple<Peer.CommonHeader, byte[]>>, IEnumerator>) (promise => this.ReceiveE(timeoutMilliseconds, promise)));
    ...
    public Future<int> Send(int type, AssocList<string, object> data, int timeout) => new Future<int>((Func<Promise<int>, IEnumerator>) (promise => this.SendE(type, data, timeout, promise)));

    public Future<int> SendError(string message, int timeout) => new Future<int>((Func<Promise<int>, IEnumerator>) (promise => this.SendE((int) byte.MaxValue, new AssocList<string, object>()
    {
    ...
    public class CommonHeader
    {
      ...
      public Future<None> Read(UnityTcpClient client) => new Future<None>((Func<Promise<None>, IEnumerator>) (promise => this.ReadE(client, promise)));
