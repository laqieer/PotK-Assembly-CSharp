...
public abstract class ExploreTask
{
  ...
  protected long ProcTime => (double) this.mStartTime == 0.0 ? 0L : (long) (((double) Time.realtimeSinceStartup - (double) this.mStartTime) * 1000.0);
  ...
  public void SetRandState() => this.mRandState = Singleton<ExploreLotteryCore>.GetInstance().GetRandomCount().ToString();
