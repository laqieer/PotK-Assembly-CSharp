...
public class Guild02812Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    guild02812Menu.guildPopup.SetSendRequestCallback(new System.Action(guild02812Menu.\u003CInitializeAsync\u003Eb__31_0));
    // ISSUE: reference to a compiler-generated method
    guild02812Menu.guildPopup.SetCancelRequestCallback(new System.Action(guild02812Menu.\u003CInitializeAsync\u003Eb__31_1));
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    if ((UnityEngine.Object) this.guildSearchFriendListPopup == (UnityEngine.Object) null)
    {
  ...
  public IEnumerator SearchBestGuild(System.Action callback = null)
  {
    ...
    // ISSUE: reference to a compiler-generated method
    Future<WebAPI.Response.GuildRecommends> searchGuild = WebAPI.GuildRecommends(true, 5, false, new System.Action<WebAPI.Response.UserError>(guild02812menu.\u003CSearchBestGuild\u003Eb__36_0));
    IEnumerator e = searchGuild.Wait();
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
  ...
  public void onButtonSetting() => Singleton<PopupManager>.GetInstance().open(this.searchSettingPopup).GetComponent<Guild028101Popup>().Initialize(this, this.searchSetting);
