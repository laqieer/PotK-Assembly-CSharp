...
namespace DeckOrganization
{
  public class CorpsCreator : Creator
  {
    ...
    private IEnumerable<Unit> sortForCorps(IEnumerable<Unit> units) => (IEnumerable<Unit>) units.OrderByDescending<Unit, int>((Func<Unit, int>) (u => u.unit_.level)).ThenByDescending<Unit, int>((Func<Unit, int>) (u => u.unit_.combat)).ThenByDescending<Unit, int>((Func<Unit, int>) (u => u.unit_.total_hp));
  }
}
