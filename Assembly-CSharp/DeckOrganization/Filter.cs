...
namespace DeckOrganization
{
  public class Filter
  {
    ...
    public bool hasLimit => (uint) this.limit_ > 0U;
    ...
    public Filter(int index, Filter.Factor factor) => this.initCommon(index, factor, Filter.Expression.None, (object) 0, Filter.Limit.None, 0);

    public Filter(int index, Filter.Factor factor, int param) => this.initCommon(index, factor, Filter.Expression.None, (object) param, Filter.Limit.None, 0);
