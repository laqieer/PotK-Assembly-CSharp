...
public class Story059ItemData
{
  ...
  public EarthQuestStoryPlayback storyPlayback => MasterData.EarthQuestStoryPlayback.ContainsKey(this.storyPlaybackID) ? MasterData.EarthQuestStoryPlayback[this.storyPlaybackID] : (EarthQuestStoryPlayback) null;

  public string title => this.storyPlayback != null ? this.storyPlayback.title : this.episode.episode_name;
