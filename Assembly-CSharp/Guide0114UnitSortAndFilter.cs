...
public class Guide0114UnitSortAndFilter : GuideSortAndFilter
{
  ...
  public List<GuideSortAndFilter.GUIDE_GEAR_CATEGORY_TYPE> GearCategoryList => this.gearCategoryList;
  ...
  public void SetValueWindow()
  {
    ...
    {
      foreach (Guide0114UnitSortAndFilterButton sortAndFilterButton in this.dir_fil1)
    ...
    foreach (Guide0114UnitSortAndFilterButton sortAndFilterButton in this.dir_fil3)
      this.GrayCheck<GuideSortAndFilter.GUIDE_GEAR_CATEGORY_TYPE>(this.gearCategoryList, sortAndFilterButton.gearCategory, (SortAndFilterButton) sortAndFilterButton);
