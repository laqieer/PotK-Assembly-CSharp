...
public class GuildUtil
{
  ...
  public static IEnumerator EditGuildDeckAttack(int[] playerUnitIds, System.Action action = null)
  {
    ...
    Future<WebAPI.Response.GvgDeckAttackEdit> atkTeam = WebAPI.GvgDeckAttackEdit(playerUnitIds, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      errCode = e.Code;
    ...
    {
      ModalWindow.Show(Consts.GetInstance().POPUP_GUILD_BATTLE_DEF_TEAM_TITLE, Consts.GetInstance().POPUP_GUILD_BATTLE_ATK_TEAM_ERROR, (System.Action) (() => {}));
    }
    else
    {
  ...
  {
    string errCode = string.Empty;
    Future<WebAPI.Response.GvgDeckDefenseEdit> defTeam = WebAPI.GvgDeckDefenseEdit(playerUnitIds, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      errCode = e.Code;
      if (e.Code.Equals("GVG002"))
        return;
    ...
    {
      ModalWindow.Show(Consts.GetInstance().POPUP_GUILD_BATTLE_DEF_TEAM_TITLE, Consts.GetInstance().POPUP_GUILD_BATTLE_DEF_TEAM_ERROR, (System.Action) (() => {}));
    }
    else
    {
  ...
  public static IEnumerator UpdateGuildDeckAttack(
    string guild_id,
    string player_id,
    System.Action action = null)
  {
    bool maintenance = false;
    Future<WebAPI.Response.GvgDeckAttackShow> atkTeam = WebAPI.GvgDeckAttackShow(guild_id, player_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
  ...
  {
    bool maintenance = false;
    Future<WebAPI.Response.GvgDeckDefenseShow> defTeam = WebAPI.GvgDeckDefenseShow(guild_id, player_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      if (e.Code.Equals("GLD014"))
        maintenance = true;
      WebAPI.DefaultUserErrorCallback(e);
    ...
    NGMenuBase menu)
  {
    ...
    while (!((UnityEngine.Object) menu == (UnityEngine.Object) null))
    {
      TimeSpan timeSpan = targetTime.Subtract(now);
      if ((UnityEngine.Object) hour[0] != (UnityEngine.Object) null)
        hour[0].setNumber(Mathf.Abs(timeSpan.Hours % 10), Color.white);
      if ((UnityEngine.Object) hour[1] != (UnityEngine.Object) null)
        hour[1].setNumber(Mathf.Abs(timeSpan.Hours / 10), Color.white);
      if ((UnityEngine.Object) minute[0] != (UnityEngine.Object) null)
        minute[0].setNumber(Mathf.Abs(timeSpan.Minutes % 10), Color.white);
      if ((UnityEngine.Object) minute[1] != (UnityEngine.Object) null)
  ...
  public static bool isBattleOrPreparing(GvgStatus gvgStatus) => gvgStatus == GvgStatus.preparing || gvgStatus == GvgStatus.fighting;
...
label_19:
  ...
  public static UnityEngine.Sprite LoadKindSprite(
    ...
    CommonElement element)
  {
    ...
    return str.Equals(string.Empty) ? (UnityEngine.Sprite) null : Resources.Load<UnityEngine.Sprite>(string.Format("Icons/Materials/FacilityKindIcon/slc_{0}_{1}_34_30", (object) str, (object) element.ToString()));
  }

  public static MasterDataTable.CommonRewardType getCommonRewardType(
    CommonGuildRewardType type)
  {
  ...
  public static bool IsCostOver(PlayerUnit[] playerUnits, int?[] playerUnitIDs)
  {
    ...
    if (playerUnits1.Count<PlayerUnit>() <= 0)
      return false;
    playerUnits1.ForEach<PlayerUnit>((System.Action<PlayerUnit>) (x => cost += x.cost));
  ...
  public static IEnumerator UpdateGuildDeck()
  {
    ...
    switch (GuildUtil.gvgPopupState)
    {
      case GuildUtil.GvGPopupState.AtkTeam:
        e = GuildUtil.UpdateGuildDeckAttack(PlayerAffiliation.Current.guild_id, Player.Current.id, (System.Action) (() => {}));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        break;
      case GuildUtil.GvGPopupState.DefTeam:
        e = GuildUtil.UpdateGuildDeckDefanse(PlayerAffiliation.Current.guild_id, Player.Current.id, (System.Action) (() => {}));
        while (e.MoveNext())
          yield return e.Current;
        e = (IEnumerator) null;
        break;
  ...
  public static IEnumerator UpdateGuildDeckAll()
  {
    ...
    {
      IEnumerator e = GuildUtil.UpdateGuildDeckAttack(PlayerAffiliation.Current.guild_id, Player.Current.id, (System.Action) (() => {}));
      while (e.MoveNext())
        yield return e.Current;
      e = (IEnumerator) null;
      e = GuildUtil.UpdateGuildDeckDefanse(PlayerAffiliation.Current.guild_id, Player.Current.id, (System.Action) (() => {}));
