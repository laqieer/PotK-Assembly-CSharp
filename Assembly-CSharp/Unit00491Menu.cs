...
public class Unit00491Menu : UnitMenuBase
{
  ...
  public bool IsInit() => ((IEnumerable<PlayerUnit>) SMManager.Get<PlayerUnit[]>()).Count<PlayerUnit>() != this.unitCount;
    ...
    Unit00491Menu.Mode mode)
  {
    ...
    if (mode == Unit00491Menu.Mode.Evolution)
    {
      ...
      unit00491Menu.InitializeInfoEx((IEnumerable<PlayerUnit>) null, (IEnumerable<PlayerMaterialUnit>) array, UnitSortAndFilter.SORT_TYPES.UnitID, SortAndFilter.SORT_TYPE_ORDER_BUY.ASCENDING, isEquip, false, true, true, true, false, new System.Action(unit00491Menu.InitializeAllUnitInfosExtend), false, false);
      nums = array.Length;
    }
    else
    {
      ...
      if ((UnityEngine.Object) unit00491Menu.SaveMemorySlotSelectPrefab == (UnityEngine.Object) null)
      {
    ...
    PlayerUnit baseUnit = null)
  {
    ...
    e = (IEnumerator) null;
    // ISSUE: reference to a compiler-generated method
    unit00491Menu.allUnitIcons[unit_index].onClick = new System.Action<UnitIconBase>(unit00491Menu.\u003CCreateUnitIcon\u003Eb__19_0);
  }
  ...
  protected override void CreateUnitIconCache(int info_index, int unit_index, PlayerUnit baseUnit = null)
  {
    ...
    this.allUnitIcons[unit_index].onClick = (System.Action<UnitIconBase>) (ui => this.SelectUnitIcon(ui));
  }
  ...
  public void RecordEndUpdate()
  {
    ...
    this.playerUnits = ((IEnumerable<PlayerUnit>) playerUnitArray).Where<PlayerUnit>((Func<PlayerUnit, bool>) (x => x.level >= x.unit.rarity.reincarnation_level || ((IEnumerable<int?>) transmigrate_memory_player_unit_ids).Any<int?>((Func<int?, bool>) (y =>
    {
      int? nullable = y;
      int id = x.id;
      return nullable.GetValueOrDefault() == id & nullable.HasValue;
    ...
    bool isTowerEntry)
  {
    ...
    this.scroll.Reset();
    this.allUnitIcons.ForEach((System.Action<UnitIconBase>) (x =>
    {
    ...
    {
      this.scroll.Add(this.allUnitIcons[index].gameObject, this.IconWidth, this.IconHeight);
