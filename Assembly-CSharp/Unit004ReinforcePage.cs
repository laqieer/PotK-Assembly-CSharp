...
public class Unit004ReinforcePage : Unit004TrainingPage
{
  ...
  public IEnumerator Init()
  {
    ...
    unit004ReinforcePage.grid.transform.Clear();
    int b = unit004ReinforcePage.grid.maxPerLine * unit004ReinforcePage.tilingLine_;
    ...
    {
      unit004ReinforcePage.uiDragScrollView.enabled = false;
      ...
      for (int index = 0; index < b; ++index)
        unit004ReinforcePage.DirSozaiItemPrefab.CloneAndGetComponent<SozaiItem>(unit004ReinforcePage.grid.transform).SetOnlyWLine();
    }
    else
    {
      unit004ReinforcePage.uiDragScrollView.enabled = true;
      ...
      int numTile = Mathf.Max((unit004ReinforcePage.selectUnits.Length + unit004ReinforcePage.grid.maxPerLine - 1) / unit004ReinforcePage.grid.maxPerLine * unit004ReinforcePage.grid.maxPerLine, b);
      List<UIWidget> widgetList = new List<UIWidget>();
      for (int i = 0; i < numTile; ++i)
      {
        SozaiItem component1 = unit004ReinforcePage.DirSozaiItemPrefab.CloneAndGetComponent<SozaiItem>(unit004ReinforcePage.grid.transform);
        ...
        else
        {
          ...
          else
          {
            ...
            unitIcon.onClick = new System.Action<UnitIconBase>(unit004ReinforcePage.\u003CInit\u003Eb__34_3);
    ...
    // ISSUE: reference to a compiler-generated method
    unit004ReinforcePage.grid.onReposition = new UIGrid.OnReposition(unit004ReinforcePage.\u003CInit\u003Eb__34_2);
    ...
    unit004ReinforcePage.ibtnReinforceAnimFade01.isEnabled = false;
    if (unit004ReinforcePage.duplicationSelectUnits.Length != 0)
      unit004ReinforcePage.ibtnReinforceAnimFade01.isEnabled = true;
  }
  ...
  protected override IEnumerator loadResources()
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) unit004ReinforcePage.rarityAlertPopupPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004ReinforcePage.resetAlertPopupPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004ReinforcePage.upperParameterPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004ReinforcePage.upperParameterLabelPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004ReinforcePage.skillTypeIconPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004ReinforcePage.statusGaugePrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) unit004ReinforcePage.DirSozaiItemPrefab == (UnityEngine.Object) null)
    {
  ...
  private IEnumerator Show_dir_Status01()
  {
    ...
    unit004ReinforcePage.TxtHimeEnforceNumer.color = unit004ReinforcePage.selectUnits.Length == 0 ? Color.white : Color.yellow;
  ...
  public void IbtnEnforce()
  {
    ...
    if (isAlert | isMemoryAlert)
      Singleton<PopupManager>.GetInstance().open(this.rarityAlertPopupPrefab).GetComponent<Unit004832Menu>().Init(isAlert, isMemoryAlert, new System.Action(this.executeReinforce));
    else
      Debug.LogError((object) "Unit00420Menu: 強化素材が想定しているレアリティではありません");
  }

  private void executeReinforce() => Singleton<PopupManager>.GetInstance().monitorCoroutine(this.doReinfoce());
  ...
  private IEnumerator doReinfoce()
  {
    ...
    if (!Singleton<CommonRoot>.GetInstance().isLoading)
    {
      ...
      Future<WebAPI.Response.UnitBuildup> paramF = WebAPI.UnitBuildup(unit004ReinforcePage.baseUnit.id, material_player_material_unit_ids, material_player_material_unit_nums, (System.Action<WebAPI.Response.UserError>) (error =>
      {
