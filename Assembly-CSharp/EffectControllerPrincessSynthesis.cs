...
public class EffectControllerPrincessSynthesis : EffectController
{
    ...
    List<int> other_list)
  {
    ...
    for (int i = 0; i < princessSynthesis.thumList_.Count; ++i)
    {
      if (i < unit_list.Count)
      {
        ...
        {
          princessSynthesis.meshList_[i].gameObject.SetActive(false);
          princessSynthesis.meshMaleList_[i].gameObject.SetActive(true);
        ...
        {
          princessSynthesis.meshMaleList_[i].gameObject.SetActive(false);
          princessSynthesis.meshList_[i].gameObject.SetActive(true);
  ...
  {
    if (this.baseList_ == null || this.baseList_.Length <= index || !((Object) this.baseList_[index] != (Object) null))
      return;
    this.baseList_[index].gameObject.SetActive(flag);
    this.coverList_[index].gameObject.SetActive(flag);
  }
