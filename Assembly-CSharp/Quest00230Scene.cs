...
public class Quest00230Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, int period_id) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_30", (stack ? 1 : 0) != 0, (object) period_id);

  public static void ChangeScene(bool stack, EventInfo eventInfo) => Singleton<NGSceneManager>.GetInstance().changeScene("quest002_30", (stack ? 1 : 0) != 0, (object) eventInfo);
  ...
  public IEnumerator onStartSceneAsync(EventInfo eventInfo)
  {
    ...
    if (name != null)
    {
      e1 = quest00230Scene.GetComponent<BGChange>().ExtraBGprefabCreate(name);
      while (e1.MoveNext())
