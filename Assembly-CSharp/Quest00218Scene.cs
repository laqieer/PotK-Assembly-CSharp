...
public class Quest00218Scene : NGSceneBase
{
  ...
  public static void changeScene(int LLId, int? SId = null, bool stack = true) => Singleton<NGSceneManager>.GetInstance().changeScene(Quest00218Scene.DefaultSceneName, (stack ? 1 : 0) != 0, (object) new Quest00218Scene.BootParam(LLId, SId));
  ...
  public IEnumerator onStartSceneAsync(Quest00218Scene.BootParam param)
  {
    ...
    else
    {
      ...
      {
        Future<WebAPI.Response.QuestProgressExtra> extra = WebAPI.QuestProgressExtra((System.Action<WebAPI.Response.UserError>) (e =>
        {
  ...
  private IEnumerator doBGChange()
  {
    ...
    ++quest00218Scene.runningCoroutine_;
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E2__current = (object) quest00218Scene.GetComponent<BGChange>().ExtraBGprefabCreate(quest00218Scene.bgName_);
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = 1;
    return true;
  }
