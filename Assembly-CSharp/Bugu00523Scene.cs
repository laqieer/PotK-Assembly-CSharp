...
public class Bugu00523Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, List<ItemInfo> select, ItemInfo target) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_buildup_material", (stack ? 1 : 0) != 0, (object) select, (object) target);
