...
namespace com.adjust.sdk
{
  public class AdjustUtils
  {
    ...
    public static int ConvertLogLevel(AdjustLogLevel? logLevel) => !logLevel.HasValue ? -1 : (int) logLevel.Value;
    ...
    public static string GetJsonResponseCompact(Dictionary<string, object> dictionary)
    {
      ...
      {
        if (keyValuePair.Value is string str3)
        {
          if (++num > 1)
            str2 += ",";
          if (str3.StartsWith("{") && str3.EndsWith("}"))
            str2 = str2 + "\"" + keyValuePair.Key + "\":" + str3;
          else
            str2 = str2 + "\"" + keyValuePair.Key + "\":\"" + str3 + "\"";
        }
        else
        {
          ...
          str2 += AdjustUtils.GetJsonResponseCompact(dictionary1);
        }
      }
      return str2 + "}";
    }
