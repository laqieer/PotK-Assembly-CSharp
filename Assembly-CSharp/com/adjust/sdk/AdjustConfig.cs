...
namespace com.adjust.sdk
{
  public class AdjustConfig
  {
    ...
    public void setLaunchDeferredDeeplink(bool launchDeferredDeeplink) => this.launchDeferredDeeplink = launchDeferredDeeplink;

    public void setSendInBackground(bool sendInBackground) => this.sendInBackground = new bool?(sendInBackground);

    public void setEventBufferingEnabled(bool eventBufferingEnabled) => this.eventBufferingEnabled = new bool?(eventBufferingEnabled);
    ...
    public void setIsDeviceKnown(bool isDeviceKnown) => this.isDeviceKnown = new bool?(isDeviceKnown);
    ...
    public Action<AdjustAttribution> getAttributionChangedDelegate() => this.attributionChangedDelegate;
    ...
    public void setAllowiAdInfoReading(bool allowiAdInfoReading) => this.allowiAdInfoReading = new bool?(allowiAdInfoReading);

    public void setAllowAdServicesInfoReading(bool allowAdServicesInfoReading) => this.allowAdServicesInfoReading = new bool?(allowAdServicesInfoReading);

    public void setAllowIdfaReading(bool allowIdfaReading) => this.allowIdfaReading = new bool?(allowIdfaReading);
    ...
    public void setPreinstallTrackingEnabled(bool preinstallTrackingEnabled) => this.preinstallTrackingEnabled = new bool?(preinstallTrackingEnabled);
