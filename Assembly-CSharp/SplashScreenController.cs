...
public class SplashScreenController : MonoBehaviour
{
  ...
  [SerializeField]
  private UnityEngine.Sprite m_splashImageSprite;
  [SerializeField]
  ...
  {
    if ((Object) this.m_splashImage == (Object) null)
    {
      GameObject gameObject = new GameObject();
      RectTransform rectTransform = gameObject.AddComponent<RectTransform>();
      rectTransform.position = new Vector3((float) Screen.width / 2f, (float) Screen.height / 2f, 0.0f);
      ...
      {
        canvas = new GameObject().AddComponent<RectTransform>().gameObject.AddComponent<Canvas>();
        canvas.renderMode = UnityEngine.RenderMode.ScreenSpaceOverlay;
      }
      this.m_splashImage.transform.SetParent((Transform) canvas.GetComponent<RectTransform>());
      rectTransform.anchoredPosition = new Vector2(0.0f, 0.0f);
      rectTransform.localPosition = new Vector3(0.0f, 0.0f, 0.0f);
    }
    if (!((Object) this.m_splashImage != (Object) null) || !((Object) this.m_splashImageSprite != (Object) null))
      return;
    this.m_splashImage.color = Color.white;
