...
public class Popup02687Menu : Popup02610Base
{
    ...
    Versus02610Menu menu)
  {
    ...
    popup02687Menu.GetComponent<UIWidget>().alpha = 0.0f;
    ...
    Future<WebAPI.Response.SeasonticketIndex> futureF = WebAPI.SeasonticketIndex((System.Action<WebAPI.Response.UserError>) (e =>
    {
    ...
    if (futureF.Result != null)
    {
      ...
      int number = popup02687Menu.ticket == null ? 0 : popup02687Menu.ticket.quantity;
      popup02687Menu.isTicket = number > 0;
      ...
      popup02687Menu.txtSeasonTicketNum.SetText(number.ToLocalizeNumberText());
      ...
      popup02687Menu.GetComponent<UIWidget>().alpha = 1f;
    }
  }
  ...
  private IEnumerator UpSeasonAPI()
  {
    Popup02687Menu popup02687Menu = this;
    Singleton<PopupManager>.GetInstance().onDismiss();
    Future<WebAPI.Response.SeasonticketSpend> future = WebAPI.SeasonticketSpend(1, popup02687Menu.ticket.season_ticket_id, (System.Action<WebAPI.Response.UserError>) (e =>
    {
      Singleton<CommonRoot>.GetInstance().isLoading = false;
      WebAPI.DefaultUserErrorCallback(e);
