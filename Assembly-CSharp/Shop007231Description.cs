...
public class Shop007231Description : BackButtonMenuBase
{
  ...
  private IEnumerator Start()
  {
    ...
    // ISSUE: reference to a compiler-generated field
    this.\u003C\u003E1__state = -1;
    UIPanel component = shop007231Description.scroll_.GetComponent<UIPanel>();
    ...
    shop007231Description.txtDescription_.width = (int) component.width;
    ...
    shop007231Description.txtNames_.transform.localPosition = (Vector3) new Vector2(shop007231Description.txtNames_.transform.localPosition.x, (float) -shop007231Description.txtDescription_.height);
    shop007231Description.txtNames_.width = (int) component.width;
