...
public class Mypage00181ScrollContainer : MonoBehaviour
{
    ...
    GameObject tabBadge)
  {
    ...
    mypage00181ScrollContainer.Scroll = mypage00181ScrollContainer.GetComponent<NGxScrollMasonry>();
    mypage00181ScrollContainer.Scroll.Scroll.transform.Clear();
    mypage00181ScrollContainer.Scroll.Reset();
    mypage00181ScrollContainer.Scroll.Scroll.gameObject.SetActive(false);
    mypage00181ScrollContainer.gameObject.SetActive(false);
    ...
    mypage00181ScrollContainer.Scroll.Scroll.gameObject.SetActive(true);
    mypage00181ScrollContainer.gameObject.SetActive(true);
