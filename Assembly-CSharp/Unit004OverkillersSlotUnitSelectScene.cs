...
public class Unit004OverkillersSlotUnitSelectScene : NGSceneBase
{
  ...
  public static void changeScene(EditOverkillersParam param) => Singleton<NGSceneManager>.GetInstance().changeScene(Unit004OverkillersSlotUnitSelectScene.DefaultName, true, (object) param);

  private Unit004OverkillersSlotUnitSelectMenu menu => this.menuBase as Unit004OverkillersSlotUnitSelectMenu;
  ...
  public void onStartScene(Unit004OverkillersSlotUnitSelectScene.Param param) => this.StartCoroutine(this.doDelayLoadingOff());
  ...
  public void onStartScene(EditOverkillersParam param) => this.onStartScene((Unit004OverkillersSlotUnitSelectScene.Param) null);
