...
public class CorpsQuestUnitSelectionMenu : UnitSelectMenuBase
{
    ...
    CorpsUtil.SequenceType type)
  {
    ...
    if (unitSelectionMenu.setting_.rule_no > 0)
    {
      ...
      unitSelectionMenu.slc_box_Unit_Formation.SetDimensions(720, 261);
    }
    else
    {
      unitSelectionMenu.dirRule.SetActive(false);
      unitSelectionMenu.slc_box_Unit_Formation.SetDimensions(720, 208);
    }
    ...
    unitSelectionMenu.InitializeInfo((IEnumerable<PlayerUnit>) unitSelectionMenu.playerUnits, (IEnumerable<PlayerMaterialUnit>) null, Persist.corpsUnitListSortAndFilter, false, false, false, true, false, new System.Action(unitSelectionMenu.InitializeAllUnitInfosExtend));
