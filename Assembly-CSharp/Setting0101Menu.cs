...
public class Setting0101Menu : BackButtonMenuBase
{
  ...
  public void Initialize()
  {
    ...
    this.btnHighGraphic.GetComponent<UIButton>().normalSprite = isSpeedPriority ? this.btnSpeedPriorityOFFSpriteName : this.btnSpeedPriorityONSpriteName;
    this.btnSpeedPriority.GetComponent<UIButton>().normalSprite = isSpeedPriority ? this.btnSpeedPriorityONSpriteName : this.btnSpeedPriorityOFFSpriteName;
  }
  ...
  {
    this.btnHighGraphic.GetComponent<UIButton>().normalSprite = this.btnSpeedPriorityONSpriteName;
    this.btnSpeedPriority.GetComponent<UIButton>().normalSprite = this.btnSpeedPriorityOFFSpriteName;
    Singleton<NGGameDataManager>.GetInstance().SetSpeedPriorityMode(false);
  }

  public void IbtnSpeedPriority()
  {
    this.btnHighGraphic.GetComponent<UIButton>().normalSprite = this.btnSpeedPriorityOFFSpriteName;
    this.btnSpeedPriority.GetComponent<UIButton>().normalSprite = this.btnSpeedPriorityONSpriteName;
