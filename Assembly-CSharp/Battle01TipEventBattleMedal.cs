...
public class Battle01TipEventBattleMedal : Battle01TipEventBase
{
  ...
  public override void setData(BL.DropData e, BL.Unit unit)
  {
    ...
    if (e.reward.Id != 0)
      this.setText(Consts.Format(Consts.GetInstance().TipEvent_text_limited_battle_medal, (IDictionary) dictionary));
    else
      this.setText(Consts.Format(Consts.GetInstance().TipEvent_text_battle_medal, (IDictionary) dictionary));
  }
}
