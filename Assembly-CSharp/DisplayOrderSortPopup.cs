...
public class DisplayOrderSortPopup : BackButtonMenuBase
{
  ...
  {
    this.categoryOffButtons.ForEach((System.Action<GameObject>) (x => x.SetActive(true)));
    this.categoryOnButtons.ForEach((System.Action<GameObject>) (x => x.SetActive(false)));
