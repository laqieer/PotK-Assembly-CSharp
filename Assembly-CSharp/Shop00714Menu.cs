...
public class Shop00714Menu : BackButtonMenuBase
{
  ...
  public void Init(int unitPrice, int unitQuantity, System.Action<int> onPrice = null)
  {
    this.price = unitPrice;
    this.unitPrice = unitPrice;
    this.unitQuantity = unitQuantity;
    Player player = SMManager.Observe<Player>().Value;
    int num = player.max_units_cap - player.max_units;
    int a = num / unitQuantity * unitPrice;
    if (num % unitQuantity > 0)
      a += unitPrice;
    int maxPrice = Mathf.Min(a, player.coin / unitPrice * unitPrice);
  ...
  private void UpdateNextMax(Player player) => this.nextMax = player.max_units + this.price / this.unitPrice * this.unitQuantity;
  ...
  {
    Future<WebAPI.Response.ShopBuy> paramF = WebAPI.ShopBuy(10000002, this.price, (System.Action<WebAPI.Response.UserError>) (e =>
    {
