...
public class unit004812Scene : NGSceneBase
{
  ...
  public static void changeScene(bool stack) => Singleton<NGSceneManager>.GetInstance().changeScene("unit004_8_12", stack);
    ...
    Dictionary<string, object> showPopupData)
  {
    ...
    IEnumerator e;
    if ((UnityEngine.Object) this.princessSynthesisPrefab == (UnityEngine.Object) null)
    {
    ...
    if ((UnityEngine.Object) this.menu.effect == (UnityEngine.Object) null)
      this.menu.effect = UnityEngine.Object.Instantiate<GameObject>(this.princessSynthesisPrefab).GetComponent<EffectControllerPrincessSynthesis>();
