...
public class SeaHomeManager : MonoBehaviour
{
  ...
  public bool isUnitInit => ((IEnumerable<SeaHomeUnitController>) this.unitControllers).All<SeaHomeUnitController>((Func<SeaHomeUnitController, bool>) (x => x.IsInit));
  ...
  public IEnumerator Init()
  {
    ...
    if ((UnityEngine.Object) seaHomeManager.shadowPrefab == (UnityEngine.Object) null)
    {
    ...
    if (activeMap != null && (seaHomeManager.nowMap == null || seaHomeManager.nowMap != activeMap))
    {
      ...
      if ((bool) (UnityEngine.Object) seaHomeManager.mapObject)
        UnityEngine.Object.Destroy((UnityEngine.Object) seaHomeManager.mapObject);
      ...
      seaHomeManager.directionalLight.transform.rotation = mapData.getDuelDirectionalLightRotate();
    ...
    else
    {
      ...
      catch
      {
        ...
        {
          IEnumerable<int> source3 = source2.Select<PlayerUnit, int>((Func<PlayerUnit, int>) (x => x.unit.same_character_id));
          for (int index = 0; index < source3.Count<int>(); ++index)
          {
    ...
    if (sameUnitIDs.Count < seaHomeManager.unitControllers.Length)
    {
      ...
      })).Distinct<UnitUnit>((IEqualityComparer<UnitUnit>) new LambdaEqualityComparer<UnitUnit>((Func<UnitUnit, UnitUnit, bool>) ((a, b) => a.same_character_id == b.same_character_id))))
      {
        ...
        source2.Add(unitUnit.same_character_id, num);
      }
      Dictionary<int, int> dictionary2 = source2.OrderByDescending<KeyValuePair<int, int>, int>((Func<KeyValuePair<int, int>, int>) (x => x.Value)).ToDictionary<KeyValuePair<int, int>, int, int>((Func<KeyValuePair<int, int>, int>) (y => y.Key), (Func<KeyValuePair<int, int>, int>) (z => z.Value));
    ...
    List<SeaHomeManager.UnitConrtolleData> source4 = new List<SeaHomeManager.UnitConrtolleData>();
    for (int i = 0; i < sameUnitIDs.Count; ++i)
    {
      ...
      if (playerUnit == (PlayerUnit) null)
      {
        ...
        source4.Add(new SeaHomeManager.UnitConrtolleData(unitUnit.ID, (PlayerUnit) null));
      }
      else
        source4.Add(new SeaHomeManager.UnitConrtolleData(playerUnit.unit.ID, playerUnit));
    }
    ...
    for (int index = 0; index < seaHomeManager.unitControllers.Length; ++index)
    {
      ...
      {
        SeaHomeManager.UnitConrtolleData unitData = source4.FirstOrDefault<SeaHomeManager.UnitConrtolleData>((Func<SeaHomeManager.UnitConrtolleData, bool>) (x => x.Equals((object) unitController.UnitData)));
        if (unitData != null)
        {
          unitController.SetUnitData(unitData, seaHomeManager);
          source4.Remove(unitData);
          continue;
        }
      }
    ...
    {
      int num = 0;
      foreach (SeaHomeManager.UnitConrtolleData unitData in source4)
  ...
  private int RandomChoice(Dictionary<int, int> choiceData)
  {
    if (choiceData.Count <= 0)
      return 0;
    int num1 = UnityEngine.Random.Range(0, choiceData.Sum<KeyValuePair<int, int>>((Func<KeyValuePair<int, int>, int>) (x => x.Value)));
    int num2 = 0;
  ...
  public void onEndScene()
  {
    if (this.cameraController.SetMode(SeaHomeCameraController.CameraMode.NORMAL))
    {
      if (this.cameraController.IsLookuped)
      {
        ...
        {
          if ((UnityEngine.Object) unitController != (UnityEngine.Object) this.nowLookupedUnit)
            unitController.Show();
        }
    ...
    {
      if ((UnityEngine.Object) this.nowLookupedUnit != (UnityEngine.Object) null)
  ...
  public void SetTouchBipObject(GameObject bipObject)
  {
    if (this.unitControllers == null)
      return;
    this.nowTouchUnit = ((IEnumerable<SeaHomeUnitController>) this.unitControllers).FirstOrDefault<SeaHomeUnitController>((Func<SeaHomeUnitController, bool>) (x => (UnityEngine.Object) x != (UnityEngine.Object) null && x.IsTouch(bipObject)));
    if (!((UnityEngine.Object) this.nowTouchUnit != (UnityEngine.Object) null))
      return;
  ...
  public void SetLookuped(SeaHomeUnitController lookup)
  {
    ...
    foreach (SeaHomeUnitController unitController in this.unitControllers)
    {
      if ((UnityEngine.Object) unitController != (UnityEngine.Object) lookup)
        unitController.Hide();
    }
  }
  ...
  public SeaHomeUnitController.UnitPositions GetNextMovePosition(
    SeaHomeUnitController target)
  {
    ...
    ((IEnumerable<SeaHomeUnitController>) this.unitControllers).ForEach<SeaHomeUnitController>((System.Action<SeaHomeUnitController>) (x =>
    {
  ...
  public bool DuplicatePosition(SeaHomeUnitController target)
  {
    ...
    return ((IEnumerable<SeaHomeUnitController>) this.unitControllers).Any<SeaHomeUnitController>((Func<SeaHomeUnitController, bool>) (x => (UnityEngine.Object) x != (UnityEngine.Object) target && x.NowWait && x.NowPosition == target.NowPosition));
  }

  public bool CheckDance(SeaHomeUnitController unit) => ((IEnumerable<SeaHomeUnitController>) this.unitControllers).All<SeaHomeUnitController>((Func<SeaHomeUnitController, bool>) (x => x.UnitData.PlayerUnit != (PlayerUnit) null && (double) x.UnitData.PlayerUnit.trust_rate >= 25.0 && x.PrevStatus != SeaHomeUnitController.UnitStatus.Dance && (((UnityEngine.Object) x == (UnityEngine.Object) unit || x.NowWait) && x.NowStand) && !x.NowHide)) && ((IEnumerable<SeaHomeUnitController>) this.unitControllers).Select<SeaHomeUnitController, SeaHomeUnitController.UnitPositions>((Func<SeaHomeUnitController, SeaHomeUnitController.UnitPositions>) (x => x.NowPosition)).Distinct<SeaHomeUnitController.UnitPositions>().Count<SeaHomeUnitController.UnitPositions>() == this.unitControllers.Length;

  public void PlayDance()
  {
    Singleton<NGSoundManager>.GetInstance().PlayBgmFile("BgmSeaEvent", "bgm233");
    ((IEnumerable<SeaHomeUnitController>) this.unitControllers).ForEach<SeaHomeUnitController>((System.Action<SeaHomeUnitController>) (x => x.PlayDance()));
  }
  ...
  public class UnitConrtolleData
  {
    ...
    public UnitUnit Unit => MasterData.UnitUnit.ContainsKey(this.UnitID) ? MasterData.UnitUnit[this.UnitID] : (UnitUnit) null;
