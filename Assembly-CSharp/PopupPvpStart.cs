...
public class PopupPvpStart : MonoBehaviour
{
  ...
  private class PopupPvpStartObject
  {
    ...
    {
      this.name.text = name;
      if ((UnityEngine.Object) this.guild != (UnityEngine.Object) null && guild != null)
        this.guild.text = guild;
      Future<UnityEngine.Sprite> spriteF = EmblemUtility.LoadEmblemSprite(emblem);
    ...
    public IEnumerator CreateUnitThum(
      int id,
      int lv,
      GameObject prefab,
      Transform parent)
