...
public class Bugu00521Scene : NGSceneBase
{
  ...
  public static void ChangeScene(bool stack, List<ItemInfo> select) => Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_composite", (stack ? 1 : 0) != 0, (object) select);
