...
public class CriAtomExPlayer : IDisposable
{
  ...
  public CriAtomExPlayer(int maxPath, int maxPathStrings)
    : this(maxPath, maxPathStrings, false)
  {
  }

  public CriAtomExPlayer(bool enableAudioSyncedTimer)
    : this(0, 0, enableAudioSyncedTimer)
  {
  }
  ...
  public void Pause() => CriAtomExPlayer.criAtomExPlayer_Pause(this.handle, true);
  ...
  public bool IsPaused() => CriAtomExPlayer.criAtomExPlayer_IsPaused(this.handle);
  ...
  public void SetPitch(float pitch) => CriAtomExPlayer.criAtomExPlayer_SetPitch(this.handle, pitch);
  ...
  public void SetBiquadFilterParameters(
    CriAtomEx.BiquadFilterType type,
    float frequency,
    float gain,
    float q)
  {
  ...
  public void UnsetCategory() => CriAtomExPlayer.criAtomExPlayer_UnsetCategory(this.handle);
  ...
  public void DetachFader() => CriAtomExPlayer.criAtomExPlayer_DetachFader(this.handle);
  ...
  public bool IsFading() => CriAtomExPlayer.criAtomExPlayer_IsFading(this.handle);
  ...
  public void UpdateAll() => CriAtomExPlayer.criAtomExPlayer_UpdateAll(this.handle);

  public void ResetParameters() => CriAtomExPlayer.criAtomExPlayer_ResetParameters(this.handle);

  public long GetTime() => CriAtomExPlayer.criAtomExPlayer_GetTime(this.handle);
  ...
  {
    CriAtomExPlayer.criAtomExPlayer_LimitLoopCount(this.handle, !sw ? -1 : -3);
  }
  ...
  public void Stop() => CriAtomExPlayer.criAtomExPlayer_Stop(this.handle);
  ...
  public void Pause(bool sw) => CriAtomExPlayer.criAtomExPlayer_Pause(this.handle, sw);

  ~CriAtomExPlayer() => this.Dispose();

  [DllImport("cri_ware_unity", CallingConvention = CallingConvention.Winapi)]
  private static extern IntPtr criAtomExPlayer_Create(
    ref CriAtomExPlayer.Config config,
    IntPtr work,
    int work_size);
  ...
  [DllImport("cri_ware_unity", CallingConvention = CallingConvention.Winapi)]
  private static extern float criAtomExPlayer_GetParameterFloat32(
    IntPtr player,
    CriAtomEx.Parameter id);

  [DllImport("cri_ware_unity", CallingConvention = CallingConvention.Winapi)]
  private static extern uint criAtomExPlayer_GetParameterUint32(
    IntPtr player,
    CriAtomEx.Parameter id);

  [DllImport("cri_ware_unity", CallingConvention = CallingConvention.Winapi)]
  private static extern int criAtomExPlayer_GetParameterSint32(
    IntPtr player,
    CriAtomEx.Parameter id);
  ...
  [DllImport("cri_ware_unity", CallingConvention = CallingConvention.Winapi)]
  private static extern void criAtomExPlayer_SetSendLevel(
    IntPtr player,
    int channel,
  ...
  private static extern void criAtomExPlayer_SetVoiceControlMethod(
    IntPtr player,
    CriAtomEx.VoiceControlMethod method);
  ...
  [DllImport("cri_ware_unity", CallingConvention = CallingConvention.Winapi)]
  private static extern void criAtomExPlayer_SetSelectorLabel(
    IntPtr player,
    string selector,
    string label);

  [DllImport("cri_ware_unity", CallingConvention = CallingConvention.Winapi)]
  private static extern void criAtomExPlayer_SetSoundRendererType(
    IntPtr player,
    CriAtomEx.SoundRendererType type);
