...
public class StoryEffectControl : MonoBehaviour
{
  ...
  private IEnumerator coInitializeLocal(int id, string namePrefab)
  {
    ...
    return (IEnumerator) new StoryEffectControl.\u003CcoInitializeLocal\u003Ec__Iterator516()
    {
      id = id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryEffectControl.\u003CcoInitializeEmotion\u003Ec__Iterator517()
    {
      id = id,
      noColor = noColor,
      \u003C\u0024\u003Eid = id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryEffectControl.\u003CcoInitializeEnvironment\u003Ec__Iterator518()
    {
      id = id,
      noColor = noColor,
      \u003C\u0024\u003Eid = id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryEffectControl.\u003CcoInitializeEffect\u003Ec__Iterator519()
    {
      id = id,
      noColor = noColor,
      \u003C\u0024\u003Eid = id,
