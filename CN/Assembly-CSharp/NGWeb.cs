...
public class NGWeb : Singleton<NGWeb>
{
  ...
  private IEnumerator apiErrorDispatch(WebError error)
  {
    ...
    return (IEnumerator) new NGWeb.\u003CapiErrorDispatch\u003Ec__IteratorA84()
    {
      error = error,
      \u003C\u0024\u003Eerror = error,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGWeb.\u003CapiAuthTokenErrorDispatch\u003Ec__IteratorA85()
    {
      error = error,
      \u003C\u0024\u003Eerror = error
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGWeb.\u003CapiClientErrorCallback\u003Ec__IteratorA86()
    {
      error = error,
      \u003C\u0024\u003Eerror = error,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGWeb.\u003CapiServerErrorCallback\u003Ec__IteratorA87()
    {
      error = error,
      \u003C\u0024\u003Eerror = error,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGWeb.\u003CapiRetryOutErrorCallback\u003Ec__IteratorA88()
    {
      error = error,
      \u003C\u0024\u003Eerror = error
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGWeb.\u003CShowTranferModalWindowCore\u003Ec__IteratorA89()
    {
      yes = yes,
      no = no,
      \u003C\u0024\u003Eyes = yes,
