...
public class DailyMission0271Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init()
  {
    ...
    return (IEnumerator) new DailyMission0271Menu.\u003CInit\u003Ec__Iterator671()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271Menu.\u003CChooseButton\u003Ec__Iterator672()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271Menu.\u003CloadConfirmPopup\u003Ec__Iterator673()
    {
  ...
  {
    Debug.Log((object) "[dailymission]end button effect");
    this.isEndEffect = true;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271Menu.\u003CselectCompRewardAsync\u003Ec__Iterator674()
    {
      groupId = groupId,
      \u003C\u0024\u003EgroupId = groupId,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271Menu.\u003CplayEffect\u003Ec__Iterator675()
    {
      go = go,
      \u003C\u0024\u003Ego = go,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271Menu.\u003CcreateBingoMission\u003Ec__Iterator676()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0271Menu.\u003CloadUnitBackground\u003Ec__Iterator677()
    {
      \u003C\u003Ef__this = this
    };
  }
