        ...
        switch (this.lineParser(line, ref command, ref args1))
        {
          ...
          case "#":
            ...
            if (key != null)
            {
              ...
              if (StoryParser.\u003C\u003Ef__switch\u0024map1A == null)
              {
                // ISSUE: reference to a compiler-generated field
                StoryParser.\u003C\u003Ef__switch\u0024map1A = new Dictionary<string, int>(4)
                {
                  {
                    "label",
                    0
              ...
              int num2;
              // ISSUE: reference to a compiler-generated field
              if (StoryParser.\u003C\u003Ef__switch\u0024map1A.TryGetValue(key, out num2))
              {
                switch (num2)
                {
                  case 0:
                  ...
                  case 1:
                    if (SExp.car((object) args2) is SExpString sexpString2)
                    {
                      ...
                      {
                        // ISSUE: reference to a compiler-generated field
                        if (StoryParser.\u003C\u003Ef__switch\u0024map19 == null)
                        {
                          // ISSUE: reference to a compiler-generated field
                          StoryParser.\u003C\u003Ef__switch\u0024map19 = new Dictionary<string, int>(1)
                          {
                            {
                              "lisp",
                              0
                        ...
                        int num3;
                        // ISSUE: reference to a compiler-generated field
                        if (StoryParser.\u003C\u003Ef__switch\u0024map19.TryGetValue(strValue, out num3) && num3 == 0)
                        {
