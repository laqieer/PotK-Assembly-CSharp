...
public class Guild0285Scroll : MonoBehaviour
{
  ...
  public IEnumerator Initialize(Guild0285Menu menu, GuildApplicant applicant, DateTime now)
  {
    ...
    return (IEnumerator) new Guild0285Scroll.\u003CInitialize\u003Ec__Iterator6F9()
    {
      menu = menu,
      applicant = applicant,
      now = now,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0285Scroll.\u003CSetUnitIcon\u003Ec__Iterator6FA()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0285Scroll.\u003CAccept\u003Ec__Iterator6FB()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    if (PlayerAffiliation.Current.guild.appearance.membership_num < PlayerAffiliation.Current.guild.appearance.membership_capacity)
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0285Scroll.\u003CRefuse\u003Ec__Iterator6FC()
    {
      \u003C\u003Ef__this = this
    };
  }

  public void onRefuseButton() => this.StartCoroutine(this.Refuse());
}
