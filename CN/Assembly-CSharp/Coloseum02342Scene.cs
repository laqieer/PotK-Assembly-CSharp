...
public class Coloseum02342Scene : NGSceneBase
{
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    return (IEnumerator) new Coloseum02342Scene.\u003ConInitSceneAsync\u003Ec__Iterator5AF()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Scene.\u003ConStartSceneAsync\u003Ec__Iterator5B0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Scene.\u003ConStartSceneAsync\u003Ec__Iterator5B1()
    {
      gladiator = gladiator,
      info = info,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Scene.\u003ConStartSceneAsync\u003Ec__Iterator5B2()
    {
      resume = resume,
      info = info,
      battle_result = battle_result,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Scene.\u003ConStartSceneAsync\u003Ec__Iterator5B3()
    {
      resume = resume,
      info = info,
      battle_result = battle_result,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Scene.\u003ConStartSceneAsync\u003Ec__Iterator5B4()
    {
      info = info,
      result = result,
      \u003C\u0024\u003Einfo = info,
