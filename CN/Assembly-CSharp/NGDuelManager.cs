...
public class NGDuelManager : MonoBehaviour
{
  ...
  public IEnumerator Initialize(DuelResult duelResult, DuelEnvironment duelEnv)
  {
    ...
    return (IEnumerator) new NGDuelManager.\u003CInitialize\u003Ec__Iterator7E6()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CmakePlayerUnit\u003Ec__Iterator7E7()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CmakeEnemyUnit\u003Ec__Iterator7E8()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CwaitCurrentStatusEnd\u003Ec__Iterator7E9()
    {
      duration = duration,
      status = status,
      \u003C\u0024\u003Eduration = duration,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CstartDuelStartAnimation\u003Ec__Iterator7EA()
    {
      duration = duration,
      status = status,
      \u003C\u0024\u003Eduration = duration,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CwaitBossFirstCameraEnd\u003Ec__Iterator7EB()
    {
      duration = duration,
      \u003C\u0024\u003Eduration = duration,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CcreateMap\u003Ec__Iterator7EC()
    {
      stage = stage,
      \u003C\u0024\u003Estage = stage,
      \u003C\u003Ef__this = this
  ...
  private IEnumerator preloadDuelUnitObject()
  {
    ...
    NGDuelManager.\u003CpreloadDuelUnitObject\u003Ec__Iterator7ED objectCIterator7Ed = new NGDuelManager.\u003CpreloadDuelUnitObject\u003Ec__Iterator7ED();
    return (IEnumerator) objectCIterator7Ed;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CpreloadEffect\u003Ec__Iterator7EE()
    {
      \u003C\u003Ef__this = this
    };
  }
