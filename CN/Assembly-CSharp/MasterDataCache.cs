...
public static class MasterDataCache
{
  ...
  private static IEnumerable<string> CleanTargets()
  {
    ...
    MasterDataCache.\u003CCleanTargets\u003Ec__Iterator3E targetsCIterator3E1 = new MasterDataCache.\u003CCleanTargets\u003Ec__Iterator3E();
    // ISSUE: variable of a compiler-generated type
    MasterDataCache.\u003CCleanTargets\u003Ec__Iterator3E targetsCIterator3E2 = targetsCIterator3E1;
    // ISSUE: reference to a compiler-generated field
    targetsCIterator3E2.\u0024PC = -2;
    return (IEnumerable<string>) targetsCIterator3E2;
  }
  ...
  private static IEnumerable<KeyValuePair<K, T>> AssocListSelect<K, T>(T[] list, Func<T, K> getID)
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    MasterDataCache.\u003CAssocListSelect\u003Ec__Iterator3F<K, T> selectCIterator3F = new MasterDataCache.\u003CAssocListSelect\u003Ec__Iterator3F<K, T>()
    {
      list = list,
      getID = getID,
      \u003C\u0024\u003Elist = list,
    ...
    // ISSUE: reference to a compiler-generated field
    selectCIterator3F.\u0024PC = -2;
    return (IEnumerable<KeyValuePair<K, T>>) selectCIterator3F;
  }
  ...
  private static IEnumerable<KeyValuePair<M, T[]>> Select<M, T>(Dictionary<M, List<T>> d)
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    MasterDataCache.\u003CSelect\u003Ec__Iterator40<M, T> selectCIterator40 = new MasterDataCache.\u003CSelect\u003Ec__Iterator40<M, T>()
    {
      d = d,
      \u003C\u0024\u003Ed = d
    };
    // ISSUE: reference to a compiler-generated field
    selectCIterator40.\u0024PC = -2;
    return (IEnumerable<KeyValuePair<M, T[]>>) selectCIterator40;
  }
