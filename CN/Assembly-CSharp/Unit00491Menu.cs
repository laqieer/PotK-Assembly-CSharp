...
public class Unit00491Menu : UnitMenuBase
{
    ...
    Unit00491Menu.Mode mode)
  {
    ...
    return (IEnumerator) new Unit00491Menu.\u003CInit\u003Ec__Iterator322()
    {
      mode = mode,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00491Menu.\u003CUpdateInfoAndScroll\u003Ec__Iterator323()
    {
      playerUnits = playerUnits,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00491Menu.\u003CCreateUnitIcon\u003Ec__Iterator324()
    {
