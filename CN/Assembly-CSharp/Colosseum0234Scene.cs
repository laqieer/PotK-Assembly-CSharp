...
public class Colosseum0234Scene : NGSceneBase
{
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    return (IEnumerator) new Colosseum0234Scene.\u003ConInitSceneAsync\u003Ec__Iterator592()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum0234Scene.\u003ConStartSceneAsync\u003Ec__Iterator593()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum0234Scene.\u003ConStartSceneAsync\u003Ec__Iterator594()
    {
      param = param,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum0234Scene.\u003CRestart\u003Ec__Iterator595()
    {
      param = param,
      isTutorial = isTutorial,
      \u003C\u0024\u003Eparam = param,
  ...
  public override IEnumerator onEndSceneAsync()
  {
    ...
    Colosseum0234Scene.\u003ConEndSceneAsync\u003Ec__Iterator596 asyncCIterator596 = new Colosseum0234Scene.\u003ConEndSceneAsync\u003Ec__Iterator596();
    return (IEnumerator) asyncCIterator596;
  }
