...
public class GuildBankDonateListBase : BackButtonMenuBase
{
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    return (IEnumerator) new GuildBankDonateListBase.\u003CCreateScrollBase\u003Ec__Iterator715()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  protected virtual IEnumerator CreateScroll(int info_index, int bar_index)
  {
    ...
    GuildBankDonateListBase.\u003CCreateScroll\u003Ec__Iterator716 scroll = new GuildBankDonateListBase.\u003CCreateScroll\u003Ec__Iterator716();
