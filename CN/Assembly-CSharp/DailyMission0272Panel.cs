...
public class DailyMission0272Panel : MonoBehaviour
{
  ...
  public IEnumerator Init(PlayerDailyMissionAchievement pdm, BackButtonMenuBase baseMenu)
  {
    ...
    return (IEnumerator) new DailyMission0272Panel.\u003CInit\u003Ec__Iterator682()
    {
      pdm = pdm,
      baseMenu = baseMenu,
      \u003C\u0024\u003Epdm = pdm,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0272Panel.\u003CreceiveReward\u003Ec__Iterator683()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DailyMission0272Panel.\u003CopenPopup0273\u003Ec__Iterator684()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public class RewardViewModel
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new DailyMission0272Panel.RewardViewModel.\u003CLoadThumb\u003Ec__Iterator685()
      {
        go = go,
        \u003C\u0024\u003Ego = go,
        \u003C\u003Ef__this = this
    ...
    private string getRewardName()
    {
      ...
      switch (this.typeId)
      {
        case 1:
        case 24:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_UNIT, (IDictionary) new Hashtable()
          {
            {
              (object) "Name",
        ...
        case 2:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_SUPPLY, (IDictionary) new Hashtable()
          {
            {
              (object) "Name",
        ...
        case 3:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_GEAR, (IDictionary) new Hashtable()
          {
            {
              (object) "Name",
        ...
        case 4:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_ZENY, (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) this.quantity
        ...
        case 6:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_EXP, (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) this.quantity
        ...
        case 7:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_UNITEXP, (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) this.quantity
        ...
        case 10:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_STONE, (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) this.quantity
        ...
        case 14:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_MEDAL, (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) this.quantity
        ...
        case 15:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_POINT, (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) this.quantity
        ...
        case 17:
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_BATTLE_MEDAL, (IDictionary) new Hashtable()
          {
            {
              (object) "Count",
              (object) this.quantity
        ...
        case 19:
          return Consts.Format(Consts.GetInstance().DAILY_MISSIOM_REWARD_KEY, (IDictionary) new Hashtable()
          {
            {
              (object) "Name",
        ...
        case 20:
          ...
          return Consts.Format(Consts.GetInstance().MYPAGE_0017_GACHATICKET_NAME, (IDictionary) args);
        default:
          return this.message;
      }
    }
