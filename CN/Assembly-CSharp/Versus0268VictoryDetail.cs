...
public class Versus0268VictoryDetail : MonoBehaviour
{
    ...
    Versus0268Menu.PvpParam param)
  {
    ...
    return (IEnumerator) new Versus0268VictoryDetail.\u003CSetDefault\u003Ec__Iterator665()
    {
      finish = finish,
      param = param,
      \u003C\u0024\u003Efinish = finish,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268VictoryDetail.\u003CSetConditionSprite\u003Ec__Iterator666()
    {
      c = c,
      nowWin = nowWin,
      \u003C\u0024\u003Ec = c,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268VictoryDetail.\u003CSetConditionEffect\u003Ec__Iterator667()
    {
      condition = condition,
      \u003C\u0024\u003Econdition = condition,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268VictoryDetail.\u003CStartAnim\u003Ec__Iterator668()
    {
      \u003C\u003Ef__this = this
    };
  }
