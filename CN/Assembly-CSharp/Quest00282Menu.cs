...
public class Quest00282Menu : BackButtonMenuBase
{
    ...
    PlayerQuestSConverter harmony_quest)
  {
    ...
    return (IEnumerator) new Quest00282Menu.\u003CInitPlayerDecks\u003Ec__Iterator28C()
    {
      helpers = helpers,
  ...
  public IEnumerator onEndScene()
  {
    ...
    Quest00282Menu.\u003ConEndScene\u003Ec__Iterator28D sceneCIterator28D = new Quest00282Menu.\u003ConEndScene\u003Ec__Iterator28D();
    return (IEnumerator) sceneCIterator28D;
  }
}
