...
public class Battle0181CharacterStatus : NGBattleMenuBase
{
  ...
  public virtual void Init(BL.UnitPosition up, AttackStatus attackStatus)
  {
    ...
    this.setHPNumbers(unit.hp.ToString().ToCharArray());
  ...
  private IEnumerator LoadCharaIcon()
  {
    ...
    return (IEnumerator) new Battle0181CharacterStatus.\u003CLoadCharaIcon\u003Ec__Iterator7D2()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void Damaged(int damage, int? heal = null)
  {
    ...
    this.setHPNumbers(this.currentHp.ToString().ToCharArray());
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill\u003Ec__Iterator7D3()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill2\u003Ec__Iterator7D4()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill3\u003Ec__Iterator7D5()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle0181CharacterStatus.\u003CdisplaySkill4\u003Ec__Iterator7D6()
    {
      iskill = iskill,
      \u003C\u0024\u003Eiskill = iskill,
      \u003C\u003Ef__this = this
