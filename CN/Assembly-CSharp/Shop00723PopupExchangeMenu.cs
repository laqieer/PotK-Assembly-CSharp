...
public class Shop00723PopupExchangeMenu : BackButtonMenuBase
{
    ...
    PlayerUnitTicketSummary ticket)
  {
    ...
    return (IEnumerator) new Shop00723PopupExchangeMenu.\u003CcoInitialize\u003Ec__Iterator475()
    {
      menu = menu,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00723PopupExchangeMenu.\u003CwaitPopupClose\u003Ec__Iterator476()
    {
      \u003C\u003Ef__this = this
    };
  }
