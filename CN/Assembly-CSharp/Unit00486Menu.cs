...
{
  protected const int MAX_DISPMATERIALUNIT = 5;
  [SerializeField]
  ...
  public virtual bool isComposeUnit(PlayerUnit baseUnit, PlayerUnit unit)
  {
    ...
    bool flag4 = UnitDetailIcon.IsSkillUpMaterial(unit.unit, baseUnit);
  ...
  {
    ((IEnumerable<PlayerUnitSkills>) baseUnit.skills).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (x => x.level < x.skill.upper_level));
    bool flag1 = false;
    if (unit.unit.hp_compose != 0 && baseUnit.hp.compose < baseUnit.UnitTypeParameter.hp_compose_max)
      flag1 = true;
    if (unit.unit.strength_compose != 0 && baseUnit.strength.compose < baseUnit.UnitTypeParameter.strength_compose_max)
    ...
    bool flag2 = false;
    if (unit.unit.IsBreakThrough && baseUnit.breakthrough_count < baseUnit.unit.breakthrough_limit)
      flag2 = unit.unit.CheckBreakThroughMaterial(baseUnit);
    bool flag3 = UnitDetailIcon.IsSkillUpMaterial(unit.unit, baseUnit);
    if (unit.unit.IsBuildup)
    {
      int num;
      flag3 = (num = 0) != 0;
  ...
  protected void CreateSelectIconInfo(PlayerUnit[] selectUnits, bool updateFirst = true)
  {
    ...
    foreach (PlayerUnit selectUnit in selectUnits)
    {
      ...
      UnitIconInfo unitIconInfo = this.allUnitInfos.FirstOrDefault<UnitIconInfo>((Func<UnitIconInfo, bool>) (y => y.playerUnit == x && !y.playerUnit.favorite));
    ...
    bool updateFirst = true)
  {
    ...
    return (IEnumerator) new Unit00486Menu.\u003CUpdateInfoAndScrollExtend\u003Ec__Iterator345()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00486Menu.\u003CInitialize\u003Ec__Iterator346()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00486Menu.\u003CInit\u003Ec__Iterator347()
    {
      player = player,
