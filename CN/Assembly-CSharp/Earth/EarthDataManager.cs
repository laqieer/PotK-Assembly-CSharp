...
namespace Earth
{
  public class EarthDataManager : Singleton<EarthDataManager>
  {
      ...
      Action<WebAPI.Response.UserError> userErrorCallback = null)
    {
      ...
      return (IEnumerator) new EarthDataManager.\u003CEarthDataInit\u003Ec__IteratorA35()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EarthDataManager.\u003CSendSave\u003Ec__IteratorA36()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EarthDataManager.\u003CSaveAndSendServer\u003Ec__IteratorA37()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EarthDataManager.\u003CSaveEndTutorial\u003Ec__IteratorA38()
      {
        \u003C\u003Ef__this = this
      };
    }
