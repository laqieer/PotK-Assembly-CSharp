...
namespace Earth
{
  ...
  public class EarthQuestProgress : BL.ModelBase
  {
    ...
    public void GoPrologueScene(bool isCloudAnime = false)
    {
      ...
      if (EarthQuestProgress.\u003C\u003Ef__switch\u0024map22 == null)
      {
        // ISSUE: reference to a compiler-generated field
        EarthQuestProgress.\u003C\u003Ef__switch\u0024map22 = new Dictionary<string, int>(2)
        {
          {
            "battle",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (!EarthQuestProgress.\u003C\u003Ef__switch\u0024map22.TryGetValue(type, out num))
        return;
      if (num != 0)
      {
        if (num != 1)
    ...
    private IEnumerator ChangeBattle(bool isCloudAnime)
    {
      ...
      return (IEnumerator) new EarthQuestProgress.\u003CChangeBattle\u003Ec__IteratorA39()
      {
