...
public static class AlgorithmUtil
{
  ...
  private static IEnumerable<IEnumerable<T>> _permutation<T>(IEnumerable<T> xs, IEnumerable<T> ys) where T : IComparable
  {
    ...
    AlgorithmUtil.\u003C_permutation\u003Ec__IteratorB08<T> permutationCIteratorB08 = new AlgorithmUtil.\u003C_permutation\u003Ec__IteratorB08<T>()
    {
      ys = ys,
      xs = xs,
      \u003C\u0024\u003Eys = ys,
    ...
    permutationCIteratorB08.\u0024PC = -2;
    return (IEnumerable<IEnumerable<T>>) permutationCIteratorB08;
  }
}
