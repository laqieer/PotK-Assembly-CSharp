...
public class Guild028114Popup : BackButtonMenuBase
{
  ...
  public void Initialize(GuildInfoPopup popup)
  {
    ...
    this.StartCoroutine(this.SetGuildData(PlayerAffiliation.Current.guild));
  ...
  private void SetButton(GuildInfoPopup popup)
  {
    ...
    {
      if (PlayerAffiliation.Current.status == GuildMembershipStatus.applicant && PlayerAffiliation.Current.guild_id == this.guildDirectory.guild_id)
      {
  ...
  private IEnumerator SetGuildData(GuildRegistration data)
  {
    ...
    return (IEnumerator) new Guild028114Popup.\u003CSetGuildData\u003Ec__Iterator696()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild028114Popup.\u003CSetGuildData\u003Ec__Iterator697()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild028114Popup.\u003CResetScrollPosition\u003Ec__Iterator698()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void SetGuildData(GuildAppearance data, string guildID)
  {
    ...
    this.lose.SetTextLocalize(data.lose_num);
    this.draw.SetTextLocalize(data.draw_num);
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild028114Popup.\u003CShowGuildStatementPopup\u003Ec__Iterator699()
    {
      \u003C\u003Ef__this = this
    };
  }
