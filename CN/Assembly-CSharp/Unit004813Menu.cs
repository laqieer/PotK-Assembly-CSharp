...
public class Unit004813Menu : BackButtonMenuBase
{
  ...
  private IEnumerator AddEvolutionSkill(PlayerUnitSkills beforeSkill)
  {
    ...
    return (IEnumerator) new Unit004813Menu.\u003CAddEvolutionSkill\u003Ec__Iterator32E()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CSetUnitTexture\u003Ec__Iterator32F()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CsetCharacter\u003Ec__Iterator330()
    {
      otherData = otherData,
      afterUnit = afterUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CPopupSequence\u003Ec__Iterator331()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CNextSkillPopup\u003Ec__Iterator332()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CMedalPopup\u003Ec__Iterator333()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CCharacterQuestStoryPopup\u003Ec__Iterator334()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CSkillRankUpPopup\u003Ec__Iterator335()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004813Menu.\u003CFinishSequence\u003Ec__Iterator336()
    {
      \u003C\u003Ef__this = this
    };
  }
