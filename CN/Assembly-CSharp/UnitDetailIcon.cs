...
public class UnitDetailIcon : UnitIconBase
{
  ...
  public static IEnumerator LoadSprite(UnitUnit unit)
  {
    ...
    return (IEnumerator) new UnitDetailIcon.\u003CLoadSprite\u003Ec__IteratorAC9()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetMaterialUnit\u003Ec__IteratorACA()
    {
      playerUnit = playerUnit,
      isNew = isNew,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetMaterialUnit\u003Ec__IteratorACB()
    {
      playerUnit = playerUnit,
      isNew = isNew,
      playerUnits = playerUnits,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetPlayerUnit\u003Ec__IteratorACC()
    {
      playerUnit = playerUnit,
      playerUnits = playerUnits,
      basePlayerUnit = basePlayerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetPlayerUnitEvolution\u003Ec__IteratorACD()
    {
      playerUnit = playerUnit,
      playerUnits = playerUnits,
      basePlayerUnit = basePlayerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetUnit\u003Ec__IteratorACE()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetUnit\u003Ec__IteratorACF()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
