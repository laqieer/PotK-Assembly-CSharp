...
public class Bugu0053Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitGearsSynthesis(List<InventoryItem> playerGears, Player player)
  {
    ...
    return (IEnumerator) new Bugu0053Menu.\u003CInitGearsSynthesis\u003Ec__Iterator399()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0053Menu.\u003CCreateMaterialList\u003Ec__Iterator39A()
    {
      gears = gears,
      \u003C\u0024\u003Egears = gears,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0053Menu.\u003CStartComposite\u003Ec__Iterator39B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0053Menu.\u003CCompositeAPI\u003Ec__Iterator39C()
    {
      \u003C\u003Ef__this = this
    };
  }
