...
public class Guide0114Menu : GuideZukanListManager
{
  ...
  public IEnumerator onInitMenuAsync()
  {
    ...
    return (IEnumerator) new Guide0114Menu.\u003ConInitMenuAsync\u003Ec__Iterator565()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public override void SortAndFilter()
  {
    ...
    {
      if (obj.history_group_number == 0 || obj.published_at == new DateTime() || !(obj.published_at < Singleton<NGGameDataManager>.GetInstance().signedInAt))
        return;
