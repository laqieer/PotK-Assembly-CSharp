...
public class BattleUI05RewardMenu : ResultMenuBase
{
  ...
  public override IEnumerator Init(GameCore.BattleInfo info, BattleEnd result)
  {
    ...
    return (IEnumerator) new BattleUI05RewardMenu.\u003CInit\u003Ec__Iterator8CF()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RewardMenu.\u003CRun\u003Ec__Iterator8D0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RewardMenu.\u003COnFinish\u003Ec__Iterator8D1()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RewardMenu.\u003CSetReward\u003Ec__Iterator8D2()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RewardMenu.\u003CInitPopup\u003Ec__Iterator8D3()
    {
      popup = popup,
      setter = setter,
      \u003C\u0024\u003Epopup = popup,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RewardMenu.\u003COpenRewardIcon\u003Ec__Iterator8D4()
    {
      \u003C\u003Ef__this = this
    };
  }
