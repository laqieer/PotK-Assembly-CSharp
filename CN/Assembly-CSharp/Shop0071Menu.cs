...
public class Shop0071Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(WebAPI.Response.ShopStatus shopStatus, bool specialShopError)
  {
    ...
    return (IEnumerator) new Shop0071Menu.\u003CInit\u003Ec__Iterator43F()
    {
  ...
  private IEnumerator popup999111AP()
  {
    ...
    Shop0071Menu.\u003Cpopup999111AP\u003Ec__Iterator440 popup999111ApCIterator440 = new Shop0071Menu.\u003Cpopup999111AP\u003Ec__Iterator440();
    return (IEnumerator) popup999111ApCIterator440;
  }
  ...
  private IEnumerator popup00712()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    Shop0071Menu.\u003Cpopup00712\u003Ec__Iterator441 popup00712CIterator441 = new Shop0071Menu.\u003Cpopup00712\u003Ec__Iterator441();
    return (IEnumerator) popup00712CIterator441;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0071Menu.\u003CpopupAlert999111\u003Ec__Iterator442()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator popup00714()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    Shop0071Menu.\u003Cpopup00714\u003Ec__Iterator443 popup00714CIterator443 = new Shop0071Menu.\u003Cpopup00714\u003Ec__Iterator443();
    return (IEnumerator) popup00714CIterator443;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0071Menu.\u003CpopupAlert999121\u003Ec__Iterator444()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator popup00716()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    Shop0071Menu.\u003Cpopup00716\u003Ec__Iterator445 popup00716CIterator445 = new Shop0071Menu.\u003Cpopup00716\u003Ec__Iterator445();
    return (IEnumerator) popup00716CIterator445;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0071Menu.\u003CcoPopupUnitItemPlus\u003Ec__Iterator446()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void IbtnUnitCouponShop()
  {
    if (this.IsPushAndSet())
      return;
    Singleton<NGSceneManager>.GetInstance().changeScene("shop007_23", true, (object) this.unitCouponID_);
  }
}
