...
public class UnitIconBase : IconPrefabBase
{
  ...
  [SerializeField]
  protected GameObject spcelalIcon;
  ...
  public bool SpecialIcon
  {
    get
    {
      return !Object.op_Equality((Object) this.spcelalIcon, (Object) null) && this.spcelalIcon.activeSelf;
    }
    set
    {
      if (!Object.op_Inequality((Object) this.spcelalIcon, (Object) null))
        return;
      this.spcelalIcon.SetActive(value);
    }
  }
  ...
  public virtual IEnumerator SetUnit(UnitUnit unit, CommonElement element, bool isGray = false)
  {
    ...
    return (IEnumerator) new UnitIconBase.\u003CSetUnit\u003Ec__IteratorAC4()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetUnitWithLongPressAction\u003Ec__IteratorAC5()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetMaterialUnit\u003Ec__IteratorAC6()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetMaterialUnit\u003Ec__IteratorAC7()
    {
      playerUnit = playerUnit,
      isNew = isNew,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIconBase.\u003CSetPlayerUnit\u003Ec__IteratorAC8()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
