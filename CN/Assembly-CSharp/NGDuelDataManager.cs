...
public class NGDuelDataManager : Singleton<NGDuelDataManager>
{
  ...
  public IEnumerator createMapCache(BL.Stage stage, bool isColosseum)
  {
    ...
    return (IEnumerator) new NGDuelDataManager.\u003CcreateMapCache\u003Ec__Iterator7E2()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelDataManager.\u003CcreateMap\u003Ec__Iterator7E3()
    {
      stage = stage,
      isColosseum = isColosseum,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelDataManager.\u003CpreloadDuelUnitObject\u003Ec__Iterator7E4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelDataManager.\u003CloadDefaultAnimatorController\u003Ec__Iterator7E5()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit
    };
