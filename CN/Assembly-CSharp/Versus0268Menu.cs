...
public class Versus0268Menu : ResultMenuBase
{
  ...
  public override IEnumerator Init(WebAPI.Response.PvpPlayerFinish info)
  {
    ...
    return (IEnumerator) new Versus0268Menu.\u003CInit\u003Ec__Iterator653()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CSetPrefabs\u003Ec__Iterator654()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CRun\u003Ec__Iterator655()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public override IEnumerator OnFinish()
  {
    ...
    Versus0268Menu.\u003COnFinish\u003Ec__Iterator656 finishCIterator656 = new Versus0268Menu.\u003COnFinish\u003Ec__Iterator656();
    return (IEnumerator) finishCIterator656;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CInitObjects\u003Ec__Iterator657()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CShowRecord\u003Ec__Iterator658()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CShowTitleEXP\u003Ec__Iterator659()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CShowAnotherPopup\u003Ec__Iterator65A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CPvpCharacterIntimatesPopup\u003Ec__Iterator65B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CShowFirstBattlePopup\u003Ec__Iterator65C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0268Menu.\u003CShowBottomMessage\u003Ec__Iterator65D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public class PvpParam
  {
    ...
    public PvpParam(WebAPI.Response.PvpPlayerFinish finish)
    {
      ...
      else
      {
        ...
        this.title = !flag ? Consts.GetInstance().VERSUS_00262TITLE_FRIEND : Consts.GetInstance().VERSUS_00262TITLE_RANDOM;
