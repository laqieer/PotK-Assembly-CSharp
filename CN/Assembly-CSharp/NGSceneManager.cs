...
public class NGSceneManager : Singleton<NGSceneManager>
{
  ...
  private IEnumerator doLoadLevelAdditiveAsync(NGSceneManager.SceneWrapper scene)
  {
    ...
    return (IEnumerator) new NGSceneManager.\u003CdoLoadLevelAdditiveAsync\u003Ec__IteratorA75()
    {
      scene = scene,
      \u003C\u0024\u003Escene = scene,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSceneManager.\u003CinvokeMethod\u003Ec__IteratorA76()
    {
      obj = obj,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSceneManager.\u003CchangeSceneUpdate\u003Ec__IteratorA77()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSceneManager.\u003CprocessChangeSceneQueueLoop\u003Ec__IteratorA78()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSceneManager.\u003CprocessChangeSceneQueueCore\u003Ec__IteratorA79()
    {
      nextScene = nextScene,
      \u003C\u0024\u003EnextScene = nextScene,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSceneManager.\u003CwaitSceneActionImpl\u003Ec__IteratorA7A()
    {
      callback = callback,
      \u003C\u0024\u003Ecallback = callback,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSceneManager.\u003CdestroyLoadedScenesImmediate\u003Ec__IteratorA7B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator RestartCoroutine()
  {
    ...
    NGSceneManager.\u003CRestartCoroutine\u003Ec__IteratorA7C coroutineCIteratorA7C = new NGSceneManager.\u003CRestartCoroutine\u003Ec__IteratorA7C();
    return (IEnumerator) coroutineCIteratorA7C;
  }
