...
public class EffectControllerPrincessSynthesis : EffectController
{
    ...
    List<int> other_list)
  {
    ...
    return (IEnumerator) new EffectControllerPrincessSynthesis.\u003Cinitialize\u003Ec__Iterator904()
    {
      unit_list = unit_list,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerPrincessSynthesis.\u003CSet\u003Ec__Iterator905()
    {
      unit_list = unit_list,
      result_unit = result_unit,
      other_list = other_list,
