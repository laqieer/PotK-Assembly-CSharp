...
public class SlotDebug : MonoBehaviour
{
  ...
  public IEnumerator Init()
  {
    ...
    return (IEnumerator) new SlotDebug.\u003CInit\u003Ec__Iterator45F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new SlotDebug.\u003CGetTexture\u003Ec__Iterator460()
    {
      filename = filename,
      \u003C\u0024\u003Efilename = filename,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new SlotDebug.\u003CCheckLoadState\u003Ec__Iterator461()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void Lamp_switch(string color)
  {
    ...
    if (SlotDebug.\u003C\u003Ef__switch\u0024map14 == null)
    {
      // ISSUE: reference to a compiler-generated field
      SlotDebug.\u003C\u003Ef__switch\u0024map14 = new Dictionary<string, int>(3)
      {
        {
          "blue",
          0
    ...
    int num;
    // ISSUE: reference to a compiler-generated field
    if (!SlotDebug.\u003C\u003Ef__switch\u0024map14.TryGetValue(key, out num))
      return;
    switch (num)
    {
      case 0:
