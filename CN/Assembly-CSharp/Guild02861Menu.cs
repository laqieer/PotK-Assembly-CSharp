...
public class Guild02861Menu : Guild0286Scroll
{
  ...
  public IEnumerator Init(GuildMemberGift[] gifts)
  {
    ...
    return (IEnumerator) new Guild02861Menu.\u003CInit\u003Ec__Iterator709()
    {
      gifts = gifts,
      \u003C\u0024\u003Egifts = gifts,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02861Menu.\u003CSendConnection\u003Ec__Iterator70A()
    {
      gift = gift,
      \u003C\u0024\u003Egift = gift,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02861Menu.\u003CSendAll\u003Ec__Iterator70B()
    {
      \u003C\u003Ef__this = this
    };
  }
