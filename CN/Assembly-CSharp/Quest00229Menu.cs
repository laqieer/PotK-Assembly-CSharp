...
public class Quest00229Menu : BackButtonMenuBase
{
  ...
  private IEnumerator CreateScroll(int info_index, int unit_index)
  {
    ...
    return (IEnumerator) new Quest00229Menu.\u003CCreateScroll\u003Ec__Iterator258()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00229Menu.\u003CInit\u003Ec__Iterator259()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00229Menu.\u003CCreateRanking\u003Ec__Iterator25A()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00229Menu.\u003CInitBottomParts\u003Ec__Iterator25B()
    {
      rankingData = rankingData,
      \u003C\u0024\u003ErankingData = rankingData,
      \u003C\u003Ef__this = this
