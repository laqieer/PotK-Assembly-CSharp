...
public class Shop00742Unit : MonoBehaviour
{
  ...
  public IEnumerator Init(UnitUnit target)
  {
    ...
    return (IEnumerator) new Shop00742Unit.\u003CInit\u003Ec__Iterator498()
    {
      target = target,
      \u003C\u0024\u003Etarget = target,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00742Unit.\u003CUnitSpriteCreate\u003Ec__Iterator499()
    {
      target = target,
      \u003C\u0024\u003Etarget = target,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00742Unit.\u003CUnitOtherSpriteCreate\u003Ec__Iterator49A()
    {
      target = target,
      \u003C\u0024\u003Etarget = target,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00742Unit.\u003CRarityCreate\u003Ec__Iterator49B()
    {
      target = target,
      \u003C\u0024\u003Etarget = target,
      \u003C\u003Ef__this = this
