...
public class BattleTimeManager : BattleManagerBase
{
  ...
  public override IEnumerator initialize(GameCore.BattleInfo battleInfo, BE env_ = null)
  {
    ...
    return (IEnumerator) new BattleTimeManager.\u003Cinitialize\u003Ec__Iterator9BC()
    {
      env_ = env_,
      \u003C\u0024\u003Eenv_ = env_,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleTimeManager.\u003Ccleanup\u003Ec__Iterator9BD()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleTimeManager.\u003Cexec\u003Ec__Iterator9BE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleTimeManager.\u003CChangeScene\u003Ec__Iterator9BF()
    {
      sceneName = sceneName,
      isStack = isStack,
      args = args,
