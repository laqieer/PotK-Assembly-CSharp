...
public class Story0095Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitScene(bool connect)
  {
    ...
    return (IEnumerator) new Story0095Menu.\u003CInitScene\u003Ec__Iterator526()
    {
      connect = connect,
      \u003C\u0024\u003Econnect = connect,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story0095Menu.\u003CInitCharacterQuestButton\u003Ec__Iterator527()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story0095Menu.\u003CInitCharacterQuestButton\u003Ec__Iterator528()
    {
      characterQuests = characterQuests,
      \u003C\u0024\u003EcharacterQuests = characterQuests,
      \u003C\u003Ef__this = this
