...
public class Unit00483Menu : BackButtonMenuBase
{
    ...
    Dictionary<int, int> playerSkillDict)
  {
    ...
    Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyE7B ratioCAnonStoreyE7B = new Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyE7B();
    // ISSUE: reference to a compiler-generated field
    ratioCAnonStoreyE7B.baseUnit = baseUnit;
    // ISSUE: reference to a compiler-generated field
    ratioCAnonStoreyE7B.data = new Dictionary<int, float>();
    // ISSUE: reference to a compiler-generated field
    foreach (BattleskillSkill battleSkill in ratioCAnonStoreyE7B.baseUnit.GetBattleSkills())
    {
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ratioCAnonStoreyE7B.data[ratioCAnonStoreyE7B.baseUnit.evolutionSkill(battleSkill).ID] = 0.0f;
    }
    if (materialUnits.Length < 1)
    {
      // ISSUE: reference to a compiler-generated field
      return ratioCAnonStoreyE7B.data;
    }
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated method
    List<PlayerUnitSkills> list = ((IEnumerable<PlayerUnitSkills>) ratioCAnonStoreyE7B.baseUnit.skills).Where<PlayerUnitSkills>(new Func<PlayerUnitSkills, bool>(ratioCAnonStoreyE7B.\u003C\u003Em__D88)).ToList<PlayerUnitSkills>();
    foreach (PlayerUnit materialUnit in materialUnits)
    {
      PlayerUnit material = materialUnit;
      // ISSUE: reference to a compiler-generated field
      if (material.unit.same_character_id == ratioCAnonStoreyE7B.baseUnit.unit.same_character_id)
      {
        ...
        {
          // ISSUE: variable of a compiler-generated type
          Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyE7B ratioCAnonStoreyE7B1 = ratioCAnonStoreyE7B;
          // ISSUE: variable of a compiler-generated type
          Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyE7D ratioCAnonStoreyE7D1 = this;
          ...
          {
            // ISSUE: variable of a compiler-generated type
            Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyE7B ratioCAnonStoreyE7B2 = ratioCAnonStoreyE7B;
            // ISSUE: variable of a compiler-generated type
            Unit00483Menu.\u003CSkillLevelUpRatio\u003Ec__AnonStoreyE7D ratioCAnonStoreyE7D2 = this;
            // ISSUE: reference to a compiler-generated field
            UnitSkillupSetting skillupSetting = ((IEnumerable<UnitSkillupSetting>) MasterData.UnitSkillupSettingList).FirstOrDefault<UnitSkillupSetting>((Func<UnitSkillupSetting, bool>) (y => y.material_unit_id == ratioCAnonStoreyE7D2.material.unit.ID));
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CCreateSkillDetailDialog\u003Ec__Iterator33A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CInit\u003Ec__Iterator33B()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CCreateSkillIcon\u003Ec__Iterator33C()
    {
      idx = idx,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003CsetSkillIcon\u003Ec__Iterator33D()
    {
      basePlayerUnit = basePlayerUnit,
      \u003C\u0024\u003EbasePlayerUnit = basePlayerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00483Menu.\u003Ccombine\u003Ec__Iterator33E()
    {
      \u003C\u003Ef__this = this
    };
  }
