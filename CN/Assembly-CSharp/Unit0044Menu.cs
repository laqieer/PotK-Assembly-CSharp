...
public class Unit0044Menu : BackButtonMenuBase
{
  ...
  public virtual IEnumerator UpdateIcon()
  {
    ...
    return (IEnumerator) new Unit0044Menu.\u003CUpdateIcon\u003Ec__Iterator2C8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0044Menu.\u003CInitPlayerGears\u003Ec__Iterator2C9()
    {
      index = index,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0044Menu.\u003CStatusPopup\u003Ec__Iterator2CA()
    {
      afterGear = afterGear,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0044Menu.\u003CRemoveGearAsync\u003Ec__Iterator2CB()
    {
      baseUnit = baseUnit,
      \u003C\u0024\u003EbaseUnit = baseUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0044Menu.\u003CCreateItemIconRange\u003Ec__Iterator2CC()
    {
      value = value,
      \u003C\u0024\u003Evalue = value,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0044Menu.\u003CCreateItemIcon\u003Ec__Iterator2CD()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0044Menu.\u003CLoadObject\u003Ec__Iterator2CE()
    {
      \u003C\u003Ef__this = this
    };
  }
