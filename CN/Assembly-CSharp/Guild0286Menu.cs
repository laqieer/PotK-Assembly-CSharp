  ...
  private void SetHaveItemValue()
  {
    ...
    switch (giftRewardTypeId)
    {
      ...
      case 17:
        ...
        break;
      case 19:
        PlayerQuestKey[] self3 = SMManager.Get<PlayerQuestKey[]>();
        int? nullable1 = ((IEnumerable<PlayerQuestKey>) self3).FirstIndexOrNull<PlayerQuestKey>((Func<PlayerQuestKey, bool>) (x => x.quest_key_id == gift.gift_reward_id));
        num = !nullable1.HasValue ? 0 : self3[nullable1.Value].quantity;
        break;
      case 20:
...
label_3:
  ...
  private IEnumerator ShowDetailPopup()
  {
    ...
    return (IEnumerator) new Guild0286Menu.\u003CShowDetailPopup\u003Ec__Iterator701()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Menu.\u003CSetHaveItemIcon\u003Ec__Iterator702()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Menu.\u003CResourceLoad\u003Ec__Iterator703()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Menu.\u003CInit\u003Ec__Iterator704()
    {
      gifts = gifts,
      \u003C\u0024\u003Egifts = gifts,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Menu.\u003CReceiveConnection\u003Ec__Iterator705()
    {
      gift = gift,
      \u003C\u0024\u003Egift = gift,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Menu.\u003CReceiveAll\u003Ec__Iterator706()
    {
      \u003C\u003Ef__this = this
    };
  }
