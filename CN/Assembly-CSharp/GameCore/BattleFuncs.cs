  ...
  public static class BattleFuncs
  {
      ...
      bool isAI = false)
    {
      ...
      BL.DuelHistory duelHistory1 = new BL.DuelHistory()
      {
        ...
        inflictMaxDamage = ((IEnumerable<BL.DuelTurn>) duelResult.turns).Max<BL.DuelTurn>((Func<BL.DuelTurn, int>) (x => x != null && x.isAtackker ? x.damage : 0)),
      ...
      int biAttackNo = 0)
    {
      ...
      if (attackDamageData.isHit)
      {
        ...
        float num12 = 1f;
        float num13 = Mathf.Max(1f, attackStatus.originalAttack * num12) * (!attackDamageData.isCritical ? 1f : 3f);
        ...
        if ((double) num13 < 1.0)
          num13 = 1f;
        attackDamageData.duelSkillProc.InvokeDamageSkill((int) num13);
        if (!invokedPrayer)
        ...
        if (!invokedPrayer)
        {
          ...
          if ((double) num13 >= (double) num14 && num14 >= 2)
          {
        ...
        if (invokedPrayer)
        {
          int num15 = !isAttacker ? hp.attackerHp : hp.defenderHp;
          if ((double) num13 >= (double) num15)
            num13 = (float) (num15 - 1);
        }
        attackDamageData.damage = NC.Clamp(0, !isAttacker ? hp.attackerHp : hp.defenderHp, (int) num13);
        attackDamageData.dispDamage = NC.Clamp(0, 999, (int) num13);
        if (attackDamageData.duelSkillProc.isInvokeCounterAttack)
        {
          float val = num13 * attackDamageData.duelSkillProc.counterAttackRate;
        ...
        if ((!isAttacker ? (!hp.attackerIsDontAction ? 1 : 0) : (!hp.defenderIsDontAction ? 1 : 0)) != 0)
        {
          ...
          if (source.Any<BL.SkillEffect>())
          {
            ...
            foreach (BL.SkillEffect skillEffect in source)
            {
              float num17 = skillEffect.effect.GetFloat("percentage_drain") + (float) skillEffect.baseSkillLevel * skillEffect.effect.GetFloat("skill_ratio");
              num16 += (int) ((double) attackDamageData.damage * (double) num17);
            }
            attackDamageData.defenderDispDrainDamage = num16;
            int num18 = (!isAttacker ? hp.attackerHp : hp.defenderHp) - attackDamageData.damage;
            attackDamageData.defenderDrainDamage = Mathf.Min(defense.originalUnit.parameter.Hp, num18 + attackDamageData.defenderDispDrainDamage) - num18;
          }
        }
        attackDamageData.dispDrainDamage = 0;
        attackDamageData.drainDamage = 0;
        ...
        if (isAttacker)
        {
          ...
          int num19 = Mathf.Min(hp1, hp.attackerHp + attackDamageData.drainDamage);
          if (attackDamageData.dispDrainDamage > 0)
            attackDamageData.drainDamage = Mathf.Max(0, num19 - hp.attackerHp);
          attackDamageData.hp.attackerHp = num19;
        ...
        else
        {
          ...
          int num20 = Mathf.Min(hp1, hp.defenderHp + attackDamageData.drainDamage);
          if (attackDamageData.dispDrainDamage > 0)
            attackDamageData.drainDamage = Mathf.Max(0, num20 - hp.defenderHp);
          hp.defenderHp = num20;
      ...
      BL.Unit[] neighborUnits)
    {
      ...
      BattleFuncs.\u003CGetDuelSupportSkillEffects\u003Ec__Iterator22 supportSkillEffects = new BattleFuncs.\u003CGetDuelSupportSkillEffects\u003Ec__Iterator22()
      {
        beUnit = beUnit,
        beTarget = beTarget,
        logic = logic,
      ...
      Dictionary<BattleskillSkill, List<BL.Unit>> curseReflectionSkillTarget = null)
    {
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      BattleFuncs.\u003CapplyDuelSkillEffects\u003Ec__AnonStoreyB69 effectsCAnonStoreyB69_1 = new BattleFuncs.\u003CapplyDuelSkillEffects\u003Ec__AnonStoreyB69();
      // ISSUE: reference to a compiler-generated field
      effectsCAnonStoreyB69_1.snakeFunction = snakeFunction;
      // ISSUE: reference to a compiler-generated field
      effectsCAnonStoreyB69_1.duelResult = duelResult;
      // ISSUE: reference to a compiler-generated field
      effectsCAnonStoreyB69_1.atk = atk;
      // ISSUE: reference to a compiler-generated field
      effectsCAnonStoreyB69_1.def = def;
      // ISSUE: reference to a compiler-generated field
      if (effectsCAnonStoreyB69_1.duelResult.disableDuelSkillEffects)
        return new HashSet<BL.ISkillEffectListUnit>();
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      BattleFuncs.apllyDuelRemoveSleepEffect(effectsCAnonStoreyB69_1.duelResult, effectsCAnonStoreyB69_1.atk, effectsCAnonStoreyB69_1.def);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      BattleFuncs.consumeSkillEffects(effectsCAnonStoreyB69_1.duelResult.turns, effectsCAnonStoreyB69_1.atk, effectsCAnonStoreyB69_1.def);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      BattleFuncs.mapDuelSkillEffects(effectsCAnonStoreyB69_1.duelResult, effectsCAnonStoreyB69_1.atk, effectsCAnonStoreyB69_1.def, env, (Action<Tuple<BL.DuelTurn, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.Skill>>) (data => BattleFuncs.addSkillEffects(data.Item4, data.Item5, 0, false, false, new BattleskillEffectLogicEnum[1])), (Action<Tuple<BL.DuelTurn, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.Skill, bool, bool>>) (data => BattleFuncs.addSkillEffects(data.Item4, data.Item5, 1, (data.Item6 ? 1 : 0) != 0, (data.Item7 ? 1 : 0) != 0, BattleskillEffectLogicEnum.snake_venom)), (Action<Tuple<BL.DuelTurn, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, IEnumerable<BL.UnitPosition>, BL.Skill, bool, bool>>) (data => BattleFuncs.addSkillEffectsUnits(data.Item4, data.Item5, 1, (data.Item6 ? 1 : 0) != 0, (data.Item7 ? 1 : 0) != 0, BattleskillEffectLogicEnum.snake_venom)), (Action<BL.DuelTurn, BL.ISkillEffectListUnit>) null, false);
      // ISSUE: reference to a compiler-generated field
      effectsCAnonStoreyB69_1.deads = new HashSet<BL.ISkillEffectListUnit>();
      // ISSUE: reference to a compiler-generated field
      if (!effectsCAnonStoreyB69_1.duelResult.isHeal)
      {
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        BattleFuncs.applyDuelDamageSkillEffects(effectsCAnonStoreyB69_1.duelResult, effectsCAnonStoreyB69_1.atk, effectsCAnonStoreyB69_1.def, env, effectsCAnonStoreyB69_1.deads, addHpFunction, subHpFunction, effectsCAnonStoreyB69_1.snakeFunction, lifeAbsorbSkillTarget, curseReflectionSkillTarget);
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        BattleFuncs.mapDuelSkillEffects(effectsCAnonStoreyB69_1.duelResult, effectsCAnonStoreyB69_1.atk, effectsCAnonStoreyB69_1.def, env, (Action<Tuple<BL.DuelTurn, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.Skill>>) null, (Action<Tuple<BL.DuelTurn, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.ISkillEffectListUnit, BL.Skill, bool, bool>>) (data =>
        {
        ...
        {
          // ISSUE: variable of a compiler-generated type
          BattleFuncs.\u003CapplyDuelSkillEffects\u003Ec__AnonStoreyB69 effectsCAnonStoreyB69 = effectsCAnonStoreyB69_1;
          // ISSUE: variable of a compiler-generated type
          BattleFuncs.\u003CapplyDuelSkillEffects\u003Ec__AnonStoreyB68 effectsCAnonStoreyB68 = this;
          ...
          if (!isInvokedSnakeVenom.Contains(myself) && snakeVenomSkill != null && snakeVenomUnitEffect.Count >= 1)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            int num = ((IEnumerable<BL.DuelTurn>) duelResult.turns).Sum<BL.DuelTurn>((Func<BL.DuelTurn, int>) (x => x.isAtackker == turn1.isAtackker && ((IEnumerable<BL.Skill>) x.invokeDuelSkills).Any<BL.Skill>((Func<BL.Skill, bool>) (skill => skill == effectsCAnonStoreyB68.snakeVenomSkill)) ? x.dispDamage : 0));
      ...
      // ISSUE: reference to a compiler-generated field
      return effectsCAnonStoreyB69_1.deads;
    }
      ...
      Dictionary<BattleskillSkill, List<BL.Unit>> curseReflectionSkillTarget)
    {
      ...
      foreach (BattleskillEffectLogicEnum key in dictionary1.Keys)
      {
        for (is_attack = 1; is_attack <= 2; ++is_attack)
        {
          ...
          {
            if ((skillEffect.effect.GetInt("is_attack_nc") == 0 || skillEffect.effect.GetInt("is_attack_nc") == is_attack) && !BattleFuncs.isSkillsAndEffectsInvalid(myself, enemy) && (skillEffect.effect.skill.skill_type != BattleskillSkillType.passive || !myself.IsDontUseSkill(skillEffect.effect.skill.ID)) && dictionary1[key].Item1(skillEffect))
            {
              int[] range = new int[2]
              {
