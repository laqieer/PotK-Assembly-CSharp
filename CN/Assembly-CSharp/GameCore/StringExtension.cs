...
namespace GameCore
{
  public static class StringExtension
  {
    ...
    private static readonly Dictionary<char, char> hankakuToZenkakuDic = StringExtension.hankaku.Select<char, char, \u003C\u003E__AnonType0<char, char>>((IEnumerable<char>) StringExtension.zenkaku, (Func<char, char, \u003C\u003E__AnonType0<char, char>>) ((h, z) => new \u003C\u003E__AnonType0<char, char>(h, z))).ToDictionary<\u003C\u003E__AnonType0<char, char>, char, char>((Func<\u003C\u003E__AnonType0<char, char>, char>) (x => x.h), (Func<\u003C\u003E__AnonType0<char, char>, char>) (x => x.z));
    private static readonly Dictionary<char, char> zenkakuToHankakuDic = StringExtension.zenkaku.Select<char, char, \u003C\u003E__AnonType1<char, char>>((IEnumerable<char>) StringExtension.hankaku, (Func<char, char, \u003C\u003E__AnonType1<char, char>>) ((z, h) => new \u003C\u003E__AnonType1<char, char>(z, h))).ToDictionary<\u003C\u003E__AnonType1<char, char>, char, char>((Func<\u003C\u003E__AnonType1<char, char>, char>) (x => x.z), (Func<\u003C\u003E__AnonType1<char, char>, char>) (x => x.h));
