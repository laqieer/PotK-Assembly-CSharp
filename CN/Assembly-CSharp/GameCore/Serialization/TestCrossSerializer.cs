...
namespace GameCore.Serialization
{
  public class TestCrossSerializer
  {
    ...
    private static bool Eq(object a, object b) => a == null ? b == null : a.Equals(b);
    ...
    private static void RunTest()
    {
      ...
      }, (Func<object, object, bool>) ((a, b) =>
      {
        ...
        return valueOrDefault1 == valueOrDefault2 && nullable3.HasValue == nullable4.HasValue;
      }));
      TestCrossSerializer.Run((object) new int?[2]
      {
        nullable1,
    ...
    private class Hoge
    {
      ...
      public override bool Equals(object obj)
      {
        ...
        int valueOrDefault1 = intnValue1.GetValueOrDefault();
        int? intnValue2 = hoge.intnValue;
        int valueOrDefault2 = intnValue2.GetValueOrDefault();
        return valueOrDefault1 == valueOrDefault2 && intnValue1.HasValue == intnValue2.HasValue;
      }
