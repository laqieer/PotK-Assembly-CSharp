...
namespace GameCore
{
  public static class EnumerableExtension
  {
      ...
      Func<T1, T2, TResult> func)
    {
      ...
      EnumerableExtension.\u003CSelect\u003Ec__Iterator25<T1, T2, TResult> selectCIterator25 = new EnumerableExtension.\u003CSelect\u003Ec__Iterator25<T1, T2, TResult>()
      {
        source1 = source1,
        source2 = source2,
        func = func,
      ...
      selectCIterator25.\u0024PC = -2;
      return (IEnumerable<TResult>) selectCIterator25;
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EnumerableExtension.\u003CWaitAll\u003Ec__Iterator26()
      {
        self = self,
        \u003C\u0024\u003Eself = self
      };
    ...
    public static IEnumerable<T> Shuffle<T>(this IEnumerable<T> self, Random random)
    {
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      EnumerableExtension.\u003CShuffle\u003Ec__Iterator27<T> shuffleCIterator27 = new EnumerableExtension.\u003CShuffle\u003Ec__Iterator27<T>()
      {
        self = self,
        random = random,
        \u003C\u0024\u003Eself = self,
      ...
      // ISSUE: reference to a compiler-generated field
      shuffleCIterator27.\u0024PC = -2;
      return (IEnumerable<T>) shuffleCIterator27;
    }
  }
}
