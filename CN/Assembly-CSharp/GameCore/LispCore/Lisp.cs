...
namespace GameCore.LispCore
{
  public class Lisp
  {
    ...
    private void defunFourArithmeticOperations(string exp)
    {
      ...
      if (Lisp.\u003C\u003Ef__switch\u0024mapA == null)
      {
        // ISSUE: reference to a compiler-generated field
        Lisp.\u003C\u003Ef__switch\u0024mapA = new Dictionary<string, int>(5)
        {
          {
            "+",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (!Lisp.\u003C\u003Ef__switch\u0024mapA.TryGetValue(key, out num))
        return;
      switch (num)
      {
        case 0:
    ...
    private void defunLogicalOperations(string exp)
    {
      ...
      if (key == null)
        return;
      // ISSUE: reference to a compiler-generated field
      if (Lisp.\u003C\u003Ef__switch\u0024mapB == null)
      {
        // ISSUE: reference to a compiler-generated field
        Lisp.\u003C\u003Ef__switch\u0024mapB = new Dictionary<string, int>(6)
        {
          {
            "and",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (!Lisp.\u003C\u003Ef__switch\u0024mapB.TryGetValue(key, out num))
        return;
      switch (num)
      {
        case 0:
