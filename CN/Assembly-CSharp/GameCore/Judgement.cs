...
namespace GameCore
{
  public class Judgement
  {
      ...
      bool isEnemy = false)
    {
      ...
      })).FirstOrDefault<BL.SkillEffect>()), (Func<List<BL.SkillEffect>, List<BL.SkillEffect>>) (skills => skills.Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !unit.IsDontUseSkill(effect.baseSkillId)) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target))).ToList<BL.SkillEffect>()));
    }
      ...
      float hpRatio)
    {
      return self.WhereAndGroupBy(e, (Func<List<BL.SkillEffect>, BL.SkillEffect>) (x => x.OrderBy<BL.SkillEffect, float>((Func<BL.SkillEffect, float>) (effect => effect.effect.GetFloat("border"))).ThenByDescending<BL.SkillEffect, float>((Func<BL.SkillEffect, float>) (effect =>
      {
        if (effect.effect.HasKey("value"))
          return effect.effect.GetFloat("value");
        return effect.effect.HasKey("percentage") ? effect.effect.GetFloat("percentage") : 0.0f;
      })).FirstOrDefault<BL.SkillEffect>()), (Func<List<BL.SkillEffect>, List<BL.SkillEffect>>) (skills => skills.Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !unit.IsDontUseSkill(effect.baseSkillId)) && (double) hpRatio <= (double) effect.effect.GetFloat("border") && (effect.effect.GetInt("gear_kind_id") == 0 || effect.effect.GetInt("gear_kind_id") == unit.originalUnit.unit.kind.ID) && (effect.effect.GetInt("target_gear_kind_id") == 0 || effect.effect.GetInt("target_gear_kind_id") == target.originalUnit.unit.kind.ID) && (effect.effect.GetInt("element") == 0 || (CommonElement) effect.effect.GetInt("element") == unit.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("target_element") == 0 || (CommonElement) effect.effect.GetInt("target_element") == target.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("job_id") == 0 || effect.effect.GetInt("job_id") == unit.originalUnit.job.ID) && (effect.effect.GetInt("target_job_id") == 0 || effect.effect.GetInt("target_job_id") == target.originalUnit.job.ID) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target))).ToList<BL.SkillEffect>()));
    }
      ...
      bool isAI)
    {
      ...
      {
        if (effect.baseSkill.skill_type != BattleskillSkillType.passive || !unit.IsDontUseSkill(effect.baseSkillId))
        {
    ...
    public static IEnumerable<BL.SkillEffect> GetEnabledCharismaBuffDebuff(
      ...
      BL.ISkillEffectListUnit target)
    {
      return self.Where(e, (Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !effectUnit.IsDontUseSkill(effect.baseSkillId)) && distance >= effect.effect.GetInt("min_range") && distance <= effect.effect.GetInt("max_range") && (!effect.effect.HasKey("element") || effect.effect.GetInt("element") == 0 || (CommonElement) effect.effect.GetInt("element") == effectUnit.originalUnit.playerUnit.GetElement()) && (!effect.effect.HasKey("target_element") || effect.effect.GetInt("target_element") == 0 || (CommonElement) effect.effect.GetInt("target_element") == unit.originalUnit.playerUnit.GetElement()) && effectTarget == effect.effect.GetInt("effect_target") && (effectUnit != target || !BattleFuncs.isSkillsAndEffectsInvalid(target, unit)) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target)));
    }
    ...
    public static IEnumerable<BL.SkillEffect> GetEnabledRaidMissionBuffDebuff(
      ...
      BL.ISkillEffectListUnit target)
    {
      return self.Where(e, (Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !effectUnit.IsDontUseSkill(effect.baseSkillId)) && effectTarget == effect.effect.GetInt("effect_target") && (effectUnit != target || !BattleFuncs.isSkillsAndEffectsInvalid(target, unit)) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target)));
    }
    ...
    public static IEnumerable<BL.SkillEffect> GetEnabledInOutSideBattleBuffDebuff(
      ...
      BL.ISkillEffectListUnit target)
    {
      return self.Where(e, (Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !unit.IsDontUseSkill(effect.baseSkillId)) && (effect.effect.GetInt("gear_kind_id") == 0 || effect.effect.GetInt("gear_kind_id") == unit.originalUnit.unit.kind.ID) && (effect.effect.GetInt("target_gear_kind_id") == 0 || effect.effect.GetInt("target_gear_kind_id") == target.originalUnit.unit.kind.ID) && (effect.effect.GetInt("element") == 0 || (CommonElement) effect.effect.GetInt("element") == unit.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("target_element") == 0 || (CommonElement) effect.effect.GetInt("target_element") == target.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("job_id") == 0 || effect.effect.GetInt("job_id") == unit.originalUnit.job.ID) && (effect.effect.GetInt("target_job_id") == 0 || effect.effect.GetInt("target_job_id") == target.originalUnit.job.ID) && (effect.effect.GetInt("family_id") == 0 || unit.originalUnit.unit.HasFamily((UnitFamily) effect.effect.GetInt("family_id"))) && (effect.effect.GetInt("target_family_id") == 0 || target.originalUnit.unit.HasFamily((UnitFamily) effect.effect.GetInt("target_family_id"))) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target)));
    }
      ...
      BL.ISkillEffectListUnit target)
    {
      return self.Where(e, (Func<BL.SkillEffect, bool>) (effect =>
      {
        ...
        if (num2 == 0)
          num2 = 1;
        return (effect.baseSkill.skill_type != BattleskillSkillType.passive || !unit.IsDontUseSkill(effect.baseSkillId)) && absoluteTurnCount >= num1 && (absoluteTurnCount - num1) % num2 == 0 && (effect.effect.GetInt("gear_kind_id") == 0 || effect.effect.GetInt("gear_kind_id") == unit.originalUnit.unit.kind.ID) && (effect.effect.GetInt("target_gear_kind_id") == 0 || effect.effect.GetInt("target_gear_kind_id") == target.originalUnit.unit.kind.ID) && (effect.effect.GetInt("element") == 0 || (CommonElement) effect.effect.GetInt("element") == unit.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("target_element") == 0 || (CommonElement) effect.effect.GetInt("target_element") == target.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("job_id") == 0 || effect.effect.GetInt("job_id") == unit.originalUnit.job.ID) && (effect.effect.GetInt("target_job_id") == 0 || effect.effect.GetInt("target_job_id") == target.originalUnit.job.ID) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target);
      }));
    }
      ...
      Func<int, int, bool> condFunc)
    {
      return self.WhereAndGroupBy(e, (Func<List<BL.SkillEffect>, BL.SkillEffect>) (x => x.OrderBy<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (effect => effect.effectId)).FirstOrDefault<BL.SkillEffect>()), (Func<List<BL.SkillEffect>, List<BL.SkillEffect>>) (skills => skills.Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (effect =>
      {
        ...
        foreach (int key in dictionary.Keys)
        {
          ...
          {
            case 0:
              num4 = ((IEnumerable<BL.Unit>) deckUnits).Count<BL.Unit>((Func<BL.Unit, bool>) (x => x.originalUnit.unit.kind.ID == kind));
              break;
            case 1:
              num4 = ((IEnumerable<BL.Unit>) deckUnits).Count<BL.Unit>((Func<BL.Unit, bool>) (x => x.originalUnit.playerUnit.GetElement() == (CommonElement) kind));
              break;
            case 2:
              num4 = ((IEnumerable<BL.Unit>) deckUnits).Count<BL.Unit>((Func<BL.Unit, bool>) (x => x.originalUnit.job.ID == kind));
              break;
            case 3:
              num4 = ((IEnumerable<BL.Unit>) deckUnits).Count<BL.Unit>((Func<BL.Unit, bool>) (x => x.originalUnit.unit.HasFamily((UnitFamily) kind)));
              break;
            case 4:
              num4 = ((IEnumerable<BL.Unit>) deckUnits).Count<BL.Unit>((Func<BL.Unit, bool>) (x => x.unit.character.ID == kind));
              break;
            case 5:
              num4 = ((IEnumerable<BL.Unit>) deckUnits).Count<BL.Unit>((Func<BL.Unit, bool>) (x => x.unit.same_character_id == kind));
              break;
            case 6:
              num4 = ((IEnumerable<BL.Unit>) deckUnits).Count<BL.Unit>((Func<BL.Unit, bool>) (x => x.unit.ID == kind));
              break;
          }
          if (!condFunc(num4, dictionary[kind]))
            return false;
        }
        return !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target);
      })).ToList<BL.SkillEffect>()));
    }

    public static IEnumerable<BL.SkillEffect> GetEnabledDeckEveryGeBuffDebuff(
      BL.SkillEffectList self,
      BattleskillEffectLogicEnum e,
      BL.ISkillEffectListUnit unit,
      BL.ISkillEffectListUnit target,
      BL.Unit[] deckUnits)
    {
      return Judgement.GetEnabledDeckEveryBuffDebuff(self, e, unit, target, deckUnits, (Func<int, int, bool>) ((deckCount, condCount) => deckCount >= condCount));
    }

    public static IEnumerable<BL.SkillEffect> GetEnabledDeckEveryLeBuffDebuff(
      BL.SkillEffectList self,
      BattleskillEffectLogicEnum e,
      BL.ISkillEffectListUnit unit,
      BL.ISkillEffectListUnit target,
      ...
      Func<IEnumerable<int>, int, bool> condFunc)
    {
      return self.WhereAndGroupBy(e, (Func<List<BL.SkillEffect>, BL.SkillEffect>) (x => x.OrderBy<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (effect => effect.effectId)).FirstOrDefault<BL.SkillEffect>()), (Func<List<BL.SkillEffect>, List<BL.SkillEffect>>) (skills => skills.Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (effect =>
      {
        ...
        {
          case 0:
            source = ((IEnumerable<BL.Unit>) deckUnits).GroupBy<BL.Unit, int>((Func<BL.Unit, int>) (x => x.originalUnit.unit.kind.ID)).Select<IGrouping<int, BL.Unit>, int>((Func<IGrouping<int, BL.Unit>, int>) (x => x.Count<BL.Unit>()));
            break;
          case 1:
            source = ((IEnumerable<BL.Unit>) deckUnits).GroupBy<BL.Unit, int>((Func<BL.Unit, int>) (x => (int) x.originalUnit.playerUnit.GetElement())).Select<IGrouping<int, BL.Unit>, int>((Func<IGrouping<int, BL.Unit>, int>) (x => x.Count<BL.Unit>()));
            break;
          case 2:
            source = ((IEnumerable<BL.Unit>) deckUnits).GroupBy<BL.Unit, int>((Func<BL.Unit, int>) (x => x.originalUnit.job.ID)).Select<IGrouping<int, BL.Unit>, int>((Func<IGrouping<int, BL.Unit>, int>) (x => x.Count<BL.Unit>()));
            break;
          case 3:
            source = ((IEnumerable<BL.Unit>) deckUnits).SelectMany<BL.Unit, UnitFamily>((Func<BL.Unit, IEnumerable<UnitFamily>>) (x => (IEnumerable<UnitFamily>) x.originalUnit.unit.Families)).GroupBy<UnitFamily, UnitFamily>((Func<UnitFamily, UnitFamily>) (x => x)).Select<IGrouping<UnitFamily, UnitFamily>, int>((Func<IGrouping<UnitFamily, UnitFamily>, int>) (x => x.Count<UnitFamily>()));
            break;
          case 4:
            source = ((IEnumerable<BL.Unit>) deckUnits).GroupBy<BL.Unit, int>((Func<BL.Unit, int>) (x => x.unit.character.ID)).Select<IGrouping<int, BL.Unit>, int>((Func<IGrouping<int, BL.Unit>, int>) (x => x.Count<BL.Unit>()));
            break;
          case 5:
            source = ((IEnumerable<BL.Unit>) deckUnits).GroupBy<BL.Unit, int>((Func<BL.Unit, int>) (x => x.unit.same_character_id)).Select<IGrouping<int, BL.Unit>, int>((Func<IGrouping<int, BL.Unit>, int>) (x => x.Count<BL.Unit>()));
            break;
          case 6:
            source = ((IEnumerable<BL.Unit>) deckUnits).GroupBy<BL.Unit, int>((Func<BL.Unit, int>) (x => x.unit.ID)).Select<IGrouping<int, BL.Unit>, int>((Func<IGrouping<int, BL.Unit>, int>) (x => x.Count<BL.Unit>()));
            break;
        }
        return source != null && source.Count<int>() != 0 && condFunc(source, num2) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target);
      })).ToList<BL.SkillEffect>()));
    }

    public static IEnumerable<BL.SkillEffect> GetEnabledDeckAnotherGeBuffDebuff(
      BL.SkillEffectList self,
      BattleskillEffectLogicEnum e,
      BL.ISkillEffectListUnit unit,
      BL.ISkillEffectListUnit target,
      BL.Unit[] deckUnits)
    {
      return Judgement.GetEnabledDeckSameAnotherBuffDebuff(self, e, unit, target, deckUnits, (Func<IEnumerable<int>, int, bool>) ((count, kindCount) => count.Count<int>() >= kindCount));
    }

    public static IEnumerable<BL.SkillEffect> GetEnabledDeckAnotherLeBuffDebuff(
      BL.SkillEffectList self,
      BattleskillEffectLogicEnum e,
      BL.ISkillEffectListUnit unit,
      BL.ISkillEffectListUnit target,
    ...
    public static IEnumerable<BL.SkillEffect> GetEnabledDeckSameGeBuffDebuff(
      BL.SkillEffectList self,
      BattleskillEffectLogicEnum e,
      BL.ISkillEffectListUnit unit,
      BL.ISkillEffectListUnit target,
      BL.Unit[] deckUnits)
    {
      return Judgement.GetEnabledDeckSameAnotherBuffDebuff(self, e, unit, target, deckUnits, (Func<IEnumerable<int>, int, bool>) ((count, kindCount) => count.OrderByDescending<int, int>((Func<int, int>) (x => x)).First<int>() >= kindCount));
    }

    public static IEnumerable<BL.SkillEffect> GetEnabledDeckSameLeBuffDebuff(
      BL.SkillEffectList self,
      BattleskillEffectLogicEnum e,
      BL.ISkillEffectListUnit unit,
      BL.ISkillEffectListUnit target,
    ...
    public static IEnumerable<BL.SkillEffect> GetEnabledUnitRarityBuffDebuff(
      ...
      BL.ISkillEffectListUnit target)
    {
      return self.WhereAndGroupBy(e, (Func<List<BL.SkillEffect>, BL.SkillEffect>) (x => x.OrderBy<BL.SkillEffect, int>((Func<BL.SkillEffect, int>) (effect => effect.effectId)).FirstOrDefault<BL.SkillEffect>()), (Func<List<BL.SkillEffect>, List<BL.SkillEffect>>) (skills => skills.Where<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !unit.IsDontUseSkill(effect.baseSkillId)) && (effect.effect.GetInt("min_rarity") == 0 || effect.effect.GetInt("min_rarity") <= unit.originalUnit.unit.rarity.index + 1) && (effect.effect.GetInt("target_min_rarity") == 0 || effect.effect.GetInt("target_min_rarity") <= target.originalUnit.unit.rarity.index + 1) && (effect.effect.GetInt("max_rarity") == 0 || effect.effect.GetInt("max_rarity") >= unit.originalUnit.unit.rarity.index + 1) && (effect.effect.GetInt("target_max_rarity") == 0 || effect.effect.GetInt("target_max_rarity") >= target.originalUnit.unit.rarity.index + 1) && (effect.effect.GetInt("gear_kind_id") == 0 || effect.effect.GetInt("gear_kind_id") == unit.originalUnit.unit.kind.ID) && (effect.effect.GetInt("target_gear_kind_id") == 0 || effect.effect.GetInt("target_gear_kind_id") == target.originalUnit.unit.kind.ID) && (effect.effect.GetInt("element") == 0 || (CommonElement) effect.effect.GetInt("element") == unit.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("target_element") == 0 || (CommonElement) effect.effect.GetInt("target_element") == target.originalUnit.playerUnit.GetElement()) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target))).ToList<BL.SkillEffect>()));
    }
      ...
      BL.ISkillEffectListUnit unit)
    {
      return self.Where(e, (Func<BL.SkillEffect, bool>) (effect =>
      {
        if (effect.baseSkill.skill_type == BattleskillSkillType.passive && unit.IsDontUseSkill(effect.baseSkillId) || effect.effect.GetInt("equip_gear_king_id") != 0 && effect.effect.GetInt("equip_gear_king_id") != unit.originalUnit.playerUnit.equippedGearOrInitial.kind_GearKind || effect.effect.GetInt("equip_gear_model_king_id") != 0 && effect.effect.GetInt("equip_gear_model_king_id") != unit.originalUnit.playerUnit.equippedGearOrInitial.model_kind_GearModelKind)
          return false;
    ...
    public static IEnumerable<BL.SkillEffect> GetEnabledEquipGearBuffDebuff(
      ...
      BL.ISkillEffectListUnit target)
    {
      return self.Where(e, (Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !unit.IsDontUseSkill(effect.baseSkillId)) && (effect.effect.GetInt("equip_gear_king_id") == 0 || effect.effect.GetInt("equip_gear_king_id") == unit.originalUnit.playerUnit.equippedGearOrInitial.kind_GearKind) && (effect.effect.GetInt("equip_gear_model_king_id") == 0 || effect.effect.GetInt("equip_gear_model_king_id") == unit.originalUnit.playerUnit.equippedGearOrInitial.model_kind_GearModelKind) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, unit, target) && !BattleFuncs.isSkillsAndEffectsInvalid(unit, target)));
    }
    ...
    public class GearParameter
    {
      ...
      {
        GearGear gear = pi.gear;
        GearRankIncr gearRankIncr = GearRankIncr.FromRank(pi.gear_level);
        int power = pi.gear.kind.Enum != GearKindEnum.shield ? gearRankIncr.power : 0;
        int physicalDefense = pi.gear.kind.Enum != GearKindEnum.shield ? 0 : gearRankIncr.physical_defense;
        int magicDefense = pi.gear.kind.Enum != GearKindEnum.shield ? 0 : gearRankIncr.magic_defense;
        return new Judgement.GearParameter()
        {
          Power = gear.power + power,
          PhysicalDefense = gear.physical_defense + physicalDefense,
          MagicDefense = gear.magic_defense + magicDefense,
          Hit = gear.hit,
    ...
    public class BattleParameter
    {
      ...
      {
        int skillAdd = 0;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledBuffDebuff(beUnit.skillEffects, fix_logic, beUnit, gameMode))
      ...
      {
        float skillMul = 1f;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledBuffDebuff(beUnit.skillEffects, ratio_logic, beUnit, gameMode))
      ...
      {
        int skillAdd = Judgement.BattleParameter.GetSkillAdd(beUnit, BattleskillEffectLogicEnum.fix_hp, BattleskillInvokeGameModeEnum.quest);
        ...
        float num16 = 10000f * Judgement.BattleParameter.GetSkillMul(beUnit, BattleskillEffectLogicEnum.ratio_hp, BattleskillInvokeGameModeEnum.quest);
      ...
      {
        int skillAdd = Judgement.BattleParameter.GetSkillAdd(beUnit, BattleskillEffectLogicEnum.fix_hp, BattleskillInvokeGameModeEnum.colosseum);
        ...
        float num16 = 10000f * Judgement.BattleParameter.GetSkillMul(beUnit, BattleskillEffectLogicEnum.ratio_hp, BattleskillInvokeGameModeEnum.colosseum);
    ...
    public class BeforeDuelUnitParameter
    {
      ...
      private static int GetDeckEveryGeSkillAdd(
        ...
        BL.Unit[] deckUnits)
      {
        int deckEveryGeSkillAdd = 0;
        if (deckUnits == null)
          return deckEveryGeSkillAdd;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckEveryGeBuffDebuff(beUnit.skillEffects, fix_logic, beUnit, beTarget, deckUnits))
          deckEveryGeSkillAdd += skillEffect.effect.GetInt("value") + skillEffect.baseSkillLevel * skillEffect.effect.GetInt("skill_ratio");
        return deckEveryGeSkillAdd;
      }
      ...
      private static float GetDeckEveryGeSkillMul(
        ...
        BL.Unit[] deckUnits)
      {
        float deckEveryGeSkillMul = 1f;
        if (deckUnits == null)
          return deckEveryGeSkillMul;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckEveryGeBuffDebuff(beUnit.skillEffects, ratio_logic, beUnit, beTarget, deckUnits))
          deckEveryGeSkillMul *= skillEffect.effect.GetFloat("percentage") + (float) skillEffect.baseSkillLevel * skillEffect.effect.GetFloat("skill_ratio");
        return deckEveryGeSkillMul;
      }
      ...
      private static int GetDeckEveryLeSkillAdd(
        ...
        BL.Unit[] deckUnits)
      {
        int deckEveryLeSkillAdd = 0;
        if (deckUnits == null)
          return deckEveryLeSkillAdd;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckEveryLeBuffDebuff(beUnit.skillEffects, fix_logic, beUnit, beTarget, deckUnits))
          deckEveryLeSkillAdd += skillEffect.effect.GetInt("value") + skillEffect.baseSkillLevel * skillEffect.effect.GetInt("skill_ratio");
        return deckEveryLeSkillAdd;
      }
      ...
      private static float GetDeckEveryLeSkillMul(
        ...
        BL.Unit[] deckUnits)
      {
        float deckEveryLeSkillMul = 1f;
        if (deckUnits == null)
          return deckEveryLeSkillMul;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckEveryLeBuffDebuff(beUnit.skillEffects, ratio_logic, beUnit, beTarget, deckUnits))
          deckEveryLeSkillMul *= skillEffect.effect.GetFloat("percentage") + (float) skillEffect.baseSkillLevel * skillEffect.effect.GetFloat("skill_ratio");
        return deckEveryLeSkillMul;
      }
      ...
      private static int GetDeckAnotherGeSkillAdd(
        ...
        BL.Unit[] deckUnits)
      {
        int anotherGeSkillAdd = 0;
        if (deckUnits == null)
          return anotherGeSkillAdd;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckAnotherGeBuffDebuff(beUnit.skillEffects, fix_logic, beUnit, beTarget, deckUnits))
          anotherGeSkillAdd += skillEffect.effect.GetInt("value") + skillEffect.baseSkillLevel * skillEffect.effect.GetInt("skill_ratio");
        return anotherGeSkillAdd;
      }
      ...
      private static float GetDeckAnotherGeSkillMul(
        ...
        BL.Unit[] deckUnits)
      {
        float anotherGeSkillMul = 1f;
        if (deckUnits == null)
          return anotherGeSkillMul;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckAnotherGeBuffDebuff(beUnit.skillEffects, ratio_logic, beUnit, beTarget, deckUnits))
          anotherGeSkillMul *= skillEffect.effect.GetFloat("percentage") + (float) skillEffect.baseSkillLevel * skillEffect.effect.GetFloat("skill_ratio");
        return anotherGeSkillMul;
      }
      ...
      private static int GetDeckAnotherLeSkillAdd(
        ...
        BL.Unit[] deckUnits)
      {
        int anotherLeSkillAdd = 0;
        if (deckUnits == null)
          return anotherLeSkillAdd;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckAnotherLeBuffDebuff(beUnit.skillEffects, fix_logic, beUnit, beTarget, deckUnits))
          anotherLeSkillAdd += skillEffect.effect.GetInt("value") + skillEffect.baseSkillLevel * skillEffect.effect.GetInt("skill_ratio");
        return anotherLeSkillAdd;
      }
      ...
      private static float GetDeckAnotherLeSkillMul(
        ...
        BL.Unit[] deckUnits)
      {
        float anotherLeSkillMul = 1f;
        if (deckUnits == null)
          return anotherLeSkillMul;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckAnotherLeBuffDebuff(beUnit.skillEffects, ratio_logic, beUnit, beTarget, deckUnits))
          anotherLeSkillMul *= skillEffect.effect.GetFloat("percentage") + (float) skillEffect.baseSkillLevel * skillEffect.effect.GetFloat("skill_ratio");
        return anotherLeSkillMul;
      }
      ...
      private static int GetDeckSameGeSkillAdd(
        ...
        BL.Unit[] deckUnits)
      {
        int deckSameGeSkillAdd = 0;
        if (deckUnits == null)
          return deckSameGeSkillAdd;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckSameGeBuffDebuff(beUnit.skillEffects, fix_logic, beUnit, beTarget, deckUnits))
          deckSameGeSkillAdd += skillEffect.effect.GetInt("value") + skillEffect.baseSkillLevel * skillEffect.effect.GetInt("skill_ratio");
        return deckSameGeSkillAdd;
      }
      ...
      private static float GetDeckSameGeSkillMul(
        ...
        BL.Unit[] deckUnits)
      {
        float deckSameGeSkillMul = 1f;
        if (deckUnits == null)
          return deckSameGeSkillMul;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckSameGeBuffDebuff(beUnit.skillEffects, ratio_logic, beUnit, beTarget, deckUnits))
          deckSameGeSkillMul *= skillEffect.effect.GetFloat("percentage") + (float) skillEffect.baseSkillLevel * skillEffect.effect.GetFloat("skill_ratio");
        return deckSameGeSkillMul;
      }
      ...
      private static int GetDeckSameLeSkillAdd(
        ...
        BL.Unit[] deckUnits)
      {
        int deckSameLeSkillAdd = 0;
        if (deckUnits == null)
          return deckSameLeSkillAdd;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckSameLeBuffDebuff(beUnit.skillEffects, fix_logic, beUnit, beTarget, deckUnits))
          deckSameLeSkillAdd += skillEffect.effect.GetInt("value") + skillEffect.baseSkillLevel * skillEffect.effect.GetInt("skill_ratio");
        return deckSameLeSkillAdd;
      }
      ...
      private static float GetDeckSameLeSkillMul(
        ...
        BL.Unit[] deckUnits)
      {
        float deckSameLeSkillMul = 1f;
        if (deckUnits == null)
          return deckSameLeSkillMul;
        foreach (BL.SkillEffect skillEffect in Judgement.GetEnabledDeckSameLeBuffDebuff(beUnit.skillEffects, ratio_logic, beUnit, beTarget, deckUnits))
          deckSameLeSkillMul *= skillEffect.effect.GetFloat("percentage") + (float) skillEffect.baseSkillLevel * skillEffect.effect.GetFloat("skill_ratio");
        return deckSameLeSkillMul;
      }
        ...
        int attackHp)
      {
        ...
        int num1 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_strength, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_strength, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_strength, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_strength, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_strength, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_strength, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_strength, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_strength, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_strength, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_strength, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_strength) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_strength_fix);
        int num2 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_intelligence, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_intelligence, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_intelligence, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_intelligence, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_intelligence, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_intelligence, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_intelligence, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_intelligence, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_intelligence, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_intelligence, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_intelligence) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_intelligence_fix);
        int num3 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_vitality, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_vitality, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_vitality, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_vitality, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_vitality, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_vitality, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_vitality, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_vitality, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_vitality, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_vitality, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_vitality) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_vitality_fix);
        int num4 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_mind, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_mind, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_mind, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_mind, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_mind, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_mind, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_mind, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_mind, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_mind, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_mind, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_mind) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_mind_fix);
        int num5 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_agility, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_agility, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_agility, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_agility, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_agility, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_agility, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_agility, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_agility, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_agility, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_agility, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_agility) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_agility_fix);
        int num6 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_dexterity, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_dexterity, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_dexterity, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_dexterity, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_dexterity, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_dexterity, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_dexterity, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_dexterity, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_dexterity, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_dexterity, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_dexterity) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_dexterity_fix);
        int num7 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_luck, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_luck, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_luck, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_luck, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_luck, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_luck, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_luck, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_luck, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_luck, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_luck, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_luck) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_luck_fix);
        int num8 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_move, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_move, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_move, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_move, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_move, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_move, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_move, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_move, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_move, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_move, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_move) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_move_fix);
        int num9 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_physical_attack, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_physical_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_physical_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_physical_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_physical_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_physical_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_physical_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_physical_attack, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_physical_attack, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_physical_attack, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_physical_attack) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_physical_attack_fix);
        int num10 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_physical_defense, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_physical_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_physical_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_physical_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_physical_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_physical_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_physical_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_physical_defense, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_physical_defense, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_physical_defense, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_physical_defense) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_physical_defense_fix);
        int num11 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_magic_attack, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_magic_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_magic_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_magic_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_magic_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_magic_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_magic_attack, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_magic_attack, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_magic_attack, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_magic_attack, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_magic_attack) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_magic_attack_fix);
        int num12 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_magic_defense, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_magic_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_magic_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_magic_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_magic_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_magic_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_magic_defense, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_magic_defense, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_magic_defense, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_magic_defense, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_magic_defense) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_magic_defense_fix);
        int num13 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_hit, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_hit, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_hit, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_hit, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_hit, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_hit, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_hit, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_hit, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_hit, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_hit, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_hit) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_hit_fix);
        int num14 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_critical, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_critical, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_critical, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_critical, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_critical, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_critical, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_critical, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_critical, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_critical, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_critical, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_critical) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_critical_fix);
        int num15 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_evasion, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_evasion, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_evasion, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_evasion, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_evasion) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_evasion_fix);
        int num16 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_critical_evasion, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_critical_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_critical_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_critical_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_critical_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_critical_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_critical_evasion, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_critical_evasion, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_critical_evasion, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_critical_evasion, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_critical_evasion) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_critical_evasion_fix);
        int num17 = Judgement.BeforeDuelUnitParameter.GetSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.fix_attack_speed, BattleskillInvokeGameModeEnum.colosseum) + Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_fix_attack_speed, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_fix_attack_speed, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_fix_attack_speed, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_fix_attack_speed, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_fix_attack_speed, deckUnits) + Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_fix_attack_speed, deckUnits) + Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_fix_attack_speed, false) + Judgement.BeforeDuelUnitParameter.GetHpLeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_fix_attack_speed, hpRatio) + Judgement.BeforeDuelUnitParameter.GetHpGeSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_fix_attack_speed, hpRatio) + Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_fix_attack_speed) + Judgement.BeforeDuelUnitParameter.GetEquipGearSkillAdd((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_attack_speed_fix);
        ...
        float num19 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_strength, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_strength, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_strength, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_strength, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_strength, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_strength, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_strength, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_strength, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_strength, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_strength, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_strength) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_strength_ratio);
        float num20 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_intelligence, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_intelligence, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_intelligence, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_intelligence, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_intelligence, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_intelligence, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_intelligence, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_intelligence, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_intelligence, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_intelligence, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_intelligence) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_intelligence_ratio);
        float num21 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_vitality, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_vitality, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_vitality, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_vitality, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_vitality, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_vitality, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_vitality, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_vitality, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_vitality, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_vitality, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_vitality) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_vitality_ratio);
        float num22 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_mind, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_mind, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_mind, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_mind, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_mind, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_mind, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_mind, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_mind, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_mind, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_mind, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_mind) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_mind_ratio);
        float num23 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_agility, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_agility, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_agility, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_agility, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_agility, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_agility, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_agility, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_agility, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_agility, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_agility, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_agility) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_agility_ratio);
        float num24 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_dexterity, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_dexterity, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_dexterity, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_dexterity, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_dexterity, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_dexterity, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_dexterity, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_dexterity, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_dexterity, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_dexterity, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_dexterity) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_dexterity_ratio);
        float num25 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_luck, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_luck, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_luck, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_luck, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_luck, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_luck, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_luck, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_luck, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_luck, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_luck, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_luck) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_luck_ratio);
        float num26 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_move, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_move, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_move, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_move, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_move, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_move, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_move, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_move, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_move, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_move, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_move) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_move_ratio);
        float num27 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_physical_attack, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_physical_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_physical_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_physical_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_physical_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_physical_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_physical_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_physical_attack, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_physical_attack, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_physical_attack, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_physical_attack) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_physical_attack_ratio);
        float num28 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_physical_defense, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_physical_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_physical_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_physical_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_physical_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_physical_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_physical_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_physical_defense, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_physical_defense, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_physical_defense, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_physical_defense) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_physical_defense_ratio);
        float num29 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_magic_attack, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_magic_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_magic_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_magic_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_magic_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_magic_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_magic_attack, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_magic_attack, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_magic_attack, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_magic_attack, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_magic_attack) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_magic_attack_ratio);
        float num30 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_magic_defense, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_magic_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_magic_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_magic_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_magic_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_magic_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_magic_defense, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_magic_defense, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_magic_defense, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_magic_defense, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_magic_defense) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_magic_defense_ratio);
        float num31 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_hit, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_hit, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_hit, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_hit, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_hit, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_hit, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_hit, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_hit, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_hit, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_hit, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_hit) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_hit_ratio);
        float num32 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_critical, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_critical, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_critical, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_critical, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_critical, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_critical, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_critical, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_critical, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_critical, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_critical, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_critical) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_critical_ratio);
        float num33 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_evasion, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_evasion, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_evasion, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_evasion, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_evasion) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_evasion_ratio);
        float num34 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_critical_evasion, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_critical_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_critical_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_critical_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_critical_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_critical_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_critical_evasion, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_critical_evasion, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_critical_evasion, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_critical_evasion, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_critical_evasion) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_critical_evasion_ratio);
        float num35 = 10000f * Judgement.BeforeDuelUnitParameter.GetSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, attackType, BattleskillEffectLogicEnum.ratio_attack_speed, BattleskillInvokeGameModeEnum.colosseum) * Judgement.BeforeDuelUnitParameter.GetDeckEveryGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_ge_ratio_attack_speed, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckEveryLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_every_le_ratio_attack_speed, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_ge_ratio_attack_speed, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckAnotherLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_another_le_ratio_attack_speed, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_ge_ratio_attack_speed, deckUnits) * Judgement.BeforeDuelUnitParameter.GetDeckSameLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.deck_same_le_ratio_attack_speed, deckUnits) * Judgement.BeforeDuelUnitParameter.GetSpecificUnitSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.specific_unit_ratio_attack_speed, false) * Judgement.BeforeDuelUnitParameter.GetHpLeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_le_ratio_attack_speed, hpRatio) * Judgement.BeforeDuelUnitParameter.GetHpGeSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.hp_ge_ratio_attack_speed, hpRatio) * Judgement.BeforeDuelUnitParameter.GetUnitRaritySkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.unit_rarity_ratio_attack_speed) * Judgement.BeforeDuelUnitParameter.GetEquipGearSkillMul((BL.ISkillEffectListUnit) beUnit, (BL.ISkillEffectListUnit) beTarget, BattleskillEffectLogicEnum.equip_attack_speed_ratio);
        PlayerUnit playerUnit = beUnit.playerUnit;
        Judgement.GearParameter gearParameter = !(equipped_gear == (PlayerItem) null) ? Judgement.GearParameter.FromPlayerGear(equipped_gear) : Judgement.GearParameter.FromGearGear(playerUnit.unit.initial_gear);
        UnitProficiencyIncr proficiencyIncr = playerUnit.ProficiencyIncr;
        Judgement.BeforeDuelUnitParameter duelUnitParameter = new Judgement.BeforeDuelUnitParameter();
    ...
    public class BeforeDuelParameter
    {
      ...
      public static Judgement.BeforeDuelParameter CreateSingle(
        ...
        BL.Unit[] beAttackDeckUnits = null,
        BL.Unit[] beDefenseDeckUnits = null,
        bool isHeal = false,
        bool isAI = false)
      {
      ...
      public static Judgement.BeforeDuelParameter CreateColosseumSingle(
        ...
        int defenseHp)
      {
        Judgement.BeforeDuelUnitParameter attack = Judgement.BeforeDuelUnitParameter.FromBeColosseumUnit(beAttackUnit, beDefenseUnit, beAttackNeighborUnits, beAttackMagicBullet, beAttackEquippedGear, !isSample ? (!isAttack ? 2 : 1) : 0, beAttackDeckUnits, attackHp);
        Judgement.BeforeDuelUnitParameter defense = Judgement.BeforeDuelUnitParameter.FromBeColosseumUnit(beDefenseUnit, beAttackUnit, beDefenseNeighborUnits, beDefenseMagicBullet, beDefenseEquippedGear, !isSample ? (!isAttack ? 1 : 2) : 0, beDefenseDeckUnits, defenseHp);
        ...
        if (charismaUnitDistance != null)
        {
          for (int target = 0; target <= 1; ++target)
          {
            foreach (BL.ISkillEffectListUnit key in charismaUnitDistance[target].Keys)
            {
              ...
              foreach (BL.SkillEffect skillEffect in effectUnit.skillEffects.Where(BattleskillEffectLogicEnum.charisma_clamp_hit, (Func<BL.SkillEffect, bool>) (effect => (effect.baseSkill.skill_type != BattleskillSkillType.passive || !effectUnit.IsDontUseSkill(effect.baseSkillId)) && distance >= effect.effect.GetInt("min_range") && distance <= effect.effect.GetInt("max_range") && (effect.effect.GetInt("element") == 0 || (CommonElement) effect.effect.GetInt("element") == effectUnit.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("target_element") == 0 || (CommonElement) effect.effect.GetInt("target_element") == beAttackUnit.originalUnit.playerUnit.GetElement()) && (effect.effect.GetInt("target_gear_kind_id") == 0 || effect.effect.GetInt("target_gear_kind_id") == beAttackUnit.originalUnit.unit.kind.ID) && target == effect.effect.GetInt("effect_target") && (effectUnit != beDefenseUnit || !BattleFuncs.isSkillsAndEffectsInvalid(beDefenseUnit, beAttackUnit)) && !BattleFuncs.isEffectEnemyRangeAndInvalid(effect, beAttackUnit, beDefenseUnit) && !BattleFuncs.isSkillsAndEffectsInvalid(beAttackUnit, beDefenseUnit))))
              {
