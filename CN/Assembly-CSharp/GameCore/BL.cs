  ...
  public class BL
  {
    ...
    public class DropData : BL.ModelBase
    {
      ...
      public bool isDropBox
      {
        get
        {
          return this.mReward.Type == MasterDataTable.CommonRewardType.gear || this.mReward.Type == MasterDataTable.CommonRewardType.supply || this.mReward.Type == MasterDataTable.CommonRewardType.unit || this.mReward.Type == MasterDataTable.CommonRewardType.material_unit || this.mReward.Type == MasterDataTable.CommonRewardType.money;
        }
      }
      ...
      public void execute(BL.Unit unit, BL env)
      {
        ...
        switch (type)
        {
          ...
          case MasterDataTable.CommonRewardType.medal:
            ...
            break;
          default:
            if (type == MasterDataTable.CommonRewardType.material_unit)
              goto case MasterDataTable.CommonRewardType.unit;
            else
              goto case MasterDataTable.CommonRewardType.player_exp;
        }
      }
    ...
    public class SkillEffectList : BL.ModelBase
    {
        ...
        Func<BL.SkillEffect, bool> f)
      {
        ...
        BL.SkillEffectList.\u003CWhere\u003Ec__Iterator1F whereCIterator1F = new BL.SkillEffectList.\u003CWhere\u003Ec__Iterator1F()
        {
          e = e,
          f = f,
          \u003C\u0024\u003Ee = e,
        ...
        whereCIterator1F.\u0024PC = -2;
        return (IEnumerable<BL.SkillEffect>) whereCIterator1F;
      }
        ...
        Func<List<BL.SkillEffect>, List<BL.SkillEffect>> enabled)
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        BL.SkillEffectList.\u003CWhereAndGroupBy\u003Ec__Iterator20 groupByCIterator20 = new BL.SkillEffectList.\u003CWhereAndGroupBy\u003Ec__Iterator20()
        {
          e = e,
          enabled = enabled,
          f = f,
        ...
        // ISSUE: reference to a compiler-generated field
        groupByCIterator20.\u0024PC = -2;
        return (IEnumerable<BL.SkillEffect>) groupByCIterator20;
      }
...
label_7:
    ...
    public class Unit : BL.ModelBase, IDisposable, BL.ISkillEffectListUnit
    {
      ...
      {
        // ISSUE: object of a compiler-generated type is created
        return (IEnumerator) new BL.Unit.\u003CInitAIExtention\u003Ec__Iterator21()
        {
