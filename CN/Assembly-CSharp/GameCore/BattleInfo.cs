...
namespace GameCore
{
  ...
  public class BattleInfo
  {
    ...
    public StartParameter pvp_player_parm { get; set; }

    public StartParameter pvp_enemy_parm { get; set; }
      ...
      int[] guests)
    {
      ...
      switch (quest_type)
      {
        ...
        case CommonQuestType.Extra:
          battleInfo.extraQuest = ((IEnumerable<PlayerExtraQuestS>) SMManager.Get<PlayerExtraQuestS[]>()).First<PlayerExtraQuestS>((Func<PlayerExtraQuestS, bool>) (x => x.quest_extra_s.ID == quest_s_id));
    ...
    public static BattleInfo MakeBattleInfo(
      ...
      StartParameter player1_parm,
      StartParameter player2_parm,
      Bonus[] bonus_list,
      DateTime start_time)
    {
      return new BattleInfo()
      {
        ...
        pvp_player_parm = player1_parm,
        pvp_enemy_parm = player2_parm,
        isStoryEnable = false,
