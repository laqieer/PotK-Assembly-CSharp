  ...
  public class AILisp : IELisp
  {
    ...
    private bool isPanelVariable(string sym)
    {
      ...
      if (key != null)
      {
        ...
        if (AILisp.\u003C\u003Ef__switch\u0024map2 == null)
        {
          // ISSUE: reference to a compiler-generated field
          AILisp.\u003C\u003Ef__switch\u0024map2 = new Dictionary<string, int>(9)
          {
            {
              "phisics",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (AILisp.\u003C\u003Ef__switch\u0024map2.TryGetValue(key, out num) && num == 0)
          return true;
      }
      return false;
    }
    ...
    private bool isUnitVariable(string sym)
    {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (AILisp.\u003C\u003Ef__switch\u0024map3 == null)
        {
          // ISSUE: reference to a compiler-generated field
          AILisp.\u003C\u003Ef__switch\u0024map3 = new Dictionary<string, int>(10)
          {
            {
              "hp",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (AILisp.\u003C\u003Ef__switch\u0024map3.TryGetValue(key, out num) && num == 0)
          return true;
      }
      return false;
    }
    ...
    private object getBattleVariable(string[] split)
    {
      ...
      if (key1 != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          AILisp.\u003C\u003Ef__switch\u0024map6 = new Dictionary<string, int>(5)
          {
            {
              "own",
              0
        ...
        int num1;
        // ISSUE: reference to a compiler-generated field
        if (AILisp.\u003C\u003Ef__switch\u0024map6.TryGetValue(key1, out num1))
        {
          switch (num1)
          {
            case 0:
            ...
            case 3:
              ...
              else
              {
                ...
                if (key2 != null)
                {
                  ...
                  {
                    // ISSUE: reference to a compiler-generated field
                    AILisp.\u003C\u003Ef__switch\u0024map4 = new Dictionary<string, int>(4)
                    {
                      {
                        "sum_own",
                        0
                  ...
                  int num2;
                  // ISSUE: reference to a compiler-generated field
                  if (AILisp.\u003C\u003Ef__switch\u0024map4.TryGetValue(key2, out num2))
                  {
                    switch (num2)
                    {
                      case 0:
...
label_25:
            ...
            case 4:
              ...
              if (key3 != null)
              {
                ...
                {
                  // ISSUE: reference to a compiler-generated field
                  AILisp.\u003C\u003Ef__switch\u0024map5 = new Dictionary<string, int>(3)
                  {
                    {
                      "unit",
                      0
                ...
                int num3;
                // ISSUE: reference to a compiler-generated field
                if (AILisp.\u003C\u003Ef__switch\u0024map5.TryGetValue(key3, out num3))
                {
                  switch (num3)
                  {
                    case 0:
...
label_36:
    ...
    private object getPanelVariable(BL.Panel panel, BL.AIUnit unit, BL.AIUnit target, string sym)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          AILisp.\u003C\u003Ef__switch\u0024map7 = new Dictionary<string, int>(9)
          {
            {
              "phisics",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (AILisp.\u003C\u003Ef__switch\u0024map7.TryGetValue(key, out num))
        {
          switch (num)
          {
            case 0:
      ...
      string sym)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          AILisp.\u003C\u003Ef__switch\u0024map8 = new Dictionary<string, int>(10)
          {
            {
              "hp",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (AILisp.\u003C\u003Ef__switch\u0024map8.TryGetValue(key, out num))
        {
          switch (num)
          {
            case 0:
