...
public class Gacha0063DirSheetCachaPanel : MonoBehaviour
{
    ...
    GameObject hitEffectPrefab = null)
  {
    ...
    return (IEnumerator) new Gacha0063DirSheetCachaPanel.\u003CInit\u003Ec__Iterator3EF()
    {
      parent = parent,
      panel = panel,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063DirSheetCachaPanel.\u003CShowDetailPopup\u003Ec__Iterator3F0()
    {
      \u003C\u003Ef__this = this
    };
  }
