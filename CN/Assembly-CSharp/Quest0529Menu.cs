...
public class Quest0529Menu : UnitSelectMenuBase
{
  ...
  public IEnumerator LoadResources()
  {
    ...
    return (IEnumerator) new Quest0529Menu.\u003CLoadResources\u003Ec__Iterator757()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0529Menu.\u003CInitialize\u003Ec__Iterator758()
    {
      maxNum = maxNum,
  ...
  {
    int num = this.isEventQuest ? 1 : Singleton<EarthDataManager>.GetInstance().questProgress.forcedSortieCharacterMaxPosition;
    unitIcon.Gray = this.selectedUnitIcons.Count<UnitIconInfo>() >= this.SelectMax || num >= this.SelectMax ? !info.gray : info.gray;
    if (info.select != -1)
      return;
  ...
  protected override void Select(UnitIconBase unitIcon)
  {
    ...
    {
      int min = this.isEventQuest ? 1 : Singleton<EarthDataManager>.GetInstance().questProgress.forcedSortieCharacterMaxPosition;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0529Menu.\u003CDispSupplyDeck\u003Ec__Iterator759()
    {
      supplys = supplys,
      \u003C\u0024\u003Esupplys = supplys,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0529Menu.\u003CCreateSupplyIcon\u003Ec__Iterator75A()
    {
      pos = pos,
      supply = supply,
      \u003C\u0024\u003Epos = pos,
