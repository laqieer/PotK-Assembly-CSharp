...
public class UnitMenuBase : BackButtonMenuBase
{
    ...
    PlayerMaterialUnit[] playerMaterialUnits = null)
  {
    ...
    return (IEnumerator) new UnitMenuBase.\u003CUpdateInfoAndScroll\u003Ec__Iterator2F2()
    {
  ...
  protected void CreateDisplayUnitInfo(bool[] filters)
  {
    this.displayUnitInfos = this.allUnitInfos.Where<UnitIconInfo>((Func<UnitIconInfo, bool>) (x =>
    {
      if (x.removeButton)
        return true;
      return this.CheckWeaponType(x, filters) && this.CheckElementType(x, filters) && this.CheckUnitType(x, filters) && this.CheckRarity(x, filters) && this.CheckUnit(x, filters) && this.CheckLevel(x, filters) && this.CheckEquipment(x, filters) && this.CheckCompose(x, filters) && this.CheckFavorite(x, filters) && x.button_enable;
    })).ToList<UnitIconInfo>();
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIconRange\u003Ec__Iterator2F3()
    {
      value = value,
      \u003C\u0024\u003Evalue = value,
      \u003C\u003Ef__this = this
...
label_23:;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIconBase\u003Ec__Iterator2F4()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIcon\u003Ec__Iterator2F5()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CLoadObjectNormal\u003Ec__Iterator2F6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CLoadObjectDetail\u003Ec__Iterator2F7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CLoadObject\u003Ec__Iterator2F8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIcon\u003Ec__Iterator2F9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CInitialize\u003Ec__Iterator2FA()
    {
      \u003C\u003Ef__this = this
    };
  }
        ...
        if (tables.Length > 0)
          this.allUnitInfos.ForEach((Action<UnitIconInfo>) (x =>
          {
            if (!(x.playerUnit != (PlayerUnit) null))
              return;
            x.isSpecialIcon = x.playerUnit.IsSpecialEffectForRankingEvent(tables);
          }));
      }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CShowSortAndFilterPopup\u003Ec__Iterator2FB()
    {
      \u003C\u003Ef__this = this
    };
  }
