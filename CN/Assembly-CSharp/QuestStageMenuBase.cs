...
public class QuestStageMenuBase : BackButtonMenuBase
{
    ...
    bool forcus)
  {
    ...
    return (IEnumerator) new QuestStageMenuBase.\u003CInitStoryQuest\u003Ec__Iterator215()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CInitExtraQuest\u003Ec__Iterator216()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CInit\u003Ec__Iterator217()
    {
    ...
    bool forcus)
  {
    ...
    else
    {
      ...
      this.initCenter = !nullable.HasValue || !forcus ? (qclistS.Count - 1 >= 0 ? qclistS.Count - 1 : 0) : nullable.Value;
    }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CUnitCreate\u003Ec__Iterator218()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CsubBackGroundCrate\u003Ec__Iterator219()
    {
      quest = quest,
      \u003C\u0024\u003Equest = quest,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CMissionWindowCreate\u003Ec__Iterator21A()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CMaterialWindowCreate\u003Ec__Iterator21B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CInitHscroll\u003Ec__Iterator21C()
    {
      \u003C\u003Ef__this = this
    };
  }
    ...
    if (Object.op_Inequality((Object) targetButton, (Object) this.nowCenterObj))
    {
      ...
      if (flag)
      {
        ...
        if (missionList.Count <= 0)
          return;
        int index = missionList.Count > this.MissionAchievementStar.Length ? this.MissionAchievementStar.Length - 1 : missionList.Count - 1;
        this.MissionAchievementStar[index].SetActive(true);
        this.MissionAchievementStar[index].GetComponent<Quest0022MissionStar>().setStar(missionList);
      }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CibtnMaterial\u003Ec__Iterator21D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CibtnMission\u003Ec__Iterator21E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CisDragTweenStart\u003Ec__Iterator21F()
    {
      flag = flag,
      \u003C\u0024\u003Eflag = flag,
      \u003C\u003Ef__this = this
