...
public class DetailMenuScrollView02 : DetailMenuScrollViewBase
{
  ...
  public override IEnumerator initAsync(PlayerUnit playerUnit, GameObject[] prefabs)
  {
    ...
    return (IEnumerator) new DetailMenuScrollView02.\u003CinitAsync\u003Ec__IteratorA30()
    {
      prefabs = prefabs,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenuScrollView02.\u003CSetSkill\u003Ec__IteratorA31()
    {
      playerUnit = playerUnit,
      prefabs = prefabs,
      \u003C\u0024\u003EplayerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenuScrollView02.\u003CCreateSkillIcon\u003Ec__IteratorA32()
    {
      idx = idx,
