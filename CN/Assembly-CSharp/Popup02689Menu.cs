...
public class Popup02689Menu : MonoBehaviour
{
    ...
    Versus02610Menu menu)
  {
    ...
    return (IEnumerator) new Popup02689Menu.\u003CInit\u003Ec__Iterator970()
    {
      menu = menu,
      pvpInfo = pvpInfo,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CInit\u003Ec__Iterator971()
    {
      menu = menu,
      pvpInfo = pvpInfo,
    ...
    Versus02610Menu menu)
  {
    ...
    this.rewards = season_close.class_rewards;
    this.emblems = season_close.new_emblems;
    this.isEnd = false;
    this.effectParent.SetActive(false);
    this.EffectEndProvide();
    this.EffectEndEnable();
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CEffectEnd\u003Ec__Iterator972()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartResultSeason\u003Ec__Iterator973()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartResultRanking\u003Ec__Iterator974()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartScroll\u003Ec__Iterator975()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartScroll\u003Ec__Iterator976()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CCreateClassChange\u003Ec__Iterator977()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CEmblemPopup\u003Ec__Iterator978()
    {
      \u003C\u003Ef__this = this
    };
  }
