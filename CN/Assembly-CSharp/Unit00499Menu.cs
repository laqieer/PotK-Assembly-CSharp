...
public class Unit00499Menu : BackButtonMenuBase
{
    ...
    bool fromEarth = false)
  {
    ...
    return (IEnumerator) new Unit00499Menu.\u003CInitEvolutionUnits\u003Ec__Iterator361()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CShowTransmigrationPopup\u003Ec__Iterator362()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CTransmigration\u003Ec__Iterator363()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CEvolution\u003Ec__Iterator364()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CInitPlayer\u003Ec__Iterator365()
    {
      unitIconPrefab = unitIconPrefab,
      playerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CInitUnitIcon\u003Ec__Iterator366()
    {
      before = before,
      unitIcon = unitIcon,
      unit = unit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CInitTransmigrationUnits\u003Ec__Iterator367()
    {
      playerUnits = playerUnits,
      playerMaterialUnits = playerMaterialUnits,
      objects = objects,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CInitTitle\u003Ec__Iterator368()
    {
      titleText = titleText,
      \u003C\u0024\u003EtitleText = titleText,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CInit\u003Ec__Iterator369()
    {
      sceneMode = sceneMode,
      playerUnit = playerUnit,
      fromEarth = fromEarth,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00499Menu.\u003CconfirmExecute\u003Ec__Iterator36A()
    {
      title = title,
      message = message,
