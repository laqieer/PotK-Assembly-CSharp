...
public class UI3DModelCreate : MonoBehaviour
{
  ...
  private IEnumerator InitUnitUnitAnimator(UnitUnit unit_data)
  {
    ...
    return (IEnumerator) new UI3DModelCreate.\u003CInitUnitUnitAnimator\u003Ec__Iterator41E()
    {
      unit_data = unit_data,
      \u003C\u0024\u003Eunit_data = unit_data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModelCreate.\u003CInitPlayerUnitAnimator\u003Ec__Iterator41F()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModelCreate.\u003CInitUnitUnitModel\u003Ec__Iterator420()
    {
      unit_data = unit_data,
      \u003C\u0024\u003Eunit_data = unit_data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModelCreate.\u003CInitGear\u003Ec__Iterator421()
    {
      unit_data = unit_data,
      \u003C\u0024\u003Eunit_data = unit_data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModelCreate.\u003CLoadGear\u003Ec__Iterator422()
    {
      gear_data = gear_data,
      \u003C\u0024\u003Egear_data = gear_data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModelCreate.\u003CCreateModel\u003Ec__Iterator423()
    {
      unit_data = unit_data,
      \u003C\u0024\u003Eunit_data = unit_data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModelCreate.\u003CCreateModel\u003Ec__Iterator424()
    {
      player_unit_data = player_unit_data,
      \u003C\u0024\u003Eplayer_unit_data = player_unit_data,
      \u003C\u003Ef__this = this
