...
public class ColosseumUtility
{
    ...
    bool isBottom = true)
  {
    ...
    return (IEnumerator) new ColosseumUtility.\u003CCreateGearIcon\u003Ec__IteratorA1A()
    {
      prefab = prefab,
      parent = parent,
      gear = gear,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumUtility.\u003CCreateSupplyIcon\u003Ec__IteratorA1B()
    {
      prefab = prefab,
      parent = parent,
      supply = supply,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumUtility.\u003CCreateUnitIcon\u003Ec__IteratorA1C()
    {
      prefab = prefab,
      parent = parent,
      unit = unit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumUtility.\u003CCreateUniqueIcon\u003Ec__IteratorA1D()
    {
      parent = parent,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumUtility.\u003CCreateUniqueIcon\u003Ec__IteratorA1E()
    {
      parent = parent,
      rewardTypeID = rewardTypeID,
      rewardID = rewardID,
