...
public class Quest0528PlayerStatus : MonoBehaviour
{
    ...
    Quest0528Menu.FieldUnitInfo unitInfo)
  {
    ...
    return (IEnumerator) new Quest0528PlayerStatus.\u003CInit\u003Ec__Iterator74A()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528PlayerStatus.\u003CdoSetIcon\u003Ec__Iterator74B()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528PlayerStatus.\u003CdoSetAilmentIcon\u003Ec__Iterator74C()
    {
      skill = skill,
      index = index,
      \u003C\u0024\u003Eskill = skill,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528PlayerStatus.\u003CSetUnitInfo\u003Ec__Iterator74D()
    {
      unit = unit,
      unitType = unitType,
      \u003C\u0024\u003Eunit = unit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528PlayerStatus.\u003CShowDetailStatusPopup\u003Ec__Iterator74E()
    {
      \u003C\u003Ef__this = this
    };
  }
