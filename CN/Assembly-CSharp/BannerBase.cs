...
public class BannerBase : MonoBehaviour
{
  ...
  [SerializeField]
  public UI2DSprite DisableSprite;
  [SerializeField]
  ...
  public static string GetSpritePressedPath(
    int id,
    BannerBase.Type type,
    int tmp = 0,
    bool canplay = true,
    bool isEarth = false)
  {
    ...
    switch (type)
    {
      ...
      case BannerBase.Type.quest:
        ...
        break;
      case BannerBase.Type.quest_lock:
        spritePressedPath = !canplay ? (!isEarth ? string.Format("Prefabs/Banners/KeyQuest/{0}/Specialquest_pressed_lock", (object) id) : string.Format("Prefabs/Banners/EarthKeyQuest/{0}/Specialquest_pressed_lock", (object) id)) : (!isEarth ? string.Format("Prefabs/Banners/KeyQuest/{0}/Specialquest_pressed", (object) id) : string.Format("Prefabs/Banners/EarthKeyQuest/{0}/Specialquest_pressed", (object) id));
        break;
    }
  ...
  public IEnumerator LoadAndSetImage(string url)
  {
    ...
    return (IEnumerator) new BannerBase.\u003CLoadAndSetImage\u003Ec__Iterator1E7()
    {
      url = url,
      \u003C\u0024\u003Eurl = url,
      \u003C\u003Ef__this = this
  ...
  {
    if (Object.op_Equality((Object) this.DisableSprite, (Object) null) || Object.op_Equality((Object) this.slcTimeNotice, (Object) null) || this.TimenoticeLimit == null || this.TimenoticeLimit.Length == 0 || this.TimenoticeLeft == null || this.TimenoticeLeft.Length == 0 || this.TimenoticeCenter == null || this.TimenoticeCenter.Length == 0 || this.TimenoticeRight == null || this.TimenoticeRight.Length == 0)
      return false;
  ...
  public void SetTime(DateTime serverTime, CampaignQuest.RankingEventTerm rankingEventTerm)
  {
    ...
    if (this.EndTimeAsStart)
    {
      ...
      this.DisableSprite.sprite2D = this.IdleSprite.sprite2D;
      ((Component) this.DisableSprite).gameObject.SetActive(true);
    }
    else
    {
      ((Component) this.IdleSprite).gameObject.SetActive(true);
      ((Component) this.PressSprite).gameObject.SetActive(false);
      if (!Object.op_Inequality((Object) this.DisableSprite, (Object) null))
        return;
      ((Component) this.DisableSprite).gameObject.SetActive(false);
    }
  }
  ...
  public void fadeOut(float duration)
  {
    ...
    if (this.EndTimeAsStart)
    {
      this.fadeOut(((Component) this.DisableSprite).gameObject, duration);
    }
    else
    {
      if (((Component) this.IdleSprite).gameObject.activeSelf)
        this.fadeOut(((Component) this.IdleSprite).gameObject, duration);
      if (!((Component) this.PressSprite).gameObject.activeSelf)
        return;
      this.fadeOut(((Component) this.PressSprite).gameObject, duration);
    }
  }
