...
public class Bugu0058Menu : BackButtonMenuBase
{
  ...
  public IEnumerator PakuPakuAPIEvent()
  {
    ...
    return (IEnumerator) new Bugu0058Menu.\u003CPakuPakuAPIEvent\u003Ec__Iterator3BD()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0058Menu.\u003CPakuPakuAPI\u003Ec__Iterator3BE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public IEnumerator onInitMenuAsync()
  {
    ...
    Bugu0058Menu.\u003ConInitMenuAsync\u003Ec__Iterator3BF asyncCIterator3Bf = new Bugu0058Menu.\u003ConInitMenuAsync\u003Ec__Iterator3BF();
    return (IEnumerator) asyncCIterator3Bf;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0058Menu.\u003CSetMenuAsync\u003Ec__Iterator3C0()
    {
      gearData = gearData,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0058Menu.\u003CSetGearImg\u003Ec__Iterator3C1()
    {
      gearData = gearData,
      \u003C\u0024\u003EgearData = gearData,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0058Menu.\u003CSetGearMaterialList\u003Ec__Iterator3C2()
    {
      gearData = gearData,
      gearMaterialData = gearMaterialData,
      \u003C\u0024\u003EgearData = gearData,
