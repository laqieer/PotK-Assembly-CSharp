...
public class TutorialMessageBox : MonoBehaviour
{
  ...
  public IEnumerator FaceChange(string faceName, int characterIndex)
  {
    ...
    return (IEnumerator) new TutorialMessageBox.\u003CFaceChange\u003Ec__Iterator7B2()
    {
      faceName = faceName,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TutorialMessageBox.\u003CChangeItemIcon\u003Ec__Iterator7B3()
    {
      itemName = itemName,
      keyId = keyId,
      \u003C\u0024\u003EitemName = itemName,
  ...
  private MasterDataTable.CommonRewardType? GetReward(string itemName)
  {
    ...
    if (key != null)
    {
      ...
      if (TutorialMessageBox.\u003C\u003Ef__switch\u0024map1B == null)
      {
        // ISSUE: reference to a compiler-generated field
        TutorialMessageBox.\u003C\u003Ef__switch\u0024map1B = new Dictionary<string, int>(8)
        {
          {
            "none",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (TutorialMessageBox.\u003C\u003Ef__switch\u0024map1B.TryGetValue(key, out num))
      {
        switch (num)
        {
          case 0:
    ...
    Debug.LogWarning((object) ("ChangeItemIcon 物品名：" + itemName + "未找到。"));
    return new MasterDataTable.CommonRewardType?();
  }
}
