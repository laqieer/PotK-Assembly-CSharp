...
public class EquipmentDetailMenuBase : BackButtonMenuBase
{
  ...
  protected IEnumerator SetIncrementalParameter(PlayerItem gear, GameObject target)
  {
    ...
    return (IEnumerator) new EquipmentDetailMenuBase.\u003CSetIncrementalParameter\u003Ec__Iterator2D4()
    {
      gear = gear,
      target = target,
      \u003C\u0024\u003Egear = gear,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EquipmentDetailMenuBase.\u003CSetIncrementalParameter\u003Ec__Iterator2D5()
    {
      gear = gear,
      target = target,
      \u003C\u0024\u003Egear = gear,
