...
public class Quest00240723Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(PlayerStoryQuestS[] StoryData, int ChoiceLnum, bool reStart = false)
  {
    ...
    return (IEnumerator) new Quest00240723Menu.\u003CInit\u003Ec__Iterator265()
    {
      StoryData = StoryData,
      reStart = reStart,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00240723Menu.\u003CStoryChoiceButtonSetting\u003Ec__Iterator266()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00240723Menu.\u003CSwitchModeInitialze\u003Ec__Iterator267()
    {
      StoryData = StoryData,
      passdata = passdata,
      reStart = reStart,
