  ...
  public class QuestScoreBattleFinishContext : KeyCompare
  {
    ...
    public QuestScoreBattleFinishContext(Dictionary<string, object> json)
    {
      ...
      foreach (object json2 in (List<object>) json[nameof (score_total_rewards)])
        scoreTotalRewardsList.Add(json2 != null ? new QuestScoreBattleFinishContextScore_total_rewards((Dictionary<string, object>) json2) : (QuestScoreBattleFinishContextScore_total_rewards) null);
      ...
      foreach (object json3 in (List<object>) json[nameof (score_achivement_rewards)])
        achivementRewardsList.Add(json3 != null ? new QuestScoreBattleFinishContextScore_achivement_rewards((Dictionary<string, object>) json3) : (QuestScoreBattleFinishContextScore_achivement_rewards) null);
