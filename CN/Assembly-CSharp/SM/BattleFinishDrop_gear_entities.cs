...
// Type: SM.BattleFinishDrop_gear_entities
...
{
  [Serializable]
  public class BattleFinishDrop_gear_entities : KeyCompare
  {
    ...
    public BattleFinishDrop_gear_entities()
    {
    }

    public BattleFinishDrop_gear_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
