...
public class ColosseumResultUnit : MonoBehaviour
{
  ...
  public IEnumerator OnUnitLevelup(GameObject obj, int count)
  {
    ...
    return (IEnumerator) new ColosseumResultUnit.\u003COnUnitLevelup\u003Ec__Iterator5D0()
    {
      count = count,
      \u003C\u0024\u003Ecount = count,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumResultUnit.\u003CInit\u003Ec__Iterator5D1()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumResultUnit.\u003CLoadUnitPrefab\u003Ec__Iterator5D2()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  [DebuggerHidden]
  public IEnumerator LoadGearPrefab(PlayerUnit unit)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumResultUnit.\u003CLoadGearPrefab\u003Ec__Iterator5D3()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
    ...
    Func<GameObject, int, IEnumerator> levelupCallback)
  {
    ...
    {
      Debug.LogError((object) ("ColosseumBattleResult: 未找到装备武具 (id: " + (object) this.afterUnit.equippedGear.id + ")"));
      return (GaugeRunner) null;
    }
  ...
  public void ShowUnitExp()
  {
    ...
    this.TxtUnitEXP.SetTextLocalize("经验+" + this.GetUnitEXP.ToString());
