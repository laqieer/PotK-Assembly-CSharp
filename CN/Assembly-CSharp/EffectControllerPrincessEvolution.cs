...
public class EffectControllerPrincessEvolution : EffectController
{
    ...
    Unit00499Scene.Mode mode)
  {
    ...
    return (IEnumerator) new EffectControllerPrincessEvolution.\u003Cinitialize\u003Ec__Iterator902()
    {
      unit_list = unit_list,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerPrincessEvolution.\u003CSet\u003Ec__Iterator903()
    {
