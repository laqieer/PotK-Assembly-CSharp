...
public class GachaResultData : MonoBehaviour
{
  ...
  public IEnumerator CharacterStoryPopup()
  {
    ...
    return (IEnumerator) new GachaResultData.\u003CCharacterStoryPopup\u003Ec__Iterator408()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GachaResultData.\u003CSheetGachaResultPopup\u003Ec__Iterator409()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GachaResultData.\u003CStartSheetEffect\u003Ec__Iterator40A()
    {
      \u003C\u003Ef__this = this
    };
  }
