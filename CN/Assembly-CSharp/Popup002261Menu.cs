...
public class Popup002261Menu : MonoBehaviour
{
    ...
    System.Action act)
  {
    ...
    return (IEnumerator) new Popup002261Menu.\u003CInit\u003Ec__Iterator920()
    {
      act = act,
      menu = menu,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup002261Menu.\u003CEffectEnd\u003Ec__Iterator921()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup002261Menu.\u003CStartResult\u003Ec__Iterator922()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup002261Menu.\u003CStartScroll\u003Ec__Iterator923()
    {
      \u003C\u003Ef__this = this
    };
  }
