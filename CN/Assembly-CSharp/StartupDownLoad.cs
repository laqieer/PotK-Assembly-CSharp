...
public class StartupDownLoad : MonoBehaviour
{
  ...
  public IEnumerator AssetDownLoadStartAsync(string urlBase, string dlcVersion)
  {
    ...
    return (IEnumerator) new StartupDownLoad.\u003CAssetDownLoadStartAsync\u003Ec__IteratorA16()
    {
      urlBase = urlBase,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StartupDownLoad.\u003CwaitDownloadOrError\u003Ec__IteratorA17()
    {
      urlBase = urlBase,
      dlcVersion = dlcVersion,
      \u003C\u0024\u003EurlBase = urlBase,
