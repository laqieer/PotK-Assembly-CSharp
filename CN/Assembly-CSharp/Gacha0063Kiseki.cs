...
public class Gacha0063Kiseki : Gacha0063hindicator
{
    ...
    GameObject spritePrefab)
  {
    ...
    return (IEnumerator) new Gacha0063Kiseki.\u003CSet\u003Ec__Iterator3F3()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateCharacterImage\u003Ec__Iterator3F4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateSkillImage\u003Ec__Iterator3F5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateSimpleCharacter3DImage\u003Ec__Iterator3F6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateCharacterModel\u003Ec__Iterator3F7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator CashClean()
  {
    ...
    Gacha0063Kiseki.\u003CCashClean\u003Ec__Iterator3F8 cleanCIterator3F8 = new Gacha0063Kiseki.\u003CCashClean\u003Ec__Iterator3F8();
    return (IEnumerator) cleanCIterator3F8;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Kiseki.\u003CCreateModel\u003Ec__Iterator3F9()
    {
      id = id,
      \u003C\u0024\u003Eid = id,
      \u003C\u003Ef__this = this
