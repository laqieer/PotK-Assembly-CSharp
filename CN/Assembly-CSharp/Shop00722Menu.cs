...
public class Shop00722Menu : BackButtonMenuBase
{
  ...
  public IEnumerator UpdateArticleInfo()
  {
    ...
    return (IEnumerator) new Shop00722Menu.\u003CUpdateArticleInfo\u003Ec__Iterator467()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00722Menu.\u003CInit\u003Ec__Iterator468()
    {
      shopID = shopID,
      article = article,
      product = product,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00722Menu.\u003CShowDetailPopup\u003Ec__Iterator469()
    {
      content = content,
      \u003C\u0024\u003Econtent = content,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00722Menu.\u003CpopupAlert007222\u003Ec__Iterator46A()
    {
      \u003C\u003Ef__this = this
    };
  }
