...
public class FriendRequestPopupBase : BackButtonMenuBase
{
  ...
  public IEnumerator Init(PlayerHelper helper, int incr_friend_point)
  {
    ...
    return (IEnumerator) new FriendRequestPopupBase.\u003CInit\u003Ec__IteratorAFC()
    {
      helper = helper,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendRequestPopupBase.\u003CInit\u003Ec__IteratorAFD()
    {
      gladiator = gladiator,
      \u003C\u0024\u003Egladiator = gladiator,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendRequestPopupBase.\u003CInit\u003Ec__IteratorAFE()
    {
      unit = unit,
      level = level,
      playerID = playerID,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendRequestPopupBase.\u003CSetEmblem\u003Ec__IteratorAFF()
    {
      emblemId = emblemId,
      \u003C\u0024\u003EemblemId = emblemId,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendRequestPopupBase.\u003CFriendApplyAsync\u003Ec__IteratorB00()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendRequestPopupBase.\u003CopenPopup00813\u003Ec__IteratorB01()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendRequestPopupBase.\u003CopenPopup00814\u003Ec__IteratorB02()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendRequestPopupBase.\u003CopenPopup00815\u003Ec__IteratorB03()
    {
      \u003C\u003Ef__this = this
    };
  }
