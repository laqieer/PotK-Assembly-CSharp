...
public class EffectControllerGacha11 : EffectControllerGacha
{
  ...
  protected override IEnumerator Renpatu(GachaResultData.Result[] result_data)
  {
    ...
    return (IEnumerator) new EffectControllerGacha11.\u003CRenpatu\u003Ec__Iterator8FD()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha11.\u003CImageOff\u003Ec__Iterator8FE()
    {
      keep_time = keep_time,
      \u003C\u0024\u003Ekeep_time = keep_time,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha11.\u003CTundereEffectOff\u003Ec__Iterator8FF()
    {
      keep_time = keep_time,
      \u003C\u0024\u003Ekeep_time = keep_time,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha11.\u003CChangeEffectOff\u003Ec__Iterator900()
    {
      keep_time = keep_time,
      \u003C\u0024\u003Ekeep_time = keep_time,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha11.\u003CCameraAnimationOff\u003Ec__Iterator901()
    {
      keep_time = keep_time,
      \u003C\u0024\u003Ekeep_time = keep_time,
      \u003C\u003Ef__this = this
  ...
  private StoneHolder.STONE_ID ConvertStringToStoneHolderID(string string_color_name)
  {
    ...
    if (key != null)
    {
      ...
      if (EffectControllerGacha11.\u003C\u003Ef__switch\u0024map20 == null)
      {
        // ISSUE: reference to a compiler-generated field
        EffectControllerGacha11.\u003C\u003Ef__switch\u0024map20 = new Dictionary<string, int>(3)
        {
          {
            "blue",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (EffectControllerGacha11.\u003C\u003Ef__switch\u0024map20.TryGetValue(key, out num))
      {
        switch (num)
        {
          case 0:
  ...
  private int ConvertStringToAssaultType(string string_assault_type_name)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated field
      if (EffectControllerGacha11.\u003C\u003Ef__switch\u0024map21 == null)
      {
        // ISSUE: reference to a compiler-generated field
        EffectControllerGacha11.\u003C\u003Ef__switch\u0024map21 = new Dictionary<string, int>(3)
        {
          {
            "NORMAL",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (EffectControllerGacha11.\u003C\u003Ef__switch\u0024map21.TryGetValue(key, out num))
      {
        switch (num)
        {
          case 0:
