...
public class Scroll0079 : MonoBehaviour
{
    ...
    string price)
  {
    ...
    return (IEnumerator) new Scroll0079.\u003CInit\u003Ec__Iterator4AB()
    {
      data = data,
      pSDKIndex = pSDKIndex,
      price = price,
  ...
  private void Update()
  {
    ...
    this.itemName = this._coinProduct.name;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Scroll0079.\u003CSetSprite\u003Ec__Iterator4AC()
    {
  ...
  private IEnumerator openPopup999101()
  {
    ...
    Scroll0079.\u003CopenPopup999101\u003Ec__Iterator4AD popup999101CIterator4Ad = new Scroll0079.\u003CopenPopup999101\u003Ec__Iterator4AD();
    return (IEnumerator) popup999101CIterator4Ad;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Scroll0079.\u003CupdateSprite\u003Ec__Iterator4AE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void onBuy()
  {
    string message = string.Format(Consts.GetInstance().pay_yesno, (object) this.itemPrice, (object) this.itemName);
    ModalWindow.ShowYesNo(Consts.GetInstance().pay, message, (System.Action) (() =>
    {
