...
public class Bugu0052Scene : NGSceneBase
{
  ...
  public bool IsResetParam
  {
    get => Bugu0052Scene.isResetParam;
    set => Bugu0052Scene.isResetParam = value;
  }

  public int ListCount
  {
    get => this.listCount;
    set => this.listCount = value;
  }
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    return (IEnumerator) new Bugu0052Scene.\u003ConInitSceneAsync\u003Ec__Iterator395()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Scene.\u003ConStartSceneAsync\u003Ec__Iterator396()
    {
      mode = mode,
      \u003C\u0024\u003Emode = mode,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Scene.\u003ConStartSceneAsync\u003Ec__Iterator397()
    {
      mode = mode,
      select = select,
      \u003C\u0024\u003Emode = mode,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Scene.\u003ConStartSceneAsync\u003Ec__Iterator398()
    {
      mode = mode,
      target = target,
      select = select,
  ...
  public override void onEndScene()
  {
    ...
    Debug.LogWarning((object) "end scene");
