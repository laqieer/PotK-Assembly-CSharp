...
public class Quest00214DirCombi : MonoBehaviour
{
    ...
    Action<int, int> buttonEvent = null)
  {
    ...
    return (IEnumerator) new Quest00214DirCombi.\u003CInitStoryPlayBack\u003Ec__Iterator1B8()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214DirCombi.\u003CInit\u003Ec__Iterator1B9()
    {
      questSTable = questSTable,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214DirCombi.\u003CSetUnitIcon\u003Ec__Iterator1BA()
    {
      unit = unit,
