...
public class Quest002171CantOpenQuestPopup : BackButtonMenuBase
{
  ...
  public IEnumerator Init(string name, int key_id, int key_quantity, int consume_quantity)
  {
    ...
    return (IEnumerator) new Quest002171CantOpenQuestPopup.\u003CInit\u003Ec__Iterator1EC()
    {
      key_id = key_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest002171CantOpenQuestPopup.\u003CCreateKeySprite\u003Ec__Iterator1ED()
    {
      keyID = keyID,
      \u003C\u0024\u003EkeyID = keyID,
      \u003C\u003Ef__this = this
