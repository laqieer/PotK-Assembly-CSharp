...
public class BannersProc : MonoBehaviour
{
  ...
  private IEnumerator LoadBanner(int index)
  {
    ...
    return (IEnumerator) new BannersProc.\u003CLoadBanner\u003Ec__Iterator90B()
    {
      index = index,
      \u003C\u0024\u003Eindex = index,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BannersProc.\u003CLoadBannerAll\u003Ec__Iterator90C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BannersProc.\u003CBannerCreate\u003Ec__Iterator90D()
    {
