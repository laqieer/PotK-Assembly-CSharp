...
public class EffectControllerGacha : EffectController
{
  ...
  public IEnumerator SetNeedData(GachaResultData.ResultData result_data, GameObject back_button)
  {
    ...
    return (IEnumerator) new EffectControllerGacha.\u003CSetNeedData\u003Ec__Iterator8F7()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CLoadFlashImage\u003Ec__Iterator8F8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CInitResultImage\u003Ec__Iterator8F9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CbugFix\u003Ec__Iterator8FA()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CTanpatu\u003Ec__Iterator8FB()
    {
      result_data = result_data,
      \u003C\u0024\u003Eresult_data = result_data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectControllerGacha.\u003CRenpatu\u003Ec__Iterator8FC()
    {
      result_data = result_data,
      \u003C\u0024\u003Eresult_data = result_data,
      \u003C\u003Ef__this = this
  ...
  protected void SetUseStone()
  {
    ...
    if (this.resultData.patternID != null)
    {
      ...
      if (key1 != null)
      {
        ...
        if (EffectControllerGacha.\u003C\u003Ef__switch\u0024map1C == null)
        {
          // ISSUE: reference to a compiler-generated field
          EffectControllerGacha.\u003C\u003Ef__switch\u0024map1C = new Dictionary<string, int>(3)
          {
            {
              "blue",
              0
        ...
        // ISSUE: reference to a compiler-generated field
        if (EffectControllerGacha.\u003C\u003Ef__switch\u0024map1C.TryGetValue(key1, out num2))
        {
          switch (num2)
          {
            case 0:
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (EffectControllerGacha.\u003C\u003Ef__switch\u0024map1D == null)
        {
          // ISSUE: reference to a compiler-generated field
          EffectControllerGacha.\u003C\u003Ef__switch\u0024map1D = new Dictionary<string, int>(3)
          {
            {
              "blue",
              0
        ...
        // ISSUE: reference to a compiler-generated field
        if (EffectControllerGacha.\u003C\u003Ef__switch\u0024map1D.TryGetValue(key2, out num2))
        {
          switch (num2)
          {
            case 0:
      ...
      if (this.resultData.patternID.Length > 3)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (EffectControllerGacha.\u003C\u003Ef__switch\u0024map1E == null)
          {
            // ISSUE: reference to a compiler-generated field
            EffectControllerGacha.\u003C\u003Ef__switch\u0024map1E = new Dictionary<string, int>(3)
            {
              {
                "LOW",
                0
          ...
          // ISSUE: reference to a compiler-generated field
          if (EffectControllerGacha.\u003C\u003Ef__switch\u0024map1E.TryGetValue(key3, out num2))
          {
            switch (num2)
            {
              case 0:
  ...
  protected void StoneChange()
  {
    ...
    if (this.resultData.patternID != null)
    {
      ...
      if (key != null)
      {
        ...
        int num2;
        // ISSUE: reference to a compiler-generated field
        if (EffectControllerGacha.\u003C\u003Ef__switch\u0024map1F.TryGetValue(key, out num2))
        {
          switch (num2)
          {
            case 0:
