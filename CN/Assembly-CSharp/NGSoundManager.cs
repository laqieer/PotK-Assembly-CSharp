...
public class NGSoundManager : Singleton<NGSoundManager>
{
    ...
    float delay = 0.0f)
  {
    ...
    return (IEnumerator) new NGSoundManager.\u003CFade\u003Ec__IteratorA7D()
    {
      delay = delay,
      duration = duration,
      player = player,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSoundManager.\u003CdelayPlay\u003Ec__IteratorA7E()
    {
      delay = delay,
      player = player,
      \u003C\u0024\u003Edelay = delay,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSoundManager.\u003CpauseCorutine\u003Ec__IteratorA7F()
    {
      player = player,
      \u003C\u0024\u003Eplayer = player
    };
    ...
    float delay = 0.0f)
  {
    ...
    NGSoundManager.\u003CBgmCrossFade\u003Ec__IteratorA80 fadeCIteratorA80 = new NGSoundManager.\u003CBgmCrossFade\u003Ec__IteratorA80();
    return (IEnumerator) fadeCIteratorA80;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGSoundManager.\u003CBgmCrossFade\u003Ec__IteratorA81()
    {
      player = player,
      aisac = aisac,
      duration = duration,
