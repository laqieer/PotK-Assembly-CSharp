...
public class Popup02688Menu : Popup02610Base
{
  ...
  public override IEnumerator InitCoroutine(WebAPI.Response.PvpBoot pvpInfo, Versus02610Menu menu)
  {
    ...
    return (IEnumerator) new Popup02688Menu.\u003CInitCoroutine\u003Ec__Iterator96C()
    {
      pvpInfo = pvpInfo,
      menu = menu,
      \u003C\u0024\u003EpvpInfo = pvpInfo,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02688Menu.\u003CExtendPopup\u003Ec__Iterator96D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02688Menu.\u003CSeasonClose\u003Ec__Iterator96E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02688Menu.\u003CCreateClassChange\u003Ec__Iterator96F()
    {
      \u003C\u003Ef__this = this
    };
  }
