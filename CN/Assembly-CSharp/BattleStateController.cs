...
public class BattleStateController : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Original()
  {
    ...
    return (IEnumerator) new BattleStateController.\u003CStart_Original\u003Ec__Iterator9A4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleStateController.\u003CStart_Battle\u003Ec__Iterator9A5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  protected override void LateUpdate_Battle()
  {
    ...
    switch (state)
    {
      ...
      case BL.Phase.stageclear:
        this.aiController.stopAIAction();
        if (this.battleManager.isWave && this.env.core.currentWave + 1 < this.battleManager.waveLength)
        {
            ...
            if (state != BL.Phase.battle_start)
            {
              if (state != BL.Phase.battle_start_init)
              {
                if (state != BL.Phase.wave_start)
                  return;
                this.btm.setSchedule((Schedule) new BattleStateController.WaveStart(this, this.env, this.env.core.currentWave + 1));
  ...
  private class EffectAIWait : ScheduleEnumerator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleStateController.EffectAIWait.\u003CdoBody\u003Ec__Iterator9A6()
      {
        \u003C\u003Ef__this = this
      };
    }
  ...
  private class PvpMatchEffect : BattleEffects.CloneEnumlator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleStateController.PvpMatchEffect.\u003CdoBody\u003Ec__Iterator9AA()
      {
        o = o,
        \u003C\u0024\u003Eo = o,
        \u003C\u003Ef__this = this
  ...
  private class WaveStart : ScheduleEnumerator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleStateController.WaveStart.\u003CdoBody\u003Ec__Iterator9AB()
      {
        \u003C\u003Ef__this = this
      };
    }
