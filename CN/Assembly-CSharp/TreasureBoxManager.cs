...
public class TreasureBoxManager : BattleManagerBase
{
  ...
  public override IEnumerator initialize(GameCore.BattleInfo info, BE env_ = null)
  {
    ...
    return (IEnumerator) new TreasureBoxManager.\u003Cinitialize\u003Ec__Iterator993()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TreasureBoxManager.\u003Ccleanup\u003Ec__Iterator994()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TreasureBoxManager.\u003CdoExecute\u003Ec__Iterator995()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private class ExecuteSchedule : ScheduleEnumerator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TreasureBoxManager.ExecuteSchedule.\u003CdoBody\u003Ec__Iterator997()
      {
        \u003C\u003Ef__this = this
      };
    }
  ...
  private class Continuer
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TreasureBoxManager.Continuer.\u003CdoEnd\u003Ec__Iterator998()
      {
        tm = tm,
        \u003C\u0024\u003Etm = tm,
        \u003C\u003Ef__this = this
