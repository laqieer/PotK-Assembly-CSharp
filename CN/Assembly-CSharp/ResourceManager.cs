...
public class ResourceManager : Singleton<ResourceManager>
{
  ...
  public IEnumerator CleanupCache()
  {
    ...
    return (IEnumerator) new ResourceManager.\u003CCleanupCache\u003Ec__IteratorAEB()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceManager.\u003CDownloadIfNotExists\u003Ec__IteratorAEC()
    {
      path = path,
      \u003C\u0024\u003Epath = path,
      \u003C\u003Ef__this = this
  ...
  public void saveFirstDownloadSize(int size)
  {
    Dictionary<string, object> firstDownInfo = this.getFirstDownInfo();
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceManager.\u003CInitResourceInfo\u003Ec__IteratorAED()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceManager.\u003CSaveResourceInfo\u003Ec__IteratorAEE()
    {
      buf = buf,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceManager.\u003CSetStep\u003Ec__IteratorAEF()
    {
      res = res,
      step = step,
      \u003C\u0024\u003Eres = res,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceManager.\u003CSetSteps\u003Ec__IteratorAF0()
    {
      path = path,
      obj = obj,
      \u003C\u0024\u003Epath = path,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceManager.\u003CInternalLoad\u003Ec__IteratorAF1()
    {
      path = path,
      promise = promise,
      \u003C\u0024\u003Epath = path,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceManager.\u003CLoadResource\u003Ec__IteratorAF2()
    {
  ...
  public string ResolveStreamingAssetsPath(string path)
  {
    ...
    return DLC.ResourceFullPath(this.resourceInfo[n]._value._file_name);
  }
