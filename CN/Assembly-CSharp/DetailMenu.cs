...
public class DetailMenu : DetailMenuBase
{
  ...
  private IEnumerator UpdateActive(int infoIndex, bool isUpdate = true)
  {
    ...
    return (IEnumerator) new DetailMenu.\u003CUpdateActive\u003Ec__IteratorA22()
    {
      infoIndex = infoIndex,
      isUpdate = isUpdate,
      \u003C\u0024\u003EinfoIndex = infoIndex,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CSetInformationPanelIndex\u003Ec__IteratorA23()
    {
      index = index,
      \u003C\u0024\u003Eindex = index,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CInitInformationPanels\u003Ec__IteratorA24()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CItemGearFavoriteAscync\u003Ec__IteratorA25()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003ConEndSceneAsync\u003Ec__IteratorA26()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CInit\u003Ec__IteratorA27()
    {
      menu = menu,
      index = index,
      playerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CInitPlayer\u003Ec__IteratorA28()
    {
      playerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CLoadCharacterImage\u003Ec__IteratorA29()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CsetDefaultWeapon\u003Ec__IteratorA2A()
    {
      gear = gear,
      \u003C\u0024\u003Egear = gear,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenu.\u003CWaitScrollSe\u003Ec__IteratorA2B()
    {
      \u003C\u003Ef__this = this
    };
  }
