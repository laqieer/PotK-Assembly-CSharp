...
public class Bugu0059Menu : BackButtonMenuBase
{
  ...
  public IEnumerator onInitAsync()
  {
    ...
    return (IEnumerator) new Bugu0059Menu.\u003ConInitAsync\u003Ec__Iterator3C9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0059Menu.\u003ConStartAsync\u003Ec__Iterator3CA()
    {
      scene = scene,
      baseGear = baseGear,
      response = response,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0059Menu.\u003CSetNoResponse\u003Ec__Iterator3CB()
    {
      baseGear = baseGear,
      \u003C\u0024\u003EbaseGear = baseGear,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0059Menu.\u003CSetResponse\u003Ec__Iterator3CC()
    {
      response = response,
      baseGear = baseGear,
      \u003C\u0024\u003Eresponse = response,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0059Menu.\u003COpenMaterialCheckPopup\u003Ec__Iterator3CD()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0059Menu.\u003Cdrilling\u003Ec__Iterator3CE()
    {
      \u003C\u003Ef__this = this
    };
  }
