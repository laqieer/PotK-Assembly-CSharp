...
public class MypageMenu : BackButtonMenuBase
{
  ...
  public virtual IEnumerator InitSceneAsync()
  {
    ...
    return (IEnumerator) new MypageMenu.\u003CInitSceneAsync\u003Ec__Iterator726()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CStartSceneAsync\u003Ec__Iterator727()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CbackPopoup\u003Ec__Iterator728()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CInitOne\u003Ec__Iterator729()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CCharcterAnimationSetting\u003Ec__Iterator72A()
    {
      isCloudAnim = isCloudAnim,
      tweenID = tweenID,
      \u003C\u0024\u003EisCloudAnim = isCloudAnim,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003COpenColosseum\u003Ec__Iterator72B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CCloudAnimationStart\u003Ec__Iterator72C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator ChangeEarth()
  {
    ...
    MypageMenu.\u003CChangeEarth\u003Ec__Iterator72D earthCIterator72D = new MypageMenu.\u003CChangeEarth\u003Ec__Iterator72D();
    return (IEnumerator) earthCIterator72D;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CCreateCharcterAnimation\u003Ec__Iterator72E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CCreateJogDial\u003Ec__Iterator72F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MypageMenu.\u003CCreateLoginPopup\u003Ec__Iterator730()
    {
      \u003C\u003Ef__this = this
    };
  }
