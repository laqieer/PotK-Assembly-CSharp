...
public class Battle020191Menu : NGMenuBase
{
    ...
    bool fromEarth = false)
  {
    ...
    return (IEnumerator) new Battle020191Menu.\u003CInit\u003Ec__Iterator82F()
    {
      before = before,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle020191Menu.\u003CPlay\u003Ec__Iterator830()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle020191Menu.\u003CtoClose\u003Ec__Iterator831()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle020191Menu.\u003CSetCharacterViewUnit\u003Ec__Iterator832()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
