...
public class Guild028115Popup : BackButtonMenuBase
{
  ...
  private IEnumerator Initialize(string name, GuildInfoPopup popup, GuildAppearance appearance)
  {
    ...
    return (IEnumerator) new Guild028115Popup.\u003CInitialize\u003Ec__Iterator69A()
    {
      popup = popup,
      name = name,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild028115Popup.\u003CSetGuildData\u003Ec__Iterator69B()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild028115Popup.\u003CSendRequest\u003Ec__Iterator69C()
    {
      \u003C\u003Ef__this = this
    };
  }
