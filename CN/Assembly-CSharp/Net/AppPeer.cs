...
namespace Net
{
  public class AppPeer : Peer
  {
      ...
      Promise<AppPeer.ReceivedMessage> promise)
    {
      ...
      return (IEnumerator) new AppPeer.\u003CReceiveUntilF\u003Ec__IteratorA91()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new AppPeer.\u003CReceiveTypeE\u003Ec__IteratorA92()
      {
        timeoutMilliseconds = timeoutMilliseconds,
        promise = promise,
        \u003C\u0024\u003EtimeoutMilliseconds = timeoutMilliseconds,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new AppPeer.\u003CSendNothrowE\u003Ec__IteratorA93()
      {
        send = send,
        promise = promise,
        \u003C\u0024\u003Esend = send,
