...
public class Battle03UIPlayerStatus : Battle02MenuBase
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    return (IEnumerator) new Battle03UIPlayerStatus.\u003CStart_Battle\u003Ec__Iterator88C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  protected override void LateUpdate_Battle()
  {
    ...
    Battle03UIPlayerStatus.\u003CLateUpdate_Battle\u003Ec__AnonStoreyF5B battleCAnonStoreyF5B1 = new Battle03UIPlayerStatus.\u003CLateUpdate_Battle\u003Ec__AnonStoreyF5B();
    // ISSUE: reference to a compiler-generated field
    battleCAnonStoreyF5B1.v = this.modified.value;
    foreach (GameObject gameObject in this.dir_ForceHeader)
      gameObject.SetActive(false);
    // ISSUE: reference to a compiler-generated field
    this.dir_ForceHeader[(int) this.env.core.getForceID(battleCAnonStoreyF5B1.v)].SetActive(true);
    // ISSUE: reference to a compiler-generated field
    if (this.env.core.getForceID(battleCAnonStoreyF5B1.v) == BL.ForceID.player)
    {
      // ISSUE: reference to a compiler-generated field
      ((IEnumerable<GameObject>) this.slcStatus1BaseOwnIcons).ToggleOnce(!battleCAnonStoreyF5B1.v.playerUnit.is_gesut ? 0 : 1);
    }
    // ISSUE: reference to a compiler-generated field
    Judgement.BattleParameter battleParameter = Judgement.BattleParameter.FromBeUnit(battleCAnonStoreyF5B1.v);
    ...
    // ISSUE: reference to a compiler-generated field
    CommonElement element = battleCAnonStoreyF5B1.v.playerUnit.equippedGearOrInitial.GetElement();
    // ISSUE: reference to a compiler-generated field
    if (battleCAnonStoreyF5B1.v.playerUnit.equippedGear != (PlayerItem) null)
    {
      // ISSUE: reference to a compiler-generated field
      element = battleCAnonStoreyF5B1.v.playerUnit.equippedGear.GetElement();
    }
    // ISSUE: reference to a compiler-generated field
    this.weaponEquipIcon.GetComponentInChildren<GearKindIcon>().Init(battleCAnonStoreyF5B1.v.playerUnit.equippedGearOrInitial.kind, element);
    // ISSUE: reference to a compiler-generated field
    this.hpGauge.setValue(battleCAnonStoreyF5B1.v.hp, battleParameter.Hp, false);
    // ISSUE: reference to a compiler-generated field
    this.setText(this.txt_CharacterName, battleCAnonStoreyF5B1.v.unit.name);
    // ISSUE: reference to a compiler-generated field
    this.setText(this.txt_Lv, battleCAnonStoreyF5B1.v.lv);
    this.setColordText(this.txt_Fighting, battleParameter.Combat, battleParameter.CombatIncr);
    // ISSUE: reference to a compiler-generated field
    this.setText(this.txt_Hp, battleCAnonStoreyF5B1.v.hp);
    this.setText(this.txt_Hpmax, "/" + (object) battleParameter.Hp);
    // ISSUE: reference to a compiler-generated field
    this.setText(this.txt_Jobname, battleCAnonStoreyF5B1.v.job.name);
    ...
    // ISSUE: reference to a compiler-generated field
    this.SetPrincessType(battleCAnonStoreyF5B1.v);
    // ISSUE: reference to a compiler-generated field
    if (battleCAnonStoreyF5B1.v.playerUnit.skills != null)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      IEnumerable<PlayerUnitSkills> playerUnitSkillses = ((IEnumerable<UnitSkill>) battleCAnonStoreyF5B1.v.unit.RememberUnitSkills).Where<UnitSkill>((Func<UnitSkill, bool>) (w => w.skill.DispSkillList)).Select<UnitSkill, PlayerUnitSkills>((Func<UnitSkill, PlayerUnitSkills>) (f =>
      {
        // ISSUE: variable of a compiler-generated type
        Battle03UIPlayerStatus.\u003CLateUpdate_Battle\u003Ec__AnonStoreyF5B battleCAnonStoreyF5B = battleCAnonStoreyF5B1;
        // ISSUE: variable of a compiler-generated type
        Battle03UIPlayerStatus.\u003CLateUpdate_Battle\u003Ec__AnonStoreyF5D battleCAnonStoreyF5D = this;
        UnitSkill f1 = f;
        return ((IEnumerable<PlayerUnitSkills>) v.playerUnit.skills).FirstOrDefault<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (fd =>
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          return battleCAnonStoreyF5D.unitSkillEvolutionDict.ContainsKey(fd.skill.ID) && f1.skill == battleCAnonStoreyF5D.unitSkillEvolutionDict[fd.skill.ID].before_skill;
        }));
      ...
      if (!Singleton<NGBattleManager>.GetInstance().isEarth)
      {
        IEnumerable<PlayerUnitSkills> second1 = ((IEnumerable<UnitSkillCharacterQuest>) MasterData.UnitSkillCharacterQuestList).Where<UnitSkillCharacterQuest>((Func<UnitSkillCharacterQuest, bool>) (x => x.unit.ID == v.playerUnit.unit.ID && x.skill.DispSkillList)).Select<UnitSkillCharacterQuest, PlayerUnitSkills>((Func<UnitSkillCharacterQuest, PlayerUnitSkills>) (s =>
        {
          ...
          return ((IEnumerable<PlayerUnitSkills>) v.playerUnit.skills).FirstOrDefault<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (fd =>
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            return battleCAnonStoreyF5D.unitSkillEvolutionDict.ContainsKey(fd.skill.ID) && s1.skill == battleCAnonStoreyF5D.unitSkillEvolutionDict[fd.skill.ID].before_skill;
          }));
        })).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (w => w != null));
        IEnumerable<PlayerUnitSkills> second2 = ((IEnumerable<UnitSkillHarmonyQuest>) MasterData.UnitSkillHarmonyQuestList).Where<UnitSkillHarmonyQuest>((Func<UnitSkillHarmonyQuest, bool>) (x => x.character.ID == v.playerUnit.unit.character.ID && x.skill.DispSkillList)).Select<UnitSkillHarmonyQuest, PlayerUnitSkills>((Func<UnitSkillHarmonyQuest, PlayerUnitSkills>) (s =>
        {
          ...
          return ((IEnumerable<PlayerUnitSkills>) v.playerUnit.skills).FirstOrDefault<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (fd =>
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            return battleCAnonStoreyF5D.unitSkillEvolutionDict.ContainsKey(fd.skill.ID) && s2.skill == battleCAnonStoreyF5D.unitSkillEvolutionDict[fd.skill.ID].before_skill;
          }));
        })).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (w => w != null));
        IEnumerable<PlayerUnitSkills> second3 = ((IEnumerable<UnitSkillIntimate>) MasterData.UnitSkillIntimateList).Where<UnitSkillIntimate>((Func<UnitSkillIntimate, bool>) (x => x.unit.ID == v.playerUnit.unit.ID && x.skill.DispSkillList)).Select<UnitSkillIntimate, PlayerUnitSkills>((Func<UnitSkillIntimate, PlayerUnitSkills>) (s =>
        {
          ...
          return ((IEnumerable<PlayerUnitSkills>) v.playerUnit.skills).FirstOrDefault<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (fd =>
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            return battleCAnonStoreyF5D.unitSkillEvolutionDict.ContainsKey(fd.skill.ID) && s3.skill == battleCAnonStoreyF5D.unitSkillEvolutionDict[fd.skill.ID].before_skill;
          }));
        })).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (w => w != null));
      ...
      // ISSUE: reference to a compiler-generated field
      IEnumerable<PlayerUnitSkills> second = ((IEnumerable<PlayerUnitSkills>) battleCAnonStoreyF5B1.v.playerUnit.skills).Where<PlayerUnitSkills>((Func<PlayerUnitSkills, bool>) (w => w.skill.DispSkillList)).Except<PlayerUnitSkills>(playerUnitSkillses);
    ...
    {
      // ISSUE: reference to a compiler-generated field
      for (int index = 0; index < battleCAnonStoreyF5B1.v.playerUnit.equippedGear.skills.Length; ++index)
      {
        this.skillTypeIcon[10 + index] = this.createIcon(this.skillTypeIconPrefab, this.skillTypeIconParent[10 + index]);
        // ISSUE: reference to a compiler-generated field
        this.StartCoroutine(this.skillTypeIcon[10 + index].GetComponentInChildren<BattleSkillIcon>().Init(battleCAnonStoreyF5B1.v.playerUnit.equippedGear.skills[index].skill));
        // ISSUE: reference to a compiler-generated field
        this.dispWeapon = battleCAnonStoreyF5B1.v.playerUnit.equippedGear;
      }
    }
    // ISSUE: reference to a compiler-generated field
    if (battleCAnonStoreyF5B1.v.weapon.gear != null)
    {
      this.elementTypeIcon[0] = this.createIcon(this.elementTypeIconPrefab, this.elementTypeIconParent[0]);
      // ISSUE: reference to a compiler-generated field
      if (battleCAnonStoreyF5B1.v.weapon.gear.elements.Length != 0)
      {
        // ISSUE: reference to a compiler-generated field
        this.elementTypeIcon[0].GetComponentInChildren<CommonElementIcon>().Init(battleCAnonStoreyF5B1.v.weapon.gear.elements[0].element);
      }
      else
        this.elementTypeIcon[0].GetComponentInChildren<CommonElementIcon>().Init(CommonElement.none);
      // ISSUE: reference to a compiler-generated field
      this.setText(this.txt_Magic_name[0], battleCAnonStoreyF5B1.v.playerUnit.equippedGearName);
      // ISSUE: reference to a compiler-generated field
      BL.Unit.GearRange gearRange = battleCAnonStoreyF5B1.v.gearRange();
      this.setText(this.txt_Magic_range[0], string.Format("{0} - {1}", (object) gearRange.Min, (object) gearRange.Max));
      // ISSUE: reference to a compiler-generated field
      UnitFamily[] specialAttackTargets = battleCAnonStoreyF5B1.v.playerUnit.equippedWeaponGearOrInitial.SpecialAttackTargets;
    ...
    if (battleCAnonStoreyF5B1.v.playerUnit.skills != null)
    {
      ...
      int num = 0;
      // ISSUE: reference to a compiler-generated field
      foreach (PlayerUnitSkills skill in battleCAnonStoreyF5B1.v.playerUnit.skills)
      {
    ...
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    if (battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies != null && battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies.Length >= 1)
    {
      // ISSUE: reference to a compiler-generated field
      this.gearKindIcon01.GetComponent<GearKindIcon>().Init(battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies[0].gear_kind_id);
      this.gearProfiencyIconW = this.createIcon(this.gearProfiencyIconPrefab, this.gearProfiencyIconParentW);
      // ISSUE: reference to a compiler-generated field
      this.gearProfiencyIconW.GetComponentInChildren<GearProfiencyIcon>().Init(battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies[0].level);
    }
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    if (battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies != null && battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies.Length >= 2)
    {
      // ISSUE: reference to a compiler-generated field
      this.gearKindIcon02.GetComponent<GearKindIcon>().Init(battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies[1].gear_kind_id);
      this.gearProfiencyIconS = this.createIcon(this.gearProfiencyIconPrefab, this.gearProfiencyIconParentS);
      // ISSUE: reference to a compiler-generated field
      this.gearProfiencyIconS.GetComponentInChildren<GearProfiencyIcon>().Init(battleCAnonStoreyF5B1.v.playerUnit.gear_proficiencies[1].level);
    }
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    if (battleCAnonStoreyF5B1.v.playerUnit.is_enemy && battleCAnonStoreyF5B1.v.playerUnit.is_enemy_leader && battleCAnonStoreyF5B1.v.playerUnit.leader_skill != null)
    {
      // ISSUE: reference to a compiler-generated field
      this.dispLeaderSkill = battleCAnonStoreyF5B1.v.playerUnit.leader_skill;
      this.LeaderSkillBtn.SetActive(true);
    }
    else
      this.LeaderSkillBtn.SetActive(false);
    // ISSUE: reference to a compiler-generated field
    this.StartCoroutine(this.createMaskdCharacter(battleCAnonStoreyF5B1.v));
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle03UIPlayerStatus.\u003CcreateMaskdCharacter\u003Ec__Iterator88D()
    {
      v = v,
      \u003C\u0024\u003Ev = v,
      \u003C\u003Ef__this = this
