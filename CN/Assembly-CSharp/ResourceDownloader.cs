...
public static class ResourceDownloader
{
    ...
    Promise<string> promise)
  {
    ...
    return (IEnumerator) new ResourceDownloader.\u003CDownloadJson\u003Ec__IteratorAE1()
    {
      url = url,
      mono = mono,
      promise = promise,
  ...
  private static ResourceDownloader.ProgressInfo isNotFirst()
  {
    ...
    int num1 = ResourceDownloader.assetBundle.GetDownloadSize() + ResourceDownloader.streamingAssets.GetDownloadSize();
    int num2 = ResourceDownloader.assetBundle.GetDownloadedSize() + ResourceDownloader.streamingAssets.GetDownloadedSize() + ResourceDownloader.getJsonSizp();
    int num3 = firstSize - num1;
    if (num3 < 0)
      num3 = 0;
    return new ResourceDownloader.ProgressInfo()
    {
      Numerator = num3 + ResourceDownloader.assetBundle.GetDownloadedSize() + ResourceDownloader.streamingAssets.GetDownloadedSize() + ResourceDownloader.getJsonSizp(),
      Denominator = firstSize + ResourceDownloader.getJsonSizp()
    };
  }
  ...
  public static ResourceDownloader.ProgressInfo Progress
  {
    get
    {
      ...
      return new ResourceDownloader.ProgressInfo()
      {
        Numerator = ResourceDownloader.assetBundle.GetDownloadedSize() + ResourceDownloader.streamingAssets.GetDownloadedSize() + ResourceDownloader.getJsonSizp(),
        Denominator = ResourceDownloader.assetBundle.GetDownloadSize() + ResourceDownloader.streamingAssets.GetDownloadSize() + ResourceDownloader.getJsonSizp()
      };
    }
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceDownloader.\u003CInternalStart\u003Ec__IteratorAE2()
    {
      dlcVersion = dlcVersion,
      mono = mono,
      \u003C\u0024\u003EdlcVersion = dlcVersion,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ResourceDownloader.\u003CCleanCache\u003Ec__IteratorAE3()
    {
      progress = progress,
      \u003C\u0024\u003Eprogress = progress
    };
  ...
  private class WWWEx : IDisposable
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ResourceDownloader.WWWEx.\u003CStart\u003Ec__IteratorAE4()
      {
        mono = mono,
        \u003C\u0024\u003Emono = mono,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ResourceDownloader.WWWEx.\u003CWait\u003Ec__IteratorAE5()
      {
        \u003C\u003Ef__this = this
      };
    }
