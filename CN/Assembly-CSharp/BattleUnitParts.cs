...
public class BattleUnitParts : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    return (IEnumerator) new BattleUnitParts.\u003CStart_Battle\u003Ec__Iterator9AD()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoDead\u003Ec__Iterator9AE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoSpawn\u003Ec__Iterator9AF()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoRebirth\u003Ec__Iterator9B0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    Debug.LogWarning((object) " ==== moveStayUpdate !");
    this.setUnitUpdate();
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoMoving\u003Ec__Iterator9B1()
    {
      panels = panels,
      \u003C\u0024\u003Epanels = panels,
      \u003C\u003Ef__this = this
