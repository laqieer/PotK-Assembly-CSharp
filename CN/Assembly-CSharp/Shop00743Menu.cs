...
public class Shop00743Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Init(Player player, bool isUpdate = true)
  {
    ...
    return (IEnumerator) new Shop00743Menu.\u003CInit\u003Ec__Iterator49E()
    {
      player = player,
      isUpdate = isUpdate,
      \u003C\u0024\u003Eplayer = player,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00743Menu.\u003CupdateScroll\u003Ec__Iterator49F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00743Menu.\u003CDetailPopup\u003Ec__Iterator4A0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00743Menu.\u003CopenDetail\u003Ec__Iterator4A1()
    {
      \u003C\u003Ef__this = this
    };
  }
