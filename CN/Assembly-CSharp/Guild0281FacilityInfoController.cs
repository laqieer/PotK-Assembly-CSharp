...
public class Guild0281FacilityInfoController : MonoBehaviour
{
  ...
  [SerializeField]
  private UILabel wallsStatus2TitleLabel;
  [SerializeField]
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    return (IEnumerator) new Guild0281FacilityInfoController.\u003CInitializeAsync\u003Ec__Iterator687()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281FacilityInfoController.\u003CLoadFacilityInvestDialogPrefab\u003Ec__Iterator688()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281FacilityInfoController.\u003CLoadFacilityLevelUpEffectPrefab\u003Ec__Iterator689()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281FacilityInfoController.\u003COpenFacilityInvestmentDialog\u003Ec__Iterator68A()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281FacilityInfoController.\u003COnInvestmentFinished\u003Ec__Iterator68B()
    {
      selectedFacility = selectedFacility,
      \u003C\u0024\u003EselectedFacility = selectedFacility,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281FacilityInfoController.\u003CInvestFacilityCoroutine\u003Ec__Iterator68C()
    {
      selectedFacility = selectedFacility,
      \u003C\u0024\u003EselectedFacility = selectedFacility,
      \u003C\u003Ef__this = this
