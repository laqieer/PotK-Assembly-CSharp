...
public class PVPManager : Singleton<PVPManager>, IGameEngine
{
  ...
  public void startMain()
  {
    ...
    else
    {
      if (this.isRunning)
        return;
      Debug.LogWarning((object) " === startPVPMain");
  ...
  public IEnumerator cleanupPVP()
  {
    ...
    return (IEnumerator) new PVPManager.\u003CcleanupPVP\u003Ec__Iterator9DC()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    Debug.LogWarning((object) " === startPVP");
    Debug.LogWarning((object) ("     host:" + host));
    Debug.LogWarning((object) ("     port:" + (object) port));
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_startPVP\u003Ec__Iterator9DD()
    {
      host = host,
      port = port,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_connectServer\u003Ec__Iterator9DE()
    {
      host = host,
      port = port,
      promise = promise,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_battleReady\u003Ec__Iterator9DF()
    {
      promise = promise,
      \u003C\u0024\u003Epromise = promise,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003CcreateEnvironment\u003Ec__Iterator9E0()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003CinitPrefabs\u003Ec__Iterator9E1()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003CdoPvpDisposition\u003Ec__Iterator9E2()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003CdoPvpMain\u003Ec__Iterator9E3()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003ChideLoading\u003Ec__Iterator9E4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_ReadyCompleted\u003Ec__Iterator9E5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_LocateUnitsCompleted\u003Ec__Iterator9E6()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_ActionUnitCompleted\u003Ec__Iterator9E7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_TurnInitializeCompleted\u003Ec__Iterator9E8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_MoveUnitTimeout\u003Ec__Iterator9E9()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_MoveUnit\u003Ec__Iterator9EA()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_MoveUnitWithAttack\u003Ec__Iterator9EB()
    {
      unitPositionId = unitPositionId,
      row = row,
      column = column,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_MoveUnitWithSkill\u003Ec__Iterator9EC()
    {
      unitPositionId = unitPositionId,
      row = row,
      column = column,
  ...
  public static IEnumerator destroyPVPManager()
  {
    ...
    PVPManager.\u003CdestroyPVPManager\u003Ec__Iterator9ED managerCIterator9Ed = new PVPManager.\u003CdestroyPVPManager\u003Ec__Iterator9ED();
    return (IEnumerator) managerCIterator9Ed;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003C_RecoveryRequest\u003Ec__Iterator9EE()
    {
      bt = bt,
      \u003C\u0024\u003Ebt = bt,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003CdoErrorRecovery\u003Ec__Iterator9EF()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003CdoRecoveryStartPVPMain\u003Ec__Iterator9F0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    Debug.LogWarning((object) " === applyRecovery");
    BE environment = this.bm.environment;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PVPManager.\u003CnoRoomFinish\u003Ec__Iterator9F1()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void OnApplicationPause(bool pause)
  {
    if (!pause || this.peer == null)
      return;
    Debug.LogWarning((object) " === OnApplicationPause pause");
    this.peer.Close();
  }
  ...
  private class CreateEnvInfo
  {
    ...
    public StartParameter player1_parameter;
    public StartParameter player2_parameter;
    ...
    public void EncodeReady(AppPeer.Ready r)
    {
      ...
      this.player1_parameter = internalPvpStart.player1_parameter;
      this.player2_parameter = internalPvpStart.player2_parameter;
    }
    ...
    public void EncodeResume(WebAPI.Response.PvpResume r)
    {
      ...
      this.player1_parameter = r.player1_parameter;
      this.player2_parameter = r.player2_parameter;
    }
  }
}
