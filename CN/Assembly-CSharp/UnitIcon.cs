...
public class UnitIcon : UnitIconBase
{
    ...
    PlayerUnit[] playerUnits)
  {
    ...
    return (IEnumerator) new UnitIcon.\u003CSetMaterialUnit\u003Ec__IteratorAD0()
    {
      playerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetPlayerUnit\u003Ec__IteratorAD1()
    {
      playerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetPlayerUnitEvolution\u003Ec__IteratorAD2()
    {
      playerUnit = playerUnit,
      basePlayerUnit = basePlayerUnit,
      playerUnits = playerUnits,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CsetPlayerUnit\u003Ec__IteratorAD3()
    {
      playerUnit = playerUnit,
      basePlayerUnit = basePlayerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CsetSimpleUnit\u003Ec__IteratorAD4()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CsetBottomUnit\u003Ec__IteratorAD5()
    {
      playerUnit = playerUnit,
      playerUnits = playerUnits,
      \u003C\u0024\u003EplayerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CLoadSprite\u003Ec__IteratorAD6()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetUnit\u003Ec__IteratorAD7()
    {
      unit = unit,
      element = element,
      isGray = isGray,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetUnitWithLongPressAction\u003Ec__IteratorAD8()
    {
      unit = unit,
      isGray = isGray,
      buttonEvent = buttonEvent,
