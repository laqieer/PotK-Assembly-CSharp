...
namespace SimpleJSON
{
  public class JSONNode
  {
    ...
    public virtual IEnumerable<JSONNode> Childs
    {
      get
      {
        JSONNode.\u003C\u003Ec__Iterator158 cIterator158 = new JSONNode.\u003C\u003Ec__Iterator158();
        JSONNode.\u003C\u003Ec__Iterator158 childs = cIterator158;
        childs.\u0024PC = -2;
    ...
    public IEnumerable<JSONNode> DeepChilds
    {
      get
      {
        JSONNode.\u003C\u003Ec__Iterator159 deepChilds = new JSONNode.\u003C\u003Ec__Iterator159()
        {
          \u003C\u003Ef__this = this
        };
        deepChilds.\u0024PC = -2;
