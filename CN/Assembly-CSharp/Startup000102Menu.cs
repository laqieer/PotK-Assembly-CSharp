...
public class Startup000102Menu : MonoBehaviour
{
  ...
  public IEnumerator SetCharacterData(List<UnitUnit> dataList)
  {
    ...
    return (IEnumerator) new Startup000102Menu.\u003CSetCharacterData\u003Ec__Iterator169()
    {
      dataList = dataList,
      \u003C\u0024\u003EdataList = dataList,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Startup000102Menu.\u003CCreateImg\u003Ec__Iterator16A()
    {
      data = data,
      addList = addList,
      \u003C\u0024\u003Edata = data,
  ...
  public void Update()
  {
    int num1 = StartupDownLoad.progressNum();
    int max = StartupDownLoad.progressDem();
    int n = Mathf.Min(num1, max);
    float num2 = (float) n / (float) max * 100f;
    this.TxtPercentage.SetTextLocalize(string.Format("{0:F} ％", (object) num2));
    this.gaugeScale.setValue(n, max, false);
    ...
    switch (this.state)
    {
      case StartupDownLoad.State.Processing:
        if (!ResourceDownloader.IsCheckingFiles && (StartupDownLoad.progress == null || StartupDownLoad.progressDem() <= 0))
          break;
        this.DLStart();
        break;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Startup000102Menu.\u003CStartShowCharacter\u003Ec__Iterator16B()
    {
      dataList = dataList,
  ...
  private IEnumerator SceneChange()
  {
    ...
    Startup000102Menu.\u003CSceneChange\u003Ec__Iterator16C changeCIterator16C = new Startup000102Menu.\u003CSceneChange\u003Ec__Iterator16C();
    return (IEnumerator) changeCIterator16C;
  }
}
