...
public class ModelUnits : MonoBehaviour
{
  ...
  private IEnumerator LoadSLC3DModel()
  {
    ...
    return (IEnumerator) new ModelUnits.\u003CLoadSLC3DModel\u003Ec__IteratorA3B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CPreLoad3DModel\u003Ec__IteratorA3C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CStartCheckMemory\u003Ec__IteratorA3D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CCheckUsedMemory\u003Ec__IteratorA3E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CMyUpdate\u003Ec__IteratorA3F()
    {
      \u003C\u003Ef__this = this
    };
  }
