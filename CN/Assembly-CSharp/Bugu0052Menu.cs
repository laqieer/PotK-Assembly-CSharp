...
public class Bugu0052Menu : BackButtonMenuBase
{
  ...
  private Bugu0052Scene.MODE sceneMode;
  ...
  [DebuggerHidden]
  public IEnumerator Init(Bugu0052Scene scene)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CInit\u003Ec__Iterator385()
    {
      scene = scene,
      \u003C\u0024\u003Escene = scene,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CUpdateIcon\u003Ec__Iterator386()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CInitPlayerItems\u003Ec__Iterator387()
    {
      select = select,
      scene = scene,
      target = target,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CButtomIconClickSet\u003Ec__Iterator388()
    {
      icon = icon,
      \u003C\u0024\u003Eicon = icon,
      \u003C\u003Ef__this = this
  ...
  public virtual void IbtnYesS()
  {
    ...
    if (this.ItemList.Select<InventoryItem, bool>((Func<InventoryItem, bool>) (x => x.Item.favorite)).Contains<bool>(true))
    {
      if (this.mode == Bugu0052Scene.MODE.COMPOSITE)
      {
        ...
        }), Consts.Format(Consts.GetInstance().POPUP_005_FAVORITE_WARNING_MESSAGE, (IDictionary) new Hashtable()
        {
          {
            (object) "type",
            (object) Consts.GetInstance().GEAR_0052_COMPOSITE
      ...
      else
      {
        if (this.mode != Bugu0052Scene.MODE.PAKUPAKU_MATERIAL)
          return;
        this.StartCoroutine(PopupCommon.Show(Consts.GetInstance().GEAR_0052_PAKUPAKU_TITLE, Consts.Format(Consts.GetInstance().POPUP_005_FAVORITE_WARNING_MESSAGE, (IDictionary) new Hashtable()
        {
          {
            (object) "type",
            (object) Consts.GetInstance().GEAR_0052_PAKUPAKU_TITLE
          }
        })));
      }
    }
    else if (this.mode == Bugu0052Scene.MODE.COMPOSITE)
    {
      if (this.ItemList.Count >= 2)
        ...
        }), Consts.Format(Consts.GetInstance().POPUP_005_COMPOSITE_WARNING_MESSAGE, (IDictionary) new Hashtable()
        {
          {
            (object) "type",
            (object) Consts.GetInstance().GEAR_0052_COMPOSITE
    ...
    if (this.mode == Bugu0052Scene.MODE.SELL)
    {
      if (this.ItemList.Any<InventoryItem>((Func<InventoryItem, bool>) (x => x.Item.favorite)))
      {
        this.StartCoroutine(PopupCommon.Show(Consts.Format(Consts.GetInstance().POPUP_005_GEAR_WARNING_TITLE, (IDictionary) new Hashtable()
        {
          {
            (object) "type",
            (object) Consts.GetInstance().GEAR_0052_SELL
          }
        }), Consts.Format(Consts.GetInstance().POPUP_005_FAVORITE_WARNING_MESSAGE, (IDictionary) new Hashtable()
        {
          {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CRepairPopup\u003Ec__Iterator389()
    {
      act = act,
      kind = kind,
      latch = latch,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CCreateItemIconRange\u003Ec__Iterator38A()
    {
      value = value,
      \u003C\u0024\u003Evalue = value,
      \u003C\u003Ef__this = this
  ...
  protected virtual void SetTitle()
  {
    ...
    switch (this.mode)
    {
      case Bugu0052Scene.MODE.OVERVIEW:
        this.TxtTitle.SetText(Consts.Format(Consts.GetInstance().GEAR_0052_VIEW_TITLE));
      ...
      case Bugu0052Scene.MODE.COMPOSITE:
        this.TxtTitle.SetText(Consts.Format(Consts.GetInstance().GEAR_0052_COMPOSITE_TITLE));
      ...
      case Bugu0052Scene.MODE.PAKUPAKU_BASE:
        this.TxtTitle.text = Consts.Format(instance.GEAR_0052_PAKUPAKU_BASE_SELECT_TITLE);
      ...
      case Bugu0052Scene.MODE.PAKUPAKU_MATERIAL:
        this.TxtTitle.text = Consts.Format(instance.GEAR_0052_PAKUPAKU_MATERIAL_SELECT_TITLE);
        this.scrollPanel.bottomAnchor.absolute = 130;
        this.scrollBarWidget.topAnchor.absolute = -8;
        this.scrollBarWidget.bottomAnchor.absolute = 140;
        break;
      case Bugu0052Scene.MODE.REPAIR:
        this.TxtTitle.SetText(Consts.Format(Consts.GetInstance().GEAR_0052_REPAIR_TITLE));
        this.scrollPanel.bottomAnchor.absolute = 385;
        this.scrollBarWidget.topAnchor.absolute = -13;
        this.scrollBarWidget.bottomAnchor.absolute = 400;
        break;
      case Bugu0052Scene.MODE.SELL:
        this.TxtTitle.SetText(Consts.Format(Consts.GetInstance().GEAR_0052_SELL_TITLE));
        this.TxtZenyPattern3.SetText(Consts.GetInstance().GEAR_0052_SELL_LABEL);
      ...
      case Bugu0052Scene.MODE.DRILLING_BASE:
        this.TxtTitle.SetTextLocalize(instance.GEAR_0052_DRILLING_BASE_TITLE);
        this.scrollPanel.bottomAnchor.absolute = 0;
        this.scrollBarWidget.topAnchor.absolute = -8;
        this.scrollBarWidget.bottomAnchor.absolute = 0;
        this.SetPosessionText(num, this.player.max_items);
      ...
      case Bugu0052Scene.MODE.SPECIAL_DRILLING_MATERIAL:
        this.TxtTitle.SetText(instance.GEAR_0052_DRILLING_MATERIAL_TITLE);
        this.TxtZenyPattern3.SetTextLocalize(instance.GEAR_0052_DRILLING_MATERIAL_ZENY_LABEL);
        this.TxtProsession3.SetTextLocalize(instance.GEAR_0052_DRILLING_MATERIAL_PROSESSION_LABEL);
        this.scrollPanel.bottomAnchor.absolute = 99;
        this.scrollBarWidget.topAnchor.absolute = -13;
        this.scrollBarWidget.bottomAnchor.absolute = 140;
        ...
        break;
      default:
        Debug.LogError((object) "SELECT MODE ERROR");
        break;
    }
  }
  ...
  {
    this.NumProsession1.SetTextLocalize(Consts.Format(Consts.GetInstance().GEAR_0052_POSSESSION, (IDictionary) new Hashtable()
    {
      {
        (object) "now",
        (object) value
  ...
  public void GetItem(PlayerItem item, InventoryItem selectItem = null)
  {
    ...
    {
      if (item.supply != null || item.isExchangable())
      {
        this.StartCoroutine(this.CountSelectPopUp(selectItem));
      }
      else
      {
  ...
  public void GrayYesButton()
  {
    if (this.mode == Bugu0052Scene.MODE.COMPOSITE || this.mode == Bugu0052Scene.MODE.PAKUPAKU_MATERIAL)
    {
      if (this.cost < this.player.money && (this.ItemList.Count >= 2 && this.mode == Bugu0052Scene.MODE.COMPOSITE || this.ItemList.Count >= 1 && this.mode == Bugu0052Scene.MODE.PAKUPAKU_MATERIAL))
      {
        ...
        {
          this.CompositeYesButton.GetComponent<UISprite>().color = Color.white;
      ...
      {
        this.CompositeYesButton.GetComponent<UISprite>().color = Color.gray;
    ...
    {
      if (this.ItemList.Count != 0 || this.repair_mode != Bugu0052Menu.REPAIR_MODE.POWERED)
        ;
            ...
            if (item.Item.gear != null)
            {
              if (!item.Item.broken)
              {
                if (item.Item.isExchangable())
                  this.cost += item.Item.gear.sell_price * item.selectCount;
                else
  ...
  private IEnumerator NotEnoughMoneyPopUp()
  {
    ...
    Bugu0052Menu.\u003CNotEnoughMoneyPopUp\u003Ec__Iterator38B popUpCIterator38B = new Bugu0052Menu.\u003CNotEnoughMoneyPopUp\u003Ec__Iterator38B();
    return (IEnumerator) popUpCIterator38B;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CCountSelectPopUp\u003Ec__Iterator38C()
    {
      item = item,
      \u003C\u0024\u003Eitem = item,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CSellCheckPopUp\u003Ec__Iterator38D()
    {
      action = action,
      \u003C\u0024\u003Eaction = action
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CSellWarningPopUp\u003Ec__Iterator38E()
    {
      action = action,
      \u003C\u0024\u003Eaction = action
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CSellResultPopUp\u003Ec__Iterator38F()
    {
  ...
  public void SetSuppylCount(InventoryItem item, int count)
  {
    if (count != 0)
    {
      item.select = true;
      item.index = this.ItemList.Count<InventoryItem>() + 1;
    }
    else
    {
      item.select = false;
      item.index = 0;
      this.allItemIcon.Where<ItemIcon>((Func<ItemIcon, bool>) (x => x.PlayerItem == item.Item)).ForEach<ItemIcon>((Action<ItemIcon>) (x => x.SelectQuantity = false));
    }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CSellAPI\u003Ec__Iterator390()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CRepairAPI\u003Ec__Iterator391()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CRepairPoweredAPI\u003Ec__Iterator392()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CCreateItemIcon\u003Ec__Iterator393()
    {
  ...
  private void CreateItemIconSharing(int info_index, int item_index)
  {
    ...
    if (inventoryItem.Item.entity_type == MasterDataTable.CommonRewardType.supply || inventoryItem.Item.isExchangable())
    {
      itemIcon.QuantitySupply = true;
      itemIcon.EnableQuantity(inventoryItem.quantity);
    }
    else
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Bugu0052Menu.\u003CLoadObject\u003Ec__Iterator394()
    {
      \u003C\u003Ef__this = this
    };
  }
