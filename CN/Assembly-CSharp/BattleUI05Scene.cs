...
public class BattleUI05Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(GameCore.BattleInfo info, bool isWin, BattleEnd result)
  {
    ...
    return (IEnumerator) new BattleUI05Scene.\u003ConStartSceneAsync\u003Ec__Iterator8D5()
    {
      info = info,
      result = result,
      isWin = isWin,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05Scene.\u003CsetBackGround\u003Ec__Iterator8D6()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05Scene.\u003CInitMenus\u003Ec__Iterator8D7()
    {
      info = info,
      result = result,
      \u003C\u0024\u003Einfo = info,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05Scene.\u003CRunMenus\u003Ec__Iterator8D8()
    {
      info = info,
      isWin = isWin,
      result = result,
