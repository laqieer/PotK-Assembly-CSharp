...
public class Quest00210Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitSupplyEdit(List<SupplyItem> SupplyItems, bool fromEarth)
  {
    ...
    return (IEnumerator) new Quest00210Menu.\u003CInitSupplyEdit\u003Ec__Iterator1AD()
    {
      fromEarth = fromEarth,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00210Menu.\u003CupdateSupplyDeckAsync\u003Ec__Iterator1AE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00210Menu.\u003CRenderIcons\u003Ec__Iterator1AF()
    {
      \u003C\u003Ef__this = this
    };
  }
