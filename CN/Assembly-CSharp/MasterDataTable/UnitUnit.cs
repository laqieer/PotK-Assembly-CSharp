...
namespace MasterDataTable
{
  ...
  public class UnitUnit
  {
    ...
    public IEnumerator SetLargeSprite(GameObject go, int depth = 1000)
    {
      ...
      return (IEnumerator) new UnitUnit.\u003CSetLargeSprite\u003Ec__Iterator36()
      {
        go = go,
        depth = depth,
        \u003C\u0024\u003Ego = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetLargeSpriteSnap\u003Ec__Iterator37()
      {
        go = go,
        depth = depth,
        \u003C\u0024\u003Ego = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetLargeSpriteWithMask\u003Ec__Iterator38()
      {
        go = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetMediumSpriteSnap\u003Ec__Iterator39()
      {
        go = go,
        depth = depth,
        \u003C\u0024\u003Ego = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetMediumSpriteWithMask\u003Ec__Iterator3A()
      {
        go = go,
        maskFuture = maskFuture,
        depth = depth,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CLoadQuestWithMask\u003Ec__Iterator3B()
      {
        parent = parent,
        maskFuture = maskFuture,
        depth = depth,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CLoadShopContentWithMask\u003Ec__Iterator3C()
      {
        parent = parent,
        maskFuture = maskFuture,
        depth = depth,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CLoadShopContentUnitOtherWithMask\u003Ec__Iterator3D()
      {
        parent = parent,
        maskFuture = maskFuture,
        depth = depth,
