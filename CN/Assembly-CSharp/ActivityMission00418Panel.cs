...
public class ActivityMission00418Panel : MonoBehaviour
{
    ...
    BackButtonMenuBase baseMenu)
  {
    ...
    return (IEnumerator) new ActivityMission00418Panel.\u003CInit\u003Ec__Iterator2A3()
    {
      baseMenu = baseMenu,
      pdm = pdm,
      \u003C\u0024\u003EbaseMenu = baseMenu,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Panel.\u003CreceiveReward\u003Ec__Iterator2A4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public class RewardViewModel
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new ActivityMission00418Panel.RewardViewModel.\u003CLoadThumb\u003Ec__Iterator2A5()
      {
        go = go,
        parentGo = parentGo,
        \u003C\u0024\u003Ego = go,
