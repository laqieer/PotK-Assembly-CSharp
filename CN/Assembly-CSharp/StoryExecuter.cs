...
public class StoryExecuter : MonoBehaviour
{
  ...
  public IEnumerator initialize(string text)
  {
    ...
    return (IEnumerator) new StoryExecuter.\u003Cinitialize\u003Ec__Iterator51B()
    {
      text = text,
      \u003C\u0024\u003Etext = text,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CDeleteObject\u003Ec__Iterator51C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CtypewriterEffect\u003Ec__Iterator51D()
    {
      text = text,
  ...
  private int getBoxName(string name)
  {
    ...
    if (key != null)
    {
      ...
      if (StoryExecuter.\u003C\u003Ef__switch\u0024map16 == null)
      {
        // ISSUE: reference to a compiler-generated field
        StoryExecuter.\u003C\u003Ef__switch\u0024map16 = new Dictionary<string, int>(3)
        {
          {
            "normal",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (StoryExecuter.\u003C\u003Ef__switch\u0024map16.TryGetValue(key, out num))
      {
        switch (num)
        {
          case 0:
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CInitBackGround\u003Ec__Iterator51E()
    {
      s = s,
      \u003C\u0024\u003Es = s,
      \u003C\u003Ef__this = this
  ...
  public object setTextBottomWindow(string s)
  {
    ...
    else
    {
      ...
      this.myselfTextBoxContainer.SetActive(false);
      this.textBottomFlame[boxName].GetComponent<UISprite>();
  ...
  private string TranslateColor(string color)
  {
    ...
    {
      // ISSUE: reference to a compiler-generated field
      if (StoryExecuter.\u003C\u003Ef__switch\u0024map17 == null)
      {
        // ISSUE: reference to a compiler-generated field
        StoryExecuter.\u003C\u003Ef__switch\u0024map17 = new Dictionary<string, int>(8)
        {
          {
            "black",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (StoryExecuter.\u003C\u003Ef__switch\u0024map17.TryGetValue(key, out num))
      {
        switch (num)
        {
          case 0:
  ...
  public void SetTextAlgin(TextBlock.Position pos, string align)
  {
    ...
    if (key != null)
    {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        StoryExecuter.\u003C\u003Ef__switch\u0024map18 = new Dictionary<string, int>(5)
        {
          {
            "center",
            0
...
label_11:
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CdelayStopSe\u003Ec__Iterator51F()
    {
      delay = delay,
      ch = ch,
      \u003C\u0024\u003Edelay = delay,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CShowStoryEffect\u003Ec__Iterator520()
    {
      label = label,
      \u003C\u0024\u003Elabel = label
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new StoryExecuter.\u003CexecCoroutine\u003Ec__Iterator521()
    {
      e = e,
      \u003C\u0024\u003Ee = e,
      \u003C\u003Ef__this = this
