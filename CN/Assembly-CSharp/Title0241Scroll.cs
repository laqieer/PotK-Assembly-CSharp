...
public class Title0241Scroll : MonoBehaviour
{
    ...
    BackButtonMenuBase baseMenu)
  {
    ...
    return (IEnumerator) new Title0241Scroll.\u003CInit\u003Ec__Iterator5F0()
    {
      id = id,
      rarity = rarity,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Title0241Scroll.\u003COpenTitleSetPopup\u003Ec__Iterator5F1()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Title0241Scroll.\u003CCreateSprite\u003Ec__Iterator5F2()
    {
      \u003C\u003Ef__this = this
    };
  }
