...
public class Guild0286Scroll : BackButtonMenuBase
{
  ...
  public IEnumerator Init(GuildMemberGift[] gifts, Action<GuildMemberGift> action)
  {
    ...
    return (IEnumerator) new Guild0286Scroll.\u003CInit\u003Ec__Iterator6FD()
    {
      action = action,
      gifts = gifts,
      \u003C\u0024\u003Eaction = action,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Scroll.\u003CUpdateList\u003Ec__Iterator6FE()
    {
      gifts = gifts,
      \u003C\u0024\u003Egifts = gifts,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Scroll.\u003CCreateScrollBase\u003Ec__Iterator6FF()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0286Scroll.\u003CCreateScroll\u003Ec__Iterator700()
    {
