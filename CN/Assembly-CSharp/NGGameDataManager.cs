...
public class NGGameDataManager : Singleton<NGGameDataManager>
{
  ...
  private List<int> gachaTicketIDList;
  ...
  public IEnumerator LoadOtherBattleAtlas()
  {
    ...
    return (IEnumerator) new NGGameDataManager.\u003CLoadOtherBattleAtlas\u003Ec__IteratorA6D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CUnLoadOtherBattleAtlas\u003Ec__IteratorA6E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CGetWebImage\u003Ec__IteratorA6F()
    {
      url = url,
      sprite = sprite,
      \u003C\u0024\u003Eurl = url,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CLoadWebImage\u003Ec__IteratorA70()
    {
      url = url,
      \u003C\u0024\u003Eurl = url,
      \u003C\u003Ef__this = this
  ...
  private IEnumerator SaveUserInfo()
  {
    ...
    NGGameDataManager.\u003CSaveUserInfo\u003Ec__IteratorA71 infoCIteratorA71 = new NGGameDataManager.\u003CSaveUserInfo\u003Ec__IteratorA71();
    return (IEnumerator) infoCIteratorA71;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CStartSceneAsyncProxyImpl\u003Ec__IteratorA72()
    {
      promise = promise,
      \u003C\u0024\u003Epromise = promise,
      \u003C\u003Ef__this = this
    ...
    else if (WebAPI.LastPlayerBoot.player_during_battle)
    {
      ...
      if (this.isCallHomeUpdateAllData)
        WebAPI.HomeStartUp2().RunOn<WebAPI.Response.HomeStartUp2>((MonoBehaviour) this, (Action<WebAPI.Response.HomeStartUp2>) (_ =>
        {
          ...
          Singleton<NGBattleManager>.GetInstance().startBattle((GameCore.BattleInfo) null);
  ...
  {
    if (this.gachaTicketIDList == null)
    {
      this.gachaTicketIDList = ((IEnumerable<PlayerGachaTicket>) this.player.Value.gacha_tickets).Select<PlayerGachaTicket, int>((Func<PlayerGachaTicket, int>) (x => x.ticket_id)).ToList<int>();
      this.gachaTicketList = this.player.Value.gacha_tickets;
      return true;
    }
    if (((IEnumerable<PlayerGachaTicket>) this.player.Value.gacha_tickets).Any<PlayerGachaTicket>((Func<PlayerGachaTicket, bool>) (x => !this.gachaTicketIDList.Contains(x.ticket_id))))
    {
      this.gachaTicketIDList = ((IEnumerable<PlayerGachaTicket>) this.player.Value.gacha_tickets).Select<PlayerGachaTicket, int>((Func<PlayerGachaTicket, int>) (x => x.ticket_id)).ToList<int>();
      return true;
    }
