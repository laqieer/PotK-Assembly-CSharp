...
public class GachaPlay : MonoBehaviour
{
    ...
    int payment_amount)
  {
    ...
    return (IEnumerator) new GachaPlay.\u003CChargeGacha\u003Ec__Iterator404()
    {
      num = num,
      name = name,
      gacha_id = gacha_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GachaPlay.\u003CChargeGachaMulti\u003Ec__Iterator405()
    {
      gacha_type = gacha_type,
      name = name,
      gacha_id = gacha_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GachaPlay.\u003CFriendGacha\u003Ec__Iterator406()
    {
      name = name,
      num = num,
      gacha_id = gacha_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GachaPlay.\u003CTicketGacha\u003Ec__Iterator407()
    {
      num = num,
      gacha_id = gacha_id,
      payment_amount = payment_amount,
