...
public class Quest0022Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    return (IEnumerator) new Quest0022Scene.\u003ConStartSceneAsync\u003Ec__Iterator22E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0022Scene.\u003ConStartSceneAsync\u003Ec__Iterator22F()
    {
      L = L,
      M = M,
      \u003C\u0024\u003EL = L,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0022Scene.\u003ConStartSceneAsync\u003Ec__Iterator230()
    {
      L = L,
      M = M,
      S = S,
  ...
  private IEnumerator ClearPopup()
  {
    ...
    Quest0022Scene.\u003CClearPopup\u003Ec__Iterator231 popupCIterator231 = new Quest0022Scene.\u003CClearPopup\u003Ec__Iterator231();
    return (IEnumerator) popupCIterator231;
  }
  ...
  private IEnumerator ReviewPopup()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    Quest0022Scene.\u003CReviewPopup\u003Ec__Iterator232 popupCIterator232 = new Quest0022Scene.\u003CReviewPopup\u003Ec__Iterator232();
    return (IEnumerator) popupCIterator232;
  }
