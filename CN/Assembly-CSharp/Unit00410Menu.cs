...
public class Unit00410Menu : UnitSelectMenuBase
{
  ...
  private readonly int[] sellUnitBaseMedal = new int[7]
  {
    0,
    0,
    3,
    ...
    bool isEquip)
  {
    ...
    return (IEnumerator) new Unit00410Menu.\u003CInit\u003Ec__Iterator2FD()
    {
  ...
  public override void UpdateInfomation()
  {
    ...
    {
      this.ibtnEnter.GetComponent<UISprite>().color = Color.white;
      ((Collider) this.ibtnEnter.GetComponent<BoxCollider>()).enabled = true;
    }
    else
    {
      this.ibtnEnter.GetComponent<UISprite>().color = Color.gray;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00410Menu.\u003CIbtnYesAsync\u003Ec__Iterator2FE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00410Menu.\u003COpenPopup\u003Ec__Iterator2FF()
    {
