...
public class BattleUI55Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(GameCore.BattleInfo info, bool isWin, BattleEnd result)
  {
    ...
    return (IEnumerator) new BattleUI55Scene.\u003ConStartSceneAsync\u003Ec__Iterator8EC()
    {
      info = info,
      isWin = isWin,
      result = result,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI55Scene.\u003CsetBackGround\u003Ec__Iterator8ED()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI55Scene.\u003CInitMenus\u003Ec__Iterator8EE()
    {
      info = info,
      result = result,
      \u003C\u0024\u003Einfo = info,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI55Scene.\u003CRunMenus\u003Ec__Iterator8EF()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
