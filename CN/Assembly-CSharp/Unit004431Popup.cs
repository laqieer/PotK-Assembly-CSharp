...
public class Unit004431Popup : BackButtonMenuBase
{
  ...
  private IEnumerator createPopup()
  {
    ...
    return (IEnumerator) new Unit004431Popup.\u003CcreatePopup\u003Ec__Iterator30A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004431Popup.\u003CSelectIcon\u003Ec__Iterator30B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004431Popup.\u003CSetSprite\u003Ec__Iterator30C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit004431Popup.\u003CStatusPopup\u003Ec__Iterator30D()
    {
      \u003C\u003Ef__this = this
    };
  }
