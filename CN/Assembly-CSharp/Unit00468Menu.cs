...
public class Unit00468Menu : UnitSelectMenuBase
{
  ...
  private IEnumerator CreateBottomInformationObject()
  {
    ...
    return (IEnumerator) new Unit00468Menu.\u003CCreateBottomInformationObject\u003Ec__Iterator30E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CSetSelectUnit\u003Ec__Iterator30F()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CDisplaySelectUnit\u003Ec__Iterator310()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CInit\u003Ec__Iterator311()
    {
      playerDeck = playerDeck,
      max_cost = max_cost,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CDeckEditAsync\u003Ec__Iterator312()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CDeckEditApi\u003Ec__Iterator313()
    {
