...
public class BattleUI05NowTotalScorePopupMenu : ResultMenuBase
{
  ...
  public override IEnumerator Init(GameCore.BattleInfo info, BattleEnd result)
  {
    ...
    return (IEnumerator) new BattleUI05NowTotalScorePopupMenu.\u003CInit\u003Ec__Iterator8A7()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05NowTotalScorePopupMenu.\u003CLoadResources\u003Ec__Iterator8A8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05NowTotalScorePopupMenu.\u003CRun\u003Ec__Iterator8A9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05NowTotalScorePopupMenu.\u003COnFinish\u003Ec__Iterator8AA()
    {
      \u003C\u003Ef__this = this
    };
  }
