...
public class HenshinContainer : MonoBehaviour
{
  ...
  public bool updateHenshin()
  {
    ...
    else if ((double) this.wait_ <= (double) Time.time)
    {
      ...
      this.initHenshin(this.schedule_.Length <= this.indexSchedule_ ? (HenshinContainer.Schedule) null : this.schedule_[this.indexSchedule_]);
    }
  ...
  {
    public float life_;
    public HenshinContainer.UnitSetting always_;
    public HenshinContainer.UnitSetting before_;
    public HenshinContainer.UnitSetting after_;
    public bool isGoto_;
