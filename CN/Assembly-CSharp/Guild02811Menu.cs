...
public class Guild02811Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    return (IEnumerator) new Guild02811Menu.\u003CInitializeAsync\u003Ec__Iterator6A4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void CheckStatus()
  {
    ...
    {
      case GuildMembershipStatus.not_exist:
        if (!SM.GuildSignal.Current.existPlayershipEventType(GuildEventType.cancel_applicant))
          break;
        Debug.LogWarning((object) "承認が拒否られたを出す？");
        break;
      ...
      case GuildMembershipStatus.membership:
        this.buildObjButton.isEnabled = false;
        if (!SM.GuildSignal.Current.existPlayershipEventType(GuildEventType.apply_applicant))
          break;
        Debug.LogWarning((object) "承認が下りましたを出す");
        if (!Object.op_Equality((Object) this.nowPopup, (Object) null))
          break;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02811Menu.\u003CResourceLoad\u003Ec__Iterator6A5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02811Menu.\u003CSearchGuild\u003Ec__Iterator6A6()
    {
      callback = callback,
      \u003C\u0024\u003Ecallback = callback,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02811Menu.\u003CSearchBestGuild\u003Ec__Iterator6A7()
    {
      callback = callback,
      \u003C\u0024\u003Ecallback = callback,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02811Menu.\u003CFriendList\u003Ec__Iterator6A8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02811Menu.\u003CGuildListUpdate\u003Ec__Iterator6A9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator UpdateHelpers()
  {
    ...
    Guild02811Menu.\u003CUpdateHelpers\u003Ec__Iterator6AA helpersCIterator6Aa = new Guild02811Menu.\u003CUpdateHelpers\u003Ec__Iterator6AA();
    return (IEnumerator) helpersCIterator6Aa;
  }
