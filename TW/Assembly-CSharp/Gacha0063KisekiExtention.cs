...
public class Gacha0063KisekiExtention : MonoBehaviour
{
  ...
  private void SetKisekiSprite(int amount)
  {
    ...
    this.singleGachaSingleDigit.gameObject.SetActive(!flag);
    this.singleGachaDoubleDigit.gameObject.SetActive(flag);
    if (flag)
    {
      ...
      this.ChangeSprite(this.singleGachaDoubleDigitKiseki, "slc_hime_num" + (amount / 10).ToString() + ".png__GUI__006-3_sozai__006-3_sozai_prefab");
      this.ChangeSprite(this.singleGachaSingleDigitKiseki, "slc_hime_num" + (amount % 10).ToString() + ".png__GUI__006-3_sozai__006-3_sozai_prefab");
    }
    else
    {
  ...
  private IEnumerator OpenDetailPopup(GachaModule module, GameObject detailPopup)
  {
    ...
    return (IEnumerator) new Gacha0063KisekiExtention.\u003COpenDetailPopup\u003Ec__Iterator43F()
    {
      module = module,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063KisekiExtention.\u003CInitDetail\u003Ec__Iterator440()
    {
      module = module,
      menu = menu,
      detailPopup = detailPopup,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063KisekiExtention.\u003CShowProgressSheet\u003Ec__Iterator441()
    {
      \u003C\u003Ef__this = this
    };
  }
