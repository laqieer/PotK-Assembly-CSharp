...
public class Popup002HuntingNextRewardReceiveMenu : BackButtonMenuBase
{
    ...
    bool isGuild)
  {
    ...
    return (IEnumerator) new Popup002HuntingNextRewardReceiveMenu.\u003CInit\u003Ec__Iterator9F8()
    {
      periodID = periodID,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup002HuntingNextRewardReceiveMenu.\u003CStartScroll\u003Ec__Iterator9F9()
    {
      \u003C\u003Ef__this = this
    };
  }
