...
public class BattleUI05RankingMenu : ResultMenuBase
{
  ...
  public override IEnumerator Init(GameCore.BattleInfo info, BattleEnd result)
  {
    ...
    return (IEnumerator) new BattleUI05RankingMenu.\u003CInit\u003Ec__Iterator98D()
    {
      result = result,
      info = info,
      \u003C\u0024\u003Eresult = result,
  ...
  private void InitStagePoint(QuestScoreAcquisition[] scores, string specialRate)
  {
    for (int index = 0; index < scores.Length && this.obj_PtBreakDown.Length >= index; ++index)
    ...
    if (this.obj_PtBreakDown.Length < scores.Length - 1)
      return;
    this.breakDownPrefab.Clone(this.obj_PtBreakDown[scores.Length].transform).GetComponent<BattleUI05BreakDown>().SetSpecialRate(specialRate);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RankingMenu.\u003CLoadResources\u003Ec__Iterator98E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RankingMenu.\u003CRun\u003Ec__Iterator98F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05RankingMenu.\u003CWaitForTapping\u003Ec__Iterator990()
    {
      \u003C\u003Ef__this = this
    };
  }
