...
public class Colosseum0234Status : MonoBehaviour
{
    ...
    RankingPlayer myRanking)
  {
    ...
    return (IEnumerator) new Colosseum0234Status.\u003CInitialize\u003Ec__Iterator5E8()
    {
  ...
  public virtual void IbtnRank()
  {
    ...
    {
      Debug.LogWarning((object) "colosseumInfoかColosseum0234Menu未设定");
    }
    else
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum0234Status.\u003CLoadRewardObject\u003Ec__Iterator5E9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum0234Status.\u003CSetRewardItem\u003Ec__Iterator5EA()
    {
