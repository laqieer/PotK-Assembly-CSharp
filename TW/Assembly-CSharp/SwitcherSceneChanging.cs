...
public class SwitcherSceneChanging : MonoBehaviour
{
  ...
  private void Update()
  {
    bool flag1 = !Singleton<NGSceneManager>.GetInstance().isSceneInitialized | Singleton<PopupManager>.GetInstance().isOpen | Singleton<CommonRoot>.GetInstance().isLoading;
