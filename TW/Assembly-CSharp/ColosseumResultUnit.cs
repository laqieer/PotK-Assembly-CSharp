...
public class ColosseumResultUnit : MonoBehaviour
{
  ...
  public IEnumerator OnUnitLevelup(GameObject obj, int count)
  {
    ...
    return (IEnumerator) new ColosseumResultUnit.\u003COnUnitLevelup\u003Ec__Iterator622()
    {
      count = count,
      \u003C\u0024\u003Ecount = count,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumResultUnit.\u003CInit\u003Ec__Iterator623()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumResultUnit.\u003CLoadUnitPrefab\u003Ec__Iterator624()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ColosseumResultUnit.\u003CLoadGearPrefab\u003Ec__Iterator625()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
