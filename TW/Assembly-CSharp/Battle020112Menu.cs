...
public class Battle020112Menu : NGMenuBase
{
  ...
  public IEnumerator Init(QuestCharacterS quest)
  {
    ...
    return (IEnumerator) new Battle020112Menu.\u003CInit\u003Ec__Iterator8F7()
    {
      quest = quest,
      \u003C\u0024\u003Equest = quest,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle020112Menu.\u003CSetUnitPrefab\u003Ec__Iterator8F8()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle020112Menu.\u003CSetUnitPrefab\u003Ec__Iterator8F9()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
