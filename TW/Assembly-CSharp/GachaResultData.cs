...
public class GachaResultData : MonoBehaviour
{
  ...
  public void ChangeSceneOneShot()
  {
    ...
    commonRewardType.ThenMaterialUnit((Action<PlayerMaterialUnit>) (unit => this.ChangeSceneMaterialUnit(unit, is_new)));
    commonRewardType.ThenGear((Action<PlayerItem>) (gear => this.ChangeSceneGear(gear, is_new)));
    commonRewardType.ThenMaterialGear((Action<PlayerMaterialGear>) (materialGear => this.ChangeSceneMaterialGear(materialGear, is_new)));
  }
  ...
  private void ChangeSceneMaterialUnit(PlayerMaterialUnit PU, bool is_new)
  {
    Singleton<NGSceneManager>.GetInstance().changeScene("gacha006_effect", true);
  }
  ...
  private void ChangeSceneMaterialGear(PlayerMaterialGear PI, bool is_new)
  {
    Singleton<NGSceneManager>.GetInstance().changeScene("gacha006_effect", true);
  }
  ...
  public void SetData(WebAPI.Response.UnitticketSpend data)
  {
    this.resultData = (GachaResultData.ResultData) null;
    this.resultData = new GachaResultData.ResultData();
  ...
  public IEnumerator CharacterStoryPopup()
  {
    ...
    return (IEnumerator) new GachaResultData.\u003CCharacterStoryPopup\u003Ec__Iterator450()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GachaResultData.\u003CSheetGachaResultPopup\u003Ec__Iterator451()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GachaResultData.\u003CStartSheetEffect\u003Ec__Iterator452()
    {
      \u003C\u003Ef__this = this
    };
  }
