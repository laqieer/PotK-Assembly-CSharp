...
public class Guild0287Menu : GuildBankDonateListBase
{
  ...
  private IEnumerator ResourceLoad()
  {
    ...
    return (IEnumerator) new Guild0287Menu.\u003CResourceLoad\u003Ec__Iterator7CE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void SetRateButtonColor()
  {
    for (int index = 0; index < this.rateBtns.Count; ++index)
    {
      if (this.rateBtns[index].btn.isEnabled)
      {
        Color color = this.currentScale != this.rateBtns[index].Scale ? Color.gray : Color.white;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0287Menu.\u003CExecuteDonation\u003Ec__Iterator7CF()
    {
      moneyRate = moneyRate,
      \u003C\u0024\u003EmoneyRate = moneyRate,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0287Menu.\u003CStartAnimation\u003Ec__Iterator7D0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0287Menu.\u003CshowLevelupAnim\u003Ec__Iterator7D1()
    {
      level = level,
      guildBase = guildBase,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0287Menu.\u003CCreateScroll\u003Ec__Iterator7D2()
    {
      bar_index = bar_index,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0287Menu.\u003CInitDonateScroll\u003Ec__Iterator7D3()
    {
      tokens = tokens,
      \u003C\u0024\u003Etokens = tokens,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0287Menu.\u003CInitializeAsync\u003Ec__Iterator7D4()
    {
      \u003C\u003Ef__this = this
    };
  }
