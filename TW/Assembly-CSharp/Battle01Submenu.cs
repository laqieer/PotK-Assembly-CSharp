...
public class Battle01Submenu : BattleBackButtonMenuBase
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    return (IEnumerator) new Battle01Submenu.\u003CStart_Battle\u003Ec__Iterator92F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void UpdateButtonSkip()
  {
    ...
    if (!SMManager.Get<Player>().IsSkipDuel())
    {
      ...
      if (Object.op_Inequality((Object) this.txtLvSkipDuel, (Object) null))
      {
        ...
        this.txtLvSkipDuel.text = "Lv." + (object) skipDuelOpenLevel;
      }
    }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01Submenu.\u003CpushCancel\u003Ec__Iterator930()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01Submenu.\u003CAutoBattleStartPop\u003Ec__Iterator931()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01Submenu.\u003CTurnEndPop\u003Ec__Iterator932()
    {
      \u003C\u003Ef__this = this
    };
  }
