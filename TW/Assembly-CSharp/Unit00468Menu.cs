...
public class Unit00468Menu : UnitSelectMenuBase
{
  ...
  protected IEnumerator CreateBottomInformationObject()
  {
    ...
    return (IEnumerator) new Unit00468Menu.\u003CCreateBottomInformationObject\u003Ec__Iterator34C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CSetSelectUnit\u003Ec__Iterator34D()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CDisplaySelectUnit\u003Ec__Iterator34E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CInit\u003Ec__Iterator34F()
    {
      playerDeck = playerDeck,
      max_cost = max_cost,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CDeckEditAsync\u003Ec__Iterator350()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit00468Menu.\u003CDeckEditApi\u003Ec__Iterator351()
    {
