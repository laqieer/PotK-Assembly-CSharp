...
public class AnimationItemIcon : MonoBehaviour
{
  ...
  {
    if (!this.itemInfo.gear.kind.isEquip)
    {
  ...
  public void Set(ItemInfo itemInfo, bool is_new = false)
  {
    ...
    if (itemInfo.gear != null)
      this.back_.sprite = !itemInfo.gear.hasSpecificationOfEquipmentUnits ? this.backSprite[itemInfo.gear.customize_flag] : this.backSpriteSpecificationOfEquipmentUnits[itemInfo.gear.customize_flag];
