...
namespace MasterDataTable
{
  ...
  public class UnitUnit
  {
    ...
    {
      return this.cutin_pattern_id.HasValue ? Singleton<ResourceManager>.GetInstance().Load<Sprite>(string.Format("AssetBundle/Resources/Characters/{0}/battle_cutin_{1}", (object) this.character.ID, (object) this.cutin_pattern_id.Value)) : Singleton<ResourceManager>.GetInstance().Load<Sprite>(string.Format("AssetBundle/Resources/Characters/{0}/battle_cutin", (object) this.character.ID));
    }

    public Future<Sprite> LoadSpriteMedium()
    {
      return Singleton<ResourceManager>.GetInstance().Load<Sprite>(string.Format("Units/{0}/2D/c_400x400", (object) this.resource_reference_unit_id.ID));
    }
    ...
    {
      return Singleton<ResourceManager>.GetInstance().Load<Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_pickup", (object) this.resource_reference_unit_id.ID));
    }
    ...
    {
      return Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("Units/{0}/3D/duel/prefab", (object) this.resource_reference_unit_id.ID));
    }

    public Future<GameObject> LoadModelField()
    {
      return Singleton<ResourceManager>.GetInstance().Load<GameObject>(string.Format("Units/{0}/3D/field/prefab", (object) this.resource_reference_unit_id.ID));
    }
    ...
    {
      return Singleton<ResourceManager>.GetInstance().Load<Sprite>(string.Format("AssetBundle/Resources/Units/{0}/2D/unit_full", (object) this.resource_reference_unit_id.ID));
    }
    ...
    {
      if (string.IsNullOrEmpty(this.field_gray_body_material_name))
        return Future.Single<Material>((Material) null);
      string path = string.Format("Units/{0}/3D/field/{1}", (object) this.resource_reference_unit_id.ID, (object) this.field_gray_body_material_name);
      return Singleton<ResourceManager>.GetInstance().Load<Material>(path);
    }

    public Future<Material> LoadFieldGrayFaceMaterial()
    {
      if (string.IsNullOrEmpty(this.field_gray_face_material_name))
        return Future.Single<Material>((Material) null);
      string path = string.Format("Units/Shared/{0}", (object) this.field_gray_face_material_name);
      return Singleton<ResourceManager>.GetInstance().Load<Material>(path);
    }
    ...
    public Future<Material> LoadFieldGrayVehicleMaterial()
    {
      if (string.IsNullOrEmpty(this.vehicle_model_name))
        return Future.Single<Material>((Material) null);
      if (string.IsNullOrEmpty(this.field_gray_vehicle_material_name))
        return Future.Single<Material>((Material) null);
      string path = string.Format("UnitVehicle/{0}/3D/field/{1}", (object) this.vehicle_model_name, (object) this.field_gray_vehicle_material_name);
      return Singleton<ResourceManager>.GetInstance().Load<Material>(path);
    }
    ...
    public Future<Material> LoadFieldGrayEquipMaterial()
    {
      if (string.IsNullOrEmpty(this.equip_model_name))
        return Future.Single<Material>((Material) null);
      if (string.IsNullOrEmpty(this.field_gray_equip_material_name))
        return Future.Single<Material>((Material) null);
      string path = string.Format("UnitEquips/{0}/3D/field/{1}", (object) this.equip_model_name, (object) this.field_gray_equip_material_name);
      return Singleton<ResourceManager>.GetInstance().Load<Material>(path);
    }
    ...
    public Future<Material> LoadFieldGrayEquipBMaterial()
    {
      if (string.IsNullOrEmpty(this.equip_model_b_name))
        return Future.Single<Material>((Material) null);
      if (string.IsNullOrEmpty(this.field_gray_equip_b_material_name))
        return Future.Single<Material>((Material) null);
      string path = string.Format("UnitEquips_b/{0}/3D/field/{1}", (object) this.equip_model_b_name, (object) this.field_gray_equip_b_material_name);
      return Singleton<ResourceManager>.GetInstance().Load<Material>(path);
    }
    ...
    public IEnumerator SetLargeSprite(GameObject go, int depth = 1000)
    {
      ...
      return (IEnumerator) new UnitUnit.\u003CSetLargeSprite\u003Ec__Iterator3A()
      {
        go = go,
        depth = depth,
        \u003C\u0024\u003Ego = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetLargeSpriteSnap\u003Ec__Iterator3B()
      {
        go = go,
        depth = depth,
        \u003C\u0024\u003Ego = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetLargeSpriteWithMask\u003Ec__Iterator3C()
      {
        go = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetMediumSpriteSnap\u003Ec__Iterator3D()
      {
        go = go,
        depth = depth,
        \u003C\u0024\u003Ego = go,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CSetMediumSpriteWithMask\u003Ec__Iterator3E()
      {
        go = go,
        maskFuture = maskFuture,
        depth = depth,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CLoadQuestWithMask\u003Ec__Iterator3F()
      {
        parent = parent,
        maskFuture = maskFuture,
        depth = depth,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CLoadShopContentWithMask\u003Ec__Iterator40()
      {
        parent = parent,
        maskFuture = maskFuture,
        depth = depth,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new UnitUnit.\u003CLoadShopContentUnitOtherWithMask\u003Ec__Iterator41()
      {
        parent = parent,
        maskFuture = maskFuture,
        depth = depth,
    ...
    {
      return Singleton<ResourceManager>.GetInstance().Load<RuntimeAnimatorController>(string.Format(UnitUnit.duelAnimatorRootPath, (object) this.duelAnimatorControllerName));
    }
    ...
    {
      return Singleton<ResourceManager>.GetInstance().Load<RuntimeAnimatorController>(string.Format(UnitUnit.winAnimatorRootPath, (object) this.winAnimatorControllerName));
    }
