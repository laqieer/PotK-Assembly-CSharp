...
public class BattlePrepareCharacterInfoBase : NGBattleMenuBase
{
  ...
  public virtual IEnumerator Init(BL.UnitPosition up, AttackStatus[] attacks_)
  {
    ...
    return (IEnumerator) new BattlePrepareCharacterInfoBase.\u003CInit\u003Ec__Iterator95B()
    {
      up = up,
      attacks_ = attacks_,
      \u003C\u0024\u003Eup = up,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattlePrepareCharacterInfoBase.\u003CSetElementalIcon\u003Ec__Iterator95C()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  public void setCurrentAttack(AttackStatus attackStatus)
  {
    ...
    else
    {
      ...
      if ((double) this.currentAttack.elementAttackRate > 1.0)
        ...
        format = "[ff0000]{0}[-]";
      this.TxtAttack.SetTextLocalize(format.F((object) Mathf.Max(Mathf.FloorToInt((float) this.currentAttack.attack * this.currentAttack.elementAttackRate), 1)));
