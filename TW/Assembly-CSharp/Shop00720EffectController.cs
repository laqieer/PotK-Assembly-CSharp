...
public class Shop00720EffectController : EffectController
{
    ...
    WebAPI.Response.SlotS001MedalPayResult[] result_data)
  {
    ...
    return (IEnumerator) new Shop00720EffectController.\u003CRenpatu\u003Ec__Iterator497()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00720EffectController.\u003CSetTextureItemThum\u003Ec__Iterator498()
    {
      crt = crt,
      rootObj = rootObj,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00720EffectController.\u003CCutInInitialize\u003Ec__Iterator499()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
