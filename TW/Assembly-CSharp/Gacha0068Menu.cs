...
public class Gacha0068Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Set(PlayerUnit playerUnit, bool newFlag)
  {
    ...
    return (IEnumerator) new Gacha0068Menu.\u003CSet\u003Ec__Iterator453()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0068Menu.\u003CLateFitMask\u003Ec__Iterator454()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0068Menu.\u003CSetRarityStar\u003Ec__Iterator455()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0068Menu.\u003CSetWeaponIcon\u003Ec__Iterator456()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0068Menu.\u003CSetHimeIcon\u003Ec__Iterator457()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0068Menu.\u003CSetCharacterImage\u003Ec__Iterator458()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0068Menu.\u003CSetCharacterModel\u003Ec__Iterator459()
    {
      \u003C\u003Ef__this = this
    };
  }
