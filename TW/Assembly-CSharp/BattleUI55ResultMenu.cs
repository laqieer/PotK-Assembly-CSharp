...
public class BattleUI55ResultMenu : ResultMenuBase
{
  ...
  public override IEnumerator Init(GameCore.BattleInfo info, BattleEnd result)
  {
    ...
    return (IEnumerator) new BattleUI55ResultMenu.\u003CInit\u003Ec__Iterator9B4()
    {
      info = info,
      result = result,
      \u003C\u0024\u003Einfo = info,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI55ResultMenu.\u003CRun\u003Ec__Iterator9B5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI55ResultMenu.\u003COnFinish\u003Ec__Iterator9B6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI55ResultMenu.\u003CInitObjects\u003Ec__Iterator9B7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI55ResultMenu.\u003CShowUnitEXPForEarth\u003Ec__Iterator9B8()
    {
      \u003C\u003Ef__this = this
    };
  }
