...
public class Gacha00613Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Play(int num = 1, GachaModuleGacha gacha_data = null)
  {
    ...
    return (IEnumerator) new Gacha00613Menu.\u003CPlay\u003Ec__Iterator41D()
    {
      num = num,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha00613Menu.\u003ConEndSceneAsync\u003Ec__Iterator41E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha00613Menu.\u003CCreateGetListAsync\u003Ec__Iterator41F()
    {
