...
public class TreasureBoxManager : BattleManagerBase
{
  ...
  [DebuggerHidden]
  public override IEnumerator initialize(GameCore.BattleInfo info, BE env_ = null)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TreasureBoxManager.\u003Cinitialize\u003Ec__IteratorA68()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TreasureBoxManager.\u003Ccleanup\u003Ec__IteratorA69()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TreasureBoxManager.\u003CdoExecute\u003Ec__IteratorA6A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private class ExecuteSchedule : ScheduleEnumerator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TreasureBoxManager.ExecuteSchedule.\u003CdoBody\u003Ec__IteratorA6C()
      {
        \u003C\u003Ef__this = this
      };
    }
  ...
  private class Continuer
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new TreasureBoxManager.Continuer.\u003CdoEnd\u003Ec__IteratorA6D()
      {
        tm = tm,
        \u003C\u0024\u003Etm = tm,
        \u003C\u003Ef__this = this
