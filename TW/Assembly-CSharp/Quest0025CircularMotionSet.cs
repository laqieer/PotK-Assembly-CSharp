...
public class Quest0025CircularMotionSet : MonoBehaviour
{
  ...
  private IEnumerator ScrollSmooth(float nPosY)
  {
    ...
    return (IEnumerator) new Quest0025CircularMotionSet.\u003CScrollSmooth\u003Ec__Iterator2AE()
    {
      nPosY = nPosY,
      \u003C\u0024\u003EnPosY = nPosY,
      \u003C\u003Ef__this = this
  ...
  private IEnumerator setBackGroundPrefab()
  {
    ...
    Quest0025CircularMotionSet.\u003CsetBackGroundPrefab\u003Ec__Iterator2AF prefabCIterator2Af = new Quest0025CircularMotionSet.\u003CsetBackGroundPrefab\u003Ec__Iterator2AF();
    return (IEnumerator) prefabCIterator2Af;
  }
