...
public class Popup02349Menu : NGMenuBase
{
  ...
  public IEnumerator Init(PlayerHelper helper, int incr_friend_point)
  {
    ...
    return (IEnumerator) new Popup02349Menu.\u003CInit\u003Ec__IteratorA20()
    {
      helper = helper,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02349Menu.\u003CInit\u003Ec__IteratorA21()
    {
      gladiator = gladiator,
      \u003C\u0024\u003Egladiator = gladiator,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02349Menu.\u003CInit\u003Ec__IteratorA22()
    {
      unit = unit,
      level = level,
      playerID = playerID,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02349Menu.\u003CFriendApplyAsync\u003Ec__IteratorA23()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02349Menu.\u003CopenPopup00813\u003Ec__IteratorA24()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02349Menu.\u003CopenPopup00814\u003Ec__IteratorA25()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02349Menu.\u003CopenPopup00815\u003Ec__IteratorA26()
    {
      \u003C\u003Ef__this = this
    };
  }
