...
public class Shop0076Menu : BackButtonMenuBase
{
    ...
    Func<IEnumerator> onPurchased)
  {
    ...
    return (IEnumerator) new Shop0076Menu.\u003CInit\u003Ec__Iterator4F3()
    {
      player = player,
      playerShopArticle = playerShopArticle,
      shopArticle = shopArticle,
  ...
  public void onChangeInputQuantity(bool isInit = true)
  {
    ...
    if (hasValue1 || hasValue2)
    {
      if (hasValue1 && hasValue2)
      {
        if (this.quantity < this._shopArticle.daily_limit.Value && this.quantity < this._shopArticle.limit.Value)
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0076Menu.\u003COpenPopup00771\u003Ec__Iterator4F4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0076Menu.\u003CLongPressedCountPlus\u003Ec__Iterator4F5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop0076Menu.\u003CLongPressedCountMinus\u003Ec__Iterator4F6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    if (!this.initData)
      this.StartCoroutine(this.Init(this._playerShopArticle, this._shopArticle, this._player, this._playerQuantity, this._scrolls, this._articles, this._onPurchased));
    base.Update();
  }
}
