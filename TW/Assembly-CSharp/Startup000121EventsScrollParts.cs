...
public class Startup000121EventsScrollParts : Startup000121ScrollParts
{
  ...
  public IEnumerator SetDataOld(OfficialInformationArticle info, NGMenuBase menu)
  {
    ...
    return (IEnumerator) new Startup000121EventsScrollParts.\u003CSetDataOld\u003Ec__Iterator19E()
    {
      info = info,
      \u003C\u0024\u003Einfo = info,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Startup000121EventsScrollParts.\u003CLoadSprite\u003Ec__Iterator19F()
    {
      count = count,
      str = str,
      sprite = sprite,
