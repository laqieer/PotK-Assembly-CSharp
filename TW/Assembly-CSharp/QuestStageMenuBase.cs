...
public class QuestStageMenuBase : BackButtonMenuBase
{
    ...
    bool forcus)
  {
    ...
    return (IEnumerator) new QuestStageMenuBase.\u003CInitStoryQuest\u003Ec__Iterator24B()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CInitExtraQuest\u003Ec__Iterator24C()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CInit\u003Ec__Iterator24D()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CUnitCreate\u003Ec__Iterator24E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CsubBackGroundCrate\u003Ec__Iterator24F()
    {
      quest = quest,
      \u003C\u0024\u003Equest = quest,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CMissionWindowCreate\u003Ec__Iterator250()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CInitHscroll\u003Ec__Iterator251()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CinitHscrollObj\u003Ec__Iterator252()
    {
      go = go,
      StageData = StageData,
      gridWidth = gridWidth,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CibtnMission\u003Ec__Iterator253()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestStageMenuBase.\u003CisDragTweenStart\u003Ec__Iterator254()
    {
      flag = flag,
      \u003C\u0024\u003Eflag = flag,
      \u003C\u003Ef__this = this
