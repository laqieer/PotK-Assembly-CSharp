...
public class Bugu055SellMenu : Bugu00525Menu
{
  ...
  protected override void BottomInfoUpdate()
  {
    ...
    int sellCost = CalcItemCost.GetSellCost(this.SelectItemList);
    this.NumSpendZenie3.SetTextLocalize(sellCost);
    this.NumSpendZenie3.color = sellCost + instanceOrNull.GetProperty(MasterDataTable.CommonRewardType.money) > Consts.GetInstance().MONEY_MAX ? Color.red : Color.white;
    int selectItemNum = 0;
  ...
  private IEnumerator ExecuteSellAPI()
  {
    ...
    return (IEnumerator) new Bugu055SellMenu.\u003CExecuteSellAPI\u003Ec__Iterator852()
    {
      \u003C\u003Ef__this = this
    };
  }
