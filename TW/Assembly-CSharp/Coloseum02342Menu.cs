...
public class Coloseum02342Menu : BackButtonMenuBase
{
    ...
    int duelCount)
  {
    ...
    return (IEnumerator) new Coloseum02342Menu.\u003CInitialize\u003Ec__Iterator5EB()
    {
      info = info,
      result = result,
      gladiator = gladiator,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CLoadResource\u003Ec__Iterator5EC()
    {
      duelCount = duelCount,
      \u003C\u0024\u003EduelCount = duelCount,
      \u003C\u003Ef__this = this
  ...
  public void StartToBeginning(int index)
  {
    ...
    // ISSUE: object of a compiler-generated type is created
    foreach (\u003C\u003E__AnonType6<int, GameObject> anonType6 in ((IEnumerable<GameObject>) this.rounds).Select<GameObject, \u003C\u003E__AnonType6<int, GameObject>>((Func<GameObject, int, \u003C\u003E__AnonType6<int, GameObject>>) ((s, i) => new \u003C\u003E__AnonType6<int, GameObject>(i, s))))
      anonType6.s.SetActive(anonType6.i == index);
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CStartFirstDuel\u003Ec__Iterator5ED()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CStartDuel\u003Ec__Iterator5EE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CStartWalkover\u003Ec__Iterator5EF()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CStartFinalDuel\u003Ec__Iterator5F0()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CSetUnitCharacter\u003Ec__Iterator5F1()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CLoadDuelist\u003Ec__Iterator5F2()
    {
      unit = unit,
      original = original,
      resource = resource,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CUnitBattleResultAnimation\u003Ec__Iterator5F3()
    {
      CallBack = CallBack,
      index = index,
      \u003C\u0024\u003ECallBack = CallBack,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CBattleResult\u003Ec__Iterator5F4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CBattleResultForSkipDuel\u003Ec__Iterator5F5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CBattleResultForNextDuel\u003Ec__Iterator5F6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CBattleResultForFinal\u003Ec__Iterator5F7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CAdvanceNextDuel\u003Ec__Iterator5F8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CSetUnit\u003Ec__Iterator5F9()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    foreach (\u003C\u003E__AnonType3<UnitIcon, int> anonType3 in listPlayer.Select<UnitIcon, \u003C\u003E__AnonType3<UnitIcon, int>>((Func<UnitIcon, int, \u003C\u003E__AnonType3<UnitIcon, int>>) ((s, i) => new \u003C\u003E__AnonType3<UnitIcon, int>(s, i))))
      anonType3.s.Gray = anonType3.i != targetIndex;
    // ISSUE: object of a compiler-generated type is created
    foreach (\u003C\u003E__AnonType3<UnitIcon, int> anonType3 in listEnemy.Select<UnitIcon, \u003C\u003E__AnonType3<UnitIcon, int>>((Func<UnitIcon, int, \u003C\u003E__AnonType3<UnitIcon, int>>) ((s, i) => new \u003C\u003E__AnonType3<UnitIcon, int>(s, i))))
      anonType3.s.Gray = anonType3.i != targetIndex;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    foreach (\u003C\u003E__AnonType3<GameObject, int> anonType3 in list.Select<GameObject, \u003C\u003E__AnonType3<GameObject, int>>((Func<GameObject, int, \u003C\u003E__AnonType3<GameObject, int>>) ((s, i) => new \u003C\u003E__AnonType3<GameObject, int>(s, i))))
    {
      if (anonType3.i == index)
      {
        anonType3.s.SetActive(true);
        this.playerUnitIcon[anonType3.i].GetComponent<UIPanel>().depth = 3;
        this.enemyUnitIcon[anonType3.i].GetComponent<UIPanel>().depth = 3;
        this.SetGrayOut(this.playerUnitIconC, this.enemyUnitIconC, anonType3.i);
        if (withAnimate)
        {
          switch (anonType3.i)
          {
      ...
      {
        anonType3.s.SetActive(false);
        this.playerUnitIcon[anonType3.i].GetComponent<UIPanel>().depth = 2;
        this.enemyUnitIcon[anonType3.i].GetComponent<UIPanel>().depth = 2;
      }
    }
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CLoadMatchIcon\u003Ec__Iterator5FA()
    {
      ro = ro,
      list = list,
      go = go,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CSetUnitIcon\u003Ec__Iterator5FB()
    {
      unit = unit,
      icon = icon,
      list = list,
  ...
  private void SetBattleParam(int duelCount)
  {
    ...
    if (duelColosseumResult.player != null)
    {
      ...
      this.TxtAttackOwn.SetTextLocalize(!flag || duelColosseumResult.playerAttackStatus == null ? "-" : duelColosseumResult.playerAttackStatus.attack.ToLocalizeNumberText());
      ...
      int num = !flag || duelColosseumResult.playerAttackStatus == null ? 1 : NC.Clamp(1, 4, duelColosseumResult.playerAttackStatus.attackCount);
    ...
    if (duelColosseumResult.opponent != null)
    {
      ...
      this.TxtAttack.SetTextLocalize(!flag || duelColosseumResult.opponentAttackStatus == null ? "-" : duelColosseumResult.opponentAttackStatus.attack.ToLocalizeNumberText());
      ...
      int num = !flag || duelColosseumResult.opponentAttackStatus == null ? 1 : NC.Clamp(1, 4, duelColosseumResult.opponentAttackStatus.attackCount);
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CStartRoundButton\u003Ec__Iterator5FC()
    {
      delay = delay,
      \u003C\u0024\u003Edelay = delay,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CChangeDuelScene\u003Ec__Iterator5FD()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CUpdateDuelist\u003Ec__Iterator5FE()
    {
      index = index,
      \u003C\u0024\u003Eindex = index,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Coloseum02342Menu.\u003CSetEmblem\u003Ec__Iterator5FF()
    {
      id = id,
      emblem = emblem,
      \u003C\u0024\u003Eid = id,
