...
namespace Earth
{
  public class EarthDataManager : Singleton<EarthDataManager>
  {
    ...
    public List<EarthExtraQuest> GetEnableEarthExtraQuestList()
    {
      ...
      {
        int num1 = !x.start_id.HasValue ? 0 : x.start_id.Value;
        int num2 = !x.end_id.HasValue ? 10000 : x.end_id.Value;
        ...
        return num1 <= episodeID && episodeID <= num2 && earthQuestKey != null;
      ...
      Action<WebAPI.Response.UserError> userErrorCallback = null)
    {
      ...
      return (IEnumerator) new EarthDataManager.\u003CEarthDataInit\u003Ec__IteratorB10()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EarthDataManager.\u003CSendSave\u003Ec__IteratorB11()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EarthDataManager.\u003CSaveAndSendServer\u003Ec__IteratorB12()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      return EarthQuestProgress.JsonLoad((Dictionary<string, object>) json["quest_progress"], (System.Action) (() => { }));
    }
    ...
    private void JsonLoad(Dictionary<string, object> json)
    {
      ...
      this.mQuestProgress = EarthQuestProgress.JsonLoad(json6, (System.Action) (() => isCallClearCharacterBattleIndex = true));
      this.mUserProperties = new BL.ClassValue<Dictionary<MasterDataTable.CommonRewardType, int>>(new Dictionary<MasterDataTable.CommonRewardType, int>());
    ...
    {
      return string.Format(EarthDataManager.serverDataFormat, (object) string.Join(",", this.mCharacters.Values.Select<EarthCharacter, string>((Func<EarthCharacter, string>) (x => x.GetSeverString())).ToArray<string>()), (object) string.Join(",", this.mGears.Values.Select<EarthGear, string>((Func<EarthGear, string>) (x => x.GetSeverString())).ToArray<string>()), (object) string.Join(",", this.mItems.Values.Select<EarthItem, string>((Func<EarthItem, string>) (x => x.GetSeverString())).ToArray<string>()), (object) string.Join(",", this.mCharacterIntimates.Values.Select<EarthCharacterIntimate, string>((Func<EarthCharacterIntimate, string>) (x => x.GetSeverString())).ToArray<string>()), (object) this.mQuestProgress.GetSeverString(), (object) string.Join(",", this.mUserProperties.value.Select<KeyValuePair<MasterDataTable.CommonRewardType, int>, string>((Func<KeyValuePair<MasterDataTable.CommonRewardType, int>, string>) (x => string.Format(EarthDataManager.serverUserPropertiseFormat, (object) (int) x.Key, (object) x.Value))).ToArray<string>()), (object) string.Join(",", this.mShopPurchaseHistory.Select<KeyValuePair<int, int>, string>((Func<KeyValuePair<int, int>, string>) (x => string.Format(EarthDataManager.serverShopPurchaseHistoryFormat, (object) x.Key, (object) x.Value))).ToArray<string>()), (object) string.Join(",", this.mQuestKeys.Values.Select<EarthQuestKey, string>((Func<EarthQuestKey, string>) (x => x.GetSeverString())).ToArray<string>()), (object) string.Join(",", this.mKeyQuestOpen.Values.Select<EarthQuestKeyPlayData, string>((Func<EarthQuestKeyPlayData, string>) (x => x.GetSeverString())).ToArray<string>()));
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new EarthDataManager.\u003CSaveEndTutorial\u003Ec__IteratorB13()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    public void BattleInitExtra(EarthExtraQuest quest, bool isRetreatEnable = true, bool isCloudAnime = false)
    {
      this.extraQuestInfo = quest;
      this.BattleInit(CommonQuestType.EarthExtra, quest.stage.ID, quest.ID, quest.stage.Enemies, quest.stage.Guests, isRetreatEnable, isCloudAnime);
    }

    public void BattleInitStory(bool isRetreatEnable = true, bool isCloudAnime = false)
    {
      this.extraQuestInfo = (EarthExtraQuest) null;
      this.BattleInit(CommonQuestType.Earth, this.questProgress.currentEpisode.stage.ID, this.questProgress.currentEpisode.ID, this.questProgress.currentEpisode.stage.Enemies, this.questProgress.currentEpisode.stage.Guests, isRetreatEnable, isCloudAnime);
    }
      ...
      bool isCloudAnime)
    {
      ...
      GameCore.BattleInfo info = GameCore.BattleInfo.MakeBattleInfo(Guid.NewGuid().ToString(), questType, questSID, 0, 0, 0, (PlayerHelper) null, ((IEnumerable<BattleStageEnemy>) enemies).Select<BattleStageEnemy, int>((Func<BattleStageEnemy, int>) (x => x.ID)).ToArray<int>(), tupleList2.ToArray(), new PlayerUnit[0], new PlayerItem[0], new int[0], new Tuple<int, int, int, int>[0], intList.ToArray(), tupleList1.ToArray(), ((IEnumerable<BattleEarthStageGuest>) guests).Select<BattleEarthStageGuest, int>((Func<BattleEarthStageGuest, int>) (x => x.ID)).ToArray<int>());
