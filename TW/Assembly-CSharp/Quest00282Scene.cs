...
public class Quest00282Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync(PlayerStoryQuestS story_quest)
  {
    ...
    return (IEnumerator) new Quest00282Scene.\u003ConStartSceneAsync\u003Ec__Iterator2C9()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00282Scene.\u003ConStartSceneAsync\u003Ec__Iterator2CA()
    {
      quest = quest,
      \u003C\u0024\u003Equest = quest,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00282Scene.\u003ConStartSceneAsync\u003Ec__Iterator2CB()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00282Scene.\u003ConStartSceneAsync\u003Ec__Iterator2CC()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00282Scene.\u003ConStartSceneAsync\u003Ec__Iterator2CD()
    {
      story_quest = story_quest,
      extra_quest = extra_quest,
      char_quest = char_quest,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00282Scene.\u003ConStartSceneAsync\u003Ec__Iterator2CE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00282Scene.\u003ConEndSceneAsync\u003Ec__Iterator2CF()
    {
      \u003C\u003Ef__this = this
    };
  }
