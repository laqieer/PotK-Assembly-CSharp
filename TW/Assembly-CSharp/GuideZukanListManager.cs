...
public class GuideZukanListManager : BackButtonMenuBase
{
  ...
  protected virtual IEnumerator CreateZukanList(Future<GameObject> popupSortAndFilter)
  {
    ...
    return (IEnumerator) new GuideZukanListManager.\u003CCreateZukanList\u003Ec__Iterator599()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideZukanListManager.\u003CCreateSpriteCashList\u003Ec__Iterator59A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideZukanListManager.\u003CCreateIconWithNumber\u003Ec__Iterator59B()
    {
      fPrefab = fPrefab,
      \u003C\u0024\u003EfPrefab = fPrefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideZukanListManager.\u003CCreateSortAndFilter\u003Ec__Iterator59C()
    {
      fPrefab = fPrefab,
      \u003C\u0024\u003EfPrefab = fPrefab,
      \u003C\u003Ef__this = this
