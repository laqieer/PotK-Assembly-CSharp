...
namespace UniLinq
{
    ...
    ILookup<TKey, TElement>
  {
      ...
      Func<TKey, IEnumerable<TElement>, TResult> resultSelector)
    {
      ...
      Lookup<TKey, TElement>.\u003CApplyResultSelector\u003Ec__Iterator179<TResult> selectorCIterator179 = new Lookup<TKey, TElement>.\u003CApplyResultSelector\u003Ec__Iterator179<TResult>()
      {
      ...
      selectorCIterator179.\u0024PC = -2;
      return (IEnumerable<TResult>) selectorCIterator179;
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator<IGrouping<TKey, TElement>>) new Lookup<TKey, TElement>.\u003CGetEnumerator\u003Ec__Iterator17A()
      {
        \u003C\u003Ef__this = this
      };
    }
