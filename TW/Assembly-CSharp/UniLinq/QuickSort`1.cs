...
namespace UniLinq
{
  internal class QuickSort<TElement>
  {
      ...
      SortContext<TElement> context)
    {
      ...
      QuickSort<TElement>.\u003CSort\u003Ec__Iterator17B sortCIterator17B = new QuickSort<TElement>.\u003CSort\u003Ec__Iterator17B()
      {
        source = source,
        context = context,
        \u003C\u0024\u003Esource = source,
      ...
      sortCIterator17B.\u0024PC = -2;
      return (IEnumerable<TElement>) sortCIterator17B;
    }
  }
}
