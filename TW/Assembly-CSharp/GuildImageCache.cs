...
public class GuildImageCache
{
  ...
  public IEnumerator FacilitiResourceLoad(GuildAppearance guildData)
  {
    ...
    return (IEnumerator) new GuildImageCache.\u003CFacilitiResourceLoad\u003Ec__IteratorB81()
    {
      guildData = guildData,
      \u003C\u0024\u003EguildData = guildData,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuildImageCache.\u003CGuildBankLevelUpResourceLoad\u003Ec__IteratorB82()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuildImageCache.\u003CResourceLoad\u003Ec__IteratorB83()
    {
      guildData = guildData,
      \u003C\u0024\u003EguildData = guildData,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuildImageCache.\u003CGuildFrameAnimResourceLoad\u003Ec__IteratorB84()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuildImageCache.\u003CSetSprite\u003Ec__IteratorB85()
    {
      type = type,
      rank = rank,
      alpha = alpha,
