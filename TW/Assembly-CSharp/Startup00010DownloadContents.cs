...
public class Startup00010DownloadContents : MonoBehaviour
{
  ...
  public static void Show(int playingSeconds, Action<int> callback)
  {
    ...
    RenderSettings.ambientLight = new Color(0.8392157f, 0.8117647f, 0.8117647f, 0.0f);
    SceneManager.LoadScene("startup000_10", (LoadSceneMode) 1);
  }
  ...
  private IEnumerator Start()
  {
    ...
    return (IEnumerator) new Startup00010DownloadContents.\u003CStart\u003Ec__Iterator189()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Startup00010DownloadContents.\u003CTutorial\u003Ec__Iterator18A()
    {
      \u003C\u003Ef__this = this
    };
  }
