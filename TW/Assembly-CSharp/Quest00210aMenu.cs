...
public class Quest00210aMenu : BackButtonMenuBase
{
    ...
    bool removeButton)
  {
    ...
    return (IEnumerator) new Quest00210aMenu.\u003CInitSupplyList\u003Ec__Iterator1DE()
    {
      select = select,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00210aMenu.\u003CCreateItemIconRange\u003Ec__Iterator1DF()
    {
      value = value,
      \u003C\u0024\u003Evalue = value,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00210aMenu.\u003CCreateItemIcon\u003Ec__Iterator1E0()
    {
  ...
  private void CreateItemIconSharing(int info_index, int item_index)
  {
    ...
    {
      itemIcon.onClick = (Action<ItemIcon>) (supplyicon => this.CountSelectPopUp(s_item, supplyicon.IconSprite));
      itemIcon.ForBattle = false;
      itemIcon.Gray = false;
    }
    if (s_item.removeButton)
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00210aMenu.\u003CLoadObject\u003Ec__Iterator1E1()
    {
      \u003C\u003Ef__this = this
    };
  }
