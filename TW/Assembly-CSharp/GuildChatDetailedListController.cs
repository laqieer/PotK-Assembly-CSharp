...
public class GuildChatDetailedListController : MonoBehaviour
{
  ...
  private IEnumerator WaitForNGUIProcessToFinish()
  {
    ...
    return (IEnumerator) new GuildChatDetailedListController.\u003CWaitForNGUIProcessToFinish\u003Ec__IteratorB1F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuildChatDetailedListController.\u003CInitializePopupDialogPrefabs\u003Ec__IteratorB20()
    {
      \u003C\u003Ef__this = this
    };
  }
