...
{
  private static System.Type classType = typeof (RenderSettings);
  ...
  private static int _CreateRenderSettings(IntPtr L)
  {
    if (LuaDLL.lua_gettop(L) == 0)
    {
      ...
      LuaScriptMgr.Push(L, (Object) renderSettings);
      return 1;
    }
  ...
  {
    LuaScriptMgr.Push(L, (Enum) (object) RenderSettings.fogMode);
    return 1;
  }
  ...
  {
    LuaScriptMgr.Push(L, (Enum) (object) RenderSettings.ambientMode);
    return 1;
  }
  ...
  {
    LuaScriptMgr.PushValue(L, (object) RenderSettings.ambientProbe);
    return 1;
  }
  ...
  {
    LuaScriptMgr.Push(L, (Object) RenderSettings.skybox);
    return 1;
  }
  ...
  {
    LuaScriptMgr.Push(L, (Enum) (object) RenderSettings.defaultReflectionMode);
    return 1;
  }
  ...
  {
    LuaScriptMgr.Push(L, (Object) RenderSettings.customReflection);
    return 1;
  }
