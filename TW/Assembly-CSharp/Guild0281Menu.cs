...
public class Guild0281Menu : BackButtonMenuBase
{
  ...
  public WebAPI.Response.GvgResult GVGResult => this.gvgResult;

  public bool isOpenGuildMemberOrInfoPopup
  {
    set => this._isOpenGuildMemberOrInfoPopup = value;
    get => this._isOpenGuildMemberOrInfoPopup;
  }
  ...
  private IEnumerator ResourceLoadGuild(GuildRegistration data)
  {
    ...
    return (IEnumerator) new Guild0281Menu.\u003CResourceLoadGuild\u003Ec__Iterator6E2()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281Menu.\u003CInitializeAsync\u003Ec__Iterator6E3()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281Menu.\u003CPlayGuildTopLevelUpEffect\u003Ec__Iterator6E4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281Menu.\u003CshowLevelupAnim\u003Ec__Iterator6E5()
    {
      level = level,
      guildBase = guildBase,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281Menu.\u003CShowMyMemberList\u003Ec__Iterator6E6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281Menu.\u003CSetCharacterModel\u003Ec__Iterator6E7()
    {
      \u003C\u003Ef__this = this
    };
  }
...
label_5:
  ...
  public bool PlayTweens(int groupID, EventDelegate.Callback eventFinished = null)
  {
    ...
    bool flag = NGTween.playTweens(this.tweens, groupID) & !NGTween.isTweensError;
    if (eventFinished != null && this.tweens != null && flag)
    {
      UITweener uiTweener = (UITweener) null;
      foreach (UITweener tween in this.tweens)
      {
        if (tween.tweenGroup == groupID && (Object.op_Equality((Object) uiTweener, (Object) null) || (double) uiTweener.duration + (double) uiTweener.delay < (double) tween.duration + (double) tween.delay))
          uiTweener = tween;
      }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281Menu.\u003CGuildBattleResult\u003Ec__Iterator6E8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public bool checkOpenBattleEntryPopup()
  {
    if (this.guild.gvg_status != GvgStatus.can_entry)
      return false;
    int gvgId = !this.guild.active_gvg_period_id.HasValue ? 0 : this.guild.active_gvg_period_id.Value;
    ...
    if (guildBattleUser.guildID != this.guild.guild_id || guildBattleUser.gvgID != gvgId || guildBattleUser.roleNo != guildMembership._role)
      guildBattleUser.reset(this.guild.guild_id, guildMembership._role, gvgId);
    ++guildBattleUser.countTopIN;
    Persist.guildBattleUser.Flush();
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild0281Menu.\u003CcoDrawBattleEntryPopup\u003Ec__Iterator6E9()
    {
      \u003C\u003Ef__this = this
    };
  }
