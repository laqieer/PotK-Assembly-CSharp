...
public class DuelCameraManager : MonoBehaviour
{
  ...
  public IEnumerator changeCamera(string cameraName, Transform parent = null)
  {
    ...
    return (IEnumerator) new DuelCameraManager.\u003CchangeCamera\u003Ec__Iterator8A6()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DuelCameraManager.\u003CcoShakeCamera\u003Ec__Iterator8A7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DuelCameraManager.\u003CWarpCamera1stAttackPosRemoteEnemy\u003Ec__Iterator8A8()
    {
      delay = delay,
      defender = defender,
      bullet = bullet,
