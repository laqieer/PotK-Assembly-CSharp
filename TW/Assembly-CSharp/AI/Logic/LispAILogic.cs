...
namespace AI.Logic
{
  public class LispAILogic : AILogicBase
  {
    ...
    public IEnumerator createEngine(object sexp)
    {
      ...
      return (IEnumerator) new LispAILogic.\u003CcreateEngine\u003Ec__Iterator1A()
      {
        sexp = sexp,
        \u003C\u0024\u003Esexp = sexp,
        \u003C\u003Ef__this = this
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new LispAILogic.\u003CdoExecute\u003Ec__Iterator1B()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new LispAILogic.\u003CdoAI\u003Ec__Iterator1C()
      {
        \u003C\u003Ef__this = this
      };
    }
