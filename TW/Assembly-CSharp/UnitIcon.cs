...
public class UnitIcon : UnitIconBase
{
    ...
    PlayerUnit[] playerUnits)
  {
    ...
    return (IEnumerator) new UnitIcon.\u003CSetMaterialUnit\u003Ec__IteratorBB5()
    {
      playerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetPlayerUnit\u003Ec__IteratorBB6()
    {
      playerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetPlayerUnitEvolution\u003Ec__IteratorBB7()
    {
      playerUnit = playerUnit,
      basePlayerUnit = basePlayerUnit,
      playerUnits = playerUnits,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CsetPlayerUnit\u003Ec__IteratorBB8()
    {
      playerUnit = playerUnit,
      basePlayerUnit = basePlayerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CsetSimpleUnit\u003Ec__IteratorBB9()
    {
      playerUnit = playerUnit,
      \u003C\u0024\u003EplayerUnit = playerUnit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CsetBottomUnit\u003Ec__IteratorBBA()
    {
      playerUnit = playerUnit,
      playerUnits = playerUnits,
      \u003C\u0024\u003EplayerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CLoadSprite\u003Ec__IteratorBBB()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetUnit\u003Ec__IteratorBBC()
    {
      unit = unit,
      element = element,
      isGray = isGray,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitIcon.\u003CSetUnitWithLongPressAction\u003Ec__IteratorBBD()
    {
      unit = unit,
      isGray = isGray,
      buttonEvent = buttonEvent,
  ...
  public void UnknownUnit()
  {
    ...
    this.bottomBaseObject.SetActive(true);
