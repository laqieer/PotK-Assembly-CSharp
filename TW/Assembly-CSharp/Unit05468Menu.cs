...
public class Unit05468Menu : Unit00411Menu
{
  ...
  public IEnumerator Initialize(PlayerUnit[] playerUnits)
  {
    ...
    return (IEnumerator) new Unit05468Menu.\u003CInitialize\u003Ec__Iterator83A()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit05468Menu.\u003CLoadResources\u003Ec__Iterator83B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit05468Menu.\u003CCreateUnitIcon\u003Ec__Iterator83C()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit05468Menu.\u003CSwap\u003Ec__Iterator83D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit05468Menu.\u003CDispSupplyDeck\u003Ec__Iterator83E()
    {
      supplys = supplys,
      \u003C\u0024\u003Esupplys = supplys,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit05468Menu.\u003CCreateSupplyIcon\u003Ec__Iterator83F()
    {
      pos = pos,
      supply = supply,
      \u003C\u0024\u003Epos = pos,
