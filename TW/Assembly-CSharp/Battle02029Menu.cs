...
public class Battle02029Menu : NGMenuBase
{
  ...
  public IEnumerator InitForEvolution(int unit_id, int skill_id, int skill_id_before)
  {
    ...
    return (IEnumerator) new Battle02029Menu.\u003CInitForEvolution\u003Ec__Iterator903()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle02029Menu.\u003CInit\u003Ec__Iterator904()
    {
      skill_id = skill_id,
      unit_id = unit_id,
      \u003C\u0024\u003Eskill_id = skill_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle02029Menu.\u003CInitLeaderSkill\u003Ec__Iterator905()
    {
      skill_id = skill_id,
      unit_id = unit_id,
      \u003C\u0024\u003Eskill_id = skill_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle02029Menu.\u003CsetSkill\u003Ec__Iterator906()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle02029Menu.\u003CPlay\u003Ec__Iterator907()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle02029Menu.\u003CSetCharacterViewUnit\u003Ec__Iterator908()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle02029Menu.\u003CtoClose\u003Ec__Iterator909()
    {
      \u003C\u003Ef__this = this
    };
  }
