...
public class FriendBarBase : BackButtonMenuBase
{
  ...
  protected IEnumerator CreateFriendBarRange(int value)
  {
    ...
    return (IEnumerator) new FriendBarBase.\u003CCreateFriendBarRange\u003Ec__Iterator504()
    {
      value = value,
      \u003C\u0024\u003Evalue = value,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendBarBase.\u003CCreateScrollBase\u003Ec__Iterator505()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new FriendBarBase.\u003CCreateScroll\u003Ec__Iterator506()
    {
      bar_index = bar_index,
