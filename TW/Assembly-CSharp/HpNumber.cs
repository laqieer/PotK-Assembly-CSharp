...
public class HpNumber : BattleMonoBehaviour
{
  ...
  [SerializeField]
  protected GameObject[] damage_th;
  [SerializeField]
  ...
  public void StartAnime(int prev_hp, int new_hp)
  {
    ...
    if (prev_hp != new_hp)
    {
      ...
      if (num > 0)
      {
        ...
        this.SetNumber(prev_hp, this.base_o, this.base_t, this.base_h, this.base_th);
        this.SetNumber(Mathf.Abs(num), this.damage_o, this.damage_t, this.damage_h, this.damage_th);
      ...
      else
      {
        ...
        this.SetNumber(prev_hp, this.base_o, this.base_t, this.base_h, this.base_th);
        this.SetNumber(Mathf.Abs(num), this.heal_o, this.heal_t, this.heal_h, this.heal_th);
  ...
  private void SetNumber(
    ...
    GameObject[] thousand)
  {
    int num = Mathf.Clamp(_number, 0, 9999);
    int index1 = num % 10;
    int index2 = num / 10 % 10;
    int index3 = num / 100 % 10;
    int index4 = num / 1000 % 10;
    ...
    ((IEnumerable<GameObject>) thousand).ForEach<GameObject>((Action<GameObject>) (x => x.SetActive(false)));
    ...
    if (num < 1000)
      return;
    thousand[index4].SetActive(true);
  }
  ...
  private IEnumerator CountUp()
  {
    ...
    return (IEnumerator) new HpNumber.\u003CCountUp\u003Ec__IteratorA66()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new HpNumber.\u003CCountDown\u003Ec__IteratorA67()
    {
      \u003C\u003Ef__this = this
    };
  }
