...
public class Quest0528Menu : BackButtonMenuBase
{
  ...
  private IEnumerator WaitScrollSe(NGHorizontalScrollParts obj)
  {
    ...
    return (IEnumerator) new Quest0528Menu.\u003CWaitScrollSe\u003Ec__Iterator80C()
    {
      obj = obj,
      \u003C\u0024\u003Eobj = obj
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528Menu.\u003CInit\u003Ec__Iterator80D()
    {
      stage = stage,
      \u003C\u0024\u003Estage = stage,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528Menu.\u003CInit\u003Ec__Iterator80E()
    {
      quest = quest,
      \u003C\u0024\u003Equest = quest,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528Menu.\u003CsetupMapChipsWithInfoIndicator\u003Ec__Iterator80F()
    {
      stage = stage,
      \u003C\u0024\u003Estage = stage,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528Menu.\u003CcreateBattleUnitInfo\u003Ec__Iterator810()
    {
