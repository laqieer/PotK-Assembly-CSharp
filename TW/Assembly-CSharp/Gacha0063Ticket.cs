...
public class Gacha0063Ticket : Gacha0063hindicator
{
  ...
  public override IEnumerator Set(GameObject detailPopup)
  {
    ...
    return (IEnumerator) new Gacha0063Ticket.\u003CSet\u003Ec__Iterator443()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Ticket.\u003CGetTerm\u003Ec__Iterator444()
    {
      endAt = endAt,
      \u003C\u0024\u003EendAt = endAt,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Ticket.\u003CInitDetailButton\u003Ec__Iterator445()
    {
      gacha = gacha,
      detailPopup = detailPopup,
      \u003C\u0024\u003Egacha = gacha,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Gacha0063Ticket.\u003COpenDetailPopup\u003Ec__Iterator446()
    {
      gacha = gacha,
      detailPopup = detailPopup,
      \u003C\u0024\u003Egacha = gacha,
