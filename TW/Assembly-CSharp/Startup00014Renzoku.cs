...
public class Startup00014Renzoku : Startup00014Menu
{
  ...
  public void onNextButton()
  {
    ...
    Debug.LogWarning((object) ("page = " + (object) this.pageCount));
    if (this.pageCount == 0)
      this.NowStamp();
  ...
  private IEnumerator LoadResource()
  {
    ...
    return (IEnumerator) new Startup00014Renzoku.\u003CLoadResource\u003Ec__Iterator1A7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Startup00014Renzoku.\u003CInitSceneAsync\u003Ec__Iterator1A8()
    {
      lB = lB,
      \u003C\u0024\u003ElB = lB,
      \u003C\u003Ef__this = this
