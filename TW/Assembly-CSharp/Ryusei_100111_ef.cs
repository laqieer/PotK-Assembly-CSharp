...
public class Ryusei_100111_ef : MonoBehaviour
{
  ...
  private IEnumerator loadPrefab(string pname, Vector3 pos, Vector3 rot)
  {
    ...
    return (IEnumerator) new Ryusei_100111_ef.\u003CloadPrefab\u003Ec__Iterator8EF()
    {
      pname = pname,
      pos = pos,
      rot = rot,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Ryusei_100111_ef.\u003CloadPrefab\u003Ec__Iterator8F0()
    {
      data_name = data_name,
      \u003C\u0024\u003Edata_name = data_name,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Ryusei_100111_ef.\u003CloadPrefab\u003Ec__Iterator8F1()
    {
