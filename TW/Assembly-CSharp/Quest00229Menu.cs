...
public class Quest00229Menu : BackButtonMenuBase
{
  ...
  private IEnumerator CreateScroll(int info_index, int unit_index)
  {
    ...
    return (IEnumerator) new Quest00229Menu.\u003CCreateScroll\u003Ec__Iterator28F()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00229Menu.\u003CInit\u003Ec__Iterator290()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00229Menu.\u003CCreateRanking\u003Ec__Iterator291()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00229Menu.\u003CInitBottomParts\u003Ec__Iterator292()
    {
      rankingData = rankingData,
      \u003C\u0024\u003ErankingData = rankingData,
      \u003C\u003Ef__this = this
