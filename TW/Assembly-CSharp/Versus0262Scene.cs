...
public class Versus0262Scene : NGSceneBase
{
  ...
  public override IEnumerator onInitSceneAsync()
  {
    ...
    return (IEnumerator) new Versus0262Scene.\u003ConInitSceneAsync\u003Ec__Iterator696()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0262Scene.\u003ConStartSceneAsync\u003Ec__Iterator697()
    {
      type = type,
      \u003C\u0024\u003Etype = type,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus0262Scene.\u003ConStartSceneAsync\u003Ec__Iterator698()
    {
      type = type,
      pvpInfo = pvpInfo,
      \u003C\u0024\u003Etype = type,
