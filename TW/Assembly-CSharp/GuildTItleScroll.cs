...
public class GuildTItleScroll : MonoBehaviour
{
    ...
    Guild0284Menu baseMenu)
  {
    ...
    return (IEnumerator) new GuildTItleScroll.\u003CInit\u003Ec__Iterator7A3()
    {
      id = id,
      rarity = rarity,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuildTItleScroll.\u003COpenTitleSetPopup\u003Ec__Iterator7A4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuildTItleScroll.\u003CCreateSprite\u003Ec__Iterator7A5()
    {
      \u003C\u003Ef__this = this
    };
  }
