...
public class MagicBullet : MonoBehaviour
{
  ...
  [DebuggerHidden]
  public IEnumerator preloadPrefabs(NGDuelManager manager)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new MagicBullet.\u003CpreloadPrefabs\u003Ec__Iterator8AC()
    {
      manager = manager,
      \u003C\u0024\u003Emanager = manager,
      \u003C\u003Ef__this = this
  ...
  private GameObject setPreloadPrefabs(GameObject obj)
  {
    if (Object.op_Inequality((Object) this.manager, (Object) null))
      this.manager.setPreloadGameObject(obj);
    return obj;
  }
  ...
  private Future<GameObject> loadMuzzle()
  {
    ...
    {
      if (Object.op_Inequality((Object) this.manager, (Object) null))
        this.manager.setPreloadGameObject(f);
      return f;
    }));
  }
  ...
  private void Update()
  {
    ...
    switch (this.status)
    {
      ...
      case MagicBullet.MBStatus.ST_FIRE:
        ...
        this.mzl = this.manager.getPreloadGameObject(this.strMuzzlePF, parent);
      ...
      case MagicBullet.MBStatus.ST_BULLET:
        if ((double) this.shootDelay > (double) this.internalTime)
          break;
        this.bullet = this.manager.getPreloadGameObject(this.strBulletPF, ((Component) this).transform);
      ...
      case MagicBullet.MBStatus.ST_EXPLOSE:
        ...
        if (this.isHit)
        {
          if (this.mMine.isThisTurnCritical() && this.mMine.mIsLastAttack)
            this.mEnemy.playCriticalFlash_CallStartCoroutine();
          this.chakudan = this.manager.getPreloadGameObject(this.strExplosePF, ((Component) this).transform);
      ...
      case MagicBullet.MBStatus.ST_DRAIN_BULLET:
        ...
        this.drainBullet = this.manager.getPreloadGameObject(this.strDrainBulletPF, ((Component) this).transform);
      ...
      case MagicBullet.MBStatus.ST_DRAIN_HEAL:
        ...
        this.drainChakudan = this.manager.getPreloadGameObject(this.strDrainExplosePF, ((Component) this.mMine).gameObject.transform);
