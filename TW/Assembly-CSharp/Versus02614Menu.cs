...
public class Versus02614Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitOne()
  {
    ...
    return (IEnumerator) new Versus02614Menu.\u003CInitOne\u003Ec__Iterator689()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02614Menu.\u003CLoadPreafbFuture\u003Ec__Iterator68A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02614Menu.\u003CInit\u003Ec__Iterator68B()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02614Menu.\u003CCreateDisplay\u003Ec__Iterator68C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02614Menu.\u003CCreateScroll\u003Ec__Iterator68D()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Versus02614Menu.\u003CSetScrollData\u003Ec__Iterator68E()
    {
      part = part,
      data = data,
      \u003C\u0024\u003Epart = part,
