...
public class Story00912Menu : BackButtonMenuBase
{
    ...
    float sprite_scale)
  {
    ...
    return (IEnumerator) new Story00912Menu.\u003CLoadCharacterSprite\u003Ec__Iterator559()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story00912Menu.\u003CLoadMask\u003Ec__Iterator55A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story00912Menu.\u003CSetCharacterLargeImage\u003Ec__Iterator55B()
    {
      id = id,
      questS = questS,
      id2 = id2,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story00912Menu.\u003CCreateEpisodes\u003Ec__Iterator55C()
    {
      id1 = id1,
      id2 = id2,
      id3 = id3,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Story00912Menu.\u003CInit\u003Ec__Iterator55D()
    {
      id = id,
      id2 = id2,
      id3 = id3,
