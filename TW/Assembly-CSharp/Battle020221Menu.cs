...
public class Battle020221Menu : NGMenuBase
{
  ...
  private IEnumerator LoadUnitPrefab()
  {
    ...
    return (IEnumerator) new Battle020221Menu.\u003CLoadUnitPrefab\u003Ec__Iterator8FE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle020221Menu.\u003CSetUnitPrefab\u003Ec__Iterator8FF()
    {
      setObject = setObject,
      unit = unit,
      \u003C\u0024\u003EsetObject = setObject,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle020221Menu.\u003CSetCharaIcon\u003Ec__Iterator900()
    {
      id1 = id1,
      id2 = id2,
      \u003C\u0024\u003Eid1 = id1,
