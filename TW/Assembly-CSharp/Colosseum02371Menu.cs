...
public class Colosseum02371Menu : BackButtonMenuBase
{
    ...
    RankingPlayer MyRanking)
  {
    ...
    return (IEnumerator) new Colosseum02371Menu.\u003CDisplayRanking\u003Ec__Iterator633()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02371Menu.\u003CInitialize\u003Ec__Iterator634()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02371Menu.\u003CInitBottomParts\u003Ec__Iterator635()
    {
      rankingData = rankingData,
      \u003C\u0024\u003ErankingData = rankingData,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02371Menu.\u003CDisplayTotalRanking\u003Ec__Iterator636()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Colosseum02371Menu.\u003CDisplayFriendRanking\u003Ec__Iterator637()
    {
      \u003C\u003Ef__this = this
    };
  }
