...
public class PaymentListener : Singleton<PaymentListener>
{
  ...
  public static IEnumerator OpenItemList(bool isBattle)
  {
    ...
    return (IEnumerator) new PaymentListener.\u003COpenItemList\u003Ec__IteratorADB()
    {
      isBattle = isBattle,
      \u003C\u0024\u003EisBattle = isBattle
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PaymentListener.\u003C_RequestPurchase\u003Ec__IteratorADC()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator Start()
  {
    ...
    PaymentListener.\u003CStart\u003Ec__IteratorADD startCIteratorAdd = new PaymentListener.\u003CStart\u003Ec__IteratorADD();
    return (IEnumerator) startCIteratorAdd;
  }
  ...
  public static IEnumerator SendCoinbonusPresent()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    PaymentListener.\u003CSendCoinbonusPresent\u003Ec__IteratorADE presentCIteratorAde = new PaymentListener.\u003CSendCoinbonusPresent\u003Ec__IteratorADE();
    return (IEnumerator) presentCIteratorAde;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PaymentListener.\u003C_SetRetryPayment\u003Ec__IteratorADF()
    {
      wait = wait,
      \u003C\u0024\u003Ewait = wait
    };
  ...
  private IEnumerator ShowInputBirthday()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    PaymentListener.\u003CShowInputBirthday\u003Ec__IteratorAE0 birthdayCIteratorAe0 = new PaymentListener.\u003CShowInputBirthday\u003Ec__IteratorAE0();
    return (IEnumerator) birthdayCIteratorAe0;
  }
  ...
  private IEnumerator ShowApprovePurchase()
  {
    // ISSUE: object of a compiler-generated type is created
    // ISSUE: variable of a compiler-generated type
    PaymentListener.\u003CShowApprovePurchase\u003Ec__IteratorAE1 purchaseCIteratorAe1 = new PaymentListener.\u003CShowApprovePurchase\u003Ec__IteratorAE1();
    return (IEnumerator) purchaseCIteratorAe1;
  }
}
