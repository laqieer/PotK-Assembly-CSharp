  ...
  public class SExpReader
  {
    ...
    private int readObj(int p)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          SExpReader.\u003C\u003Ef__switch\u0024mapE = new Dictionary<string, int>(2)
          {
            {
              "(",
              0
...
label_5:
    ...
    private bool numberp(string c, bool is_first)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          SExpReader.\u003C\u003Ef__switch\u0024mapF = new Dictionary<string, int>(12)
          {
            {
              "0",
              0
    ...
    private bool punctp(string c)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          SExpReader.\u003C\u003Ef__switch\u0024map10 = new Dictionary<string, int>(2)
          {
            {
              "(",
              0
    ...
    private bool whiteSpacep(string c)
    {
      ...
      if (key != null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          SExpReader.\u003C\u003Ef__switch\u0024map11 = new Dictionary<string, int>(6)
          {
            {
              " ",
              0
