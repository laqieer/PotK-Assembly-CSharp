...
namespace GameCore
{
  public class ColosseumEnvironmentInitializer
  {
      ...
      ColosseumEnvironment env_)
    {
      ...
      IEnumerable<BL.Unit> deckUnits1 = colosseumEnvironment.playerUnitDict.Values.Where<BL.Unit>((Func<BL.Unit, bool>) (x => x != null));
      IEnumerable<BL.Unit> deckUnits2 = colosseumEnvironment.opponentUnitDict.Values.Where<BL.Unit>((Func<BL.Unit, bool>) (x => x != null));
