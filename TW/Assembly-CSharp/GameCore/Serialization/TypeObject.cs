  ...
  public class TypeObject
  {
    ...
    public Dictionary<string, object> ToJson()
    {
      return new Dictionary<string, object>()
      {
        ...
        {
          "buf",
          this.buf != null ? (object) BitConverter.ToString(this.buf).Replace("-", string.Empty) : (object) (string) null
        },
        {
          "length",
          !this.length.HasValue ? (object) null : (object) this.length.Value
        },
        {
          "value",
          (object) this.value
    ...
    public static TypeObject FromJson(IDictionary<string, object> json)
    {
      ...
      typeObject1.objectId = (int) (long) json["objectId"];
      typeObject1.typeInfo = TypeInfo.Parse((string) json["typeInfo"]);
      typeObject1.buf = json["buf"] != null ? TypeObject.ToBytes((string) json["buf"]) : (byte[]) null;
      TypeObject typeObject2 = typeObject1;
      long? nullable1 = (long?) json["length"];
      int? nullable2 = !nullable1.HasValue ? new int?() : new int?((int) nullable1.Value);
      typeObject2.length = nullable2;
      typeObject1.value = (int) (long) json["value"];
      return typeObject1;
    }
