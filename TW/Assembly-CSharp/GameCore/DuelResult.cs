  ...
  public class DuelResult : ActionResult
  {
    ...
    public override ActionResultNetwork ToNetworkLocal(BL env)
    {
      return (ActionResultNetwork) new DuelResultNetwork()
      {
        ...
        turns = (this.turns != null ? ((IEnumerable<BL.DuelTurn>) this.turns).Select<BL.DuelTurn, BL.DuelTurnNetwork>((Func<BL.DuelTurn, BL.DuelTurnNetwork>) (x => x.ToNetwork(env))).ToArray<BL.DuelTurnNetwork>() : (BL.DuelTurnNetwork[]) null),
    ...
    public static ActionResult FromNetwork(ActionResultNetwork nnw, BL env)
    {
      ...
      return (ActionResult) new DuelResult()
      {
        ...
        turns = (duelResultNetwork.turns != null ? ((IEnumerable<BL.DuelTurnNetwork>) duelResultNetwork.turns).Select<BL.DuelTurnNetwork, BL.DuelTurn>((Func<BL.DuelTurnNetwork, BL.DuelTurn>) (x => BL.DuelTurn.FromNetwork(x, env))).ToArray<BL.DuelTurn>() : (BL.DuelTurn[]) null),
