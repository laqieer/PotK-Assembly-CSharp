...
public class Quest0528PlayerStatusDetail : BackButtonMenuBase
{
  ...
  public static IEnumerator LoadIcon(PlayerUnit v)
  {
    ...
    return (IEnumerator) new Quest0528PlayerStatusDetail.\u003CLoadIcon\u003Ec__Iterator816()
    {
      v = v,
      \u003C\u0024\u003Ev = v
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528PlayerStatusDetail.\u003CResourcePreLoad\u003Ec__Iterator817()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528PlayerStatusDetail.\u003CCreateMaskdCharacter\u003Ec__Iterator818()
    {
      v = v,
      \u003C\u0024\u003Ev = v,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0528PlayerStatusDetail.\u003CInit\u003Ec__Iterator819()
    {
      unit = unit,
      forceID = forceID,
      \u003C\u0024\u003Eunit = unit,
