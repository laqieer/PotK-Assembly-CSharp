...
public class Quest00226Menu : Quest00219Menu
{
    ...
    QuestScoreCampaignProgress qscp)
  {
    ...
    return (IEnumerator) new Quest00226Menu.\u003CInit\u003Ec__Iterator279()
    {
      qscp = qscp,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00226Menu.\u003CInit\u003Ec__Iterator27A()
    {
      ExtraData = ExtraData,
      lid = lid,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00226Menu.\u003CScrollInit\u003Ec__Iterator27B()
    {
      extra = extra,
      prefab = prefab,
      isClear = isClear,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00226Menu.\u003CListInit\u003Ec__Iterator27C()
    {
      extra = extra,
      prefab = prefab,
      isClear = isClear,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00226Menu.\u003CCellInit\u003Ec__Iterator27D()
    {
      prefab = prefab,
      extra = extra,
      isClear = isClear,
