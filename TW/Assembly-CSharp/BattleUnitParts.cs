...
public class BattleUnitParts : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    return (IEnumerator) new BattleUnitParts.\u003CStart_Battle\u003Ec__IteratorA82()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoDead\u003Ec__IteratorA83()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoSpawn\u003Ec__IteratorA84()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoRebirth\u003Ec__IteratorA85()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUnitParts.\u003CdoMoving\u003Ec__IteratorA86()
    {
      panels = panels,
      \u003C\u0024\u003Epanels = panels,
      \u003C\u003Ef__this = this
