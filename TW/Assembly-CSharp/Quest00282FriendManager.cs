...
public class Quest00282FriendManager : MonoBehaviour
{
    ...
    DateTime now)
  {
    ...
    return (IEnumerator) new Quest00282FriendManager.\u003CInitFriendList\u003Ec__Iterator2C5()
    {
      friend = friend,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00282FriendManager.\u003CChangeFriendIcon\u003Ec__Iterator2C6()
    {
      friend = friend,
      \u003C\u0024\u003Efriend = friend,
      \u003C\u003Ef__this = this
