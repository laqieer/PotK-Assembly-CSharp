...
public class DetailUnitParameter : MonoBehaviour
{
  ...
  public IEnumerator Init(int unitID, int position, Battle0171111Event descriptionPopup)
  {
    ...
    return (IEnumerator) new DetailUnitParameter.\u003CInit\u003Ec__IteratorBF9()
    {
      unitID = unitID,
      position = position,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailUnitParameter.\u003CInitUnitObject\u003Ec__IteratorBFA()
    {
      data = data,
      unit = unit,
      descriptionPopup = descriptionPopup,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailUnitParameter.\u003CInitSkillObject\u003Ec__IteratorBFB()
    {
