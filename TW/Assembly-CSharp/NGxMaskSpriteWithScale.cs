...
public class NGxMaskSpriteWithScale : MonoBehaviour
{
  ...
  public void FitMask()
  {
    ...
    else
    {
      ...
      string str = string.Format("dynamic {0}x{1} x({2}) y({3}) {4}", (object) num5, (object) num6, (object) num9, (object) num10, (object) (UIDrawCall.Clipping) (!Object.op_Inequality((Object) this.MainUI2DSprite.panel, (Object) null) ? 0 : (int) this.MainUI2DSprite.panel.clipping));
      if (!Object.op_Equality((Object) this.MainUI2DSprite, (Object) null) && !Object.op_Equality((Object) this.MainUI2DSprite.material, (Object) null) && !(str != ((Object) this.MainUI2DSprite.material).name) && !Object.op_Inequality((Object) this.lastMaskTexture, (Object) this.maskTexture))
        return;
      Shader shader = !this.isMultiMaskColor ? (!Object.op_Inequality((Object) this.MainUI2DSprite.panel, (Object) null) || this.MainUI2DSprite.panel.clipping != UIDrawCall.Clipping.SoftClip ? (!Object.op_Inequality((Object) this.MainUI2DSprite.panel, (Object) null) || this.MainUI2DSprite.panel.clipping != UIDrawCall.Clipping.AlphaClip ? Shader.Find("Unlit/AlphaMask") : Shader.Find("Unlit/AlphaMask (AlphaClip)")) : Shader.Find("Unlit/AlphaMask (SoftClip)")) : (!Object.op_Inequality((Object) this.MainUI2DSprite.panel, (Object) null) || this.MainUI2DSprite.panel.clipping != UIDrawCall.Clipping.SoftClip ? (!Object.op_Inequality((Object) this.MainUI2DSprite.panel, (Object) null) || this.MainUI2DSprite.panel.clipping != UIDrawCall.Clipping.AlphaClip ? Shader.Find("Unlit/AlphaMaskMultiColor") : Shader.Find("Unlit/AlphaMaskMultiColor (AlphaClip)")) : Shader.Find("Unlit/AlphaMaskMultiColor (SoftClip)"));
