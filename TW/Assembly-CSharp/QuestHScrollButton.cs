...
public class QuestHScrollButton : MonoBehaviour
{
  ...
  private IEnumerator ChoiceNumberSprites(string path)
  {
    ...
    return (IEnumerator) new QuestHScrollButton.\u003CChoiceNumberSprites\u003Ec__Iterator241()
    {
      path = path,
      \u003C\u0024\u003Epath = path,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestHScrollButton.\u003CInit\u003Ec__Iterator242()
    {
      colorName = colorName,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestHScrollButton.\u003CInitButton\u003Ec__Iterator243()
    {
      color = color,
      eventQuest = eventQuest,
      \u003C\u0024\u003Ecolor = color,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestHScrollButton.\u003CSetSpritePaths\u003Ec__Iterator244()
    {
      eventQuest = eventQuest,
      colorName = colorName,
      \u003C\u0024\u003EeventQuest = eventQuest,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new QuestHScrollButton.\u003CCreateSprite\u003Ec__Iterator245()
    {
      path = path,
      spriteobj = spriteobj,
      \u003C\u0024\u003Epath = path,
