...
public class ModelUnits : MonoBehaviour
{
  ...
  private IEnumerator LoadSLC3DModel()
  {
    ...
    return (IEnumerator) new ModelUnits.\u003CLoadSLC3DModel\u003Ec__IteratorB16()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CPreLoad3DModel\u003Ec__IteratorB17()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CStartCheckMemory\u003Ec__IteratorB18()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CCheckUsedMemory\u003Ec__IteratorB19()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ModelUnits.\u003CMyUpdate\u003Ec__IteratorB1A()
    {
      \u003C\u003Ef__this = this
    };
  }
