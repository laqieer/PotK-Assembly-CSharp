...
public class Battle01CommandOugi : NGBattleMenuBase, IButtonEnableBeheviour
{
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    return (IEnumerator) new Battle01CommandOugi.\u003ConInitAsync\u003Ec__Iterator90F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01CommandOugi.\u003CStart_Battle\u003Ec__Iterator910()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  protected override void Update_Battle()
  {
    ...
    if (unit.ougi.skill.target_type == BattleskillTargetType.myself && unit.skillEffects.CanUseSkill(unit.ougi.skill, (BL.ISkillEffectListUnit) unit) == 1)
    {
