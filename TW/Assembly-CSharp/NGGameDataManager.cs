...
public class NGGameDataManager : Singleton<NGGameDataManager>
{
  ...
  public LevelRewardSchemaMixin[] playerLevelRewards;
  ...
  private HashSet<string> webImageLodingSet;
  ...
  private PlayerGachaTicket[] gachaTicketList;
  ...
  public IEnumerator LoadOtherBattleAtlas()
  {
    ...
    return (IEnumerator) new NGGameDataManager.\u003CLoadOtherBattleAtlas\u003Ec__IteratorB4E()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CUnLoadOtherBattleAtlas\u003Ec__IteratorB4F()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CGetWebImage\u003Ec__IteratorB50()
    {
      url = url,
      sprite = sprite,
      \u003C\u0024\u003Eurl = url,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CLoadWebImage\u003Ec__IteratorB51()
    {
      url = url,
      \u003C\u0024\u003Eurl = url,
      \u003C\u003Ef__this = this
  ...
  private IEnumerator SaveUserInfo()
  {
    ...
    NGGameDataManager.\u003CSaveUserInfo\u003Ec__IteratorB52 infoCIteratorB52 = new NGGameDataManager.\u003CSaveUserInfo\u003Ec__IteratorB52();
    return (IEnumerator) infoCIteratorB52;
  }

  public void CacheClear() => this.webImageCache.Clear();
  ...
  protected override void Initialize()
  {
    ...
    this.webImageLodingSet = new HashSet<string>();
    this.StartCoroutine(this.SaveUserInfo());
    Consts.Update(MasterData.ConstsConstsList);
    this.InvokeRepeating("heart", 30f, 120f);
    DenaNGImageCache.CreateDir(DenaNGImageCache.GetNgCacheDir());
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGGameDataManager.\u003CStartSceneAsyncProxyImpl\u003Ec__IteratorB53()
    {
      promise = promise,
      \u003C\u0024\u003Epromise = promise,
      \u003C\u003Ef__this = this
  ...
  public bool InfoOrLoginBonusJump()
  {
    ...
    if (!this.infoThrough)
    {
      ...
      try
      {
        foreach (OfficialInformationArticle informationArticle in ((IEnumerable<OfficialInformationArticle>) this.officialInfos).Where<OfficialInformationArticle>((Func<OfficialInformationArticle, bool>) (x => !Persist.infoUnRead.Data.GetUnRead(x.id))))
        {
  ...
  public void bootFirstScene(string scene)
  {
    ...
    else if (WebAPI.LastPlayerBoot.player_during_battle)
    {
      ...
      if (this.isCallHomeUpdateAllData)
        WebAPI.HomeStartUp2().RunOn<WebAPI.Response.HomeStartUp2>((MonoBehaviour) this, (Action<WebAPI.Response.HomeStartUp2>) (_ =>
        {
          this.isCallHomeUpdateAllData = false;
          Singleton<NGBattleManager>.GetInstance().startBattle((GameCore.BattleInfo) null, WebAPI.LastPlayerBoot.continue_count);
        }));
      else
        WebAPI.HomeStartUp().RunOn<WebAPI.Response.HomeStartUp>((MonoBehaviour) this, (Action<WebAPI.Response.HomeStartUp>) (_ => Singleton<NGBattleManager>.GetInstance().startBattle((GameCore.BattleInfo) null, WebAPI.LastPlayerBoot.continue_count)));
    }
    else if (WebAPI.LastPlayerBoot.player_during_pvp)
    {
      ...
      if (this.isCallHomeUpdateAllData)
        ...
        {
          this.isCallHomeUpdateAllData = false;
          Singleton<NGBattleManager>.GetInstance().startBattle(new GameCore.BattleInfo()
          {
            pvp = true,
            pvp_restart = true,
  ...
  public bool isChangeHaveGachaTiket()
  {
    ...
    if (this.gachaTicketList != null)
    {
      foreach (PlayerGachaTicket gachaTicket1 in this.gachaTicketList)
      {
        foreach (PlayerGachaTicket gachaTicket2 in this.player.Value.gacha_tickets)
        {
          if (gachaTicket1.ticket_id == gachaTicket2.ticket_id && gachaTicket1.quantity < gachaTicket2.quantity)
          {
            this.gachaTicketList = this.player.Value.gacha_tickets;
            return true;
          }
        }
      }
  ...
  public void changeGachaTiketList() => this.gachaTicketList = this.player.Value.gacha_tickets;

  private void heart()
  {
    if (!this.homeStartUped || !ResourceManager.IsInited || !((Component) ((Component) this).transform).gameObject.activeSelf)
      return;
    this.StartCoroutine(WebAPI.SendHeart().Wait());
  }
  ...
  public class Boost
  {
    ...
    public Decimal DiscountGearCombine
    {
      get
      {
        ...
        return bonusGearCombine == null ? 1.0M : (Decimal) bonusGearCombine.increase_price;
      }
    }
    ...
    public Decimal DiscountUnitBuildup
    {
      get
      {
        ...
        return bonusUnitBuildup == null ? 1.0M : (Decimal) bonusUnitBuildup.increase_price;
      }
    }
    ...
    public Decimal DiscountUnitCompose
    {
      get
      {
        ...
        return bonusUnitCompose == null ? 1.0M : (Decimal) bonusUnitCompose.increase_price;
      }
    }
    ...
    public Decimal DiscountUnitTransmigrate
    {
      get
      {
        ...
        return unitTransmigrate == null ? 1.0M : (Decimal) unitTransmigrate.increase_price;
      }
    }
