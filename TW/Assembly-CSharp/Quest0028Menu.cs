...
public class Quest0028Menu : BackButtonMenuBase
{
  ...
  private int questType
  {
    get
    {
      ...
      if (this.convert_quest == null)
        return 0;
      return this.convert_quest.questS.data_type == QuestSConverter.DataType.Character ? 2 : 4;
    }
  }
  ...
  protected IEnumerator CallExtarDeckData(int id)
  {
    ...
    return (IEnumerator) new Quest0028Menu.\u003CCallExtarDeckData\u003Ec__Iterator2B5()
    {
      id = id,
      \u003C\u0024\u003Eid = id,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CCallStoryDeckData\u003Ec__Iterator2B6()
    {
      id = id,
      \u003C\u0024\u003Eid = id,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CCallCharaDeckData\u003Ec__Iterator2B7()
    {
      id = id,
      \u003C\u0024\u003Eid = id,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CCallConvertDeckData\u003Ec__Iterator2B8()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CInitPlayerDecks\u003Ec__Iterator2B9()
    {
  ...
  protected override void Update()
  {
    ...
    {
      if (!(deckUnitData[index] == (PlayerUnit) null) && !deckUnitData[index].is_gesut && !(deckUnitData[index].equippedGear == (PlayerItem) null) && deckUnitData[index].equippedGear.broken)
      {
        flag = true;
        break;
      }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CAddDeck\u003Ec__Iterator2BA()
    {
      prefab = prefab,
      playerDeck = playerDeck,
      friend = friend,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CStoryMovie\u003Ec__Iterator2BB()
    {
      is_new = is_new,
      act = act,
      id = id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CSetSupplyIcons\u003Ec__Iterator2BC()
    {
      SupplyList = SupplyList,
      \u003C\u0024\u003ESupplyList = SupplyList,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Menu.\u003CWaitScrollSe\u003Ec__Iterator2BD()
    {
      \u003C\u003Ef__this = this
    };
  }
