...
public class DetailMenuScrollView02 : DetailMenuScrollViewBase
{
  ...
  public override IEnumerator initAsync(PlayerUnit playerUnit, GameObject[] prefabs)
  {
    ...
    return (IEnumerator) new DetailMenuScrollView02.\u003CinitAsync\u003Ec__IteratorB0B()
    {
      prefabs = prefabs,
  ...
  [DebuggerHidden]
  private IEnumerator SetSkill(PlayerUnit playerUnit, GameObject[] prefabs)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenuScrollView02.\u003CSetSkill\u003Ec__IteratorB0C()
    {
      playerUnit = playerUnit,
      prefabs = prefabs,
      \u003C\u0024\u003EplayerUnit = playerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new DetailMenuScrollView02.\u003CCreateSkillIcon\u003Ec__IteratorB0D()
    {
      idx = idx,
