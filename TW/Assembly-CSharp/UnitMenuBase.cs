...
public class UnitMenuBase : BackButtonMenuBase
{
  ...
  public virtual void IbtnClearS() => Debug.Log((object) "click default event IbtnClearS");

  public virtual void IbtnNo() => Debug.Log((object) "click default event IbtnNo");
  ...
  public virtual void IbtnYes() => Debug.Log((object) "click default event IbtnYes");

  public virtual void IbtnYesS() => Debug.Log((object) "click default event IbtnYesS");

  public virtual void VScrollBar() => Debug.Log((object) "click default event VScrollBar");

  private bool[] CreateFilterTable()
  {
    bool[] filterTable = new bool[38];
    if (this.persist == null)
      return ((IEnumerable<bool>) filterTable).Select<bool, bool>((Func<bool, bool>) (x => true)).ToArray<bool>();
    try
    {
      for (int index = 0; index < 38; ++index)
      {
        if (index < this.persist.Data.filter.Count)
          filterTable[index] = this.persist.Data.filter[index];
        else
          filterTable.SetValue((object) true, index);
      }
    }
    catch (Exception ex)
    {
      ((IEnumerable<bool>) filterTable).ForEach<bool>((Action<bool>) (x => x = true));
    }
    return filterTable;
  }

  private UnitGroupHead GetGroupType()
  {
    return this.persist == null ? UnitGroupHead.group_all : (Enum.IsDefined(typeof (UnitGroupHead), (object) this.persist.Data.groupType) ? this.persist.Data.groupType : UnitGroupHead.group_all);
  }
  ...
  private int GetGroupID()
  {
    if (this.persist == null)
      return 1;
    if (this.persist.Data.groupID < 1)
      this.persist.Data.groupID = 1;
    return this.persist.Data.groupID;
  }

  public UnitIconInfo GetUnitInfoAll(PlayerUnit unit)
  {
    int? nullable = this.allUnitInfos.FirstIndexOrNull<UnitIconInfo>((Func<UnitIconInfo, bool>) (v => v.playerUnit != (PlayerUnit) null && v.playerUnit == unit));
  ...
  {
    int? nullable = this.displayUnitInfos.FirstIndexOrNull<UnitIconInfo>((Func<UnitIconInfo, bool>) (v => v.playerUnit != (PlayerUnit) null && v.playerUnit == unit));
    ...
    PlayerMaterialUnit[] playerMaterialUnits = null)
  {
    ...
    return (IEnumerator) new UnitMenuBase.\u003CUpdateInfoAndScroll\u003Ec__Iterator330()
    {
  ...
  private bool CheckGroup(UnitIconInfo info, UnitGroupHead groupType, int groupID)
  {
    UnitGroup groupInfo = ((IEnumerable<UnitGroup>) MasterData.UnitGroupList).FirstOrDefault<UnitGroup>((Func<UnitGroup, bool>) (x => x.unit_id == info.unit.ID));
    if (groupInfo == null)
      return false;
    if (groupType == UnitGroupHead.group_all)
      return true;
    ...
    return (groupLargeCategory != null || groupSmallCategory != null || clothingCategory != null || generationCategory != null) && (groupType == UnitGroupHead.group_large && groupLargeCategory != null && groupLargeCategory.ID == groupID || groupType == UnitGroupHead.group_small && groupSmallCategory != null && groupSmallCategory.ID == groupID || groupType == UnitGroupHead.group_clothing && clothingCategory != null && clothingCategory.ID == groupID || groupType == UnitGroupHead.group_generation && generationCategory != null && generationCategory.ID == groupID);
  }

  protected void CreateDisplayUnitInfo(bool[] filters, UnitGroupHead groupType, int groupID)
  {
    this.displayUnitInfos = this.allUnitInfos.Where<UnitIconInfo>((Func<UnitIconInfo, bool>) (x =>
    {
      if (x.removeButton)
        return true;
      return this.CheckWeaponType(x, filters) && this.CheckElementType(x, filters) && this.CheckUnitType(x, filters) && this.CheckRarity(x, filters) && this.CheckUnit(x, filters) && this.CheckLevel(x, filters) && this.CheckEquipment(x, filters) && this.CheckCompose(x, filters) && this.CheckFavorite(x, filters) && x.button_enable && this.CheckGroup(x, groupType, groupID);
    })).ToList<UnitIconInfo>();
  }
  ...
  protected virtual void Sort(SortInfo info)
  {
    ...
    this.CreateDisplayUnitInfo(info.filters, this.GetGroupType(), this.GetGroupID());
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIconRange\u003Ec__Iterator331()
    {
      value = value,
      \u003C\u0024\u003Evalue = value,
      \u003C\u003Ef__this = this
  ...
  private void UpdateSortSprite(UnitSortAndFilter.SORT_TYPES type)
  {
    ...
    if (string.IsNullOrEmpty(strArray[(int) type]))
      return;
    string name = string.Format("slc_Label_{0}.png__GUI__unit_title_short__unit_title_short_prefab", (object) strArray[(int) type]);
    UISpriteData sprite = this.SortSprite.atlas.GetSprite(name);
    this.SortSprite.spriteName = name;
...
label_23:;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIconBase\u003Ec__Iterator332()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIcon\u003Ec__Iterator333()
    {
  ...
  protected virtual void CreateUnitIconCache(int info_index, int unit_index, PlayerUnit baseUnit = null)
  {
    ...
    if (unitIcon is UnitIcon)
      ...
      unitIcon.UnitIcon.princessType.DispPrincessType(this.displayUnitInfos[info_index].pricessType);
    unitIcon.SpecialIcon = this.displayUnitInfos[info_index].isSpecialIcon;
    unitIcon.SpecialIconType = this.displayUnitInfos[info_index].specialIconType;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CLoadObjectNormal\u003Ec__Iterator334()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CLoadObjectDetail\u003Ec__Iterator335()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CLoadObject\u003Ec__Iterator336()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CCreateUnitIcon\u003Ec__Iterator337()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CInitialize\u003Ec__Iterator338()
    {
      \u003C\u003Ef__this = this
    };
  }
    ...
    int maxDispMaterialUnit)
  {
    ...
    if (playerMaterialUnits != null)
    {
      foreach (PlayerMaterialUnit playerMaterialUnit in playerMaterialUnits)
      {
        int num = maxDispMaterialUnit <= 0 ? playerMaterialUnit.quantity : Mathf.Min(maxDispMaterialUnit, playerMaterialUnit.quantity);
    ...
    if (isSpecialIcon)
    {
      ...
      if (tables.Length > 0 || unitBonus.Length > 0)
        this.allUnitInfos.ForEach((Action<UnitIconInfo>) (x =>
        {
          ...
          int? specialIconType = UnitIconBase.GetSpecialIconType(color_code);
          x.specialIconType = !specialIconType.HasValue ? 0 : specialIconType.Value;
        }));
    }
    if (this.extendFunc == null)
      return;
    ...
    int maxDispMaterialUnit = 0)
  {
    ...
    this.CreateDisplayUnitInfo(this.CreateFilterTable(), this.GetGroupType(), this.GetGroupID());
  }
  ...
  protected virtual void InitializeInfoEx(
    ...
    System.Action createAllUnitInfoExtendFunc = null)
  {
    UnitSortAndFilter.SORT_TYPES sortType = UnitSortAndFilter.SORT_TYPES.BranchOfAnArmy;
    SortAndFilter.SORT_TYPE_ORDER_BUY orderType = SortAndFilter.SORT_TYPE_ORDER_BUY.ASCENDING;
    this.persist = persistData;
    if (this.persist != null)
    {
      try
      {
        sortType = this.persist.Data.sortType;
        orderType = this.persist.Data.order;
      }
      catch (Exception ex)
      {
        this.persist.Delete();
    ...
    this.InitializeInfoEx(playerUnits, playerMaterialUnit, sortType, orderType, isEquip, removeButton, for_battle_check, princessType, bGroupUniqueMaterialUnit, isSpecialIcon, createAllUnitInfoExtendFunc);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitMenuBase.\u003CShowSortAndFilterPopup\u003Ec__Iterator339()
    {
      \u003C\u003Ef__this = this
    };
  }
