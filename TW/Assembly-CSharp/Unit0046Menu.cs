...
public class Unit0046Menu : BackButtonMenuBase
{
  ...
  private IEnumerator WaitScrollSe()
  {
    ...
    return (IEnumerator) new Unit0046Menu.\u003CWaitScrollSe\u003Ec__Iterator322()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CShouldStop\u003Ec__Iterator323()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CInit3DModelPrefab\u003Ec__Iterator324()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CModelChange\u003Ec__Iterator325()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003COneProcessDestroy\u003Ec__Iterator326()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CStartDestroyPoolableObject\u003Ec__Iterator327()
    {
      go = go,
      \u003C\u0024\u003Ego = go
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CInitPlayerDecks\u003Ec__Iterator328()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CAddDeck\u003Ec__Iterator329()
    {
      prefab = prefab,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CUpdateDeck\u003Ec__Iterator32A()
    {
      index = index,
      \u003C\u0024\u003Eindex = index,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Unit0046Menu.\u003CInitPlayerItems\u003Ec__Iterator32B()
    {
      items = items,
      \u003C\u0024\u003Eitems = items,
      \u003C\u003Ef__this = this
  ...
  public void charaActive(PlayerDeck pDeck)
  {
    ...
    foreach (PlayerUnit playerUnit in pDeck.player_units)
    {
      if (playerUnit == (PlayerUnit) null)
        ((Component) this.buttons[index]).GetComponent<Unit0046Character>().CharaSetActive(false, (string) null);
      else
        ((Component) this.buttons[index]).GetComponent<Unit0046Character>().CharaSetActive(true, playerUnit.SpecialEffectType((IEnumerable<QuestScoreBonusTimetable>) array, (IEnumerable<UnitBonus>) activeUnitBonus));
      ++index;
    }
  }
