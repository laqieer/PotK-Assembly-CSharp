...
public class Friend00819Menu : FriendBarBase
{
  ...
  private IEnumerator openPopup00893()
  {
    ...
    return (IEnumerator) new Friend00819Menu.\u003CopenPopup00893\u003Ec__Iterator51C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend00819Menu.\u003CopenPopup008202\u003Ec__Iterator51D()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend00819Menu.\u003CRefreshScroll\u003Ec__Iterator51E()
    {
      friends = friends,
      \u003C\u0024\u003Efriends = friends,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend00819Menu.\u003CInitFriendScroll\u003Ec__Iterator51F()
    {
      mode = mode,
      friends = friends,
      \u003C\u0024\u003Emode = mode,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend00819Menu.\u003CCreateScroll\u003Ec__Iterator520()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend00819Menu.\u003CRefreshFrendRequestsImpl\u003Ec__Iterator521()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator ReloadFriendRequestsData()
  {
    ...
    Friend00819Menu.\u003CReloadFriendRequestsData\u003Ec__Iterator522 dataCIterator522 = new Friend00819Menu.\u003CReloadFriendRequestsData\u003Ec__Iterator522();
    return (IEnumerator) dataCIterator522;
  }
}
