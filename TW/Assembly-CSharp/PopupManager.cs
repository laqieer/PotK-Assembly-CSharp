...
public class PopupManager : Singleton<PopupManager>
{
  ...
  private IEnumerator doDismissQueue()
  {
    ...
    return (IEnumerator) new PopupManager.\u003CdoDismissQueue\u003Ec__IteratorB45()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PopupManager.\u003CdismissWait\u003Ec__IteratorB46()
    {
      parts = parts,
      \u003C\u0024\u003Eparts = parts,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PopupManager.\u003CplayBackground\u003Ec__IteratorB47()
    {
      seconds = seconds,
      play = play,
      \u003C\u0024\u003Eseconds = seconds,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PopupManager.\u003CopenPopup00872\u003Ec__IteratorB48()
    {
      strTitle = strTitle,
