...
public class Popup02689Menu : MonoBehaviour
{
    ...
    Versus02610Menu menu)
  {
    ...
    return (IEnumerator) new Popup02689Menu.\u003CInit\u003Ec__IteratorA45()
    {
      menu = menu,
      pvpInfo = pvpInfo,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CInit\u003Ec__IteratorA46()
    {
      menu = menu,
      pvpInfo = pvpInfo,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CEffectEnd\u003Ec__IteratorA47()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartResultSeason\u003Ec__IteratorA48()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartResultRanking\u003Ec__IteratorA49()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartScroll\u003Ec__IteratorA4A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CStartScroll\u003Ec__IteratorA4B()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CCreateClassChange\u003Ec__IteratorA4C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup02689Menu.\u003CEmblemPopup\u003Ec__IteratorA4D()
    {
      \u003C\u003Ef__this = this
    };
  }
