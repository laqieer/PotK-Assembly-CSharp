...
namespace SM
{
  ...
  public class BattleEnd : KeyCompare
  {
    ...
    public BattleEnd(Dictionary<string, object> json)
    {
      ...
      foreach (object json15 in (List<object>) json[nameof (drop_material_gear_entities)])
        materialGearEntitiesList.Add(json15 != null ? new BattleEndDrop_material_gear_entities((Dictionary<string, object>) json15) : (BattleEndDrop_material_gear_entities) null);
      ...
      foreach (object json16 in (List<object>) json[nameof (drop_unit_entities)])
        dropUnitEntitiesList.Add(json16 != null ? new BattleEndDrop_unit_entities((Dictionary<string, object>) json16) : (BattleEndDrop_unit_entities) null);
      this.drop_unit_entities = dropUnitEntitiesList.ToArray();
      List<PlayerItem> playerItemList2 = new List<PlayerItem>();
      foreach (object json17 in (List<object>) json[nameof (before_player_gears)])
        playerItemList2.Add(json17 != null ? new PlayerItem((Dictionary<string, object>) json17) : (PlayerItem) null);
      this.before_player_gears = playerItemList2.ToArray();
      List<PlayerUnit> playerUnitList2 = new List<PlayerUnit>();
      foreach (object json18 in (List<object>) json[nameof (after_player_units)])
        playerUnitList2.Add(json18 != null ? new PlayerUnit((Dictionary<string, object>) json18) : (PlayerUnit) null);
      ...
      foreach (object json19 in (List<object>) json[nameof (drop_supply_entities)])
        dropSupplyEntitiesList.Add(json19 != null ? new BattleEndDrop_supply_entities((Dictionary<string, object>) json19) : (BattleEndDrop_supply_entities) null);
      ...
      foreach (object json20 in (List<object>) json[nameof (unlock_intimate_skills)])
        unlockIntimateSkillList.Add(json20 != null ? new UnlockIntimateSkill((Dictionary<string, object>) json20) : (UnlockIntimateSkill) null);
      ...
      foreach (object json21 in (List<object>) json[nameof (drop_gacha_ticket_entities)])
        gachaTicketEntitiesList.Add(json21 != null ? new BattleEndDrop_gacha_ticket_entities((Dictionary<string, object>) json21) : (BattleEndDrop_gacha_ticket_entities) null);
