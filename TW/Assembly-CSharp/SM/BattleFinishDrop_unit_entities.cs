...
// Type: SM.BattleFinishDrop_unit_entities
...
{
  [Serializable]
  public class BattleFinishDrop_unit_entities : KeyCompare
  {
    ...
    public BattleFinishDrop_unit_entities()
    {
    }

    public BattleFinishDrop_unit_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
