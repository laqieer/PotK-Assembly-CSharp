...
public class GuideUnitDeteilIndicator : MonoBehaviour
{
    ...
    PlayerUnitHistory[] historyList)
  {
    ...
    return (IEnumerator) new GuideUnitDeteilIndicator.\u003CSet\u003Ec__Iterator5A8()
    {
      unit = unit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideUnitDeteilIndicator.\u003CInitSkillDialog\u003Ec__Iterator5A9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideUnitDeteilIndicator.\u003CSetSkillIcon\u003Ec__Iterator5AA()
    {
      unit = unit,
      history = history,
      \u003C\u0024\u003Eunit = unit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideUnitDeteilIndicator.\u003CSetUnitSkill\u003Ec__Iterator5AB()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new GuideUnitDeteilIndicator.\u003CSetModel\u003Ec__Iterator5AC()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
