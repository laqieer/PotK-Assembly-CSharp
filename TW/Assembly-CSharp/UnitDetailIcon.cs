...
public class UnitDetailIcon : UnitIconBase
{
  ...
  public static IEnumerator LoadSprite(UnitUnit unit)
  {
    ...
    return (IEnumerator) new UnitDetailIcon.\u003CLoadSprite\u003Ec__IteratorBAE()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetMaterialUnit\u003Ec__IteratorBAF()
    {
      playerUnit = playerUnit,
      isNew = isNew,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetMaterialUnit\u003Ec__IteratorBB0()
    {
      playerUnit = playerUnit,
      isNew = isNew,
      playerUnits = playerUnits,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetPlayerUnit\u003Ec__IteratorBB1()
    {
      playerUnit = playerUnit,
      playerUnits = playerUnits,
      basePlayerUnit = basePlayerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetPlayerUnitEvolution\u003Ec__IteratorBB2()
    {
      playerUnit = playerUnit,
      playerUnits = playerUnits,
      basePlayerUnit = basePlayerUnit,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetUnit\u003Ec__IteratorBB3()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UnitDetailIcon.\u003CSetUnit\u003Ec__IteratorBB4()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  public void SetUnitCache(PlayerUnit unit, bool isGray = false)
  {
    ...
    this.UnitIcon.SpecialIconType = 0;
