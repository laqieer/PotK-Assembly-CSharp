...
public class Quest0028Scene : NGSceneBase
{
  ...
  public IEnumerator onStartSceneAsync()
  {
    ...
    return (IEnumerator) new Quest0028Scene.\u003ConStartSceneAsync\u003Ec__Iterator2BE()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Scene.\u003ConStartSceneAsync\u003Ec__Iterator2BF()
    {
      friend = friend,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Scene.\u003ConStartSceneAsync\u003Ec__Iterator2C0()
    {
      friend = friend,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Scene.\u003ConStartSceneAsync\u003Ec__Iterator2C1()
    {
      friend = friend,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Scene.\u003ConStartSceneAsync\u003Ec__Iterator2C2()
    {
      friend = friend,
      quest = quest,
      \u003C\u0024\u003Efriend = friend,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0028Scene.\u003ConStartSceneAsync\u003Ec__Iterator2C3()
    {
      story_quest = story_quest,
      extra_quest = extra_quest,
      char_quest = char_quest,
