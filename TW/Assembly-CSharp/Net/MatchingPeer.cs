...
namespace Net
{
  public class MatchingPeer : Peer
  {
      ...
      Promise<MatchingPeer.ReceivedMessage> promise)
    {
      ...
      return (IEnumerator) new MatchingPeer.\u003CReceiveUntilF\u003Ec__IteratorB75()
      {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new MatchingPeer.\u003CReceiveTypeE\u003Ec__IteratorB76()
      {
        timeoutMilliseconds = timeoutMilliseconds,
        promise = promise,
        \u003C\u0024\u003EtimeoutMilliseconds = timeoutMilliseconds,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new MatchingPeer.\u003CSendNothrowE\u003Ec__IteratorB77()
      {
        send = send,
        promise = promise,
        \u003C\u0024\u003Esend = send,
