...
public class Popup002261Menu : MonoBehaviour
{
    ...
    System.Action act)
  {
    ...
    return (IEnumerator) new Popup002261Menu.\u003CInit\u003Ec__Iterator9F3()
    {
      act = act,
      menu = menu,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup002261Menu.\u003CEffectEnd\u003Ec__Iterator9F4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup002261Menu.\u003CStartResult\u003Ec__Iterator9F5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Popup002261Menu.\u003CStartScroll\u003Ec__Iterator9F6()
    {
      \u003C\u003Ef__this = this
    };
  }
