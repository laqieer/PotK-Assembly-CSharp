...
public class EffectController : MonoBehaviour
{
  ...
  protected IEnumerator SetTextureGearBasic(int gear_id, MeshRenderer mesh_renderer)
  {
    ...
    return (IEnumerator) new EffectController.\u003CSetTextureGearBasic\u003Ec__Iterator46D()
    {
      gear_id = gear_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CSetTextureGearThum\u003Ec__Iterator46E()
    {
      gear_id = gear_id,
      mesh_renderer = mesh_renderer,
      \u003C\u0024\u003Egear_id = gear_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CSetTextureSupplyThum\u003Ec__Iterator46F()
    {
      supply_id = supply_id,
      mesh_renderer = mesh_renderer,
      \u003C\u0024\u003Esupply_id = supply_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CSetTexture\u003Ec__Iterator470()
    {
      sprite = sprite,
      mesh_renderer = mesh_renderer,
      \u003C\u0024\u003Esprite = sprite,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CSetTextureUnit\u003Ec__Iterator471()
    {
      unit_id = unit_id,
      mesh_renderer = mesh_renderer,
      \u003C\u0024\u003Eunit_id = unit_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CSetTextureUnitThum\u003Ec__Iterator472()
    {
      unit_id = unit_id,
      mesh_renderer = mesh_renderer,
      \u003C\u0024\u003Eunit_id = unit_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CSetTextureUnitCutin\u003Ec__Iterator473()
    {
      unit_id = unit_id,
      mesh_renderer = mesh_renderer,
      \u003C\u0024\u003Eunit_id = unit_id,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CCreateModel\u003Ec__Iterator474()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new EffectController.\u003CSetAnimator\u003Ec__Iterator475()
    {
      animator = animator,
      \u003C\u0024\u003Eanimator = animator,
      \u003C\u003Ef__this = this
  ...
  protected void SetAoriEffect(List<GameObject> obj_list, string[] anim_pattern)
  {
    foreach (string key in anim_pattern)
    {
      if (key != null)
      {
        ...
        if (EffectController.\u003C\u003Ef__switch\u0024map15 == null)
        {
          // ISSUE: reference to a compiler-generated field
          EffectController.\u003C\u003Ef__switch\u0024map15 = new Dictionary<string, int>(3)
          {
            {
              "blue",
              0
        ...
        int num;
        // ISSUE: reference to a compiler-generated field
        if (EffectController.\u003C\u003Ef__switch\u0024map15.TryGetValue(key, out num))
        {
          switch (num)
          {
            case 0:
