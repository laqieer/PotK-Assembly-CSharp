...
public class GuildApplicantsBarBase : BackButtonMenuBase
{
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    return (IEnumerator) new GuildApplicantsBarBase.\u003CCreateScrollBase\u003Ec__Iterator7A6()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  protected virtual IEnumerator CreateScroll(int info_index, int bar_index)
  {
    ...
    GuildApplicantsBarBase.\u003CCreateScroll\u003Ec__Iterator7A7 scroll = new GuildApplicantsBarBase.\u003CCreateScroll\u003Ec__Iterator7A7();
