...
public class DLC
{
  ...
  public DLC(ResourceInfo resourceInfo, string[] paths, bool fileCheckDisable = false, bool fromLocal = false)
  {
    ...
    {
      foreach (string str in new HashSet<string>((IEnumerable<string>) paths).Shuffle<string>().ToArray<string>())
      {
        ResourceInfo.Resource resource = ResourceInfo.SearchResourceInfo(str, resourceInfo);
  ...
  public static string ResourceDirectory(string type)
  {
    ...
    {
      case "ab":
        return StorageUtil.persistentDataPath + "/cache/ab/";
      case "sa":
        return StorageUtil.persistentDataPath + "/cache/sa/";
      default:
  ...
  public static string ResourceTempDirectory => StorageUtil.temporaryCachePath + "/";
  ...
  {
    return (!includesExistFile ? 0L : this.GetDownloadSize(true) - this.GetDownloadSize()) + ((IEnumerable<DLC.Consumer>) this.consumers).Sum<DLC.Consumer>((Func<DLC.Consumer, long>) (x => (long) x.Downloaded)) + (long) this.GetDownloadingLoadedSize();
  }
  ...
  {
    return this.dataDic.Where<KeyValuePair<string, DLC.Data>>((Func<KeyValuePair<string, DLC.Data>, bool>) (x => includesExistFile || !x.Value.Exists)).Sum<KeyValuePair<string, DLC.Data>>((Func<KeyValuePair<string, DLC.Data>, long>) (x => (long) x.Value.DownloadSize));
  }

  public long GetStoredSize(bool includesExistFile = false)
  {
    return (!includesExistFile ? 0L : this.GetStoreSize(true) - this.GetStoreSize()) + ((IEnumerable<DLC.Consumer>) this.consumers).Sum<DLC.Consumer>((Func<DLC.Consumer, long>) (x => (long) x.Stored));
  }

  public long GetStoreSize(bool includesExistFile = false)
  {
    return this.dataDic.Where<KeyValuePair<string, DLC.Data>>((Func<KeyValuePair<string, DLC.Data>, bool>) (x => includesExistFile || !x.Value.Exists)).Sum<KeyValuePair<string, DLC.Data>>((Func<KeyValuePair<string, DLC.Data>, long>) (x => (long) x.Value.StoreSize));
  }
  ...
  public IEnumerator Start(MonoBehaviour mono)
  {
    ...
    return (IEnumerator) new DLC.\u003CStart\u003Ec__IteratorBC3()
    {
      mono = mono,
      \u003C\u0024\u003Emono = mono,
      \u003C\u003Ef__this = this
  ...
  private class WWWWrapper : DLC.WWWFile
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new DLC.WWWWrapper.\u003CWait\u003Ec__IteratorBC4()
      {
        \u003C\u003Ef__this = this
      };
    }
      ...
      this.thread = new Thread((ThreadStart) (() =>
      {
        try
        {
          ...
          using (TcpClient tcpClient = new TcpClient())
          {
            ...
            wwwStreamFile.WriteHeaderTo(stream2, uri);
            wwwStreamFile.ReadFromStream(stream2);
            using (FileStream fileStream = File.Create(wwwStreamFile.tmPath))
            {
              ...
              for (; contentLength > 0; contentLength -= num1)
              {
                ...
                {
                  int num2 = stream2.Read(numArray, num1, Math.Min(numArray.Length - num1, contentLength));
                  num1 += num2;
...
label_3:;
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new DLC.WWWStreamFile.\u003CWait\u003Ec__IteratorBC5()
      {
        \u003C\u003Ef__this = this
      };
    }
  ...
  private class Consumer : IDisposable
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new DLC.Consumer.\u003CRun_\u003Ec__IteratorBC6()
      {
        \u003C\u003Ef__this = this
      };
    }
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new DLC.Consumer.\u003CRun\u003Ec__IteratorBC7()
      {
        \u003C\u003Ef__this = this
      };
    }
