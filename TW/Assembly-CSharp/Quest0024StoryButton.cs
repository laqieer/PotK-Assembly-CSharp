...
public class Quest0024StoryButton : MonoBehaviour
{
  ...
  public IEnumerator InitButton(bool hard)
  {
    ...
    return (IEnumerator) new Quest0024StoryButton.\u003CInitButton\u003Ec__Iterator2A5()
    {
      hard = hard,
      \u003C\u0024\u003Ehard = hard,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0024StoryButton.\u003CSetSpritePaths\u003Ec__Iterator2A6()
    {
      hard = hard,
      \u003C\u0024\u003Ehard = hard,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest0024StoryButton.\u003CCreateSprite\u003Ec__Iterator2A7()
    {
      path = path,
      spriteobj = spriteobj,
      \u003C\u0024\u003Epath = path,
