...
public class TutorialRoot : Singleton<TutorialRoot>
{
  ...
  private IEnumerator startTutorial()
  {
    ...
    return (IEnumerator) new TutorialRoot.\u003CstartTutorial\u003Ec__Iterator877()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TutorialRoot.\u003Cinit\u003Ec__Iterator878()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TutorialRoot.\u003CsignUpLoop\u003Ec__Iterator879()
    {
      callback = callback,
      \u003C\u0024\u003Ecallback = callback,
      \u003C\u003Ef__this = this
  ...
  {
    if (env.phaseState.state == BL.Phase.finalize && !env.battleInfo.pvp && !env.battleInfo.gvg && !env.battleInfo.isEarthMode && env.battleInfo.isFirstAllDead && env.allDeadUnitsp(BL.ForceID.player))
    {
      Singleton<NGBattleManager>.GetInstance().isBattleEnable = false;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TutorialRoot.\u003ConBattleStateChange\u003Ec__Iterator87A()
    {
      state = state,
      turn = turn,
      \u003C\u0024\u003Estate = state,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new TutorialRoot.\u003CbulkDownLoadCheck\u003Ec__Iterator87B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private IEnumerator doBulkDownload()
  {
    ...
    TutorialRoot.\u003CdoBulkDownload\u003Ec__Iterator87C downloadCIterator87C = new TutorialRoot.\u003CdoBulkDownload\u003Ec__Iterator87C();
    return (IEnumerator) downloadCIterator87C;
  }
