...
public class Gacha0065Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Shot()
  {
    ...
    return (IEnumerator) new Gacha0065Menu.\u003CShot\u003Ec__Iterator44A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void ChangeBonusMode(int? bonusCountDown, int lostCristal)
  {
    ...
    string text1 = Consts.Format(Consts.GetInstance().GACHA_0065MENU_DESCRIPTION01, (IDictionary) new Hashtable()
    {
      {
        (object) "lostcrystal",
