...
public class BattleUI05PunitiveExpeditionMenu : ResultMenuBase
{
  ...
  private IEnumerator LoadResources()
  {
    ...
    return (IEnumerator) new BattleUI05PunitiveExpeditionMenu.\u003CLoadResources\u003Ec__Iterator978()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  private void InitTargetPoint(EventBattleFinish eventInfo)
  {
    ...
    GameObject gameObject1 = this.DirHuntingTargetPT.Clone();
    gameObject1.GetComponent<BattleUI05PunitiveExpeditionTargetScroll>().Init(eventInfo.bonus_rate);
    this.scrollContiner.Add(gameObject1);
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05PunitiveExpeditionMenu.\u003CInit\u003Ec__Iterator979()
    {
      result = result,
      index = index,
      \u003C\u0024\u003Eresult = result,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05PunitiveExpeditionMenu.\u003CRun\u003Ec__Iterator97A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleUI05PunitiveExpeditionMenu.\u003CWaitForTapping\u003Ec__Iterator97B()
    {
      \u003C\u003Ef__this = this
    };
  }
