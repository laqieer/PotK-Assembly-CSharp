...
public class UI3DModel : MonoBehaviour
{
  ...
  public IEnumerator UnitEdit(PlayerUnit pu)
  {
    ...
    return (IEnumerator) new UI3DModel.\u003CUnitEdit\u003Ec__Iterator461()
    {
      pu = pu,
      \u003C\u0024\u003Epu = pu,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModel.\u003CUnit\u003Ec__Iterator462()
    {
      pu = pu,
      callback = callback,
      \u003C\u0024\u003Epu = pu,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModel.\u003CHistoryUnit\u003Ec__Iterator463()
    {
      unit = unit,
      \u003C\u0024\u003Eunit = unit,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModel.\u003CPickUpUnit\u003Ec__Iterator464()
    {
      uu = uu,
      \u003C\u0024\u003Euu = uu,
      \u003C\u003Ef__this = this
  ...
  private void AnimAction()
  {
    ...
    Debug.Log((object) ("Play State Name = " + str));
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new UI3DModel.\u003CCenterRotate\u003Ec__Iterator465()
    {
      \u003C\u003Ef__this = this
    };
  }
