...
namespace LuaInterface
{
  ...
  public class LuaDLL
  {
    ...
    public static int lua_upvalueindex(int i) => LuaIndexes.LUA_GLOBALSINDEX - i;
    ...
    public static int luaL_getn(IntPtr luaState, int i) => LuaDLL.lua_objlen(luaState, i);
    ...
    public static IntPtr lua_open() => LuaDLL.luaL_newstate();
    ...
    public static int luaL_dostring(IntPtr luaState, string chunk)
    {
      ...
      return num != 0 ? num : LuaDLL.lua_pcall(luaState, 0, -1, 0);
    }
    ...
    {
      return lockRef != 0 ? LuaDLL.luaL_ref(luaState, LuaIndexes.LUA_REGISTRYINDEX) : 0;
    }
    ...
    {
      IntPtr pointerForDelegate = Marshal.GetFunctionPointerForDelegate((Delegate) function);
      LuaDLL.lua_pushcclosure(luaState, pointerForDelegate, n);
    }
    ...
    {
      byte[] numArray = new byte[strlen];
      Marshal.Copy(source, numArray, 0, strlen);
    ...
    {
      int strLen;
      IntPtr num = LuaDLL.lua_tolstring(luaState, index, out strLen);
      return num != IntPtr.Zero ? Marshal.PtrToStringAnsi(num, strLen) ?? LuaDLL.AnsiToUnicode(num, strLen) : (string) null;
    }
    ...
    [DllImport("ulua", CallingConvention = CallingConvention.Cdecl)]
    public static extern void tolua_getfloat2(
      IntPtr luaState,
      int reference,
      int stack,
      ref float x,
    ...
    [DllImport("ulua", CallingConvention = CallingConvention.Cdecl)]
    public static extern void tolua_getfloat3(
      IntPtr luaState,
      int reference,
      int stack,
      ref float x,
    ...
    [DllImport("ulua", CallingConvention = CallingConvention.Cdecl)]
    public static extern void tolua_getfloat4(
      IntPtr luaState,
      int reference,
      int stack,
      ref float x,
    ...
    [DllImport("ulua", CallingConvention = CallingConvention.Cdecl)]
    public static extern void tolua_getfloat6(
      IntPtr luaState,
      int reference,
      int stack,
      ref float x,
    ...
    [DllImport("ulua", CallingConvention = CallingConvention.Cdecl)]
    public static extern void tolua_pushfloat3(
      IntPtr luaState,
      int reference,
      float x,
      float y,
    ...
    [DllImport("ulua", CallingConvention = CallingConvention.Cdecl)]
    public static extern void tolua_pushfloat4(
      IntPtr luaState,
      int reference,
      float x,
      float y,
    ...
    [DllImport("ulua", CallingConvention = CallingConvention.Cdecl)]
    public static extern bool tolua_pushnewudata(
      IntPtr L,
      int metaRef,
      int weakTableRef,
      int index);
