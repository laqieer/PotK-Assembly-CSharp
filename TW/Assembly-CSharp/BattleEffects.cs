...
public class BattleEffects : BattleMonoBehaviour
{
  ...
  protected override IEnumerator Start_Battle()
  {
    ...
    return (IEnumerator) new BattleEffects.\u003CStart_Battle\u003Ec__IteratorA7C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BattleEffects.\u003CdoFieldEffect\u003Ec__IteratorA7D()
    {
      delay = delay,
      prefab = prefab,
      t = t,
      ...
      if (Object.op_Inequality((Object) invokedEffectPrefab, (Object) null) && invokedTargetUnits != null)
      {
        ...
        this.btm.setScheduleAction((System.Action) (() =>
        {
          foreach (BL.Unit invokedTargetUnit in invokedTargetUnits)
            this.execFieldEffect(invokedEffectPrefab, ((Component) this.env.unitResource[invokedTargetUnit].gameObject.GetComponent<UnitUpdate>()).transform);
  ...
  public void skillFieldEffectStart(BL.Unit unit, BL.Skill skill, List<BL.Unit> targets)
  {
    ...
    this.skillFieldEffectStartCore(skill.skill.field_effect, unit, targets, skillResource.effectPrefab, skillResource.invokedEffectPrefab, skillResource.targetEffectPrefab, (System.Action) null, (System.Action) null, new List<BL.Unit>()
    {
      unit
    });
  }
  ...
  private class StartEffect : ScheduleEnumerator
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new BattleEffects.StartEffect.\u003CdoBody\u003Ec__IteratorA7E()
      {
        \u003C\u003Ef__this = this
      };
    }
