...
public class PopupPvpStart : MonoBehaviour
{
    ...
    string eGuild = null)
  {
    ...
    return (IEnumerator) new PopupPvpStart.\u003CInitialize\u003Ec__IteratorA57()
    {
      pName = pName,
      pEmblem = pEmblem,
      pGuild = pGuild,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new PopupPvpStart.\u003CInitialize\u003Ec__IteratorA58()
    {
      pName = pName,
      pEmblem = pEmblem,
      pGuild = pGuild,
  ...
  private class PopupPvpStartObject
  {
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PopupPvpStart.PopupPvpStartObject.\u003CSetData\u003Ec__IteratorA59()
      {
        name = name,
        guild = guild,
        emblem = emblem,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PopupPvpStart.PopupPvpStartObject.\u003CCreateUnitsThumPlayer\u003Ec__IteratorA5A()
      {
        units = units,
        prefab = prefab,
        \u003C\u0024\u003Eunits = units,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PopupPvpStart.PopupPvpStartObject.\u003CCreateUnitsThumEnemy\u003Ec__IteratorA5B()
      {
        units = units,
        prefab = prefab,
        \u003C\u0024\u003Eunits = units,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PopupPvpStart.PopupPvpStartObject.\u003CCreateUnitsThumPlayerDebug\u003Ec__IteratorA5C()
      {
        units = units,
        prefab = prefab,
        \u003C\u0024\u003Eunits = units,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PopupPvpStart.PopupPvpStartObject.\u003CCreateUnitsThumEnemyDebug\u003Ec__IteratorA5D()
      {
        units = units,
        prefab = prefab,
        \u003C\u0024\u003Eunits = units,
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new PopupPvpStart.PopupPvpStartObject.\u003CCreateUnitThum\u003Ec__IteratorA5E()
      {
        prefab = prefab,
        parent = parent,
        id = id,
