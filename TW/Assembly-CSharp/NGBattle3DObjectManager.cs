...
public class NGBattle3DObjectManager : BattleManagerBase
{
  ...
  public string buttonPrefab_loading_path = "Prefabs/filed_3d_icon/3dicon_botan_loading";
  ...
  public IEnumerator loadStage(BE env, bool setOthers = true)
  {
    ...
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadStage\u003Ec__IteratorA99()
    {
      env = env,
      setOthers = setOthers,
      \u003C\u0024\u003Eenv = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadUnitResources\u003Ec__IteratorA9A()
    {
      env = env,
      \u003C\u0024\u003Eenv = env,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003Cinitialize\u003Ec__IteratorA9B()
    {
      env_ = env_,
      \u003C\u0024\u003Eenv_ = env_,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003Ccleanup\u003Ec__IteratorA9C()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CinitializePanels\u003Ec__IteratorA9D()
    {
      env = env,
      root = root,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CcreatePanels\u003Ec__IteratorA9E()
    {
      env = env,
      setOthers = setOthers,
      root = root,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003Cspawns\u003Ec__IteratorA9F()
    {
      units = units,
      wait = wait,
      \u003C\u0024\u003Eunits = units,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadSkillResource\u003Ec__IteratorAA0()
    {
      env = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadSkillResource\u003Ec__IteratorAA1()
    {
      skill = skill,
      env = env,
      \u003C\u0024\u003Eskill = skill,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadAilmentSkillResource\u003Ec__IteratorAA2()
    {
      env = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadItemResource\u003Ec__IteratorAA3()
    {
      env = env,
      item = item,
      \u003C\u0024\u003Eenv = env,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadMagicBulletResource\u003Ec__IteratorAA4()
    {
      mb = mb,
      env = env,
      \u003C\u0024\u003Emb = mb,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGBattle3DObjectManager.\u003CloadUnitResource\u003Ec__IteratorAA5()
    {
      env = env,
      unit = unit,
      \u003C\u0024\u003Eenv = env,
