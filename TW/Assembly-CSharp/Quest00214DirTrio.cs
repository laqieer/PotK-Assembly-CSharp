...
public class Quest00214DirTrio : MonoBehaviour
{
    ...
    Action<int, int[], int> buttonEvent = null)
  {
    ...
    return (IEnumerator) new Quest00214DirTrio.\u003CInitStoryPlayBack\u003Ec__Iterator1E7()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214DirTrio.\u003CInit\u003Ec__Iterator1E8()
    {
      questSTable = questSTable,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00214DirTrio.\u003CSetUnitIcon\u003Ec__Iterator1E9()
    {
      unit = unit,
