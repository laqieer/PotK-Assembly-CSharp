...
public class Shop00723PopupExchangeMenu : BackButtonMenuBase
{
  ...
  public IEnumerator coInitialize(
    Shop00723Menu menu,
    UnitTicketUnitSample unitSample,
    PlayerUnitTicketSummary ticket)
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00723PopupExchangeMenu.\u003CcoInitialize\u003Ec__Iterator4BB()
    {
      menu = menu,
  ...
  public void onPopupValueChanged()
  {
    ...
    if (!this.popupType_.items.Contains(this.popupValue_.text))
      this.btnOk_.isEnabled = this.isOK_;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00723PopupExchangeMenu.\u003CwaitPopupClose\u003Ec__Iterator4BC()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void onClickOk()
  {
    ...
    this.menu_.doExchangeUnit(!this.isTypeSelectable_ ? UnitTypeEnum.random : ((IEnumerable<MasterDataTable.UnitType>) MasterData.UnitTypeList).First<MasterDataTable.UnitType>((Func<MasterDataTable.UnitType, bool>) (ut => ut.name.Equals(this.popupValue_.text))).Enum);
  }
