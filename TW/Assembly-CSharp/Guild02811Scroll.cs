...
public class Guild02811Scroll : MonoBehaviour
{
  ...
  public IEnumerator Initialize(GuildDirectory guildData, GuildInfoPopup popup, bool IsApply)
  {
    ...
    return (IEnumerator) new Guild02811Scroll.\u003CInitialize\u003Ec__Iterator707()
    {
      IsApply = IsApply,
      guildData = guildData,
      popup = popup,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02811Scroll.\u003CSetGuildData\u003Ec__Iterator708()
    {
      data = data,
      \u003C\u0024\u003Edata = data,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02811Scroll.\u003CShowGuildInfo\u003Ec__Iterator709()
    {
      \u003C\u003Ef__this = this
    };
  }
