...
public class Startup00010MiniGame : MonoBehaviour
{
  ...
  public IEnumerator BonusScoreCutin(int score)
  {
    ...
    return (IEnumerator) new Startup00010MiniGame.\u003CBonusScoreCutin\u003Ec__Iterator18E()
    {
      score = score,
      \u003C\u0024\u003Escore = score,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Startup00010MiniGame.\u003CScoreCutin\u003Ec__Iterator18F()
    {
      score = score,
      \u003C\u0024\u003Escore = score,
      \u003C\u003Ef__this = this
  ...
  private void Update()
  {
    ...
    float f = (float) ((double) Mathf.Min(num2, num1) / (double) num1 * 100.0);
    if (float.IsNaN(f))
      f = 0.0f;
    ...
    int num3 = (int) (((double) f - 4.0) / 10.0);
    ...
    this.dlc_gauge.SetTextLocalize(string.Format("{0:F} ％", (object) f));
    this.slc_dlc_gauge.setValue(Mathf.FloorToInt(f), 100, false);
