...
public static class WebQueue
{
  ...
  public static IEnumerator RunWorkerMobage()
  {
    ...
    WebQueue.\u003CRunWorkerMobage\u003Ec__IteratorC0A mobageCIteratorC0A = new WebQueue.\u003CRunWorkerMobage\u003Ec__IteratorC0A();
    return (IEnumerator) mobageCIteratorC0A;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new WebQueue.\u003CprocessQueueMobage\u003Ec__IteratorC0B()
    {
      queue = queue,
      \u003C\u0024\u003Equeue = queue
    };
  ...
  private static void reloginBySessionInvalid()
  {
    ...
    ModalWindow.Show(Consts.GetInstance().prompt, Consts.GetInstance().login_failure_back, (System.Action) (() => SDK.instance.LogOut(true)));
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new WebQueue.\u003CcallFailCallback\u003Ec__IteratorC0C()
    {
      error = error,
      \u003C\u0024\u003Eerror = error
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new WebQueue.\u003CdefaultFailCallback\u003Ec__IteratorC0D()
    {
      error = error,
      \u003C\u0024\u003Eerror = error
    };
