...
public class Friend0081Menu : FriendBarBase
{
  ...
  private IEnumerator BackSceneAsync()
  {
    ...
    return (IEnumerator) new Friend0081Menu.\u003CBackSceneAsync\u003Ec__Iterator507()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend0081Menu.\u003CUpdateList\u003Ec__Iterator508()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend0081Menu.\u003CInitFriendScroll\u003Ec__Iterator509()
    {
      friends = friends,
      \u003C\u0024\u003Efriends = friends,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Friend0081Menu.\u003CCreateScroll\u003Ec__Iterator50A()
    {
