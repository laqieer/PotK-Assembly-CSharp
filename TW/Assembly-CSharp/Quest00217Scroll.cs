...
public class Quest00217Scroll : BannerBase
{
  ...
  public virtual IEnumerator InitScroll(Quest00217Scroll.Parameter param, DateTime serverTime)
  {
    ...
    return (IEnumerator) new Quest00217Scroll.\u003CInitScroll\u003Ec__Iterator217()
    {
      param = param,
  ...
  protected string SetSpritePath(int L, int M, string seek_index)
  {
    bool flag = seek_index == "m" || seek_index == nameof (M);
    int id = !flag ? L : M;
    int tmp = !flag ? 0 : 1;
    BannerBase.Type type = BannerBase.Type.quest;
    return BannerBase.GetSpriteIdlePath(id, type, tmp);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00217Scroll.\u003CSetAndCreate_BannerSprite\u003Ec__Iterator218()
    {
      path = path,
      obj = obj,
      \u003C\u0024\u003Epath = path,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00217Scroll.\u003CQuestTimeCompare\u003Ec__Iterator219()
    {
      serverTime = serverTime,
      StageData = StageData,
      seekIndex = seekIndex,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Quest00217Scroll.\u003CcoWaitEffectNoDescription\u003Ec__Iterator21A()
    {
      animator = animator,
