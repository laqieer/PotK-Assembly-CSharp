...
public class NGDuelManager : MonoBehaviour
{
  ...
  public static void actScreen(bool darken = true)
  {
    ...
    instance.isActiveBlackBGPanel = false;
    instance.ShowLoadingTips(darken);
  }
  ...
  public IEnumerator Initialize(DuelResult duelResult, DuelEnvironment duelEnv)
  {
    ...
    return (IEnumerator) new NGDuelManager.\u003CInitialize\u003Ec__Iterator8B1()
    {
  ...
  private bool checkPostInitialized()
  {
    if (Object.op_Inequality((Object) null, (Object) this.mRoot3d))
    {
      ...
      if (children == null)
      {
        Debug.LogError((object) "NGDuelUnit checkPostInitialized DuelRoot3D里没有人");
        return false;
      }
      int num = 0;
      ...
      if (num == 3)
      {
        Debug.Log((object) "NGDuelUnit checkPostInitialized clone是3个");
        return true;
      }
      Debug.LogError((object) ("NGDuelUnit checkPostInitialized cloneは" + (object) num + "个"));
      return false;
    }
    Debug.LogError((object) "NGDuelUnit checkPostInitialized DuelRoot3D是NULL");
    return false;
  }
  ...
  private bool checkPreInitialized()
  {
    if (Object.op_Inequality((Object) null, (Object) this.mRoot3d))
    {
      ...
      if (children == null)
      {
        Debug.LogError((object) "NGDuelUnit checkPreInitialized DuelRoot3D里没有人");
        return false;
      }
      int num = 0;
      foreach (Component component in children)
      ...
      if (num == 0)
      {
        Debug.Log((object) "NGDuelUnit checkPreInitialized clone是0个");
        return true;
      }
      Debug.LogError((object) ("NGDuelUnit checkPreInitialized clone为" + (object) num + "个"));
      return false;
    }
    Debug.LogError((object) "NGDuelUnit checkPreInitialized DuelRoot3D是NULL");
    return false;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CmakePlayerUnit\u003Ec__Iterator8B2()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CmakeEnemyUnit\u003Ec__Iterator8B3()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CwaitCurrentStatusEnd\u003Ec__Iterator8B4()
    {
      duration = duration,
      status = status,
      \u003C\u0024\u003Eduration = duration,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CstartDuelStartAnimation\u003Ec__Iterator8B5()
    {
      duration = duration,
      status = status,
      \u003C\u0024\u003Eduration = duration,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CwaitBossFirstCameraEnd\u003Ec__Iterator8B6()
    {
      duration = duration,
      \u003C\u0024\u003Eduration = duration,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CcreateMap\u003Ec__Iterator8B7()
    {
      stage = stage,
      \u003C\u0024\u003Estage = stage,
      \u003C\u003Ef__this = this
  ...
  private IEnumerator preloadDuelUnitObject()
  {
    ...
    NGDuelManager.\u003CpreloadDuelUnitObject\u003Ec__Iterator8B8 objectCIterator8B8 = new NGDuelManager.\u003CpreloadDuelUnitObject\u003Ec__Iterator8B8();
    return (IEnumerator) objectCIterator8B8;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new NGDuelManager.\u003CpreloadEffect\u003Ec__Iterator8B9()
    {
      \u003C\u003Ef__this = this
    };
  }
      ...
      if (turn.attackerAilmentEffects != null)
      {
        foreach (BattleskillAilmentEffect attackerAilmentEffect in turn.attackerAilmentEffects)
        {
          if (!string.IsNullOrEmpty(attackerAilmentEffect.duel_effect_name))
            stringSet.Add(attackerAilmentEffect.duel_effect_name);
        }
      }
      if (turn.defenderConsumeSkillEffects != null && turn.defenderConsumeSkillEffects.Any<BL.SkillEffect>((Func<BL.SkillEffect, bool>) (x => x.effect.effect_logic.Enum == BattleskillEffectLogicEnum.absolute_defense)))
        stringSet.Add("ef120_holy_shield_s");
    }
