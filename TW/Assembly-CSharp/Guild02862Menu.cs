...
public class Guild02862Menu : BackButtonMenuBase
{
  ...
  public IEnumerator InitializeAsync()
  {
    ...
    return (IEnumerator) new Guild02862Menu.\u003CInitializeAsync\u003Ec__Iterator7C4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02862Menu.\u003CResourceLoad\u003Ec__Iterator7C5()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02862Menu.\u003CCreateItemIconForInitialize\u003Ec__Iterator7C6()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02862Menu.\u003CloadThumb\u003Ec__Iterator7C7()
    {
      itemIcon = itemIcon,
      parent = parent,
      \u003C\u0024\u003EitemIcon = itemIcon,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02862Menu.\u003CInitGiftList\u003Ec__Iterator7C8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02862Menu.\u003CSetItem\u003Ec__Iterator7C9()
    {
      iconInfo = iconInfo,
      \u003C\u0024\u003EiconInfo = iconInfo,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Guild02862Menu.\u003CShowDetailPopup\u003Ec__Iterator7CA()
    {
      giftInfo = giftInfo,
      \u003C\u0024\u003EgiftInfo = giftInfo,
      \u003C\u003Ef__this = this
  ...
  private void onLongPressIcon(Guild02862Menu.GiftIconInfo giftInfo)
  {
    if (this.IsPushAndSet())
      return;
    if (giftInfo.gift.reward_type_id == 1 || giftInfo.gift.reward_type_id == 24 || giftInfo.gift.reward_type_id == 3 || giftInfo.gift.reward_type_id == 26 || giftInfo.gift.reward_type_id == 2 || giftInfo.gift.reward_type_id == 19 || giftInfo.gift.reward_type_id == 21)
