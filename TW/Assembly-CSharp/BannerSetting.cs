...
public class BannerSetting : BannerBase
{
  ...
  public IEnumerator Init(Banner banner, BannersProc parent, DateTime serverTime)
  {
    ...
    return (IEnumerator) new BannerSetting.\u003CInit\u003Ec__Iterator9D4()
    {
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BannerSetting.\u003ConBannerEventConnection\u003Ec__Iterator9D5()
    {
      banner = banner,
      type = type,
      \u003C\u0024\u003Ebanner = banner,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BannerSetting.\u003CLoadAndSetImage\u003Ec__Iterator9D6()
    {
      banner = banner,
      \u003C\u0024\u003Ebanner = banner,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new BannerSetting.\u003CSetTransition\u003Ec__Iterator9D7()
    {
      banner = banner,
      parent = parent,
      \u003C\u0024\u003Ebanner = banner,
