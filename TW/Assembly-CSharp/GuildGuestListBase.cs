...
public class GuildGuestListBase : BackButtonMenuBase
{
  ...
  protected void ScrollUpdate()
  {
    ...
    do
    {
      ...
      foreach (GameObject gameObject in this.scroll)
      {
        ...
        {
          int info_index = !nullable.HasValue ? this.allGuestInfo.Count : nullable.Value + this.MaxValue;
  ...
  protected IEnumerator CreateScrollBase(GameObject prefab)
  {
    ...
    return (IEnumerator) new GuildGuestListBase.\u003CCreateScrollBase\u003Ec__Iterator70A()
    {
      prefab = prefab,
      \u003C\u0024\u003Eprefab = prefab,
      \u003C\u003Ef__this = this
  ...
  protected virtual IEnumerator CreateScroll(int info_index, int bar_index)
  {
    ...
    GuildGuestListBase.\u003CCreateScroll\u003Ec__Iterator70B scroll = new GuildGuestListBase.\u003CCreateScroll\u003Ec__Iterator70B();
