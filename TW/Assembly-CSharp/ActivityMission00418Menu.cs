...
public class ActivityMission00418Menu : BackButtonMenuBase
{
  ...
  private IEnumerator detailedPopup()
  {
    ...
    return (IEnumerator) new ActivityMission00418Menu.\u003CdetailedPopup\u003Ec__Iterator2D4()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  public void purchase()
  {
    ...
    PopupManager.ShowYesNo(Consts.GetInstance().fund_title, string.Format(Consts.GetInstance().fund_content, (object) this.fundNeed), new System.Action(this.YesBtn), (System.Action) (() => { }));
  }
  ...
  private IEnumerator popup99931()
  {
    ...
    ActivityMission00418Menu.\u003Cpopup99931\u003Ec__Iterator2D5 popup99931CIterator2D5 = new ActivityMission00418Menu.\u003Cpopup99931\u003Ec__Iterator2D5();
    return (IEnumerator) popup99931CIterator2D5;
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CIbtnBuyBack\u003Ec__Iterator2D6()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CaddCondition\u003Ec__Iterator2D7()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CsetBackground\u003Ec__Iterator2D8()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CInit\u003Ec__Iterator2D9()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CchangeView\u003Ec__Iterator2DA()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CchangePanel\u003Ec__Iterator2DB()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CcreatePanel\u003Ec__Iterator2DC()
    {
      prefab = prefab,
      pdm = pdm,
      \u003C\u0024\u003Eprefab = prefab,
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new ActivityMission00418Menu.\u003CcreateBanner\u003Ec__Iterator2DD()
    {
      table = table,
      listState = listState,
      \u003C\u0024\u003Etable = table,
