...
public class Battle01SelectNode : BattleMonoBehaviour
{
  ...
  public override IEnumerator onInitAsync()
  {
    ...
    return (IEnumerator) new Battle01SelectNode.\u003ConInitAsync\u003Ec__Iterator922()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CStart_Battle\u003Ec__Iterator923()
    {
      \u003C\u003Ef__this = this
    };
  }
...
label_16:
  ...
  {
    u.setIsDead(true, this.env.core, this.env.core.phaseState.absoluteTurnCount);
  ...
  private void doEnemyDead(BL.Unit u)
  {
    ...
    if (this.env.core.unitCurrent.unit == null || this.env.core.unitCurrent.unit.isDead || this.env.core.isAutoBattle.value || !this.env.core.unitCurrent.unit.isPlayerControl || !this.env.core.currentUnitPosition.cantChangeCurrent || this.env.core.currentUnitPosition.isCompleted)
      return;
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CWaitScrollSe\u003Ec__Iterator924()
    {
      obj = obj,
      \u003C\u0024\u003Eobj = obj
    };
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CAutoBattleStartPop\u003Ec__Iterator925()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CTurnEndPop\u003Ec__Iterator926()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Battle01SelectNode.\u003CpushCancel\u003Ec__Iterator927()
    {
      \u003C\u003Ef__this = this
    };
  }
