...
public class Shop00720Menu : BackButtonMenuBase
{
  ...
  public IEnumerator Initialize(Shop00720Scene scene)
  {
    ...
    return (IEnumerator) new Shop00720Menu.\u003CInitialize\u003Ec__Iterator49A()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00720Menu.\u003CMedalPay\u003Ec__Iterator49B()
    {
      \u003C\u003Ef__this = this
    };
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00720Menu.\u003CSetResult\u003Ec__Iterator49C()
    {
      result = result,
      \u003C\u0024\u003Eresult = result,
      \u003C\u003Ef__this = this
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator) new Shop00720Menu.\u003CShowRewards\u003Ec__Iterator49D()
    {
      prefabs = prefabs,
      deckID = deckID,
      \u003C\u0024\u003Eprefabs = prefabs,
