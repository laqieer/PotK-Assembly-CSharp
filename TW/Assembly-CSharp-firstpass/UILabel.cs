...
public class UILabel : UIWidget
{
  ...
  protected void SetActiveFont(Font fnt)
  {
    ...
    {
      int num1;
      if (UILabel.mFontUsage.TryGetValue(this.mActiveTTF, out num1))
      {
        int num2;
        int num3 = Mathf.Max(0, num2 = num1 - 1);
        if (num3 == 0)
        {
          this.mActiveTTF.textureRebuildCallback = (Font.FontTextureRebuildCallback) null;
  ...
  private static void OnFontTextureChanged()
  {
    for (int i = 0; i < UILabel.mList.size; ++i)
    {
      ...
      if (Object.op_Inequality((Object) m, (Object) null))
      {
        ...
        if (Object.op_Inequality((Object) trueTypeFont, (Object) null))
        {
  ...
  public string GetStandardizationTextJP(string text)
  {
    this.text = text;
    this.ProcessText();
    return NGUIText.GetStandardizationTextJP(text);
  }

  public string GetStandardizationTextEN(string text)
  {
    this.text = text;
    return NGUIText.GetStandardizationTextEN(text);
  }
